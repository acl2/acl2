...
; DF built-ins not included above:
    ...
    '(& &ALLOW-OTHER-KEYS &AUX &BODY &KEY
        ...
        *STANDARD-CO* *STANDARD-OI*
        ...
        ADD-DEFAULT-HINTS ADD-DEFAULT-HINTS! ADD-GLOBAL-STOBJ
        ...
        ARRAY2P-LINEAR ASET1 ASET1-TRUSTED ASET2
        ...
        ASSUME ATOM ATOM-LISTP ATOM-LISTP-FORWARD-TO-TRUE-LISTP
        ATTACH-STOBJ BACKCHAIN-LIMIT BADGE BADGE-USERFN
        BINARY-* BINARY-+ BINARY-APPEND BIND-FREE
        ...
        BRR BRR-EVISC-TUPLE BRR-NEAR-MISSP BRR@ BUILD-STATE1 BUTLAST
        ...
        COMMUNITY-BOOKS
        COMMUTATIVITY-OF-*
        COMMUTATIVITY-OF-+ COMP COMPARE-OBJECTS COMPLETION-OF-*
        ...
        CW CW! CW!+ CW+
        CW-GSTACK
        CW-GSTACK-FOR-SUBTERM CW-GSTACK-FOR-SUBTERM*
        ...
        IMPROPER-CONSP IN-ARITHMETIC-THEORY IN-LOGIC-MODE
        ...
        L<
        LAMBDA LAMBDA$
        LAST LAST-CDR LAST-PROVER-STEPS LD
        LD-ALWAYS-SKIP-TOP-LEVEL-LOCALS LD-ERROR-ACTION
        ...
        LIST$ LIST* LIST*-MACRO LIST-MACRO LISTP LOCAL LOGAND
        ...
        OLD-AND-NEW-EVENT-DATA OOPS OPEN-CHANNEL-LISTP OPEN-CHANNEL1
        ...
        REMOVE-EQ REMOVE-EQUAL REMOVE-GLOBAL-STOBJ REMOVE-GUARD-HOLDERS
        ...
        SET-SLOW-ALIST-ACTION SET-SPLITTER-OUTPUT
        SET-STANDARD-CO
        SET-STANDARD-OI
        SET-STATE-OK
        ...
        SET-TRACE-CO SET-TRACE-EVISC-TUPLE SET-VERIFY-GUARDS-EAGERNESS
        SET-W
        ...
        SHOW-FC-CRITERIA SIGNED-BYTE SIGNED-BYTE-P SIGNUM SIMPLIFY
        ...
        STATE-GLOBAL-LET*-PUT-GLOBALS STATE-P STATE-P+
        ...
        STRING STRING-ALISTP STRING-APPEND STRING-APPEND-LST
        ...
        TOP-LEVEL TRACE! TRACE$ TRACE-CO TRANS
        TRANS! TRANS* TRANS*-
        ...
        WELL-FORMED-LAMBDA-OBJECTP WET WHEN$ WHEN$+ WITH-BRR-DATA
        WITH-CBD WITH-CURRENT-PACKAGE WITH-FAST-ALIST
