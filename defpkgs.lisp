    ...
    *hons-primitives* ; even for non-hons version, for compatibility of the two
    ...
    '(& &ALLOW-OTHER-KEYS &AUX &BODY &KEY
        ...
        *STANDARD-CO* *STANDARD-OI*
        ...
        DMR-START DMR-STOP DOC DOC! DOCS
        ...
        LOGICAL-DEFUN ; deprecated in favor of get-defun-event
        ...
        SYMBOL
; The following are deprecated in ACL2 Version  8.4.  See SYMBOL< etc. below
; for current versions.
        SYMBOL-< SYMBOL-<-ASYMMETRIC SYMBOL-<-IRREFLEXIVE
        SYMBOL-<-TRANSITIVE SYMBOL-<-TRICHOTOMY
; End of deprecated symbols.
        SYMBOL-ALISTP
