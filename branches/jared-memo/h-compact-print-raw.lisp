...
; h-compact-print-raw.lisp
;
; Functions for compact printing and reading using HONS.  Jared split this out
; of memoize-raw.lisp because it has nothing to do with memoization.
;
; There are alternatives to this, such as the serialize book.  But I think this
; may now be some deep part of ACL2's certificate-printing stuff for make-event
; forms, so we're probably stuck with it for now.  God help us.
