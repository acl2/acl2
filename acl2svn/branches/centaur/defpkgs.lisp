    ...
    *hons-primitives* ; even for non-hons version, for compatibility of the two
    ...
    '(& &ALLOW-OTHER-KEYS &AUX &BODY &KEY
        ...
        *STANDARD-CO* *STANDARD-OI*
        ...
        ADD-RAW-ARITY ADD-TIMERS ADD-TO-SET-EQ
        ...
        CONSP-ASSOC CONSP-ASSOC-EQ COROLLARY
        ...
        EXTEND-T-STACK
        EXTEND-WORLD EXTRA-INFO FERTILIZE
        ...
        GET-GLOBAL GET-TIMER GET-WORMHOLE-STATUS
        ...
        PUT-ASSOC-EQ PUT-ASSOC-EQL
        PUT-ASSOC-EQUAL PUT-GLOBAL PUTPROP
        QUIT QUOTE QUOTEP R-EQLABLE-ALISTP
        ...
        SET-WORMHOLE-DATA
        SET-WORMHOLE-ENTRY-CODE SETENV$ SEVENTH
