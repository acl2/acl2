    ...
    *hons-primitives* ; even for non-hons version, for compatibility of the two
    '(& &ALLOW-OTHER-KEYS &AUX &BODY &KEY &OPTIONAL &REST &WHOLE *
        ...
        *STANDARD-CHARS* *STANDARD-CI* *STANDARD-CO* *STANDARD-OI* + - / /= 1+
        ...
        RETRACT-WORLD RETRIEVE RETURN-LAST RETURN-LAST-TABLE
        REVAPPEND REVERSE RFIX ROUND
        SATISFIES SECOND SET-PRINT-BASE SET-PRINT-CASE SET-BACKCHAIN-LIMIT
        SET-BODY SET-BOGUS-DEFUN-HINTS-OK SET-BOGUS-MUTUAL-RECURSION-OK
