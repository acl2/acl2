...
(link-doc-to read-byte$ built-ins io)
(link-doc-to open-input-channel built-ins io)
(link-doc-to open-input-channel-p built-ins io)
(link-doc-to close-input-channel built-ins io)
(link-doc-to read-char$ built-ins io)
(link-doc-to peek-char$ built-ins io)
(link-doc-to read-object built-ins io)
(link-doc-to open-output-channel built-ins io)
(link-doc-to open-output-channel-p built-ins io)
(link-doc-to close-output-channel built-ins io)
(link-doc-to write-byte$ built-ins io)
(link-doc-to print-object$ built-ins io)
(link-doc-to get-output-stream-string$ built-ins io)

(link-doc-to lambda miscellaneous term)
(link-doc-to untranslate built-ins user-defined-functions-table)
...
(link-doc-to member-eq built-ins member)
(link-doc-to member-equal built-ins member)
(link-doc-to assoc-eq built-ins assoc)
(link-doc-to assoc-equal built-ins assoc)
(link-doc-to subsetp-eq built-ins subsetp)
(link-doc-to subsetp-equal built-ins subsetp)
(link-doc-to no-duplicatesp-eq built-ins no-duplicatesp)
(link-doc-to no-duplicatesp-equal built-ins no-duplicatesp)
(link-doc-to rassoc-eq built-ins rassoc)
(link-doc-to rassoc-equal built-ins rassoc)
(link-doc-to remove-eq built-ins remove)
(link-doc-to remove-equal built-ins remove)
(link-doc-to remove1-eq built-ins remove1)
(link-doc-to remove1-equal built-ins remove1)
(link-doc-to remove-duplicates-eq built-ins remove-duplicates)
(link-doc-to remove-duplicates-equal built-ins remove-duplicates)
(link-doc-to position-eq built-ins position)
(link-doc-to position-equal built-ins position)
(link-doc-to set-difference-eq built-ins set-difference$)
(link-doc-to set-difference-equal built-ins set-difference$)
(link-doc-to add-to-set-eq built-ins add-to-set)
(link-doc-to add-to-set-eql built-ins add-to-set) ; pre-v4-3 compatibility
(link-doc-to add-to-set-equal built-ins add-to-set)
(link-doc-to intersectp-eq built-ins intersectp)
(link-doc-to intersectp-equal built-ins intersectp)
(link-doc-to put-assoc-eq built-ins put-assoc)
(link-doc-to put-assoc-eql built-ins put-assoc) ; pre-v4-3 compatibility
(link-doc-to put-assoc-equal built-ins put-assoc)
(link-doc-to delete-assoc-eq built-ins delete-assoc)
(link-doc-to delete-assoc-equal built-ins delete-assoc)
(link-doc-to union-eq built-ins union$)
(link-doc-to union-equal built-ins union$)
(link-doc-to intersection-eq built-ins intersection$)
(link-doc-to intersection-equal built-ins intersection$)

(link-doc-to observation-cw built-ins observation)
