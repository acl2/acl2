(REL-BIT)
(STRIP-UNARY-B-FN (216 101 (:REWRITE DEFAULT-+-2))
...
(STRIP-UNARY-BV-FN (251 114 (:REWRITE DEFAULT-+-2))
...
(B-IF-META1-LIST
     (1968 925 (:REWRITE DEFAULT-+-2))
     (1260 925 (:REWRITE DEFAULT-+-1))
...
(B-NOT-CALLP)
(B-IF-META (859 859 (:REWRITE DEFAULT-CDR))
