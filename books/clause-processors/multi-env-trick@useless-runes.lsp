...
(MULTI-ENV-EV-DISJOIN-ATOM (1 1 (:REWRITE MULTI-ENV-EV-CONSTRAINT-8)))
(MULTI-ENV-EV-DISJOIN-APPEND (23 23 (:REWRITE MULTI-ENV-EV-CONSTRAINT-8))
                             (23 23
                                 (:REWRITE MULTI-ENV-EV-CONSTRAINT-2)))
(MULTI-ENV-EV-CONJOIN-CONS)
(MULTI-ENV-EV-CONJOIN-WHEN-CONSP)
(MULTI-ENV-EV-CONJOIN-ATOM (1 1 (:REWRITE MULTI-ENV-EV-CONSTRAINT-8)))
(MULTI-ENV-EV-CONJOIN-APPEND (23 23 (:REWRITE MULTI-ENV-EV-CONSTRAINT-8))
                             (23 23
                                 (:REWRITE MULTI-ENV-EV-CONSTRAINT-2)))
...
(MULTI-ENV-EV-THEOREMP-CONJOIN-CONS
     ...
     (50 50
         (:REWRITE MULTI-ENV-EV-CONJOIN-ATOM)))
...
(MULTI-ENV-EV-THEOREMP-IMPLIES-CLAUSES-APPLY-ALISTS
     (65 5
         (:DEFINITION CLAUSE-APPLY-ALISTS-MULTI-ENV-EV))
