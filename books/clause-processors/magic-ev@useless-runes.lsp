(MAGIC-EV (2060 937 (:REWRITE DEFAULT-+-2))
...
(LEN-OF-MAGIC-EV-LST (1235 19 (:DEFINITION MAGIC-EV))
...
(TRUE-LISTP-MAGIC-EV-LST (1040 16 (:DEFINITION MAGIC-EV))
...
(MAGIC-EV (2010 1931 (:REWRITE DEFAULT-CDR))
