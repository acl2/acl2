...
(PSEUDO-TERMP-CONS-TERM1-MV2
     ...
     (2 2 (:REWRITE DEFAULT-*-2))
     (2 2 (:REWRITE DEFAULT-*-1)))
(TERM-SUBST (5 5 (:REWRITE DEFAULT-CDR))
            (4 4
               (:REWRITE TERM-LISTP-IMPLIES-PSEUDO-TERM-LISTP))
            (3 3 (:REWRITE TERMP-IMPLIES-PSEUDO-TERMP))
            (3 3 (:REWRITE DEFAULT-CAR)))
(TERM-SUBST-FLG (4 2 (:TYPE-PRESCRIPTION RETURN-LAST))
                (2 2
                   (:TYPE-PRESCRIPTION THROW-NONEXEC-ERROR)))
(FLAG::FLAG-EQUIV-LEMMA)
(TERM-SUBST-FLG-EQUIVALENCES)
(FLAG-LEMMA-FOR-SUBLIS-VAR1-WHEN-UNCHANGED (119 119 (:REWRITE DEFAULT-CAR))
...
(LEN-OF-SUBLIS-VAR1-LST (133 7 (:DEFINITION SUBLIS-VAR1))
...
(FLAG-LEMMA-FOR-PSEUDO-TERMP-OF-SUBLIS-VAR1
     ...
     (129 129
          (:REWRITE TERM-LISTP-IMPLIES-PSEUDO-TERM-LISTP))
     (99 9
         (:REWRITE PSEUDO-TERMP-SUBLIS-VAR1-LST))
     (98 98
         (:REWRITE TERMP-IMPLIES-PSEUDO-TERMP))
...
(LEN-OF-TERMLIST-SUBST (10 10 (:REWRITE DEFAULT-CDR))
                       (10 1 (:DEFINITION TERM-SUBST))
                       (9 9 (:REWRITE DEFAULT-CAR))
                       (6 3 (:REWRITE DEFAULT-+-2))
                       (5 1 (:DEFINITION ASSOC-EQUAL))
                       (3 3 (:REWRITE DEFAULT-+-1)))
(PSEUDO-TERMP-OF-LOOKUP (10 2 (:DEFINITION ASSOC-EQUAL))
                        (8 8 (:REWRITE DEFAULT-CAR))
                        (8 1 (:DEFINITION PSEUDO-TERM-LISTP))
...
(ASSOC-OF-APPEND-WHEN-ALISTP-X (124 112 (:REWRITE DEFAULT-CAR))
                               (50 25
...
(EVAL-OF-SUBLIS-VAR
     ...
     (1 1 (:REWRITE DEFAULT-COERCE-2))
     (1 1 (:REWRITE DEFAULT-COERCE-1)))
(SUBCOR-VAR1-IN-TERMS-OF-CDR-ASSOC (78 74 (:REWRITE DEFAULT-CAR))
                                   (43 41 (:REWRITE DEFAULT-CDR)))
(CONS-TERM1-EQUALS-CONS-TERM1-MV2
     ...
     (4 4 (:REWRITE DEFAULT-*-2))
     (4 4 (:REWRITE DEFAULT-*-1)))
(CONS-TERM1-MV2-WHEN-NOT-SYMBOLP (4 4 (:REWRITE DEFAULT-CAR))
