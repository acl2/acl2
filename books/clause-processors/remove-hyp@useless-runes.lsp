...
(REMOVE-FIRST-HYP-CP-CORRECT
     ...
     (14 14
         (:REWRITE REMOVE-HYP-EV-CONSTRAINT-3))
...
(REMOVE-HYP-CP)
(DISJOIN-OF-REMOVE-EQUAL (417 417 (:REWRITE DEFAULT-CAR))
                         (401 391 (:REWRITE DEFAULT-CDR))
                         (115 91
                              (:REWRITE REMOVE-HYP-EV-CONSTRAINT-3))
                         (82 58
                             (:REWRITE REMOVE-HYP-EV-CONSTRAINT-1)))
(REMOVE-HYP-CP-CORRECT (8 8 (:REWRITE DEFAULT-CDR))
