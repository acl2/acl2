...
(PERM-CDR (45 45 (:REWRITE DEFAULT-CAR))
...
(SPLIT-LIST (259 14 (:DEFINITION INTEGER-ABS))
            ...
            (1 1
               (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-A+AB))
            (1 1 (:REWRITE |(< 0 (- x))|)))
(MERGE2 (296 16 (:DEFINITION INTEGER-ABS))
        ...
        (2 2 (:REWRITE |(< (+ c x) d)|))
        (2 2 (:REWRITE |(< (+ c x) (+ d y))|)))
(SPLIT-LIST-SMALLER (3848 208 (:DEFINITION INTEGER-ABS))
                    ...
                    (4 4
                       (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-A+AB))
                    (4 4 (:REWRITE |(< 0 (- x))|)))
(MERGESORT (250 4 (:DEFINITION ACL2-COUNT))
...
(PERM-APPEND (522 474 (:REWRITE DEFAULT-CAR))
...
(PERM-APPEND-DEL (27 3 (:DEFINITION DEL))
...
(MERGE2-IS-APPEND (86 76 (:REWRITE DEFAULT-CAR))
...
(PERM-APPEND-CONS-2 (396 3 (:REWRITE DEL-APPEND))
...
(PERM-MERGESORT (286 18 (:DEFINITION SPLIT-LIST))
...
(LEMMA0 (24 4 (:REWRITE EVL-CONSTRAINT-9))
...
(CORRECTNESS-OF-BV-ADDS-IN
     ...
     (17 17
         (:REWRITE PERM-IMPLIES-BV-ADD-EQUALITY))
