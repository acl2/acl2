...
(REPL-EV-DISJOIN-ATOM (1 1 (:REWRITE REPL-EV-OF-IF-CALL)))
(REPL-EV-DISJOIN-APPEND (23 23 (:REWRITE REPL-EV-OF-QUOTE))
                        (23 23 (:REWRITE REPL-EV-OF-IF-CALL)))
(REPL-EV-CONJOIN-CONS)
(REPL-EV-CONJOIN-WHEN-CONSP)
(REPL-EV-CONJOIN-ATOM (1 1 (:REWRITE REPL-EV-OF-IF-CALL)))
(REPL-EV-CONJOIN-APPEND (23 23 (:REWRITE REPL-EV-OF-QUOTE))
                        (23 23 (:REWRITE REPL-EV-OF-IF-CALL)))
(REPL-EV-CONJOIN-CLAUSES-CONS (100 50 (:DEFINITION DISJOIN))
                              (50 50 (:DEFINITION DISJOIN2))
                              (7 7 (:REWRITE REPL-EV-DISJOIN-ATOM))
                              (5 5 (:REWRITE REPL-EV-CONJOIN-ATOM)))
(REPL-EV-CONJOIN-CLAUSES-WHEN-CONSP (24 24 (:REWRITE REPL-EV-OF-QUOTE))
                                    (24 24 (:REWRITE REPL-EV-OF-IF-CALL))
                                    (18 9 (:DEFINITION DISJOIN))
                                    (9 9 (:REWRITE REPL-EV-DISJOIN-ATOM))
                                    (9 9 (:DEFINITION DISJOIN2)))
(REPL-EV-CONJOIN-CLAUSES-ATOM (1 1 (:REWRITE REPL-EV-OF-IF-CALL)))
(REPL-EV-CONJOIN-CLAUSES-APPEND (65 65 (:REWRITE REPL-EV-OF-QUOTE))
                                (65 65 (:REWRITE REPL-EV-OF-IF-CALL))
                                (24 12 (:DEFINITION DISJOIN))
                                (12 12 (:REWRITE REPL-EV-DISJOIN-ATOM))
                                (12 12 (:DEFINITION DISJOIN2)))
(REPL-EV-THEOREMP-CONJOIN-CONS (53 53 (:REWRITE REPL-EV-CONJOIN-ATOM)))
(REPL-EV-THEOREMP-CONJOIN-APPEND)
(REPL-EV-THEOREMP-CONJOIN-CLAUSES-CONS (3 3 (:REWRITE REPL-EV-DISJOIN-ATOM))
...
(REPL-EV-META-EXTRACT-FORMULA (9 9 (:REWRITE REPL-EV-OF-VARIABLE))
                              (9 9
                                 (:REWRITE REPL-EV-OF-TYPESPEC-CHECK-CALL))
...
(SIMPLE-ONE-WAY-UNIFY-CORRECT-FOR-REPL-EV
     ...
     (4 4
        (:REWRITE REPL-EV-META-EXTRACT-FN-CHECK-DEF))
...
(REPL-EV-EQUALITY-ALIST-P (4 4 (:REWRITE DEFAULT-CAR))
...
(SUBST-SUBTERMS (131 1 (:DEFINITION PSEUDO-TERMP))
...
(SUBST-SUBTERMS-FLAG (4 2 (:TYPE-PRESCRIPTION RETURN-LAST))
                     (2 2
                        (:TYPE-PRESCRIPTION THROW-NONEXEC-ERROR)))
(FLAG::FLAG-EQUIV-LEMMA)
(SUBST-SUBTERMS-FLAG-EQUIVALENCES)
(LEN-SUBST-SUBTERMS-LIST (48 24 (:REWRITE DEFAULT-+-2))
...
(DISJOIN-SUBST-SUBTERMS-LIST-CORRECT
     (220 57
          (:REWRITE ASSOC-IN-REPL-EV-EQUALITY-ALIST))
     ...
     (48 48
         (:TYPE-PRESCRIPTION SUBST-SUBTERMS-LIST))
...
(HYP-TERM (5 1 (:DEFINITION ASSOC-EQUAL))
          (3 3 (:REWRITE DEFAULT-CAR))
          (1 1 (:REWRITE DEFAULT-CDR))
          (1 1 (:REWRITE ASSOC-IN-MATCH-TREE)))
(LHS (5 1 (:DEFINITION ASSOC-EQUAL))
     (3 3 (:REWRITE DEFAULT-CAR))
     (1 1 (:REWRITE DEFAULT-CDR))
     (1 1 (:REWRITE ASSOC-IN-MATCH-TREE)))
(RHS (5 1 (:DEFINITION ASSOC-EQUAL))
     (3 3 (:REWRITE DEFAULT-CAR))
     (1 1 (:REWRITE DEFAULT-CDR))
     (1 1 (:REWRITE ASSOC-IN-MATCH-TREE)))
(HYP-TERM-ACL2-COUNT-WEAK (204 4 (:DEFINITION ACL2-COUNT))
...
(HYP-TERM-ACL2-COUNT-STRONG (204 4 (:DEFINITION ACL2-COUNT))
                            (64 32 (:REWRITE DEFAULT-+-2))
                            (44 32 (:REWRITE DEFAULT-+-1))
                            (32 8 (:REWRITE COMMUTATIVITY-OF-+))
                            (32 8 (:DEFINITION INTEGER-ABS))
                            ...
                            (2 2 (:TYPE-PRESCRIPTION MEMBER-EQUAL))
                            (2 2 (:REWRITE ASSOC-IN-MATCH-TREE)))
(LHS-ACL2-COUNT-WEAK (204 4 (:DEFINITION ACL2-COUNT))
                     (64 32 (:REWRITE DEFAULT-+-2))
                     (44 32 (:REWRITE DEFAULT-+-1))
                     (32 8 (:REWRITE COMMUTATIVITY-OF-+))
                     (32 8 (:DEFINITION INTEGER-ABS))
                     ...
                     (2 2 (:TYPE-PRESCRIPTION MEMBER-EQUAL))
                     (2 2 (:REWRITE ASSOC-IN-MATCH-TREE)))
(LHS-ACL2-COUNT-STRONG (204 4 (:DEFINITION ACL2-COUNT))
                       (64 32 (:REWRITE DEFAULT-+-2))
                       (44 32 (:REWRITE DEFAULT-+-1))
                       (32 8 (:REWRITE COMMUTATIVITY-OF-+))
                       (32 8 (:DEFINITION INTEGER-ABS))
                       ...
                       (2 2 (:TYPE-PRESCRIPTION MEMBER-EQUAL))
                       (2 2 (:REWRITE ASSOC-IN-MATCH-TREE)))
(RHS-ACL2-COUNT-WEAK (204 4 (:DEFINITION ACL2-COUNT))
                     (64 32 (:REWRITE DEFAULT-+-2))
                     (44 32 (:REWRITE DEFAULT-+-1))
                     (32 8 (:REWRITE COMMUTATIVITY-OF-+))
                     (32 8 (:DEFINITION INTEGER-ABS))
                     ...
                     (2 2 (:TYPE-PRESCRIPTION MEMBER-EQUAL))
                     (2 2 (:REWRITE ASSOC-IN-MATCH-TREE)))
(RHS-ACL2-COUNT-STRONG (204 4 (:DEFINITION ACL2-COUNT))
                       (64 32 (:REWRITE DEFAULT-+-2))
                       (44 32 (:REWRITE DEFAULT-+-1))
                       (32 8 (:REWRITE COMMUTATIVITY-OF-+))
                       (32 8 (:DEFINITION INTEGER-ABS))
...
(UNIFY-LIT-WITH-EQUALITY-RULE-CDR-PSEUDO-TERMP
     ...
     (1 1
        (:REWRITE SIMPLE-ONE-WAY-UNIFY-WITH-REPL-EV))
     (1 1
        (:REWRITE SIMPLE-ONE-WAY-UNIFY-USAGE)))
(MATCH-TREE-REPL-EV (2 2 (:REWRITE REPL-EV-OF-VARIABLE))
                    (2 2
                       (:REWRITE REPL-EV-OF-TYPESPEC-CHECK-CALL))
...
(REPL-EV-EQUALITY-ALIST-P-LIT-GET-EQUALITY-RULES
     ...
     (2 2
        (:REWRITE UNIFY-LIT-WITH-EQUALITY-RULE-CONSP)))
...
(PSEUDO-TERMP-DUMB-NEGATE-LIT
     ...
     (11 11 (:REWRITE DEFAULT-COERCE-1)))
(REMOVE-NON-SYMBOLS)
(SYMBOL-LISTP-REMOVE-NON-SYMBOLS (16 15 (:REWRITE DEFAULT-CAR))
                                 (12 12 (:REWRITE FN-CHECK-DEF-FORMALS))
                                 (11 10 (:REWRITE DEFAULT-CDR)))
(REMOVE-NON-SYMBOLS-WHEN-SYMBOL-LISTP (16 16 (:REWRITE DEFAULT-CAR))
                                      (9 9 (:REWRITE FN-CHECK-DEF-FORMALS))
                                      (8 8 (:REWRITE DEFAULT-CDR)))
(REMOVE-NON-SYMBOL-PAIRS)
(SYMBOL-ALISTP-REMOVE-NON-SYMBOL-PAIRS (48 46 (:REWRITE DEFAULT-CAR))
                                       (15 14 (:REWRITE DEFAULT-CDR)))
(REMOVE-NON-SYMBOL-PAIRS-WHEN-SYMBOL-ALISTP (44 44 (:REWRITE DEFAULT-CAR))
                                            (11 11 (:REWRITE DEFAULT-CDR)))
(REPLACE-EQUALITIES-ITER (123 123 (:REWRITE DEFAULT-CAR))
...
(PSEUDO-TERM-LISTP-REPLACE-EQUALITIES-ITER
     ...
     (120 4
          (:REWRITE REMOVE-NON-SYMBOLS-WHEN-SYMBOL-LISTP))
     (96 48 (:REWRITE DEFAULT-+-2))
...
(REPLACE-EQUALITIES-ITER-CORRECT
     ...
     (56 56
         (:TYPE-PRESCRIPTION REPLACE-EQUALITIES-ITER))
     (55 55
         (:TYPE-PRESCRIPTION SYMBOL-LIST-LISTP))
     (55 11 (:DEFINITION ASSOC-EQUAL))
     (36 1
         (:DEFINITION REPL-EV-EQUALITY-ALIST-P))
     (23 23 (:REWRITE FN-CHECK-DEF-NOT-QUOTE))
     ...
     (4 4
        (:TYPE-PRESCRIPTION SUBST-SUBTERMS-LIST))
     (3 3
        (:TYPE-PRESCRIPTION LIT-GET-EQUALITY-RULES))
     (2 2
        (:REWRITE REPL-EV-META-EXTRACT-FN-CHECK-DEF)))
...
(REPLACE-EQUALITIES-CP-CORRECT
     ...
     (11 1
         (:REWRITE REMOVE-NON-SYMBOL-PAIRS-WHEN-SYMBOL-ALISTP))
