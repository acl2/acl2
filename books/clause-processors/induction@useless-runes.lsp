...
(INDEV-OF-IF-CALL)
(INDEV-OF-O-P-CALL)
(INDEV-OF-O<-CALL (44 2 (:DEFINITION O<))
...
(INDEV-DISJOIN-ATOM (1 1 (:REWRITE INDEV-OF-IF-CALL)))
(INDEV-DISJOIN-APPEND (23 23 (:REWRITE INDEV-OF-QUOTE))
                      (23 23 (:REWRITE INDEV-OF-IF-CALL)))
(INDEV-CONJOIN-CONS)
(INDEV-CONJOIN-WHEN-CONSP)
(INDEV-CONJOIN-ATOM (1 1 (:REWRITE INDEV-OF-IF-CALL)))
(INDEV-CONJOIN-APPEND (23 23 (:REWRITE INDEV-OF-QUOTE))
                      (23 23 (:REWRITE INDEV-OF-IF-CALL)))
(INDEV-CONJOIN-CLAUSES-CONS (100 50 (:DEFINITION DISJOIN))
                            (50 50 (:DEFINITION DISJOIN2))
                            (7 7 (:REWRITE INDEV-DISJOIN-ATOM))
                            (5 5 (:REWRITE INDEV-CONJOIN-ATOM)))
(INDEV-CONJOIN-CLAUSES-WHEN-CONSP (24 24 (:REWRITE INDEV-OF-QUOTE))
                                  (24 24 (:REWRITE INDEV-OF-IF-CALL))
                                  (18 9 (:DEFINITION DISJOIN))
                                  (9 9 (:REWRITE INDEV-DISJOIN-ATOM))
                                  (9 9 (:DEFINITION DISJOIN2)))
(INDEV-CONJOIN-CLAUSES-ATOM (1 1 (:REWRITE INDEV-OF-IF-CALL)))
(INDEV-CONJOIN-CLAUSES-APPEND (65 65 (:REWRITE INDEV-OF-QUOTE))
                              (65 65 (:REWRITE INDEV-OF-IF-CALL))
                              (24 12 (:DEFINITION DISJOIN))
                              (12 12 (:REWRITE INDEV-DISJOIN-ATOM))
                              (12 12 (:DEFINITION DISJOIN2)))
(INDEV-THEOREMP-CONJOIN-CONS (53 53 (:REWRITE INDEV-CONJOIN-ATOM)))
(INDEV-THEOREMP-CONJOIN-APPEND)
(INDEV-THEOREMP-CONJOIN-CLAUSES-CONS (3 3 (:REWRITE INDEV-DISJOIN-ATOM))
                                     (3 3 (:REWRITE INDEV-CONJOIN-ATOM)))
(INDEV-THEOREMP-CONJOIN-CLAUSES-APPEND (15 15 (:REWRITE INDEV-DISJOIN-ATOM)))
...
(INDUCTION-STEPS (1674 12 (:DEFINITION PSEUDO-TERMP))
                 ...
                 (9 9
                    (:REWRITE SUBSTITUTE-LIST-INTO-CLAUSE-OF-ATOM))
                 (5 5
                    (:REWRITE SUBSTITUTE-INTO-LIST-OF-ATOM)))
(MEASURE-DECRS-SUBS (816 6 (:DEFINITION PSEUDO-TERMP))
...
(MEASURE-DECRS (195 20 (:REWRITE PSEUDO-TERMP-CAR))
               ...
               (2 2
                  (:REWRITE PSEUDO-TERM-VAL-ALISTP-OF-ATOM)))
(O-FIRST-EXPT-OF-MAKE-ORD (2 2 (:REWRITE DEFAULT-CAR)))
(O-FIRST-COEFF-OF-MAKE-ORD (1 1 (:REWRITE DEFAULT-CDR))
                           (1 1 (:REWRITE DEFAULT-CAR)))
(O-RST-OF-MAKE-ORD)
(O-FINP-OF-MAKE-ORD)
(O-P-OF-MAKE-ORD (150 150 (:REWRITE DEFAULT-CAR))
                 ...
                 (4 4 (:REWRITE NATP-RW)))
(O<-SELF (30 30 (:REWRITE DEFAULT-CAR))
...
(ACL2-COUNT-OF-O-RST (118 57 (:REWRITE DEFAULT-+-2))
                     ...
                     (6 6 (:REWRITE DEFAULT-COERCE-2))
                     (6 6 (:REWRITE DEFAULT-COERCE-1)))
(O-FIN-PART (67 2 (:DEFINITION ACL2-COUNT))
...
(REPLACE-O-FIN-PART (67 2 (:DEFINITION ACL2-COUNT))
                    (21 10 (:REWRITE DEFAULT-+-2))
                    (14 10 (:REWRITE DEFAULT-+-1))
                    (10 2 (:DEFINITION INTEGER-ABS))
                    (8 2 (:REWRITE COMMUTATIVITY-OF-+))
                    ...
                    (1 1 (:REWRITE DEFAULT-COERCE-2))
                    (1 1 (:REWRITE DEFAULT-COERCE-1)))
(O-FIRST-EXPT-OF-REPLACE-O-FIN-PART (36 4 (:REWRITE NFIX-WHEN-NATP))
...
(O-FINP-OF-REPLACE-O-FIN-PART (18 2 (:REWRITE NFIX-WHEN-NATP))
...
(O-P-OF-FIRST-EXPT-WHEN-O-P (54 3 (:DEFINITION O<))
...
(POSP-OF-FIRST-COEFF-WHEN-O-P (4 1 (:REWRITE O-P-OF-FIRST-EXPT-WHEN-O-P))
                              (1 1 (:REWRITE DEFAULT-CAR))
                              (1 1 (:META CANCEL_TIMES-EQUAL-CORRECT))
                              (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(O-P-NFIX (9 1 (:REWRITE NFIX-WHEN-NATP))
...
(FIRST-<-RST-WHEN-O-P (18 4 (:REWRITE DEFAULT-<-1))
                      ...
                      (1 1 (:REWRITE DEFAULT-CAR)))
(O-P-OF-O-RST (28 14
                  (:TYPE-PRESCRIPTION POSP-OF-FIRST-COEFF-WHEN-O-P))
              (14 1 (:REWRITE ZP-WHEN-GT-0))
              (7 1 (:REWRITE ZP-WHEN-INTEGERP))
              ...
              (1 1 (:META CANCEL_TIMES-EQUAL-CORRECT))
              (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(O-P-REPLACE-O-FIN-PART (27 3 (:REWRITE NFIX-WHEN-NATP))
...
(REPLACE-O-FIN-PART (4 1 (:REWRITE NATP-WHEN-GTE-0))
...
(REPLACE-O-FIN-PART-NONZERO (12 5 (:REWRITE DEFAULT-<-2))
                            (8 2 (:REWRITE ZP-WHEN-GT-0))
                            ...
                            (2 2 (:REWRITE ZP-WHEN-INTEGERP))
                            (2 2 (:REWRITE ZP-OPEN)))
(O-FIRST-EXPT-OF-NFIX (9 1 (:REWRITE NFIX-WHEN-NATP))
                      (6 1 (:REWRITE NFIX-WHEN-NOT-NATP))
                      (5 2 (:REWRITE NATP-WHEN-GTE-0))
                      (4 4 (:TYPE-PRESCRIPTION NATP))
                      (2 2 (:REWRITE NATP-WHEN-INTEGERP))
                      ...
                      (1 1 (:META CANCEL_PLUS-LESSP-CORRECT)))
(INDEV-ALIST)
(INDEV-SUBSTITUTE-INTO-TERM (110 94 (:REWRITE DEFAULT-CAR))
...
(LEN-EQUAL-0 (9 5 (:REWRITE DEFAULT-+-2))
             ...
             (4 4 (:META CANCEL_TIMES-EQUAL-CORRECT))
             (4 4 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(NTHCDR-NIL (16 4 (:REWRITE ZP-WHEN-GT-0))
            (13 13
            ...
            (4 4 (:REWRITE DEFAULT-+-1))
            (4 4 (:META CANCEL_PLUS-LESSP-CORRECT)))
(NTHCDR-OPEN (128 27 (:REWRITE ZP-WHEN-GT-0))
...
(NTHCDR-END (55 10 (:REWRITE NTHCDR-OPEN))
            ...
            (6 6 (:REWRITE NATP-WHEN-INTEGERP))
            (6 6 (:REWRITE NATP-RW)))
(INDUCTION-CP-IND (670 80 (:REWRITE NATP-WHEN-INTEGERP))
...
(O-P-WHEN-THEOREMP (8 8 (:REWRITE DEFAULT-CAR))
...
(MEASURE-DECR-WHEN-MEASURE-DECRS-SUBS
     ...
     (7 7
        (:TYPE-PRESCRIPTION MEASURE-DECRS-SUBS))
...
(MEASURE-DECR-WHEN-MEASURE-DECRS
     ...
     (32 16
         (:REWRITE INDEV-CONJOIN-CLAUSES-ATOM))
...
(O-P-WITH-CLAUSE-WHEN-THEOREMP (29 5 (:REWRITE O-P-WHEN-THEOREMP))
...
(INDUCTION-STEP-RIGHT (235 47
                           (:DEFINITION SUBSTITUTE-LIST-INTO-CLAUSE))
                      ...
                      (7 7
                         (:TYPE-PRESCRIPTION SUBSTITUTE-LIST-INTO-CLAUSE))
                      (5 5 (:REWRITE ZP-WHEN-INTEGERP))
                      (5 5 (:REWRITE ZP-OPEN))
...
(INDUCTION-CP-CORRECT-REC-WITHOUT-ORIG-CLAUSE
     ...
     (8 8
        (:REWRITE SUBSTITUTE-INTO-LIST-OF-ATOM)))
(INDUCTION-CP (1380 268 (:DEFINITION LEN))
              ...
              (2 2
                 (:REWRITE SUBSTITUTE-INTO-LIST-OF-ATOM)))
(DISJOIN-SINGLETON (1 1 (:REWRITE DEFAULT-CDR))
                   (1 1 (:REWRITE DEFAULT-CAR)))
(INDEV-THEOREM-DISJOIN-CLAUSE (2 2 (:REWRITE INDEV-OF-VARIABLE))
                              (2 2 (:REWRITE INDEV-OF-QUOTE))
                              ...
                              (2 2 (:REWRITE INDEV-DISJOIN-ATOM)))
(INDEV-THEOREM-DISJOIN-CONS (3 3 (:REWRITE INDEV-OF-VARIABLE))
                            ...
                            (2 2 (:REWRITE INDEV-DISJOIN-ATOM)))
(INDUCTION-CP-CORRECT (2016 96 (:DEFINITION INDUCTION-STEP-LISTP))
                      ...
                      (526 254
                           (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
                      (480 96
                           (:DEFINITION PSEUDO-TERM-ALIST-LISTP))
                      (427 427
                           (:TYPE-PRESCRIPTION INDUCTION-STEPS))
                      (409 409
                           (:REWRITE TERM-LISTP-IMPLIES-PSEUDO-TERM-LISTP))
                      (409 409
                           (:REWRITE PSEUDO-TERM-LISTP-OF-ATOM))
...
(FIB-OF-X+2 (31 22 (:REWRITE DEFAULT-+-2))
            ...
            (1 1 (:REWRITE NATP-RW)))
(FIB-OF-0-AND-1)
(FIB-POSITIVE (45 31 (:REWRITE DEFAULT-<-2))
