...
(CORRECTNESS-OF-BV-ADD-SORT-CP
 (2584 17 (:DEFINITION PSEUDO-TERMP))
 (969 51 (:REWRITE |(equal (if a b c) x)|))
 (948 948 (:REWRITE DEFAULT-CAR))
 (893 893 (:REWRITE DEFAULT-CDR))
 (884 884 (:TYPE-PRESCRIPTION LEN))
 (821 668 (:REWRITE SIMPLIFY-SUMS-EQUAL))
 (821 668 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
 (821 668 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
