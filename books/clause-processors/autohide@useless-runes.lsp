(WANT-TO-AUTOHIDE (225 27 (:DEFINITION LENGTH))
...
(AUTOHIDE-TERM (225 27 (:DEFINITION LENGTH))
               (180 36 (:DEFINITION LEN))
               (156 156 (:REWRITE DEFAULT-CAR))
               (144 144 (:REWRITE DEFAULT-CDR))
               (81 81 (:TYPE-PRESCRIPTION LEN))
               ...
               (9 9 (:REWRITE DEFAULT-COERCE-1))
               (9 9 (:REWRITE CDR-CONS)))
(FLAG-AUTOHIDE-TERM (8 2 (:TYPE-PRESCRIPTION RETURN-LAST))
                    (2 2
                       (:TYPE-PRESCRIPTION THROW-NONEXEC-ERROR)))
(FLAG::FLAG-EQUIV-LEMMA)
(FLAG-AUTOHIDE-TERM-EQUIVALENCES)
(AUTOHIDE-TERM-LIST-WHEN-ATOM)
(AUTOHIDE-TERM-LIST-OF-CONS (22 2 (:DEFINITION AUTOHIDE-TERM))
                            (13 13 (:REWRITE DEFAULT-CAR))
                            (8 8
                               (:REWRITE AUTOHIDE-TERM-LIST-WHEN-ATOM))
                            (7 7 (:REWRITE DEFAULT-CDR))
                            (6 2 (:DEFINITION MEMBER-EQUAL))
                            (2 2 (:TYPE-PRESCRIPTION MEMBER-EQUAL)))
(AUTOHIDE-TERM-LIST-LEN (76 38 (:REWRITE DEFAULT-+-2))
...
(LAMBDA-HEADER-P)
(PSEUDO-TERMP-OF-CONS (192 192 (:REWRITE DEFAULT-CDR))
...
(AUTOHIDE-EV-OF-DISJOIN2 (27 21 (:REWRITE AUTOHIDE-EV-CONSTRAINT-9))
                         (18 18 (:REWRITE AUTOHIDE-EV-CONSTRAINT-3))
                         (13 13 (:REWRITE DEFAULT-CDR))
                         (13 13 (:REWRITE DEFAULT-CAR))
                         (12 12 (:REWRITE AUTOHIDE-EV-CONSTRAINT-1)))
(AUTOHIDE-EV-OF-DISJOIN (71 71 (:REWRITE DEFAULT-CDR))
...
(AUTOHIDE-EV-OF-ARBITRARY-FUNCTION (26 18 (:REWRITE DEFAULT-CAR))
...
(AUTOHIDE-CP)
(AUTOHIDE-CP-CORRECT (12 12 (:REWRITE DEFAULT-CDR))
