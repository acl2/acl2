...
(TERM-PATTERNP)
(TERM-PATTERN-MATCH)
(TERM-PATTERN-MATCH-FLAG (4 2 (:TYPE-PRESCRIPTION RETURN-LAST))
                         (2 2
...
(FLAG-LEMMA-FOR-TERM-PATTERN-MATCH-FLAG-ALISTP
     ...
     (8 8
        (:TYPE-PRESCRIPTION TERM-PATTERN-MATCH-LIST)))
(TERM-PATTERN-MATCH-ALISTP)
(TERM-PATTERN-MATCH-LIST-ALISTP)
(TERM-PATTERN-MATCH (25 25 (:REWRITE DEFAULT-CAR))
...
(FLAG-LEMMA-FOR-TERM-PATTERN-MATCH-FLAG-PSEUDO-TERM-SUBSTP
     ...
     (56 56
         (:TYPE-PRESCRIPTION TERM-PATTERN-MATCH))
     (47 43
...
(MATCH-TERM-PATTERN (2 2 (:REWRITE DEFAULT-CAR))
...
(PSEUDO-TERM-SUBSTP-MATCH-TERM-PATTERN
     ...
     (4 4
        (:TYPE-PRESCRIPTION MATCH-TERM-PATTERN)))
(TERM-MATCHES)
