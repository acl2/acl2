...
(PK-INDUCTION (3 2 (:REWRITE DEFAULT-<-1))
              (2 2 (:REWRITE DEFAULT-<-2))
              (1 1 (:REWRITE ZP-OPEN)))
(PK-0)
(PK-HOLDS (4 4 (:REWRITE ZP-OPEN))
...
(Q-PARAMS)
(K-PARAMS-BADGUY)
(OPEN-K-PARAMS (55 25 (:REWRITE ZP-OPEN))
...
(Q-PARAMS-HOLDS-1 (467 347 (:REWRITE DEFAULT-+-2))
...
(Q-PARAMS-HOLDS-2 (929 663 (:REWRITE DEFAULT-+-2))
...
(Q-PARAMS-HOLDS-3 (144 144 (:REWRITE DEFAULT-<-2))
...
(Q-PARAMS-HOLDS-4 (67 67 (:REWRITE DEFAULT-<-2))
