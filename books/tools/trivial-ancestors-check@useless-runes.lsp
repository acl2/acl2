...
(CHECK-ASSUMED-TRUE-OR-FALSE-OK (149 146 (:REWRITE DEFAULT-CAR))
                                (38 36 (:REWRITE DEFAULT-CDR)))
(TRIVIAL-ANCESTORS-CHECK (381 381 (:REWRITE DEFAULT-CDR))
...
(TRIVIAL-ANCESTORS-CHECK-OK (12 3 (:DEFINITION STRIP-ANCESTOR-LITERALS))
