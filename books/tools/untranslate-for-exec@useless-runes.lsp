(UTE-TERM-P (790 336 (:REWRITE DEFAULT-+-2))
            (482 336 (:REWRITE DEFAULT-+-1))
...
(UTE-TERM-P-FLAG (790 336 (:REWRITE DEFAULT-+-2))
                 (482 336 (:REWRITE DEFAULT-+-1))
                 (269 264 (:REWRITE DEFAULT-CDR))
                 (229 197 (:REWRITE DEFAULT-CAR))
                 (197 197 (:REWRITE CAR-WHEN-ALL-EQUALP))
...
(UTE-TERMLIST-P-WHEN-ATOM (2 1
                             (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
                          (1 1 (:TYPE-PRESCRIPTION TRUE-LISTP))
                          (1 1 (:REWRITE CONSP-BY-LEN)))
(UTE-TERMLIST-P-OF-CONS (230 2 (:DEFINITION UTE-TERM-P))
                        (90 45
                            (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
...
(UTE-TERMLIST-P-OF-CDR-WHEN-UTE-TERMLIST-P
     ...
     (6 3
        (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
     (5 1
        (:REWRITE UTE-TERM-P-OF-CAR-WHEN-UTE-TERMLIST-P))
...
(UTE-TERMLIST-P-OF-REV
     ...
     (318 21
          (:REWRITE UTE-TERM-P-OF-CAR-WHEN-UTE-TERMLIST-P))
     (223 35
          (:REWRITE UTE-TERMLIST-P-OF-CDR-WHEN-UTE-TERMLIST-P))
...
(MATCH-CONS-NEST-AUX (266 210 (:REWRITE DEFAULT-CDR))
...
(UTE-TERMLIST-P-OF-MATCH-CONS-NEST.ARGS
     ...
     (1 1 (:REWRITE CONSP-OF-CDR-BY-LEN)))
(SYMBOL-LISTP-OF-BUTLAST (268 17 (:REWRITE TAKE-OF-TOO-MANY))
...
(ACL2-COUNT-OF-PATMATCH-MV-STYLE-LAMBDA-NEW-BODY
     (1178 393 (:REWRITE DEFAULT-+-2))
     (580 393 (:REWRITE DEFAULT-+-1))
     (379 174
          (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
...
(CONVERT-SUBEXPRESSION-TO-MV
     (1256 565 (:REWRITE DEFAULT-+-2))
     (798 565 (:REWRITE DEFAULT-+-1))
     (609 609 (:REWRITE CAR-WHEN-ALL-EQUALP))
     (504 126 (:DEFINITION INTEGER-ABS))
     (471 3
          (:DEFINITION CONVERT-SUBEXPRESSION-TO-MV))
     ...
     (6 6 (:TYPE-PRESCRIPTION MEMBER-EQUAL))
     (3 3
        (:TYPE-PRESCRIPTION BOOLEANP-OF-MATCH-CONS-NEST.MATCHP))
     (3 3 (:REWRITE SUBSETP-MEMBER . 2))
     (3 3 (:REWRITE SUBSETP-MEMBER . 1))
     (3 3
        (:REWRITE MEMBER-EQUAL-WHEN-ALL-EQUALP)))
(UTE-TERM-P-OF-CONVERT-SUBEXPRESSION-TO-MV.NEW-X
     ...
     (5616 1985
           (:REWRITE UTE-TERMLIST-P-WHEN-ATOM))
...
(REINCARNATE-MVS (1049 477 (:REWRITE DEFAULT-+-2))
                 (682 477 (:REWRITE DEFAULT-+-1))
...
(REINCARNATE-MVS-FLAG (1049 477 (:REWRITE DEFAULT-+-2))
                      (682 477 (:REWRITE DEFAULT-+-1))
                      (440 110 (:DEFINITION INTEGER-ABS))
                      (385 55 (:DEFINITION LENGTH))
                      (359 152
