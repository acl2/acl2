...
(MATCH-TREE)
(SYMBOL-ALISTP-MATCH-TREE (198 186 (:REWRITE DEFAULT-CAR))
                          (153 126 (:REWRITE DEFAULT-CDR)))
(MATCH-TREE (34 34 (:REWRITE DEFAULT-CAR))
            ...
            (1 1 (:REWRITE DEFAULT-+-1)))
(ASSOC-IN-MATCH-TREE (153 147 (:REWRITE DEFAULT-CAR))
                     (86 74 (:REWRITE DEFAULT-CDR)))
(SUBST-TREE)
(MATCH-TREE-BINDERS (1 1 (:TYPE-PRESCRIPTION TRUE-LISTP)))
...
(MATCH-TREE-BINDERS-BOUND (540 490 (:REWRITE DEFAULT-CAR))
...
(MATCH-TREE-ALL-BINDERS-BOUND
     ...
     (44 44
         (:TYPE-PRESCRIPTION MATCH-TREE-BINDERS))
     (19 19
         (:TYPE-PRESCRIPTION MATCH-TREE-BINDER-P))
     (15 3 (:REWRITE ASSOC-IN-MATCH-TREE))
     (9 9
        (:TYPE-PRESCRIPTION MATCH-TREE-CHECK-BINDING)))
(KEYS-SUBSET-OF-APPEND (135 126 (:REWRITE DEFAULT-CAR))
...
(SUBST-TREE-WHEN-ALL-BINDERS-BOUND
     ...
     (9 9
        (:TYPE-PRESCRIPTION MATCH-TREE-CHECK-BINDING)))
(SUBSETP-WHEN-SUBSETP-OF-CDR (50 50 (:REWRITE DEFAULT-CAR))
                             (2 2 (:REWRITE CDR-CONS))
                             (2 2 (:REWRITE CAR-CONS)))
(SUBSETP-REFL (16 16 (:REWRITE DEFAULT-CAR)))
(MATCH-TREE-IS-SUBST-TREE (1107 515 (:REWRITE DEFAULT-CDR))
                          ...
                          (40 20
                              (:REWRITE SUBSETP-WHEN-SUBSETP-OF-CDR))
                          (8 1 (:DEFINITION SYMBOL-ALISTP))
                          (5 5 (:TYPE-PRESCRIPTION SYMBOL-ALISTP)))
(MATCH-TREE-!VARS)
(MATCH-TREE-INITIAL-ALIST-LST)
(MATCH-TREE-INITIAL-ALIST-TERM)
(PREFIX-?-VARS (2 2 (:REWRITE DEFAULT-CAR))
               (1 1 (:REWRITE DEFAULT-CDR)))
(TREEMATCH-FN)
(TREEMATCH*-FN)
(MATCH-TREE-RESTRICTIONS (1 1 (:TYPE-PRESCRIPTION TRUE-LISTP)))
...
(MATCH-TREE-RESTRICTIONS-OF-LOOKUP
     ...
     (184 13
          (:REWRITE MATCH-TREE-RESTRICTIONS-OF-LOOKUP-LEMMA))
...
(SYMBOLP-BY-MATCH-TREE-RESTRICTIONS
     ...
     (171 3
          (:REWRITE MATCH-TREE-RESTRICTIONS-OF-LOOKUP-LEMMA))
     (144 16
          (:DEFINITION MATCH-TREE-RESTRICTIONS))
     (130 26 (:DEFINITION BINARY-APPEND))
     (110 10 (:DEFINITION MATCH-TREE-BINDERS))
     (60 60
         (:TYPE-PRESCRIPTION MATCH-TREE-BINDERS))
...
(NOT-QUOTE-BY-MATCH-TREE-RESTRICTIONS
     ...
     (48 2
         (:DEFINITION MATCH-TREE-CHECK-BINDING))
     (42 42
         (:TYPE-PRESCRIPTION MATCH-TREE-BINDERS))
...
(NOT-NIL-BY-MATCH-TREE-RESTRICTIONS
     ...
     (14 14
         (:TYPE-PRESCRIPTION MATCH-TREE-BINDER-P)))
(MATCH-TREE-MEASURE-WEAK (1481 681 (:REWRITE DEFAULT-CDR))
...
(MATCH-TREE-MEASURE-STRONG (3696 1848 (:REWRITE DEFAULT-+-2))
...
(REPLACE-EQUALITIES-THM-FNSYM (23 23 (:REWRITE DEFAULT-CAR))
...
(MATCH-TREE-RW-FNAME)
(MATCH-TREE-REWRITES-VAR-FN (1 1
                               (:TYPE-PRESCRIPTION MATCH-TREE-RW-FNAME)))
...
(BAR (14 14 (:REWRITE DEFAULT-CAR))
     (12 2 (:DEFINITION ASSOC-EQUAL))
     (8 1 (:REWRITE ASSOC-IN-MATCH-TREE))
     (5 5 (:REWRITE DEFAULT-CDR)))
(BAZ (14 14 (:REWRITE DEFAULT-CAR))
     (12 2 (:DEFINITION ASSOC-EQUAL))
     (8 1 (:REWRITE ASSOC-IN-MATCH-TREE))
     (5 5 (:REWRITE DEFAULT-CDR)))
(BAR-ACL2-COUNT-WEAK (204 4 (:DEFINITION ACL2-COUNT))
...
(BAR-ACL2-COUNT-STRONG (204 4 (:DEFINITION ACL2-COUNT))
                       (64 32 (:REWRITE DEFAULT-+-2))
                       (44 32 (:REWRITE DEFAULT-+-1))
                       (39 17 (:REWRITE DEFAULT-CDR))
                       (32 8 (:REWRITE COMMUTATIVITY-OF-+))
                       ...
                       (2 2 (:TYPE-PRESCRIPTION SYMBOL-ALISTP))
                       (2 2 (:TYPE-PRESCRIPTION MEMBER-EQUAL)))
(BAZ-ACL2-COUNT-WEAK (204 4 (:DEFINITION ACL2-COUNT))
                     (64 32 (:REWRITE DEFAULT-+-2))
                     (44 32 (:REWRITE DEFAULT-+-1))
                     (39 17 (:REWRITE DEFAULT-CDR))
                     (32 8 (:REWRITE COMMUTATIVITY-OF-+))
                     ...
                     (2 2 (:TYPE-PRESCRIPTION SYMBOL-ALISTP))
                     (2 2 (:TYPE-PRESCRIPTION MEMBER-EQUAL)))
(BAZ-ACL2-COUNT-STRONG (204 4 (:DEFINITION ACL2-COUNT))
                       (64 32 (:REWRITE DEFAULT-+-2))
                       (44 32 (:REWRITE DEFAULT-+-1))
                       (39 17 (:REWRITE DEFAULT-CDR))
                       (32 8 (:REWRITE COMMUTATIVITY-OF-+))
...
(BAZ-TYPE (15 4 (:REWRITE DEFAULT-CDR))
          (12 2 (:DEFINITION ASSOC-EQUAL))
...
(BAR-RW)
(BAZ-RW)
(FOOIF->BAR (14 14 (:REWRITE DEFAULT-CAR))
            (12 2 (:DEFINITION ASSOC-EQUAL))
            (8 1 (:REWRITE ASSOC-IN-MATCH-TREE))
            (5 5 (:REWRITE DEFAULT-CDR)))
(FOOIF->BAZ (14 14 (:REWRITE DEFAULT-CAR))
            (12 2 (:DEFINITION ASSOC-EQUAL))
            (8 1 (:REWRITE ASSOC-IN-MATCH-TREE))
            (5 5 (:REWRITE DEFAULT-CDR)))
(FOOIF->BAR-ACL2-COUNT-WEAK (204 4 (:DEFINITION ACL2-COUNT))
                            (64 32 (:REWRITE DEFAULT-+-2))
                            (44 32 (:REWRITE DEFAULT-+-1))
                            (32 8 (:REWRITE COMMUTATIVITY-OF-+))
                            (32 8 (:DEFINITION INTEGER-ABS))
...
(FOOIF->BAR-ACL2-COUNT-STRONG (204 4 (:DEFINITION ACL2-COUNT))
                              (64 32 (:REWRITE DEFAULT-+-2))
                              (44 32 (:REWRITE DEFAULT-+-1))
                              (32 8 (:REWRITE COMMUTATIVITY-OF-+))
                              (32 8 (:DEFINITION INTEGER-ABS))
                              ...
                              (2 2 (:REWRITE CAR-CONS))
                              (1 1 (:REWRITE CDR-CONS)))
(FOOIF->BAZ-ACL2-COUNT-WEAK (204 4 (:DEFINITION ACL2-COUNT))
                            (64 32 (:REWRITE DEFAULT-+-2))
                            (44 32 (:REWRITE DEFAULT-+-1))
                            (32 8 (:REWRITE COMMUTATIVITY-OF-+))
                            (32 8 (:DEFINITION INTEGER-ABS))
                            ...
                            (2 2 (:REWRITE CAR-CONS))
                            (1 1 (:REWRITE CDR-CONS)))
(FOOIF->BAZ-ACL2-COUNT-STRONG (204 4 (:DEFINITION ACL2-COUNT))
                              (64 32 (:REWRITE DEFAULT-+-2))
                              (44 32 (:REWRITE DEFAULT-+-1))
                              (32 8 (:REWRITE COMMUTATIVITY-OF-+))
                              (32 8 (:DEFINITION INTEGER-ABS))
...
(FOOIF->BAZ-TYPE (12 2 (:DEFINITION ASSOC-EQUAL))
                 (8 1 (:REWRITE ASSOC-IN-MATCH-TREE))
