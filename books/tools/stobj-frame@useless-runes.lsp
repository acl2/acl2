...
(DEF-STOBJ-FRAME-FN)
(BAZ-TO-BAR)
(NTH-FOO-OF-BAZ-TO-BAR (66 4 (:REWRITE NTH-WITH-LARGE-INDEX))
                       (20 4 (:DEFINITION LEN))
...
(BAZ-TO-BAR-FOO-FRAME (64 3 (:REWRITE NTH-WITH-LARGE-INDEX))
...
(NTH-FOO-OF-BAZ-TO-BAR-RETURN-BIZ (96 6 (:REWRITE NTH-WITH-LARGE-INDEX))
                                  (30 6 (:DEFINITION LEN))
...
(BAZ-TO-BAR-RETURN-BIZ-FOO-FRAME-0 (396 18 (:REWRITE NTH-WITH-LARGE-INDEX))
