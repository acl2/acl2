...
(FROM-TO-BY-NORMALIZER
 ...
 (173309 173309 (:TYPE-PRESCRIPTION NOT-INTEGERP-3B))
 (173309 173309 (:TYPE-PRESCRIPTION NOT-INTEGERP-2B))
 (173309 173309 (:TYPE-PRESCRIPTION NOT-INTEGERP-1B))
 (119470 5705 (:REWRITE |(< (- x) c)|))
 (116878 37234 (:TYPE-PRESCRIPTION MOD-ZERO . 2))
 (116618 37234 (:TYPE-PRESCRIPTION MOD-NEGATIVE . 2))
 ...
 (37234 37234 (:TYPE-PRESCRIPTION MOD-NEGATIVE . 1))
 (36885 36885 (:TYPE-PRESCRIPTION MOD-NONPOSITIVE))
 (36885 36885 (:TYPE-PRESCRIPTION INTEGERP-MOD-2))
 ...
 (23058 5892 (:REWRITE REDUCE-ADDITIVE-CONSTANT-<))
 (22112 553 (:REWRITE SIMPLIFY-SUMS-EQUAL))
 (20332 20332 (:TYPE-PRESCRIPTION MOD-POSITIVE . 1))
 ...
 (16320 576 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
 (13632 576 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
 ...
 (9636 645 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-EQUAL))
 ...
 (5892 5892 (:REWRITE REDUCE-RATIONAL-MULTIPLICATIVE-CONSTANT-<))
 (5892 5892 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-<))
 (5852 5376 (:REWRITE REMOVE-STRICT-INEQUALITIES))
 (5818 5818 (:REWRITE |(< c (/ x)) positive c --- present in goal|))
 (5818 5818 (:REWRITE |(< c (/ x)) positive c --- obj t or nil|))
 (5818 5818 (:REWRITE |(< c (/ x)) negative c --- present in goal|))
 (5818 5818 (:REWRITE |(< c (/ x)) negative c --- obj t or nil|))
 (5818 5818 (:REWRITE |(< (/ x) c) positive c --- present in goal|))
 (5818 5818 (:REWRITE |(< (/ x) c) positive c --- obj t or nil|))
 (5818 5818 (:REWRITE |(< (/ x) c) negative c --- present in goal|))
 (5818 5818 (:REWRITE |(< (/ x) c) negative c --- obj t or nil|))
 ...
 (1425 1257 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-<-0-RATIONAL-REMAINDER))
 (1425 1257 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-<-0-RATIONAL-COMMON))
 ...
 (1287 167 (:REWRITE |(floor (* x (/ y)) z) rewriting-goal-literal|))
 (1088 1088 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-REMAINDER))
 (1088 1088 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-COMMON))
...
(FROM-TO-BY-AC=FROM-TO-BY
 ...
 (2228 2228 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-REMAINDER))
 (2228 2228 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-COMMON))
