(BADGE-TYPE (117 1 (:DEFINITION APPLY$-BADGEP))
...
(SUITABLY-TAMEP-LISTP-IMPLICANT-1 (24 24 (:REWRITE DEFAULT-CAR))
...
(LEN-EV$-LIST (150 1 (:DEFINITION EV$))
...
(COUNT-TO-NIL)
(EXECUTABLE-BADGE)
(EXECUTABLE-TAMEP (1672 724 (:REWRITE DEFAULT-+-2))
                  (1013 724 (:REWRITE DEFAULT-+-1))
                  (480 120 (:DEFINITION INTEGER-ABS))
                  (480 60 (:DEFINITION LENGTH))
                  (345 18 (:REWRITE O<=-O-FINP-DEF))
                  (300 60 (:DEFINITION LEN))
                  (201 151 (:REWRITE DEFAULT-<-2))
                  (182 151 (:REWRITE DEFAULT-<-1))
                  (180 44 (:REWRITE O-P-O-INFP-CAR))
...
(FIND-BADGE-ILK)
(CHECK-ILKS)
(CHECKER (507 246 (:REWRITE DEFAULT-+-2))
...
(BADGE-TABLE-OKP)
(APPLY$-BADGEP-HONS-GET-LEMMA (7340 66 (:REWRITE TAMEP-IMPLICANT-1))
...
(APPLY$-BADGEP-EXECUTABLE-BADGE-LEMMA
     ...
     (26 26 (:REWRITE DEFAULT-<-1)))
(APPLY$-BADGEP-EXECUTABLE-BADGE (1144 496 (:REWRITE DEFAULT-CDR))
...
(FLAG-LEMMA-FOR-GUESS-ILKS-ALIST-CORRECT
     ...
     (733 733
          (:REWRITE GUESS-ILKS-ALIST-LIST-LEMMA))
     (553 553
          (:REWRITE ARITIES-OKP-IMPLIES-ARITY)))
...
(FN-EQUAL-IMPLIES-EQUAL-APPLY$-1
     ...
     (2 2
        (:REWRITE APPLY$-EQUIVALENCE-NECC-REWRITER)))
