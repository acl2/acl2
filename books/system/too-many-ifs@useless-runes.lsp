...
(SIGNED-BYTE-P-30-OCCUR-CNT-BOUNDED-FLG-TERM
 (4 4 (:TYPE-PRESCRIPTION OCCUR-CNT-BOUNDED))
 (4 4 (:TYPE-PRESCRIPTION INTEGERP-OCCUR-CNT-BOUNDED-TERM))
 )
(SIGNED-BYTE-P-30-OCCUR-CNT-BOUNDED-FLG-LIST
 (4 4 (:TYPE-PRESCRIPTION OCCUR-CNT-BOUNDED-LST))
 (4 4 (:TYPE-PRESCRIPTION INTEGERP-OCCUR-CNT-BOUNDED-LIST))
 )
