(MAKE-REVERSED-AD-LIST (396 196 (:REWRITE DEFAULT-+-2))
...
(CAR-CDR-ABBREV-NAME)
(PRETTY-PARSE-AD-LIST (526 262 (:REWRITE DEFAULT-+-2))
...
(EVAD-CONSTRAINT-14)
(EVAD-CONSTRAINT-15)
(ENUMERATE-DR-LISTPS (50 50 (:META CANCEL_TIMES-EQUAL-CORRECT))
...
(ENUMERATE-ADR-LISTPS (191 191 (:REWRITE DEFAULT-CAR))
...
(REV)
(EVAD-LIST-CAR-CDR-ABBREV-NAME (243 243 (:REWRITE DEFAULT-CAR))
...
(EQUAL-EVAD-COMPOSE-AD (620 620 (:TYPE-PRESCRIPTION COMPOSE-AD))
...
(COMPOSE-AC-APPEND (84 69 (:REWRITE DEFAULT-CDR))
...
(MAKE-REVERSED-AD-LIST-SPEC (985 985 (:TYPE-PRESCRIPTION COMPOSE-AD))
...
(DR-LISTP-LEN-1-REV (134 101 (:REWRITE DEFAULT-CDR))
...
(EVAD-PRETTY-PARSE-AD-LIST-HINT (526 262 (:REWRITE DEFAULT-+-2))
                                (352 262 (:REWRITE DEFAULT-+-1))
                                (280 56 (:DEFINITION INTEGER-ABS))
                                (224 56 (:REWRITE COMMUTATIVITY-OF-+))
                                (224 28 (:DEFINITION LENGTH))
                                ...
                                (4 4 (:META CANCEL_TIMES-EQUAL-CORRECT))
                                (4 4 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(EVAD-PRETTY-PARSE-AD-LIST (808 808
                                (:TYPE-PRESCRIPTION PRETTY-PARSE-AD-LIST))
...
(COMPOSE-D-LEMMA2 (299 299 (:TYPE-PRESCRIPTION COMPOSE-D))
                  ...
                  (2 1 (:DEFINITION FIX)))
(REV-DR-LIST-IS-NO-OP (38 38 (:TYPE-PRESCRIPTION COMPOSE-AD))
...
(PRETTY-PARSE-AD-LIST-SPEC (1345 1345 (:TYPE-PRESCRIPTION COMPOSE-AD))
                           ...
                           (56 56
                               (:TYPE-PRESCRIPTION CAR-CDR-ABBREV-NAME))
