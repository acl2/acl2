(MAKE-REVERSED-AD-LIST
 (1394 8 (:REWRITE O<=-O-FINP-DEF))
 (1150 20 (:LINEAR ACL2-COUNT-CAR-CDR-LINEAR))
 (738 366 (:REWRITE DEFAULT-+-2))
 (482 366 (:REWRITE DEFAULT-+-1))
 (380 76 (:DEFINITION INTEGER-ABS))
 (304 76 (:REWRITE COMMUTATIVITY-OF-+))
 (304 38 (:DEFINITION LENGTH))
 (216 92 (:META CANCEL_PLUS-LESSP-CORRECT))
