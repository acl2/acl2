...
(ST{IMPL}$CORR)
(CREATE-ST$A)
(CREATE-ST{IMPL}{CORRESPONDENCE})
(CREATE-ST{IMPL}{PRESERVED})
(MISC{IMPL}{CORRESPONDENCE})
(UPDATE-MISC{IMPL}{CORRESPONDENCE}-LEMMA
...
(UPDATE-MISC{IMPL}{CORRESPONDENCE}
