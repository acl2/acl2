...
(APPLY$-SSQ (4 2 (:REWRITE DEFAULT-SYMBOL-NAME))
            ...
            (2 1 (:REWRITE APPLY$-PRIMP-BADGE))
            (2 1 (:REWRITE APPLY$-PRIMITIVE)))
(FOO (2296 2 (:DEFINITION MEMBER-EQUAL))
...
(TEST)
(TEST (56461 290 (:DEFINITION APPLY$-BADGEP))
      ...
      (4999 455
            (:DEFINITION FROM-TO-BY-DOWN-OPENER))
...
(BOOHOO (8414 37 (:DEFINITION MEMBER-EQUAL))
...
(BUG1 (288 39 (:REWRITE APPLY$-PRIMITIVE))
      ...
      (2 2
         (:REWRITE SYMBOL-LISTP-IMPLIES-SYMBOLP)))
(BUG2 (3449 4 (:DEFINITION MEMBER-EQUAL))
