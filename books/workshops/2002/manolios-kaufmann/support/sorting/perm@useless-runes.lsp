...
(PERM-IMPLIES-PERM-APPEND-2 (168 84
                                 (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
                            ...
                            (72 72 (:TYPE-PRESCRIPTION IN))
                            (72 6 (:REWRITE PERM-REMOVE-EL-APP))
                            (41 14 (:REWRITE CAR-PERM)))
...
(PERM-IMPLIES-EQUAL-IN-2 (167 21 (:REWRITE PERM-SYMMETRIC))
                         (61 61 (:REWRITE DEFAULT-CAR))
                         (42 42 (:REWRITE DEFAULT-CDR))
                         (40 8 (:DEFINITION REMOVE-EL))
                         (21 21 (:REWRITE PERM-TRANSITIVE))
                         (8 8 (:REWRITE CAR-PERM)))
