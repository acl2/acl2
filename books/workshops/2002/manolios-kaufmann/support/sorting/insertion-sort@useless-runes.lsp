(INSERT)
(ISORT)
(ORDERED-INSERT (1112 101 (:REWRITE <<-IMPLIES-LEXORDER))
...
(PERM-INSERT (414 35 (:REWRITE <<-IMPLIES-LEXORDER))
...
(INSERT-INSERT (1069 92 (:REWRITE <<-IMPLIES-LEXORDER))
...
(INSERT-IN (534 45 (:REWRITE <<-IMPLIES-LEXORDER))
           ...
           (1 1 (:REWRITE <<-IRREFLEXIVE)))
(INSERT-SORT-REMOVE (1363 65 (:DEFINITION INSERT))
                    (910 65 (:DEFINITION <<=))
...
(SORT-CANONICAL (630 30 (:DEFINITION INSERT))
                (420 30 (:DEFINITION <<=))
...
(MAIN (226 28 (:REWRITE PERM-SYMMETRIC))
...
(MAIN2 (162 14 (:REWRITE <<-IMPLIES-LEXORDER))
       ...
       (1 1 (:REWRITE <<-IRREFLEXIVE)))
(MAIN3 (48 4 (:REWRITE <<-IMPLIES-LEXORDER))
