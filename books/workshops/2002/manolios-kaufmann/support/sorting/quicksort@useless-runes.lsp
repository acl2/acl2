...
(LESSP)
(NOTLESSP)
(PERM-LESS-NOTLESS (142 44 (:REWRITE <<-TRICHOTOMY))
...
(PERM-QSORT (180 6 (:DEFINITION NOTLESS))
...
(PERM-IMPLIES-EQUAL-NOTLESSP-2 (1511 422 (:REWRITE <<-TRICHOTOMY))
                               (1348 252 (:REWRITE <<-ASYMMETRIC))
...
(ORDEREDP-LEMMA (2636 465 (:REWRITE <<-TRICHOTOMY))
                (1215 223 (:REWRITE <<-ASYMMETRIC))
                (465 465 (:REWRITE <<-TRANSITIVE))
                (277 178 (:REWRITE DEFAULT-CDR))
                (18 18 (:REWRITE <<-IRREFLEXIVE)))
(QSORT-IS-ORDERED (146 38 (:REWRITE <<-TRICHOTOMY))
