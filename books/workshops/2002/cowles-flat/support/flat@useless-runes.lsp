...
(FLAT::$F$1-$<=$-$F$2)
(FLAT::$F$1-$<=$-$F$2-A)
(FLAT::$F$1-$<=$-$F$2-B (1 1 (:REWRITE FLAT::$F$1-$<=$-$F$2-A)))
(FLAT::$F$1-$<=$-$F$2-C (7 5 (:REWRITE FLAT::$F$1-$<=$-$F$2-A)))
(FLAT::F$1)
(FLAT::UB-F$1)
(FLAT::F$1-$<=$-UB-F$1)
(FLAT::F$1-$<=$-UB-F$1-A)
(FLAT::F$1-$<=$-UB-F$1-B (1 1 (:REWRITE FLAT::F$1-$<=$-UB-F$1-A)))
(FLAT::F$1-$<=$-UB-F$1-C (6 4 (:REWRITE FLAT::F$1-$<=$-UB-F$1-A)))
...
(FLAT::$BOTTOM$-BASED-CHAIN-IS-$<=$-CHAIN-B
     (11 2
         (:REWRITE FLAT::BASE-OF-$BOTTOM$-BASED-CHAIN=$BOTTOM$))
     (6 2 (:REWRITE ZP-OPEN))
...
(FLAT::$BOTTOM$-BASED-CHAIN-IS-$<=$-CHAIN-C
     ...
     (2 2 (:REWRITE DEFAULT-<-1))
     (2 2
        (:REWRITE FLAT::$BOTTOM$-BASED-CHAIN-IS-$<=$-CHAIN-B))
     (1 1 (:REWRITE DEFAULT-+-2))
     (1 1 (:REWRITE DEFAULT-+-1))
     (1 1
        (:REWRITE FLAT::$BOTTOM$-BASED-CHAIN-I>0)))
...
(FLAT::LUB-$BOTTOM$-BASED-CHAIN-IS-UPPER-BOUND
     ...
     (30 30
         (:TYPE-PRESCRIPTION FLAT::LUB-$BOTTOM$-BASED-CHAIN-NAT-I))
...
(FLAT::UB-CHAIN$)
(FLAT::UB-CHAIN$-IS-UPPER-BOUND (1 1 (:REWRITE DEFAULT-<-2))
                                (1 1 (:REWRITE DEFAULT-<-1)))
...
(FLAT::SHIFTED$-CHAIN-REWRITE
     (25 4
         (:REWRITE FLAT::LUB-$BOTTOM$-BASED-CHAIN-NAT-I-REWRITE))
     (23 4
         (:REWRITE FLAT::BASE-OF-$BOTTOM$-BASED-CHAIN=$BOTTOM$))
     ...
     (5 2
        (:REWRITE FLAT::$BOTTOM$-BASED-CHAIN-IS-$<=$-CHAIN-C))
     (4 4
        (:REWRITE FLAT::$BOTTOM$-BASED-CHAIN-IS-$<=$-CHAIN-B))
...
(FLAT::LUB-$BOTTOM$-BASED-CHAIN-IS-UPPER-BOUND-OF-SHIFTED$-CHAIN
     ...
     (1 1 (:REWRITE DEFAULT-+-1))
     (1 1
        (:REWRITE FLAT::$BOTTOM$-BASED-CHAIN-IS-$<=$-CHAIN-F)))
...
(FLAT::SHIFTED-$CHAIN$-IS-$<=$-CHAIN
     ...
     (6 6
        (:REWRITE FLAT::BASE-OF-$CHAIN$=$BOTTOM$))
     (3 3 (:REWRITE DEFAULT-<-2))
     (3 3 (:REWRITE DEFAULT-<-1)))
(FLAT::LUB-$CHAIN$-I-REWRITE (14 2
                                 (:REWRITE FLAT::BASE-OF-$CHAIN$=$BOTTOM$))
                             (9 2 (:REWRITE ZP-OPEN))
                             (3 3 (:TYPE-PRESCRIPTION ZP))
                             (2 2 (:REWRITE DEFAULT-<-2))
...
(FLAT::SHIFTED-$CHAIN$+$BOTTOM$-BASE-REWRITE
     (24 4
         (:REWRITE FLAT::LUB-$CHAIN$-I-REWRITE))
     (22 4
         (:REWRITE FLAT::BASE-OF-$CHAIN$=$BOTTOM$))
...
(FLAT::LUB-MONO-CHAIN$-IS-UPPER-BOUND
     ...
     (5 5
        (:REWRITE FLAT::$BOTTOM$-BASED-CHAIN-I>0)))
(FLAT::UB-MONO-CHAIN$)
(FLAT::UB-MONO-CHAIN$-IS-UPPER-BOUND (1 1 (:REWRITE DEFAULT-<-2))
                                     (1 1 (:REWRITE DEFAULT-<-1)))
(FLAT::LUB-MONO-CHAIN$-IS-LEAST-UPPER-BOUND (1 1 (:REWRITE DEFAULT-<-2))
                                            (1 1 (:REWRITE DEFAULT-<-1)))
(FLAT::MONO-CHAIN$+$BOTTOM$-BASE-IS-$<=$-CHAIN
     (22 6
         (:REWRITE FLAT::LUB-MONO-CHAIN$-I-REWRITE))
...
(FLAT::MONO-CHAIN$+$BOTTOM$-BASE-IS-CHAIN-OF-MONOTONIC-FNS
     ...
     (53 8
         (:REWRITE FLAT::MONO-CHAIN$+$BOTTOM$-BASE=$BOTTOM$))
