...
(NATURAL-TO-STRING (156 4
                   ...
                   (4 4 (:DEFINITION IFIX))
                   (4 4 (:DEFINITION FIX)))
(EXPLORE_RIGHT_EXPR (751 352 (:REWRITE DEFAULT-+-2))
...
(ARRAY-BITP1 (6 6
                (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(BINDING?)
(SEQ-FN+ (91 91 (:REWRITE DEFAULT-CAR))
...
(SETARRAYI)
(GETARRAYI)
(CHANGE-STATE (153 71 (:REWRITE DEFAULT-+-2))
...
(UPDATE-STATE-BODY (153 71 (:REWRITE DEFAULT-+-2))
                   (99 71 (:REWRITE DEFAULT-+-1))
                   (56 14 (:REWRITE COMMUTATIVITY-OF-+))
                   (56 14 (:DEFINITION INTEGER-ABS))
                   (56 7 (:DEFINITION LENGTH))
...
(APP-FN (4 4
           (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(TOTAL_LENGTH)
(OTHER-FN (16 9 (:REWRITE DEFAULT-<-1))
...
(LEMMA_NTH_UPDATE-NTH1 (123 121 (:REWRITE DEFAULT-+-2))
...
(LEMMA_NTH_UPDATE-NTH2BIS (7 1 (:DEFINITION UPDATE-NTH))
...
(>_NOT_EQUAL)
(B-NOT_B-NOT (2 2 (:REWRITE >_NOT_EQUAL)))
