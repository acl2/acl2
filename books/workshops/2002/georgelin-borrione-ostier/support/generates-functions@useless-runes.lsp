...
(SLICE-REC2 (40 40
            ...
            (2 2
               (:TYPE-PRESCRIPTION MAKE_NAME_VAR_SIG))
...
(ASSIGNMENT (6 6
               (:TYPE-PRESCRIPTION |x < y  =>  0 < y-x|)))
(IF-STATEMENT (730 323 (:REWRITE DEFAULT-+-2))
...
(FIND_LINKS_INPUT)
(FIND_LINKS_OUTPUT)
(SEARCH_INPUT_COMP (25 5
                       (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
                   (14 5 (:TYPE-PRESCRIPTION BINARY-APPEND))
                   (5 5 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(SEARCH_OUTPUT_COMP)
(COMPONENTS-UPDATE-SIGNALS (4 4 (:TYPE-PRESCRIPTION TRUE-LISTP)))
