...
(EMPTY-ASSOC)
(MEASURE-ASSOC)
(O-P-MEASURE-ASSOC (15 1 (:DEFINITION MEASURE-ASSOC))
                   ...
                   (1 1 (:REWRITE DEFAULT-+-1)))
(REDUCT-ASSOC-MEASURE-ASSOC (258 258 (:REWRITE DEFAULT-CDR))
...
(ANOTHER-DEFINITION-COUNT-BAG-EQUAL-ASSOC (320 320 (:REWRITE DEFAULT-CDR))
...
(COUNT-INCLUDE-ASSOC (4689 2912 (:REWRITE DEFAULT-CDR))
...
(MEMBER-BAG-EQUIV-ASSOC (30 2 (:DEFINITION MEASURE-ASSOC))
...
(EQUIV-IMPLIES-IFF-MEMBER-BAG-EQUIV-1-ASSOC
     ...
     (2 2 (:TYPE-PRESCRIPTION MEASURE-ASSOC)))
(REMOVE-ONE-BAG-EQUIV-ASSOC (30 2 (:DEFINITION MEASURE-ASSOC))
                            (28 28 (:REWRITE DEFAULT-CDR))
                            (21 1 (:DEFINITION REDUCT-ASSOC))
                            (20 20 (:REWRITE DEFAULT-CAR))
                            (11 1 (:DEFINITION SELECT-ASSOC))
...
(SUB-BAG-EQUIV-ASSOC (44 44 (:REWRITE DEFAULT-CDR))
                     ...
                     (2 2 (:TYPE-PRESCRIPTION MEASURE-ASSOC)))
(SUB-BAG-EQUIV-REFLEXIVE-ASSOC (490 5
                                    (:DEFINITION REMOVE-ONE-BAG-EQUIV-ASSOC))
...
(EQUAL-BAG-EQUIV-IS-AN-EQUIVALENCE-ASSOC
     ...
     (8 8
        (:REWRITE SUB-BAG-EQUIV-TRANSITIVE-ASSOC))
     (4 4
        (:TYPE-PRESCRIPTION MEMBER-BAG-EQUIV-ASSOC)))
...
(UNION-BAG-EQUIV-ASSOC (30 2 (:DEFINITION MEASURE-ASSOC))
...
(EQUAL-BAG-EQUIV-IMPLIES-EQUAL-BAG-EQUIV-UNION-BAG-EQUIV-1-ASSOC
     ...
     (45 5 (:DEFINITION EMPTY-ASSOC))
     (27 27
         (:TYPE-PRESCRIPTION UNION-BAG-EQUIV-ASSOC))
     (20 20 (:REWRITE DEFAULT-<-2))
     (20 20 (:REWRITE DEFAULT-<-1))
...
(INTER-BAG-EQUIV-ASSOC (30 2 (:DEFINITION MEASURE-ASSOC))
                       (24 24 (:REWRITE DEFAULT-CDR))
                       (21 1 (:DEFINITION REDUCT-ASSOC))
                       (16 16 (:REWRITE DEFAULT-CAR))
                       (9 1 (:DEFINITION EMPTY-ASSOC))
...
(UNIMIN-BAG-EQUIV-ASSOC (30 2 (:DEFINITION MEASURE-ASSOC))
                        (24 24 (:REWRITE DEFAULT-CDR))
                        (21 1 (:DEFINITION REDUCT-ASSOC))
                        (16 16 (:REWRITE DEFAULT-CAR))
                        (9 1 (:DEFINITION EMPTY-ASSOC))
...
(EQUAL-BAG-EQUIV-IMPLIES-EQUAL-BAG-EQUIV-UNIMIN-BAG-EQUIV-1-ASSOC
     ...
     (45 45
         (:TYPE-PRESCRIPTION UNIMIN-BAG-EQUIV-ASSOC)))
...
(DIFF-BAG-EQUIV-ASSOC (30 2 (:DEFINITION MEASURE-ASSOC))
                      (24 24 (:REWRITE DEFAULT-CDR))
                      (21 1 (:DEFINITION REDUCT-ASSOC))
                      (16 16 (:REWRITE DEFAULT-CAR))
                      (9 1 (:DEFINITION EMPTY-ASSOC))
