...
(COUNT-INCLUDE-LIST (14 7 (:REWRITE DEFAULT-+-2))
                    (10 10 (:REWRITE DEFAULT-CDR))
                    (7 7 (:REWRITE DEFAULT-+-1))
                    (5 5 (:REWRITE DEFAULT-CAR)))
(MEMBER-BAG-EQUIV-LIST)
(EQUIV-IMPLIES-IFF-MEMBER-BAG-EQUIV-1-LIST (27 27 (:REWRITE DEFAULT-CDR))
...
(SUB-BAG-EQUIV-LIST)
(SUB-BAG-EQUIV-REFLEXIVE-LIST (25 25 (:REWRITE DEFAULT-CAR))
                              (25 5
                                  (:DEFINITION REMOVE-ONE-BAG-EQUIV-LIST))
...
(EQUAL-BAG-EQUIV-IS-AN-EQUIVALENCE-LIST
     ...
     (8 8
        (:REWRITE SUB-BAG-EQUIV-TRANSITIVE-LIST))
     (4 4
        (:TYPE-PRESCRIPTION MEMBER-BAG-EQUIV-LIST)))
...
(EQUAL-BAG-EQUIV-IMPLIES-EQUAL-BAG-EQUIV-UNION-BAG-EQUIV-1-LIST
     (34 34
         (:TYPE-PRESCRIPTION UNION-BAG-EQUIV-LIST))
...
(EQUAL-BAG-EQUIV-IMPLIES-EQUAL-BAG-EQUIV-UNIMIN-BAG-EQUIV-1-LIST
     (51 51
         (:TYPE-PRESCRIPTION UNIMIN-BAG-EQUIV-LIST))
