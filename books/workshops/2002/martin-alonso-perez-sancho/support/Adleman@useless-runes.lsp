...
(DETECT)
(MEMBER-TUBE-MERGE (73 61 (:REWRITE DEFAULT-CAR))
                   (60 30
                       (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
                   (59 50 (:REWRITE DEFAULT-CDR))
                   (30 30 (:TYPE-PRESCRIPTION TRUE-LISTP))
                   (30 30 (:TYPE-PRESCRIPTION BINARY-APPEND)))
(MEMBER-SEPARATE+ (52 49 (:REWRITE DEFAULT-CAR))
                  (44 41 (:REWRITE DEFAULT-CDR)))
(MEMBER-SEPARATE- (52 49 (:REWRITE DEFAULT-CAR))
                  (44 41 (:REWRITE DEFAULT-CDR)))
(MEMBER-DETECT (2 2 (:REWRITE DEFAULT-CAR)))
(PROP-VARIABLE-P)
(TRUTH-VALUE-P)
(OPPOSITE-VALUE)
(PROP-VARIABLE-VALUE)
...
(MEMBER-CNF-FORMULA (240 6 (:DEFINITION SAT-LIPTON-CLAUSE))
...
(COMPLETENESS-SEPARATE+ (40 40 (:REWRITE DEFAULT-CDR))
                        (36 36 (:REWRITE DEFAULT-CAR))
                        (30 6 (:DEFINITION ASSOC-EQUAL))
                        (14 14
                            (:REWRITE MEMBER-CLAUSE-ACCUMULATOR-NIL))
                        (10 5 (:REWRITE DEFAULT-+-2))
                        (5 5 (:REWRITE DEFAULT-+-1)))
(COMPLETENESS-SAT-LIPTON-CLAUSE (256 256 (:REWRITE DEFAULT-CDR))
...
(COMPLETENESS-SAT-LIPTON-CNF-FORMULA
     ...
     (11 11
         (:TYPE-PRESCRIPTION VARIABLE-AGGREGATE-P))
     (11 11 (:DEFINITION OPPOSITE-VALUE))
     (4 1 (:REWRITE MEMBER-CLAUSE-ACCUMULATOR)))
(SOUNDNESS-SEPARATE+ (41 41 (:REWRITE DEFAULT-CDR))
                     ...
                     (8 8
                        (:REWRITE MEMBER-CLAUSE-ACCUMULATOR-NIL))
                     (5 5 (:REWRITE DEFAULT-+-1)))
(SOUNDNESS-SAT-LIPTON-CLAUSE (259 259 (:REWRITE DEFAULT-CDR))
                             (238 7
                                  (:REWRITE COMPLETENESS-SAT-LIPTON-CLAUSE))
...
(SOUNDNESS-SAT-LIPTON-CNF-FORMULA
     ...
     (170 5
          (:REWRITE COMPLETENESS-SAT-LIPTON-CNF-FORMULA))
...
(NO-DUPLICATESP-CNF-FORMULA-VARIABLES
     ...
     (24 24
         (:REWRITE MEMBER-CLAUSE-ACCUMULATOR-NIL))
     (18 18
         (:TYPE-PRESCRIPTION CLAUSE-VARIABLES))
...
(CLAUSE-HAS-NOT-MARKS (398 396 (:REWRITE DEFAULT-CDR))
                      ...
                      (40 40
                          (:TYPE-PRESCRIPTION VARIABLE-AGGREGATE-P)))
(CNF-FORMULA-HAS-NOT-MARKS (360 3 (:DEFINITION CLAUSE-VARIABLES))
                           (342 12 (:DEFINITION UNION-EQUAL))
...
(MEMBER-APPEND (59 59
               ...
               (48 24
                   (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
               (44 44
                   (:REWRITE ADD-LABELED-SYMBOL-LST-PROPERTIES))
...
(MEMBER-BUILD-TUBE-PROPERTIES (299 297 (:REWRITE DEFAULT-CAR))
...
(NOT-ASSOC-BUILD-TUBE (63 63 (:REWRITE DEFAULT-CAR))
                      ...
                      (12 12
                          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                      (4 4
                         (:TYPE-PRESCRIPTION ADD-LABELED-SYMBOL-LST))
...
(BUILD-TUBE-AGGREGATES-AUX (238 12
                                (:REWRITE VARIABLE-AGGREGATE-P-VALOR-MEMBER))
...
(BUILD-INITIAL-TUBE-CNF-FORMULA-AGGREGATES
     ...
     (1 1
        (:TYPE-PRESCRIPTION VARIABLE-AGGREGATE-P)))
(COMPLETENESS-SAT-LIPTON (552 4 (:DEFINITION CNF-FORMULA-VARIABLES))
                         (480 4 (:DEFINITION CLAUSE-VARIABLES))
                         (456 16 (:DEFINITION UNION-EQUAL))
                         (263 263 (:REWRITE DEFAULT-CAR))
                         (221 2
                              (:REWRITE SOUNDNESS-SAT-LIPTON-CNF-FORMULA))
                         ...
                         (64 8 (:DEFINITION ADD-LABELED-SYMBOL-LST))
                         (62 2
                             (:REWRITE SOUNDNESS-SAT-LIPTON-CLAUSE-ACC-NIL))
                         ...
                         (1 1 (:TYPE-PRESCRIPTION LITERAL-P))
                         (1 1 (:DEFINITION OPPOSITE-VALUE)))
(SOUNDNESS-SAT-LIPTON (414 3 (:DEFINITION CNF-FORMULA-VARIABLES))
                      (360 3 (:DEFINITION CLAUSE-VARIABLES))
                      (342 12 (:DEFINITION UNION-EQUAL))
                      ...
                      (6 6 (:REWRITE CAR-CONS))
                      (5 5
                         (:TYPE-PRESCRIPTION CLAUSE-AGGREGATE-P))
                      (2 2
                         (:TYPE-PRESCRIPTION VARIABLE-AGGREGATE-P))
                      (2 2 (:TYPE-PRESCRIPTION CLAUSE-VALUE))
                      (2 2 (:DEFINITION TRUTH-VALUE-P))
                      ...
                      (1 1 (:DEFINITION OPPOSITE-VALUE)))
(SAT-LIPTON-P)
(SOUNDNESS-SAT-LIPTON-P (181 1 (:REWRITE COMPLETENESS-SAT-LIPTON))
                        ...
                        (5 1 (:DEFINITION BINARY-APPEND))
                        (4 4
                           (:TYPE-PRESCRIPTION CNF-FORMULA-VARIABLES))
                        (4 4 (:DEFINITION ACONS))
...
(AGGREGATE-ASSIG-EQUAL-LITERAL-VALUE
     ...
     (12 12 (:DEFINITION ACONS))
     (9 9
        (:TYPE-PRESCRIPTION BUILD-AGGREGATE-ASSIG))
...
(SUBSETP-UNION-EQUAL (86 83 (:REWRITE DEFAULT-CAR))
...
(AGGREGATE-ASSIG-EQUAL-CNF-FORMULA-VALUE
     ...
     (91 2
         (:REWRITE BUILD-INITIAL-TUBE-CNF-FORMULA-AGGREGATES))
     ...
     (14 7 (:REWRITE DEFAULT-+-2))
     (13 1
         (:REWRITE AGGREGATE-ASSIG-EQUAL-LITERAL-VALUE))
     ...
     (6 6 (:REWRITE CAR-CONS))
     (2 2
        (:TYPE-PRESCRIPTION CNF-FORMULA-AGGREGATE-P))
     (2 2 (:DEFINITION SAT-LIPTON-CNF-FORMULA))
     (2 2
        (:DEFINITION CNF-FORMULA-AGGREGATE-P)))
(MEMBER-ADD-LABELED-SYMBOL-LST
     ...
     (4 4 (:TYPE-PRESCRIPTION PROP-VARIABLE-P))
     (4 4 (:DEFINITION PROP-VARIABLE-P)))
(MEMBER-APPEND (709 27 (:DEFINITION SUBSETP-EQUAL))
               (212 106
                    (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
               ...
               (99 99
                   (:REWRITE MEMBER-CLAUSE-ACCUMULATOR-NIL))
               (4 4 (:REWRITE MEMBER-DETECT)))
(AGGREGATE-ASSIG-MEMBER-TUBE (192 192 (:REWRITE DEFAULT-CAR))
                             ...
                             (23 23
                                 (:REWRITE MEMBER-CLAUSE-ACCUMULATOR-NIL))
                             (6 6
                                (:TYPE-PRESCRIPTION ADD-LABELED-SYMBOL))
                             (3 1
                                (:REWRITE VARIABLE-AGGREGATE-P-VALOR-MEMBER))
