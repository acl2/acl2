...
(VARIABLE-SUBSTITUTION-VALUE-VARIABLE-P (25 25 (:REWRITE DEFAULT-CAR))
...
(VAL-VAL-INVERSE-RENAMING (159 136 (:REWRITE DEFAULT-CAR))
...
(RENAMING-INVERSE (262 208 (:REWRITE DEFAULT-CDR))
...
(RENAMING-IMPLIES-RENAMED (33 30 (:REWRITE DEFAULT-CDR))
...
(RENAMED-IMPLIES-VARIABLE-VAL-LEMMA (6 1 (:DEFINITION VAL))
...
(RENAMED-IMPLIES-RENAMING
     ...
     (2 2
        (:REWRITE RENAMED-IMPLIES-VARIABLE-SUBSTITUTION))
     (2 2
        (:REWRITE RENAMED-IMPLIES-SETP-CODOMAIN))
     (1 1 (:REWRITE SUBSETP-TRANSITIVE)))
(NUMBER-RENAME-AUX (121 58 (:REWRITE DEFAULT-+-2))
...
(ALISTP-ACL2-NUMBERP-ALISTP (21 21 (:REWRITE DEFAULT-CAR))
...
(NUMBER-RENAME-AUX (49 42 (:REWRITE DEFAULT-CAR))
...
(NUMBER-RENAME-AUX-SUBSTITUTION-S-P
     ...
     (18 18
         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (18 3 (:DEFINITION VAL)))
(NUMBER-RENAME-AUX-EQUAL-LEN (165 86 (:REWRITE DEFAULT-CAR))
...
(COINCIDE-CONMUTATIVE (89 89 (:REWRITE DEFAULT-CAR))
...
(COINCIDE-CONS (140 140 (:REWRITE DEFAULT-CAR))
               (67 67 (:REWRITE DEFAULT-CDR))
               (2 2 (:REWRITE COINCIDE-MAIN-PROPERTY)))
(COINCIDE-SUBSETP-TRANSITIVE (325 325 (:REWRITE DEFAULT-CAR))
...
(ACL2-NUMBERP-LIST-INCREMENT-SETP-2-LEMA
     ...
     (28 14 (:REWRITE DEFAULT-UNARY-MINUS))
     (23 23
         (:REWRITE ACL2-NUMBERP-LIST-INCREMENT-SETP-1-LEMA))
     (14 14 (:REWRITE DEFAULT-+-2))
     (14 14 (:REWRITE DEFAULT-+-1)))
(ACL2-NUMBERP-LIST-INCREMENT-SETP-2
     ...
     (10 10
         (:REWRITE ACL2-NUMBERP-LIST-INCREMENT-SETP-1)))
(ACL2-NUMBERP-LIST-INCREMENT-SETP
     ...
     (2 2
        (:REWRITE ACL2-NUMBERP-LIST-INCREMENT-SETP-2-LEMA))
     (2 2
        (:REWRITE ACL2-NUMBERP-LIST-INCREMENT-SETP-1-LEMA)))
...
(NUMBER-RENAME-CO-DOMAIN-ACL2-NUMBERP-LIST-INCREMENT
     (124 124
          (:TYPE-PRESCRIPTION NUMBER-RENAME-AUX))
     (102 102
          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(ACL2-NUMBERP-LIST-INCREMENT-IMPLIES-RENAMING
     (16 1
         (:DEFINITION ACL2-NUMBERP-LIST-INCREMENT))
     (8 2 (:DEFINITION CO-DOMAIN))
...
(NUMBER-RENAME-RENAMING
     ...
     (4 4
        (:REWRITE ACL2-NUMBERP-LIST-INCREMENT-SETP))
     (4 4
        (:REWRITE ACL2-NUMBERP-LIST-INCREMENT-IMPLIES-VARIABLE-SUBSTITUTION))
     (3 3 (:DEFINITION ASSOC-EQUAL))
     (2 2
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (2 2
        (:REWRITE ACL2-NUMBERP-LIST-INCREMENT-IMPLIES-RENAMING)))
(NUMBER-RENAME-INVARIANTS (888 555 (:REWRITE DEFAULT-CAR))
...
(NUMBER-RENAME-INCREMENTAL (448 8 (:DEFINITION NUMBER-RENAME-AUX))
...
(NUMBER-RENAME)
(NUMBER-RENAME-NOT-NIL (62 27 (:REWRITE DEFAULT-CAR))
                       (23 15 (:REWRITE DEFAULT-CDR))
                       (4 4
                          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(TERM-SUBSUMES-NUMBER-RENAMED-TERM (56 4 (:DEFINITION NUMBER-RENAME-AUX))
...
(NUMBER-RENAMED-TERM-SUBSUMES-TERM
     ...
     (8 1 (:DEFINITION INVERSE))
     (3 3 (:DEFINITION ASSOC-EQUAL)))
(NUMBER-RENAMED-VARIABLES->=-X (14 1 (:DEFINITION NUMBER-RENAME-AUX))
...
(NUMBER-RENAMED-VARIABLES-<=-X (14 1 (:DEFINITION NUMBER-RENAME-AUX))
                               ...
                               (1 1 (:REWRITE DEFAULT-<-2))
                               (1 1 (:DEFINITION ASSOC-EQUAL)))
(SMALLER-BIGGER-DISJOINTP (112 112
                               (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(NUMBER-RENAME-TERM-S-P (14 1 (:DEFINITION NUMBER-RENAME-AUX))
                        ...
                        (1 1 (:REWRITE DEFAULT-+-1))
                        (1 1 (:DEFINITION ASSOC-EQUAL)))
(NUMBER-RENAME-TERM-P (12 12 (:REWRITE DEFAULT-CDR))
...
(NUMBER-RENAMED-TERM-RENAMED-TERM
     (2 2
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(NUMBER-RENAME-LIST)
(LIST-SUBSUMES-NUMBER-RENAMED-LIST- (92 4 (:DEFINITION NUMBER-RENAME-AUX))
