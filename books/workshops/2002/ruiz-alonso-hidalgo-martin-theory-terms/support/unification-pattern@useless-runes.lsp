(SEL)
(SEL-SELECTS (2 2 (:REWRITE DEFAULT-CAR)))
(TRANSFORM-MM-SEL)
(SELECT-ELIMINATE-AND-CONS-EQUAL-SET (590 557 (:REWRITE DEFAULT-CAR))
...
(MEMBER-SOLUTION (216 36 (:DEFINITION VAL)))
(SUBSETP-SOLUTION (168 28 (:DEFINITION VAL))
                  (166 166 (:REWRITE DEFAULT-CAR))
                  (117 117 (:REWRITE DEFAULT-CDR))
                  (18 6 (:DEFINITION MEMBER-EQUAL))
                  (8 8 (:REWRITE SUBSETP-TRANSITIVE)))
(EQUAL-SET-IMPLIES-IFF-SOLUTION-2 (81 3 (:DEFINITION SOLUTION))
...
(SUBSETP-VARIABLES-LEMMA-1 (90 18 (:DEFINITION BINARY-APPEND))
                           (73 73 (:REWRITE DEFAULT-CDR))
                           (46 23 (:DEFINITION VARIABLES)))
(SUBSETP-VARIABLES-LEMMA-2 (90 18 (:DEFINITION BINARY-APPEND))
                           (70 70 (:REWRITE DEFAULT-CAR))
                           (46 23 (:DEFINITION VARIABLES)))
(SUBSETP-SYSTEM-VAR (80 16 (:DEFINITION BINARY-APPEND))
...
(SOLUTION-APPEND (348 58 (:DEFINITION VAL))
...
(TRANSFORM-SEL-RULE-DECOMPOSE
     ...
     (50 10
         (:REWRITE SELECT-ELIMINATE-AND-CONS-EQUAL-SET-INSTANCE)))
...
(MAIN-PROPERTY-ELIMINATE (252 42 (:DEFINITION VAL))
                         (235 231 (:REWRITE DEFAULT-CAR))
                         (161 160 (:REWRITE DEFAULT-CDR)))
(MAIN-PROPERTY-ELIMINATE-COROLARY (222 37 (:DEFINITION VAL))
...
(TRANSFORM-SEL-CHECK-RULE-NOT-EQUAL-SIZE
     ...
     (30 5 (:DEFINITION VAL))
     (25 2
         (:REWRITE IF-X-IS-NOT-TERM-AND-IS-IN-TERM-THEN-IS-IN-SOME-ARGUMENT))
     (20 4 (:DEFINITION BINARY-APPEND))
     ...
     (4 2 (:REWRITE DEFAULT-<-2))
     (3 2 (:REWRITE DEFAULT-<-1)))
(TRANSFORM-SEL-CHECK-RULE (12 2 (:DEFINITION VAL))
...
(TRANSFORM-MM-SEL-CONFLICT-RULE (20 20 (:REWRITE DEFAULT-CAR))
                                (12 12 (:REWRITE DEFAULT-CDR)))
(TRANSFORM-SEL-NOT-PAIR-RULE-LEMMA (357 248 (:REWRITE DEFAULT-CAR))
                                   (120 20 (:DEFINITION VAL)))
(TRANSFORM-SEL-NOT-PAIR-RULE (90 5 (:DEFINITION PAIR-ARGS))
                             (73 41 (:REWRITE DEFAULT-CAR))
                             (50 40 (:REWRITE DEFAULT-CDR))
                             (35 5 (:REWRITE MV-NTH-1-SECOND))
                             (15 5 (:REWRITE MV-NTH-0-FIRST))
                             (6 2
                                (:REWRITE TRANSFORM-MM-SEL-CONFLICT-RULE)))
(TRANSFORM-MM-SEL-EQUIVALENT-1 (764 704 (:REWRITE DEFAULT-CAR))
                               (542 73 (:DEFINITION VAL))
                               (484 463 (:REWRITE DEFAULT-CDR))
                               (156 2 (:DEFINITION APPLY-SYST))
                               (135 27 (:DEFINITION ELIMINATE))
                               (94 24
                                   (:REWRITE TRANSFORM-SEL-NOT-PAIR-RULE))
...
(TRANSFORM-MM-SEL-EQUIVALENT-2 (891 846 (:REWRITE DEFAULT-CAR))
...
(TRANSFORM-SEL-UNSOLVABLE (255 227 (:REWRITE DEFAULT-CAR))
...
(SYSTEM-VAR-APPEND (99 96 (:REWRITE DEFAULT-CDR))
...
(PAIR-ARGS-SYSTEM-VAR-LEMMA-1
     ...
     (113 24
          (:REWRITE SELECT-ELIMINATE-AND-CONS-EQUAL-SET-INSTANCE)))
(PAIR-ARGS-SYSTEM-VAR-LEMMA-2 (1192 48 (:DEFINITION SUBSETP-EQUAL))
...
(APPLY-RANGE-PRESERVES-DOMAIN (36 35 (:REWRITE DEFAULT-CAR))
                              (27 3 (:DEFINITION APPLY-SUBST))
                              (21 20 (:REWRITE DEFAULT-CDR))
                              (18 3 (:DEFINITION VAL)))
(CO-DOMAIN-DE-APPLY-RANGE (46 44 (:REWRITE DEFAULT-CAR))
...
(SUBSETP-DISJOINT (122 122 (:REWRITE DEFAULT-CAR))
...
(DOMAIN-DISJOINT-CO-DOMAIN-ELIMINATE-BRIDGE-LEMMA
     ...
     (22 1
         (:REWRITE VARIABLES-APPLY-SUBSETP-LEMMA))
...
(ELIMINATE-ELIMINATE-VARIABLES-2
     ...
     (8 8 (:TYPE-PRESCRIPTION VARIABLE-P)))
(SUBSETP-SYSTEM-VAR-CO-DOMAIN (115 20 (:DEFINITION MEMBER-EQUAL))
...
(DOMAIN-DISJOINT-SYSTEM-ELIMINATE-BRIDGE-LEMMA
     ...
     (27 1
         (:REWRITE ELIMINATE-ELIMINATE-VARIABLES-2))
     (25 4 (:DEFINITION MEMBER-EQUAL))
...
(TRANSFORM-MM-SEL-PRESERVES-IDEMPOTENCY
     ...
     (8 6
        (:REWRITE APPLY-CONSP-IS-CONSP-LIST-OF-TERMS))
     (6 6 (:TYPE-PRESCRIPTION APPLY-SYST)))
(SYSTEM-S-P-APPLY-SYST (288 18 (:DEFINITION TERM-S-P-AUX))
...
(TERM-S-P-MEMBER-SYSTEM-S-P
     ...
     (7 7
        (:REWRITE SYSTEM-S-P-VARIABLE-S-P-CDR))
     (6 6 (:TYPE-PRESCRIPTION VARIABLE-P)))
...
(SUBSTITUTION-S-P-APPLY-RANGE (136 130 (:REWRITE DEFAULT-CAR))
...
(TRANSFORM-MM-SEL-PRESERVES-SUBSTITUTION-S-P
     ...
     (4 4 (:TYPE-PRESCRIPTION VARIABLES))
     (4 2 (:DEFINITION VARIABLES)))
(SUBSETP-VARIABLES-DELETE (624 28 (:DEFINITION SUBSETP-EQUAL))
...
(SUBSETP-VARIABLES-ELIMINATE-LEMMA (372 371 (:REWRITE DEFAULT-CDR))
                                   (270 54 (:DEFINITION BINARY-APPEND))
                                   (192 8 (:REWRITE MEMBER-APPEND))
                                   (100 50 (:DEFINITION VARIABLES)))
(SUBSETP-VARIABLES-ELIMINATE (152 147 (:REWRITE DEFAULT-CDR))
                             ...
                             (4 4 (:TYPE-PRESCRIPTION APPLY-SYST)))
(LEN-SUBSETP-SETP (90 90 (:REWRITE DEFAULT-CDR))
...
(TRANSFORM-DOES-NOT-INCREASES-N-VARIABLES
     ...
     (3 2
        (:REWRITE SELECT-ELIMINATE-AND-CONS-EQUAL-SET-INSTANCE)))
(POSITIVE-LENGTH-MEMBER (11 6 (:REWRITE DEFAULT-+-2))
                        (6 6 (:REWRITE DEFAULT-+-1))
                        (4 4 (:REWRITE DEFAULT-CDR))
                        (4 4 (:REWRITE DEFAULT-CAR)))
(MEMBER-ELIMINATE (38 35 (:REWRITE DEFAULT-CAR))
                  (20 19 (:REWRITE DEFAULT-CDR)))
(LEN-SUBSETP-SETP-STRICT (158 158 (:REWRITE DEFAULT-CDR))
                         ...
                         (1 1 (:REWRITE SUBSETP-REFLEXIVE)))
(SUBSETP-VARIABLES-ORIENT-2 (70 14 (:DEFINITION BINARY-APPEND))
                            (49 49 (:REWRITE DEFAULT-CDR))
                            (28 28 (:TYPE-PRESCRIPTION VARIABLES))
                            (2 2 (:REWRITE CDR-CONS)))
(ELIMINATE-VARIABLES-STRICT (198 3 (:DEFINITION APPLY-SYST))
                            (180 9
                                 (:REWRITE MAKE-SET-OF-A-SETP-IS-THE-SAME))
...
(SIZE-SYSTEM-CONS-SELECT-AND-DELETE-ONE-LEMMA
     (319 144 (:REWRITE DEFAULT-+-2))
     (270 54 (:DEFINITION SIZE))
     (232 144 (:REWRITE DEFAULT-+-1))
...
(N-VARIABLES-RHS-CONS-SELECT-AND-DELETE-ONE
     (24 3
         (:DEFINITION N-VARIABLES-RIGHT-HAND-SIDE))
     ...
     (1 1
        (:REWRITE SELECT-ELIMINATE-AND-CONS-EQUAL-SET-INSTANCE)))
(SIZE-SYSTEM-ELIMINATE-DELETE-ONE-LEMMA (148 68 (:REWRITE DEFAULT-+-2))
...
(SIZE-SYSTEM-ELIMINATE-DELETE-ONE (270 124 (:REWRITE DEFAULT-+-2))
...
(SIZE-SYSTEM-APPEND (203 93 (:REWRITE DEFAULT-+-2))
...
(SI-PERMANECE-SYSTEM-VAR-AL-TRANSFORMAR-DECRECE-SIZE-SYSTEM
     ...
     (2 2 (:TYPE-PRESCRIPTION APPLY-SYST)))
(SIZE-SYSTEM-EQUATION-LEMMA (1379 632 (:REWRITE DEFAULT-+-2))
                            (1110 222 (:DEFINITION SIZE))
                            (1040 632 (:REWRITE DEFAULT-+-1))
                            (205 205 (:REWRITE FOLD-CONSTS-IN-+)))
(SIZE-SYSTEM-EQUATION
     (526 14 (:DEFINITION SIZE-SYSTEM))
     (191 88 (:REWRITE DEFAULT-+-2))
     (154 14 (:REWRITE COMMUTATIVITY-2-OF-+))
     (150 30 (:DEFINITION SIZE))
     (146 88 (:REWRITE DEFAULT-+-1))
     ...
     (1 1
        (:REWRITE SELECT-ELIMINATE-AND-CONS-EQUAL-SET-INSTANCE)))
(SIZE-T->-0 (12 6 (:REWRITE DEFAULT-+-2))
            (8 8 (:REWRITE DEFAULT-CDR))
            (7 6 (:REWRITE DEFAULT-+-1))
            (1 1 (:REWRITE DEFAULT-CAR)))
(N-VARIABLES-RIGHT-HAND-SIDE-ORIENT (1129 1127 (:REWRITE DEFAULT-CDR))
...
(N-VARIABLES-RIGHT-HAND-SIDE-CHECK-LEMMA (72 72 (:REWRITE DEFAULT-CDR)))
(N-VARIABLES-RIGHT-HAND-SIDE-CHECK (10 2 (:DEFINITION BINARY-APPEND))
...
(IF-N-VARIABLES-AND-SIZE-ARE-EQUAL-TRANSFORM-MM-SEL-DECREASE-N-VARIABLES-R-H-S
     ...
     (4 4 (:TYPE-PRESCRIPTION BINARY-APPEND))
     (2 2 (:TYPE-PRESCRIPTION APPLY-SYST)))
(ORDINALP-UNIFICATION-MEASURE (16 12 (:REWRITE DEFAULT-CAR))
                              (8 4 (:REWRITE DEFAULT-CDR))
                              (6 3 (:REWRITE DEFAULT-<-1))
                              (6 3 (:REWRITE DEFAULT-+-2))
                              (3 3 (:REWRITE DEFAULT-<-2))
                              (3 3 (:REWRITE DEFAULT-+-1)))
(UNIFICATION-MEASURE-DECREASES (151 96 (:REWRITE DEFAULT-CAR))
                               (45 45
                                   (:TYPE-PRESCRIPTION TRANSFORM-MM-SEL))
                               (40 8 (:DEFINITION ELIMINATE))
                               ...
                               (6 3 (:REWRITE DEFAULT-<-2))
                               (6 3 (:REWRITE DEFAULT-<-1)))
(SOLVE-SYSTEM-SEL (7 7 (:REWRITE DEFAULT-CAR))
                  (5 1 (:DEFINITION ELIMINATE))
                  (2 2 (:REWRITE DEFAULT-CDR))
                  (1 1
                     (:TYPE-PRESCRIPTION SOLVE-SYSTEM-SEL)))
...
(SOLVE-SYSTEM-SEL-EQUIVALENT-1
     ...
     (40 23
         (:TYPE-PRESCRIPTION SOLVE-SYSTEM-SEL))
     (40 10
         (:REWRITE TRANSFORM-MM-SEL-EQUIVALENT-2))
     (36 36 (:TYPE-PRESCRIPTION VARIABLE-P))
     (33 11
         (:REWRITE IF-SOLVABLE-TRANSFORM-SEL-SUCCESS))
     (27 9
         (:REWRITE TRANSFORM-SEL-NOT-PAIR-RULE))
     (27 9
         (:REWRITE TRANSFORM-MM-SEL-CONFLICT-RULE))
     (5 1 (:DEFINITION ELIMINATE)))
(SOLVE-SYSTEM-SEL-EQUIVALENT-2 (180 20 (:DEFINITION APPLY-SUBST))
                               ...
                               (30 10
                                   (:REWRITE TRANSFORM-MM-SEL-CONFLICT-RULE))
                               (1 1
                                  (:REWRITE TRANSFORM-MM-SEL-EQUIVALENT-1)))
(SOLVE-SYSTEM-SEL-UNSOLVABLE (60 2 (:DEFINITION SOLUTION))
...
(SOLVE-SYSTEM-SEL-PRESERVES-IDEMPOTENCY
     ...
     (17 5
         (:REWRITE N-VARIABLES-RIGHT-HAND-SIDE-CHECK))
...
(SUBSTITUION-S-P-MGS-SEL
     ...
     (16 1
         (:REWRITE SOLVE-SYSTEM-SEL-SUBSTITUTION-S-P))
...
(MGS-SEL-MOST-GENERAL-SOLUTION
     ...
     (63 63 (:REWRITE DEFAULT-CDR))
     (40 1
         (:REWRITE SUBSTITUTIONS-SOLUTION-SYSTEM))
...
(UNIFIABLE-SEL)
(MGU-SEL)
(UNIFIABLE-SEL-COMPLETENESS (12 2 (:DEFINITION VAL))
                            (11 11 (:REWRITE DEFAULT-CAR))
                            (8 8 (:REWRITE DEFAULT-CDR)))
(UNIFIABLE-SEL-SOUNDNESS (18 2 (:DEFINITION APPLY-SUBST))
                         (12 12 (:REWRITE DEFAULT-CAR))
                         (12 2 (:DEFINITION VAL))
                         (7 7 (:REWRITE DEFAULT-CDR)))
(MGU-SEL-IDEMPOTENT)
(MGU-SEL-SUBSTITUTION-S-P (21 18 (:REWRITE DEFAULT-CAR))
                          (20 20 (:REWRITE DEFAULT-CDR))
                          (20 4 (:DEFINITION LEN))
                          (8 4 (:REWRITE DEFAULT-+-2))
...
(MGU-SEL-MOST-GENERAL-UNIFIER (24 4 (:DEFINITION VAL))
