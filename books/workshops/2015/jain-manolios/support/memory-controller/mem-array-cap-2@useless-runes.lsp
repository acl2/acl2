...
(ACL2S::DEF=>REQS (2 2 (:REWRITE DEFAULT-CDR))
                  (2 2 (:REWRITE DEFAULT-CAR)))
(ACL2S::REQS=>DEF (3 3 (:REWRITE ACL2S::DEF=>REQS))
                  (2 2 (:REWRITE DEFAULT-CAR))
...
(ACL2S::SSTATEP-EXCLUDES-ATOM-LIST (1 1 (:REWRITE DEFAULT-CAR)))
...
(ACL2S::DEF=>SSTATE)
(ACL2S::SSTATE=>DEF (5 2
                       (:REWRITE ACL2S::SSTATEP-MEM-REQS-SELECTOR))
                    (5 2
                       (:REWRITE ACL2S::SSTATEP-DMEM-SELECTOR))
                    (1 1
                       (:REWRITE ACL2S::SSTATEP-PT-SELECTOR)))
...
(ACL2S::MREFRESH-AUX
     ...
     (1 1 (:REWRITE DEFAULT-CDR))
     (1 1 (:REWRITE AC-<)))
(ACL2S::MREFRESH (1 1 (:TYPE-PRESCRIPTION ACL2S::MREFRESH)))
...
(ACL2S::MREFRESH-AUX-MEM-UNCHANGED (124 8 (:REWRITE NTH-WITH-LARGE-INDEX))
                                   ...
                                   (8 8 (:REWRITE ZP-OPEN)))
(ACL2S::MREFRESH-MEM-UNCHANGED (123 8 (:REWRITE NTH-WITH-LARGE-INDEX))
                               (92 4 (:DEFINITION NTH))
                               ...
                               (4 4
                                  (:REWRITE ACL2S::UPDATE-NTH-NTH-SAME)))
(ACL2S::MEM-STEP)
(ACL2S::SPEC-STEP (12 6
                      (:TYPE-PRESCRIPTION DEFDATA::NAT-LISTP--NTH--INTEGERP))
...
(ACL2S::ISTATEP-TAG-BRIDGE-LEMMA2
     (32 16
         (:TYPE-PRESCRIPTION ACL2S::SSTATEP-UNIQUE-TAG)))
(ACL2S::ISTATEP-TAG-IS-NON-EMPTY
     (288 144
          (:TYPE-PRESCRIPTION ACL2S::SSTATEP-UNIQUE-TAG)))
(ACL2S::ISTATEP-DEF-CRUX (10 5
                             (:TYPE-PRESCRIPTION ACL2S::SSTATEP-UNIQUE-TAG)))
...
(ACL2S::ISTATEP-EXCLUDES-ATOM-LIST (1 1 (:REWRITE DEFAULT-CAR)))
...
(ACL2S::ISTATEP-MEM-REQS-MODIFIER
     (324 162
          (:TYPE-PRESCRIPTION ACL2S::SSTATEP-UNIQUE-TAG))
     (3 1
        (:REWRITE ACL2S::ISTATEP-PT-MODIFIER)))
...
(ACL2S::DEF=>ISTATE)
(ACL2S::ISTATE=>DEF (5 2
                       (:REWRITE ACL2S::ISTATEP-RBUF-SELECTOR))
                    (5 2
                       (:REWRITE ACL2S::ISTATEP-MEM-REQS-SELECTOR))
                    (5 2
                       (:REWRITE ACL2S::ISTATEP-DMEM-SELECTOR))
                    (1 1
                       (:REWRITE ACL2S::ISTATEP-PT-SELECTOR)))
