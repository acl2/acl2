...
(ACL2S::GOOD-STATE-INDUCTIVE
 (70373 719 (:REWRITE ACL2S::GOOD-STATEP-IMPLIES-ISTATEP))
 (46250 1060 (:REWRITE ACL2S::ISTATEP-IMEM-SELECTOR))
 (44713 986 (:REWRITE ACL2S::ISTATEP-STK-SELECTOR))
 (42366 2370 (:REWRITE NTH-WITH-LARGE-INDEX))
 (32455 1185 (:DEFINITION NTH))
 (12761 8554 (:REWRITE DEFAULT-+-2))
 (12636 12632 (:REWRITE DEFAULT-CDR))
 (10510 4386 (:REWRITE DEFAULT-CAR))
 (8815 6387 (:REWRITE DEFAULT-<-2))
 (8554 8554 (:REWRITE DEFAULT-+-1))
...
(ACL2S::BSTK-SKIP-REFINES-STK
 (2277010 94143 (:REWRITE ACL2S::GOOD-STATEP-IMPLIES-ISTATEP))
