...
(ACL2S::DEF=>STACK (2 2 (:REWRITE DEFAULT-CDR)))
(ACL2S::STACK=>DEF (2 2 (:REWRITE ACL2S::DEF=>STACK))
...
(ACL2S::INST-MEMP-IMPLIES-TLP
     ...
     (4 4
        (:REWRITE DEFAULT-SYMBOL-PACKAGE-NAME)))
(ACL2S::DEF=>INST-MEM (2 2 (:REWRITE DEFAULT-CDR))
                      (2 2 (:REWRITE DEFAULT-CAR)))
(ACL2S::INST-MEM=>DEF (3 3 (:REWRITE ACL2S::DEF=>INST-MEM))
                      (2 2 (:REWRITE DEFAULT-CAR))
                      (1 1 (:REWRITE DEFAULT-CDR)))
...
(ACL2S::SSTATEP-STK-MODIFIER (3 1
                                (:REWRITE ACL2S::SSTATEP-PC-MODIFIER)))
...
(ACL2S::SSTATE=>DEF (5 2
                       (:REWRITE ACL2S::SSTATEP-STK-SELECTOR))
                    (5 2
                       (:REWRITE ACL2S::SSTATEP-IMEM-SELECTOR))
                    (1 1
                       (:REWRITE ACL2S::SSTATEP-PC-SELECTOR)))
...
(ACL2S::MPOP)
(ACL2S::MPOP-CONTRACT (2 2 (:REWRITE ACL2S::DEF=>STACK))
                      (1 1 (:REWRITE DEFAULT-CDR)))
(ACL2S::MTOP (1 1 (:TYPE-PRESCRIPTION ACL2S::MTOP)))
(ACL2S::MTOP-CONTRACT)
(ACL2S::MNOP (1 1 (:TYPE-PRESCRIPTION ACL2S::MNOP)))
(ACL2S::MNOP-CONTRACT)
(ACL2S::STK-STEP-INST)
(ACL2S::STK-STEP-INST-CONTRACT (17 17 (:REWRITE DEFAULT-CDR))
                               (10 10 (:REWRITE DEFAULT-CAR)))
(ACL2S::PUSH-POP-UNCHANGED)
(ACL2S::MNOP-UNCHANGED (3 3 (:TYPE-PRESCRIPTION ACL2S::MNOP)))
(ACL2S::MTOP-UNCHANGED (3 3 (:TYPE-PRESCRIPTION ACL2S::MTOP)))
...
(ACL2S::ISTATEP-STK-MODIFIER
     (316 158
          (:TYPE-PRESCRIPTION ACL2S::SSTATEP-UNIQUE-TAG))
     (3 1
        (:REWRITE ACL2S::ISTATEP-PC-MODIFIER)))
(ACL2S::ISTATEP-IBUF-MODIFIER
     (316 158
          (:TYPE-PRESCRIPTION ACL2S::SSTATEP-UNIQUE-TAG))
     (6 1 (:REWRITE ACL2S::ISTATEP-PC-MODIFIER))
     (3 1
        (:REWRITE ACL2S::ISTATEP-STK-MODIFIER)))
...
(ACL2S::ISTATE=>DEF (5 2
                       (:REWRITE ACL2S::ISTATEP-STK-SELECTOR))
                    (5 2
                       (:REWRITE ACL2S::ISTATEP-IMEM-SELECTOR))
                    (5 2
                       (:REWRITE ACL2S::ISTATEP-IBUF-SELECTOR))
                    (1 1
                       (:REWRITE ACL2S::ISTATEP-PC-SELECTOR)))
...
(ACL2S::COMMITED-STATE-GOOD-STATE
     ...
     (112 2
          (:REWRITE ACL2S::ISTATEP-STK-MODIFIER))
     (70 19
         (:REWRITE ACL2S::GOOD-STATEP-IMPLIES-ISTATEP))
...
(ACL2S::GOOD-STATE-INDUCTIVE
     ...
     (43785 986
            (:REWRITE ACL2S::ISTATEP-STK-SELECTOR))
     (42366 2370 (:REWRITE NTH-WITH-LARGE-INDEX))
     (30891 1185 (:DEFINITION NTH))
     (12636 12632 (:REWRITE DEFAULT-CDR))
     (11128 7085 (:REWRITE DEFAULT-+-2))
     (10510 4386 (:REWRITE DEFAULT-CAR))
     (8815 6387 (:REWRITE DEFAULT-<-2))
     (7085 7085 (:REWRITE DEFAULT-+-1))
     (6431 6387 (:REWRITE DEFAULT-<-1))
     (3356 839 (:REWRITE ZP-OPEN))
     (2908 28
           (:REWRITE ACL2S::ISTATEP-PC-MODIFIER))
     (2684 1060
           (:REWRITE ACL2S::SSTATEP-IMEM-SELECTOR))
     (2462 986
           (:REWRITE ACL2S::SSTATEP-STK-SELECTOR))
     (2446 2446 (:LINEAR LEQ-POSITION-EQUAL-LEN))
     (2152 2152 (:REWRITE ACL2S::DEF=>STACK))
     (1348 28
           (:REWRITE ACL2S::ISTATEP-STK-MODIFIER))
     (1032 513
           (:REWRITE ACL2S::ISTATEP-IBUF-SELECTOR))
...
(ACL2S::BSTK-SKIP-REFINES-STK
     (2252907 94143
              (:REWRITE ACL2S::GOOD-STATEP-IMPLIES-ISTATEP))
     (1872390 1552163 (:REWRITE DEFAULT-CDR))
     (1198952 855140 (:REWRITE DEFAULT-<-2))
     (1192048 393440 (:REWRITE DEFAULT-CAR))
     (859203 855140 (:REWRITE DEFAULT-<-1))
     (608048 12616
             (:REWRITE ACL2S::ISTATEP-PC-MODIFIER))
     (438880 111511 (:REWRITE O-P-O-INFP-CAR))
     (334372 334372 (:LINEAR LEQ-POSITION-EQUAL-LEN))
     (313496 78374 (:REWRITE ZP-OPEN))
     (301536 18924
             (:REWRITE ACL2S::ISTATEP-STK-MODIFIER))
     (109123 109123 (:REWRITE O-P-DEF-O-FINP-1))
     (23269 23269
            (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (6947 3475 (:REWRITE DEFAULT-UNARY-MINUS)))
