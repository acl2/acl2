...
(LL2::OCCUR-ARR-ITER-OF-IFIX-IX-NORMALIZE-CONST)
...
(LL2::INTEGER-LISTP-UPDATE-NTH
     (3405 29 (:REWRITE LL2::UPDATE-NTH-REDUNDANT))
     (2857 43 (:REWRITE NTH-WITH-LARGE-INDEX))
     (1168 36 (:REWRITE ZP-WHEN-GT-0))
     (892 23 (:REWRITE |(< (+ (- c) x) y)|))
     (630 256 (:REWRITE DEFAULT-LESS-THAN-1))
     (405 248 (:REWRITE DEFAULT-PLUS-2))
     (350 256 (:REWRITE DEFAULT-LESS-THAN-2))
     ...
     (244 244
          (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-<))
     (243 188 (:REWRITE SIMPLIFY-SUMS-<))
     (202 188
          (:REWRITE REMOVE-STRICT-INEQUALITIES))
     (200 161 (:REWRITE DEFAULT-CDR))
...
(LL2::SEM-LOOP-8-=-OCCUR-ARR-TAILREC-0-0
     (249206 2 (:DEFINITION LL2::SEM-LOOP-8))
     ...
     (4 4
        (:REWRITE LL2::OCCUR-ARR-ITER-OF-IFIX-IX-NORMALIZE-CONST))
     (4 4 (:REWRITE |(* a (/ a))|))
...
(LL2::LL2-RUNNING-OCCURRENCES-CODE-=-OCCURLIST
     ...
     (2760490 189
              (:REWRITE UPDATE-NTH-UPDATE-NTH . 2))
     (1850916 1 (:DEFINITION LL2::SEM-LOOP-8))
