(FLOG2 (14 14 (:TYPE-PRESCRIPTION NOT-INTEGERP-4B))
...
(FLOG2-IS-CORRECT
     ...
     (2 2 (:REWRITE DEFAULT-UNARY-/))
     (2 2 (:REWRITE |(< (+ c x) d)|)))
(CLOG2 (32 32 (:TYPE-PRESCRIPTION NOT-INTEGERP-3B))
       ...
       (1 1 (:REWRITE |(< 0 (- x))|))
       (1 1 (:REWRITE |(+ c (+ d x))|)))
(NATP-CLOG2 (79 79 (:TYPE-PRESCRIPTION NOT-INTEGERP-3B))
            ...
            (4 4 (:REWRITE |(< 0 (- x))|))
            (4 4 (:REWRITE |(< (- x) 0)|)))
(POSP-1/2+1/2*N (27 27 (:TYPE-PRESCRIPTION NOT-INTEGERP-4A))
...
(POSP-CLOG2 (278 278
            ...
            (1 1
               (:REWRITE INTEGERP-+-REDUCE-LEADING-RATIONAL-CONSTANT)))
(CLOG2-LEMMA-A (238 2 (:DEFINITION CLOG2))
               (108 6 (:REWRITE |(* (+ x y) z)|))
               (93 3 (:REWRITE |(< d (+ c x))|))
               ...
               (1 1
                  (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-A+AB))
               (1 1 (:REWRITE |(< 0 (- x))|)))
(CLOG2-LEMMA-B (444 4 (:DEFINITION CLOG2))
...
(CLOG2-IS-CORRECT-UPPER
     ...
     (7 7
        (:REWRITE INTEGERP-+-REDUCE-LEADING-RATIONAL-CONSTANT))
     (3 3 (:REWRITE BUBBLE-DOWN-*-MATCH-3)))
(CLOG2-IS-CORRECT (108 2 (:DEFINITION CLOG2))
                  ...
                  (1 1 (:REWRITE |(< 0 (- x))|))
                  (1 1 (:REWRITE |(< (- x) (- y))|)))
(NBR-CALLS-CLOG2 (32 32 (:TYPE-PRESCRIPTION NOT-INTEGERP-3B))
                 (32 32 (:TYPE-PRESCRIPTION NOT-INTEGERP-2B))
                 (32 32 (:TYPE-PRESCRIPTION NOT-INTEGERP-1B))
                 (10 10
                     (:REWRITE REMOVE-WEAK-INEQUALITIES-TWO))
...
(NBR-CALLS-CLOG2=1+CLOG2
     ...
     (4 4 (:REWRITE |(< 0 (- x))|))
     (4 4 (:REWRITE |(< (- x) (- y))|)))
(NBR-CALLS-FLOG2 (14 14 (:TYPE-PRESCRIPTION NOT-INTEGERP-4B))
                 (14 14 (:TYPE-PRESCRIPTION NOT-INTEGERP-3B))
                 (14 14 (:TYPE-PRESCRIPTION NOT-INTEGERP-2B))
                 (14 14 (:TYPE-PRESCRIPTION NOT-INTEGERP-1B))
                 (5 5
