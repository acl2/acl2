...
(ATMV1-OK_REG-ERROR)
(OK_REGISTER (173 4 (:REWRITE REG-DET-THM-NEXT-TYPE2))
             ...
             (39 1
                 (:REWRITE REG-DET-THM-OUT_VALUE-TYPE2))
...
(ATMV1-INJECT3)
(ATMV1-ERROR)
(ATMV1-ERROR-TYPE1 (122 122 (:REWRITE DEFAULT-CDR))
                   ...
                   (1 1
                      (:TYPE-PRESCRIPTION ATMV1-FSM_STATEP)))
(ATMV1-ERROR-TYPE2 (20 20 (:REWRITE DEFAULT-CDR))
...
(ATMV1-ERROR-DEF1 (196 196 (:REWRITE DEFAULT-CDR))
...
(ATMV1-THM-NEXT-TYPE1
     ...
     (769 479
          (:REWRITE REG-DET-THM-OUT_VALUE-TYPE2))
     (720 720
          (:TYPE-PRESCRIPTION REG-DET-THM-REACH_STATE-TYPE))
     ...
     (180 90
          (:REWRITE REG-DET-THM-E_DETECT-TYPE2))
...
(ATMV1-THM-ERROR (144 6 (:REWRITE ATMV1-THM-ERROR-TYPE2))
...
(SPEC-ATMV1-IP)
(SPEC-ATMV1-TRACE-IP)
(SPEC-ATMV1-REC-NEXT (70 70 (:REWRITE DEFAULT-CDR))
...
(SPEC-ATMV1-TEST1 (576 1 (:DEFINITION SPEC-ATMV1-REC-NEXT))
                  (353 1 (:REWRITE ATMV1-THM-NEXT-TYPE2))
                  (155 2
                       (:REWRITE SPEC-ATMV1-THM-REC-NEXT-TYPE2))
                  ...
                  (11 11 (:REWRITE DEFAULT-+-1)))
(SPEC-ATMV1-TEST2 (576 1 (:DEFINITION SPEC-ATMV1-REC-NEXT))
                  (353 1 (:REWRITE ATMV1-THM-NEXT-TYPE2))
                  (155 2
                       (:REWRITE SPEC-ATMV1-THM-REC-NEXT-TYPE2))
...
(SPEC-ATMV1-TEST3 (576 1 (:DEFINITION SPEC-ATMV1-REC-NEXT))
                  (353 1 (:REWRITE ATMV1-THM-NEXT-TYPE2))
                  (155 2
                       (:REWRITE SPEC-ATMV1-THM-REC-NEXT-TYPE2))
                  (106 106 (:REWRITE DEFAULT-CDR))
