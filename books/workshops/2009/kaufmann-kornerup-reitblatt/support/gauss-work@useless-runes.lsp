...
(_N_33$HYPS)
(_N_33$PROP)
(_N_33$PROP{_N_8$STEP} (105 63 (:REWRITE DEFAULT-+-2))
...
(ACL2-LOOP-INV$INV{INIT} (24 16 (:REWRITE DEFAULT-+-2))
...
(ACL2-LOOP-INV$INV{NATP-LOOP-INIT} (1 1 (:REWRITE MGET-DIFF-MSET)))
(ACL2-LOOP-INV$INV+)
(ACL2-LOOP-INV$INV$CONDITIONAL)
(ACL2-LOOP-INV$INV{PRE}{HOLDS})
(ACL2-LOOP-INV$INV)
(LEMMA-1-ACL2-LOOP (38 27 (:REWRITE DEFAULT-<-2))
...
(LEMMA-2-ACL2-LOOP)
(ACL2-TOP-INV$INV (30 24 (:REWRITE DEFAULT-*-2))
