...
(SIZE-OF)
(IS-EMPTY)
(GET-ARR-LIST-FIRST-N (5 4 (:REWRITE DEFAULT-<-2))
...
(PD)
(GET-FIRST)
(GET-LAST (10 10 (:REWRITE DEFAULT-CDR))
          (10 2 (:DEFINITION LEN))
...
(IS-FULL-FRONT)
(IS-FULL-BACK)
(INDEX-OF--FROM-FRONT (31 31 (:REWRITE DEFAULT-CDR))
...
(IOFF-NAT--THM (233 233 (:REWRITE DEFAULT-CDR))
...
(INDEX-OF--FROM-BACK (31 31 (:REWRITE DEFAULT-CDR))
...
(IOFB-NAT--THM (185 185 (:REWRITE DEFAULT-CDR))
               ...
               (22 11 (:DEFINITION TRUE-LISTP))
               (2 2 (:REWRITE NTH-0-CONS)))
(CONTAINS (14 14 (:REWRITE DEFAULT-CDR))
          (10 2 (:DEFINITION LEN))
          ...
          (2 1 (:DEFINITION ARRP))
          (1 1 (:REWRITE DEFAULT-UNARY-MINUS)))
(SHIFT-UP-TO (28 28 (:REWRITE DEFAULT-CDR))
...
(SHIFT-DOWN-TO (17 14 (:REWRITE DEFAULT-+-2))
               ...
               (2 1 (:DEFINITION TRUE-LISTP))
               (2 1 (:DEFINITION ARRP)))
(ADD-FIRST (84 84 (:REWRITE DEFAULT-CDR))
           (40 8 (:DEFINITION LEN))
           ...
           (8 4 (:DEFINITION ARRP))
           (2 2 (:REWRITE DEFAULT-UNARY-MINUS)))
(ADD-LAST (64 64 (:REWRITE DEFAULT-CDR))
          ...
          (6 3 (:DEFINITION ARRP))
          (3 3 (:REWRITE DEFAULT-UNARY-MINUS)))
(REMOVE-FIRST (20 20 (:REWRITE DEFAULT-CDR))
              ...
              (1 1 (:REWRITE DEFAULT-UNARY-MINUS)))
(REMOVE-LAST (31 31 (:REWRITE DEFAULT-CDR))
             (20 4 (:DEFINITION LEN))
...
(REMOVE-FRONT)
(REMOVE-BACK)
(REMOVE-FIRST-OCCURRENCE (84 84 (:REWRITE DEFAULT-CDR))
...
(REMOVE-LAST-OCCURRENCE (64 64 (:REWRITE DEFAULT-CDR))
...
(ADD-ELEMENT)
(REMOVE-ELEMENT)
(CLEAR-HELPER (11 11 (:REWRITE DEFAULT-<-2))
              (11 11 (:REWRITE DEFAULT-<-1))
