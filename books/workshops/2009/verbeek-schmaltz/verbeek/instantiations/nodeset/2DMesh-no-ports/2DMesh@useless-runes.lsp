...
(2DMESH-NODESETP)
(X-DIM-GEN)
(ALL-COORDINATEP-X-DIM-GEN (21 20 (:REWRITE DEFAULT-CDR))
                           ...
                           (3 3 (:REWRITE ZP-OPEN)))
(COORD-GENERATOR-1)
(VALID-COORDINATES-COORD-GEN-1 (340 310 (:REWRITE DEFAULT-CDR))
...
(COORD-GEN)
(VALID-COORDINATES-COORD-GEN (1597 1559 (:REWRITE DEFAULT-<-1))
...
(SUBSETS-ARE-VALID-MESH-NODESETP
     ...
     (32 32
         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(MESH-COMPLIES-NODESET (17 1 (:DEFINITION 2DMESH-NODESETP))
