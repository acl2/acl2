(CARD)
(SETP)
(SET-RECURSION-SCHEME (550 256 (:REWRITE DEFAULT-+-2))
...
(EQUAL-CARDS-IMPLY-SAME-MEMBERS
     ...
     (3 3
        (:TYPE-PRESCRIPTION SET-RECURSION-SCHEME)))
(CARD-SUBSET (113 113 (:REWRITE DEFAULT-CDR))
             (109 94
                  (:REWRITE EQUAL-CARDS-IMPLY-SAME-MEMBERS))
             (94 94 (:REWRITE DEFAULT-CAR))
             (40 20 (:REWRITE DEFAULT-<-1))
             (27 20 (:REWRITE DEFAULT-<-2))
             (24 12 (:REWRITE DEFAULT-+-2))
             (12 12 (:REWRITE DEFAULT-+-1)))
(NODUPS-LEN=CARD (22 22 (:REWRITE DEFAULT-CDR))
                 (14 14
                     (:REWRITE EQUAL-CARDS-IMPLY-SAME-MEMBERS))
...
(NODUPS-LIST=SET (26 26 (:REWRITE DEFAULT-CDR))
                 (22 22
                     (:REWRITE EQUAL-CARDS-IMPLY-SAME-MEMBERS))
                 (22 22 (:REWRITE DEFAULT-CAR)))
(LEN-NODUP-SUBSET (40 2 (:DEFINITION CARD))
