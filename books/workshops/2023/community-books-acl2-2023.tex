...
\author{Alessandro Coglio\inst{1,4,5} (presenter),
        Warren Hunt\inst{3,7},\\
        Matt Kaufmann\inst{3},
        Ankit Kumar\inst{6},
        Vivek Ramanathan\inst{3},\\
        David Russinoff\inst{2},
        Eric W. Smith\inst{4,5,1},
        Max von Hippel\inst{6},\\
        \emph{more authors}\inst{8}}

\institute{\inst{1}Aleo Systems Inc.,
           \inst{2}{Arm Inc.},
           \inst{3}ForrestHunt Inc.,\\
           \inst{4}Kestrel Institute,
           \inst{5}Kestrel Technology LLC,\\
           \inst{6}Northeastern University,
           \inst{7}University of Texas at Austin,\\
           \inst{8}\emph{more organizations}}
