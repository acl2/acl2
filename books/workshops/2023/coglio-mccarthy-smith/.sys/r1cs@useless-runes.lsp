...
(ZKPAPER::EQUALITY-TEST-GADGET-CORRECTNESS
 ...
 (42 42 (:REWRITE PFIELD::MUL-OF--1-BECOMES-NEG-ALT))
...
(ZKPAPER::LEMMA
 (16976 167 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
 (11208 11208 (:TYPE-PRESCRIPTION EVENP))
 (11154 110 (:REWRITE MOD-WHEN-<))
 (9469 175 (:LINEAR LENDIAN=>NAT-UPPER-BOUND))
 (7493 3757 (:TYPE-PRESCRIPTION EXPT-TYPE-ODD-EXPONENT-NEGATIVE-BASE))
 (7493 3757 (:TYPE-PRESCRIPTION EXPT-TYPE-EVEN-EXPONENT-2))
 (7493 3757 (:TYPE-PRESCRIPTION EXPT-TYPE-EVEN-EXPONENT-1))
 (6462 110 (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
 (3812 110 (:REWRITE MOD-WHEN-MULTIPLE))
 (3775 167 (:LINEAR <-OF-*-AND-*-SAME-LINEAR-2))
 (3757 3757 (:TYPE-PRESCRIPTION EXPT-TYPE-SMALL-BASE-NEGATIVE-EXPONENT))
 (3618 3618 (:TYPE-PRESCRIPTION LEN))
 (2816 216 (:REWRITE INTEGERP-OF-*))
 (2814 450 (:LINEAR <-OF-EXPT-AND-EXPT-SAME-EXPONENTS-LINEAR))
 (2344 8 (:REWRITE <-OF-0-AND-*))
 (2316 804 (:REWRITE |(< 0 (len x))|))
 (2046 186 (:REWRITE DAB-DIGIT-FIX-WHEN-DAB-DIGITP))
 (1580 116 (:REWRITE MULTIPLE-WHEN-MOD-0-CHEAP))
 (1408 23 (:REWRITE MOD-OF-+-SUBST-CONSTANT))
 (1407 225 (:LINEAR EXPT-WHEN-NEGATIVE-EXPONENT-LINEAR-4))
 (1407 225 (:LINEAR EXPT-WHEN-NEGATIVE-EXPONENT-LINEAR-2))
 ...
 (1116 186 (:REWRITE DAB-DIGITP-OF-CAR-WHEN-DAB-DIGIT-LISTP))
 (1096 30 (:REWRITE PFIELD::ADD-COMMUTATIVE))
 (852 450 (:LINEAR <-OF-EXPT-AND-EXPT-SAME-EXPONENTS-LINEAR-NEGATIVE-EXPONENT))
 (594 305 (:TYPE-PRESCRIPTION R1CS::NATP-OF-LOOKUP-EQUAL-WHEN-R1CS-VALUATIONP-TYPE))
 (594 175 (:REWRITE ZKPAPER::LEN-OF-LOOKUP-EQUAL-LIST))
 (588 588 (:REWRITE CONSP-OF-CDR-BY-LEN))
 (450 450 (:LINEAR <=-OF-EXPT-AND-EXPT-SAME-BASE-LINEAR))
 (450 450 (:LINEAR <-OF-EXPT-AND-EXPT-SAME-BASE-LINEAR))
 (426 225 (:LINEAR EXPT-WHEN-NEGATIVE-EXPONENT-LINEAR-3))
 (426 225 (:LINEAR EXPT-WHEN-NEGATIVE-EXPONENT-LINEAR-1))
 (419 161 (:REWRITE LEN-WHEN-ATOM))
 (380 380 (:REWRITE LENDIAN=>NAT-OF-ALL-ZEROS-CONSTANT))
 (372 372 (:TYPE-PRESCRIPTION DAB-DIGITP))
 (372 372 (:TYPE-PRESCRIPTION DAB-DIGIT-LISTP))
 (372 372 (:REWRITE DAB-DIGITP-WHEN-MEMBER-EQUAL-OF-DAB-DIGIT-LISTP))
 (372 372 (:REWRITE DAB-DIGIT-LISTP-WHEN-SUBSETP-EQUAL))
 (367 367 (:REWRITE *-OF-*-COMBINE-CONSTANTS))
 (354 354 (:TYPE-PRESCRIPTION NONNEG-OF-MOD-TYPE))
 (334 334 (:LINEAR <=-OF-*-AND-*-SAME-ALT-LINEAR))
 (334 334 (:LINEAR <-OF-*-AND-*-LINEAR))
 (198 198 (:REWRITE EXPT-WHEN-NOT-ACL2-NUMBERP-CHEAP))
 (190 190 (:REWRITE LENDIAN=>NAT-OF-DAB-DIGIT-LIST-FIX-DIGITS-NORMALIZE-CONST))
 (186 186 (:REWRITE DAB-DIGIT-LISTP-WHEN-NOT-CONSP))
 (167 167 (:LINEAR <-OF-*-AND-*-SAME-LINEAR-4))
 (167 167 (:LINEAR <-OF-*-AND-*-SAME-LINEAR-3))
 (167 167 (:LINEAR <-OF-*-AND-*-SAME-LINEAR-1))
 ...
 (13 13 (:REWRITE NATP-LISTP-WHEN-DAB-DIGIT-LISTP))
...
(ZKPAPER::POW2SUM-VECTOR-TO-MOD-OF-LEBITS=>NAT
 (547 8 (:REWRITE PFIELD::MOD-WHEN-FEP))
 (511 7 (:REWRITE PFIELD::FEP-HOLDS))
 (505 8 (:REWRITE MOD-WHEN-<))
...
(ZKPAPER::ADDITION-GADGET-CORRECTNESS
 ...
 (87 10 (:REWRITE MOD-WHEN-MULTIPLE))
 ...
 (24 20 (:REWRITE COMMUTATIVITY-OF-*))
