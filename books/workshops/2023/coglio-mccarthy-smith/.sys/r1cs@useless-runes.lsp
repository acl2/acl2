...
(ZKPAPER::LEMMA
 (18924 350 (:LINEAR LENDIAN=>NAT-UPPER-BOUND))
 (18768 175 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
 (18754 175 (:LINEAR <-OF-*-SAME-LINEAR-2))
 (17634 110 (:REWRITE MOD-WHEN-<))
 (12510 12510 (:TYPE-PRESCRIPTION EVENP))
 (8361 4191 (:TYPE-PRESCRIPTION EXPT-TYPE-ODD-EXPONENT-NEGATIVE-BASE))
 (8361 4191 (:TYPE-PRESCRIPTION EXPT-TYPE-EVEN-EXPONENT-2))
 (8361 4191 (:TYPE-PRESCRIPTION EXPT-TYPE-EVEN-EXPONENT-1))
 (7236 7236 (:TYPE-PRESCRIPTION LEN))
 (6462 110 (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
 (5580 852 (:LINEAR <-OF-EXPT-AND-EXPT-SAME-EXPONENTS-LINEAR))
 (4679 175 (:LINEAR <-OF-*-AND-*-SAME-LINEAR-2))
 (4632 1608 (:REWRITE |(< 0 (len x))|))
 (4191 4191 (:TYPE-PRESCRIPTION EXPT-TYPE-SMALL-BASE-NEGATIVE-EXPONENT))
