...
;;                                           alltopics
;;                                           100))
;;       (evnts (emit-evnts 'A 'B alltopics attacktopics 20 0 18)))
...
(time$
 (b* ((attacktopics '(SUB1 SUB2 SUB3))
      (grp (reduce* graph->group 
                   ...
                   *goerli*
                   (alltopics)))
      (evnts (emit-evnts 'P222 'P834 (alltopics) attacktopics 20 0 18)))
   ;; P222 is attacker, P834 is observer who records violations
   (eth-attack-violations grp evnts evnts 'P222 'P834 attacktopics 0 *eth-twp* 42 nil)))
