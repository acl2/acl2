...
(|inv-fibs-thm-hist-inv-most|
 (3614 55 (:REWRITE NTH-WITH-LARGE-INDEX))
 (1144 80 (:REWRITE LOGHEAD-IDENTITY))
 (871 495 (:REWRITE USB-LINEAR-REWRITE))
 ...
 (494 316 (:REWRITE DEFAULT-<-2))
 (469 91 (:REWRITE LOGHEAD-<))
 (457 410 (:REWRITE DEFAULT-+-2))
 (412 410 (:REWRITE DEFAULT-+-1))
 (406 406 (:REWRITE REMOVE-REDUNDANT-<=-HYPS))
...
(|inv-fibs-thm|
 ...
 (12 12
     (:TYPE-PRESCRIPTION |$itr_loop_iter_fibs_3|))
...
(|inv-fibs-thmfibs_2-inst-thm|
     ...
     (82 8
         (:REWRITE |inv-fibs-thm-hist-inv-l-fibs_2|))
     (77 41 (:REWRITE HACK<))
...
(|inv-fibs-thmfibs_2-inst--alt-thm|
     ...
     (6 6
        (:TYPE-PRESCRIPTION |itr_iter_fibs_3|))
     (6 6
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (6 2
        (:REWRITE LOGHEAD-NOT-GREATER-THAN-BIG-CONSTANT))
     ...
     (1 1
        (:REWRITE LOGHEAD-NONNEGATIVE-REWRITE)))
(|fibs-thm| (380 16 (:REWRITE NTH-WITH-LARGE-INDEX))
