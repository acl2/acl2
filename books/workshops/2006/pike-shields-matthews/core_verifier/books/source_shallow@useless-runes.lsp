(NBITS-HLP (136 1 (:REWRITE O<=-O-FINP-DEF))
...
(C-WORD-**-HLP (10 1 (:REWRITE O<=-O-FINP-DEF))
               ...
               (1 1 (:REWRITE AC-<)))
(C-WORD-**)
(C-LG2-HLP (326 2 (:REWRITE O<=-O-FINP-DEF))
...
(C-WORD->>> (3 3
               (:TYPE-PRESCRIPTION |x < y  =>  0 < y-x|)))
(C-WORD-APPEND-HLP (206 97 (:REWRITE DEFAULT-+-2))
...
(C-WORD-JOIN-HLP)
(C-WORD-JOIN)
(C-WORD-SPLIT-HLP (1 1
                     (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(C-WORD-SPLIT)
(C-WORD-SEGMENT)
(MAKE-TRANS-WD)
(C-WORD-TRANSPOSE-HLP (9 9
                         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(C-WORD-TRANSPOSE)
(C-WORD-REVERSE)
(C-WORD-PARITY)
(C-WORD-PADD)
(C-WORD-PMULT-HLP (1856 34 (:REWRITE UNIQUE-RATIONALP))
...
(C-WORD-PGCD-HLP (6 6
                    (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(C-WORD-PGCD)
(C-WORD-PIRRED-HLP (5 5 (:META CANCEL_PLUS-LESSP-CORRECT))
...
(C-WORD-PIRRED (3 3 (:TYPE-PRESCRIPTION FLOOR-TYPE-3 . 2))
...
(C-VEC->>>)
(C-VEC-APPEND (1 1 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(C-VEC-EXTRACT (2 1
                  (:TYPE-PRESCRIPTION TRUE-LISTP-NTHCDR-TYPE-PRESCRIPTION))
               (1 1 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(C-VEC-JOIN (687 46 (:REWRITE O-FIRST-EXPT-<))
            ...
            (3 3
               (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(C-VEC-SPLIT (951 493 (:REWRITE DEFAULT-+-2))
...
(MAKE-ROWS (28 2 (:REWRITE O<=-O-FINP-DEF))
...
(C-VEC-TRANSPOSE-HLP (28 2 (:REWRITE O<=-O-FINP-DEF))
                     (15 12 (:REWRITE DEFAULT-+-2))
                     (13 13
                         (:TYPE-PRESCRIPTION |x < y  =>  0 < y-x|))
                     (12 12 (:REWRITE DEFAULT-+-1))
                     ...
                     (2 1 (:REWRITE O-FIRST-COEFF-<)))
(C-VEC-TRANSPOSE)
(C-VEC-REVERSE-HLP (28 2 (:REWRITE O<=-O-FINP-DEF))
                   (15 12 (:REWRITE DEFAULT-+-2))
                   (12 12 (:REWRITE DEFAULT-+-1))
                   (12 7 (:REWRITE DEFAULT-<-1))
                   (9 9 (:META CANCEL_PLUS-LESSP-CORRECT))
