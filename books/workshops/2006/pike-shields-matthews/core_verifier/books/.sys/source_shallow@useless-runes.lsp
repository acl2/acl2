...
(C-VEC-SPLIT
 (1922 28 (:REWRITE O<=-O-FINP-DEF))
 (1918 21 (:LINEAR ACL2-COUNT-CAR-CDR-LINEAR))
 (1562 794 (:REWRITE DEFAULT-+-2))
 (1050 794 (:REWRITE DEFAULT-+-1))
 (700 140 (:DEFINITION INTEGER-ABS))
 (560 70 (:DEFINITION LENGTH))
 (340 265 (:REWRITE DEFAULT-<-2))
 (340 265 (:REWRITE DEFAULT-<-1))
 (226 218 (:REWRITE DEFAULT-CDR))
 (219 213 (:REWRITE FOLD-CONSTS-IN-+))
