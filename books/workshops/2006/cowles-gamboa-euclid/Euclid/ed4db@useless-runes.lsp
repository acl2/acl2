...
(INT-RND-REM::DIVIDES-P-SUFF (4 4 (:REWRITE DEFAULT-*-2))
...
(INT-RND-REM::UNIT-P=_+1_OR_-1 (12 6 (:REWRITE DEFAULT-*-2))
                               (8 8
                                  (:REWRITE INT-RND-REM::DIVIDES-P-SUFF))
...
(INT-RND-REM::GREATEST-FACTOR (10 10
                                  (:TYPE-PRESCRIPTION INT-RND-REM::NATP-ABS))
                              (4 3 (:REWRITE DEFAULT-<-1))
                              (3 3 (:REWRITE DEFAULT-<-2))
                              ...
                              (1 1 (:REWRITE DEFAULT-+-1))
                              (1 1 (:REWRITE DEFAULT-*-1)))
(INT-RND-REM::NATP-GREATEST-FACTOR (14 7 (:REWRITE DEFAULT-*-2))
                                   (7 7 (:REWRITE ZP-OPEN))
...
(INT-RND-REM::NOT-INTEGERP-/-A (4 2 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
                               (2 2 (:REWRITE DEFAULT-<-2))
                               (2 2 (:REWRITE DEFAULT-<-1))
                               (2 2 (:REWRITE DEFAULT-*-2))
                               (2 2 (:REWRITE DEFAULT-*-1))
...
(INT-RND-REM::NOT-INTEGERP-/-B-LEMMA (6 4 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
...
(INT-RND-REM::GREATEST-FACTOR->-1-A
     ...
     (6 6
        (:LINEAR INT-RND-REM::GREATEST-FACTOR->-1))
     (5 5 (:REWRITE ZP-OPEN))
     (5 5 (:REWRITE DEFAULT-*-1))
     (2 2 (:REWRITE DEFAULT-+-2))
     (2 2 (:REWRITE DEFAULT-+-1)))
(INT-RND-REM::GREATEST-FACTOR->=-DIVISOR
     ...
     (56 10
         (:LINEAR INT-RND-REM::GREATEST-FACTOR->-1))
     (48 10
         (:LINEAR INT-RND-REM::GREATEST-FACTOR->-1-A))
...
(INT-RND-REM::SUBGOAL-7.4
     ...
     (28 28
         (:REWRITE INT-RND-REM::DIVIDES-P-SUFF))
     (20 10
         (:REWRITE INT-RND-REM::GREATEST-FACTOR=1))
     (13 13
         (:LINEAR INT-RND-REM::GREATEST-FACTOR->=-DIVISOR))
     (13 13
         (:LINEAR INT-RND-REM::GREATEST-FACTOR->-1-A))
     (13 13
         (:LINEAR INT-RND-REM::GREATEST-FACTOR-<=-Y))
...
(INT-RND-REM::SUBGOAL-7.3 (6 6 (:REWRITE DEFAULT-<-2))
                          (6 6 (:REWRITE DEFAULT-<-1))
...
(INT-RND-REM::SUBGOAL-5.3 (9 9 (:REWRITE DEFAULT-<-2))
...
(INT-RND-REM::SUBGOAL-1.1
     (477 12
          (:DEFINITION INT-RND-REM::GREATEST-FACTOR))
