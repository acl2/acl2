(ROUND-AS-FLOOR-&-CEILING (1384 126 (:REWRITE NIQ-TYPE . 3))
                          ...
                          (6 2 (:REWRITE <-*-/-LEFT)))
(CEILING-AS-FLOOR (68 6 (:REWRITE NIQ-TYPE . 3))
...
(DIVISION-PROPERTY (11081 7487 (:REWRITE DEFAULT-*-2))
