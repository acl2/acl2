(FUPOL::|m +M p != 0| (16 16 (:TYPE-PRESCRIPTION FUPOL::+M))
                      (3 1 (:DEFINITION FUPOL::POLINOMIOP))
                      (1 1 (:REWRITE DEFAULT-CDR))
                      (1 1 (:REWRITE DEFAULT-CAR)))
(FUPOL::|mp(m +M p) = m| (5 5 (:TYPE-PRESCRIPTION FUPOL::+M))
                         (3 1 (:DEFINITION FUPOL::POLINOMIOP))
                         (2 2 (:REWRITE DEFAULT-CAR))
                         (1 1 (:REWRITE DEFAULT-CDR)))
(FUPOL::|resto(m +M p) = p| (3 3 (:REWRITE DEFAULT-CDR))
                            (2 2 (:REWRITE DEFAULT-CAR)))
...
(FUPOL::|m +Mo fn(p) = fn(m +M p)|
 ...
 (1072 30
       (:REWRITE FUPOL::|n +Mo p = p_p +M (n +Mo p_r)|))
 (919 4
      (:REWRITE FUPOL::|(m +Mo fn(p)) =P fn(m +Mo p)|))
 (710
  70
  (:REWRITE
    FUPOL::|(primero p) >-monomio (resto p) => primero (fn p) =e primero p|))
...
(FUPOL::|fn(m *M (n +Mo p)) =P fn((m * n) +Mo (m *M p))|
 ...
 (223 50
      (:REWRITE FUPOL::| m != 0 and p != 0 => fn(m *M p) != 0|))
...
(FUPOL::|m *M p = m *M fn(p)|
 ...
 (1 1
    (:REWRITE FUPOL::POLINOMIOP-+-MONOMIO)))
(FUPOL::=P-IMPLIES-=P-*-MONOMIO-2 (63 63 (:REWRITE DEFAULT-CAR))
