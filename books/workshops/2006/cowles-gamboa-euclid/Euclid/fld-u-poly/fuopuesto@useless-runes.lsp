...
(FUPOL::POLINOMIOP-- (22 22 (:REWRITE DEFAULT-CAR))
                     (21 21 (:REWRITE DEFAULT-CDR)))
(FUPOL::|- p =e (- mp(p)) +M (- (resto(p)))| (12 12 (:REWRITE DEFAULT-CAR))
...
(FUPOL::|- (m +Mo p) =P (- m) +Mo (- p)|
     ...
     (50 40
         (:TYPE-PRESCRIPTION FUPOL::POLINOMIOP-RESTO)))
(FUPOL::|FUMON::nulop_-|)
(FUPOL::=P-IMPLIES-=P_- (81 79 (:REWRITE DEFAULT-CAR))
                        (68 66 (:REWRITE DEFAULT-CDR))
                        (20 12
                            (:TYPE-PRESCRIPTION FUPOL::POLINOMIOP-RESTO)))
(FUPOL::ORDENADOP_- (313 34
                         (:REWRITE FUTER::|a < b => ~(b < a)|))
                    (305 81
                         (:REWRITE FUTER::|a < b or b < a or a = b|))
