...
(==_E-EQUIVALENCE-LAW (86 86 (:REWRITE CLOSURE-LAWS)))
(==_E-IMPLIES-IFF-EDP (43 24 (:REWRITE EQUIVALENCE-LAW))
                      (19 19 (:REWRITE CLOSURE-LAWS)))
(==_E-IMPLIES-==_E-++_E-1 (1410 16 (:REWRITE ZERO-DIVISOR-LAW)))
(==_E-IMPLIES-==_E-++_E-2 (1434 16 (:REWRITE ZERO-DIVISOR-LAW)))
(==_E-IMPLIES-==_E-**_E-1 (2820 32 (:REWRITE ZERO-DIVISOR-LAW)))
(==_E-IMPLIES-==_E-**_E-2 (2868 32 (:REWRITE ZERO-DIVISOR-LAW)))
...
(ZERO-DIVISOR-LAW-FOR-**_E (114 56 (:REWRITE EQUIVALENCE-LAW)))
(NATP-SIZE-FOR-==_E (46 22 (:REWRITE EQUIVALENCE-LAW)))
(CONGRUENCE-FOR-SIZE-&-==_E (68 58
                                (:TYPE-PRESCRIPTION NATP-SIZE-FOR-==_E))
                            (66 36 (:REWRITE EQUIVALENCE-LAW))
                            (58 58 (:TYPE-PRESCRIPTION NATP-SIZE))
                            (30 30 (:REWRITE CLOSURE-LAWS)))
(CLOSURE-OF-Q_E-&-R_E-FOR-==_E (57 28 (:REWRITE EQUIVALENCE-LAW)))
(DIVISION-PROPERTY-FOR-==_E (28 2 (:REWRITE DEFAULT-<-1))
                            (14 2
                                (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                            (6 2 (:REWRITE DEFAULT-<-2)))
(A_E-PROPERTY)
(A_E-PROPERTY-1)
(NATP-SIZE-A_E (12 12 (:TYPE-PRESCRIPTION NATP-SIZE))
               (1 1 (:TYPE-PRESCRIPTION NATP-SIZE-A_E)))
(B_E-PROPERTY (9 9 (:TYPE-PRESCRIPTION NATP-SIZE))
              (2 2 (:REWRITE DEFAULT-<-2))
              (2 2 (:REWRITE DEFAULT-<-1)))
(B_E-PROPERTIES-SIZE (9 3 (:REWRITE B_E-PROPERTY))
                     (4 2 (:REWRITE DEFAULT-<-1))
                     (2 2 (:REWRITE DEFAULT-<-2))
                     (1 1 (:TYPE-PRESCRIPTION NATP-SIZE)))
(FIND-SMALLEST-N (82 48 (:REWRITE DEFAULT-<-1))
...
(NATP-FIND-SMALLEST-N (133 77 (:REWRITE DEFAULT-<-1))
                      ...
                      (14 2
                          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(FIND-SMALLEST-N-SIZE-A_E (388 388 (:TYPE-PRESCRIPTION NATP-SIZE))
...
(B_E-FIND-SMALLEST-N (1079 1079 (:TYPE-PRESCRIPTION NATP-SIZE))
...
(NOT-SIZE-B_E-N-=-N (456 456 (:TYPE-PRESCRIPTION NATP-SIZE))
...
(B_E-FIND-SMALLEST-N-0 (70 5 (:DEFINITION FIND-SMALLEST-N))
                       ...
                       (5 5 (:REWRITE DEFAULT-<-1)))
(NOT-SIZE-B_E-N-=-N-1)
(SIZE->=-FIND-SMALLEST-N-0 (14 1 (:DEFINITION FIND-SMALLEST-N))
...
(B_E-FIND-SMALLEST-N-0-DIVIDES-Y (234 15 (:DEFINITION FIND-SMALLEST-N))
...
(|1_E|)
(CLOSURE-LAW-FOR-1-E (56 4 (:DEFINITION FIND-SMALLEST-N))
...
(NULLITY-LAWS)
(ASSOCIATIVITY-SPECIAL-CASE (112 8 (:DEFINITION FIND-SMALLEST-N))
...
(LEFT-UNICITY-LAW-FOR-1_E-==_E (140 10 (:DEFINITION FIND-SMALLEST-N))
...
(LEFT-UNICITY-LAW-FOR-1_E (222 75 (:REWRITE EQUIVALENCE-LAW))
