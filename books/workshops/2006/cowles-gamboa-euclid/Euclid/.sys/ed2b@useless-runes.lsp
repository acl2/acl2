...
(DIVISION-PROPERTY
 (11267 7673 (:REWRITE DEFAULT-*-2))
 (7761 7673 (:REWRITE DEFAULT-*-1))
 (7650 1162 (:REWRITE FLOOR-=-X/Y . 2))
 (7251 3297 (:REWRITE DEFAULT-+-2))
 (6122 4433 (:REWRITE DEFAULT-<-1))
 (5269 4433 (:REWRITE DEFAULT-<-2))
 (5246 3872 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
 (4213 3297 (:REWRITE DEFAULT-+-1))
 (3772 1644 (:REWRITE DEFAULT-UNARY-MINUS))
 (2292 1162 (:REWRITE FLOOR-TYPE-3 . 3))
 (2284 1162 (:REWRITE FLOOR-TYPE-4 . 2))
 (2243 1162 (:REWRITE FLOOR-TYPE-4 . 3))
 (1936 1936 (:REWRITE DEFAULT-UNARY-/))
 (1824 1162 (:REWRITE FLOOR-TYPE-3 . 2))
 (1422 1162 (:REWRITE FLOOR-=-X/Y . 3))
 (1374 1374 (:REWRITE NUMERATOR-WHEN-INTEGERP))
 (1003 431 (:LINEAR X*Y>1-POSITIVE))
