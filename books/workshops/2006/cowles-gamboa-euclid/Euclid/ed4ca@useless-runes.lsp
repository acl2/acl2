...
(INT-C-MOD::UNIT-P)
(INT-C-MOD::ABS-UNIT-P=1 (32 24 (:REWRITE DEFAULT-*-2))
...
(INT-C-MOD::UNIT-P=_+1_OR_-1 (14 14 (:REWRITE INT-C-MOD::DIVIDES-P-SUFF))
...
(INT-C-MOD::REDUCIBLE-P-SUFF (4 4 (:DEFINITION MV-NTH)))
...
(INT-C-MOD::IRREDUCIBLE-FACTORIZATION-EXISTENCE
     (252 12
          (:REWRITE INT-C-MOD::REDUCIBLE-P-SUFF))
     (120 120
          (:TYPE-PRESCRIPTION INT-C-MOD::UNIT-P))
     (120 120
          (:REWRITE INT-C-MOD::UNIT-P=_+1_OR_-1))
