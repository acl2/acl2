...
(INT-MOD::COMMUTATIVITY-LAWS (3 3 (:REWRITE DEFAULT-+-2))
                             (3 3 (:REWRITE DEFAULT-+-1))
                             (3 3 (:REWRITE DEFAULT-*-2))
                             (3 3 (:REWRITE DEFAULT-*-1)))
(INT-MOD::ASSOCIATIVITY-LAWS)
(INT-MOD::LEFT-DISTRIBUTIVITY-LAW (6 2 (:LINEAR X*Y>1-POSITIVE))
...
(INT-MOD::RIGHT-INVERSE-LAW (3 3
                               (:TYPE-PRESCRIPTION |x < y  =>  0 < y-x|)))
(INT-MOD::ZERO-DIVISOR-LAW (1 1 (:REWRITE DEFAULT-*-2))
                           (1 1 (:REWRITE DEFAULT-*-1)))
(INT-MOD::NATP-ABS (14 14 (:REWRITE DEFAULT-<-2))
                   (14 14 (:REWRITE DEFAULT-<-1))
                   (9 9 (:REWRITE DEFAULT-UNARY-MINUS))
                   (1 1
                      (:TYPE-PRESCRIPTION INT-MOD::NATP-ABS)))
(INT-MOD::CONGRUENCE-FOR-ABS)
(INT-MOD::CLOSURE-OF-FLOOR-&-MOD (1 1 (:TYPE-PRESCRIPTION MOD-TYPE . 4))
...
(INT-MOD::CONGRUENCE-FOR-FLOOR-&-MOD
     ...
     (16 16
         (:TYPE-PRESCRIPTION FLOOR-TYPE-1 . 1)))
(INT-MOD::DIVISION-PROPERTY (52 40 (:REWRITE DEFAULT-<-1))
...
(INT-MOD::ABS-* (84 76 (:REWRITE DEFAULT-<-2))
...
(INT-MOD::UNIT-P)
(INT-MOD::ABS-UNIT-P=1 (42 42 (:TYPE-PRESCRIPTION MOD-TYPE . 4))
...
(INT-MOD::UNIT-P=_+1_OR_-1 (14 14 (:REWRITE INT-MOD::DIVIDES-P-SUFF))
...
(INT-MOD::ABS-<-ABS-* (12 12 (:REWRITE DEFAULT-<-2))
...
(INT-MOD::REDUCIBLE-P)
(INT-MOD::REDUCIBLE-P-SUFF (4 4 (:DEFINITION MV-NTH)))
...
(INT-MOD::IRREDUCIBLE-FACTORS (218 14 (:REWRITE INT-MOD::REDUCIBLE-P-SUFF))
...
(INT-MOD::IRREDUCIBLE-FACTORIZATION-EXISTENCE
     ...
     (120 120
          (:TYPE-PRESCRIPTION INT-MOD::UNIT-P))
     (120 120
          (:REWRITE INT-MOD::UNIT-P=_+1_OR_-1))
...
(INT-MOD::IRREDUCIBLE-P-UNIT-ASSOCIATES
     ...
     (1 1
        (:REWRITE INT-MOD::UNIT-ASSOCIATES-P-SUFF)))
