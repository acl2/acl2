...
(INT-RND-REM::COMMUTATIVITY-LAWS (3 3 (:REWRITE DEFAULT-+-2))
                                 (3 3 (:REWRITE DEFAULT-+-1))
                                 (3 3 (:REWRITE DEFAULT-*-2))
                                 (3 3 (:REWRITE DEFAULT-*-1)))
(INT-RND-REM::ASSOCIATIVITY-LAWS)
(INT-RND-REM::LEFT-DISTRIBUTIVITY-LAW (6 2 (:LINEAR X*Y>1-POSITIVE))
...
(INT-RND-REM::ZERO-DIVISOR-LAW (1 1 (:REWRITE DEFAULT-*-2))
                               (1 1 (:REWRITE DEFAULT-*-1)))
(INT-RND-REM::NATP-ABS (14 14 (:REWRITE DEFAULT-<-2))
                       (14 14 (:REWRITE DEFAULT-<-1))
                       (9 9 (:REWRITE DEFAULT-UNARY-MINUS))
                       (1 1
                          (:TYPE-PRESCRIPTION INT-RND-REM::NATP-ABS)))
...
(INT-RND-REM::DIVISION-PROPERTY
     (6315 3349 (:REWRITE DEFAULT-*-2))
     (5240 776 (:REWRITE FLOOR-=-X/Y . 2))
     (3836 1310 (:REWRITE DEFAULT-+-2))
     (3719 2454 (:REWRITE DEFAULT-<-1))
     (3609 2600 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
     (3401 3349 (:REWRITE DEFAULT-*-1))
     (3274 2454 (:REWRITE DEFAULT-<-2))
     (2050 1310 (:REWRITE DEFAULT-+-1))
     (1697 781 (:REWRITE DEFAULT-UNARY-MINUS))
     (1640 776 (:REWRITE FLOOR-TYPE-4 . 2))
     (1506 776 (:REWRITE FLOOR-TYPE-3 . 3))
     (1446 776 (:REWRITE FLOOR-TYPE-4 . 3))
     (1300 1300 (:REWRITE DEFAULT-UNARY-/))
     (1236 776 (:REWRITE FLOOR-TYPE-3 . 2))
     (1009 1009 (:REWRITE NUMERATOR-WHEN-INTEGERP))
     (776 776 (:REWRITE FLOOR-=-X/Y . 3))
     (505 237 (:LINEAR X*Y>1-POSITIVE))
     (201 201 (:REWRITE FOLD-CONSTS-IN-*))
     (59 59 (:REWRITE EQUAL-CONSTANT-+))
     (15 7 (:REWRITE <-*-/-LEFT))
     (7 3 (:REWRITE X*Y>1-POSITIVE))
     (1 1 (:REWRITE <-*-/-RIGHT)))
(INT-RND-REM::ABS-* (84 76 (:REWRITE DEFAULT-<-2))
...
(INT-RND-REM::UNIT-P)
(INT-RND-REM::ABS-UNIT-P=1 (377 67 (:REWRITE DEFAULT-+-2))
...
(INT-RND-REM::UNIT-P=_+1_OR_-1 (14 14
                                   (:REWRITE INT-RND-REM::DIVIDES-P-SUFF))
...
(INT-RND-REM::ABS-<-ABS-* (12 12 (:REWRITE DEFAULT-<-2))
...
(INT-RND-REM::REDUCIBLE-P-SUFF (4 4 (:DEFINITION MV-NTH)))
(INT-RND-REM::IRREDUCIBLE-P)
(INT-RND-REM::IRREDUCIBLE-P-IMPLIES-PRIME-PROPERTY
     (139 8
          (:REWRITE INT-RND-REM::DIVIDES-P-SUFF))
     (103 3
          (:REWRITE INT-RND-REM::REDUCIBLE-P-SUFF))
...
(INT-RND-REM::IRREDUCIBLE-FACTORIZATION-EXISTENCE
     (252 12
          (:REWRITE INT-RND-REM::REDUCIBLE-P-SUFF))
     (120 120
          (:TYPE-PRESCRIPTION INT-RND-REM::UNIT-P))
     (120 120
          (:REWRITE INT-RND-REM::UNIT-P=_+1_OR_-1))
...
(INT-RND-REM::IRREDUCIBLE-P-UNIT-ASSOCIATES
     ...
     (2 2
        (:REWRITE INT-RND-REM::DIVIDES-P-SUFF))
     (1 1
        (:REWRITE INT-RND-REM::UNIT-ASSOCIATES-P-SUFF)))
