(ROUTE)
(ROUTING)
(ROUTE-IDS (714 42 (:REWRITE NTH-WITH-LARGE-INDEX))
...
(VALIDFIELDS-ROUTE (2831 150 (:REWRITE NTH-WITH-LARGE-INDEX))
...
(TRLSTP-ROUTE (204 12 (:REWRITE NTH-WITH-LARGE-INDEX))
...
(TRLSTP-ROUTING (308 20 (:REWRITE NTH-WITH-LARGE-INDEX))
...
(CORRECTROUTESP-ROUTE (3458 219 (:REWRITE NTH-WITH-LARGE-INDEX))
...
(ROUTING-CORRECTROUTESP (480 32 (:REWRITE NTH-WITH-LARGE-INDEX))
...
(TRUE-LISTP-ROUTING)
(ROUTING-NIL)
(TOMISSIVES-ROUTING (97 1 (:DEFINITION TOMISSIVES))
...
(IDS-ROUTING (3334 214 (:REWRITE NTH-WITH-LARGE-INDEX))
             (2033 107 (:DEFINITION NTH))
