...
(32X4-ADD-SHIFT)
(EIF)
(EIF-REWRITE (2 2 (:REWRITE DEFAULT-CDR))
             (2 2 (:REWRITE DEFAULT-CAR)))
(EIF-REWRITE-NIL)
(INCREMENT)
(INCREMENT-REWRITE (11 5 (:REWRITE ZP-OPEN))
                   (10 10 (:REWRITE DEFAULT-CDR))
                   (6 2 (:REWRITE FOLD-CONSTS-IN-+))
                   (5 5 (:REWRITE DEFAULT-CAR))
                   (5 5 (:REWRITE DEFAULT-+-2))
...
(ENIF)
(ENIF-REWRITE (11 11 (:TYPE-PRESCRIPTION EIF))
              (2 2 (:REWRITE DEFAULT-CDR))
              (2 2 (:REWRITE DEFAULT-CAR)))
(ENIF-NIL)
(NEXT_DIGIT_COUNTER_STATE_OPEN (26 26 (:REWRITE DEFAULT-CDR))
                               (18 18 (:REWRITE DEFAULT-CAR)))
(NEXT_COUNTER_STATE)
(EEIF)
(EEIF-OPEN (2 2 (:REWRITE DEFAULT-CDR))
           (2 2 (:REWRITE DEFAULT-CAR)))
(EEIF-NIL)
(NEXT_COUNTER_STATE-REWRITE (74 35 (:REWRITE DEFAULT-CAR))
