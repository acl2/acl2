...
(STYPE-P (469 28 (:DEFINITION ACL2-COUNT))
         ...
         (3 3 (:REWRITE |(< 0 (- x))|)))
(STYPE-COMPOUND-RECOGNIZER (210 10 (:LINEAR ACL2-COUNT-0-LEN-0))
                           (178 7 (:DEFINITION FUN-P))
                           (146 5 (:REWRITE PRODUCT-TYPE-FUN-P))
                           (146 3 (:DEFINITION BOOL-P))
                           (140 1 (:REWRITE PRODUCT-TYPE-BOOL-P))
                           (138 3 (:REWRITE FUN-P-PRODUCT-TYPE))
                           (136 2 (:REWRITE BOOL-P-PRODUCT-TYPE))
                           (120 10 (:DEFINITION ACL2-COUNT))
                           (100 100 (:TYPE-PRESCRIPTION ACL2-COUNT))
                           (89 4 (:REWRITE NTH-WITH-LARGE-INDEX))
                           (79 2 (:DEFINITION NTH))
                           (78 34 (:REWRITE DEFAULT-+-2))
                           (70 14 (:DEFINITION LEN))
                           (60 10 (:DEFINITION LENGTH))
                           (57 1 (:DEFINITION FUN-DOMAIN))
                           (56 1 (:DEFINITION FUN-RANGE))
                           ...
                           (13 1 (:REWRITE NOT-FUN-P-FUN-DOMAIN))
                           (11 1 (:REWRITE NOT-FUN-P-FUN-RANGE))
                           (10 10 (:REWRITE FOLD-CONSTS-IN-+))
                           (10 10 (:REWRITE |(equal (- x) 0)|))
                           (10 10 (:LINEAR LEQ-POSITION-EQUAL-LEN))
                           (5 5 (:TYPE-PRESCRIPTION FUN-P))
...
(EXPRESSION-COMPOUND-RECOGNIZER
     (1281 61 (:LINEAR ACL2-COUNT-0-LEN-0))
     (732 61 (:DEFINITION ACL2-COUNT))
     (610 610 (:TYPE-PRESCRIPTION ACL2-COUNT))
     (480 16 (:DEFINITION IFELSE-P))
     (453 196 (:REWRITE DEFAULT-+-2))
     (440 11 (:DEFINITION VAR-P))
     (438 10 (:REWRITE IFELSE-P-PRODUCT-TYPE))
     (428 9 (:REWRITE VAR-P-PRODUCT-TYPE))
     (421 1 (:REWRITE PRODUCT-TYPE-TRUE-P))
     (421 1 (:REWRITE PRODUCT-TYPE-FALSE-P))
     (400 18 (:REWRITE NTH-WITH-LARGE-INDEX))
     (390 7 (:REWRITE PRODUCT-TYPE-LAM-P))
     (383 11 (:DEFINITION APP-P))
     (370 74 (:DEFINITION LEN))
     (355 9 (:DEFINITION NTH))
     (352 8 (:REWRITE APP-P-PRODUCT-TYPE))
     (336 56 (:DEFINITION LENGTH))
     (326 11 (:DEFINITION LAM-P))
     (311 5 (:REWRITE PRODUCT-TYPE-APP-P))
     (293 293 (:TYPE-PRESCRIPTION LEN))
     (276 7 (:REWRITE LAM-P-PRODUCT-TYPE))
     (257 196 (:REWRITE DEFAULT-+-1))
     (233 3 (:REWRITE PRODUCT-TYPE-VAR-P))
     (212 4 (:DEFINITION FALSE-P))
     (207 6 (:REWRITE FALSE-P-PRODUCT-TYPE))
     (177 177 (:REWRITE DEFAULT-CDR))
     (161 7 (:REWRITE PRODUCT-TYPE-IFELSE-P))
     (146 3 (:DEFINITION TRUE-P))
     (144 33 (:DEFINITION TRUE-LISTP))
     (140 6 (:REWRITE TRUE-P-PRODUCT-TYPE))
     ...
     (57 1 (:DEFINITION VAR-NAME))
     (57 1 (:DEFINITION LAM-VAR))
     (57 1 (:DEFINITION IFELSE-COND))
     (57 1 (:DEFINITION APP-FUN))
     (56 1 (:DEFINITION LAM-TYPE))
     (56 1 (:DEFINITION LAM-BODY))
     (56 1 (:DEFINITION IFELSE-CASE2))
     (56 1 (:DEFINITION IFELSE-CASE1))
     (56 1 (:DEFINITION APP-ARG))
     (41 1 (:REWRITE NOT-LAM-P-LAM-VAR))
     (31 1 (:REWRITE NOT-APP-P-APP-FUN))
     (22 1 (:REWRITE NOT-VAR-P-VAR-NAME))
     ...
     (16 16 (:TYPE-PRESCRIPTION VN-P))
     (14 14 (:TYPE-PRESCRIPTION FUN-P))
     (13 13 (:TYPE-PRESCRIPTION IFELSE-P))
     (13 1 (:REWRITE NOT-IFELSE-P-IFELSE-COND))
     (12 12 (:TYPE-PRESCRIPTION BOOL-P))
     (12 6 (:DEFINITION PRODUCT-TYPE))
     (11 1 (:REWRITE NOT-LAM-P-LAM-TYPE))
     (11 1 (:REWRITE NOT-LAM-P-LAM-BODY))
     (11 1 (:REWRITE NOT-IFELSE-P-IFELSE-CASE2))
     (11 1 (:REWRITE NOT-IFELSE-P-IFELSE-CASE1))
     (11 1 (:REWRITE NOT-APP-P-APP-ARG))
     (10 10 (:TYPE-PRESCRIPTION VAR-P))
     (10 2 (:REWRITE VARNAME-LISTP-NTH))
     (9 9 (:TYPE-PRESCRIPTION APP-P))
     (9 9 (:REWRITE DEFAULT-<-1))
     (9 9 (:REWRITE |(< (- x) (- y))|))
     (8 8 (:TYPE-PRESCRIPTION LAM-P))
     (6 2 (:REWRITE VN-NOT-VARNAME))
     (4 4 (:REWRITE |(< 0 (- x))|))
     (4 2 (:DEFINITION VARNAME-LISTP))
     (3 3 (:TYPE-PRESCRIPTION FALSE-P))
     (3 1 (:REWRITE FUN-NOT-STYPE))
     (2 2 (:TYPE-PRESCRIPTION VARNAME-LISTP))
     (2 2 (:TYPE-PRESCRIPTION TRUE-P))
     (2 2
        (:REWRITE VARNAME-LISTP-MEMBERP-EQUAL))
     (2 2 (:REWRITE VARNAME-LISTP-MEMBER-EQUAL))
     (2 2
        (:REWRITE VARNAME-LISTP-INITIAL-SUBLISTP-EQUAL)))
...
(TYPE-DERIV-COMPOUND-RECOGNIZER (1239 59 (:LINEAR ACL2-COUNT-0-LEN-0))
                                (708 59 (:DEFINITION ACL2-COUNT))
                                (590 590 (:TYPE-PRESCRIPTION ACL2-COUNT))
                                (473 15 (:DEFINITION T-IF-P))
                                (465 14 (:DEFINITION T-APP-P))
                                (439 1 (:REWRITE PRODUCT-TYPE-T-TRUE-P))
                                (439 1 (:REWRITE PRODUCT-TYPE-T-FALSE-P))
                                (429 9 (:REWRITE T-IF-P-PRODUCT-TYPE))
                                (421 181 (:REWRITE DEFAULT-+-2))
                                (419 8 (:REWRITE T-APP-P-PRODUCT-TYPE))
                                (372 1 (:REWRITE PRODUCT-TYPE-T-VAR-P))
                                (360 8 (:DEFINITION T-ABS-P))
                                (343 7 (:REWRITE T-ABS-P-PRODUCT-TYPE))
                                (327 3 (:REWRITE PRODUCT-TYPE-T-ABS-P))
                                (315 63 (:DEFINITION LEN))
                                (311 14 (:REWRITE NTH-WITH-LARGE-INDEX))
                                (294 49 (:DEFINITION LENGTH))
                                (278 5 (:DEFINITION T-VAR-P))
                                (276 7 (:DEFINITION NTH))
                                (274 6 (:REWRITE T-VAR-P-PRODUCT-TYPE))
                                (272 272 (:TYPE-PRESCRIPTION LEN))
                                (256 7 (:REWRITE PRODUCT-TYPE-T-APP-P))
                                (240 181 (:REWRITE DEFAULT-+-1))
                                (212 4 (:DEFINITION T-FALSE-P))
                                (207 6 (:REWRITE T-FALSE-P-PRODUCT-TYPE))
                                (179 7 (:REWRITE PRODUCT-TYPE-T-IF-P))
                                (162 162 (:REWRITE DEFAULT-CDR))
                                (146 3 (:DEFINITION T-TRUE-P))
                                (144 33 (:DEFINITION TRUE-LISTP))
                                (140 6 (:REWRITE T-TRUE-P-PRODUCT-TYPE))
                                ...
                                (57 1 (:DEFINITION T-IF-COND))
                                (57 1 (:DEFINITION T-APP-ARGTYPE))
                                (57 1 (:DEFINITION T-ABS-BODY))
                                (56 1 (:DEFINITION T-IF-CASE2))
                                (56 1 (:DEFINITION T-IF-CASE1))
                                (56 1 (:DEFINITION T-APP-FUN))
                                (56 1 (:DEFINITION T-APP-ARG))
                                (31 1 (:REWRITE NOT-T-ABS-P-T-ABS-BODY))
                                (23 1 (:REWRITE NOT-T-APP-P-T-APP-ARGTYPE))
                                (18 6 (:REWRITE VN-P-PRODUCT-TYPE))
                                ...
                                (14 14 (:TYPE-PRESCRIPTION FUN-P))
                                (14 7 (:REWRITE DEFAULT-<-2))
                                (13 1 (:REWRITE NOT-T-IF-P-T-IF-COND))
                                (12 12 (:TYPE-PRESCRIPTION VN-P))
                                ...
                                (12 12 (:TYPE-PRESCRIPTION APP-P))
                                (12 6 (:DEFINITION PRODUCT-TYPE))
                                (11 11 (:TYPE-PRESCRIPTION T-APP-P))
                                (11 1 (:REWRITE NOT-T-IF-P-T-IF-CASE2))
                                (11 1 (:REWRITE NOT-T-IF-P-T-IF-CASE1))
                                (11 1 (:REWRITE NOT-T-APP-P-T-APP-FUN))
                                (11 1 (:REWRITE NOT-T-APP-P-T-APP-ARG))
                                (7 7 (:TYPE-PRESCRIPTION T-ABS-P))
                                (7 7 (:REWRITE DEFAULT-<-1))
                                (7 7 (:REWRITE |(< (- x) (- y))|))
                                (4 4 (:TYPE-PRESCRIPTION T-VAR-P))
                                (3 3 (:TYPE-PRESCRIPTION T-FALSE-P))
                                (3 3 (:REWRITE |(< 0 (- x))|))
                                (3 1 (:REWRITE FUN-NOT-STYPE))
...
(EVAL-DERIV-P (1469 85 (:LINEAR ACL2-COUNT-0-LEN-0))
              ...
              (6 3 (:REWRITE |(< (+ c x) d)|))
              (6 3 (:DEFINITION TRUE-LISTP)))
(EVAL-DERIV-COMPOUND-RECOGNIZER (1155 55 (:LINEAR ACL2-COUNT-0-LEN-0))
                                (660 55 (:DEFINITION ACL2-COUNT))
                                (550 550 (:TYPE-PRESCRIPTION ACL2-COUNT))
                                (499 3 (:REWRITE PRODUCT-TYPE-E-APP1-P))
                                (457 1 (:REWRITE PRODUCT-TYPE-E-APPABS-P))
                                (435 9 (:REWRITE E-IFTRUE-P-PRODUCT-TYPE))
                                (435 9 (:REWRITE E-IFFALSE-P-PRODUCT-TYPE))
                                (431 10 (:DEFINITION E-IFTRUE-P))
                                (431 10 (:DEFINITION E-IFFALSE-P))
                                (422 3 (:REWRITE PRODUCT-TYPE-E-APP2-P))
                                (381 163 (:REWRITE DEFAULT-+-2))
                                (376 10 (:DEFINITION E-IFCOND-P))
                                (363 9 (:REWRITE E-IFCOND-P-PRODUCT-TYPE))
                                (345 3 (:REWRITE PRODUCT-TYPE-E-IFCOND-P))
                                (302 8 (:DEFINITION E-APP2-P))
                                (286 8 (:REWRITE E-APP2-P-PRODUCT-TYPE))
                                (282 47 (:DEFINITION LENGTH))
                                (265 53 (:DEFINITION LEN))
                                (256 1 (:REWRITE PRODUCT-TYPE-E-IFTRUE-P))
                                (241 241 (:TYPE-PRESCRIPTION LEN))
                                (228 6 (:DEFINITION E-APP1-P))
                                (218 163 (:REWRITE DEFAULT-+-1))
                                (209 7 (:REWRITE E-APP1-P-PRODUCT-TYPE))
                                (189 1 (:REWRITE PRODUCT-TYPE-E-IFFALSE-P))
                                (146 3 (:DEFINITION E-APPABS-P))
                                (144 144 (:REWRITE DEFAULT-CDR))
                                (144 33 (:DEFINITION TRUE-LISTP))
                                (140 6 (:REWRITE E-APPABS-P-PRODUCT-TYPE))
                                (135 6 (:REWRITE NTH-WITH-LARGE-INDEX))
                                (125 125 (:REWRITE |(equal (- x) (- y))|))
                                (120 3 (:DEFINITION NTH))
                                (102 102 (:REWRITE DEFAULT-CAR))
                                (57 1 (:DEFINITION E-IFCOND-COND))
                                (57 1 (:DEFINITION E-APP2-ARG))
                                (57 1 (:DEFINITION E-APP1-FUN))
                                ...
                                (12 12 (:TYPE-PRESCRIPTION APP-P))
                                (12 6 (:DEFINITION PRODUCT-TYPE))
                                (9 9 (:TYPE-PRESCRIPTION E-IFTRUE-P))
                                (9 9 (:TYPE-PRESCRIPTION E-IFFALSE-P))
                                (9 9 (:TYPE-PRESCRIPTION E-IFCOND-P))
                                (7 7 (:TYPE-PRESCRIPTION E-APP2-P))
                                (6 6 (:TYPE-PRESCRIPTION NFIX))
                                (6 3 (:REWRITE DEFAULT-<-2))
                                (5 5 (:TYPE-PRESCRIPTION E-APP1-P))
                                (3 3 (:REWRITE DEFAULT-<-1))
                                (3 3 (:REWRITE |(< 0 (- x))|))
                                (3 3 (:REWRITE |(< (- x) (- y))|))
