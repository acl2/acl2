(NTH-OPEN (14 4 (:REWRITE ZP-OPEN))
          ...
          (2 2 (:REWRITE |(< (- x) (- y))|)))
(UPDATE-NTH-OPEN (13 3 (:REWRITE ZP-OPEN))
                 (8 2 (:REWRITE |(< d (+ c x))|))
...
(ACL2-COUNT-NTH-MEASURE (247 127 (:REWRITE DEFAULT-+-2))
                        ...
                        (9 6 (:REWRITE |(< d (+ c x y))|))
                        (2 2 (:REWRITE |(< 0 (- x))|)))
(ACL2-COUNT-CONSP-POSP (29 14 (:REWRITE DEFAULT-+-2))
                       ...
                       (1 1 (:REWRITE |(< 0 (- x))|))
                       (1 1 (:REWRITE |(< (- x) (- y))|)))
(ACL2-COUNT-0-LEN-0 (50 27 (:REWRITE DEFAULT-+-2))
                    ...
                    (2 2 (:REWRITE DEFAULT-CAR)))
(ACL2-COUNT-NTH-LEN-2 (816 421 (:REWRITE DEFAULT-+-2))
