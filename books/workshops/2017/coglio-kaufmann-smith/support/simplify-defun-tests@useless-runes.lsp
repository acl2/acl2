...
(INTEGERP-OF-CAR (1 1 (:REWRITE DEFAULT-CAR)))
(FOO)
(FOO$NOT-NORMALIZED)
(FOO{1})
(FOO-HYPS)
...
(FOO-LST-BECOMES-FOO-LST{1})
(F1)
(ACL2-NUMBERP-OF-CAR (1 1 (:REWRITE DEFAULT-CAR)))
(F1$NOT-NORMALIZED)
(F2$NOT-NORMALIZED)
(F1{1})
(F1-HYPS)
...
(F-BECOMES-F{1})
(FIX-TRUE-LISTP)
(MEMBER-FIX-TRUE-LISTP (76 40 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
...
(F1-MEASURE-LEMMA)
(F1$NOT-NORMALIZED)
(F1{1} (25 5 (:DEFINITION F1$NOT-NORMALIZED))
...
(F6$NOT-NORMALIZED)
(F6{1} (1 1 (:TYPE-PRESCRIPTION F6{1})))
(F6-BEFORE-VS-AFTER-0)
(F6-BEFORE-VS-AFTER-1)
(F6{1}-COPY (1 1 (:TYPE-PRESCRIPTION F6{1}-COPY)))
(F6{1}-COPY-DEF)
(F6{1}-IS-F6{1}-COPY)
(F6-BECOMES-F6{1}-LEMMA)
(F6-BECOMES-F6{1})
...
(F2)
(F2$NOT-NORMALIZED)
(F2{1} (4 2 (:TYPE-PRESCRIPTION RETURN-LAST))
       (2 2
          (:TYPE-PRESCRIPTION THROW-NONEXEC-ERROR)))
(F2-BEFORE-VS-AFTER-0)
(F2{1}-COPY)
...
(FOO (1 1 (:REWRITE DEFAULT-CDR))
     (1 1 (:REWRITE DEFAULT-CAR)))
(CAR-RATIONAL-LISTP (4 4 (:REWRITE DEFAULT-CAR))
                    (1 1
                       (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                    (1 1 (:REWRITE DEFAULT-CDR)))
(FOO$NOT-NORMALIZED)
(FOO{1} (5 5 (:REWRITE DEFAULT-CDR))
        (5 5 (:REWRITE DEFAULT-CAR)))
(FOO-HYPS)
(FOO{1}-BEFORE-VS-AFTER-0)
(FOO-HYPS-PRESERVED-FOR-FOO (2 2 (:REWRITE DEFAULT-CDR))
...
(FOO-BECOMES-FOO{1})
(LENB)
(LEN-BECOMES-LENB (16 8 (:REWRITE DEFAULT-+-2))
...
(LENB-BECOMES-LENB{1})
(LENB)
(LENB-BECOMES-LEN (12 6 (:REWRITE DEFAULT-+-2))
