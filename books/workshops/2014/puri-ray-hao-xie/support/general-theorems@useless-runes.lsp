(PHI-RESTRICTION-NEXT-BLOCK (800 160 (:DEFINITION LEN))
...
(PHI-RESTRICTION-RUN-LISTS (330 330 (:REWRITE DEFAULT-CAR))
                           (321 321 (:REWRITE DEFAULT-CDR)))
(PHI-RESTRICTION-RUN-BLOCK (24 24 (:REWRITE DEFAULT-CAR))
                           (19 19 (:REWRITE DEFAULT-CDR)))
(PHI-RESTRICTION-BLOCK-SET (88 88 (:REWRITE DEFAULT-CAR))
                           (69 69 (:REWRITE DEFAULT-CDR)))
(PHI-RESTRICTION-BLOCK-ITERS (35 14 (:REWRITE ZP-OPEN))
...
(PHI-RESTRICTION-APPEND-REVERSE
     ...
     (13 13
         (:TYPE-PRESCRIPTION PHI-STATEMENTS-AUX-P))
...
(PHI-RESTRICTION-REMOVE-N (1056 11 (:DEFINITION PHI-RESTRICTION-LIST))
                          ...
                          (5 5 (:REWRITE ZP-OPEN)))
(PHI-RESTRICTION-TAKE-N (960 10 (:DEFINITION PHI-RESTRICTION-LIST))
                        ...
                        (5 5 (:REWRITE ZP-OPEN)))
(PHI-RESTRICTION-CDR (106 1 (:DEFINITION PHI-RESTRICTION-BLOCK))
                     ...
                     (1 1
                        (:TYPE-PRESCRIPTION PHI-STATEMENTS-AUX-P))
                     (1 1
                        (:TYPE-PRESCRIPTION PHI-RESTRICTION-LIST))
...
(BRANCH-RESTRICTION-LIST-GET-NEXT-BLOCK
     ...
     (4 4 (:DEFINITION FIX)))
(BRANCH-RESTRICTION-BLOCK-GET-NEXT-BLOCK (12 12 (:REWRITE DEFAULT-CAR))
                                         (6 6 (:REWRITE DEFAULT-CDR)))
(BRANCH-RESTRICTION-CCDFG-CDR
     (217 1
          (:DEFINITION BRANCH-RESTRICTION-BLOCK))
     (207 1 (:DEFINITION BRANCH-RESTRICTION-LIST))
     (191 1 (:DEFINITION BRANCH-STATEMENT-P))
     (114 20 (:REWRITE O-P-O-INFP-CAR))
     (99 1
         (:DEFINITION UNCONDITIONAL-BRANCH-STATEMENT-P))
     (78 1
         (:DEFINITION CONDITIONAL-BRANCH-STATEMENT-P))
     ...
     (1 1
        (:TYPE-PRESCRIPTION BRANCH-RESTRICTION-LIST)))
(BRANCH-RESTRICTION-CCDFG-CAR
     ...
     (4 1
        (:REWRITE BRANCH-RESTRICTION-CCDFG-CDR)))
(BRANCH-RESTRICTION-REMOVE-N
     (2484 12
           (:DEFINITION BRANCH-RESTRICTION-LIST))
...
(BRANCH-RESTRICTION-TAKE-N
     ...
     (20 5
         (:REWRITE BRANCH-RESTRICTION-CCDFG-CDR))
     (4 4 (:REWRITE ZP-OPEN)))
(TAKE-N-1 (10 10 (:REWRITE DEFAULT-CAR))
          (8 8 (:REWRITE DEFAULT-CDR))
          (2 2 (:META CANCEL_TIMES-EQUAL-CORRECT))
          (2 2 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(REMOVE-N-1 (5 5 (:REWRITE DEFAULT-CDR))
            (2 2 (:META CANCEL_TIMES-EQUAL-CORRECT))
            (2 2 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(M)
(ADD-3)
...
(RUN-BLOCK-SET-APPEND (53 47 (:REWRITE DEFAULT-CAR))
...
(RUN-BLOCK-SET-REVERSE-APPEND (3 1 (:DEFINITION BINARY-APPEND))
                              (1 1 (:REWRITE DEFAULT-CDR))
                              (1 1 (:REWRITE DEFAULT-CAR)))
(RUN-BLOCK->RUN-SET (7 7 (:REWRITE DEFAULT-CAR))
                    (6 6 (:REWRITE DEFAULT-CDR)))
(RUN-BLOCK-SET-CONS (1278 6 (:DEFINITION BRANCH-RESTRICTION-LIST))
...
(INDUCTION-HINT-RUN-BLOCK-SET-REMOVE-TAKE-N
     ...
     (1 1 (:REWRITE DEFAULT-+-2))
     (1 1 (:REWRITE DEFAULT-+-1)))
(RUN-BLOCK-SET-REMOVE-TAKE-N (41 41 (:REWRITE DEFAULT-CDR))
                             ...
                             (5 5 (:DEFINITION NOT))
                             (2 1
                                (:REWRITE BRANCH-RESTRICTION-REMOVE-N)))
(TAKE-RETURN-TAKE (140 140 (:REWRITE DEFAULT-CDR))
...
(K (4 4
   ...
   (2 2 (:REWRITE DEFAULT-+-1))
   (2 1 (:REWRITE M)))
(RUN-BLOCK-ITERS-APPEND-SUBGOAL (35 17 (:REWRITE ZP-OPEN))
                                (27 27 (:REWRITE DEFAULT-+-2))
                                (27 27 (:REWRITE DEFAULT-+-1))
                                (17 11 (:REWRITE FOLD-CONSTS-IN-+))
                                (15 15 (:REWRITE DEFAULT-<-2))
                                (15 15 (:REWRITE DEFAULT-<-1)))
(RUN-BLOCK-ITERS-APPEND (1 1 (:REWRITE DEFAULT-<-2))
                        (1 1 (:REWRITE DEFAULT-<-1))
                        (1 1 (:REWRITE DEFAULT-+-2))
                        (1 1 (:REWRITE DEFAULT-+-1)))
(RUN-BLOCK-ITERS-ADD (2 2 (:REWRITE DEFAULT-<-2))
                     (2 2 (:REWRITE DEFAULT-<-1))
                     (1 1 (:REWRITE DEFAULT-+-2))
                     (1 1 (:REWRITE DEFAULT-+-1)))
(PRE-LOOP-CDR-SAME (57 57 (:REWRITE DEFAULT-CDR))
...
(TAKE-N-PLUS-INTERVAL (2 2 (:REWRITE DEFAULT-<-2))
                      (2 2 (:REWRITE DEFAULT-<-1))
                      (2 2 (:REWRITE DEFAULT-+-2))
                      (2 2 (:REWRITE DEFAULT-+-1)))
