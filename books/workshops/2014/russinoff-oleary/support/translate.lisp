...
#|
The translation of a C++ model to ACL2 is performed in two phases:

(1) The parser generates a file containing an S-expression representation of
...
#|
The S-expression generated by the parser for a C function has the form
...
The overall strategy in the translation of a C function to ACL2 is to construct a nest
...
In addition to the top-level ACL2 function corrrsponding to a C function, a separate
