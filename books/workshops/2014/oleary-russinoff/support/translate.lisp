...
(1) The MASC parser generates a file containing an S-expression representation of 
...
The overall strategy in the translation of a MASC function to ACL2 is to construct a nest 
...
In addition to the top-level ACL2 function corrrsponding to a MASC function, a separate 
