...
\bookpath{kestrel/alists-light}: A ``minimalist'' library about alists.
...
\bookpath{kestrel/arithmetic-light}: A ``minimalist'' library about arithmetic.
\begin{itemize}
...
\bookpath{kestrel/axe}: Kestrel's Axe toolkit.
\begin{itemize}
...
\bookpath{kestrel/booleans}: A lightweight library about operations on booleans.
\begin{itemize}
...
\bookpath{kestrel/bv}: Kestrel's library about bit-vectors (BVs)
\begin{itemize}
...
\bookpath{kestrel/bv-lists}: A library about lists of BVs (see also kestrel/bv).
\begin{itemize}
