...
\item Some fancy rewriter features discussed in \textit{New Rewriter Features in FGL}
\end{itemize}
...
\begin{itemize}
\item Based on \bookpath{clause-processors/pseudo-term-fty}, treats pseudo-term as an FTY sum type
...
\item Added \code{defret-mutual-generate}, discussed in paper \textit{Generating Mutually Inductive Theorems...}
\end{itemize}
