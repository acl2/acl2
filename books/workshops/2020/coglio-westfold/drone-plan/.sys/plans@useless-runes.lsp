(INTERSECTION-EQUAL-OF-CONS-IFF
 (2032 6 (:DEFINITION SUBSETP-EQUAL))
...
(DRONE-ID-LIST-P-ALIST-KEYS-PATH-MAP
 (3379 81 (:REWRITE NO-DUPLICATESP-EQUAL-WHEN-NO-DUPLICATESP-EQUAL-OF-CDR))
 (2119 130 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (1074 4 (:REWRITE NO-DUPLICATESP-EQUAL-OF-CONS-NO-SPLIT))
 (963 57 (:REWRITE NO-DUPLICATESP-EQUAL-OF-CDR))
 (950 6 (:REWRITE NO-DUPLICATE-ALIST-CAAR-ALIST-KEYS-CDR))
...
(PLAN-FOR-ID-SUBSET-P
 (6716 39 (:DEFINITION TRUE-LISTP))
 (6545 105 (:REWRITE NODE-LIST-P-TRUE-LISTP1))
 (4989 73 (:REWRITE TRUE-LISTP-OF-CDR-0))
...
(TRUE-ALISTP-CDR
 (488 7 (:REWRITE TRUE-LISTP-OF-CDR-0))
 (419 8 (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
 (413 4 (:DEFINITION TRUE-LIST-LISTP))
 (408 5 (:DEFINITION TRUE-LISTP))
...
(FILTER-UNPRODUCTIVE-PLANS-PLAN-FOR-ID-SUBSET-P
 (164702 70 (:REWRITE SUBSEQUENCEP-EQUAL-EQUAL-LEN))
 (135636 156 (:DEFINITION TRUE-LISTP))
 ...
 (55197 42 (:REWRITE SUBSEQUENCEP-EQUAL-OF-CDR-RIGHT))
 (53888 256 (:REWRITE TRUE-LISTP-OF-CDR-0))
...
(FILTER-REDUNDANT-DESTINATION-PLANS-1-AUX-PLAN-FOR-ID-SUBSET-P
 (47032 60 (:REWRITE SUBSEQUENCEP-EQUAL-EQUAL-LEN))
 ...
 (33733 108 (:DEFINITION TRUE-LISTP))
 (26080 12 (:DEFINITION SUBSETP-EQUAL))
 (14298 192 (:REWRITE NODE-LIST-P-OF-CDR))
 (13224 477 (:REWRITE PATHS-NOT-ENDING-IN-SET-WHEN-NOT-CONSP))
 (12397 888 (:REWRITE LEN-OF-CDR))
 (10951 36 (:REWRITE SUBSEQUENCEP-EQUAL-OF-CDR-RIGHT))
 (9707 168 (:REWRITE TRUE-LISTP-OF-CDR-0))
