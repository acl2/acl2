...
(NTH-OF-DRONE-ID-LIST-FIX
     ...
     (50 13
         (:REWRITE CONSP-OF-DRONE-ID-LIST-FIX))
...
(DRONE-ID-LIST-EQUIV-IMPLIES-DRONE-ID-LIST-EQUIV-APPEND-1
     ...
     (131 17
          (:REWRITE DRONE-ID-P-DRONE-ID-FIX-ID))
     (126 126
          (:TYPE-PRESCRIPTION DRONE-ID-LIST-P))
     (80 17
         (:REWRITE DRONE-ID-P-OF-CAR-WHEN-DRONE-ID-LIST-P))
     (79 22
         (:REWRITE DRONE-ID-LIST-P-OF-CDR-WHEN-DRONE-ID-LIST-P))
...
(TRUE-ALISTP-CDR (484 7 (:REWRITE TRUE-LISTP-OF-CDR-0))
                 (415 8
                      (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
...
(TRUE-ALISTP-CDAR (18 1 (:REWRITE CONSP-FROM-LEN-CHEAP))
                  (4 4
                     (:LINEAR LOWER-BOUND-OF-LEN-WHEN-SUBSEQUENCEP-EQUAL))
                  (4 4
                     (:LINEAR LOWER-BOUND-OF-LEN-WHEN-SUBLISTP))
                  ...
                  (1 1
                     (:REWRITE CONSP-WHEN-LEN-EQUAL-CONSTANT)))
(COLLECT-LOCS (22 5 (:REWRITE CONSP-FROM-LEN-CHEAP))
              ...
              (1 1
                 (:LINEAR LEN-POSITIVE-WHEN-CONSP-LINEAR-CHEAP)))
(MAX-PLAN-LENGTH (24 7 (:REWRITE CONSP-FROM-LEN-CHEAP))
