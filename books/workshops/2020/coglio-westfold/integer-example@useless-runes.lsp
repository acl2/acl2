...
(ALPHA-IMAGE (4 2 (:REWRITE DEFAULT-<-1))
             (2 2 (:REWRITE DEFAULT-<-2)))
(BETA-IMAGE)
(BETA-OF-ALPHA)
(ALPHA-OF-BETA (10 10 (:REWRITE DEFAULT-<-2))
...
(OLDP-OF-REC-CALL-ARGS (52 36 (:REWRITE DEFAULT-<-1))
...
(DRAWLINE-LOOP{1})
(DRAWLINE-LOOP{1}$NOT-NORMALIZED)
(DRAWLINE-LOOP{2} (2832 2238 (:REWRITE DEFAULT-<-1))
...
(DRAWLINE{1})
(DRAWLINE{1}$NOT-NORMALIZED)
(DRAWLINE{2} (213 174 (:REWRITE DEFAULT-<-1))
