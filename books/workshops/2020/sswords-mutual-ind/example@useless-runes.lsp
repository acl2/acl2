...
(STD::EV-ALIST)
(STD::LOOKUP-IN-EV-ALIST (106 102 (:REWRITE DEFAULT-CAR))
                         ...
                         (16 16
                             (:REWRITE STD::EV-TERM-OF-FNCALL-ARGS)))
(STD::SUBST-TERM)
(STD::SUBST-TERM-IND)
...
(STD::SUBST-TERM-FLAG)
(STD::SUBST-TERM-FLAG-EQUALS-SUBST-TERM (78 78 (:REWRITE DEFAULT-CAR))
...
(STD::SUBST-TERM-FLAG (4 2 (:TYPE-PRESCRIPTION RETURN-LAST))
                      (2 2
...
(STD::CONSP-ASSOC-EQUAL-IFF (38 38 (:REWRITE DEFAULT-CAR))
...
(STD::SUBST-TERM (50 6 (:DEFINITION LENGTH))
...
(STD::REMOVE-RETURN-LAST-TERM (767 341 (:REWRITE DEFAULT-+-2))
...
(STD::REMOVE-RETURN-LAST-FLAG (767 341 (:REWRITE DEFAULT-+-2))
                              (471 341 (:REWRITE DEFAULT-+-1))
                              (264 66 (:DEFINITION INTEGER-ABS))
                              (264 33 (:DEFINITION LENGTH))
                              (165 33 (:DEFINITION LEN))
...
(STD::EQUAL-OF-LEN (9 5 (:REWRITE DEFAULT-+-2))
...
(STD::REMOVE-RETURN-LAST-TERM-CORRECT
     (18 1
         (:DEFINITION STD::REMOVE-RETURN-LAST-TERM))
     (9 9 (:REWRITE DEFAULT-CAR))
     (8 8 (:REWRITE DEFAULT-CDR))
     (2 2 (:REWRITE STD::RL-EV-OF-VARIABLE))
     (2 2
        (:REWRITE STD::RL-EV-OF-RETURN-LAST-CALL))
...
(STD::REMOVE-RETURN-LAST-TERMLIST-CORRECT
     (3 1
        (:DEFINITION STD::REMOVE-RETURN-LAST-TERMLIST))
