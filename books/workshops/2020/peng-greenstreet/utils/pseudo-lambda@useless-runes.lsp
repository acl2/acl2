...
(EQUAL-FIXED-AND-X-OF-PSEUDO-LAMBDAP
 (14848 1330 (:REWRITE CONSP-OF-PSEUDO-LAMBDAP))
 (14203 511 (:REWRITE CONSP-OF-CDDR-OF-PSEUDO-LAMBDAP))
 (11252 1671 (:REWRITE DEFAULT-CAR))
 (11202 223 (:REWRITE SYMBOLP-OF-CAAR-WHEN-SYMBOL-SYMBOL-ALISTP))
 (10876 960 (:REWRITE CONSP-OF-CDR-OF-PSEUDO-LAMBDAP))
 (8949 314 (:REWRITE SYMBOL-SYMBOL-ALISTP-OF-CDR-WHEN-SYMBOL-SYMBOL-ALISTP))
 (8921 405 (:REWRITE TRUE-LISTP-OF-CDR-OF-PSEUDO-LAMBDAP))
 (5891 2814 (:REWRITE DEFAULT-CDR))
 (4710 47 (:REWRITE PSEUDO-LAMBDAP-OF-CAR-WHEN-PSEUDO-TERMP))
 (3851 706 (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
 (2604 47 (:REWRITE PSEUDO-LAMBDAP-OF-CAR-WHEN-PSEUDO-LAMBDA-LISTP))
 (2016 64 (:REWRITE PSEUDO-LAMBDA-LISTP-WHEN-NOT-CONSP))
 ...
 (330 35 (:REWRITE EQUAL-LEN-OF-PSEUDO-LAMBDA-FORMALS-AND-ACTUALS))
