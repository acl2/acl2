...
A formalization of the ACL2 programming language:
\begin{itemize}
...
A library for C.
\begin{itemize}
\item ATC, the C code generator for ACL2, described in a paper at this Workshop.
\item Formal model of a subset of C.
\end{itemize}
...
\item Useful in zero-knowledge proofs.
\end{itemize}
...
A library for Isar-style proofs in ACL2.
\begin{itemize}
...
A library for Solidity, the main smart contract language for Ethereum.
\begin{itemize}
\item A model of (some) Solidity values.
\item Small towards a formal model of Solidity.
\end{itemize}
...
A library for Syntheto (described in a paper at this workshop).
\begin{itemize}
...
A library for Yul, an intermediate language used in the Solidity compiler.
\begin{itemize}
...
A library for the Zcash blockchain.
\begin{itemize}
...
\bookpath{std/obags}:
A library for ordered bags (obags).
\begin{itemize}
...
Augmented Backus-Naur Form (ABNF) library.
\begin{itemize}
...
Automated Program Transformations (APT) library.
\begin{itemize}
...
Elliptic curve cryptographic library.
\begin{itemize}
...
Second-Order Functions and Theorems (SOFT) library.
\begin{itemize}
...
\code{apply\$} and \code{loop\$} libraries.
\begin{itemize}
