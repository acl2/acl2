...
Library Wrappers.
\begin{itemize}
\item A new, robust variant of \code{make-flag}.
\end{itemize}
...
\item The file \code{[books]/doc/top-slow.lisp} no longer actually builds a
...
\item Various improvements have been made to \code{defopeners} and
  \code{defopeners-mut-rec}.
\end{itemize}
