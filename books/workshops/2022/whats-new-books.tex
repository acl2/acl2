...
\author{Jagadish Bapanapally\inst{7}\inst{4},
        Cuong Chau\inst{2}, \\
        Alessandro Coglio\inst{1}\inst{4}\inst{5} (presenter),
        Shilpi Goel\inst{3},\\
        Matt Kaufmann\inst{6},
        J Strother Moore\inst{6},
...
\institute{\inst{1}Aleo,
           ...
           \inst{6}University of Texas at Austin (retired),
           \inst{7}University of Wyoming}
