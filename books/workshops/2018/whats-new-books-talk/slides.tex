...
\author{Cuong Chau\inst{1},
        ...
        Mihir Mehta\inst{1},
        J Moore\inst{1},
        David Russinoff\inst{8},
        Julien Schmaltz\inst{9},
        \\
        Rob Sumners\inst{5},
        Sol Swords\inst{5}}

\institute{\inst{1}University of Texas at Austin,
           \inst{2}Kestrel Institute,
           \inst{3}Apple,
           \inst{4}Rockwell Collins,
           \\
           \inst{5}Centaur,
           \inst{6}University of British Columbia,
           \inst{7}Oracle,
           \inst{8}ARM,
           \\
           \inst{9}Eindhoven Institute of Technology}
