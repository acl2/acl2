(MAKE-BLOCKS (36 9 (:DEFINITION NTH))
...
(UNMAKE-BLOCKS (272 156 (:REWRITE DEFAULT-+-2))
...
(UNMAKE-MAKE-BLOCKS-LEMMA-1 (55 29 (:REWRITE DEFAULT-CDR))
...
(UNMAKE-MAKE-BLOCKS (879 12 (:DEFINITION TAKE))
...
(MAKE-BLOCKS-CORRECTNESS-3 (66 4 (:REWRITE NON-NIL-NTH))
                           (45 6 (:DEFINITION LEN))
                           (30 2 (:DEFINITION NTH))
...
(LEN-OF-MAKE-UNMAKE (5500 269 (:LINEAR NON-NIL-NTH))
