...
(SET-INDICES-CORRECTNESS-1 (43 35 (:REWRITE DEFAULT-CAR))
...
(SET-INDICES-CORRECTNESS-2 (406 42 (:REWRITE MEMBER-OF-A-NAT-LIST))
                           (382 40
                                (:REWRITE TRUE-LISTP-WHEN-STRING-LIST))
                           (267 44 (:DEFINITION STRING-LISTP))
                           (263 9 (:REWRITE MEMBER-EQUAL-NTH))
                           (260 22 (:LINEAR NON-NIL-NTH))
...
(SET-INDICES-CORRECTNESS-3 (284 21 (:LINEAR NON-NIL-NTH))
                           ...
                           (8 8 (:REWRITE SUBSETP-MEMBER . 4))
                           (8 8 (:REWRITE SUBSETP-MEMBER . 3)))
(SET-INDICES-CORRECTNESS-4 (119 85 (:REWRITE DEFAULT-CAR))
...
(SET-INDICES-IN-ALV (16 2 (:REWRITE MEMBER-OF-A-NAT-LIST))
                    (10 2 (:DEFINITION LEN))
...
(SET-INDICES-IN-ALV-CORRECTNESS-2 (50 1 (:DEFINITION SET-INDICES))
                                  (41 6 (:REWRITE ZP-OPEN))
                                  (24 2 (:DEFINITION MAKE-LIST-AC))
                                  (23 1 (:REWRITE CDR-OF-MAKE-LIST))
