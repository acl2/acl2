...
(FIND-N-FREE-BLOCKS-CORRECTNESS-1
     (7 1 (:DEFINITION LEN))
     (2 2
        (:TYPE-PRESCRIPTION FIND-N-FREE-BLOCKS-HELPER))
...
(FIND-N-FREE-BLOCKS-CORRECTNESS-7 (9 1 (:REWRITE NON-NIL-NTH))
                                  (8 1 (:DEFINITION NTH))
...
(COUNT-BEFORE-N (3 3
                ...
                (1 1 (:REWRITE DEFAULT-<-1)))
(COUNT-BEFORE-N-CORRECTNESS-1 (19 10 (:REWRITE DEFAULT-+-2))
                              ...
                              (4 1 (:DEFINITION NTH))
                              (3 3 (:REWRITE DEFAULT-CAR)))
(COUNT-BEFORE-N-CORRECTNESS-2 (108 55 (:REWRITE DEFAULT-+-2))
...
(COUNT-BEFORE-N-CORRECTNESS-3 (49 7 (:LINEAR NON-NIL-NTH))
