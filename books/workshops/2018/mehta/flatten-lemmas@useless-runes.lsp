(NO-DUPLICATESP-OF-MEMBER (326 19 (:DEFINITION NO-DUPLICATESP-EQUAL))
...
(NOT-INTERSECTP-LIST-CORRECTNESS-2 (69 20 (:REWRITE SUBSETP-MEMBER . 3))
                                   (47 2 (:DEFINITION SUBSETP-EQUAL))
...
(NOT-INTERSECTP-EQUAL-IF-SUBSET (80 5 (:DEFINITION INTERSECTP-EQUAL))
...
(WHEN-APPEND-IS-DISJOINT-LIST-LISTP
     ...
     (144 9 (:REWRITE FLATTENP-OF-APPEND))
     (143 143
          (:REWRITE FLATTEN-SUBSET-NO-DUPLICATESP-LEMMA-3))
     (140 140
          (:TYPE-PRESCRIPTION TRUE-LISTP-OF-FLATTEN))
...
(NOT-INTERSECTP-LIST-OF-APPEND-2
     ...
     (7 7 (:TYPE-PRESCRIPTION SUBSETP-EQUAL))
     (4 4 (:REWRITE SUBSETP-IS-TRANSITIVE)))
(NO-DUPLICATES-LISTP-OF-APPEND (203 29 (:DEFINITION MEMBER-EQUAL))
                               (168 17
                                    (:REWRITE TRUE-LISTP-WHEN-STRING-LIST))
