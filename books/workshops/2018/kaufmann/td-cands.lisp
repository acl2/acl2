...
(((JUSTIFICATION (I MAXIMUM)
 ...
 ((JUSTIFICATION (X GL::FLAG)
                 (NIL O-P . O<)
                 ((IF (EQL GL::FLAG 'GL::COLLECT-VARS)
                      (ACL2-COUNT X)
                      (ACL2-COUNT X))
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (X GL::FLAG)
                  ...
                  ((IF (EQL GL::FLAG 'GL::COLLECT-VARS)
                       ...
                       (ACL2-COUNT X))
                   MV-LIST RETURN-LAST))
   (((O-P (IF (EQUAL GL::FLAG 'GL::COLLECT-VARS)
              (ACL2-COUNT X)
              (ACL2-COUNT X))))
    ((EQUAL GL::FLAG 'GL::COLLECT-VARS)
     (NOT (CONSP X))
     (O< (IF 'NIL
             (ACL2-COUNT (CDR X))
             (ACL2-COUNT (CDR X)))
         (IF (EQUAL GL::FLAG 'GL::COLLECT-VARS)
             (ACL2-COUNT X)
             (ACL2-COUNT X))))
    ((EQUAL GL::FLAG 'GL::COLLECT-VARS)
     (NOT (CONSP X))
   ...
   (((O-P (SATLINK::LIT->VAR$INLINE SATLINK::LIT)))
    ((EQUAL '1
            (AIGNET::EBA-GET-BIT (SATLINK::LIT->VAR$INLINE SATLINK::LIT)
                                 AIGNET::EBA))
     (NOT (EQUAL (AIGNET::SNODE->TYPE$INLINE (AIGNET::ID->SLOT (SATLINK::LIT->VAR$INLINE SATLINK::LIT)
                                                               '0
                                                               AIGNET))
                 '1))
     (O< (SATLINK::LIT->VAR$INLINE (AIGNET::SNODE->FANIN$INLINE (AIGNET::ID->SLOT (SATLINK::LIT->VAR$INLINE SATLINK::LIT)
                                                                                  '1
                                                                                  AIGNET)))
         (SATLINK::LIT->VAR$INLINE SATLINK::LIT)))
    ((EQUAL '1
 ...
 ((JUSTIFICATION (PROOF-CHECKER-ARRAY::I)
  ...
  ((JUSTIFICATION (LEN)
   ...
   (X86ISA::X86-SORT-BY-OPCODE-MERGESORT-FIXNUM :SYSTEM . "projects/x86isa/doc")
  ...
  ((JUSTIFICATION (N)
   ...
   (AIGNET::AIGNET-COUNT-REFS-ITER :SYSTEM . "centaur/aignet/refcounts")
  ...
  ((JUSTIFICATION (ID)
   ...
   (((O-P (NFIX ID)))
    ((NOT (EQUAL (AIGNET::SNODE->TYPE$INLINE (AIGNET::ID->SLOT ID '0 AIGNET))
                 '1))
     (O< (NFIX (SATLINK::LIT->VAR$INLINE (AIGNET::SNODE->FANIN$INLINE (AIGNET::ID->SLOT ID '1 AIGNET))))
         (NFIX ID)))
    ((NOT (EQUAL (AIGNET::SNODE->TYPE$INLINE (AIGNET::ID->SLOT ID '0 AIGNET))
                 '1))
     (O< (NFIX (SATLINK::LIT->VAR$INLINE (AIGNET::SNODE->FANIN$INLINE (AIGNET::ID->SLOT ID '0 AIGNET))))
         (NFIX ID)))
    ((NOT (EQUAL (AIGNET::SNODE->TYPE$INLINE (AIGNET::ID->SLOT ID '0 AIGNET))
                 '3))
     (O< (NFIX (SATLINK::LIT->VAR$INLINE (AIGNET::CO-ID->FANIN ID AIGNET)))
         (NFIX ID))))
  ...
  ((JUSTIFICATION (ID)
                  ...
                  ((NFIX ID) MV-LIST RETURN-LAST))
   (((O-P (NFIX ID)))
    ((EQUAL '1 (GET-BIT ID AIGNET::MARK))
     (NOT (EQUAL (AIGNET::SNODE->TYPE$INLINE (AIGNET::ID->SLOT ID '0 AIGNET2))
                 '1))
     (O< (NFIX (SATLINK::LIT->VAR$INLINE (AIGNET::SNODE->FANIN$INLINE (AIGNET::ID->SLOT ID '1 AIGNET2))))
         (NFIX ID)))
    ((EQUAL '1 (GET-BIT ID AIGNET::MARK))
     (NOT (EQUAL (AIGNET::SNODE->TYPE$INLINE (AIGNET::ID->SLOT ID '0 AIGNET2))
                 '1))
     (O< (NFIX (SATLINK::LIT->VAR$INLINE (AIGNET::SNODE->FANIN$INLINE (AIGNET::ID->SLOT ID '0 AIGNET2))))
         (NFIX ID))))
   (AIGNET::FRAIG-RECORD-SAT-CTREX-REC 6 :SYSTEM . "centaur/aignet/fraig"))
 ...
 ((JUSTIFICATION (L2 L1)
  ...
  ((JUSTIFICATION (Y X)
   ...
   (((O-P (BINARY-+ (LEN X) (LEN Y))))
    ((NOT (CONSP X))
     (NOT (CONSP Y))
     (X86ISA::X86-OPCODE-< (CAR Y) (CAR X))
     (O< (BINARY-+ (LEN (CDR X)) (LEN Y))
         (BINARY-+ (LEN X) (LEN Y))))
    ((NOT (CONSP X))
     (NOT (CONSP Y))
     (NOT (X86ISA::X86-OPCODE-< (CAR Y) (CAR X)))
     (O< (BINARY-+ (LEN X) (LEN (CDR Y)))
         (BINARY-+ (LEN X) (LEN Y)))))
   (X86ISA::X86-SORT-BY-OPCODE-MERGE 2 :SYSTEM . "projects/x86isa/doc"))
  ((JUSTIFICATION (L2 L1)
                  (NIL O-P . O<)
                  ((BINARY-+ (LEN L1) (LEN L2))
                   MV-LIST RETURN-LAST))
 ...
 ((JUSTIFICATION (LST TERM FLAG)
  ...
  ((JUSTIFICATION (LST TERM FLAG)
   ...
   (FLAG-ALL-VARS1 4 :SYSTEM
                   .
                   "kestrel/utilities/all-vars-theorems")))
 ((JUSTIFICATION (N)
                 (NIL O-P . O<)
   ...
   (((O-P (ACL2-COUNT X)))
    ((NOT (CONSP (CDR (CDR X))))
     (O< (ACL2-COUNT (CDR (CDR X)))
         (ACL2-COUNT X))))
   (RTL::CAT-SIZE 1 :SYSTEM
                  .
                  "projects/x86isa/machine/instructions/fp/base"))
  ((JUSTIFICATION (X)
                  (NIL O-P . O<)
                  ((ACL2-COUNT X) MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT X)))
  ...
  ((JUSTIFICATION (TREE)
   ...
   (SIZE-LT 1 :SYSTEM
            .
            "projects/leftist-trees/leftist-tree-defuns"))
  ((JUSTIFICATION (SMT::TYPE-DECL-LIST)
                  (NIL O-P . O<)
                  ((ACL2-COUNT SMT::TYPE-DECL-LIST)
                   MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT SMT::TYPE-DECL-LIST)))
    ((NOT (CONSP (SMT::PSEUDO-TERM-LIST-FIX SMT::TYPE-DECL-LIST)))
     (NOT (SMT::IS-TYPE-DECL (CAR (SMT::PSEUDO-TERM-LIST-FIX SMT::TYPE-DECL-LIST))))
     (O< (ACL2-COUNT (CDR (SMT::PSEUDO-TERM-LIST-FIX SMT::TYPE-DECL-LIST)))
         (ACL2-COUNT SMT::TYPE-DECL-LIST))))
   (SMT::STRUCTURIZE-TYPE-DECL-LIST 1 :SYSTEM
                                    .
                                    "projects/smtlink/verified/goal-generator"))
 ...
 ((JUSTIFICATION (SMT::UNINTERPRETED)
                 (NIL O-P . O<)
                 ((LEN SMT::UNINTERPRETED)
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (L)
                  (NIL O-P . O<)
  ...
  ((JUSTIFICATION (X)
   ...
   (X86ISA::SORT-BY-X86-OPCODES< :SYSTEM . "projects/x86isa/doc")
  ...
  ((JUSTIFICATION (X)
   ...
   (VL::VL-EVATOMLIST-SCAN-FOR-IGNORE :SYSTEM
                                      . "centaur/vl/lint/suppress-warnings")
   (SV::SVTV-DEBUG-FSM-WRITEPHASES :SYSTEM . "centaur/sv/svtv/debug")
   (VL::VL-CASSERTIONLIST-LVALUECHECK :SYSTEM . "centaur/vl/lint/lvaluecheck")
   (VL::VL-DISTLIST-IMMDEPS-FN :SYSTEM . "centaur/vl/mlib/immdeps")
   (VL::VL-CASSERTIONLIST-COLLECT-ODD-NAMES :SYSTEM
                                            . "centaur/vl/transforms/addnames")
   (VL::VL-FUNDECLLIST-INCREWRITE :SYSTEM
                                  .
   ...
   (VL::VL-EVATOMLIST-STRIP :SYSTEM . "centaur/vl/mlib/strip")
  ...
  ((JUSTIFICATION (SMT::FORMAL/RETURN-LST)
   ...
   (SMT::REMOVE-DUPLICATE-FROM-DECL-LIST :SYSTEM
                                         . "projects/smtlink/verified/Smtlink")
   (SMT::GENERATE-TYPES-AUXES :SYSTEM
                              .
                              "projects/smtlink/verified/verified-cps")
  ...
  ((JUSTIFICATION (SMT::FN-LVLS)
   ...
   (SMT::SUM-LVLS 1 :SYSTEM
                  .
                  "projects/smtlink/verified/goal-generator"))
  ((JUSTIFICATION (MORE-RETURNS)
                  (NIL O-P . O<)
                  ((LEN MORE-RETURNS)
                   MV-LIST RETURN-LAST))
   (((O-P (LEN MORE-RETURNS)))
    ((NOT (CONSP (SMT::HINT-PAIR-LIST-FIX$INLINE MORE-RETURNS)))
     (O< (LEN (CDR (SMT::HINT-PAIR-LIST-FIX$INLINE MORE-RETURNS)))
         (LEN MORE-RETURNS))))
   (SMT::GENERATE-FN-MORE-RETURNS-HINT 2 :SYSTEM
                                       .
                                       "projects/smtlink/verified/goal-generator")
   (SMT::PREPROCESS-AUXES :SYSTEM
                          .
                          "projects/smtlink/verified/verified-cps"))
   ...
   (((O-P (LEN SMT::CONTENT)))
    ((NOT (CONSP (SMT::ARGUMENT-LST-SYNTAX-FIX SMT::CONTENT)))
     (O< (LEN (CDR (SMT::ARGUMENT-LST-SYNTAX-FIX SMT::CONTENT)))
         (LEN SMT::CONTENT))))
   (SMT::MAKE-MERGE-FORMALS-HELPER 2 :SYSTEM
                                   . "projects/smtlink/verified/Smtlink"))
  ((JUSTIFICATION (SMT::CONTENT)
                  (NIL O-P . O<)
                  ((LEN SMT::CONTENT)
   ...
   (((O-P (LEN FORMALS)))
    ((NOT (CONSP (CDR (SYMBOL-LIST-FIX$INLINE FORMALS))))
     (O< (LEN (CDR (SYMBOL-LIST-FIX$INLINE FORMALS)))
         (LEN FORMALS))))
   (SMT::TRANSLATE-LAMBDA-FORMALS 1 :SYSTEM
                                  .
                                  "projects/smtlink/trusted/z3-py/translator"))
  ((JUSTIFICATION (SMT::UNINTERPRETED)
                  (NIL O-P . O<)
                  ((LEN SMT::UNINTERPRETED)
                   MV-LIST RETURN-LAST))
   (((O-P (LEN SMT::UNINTERPRETED)))
    ((NOT (CONSP (SYMBOL-LIST-FIX$INLINE SMT::UNINTERPRETED)))
     (NOT (HONS-GET (CAR (SYMBOL-LIST-FIX$INLINE SMT::UNINTERPRETED))
                    (SMT::FUNC-ALIST-FIX$INLINE SMT::FN-LST)))
     (O< (LEN (CDR (SYMBOL-LIST-FIX$INLINE SMT::UNINTERPRETED)))
         (LEN SMT::UNINTERPRETED))))
 ...
 ((JUSTIFICATION (PROOF-CHECKER-ARRAY::I MAX)
  ...
  ((JUSTIFICATION (X86ISA::LOWER X86ISA::UPPER)
   ...
   (X86ISA::MEM-TABLE-ENTRIES 4 :SYSTEM
                              .
                              "projects/x86isa/machine/concrete-state"))
  ((JUSTIFICATION (I X86ISA::TABLE-LEN)
                  (NIL O-P . O<)
                  ((NFIX (BINARY-+ X86ISA::TABLE-LEN (UNARY-- I)))
                   MV-LIST RETURN-LAST))
   (((O-P (NFIX (BINARY-+ X86ISA::TABLE-LEN (UNARY-- I)))))
    ((NOT (INTEGERP I))
     (< I '0)
     (NOT (INTEGERP X86ISA::TABLE-LEN))
     (< X86ISA::TABLE-LEN '0)
     (NOT (< I X86ISA::TABLE-LEN))
     (O< (NFIX (BINARY-+ X86ISA::TABLE-LEN
                         (UNARY-- (BINARY-+ '1 I))))
         (NFIX (BINARY-+ X86ISA::TABLE-LEN (UNARY-- I))))))
   (X86ISA::EXPECTED-MEM-ARRAY-NEXT-ADDR 3 :SYSTEM
                                         .
                                         "projects/x86isa/machine/concrete-state"))
   ...
   (((O-P (NFIX (BINARY-+ (NFIX STR::XL)
    ...
    ((NOT (INTEGERP (BINARY-+ (NFIX STR::XL)
     ...
     (O< (NFIX (BINARY-+ (NFIX STR::XL)
         ...
         (NFIX (BINARY-+ (NFIX STR::XL)
                         (UNARY-- (NFIX N)))))))
   (STR::REVAPPEND-CHARS-AUX 4 :SYSTEM . "std/strings/cat")
 ...
 ((JUSTIFICATION (VL::TOKSTREAM)
  ...
  ((JUSTIFICATION (VL::TOKSTREAM)
   ...
   (((O-P (LEN (VL::VL-TOKSTREAM->TOKENS$INLINE VL::TOKSTREAM))))
    ((NOT (VL::VL-IS-TOKEN?$INLINE ':VL-LBRACK
                                   VL::TOKSTREAM))
     (MV-NTH '0
             (VL::VL-PARSE-VARIABLE-DIMENSION-FN VL::TOKSTREAM VL::CONFIG))
     (O< (LEN (VL::VL-TOKSTREAM->TOKENS$INLINE (MV-NTH '2
                                                       (VL::VL-PARSE-VARIABLE-DIMENSION-FN VL::TOKSTREAM VL::CONFIG))))
         (LEN (VL::VL-TOKSTREAM->TOKENS$INLINE VL::TOKSTREAM)))))
   (VL::VL-PARSE-0+-VARIABLE-DIMENSIONS-FN 2 :SYSTEM
                                           . "centaur/vl/loader/parser/datatypes"))
  ((JUSTIFICATION (VL::TOKSTREAM)
                  (NIL O-P . O<)
                  ((LEN (VL::VL-TOKSTREAM->TOKENS$INLINE VL::TOKSTREAM))
  ...
  ((JUSTIFICATION (VL::TOKSTREAM)
   ...
   (((O-P (LEN (VL::VL-TOKSTREAM->TOKENS$INLINE VL::TOKSTREAM))))
    ((MV-NTH '0
             (VL::VL-PARSE-VARIABLE-DECL-ASSIGNMENT-FN VL::TOKSTREAM VL::CONFIG))
     (O< (LEN (VL::VL-TOKSTREAM->TOKENS$INLINE (MV-NTH '2
                                                       (VL::VL-MATCH$INLINE (MV-NTH '2
                                                                                    (VL::VL-PARSE-VARIABLE-DECL-ASSIGNMENT-FN VL::TOKSTREAM VL::CONFIG))))))
         (LEN (VL::VL-TOKSTREAM->TOKENS$INLINE VL::TOKSTREAM)))))
   (VL::VL-PARSE-1+-VARIABLE-DECL-ASSIGNMENTS-SEPARATED-BY-COMMAS-FN 2 :SYSTEM
                                                                     . "centaur/vl/loader/parser/datatypes"))
  ((JUSTIFICATION (VL::TOKSTREAM)
                  (NIL O-P . O<)
                  ((LEN (VL::VL-TOKSTREAM->TOKENS$INLINE VL::TOKSTREAM))
  ...
  ((JUSTIFICATION (VL::TOKSTREAM)
   ...
   (((O-P (LEN (VL::VL-TOKSTREAM->TOKENS$INLINE VL::TOKSTREAM))))
    ((MV-NTH '0
             (IF (VL::VL-IS-SOME-TOKEN?$INLINE '(:VL-KWD-POSEDGE :VL-KWD-NEGEDGE)
                                               VL::TOKSTREAM)
                 (IF (MV-NTH '0
                             (VL::VL-MATCH$INLINE VL::TOKSTREAM))
                     (CONS (MV-NTH '0
     ...
     (O< (LEN (VL::VL-TOKSTREAM->TOKENS$INLINE (MV-NTH '2
                                                       (VL::VL-MATCH$INLINE (MV-NTH '2
                                                                                    (VL::VL-PARSE-EXPRESSION-FN (MV-NTH '2
                                                                                                                ...
                                                                                                                VL::CONFIG))))))
         (LEN (VL::VL-TOKSTREAM->TOKENS$INLINE VL::TOKSTREAM)))))
   (VL::VL-PARSE-EVENT-EXPRESSION-2005-FN 2 :SYSTEM
                                          . "centaur/vl/loader/parser/eventctrl"))
  ((JUSTIFICATION (VL::TOKSTREAM)
                  (NIL O-P . O<)
                  ((LEN (VL::VL-TOKSTREAM->TOKENS$INLINE VL::TOKSTREAM))
                   MV-LIST RETURN-LAST))
 ...
 ((JUSTIFICATION (VL::ECHARS)
  ...
  ((JUSTIFICATION (VL::ECHARS)
   ...
   (((O-P (ACL2-COUNT (VL::VL-ECHARLIST-FIX$INLINE VL::ECHARS))))
    ((NOT (MV-NTH '0
                  (VL::VL-PARSE-DEFINE-ACTUAL VL::NAME
                                              VL::ECHARS VL::CONFIG VL::LOC 'NIL
                                              'NIL)))
     (NOT (MV-NTH '1
                  (VL::VL-PARSE-DEFINE-ACTUAL VL::NAME
                                              VL::ECHARS VL::CONFIG VL::LOC 'NIL
 ...
 ((JUSTIFICATION (AIGNET::NODE AIGNET)
                 (NIL O-P . O<)
                 ((NFIX (BINARY-+ '1
                                  (BINARY-+ (AIGNET::MAX-FANIN AIGNET)
                                            (UNARY-- (NFIX AIGNET::NODE)))))
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (AIGNET::NODE AIGNET)
                  (NIL O-P . O<)
                  ((NFIX (BINARY-+ '1
   ...
   (((O-P (NFIX (BINARY-+ '1
    ...
    ((NOT (INTEGERP (BINARY-+ '1
     ...
     (O< (NFIX (BINARY-+ '1
                         (BINARY-+ (AIGNET::MAX-FANIN AIGNET)
                                   (UNARY-- (NFIX (BINARY-+ '1
                                                            (LNFIX$INLINE AIGNET::NODE)))))))
         (NFIX (BINARY-+ '1
                         (BINARY-+ (AIGNET::MAX-FANIN AIGNET)
                                   (UNARY-- (NFIX AIGNET::NODE))))))))
   (AIGNET::FRAIG-SWEEP-AUX 13 :SYSTEM . "centaur/aignet/fraig")))
 ...
 ((JUSTIFICATION (AIGNET::N AIGNET)
                 (NIL O-P . O<)
                 ((NFIX (BINARY-+ (AIGNET::NUM-NODES AIGNET)
                                  (UNARY-- (NFIX AIGNET::N))))
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (AIGNET::N AIGNET)
                  (NIL O-P . O<)
                  ((NFIX (BINARY-+ (AIGNET::NUM-NODES AIGNET)
                                   (UNARY-- (NFIX AIGNET::N))))
                   MV-LIST RETURN-LAST))
   (((O-P (NFIX (BINARY-+ (AIGNET::NUM-NODES AIGNET)
                          (UNARY-- (NFIX AIGNET::N))))))
    ((NOT (INTEGERP (BINARY-+ (AIGNET::NUM-NODES AIGNET)
                              (UNARY-- (NFIX AIGNET::N)))))
     (NOT (< '0
             (BINARY-+ (AIGNET::NUM-NODES AIGNET)
                       (UNARY-- (NFIX AIGNET::N)))))
     (O< (NFIX (BINARY-+ (AIGNET::NUM-NODES AIGNET)
                         (UNARY-- (NFIX (BINARY-+ '1
                                                  (LNFIX$INLINE AIGNET::N))))))
         (NFIX (BINARY-+ (AIGNET::NUM-NODES AIGNET)
                         (UNARY-- (NFIX AIGNET::N)))))))
 ...
 ((JUSTIFICATION (AIGNET::N AIGNET)
                 (NIL O-P . O<)
                 ((NFIX (BINARY-+ (BINARY-+ '1 (AIGNET::MAX-FANIN AIGNET))
                                  (UNARY-- (NFIX AIGNET::N))))
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (AIGNET::N AIGNET)
                  (NIL O-P . O<)
                  ((NFIX (BINARY-+ (BINARY-+ '1 (AIGNET::MAX-FANIN AIGNET))
                                   (UNARY-- (NFIX AIGNET::N))))
                   MV-LIST RETURN-LAST))
   (((O-P (NFIX (BINARY-+ (BINARY-+ '1 (AIGNET::MAX-FANIN AIGNET))
                          (UNARY-- (NFIX AIGNET::N))))))
    ((NOT (INTEGERP (BINARY-+ (BINARY-+ '1 (AIGNET::MAX-FANIN AIGNET))
                              (UNARY-- (NFIX AIGNET::N)))))
     (NOT (< '0
             (BINARY-+ (BINARY-+ '1 (AIGNET::MAX-FANIN AIGNET))
                       (UNARY-- (NFIX AIGNET::N)))))
     (O< (NFIX (BINARY-+ (BINARY-+ '1 (AIGNET::MAX-FANIN AIGNET))
                         (UNARY-- (NFIX (BINARY-+ '1
                                                  (LNFIX$INLINE AIGNET::N))))))
         (NFIX (BINARY-+ (BINARY-+ '1 (AIGNET::MAX-FANIN AIGNET))
                         (UNARY-- (NFIX AIGNET::N)))))))
   (AIGNET::AIGNET-POPULATE-STRASH 3
                                   :SYSTEM . "centaur/aignet/construction")
   (AIGNET::AIGNET-RECORD-LEVELS-AUX :SYSTEM . "centaur/aignet/levels")
   (AIGNET::REWRITE-SWEEP :SYSTEM . "centaur/aignet/rewrite")))
 ((JUSTIFICATION (X GL::FLAG)
                 (NIL O-P . O<)
