...
(VARID-LIST-FIX-OF-APPEND (56 10
                              (:REWRITE VARID-LIST-FIX-WHEN-VARID-LISTP))
...
(NTH-OF-VARID-LIST-FIX
     ...
     (2 1
        (:REWRITE CAR-OF-VARID-LIST-FIX-X-UNDER-VARID-EQUIV)))
