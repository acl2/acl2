...
(TRUE-PSEUDO-TERMP)
(FALSE-PSEUDO-TERMP)
(DROP-NOTS (45 23 (:REWRITE DEFAULT-+-2))
...
(NOT-)
(GET-KEY (216 101 (:REWRITE DEFAULT-+-2))
...
(AND-OR-P)
(AND-OR-TYPE)
(T-IMPLIES-PREDICATE-TYPE-SPECIFIER-AND-OR-TYPE (2 2 (:REWRITE DEFAULT-CAR)))
(AND-OR-TYPE)
(AND-OR-BODY)
