...
(TRUE-LISTP-WHEN-VARID-LISTP-COMPOUND-RECOGNIZER)
(VARID-LIST-FIX$INLINE)
(VARID-LISTP-OF-VARID-LIST-FIX
 (12 5 (:REWRITE VARID-LISTP-WHEN-NOT-CONSP))
...
(NTH-OF-VARID-LIST-FIX
 (110 23 (:REWRITE VARID-LIST-FIX-WHEN-VARID-LISTP))
 (74 30 (:REWRITE VARID-FIX-VARID))
 (73 73 (:TYPE-PRESCRIPTION VARID-LISTP))
 (44 11 (:REWRITE VARID-P-OF-CAR-WHEN-VARID-LISTP))
 (39 39 (:REWRITE VARID-LISTP-WHEN-NOT-CONSP))
 (32 8 (:REWRITE VARID-LISTP-OF-CDR-WHEN-VARID-LISTP))
 )
