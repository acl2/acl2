...
(CONS-EQUAL-META-FUNCTION-HELPER (213 99 (:REWRITE DEFAULT-+-2))
...
(CONS-EQUAL-SMART-META-HELPER (337 282 (:REWRITE DEFAULT-CAR))
                              (299 299 (:REWRITE DEFAULT-CDR))
                              (145 79 (:REWRITE CONS-EV-CONSTRAINT-3))
                              (88 77 (:REWRITE CONS-EV-CONSTRAINT-1)))
(CONS-EQUAL-META-FUNCTION (2 2 (:REWRITE DEFAULT-CDR))
...
(CONS-EQUAL-SMART-META
     ...
     (29 1
         (:DEFINITION CONS-EQUAL-META-FUNCTION-HELPER))
     (24 16 (:REWRITE CONS-EV-CONSTRAINT-10))
     (18 18
         (:TYPE-PRESCRIPTION CONS-EQUAL-META-FUNCTION-HELPER))
...
(CONS-EQUAL-REWRITE (3 3 (:REWRITE DEFAULT-CDR))
                    (3 3 (:REWRITE DEFAULT-CAR)))
(CONS-ONTO-CDR-EQUALS-ALL-REWRITE (4 4 (:REWRITE DEFAULT-CDR))
                                  (4 4 (:REWRITE DEFAULT-CAR)))
(LIST-CAR-EQUAL-ALL-REWRITE (2 2 (:REWRITE DEFAULT-CDR))
                            (2 2 (:REWRITE DEFAULT-CAR)))
(CONS-EQUAL-CONS-SAME-REWRITE-ONE (2 2 (:REWRITE DEFAULT-CDR))
                                  (2 2 (:REWRITE DEFAULT-CAR)))
(CONS-EQUAL-CONS-SAME-REWRITE-TWO (2 2 (:REWRITE DEFAULT-CDR))
                                  (2 2 (:REWRITE DEFAULT-CAR)))
