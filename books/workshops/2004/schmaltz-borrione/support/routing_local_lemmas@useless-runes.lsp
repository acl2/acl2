...
(LEMMA3_ALL_INF_N_ROUTE
     ...
     (1 1 (:REWRITE |(- (- x))|)))
(LEMMA4_CONSP_ROUTE (860 43 (:REWRITE ABS-<-1-IMP-NOT-INT))
                    (686 686
                         (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-<))
                    (686 686
                         (:REWRITE REMOVE-WEAK-INEQUALITIES-TWO))
                    ...
                    (2 2 (:REWRITE |(< (+ c x y) d)|)))
(ALL_INTP_QUARTER_1_LIST (420 11 (:REWRITE ABS-<-1-IMP-NOT-INT))
...
(LEMMA_MEMBER_QUARTER_4
     ...
     (50 6
         (:REWRITE LEMMA_MEMBER_QUARTER_MINUS_1_LIST))
     (45 45
         (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
...
(LEMMA_MEMBER_QUARTER_4_0
     ...
     (3 3 (:REWRITE |(< d (+ c x y))|)))
(NO_DUPLI_QUARTER_4 (300 15 (:REWRITE ABS-<-1-IMP-NOT-INT))
...
(CAR_QUARTER_MINUS_3_LIST
     ...
     (2 1 (:REWRITE DEFAULT-CAR))
     (1 1
        (:TYPE-PRESCRIPTION QUARTER_MINUS_1_LIST))
     (1 1
        (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-A+AB))
     (1 1 (:REWRITE |(< d (+ c x))|))
     (1 1 (:REWRITE |(< d (+ c x y))|))
