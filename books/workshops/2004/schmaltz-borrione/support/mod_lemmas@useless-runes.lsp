(MOD-X-=-X (259 55 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
           (259 55
           ...
           (1 1 (:REWRITE |(< (- x) 0)|)))
(LEMMA_FOR_NEXT_THEOREM (256 55 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
                        (104 104
                             (:TYPE-PRESCRIPTION NOT-INTEGERP-3B))
                        (104 104
                             (:TYPE-PRESCRIPTION NOT-INTEGERP-2B))
...
(MOD-X-=-X-+-N (199 85 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
...
(MOD-X-=-MINUSX-POS
     ...
     (1 1 (:REWRITE |(< (+ c x) (+ d y))|))
     (1 1 (:REWRITE |(< (+ c x y) d)|)))
(MOD-+-N/2-POS (513 117 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
               (257 3 (:LINEAR MOD-BOUNDS-3))
               (204 204
                    (:TYPE-PRESCRIPTION NOT-INTEGERP-4A))
               (204 204
                    (:TYPE-PRESCRIPTION NOT-INTEGERP-3A))
               ...
               (1 1 (:REWRITE |(< (+ c x) d)|))
               (1 1 (:REWRITE |(* (- x) y)|)))
(MOD-+-N/2-NEG (257 119 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
...
(MOD-N/2-POS (437 109 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
             ...
             (1 1 (:REWRITE |(< d (+ c x))|))
             (1 1 (:REWRITE |(< (+ c x) d)|)))
(MOD-N/2-NEG (332 113 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
