(FIRST_TRAVEL_STEP)
(NTH_TRAVEL_STEP)
(LEMMA_NO_DUPLICATESP_LEN_2 (112 8 (:REWRITE NTH-WITH-LARGE-INDEX))
                            (42 21
...
(NO_DUPLI_LEN_3_LEMMA (986 74 (:REWRITE NTH-WITH-LARGE-INDEX))
                      (392 196
                           (:TYPE-PRESCRIPTION TRUE-LISTP-MEMBER-EQUAL))
...
(NO_DUPLI_LEN_3_LEMMA_BIS (158 11 (:REWRITE NTH-WITH-LARGE-INDEX))
                          (85 5 (:DEFINITION NTH))
