...
(MEMBER-MATCHER (92 12 (:DEFINITION VAL))
                (23 23 (:META CANCEL_TIMES-EQUAL-CORRECT))
                (23 23 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(SUBSETP-MATCHER (121 11 (:DEFINITION APPLY-SUBST))
...
(EQUAL-SET-IMPLIES-IFF-MATCHER-2 (42 2 (:DEFINITION MATCHER))
...
(MATCHER-APPEND (232 29 (:DEFINITION VAL))
...
(INDUCTION-PAIR-ARGS (139 67 (:REWRITE DEFAULT-+-2))
...
(TRANSFORM-SUBS-SEL-FAIL (1179 24 (:REWRITE MATCHER-ASSOC))
...
(LENGTH-SYSTEM-APPEND (231 106 (:REWRITE DEFAULT-+-2))
...
(ELIMINATE-NOT-MEMBER (164 76 (:REWRITE DEFAULT-+-2))
                      ...
                      (12 12 (:META CANCEL_TIMES-EQUAL-CORRECT))
                      (12 12 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(LENGTH-SYSTEM-ELIMINATE (180 84 (:REWRITE DEFAULT-+-2))
...
(LENGTH-SYSTEM-ELIMINATE-LEQ (189 87 (:REWRITE DEFAULT-+-2))
                             (155 31 (:DEFINITION LENGTH-TERM))
...
(MATCH-SEL-SUBSTITUTION-S-P (172 11 (:DEFINITION TERM-S-P-AUX))
...
(SUBS-SEL)
(MATCHING-SEL)
(SUBS-SEL-SOUNDNESS (11 1 (:DEFINITION APPLY-SUBST))
                    (8 8 (:REWRITE DEFAULT-CAR))
                    (8 1 (:DEFINITION VAL))
                    (4 4 (:REWRITE DEFAULT-CDR))
                    (1 1 (:META CANCEL_TIMES-EQUAL-CORRECT))
                    (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(SUBS-SEL-COMPLETENESS (33 3 (:DEFINITION APPLY-SUBST))
                       (24 3 (:DEFINITION VAL))
                       (15 15 (:REWRITE DEFAULT-CAR))
                       (11 11 (:REWRITE DEFAULT-CDR))
                       (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
