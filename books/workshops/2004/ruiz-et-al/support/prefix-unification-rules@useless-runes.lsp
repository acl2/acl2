...
(UNIF-REDUCE-ONE-STEP-P-DECOMPOSE (2 1
...
(MEMBER-SOLUTION (284 36 (:DEFINITION VAL))
                 (55 55 (:META CANCEL_TIMES-EQUAL-CORRECT))
                 (55 55 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(SOLUTION-DELETE-ONE (176 22 (:DEFINITION VAL))
...
(SOLUTION-DELETE-ONE-2 (588 74 (:DEFINITION VAL))
...
(PERM-IMPLIES-IFF-SOLUTION-2 (416 52 (:DEFINITION VAL))
...
(PERM-NTH-ELIMINATE-N (142 142 (:REWRITE DEFAULT-CAR))
...
(SOLUTION-APPEND (464 58 (:DEFINITION VAL))
...
(SOLUTION-ELIMINATE-N (216 28 (:DEFINITION VAL))
...
(TRANSFORM-SEL-RULE-DECOMPOSE (540 374 (:REWRITE DEFAULT-CAR))
                              ...
                              (5 5
                                 (:REWRITE PERM-NTH-ELIMINATE-N-INSTANCE)))
(MAIN-PROPERTY-ELIMINATE-LEMMA (97 97 (:META CANCEL_TIMES-EQUAL-CORRECT))
...
(MAIN-PROPERTY-ELIMINATE (336 42 (:DEFINITION VAL))
...
(MAIN-PROPERTY-ELIMINATE-COROLLARY (296 37 (:DEFINITION VAL))
...
(TRANSFORM-SEL-CHECK-RULE (16 2 (:DEFINITION VAL))
...
(TRANSFORM-SEL-NOT-PAIR-RULE (100 5 (:DEFINITION PAIR-ARGS))
...
(MM-PRESERVES-SOLUTIONS-1 (948 81 (:DEFINITION VAL))
...
(MM-PRESERVES-SOLUTIONS-2 (1464 108 (:DEFINITION VAL))
                          ...
                          (4 4 (:TYPE-PRESCRIPTION BINARY-APPEND))
                          (4 4 (:TYPE-PRESCRIPTION APPLY-SYST)))
(MM-PRESERVES-SOLUTIONS-3 (343 310 (:REWRITE DEFAULT-CAR))
...
(SYSTEM-VAR-APPEND (99 96 (:REWRITE DEFAULT-CDR))
                   ...
                   (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
                   (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(PAIR-ARGS-SYSTEM-VAR-LEMMA-1 (1601 143 (:DEFINITION MEMBER-EQUAL))
                              ...
                              (12 12
                                  (:REWRITE PERM-NTH-ELIMINATE-N-INSTANCE)))
(PAIR-ARGS-SYSTEM-VAR-LEMMA-2 (1308 48 (:DEFINITION SUBSETP-EQUAL))
                              ...
                              (6 6
                                 (:REWRITE PERM-NTH-ELIMINATE-N-INSTANCE)))
(PAIR-ARGS-SYSTEM-VAR (40 2 (:DEFINITION PAIR-ARGS))
...
(ELIMINATE-ELIMINATE-VARIABLES-2
     ...
     (8 8 (:TYPE-PRESCRIPTION VARIABLE-P)))
(SUBSETP-SYSTEM-VAR-CO-DOMAIN (155 20 (:DEFINITION MEMBER-EQUAL))
                              (128 7 (:DEFINITION NOT-SUBSETP-WITNESS))
...
(SUBSETP-VARIABLES-ELIMINATE-LEMMA
     ...
     (7 7 (:REWRITE ZP-OPEN))
     (6 6 (:REWRITE NATP-RW)))
(SUBSETP-VARIABLES-ELIMINATE (208 2 (:DEFINITION APPLY-SYST))
...
(TRANSFORM-DOES-NOT-INCREASES-N-VARIABLES
     ...
     (3 3
        (:TYPE-PRESCRIPTION UNIF-REDUCE-ONE-STEP-P)))
...
(LEN-SUBSETP-SETP-STRICT (158 158 (:REWRITE DEFAULT-CDR))
                         ...
                         (1 1 (:REWRITE SUBSETP-REFLEXIVE)))
(SUBSETP-VARIABLES-ORIENT-2 (52 52
                                (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
                            (50 10 (:DEFINITION BINARY-APPEND))
...
(ELIMINATE-VARIABLES-STRICT (312 3 (:DEFINITION APPLY-SYST))
...
(PERM-IMPLIES-EQUAL-SIZE-SYSTEM-1 (104 48 (:REWRITE DEFAULT-+-2))
                                  (80 48 (:REWRITE DEFAULT-+-1))
                                  (80 16 (:DEFINITION SIZE))
                                  (64 64 (:TYPE-PRESCRIPTION SIZE))
...
(SIZE-SYSTEM-APPEND (231 106 (:REWRITE DEFAULT-+-2))
                    ...
                    (3 3 (:REWRITE EQUAL-CONSTANT-+)))
(SIZE-SYSTEMS-DECOMPOSE-LEMMA (374 176 (:REWRITE DEFAULT-+-2))
                              (321 191 (:REWRITE DEFAULT-CAR))
                              (310 176 (:REWRITE DEFAULT-+-1))
...
(SI-PERMANECE-SYSTEM-VAR-AL-TRANSFORMAR-DECRECE-SIZE-SYSTEM
     ...
     (471 286 (:REWRITE DEFAULT-+-2))
     (385 286 (:REWRITE DEFAULT-+-1))
...
(IF-N-VARIABLES-AND-SIZE-ARE-EQUAL-REDUCTION-DECREASE-N-VARIABLES-R-H-S
     ...
     (646 410 (:REWRITE DEFAULT-+-2))
     (522 410 (:REWRITE DEFAULT-+-1))
     (295 5 (:DEFINITION APPLY-RANGE))
     ...
     (2 2 (:REWRITE NATP-RW)))
(LEXP-UNIFICATION-MEASURE (42 24 (:REWRITE DEFAULT-CAR))
...
(IF-SOLVABLE-TRANSFORM-SEL-SUCCESS
     ...
     (5 5 (:REWRITE NATP-RW)))
(UNIF-SEQ-P-EQUIVALENT-1 (242 22 (:DEFINITION APPLY-SUBST))
                         (176 22 (:DEFINITION VAL))
...
(UNIF-SEQ-P-EQUIVALENT-2 (198 18 (:DEFINITION APPLY-SUBST))
...
(UNIF-SEQ-P-UNSOLVABLE (72 2 (:DEFINITION SOLUTION))
...
(MGS-SEQ-P)
(MGS-SEQ)
(MGS-SEQ-COMPLETENESS (22 2 (:DEFINITION APPLY-SUBST))
                      ...
                      (3 1
                         (:REWRITE TRANSFORM-MM-SEL-CONFLICT-RULE)))
(MGS-SEQ-SOUNDNESS (88 8 (:DEFINITION APPLY-SUBST))
                   ...
                   (3 3
                      (:REWRITE PERM-NTH-ELIMINATE-N-INSTANCE)))
(MGS-SEQ-IDEMPOTENT (20 1 (:DEFINITION SYSTEM-VAR))
