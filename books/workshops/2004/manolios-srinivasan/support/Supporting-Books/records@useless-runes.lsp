...
(BAD-FIELD-AUX)
(BAD-FIELD (2 2 (:TYPE-PRESCRIPTION ACL2->RCD)))
...
(ACL2->RCD-RCD->ACL2-OF-RCDP (202 53 (:REWRITE <<-TRICHOTOMY))
                             ...
                             (39 1
                                 (:REWRITE RCDP-EQUALITY-SUFFICIENCY-AUX)))
...
(ACL2->RCD-PRESERVES-EQUALITY (98 3
                                  (:REWRITE RCDP-EQUALITY-SUFFICIENCY-AUX))
...
(RCD->ACL2-ACL2->RCD-INVERSE (107 28 (:REWRITE <<-TRICHOTOMY))
...
(G-OVER-IF)
(S-OVER-IF)
(G-SAME-S- (139 2 (:DEFINITION S-AUX))
...
(G-DIFF-S- (198 7 (:DEFINITION RCDP))
           ...
           (1 1
              (:REWRITE S-AUX-NON-NIL-CANNOT-BE-NIL)))
(G-OF-S-REDUX (479 17 (:DEFINITION RCDP))
...
(G-DIFF-S (198 7 (:DEFINITION RCDP))
          ...
          (1 1
             (:REWRITE S-AUX-NON-NIL-CANNOT-BE-NIL)))
(S-SAME-G (98 1 (:DEFINITION G-AUX))
...
(S-SAME-S (201 3 (:DEFINITION S-AUX))
          (93 24 (:REWRITE <<-TRICHOTOMY))
          (93 3
              (:REWRITE RCDP-EQUALITY-SUFFICIENCY-AUX))
...
(S-DIFF-S (363 5 (:DEFINITION S-AUX))
...
(S-NON-NIL-CANNOT-BE-NIL (132 2 (:DEFINITION S-AUX))
...
(NON-NIL-IF-G-NON-NIL (13 1 (:REWRITE G-AUX-IS-NIL-FOR-<<))
                      ...
                      (2 1 (:REWRITE <<-ASYMMETRIC))
                      (1 1 (:TYPE-PRESCRIPTION RCDP)))
(RCDP-EQUALITY-SUFFICIENCY (588 6 (:DEFINITION G-AUX))
