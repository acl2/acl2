...
(S-AUX==R-AUX-LEMMA (3907 2606 (:REWRITE <<-TRANSITIVE))
                    (1406 1406 (:REWRITE DEFAULT-CDR))
                    (16 16
                        (:REWRITE S-AUX-NON-NIL-CANNOT-BE-NIL)))
(S-AUX==R-AUX (506 132 (:REWRITE <<-TRICHOTOMY))
...
(LEN-LEN-INDUCTION (121 58 (:REWRITE DEFAULT-+-2))
...
(S-AUX-EQUAL-DIFFERENTIAL (4182 4020 (:REWRITE DEFAULT-CDR))
                          (20 20
                              (:REWRITE S-AUX-NON-NIL-CANNOT-BE-NIL)))
(RCD->ACL2-PRESERVES-EQUALITY (304 80 (:REWRITE <<-TRICHOTOMY))
                              (272 48 (:REWRITE <<-ASYMMETRIC))
...
(S-AUX-PRESERVES-RCDP (662 9 (:REWRITE CDR-S-AUX))
                      (513 474 (:REWRITE DEFAULT-CAR))
                      (271 248 (:REWRITE DEFAULT-CDR))
                      (3 3
                         (:REWRITE S-AUX-NON-NIL-CANNOT-BE-NIL)))
(RCDP-ACL2->RCD (76 20 (:REWRITE <<-TRICHOTOMY))
                (68 12 (:REWRITE <<-ASYMMETRIC))
                (44 44 (:TYPE-PRESCRIPTION <<))
                (34 34 (:REWRITE DEFAULT-CAR))
                (23 23 (:REWRITE DEFAULT-CDR))
                (20 20 (:REWRITE <<-TRANSITIVE)))
(ACL2->RCD-PRESERVES-EQUALITY (95 25 (:REWRITE <<-TRICHOTOMY))
                              (85 15 (:REWRITE <<-ASYMMETRIC))
...
(S-EQUAL-DIFFERENTIAL-G (84 2 (:DEFINITION S-AUX))
                        ...
                        (20 20 (:REWRITE <<-TRANSITIVE))
                        (10 10 (:REWRITE DEFAULT-CDR)))
(S-EQUAL-DIFFERENTIAL-V (18 2 (:REWRITE EQUAL-S-RECORD-EQUALITY))
                        (17 5
                            (:REWRITE ACL2->RCD-PRESERVES-EQUALITY))
