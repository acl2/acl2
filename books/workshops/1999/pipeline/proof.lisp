...
; This was added by J Moore to accommodate the nu-rewriter.
(defthm equal-b-and-1
  (equal (equal (b-and a b) 1)
         (and (b1p a) (b1p b)))
  :hints (("Goal" :in-theory (enable b-AND B1P))))
...
(defthm MA-weight-MT-step
  ...
  :hints (("Goal" :in-theory (enable flushed? lift-b-ops
				     MA-step step-latch1 step-latch2
				     stall-cond?))))
