(MARKEDP)
(MARK)
(COUNT-NON-MEMBERS-CONS (36 36 (:REWRITE DEFAULT-CAR))
...
(E0-ORDINALP-MEASURE (30 2 (:DEFINITION COUNT-NON-MEMBERS))
...
(MEASURE-DECREASES-2 (226 208 (:REWRITE DEFAULT-CDR))
...
(LINEAR-FIND-NEXT-STEP (11 11 (:REWRITE DEFAULT-CAR))
                       (7 1 (:DEFINITION NEIGHBORS))
                       (6 6 (:REWRITE SUBSETP-MEMBER-MEMBER))
                       (6 6 (:REWRITE DEFAULT-CDR))
                       (2 2
                          (:REWRITE NON-NODES-HAVE-NO-NEIGHBORS)))
(LINEAR-FIND-PATH)
(TRANSITIVITY-OF-SUBSETP (113 23 (:DEFINITION MEMBER-EQUAL))
...
(LINEAR-FIND-NEXT-STEP-EXTENDS-MT-COROLLARY-1
     ...
     (12 12
         (:TYPE-PRESCRIPTION LINEAR-FIND-NEXT-STEP))
     ...
     (1 1 (:DEFINITION MARK)))
(GENERALIZED-TEST-IS-ALWAYS-T (226 208 (:REWRITE DEFAULT-CDR))
                              (223 207 (:REWRITE DEFAULT-CAR))
                              (156 74 (:REWRITE DEFAULT-+-2))
                              (74 74 (:REWRITE DEFAULT-+-1))
                              ...
                              (2 2 (:REWRITE EQUAL-CONSTANT-+)))
(TEST-IS-ALWAYS-T (164 1 (:DEFINITION LINEAR-FIND-NEXT-STEP))
                  (97 3 (:DEFINITION REV))
...
(EXISTENCE (973 78 (:DEFINITION BINARY-APPEND))
...
(X-CONSTRAINT (973 78 (:DEFINITION BINARY-APPEND))
              (706 499 (:REWRITE DEFAULT-CAR))
              (540 64 (:REWRITE CAR-REV))
              ...
              (86 86
                  (:REWRITE NON-NODES-HAVE-NO-NEIGHBORS))
              (60 60 (:REWRITE SUBSETP-MEMBER-MEMBER)))
(UNIQUENESS (3663 309 (:DEFINITION BINARY-APPEND))
...
(FIND-NEXT-STEP-AVOIDING (21 21 (:REWRITE DEFAULT-CAR))
...
(FIND-PATH-AVOIDING)
(STEP1 (574 41 (:DEFINITION BINARY-APPEND))
       ...
       (12 12
           (:REWRITE NON-NODES-HAVE-NO-NEIGHBORS)))
(FIND-NEXT-STEP-AVOIDING-CONS (1492 45 (:REWRITE STEP1))
                              ...
                              (10 10
                                  (:REWRITE NON-NODES-HAVE-NO-NEIGHBORS)))
(PATHLESSP (458 1 (:DEFINITION FIND-NEXT-STEP-AVOIDING))
           (360 5 (:REWRITE STEP1))
...
(FIND-NEXT-STEP-AVOIDING-STACK-EXTENSION
     ...
     (2 2
        (:REWRITE NON-NODES-HAVE-NO-NEIGHBORS))
     (1 1
        (:REWRITE PATHLESS-MT-SUBSTITUTION-LEMMA1)))
(PATHLESS-MT-SUBSTITUTION-LEMMA2
     (8334 14
           (:DEFINITION FIND-NEXT-STEP-AVOIDING))
...
(PATHLESS-MT-SUBSTITUTION-LEMMA3
     ...
     (18 18
         (:REWRITE FIND-NEXT-STEP-AVOIDING-STACK-EXTENSION)))
...
(PATHLESSP-X-X (160 10
                    (:REWRITE PATHLESS-MT-SUBSTITUTION-LEMMA3))
...
(FIND-NEXT-STEP-AVOIDING-NON-FAILURE-NORMALIZER-COROLLARY
     ...
     (10 10
         (:REWRITE PATHLESS-MT-SUBSTITUTION-COROLLARY))
     (10 10
         (:REWRITE FIND-NEXT-STEP-AVOIDING-STACK-EXTENSION))
     (4 4
        (:REWRITE NON-NODES-HAVE-NO-NEIGHBORS))
...
(LINEAR-FIND-NEXT-STEP-EXTENDS-MT-COROLLARY-2
     ...
     (2 2 (:DEFINITION MARK)))
(STEP2 (57836 4712 (:DEFINITION BINARY-APPEND))
       (57472 377 (:REWRITE STEP1))
       (46499 36358 (:REWRITE DEFAULT-CAR))
       (32707 29723 (:REWRITE DEFAULT-CDR))
       (31159 240
              (:REWRITE LINEAR-FIND-NEXT-STEP-EXTENDS-MT-COROLLARY-2))
...
(LINEAR-FIND-PATH-IS-FIND-PATH
     ...
     (5 5
        (:REWRITE FIND-NEXT-STEP-AVOIDING-STACK-EXTENSION)))
(SPEC-OF-LINEAR-FIND-PATH (42 42 (:REWRITE DEFAULT-CAR))
