...
(C-P-NTH-IS-E-P
 ...
 (956 106 (:REWRITE S-P-CAR))
 (504 10 (:REWRITE L-EVAL-R-LTE-AAA-2))
 ...
 (287 116 (:REWRITE BOOLEANP-IS-B-P))
 (264 10 (:REWRITE S-P-NTH-IS-B-P))
 (264 10 (:REWRITE S-P-NTH))
 ...
 (116 116 (:REWRITE S-P-MEMBERP-EQUAL))
 (116 116 (:REWRITE S-P-MEMBER-EQUAL))
...
(C-EVAL)
(C-EVAL-IS-S-P
 (3181 5 (:DEFINITION E-EVAL))
 (2656 113 (:REWRITE S-P-CAR))
 (1884 32 (:DEFINITION INITIAL-SUBLISTP-EQUAL))
 (1491 59 (:REWRITE C-P-CAR))
 ...
 (247 103 (:REWRITE BOOLEANP-IS-B-P))
 ...
 (113 113 (:REWRITE S-P-MEMBERP-EQUAL))
 (113 113 (:REWRITE S-P-MEMBER-EQUAL))
...
(S-LTE-C-EVAL-IS-S-LTE
 (25117 16 (:DEFINITION E-EVAL))
 (17018 180 (:REWRITE S-LTE-S1-NOT-X-S2-IS-TOP))
 (16857 88 (:REWRITE S-LTE-TRANSITIVE))
 (11250 90 (:DEFINITION NTH))
 (11094 513 (:DEFINITION INITIAL-SUBLISTP-EQUAL))
 (10487 461 (:DEFINITION N-P))
 (6786 474 (:REWRITE S-P-CAR))
 ...
 (496 200 (:REWRITE BOOLEANP-IS-B-P))
 (474 474 (:REWRITE S-P-MEMBERP-EQUAL))
 (474 474 (:REWRITE S-P-MEMBER-EQUAL))
...
(C-RUN-IS-R-P
 ...
 (53 53 (:REWRITE S-P-MEMBERP-EQUAL))
 (53 53 (:REWRITE S-P-MEMBER-EQUAL))
...
(C-RUN-LEN
 ...
 (31 31 (:REWRITE S-P-MEMBERP-EQUAL))
 (31 31 (:REWRITE S-P-MEMBER-EQUAL))
