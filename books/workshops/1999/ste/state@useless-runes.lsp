...
(S-LTE-UPDATE-NTH
 (74073 2417 (:REWRITE S-P-INITIAL-SUBLISTP-EQUAL))
 (43764 4880 (:DEFINITION TRUE-LISTP))
 (17591 17591 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
 (12178 489 (:DEFINITION INITIAL-SUBLISTP-EQUAL))
...
(NOT-LTE-X-BOOLEAN-IF-TOP
 ...
 (2728 2728 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(S-LTE-X-WITH-UPDATE-IMPLIES-EQUAL
 ...
 (5087 5087 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
