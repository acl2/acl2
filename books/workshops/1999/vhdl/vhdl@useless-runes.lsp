...
(ASSOC-VALUE)
(DIGIT-TO-STRING)
(NATURAL-TO-STRING (40 33 (:REWRITE DEFAULT-<-1))
...
(COMP-DESC-ENV)
(PREFIX-ENV)
(BUILD-PORT-ENV (294 133 (:REWRITE DEFAULT-+-2))
...
(BUILD-VAR-ENV)
(BUILD-PROCESS-ENV (1 1 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(BUILD-SIGNAL-ENV)
(BUILD-NEXT-ENV)
(EXTRACT-ENV-KIND)
(ALLOC-ENV)
(SORT-ARCHITECTURE-ENV (1016 371
...
(EXPAND-EXP)
(MAKE-VAR-ASSIGN (1 1
                    (:TYPE-PRESCRIPTION EXPAND-VAR-SIGNAL)))
(MAKE-SIGNAL-ASSIGN (1 1
                       (:TYPE-PRESCRIPTION EXPAND-VAR-SIGNAL)))
(MAKE-IF-CMD)
(MAKE-SEQ-CMD)
(EXPAND-CMD-LIST (1112 483 (:REWRITE DEFAULT-+-2))
