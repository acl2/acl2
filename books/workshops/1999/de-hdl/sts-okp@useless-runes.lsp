(STS-OKP (1273 31
         ...
         (615 597 (:REWRITE DEFAULT-CAR))
         (595 35 (:DEFINITION ASSOC-EQUAL))
         (590 561 (:REWRITE DEFAULT-CDR))
         (387 36 (:DEFINITION SYMBOL-ALISTP))
         (369 47 (:DEFINITION SYMBOL-LISTP))
         ...
         (30 2
             (:REWRITE NOT-CDDDDR-ASSOC-EQ-FN-NETLIST-IMPLIES-NO-MODULE))
...
(STS-OKP-SAME-WITH-CDR
     ...
     (15 15
         (:TYPE-PRESCRIPTION SYMBOL-LIST-LISTP)))
(STS-OKP-CDR-NETLIST (73 73 (:REWRITE DEFAULT-CAR))
