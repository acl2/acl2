...
(DOMAIN-LIST-DOMAIN (153 15 (:DEFINITION FRINGE))
...
(RELATIONS-1 (2 2 (:REWRITE DEFAULT-CDR))
             (1 1 (:REWRITE DEFAULT-CAR)))
(FUNCTIONS-1 (3 3 (:REWRITE DEFAULT-CDR)))
(VAR-LIST-APPEND-ONE (20 12 (:REWRITE DEFAULT-CAR))
                     (17 9 (:REWRITE DEFAULT-CDR)))
(VAR-LIST-PROPS (146 10
                     (:REWRITE DOMAIN-TERM-LIST-TRUE-LISTP))
                (120 14 (:DEFINITION DOMAIN-TERM-LIST))
...
(NOT-DOMAIN-TERM-NOT-DOMAIN-TERM-LIST
     ...
     (1 1 (:REWRITE DEFAULT-CAR)))
(EVAL-TERM-LIST-PARTS (385 47 (:DEFINITION DOMAIN-TERM-LIST))
                      (315 32
...
(XEVAL-INTERP-PARTS (15064 13726 (:REWRITE DEFAULT-CDR))
...
(LEN-APPEND-LIST (22 11 (:REWRITE DEFAULT-+-2))
                 (17 9 (:REWRITE DEFAULT-CDR))
...
(VAR-OCCURRENCE-TERM-LIST-LIST-CONS
     (440 52 (:DEFINITION DOMAIN-TERM-LIST))
     (330 30
          (:REWRITE DOMAIN-TERM-LIST-TRUE-LISTP))
     (243 243
          (:TYPE-PRESCRIPTION DOMAIN-TERM-LIST))
     (226 226 (:REWRITE DEFAULT-CAR))
     (225 15 (:REWRITE DOMAIN-TERM-LIST-MEMBER))
...
(DISJOINT-APPEND-5 (4469 288 (:REWRITE DOMAIN-TERM-LIST-MEMBER))
...
(SUBST-APPEND-VALS-LIST (130 58 (:REWRITE DEFAULT-CAR))
...
(NIL-NOT-IN-DOMAIN-TERM-LIST (7 1 (:DEFINITION DOMAIN-TERM-LIST))
                             (3 1
                                (:REWRITE VARIABLE-TERM-IS-NOT-DOMAIN-TERM))
...
(NOT-MEMBER-APPEND (329 24 (:REWRITE DOMAIN-TERM-LIST-MEMBER))
...
(NOT-VARS-IN-TERM-LIST-2 (11 2 (:DEFINITION DOMAIN-TERM-LIST))
...
(SUBSET-EVAL-TERM-LIST-DOMAIN
     ...
     (67 67
         (:REWRITE FAPPLY-RETURNS-DOMAIN-TERM))
     (60 60
         (:REWRITE CAR-OF-EVAL-TERM-LIST-IS-DOMAIN-TERM))
...
(FEVAL-INTERP-PARTS (506 2 (:DEFINITION XEVAL))
                    ...
                    (2 2 (:DEFINITION FUNCTION-SYMBOL)))
(SETP-APPEND-DISJOINT (569 35 (:DEFINITION MEMBER-EQUAL))
...
(SETP-APPEND-DISJOINT-2 (1405 124 (:REWRITE DOMAIN-TERM-LIST-MEMBER))
...
(SETP-FRINGE-DOMAIN (116 2 (:DEFINITION SETP))
