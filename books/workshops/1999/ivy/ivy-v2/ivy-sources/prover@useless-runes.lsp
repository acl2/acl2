...
(REFUTATION-IS-FSOUND
     (2317 1
           (:REWRITE SKOLEMIZE-EXTEND-WITH-FREE-VARS))
     (2315 1
           (:REWRITE RENAME-ALL-PRESERVES-FREE-VARS))
...
(PROVED (3296 14 (:DEFINITION VARS-IN-TERM-LIST))
        (3144 2
              (:REWRITE FREE-OCCURRENCE-REMOVE-FREE-VARS))
...
(PROOF-IS-FSOUND (12 12 (:REWRITE DEFAULT-CDR))
