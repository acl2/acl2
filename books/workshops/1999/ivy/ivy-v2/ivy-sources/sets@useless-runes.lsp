(SUBSET-CONS (43 43 (:REWRITE DEFAULT-CAR))
             (22 22 (:REWRITE DEFAULT-CDR)))
(SUBSET-REFLEXIVE (22 22 (:REWRITE DEFAULT-CAR))
                  (19 19 (:REWRITE DEFAULT-CDR)))
(SUBSETP-EQUAL-TRANSITIVE (116 116 (:REWRITE DEFAULT-CAR))
                          (89 89 (:REWRITE DEFAULT-CDR)))
(SUBSET-MEMBER-SUBSET-CONS (5 5 (:REWRITE DEFAULT-CDR))
                           (5 5 (:REWRITE DEFAULT-CAR)))
(NOT-MEMBER-SUBSET (22 22 (:REWRITE DEFAULT-CAR))
                   (15 15 (:REWRITE DEFAULT-CDR))
                   (8 8 (:REWRITE SUBSETP-EQUAL-TRANSITIVE)))
(SUBSET-SKOLEM)
(SUBSET-SKOLEM-LEMMA (69 69 (:REWRITE DEFAULT-CAR))
                     (45 45 (:REWRITE DEFAULT-CDR))
                     (25 22 (:REWRITE SUBSETP-EQUAL-TRANSITIVE)))
(UNION-EQUAL-PRESERVES-TRUE-LISTP (26 9 (:DEFINITION TRUE-LISTP))
                                  (18 18 (:REWRITE DEFAULT-CDR))
                                  (14 14 (:REWRITE DEFAULT-CAR))
                                  (1 1 (:REWRITE SUBSETP-EQUAL-TRANSITIVE)))
(UNION-NIL-LEFT (11 11 (:TYPE-PRESCRIPTION UNION-EQUAL)))
(UNION-NIL-RIGHT (8 8 (:REWRITE DEFAULT-CAR))
                 (5 5 (:REWRITE NOT-MEMBER-SUBSET))
                 (5 5 (:REWRITE DEFAULT-CDR)))
(MEMBER-UNION-OR (246 222 (:REWRITE DEFAULT-CAR))
...
(NOT-MEMBER-UNION-EQUAL (138 134 (:REWRITE DEFAULT-CAR))
...
(SUBSET-UNION-2 (233 233 (:TYPE-PRESCRIPTION UNION-EQUAL))
                (26 26 (:REWRITE DEFAULT-CAR))
                (17 17 (:REWRITE DEFAULT-CDR))
                (11 11 (:REWRITE SUBSETP-EQUAL-TRANSITIVE)))
(UNION-EQUAL-IDEMPOTENT (11 11 (:TYPE-PRESCRIPTION UNION-EQUAL))
                        (1 1 (:REWRITE SUBSETP-EQUAL-TRANSITIVE)))
(SUBSET-UNION-3 (74 74 (:REWRITE DEFAULT-CAR))
                (63 63 (:REWRITE DEFAULT-CDR))
                (8 8 (:TYPE-PRESCRIPTION UNION-EQUAL)))
(SUBSET-UNION (343 343 (:REWRITE DEFAULT-CAR))
...
(SUBSET-UNION-4 (513 27 (:REWRITE SUBSET-UNION-2))
...
(SUBSET-UNION-LEFT-2 (513 27 (:REWRITE SUBSET-UNION-2))
...
(SUBSET-UNION-LEFT-NOT (314 212 (:REWRITE SUBSETP-EQUAL-TRANSITIVE))
...
(SUBSET-UNION-RIGHT-NOT (110 6 (:REWRITE SUBSET-UNION-LEFT-NOT))
...
(REMOVED-ELEMENT-IS-NOT-MEMBER (27 25 (:REWRITE DEFAULT-CAR))
...
(SUBSET-EQUAL-REMOVE (316 306 (:REWRITE DEFAULT-CAR))
...
(NOT-MEMBER-NOT-MEMBER-REMOVE (292 17 (:DEFINITION SUBSETP-EQUAL))
...
(SUBSET-CONS-REMOVE (81 68 (:REWRITE DEFAULT-CAR))
                    ...
                    (1 1
                       (:REWRITE REMOVED-ELEMENT-IS-NOT-MEMBER)))
(SUBSET-REMOVE-APPEND-ONE (207 129 (:REWRITE DEFAULT-CAR))
                          (152 83 (:REWRITE DEFAULT-CDR))
                          (5 1 (:REWRITE SUBSET-MEMBER-SUBSET-CONS)))
(NOT-EQUAL-MEMBER-REMOVE (98 90 (:REWRITE DEFAULT-CAR))
                         ...
                         (2 2
                            (:REWRITE REMOVED-ELEMENT-IS-NOT-MEMBER)))
(REMOVE-EQUAL-COMMUTATIVE (111 106 (:REWRITE DEFAULT-CAR))
                          (95 91 (:REWRITE DEFAULT-CDR)))
(REMOVE-EQUAL-IDEMPOTENT (45 43 (:REWRITE DEFAULT-CAR))
                         (34 33 (:REWRITE DEFAULT-CDR)))
(TRUE-LISTP-REMOVE-EQUAL)
(SET-EQUAL)
(SET-EQUAL-REFLEXIVE)
(SET-EQUAL-IS-AN-EQUIVALENCE (90 8 (:DEFINITION SUBSETP-EQUAL))
...
(SET-EQUAL-IMPLIES-SET-EQUAL-CONS-2 (20 2 (:DEFINITION SUBSETP-EQUAL))
                                    (6 6 (:REWRITE DEFAULT-CAR))
                                    (4 4 (:REWRITE NOT-MEMBER-SUBSET))
                                    (4 4 (:REWRITE DEFAULT-CDR)))
(MEMBER-APPEND-LEFT (132 66
...
(MEMBER-APPEND-RIGHT (325 18 (:REWRITE NOT-MEMBER-SUBSET))
...
(SUBSET-APPEND-LEFT (98 19 (:DEFINITION MEMBER-EQUAL))
...
(SET-EQUAL-MEMBER-EQUAL-CONS (4 1 (:DEFINITION MEMBER-EQUAL))
                             (3 3 (:REWRITE SUBSETP-EQUAL-TRANSITIVE))
                             (2 2 (:REWRITE NOT-MEMBER-SUBSET))
                             (1 1 (:REWRITE DEFAULT-CDR))
                             (1 1 (:REWRITE DEFAULT-CAR)))
(SET-EQUAL-NIL (6 1 (:REWRITE SUBSET-MEMBER-SUBSET-CONS))
               (4 4 (:REWRITE SUBSETP-EQUAL-TRANSITIVE))
               (2 2 (:REWRITE DEFAULT-CAR))
               (1 1 (:REWRITE NOT-MEMBER-SUBSET)))
(UNION-EQUAL-COMMUTE-SUBSET (186 12 (:DEFINITION SUBSETP-EQUAL))
                            (114 6 (:REWRITE SUBSET-UNION-2))
                            (98 2 (:DEFINITION UNION-EQUAL))
...
(UNION-EQUAL-ASSOCIATIVE (867 867 (:TYPE-PRESCRIPTION UNION-EQUAL))
...
(UNION-EQUAL-IDEMPOTENT-GENERAL (24 24 (:TYPE-PRESCRIPTION UNION-EQUAL)))
(SUBSET-APPEND-1 (38 9 (:DEFINITION MEMBER-EQUAL))
...
(SUBSET-APPEND-2 (68 4 (:REWRITE SUBSET-APPEND-1))
                 ...
                 (1 1 (:REWRITE SUBSET-MEMBER-SUBSET-CONS)))
(MEMBER-APPEND-CONS (3 1 (:DEFINITION BINARY-APPEND))
                    (2 2 (:REWRITE DEFAULT-CAR))
                    (1 1 (:REWRITE DEFAULT-CDR)))
(SUBSET-APPEND-CONS (344 9 (:DEFINITION SUBSETP-EQUAL))
...
(SUBSET-APPEND-CONS-3 (595 9 (:REWRITE SUBSET-APPEND-2))
...
(SETP-APPEND-2 (80 15 (:DEFINITION MEMBER-EQUAL))
...
(NOT-MEMBER-SET-DIFFERENCE (340 18 (:DEFINITION SUBSETP-EQUAL))
...
(SET-DIFFERENCE-EQUAL-NIL (8 8 (:REWRITE DEFAULT-CAR))
                          (5 5 (:REWRITE NOT-MEMBER-SUBSET))
                          (5 5 (:REWRITE DEFAULT-CDR)))
(CONSP-HAS-MEMBER-EQUAL (2 2 (:REWRITE DEFAULT-CAR))
                        (1 1 (:REWRITE NOT-MEMBER-SUBSET)))
(SUBSET-UNION-6 (324 6 (:REWRITE SUBSET-UNION-2))
                ...
                (6 6 (:REWRITE NOT-MEMBER-SUBSET)))
(SPECIAL-SET-LEMMA-2 (1188 51 (:DEFINITION SUBSETP-EQUAL))
...
(SUBSET-UNION-7 (633 13 (:REWRITE SUBSET-UNION-2))
...
(SPECIAL-SET-LEMMA-3 (2784 68 (:DEFINITION SUBSETP-EQUAL))
                     ...
                     (3 1 (:REWRITE SUBSET-UNION-LEFT-NOT))
                     (1 1 (:REWRITE SUBSET-UNION-RIGHT-NOT)))
(SUBSET-UNION-8 (821 36 (:DEFINITION SUBSETP-EQUAL))
                ...
                (22 2 (:REWRITE NOT-MEMBER-UNION-EQUAL))
                (12 12 (:REWRITE NOT-MEMBER-SUBSET)))
(SUBSET-UNION-9 (768 35 (:DEFINITION SUBSETP-EQUAL))
                ...
                (19 1 (:REWRITE SUBSET-UNION))
                (14 14 (:REWRITE NOT-MEMBER-SUBSET)))
(SPECIAL-SET-LEMMA-4 (1543 71 (:DEFINITION SUBSETP-EQUAL))
...
(SPECIAL-SET-LEMMA-6 (161 9 (:DEFINITION SUBSETP-EQUAL))
...
(DISJOINT)
(DISJOINT-NIL-RIGHT (5 5 (:REWRITE NOT-MEMBER-SUBSET))
                    (5 5 (:REWRITE DEFAULT-CAR))
                    (2 2 (:REWRITE DEFAULT-CDR)))
(DISJOINT-APPEND-UNION-1 (798 42 (:REWRITE SUBSET-UNION-2))
                         ...
                         (9 9 (:TYPE-PRESCRIPTION TRUE-LISTP))
                         (9 9 (:TYPE-PRESCRIPTION BINARY-APPEND)))
(DISJOINT-APPEND-UNION-2 (342 18 (:REWRITE SUBSET-UNION-2))
...
(DISJOINT-APPEND-UNION-3 (342 18 (:REWRITE SUBSET-UNION-2))
                         ...
                         (13 13 (:TYPE-PRESCRIPTION BINARY-APPEND))
                         (8 8 (:TYPE-PRESCRIPTION UNION-EQUAL)))
(DISJOINT-APPEND-UNION-4 (798 42 (:REWRITE SUBSET-UNION-2))
                         (686 14 (:DEFINITION UNION-EQUAL))
                         ...
                         (9 9 (:TYPE-PRESCRIPTION TRUE-LISTP))
                         (9 9 (:TYPE-PRESCRIPTION BINARY-APPEND)))
(DISJOINT-APPEND-1 (34 25 (:REWRITE DEFAULT-CAR))
                   (26 13
                       (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
                   (21 18 (:REWRITE DEFAULT-CDR))
                   ...
                   (13 13 (:TYPE-PRESCRIPTION TRUE-LISTP))
                   (13 13 (:TYPE-PRESCRIPTION BINARY-APPEND)))
(DISJOINT-APPEND-2 (55 4 (:REWRITE DISJOINT-APPEND-1))
                   ...
                   (9 9 (:TYPE-PRESCRIPTION TRUE-LISTP))
                   (9 9 (:TYPE-PRESCRIPTION BINARY-APPEND)))
(DISJOINT-APPEND-3 (116 14 (:REWRITE MEMBER-APPEND-RIGHT))
...
(DISJOINT-APPEND-4 (196 9 (:REWRITE DISJOINT-APPEND-3))
                   ...
                   (12 12 (:TYPE-PRESCRIPTION BINARY-APPEND))
                   (9 9 (:REWRITE SUBSETP-EQUAL-TRANSITIVE)))
(DISJOINT-UNION-1 (456 24 (:REWRITE SUBSET-UNION-2))
                  ...
                  (12 12 (:TYPE-PRESCRIPTION UNION-EQUAL)))
(DISJOINT-UNION-2 (456 24 (:REWRITE SUBSET-UNION-2))
                  ...
                  (12 12 (:TYPE-PRESCRIPTION UNION-EQUAL)))
(DISJOINT-SKOLEM)
(DISJOINT-SKOLEM-LEMMA (126 126 (:REWRITE DEFAULT-CAR))
