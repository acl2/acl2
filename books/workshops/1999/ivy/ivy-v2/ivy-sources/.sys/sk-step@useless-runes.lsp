(STEP-SK
 (2417 2417 (:REWRITE DEFAULT-CDR))
 (1342 1342 (:REWRITE DEFAULT-CAR))
 (540 9 (:DEFINITION EXISTS-COUNT))
 (530 258 (:REWRITE DEFAULT-+-2))
 (343 258 (:REWRITE DEFAULT-+-1))
 (334 2 (:LINEAR ACL2-COUNT-CAR-CDR-LINEAR))
...
(STEP-SK-ARITY
 ...
 (534 260 (:REWRITE DEFAULT-+-2))
 (346 260 (:REWRITE DEFAULT-+-1))
 (334 2 (:LINEAR ACL2-COUNT-CAR-CDR-LINEAR))
 (144 36 (:DEFINITION INTEGER-ABS))
 (144 18 (:DEFINITION LENGTH))
...
(BUILD-SK
 (1985 1979 (:REWRITE DEFAULT-CDR))
 (1258 1238 (:REWRITE DEFAULT-CAR))
 (961 434 (:REWRITE DEFAULT-+-2))
 (900 15 (:DEFINITION EXISTS-COUNT))
 (673 18 (:DEFINITION ACL2-COUNT))
 (578 434 (:REWRITE DEFAULT-+-1))
...
(BUILD-SK-I
 (2213 2203 (:REWRITE DEFAULT-CDR))
 (1438 33 (:DEFINITION ACL2-COUNT))
 (1396 1361 (:REWRITE DEFAULT-CAR))
 (1304 598 (:REWRITE DEFAULT-+-2))
 (900 15 (:DEFINITION EXISTS-COUNT))
 (802 598 (:REWRITE DEFAULT-+-1))
