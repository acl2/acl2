(DIST-OR-AND-2 (198 95 (:REWRITE DEFAULT-+-2))
...
(DIST-OR-AND (198 95 (:REWRITE DEFAULT-+-2))
...
(CNF (2511 2511 (:REWRITE DEFAULT-CDR))
...
(CNF-WFF (959 959 (:REWRITE DEFAULT-CDR))
         ...
         (27 27 (:TYPE-PRESCRIPTION VARIABLE-TERM)))
(DIST-OR-AND-2-CNFP (24578 24308 (:REWRITE DEFAULT-CDR))
                    (1005 1005
                          (:TYPE-PRESCRIPTION DIST-OR-AND-2)))
(DIST-OR-AND-CNFP (9494 9386 (:REWRITE DEFAULT-CDR))
                  (4536 4482 (:REWRITE DEFAULT-CAR))
                  (1386 99 (:DEFINITION DIST-OR-AND-2))
                  (402 402 (:TYPE-PRESCRIPTION DIST-OR-AND)))
(CNF-CNFP (1833 1833 (:REWRITE DEFAULT-CDR))
          (838 838 (:REWRITE DEFAULT-CAR))
          (144 144 (:TYPE-PRESCRIPTION CNF))
          (108 3 (:DEFINITION DIST-OR-AND))
          (54 3 (:DEFINITION DIST-OR-AND-2)))
(SUBST-DIST-DIST-2 (12920 12671 (:REWRITE DEFAULT-CDR))
...
(SUBST-DIST-DIST (14218 13969 (:REWRITE DEFAULT-CDR))
...
(SUBST-CNF-COMMUTE (4407 4407 (:REWRITE DEFAULT-CDR))
...
(CNF-FSOUND-FLG (23920 184 (:DEFINITION SUBST-FREE))
