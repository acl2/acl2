(SIMP-TF (945 457 (:REWRITE DEFAULT-+-2))
...
(SIMP-TF-WFF (5372 5372 (:REWRITE DEFAULT-CDR))
             (2494 2494 (:REWRITE DEFAULT-CAR))
             (318 106
                  (:REWRITE VARIABLE-TERM-IS-NOT-DOMAIN-TERM))
             (106 106 (:TYPE-PRESCRIPTION VARIABLE-TERM)))
(TF-FREE (669 325 (:REWRITE DEFAULT-+-2))
...
(TF-FREE-EXCEPT-TOP)
(SIMP-COMPLETE-1 (4729 4729 (:REWRITE DEFAULT-CDR))
                 (1189 1189 (:REWRITE DEFAULT-CAR)))
(SIMP-COMPLETE-2 (246 3 (:DEFINITION SIMP-TF))
...
(NOT-EQUAL-SUBST-TRUE (5 5 (:TYPE-PRESCRIPTION SUBST-FREE)))
(NOT-EQUAL-SUBST-FALSE (894 894 (:REWRITE DEFAULT-CDR))
...
(SUBST-SIMP-TF-COMMUTE (8218 676
                             (:REWRITE DOMAIN-TERM-LIST-TRUE-LISTP))
...
(SIMP-TF-XSOUND (47205 47205 (:REWRITE DEFAULT-CDR))
...
(SIMP-TF-FSOUND (506 2 (:DEFINITION XEVAL))
...
(SIMP-TF-PRESERVES-NNFP (6294 6294 (:REWRITE DEFAULT-CDR))
