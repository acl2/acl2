...
(SUBBAG-REMOVE1-EQUAL-QVARS-LEMMA-1
     ...
     (4232 66
           (:REWRITE MEMBER-NOT-EQUAL-REMOVE1-EQUAL))
     (2410 38
           (:REWRITE RENAME-BOUND-DOESNT-CHANGE-OTHER-VARIABLES))
     (2300 12
           (:REWRITE REMOVE1-EQUAL-APPEND-COMMUTE-2))
     (1316 658
           (:REWRITE RENAME-BOUND-PRESERVES-CAR))
...
(DISJOINT-CONS (517 38 (:REWRITE DOMAIN-TERM-LIST-MEMBER))
...
(NEW-VARS-REALLY-GET-THERE-LEMMA
     ...
     (870 15
          (:REWRITE RENAME-BOUND-INTRODUCES-NEW-VARIABLE))
...
(NEW-VARS-REALLY-GET-THERE (249 1 (:DEFINITION RENAME-BUNCH))
                           (240 1 (:DEFINITION RENAME-BOUND))
...
(DOUBLE-LIST-INDUCT (121 58 (:REWRITE DEFAULT-+-2))
...
(LEN-APPEND-RIGHT (119 60 (:REWRITE DEFAULT-+-2))
...
(SAFE-LIST-IS-PERM-OF-QVARS-RENAME-ALL
     ...
     (69 1
         (:REWRITE RENAME-BUNCH-INTRODUCES-NEW-VARIABLES))
     (65 65
         (:TYPE-PRESCRIPTION VAR-OCCURRENCE-TERM-LIST))
