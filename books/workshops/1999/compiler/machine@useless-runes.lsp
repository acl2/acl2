(BUTLST (140 61 (:REWRITE DEFAULT-+-2))
...
(M1+)
(M1-)
(MAPPEND (137 66 (:REWRITE DEFAULT-+-2))
...
(MMEMBER (74 36 (:REWRITE DEFAULT-+-2))
         ...
         (4 4 (:REWRITE DEFAULT-COERCE-2))
         (4 4 (:REWRITE DEFAULT-COERCE-1)))
(MASSOC (116 56 (:REWRITE DEFAULT-+-2))
...
(M-)
(M*)
(MCAR-IS-LIKE-CAR (2 2 (:REWRITE DEFAULT-CAR)))
(MCDR-IS-LIKE-CDR (2 2 (:REWRITE DEFAULT-CDR)))
(M1+-IS-LIKE-1+ (3 2 (:REWRITE DEFAULT-+-2))
                (2 2
...
(MMEMBER-IS-LIKE-MEMBER (11 11 (:REWRITE DEFAULT-CAR))
                        (4 4 (:REWRITE DEFAULT-CDR)))
(MASSOC-IS-LIKE-ASSOC (28 28 (:REWRITE DEFAULT-CAR))
                      (4 4 (:REWRITE DEFAULT-CDR)))
(M+-IS-LIKE-+ (9 9
                 (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(M--IS-LIKE-- (9 9
...
(INSTRUCTIONP (568 270 (:REWRITE DEFAULT-+-2))
...
(DECLSP (83 39 (:REWRITE DEFAULT-+-2))
...
(PROGP)
(GET-CODE)
(CODEP-IMPLIES-GOOD-CODE (52 52 (:REWRITE DEFAULT-CAR))
                         (26 26 (:REWRITE DEFAULT-CDR)))
(CODEP-IMPLIES-ALISTP (51 51 (:REWRITE DEFAULT-CAR))
                      (20 20 (:REWRITE DEFAULT-CDR)))
(CODEP-IMPLIES-CONSP-ASSOC (69 69 (:REWRITE DEFAULT-CAR))
                           (28 7 (:DEFINITION INSTRUCTION-LISTP))
                           (20 20 (:REWRITE DEFAULT-CDR))
                           (7 7 (:TYPE-PRESCRIPTION INSTRUCTIONP)))
(OPR (1 1 (:TYPE-PRESCRIPTION MAPPEND)))
(MSTEP (1022 529 (:REWRITE DEFAULT-+-2))
...
(DOWNLOAD (137 66 (:REWRITE DEFAULT-+-2))
          (92 66 (:REWRITE DEFAULT-+-1))
          (56 14 (:REWRITE COMMUTATIVITY-OF-+))
          (56 14 (:DEFINITION INTEGER-ABS))
          (56 7 (:DEFINITION LENGTH))
          ...
          (4 1 (:DEFINITION INSTRUCTION-LISTP))
          (1 1 (:TYPE-PRESCRIPTION INSTRUCTIONP)))
(EXECUTE (608 583 (:REWRITE DEFAULT-CDR))
         (543 436 (:REWRITE DEFAULT-CAR))
         (19 19 (:REWRITE DEFAULT-<-2))
         (19 19 (:REWRITE DEFAULT-<-1)))
(MSTEPS-EQN (494 2 (:DEFINITION MSTEP))
...
(MSTEP-EQN (339 276 (:REWRITE DEFAULT-CDR))
           ...
           (3 3 (:TYPE-PRESCRIPTION LEN)))
(MACHINE-INDUCTION (976 501 (:REWRITE DEFAULT-+-2))
