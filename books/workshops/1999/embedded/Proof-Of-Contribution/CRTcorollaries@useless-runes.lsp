...
(PG-HACK-2)
(PG-HACK-3 (27 27 (:REWRITE DEFAULT-*-2))
...
(GCD-DIVIDES-BOTH (178 2 (:DEFINITION NONNEG-INT-GCD))
                  (144 12
                       (:REWRITE NONNEG-INT-MOD-WHEN-DIVIDES))
                  ...
                  (4 4 (:LINEAR *-STRONGLY-MONOTONIC . 1))
                  (2 2 (:REWRITE A8)))
(DIVBOTH1 (25 23 (:REWRITE DEFAULT-*-2))
          ...
          (4 4 (:REWRITE DEFAULT-<-2))
          (4 4 (:REWRITE DEFAULT-<-1)))
(DIVBOTH2 (103 103 (:REWRITE DEFAULT-*-2))
...
(DIVIDED-BY-ALL)
(HELPER (586 586 (:TYPE-PRESCRIPTION NATP-ALL))
...
(HELPER2)
(REL-PRIME-OF-PRODUCT (424 424 (:TYPE-PRESCRIPTION NATP-ALL))
                      ...
                      (36 36
                          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                      (2 2 (:TYPE-PRESCRIPTION POSP)))
(HELPER3 (72 72 (:REWRITE DEFAULT-CAR))
...
(PROD-IS-POS (50 8 (:REWRITE NATP-POSP))
             ...
             (2 2
                (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(CONGRUENT-MOD)
(CONGRUENT-ALL-MOD (10 5 (:REWRITE DEFAULT-+-2))
...
(INT-EQU-MODNEG (18 6 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
...
(MOD--)
(CONGRUENT-ALL-MOD-LIST (10 5 (:REWRITE DEFAULT-+-2))
                        (6 6 (:REWRITE DEFAULT-CDR))
                        (5 5 (:REWRITE DEFAULT-+-1))
...
(REL-PRIME-IS-POS (28 7 (:REWRITE NATP-POSP))
...
(SAME-CONGRUENCE-OVER-CONGLIST
     ...
     (14 14 (:REWRITE DEFAULT-CDR))
     (8 8
        (:REWRITE DIFF-PROD-MEANS-CONG-ALL-MOD-LIST))
     (8 8
...
(DIFF-PROD-MEANS-CONG-ALL-MOD-LIST-INV
     ...
     (2 2 (:REWRITE MOD--))
     (2 2 (:REWRITE MOD-+-EXP)))
(MYAX (163 163 (:REWRITE DEFAULT-CDR))
...
(SIL1 (10 4 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
      ...
      (1 1 (:REWRITE POSP-RW))
      (1 1 (:REWRITE NATP-RW)))
(CASESOFRESDIV (8 8 (:META CANCEL_PLUS-LESSP-CORRECT))
               (6 6 (:REWRITE DEFAULT-<-2))
               (6 6 (:REWRITE DEFAULT-<-1))
               (4 4 (:REWRITE DEFAULT-*-2))
               (4 4 (:REWRITE DEFAULT-*-1))
...
(A-NUMBER-IN-ARANGE-IS-0-IF-NO-REST
     ...
     (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
     (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(EQUALITY-IN-RANGE-1 (124 26 (:REWRITE CASESOFRESDIV))
                     ...
                     (7 7 (:REWRITE DEFAULT-UNARY-/))
                     (1 1 (:REWRITE EQUAL-CONSTANT-+)))
(SIL2 (82 12 (:REWRITE CASESOFRESDIV))
...
(EQUALITY-IN-RANGE-2 (4 4
                        (:TYPE-PRESCRIPTION |x < y  =>  0 < y-x|)))
(UNIQUE-INVERSION (333 21 (:REWRITE CASESOFRESDIV))
...
(SILS2 (126 3 (:DEFINITION PROD))
       ...
       (3 3
          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(SILS1)
(CHINESE-REMAINDER-2 (704 2 (:DEFINITION CONGRUENT-ALL))
...
(LEMMA-X (35 34 (:REWRITE DEFAULT-CAR))
...
(CRT-INVERSION
     ...
     (28 2
         (:REWRITE MODULO-PROD-HAS-SAME-CONGRUENCE))
     (28 2
         (:REWRITE ANY-NUMBER-WHICH-DIVIDED-BY-ALL-HAS-SAME-CONGRUENCE))
...
(ANY-NUMBER-WHICH-DIVIDES-MAKES-SAME-RESIDUES
     ...
     (7 7 (:REWRITE DEFAULT-*-2))
     (7 7 (:REWRITE DEFAULT-*-1)))
(MOD-PROD-MAKES-SAME-RESIDUES (42 1 (:DEFINITION PROD))
