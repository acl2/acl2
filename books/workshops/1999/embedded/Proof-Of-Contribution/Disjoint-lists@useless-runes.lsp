(IN-RANGE)
(NO-DUP-1 (25 17 (:REWRITE DEFAULT-<-2))
          ...
          (8 8 (:REWRITE ZP-OPEN)))
(NO-DUP-3 (90 52 (:REWRITE DEFAULT-+-2))
...
(MEMBER-OF-NTH-ENTRY-OF-LL-IS-MEMBER-OF-APPEND-OF-FIRST-N-ENTRIES-IN-EXCESS
  ...
  (32 32
      (:REWRITE
           NO-DUPLICATES-IN-APPEND-IMPLY-DIFFERENT-ELEMENTS-IN-COMPONENTS-2))
  (32 32
      (:REWRITE DISJOINT-SETS-HAVE-NO-COMMON-ELS-2))
  (16 8
      (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
...
(GENERALIZED-DISJUNCTIVITY-OF-ELS-2
 ...
 (1
  ...
  (:REWRITE
   MEMBER-OF-NTH-ENTRY-OF-LL-IS-MEMBER-OF-APPEND-OF-FIRST-N-ENTRIES-IN-EXCESS)))
(DIFFERENT-LIST-INDEXES-ARE-DIFFERENT (10 2 (:DEFINITION LEN))
...
(APPEND-LISTS-CAR-CDR (15 5 (:DEFINITION BINARY-APPEND))
                      (13 13 (:REWRITE DEFAULT-CDR))
                      (10 10 (:REWRITE DEFAULT-CAR)))
(APPEND-LISTS-FIRST-MIDDLE-END (130 130 (:REWRITE DEFAULT-CDR))
...
(NO-DUPLICATES-ALL-IMPLIES-NO-DUPLICATES-ONE
  ...
  (2 2
     (:TYPE-PRESCRIPTION TRUE-LISTP-NTHCDR-TYPE-PRESCRIPTION))
  (2 2 (:TYPE-PRESCRIPTION FIRSTN)))
(NO-MEMBER-HOLDS-ON-FIRSTN (14 13 (:REWRITE DEFAULT-CAR))
