(MODEL-CHECK::MU-SEMANTICS (2758 1354 (:REWRITE DEFAULT-+-2))
                           (1818 1354 (:REWRITE DEFAULT-+-1))
                           ...
                           (2 2 (:REWRITE ZP-OPEN)))
(MODEL-CHECK::SEMANTICS-IND (9946 4805 (:REWRITE DEFAULT-+-2))
                            (6509 4805 (:REWRITE DEFAULT-+-1))
...
(MODEL-CHECK::OPEN-EX (223 223 (:REWRITE DEFAULT-CDR))
                      ...
                      (16 4
                          (:DEFINITION MODEL-CHECK::ATOMIC-PROPS))
                      (12 12 (:REWRITE DEFAULT-+-1))
                      (4 4 (:TYPE-PRESCRIPTION IN))
                      (3 3
                         (:DEFINITION FAST-SETS::SET-COMPLEMENT)))
(MODEL-CHECK::OPEN-NOT (203 203 (:REWRITE DEFAULT-CDR))
                       (180 32 (:DEFINITION IN))
                       ...
                       (24 12 (:REWRITE DEFAULT-+-2))
                       (18 3
                           (:DEFINITION MODEL-CHECK::INVERSE-RELATION))
                       (16 4
                           (:DEFINITION MODEL-CHECK::ATOMIC-PROPS))
                       (14 5 (:REWRITE MODEL-CHECK::OPEN-EX))
                       (12 12 (:REWRITE DEFAULT-+-1))
                       (4 4 (:TYPE-PRESCRIPTION IN)))
(MODEL-CHECK::OPEN-AND (391 391 (:REWRITE DEFAULT-CDR))
...
(MODEL-CHECK::OPEN-OR
     ...
     (84 12 (:DEFINITION ASSOC-EQUAL))
     (55 38
         (:TYPE-PRESCRIPTION FAST-SETS::SET-UNION-RETURN-TYPE))
     (50 25 (:REWRITE DEFAULT-+-2))
     (42 6 (:DEFINITION MODEL-CHECK::A-LABELING))
     (38 38
     ...
     (6 6
        (:DEFINITION FAST-SETS::SET-COMPLEMENT)))
(MODEL-CHECK::OPEN-MU (97 97 (:REWRITE DEFAULT-CDR))
                      (75 3
                          (:DEFINITION MODEL-CHECK::COMPUTE-FIX-POINT))
                      (64 8 (:DEFINITION PUT-ASSOC-EQUAL))
                      (56 56 (:REWRITE DEFAULT-CAR))
                      (29 16 (:REWRITE DEFAULT-+-2))
                      (27 3
                          (:REWRITE RELATIONS::PUT-ASSOC-EQUAL-TWICE))
                      ...
                      (6 6
                         (:REWRITE RELATIONS::ASSOC-EQUAL-PUT-ASSOC-EQUAL))
...
(MODEL-CHECK::OPEN-NU (97 97 (:REWRITE DEFAULT-CDR))
                      (87 3
                          (:DEFINITION MODEL-CHECK::COMPUTE-FIX-POINT))
...
(MODEL-CHECK::OPEN-COMPUTE-FIX-POINT
     ...
     (189 9
          (:REWRITE SETS::|X =< Y  ==>  X-Y == {}|))
     (189 9
          (:REWRITE SETS::|X =< Y  ==>  X & Y == X|))
...
(MODEL-CHECK::SEM-IS-TRUE-LISTP
     ...
     (6 6
        (:REWRITE SETS::|X =< Y & Y =< Z  =>  X =< Z|)))
(MODEL-CHECK::MU-SEMANTICS (1681 7
                                 (:DEFINITION MODEL-CHECK::MU-SEMANTICS))
                           ...
                           (1 1 (:REWRITE ZP-OPEN)))
(MODEL-CHECK::SEMANTICS (1 1
                           (:TYPE-PRESCRIPTION MODEL-CHECK::TRANSLATE-F)))
(MODEL-CHECK::MODEL-CHECK
     (19111 1720 (:DEFINITION IN))
     (18240 160
            (:DEFINITION MODEL-CHECK::TRANSLATE-F))
     (16529 2
            (:DEFINITION MODEL-CHECK::BASIC-M-CALC-FORMULAP))
     (12966 10
...
(MODEL-CHECK::MU-SEMANTICS-STAYS-IN-BOUNDS
     ...
     (1634 1634 (:REWRITE DEFAULT-+-1))
     (1634 74
           (:REWRITE SETS::|X =< Y  ==>  X u Y == Y|))
     (1390 1390
           (:TYPE-PRESCRIPTION SETS::REM-DUPS))
     ...
     (9 9
        (:TYPE-PRESCRIPTION FAST-SETS::MINUS)))
...
(MODEL-CHECK::SEM-MON-F-IS-SEM-MONOTONE
     ...
     (2 2 (:REWRITE DEFAULT-+-1))
     (2 2 (:LINEAR SETS::S<-IMPLIES-<-LEN)))
(MODEL-CHECK::MU-SYMBOL-NOT-+-OR-& (13 13 (:META CANCEL_TIMES-EQUAL-CORRECT))
...
(MODEL-CHECK::SEMMU-IS-A-FIXPOINT
     ...
     (140 20 (:DEFINITION ASSOC-EQUAL))
     (108 8
          (:REWRITE MODEL-CHECK::OPEN-COMPUTE-FIX-POINT))
     ...
     (17 17
         (:REWRITE MODEL-CHECK::GOOD-VAL-RANGE-OK))
...
(MODEL-CHECK::SEMMU-IS-BELOW-ALL-POST-FIXPOINTS
     ...
     (1015 11
           (:REWRITE MODEL-CHECK::MU-SEMANTICS-STAYS-IN-BOUNDS))
     (698 21
          (:DEFINITION RELATIONS::REL-RANGE-SUBSET))
     (618 3
          (:REWRITE FAST-SETS::FAST-INTERSECT-IS-SET-INTERSECT))
     (585 529 (:REWRITE DEFAULT-CDR))
     (564 9 (:DEFINITION MODEL-CHECK::MU-SYMBOLP))
     (557 516 (:REWRITE DEFAULT-CAR))
     (531 11
          (:REWRITE RELATIONS::EXPAND-RELATION-OK))
     (501 3
          (:REWRITE FAST-SETS::FAST-SET-UNION-IS-SET-UNION))
     (480 9
          (:REWRITE SETS::|X =< Y  ==>  X & Y == X|))
     ...
     (273 3
          (:DEFINITION FAST-SETS::SET-COMPLEMENT))
     (270 3
          (:REWRITE FAST-SETS::FAST-MINUS-IS-MINUS))
     (264 8 (:DEFINITION SETS::SET-REMOVE))
     (258 3 (:DEFINITION SETS::INTERSECT))
     (252 42
          (:REWRITE RELATIONS::=<-IMAGE-REL-OK2))
     (204 3 (:DEFINITION SETS::MINUS))
     (189 9
          (:REWRITE SETS::|X =< Y  ==>  X-Y == {}|))
     (170 170
     ...
     (105 105
          (:TYPE-PRESCRIPTION RELATIONS::REL-RANGE-SUBSET))
