...
(PERM-REMOVE-EL-APP (219 219 (:TYPE-PRESCRIPTION BINARY-APPEND))
                    (65 53 (:REWRITE DEFAULT-CAR))
                    (61 49 (:REWRITE DEFAULT-CDR)))
(PERM-IMPLIES-PERM-REMOVE-EL-2 (45 2 (:DEFINITION PERM))
...
(PERM-IMPLIES-PERM-APPEND-1 (914 457
...
(PERM-IMPLIES-PERM-CONS-2 (14 14 (:REWRITE DEFAULT-CAR))
                          (10 10 (:REWRITE DEFAULT-CDR))
                          (6 6 (:TYPE-PRESCRIPTION IN))
                          (2 2 (:REWRITE CAR-PERM)))
(PERM-APP-CONS (485 191 (:REWRITE DEFAULT-CAR))
