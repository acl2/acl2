...
(DIVIDES-* (6 6 (:TYPE-PRESCRIPTION NOT-INTEGERP-3A))
...
(COVER-ONE (205 41 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
           (205 41
...
(COVER=>COVER-ONE (18 18 (:REWRITE SIMPLIFY-SUMS-<))
                  (18 18
                      (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-<))
                  (18 18
                      (:REWRITE REMOVE-WEAK-INEQUALITIES-TWO))
                  ...
                  (2 2 (:REWRITE DEFAULT-+-2))
                  (2 2 (:REWRITE DEFAULT-+-1)))
(COVER-< (842 178 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
         (842 178
              (:TYPE-PRESCRIPTION MOD-POSITIVE . 2))
         (376 376
              (:TYPE-PRESCRIPTION NOT-INTEGERP-4B))
         ...
         (5 5 (:REWRITE |(< 0 (- x))|))
         (2 2 (:LINEAR MOD-BOUNDS-2)))
(COVER-MOD (4468 1072 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
           (4468 1072
                 (:TYPE-PRESCRIPTION MOD-POSITIVE . 2))
           (1998 1998
                 (:TYPE-PRESCRIPTION NOT-INTEGERP-3B))
...
(COVER-THM (2165 433 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
           (2165 433
                 (:TYPE-PRESCRIPTION MOD-POSITIVE . 2))
           (1048 1048
                 (:TYPE-PRESCRIPTION NOT-INTEGERP-3B))
...
(KEY-LEMMA-SIERPINSKI (656 110 (:REWRITE DEFAULT-*-2))
...
(ALGEBRA-LEMMA-3
     ...
     (2 2 (:LINEAR EXPT-<-1-TWO))
     (2 2 (:LINEAR EXPT-<-1-ONE)))
(ALGEBRA-LEMMA-4 (1055 71 (:REWRITE DEFAULT-+-2))
                 (425 361
                      (:TYPE-PRESCRIPTION RATIONALP-EXPT-TYPE-PRESCRIPTION))
...
(FACTOR-DIVIDES (2 2 (:REWRITE REDUCE-INTEGERP-+))
                (2 2
                   (:REWRITE NORMALIZE-FACTORS-GATHER-EXPONENTS))
                ...
                (1 1 (:REWRITE |(* c (* d x))|)))
(ALGEBRA-LEMMA-5 (770 83 (:REWRITE DEFAULT-+-2))
...
(LEMMA-EXCEPTIONAL-CASE-A
     ...
     (1 1 (:REWRITE FLOOR-NEGATIVE . 3))
     (1 1 (:REWRITE FLOOR-NEGATIVE . 2)))
(INTEGERP-EXCEPTIONAL-DIVISOR (2 2 (:TYPE-PRESCRIPTION FLOOR-ZERO . 3))
...
(PROPER-DIVISOR
     ...
     (12 12
         (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-INTEGERP-BASE))
     (5 5
        (:TYPE-PRESCRIPTION INTEGERP-EXCEPTIONAL-DIVISOR)))
(INTEGERP-PROPER-DIVISOR
     ...
     (1 1 (:REWRITE |(+ c (+ d x))|)))
(PROPER-DIVISOR>1 (1301 285 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
                  (1301 285
                        (:TYPE-PRESCRIPTION MOD-POSITIVE . 2))
                  (714 34 (:REWRITE MOD-ZERO . 2))
                  (609 609
