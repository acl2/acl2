...
(COVER=>COVER-ONE (18 18 (:REWRITE SIMPLIFY-SUMS-<))
                  ...
                  (2 2 (:REWRITE DEFAULT-+-2))
                  (2 2 (:REWRITE DEFAULT-+-1)))
(COVER-< (782 166 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
         (782 166
              (:TYPE-PRESCRIPTION MOD-POSITIVE . 2))
         (352 352
              (:TYPE-PRESCRIPTION NOT-INTEGERP-4B))
         ...
         (4 4 (:REWRITE |(< 0 (- x))|))
         (2 2 (:LINEAR MOD-BOUNDS-2)))
(COVER-MOD (4554 1094 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
           (4554 1094
                 (:TYPE-PRESCRIPTION MOD-POSITIVE . 2))
           (2033 2033
                 (:TYPE-PRESCRIPTION NOT-INTEGERP-3B))
...
(COVER-THM (1355 271 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
           (1355 271
                 (:TYPE-PRESCRIPTION MOD-POSITIVE . 2))
           (724 724
                (:TYPE-PRESCRIPTION NOT-INTEGERP-4B))
...
(INTEGERP-PROPER-DIVISOR
     ...
     (1 1 (:REWRITE |(+ c (+ d x))|)))
(PROPER-DIVISOR>1 (1291 283 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
                  (1291 283
                        (:TYPE-PRESCRIPTION MOD-POSITIVE . 2))
                  (651 31 (:REWRITE MOD-ZERO . 2))
                  (602 602
