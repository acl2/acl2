...
(DEFSIMULATE+-FN)
(TRY-NEXT (1 1 (:TYPE-PRESCRIPTION TRY-NEXT)))
(TRY-RUN (6 6 (:TYPE-PRESCRIPTION TRY-NEXT))
         (4 4
...
($$$STEPS-TO-EXITPOINT-SUB-TAIL)
($$$STEPS-TO-EXITPOINT-SUB-TAIL-DEF (12 12 (:REWRITE DEFAULT-CDR))
...
($$$NEXT-CUTPOINT-MAIN)
($$$NEXT-CUTPOINT-MAIN-DEF (9 9 (:REWRITE DEFAULT-CDR))
...
(|$$$MAIN-STEPS-TO-EXITPOINT-TAIL-arity-1|
 (1
  1
  (:TYPE-PRESCRIPTION |$$$MAIN-STEPS-TO-EXITPOINT-TAIL-arity-1-defpun-stn|)))
...
(|TRY-STEPS-TO-EXITPOINT-TAIL-SUB-arity-1|
 (1
  1
  (:TYPE-PRESCRIPTION |TRY-STEPS-TO-EXITPOINT-TAIL-SUB-arity-1-defpun-stn|)))
...
(TRY-STEPS-TO-EXITPOINT-TAIL-SUB-DEF
     ...
     (1 1
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (1 1 (:REWRITE DEFAULT-+-1)))
(TRY-STEPS-TO-EXITPOINT-TAIL-SUB$DEF (1 1 (:TYPE-PRESCRIPTION TRY-NEXT)))
