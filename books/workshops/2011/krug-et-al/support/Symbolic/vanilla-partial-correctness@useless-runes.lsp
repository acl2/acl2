...
(NO-BIG-EXITPOINT-IMPLIES-LITTLE-LESS
 ...
 (591 148 (:REWRITE FALSIFIER-IS-NATP-OR-OMEGA))
 (577 546 (:REWRITE DEFAULT-<-1))
 (316 160 (:REWRITE FOLD-CONSTS-IN-+))
 (219 6 (:LINEAR FALSIFIER-IF-NATP-IS-LESS-THAN-N))
...
(BIG-STEPS-ALTERNATE-DEFINITION
 ...
 (10720 184 (:REWRITE NO-BIG-EXITPOINT-IMPLIES-LITTLE-LESS))
 (7542 144 (:REWRITE FALSIFIER-FALSIFIES-1))
 (6081 72 (:DEFINITION NO-BIG-EXITPOINT))
 (5670 144 (:DEFINITION FALSIFIER-NO-EXITPOINT))
...
(FIRST-EXITPOINT-HAS-ASSERTION-TOO
 ...
 (630 630 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(PARTIAL-CORRECTNESS
 (7328 156 (:LINEAR LITTLE-IS-MONOTONIC))
 (4488 78 (:REWRITE NO-BIG-EXITPOINT-IMPLIES-LITTLE-LESS))
