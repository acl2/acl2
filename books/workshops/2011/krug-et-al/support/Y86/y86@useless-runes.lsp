...
(HANDLE-PAGE-FAULT)
(Y86-NOP)
(Y86-HALT (1 1 (:TYPE-PRESCRIPTION Y86-HALT)))
(Y86-RRMOVL (12 6
                (:TYPE-PRESCRIPTION |(n08p (r08 addr st))|))
            (6 6 (:TYPE-PRESCRIPTION MEMORYP)))
(Y86-IRMOVL (12 12 (:TYPE-PRESCRIPTION MEMORYP))
            (12 6
                (:TYPE-PRESCRIPTION |(n32p (r32 addr (g :mem st)))|))
            (12 6
                (:TYPE-PRESCRIPTION |(n08p (r08 addr st))|)))
(Y86-RMMOVL (12 12 (:TYPE-PRESCRIPTION MEMORYP))
            (12 6
                (:TYPE-PRESCRIPTION |(n32p (r32 addr (g :mem st)))|))
            (12 6
                (:TYPE-PRESCRIPTION |(n08p (r08 addr st))|)))
...
(SHRL-CF)
(SHRL-OF)
(UNPACK (1 1 (:TYPE-PRESCRIPTION UNPACK)))
(|(n01p (cf x y))|)
(|(n01p (zf x))|)
(|(n01p (of x y))|)
(|(n01p (sf x))|)
...
(|(unpack (nat-to-boolean (sall-cf shift CrB)))|
     ...
     (2 2
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(|(unpack (nat-to-boolean (sall-of CrB)))| (24 16 (:REWRITE DEFAULT-*-2))
...
(|(unpack (nat-to-boolean (shrl-cf shift CrB)))|
     ...
     (2 2
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(|(unpack (nat-to-boolean (shrl-of CrB)))| (12 8 (:REWRITE DEFAULT-*-2))
...
(Y86-PUSHL (12 6
               (:TYPE-PRESCRIPTION |(n08p (r08 addr st))|))
           (6 6 (:TYPE-PRESCRIPTION MEMORYP)))
(Y86-POPL (12 12 (:TYPE-PRESCRIPTION MEMORYP))
          (12 6
              (:TYPE-PRESCRIPTION |(n32p (r32 addr (g :mem st)))|))
          (12 6
              (:TYPE-PRESCRIPTION |(n08p (r08 addr st))|)))
(Y86-IADDL (12 12 (:TYPE-PRESCRIPTION MEMORYP))
           (12 6
               (:TYPE-PRESCRIPTION |(n32p (r32 addr (g :mem st)))|))
           (12 6
               (:TYPE-PRESCRIPTION |(n08p (r08 addr st))|)))
...
(|(y86-step st)|
     ...
     (2 2 (:DEFINITION OP2)))
(UPDATE-REGS-FN (153 71 (:REWRITE DEFAULT-+-2))
...
(UPDATE-MEM-FN (153 71 (:REWRITE DEFAULT-+-2))
               (99 71 (:REWRITE DEFAULT-+-1))
               (56 14 (:REWRITE COMMUTATIVITY-OF-+))
               (56 14 (:DEFINITION INTEGER-ABS))
               (56 7 (:DEFINITION LENGTH))
               ...
               (7 7 (:REWRITE DEFAULT-COERCE-2))
               (7 7 (:REWRITE DEFAULT-COERCE-1)))
(UNTRANS-UPDATE-REGS-1 (199 89 (:REWRITE DEFAULT-+-2))
...
(UNTRANS-UPDATE-MEM-1 (199 89 (:REWRITE DEFAULT-+-2))
                      (123 89 (:REWRITE DEFAULT-+-1))
                      (64 16 (:DEFINITION INTEGER-ABS))
                      (64 8 (:DEFINITION LENGTH))
                      (42 42 (:REWRITE DEFAULT-CDR))
