(MEMBERP)
(|(memberp e (list x))| (1 1 (:REWRITE DEFAULT-CAR)))
(ARG1)
(ARG2)
(NON-QUOTEP-ADDENDS (226 107 (:REWRITE DEFAULT-+-2))
...
(DISJOINTP-1)
(DISJOINTP)
(DISJOINTP-THM-1 (583 583 (:REWRITE DEFAULT-CAR))
                 (526 526 (:REWRITE DEFAULT-CDR)))
(CROCK-1 (29 29 (:REWRITE DEFAULT-CAR))
         (13 13 (:REWRITE DEFAULT-CDR))
         (10 10 (:REWRITE ZP-OPEN))
         (4 4 (:REWRITE DEFAULT-+-2))
         (4 4 (:REWRITE DEFAULT-+-1)))
(CROCK-2 (111 111 (:REWRITE DEFAULT-CAR))
         (94 94 (:REWRITE DEFAULT-CDR))
         (9 9 (:REWRITE ZP-OPEN))
         (2 2 (:REWRITE DEFAULT-+-2))
         (2 2 (:REWRITE DEFAULT-+-1)))
(DISJOINT-THM-2 (176 16 (:DEFINITION DISJOINTP-1))
...
(|(memberp e (range base offset length))|
     (54 1 (:DEFINITION RANGE-1))
     (39 6 (:REWRITE COMMUTATIVITY-2-OF-+))
...
(SUBRANGEP)
(|(disjointp subrange1 subrange2)| (304 304 (:REWRITE DEFAULT-CAR))
...
(RANGE-1-V2 (52 52
            ...
            (2 2
               (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(RANGE-V2)
(CROCK-1-1-1 (80 73 (:REWRITE DEFAULT-+-1))
             ...
             (14 14
                 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(CROCK-1-1 (23 22 (:REWRITE DEFAULT-+-2))
           ...
           (2 2
              (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
           (2 2 (:REWRITE FOLD-CONSTS-IN-+)))
(CROCK-1 (122 2 (:DEFINITION RANGE-1-V2))
         (90 12 (:REWRITE COMMUTATIVITY-2-OF-+))
         ...
         (2 2 (:REWRITE DEFAULT-<-2))
         (2 2 (:REWRITE DEFAULT-<-1)))
(CROCK-2-2 (19 18 (:REWRITE DEFAULT-<-1))
           (18 18 (:REWRITE DEFAULT-<-2))
           (16 16
               (:TYPE-PRESCRIPTION |x < y  =>  0 < y-x|))
           ...
           (4 1
              (:REWRITE DISTRIBUTIVITY-OF-MINUS-OVER-+))
           (4 1 (:REWRITE <-+-NEGATIVE-0-1)))
(CROCK-2 (34 30 (:REWRITE DEFAULT-<-2))
...
(|(subrangep (range base1 offset1 length1) (range base2 offset2 length2))|
     (212 4 (:DEFINITION RANGE-1-V2))
     (156 24 (:REWRITE COMMUTATIVITY-2-OF-+))
...
(|(subrangep (range base offset length) (list x)|
     ...
     (1 1 (:REWRITE DEFAULT-CDR))
     (1 1 (:REWRITE DEFAULT-CAR)))
(|(subrangep (list x) (list y)| (1 1 (:REWRITE DEFAULT-CDR))
                                (1 1 (:REWRITE DEFAULT-CAR)))
(CROCK-1 (50 50 (:REWRITE DEFAULT-CAR))
         (2 2 (:REWRITE CDR-CONS))
         (2 2 (:REWRITE CAR-CONS)))
(|(subrangep x x)| (17 17 (:REWRITE DEFAULT-CAR)))
(DISJOINT-THMS-BIND-FREE-FN-4)
(DISJOINT-THMS-BIND-FREE-FN-3 (308 146 (:REWRITE DEFAULT-+-2))
...
(CROCK-1-1 (38 38 (:REWRITE DEFAULT-CAR))
           (30 30 (:REWRITE DEFAULT-CDR))
           (5 5 (:REWRITE ZP-OPEN))
           (2 2 (:REWRITE DEFAULT-+-2))
           (2 2 (:REWRITE DEFAULT-+-1)))
(CROCK-1-2 (5 5 (:REWRITE DEFAULT-CAR))
           (2 2 (:REWRITE DEFAULT-CDR)))
(CROCK-1-3 (437 437 (:REWRITE DEFAULT-CAR))
           (255 255 (:REWRITE DEFAULT-CDR)))
(CROCK-1 (108 108 (:REWRITE DEFAULT-CDR))
...
(|(disjointp (list x y)) --- disjoint super-ranges|
     ...
     (3 3
        (:REWRITE |(disjointp subrange1 subrange2)|))
     (2 2 (:REWRITE NATP-RW))
...
(CROCK-1-1 (437 437 (:REWRITE DEFAULT-CAR))
           (255 255 (:REWRITE DEFAULT-CDR)))
(CROCK-1-2 (20 14 (:REWRITE DEFAULT-<-1))
           ...
           (6 6
              (:TYPE-PRESCRIPTION |x < y  =>  0 < y-x|))
           (5 5 (:REWRITE DEFAULT-UNARY-MINUS)))
(CROCK-1-3-1 (515 515 (:REWRITE DEFAULT-CAR))
             (273 273 (:REWRITE DEFAULT-CDR)))
(CROCK-1-3 (49 11 (:DEFINITION MEMBERP))
           ...
           (8 8 (:REWRITE DEFAULT-+-1))
           (5 5 (:REWRITE DEFAULT-UNARY-MINUS)))
(CROCK-1 (101 70 (:REWRITE DEFAULT-<-1))
...
(ANCESTORS-CHECK-DISJOINTP-HACK-CONSTRAINT
     ...
     (24 6
         (:DEFINITION STRIP-ANCESTOR-LITERALS)))
