...
(POL::+-MONOMIAL-+-MONOMIAL
 (40492 20276 (:TYPE-PRESCRIPTION TER::TERMP-NULLP))
 (23108 1580 (:REWRITE TER::<-HAS-FIRST))
 (20311 20311 (:TYPE-PRESCRIPTION TER::NULLP))
...
(POL::NF
 ...
 (676 652 (:REWRITE DEFAULT-CAR))
 (674 337 (:TYPE-PRESCRIPTION TER::TERMP-NULLP))
 (425 377 (:REWRITE DEFAULT-CDR))
