(POL::MONOMIAL-LISTP (16 8 (:TYPE-PRESCRIPTION TER::TERMP-NULLP))
                     (8 8 (:TYPE-PRESCRIPTION TER::NULLP)))
(POL::POLYNOMIAL (58 29
                     (:TYPE-PRESCRIPTION TER::TERMP-NULLP))
                 (29 29 (:TYPE-PRESCRIPTION TER::NULLP)))
(POL::POLYNOMIALP-POLYNOMIAL (76 38
                                 (:TYPE-PRESCRIPTION TER::TERMP-NULLP))
...
(POL::POLYNOMIALP-REST (6 6 (:REWRITE DEFAULT-CAR))
...
(POL::COMPLETEP (2 2 (:REWRITE DEFAULT-<-2))
                (2 2 (:REWRITE DEFAULT-<-1))
                (1 1 (:REWRITE DEFAULT-CAR)))
(POL::COMPLETEP-UNIFORMP (71 71 (:REWRITE DEFAULT-CDR))
                         (48 24 (:REWRITE DEFAULT-+-2))
                         (24 24 (:REWRITE DEFAULT-CAR))
                         (24 24 (:REWRITE DEFAULT-+-1)))
(POL::UNIFORMP-COMPLETEP (66 33 (:REWRITE DEFAULT-+-2))
                         (33 33 (:REWRITE DEFAULT-+-1))
                         (14 14 (:REWRITE POL::COMPLETEP-UNIFORMP)))
(POL::UNIFORMP-IFF-COMPLETEP (25 5 (:DEFINITION LEN))
