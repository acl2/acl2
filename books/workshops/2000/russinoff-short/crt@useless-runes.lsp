(G-C-D (9 9 (:REWRITE DEFAULT-<-2))
       ...
       (1 1 (:REWRITE A4)))
(REL-PRIME (6 6 (:TYPE-PRESCRIPTION G-C-D)))
(REL-PRIME-ALL)
(REL-PRIME-MODULI)
...
(CRT)
(G-C-D-TYPE)
(R-S-LEMMA (293 242 (:REWRITE DEFAULT-*-2))
           (292 46 (:REWRITE A3))
...
(PROD-TYPE (14 14 (:REWRITE DEFAULT-CAR))
           ...
           (2 2
              (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(C-D-LEMMA (745 344 (:REWRITE DEFAULT-*-2))
...
(MEMBER-SUBLISTP (17 17 (:REWRITE DEFAULT-CAR))
                 (11 11 (:REWRITE DEFAULT-CDR)))
(G-C-D-COMMUTATIVE (76 18 (:REWRITE ZP-OPEN))
                   (76 8 (:REWRITE A9))
                   (72 12 (:REWRITE A3))
...
(REL-PRIME-ALL-REL-PRIME (10 10 (:REWRITE DEFAULT-CAR))
                         ...
                         (4 4 (:REWRITE DEFAULT-CDR)))
(REL-PRIME-ALL-MODULI-REMOVE (100 99 (:REWRITE DEFAULT-CAR))
...
(REL-PRIME-NOT-EQL (4 4 (:REWRITE DEFAULT-<-2))
                   (4 4 (:REWRITE DEFAULT-<-1))
                   (2 2 (:REWRITE DEFAULT-*-2))
                   (2 2 (:REWRITE DEFAULT-*-1)))
...
(CONG0-1 (121 121 (:REWRITE DEFAULT-CAR))
         ...
         (2 2 (:REWRITE DEFAULT-+-2))
         (2 2 (:REWRITE DEFAULT-+-1)))
(SUBLISTP-INDUCT (50 10 (:DEFINITION LEN))
...
(SUBLISTP-LAST (56 7 (:REWRITE NOT-MEMBER-REL-PRIME-ALL))
