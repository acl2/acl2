...
(TJVM::COMMUTATIVITY2-OF-* (6 4 (:REWRITE DEFAULT-*-2))
                           (6 4 (:REWRITE DEFAULT-*-1))
                           (4 4
                              (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(TJVM::PLUS-RIGHT-ID (4 4
                        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(TJVM::STATES)
(TJVM::FRAMES)
(TJVM::STEP-OPENER (401 401 (:REWRITE DEFAULT-CAR))
                   ...
                   (18 6
                       (:DEFINITION TJVM::BUILD-CLASS-FIELD-BINDINGS))
                   (10 2 (:DEFINITION LEN))
...
(TJVM::C+)
(TJVM::C*)
(TJVM::C+-REVEALED (12 10 (:REWRITE DEFAULT-+-2))
                   (10 10 (:REWRITE DEFAULT-<-2))
                   (10 10 (:REWRITE DEFAULT-<-1))
                   (10 10 (:REWRITE DEFAULT-+-1))
                   (3 3 (:REWRITE ZP-OPEN))
                   (2 2 (:REWRITE FOLD-CONSTS-IN-+)))
(TJVM::C*-REVEALED (10 7 (:REWRITE DEFAULT-+-2))
                   ...
                   (7 7 (:REWRITE DEFAULT-+-1))
                   (3 3 (:REWRITE ZP-OPEN)))
(TJVM::TJVM-C+ (195 15 (:REWRITE TJVM::STEP-OPENER))
...
(TJVM::TJVM-+ (56 3 (:DEFINITION TJVM::TJVM))
...
(TJVM::TJVM-OPENER (65 5 (:REWRITE TJVM::STEP-OPENER))
...
(TJVM::ASSOC-EQUAL-BIND (229 165 (:REWRITE DEFAULT-CAR))
                        (81 67 (:REWRITE DEFAULT-CDR)))
(TJVM::BIND-FORMALS-CONS (3 3 (:REWRITE DEFAULT-CDR))
                         (3 3 (:REWRITE DEFAULT-CAR)))
(TJVM::POPN-OPENER (5 5 (:REWRITE DEFAULT-+-2))
...
(TJVM::FACT-CLOCK)
(TJVM::EXAMPLE1)
(TJVM::FACT-CLOCK-REVEALED (29 20 (:REWRITE DEFAULT-+-2))
...
(TJVM::EXAMPLE2-HINT)
(TJVM::EXAMPLE2 (84 8 (:DEFINITION TJVM::C+))
                ...
                (5 5 (:REWRITE DEFAULT-*-1))
                (3 3
                   (:TYPE-PRESCRIPTION TJVM::EXAMPLE2-HINT)))
(TJVM::|bF_XINCREMENT|)
...
(TJVM::EXAMPLE4 (9032 8700 (:REWRITE DEFAULT-CAR))
...
(TJVM::HACKISH-LEMMA1 (180 36 (:DEFINITION ASSOC-EQUAL))
                      ...
                      (1 1 (:REWRITE DEFAULT-+-1)))
(TJVM::HACKISH-LEMMA2 (240 48 (:DEFINITION ASSOC-EQUAL))
                      ...
                      (2 1 (:REWRITE DEFAULT-+-2))
                      (1 1 (:REWRITE DEFAULT-+-1)))
(TJVM::EXAMPLE5 (1339 1339 (:REWRITE DEFAULT-CAR))
                ...
                (20 20
                    (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(TJVM::SETCOLORBOX-HEAP-PROPERTY (296 296 (:REWRITE DEFAULT-CAR))
