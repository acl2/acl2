...
(R-INT-TAKE-STEP (12 6 (:REWRITE ENCAP-CON-NOT-ABS))
                 (6 6 (:REWRITE TYPE-FC)))
(R-TAKE-STEP (6 3 (:REWRITE ENCAP-CON-NOT-ABS))
             (3 3 (:REWRITE TYPE-FC)))
(B-IS-A-WF-BISIM-SK (42 3 (:DEFINITION E0-ORD-<))
                    ...
                    (1 1
                       (:REWRITE ENCAP-EXISTS-W-SUCC-FOR-U-SUFF))
                    (1 1
                       (:REWRITE ENCAP-EXISTS-W-SUCC-FOR-S-SUFF)))
