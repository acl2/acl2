...
(FLUSHED-MA (1 1 (:TYPE-PRESCRIPTION FLUSHED-MA)))
(GOOD-MA)
(MA-TO-ISA)
(MA-RANK)
(WF-REL)
...
(RANK-FC)
(R-FC)
(B-IS-A-WF-BISIM-CORE (89118 89118 (:REWRITE NTH-CONS-OPEN))
...
(CON-TO-ABS-TYPE (3089 3089 (:REWRITE NTH-CONS-OPEN))
...
(ABS-STEP-TYPE (15 15 (:REWRITE NTH-CONS-OPEN))
...
(CON-STEP-TYPE (63 63 (:REWRITE NTH-CONS-OPEN))
...
(ABS-NOT-CON)
(B-IS-AN-EQUIVALENCE)
(RANK-WELL-FOUNDED (12 12 (:REWRITE NTH-CONS-OPEN))
