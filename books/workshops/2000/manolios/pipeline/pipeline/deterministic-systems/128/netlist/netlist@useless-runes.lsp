...
(INPUT-VALS-NOT-CHANGED (41 41 (:REWRITE DEFAULT-CAR))
                        (21 21 (:REWRITE DEFAULT-CDR)))
(EQUAL-LEN-0 (9 5 (:REWRITE DEFAULT-+-2))
             (5 5 (:REWRITE DEFAULT-+-1))
             (4 4 (:REWRITE DEFAULT-CDR)))
(ADDER-NET-IS-SERIAL-ADDER (4854 4144 (:REWRITE DEFAULT-CAR))
                           (3529 2849 (:REWRITE DEFAULT-CDR))
                           (1848 616 (:REWRITE FOLD-CONSTS-IN-+))
                           (1832 1805 (:REWRITE DEFAULT-+-2))
...
(BIND)
(MEMBER-BIND (1270 1134 (:REWRITE DEFAULT-CAR))
             (872 802 (:REWRITE DEFAULT-CDR))
             (74 74 (:REWRITE INPUT-VALS-NOT-CHANGED)))
(VALS-BIND-THM (82 82 (:REWRITE DEFAULT-CDR))
...
(SUBSET)
(MEM-BIND (213 147 (:REWRITE DEFAULT-CAR))
          (84 68 (:REWRITE DEFAULT-CDR))
          (32 32 (:TYPE-PRESCRIPTION BINARY-APPEND)))
(SUBSET-BIND (81 9 (:DEFINITION BIND))
...
(DISJOINT)
(NOT-MEM-BIND (84 74 (:REWRITE DEFAULT-CAR))
              (58 48 (:REWRITE DEFAULT-CDR))
              (18 18 (:TYPE-PRESCRIPTION BINARY-APPEND)))
(DISJOINT-BIND (61 61 (:REWRITE DEFAULT-CAR))
               ...
               (4 4 (:TYPE-PRESCRIPTION TRUE-LISTP))
               (4 4 (:TYPE-PRESCRIPTION BINARY-APPEND)))
(DISJOINT-COMM (430 430 (:REWRITE DEFAULT-CAR))
               (257 257 (:REWRITE DEFAULT-CDR)))
(MEM-VAL-BIND (46 44 (:REWRITE DEFAULT-CAR))
              (30 28 (:REWRITE DEFAULT-CDR)))
(ADD)
(ADDER-NET-IS-SERIAL-ADDER-2 (167 1 (:DEFINITION NET-VAL))
...
(ADD-IS-SERIAL-ADDER)
(NET-ALU)
(LEN-ADD-FIX (33 27 (:REWRITE DEFAULT-+-2))
...
(NET-ALU-ALU-OUTPUT (156 6 (:DEFINITION SERIAL-ADDER))
...
(NET-EXCP)
(NET-EXCP-SERIAL-EXCP (214 10 (:DEFINITION SERIAL-ADDER))
                      (186 14 (:DEFINITION N))
