...
(RANK-FC)
(R-FC)
(B-IS-A-WF-BISIM-CORE (4151 3853 (:REWRITE DEFAULT-+-1))
...
(CON-TO-ABS-TYPE (69 69 (:REWRITE NTH-CONS-OPEN))
...
(ABS-STEP-TYPE (13 13 (:REWRITE NTH-CONS-OPEN))
...
(CON-STEP-TYPE (523 523 (:REWRITE NTH-CONS-OPEN))
