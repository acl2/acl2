...
(COMMUTATIVE-DIAGRAM (349 181 (:REWRITE DEFAULT-CDR))
                     ...
                     (88 88
                         (:REWRITE MA-SIG-LISTP-INITIAL-SUBLISTP-EQUAL))
                     (63 63 (:REWRITE SIMPLIFY-BIT-FUNCTIONS))
                     (40 40
                         (:REWRITE MA-SIG-LISTP-MEMBERP-EQUAL))
...
(ZEROS)
(LIVENESS)
(MA-IS-BAD (28 10 (:REWRITE DEFAULT-CAR))
