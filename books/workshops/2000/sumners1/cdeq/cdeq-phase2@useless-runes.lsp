...
(PICK)
(RANK-THF)
(RANK-THF-TYPE-PRESCRIPTION (3 3 (:REWRITE DEFAULT-<-2))
...
(RANK-TVS-UNAFFECTED-ADDRESSES
     ...
     (6 6
        (:TYPE-PRESCRIPTION RANK-THF-TYPE-PRESCRIPTION))
     (6 6 (:REWRITE ZP-OPEN))
     (4 4 (:REWRITE DEFAULT-<-2))
     (4 4 (:REWRITE DEFAULT-<-1)))
...
(RANK-ONR)
(RANK-ONR-TYPE-PRESCRIPTION (3 3 (:REWRITE DEFAULT-<-2))
                            (3 3 (:REWRITE DEFAULT-<-1))
                            (1 1 (:REWRITE DEFAULT-UNARY-MINUS))
                            (1 1 (:REWRITE DEFAULT-+-2))
                            (1 1 (:REWRITE DEFAULT-+-1)))
...
(SUFF-ONR)
(SUFF)
(>>-WELL-FOUNDED (20 1 (:DEFINITION RANK-TVS))
...
(>>-LABEL (160 16 (:DEFINITION MEND))
          (144 16 (:DEFINITION REP-TVS))
          (128 32
               (:REWRITE MEND-<=-BOT-TOP-EQUALS-NIL))
...
(>>-STUTTER1 (4113 457 (:DEFINITION REP-TVS))
...
(LINEAR-FACTOID2 (12 12
                     (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                 (7 4 (:REWRITE DEFAULT-+-2))
                 (7 4 (:REWRITE DEFAULT-+-1))
                 (6 3 (:REWRITE DEFAULT-<-2))
                 (6 3 (:REWRITE DEFAULT-<-1)))
(>>-STUTTER2 (2757 140 (:DEFINITION RANK-TVS))
...
(>>-MATCH (5553 617 (:DEFINITION REP-TVS))
...
(ASSUME-THF)
(INV)
(THF-INV-SHR-THM (224 21 (:REWRITE AGE<<-IS-ASYMMETRIC))
                 ...
                 (2 2
                    (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(THF-INV-THF-THM (252 86 (:REWRITE AGE<<-TOP+1-HACK1))
...
(THF-INV-OTHER-THF-THM (5294 1732 (:REWRITE TAG<-IMPLIES-AGE<<))
                       ...
                       (138 138
                            (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(ONR-INV-THF-THM (3492 3492 (:REWRITE DEFAULT-CDR))
                 ...
                 (372 372
                      (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(ONR-INV-SHR-THM (391 391 (:REWRITE DEFAULT-CDR))
...
(ONR-INV-ONR-THM (904 904 (:REWRITE DEFAULT-CDR))
                 ...
                 (74 74
                     (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(THF-INV-ONR-THM (7565 7565 (:REWRITE DEFAULT-CDR))
                 ...
                 (805 805
                      (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(ONR-INV-IMPLIES-ASSUME-ONR (348 348 (:REWRITE DEFAULT-CDR))
                            ...
                            (31 31
                                (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(THF-INV-IMPLIES-ASSUME-THF (224 21 (:REWRITE AGE<<-IS-ASYMMETRIC))
                            (175 35 (:REWRITE AGE<<-TRICHOTOMY))
                            (91 35 (:REWRITE TAG<-IMPLIES-AGE<<))
                            (91 35 (:REWRITE AGE<<-TOP+1-HACK1))
...
(>>-INVARIANT-PERSISTENT (27 3 (:DEFINITION INV-TVS))
                         ...
                         (6 3 (:REWRITE DEFAULT-+-2))
                         (3 3 (:REWRITE DEFAULT-+-1)))
(INV-SHR-IMPLIES-SUFF-SHR (2 2 (:REWRITE DEFAULT-CDR))
                          (2 2 (:REWRITE DEFAULT-CAR)))
(INV-THF-IMPLIES-SUFF-THF (224 21 (:REWRITE AGE<<-IS-ASYMMETRIC))
                          (175 35 (:REWRITE AGE<<-TRICHOTOMY))
                          (91 35 (:REWRITE TAG<-IMPLIES-AGE<<))
                          (91 35 (:REWRITE AGE<<-TOP+1-HACK1))
                          (59 59 (:REWRITE DEFAULT-CDR))
                          ...
                          (2 2
                             (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(INV-ONR-IMPLIES-SUFF-ONR (290 290 (:REWRITE DEFAULT-CDR))
