...
(FIRST-REQUEST-GETS-HPID-FD (604 604 (:REWRITE DEFAULT-CDR))
                            (246 123 (:REWRITE DEFAULT-+-2))
                            (123 123 (:REWRITE DEFAULT-+-1)))
(POP-REQUEST (511 511 (:REWRITE DEFAULT-CAR))
             (88 44 (:REWRITE DEFAULT-+-2))
             (44 44 (:REWRITE DEFAULT-+-1)))
(POP-REQUEST-PRESERVES-LSTATE-LISTP (836 836 (:REWRITE DEFAULT-CDR))
...
(LISTENING-PAIRS (7 7 (:REWRITE DEFAULT-CDR))
...
(CONNECTION-PAIRS (478 2
                  ...
                  (2 2
                     (:REWRITE INTEGER-OR-CONSTP-NOT-VARP)))
(FDS-IN-USE (5 5 (:REWRITE DEFAULT-CDR))
