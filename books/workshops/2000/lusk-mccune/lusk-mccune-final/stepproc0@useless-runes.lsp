...
(FORK-CONNECTIONS-PRESERVES-CSTATE-LISTP
     (87426 138 (:DEFINITION EVALUATED-EXPRESSIONP))
     (82794 2622 (:DEFINITION MEMBER-EQUAL))
     (53946 53932 (:REWRITE DEFAULT-CAR))
     (30897 30883 (:REWRITE DEFAULT-CDR))
     (15348 264 (:REWRITE CSTATE-PROPERTIES))
     (1428 1428 (:TYPE-PRESCRIPTION MEMBER-EQUAL))
     (1424 712 (:REWRITE DEFAULT-+-2))
     (712 712 (:REWRITE DEFAULT-+-1))
     (558 558 (:TYPE-PRESCRIPTION CSTATEP))
     (180 180 (:TYPE-PRESCRIPTION VARP))
     (180 180 (:TYPE-PRESCRIPTION CONSTP))
     (138 138
          (:REWRITE INTEGER-OR-CONSTP-NOT-VARP)))
(EXEC-FORK)
