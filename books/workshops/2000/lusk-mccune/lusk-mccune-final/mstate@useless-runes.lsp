...
(MESSAGE-TO-SELECT (922 4
                   ...
                   (4 4
                      (:REWRITE INTEGER-OR-CONSTP-NOT-VARP)))
(REQUEST-TO-SELECT (52 52 (:REWRITE DEFAULT-CDR))
                   (44 44 (:REWRITE DEFAULT-CAR))
                   (23 12 (:REWRITE DEFAULT-+-2))
                   (20 1 (:DEFINITION REQUEST-LISTP))
                   (12 12 (:REWRITE DEFAULT-+-1)))
(PSTATE-STATUS (56204 277 (:DEFINITION EVALUATED-EXPRESSIONP))
               (48181 5265 (:DEFINITION MEMBER-EQUAL))
               (31650 31640 (:REWRITE DEFAULT-CAR))
               (21082 21072 (:REWRITE DEFAULT-CDR))
               (15296 64
                      (:DEFINITION EVALUATED-EXPRESSION-LISTP))
               (2246 1141 (:REWRITE DEFAULT-+-2))
               (2235 931
                     (:REWRITE INTEGER-OR-CONSTP-NOT-VARP))
               ...
               (512 128 (:REWRITE CSTATE-PROPERTIES))
               (433 433 (:REWRITE DEFAULT-<-2))
               (433 433 (:REWRITE DEFAULT-<-1))
               (384 384 (:TYPE-PRESCRIPTION CSTATEP))
...
(WAITING-PSTATES (6116 24 (:DEFINITION EVALUATED-EXPRESSIONP))
...
(ACTIVE-PSTATES (6116 24 (:DEFINITION EVALUATED-EXPRESSIONP))
                (5640 10 (:DEFINITION CSTATE-LISTP))
                (5510 10 (:DEFINITION CSTATEP))
                (5420 456 (:DEFINITION MEMBER-EQUAL))
                (4780 20
                ...
                (11 11 (:REWRITE DEFAULT-<-1))
                (10 10 (:TYPE-PRESCRIPTION REQUEST-LISTP)))
(ITH-ACTIVE-PSTATE (6940 27 (:DEFINITION EVALUATED-EXPRESSIONP))
...
(ITH-ACTIVE-PSTATE-PROPERTIES
     ...
     (18262 17822 (:REWRITE DEFAULT-CAR))
     (15296 64
            (:DEFINITION EVALUATED-EXPRESSION-LISTP))
     (15040 64 (:DEFINITION EVALUATED-EXPRESSIONP))
     (14247 13807 (:REWRITE DEFAULT-CDR))
     (3520 880 (:DEFINITION RFIX))
     (2816 704 (:DEFINITION LFIX))
     (2640 2640 (:TYPE-PRESCRIPTION BFIX))
     (2640 880 (:REWRITE CONSTP-NOT-RATIONALP))
     (2616 2616 (:TYPE-PRESCRIPTION CONSTP))
     (2616 488 (:DEFINITION LEN))
     (1510 980 (:REWRITE DEFAULT-+-2))
     ...
     (152 152 (:TYPE-PRESCRIPTION VARP))
     (152 152
          (:REWRITE INTEGER-OR-CONSTP-NOT-VARP))
...
(PROGP)
(PROGRAM-LISTP)
(PROGRAM-LISTP-IS-ALISTP (23 23 (:REWRITE DEFAULT-CAR))
...
(MSTATEP (20 20 (:REWRITE DEFAULT-CDR))
         (15 9 (:REWRITE DEFAULT-+-2))
         (9 9 (:REWRITE DEFAULT-+-1)))
(PSTATES)
(CSTATES (2 2 (:REWRITE DEFAULT-CDR))
         (2 1 (:REWRITE DEFAULT-+-2))
         (1 1 (:REWRITE DEFAULT-+-1)))
(LSTATES (8 8 (:REWRITE DEFAULT-CDR))
         (7 4 (:REWRITE DEFAULT-+-2))
         (4 4 (:REWRITE DEFAULT-+-1)))
(PROGRAMS (20 20 (:REWRITE DEFAULT-CDR))
          (15 9 (:REWRITE DEFAULT-+-2))
          (9 9 (:REWRITE DEFAULT-+-1)))
(UPDATE-PSTATES (416 1 (:DEFINITION PSTATE-LISTP))
...
(UPDATE-CSTATES (1128 2 (:DEFINITION CSTATE-LISTP))
                ...
                (4 4
                   (:REWRITE INTEGER-OR-CONSTP-NOT-VARP)))
(UPDATE-LSTATES (87 3 (:DEFINITION LSTATE-LISTP))
...
(EVALUATED-EXPRESSION-APPEND (1071 859 (:REWRITE DEFAULT-CAR))
                             ...
                             (13 13
                                 (:REWRITE INTEGER-OR-CONSTP-NOT-VARP)))
(DELIVER-MESSAGE (48706 146 (:DEFINITION EVALUATED-EXPRESSIONP))
...
(MSTATEP-DELIVER-MESSAGE (51820 127 (:DEFINITION EVALUATED-EXPRESSIONP))
