...
(VARP-NOT-CONS)
(MEMORYP)
(MEMORY-IS-ALIST (627 627 (:REWRITE DEFAULT-CAR))
                 (324 324 (:REWRITE DEFAULT-CDR))
                 (80 16 (:DEFINITION LEN))
                 (32 16 (:REWRITE DEFAULT-+-2))
                 (16 16 (:REWRITE DEFAULT-+-1)))
(MEMORY-ACCESS-GIVES-EVALUATED-EXPRESSIONP (1006 1006 (:REWRITE DEFAULT-CAR))
                                           (554 554 (:REWRITE DEFAULT-CDR))
                                           (120 24 (:DEFINITION LEN))
                                           (48 24 (:REWRITE DEFAULT-+-2))
                                           (24 24 (:REWRITE DEFAULT-+-1)))
(VAL)
(ASGN (149 1 (:DEFINITION EVALUATED-EXPRESSIONP))
...
(ASGN-GIVES-MEMORYP (1424 1313 (:REWRITE DEFAULT-CAR))
...
(EVL2 (38442 258 (:DEFINITION EVALUATED-EXPRESSIONP))
      (31563 4971 (:DEFINITION MEMBER-EQUAL))
      (25793 25410 (:REWRITE DEFAULT-CAR))
      (19088 18705 (:REWRITE DEFAULT-CDR))
      (16422 69 (:DEFINITION EVL2))
      (8843 4416 (:REWRITE DEFAULT-+-2))
      (5325 4416 (:REWRITE DEFAULT-+-1))
      (2677 326 (:DEFINITION LENGTH))
      (2056 514 (:REWRITE COMMUTATIVITY-OF-+))
      (2056 514 (:DEFINITION INTEGER-ABS))
      (1033 857 (:REWRITE DEFAULT-<-2))
      (990 857 (:REWRITE DEFAULT-<-1))
      (621 69 (:DEFINITION MYASSOC))
      (584 584 (:REWRITE DEFAULT-UNARY-MINUS))
      (483 69 (:DEFINITION ITH))
      (345 69 (:DEFINITION BINARY-APPEND))
      (257 257 (:REWRITE DEFAULT-REALPART))
      (257 257 (:REWRITE DEFAULT-NUMERATOR))
      (257 257 (:REWRITE DEFAULT-IMAGPART))
      (257 257 (:REWRITE DEFAULT-DENOMINATOR))
      (257 257 (:REWRITE DEFAULT-COERCE-2))
      (257 257 (:REWRITE DEFAULT-COERCE-1)))
(NOT-CONSTP-CONS-CONS)
(CONST-EVALUATED-MYASSOC (4 4 (:REWRITE DEFAULT-CDR))
                         (3 3 (:REWRITE DEFAULT-CAR))
                         (3 2 (:REWRITE DEFAULT-+-2))
                         (2 2 (:REWRITE DEFAULT-+-1)))
(MYASSOC-EVALUATED (4054 3274 (:REWRITE DEFAULT-CAR))
...
(EVALUATED-EXPRESSIONP-LFIX (916 901 (:REWRITE DEFAULT-CAR))
...
(EVALUATED-APPEND (1793 1730 (:REWRITE DEFAULT-CAR))
                  ...
                  (39 3 (:DEFINITION EXPRESSIONP))
                  (24 24 (:TYPE-PRESCRIPTION EXPRESSIONP)))
(EVALUATED-MEMBER (2974 2956 (:REWRITE DEFAULT-CAR))
                  ...
                  (39 3 (:DEFINITION EXPRESSIONP))
                  (24 24 (:TYPE-PRESCRIPTION EXPRESSIONP)))
(EVALUATED-ITH (4986 4917 (:REWRITE DEFAULT-CAR))
...
(CAR-CONST-EXPR)
(CDR-CONST-EXPR (9 9 (:REWRITE DEFAULT-CDR))
...
(EVALUATED-VAL (606 3 (:DEFINITION EVALUATED-EXPRESSIONP))
...
(EVL2-EXPRESSIONP (132357 125509 (:REWRITE DEFAULT-CDR))
                  (43758 23895 (:REWRITE DEFAULT-+-2))
                  (23895 23895 (:REWRITE DEFAULT-+-1))
                  (12033 1337 (:DEFINITION MYASSOC))
                  (6700 1340 (:DEFINITION BINARY-APPEND))
                  (3823 3820 (:REWRITE DEFAULT-<-1))
                  (3820 3820 (:REWRITE DEFAULT-<-2))
