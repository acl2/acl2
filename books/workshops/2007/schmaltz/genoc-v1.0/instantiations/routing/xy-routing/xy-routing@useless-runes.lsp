(DIST)
(O-P-DIST (170 23 (:REWRITE LESSP-IMPLIES-<-CAR))
          (150 13
...
(XY-ROUTING (1246 153 (:REWRITE LESSP-IMPLIES-<-CAR))
...
(FIRST-XY-ROUTING (547 513 (:REWRITE DEFAULT-CAR))
...
(LAST-XY-ROUTING (993 833 (:REWRITE DEFAULT-CAR))
...
(XY-ROUTING-LEN->=-2 (750 742 (:REWRITE DEFAULT-CDR))
...
(MEMBER-COORD-GENERATOR-1
     ...
     (1 1 (:REWRITE |(< 0 (- x))|))
     (1 1 (:REWRITE |(< (+ c x) d)|)))
(TACTIC1 (716 91 (:REWRITE LESSP-IMPLIES-<-CAR))
         (664 50
              (:REWRITE NOTLESSP-IMPLIES-NOT-<-CAR))
...
(ROUTING-ALL-X-LESS (5195 623 (:REWRITE LESSP-IMPLIES-<-CAR))
...
(ROUTING-ALL-Y-LESS (1182 30 (:REWRITE FIRST-XY-ROUTING))
                    (825 825 (:REWRITE |(< (- x) (- y))|))
...
(ALL-X-<-MAX-MINUS-1 (386 20
                     ...
                     (6 6 (:REWRITE DEFAULT-+-1)))
(ALL-X-<-MAX-X-DIM-GEN (185 18 (:REWRITE LESSP-IMPLIES-<-CAR))
                       ...
                       (1 1 (:REWRITE |(< (+ d x) (+ c y))|))
                       (1 1 (:REWRITE |(< (+ c x) (+ d y))|)))
(ALL-X-<-MAX-COORD-GEN (5952 462 (:REWRITE LESSP-IMPLIES-<-CAR))
...
(ALL-X-<-MAX-MEMBER-EQUAL
     ...
     (2 2
        (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-A+AB))
     (2 2 (:REWRITE |(< 0 (- x))|)))
(ALL-X-<-MAX-REV (4398 260 (:REWRITE LESSP-IMPLIES-<-CAR))
                 ...
                 (5 5
                    (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-A+AB))
                 (5 5 (:REWRITE |(< 0 (- x))|)))
(ALL-Y-<-MAX-X-DIM-GEN (138 6 (:REWRITE NOTLESSP-IMPLIES-NOT-<-CAR))
...
(ALL-Y-<-MAX-MINUS-1 (404 20
                     ...
                     (6 6 (:REWRITE DEFAULT-+-2))
                     (6 6 (:REWRITE DEFAULT-+-1)))
(ALL-Y-<-MAX-APPEND (1031 84 (:REWRITE LESSP-IMPLIES-<-CAR))
...
(ALL-Y-<-MAX-REV (492 48 (:REWRITE LESSP-IMPLIES-<-CAR))
...
(SUBSETP-APPEND-2 (26 2 (:DEFINITION SUBSETP-EQUAL))
...
(ALL-Y-<-MAX-MEMBER-EQUAL
     ...
     (2 2
        (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-A+AB))
     (2 2 (:REWRITE |(< 0 (- x))|)))
(ALL-MAX-MEMBER-EQUAL (344 30 (:REWRITE LESSP-IMPLIES-<-CAR))
                      (313 10
                           (:REWRITE NOTLESSP-IMPLIES-NOT-<-CAR))
...
(SUBSETP-X-DIM-GEN-COORD-GEN-1
     ...
     (3 3 (:REWRITE |(equal (- x) (- y))|)))
(SUBSETP-COORD-GEN-1 (459 3 (:REWRITE MEMBER-COORD-GENERATOR-1))
...
(XYROUTING-MISSIVES (27742 1067 (:REWRITE NTH-WITH-LARGE-INDEX))
...
(CONSP-XY-ROUTING (490 490 (:REWRITE DEFAULT-CAR))
...
(V-IDS-XY-ROUTING-=-M-IDS
     ...
     (14 14
         (:REWRITE 2D-MESH-NODESETP-MEMBER-EQUAL)))
(TRLSTP-XYROUTING (26018 993 (:REWRITE NTH-WITH-LARGE-INDEX))
