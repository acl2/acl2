...
(NO_INTERSECTP_PACKET (16 8
                          (:TYPE-PRESCRIPTION TRUE-LISTP-MEMBER-EQUAL))
                      (8 8 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(TEST_PREV_ROUTES)
(UPDATE-PREV)
(UPDATE_ROUTE)
(PKT-SCHEDULER (3 3 (:TYPE-PRESCRIPTION UPDATE-PREV)))
(PACKET-SCHEDULING (1 1
                      (:TYPE-PRESCRIPTION CONSUME-ATTEMPTS)))
(PKT-SCHED-NT-SCHED (1 1 (:TYPE-PRESCRIPTION UPDATE-PREV)))
...
(PKT-SCHED-NT-DEL (4 4 (:TYPE-PRESCRIPTION UPDATE-PREV)))
...
(CONSUME-AT-LEAST-ONE-ATTEMPT-PACKET-SCHEDULING
     ...
     (6 3 (:DEFINITION IDV))
     (5 5
        (:TYPE-PRESCRIPTION NO_INTERSECTP_PACKET))
     (5 5 (:REWRITE CHECKROUTES-CAAR))
     (5 5 (:DEFINITION MEMBER-EQUAL)))
(SUBSETP-SCHEDULED-PKT (2366 142 (:REWRITE NTH-WITH-LARGE-INDEX))
                       ...
                       (34 34
                           (:TYPE-PRESCRIPTION CONSP-MEMBER-EQUAL)))
(SUBSETP-DELAYED-PKT (1566 94 (:REWRITE NTH-WITH-LARGE-INDEX))
...
(NOT-MEMBER-V-IDS-PKT-SCHED
     ...
     (29 29
         (:TYPE-PRESCRIPTION CONSP-MEMBER-EQUAL)))
(NO-DUPLICATESP-PKT-SCHED (1482 90 (:REWRITE NTH-WITH-LARGE-INDEX))
                          (855 45 (:DEFINITION NTH))
                          (522 522 (:TYPE-PRESCRIPTION LEN))
...
(TRLSTP-SCHEDULED-CT (339 3 (:DEFINITION PKT-SCHED-NT-SCHED))
                     (272 16 (:REWRITE NTH-WITH-LARGE-INDEX))
...
(VALIDFIELDS-TRLST-PKT-DEL (1224 72 (:REWRITE NTH-WITH-LARGE-INDEX))
                           ...
                           (12 12
                               (:TYPE-PRESCRIPTION CONSP-MEMBER-EQUAL)))
(NOT-MEMBER-V-IDS-PKT-DEL (784 48 (:REWRITE NTH-WITH-LARGE-INDEX))
                          ...
                          (24 24
                              (:TYPE-PRESCRIPTION CONSP-MEMBER-EQUAL)))
(NO-DUPLICATESP-PKT-DEL (784 48 (:REWRITE NTH-WITH-LARGE-INDEX))
                        (456 24 (:DEFINITION NTH))
                        ...
                        (24 24
                            (:TYPE-PRESCRIPTION CONSP-MEMBER-EQUAL)))
(TRLSTP-DELAYED-PKT (219 3 (:DEFINITION PKT-SCHED-NT-DEL))
...
(PKT-SCHEDULED-CORRECTNESS
     ...
     (48 48
         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(PKT-DELAYED-CORRECTNESS (11178 690 (:REWRITE NTH-WITH-LARGE-INDEX))
...
(NOT-IN-V-IDS-CT (3100 188 (:REWRITE NTH-WITH-LARGE-INDEX))
...
(CREATE_STEPS (6 6 (:TYPE-PRESCRIPTION UPDATE-PREV)))
