...
(CNV::Q-TRUE-LISTP-MULTISET-DIFF (5 5 (:REWRITE DEFAULT-CDR))
...
(CNV::EXISTS-LOCAL-PEAK (72 32 (:REWRITE DEFAULT-+-2))
...
(CNV::REPLACE-LOCAL-PEAK (72 32 (:REWRITE DEFAULT-+-2))
                         (46 32 (:REWRITE DEFAULT-+-1))
                         (16 16 (:REWRITE DEFAULT-CDR))
                         (16 4 (:REWRITE COMMUTATIVITY-OF-+))
                         (16 4 (:DEFINITION INTEGER-ABS))
...
(CNV::TRANSFORM-TO-VALLEY-ADMISSION
     ...
     (20 4 (:DEFINITION REMOVE-ONE)))
(CNV::MUL-REL-NIL (95 95 (:REWRITE DEFAULT-CDR))
...
(CNV::TRANSFORM-TO-VALLEY (91 91 (:REWRITE DEFAULT-CAR))
...
(CNV::NORMALIZING (43 34 (:REWRITE DEFAULT-CAR))
...
(CNV::NORMALIZING-CONSP-PROOF-IRREDUCIBLE
     ...
     (4 4
        (:REWRITE CNV::NORMALIZING-NOT-CONSP-PROOF-IRREDUCIBLE))
...
(CNV::NORMAL-FORM-AUX-NORMAL-FORM
     ...
     (6 3
        (:REWRITE CNV::LEGAL-REDUCE-ONE-STEP-CLOSURE))
     (5 5 (:TYPE-PRESCRIPTION LAST))
     (3 3 (:REWRITE CNV::LEGAL-REDUCIBLE-1)))
(CNV::R-EQUIV)
(CNV::R-EQUIVALENT-COMPLETE (118 2
                                 (:DEFINITION CNV::TRANSFORM-TO-VALLEY))
                            ...
                            (2 2
                               (:TYPE-PRESCRIPTION CNV::EXISTS-LOCAL-PEAK)))
(CNV::MAKE-PROOF-COMMON-N-F (5 5 (:TYPE-PRESCRIPTION BINARY-APPEND)))
(CNV::R-EQUIVALENT-SOUND (3 3 (:TYPE-PRESCRIPTION BINARY-APPEND)))
