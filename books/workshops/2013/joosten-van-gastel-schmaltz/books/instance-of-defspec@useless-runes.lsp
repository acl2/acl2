(GET-DEFUN-WRLD)
(REPLACE-ARGUMENTS (192 90 (:REWRITE DEFAULT-+-2))
...
(REPLACE-ATOM (58 28 (:REWRITE DEFAULT-+-2))
...
(REPLACEFNS (638 285 (:REWRITE DEFAULT-+-2))
...
(GET-DERIVED-THEOREMS (50 25 (:REWRITE DEFAULT-+-2))
...
(FIND-ENCAPSULATE)
(REMOVE-DUPLICATES-ON-CDR (2 2 (:REWRITE DEFAULT-CAR))
...
(CONSTANT-AS-N-ARY)
(UNARY-FUNCTION (1 1 (:TYPE-PRESCRIPTION UNARY-FUNCTION)))
(UNARY-AS-N-ARY-FUNCTION)
(UNARY-AS-N-ARY (6 6 (:TYPE-PRESCRIPTION XFIRSTN)))
(N-ARY-AS-UNARY-FUNCTION)
(N-ARY-AS-UNARY)
(BINARY-FUNCTION)
(BINARY-AS-N-ARY-FUNCTION)
(BINARY-AS-N-ARY (27 27 (:TYPE-PRESCRIPTION XFIRSTN)))
(TERNARY-FUNCTION)
(TERNARY-AS-N-ARY-FUNCTION)
(TERNARY-AS-N-ARY (45 45 (:TYPE-PRESCRIPTION XFIRSTN)))
