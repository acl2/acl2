...
(PERMP-IMPLIES-EQUAL-NOT-IN-2
     ...
     (590 47
          (:REWRITE UNSUCCESFUL-DEL-PRESERVES-SET))
     (512 239
          (:TYPE-PRESCRIPTION TRUE-LISTP-MEMBER-EQUAL))
     ...
     (127 1
          (:REWRITE SUCCESFUL-DEL-PRESERVES-PERMP))
     ...
     (31 2
         (:REWRITE DEL-SAME-MEMBER-PRESERVES-PERMP))
     (24 4 (:REWRITE NOT-IN-TEST-FOR-ALL-CDR))
     (18 18
         (:REWRITE NOT-IN-TEST-FOR-ALL-SUBSET-APPEND))
     (18 18
         (:REWRITE NOT-IN-TEST-FOR-ALL-SUBSET))
     (17 1 (:REWRITE DEL-PRESERVES-PERMP))
     (8 8
        (:REWRITE NOT-IN-TEST-FOR-ALL-HOLDS-FOR-MEMBER))
     (8 8
        (:REWRITE NOT-IN-TEST-FOR-ALL-HOLDS-FOR-ASSOC))
     (6 6 (:REWRITE CAR-CONS))
     (5 5 (:REWRITE CDR-CONS)))
(NOT-IN-APPEND-ALT (270 135
                        (:TYPE-PRESCRIPTION TRUE-LISTP-MEMBER-EQUAL))
                   (202 56
                        (:REWRITE NOT-IN-TEST-FOR-ALL-SUBSET-APPEND))
                   ...
                   (24 24
                       (:REWRITE NOT-IN-TEST-FOR-ALL-HOLDS-FOR-ASSOC))
                   (1 1
                      (:REWRITE SET-IS-SUBSET-OF-APPENDING-ITSELF-ALT))
                   (1 1
                      (:REWRITE SET-IS-SUBSET-OF-APPENDING-ITSELF)))
...
(SUBSET-NOT-IN (1058 529
               ...
               (66 41
                   (:REWRITE NOT-IN-EMPTY-LIST-ALWAYS-TRUE))
               (41 41
                   (:REWRITE NOT-IN-TEST-FOR-ALL-SUBSET))
               (36 18
                   (:REWRITE NOT-IN-TEST-FOR-ALL-HOLDS-FOR-MEMBER))
...
(SUBSETP-APPEND (36 4 (:DEFINITION SUBSETP-EQUAL))
...
(SUBSETP-CONS-CDR-PART (3 1 (:DEFINITION MEMBER-EQUAL))
...
(M-IDS-TOMISSIVES (21 20 (:REWRITE DEFAULT-CAR))
                  (19 18 (:REWRITE DEFAULT-CDR)))
(FWD-MISSIVESP (15 1 (:DEFINITION SUBSETP-EQUAL))
               ...
               (2 2
                  (:TYPE-PRESCRIPTION V-ID-MAP-TRUE-LISTP))
               (2 2 (:REWRITE SUBSETP-TRANS))
               ...
               (1 1
                  (:TYPE-PRESCRIPTION CONSP-MEMBER-EQUAL))
               (1 1
                  (:REWRITE M-P-FOR-ALL-HOLDS-FOR-MEMBER))
               (1 1
                  (:REWRITE M-P-FOR-ALL-HOLDS-FOR-ASSOC)))
(TOMISSIVES-TRUELISTP)
(TO-MISSIVES-MISSIVESP
     (2937 75
           (:REWRITE NATP-FOR-ALL-SUBSET-APPEND))
     (2427 25 (:DEFINITION A-NATP))
     (2199 75
           (:REWRITE LEN=-FOR-ALL-SUBSET-APPEND))
     (2028 25 (:DEFINITION A-LEN=))
     (1726 32
           (:REWRITE VALIDFIELDS-TM-TEST-FOR-ALL-CDR))
     (1377 1356 (:REWRITE DEFAULT-CDR))
     (1324 1305 (:REWRITE DEFAULT-CAR))
     ...
     (789 25
          (:DEFINITION PER-RESOURCE-NO-DUPLICATE-FLITS))
     ...
     (85 25
         (:REWRITE LEN=-FOR-ALL-HOLDS-FOR-MEMBER))
     (75 75 (:REWRITE NATP-FOR-ALL-SUBSET))
     (75 75 (:REWRITE LEN=-FOR-ALL-SUBSET))
     (75 25
         (:REWRITE DEFS-TM-P-INCLUDES-WEAK-TM-P))
     (67 67
         (:REWRITE VALIDFIELDS-TM-TEST-FOR-ALL-SUBSET-APPEND))
     (67 67
         (:REWRITE VALIDFIELDS-TM-TEST-FOR-ALL-SUBSET))
     (53 53 (:TYPE-PRESCRIPTION STRIP-CARS))
     (50 50 (:TYPE-PRESCRIPTION TM-P))
     (50 50
         (:TYPE-PRESCRIPTION FILTER-CAR=-TEST-FILTER-TRUE-LISTP))
     (50 50 (:REWRITE DEFAULT-+-1))
     (50 25 (:DEFINITION FILTER-CAR=-TEST))
     (30 5 (:REWRITE DEFS-M-P-INCLUDES-WEAK-M-P))
     (28 10
         (:REWRITE M-P-FOR-ALL-HOLDS-FOR-MEMBER))
     (25 25
         (:REWRITE LEN=-FOR-ALL-HOLDS-FOR-ASSOC))
     (24 4 (:REWRITE M-P-FOR-ALL-CDR))
     (19 19
         (:REWRITE VALIDFIELDS-TM-TEST-FOR-ALL-HOLDS-FOR-MEMBER))
     (19 19
         (:REWRITE VALIDFIELDS-TM-TEST-FOR-ALL-HOLDS-FOR-ASSOC))
     (15 15 (:TYPE-PRESCRIPTION M-P))
     ...
     (8 2
        (:REWRITE SET-IS-SUBSET-OF-APPENDING-ITSELF-ALT))
     (5 5
        (:REWRITE TOMISSIVE-TM-MAP-SUBSETP-IMPLIES-MEMBER-V))
     (4 4
        (:REWRITE V-ID-MAP-SUBSETP-IMPLIES-MEMBER-V)))
(REWRITE-MISSIVESP-APPEND
     ...
     (486 12
          (:REWRITE SUBSET-STABLE-UNDER-APPEND))
     ...
     (10 10
         (:TYPE-PRESCRIPTION M-ORG-MAP-TRUE-LISTP))
...
(TOMISSIVE-V)
(EQUAL-LOCS)
(TM-IDS-TOMISSIVES-V-IDS (21 20 (:REWRITE DEFAULT-CAR))
                         (19 18 (:REWRITE DEFAULT-CDR)))
(TMISSIVESP-TOMISSIVES-BIS
     (2028 24
           (:REWRITE VALIDFIELDS-TRLST-TEST-FOR-ALL-CDR))
     ...
     (63 23
         (:REWRITE LEN=-FOR-ALL-HOLDS-FOR-MEMBER))
     (57 19
         (:REWRITE DEFS-V-P-INCLUDES-WEAK-V-P))
     (51 51
         (:REWRITE VALIDFIELDS-TRLST-TEST-FOR-ALL-SUBSET-APPEND))
     (51 51
         (:REWRITE VALIDFIELDS-TRLST-TEST-FOR-ALL-SUBSET))
     (48 48
         (:TYPE-PRESCRIPTION FILTER-CAR=-TEST-FILTER-TRUE-LISTP))
     ...
     (23 5
         (:REWRITE VALIDFIELDS-TM-TEST-FOR-ALL-HOLDS-FOR-MEMBER))
     (15 15
         (:REWRITE VALIDFIELDS-TRLST-TEST-FOR-ALL-HOLDS-FOR-MEMBER))
     (15 15
         (:REWRITE VALIDFIELDS-TRLST-TEST-FOR-ALL-HOLDS-FOR-ASSOC))
     (14 14
         (:REWRITE VALIDFIELDS-TM-TEST-FOR-ALL-SUBSET))
     (13 4
         (:REWRITE SET-IS-SUBSET-OF-APPENDING-ITSELF-ALT))
     ...
     (5 5
        (:REWRITE VALIDFIELDS-TM-TEST-FOR-ALL-HOLDS-FOR-ASSOC))
     (5 5
        (:REWRITE TOTMISSIVE-V-MAP-SUBSETP-IMPLIES-MEMBER-V))
     (4 4
        (:REWRITE V-ID-MAP-SUBSETP-IMPLIES-MEMBER-V)))
(FWD-TMISSIVESP (155 1 (:DEFINITION VALIDFIELDS-TM))
                ...
                (2 2
                   (:TYPE-PRESCRIPTION PER-RESOURCE-NO-DUPLICATE-FLITS))
                (2 2
                   (:TYPE-PRESCRIPTION FILTER-CAR=-TEST-FILTER-TRUE-LISTP))
...
(REWRITE-TMISSIVESP-APPEND
     ...
     (10 10
         (:TYPE-PRESCRIPTION TM-ORG-MAP-TRUE-LISTP))
     (10 10
         (:TYPE-PRESCRIPTION TM-CUR-MAP-TRUE-LISTP))
     (8 8 (:TYPE-PRESCRIPTION WEAK-TM-P))
     (8 8 (:TYPE-PRESCRIPTION TM-P))
     (8 8 (:TYPE-PRESCRIPTION STRIP-CARS))
     (8 8
...
(REWRITE-TRLSTP-APPEND
     ...
     (1 1 (:TYPE-PRESCRIPTION CONSP-APPEND . 1))
     (1 1 (:TYPE-PRESCRIPTION BINARY-APPEND)))
(FWD-TRLSTP (242 1 (:DEFINITION VALIDFIELDS-TRLST))
...
(VALIDSTATE-ENTRY-IMPLIES-COORD-AND-BUFFER
     ...
     (2 2
        (:REWRITE VALIDCOORD-FOR-ALL-HOLDS-FOR-MEMBER))
     (2 2
        (:REWRITE VALIDCOORD-FOR-ALL-HOLDS-FOR-ASSOC))
     (2 2
        (:REWRITE VALIDBUFFER-FOR-ALL-HOLDS-FOR-MEMBER))
     (2 2
        (:REWRITE VALIDBUFFER-FOR-ALL-HOLDS-FOR-ASSOC))
     (1 1
        (:REWRITE VALIDSTATE-ENTRYP-FOR-ALL-HOLDS-FOR-MEMBER))
     (1 1
        (:REWRITE VALIDSTATE-ENTRYP-FOR-ALL-HOLDS-FOR-ASSOC)))
