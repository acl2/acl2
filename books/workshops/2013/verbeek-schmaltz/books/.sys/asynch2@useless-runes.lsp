...
(FIX-TRUE-LISTP)
(FIND-SIMPLE-PATH
 (2291 1014 (:REWRITE DEFAULT-+-2))
 (1862 37 (:REWRITE O<=-O-FINP-DEF))
 (1446 1014 (:REWRITE DEFAULT-+-1))
 (1419 25 (:LINEAR ACL2-COUNT-CAR-CDR-LINEAR))
 (1128 230 (:META CANCEL_PLUS-LESSP-CORRECT))
 (780 156 (:DEFINITION INTEGER-ABS))
 (624 78 (:DEFINITION LENGTH))
 (512 416 (:REWRITE DEFAULT-CDR))
 (444 332 (:REWRITE DEFAULT-CAR))
 (390 78 (:DEFINITION LEN))
 (387 73 (:REWRITE O-P-O-INFP-CAR))
 (328 217 (:REWRITE DEFAULT-<-2))
 ...
 (78 78 (:REWRITE INTEGERP==>DENOMINATOR=1))
