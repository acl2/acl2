(REMOVE-LIST)
(A-LEN->=)
(CARS (4 1 (:REWRITE O-P-O-INFP-CAR))
...
(POWERSET)
(NOT-IN)
(CADRS (12 3 (:REWRITE O-P-O-INFP-CAR))
...
(SKIP-TO-LAST)
(A-TRUE-LISTP)
(PROJ (6 1 (:DEFINITION TRUE-LISTP))
      ...
      (1 1 (:REWRITE O-P-DEF-O-FINP-1)))
(FIX-TRUE-LISTP)
(FIND-SIMPLE-PATH (1740 782 (:REWRITE DEFAULT-+-2))
                  (1657 37 (:REWRITE O<=-O-FINP-DEF))
                  (1109 782 (:REWRITE DEFAULT-+-1))
...
(UNI (1 1 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(LEM-REMOVE-EQUAL-< (81 42 (:REWRITE DEFAULT-+-2))
...
(MEMBER-REMOVE-LIST (534 520 (:REWRITE DEFAULT-CAR))
...
(MEMBER-APPEND (62 50 (:REWRITE DEFAULT-CAR))
               (48 24
                   (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
...
(NOT-IN-SINGLETON (53 53 (:REWRITE DEFAULT-CAR))
                  (26 26 (:META CANCEL_TIMES-EQUAL-CORRECT))
                  (26 26 (:META CANCEL_PLUS-EQUAL-CORRECT))
...
(SUBSETP-REFLEXIVE (22 22 (:REWRITE DEFAULT-CAR))
                   (19 19 (:REWRITE DEFAULT-CDR))
                   (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
                   (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(SUBSETP-APPEND-L (84 75 (:REWRITE DEFAULT-CAR))
                  ...
                  (21 7 (:REWRITE CAR-APPEND)))
(SUBSETP-APPEND-R-1 (41 41 (:REWRITE DEFAULT-CAR))
...
(SUBSETP-APPEND-R-2 (56 56 (:REWRITE DEFAULT-CAR))
...
(SPEC-OF-PROJ (78 11 (:DEFINITION NTH))
              ...
              (3 3 (:REWRITE O-P-DEF-O-FINP-1)))
(SPEC-OF-A-TRUE-LISTP (28 6 (:DEFINITION TRUE-LISTP))
                      ...
                      (4 4 (:META CANCEL_TIMES-EQUAL-CORRECT))
                      (4 4 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(MEMBER-KEY-->MEMBER-ASSOC (146 66 (:REWRITE DEFAULT-CAR))
...
(SPEC-OF-A-LEN->=1 (16 4 (:REWRITE O-P-O-INFP-CAR))
                   (10 10 (:REWRITE DEFAULT-CAR))
                   ...
                   (4 4 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(MEMBER-NTH-OF-PROJ (18 2 (:DEFINITION NTH))
...
(LEN-REMOVE-EQUAL (26 13 (:REWRITE DEFAULT-+-2))
...
(SPEC-OF-EQLABLE-LISTP (10 10 (:REWRITE DEFAULT-CAR))
                       (8 8 (:REWRITE SPEC-OF-A-LEN->=1))
                       (6 6 (:REWRITE MEMBER-SKIP-TO-LAST))
                       (4 4 (:REWRITE DEFAULT-CDR))
                       (4 4 (:META CANCEL_TIMES-EQUAL-CORRECT))
                       (4 4 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(CAR-FIND-SIMPLE-PATH (51 7 (:DEFINITION SKIP-TO-LAST))
...
(CONSP-FIND-SIMPLE-PATH (44 35 (:REWRITE DEFAULT-CAR))
...
(NO-DUPS-FIND-SIMPLE-PATH (677 46 (:REWRITE MEMBER-FIND-SIMPLE-PATH))
