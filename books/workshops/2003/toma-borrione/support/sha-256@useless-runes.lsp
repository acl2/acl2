(K-256)
(WORDP-K-256 (12 1 (:DEFINITION WORDP))
             (5 1 (:DEFINITION LEN))
             (4 1 (:DEFINITION BVP))
...
(H-256)
(WORDP-H-256)
(PREPARE-256-AC (64 1 (:DEFINITION WVP))
...
(PREPARE-256)
(WVP-PREPARE-256-AC (1102 74 (:DEFINITION BVP))
                    ...
                    (3 3 (:REWRITE NTH-WVP)))
(LEN-PREPARE-256-AC (630 45 (:DEFINITION BVP))
...
(WVP-PREPARE-256 (51 1 (:DEFINITION PARSING))
...
(LEN-PREPARE-256 (51 1 (:DEFINITION PARSING))
                 ...
                 (2 2 (:REWRITE DEFAULT-<-1)))
(TEMP-1-256)
(WORDP-TEMP-1-256 (196 14 (:DEFINITION BVP))
...
(TEMP-2-256)
(WORDP-TEMP-2-256 (98 7 (:DEFINITION BVP))
...
(DIGEST-ONE-BLOCK-256-AC (128 2 (:DEFINITION WVP))
...
(WVP-DIGEST-ONE-BLOCK-256-AC (1164 81 (:DEFINITION BVP))
...
(LEN-DIGEST-ONE-BLOCK-256-AC (952 68 (:DEFINITION BVP))
                             ...
                             (18 18 (:REWRITE DEFAULT-<-2))
                             (18 18 (:REWRITE DEFAULT-<-1)))
(WVP-DIGEST-ONE-BLOCK-256 (196 14 (:DEFINITION BVP))
                          (184 32 (:REWRITE BVP-TRUE-LISTP))
                          (128 14 (:DEFINITION TRUE-LISTP))
                          ...
                          (6 6 (:REWRITE DEFAULT-+-1))
                          (2 2 (:LINEAR LEQ-POSITION-EQUAL-LEN)))
(LEN-DIGEST-ONE-BLOCK-256 (196 14 (:DEFINITION BVP))
                          (184 32 (:REWRITE BVP-TRUE-LISTP))
                          (128 14 (:DEFINITION TRUE-LISTP))
                          (38 38 (:REWRITE DEFAULT-CDR))
                          (24 24 (:TYPE-PRESCRIPTION TRUE-LISTP))
...
(WVP-INTERMEDIATE-HASH-256 (252 72 (:REWRITE NTH-WITH-LARGE-INDEX))
                           ...
                           (8 8 (:DEFINITION BITP))
                           (2 2 (:LINEAR LEQ-POSITION-EQUAL-LEN)))
(LEN-INTERMEDIATE-HASH-256 (21018 216 (:DEFINITION BV-INT-LITTLE-ENDIAN))
...
(DIGEST-256 (1 1
               (:TYPE-PRESCRIPTION DIGEST-ONE-BLOCK-256)))
(WVP-DIGEST-256 (251 251 (:REWRITE DEFAULT-CDR))
...
(LEN-DIGEST-256 (290 290 (:REWRITE DEFAULT-CDR))
...
(SHA-256)
(WVP-SHA-256 (15 3 (:DEFINITION LEN))
             ...
             (2 2 (:REWRITE DEFAULT-<-2))
             (1 1 (:LINEAR LEQ-POSITION-EQUAL-LEN)))
(LEN-SHA-256 (38 2 (:REWRITE LEN-DIGEST-256))
