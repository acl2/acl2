(MVECTORP)
(VECTOR-IS-TRUE-LIST (6 6 (:REWRITE DEFAULT-CAR))
                     (4 4
...
(MVECTORP-VZERO (5 4 (:REWRITE DEFAULT-CDR))
...
(MVECTORP-V+ (11 10 (:REWRITE DEFAULT-CAR))
             (9 9
                (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(LEN-V+ (20 10 (:REWRITE DEFAULT-CDR))
        ...
        (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
        (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(V+-ASSOC (81 32 (:REWRITE DEFAULT-+-2))
          ...
          (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
          (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(V+-ASSOC2 (85 34 (:REWRITE DEFAULT-+-2))
           ...
           (2 2 (:REWRITE EQUAL-CONSTANT-+)))
(V+-COMM (52 26 (:REWRITE DEFAULT-+-2))
...
(V+-ZERO-LEFT (132 6 (:REWRITE CONSP-VZERO))
              ...
              (4 4 (:META CANCEL_TIMES-EQUAL-CORRECT))
              (4 4 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(V+ZERO-RIGHT (57 32 (:REWRITE DEFAULT-CDR))
              ...
              (1 1 (:META CANCEL_TIMES-EQUAL-CORRECT))
              (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(NTH-V+ (135 115 (:REWRITE DEFAULT-+-1))
        (134 134
             (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(CONSP-SV* (6 6
           ...
           (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
           (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(SV*-0-LEFT (27 3 (:REWRITE ZP-OPEN))
            ...
            (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(SV*-0-RIGHT (28 9 (:REWRITE CONSP-VZERO))
...
(SV*-SV* (78 29 (:REWRITE DEFAULT-*-2))
         ...
         (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
         (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(SV*-COLLECT (13 11 (:REWRITE DEFAULT-CAR))
...
(SV*-COLLECT-BOTH (62 44
                  ...
                  (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
                  (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(SV*-DIST-NIL (62 6 (:REWRITE V+-NIL))
...
(SV*-DIST (152 110
          ...
          (1 1 (:REWRITE EQUAL-CONSTANT-+)))
(NTH-SV* (62 33 (:REWRITE DEFAULT-CAR))
...
(DOT* (59 30 (:REWRITE DEFAULT-+-2))
      ...
      (2 2 (:REWRITE EQUAL-CONSTANT-+)))
(NUMBERP-DOT*)
(DOT*-NIL-LEFT (6 2 (:REWRITE UNICITY-OF-0))
...
(DOT*-COMM (18 18
           ...
           (5 5 (:META CANCEL_PLUS-EQUAL-CORRECT))
           (1 1 (:REWRITE EQUAL-CONSTANT-+)))
(ZERO-DOT*-RECURSION (4 4
                        (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(DOT*-ZERO-LEFT (34 6 (:REWRITE ZP-OPEN))
                ...
                (1 1 (:META CANCEL_TIMES-EQUAL-CORRECT))
                (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(DOT*-ZERO-RIGHT (35 7 (:REWRITE ZP-OPEN))
                 (28 2 (:REWRITE CONSP-VZERO))
                 (22 5 (:REWRITE DEFAULT-CDR))
                 (21 4 (:REWRITE DEFAULT-CAR))
                 (16 4 (:REWRITE <-0-+-NEGATIVE-1))
                 ...
                 (1 1 (:META CANCEL_TIMES-EQUAL-CORRECT))
                 (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(DIST-DOT*-V+-LEFT (123 62 (:REWRITE DEFAULT-+-2))
                   ...
                   (6 6 (:REWRITE CONSP-V+)))
(DIST-DOT*-V+-RIGHT (109 55 (:REWRITE DEFAULT-+-2))
                    ...
                    (4 4 (:REWRITE CONSP-V+)))
(DOT*-SV*-LEFT (73 41 (:REWRITE DEFAULT-*-1))
               (70 55
                   (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
