...
(M-EMPTYP-M+ (876 3 (:DEFINITION V+))
             ...
             (4 1 (:DEFINITION FIX))
             (2 1 (:REWRITE ROW-COUNT-IMPLIES-EMPTY)))
(ROW-COUNT-M+ (876 3 (:DEFINITION V+))
...
(COL-COUNT-M+ (387 19 (:REWRITE DEFAULT-+-2))
              (386 2 (:DEFINITION V+))
...
(COL-CAR-M+ (1710 137 (:REWRITE ROW-CDR-EMPTY))
...
(M+-BY-COL-RECURSION (613 132 (:REWRITE DEFAULT-+-2))
...
(M+-BY-COL-DEF (14475 1050 (:META CANCEL_PLUS-EQUAL-CORRECT))
...
(M+-ASSOC (17861 110 (:DEFINITION V+))
...
(M+-ASSOC2 (19385 122 (:DEFINITION V+))
...
(M+-COMM (4229 30 (:DEFINITION V+))
         ...
         (3 3 (:REWRITE EQUAL-CONSTANT-+)))
(M+ZERO (2174 3 (:DEFINITION M+-BY-COL-DEF))
        (1344 6 (:DEFINITION V+))
        ...
        (51 17
            (:REWRITE ROW-COUNT-IMPLIES-NOT-EMPTY))
        (51 2
            (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(ZERO+M (2335 3 (:DEFINITION M+-BY-COL-DEF))
        (1435 6 (:DEFINITION V+))
        ...
        (3 3 (:REWRITE CAR-CONS)))
(ROW-M+ (8290 117 (:DEFINITION COL-CAR-DEF))
        ...
        (1977 1977
              (:TYPE-PRESCRIPTION COL-COUNT-TYPE))
        ...
        (18 18 (:REWRITE CAR-CONS)))
(COL-M+ (11222 728 (:REWRITE COL-CDR-EMPTY))
...
(ENTRY-M+ (6416 46 (:DEFINITION ROW-BY-COL-DEF))
