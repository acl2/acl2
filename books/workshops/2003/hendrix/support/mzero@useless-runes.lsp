...
(MZERO (12 12 (:META CANCEL_PLUS-LESSP-CORRECT))
...
(MATRIXP-ZERO)
(M-EMPTY-ZERO (15 5 (:DEFINITION VZERO))
              (13 13
                  (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
              (9 9 (:REWRITE DEFAULT-+-2))
              (9 9 (:REWRITE DEFAULT-+-1))
              ...
              (1 1 (:REWRITE DEFAULT-<-2))
              (1 1 (:REWRITE DEFAULT-<-1)))
(COL-COUNT-ZERO (8 1 (:DEFINITION MZERO))
                (6 6 (:REWRITE ZP-OPEN))
                (3 1 (:DEFINITION VZERO))
                (2 2 (:REWRITE DEFAULT-+-2))
                (2 2 (:REWRITE DEFAULT-+-1)))
(ROW-COUNT-ZERO (108 4 (:REWRITE ROW-CDR-EMPTY))
                (44 44
                    (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(ZERO-BY-COL-DEF (176 10 (:REWRITE COL-CONS-ROW-CONS-UNIT))
