(ASSOC-EQ-PROPERTIES (59 59 (:REWRITE DEFAULT-CAR))
                     (10 10 (:REWRITE DEFAULT-CDR)))
(ASSOC2-PROPERTIES (364 364 (:REWRITE DEFAULT-CAR))
                   (99 99 (:REWRITE DEFAULT-CDR)))
(ASSOC-KEYWORD-PROPERTIES (53 50 (:REWRITE DEFAULT-CAR))
...
(ARRAY2P-HEADER-EXISTS (10 10 (:REWRITE DEFAULT-CAR))
                       (4 4 (:REWRITE DEFAULT-CDR))
                       (4 4 (:LINEAR ARRAY2P-LINEAR))
                       (3 3 (:LINEAR ARRAY1P-LINEAR))
                       (3 1 (:DEFINITION ALISTP)))
(ARRAY2P-CONS-1 (425 173 (:REWRITE DEFAULT-CDR))
...
(ALISTP-COMPRESS211 (108 107 (:REWRITE DEFAULT-CAR))
...
(COMPRESS211-ASSOC2-PROPERTY-1 (348 338 (:REWRITE DEFAULT-CAR))
                               ...
                               (4 1
                                  (:REWRITE DISTRIBUTIVITY-OF-MINUS-OVER-+)))
(COMPRESS211-ASSOC2-PROPERTY-2 (262 257 (:REWRITE DEFAULT-CAR))
                               (152 150 (:REWRITE DEFAULT-CDR))
                               (33 8
                                   (:REWRITE COMPRESS211-ASSOC2-PROPERTY-0))
                               (26 26
                                   (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                               (26 16 (:REWRITE DEFAULT-+-1))
                               (22 16 (:REWRITE DEFAULT-+-2))
                               ...
                               (20 10 (:REWRITE DEFAULT-UNARY-MINUS))
                               (6 6
                                  (:REWRITE COMPRESS211-ASSOC2-PROPERTY-1))
                               (5 5 (:REWRITE DEFAULT-<-2))
                               (5 5 (:REWRITE DEFAULT-<-1)))
(NOT-ASSOC2-COMPRESS211 (296 293 (:REWRITE DEFAULT-CAR))
                        (193 8
                             (:REWRITE COMPRESS211-ASSOC2-PROPERTY-2))
                        (182 7
                             (:REWRITE COMPRESS211-ASSOC2-PROPERTY-0))
...
(ALISTP-COMPRESS21 (270 18 (:DEFINITION ASSOC2))
                   ...
                   (13 13
                       (:REWRITE COMPRESS211-ASSOC2-PROPERTY-1)))
(BOUNDED-INTEGER-ALISTP2-APPEND (75 63 (:REWRITE DEFAULT-CAR))
...
(COMPRESS21-ASSOC2-PROPERTY-0 (1609 1564 (:REWRITE DEFAULT-CAR))
                              ...
                              (18 18
                                  (:REWRITE COMPRESS211-ASSOC2-PROPERTY-2)))
(COMPRESS21-ASSOC2-PROPERTY-1 (1182 1156 (:REWRITE DEFAULT-CAR))
                              ...
                              (4 4
                                 (:REWRITE COMPRESS211-ASSOC2-PROPERTY-2)))
(COMPRESS21-ASSOC2-PROPERTY-2 (433 428 (:REWRITE DEFAULT-CAR))
                              ...
                              (16 16
                                  (:REWRITE COMPRESS211-ASSOC2-PROPERTY-1))
                              (16 16
                                  (:REWRITE COMPRESS21-ASSOC2-PROPERTY-1))
                              (10 10
                                  (:REWRITE COMPRESS21-ASSOC2-PROPERTY-0)))
(COMPRESS2-ASSOC2-PROPERTY-0 (435 5 (:DEFINITION COMPRESS21))
                             ...
                             (10 10 (:REWRITE DEFAULT-<-1))
                             (8 8
                                (:REWRITE COMPRESS21-ASSOC2-PROPERTY-2))
                             (7 7
                                (:REWRITE COMPRESS211-ASSOC2-PROPERTY-1))
                             (7 7
                                (:REWRITE COMPRESS21-ASSOC2-PROPERTY-1)))
(COMPRESS2-ASSOC2-PROPERTY-1 (260 132 (:REWRITE DEFAULT-CDR))
...
(COMPRESS2-ASSOC2-PROPERTY-2 (88 1 (:DEFINITION COMPRESS21))
                             ...
                             (1 1
                                (:REWRITE COMPRESS21-ASSOC2-PROPERTY-1))
                             (1 1
                                (:REWRITE COMPRESS2-ASSOC2-PROPERTY-1)))
(HEADER-COMPRESS2 (180 81 (:REWRITE DEFAULT-CDR))
                  ...
                  (1 1
                     (:REWRITE COMPRESS21-ASSOC2-PROPERTY-1))
                  (1 1
                     (:REWRITE COMPRESS2-ASSOC2-PROPERTY-2)))
(ARRAY2P-COMPRESS2 (1725 839 (:REWRITE DEFAULT-CDR))
...
(ARRAY2P-COMPRESS2-PROPERTIES (552 4 (:DEFINITION COMPRESS21))
                              ...
                              (2 2 (:REWRITE DEFAULT-*-2))
                              (2 2 (:REWRITE DEFAULT-*-1)))
(ARRAY2P-ASET2 (490 194 (:REWRITE DEFAULT-CDR))
...
(ARRAY2P-ASET2-PROPERTIES (556 245 (:REWRITE DEFAULT-CDR))
                          ...
                          (3 3 (:REWRITE DEFAULT-*-2))
                          (3 3 (:REWRITE DEFAULT-*-1)))
(AREF2-COMPRESS2 (1266 518 (:REWRITE DEFAULT-CDR))
                 ...
                 (4 4
                    (:REWRITE COMPRESS21-ASSOC2-PROPERTY-1)))
(ARRAY2P-ACONS-PROPERTIES (99 42 (:REWRITE DEFAULT-CDR))
...
(ARRAY2P-CONSP-HEADER (6 6 (:REWRITE DEFAULT-CAR))
                      (2 2 (:REWRITE DEFAULT-CDR))
                      (1 1 (:LINEAR ARRAY1P-LINEAR)))
(ARRAY2P-CAR-HEADER (92 37 (:REWRITE DEFAULT-CDR))
                    ...
                    (1 1 (:REWRITE DEFAULT-*-2))
                    (1 1 (:REWRITE DEFAULT-*-1)))
(AREF2-ASET2-EQUAL (479 197 (:REWRITE DEFAULT-CDR))
                   ...
                   (3 3 (:REWRITE DEFAULT-*-2))
                   (3 3 (:REWRITE DEFAULT-*-1)))
(AREF2-ASET2-NOT-EQUAL (4150 1815 (:REWRITE DEFAULT-CDR))
                       ...
                       (12 12
                           (:REWRITE COMPRESS2-ASSOC2-PROPERTY-2)))
(AREF2-ASET2 (4405 1915 (:REWRITE DEFAULT-CDR))
             ...
             (11 11
                 (:REWRITE COMPRESS2-ASSOC2-PROPERTY-2)))
(ARRAY2P-FORWARD-MODULAR (84 36 (:REWRITE DEFAULT-CDR))
                         ...
                         (1 1 (:REWRITE DEFAULT-*-2))
                         (1 1 (:REWRITE DEFAULT-*-1)))
(ARRAY2P-LINEAR-MODULAR (84 36 (:REWRITE DEFAULT-CDR))
                        (47 38 (:REWRITE DEFAULT-CAR))
                        (37 5 (:REWRITE ASSOC-KEYWORD-PROPERTIES))
                        (30 6 (:DEFINITION ASSOC-EQUAL))
                        (24 6 (:DEFINITION ASSOC-KEYWORD))
