...
(%%P0-PROPERTY-LEMMA)
(%%P0-PROPERTY)
(OUT2$-IS-OUT2$-BASE (1 1 (:REWRITE ZP-OPEN)))
(OUT1$-IS-OUT1$-BASE (56 8 (:REWRITE IF1-NON-0))
                     ...
                     (1 1 (:REWRITE ZP-OPEN)))
(%%P0-BASE (2 1 (:REWRITE %%P0-IMPLIES-%%P0-AUX)))
...
(%%P0-INDUCTION_STEP (2 1 (:REWRITE %%P0-IMPLIES-%%P0-AUX)))
(%%P0-HOLDS)
(OUT2$-IS-OUT2$)
(OUT1$-IS-OUT1$)
