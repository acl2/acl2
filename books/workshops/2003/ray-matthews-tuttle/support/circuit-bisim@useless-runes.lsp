(EVALUATION-EQ)
(EVALUATION-EQ-IS-SYMMETRIC (20 20 (:REWRITE DEFAULT-CAR))
                            (4 4 (:REWRITE DEFAULT-CDR)))
(EVALUATION-EQ-MEMBER-P)
(EVALUATION-EQ-MEMBER)
(MEMBER-IS-MEMBERP (70 70 (:REWRITE DEFAULT-CAR))
                   (23 23 (:REWRITE DEFAULT-CDR)))
(MEMBER-IS-EVALUATION-EQ (49 49 (:REWRITE DEFAULT-CAR))
...
(EVALUATION-EQ-SUBSET-TO-MEMBER (42 7 (:DEFINITION EVALUATION-EQ))
...
(ONLY-TRUTH-P)
(ALL-TRUTHSP-LABEL)
(ALL-TRUTHSP-LABEL-EXPANDED (23 23 (:REWRITE DEFAULT-CAR))
...
(WELL-FORMED-TRANSITION-P-NECC (4 4 (:DEFINITION MV-NTH)))
...
(C-BISIMILAR-EQUIV-IMPLIES-BISIMILAR-INITIAL-STATES-N->M
     ...
     (5 5
        (:REWRITE WELL-FORMED-TRANSITION-P-EXPANDED))
     (4 4 (:REWRITE STRICT-EVALUATION-P-NECC)))
(TRUTHP-LABEL-FROM-ONLY-TRUTHP (22 22 (:REWRITE DEFAULT-CAR))
...
(MEMBERP-TO-INTERSECT-REDUCTION
     ...
     (2 2
        (:REWRITE PROPER-SUBSET-IS-TRANSITIVE)))
(EVALUATION-EQ-VARS-REDUCTION (15 15 (:REWRITE DEFAULT-CAR))
                              (14 14
                                  (:REWRITE STRICT-EVALUATION-P-EXPANDED))
                              (6 6
                                 (:REWRITE TRANSITION-SUBSET-P-EXPANDED))
...
(TRUTHP-LABEL-TO-SUBSET (251 29 (:REWRITE SUBSET-TRANSITIVE-MEMBER))
...
(C-BISIMILAR-STATES-HAVE-LABELS-EQUAL
     ...
     (8 8
        (:REWRITE TRUTHP-LABEL-INTERSECT-IS-A-SUBSET))
