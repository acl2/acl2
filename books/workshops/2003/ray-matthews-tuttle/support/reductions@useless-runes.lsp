...
(REDUCE-PROBLEM-CONJUNCTION (282 134 (:REWRITE DEFAULT-+-2))
...
(LTL-SEMANTICS*-APPEND-REDUCTION
     ...
     (7866 29
           (:DEFINITION CONSISTENT-EQUATION-RECORD-P))
     ...
     (290 290
          (:TYPE-PRESCRIPTION STRICT-EVALUATION-LIST-P))
     (290 290
          (:TYPE-PRESCRIPTION ONLY-EVALUATIONS-P))
     ...
     (87 87
         (:REWRITE ALL-TRUTHS-P-FROM-ONLY-ALL-TRUTHS-P))
     (87 29
         (:REWRITE LTL-SEMANTICS-IS-DECOMPOSED-OVER-CONJUNCTION))
     ...
     (29 29
         (:REWRITE LABEL-SUBSET-SUBSET-REDUCTION))
...
(MEMBERP-UNION-REDUCTION-1 (93 6
                               (:REWRITE NOT-MEMBERP-UNION-REDUCTION))
...
(FIND-ALL-VARIABLES-PRODUCES-SUBSET
     ...
     (9 9
        (:REWRITE PROPER-SUBSET-IS-IRREFLEXIVE))
     (9 9
        (:REWRITE FIND-VARIABLES-1-PASS-IS-SUBSET)))
(SET-INTERSECT-IS-SUBSET
     ...
     (97 97
         (:REWRITE PROPER-SUBSET-IS-TRANSITIVE)))
(MEMBERP-REMOVE-REDUCTION (125 125 (:REWRITE DEFAULT-CAR))
...
(CONE-VARIABLES-ARE-SUBSET
     ...
     (56 2
         (:REWRITE MEMBERP-FIND-ALL-VARIABLES-REDUCTION))
...
(CONE-OF-INFLUENCE-REDUCTION-FOR-SPECIFIC
     ...
     (279 1
          (:REWRITE CONE-OF-INFLUENCE-REDUCTION-IS-SOUND))
     (98 3 (:DEFINITION SUBSET))
     (88 4
         (:DEFINITION CREATE-RESTRICTED-VAR-SET))
...
(SET-UNION-SUBSET-REDUCTION-2
     ...
     (18 18
         (:REWRITE SET-UNION-SUBSET-REDUCTION))
     (18 18
         (:REWRITE PROPER-SUBSET-IS-TRANSITIVE))
...
(CONJUNCTION-HAS-VARIABLES-SUBSET-1
     ...
     (6 6
        (:REWRITE SET-UNION-SUBSET-REDUCTION-2))
...
(CONJUNCTION-HAS-VARIABLES-SUBSET-2
     ...
     (1158 3
           (:REWRITE CONJUNCTION-HAS-VARIABLES-SUBSET-1))
     ...
     (138 138
          (:REWRITE TRANSITION-SUBSET-P-EXPANDED))
     (138 138
          (:REWRITE SUBSET-MEMBER-REDUCTION-2))
...
(COMPOSITIONAL-REDUCTION-IS-SOUND
     ...
     (20 1
         (:DEFINITION REDUCE-PROBLEM-CONJUNCTION))
     (17 17
         (:TYPE-PRESCRIPTION REDUCE-PROBLEM-CONJUNCTION))
