...
(G-KEYS-AUX-RELATIONSHIP
 (460 447 (:REWRITE DEFAULT-CAR))
 (193 182 (:REWRITE DEFAULT-CDR))
 )
(S-KEYS-AUX-REDUCTION
 (2456 658 (:REWRITE <<-TRICHOTOMY))
 (1806 338 (:REWRITE <<-ASYMMETRIC))
 (1118 34 (:REWRITE MEMBERP-YES-REDUCE-INSERT))
 (1012 30 (:DEFINITION ORDEREDP))
 (1000 937 (:REWRITE DEFAULT-CAR))
 (619 480 (:REWRITE DEFAULT-CDR))
 (150 150 (:TYPE-PRESCRIPTION ORDEREDP))
 )
(KEYS-AUX-ARE-ORDERED
 (733 200 (:REWRITE <<-TRICHOTOMY))
 (634 114 (:REWRITE <<-ASYMMETRIC))
 (312 196 (:REWRITE <<-TRANSITIVE))
...
(G-KEYS-RELATIONSHIP
 (162 6 (:REWRITE G-AUX-IS-NIL-FOR-<<))
 (117 30 (:REWRITE <<-TRICHOTOMY))
 (87 3 (:DEFINITION RCDP))
 (75 15 (:REWRITE <<-ASYMMETRIC))
 (59 41 (:REWRITE DEFAULT-CAR))
 (30 30 (:REWRITE <<-TRANSITIVE))
 (29 29 (:TYPE-PRESCRIPTION ACL2->RCD))
 (16 16 (:REWRITE DEFAULT-CDR))
 (6 1 (:DEFINITION KEYS-AUX))
 )
(S-KEYS-REDUCTION
 (248 4 (:REWRITE G-KEYS-AUX-RELATIONSHIP))
 (214 6 (:REWRITE MEMBERP-NO-REDUCE-DROP))
 (192 4 (:DEFINITION G-AUX))
 (183 47 (:REWRITE <<-TRICHOTOMY))
 (146 4 (:REWRITE MEMBERP-YES-REDUCE-INSERT))
 (125 23 (:REWRITE <<-ASYMMETRIC))
 (120 120 (:TYPE-PRESCRIPTION <<))
 (118 2 (:DEFINITION INSERT))
 (108 4 (:REWRITE G-AUX-IS-NIL-FOR-<<))
 (79 67 (:REWRITE DEFAULT-CAR))
 (58 2 (:DEFINITION RCDP))
 (54 2 (:DEFINITION DROP))
 (48 2 (:DEFINITION ORDEREDP))
 (47 47 (:REWRITE <<-TRANSITIVE))
 (40 40 (:TYPE-PRESCRIPTION ACL2->RCD))
 (36 1 (:DEFINITION S-AUX))
 (35 35 (:REWRITE DEFAULT-CDR))
 (28 4 (:DEFINITION MEMBERP))
 (24 24 (:TYPE-PRESCRIPTION MEMBERP))
 (24 4 (:DEFINITION KEYS-AUX))
 (12 12 (:TYPE-PRESCRIPTION ORDEREDP))
 (6 2 (:REWRITE KEYS-AUX-ARE-ORDERED))
 )
(KEYS-ARE-ORDERED)
(G-OF-NIL-IS-NIL
