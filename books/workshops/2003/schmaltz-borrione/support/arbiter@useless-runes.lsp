...
(STAGE_P_<_LEN_L (115 39
                 ...
                 (1 1 (:LINEAR LEQ-POSITION-EQUAL-LEN)))
(PRIOR_SCHEME (166 8 (:REWRITE NTH-WITH-LARGE-INDEX))
              (144 48
                   (:REWRITE NOT_NO_REQUESTP_CDR_=>_NOT_NO_REQUESTP_L))
...
(ROUND_ROBIN_>=_0 (77 4 (:REWRITE FIRSTN-WITH-LARGE-INDEX))
...
(LEMMA_FOR_ROUND_ROBIN_<_CASE_2 (461 143 (:REWRITE CAR_NO_REQUESTP))
...
(LEMMA1_CASE_2 (759 44 (:REWRITE FIRSTN-WITH-LARGE-INDEX))
               ...
               (30 6
                   (:REWRITE LEMMA_FOR_ROUND_ROBIN_<_CASE_2))
               (28 28 (:REWRITE ZP-OPEN))
               (18 6 (:REWRITE LASTN_NO_REQUESTP)))
(LEMMA2_CASE_2)
(LEMMA3_CASE_2 (45 2 (:REWRITE FIRSTN-WITH-LARGE-INDEX))
...
(LEMMA4_CASE_2 (486 24 (:REWRITE FIRSTN-WITH-LARGE-INDEX))
...
(ROUND_ROBIN_<_N_CASE_2
     ...
     (1 1 (:LINEAR LEQ-POSITION-EQUAL-LEN)))
(LEMMA1_CASE_3)
(LEMMA4_CASE_3 (26 8 (:REWRITE DEFAULT-CAR))
               ...
               (1 1 (:LINEAR LEQ-POSITION-EQUAL-LEN)))
(LEMMA5_CASE_3 (26 8 (:REWRITE DEFAULT-CAR))
...
(ROUND_ROBIN_<_N_CASE_3
     ...
     (1 1 (:LINEAR LEQ-POSITION-EQUAL-LEN)))
(LIST_REQ_=>_LIST_LAST (712 174 (:REWRITE CAR_NO_REQUESTP))
...
(ROUND_ROBIN_<_N (109 11 (:REWRITE FIRSTN-WITH-LARGE-INDEX))
...
(ROUND_ROBIN_<=N-1 (106 31
                   ...
                   (3 3 (:REWRITE FOLD-CONSTS-IN-+))
                   (1 1 (:LINEAR LEQ-POSITION-EQUAL-LEN)))
(FIND_NOT_EQUAL_LAST_GRANTED (113 113
                                  (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(LEMMA1_NO_DEADLOCK (138 6 (:REWRITE NTH-WITH-LARGE-INDEX))
...
(LEMMA2_NO_DEADLOCK (311 105 (:REWRITE CAR_NO_REQUESTP))
                    (264 45
                         (:REWRITE NOT_NO_REQUESTP_CDR_=>_NOT_NO_REQUESTP_L))
...
(NO_DEADLOCK (1751 35 (:REWRITE NTH-WITH-LARGE-INDEX))
...
(MASTER_NUM)
(INT+INT=INT)
(INTEGERP_MASTER_NUM (90 2 (:REWRITE NTH-WITH-LARGE-INDEX))
                     (81 1 (:DEFINITION NTH))
                     ...
                     (1 1 (:REWRITE DEFAULT-CAR)))
(POS+POS=POS)
(MASTER_NUM_>=0 (115 2 (:REWRITE NTH-WITH-LARGE-INDEX))
...
(DEFAULT_MASTER_MASTER_NUM
     ...
     (2 1
        (:REWRITE L_UNI_=>_LEN_CAR_=_LEN_CADR)))
(LEN_NTH_UNI_LIST (739 25 (:REWRITE NTH-WITH-LARGE-INDEX))
...
(MASTER_NUM_<_P*N (612 20 (:REWRITE NTH-WITH-LARGE-INDEX))
...
(LEN_ARBITER (14 1 (:REWRITE DEFAULT_MASTER_MASTER_NUM))
             ...
             (1 1 (:REWRITE DEFAULT-CAR)))
(CONSP_ARBITER (14 1 (:REWRITE DEFAULT_MASTER_MASTER_NUM))
               (11 1 (:DEFINITION NO_REQUESTP_MATRIX))
...
(NTH_ARBITER_=_1 (2463 23 (:DEFINITION NTH))
                 ...
                 (2 1 (:DEFINITION IFF)))
(NTH_ARBITER_=_0 (124 24 (:REWRITE LEMMA2_NO_DEADLOCK))
