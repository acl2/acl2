...
(HACK)
(NONNEG-INT-MOD-+-* (45 45 (:REWRITE DEFAULT-<-2))
...
(NONNEG-INT-MOD-+-*-NONNEG-INT-MOD (136 136 (:REWRITE DEFAULT-<-2))
...
(RIGHT-NONNEG-INT-MOD-* (3 1 (:LINEAR NONNEG-INT-MOD-<-DIVISOR))
                        ...
                        (2 2 (:REWRITE DEFAULT-*-2))
                        (2 2 (:REWRITE DEFAULT-*-1)))
(NONNEG-INT-MOD-*-0 (116 109 (:REWRITE DEFAULT-<-1))
                    ...
                    (4 4 (:DEFINITION IFIX)))
(NONNEG-INT-MOD-+-0 (179 158 (:REWRITE DEFAULT-<-1))
...
(NONNEG-INT-MOD-MINUS-0 (246 198 (:REWRITE DEFAULT-<-1))
...
(DIVISOR-<= (5 5 (:REWRITE DEFAULT-<-2))
            (5 5 (:REWRITE DEFAULT-<-1))
            (1 1 (:REWRITE ZP-OPEN))
            (1 1 (:LINEAR NONNEG-INT-MOD-<-DIVISOR)))
(NONNEG-INT-MOD-1 (17 1 (:DEFINITION NONNEG-INT-MOD))
                  (6 2 (:DEFINITION NFIX))
...
(NONNEG-INT-GCD (30 2 (:DEFINITION NONNEG-INT-MOD))
                ...
                (2 2 (:REWRITE DEFAULT-+-2))
                (1 1 (:REWRITE ZP-OPEN)))
(NONNEG-INT-GCD->-0 (86 5 (:DEFINITION NONNEG-INT-MOD))
...
(NONNEG-INT-GCD-IS-COMMON-DIVISOR
     ...
     (4 4 (:DEFINITION IFF)))
(NONNEG-INT-GCD-MULTIPLIER1 (30 2 (:DEFINITION NONNEG-INT-MOD))
                            (12 4 (:DEFINITION NFIX))
                            (11 9 (:REWRITE DEFAULT-<-1))
                            (9 9 (:REWRITE DEFAULT-<-2))
                            (4 2 (:REWRITE DEFAULT-+-1))
...
(NONNEGATIVE-INTEGER-QUOTIENT-GCD
     ...
     (2 2 (:DEFINITION IFIX)))
(LINEAR-COMBINATION-GCD=1 (317 57 (:REWRITE NONNEG-INT-MOD-MINUS-0))
...
(DIVISOR-OF-PRODUCT-DIVIDES-FACTOR
     ...
     (1 1
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(NONNEG-INT-MOD-ABS-+-* (631 62 (:REWRITE NONNEG-INT-MOD-+-0))
...
(NONNEG-INT-GCD-ABS->= (246 12 (:DEFINITION NONNEG-INT-MOD))
...
(NONNEG-INT-MOD-ABS (312 255 (:REWRITE DEFAULT-<-2))
                    ...
                    (4 1
                       (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                    (2 2 (:REWRITE FOLD-CONSTS-IN-*)))
(NONNEG-INT-GCD-ABS-<= (246 10 (:DEFINITION NONNEG-INT-GCD))
...
(COMMUTATIVITY-OF-NONNEG-INT-GCD (30 30 (:REWRITE DEFAULT-<-2))
...
(NONNEG-INT-GCD-1-LEFT (42 2 (:DEFINITION NONNEG-INT-MOD))
...
(NONNEG-INT-GCD-NUMERATOR-DENOMINATOR
     ...
     (3 3 (:REWRITE DEFAULT-*-1))
     (1 1 (:REWRITE FOLD-CONSTS-IN-*)))
(LOWEST-TERMS-NONNEG-INT-MOD (107 107 (:REWRITE DEFAULT-<-2))
                             ...
                             (15 15 (:REWRITE NONNEG-INT-MOD-+-0))
                             (8 5 (:REWRITE ZP-OPEN)))
(LOWEST-TERMS-<= (86 86 (:REWRITE DEFAULT-<-2))
...
(LEAST-NUMERATOR-DENOMINATOR-NONNEG-INT-MOD
     ...
     (6 2 (:REWRITE COMMUTATIVITY-OF-+))
     (3 1 (:REWRITE <-0-MINUS)))
(LEAST-NUMERATOR-DENOMINATOR-<= (45 45 (:REWRITE DEFAULT-<-2))
                                (45 45 (:REWRITE DEFAULT-<-1))
                                (20 2 (:REWRITE NONNEG-INT-MOD-MINUS-0))
                                ...
                                (2 2 (:REWRITE DEFAULT-+-2))
                                (2 2 (:REWRITE DEFAULT-+-1)))
(UNIQUE-RATIONALP (43 2 (:DEFINITION NONNEG-INT-GCD))
