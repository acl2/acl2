(INTP-+)
(INTP-*)
(META-INTEGERP-UNHIDE (1 1
                         (:TYPE-PRESCRIPTION META-INTEGERP-UNHIDE)))
(META-INTEGERP-UNHIDE-HIDE (3 3
                              (:TYPE-PRESCRIPTION META-INTEGERP-UNHIDE)))
...
(NINTP-3)
(NINTP-4)
(LEAVES (1634 763 (:REWRITE DEFAULT-+-2))
...
(META-INTEGERP)
(META-RATIONALP)
(NIQ-BOUNDS (91 77 (:REWRITE DEFAULT-<-2))
...
(BAG-TERMS (3334 34 (:DEFINITION BINARY-LOGAND))
...
(META-RATIONALP (7972 380
                ...
                (90 90 (:REWRITE DEFAULT-COERCE-1)))
(TREE-2)
(TREES (1240 824 (:REWRITE DEFAULT-CAR))
       ...
       (4 4 (:REWRITE FOLD-CONSTS-IN-*)))
(BIG-TREE-2)
(BIG-TREE-BIG-TREE-2 (5858 3726 (:REWRITE DEFAULT-CAR))
                     ...
                     (4 4 (:REWRITE FOLD-CONSTS-IN-*)))
(TREE-2-LEAVES (418 240 (:REWRITE INTP-EVA-CONSTRAINT-18))
...
(ACL2-NUMBERP-TREE-2 (429 234 (:REWRITE DEFAULT-CAR))
                     ...
                     (1 1 (:REWRITE DEFAULT-*-2)))
(SUBTRACT-LEAF-GOOD-+ (635 379 (:REWRITE DEFAULT-CAR))
...
(SUBTRACT-LEAF-GOOD-* (1537 872 (:REWRITE DEFAULT-CAR))
...
(SUBTRACT-BAG-GOOD-+ (1421 809 (:REWRITE DEFAULT-CAR))
...
(SUBTRACT-BAG-GOOD-* (3935 2304 (:REWRITE DEFAULT-CAR))
...
(BIG-TREE-TERM (50 34 (:REWRITE DEFAULT-CAR))
               ...
               (3 2 (:REWRITE DEFAULT-*-2))
               (3 2 (:REWRITE DEFAULT-*-1)))
(META-INTEGERP-CORRECT (2330 1858 (:REWRITE DEFAULT-CAR))
...
(META-RATIONALP-CORRECT (2322 1850 (:REWRITE DEFAULT-CAR))
                        (1903 1702 (:REWRITE DEFAULT-CDR))
