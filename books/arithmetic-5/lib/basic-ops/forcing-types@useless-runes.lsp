...
(DEFAULT-PLUS-2 (10 10
                    (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                (2 2 (:REWRITE DEFAULT-+-1)))
(DEFAULT-MINUS (3 2 (:REWRITE DEFAULT-UNARY-MINUS))
               (2 2
                  (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(DEFAULT-TIMES-1 (4 4
                    (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(DEFAULT-TIMES-2 (6 6
                 ...
                 (2 2 (:REWRITE DEFAULT-*-1)))
(DEFAULT-DIVIDE (5 2 (:REWRITE DEFAULT-UNARY-/))
                (3 3
                   (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                (2 1 (:DEFINITION NOT)))
(DEFAULT-RATIONAL-DENOMINATOR (2 2 (:REWRITE DEFAULT-DENOMINATOR)))
(DEFAULT-RATIONAL-NUMERATOR (2 2 (:REWRITE DEFAULT-NUMERATOR)))
(DEFAULT-LESS-THAN-1 (10 6 (:REWRITE DEFAULT-<-2))
                     (7 7
                        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(DEFAULT-LESS-THAN-2 (11 11
                         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
