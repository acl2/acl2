...
(TEMP-1 (140 130 (:REWRITE DEFAULT-CDR))
...
(ADDEND-INFO-LIST-THM
     ...
     (1 1 (:TYPE-PRESCRIPTION QUOTEP)))
(ASSOC-ADDEND (9 9 (:REWRITE DEFAULT-CDR))
...
(SIMPLIFY-SUMS-EQUAL (3 3
                     ...
                     (2 2 (:REWRITE DEFAULT-+-1)))
(SIMPLIFY-SUMS-< (6 4 (:REWRITE DEFAULT-+-2))
                 (4 4
                    (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(PREFER-POSITIVE-ADDENDS-EQUAL (3 3
                               ...
                               (3 2 (:REWRITE DEFAULT-+-2))
                               (2 2 (:REWRITE DEFAULT-+-1)))
(PREFER-POSITIVE-ADDENDS-< (6 4 (:REWRITE DEFAULT-+-2))
                           (4 4
                              (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                           (4 4 (:REWRITE DEFAULT-+-1))
                           (3 3 (:REWRITE DEFAULT-<-2))
...
(FIND-DIVISIVE-FACTOR-SCATTER-EXPONENTS1
     (11312 5
            (:DEFINITION FIND-DIVISIVE-FACTOR-SCATTER-EXPONENTS2))
     ...
     (552 65
          (:DEFINITION STABLE-UNDER-REWRITING-PRODUCTS))
...
(FIND-RATIONAL-DIVISIVE-FACTOR-SCATTER-EXPONENTS1
     (13172 5
            (:DEFINITION FIND-RATIONAL-DIVISIVE-FACTOR-SCATTER-EXPONENTS2))
     ...
     (196 28 (:DEFINITION INTEGER-ABS))
     (195 65
          (:DEFINITION PROVEABLY-REAL/RATIONAL))
     (152 114 (:REWRITE DEFAULT-+-1))
     (112 28 (:REWRITE |(+ y x)|))
     (112 14 (:DEFINITION LENGTH))
     (70 59 (:REWRITE DEFAULT-<-2))
