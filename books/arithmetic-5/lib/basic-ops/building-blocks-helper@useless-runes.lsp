...
(REAL/RATIONALP-GUARD-FN (99 46 (:REWRITE DEFAULT-+-2))
                         ...
                         (4 4 (:REWRITE DEFAULT-COERCE-2))
                         (4 4 (:REWRITE DEFAULT-COERCE-1)))
(NIQ-BOUNDS (67 57 (:REWRITE DEFAULT-<-2))
...
(REWRITE-FLOOR-X*Y-Z-LEFT (64 4 (:LINEAR FLOOR-BOUNDS-3))
...
(POWER-OF-2-MEASURE)
(POWER-OF-2-HELPER (71 71 (:REWRITE DEFAULT-*-2))
