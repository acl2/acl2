(RATIONALP-GUARD-FN (99 46 (:REWRITE DEFAULT-+-2))
...
(REAL/RATIONALP-GUARD-FN (99 46 (:REWRITE DEFAULT-+-2))
                         (65 46 (:REWRITE DEFAULT-+-1))
                         (32 8 (:REWRITE COMMUTATIVITY-OF-+))
                         (32 8 (:DEFINITION INTEGER-ABS))
                         (32 4 (:DEFINITION LENGTH))
                         ...
                         (4 4 (:REWRITE DEFAULT-COERCE-2))
                         (4 4 (:REWRITE DEFAULT-COERCE-1)))
(NIQ-BOUNDS (69 59 (:REWRITE DEFAULT-<-2))
...
(INTEGERP-<-CONSTANT (12 12 (:REWRITE DEFAULT-*-2))
...
(CONSTANT-<-INTEGERP (12 12 (:REWRITE DEFAULT-*-2))
                     (12 12 (:REWRITE DEFAULT-*-1))
