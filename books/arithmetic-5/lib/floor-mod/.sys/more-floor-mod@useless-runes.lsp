(|(* 2 (floor x y))|
 ...
 (6464 6464 (:REWRITE NORMALIZE-FACTORS-SCATTER-EXPONENTS))
 ...
 (4005 4005 (:TYPE-PRESCRIPTION FLOOR-ZERO . 3))
 (4005 4005 (:TYPE-PRESCRIPTION FLOOR-POSITIVE . 3))
 (4005 4005 (:TYPE-PRESCRIPTION FLOOR-POSITIVE . 2))
 (4005 4005 (:TYPE-PRESCRIPTION FLOOR-POSITIVE . 1))
 (4005 4005 (:TYPE-PRESCRIPTION FLOOR-NEGATIVE . 3))
 (4005 4005 (:TYPE-PRESCRIPTION FLOOR-NEGATIVE . 2))
 (4005 4005 (:TYPE-PRESCRIPTION FLOOR-NEGATIVE . 1))
 (3987 3987 (:TYPE-PRESCRIPTION FLOOR-ZERO . 1))
 (3983 3983 (:TYPE-PRESCRIPTION FLOOR-NONPOSITIVE . 3))
 (3983 3983 (:TYPE-PRESCRIPTION FLOOR-NONPOSITIVE . 2))
 (3983 3983 (:TYPE-PRESCRIPTION FLOOR-NONPOSITIVE . 1))
 (3983 3983 (:TYPE-PRESCRIPTION FLOOR-NONNEGATIVE . 3))
 (3983 3983 (:TYPE-PRESCRIPTION FLOOR-NONNEGATIVE . 2))
 (3983 3983 (:TYPE-PRESCRIPTION FLOOR-NONNEGATIVE . 1))
 (3703 3467 (:REWRITE DEFAULT-PLUS-1))
 (3576 356 (:REWRITE PREFER-POSITIVE-EXPONENTS-SCATTER-EXPONENTS-EQUAL))
 (3515 202 (:REWRITE DEFAULT-FLOOR-RATIO))
 (3479 452 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-EQUAL))
 (3285 3285 (:REWRITE NORMALIZE-TERMS-SUCH-AS-1/AX+BX))
 (3281 921 (:REWRITE RATIONALP-X))
 (2742 2742 (:REWRITE |(* c (* d x))|))
 (2268 1092 (:REWRITE PREFER-POSITIVE-EXPONENTS-SCATTER-EXPONENTS-<))
 (2046 1661 (:REWRITE REDUCE-RATIONAL-MULTIPLICATIVE-CONSTANT-<))
 (2046 1661 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-<))
 ...
 (1653 1653 (:REWRITE |(< c (/ x)) positive c --- present in goal|))
 (1653 1653 (:REWRITE |(< c (/ x)) positive c --- obj t or nil|))
 (1653 1653 (:REWRITE |(< c (/ x)) negative c --- present in goal|))
 (1653 1653 (:REWRITE |(< c (/ x)) negative c --- obj t or nil|))
 (1653 1653 (:REWRITE |(< c (- x))|))
 (1653 1653 (:REWRITE |(< (/ x) c) positive c --- present in goal|))
 (1653 1653 (:REWRITE |(< (/ x) c) positive c --- obj t or nil|))
 (1653 1653 (:REWRITE |(< (/ x) c) negative c --- present in goal|))
 (1653 1653 (:REWRITE |(< (/ x) c) negative c --- obj t or nil|))
 (1653 1653 (:REWRITE |(< (/ x) (/ y))|))
 (1653 1653 (:REWRITE |(< (- x) c)|))
 (1653 1653 (:REWRITE |(< (- x) (- y))|))
 (1630 1630 (:REWRITE NORMALIZE-FACTORS-GATHER-EXPONENTS))
 (1513 1513 (:REWRITE PREFER-POSITIVE-ADDENDS-<))
 (1488 138 (:DEFINITION RFIX))
 (1436 1436 (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
 (1376 64 (:LINEAR LINEAR-FLOOR-BOUNDS-2))
 (1313 149 (:REWRITE FLOOR-CANCEL-*-REWRITING-GOAL-LITERAL))
 (1313 149 (:REWRITE FLOOR-CANCEL-*-CONST))
 (1313 149 (:REWRITE |(floor x (* y (/ z))) rewriting-goal-literal|))
 (1313 149 (:REWRITE |(floor (* x (/ y)) z) rewriting-goal-literal|))
 (1307 406 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
 (1269 141 (:REWRITE RATIONALP-/))
 (1174 1092 (:REWRITE SIMPLIFY-PRODUCTS-SCATTER-EXPONENTS-<))
 (940 328 (:REWRITE SIMPLIFY-PRODUCTS-SCATTER-EXPONENTS-EQUAL))
 ...
 (742 742 (:REWRITE |(< (/ x) 0)|))
 (705 705 (:REWRITE |(< 0 (/ x))|))
 (703 703 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-REMAINDER))
 (703 703 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-COMMON))
 (654 78 (:REWRITE ACL2-NUMBERP-X))
 (652 652 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-<-0-RATIONAL-REMAINDER))
 (652 652 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-<-0-RATIONAL-COMMON))
 ...
 (367 78 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
 (344 344 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-=-0))
 (296 274 (:REWRITE |(< (* x y) 0) rationalp (* x y)|))
 ...
 (181 159 (:REWRITE |(< 0 (* x y)) rationalp (* x y)|))
 (156 156 (:REWRITE ARITH-NORMALIZE-FACTORS-SCATTER-EXPONENTS))
 (154 154 (:REWRITE |(< (+ c/d x) y)|))
 (149 149 (:REWRITE FLOOR-CANCEL-*-NOT-REWRITING-GOAL-LITERAL))
 (149 149 (:REWRITE |(floor x (- y))| . 2))
 (149 149 (:REWRITE |(floor x (- y))| . 1))
 (149 149 (:REWRITE |(floor x (* y (/ z))) not rewriting-goal-literal|))
 (149 149 (:REWRITE |(floor (- x) y)| . 2))
 (149 149 (:REWRITE |(floor (- x) y)| . 1))
 (149 149 (:REWRITE |(floor (* x (/ y)) z) not rewriting-goal-literal|))
