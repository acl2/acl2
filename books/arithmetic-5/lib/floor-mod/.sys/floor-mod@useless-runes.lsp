...
(|(mod (mod x y) z)|
 (1505 1505 (:TYPE-PRESCRIPTION FLOOR-NONPOSITIVE . 2))
...
(|(equal (mod (+ x y) z) x)|
 ...
 (350 314 (:TYPE-PRESCRIPTION NOT-INTEGERP-2A))
 ...
 (123 79 (:REWRITE INTEGERP-MINUS-X))
...
(FLOOR-+-CANCEL-0-FN-1
 ...
 (80 74 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
 (80 74 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
...
(FIND-CANCELLING-ADDENDS
 ...
 (163 141 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
 (163 141 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
 (154 141 (:REWRITE SIMPLIFY-SUMS-EQUAL))
...
(SIMPLIFY-MOD-+-MOD-FN
 ...
 (1767 1444 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
 (1767 1444 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
 (1633 1444 (:REWRITE SIMPLIFY-SUMS-EQUAL))
...
(SIMPLIFY-MOD-+-MINUS-MOD-FN
 ...
 (4008 3196 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
 (4002 3196 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
 (3685 3196 (:REWRITE SIMPLIFY-SUMS-EQUAL))
 (3196 3196 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-EQUAL))
 (3196 3196 (:REWRITE EQUAL-OF-PREDICATES-REWRITE))
 (3196 3196 (:REWRITE |(equal c (/ x))|))
 (3196 3196 (:REWRITE |(equal c (- x))|))
 (3196 3196 (:REWRITE |(equal (/ x) c)|))
 (3196 3196 (:REWRITE |(equal (/ x) (/ y))|))
 (3196 3196 (:REWRITE |(equal (- x) c)|))
 (3196 3196 (:REWRITE |(equal (- x) (- y))|))
 ...
 (816 272 (:DEFINITION SYMBOL-LISTP))
 (544 272 (:DEFINITION TRUE-LISTP))
 (121 121 (:REWRITE |(equal x (if a b c))|))
 (121 121 (:REWRITE |(equal (if a b c) x)|))
...
(|(mod (+ x (- (mod a b))) y)|
 ...
 (1256 1111 (:REWRITE PREFER-POSITIVE-ADDENDS-<))
 (1117 1117 (:REWRITE REDUCE-RATIONAL-MULTIPLICATIVE-CONSTANT-<))
 (1117 1117 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-<))
 (1115 1115 (:REWRITE REMOVE-STRICT-INEQUALITIES))
 (1115 1115 (:REWRITE INTEGERP-<-CONSTANT))
 (1115 1115 (:REWRITE CONSTANT-<-INTEGERP))
 (1115 1115 (:REWRITE |(< c (/ x)) positive c --- present in goal|))
 (1115 1115 (:REWRITE |(< c (/ x)) positive c --- obj t or nil|))
 (1115 1115 (:REWRITE |(< c (/ x)) negative c --- present in goal|))
 (1115 1115 (:REWRITE |(< c (/ x)) negative c --- obj t or nil|))
 (1115 1115 (:REWRITE |(< c (- x))|))
 (1115 1115 (:REWRITE |(< (/ x) c) positive c --- present in goal|))
 (1115 1115 (:REWRITE |(< (/ x) c) positive c --- obj t or nil|))
 (1115 1115 (:REWRITE |(< (/ x) c) negative c --- present in goal|))
 (1115 1115 (:REWRITE |(< (/ x) c) negative c --- obj t or nil|))
 (1115 1115 (:REWRITE |(< (/ x) (/ y))|))
 (1115 1115 (:REWRITE |(< (- x) c)|))
 (1115 1115 (:REWRITE |(< (- x) (- y))|))
 ...
 (429 429 (:REWRITE |(< (/ x) 0)|))
 (426 426 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-<-0-RATIONAL-REMAINDER))
 (426 426 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-<-0-RATIONAL-COMMON))
 (360 360 (:REWRITE |(< 0 (/ x))|))
