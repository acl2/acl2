...
(RTL::ADJOIN-EQUAL)
(RTL::REMOVE-ONE)
(RTL::REMOVE-ONE-PRESERVES-TRUE-LISTP (10 10 (:REWRITE DEFAULT-CDR))
...
(RTL::GET-FACTORS-OF-PRODUCT-TRUE-LISTP (19 3 (:DEFINITION MEMBER-EQUAL))
                                        (18 13 (:REWRITE DEFAULT-CDR))
                                        (16 14 (:REWRITE DEFAULT-CAR))
                                        (15 3 (:DEFINITION TRUE-LISTP)))
(RTL::FIND-INVERTED-FACTORS-IN-LIST)
(RTL::REMOVE-CANCELLING-FACTOR-PAIRS-HELPER (24 8 (:DEFINITION MEMBER-EQUAL))
