(RTL::EVEN-INT-IMPLIES-INT (5 5 (:REWRITE DEFAULT-*-2))
...
(RTL::HACK-INT)
(RTL::INTEGERP-SUM-OF-ODDS-OVER-2 (58 57 (:REWRITE DEFAULT-*-1))
...
(RTL::EVEN-AND-ODD-ALTERNATE-ERIC-2-BK
     (5 5
        (:TYPE-PRESCRIPTION RTL::INTEGERP-PROD)))
(RTL::EVEN-ODD-5 (13 2 (:REWRITE RTL::EVEN-INT-IMPLIES-INT))
...
(RTL::EVEN-AND-ODD-ALTERNATE-ERIC-2
 (95 95
     (:TYPE-PRESCRIPTION RTL::INTEGERP-PROD))
 (52 5
     (:REWRITE RTL::EVEN-AND-ODD-ALTERNATE-ERIC-2-BK))
 (41 5
