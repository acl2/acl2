...
(RTL::IS-A-FACTOR (277 133 (:REWRITE DEFAULT-+-2))
                  (179 22 (:DEFINITION LENGTH))
                  (176 133 (:REWRITE DEFAULT-+-1))
...
(RTL::FACTOR-SYNTAXP (150 72 (:REWRITE DEFAULT-+-2))
...
(RTL::PRODUCT-SYNTAXP (293 141 (:REWRITE DEFAULT-+-2))
...
(RTL::SUM-OF-PRODUCTS-SYNTAXP
     ...
     (13 13 (:REWRITE DEFAULT-DENOMINATOR))
     (10 10
         (:TYPE-PRESCRIPTION RTL::FACTOR-SYNTAXP)))
