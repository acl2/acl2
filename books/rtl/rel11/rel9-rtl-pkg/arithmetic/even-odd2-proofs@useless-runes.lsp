...
(RTL::EVEN-AUX-REDUCE-3 (2 2 (:REWRITE DEFAULT-+-2))
                        (2 2 (:REWRITE DEFAULT-+-1))
                        (1 1 (:REWRITE ZP-OPEN)))
...
(RTL::EVEN-MINUS-EVEN-POS-AUX
 (145 27
      (:REWRITE RTL::EVEN-PLUS-EVEN-POS-AUX))
...
(RTL::EVEN-SUM-REWRITE-1 (13 12 (:REWRITE DEFAULT-+-2))
...
(RTL::ODD-PLUS-EVEN (3 3 (:REWRITE DEFAULT-+-2))
                    (3 3 (:REWRITE DEFAULT-+-1))
                    (2 2
                       (:TYPE-PRESCRIPTION RTL::NONNEG-+-TYPE))
                    (1 1 (:REWRITE RTL::INTEGERP-MINUS)))
...
(RTL::EVEN-REDUCE
 ...
 (2 2 (:META CANCEL_TIMES-EQUAL-CORRECT))
 (2 2 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(RTL::ODD-REDUCE (9 2 (:REWRITE RTL::ODD-PLUS-EVEN))
                 ...
                 (1 1 (:REWRITE DEFAULT-+-2))
                 (1 1 (:REWRITE DEFAULT-+-1)))
(RTL::ODD-PLUS-ODD (41 31 (:REWRITE DEFAULT-+-2))
...
(RTL::ODD-DOUBLE (2 2 (:REWRITE DEFAULT-*-2))
                 (2 2 (:REWRITE DEFAULT-*-1))
                 (1 1 (:REWRITE RTL::INTEGERP-MINUS)))
(RTL::EVEN-SUM-REWRITE-2
 ...
 (2 2 (:META CANCEL_TIMES-EQUAL-CORRECT))
 (2 2 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(RTL::EVEN-MEANS-HALF-IS-INTEGER (25 25
                                     (:TYPE-PRESCRIPTION RTL::INTEGERP-PROD))
                                 (2 2 (:REWRITE DEFAULT-*-2))
                                 (2 2 (:REWRITE DEFAULT-*-1)))
