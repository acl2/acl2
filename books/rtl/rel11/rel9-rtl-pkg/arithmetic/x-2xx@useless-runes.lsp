(RTL::LEMMA-1 (39 7 (:LINEAR X*Y>1-POSITIVE))
...
(RTL::LEMMA-2 (13 1 (:LINEAR NONNEG-INT-MOD-<-DIVISOR))
...
(RTL::LEMMA-5 (4 4 (:REWRITE INTEGERP==>DENOMINATOR=1))
              (4 4 (:REWRITE DEFAULT-DENOMINATOR))
              ...
              (1 1 (:REWRITE DEFAULT-<-1))
              (1 1 (:META CANCEL_PLUS-LESSP-CORRECT)))
(RTL::LEMMA-6 (45 3 (:LINEAR X*Y>1-POSITIVE))
...
(RTL::LEMMA-7 (32 15 (:REWRITE DEFAULT-*-2))
              (30 10
                  (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(RTL::X-2XX (3 2 (:REWRITE DEFAULT-*-2))
