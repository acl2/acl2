...
(RTL::FP-2 (19 7 (:REWRITE RTL::BVECP-EXACTP))
...
(RTL::FP--LEMMA-2-2
     ...
     (15 5 (:REWRITE RTL::BVECP-EXACTP))
     (10 10 (:TYPE-PRESCRIPTION RTL::BVECP)))
(RTL::FP--LEMMA-2 (18 18
                      (:TYPE-PRESCRIPTION RTL::EXPT-2-POSITIVE-INTEGER-TYPE))
                  (18 18 (:TYPE-PRESCRIPTION RTL::A14 . 1))
                  (17 17
                      (:TYPE-PRESCRIPTION RTL::FP--NON-NEGATIVE)))
(RTL::FP-+)
(RTL::EXPO-PROD-1
...
(RTL::EXPO-PROD-3-1 (30 10 (:REWRITE RTL::ALREADY-SIG))
