(RCDP (3 3 (:REWRITE DEFAULT-CAR))
      (2 2 (:REWRITE DEFAULT-CDR)))
(RCDP-IMPLIES-ALISTP (57 15 (:REWRITE <<-TRICHOTOMY))
                     (51 9 (:REWRITE <<-ASYMMETRIC))
                     (27 27 (:REWRITE DEFAULT-CAR))
                     (15 15 (:REWRITE <<-TRANSITIVE))
                     (13 13 (:REWRITE DEFAULT-CDR)))
(IFRP (46 24 (:REWRITE DEFAULT-+-2))
...
(AG-AUX (58 28 (:REWRITE DEFAULT-+-2))
...
(ACONS-IF)
(AS-AUX (58 28 (:REWRITE DEFAULT-+-2))
        (39 28 (:REWRITE DEFAULT-+-1))
        (24 6 (:REWRITE COMMUTATIVITY-OF-+))
        (24 6 (:DEFINITION INTEGER-ABS))
        (24 3 (:DEFINITION LENGTH))
        ...
        (3 3 (:REWRITE DEFAULT-COERCE-2))
        (3 3 (:REWRITE DEFAULT-COERCE-1)))
(AS-AUX-IS-BOUNDED (132 132 (:REWRITE DEFAULT-CAR))
                   (38 38 (:REWRITE DEFAULT-CDR)))
(AS-AUX-PRESERVES-RCDP (265 265 (:REWRITE DEFAULT-CAR))
                       (245 205 (:REWRITE <<-TRANSITIVE))
                       (145 145 (:REWRITE DEFAULT-CDR)))
(AS (494 88 (:REWRITE <<-ASYMMETRIC))
...
(AG-AUX-SAME-AS-AUX (296 221 (:REWRITE <<-TRANSITIVE))
                    (262 262 (:REWRITE DEFAULT-CAR))
                    (97 97 (:REWRITE DEFAULT-CDR))
                    (21 9 (:REWRITE AS-AUX-IS-BOUNDED)))
(AG-AUX-DIFF-AS-AUX (867 849 (:REWRITE DEFAULT-CAR))
                    (297 289 (:REWRITE DEFAULT-CDR))
                    (47 12 (:REWRITE AS-AUX-IS-BOUNDED)))
(AS-AUX-SAME-AG-AUX (133 133 (:REWRITE DEFAULT-CAR))
                    (122 94 (:REWRITE <<-TRANSITIVE))
                    (40 40 (:REWRITE DEFAULT-CDR)))
(AS-AUX-SAME-AS-AUX (458 337 (:REWRITE <<-TRANSITIVE))
                    (412 412 (:REWRITE DEFAULT-CAR))
                    (156 156 (:REWRITE DEFAULT-CDR))
                    (21 9 (:REWRITE AS-AUX-IS-BOUNDED)))
(AS-AUX-DIFF-AS-AUX (1828 1802 (:REWRITE DEFAULT-CAR))
                    (570 558 (:REWRITE DEFAULT-CDR)))
(AS-AUX-NON-NIL-CANNOT-BE-NIL (93 93 (:REWRITE DEFAULT-CAR))
                              (87 73 (:REWRITE <<-TRANSITIVE))
                              (29 29 (:REWRITE DEFAULT-CDR)))
(AG-AUX-IS-NIL-FOR-<< (45 14 (:REWRITE <<-TRICHOTOMY))
...
(RCD->ACL2-OF-RECORD-NON-NIL (76 20 (:REWRITE <<-TRICHOTOMY))
                             (68 12 (:REWRITE <<-ASYMMETRIC))
                             (44 44 (:TYPE-PRESCRIPTION <<))
                             (34 34 (:REWRITE DEFAULT-CAR))
                             (20 20 (:REWRITE DEFAULT-CDR))
                             (20 20 (:REWRITE <<-TRANSITIVE)))
(AG-SAME-AS (88 2 (:DEFINITION AS-AUX))
...
(AG-DIFF-AS (158 5 (:REWRITE AG-AUX-IS-NIL-FOR-<<))
            ...
            (1 1
               (:REWRITE AS-AUX-NON-NIL-CANNOT-BE-NIL)))
(AG-OF-AS-REDUX (383 10 (:REWRITE AG-AUX-IS-NIL-FOR-<<))
                ...
                (3 3
                   (:REWRITE AS-AUX-NON-NIL-CANNOT-BE-NIL)))
(AS-SAME-AG (68 1 (:DEFINITION AG-AUX))
...
(AS-SAME-AS (123 3 (:DEFINITION AS-AUX))
            ...
            (6 6 (:REWRITE DEFAULT-CDR)))
(AS-DIFF-AS (233 5 (:DEFINITION AS-AUX))
            ...
            (10 10 (:REWRITE DEFAULT-CDR))
            (6 6 (:TYPE-PRESCRIPTION ACL2->RCD)))
(AG-OF-NIL-IS-DEFAULT (13 1 (:REWRITE AG-AUX-IS-NIL-FOR-<<))
                      (8 2 (:REWRITE <<-TRICHOTOMY))
                      (2 2 (:REWRITE <<-TRANSITIVE))
                      (2 1 (:REWRITE <<-ASYMMETRIC))
                      (1 1 (:TYPE-PRESCRIPTION RCDP)))
(AS-NON-DEFAULT-CANNOT-BE-NIL (82 2 (:DEFINITION AS-AUX))
                              ...
                              (4 4 (:REWRITE DEFAULT-CDR)))
(NON-NIL-IF-AG-NOT-DEFAULT (13 1 (:REWRITE AG-AUX-IS-NIL-FOR-<<))
                           (8 2 (:REWRITE <<-TRICHOTOMY))
                           (2 2 (:REWRITE <<-TRANSITIVE))
                           (2 1 (:REWRITE <<-ASYMMETRIC))
                           (1 1 (:TYPE-PRESCRIPTION RCDP)))
(BVECP)
(BV-ARRP (3 3 (:REWRITE DEFAULT-CAR))
         (2 2 (:REWRITE DEFAULT-CDR)))
(BVECP-OF-DEFAULT-GET-VALU-IS-TRUE (20 12 (:REWRITE DEFAULT-<-2))
...
(BV-ARRP-IMPLIES-RCDP (102 29 (:REWRITE <<-TRICHOTOMY))
                      (91 17 (:REWRITE <<-ASYMMETRIC))
                      (56 56 (:REWRITE DEFAULT-CAR))
                      (36 36 (:REWRITE DEFAULT-CDR))
                      (32 28 (:REWRITE <<-TRANSITIVE))
                      (1 1 (:REWRITE <<-IRREFLEXIVE)))
(AS-AUX-MAPS-BV-RCD-TO-BV-RCD (332 332 (:REWRITE DEFAULT-CAR))
                              (268 228 (:REWRITE <<-TRANSITIVE))
                              (210 210 (:REWRITE DEFAULT-CDR))
                              (30 1 (:DEFINITION RCDP)))
(AG-AUX-MAPS-BV-RCD-TO-BVECP (140 140 (:REWRITE DEFAULT-CAR))
                             (104 87 (:REWRITE <<-TRANSITIVE))
                             (65 65 (:REWRITE DEFAULT-CDR)))
(BV-ARRP-IMPLIES-NOT-IFRP (119 119 (:REWRITE DEFAULT-CAR))
                          (89 89 (:REWRITE DEFAULT-CDR))
                          (83 24 (:REWRITE <<-TRICHOTOMY))
                          (74 14 (:REWRITE <<-ASYMMETRIC))
                          (27 23 (:REWRITE <<-TRANSITIVE))
                          (2 2 (:TYPE-PRESCRIPTION RCDP))
                          (1 1 (:REWRITE <<-IRREFLEXIVE)))
(BV-ARRP-ACL2->RCD-TRANSFERS (38 10 (:REWRITE <<-TRICHOTOMY))
                             (34 6 (:REWRITE <<-ASYMMETRIC))
                             (22 22 (:TYPE-PRESCRIPTION <<))
                             (14 14 (:REWRITE DEFAULT-CAR))
                             (10 10 (:REWRITE DEFAULT-CDR))
                             (10 10 (:REWRITE <<-TRANSITIVE)))
(BV-ARRP-RCD->ACL2-TRANSFERS (38 10 (:REWRITE <<-TRICHOTOMY))
                             (34 6 (:REWRITE <<-ASYMMETRIC))
                             (22 22 (:TYPE-PRESCRIPTION <<))
                             (14 14 (:REWRITE DEFAULT-CAR))
                             (10 10 (:REWRITE DEFAULT-CDR))
                             (10 10 (:REWRITE <<-TRANSITIVE)))
(AS-MAPS-BV-ARR-TO-BV-ARR (41 1 (:DEFINITION AS-AUX))
...
(AG-MAPS-BV-ARR-TO-BVECP (70 1 (:DEFINITION AG-AUX))
...
(MK-BVARR)
(MK-BVARR-IS-BV-ARRP (57 15 (:REWRITE <<-TRICHOTOMY))
                     (51 9 (:REWRITE <<-ASYMMETRIC))
                     (33 33 (:TYPE-PRESCRIPTION <<))
...
(MK-BVARR-IDENTITY (38 10 (:REWRITE <<-TRICHOTOMY))
                   (34 6 (:REWRITE <<-ASYMMETRIC))
                   (22 22 (:TYPE-PRESCRIPTION <<))
