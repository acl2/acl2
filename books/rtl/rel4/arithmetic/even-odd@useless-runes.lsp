(EVEN-INT-IMPLIES-INT (5 5 (:REWRITE DEFAULT-*-2))
...
(HACK-INT)
(INTEGERP-SUM-OF-ODDS-OVER-2 (58 57 (:REWRITE DEFAULT-*-1))
...
(EVEN-AND-ODD-ALTERNATE-3
 ...
 (1
   1
   (:REWRITE EQUAL-MULTIPLY-THROUGH-BY-INVERTED-FACTOR-FROM-LEFT-HAND-SIDE)))
(EVEN-AND-ODD-ALTERNATE-ERIC-2-BK (5 5 (:TYPE-PRESCRIPTION INTEGERP-PROD)))
(EVEN-ODD-5 (13 2 (:REWRITE EVEN-INT-IMPLIES-INT))
...
(EVEN-AND-ODD-ALTERNATE-ERIC-2
 ...
 (52 5
     (:REWRITE EVEN-AND-ODD-ALTERNATE-ERIC-2-BK))
 (41 5
