...
(EVEN-AUX-REDUCE-3 (2 2 (:REWRITE DEFAULT-+-2))
                   (2 2 (:REWRITE DEFAULT-+-1))
                   (1 1 (:REWRITE ZP-OPEN)))
...
(EVEN-SUM-REWRITE-1 (13 12 (:REWRITE DEFAULT-+-2))
...
(ODD)
(ODD-MEANS-INTEGERP)
(ODD-PLUS-EVEN (3 3 (:REWRITE DEFAULT-+-2))
               (3 3 (:REWRITE DEFAULT-+-1))
...
(EVEN-REDUCE
 ...
 (2 2 (:META CANCEL_TIMES-EQUAL-CORRECT))
 (2 2 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(ODD-REDUCE (9 2 (:REWRITE ODD-PLUS-EVEN))
            (5 2 (:REWRITE ODD-SUM-REWRITE-1))
            (1 1 (:TYPE-PRESCRIPTION NONNEG-+-TYPE))
            (1 1 (:REWRITE INTEGERP-MINUS))
            (1 1 (:REWRITE DEFAULT-+-2))
            (1 1 (:REWRITE DEFAULT-+-1)))
(ODD-PLUS-ODD (41 31 (:REWRITE DEFAULT-+-2))
...
(ODD-SUM-REWRITE-2
 ...
 (1 1
    (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(INDUCT-SCHEME (1 1 (:TYPE-PRESCRIPTION NONNEG-+-TYPE)))
(EVEN-DOUBLE-POS
...
(ODD-DOUBLE (2 2 (:REWRITE DEFAULT-*-2))
            (2 2 (:REWRITE DEFAULT-*-1))
            (1 1 (:REWRITE INTEGERP-MINUS)))
(EVEN-SUM-REWRITE-2
 ...
 (2 2 (:META CANCEL_TIMES-EQUAL-CORRECT))
 (2 2 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(EVEN-MEANS-HALF-IS-INTEGER (25 25 (:TYPE-PRESCRIPTION INTEGERP-PROD))
                            (2 2 (:REWRITE DEFAULT-*-2))
                            (2 2 (:REWRITE DEFAULT-*-1)))
