...
(ADJOIN-EQUAL)
(REMOVE-ONE)
(REMOVE-ONE-PRESERVES-TRUE-LISTP (10 10 (:REWRITE DEFAULT-CDR))
                                 (9 9 (:REWRITE DEFAULT-CAR)))
(GET-FACTORS-OF-PRODUCT (679 82 (:DEFINITION LENGTH))
...
(GET-FACTORS-OF-PRODUCT-TRUE-LISTP (19 3 (:DEFINITION MEMBER-EQUAL))
                                   (18 13 (:REWRITE DEFAULT-CDR))
                                   (16 14 (:REWRITE DEFAULT-CAR))
                                   (15 3 (:DEFINITION TRUE-LISTP)))
(FIND-INVERTED-FACTORS-IN-LIST)
(REMOVE-CANCELLING-FACTOR-PAIRS-HELPER (24 8 (:DEFINITION MEMBER-EQUAL))
