(EQUAL-LOG=-0)
(EQUAL-LOG=-1)
(EQUAL-LNOT-0 (4 4 (:REWRITE DEFAULT-<-2))
              (4 4 (:REWRITE DEFAULT-<-1))
              (3 3 (:REWRITE DEFAULT-+-2))
              (3 3 (:REWRITE DEFAULT-+-1))
              (2 2 (:REWRITE DEFAULT-UNARY-MINUS))
              (1 1 (:REWRITE BITS-EXPT-CONSTANT)))
(EQUAL-LNOT-1 (4 4 (:REWRITE DEFAULT-<-2))
              (4 4 (:REWRITE DEFAULT-<-1))
              (3 3 (:REWRITE DEFAULT-+-2))
              (3 3 (:REWRITE DEFAULT-+-1))
              (2 2 (:REWRITE DEFAULT-UNARY-MINUS))
...
(BITS-IF)
(BITN-IF)
(BITS-IF1 (21 10 (:REWRITE DEFAULT-<-1))
          (17 6
...
(BITN-IF1 (2 2 (:REWRITE IF1-NON-0)))
(LOG=-0-REWRITE (2 2 (:REWRITE DEFAULT-<-2))
                (2 2 (:REWRITE DEFAULT-<-1))
                (2 2 (:REWRITE DEFAULT-+-2))
                (2 2 (:REWRITE DEFAULT-+-1))
                (1 1 (:REWRITE DEFAULT-UNARY-MINUS))
                (1 1 (:REWRITE BITS-EXPT-CONSTANT)))
(LOG=-1-REWRITE (2 2 (:REWRITE DEFAULT-<-2))
                (2 2 (:REWRITE DEFAULT-<-1)))
(LOG<>-IS-LNOT-LOG= (2 2 (:REWRITE DEFAULT-+-2))
                    (2 2 (:REWRITE DEFAULT-+-1))
                    (1 1 (:REWRITE DEFAULT-UNARY-MINUS)))
(BVECP-IF)
