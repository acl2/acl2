(EVEN-AUX (3 3 (:REWRITE DEFAULT-<-2))
...
(EVEN)
(ODD)
(MOD4 (10 5 (:TYPE-PRESCRIPTION NATP-MOD))
...
(MOD4-IS-1-FW-TO-NOT-EVEN (3 3 (:REWRITE DEFAULT-+-2))
                          (3 3 (:REWRITE DEFAULT-+-1))
                          (1 1 (:TYPE-PRESCRIPTION NONNEG-+-TYPE)))
(MOD4-IS-2-FW-TO-EVEN (3 3 (:REWRITE DEFAULT-+-2))
                      (3 3 (:REWRITE DEFAULT-+-1))
                      (1 1 (:TYPE-PRESCRIPTION NONNEG-+-TYPE)))
(MOD4-IS-3-FW-TO-NOT-EVEN (3 3 (:REWRITE DEFAULT-+-2))
                          (3 3 (:REWRITE DEFAULT-+-1))
                          (1 1 (:TYPE-PRESCRIPTION NONNEG-+-TYPE)))
