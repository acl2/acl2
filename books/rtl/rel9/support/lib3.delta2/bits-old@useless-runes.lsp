...
(BITS-BITS-SUM-ALT
     ...
     (2 2 (:REWRITE |(/ (/ x))|)))
(BITS-BITS-DIFF-NEW
     (156 11 (:REWRITE BITS-NEG))
     (108 12 (:REWRITE BITS-TAIL-2))
     (72 12 (:REWRITE BITS-TAIL))
...
(BITS-BITS-PROD
     ...
     (148 11
          (:REWRITE BITS-WITH-INDICES-IN-THE-WRONG-ORDER))
     (103 7 (:REWRITE BITS-TAIL-2))
     (93 3 (:DEFINITION NATP))
     (43 7 (:REWRITE BITS-TAIL))
...
(BITS-DIFF-0
 ...
 (90 3 (:REWRITE BITS-REVERSE-INDICES))
 (90 3 (:REWRITE BITS-NEG-INDICES))
 (86 41 (:REWRITE SIMPLIFY-SUMS-<))
 (68 17 (:REWRITE |(+ c (+ d x))|))
 (67 3 (:REWRITE BITS-TAIL-2))
...
(BITS-TAIL-GEN
 ...
 (2 2 (:LINEAR EXPT-<-1-TWO))
 (2 2 (:LINEAR EXPT-<-1-ONE))
 (1 1 (:REWRITE BITS-REVERSE-INDICES))
 (1 1 (:REWRITE BITS-NEG-INDICES)))
(BITS-SHIFT-UP-1-NEW)
(BITS-SHIFT-UP-2-NEW)
(BITN-MINUS-1-NEW
 (6
...
(BITN-PLUS-BITS-NEW)
(DIFF-BIT)
(DIFF-BIT-REWRITE (80 20 (:REWRITE NEG-BITN-2))
                  (80 20 (:REWRITE NEG-BITN-1))
                  (80 20 (:REWRITE NEG-BITN-0))
                  ...
                  (7 7 (:REWRITE ZP-OPEN)))
(DIFF-BIT-BOUNDS
     (142 2 (:DEFINITION SUMBITS-BADGUY))
     (20 20
         (:TYPE-PRESCRIPTION BITN-NONNEGATIVE-INTEGER))
     (16 4 (:REWRITE NEG-BITN-2))
     (16 4 (:REWRITE NEG-BITN-1))
     (16 4 (:REWRITE NEG-BITN-0))
...
(INTVAL-REWRITE
 ...
 (12 12
     (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-INTEGERP-BASE))
 (11 11 (:TYPE-PRESCRIPTION SGNDINTVAL))
 (11 11 (:TYPE-PRESCRIPTION INTVAL))
 (8 8 (:REWRITE REDUCE-RATIONALP-+))
 (8 8 (:REWRITE REDUCE-RATIONALP-*))
 (8 8 (:REWRITE RATIONALP-MINUS-X))
 (8 8 (:META META-RATIONALP-CORRECT))
 (8 2 (:REWRITE NEG-BITN-2))
 (8 2 (:REWRITE NEG-BITN-1))
 (8 2 (:REWRITE NEG-BITN-0))
 (8 2 (:REWRITE |(+ c (+ d x))|))
...
(INTVAL-BITS
 ...
 (1 1 (:LINEAR EXPT-<=-1-ONE))
 (1 1 (:LINEAR EXPT-<-1-ONE)))
(SIGN-EXTEND (3 3 (:TYPE-PRESCRIPTION INTVAL)))
(SIGN-EXTEND-REWRITE)
(INTVAL-SIGN-EXTEND
