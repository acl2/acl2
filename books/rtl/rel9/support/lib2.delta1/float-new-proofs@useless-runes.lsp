...
(ISIGF_ALT)
(ISGNF_ALT-IS-ISGNF)
(IEXPOF_ALT-IS-IEXPOF (10 6 (:REWRITE DEFAULT-+-2))
...
(NDECODE_ALT-IS-NDECODE (202 76 (:REWRITE DEFAULT-+-2))
                        ...
                        (4 4 (:REWRITE A5)))
(SGN-NDECODE_ALT (4 4 (:REWRITE DEFAULT-+-2))
                 (4 4 (:REWRITE DEFAULT-+-1))
                 ...
                 (2 2 (:REWRITE BITN-NEG))
                 (2 2 (:REWRITE A4)))
(EXPO-NDECODE_ALT (14 10 (:REWRITE DEFAULT-+-2))
                  ...
                  (2 2 (:REWRITE DEFAULT-*-1))
                  (2 2 (:REWRITE A4)))
(SIG-NDECODE_ALT (11 7 (:REWRITE DEFAULT-+-2))
                 ...
                 (3 1 (:REWRITE A4)))
(CAT_ALT-IS-CAT (32 4 (:REWRITE BITS-TAIL))
                (20 4 (:REWRITE A4))
...
(NENCODE_ALT-IS-NENCODE
     ...
     (4 4 (:REWRITE A3)))
(BVECP-NENCODE_ALT (2 2 (:REWRITE DEFAULT-<-2))
                   (2 2 (:REWRITE DEFAULT-<-1))
                   (1 1 (:REWRITE DEFAULT-+-2))
                   (1 1 (:REWRITE DEFAULT-+-1)))
(NREPP-NDECODE_ALT (2 2 (:REWRITE DEFAULT-<-2))
                   (2 2 (:REWRITE DEFAULT-<-1)))
(NENCODE_ALT-NDECODE_ALT (2 2 (:REWRITE DEFAULT-<-2))
                         (2 2 (:REWRITE DEFAULT-<-1)))
(NENCODINGP_ALT-NENCODE_ALT (2 2 (:REWRITE DEFAULT-<-2))
                            (2 2 (:REWRITE DEFAULT-<-1)))
(NDECODE_ALT-NENCODE_ALT (2 2 (:REWRITE DEFAULT-<-2))
                         (2 2 (:REWRITE DEFAULT-<-1)))
(DENCODINGP_ALT)
...
(DDECODE_ALT
     ...
     (8 8
        (:TYPE-PRESCRIPTION EXPT-POSITIVE-INTEGER-TYPE))
     (8 8 (:TYPE-PRESCRIPTION A14 . 1)))
(DDECODE_ALT-IS-DECODE (76 16 (:REWRITE DEFAULT-*-2))
                       ...
                       (6 2 (:REWRITE BITN-NEG))
                       (4 4 (:REWRITE A5)))
(SGN-DDECODE_ALT (4 4 (:REWRITE DEFAULT-+-2))
                 (4 4 (:REWRITE DEFAULT-+-1))
                 (4 2 (:REWRITE BVECP-BITN-0))
                 (2 2 (:REWRITE FOLD-CONSTS-IN-+))
                 (2 2 (:REWRITE DEFAULT-<-2))
                 ...
                 (2 2 (:REWRITE BITN-NEG))
                 (2 2 (:REWRITE A4)))
(EXPO-DDECODE_ALT (34 28 (:REWRITE DEFAULT-*-2))
                  ...
                  (4 2
                     (:REWRITE BITS-WITH-INDICES-IN-THE-WRONG-ORDER))
                  (4 2 (:REWRITE BITS-NEG)))
(SIG-DDECODE_ALT (10 2 (:REWRITE ALREADY-SIG))
                 (7 2 (:REWRITE BITS-TAIL))
                 (6 6
                    (:TYPE-PRESCRIPTION BITS-NONNEGATIVE-INTEGERP-TYPE))
...
(DENCODE_ALT-IS-DENCODE
     ...
     (4 4 (:REWRITE DEFAULT-<-2))
     (4 4 (:REWRITE ALREADY-SIG)))
(DREPP-DDECODE_ALT (2 2 (:REWRITE DEFAULT-<-2))
                   (2 2 (:REWRITE DEFAULT-<-1)))
(DENCODE_ALT-DDECODE_ALT (2 2 (:REWRITE DEFAULT-<-2))
                         (2 2 (:REWRITE DEFAULT-<-1)))
(DENCODINGP_ALT-DENCODE_ALT (1 1 (:REWRITE DEFAULT-<-2))
                            (1 1 (:REWRITE DEFAULT-<-1)))
(DDECODE_ALT-DENCODE_ALT (2 2 (:REWRITE DEFAULT-<-2))
                         (2 2 (:REWRITE DEFAULT-<-1)))
