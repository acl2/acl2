...
(ESIGF-IS-ESIGF_ALT)
(EENCODINGP)
(EENCODINGP-IS-EENCODINGP_ALT (14 10 (:REWRITE DEFAULT-+-2))
...
(EENCODE-IS-EENCODE_ALT
     (1499 928 (:REWRITE DEFAULT-+-2))
     (1219 928 (:REWRITE DEFAULT-+-1))
     (924 308 (:REWRITE DEFAULT-*-2))
     (545 545
          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (404 308 (:REWRITE DEFAULT-*-1))
...
(EDECODE-IS-EDECODE_ALT (156 4 (:DEFINITION EXPT))
...
(REBIAS-UP)
(ISGNF-IS-ISGNF_ALT)
(IEXPOF-IS-IEXPOF_ALT (10 6 (:REWRITE DEFAULT-+-2))
...
(NDECODE-IS-NDECODE (284 8 (:DEFINITION EXPT))
                    ...
                    (2 2 (:REWRITE NEG-BITN_ALT-1))
                    (2 2 (:REWRITE NEG-BITN_ALT-0)))
(DDECODE-IS-DECODE (128 4 (:DEFINITION EXPT))
