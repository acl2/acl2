(LNOT_ALT-IS-LNOT (16 2 (:REWRITE BITS-TAIL))
                  ...
                  (2 2 (:DEFINITION FIX)))
(EQUAL-LNOT_ALT-0 (1 1 (:REWRITE BVECP-MONOTONE)))
(EQUAL-LNOT_ALT-1 (1 1 (:REWRITE BVECP-MONOTONE)))
(BITS_ALT-IF)
(BITN_ALT-IF)
(BITS_ALT-IF1 (8 4
                 (:REWRITE BITS-WITH-INDICES-IN-THE-WRONG-ORDER))
...
(BITN_ALT-IF1 (10 4 (:REWRITE BVECP-BITN-0))
...
(LOG=-0-REWRITE_ALT (1 1 (:REWRITE BVECP-MONOTONE)))
(LOG<>-IS-LNOT_ALT-LOG=)
(CAT_ALT-COMBINE-CONSTANTS (4 4 (:REWRITE DEFAULT-+-2))
