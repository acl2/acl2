...
(TARAI-INDUCTION
 ...
 (2387 1269 (:REWRITE DEFAULT-+-2))
 (1623 1269 (:REWRITE DEFAULT-+-1))
 (1171 370 (:REWRITE DEFAULT-UNARY-MINUS))
...
(TARAI_TERMINATES_PROOF
 (1974 1974 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
 (638 380 (:REWRITE DEFAULT-<-2))
 (603 513 (:REWRITE DEFAULT-+-2))
