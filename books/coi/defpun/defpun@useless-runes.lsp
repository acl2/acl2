...
(DEFPUN-STN)
(DEFPUN-FN (4 4 (:REWRITE DEFAULT-<-2))
           (4 4 (:REWRITE DEFAULT-<-1))
           (1 1 (:REWRITE ZP-OPEN))
           (1 1 (:REWRITE DEFAULT-+-2))
           (1 1 (:REWRITE DEFAULT-+-1)))
(DEFPUN-RET-TYPE-DEFPUN-FN (6 6 (:REWRITE ZP-OPEN))
                           (2 2 (:REWRITE DEFAULT-+-2))
                           (2 2 (:REWRITE DEFAULT-+-1)))
(DEFPUN-F)
(DEFPUN-RET-TYPE-DEFPUN-F (21 3 (:DEFINITION DEFPUN-STN))
...
(TEST-FCH (4 1 (:REWRITE ZP-OPEN))
          ...
          (1 1 (:REWRITE DEFAULT-+-2))
          (1 1 (:REWRITE DEFAULT-+-1)))
(TEST-F-DEF (7 1 (:DEFINITION DEFPUN-STN))
            (2 2 (:REWRITE DEFAULT-<-2))
            (2 2 (:REWRITE DEFAULT-<-1))
            (1 1 (:REWRITE DEFAULT-+-2))
            (1 1 (:REWRITE DEFAULT-+-1)))
...
(DESTRUCTURE-DCL-BODY-KEYPAIRS
     (2 2
        (:TYPE-PRESCRIPTION DEFAULT-DEFPUN-RULE-CLASSES)))
(DEFPUN-SYNTAX-ER)
(EXTRACT-PAIR (216 101 (:REWRITE DEFAULT-+-2))
