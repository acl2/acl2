...
(OPEN_ACK_MEASURE (54 6 (:REWRITE OPEN_ACK_1_TERMINATES))
                  ...
                  (8 8
                     (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(OPEN_ACK_MEASURE!)
(OPEN_ACK_TERMINATES (76 76 (:REWRITE DEFAULT-CDR))
                     ...
                     (14 14
                         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(OPEN_ACK_TERMINATES_X (76 76 (:REWRITE DEFAULT-CDR))
                       (76 76 (:REWRITE DEFAULT-CAR))
                       (63 56 (:REWRITE DEFAULT-+-2))
                       (63 56 (:REWRITE DEFAULT-+-1))
                       (22 22 (:REWRITE ZP-OPEN))
                       (14 14
                           (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(OPEN_ACK_TERMINATES_Y (76 76 (:REWRITE DEFAULT-CDR))
                       (76 76 (:REWRITE DEFAULT-CAR))
                       (63 56 (:REWRITE DEFAULT-+-2))
                       (63 56 (:REWRITE DEFAULT-+-1))
                       (22 22 (:REWRITE ZP-OPEN))
                       (14 14
                           (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(OPEN_ACK_TERMINATES_XARGS (76 76 (:REWRITE DEFAULT-CDR))
                           (76 76 (:REWRITE DEFAULT-CAR))
                           (63 56 (:REWRITE DEFAULT-+-2))
                           (63 56 (:REWRITE DEFAULT-+-1))
                           (22 22 (:REWRITE ZP-OPEN))
