...
(GENSYM::GENSYM-LIST)
(GENSYM::LEN-GENSYM-LIST (100 60 (:REWRITE DEFAULT-CDR))
...
(GENSYM::UNIQUE-GENSYM-LIST
     ...
     (3 3
        (:TYPE-PRESCRIPTION GENSYM::GENSYM-LIST))
     (3 3 (:REWRITE DEFAULT-CAR))
...
(GENSYM::DISJOINT-GENSYM-LIST
     ...
     (76 4
         (:REWRITE GENSYM::MEMBERP-GENSYM-LIST-FORWARD-1))
...
(GENSYM::LEN-GENSYM-N (187 37 (:REWRITE LIST::LEN-WHEN-AT-MOST-1))
...
(GENSYM::DISJOINT-GENSYM-N
     ...
     (128 2
          (:DEFINITION LIST::DISJOINT-REMOVE-DEFINITION))
     (76 4
         (:REWRITE GENSYM::MEMBERP-GENSYM-N-FORWARD-1))
     (38 38 (:TYPE-PRESCRIPTION BAG::SUBBAGP))
     (36 4
         (:REWRITE BAG::SUBBAGP-IMPLIES-MEMBERSHIP))
     (36 2 (:REWRITE BAG::SUBBAGP-OF-CDR))
     ...
     (4 2
        (:REWRITE BAG::DISJOINT-CDR-FROM-DISJOINT-CHEAP)))
(GENSYM::SYMBOL-LISTP-GENSYM-N (5 4 (:REWRITE DEFAULT-CDR))
