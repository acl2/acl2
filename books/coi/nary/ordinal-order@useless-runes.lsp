(O1-TEST)
(O2-TEST)
(OCONSP (32 23 (:REWRITE DEFAULT-CDR))
...
(OCONS (10 5 (:TYPE-PRESCRIPTION O+-O-FINP))
       (5 5 (:TYPE-PRESCRIPTION O-FINP)))
(POLARITY)
(OCAR (18 3 (:REWRITE O-INFP->NEQ-0))
...
(OCDR (18 3 (:REWRITE O-INFP->NEQ-0))
      (16 16 (:REWRITE DEFAULT-CDR))
      (13 13 (:REWRITE DEFAULT-CAR))
      (12 6 (:REWRITE O-P-DEF-O-FINP-1))
      (9 3 (:REWRITE O-FIRST-EXPT-O-INFP))
      ...
      (8 8 (:META CANCEL_PLUS-EQUAL-CORRECT))
      (6 3 (:REWRITE O-FIRST-EXPT-DEF-O-FINP)))
(OCDR-OCONS (346 37 (:REWRITE O-FIRST-EXPT-<))
...
(OCAR-OCONS (346 37 (:REWRITE O-FIRST-EXPT-<))
            (333 14 (:REWRITE O+-O-FIRST-EXPT-SMASH))
            (162 81 (:TYPE-PRESCRIPTION O+-O-FINP))
            (162 62 (:REWRITE O-FIRST-EXPT-DEF-O-FINP))
            (112 37 (:REWRITE O-FIRST-COEFF-<))
            ...
            (1 1 (:META CANCEL_TIMES-EQUAL-CORRECT))
            (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(OCONSP-OCONS (3705 101 (:REWRITE O-FIRST-EXPT-<))
...
(OP-OCONS (3871 103 (:REWRITE O-FIRST-EXPT-<))
          ...
          (2 2
             (:REWRITE |a <= b & c <= d  =>  a+c <= b+d|))
          (2 2 (:REWRITE |a <= b  =>  a+c <= b+c|)))
(OCONSP-EQUAL (7697 140 (:REWRITE O-FIRST-EXPT-<))
              ...
              (4 4 (:REWRITE |~(a < a)|)))
(LEN-LEN-INDUCTION (62 31 (:REWRITE DEFAULT-+-2))
...
(ORDINAL-DOUBLE-CONTAINMENT (48 4 (:REWRITE O-FIRST-EXPT-<))
                            ...
                            (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(CHARTOO)
(OP-CHARTOO (1 1 (:REWRITE DEFAULT-CHAR-CODE)))
...
(CHARACTERP-REDUCTION (12 1 (:REWRITE DEFAULT-CODE-CHAR))
                      ...
                      (1 1 (:META CANCEL_TIMES-EQUAL-CORRECT))
                      (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(EQUAL-CHARTOO-REDUCTION (35 6 (:REWRITE DEFAULT-CODE-CHAR))
...
(CHAR-LISTOO (36 6 (:REWRITE O-P-DEF-O-FINP-1))
             (19 19 (:REWRITE DEFAULT-CAR))
             (18 18 (:REWRITE DEFAULT-CDR))
             (12 12 (:TYPE-PRESCRIPTION O-FINP)))
(OP-CHAR-LISTOO (18 3 (:REWRITE O-P-DEF-O-FINP-1))
...
(STRINGTOO)
(OP-STRINGTOO)
(EQUAL-COERCE-REDUCTION (12 12 (:REWRITE DEFAULT-COERCE-2))
...
(EQUAL-STRINGTOO-REDUCTION (6 2 (:DEFINITION CHAR-LISTOO))
...
(EQUAL-0+-1-REDUCTION (362 23 (:REWRITE O-FIRST-EXPT-O-INFP))
                      (286 2
                           (:REWRITE |limitp.b  =>  a<b   <=>  a+1 < b|))
...
(EQUAL-STRING-DOUBLE-CONTAINMENT (10 2 (:REWRITE STRING<-L-ASYMMETRIC))
...
(EQUAL-SYMBOL-DOUBLE-CONTAINMENT (17 3 (:REWRITE SYMBOL-<-ASYMMETRIC))
                                 (7 3 (:REWRITE OCONSP-EQUAL))
                                 (5 5 (:REWRITE SYMBOL-<-TRANSITIVE))
                                 (4 4 (:TYPE-PRESCRIPTION OCONSP))
                                 (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
                                 (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(EQUAL-SYMBOLTOO-REDUCTION (132 4 (:REWRITE O+-O-FIRST-EXPT-SMASH))
...
(INTOO (2 2 (:REWRITE DEFAULT-<-2))
       (2 2 (:REWRITE DEFAULT-<-1))
       (2 2 (:META CANCEL_PLUS-LESSP-CORRECT))
       (1 1 (:REWRITE DEFAULT-UNARY-MINUS)))
(EQUAL-INTOO-REDUCTION (22 10 (:REWRITE DEFAULT-CDR))
                       ...
                       (5 5 (:META CANCEL_TIMES-EQUAL-CORRECT)))
(OP-INTOO (3 3 (:REWRITE DEFAULT-<-2))
          (3 3 (:REWRITE DEFAULT-<-1))
          (3 3 (:META CANCEL_PLUS-LESSP-CORRECT))
          (2 2 (:TYPE-PRESCRIPTION OCONS))
          (2 2 (:REWRITE DEFAULT-UNARY-MINUS)))
(RATIONALTOO (1 1 (:REWRITE NUMERATOR-WHEN-INTEGERP))
             (1 1 (:REWRITE INTEGERP==>DENOMINATOR=1))
             (1 1 (:REWRITE DEFAULT-NUMERATOR))
             (1 1 (:REWRITE DEFAULT-DENOMINATOR)))
(OP-RATIONALTOO (1 1 (:REWRITE NUMERATOR-WHEN-INTEGERP))
                (1 1 (:REWRITE INTEGERP==>DENOMINATOR=1))
                (1 1 (:REWRITE DEFAULT-NUMERATOR))
                (1 1 (:REWRITE DEFAULT-DENOMINATOR)))
(EQUAL-RATIONAL-REDUCTION (18 4 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
                          ...
                          (2 2 (:REWRITE DEFAULT-*-2))
                          (2 2 (:REWRITE DEFAULT-*-1)))
(EQUAL-RATIONALTOO-REDUCTION (146 32 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
...
(COMPLEXTOO (1 1 (:REWRITE DEFAULT-REALPART))
            (1 1 (:REWRITE DEFAULT-IMAGPART)))
(OP-COMPLEXTOO (1 1 (:REWRITE DEFAULT-REALPART))
               (1 1 (:REWRITE DEFAULT-IMAGPART)))
(EQUAL-COMPLEXTOO-REDUCTION (116 4 (:REWRITE O+-O-FIRST-EXPT-SMASH))
                            (64 8 (:REWRITE O-FIRST-EXPT-<))
                            (40 40 (:TYPE-PRESCRIPTION O-FINP))
                            (24 8 (:REWRITE O-FINP-<))
                            (24 8 (:REWRITE AC-<))
...
(OP-NUMTOO (3 1 (:REWRITE O-P-DEF-O-FINP-1))
           (2 2 (:TYPE-PRESCRIPTION OCONS))
           (2 2
              (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(EQUAL-NUMTOO-REDUCTION (116 4 (:REWRITE O+-O-FIRST-EXPT-SMASH))
                        (64 8 (:REWRITE O-FIRST-EXPT-<))
                        (40 40 (:TYPE-PRESCRIPTION O-FINP))
...
(ATOMTOO)
(GOOD-ATOM)
(EQUAL-ATOMTOO-REDUCTION (182 6 (:REWRITE O+-O-FIRST-EXPT-SMASH))
                         ...
                         (5 5
                            (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(OP-ATOMTOO (5 1 (:REWRITE O-P-DEF-O-FINP-1))
            (4 4 (:TYPE-PRESCRIPTION OCONS))
            (1 1
               (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(GOOD-TERM)
(*TOO)
(OP-*TOO (8 4 (:REWRITE O-P-DEF-O-FINP-1))
         (4 4 (:TYPE-PRESCRIPTION *TOO))
         (2 2 (:REWRITE DEFAULT-CDR))
         (2 2 (:REWRITE DEFAULT-CAR)))
(*TOO)
(*TOO-INDUCTION (3526 340 (:META CANCEL_PLUS-LESSP-CORRECT))
                (2594 1249 (:REWRITE DEFAULT-+-2))
                (2378 24 (:REWRITE O<=-O-FINP-DEF))
                (1776 1249 (:REWRITE DEFAULT-+-1))
                ...
                (24 24
                    (:REWRITE |a < b & b < c  =>  a < c|)))
(EQUAL-*TOO-REDUCTION (436 16 (:REWRITE O+-O-FIRST-EXPT-SMASH))
...
(O<<)
(ORDINAL-ORDER-PROPERTY (67 7 (:REWRITE O-FIRST-EXPT-<))
