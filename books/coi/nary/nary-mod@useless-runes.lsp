...
(NARY::PUSH-MOD-*)
(NARY::PUSH-MOD-+)
(NARY::MOD-MOD (748 292 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
               (328 292
                    (:TYPE-PRESCRIPTION MOD-NEGATIVE . 2))
               (324 292
                    (:TYPE-PRESCRIPTION MOD-POSITIVE . 2))
               ...
               (1 1 (:REWRITE |(* c (* d x))|)))
(NARY::INTEGERP-MOD+ (3 3 (:TYPE-PRESCRIPTION MOD-ZERO . 2))
...
(NARY::INTEGERP-MOD-REWRITE
     ...
     (1 1 (:REWRITE |(- (* c x))|)))
(NARY::MOD-NOT-ACL2-NUMBERP (5 5 (:TYPE-PRESCRIPTION RATIONALP-MOD))
...
(NARY::MOD-ARG-TYPE (55 55 (:TYPE-PRESCRIPTION MOD-ZERO . 2))
                    ...
                    (1 1 (:REWRITE MOD-MINUS-2))
                    (1 1 (:REWRITE MOD-CANCEL-*)))
(NARY::EQUAL-MOD-TRANSFERS-TYPE (2 2 (:TYPE-PRESCRIPTION RATIONALP-MOD))
...
(NARY::TIMES-ZERO)
(NARY::MOD-N-OF-N-REDUCTION (176 11
                            ...
                            (2 1
                               (:REWRITE NARY::MOD-NOT-ACL2-NUMBERP)))
(NARY::MOD-N-OF-MOD-N-REDUCTION (4 4
                                   (:REWRITE NARY::MOD-NOT-ACL2-NUMBERP)))
(NARY::UN-MOD)
(NARY::MOD-EQUIV)
...
(NARY::MOD-EQUIV-NO-MOD
     ...
     (2 2 (:REWRITE RATIONALP-UNARY-/)))
(NARY::MOD-+-CONGRUENCE (86 86
                            (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                        (2 2 (:REWRITE NARY::MOD-MOD)))
(NARY::MOD-*-CONGRUENCE (76 76
                            (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(NARY::PUSH-MOD-EXPT
 (2517 553
       (:TYPE-PRESCRIPTION MOD-POSITIVE . 2))
...
(NARY::INTEGERP-MOD-TYPE (18 3 (:TYPE-PRESCRIPTION MOD-ZERO . 2))
