...
(FIX-LIST)
(PAIRLIS$-FIX-LIST (26 26 (:TYPE-PRESCRIPTION FIX-LIST)))
(QUOTE-LIST)
...
(PSEUDO-TERMP-KEY)
(NARY-BETA-REDUCE (400 198 (:REWRITE DEFAULT-+-2))
...
(UNHIDE-EVAL-KEY (143 70 (:REWRITE DEFAULT-+-2))
...
(UNHIDE-EVAL-KEY-REDUCTION (53 43 (:REWRITE UNHIDE-EVAL-CONSTRAINT-9))
                           (53 43 (:REWRITE UNHIDE-EVAL-CONSTRAINT-8))
                           (30 6 (:DEFINITION ASSOC-EQUAL)))
(WF-BETA-TERM (360 178 (:REWRITE DEFAULT-+-2))
...
(CAR-QUOTE-LIST (22 12 (:REWRITE DEFAULT-CAR))
                (5 5 (:REWRITE DEFAULT-CDR)))
(CAR-UNHIDE-EVAL-LIST (5 5 (:REWRITE DEFAULT-CAR))
...
(CONSP-UNHIDE-EVAL-LIST (2 2 (:REWRITE UNHIDE-EVAL-CONSTRAINT-4))
...
(UNHIDE-EVAL-KEY-NARY-BETA-REDUCE (265 21 (:DEFINITION PAIRLIS$))
...
(UNHIDE-EVAL-KEY-LAMBDA-EXPR (203 203 (:REWRITE DEFAULT-CAR))
...
(UNHIDE-EVAL-LAMBDA-EXPR-HELPER (12 12 (:REWRITE DEFAULT-CDR))
                                (12 12 (:REWRITE DEFAULT-CAR))
                                (10 2 (:DEFINITION PAIRLIS$)))
(UNHIDE-EVAL-LAMBDA-EXPR (12 1 (:DEFINITION PAIRLIS$))
                         (7 6 (:REWRITE DEFAULT-CDR))
                         (7 1 (:REWRITE CAR-UNHIDE-EVAL-LIST))
                         (6 6 (:REWRITE DEFAULT-CAR))
                         (3 3
                            (:REWRITE UNHIDE-EVAL-KEY-LAMBDA-EXPR))
                         (3 3 (:REWRITE UNHIDE-EVAL-CONSTRAINT-9))
                         (3 3 (:REWRITE UNHIDE-EVAL-CONSTRAINT-8))
                         (3 3 (:REWRITE UNHIDE-EVAL-CONSTRAINT-3))
                         (3 3 (:REWRITE UNHIDE-EVAL-CONSTRAINT-2))
...
(UNHIDE-EVAL-NARY-BETA-REDUCE
     (335 5
          (:REWRITE PSEUDO-TERMP-KEY-IMPLIES-WF-BETA-TERM))
...
(UNIDE-EVAL-TO-NARY-BETA-REDUCE
     ...
     (1 1
        (:REWRITE ASSOC-EQ-PAIRLIS$-NON-MEMBER)))
(NARY-BETA-REDUCE-LAMBDA (183 183 (:REWRITE DEFAULT-CDR))
...
(NARY-BETA-REDUCE-HIDE-WRAPPER
     ...
     (1 1
        (:TYPE-PRESCRIPTION NARY-BETA-REDUCE-HIDE-WRAPPER)))
(NARY-*META*-BETA-REDUCE-HIDE
     ...
     (2 2
        (:REWRITE ASSOC-EQ-PAIRLIS$-NON-MEMBER)))
(NARY-UNHIDE-HIDE-WRAPPER (62 62 (:REWRITE DEFAULT-CDR))
                          ...
                          (1 1
                             (:TYPE-PRESCRIPTION NARY-UNHIDE-HIDE-WRAPPER)))
(NARY-*META*-UNHIDE-HIDE (86 43 (:REWRITE DEFAULT-+-2))
                         (43 43 (:REWRITE DEFAULT-+-1))
                         (31 8 (:DEFINITION SYMBOL-LISTP))
                         (26 2 (:REWRITE CAR-UNHIDE-EVAL-LIST))
                         (23 23
