...
(ONE-4-MONADIC
 (41257 12275 (:REWRITE ZP-OPEN))
 (29420 29420 (:REWRITE DEFAULT-+-1))
 (19663 3875 (:REWRITE DEFUNG::NOT-ZP-INC))
 (16080 5815 (:REWRITE DEFUNG::NOT-TRUE-FROM-NOT-X))
 (14912 5011 (:REWRITE DEFUNG::TRUE-FROM-X))
 (12923 4249 (:DEFINITION NATP))
 (12750 12750 (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
 (11530 11530 (:META *META*-UNHIDE-HIDE))
 (5873 5873 (:REWRITE DEFUNG::QUOTED-TRUE))
 (4281 4281 (:TYPE-PRESCRIPTION NATP))
 (2258 232 (:REWRITE DEFAULT-CAR))
 (2218 224 (:REWRITE DEFAULT-CDR))
 (1908 412 (:REWRITE DEFUNG::NATP-FIX))
 )
(ONE-4-DOMAIN)
(ONE-4)
