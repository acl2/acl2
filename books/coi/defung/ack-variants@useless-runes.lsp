...
(OPEN-ACK0-DOMAIN (32 2 (:DEFINITION ACK0-DEFINITION))
                  ...
                  (2 2
                     (:REWRITE DEFUNG::COMBINE-AND-EVALUATE-CONSTANTS)))
(ACK0-DOMAIN-TRUE (1 1 (:REWRITE OPEN-ACK0-DOMAIN)))
(OPEN-ACK0-BASE)
(OPEN-ACK0-INDUCTION (24 24
                         (:TYPE-PRESCRIPTION DEFUNG::TRUE-FROM-X))
...
(OPEN-ACK1-0-DOMAIN (32 2 (:DEFINITION ACK1-0-DEFINITION))
                    ...
                    (2 2
                       (:REWRITE DEFUNG::COMBINE-AND-EVALUATE-CONSTANTS)))
(ACK1-0-DOMAIN-TRUE (1 1 (:REWRITE OPEN-ACK1-0-DOMAIN)))
(OPEN-ACK1-0-BASE)
(OPEN-ACK1-0-INDUCTION (24 24
                           (:TYPE-PRESCRIPTION DEFUNG::TRUE-FROM-X))
...
(OPEN-ACK1-DOMAIN (22 22
                  ...
                  (2 1
                     (:REWRITE DEFUNG::NOT-TRUE-FROM-NOT-X))
                  (1 1 (:REWRITE DEFUNG::QUOTED-TRUE)))
(ACK1-DOMAIN-TRUE (1 1 (:REWRITE OPEN-ACK1-DOMAIN)))
(OPEN-ACK1-BASE)
(OPEN-ACK1-INDUCTION (73 25 (:REWRITE ACK1-DOMAIN-TRUE))
                     (52 52
                         (:TYPE-PRESCRIPTION DEFUNG::TRUE-FROM-X))
                     (36 36
                         (:REWRITE DEFUNG::COMBINE-AND-EVALUATE-CONSTANTS))
...
(OPEN-ACK1-MEASURE-INDUCTION
     ...
     (2 1
        (:REWRITE DEFUNG::NOT-TRUE-FROM-NOT-X))
     (1 1 (:REWRITE DEFUNG::QUOTED-TRUE)))
(ACK1-MONADIC (422 93 (:REWRITE O-INFP->NEQ-0))
              (285 122
                   (:REWRITE DEFUNG::BOOLEAN-EQUAL-REDUCTION))
...
(OPEN-ACK2-0-DOMAIN (32 2 (:DEFINITION ACK2-0-DEFINITION))
                    ...
                    (2 2
                       (:REWRITE DEFUNG::COMBINE-AND-EVALUATE-CONSTANTS)))
(ACK2-0-DOMAIN-TRUE (1 1 (:REWRITE OPEN-ACK2-0-DOMAIN)))
(OPEN-ACK2-0-BASE)
(OPEN-ACK2-0-INDUCTION (24 24
                           (:TYPE-PRESCRIPTION DEFUNG::TRUE-FROM-X))
...
(OPEN-ACK2-DOMAIN (22 22
                  ...
                  (2 1
                     (:REWRITE DEFUNG::NOT-TRUE-FROM-NOT-X))
                  (1 1 (:REWRITE DEFUNG::QUOTED-TRUE)))
(ACK2-DOMAIN-TRUE (1 1 (:REWRITE OPEN-ACK2-DOMAIN)))
(OPEN-ACK2-BASE)
(OPEN-ACK2-INDUCTION (73 25 (:REWRITE ACK2-DOMAIN-TRUE))
                     (52 52
                         (:TYPE-PRESCRIPTION DEFUNG::TRUE-FROM-X))
                     (36 36
                         (:REWRITE DEFUNG::COMBINE-AND-EVALUATE-CONSTANTS))
...
(NATP-NATP-IMPLIES-NATP-ACK2 (349 255
                                  (:REWRITE DEFUNG::BOOLEAN-EQUAL-REDUCTION))
                             (290 290
                                  (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(ACK2-MONADIC (190 149
              ...
              (45 3
                  (:REWRITE NATP-NATP-IMPLIES-NATP-ACK2-0))
...
(OPEN-ACK3-0-DOMAIN (32 2 (:DEFINITION ACK3-0-DEFINITION))
                    ...
                    (2 2
                       (:REWRITE DEFUNG::COMBINE-AND-EVALUATE-CONSTANTS)))
(ACK3-0-DOMAIN-TRUE (1 1 (:REWRITE OPEN-ACK3-0-DOMAIN)))
(OPEN-ACK3-0-BASE)
(OPEN-ACK3-0-INDUCTION (24 24
                           (:TYPE-PRESCRIPTION DEFUNG::TRUE-FROM-X))
...
(OPEN-ACK3-DOMAIN (22 22
                  ...
                  (2 1
                     (:REWRITE DEFUNG::NOT-TRUE-FROM-NOT-X))
                  (1 1 (:REWRITE DEFUNG::QUOTED-TRUE)))
(ACK3-DOMAIN-TRUE (1 1 (:REWRITE OPEN-ACK3-DOMAIN)))
(OPEN-ACK3-BASE)
(OPEN-ACK3-INDUCTION (73 25 (:REWRITE ACK3-DOMAIN-TRUE))
                     (52 52
                         (:TYPE-PRESCRIPTION DEFUNG::TRUE-FROM-X))
                     (36 36
                         (:REWRITE DEFUNG::COMBINE-AND-EVALUATE-CONSTANTS))
...
(NATP-NATP-IMPLIES-NATP-ACK3-0
     ...
     (3 3 (:REWRITE DEFAULT-<-1))
     (3 3 (:META CANCEL_PLUS-LESSP-CORRECT)))
(NATP-NATP-IMPLIES-NATP-ACK3 (349 255
                                  (:REWRITE DEFUNG::BOOLEAN-EQUAL-REDUCTION))
                             (290 290
                                  (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
                             (265 165 (:REWRITE O-INFP->NEQ-0))
...
(ACK3-MONADIC (190 149
              ...
              (56 14 (:REWRITE EQUAL-CONSTANT-+))
              (45 3
                  (:REWRITE NATP-NATP-IMPLIES-NATP-ACK3-0))
              (31 31 (:REWRITE NATP-RW))
              (20 4 (:REWRITE NATP-POSP))
              (18 18 (:REWRITE DEFUNG::QUOTED-TRUE))
              (16 4 (:REWRITE POSP-RW))
