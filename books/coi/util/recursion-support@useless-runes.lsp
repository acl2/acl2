...
(DEFUN::BASE-VALUE)
(DEFUN::REC-VALUE)
(DEFUN::LIFT-BASE-FN (841 398 (:REWRITE DEFAULT-+-2))
                     (540 398 (:REWRITE DEFAULT-+-1))
                     ...
                     (33 21
                         (:TYPE-PRESCRIPTION DEFUN::SYN-CONJOIN))
                     (1 1
                        (:TYPE-PRESCRIPTION DEFUN::SYN-LAZY-IF)))
(DEFUN::PAIR-ARGS-WITH-TRUE)
(DEFUN::LIFT-BASE)
(DEFUN::LIFT-RECURSION-GUARD)
(DEFUN::DUPLO (378 12 (:DEFINITION ACL2-COUNT))
...
(DEFUN::DUPLO-SPINE (126 4 (:DEFINITION ACL2-COUNT))
...
(DEFUN::TERM-VARS (378 12 (:DEFINITION ACL2-COUNT))
                  (138 66 (:REWRITE DEFAULT-+-2))
                  (90 66 (:REWRITE DEFAULT-+-1))
                  (48 12 (:REWRITE COMMUTATIVITY-OF-+))
                  (48 12 (:DEFINITION INTEGER-ABS))
                  ...
                  (6 6 (:REWRITE DEFAULT-COERCE-2))
                  (6 6 (:REWRITE DEFAULT-COERCE-1)))
(DEFUN::TERM-VAR-SUB (378 12 (:DEFINITION ACL2-COUNT))
                     (138 66 (:REWRITE DEFAULT-+-2))
                     (90 66 (:REWRITE DEFAULT-+-1))
                     (48 12 (:REWRITE COMMUTATIVITY-OF-+))
                     (48 12 (:DEFINITION INTEGER-ABS))
                     ...
                     (6 6 (:REWRITE DEFAULT-COERCE-2))
                     (6 6 (:REWRITE DEFAULT-COERCE-1)))
(DEFUN::VAR-ALIST-REC (5 5
                         (:TYPE-PRESCRIPTION SYMBOL-FNS::SAFE-WITNESS)))
(DEFUN::VAR-ALIST)
(DEFUN::DUPLICATE-DEFUN (5 3
                           (:TYPE-PRESCRIPTION DEFUN::SYN-CONJOIN)))
(DEFUN::CONGRUENCE-INDUCTION-FUNCTION
     (7 7
        (:TYPE-PRESCRIPTION SYMBOL-FNS::SAFE-WITNESS)))
(DEFUN::PREFIX-LIST (1 1 (:REWRITE DEFAULT-CDR))
