...
(DEFUN::DECLARATION-LISTP-STRIP-DECLS-REC (20 20 (:REWRITE DEFAULT-CAR))
...
(DEFUN::DECLARATION-LISTP-DECOMPOSE-DEFUN-BODY
     (5 1
        (:DEFINITION DEFUN::DECLARATION-LISTP)))
(DEFUN::MAKE-DEFUN-BODY (20 20 (:REWRITE DEFAULT-CAR))
                        (10 10 (:REWRITE DEFAULT-CDR))
                        (10 5 (:DEFINITION TRUE-LISTP)))
(DEFUN::CAR-APPEND (69 69 (:TYPE-PRESCRIPTION BINARY-APPEND))
                   (45 15 (:REWRITE DEFAULT-CAR))
                   (5 5 (:REWRITE DEFAULT-CDR)))
(DEFUN::WF-DEFUN-BODY-MAKE-DEFUN-BODY-1 (190 120 (:REWRITE DEFAULT-CDR))
                                        (183 177 (:REWRITE DEFAULT-CAR)))
(DEFUN::WF-DEFUN-BODY-MAKE-DEFUN-BODY-2 (141 89 (:REWRITE DEFAULT-CDR))
...
(DEFUN::DEFUN-BODY)
(DEFUN::MAKE-DEFUN)
(DEFUN::MAKE-DEFUN-TYPE (42 42 (:REWRITE DEFAULT-CDR))
...
(DEFUN::WF-DEFUN-BODY-DEFUN-BODY (39 39 (:REWRITE DEFAULT-CDR))
...
(DEFUN::FUNCTION-DECLARATION-P-SIGNATURE-TO-DECLARATION
     (36 4
         (:REWRITE DEFUN::SYMBOL-LISTP-IMPLIES-TRUE-LISTP))
...
(DEFUN::XARG-P)
(DEFUN::XARG-BODY)
(DEFUN::GET-XARG-KEY-FROM-BODY (153 71 (:REWRITE DEFAULT-+-2))
...
(DEFUN::EXTRACT-XARG-KEY-FROM-BODY-REC (153 71 (:REWRITE DEFAULT-+-2))
                                       (99 71 (:REWRITE DEFAULT-+-1))
                                       (56 14 (:REWRITE COMMUTATIVITY-OF-+))
                                       (56 14 (:DEFINITION INTEGER-ABS))
                                       (56 7 (:DEFINITION LENGTH))
...
(DEFUN::DECLARATION-LISTP-REVAPPEND (40 34 (:REWRITE DEFAULT-CAR))
...
(DEFUN::GET-XARG-KEYS-FROM-BODY (1 1 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(DEFUN::TRUE-LISTP-GET-XARG-KEYS-FROM-BODY)
(DEFUN::GET-XARG-KEYS-FROM-DECLS (9 9 (:REWRITE DEFAULT-CAR))
                                 (2 2 (:REWRITE DEFAULT-CDR)))
(DEFUN::TRUE-LISTP-GET-XARG-KEYS-FROM-DECLS)
(DEFUN::TYPE-DECLARATION)
(DEFUN::GET-TYPE-DECLARATIONS-FROM-BODY)
(DEFUN::GET-TYPE-DECLARATIONS-FROM-DECLS (9 9 (:REWRITE DEFAULT-CAR))
                                         (2 2 (:REWRITE DEFAULT-CDR)))
...
(DEFUN::EXTRACT-FUNCTION-DECLARATION-REC
     (83 1
         (:DEFINITION DEFUN::EXTRACT-FUNCTION-DECLARATION-FROM-BODY-REC))
     (49 1
         (:DEFINITION DEFUN::FUNCTION-DECLARATION-P))
     (44 1
         (:DEFINITION DEFUN::SIGNATURE-DECLARATION-P))
     (36 4
         (:REWRITE DEFUN::SYMBOL-LISTP-IMPLIES-TRUE-LISTP))
...
(DEFUN::FUNCTION-DECLARATION-P-VAL-0-EXTRACT-FUNCTION-DECLARATION
     (216 24
          (:REWRITE DEFUN::SYMBOL-LISTP-IMPLIES-TRUE-LISTP))
     (186 2
          (:DEFINITION DEFUN::EXTRACT-FUNCTION-DECLARATION-REC))
     (162 2
          (:DEFINITION DEFUN::EXTRACT-FUNCTION-DECLARATION-FROM-BODY-REC))
     ...
     (4 2
        (:DEFINITION DEFUN::DECLARATION-BODY)))
(DEFUN::FUNCTION-DECLARATION-P-VAL-1-EXTRACT-FUNCTION-DECLARATION
     ...
     (4 2
        (:DEFINITION DEFUN::DECLARATION-BODY)))
(DEFUN::TRUE-LISTP-VAL-3-EXTRACT-FUNCTION-DECLARATION
     (144 16
          (:REWRITE DEFUN::SYMBOL-LISTP-IMPLIES-TRUE-LISTP))
     ...
     (2 1
        (:DEFINITION DEFUN::DECLARATION-BODY)))
(DEFUN::DECLARATION-LISTP-VAL-3-EXTRACT-FUNCTION-DECLARATION
     (144 16
          (:REWRITE DEFUN::SYMBOL-LISTP-IMPLIES-TRUE-LISTP))
     (96 16 (:DEFINITION SYMBOL-LISTP))
     (93 1
...
(DEFUN::LAMBDA-FORMALS (3 3 (:REWRITE DEFAULT-CAR))
                       (2 2 (:REWRITE DEFAULT-CDR))
                       (2 1 (:REWRITE DEFAULT-+-2))
                       (1 1 (:REWRITE DEFAULT-+-1)))
(DEFUN::LAMBDA-BODY (8 8 (:REWRITE DEFAULT-CDR))
...
(DEFUN::PSEUDO-TERMP-LAMBDA-BODY
     ...
     (1 1
        (:REWRITE TERM-LISTP-IMPLIES-PSEUDO-TERM-LISTP)))
(DEFUN::LAMBDA-BODY-MEASURE (281 124 (:REWRITE DEFAULT-+-2))
...
(DEFUN::LAMBDA-FORMALS-MEASURE (212 96 (:REWRITE DEFAULT-+-2))
...
(DEFUN::LAMBDA-ARGS-MEASURE (49 23 (:REWRITE DEFAULT-+-2))
...
(DEFUN::MEMBERX)
(DEFUN::REVAPPENDX)
(DEFUN::LEN-REVAPPENDX (50 24 (:REWRITE DEFAULT-+-2))
...
(DEFUN::SYMBOL-LISTP-REVAPPENDX (19 18 (:REWRITE DEFAULT-CAR))
...
(DEFUN::PSEUDO-TERM-LISTP-REVAPPENDX
     ...
     (2 2 (:REWRITE DEFAULT-COERCE-2))
     (2 2 (:REWRITE DEFAULT-COERCE-1)))
(DEFUN::COLLECT-FREE-VARIABLES (252 8 (:DEFINITION ACL2-COUNT))
                               ...
                               (4 4
                                  (:TYPE-PRESCRIPTION DEFUN::REVAPPENDX))
...
(DEFUN::PROMOTE-FREE-VARIABLES
     (6 6
        (:TYPE-PRESCRIPTION DEFUN::REVAPPENDX))
     (1 1
        (:TYPE-PRESCRIPTION DEFUN::PROMOTE-FREE-VARIABLES)))
(DEFUN::LAMBDA-EXPR-P-PROMOTE-FREE-VARIABLES
     (123 6
          (:DEFINITION DEFUN::COLLECT-FREE-VARIABLES))
...
(DEFUN::PSEUDO-TERMP-PROMOTE-FREE-VARIABLES
     ...
     (3 3
        (:REWRITE TERM-LISTP-IMPLIES-PSEUDO-TERM-LISTP)))
(DEFUN::EQUAL-COMMON-PLUS-REDUCTION (5 5 (:REWRITE DEFAULT-+-2))
                                    (5 5 (:REWRITE DEFAULT-+-1)))
...
(DEFUN::GUARDS-FROM-DECLARE-LIST
     (162 1
          (:DEFINITION DEFUN::GUARDS-FROM-DECLARE-BODY))
     (92 2
         (:DEFINITION DEFUN::SIGNATURE-DECLARATION-P))
     (72 8
         (:REWRITE DEFUN::SYMBOL-LISTP-IMPLIES-TRUE-LISTP))
...
(DEFUN::MV-EQUIV)
(DEFUN::MV-EQUIVP)
(DEFUN::MV-EQUIVP-IMPLIES-SYMBOLP-MV-EQUIV (1 1 (:REWRITE DEFAULT-CDR))
                                           (1 1 (:REWRITE DEFAULT-CAR))
                                           (1 1 (:REWRITE DEFAULT-<-2))
                                           (1 1 (:REWRITE DEFAULT-<-1)))
(DEFUN::OUTER-EQUIVP)
(DEFUN::OUTER-EQUIVP-FROM-SYMBOLP)
(DEFUN::OUTER-EQUIVP-FROM-MV-EQUIVP (3 3 (:REWRITE DEFAULT-CDR))
...
(DEFUN::SYMBOL-LISTP-NULLIFY-LIST-APPEND (13 12 (:REWRITE DEFAULT-CDR))
                                         (11 10 (:REWRITE DEFAULT-CAR)))
(DEFUN::MAP-LIST (1 1 (:REWRITE DEFAULT-CDR))
                 (1 1 (:REWRITE DEFAULT-CAR)))
(DEFUN::CONGRUENCE-SPEC-LISTP-MAP-LIST (34 33 (:REWRITE DEFAULT-CDR))
                                       (29 28 (:REWRITE DEFAULT-CAR)))
(DEFUN::SPLIT-PATTERN (18 17 (:REWRITE DEFAULT-CAR))
                      (17 16 (:REWRITE DEFAULT-CDR))
                      (16 4
                          (:DEFINITION DEFUN::OUTER-EQUIV-LISTP))
                      (4 4
                         (:TYPE-PRESCRIPTION DEFUN::OUTER-EQUIVP))
                      (4 2
                         (:DEFINITION DEFUN::NULLIFY-LIST-APPEND)))
...
(DEFUN::CONGRUENCE-SPEC-LIST-SPLIT-PATTERN
     ...
     (10 10
         (:TYPE-PRESCRIPTION DEFUN::MAP-LIST)))
(DEFUN::MAP-CONS)
...
(DEFUN::OUTER-EQUIV-LIST (7 7 (:REWRITE DEFAULT-CAR))
                         (6 6 (:REWRITE DEFAULT-CDR))
                         (4 4 (:REWRITE DEFAULT-<-2))
                         (4 4 (:REWRITE DEFAULT-<-1))
                         (4 4 (:REWRITE DEFAULT-+-2))
                         (4 4 (:REWRITE DEFAULT-+-1)))
(DEFUN::OUTER-EQUIV-LISTP-OUTER-EQUIV-LIST (24 23 (:REWRITE DEFAULT-CAR))
                                           (13 12 (:REWRITE DEFAULT-CDR))
                                           (7 7 (:REWRITE DEFAULT-<-2))
                                           (7 7 (:REWRITE DEFAULT-<-1))
                                           (4 4 (:REWRITE DEFAULT-+-2))
                                           (4 4 (:REWRITE DEFAULT-+-1)))
(DEFUN::WF-CONGRUENCE-OUTER-EQUIV-LIST (20 4 (:DEFINITION LEN))
                                       (10 10 (:REWRITE DEFAULT-CDR))
                                       (8 4 (:REWRITE DEFAULT-+-2))
                                       (4 4 (:REWRITE DEFAULT-CAR))
                                       (4 4 (:REWRITE DEFAULT-+-1))
...
(DEFUN::OUTER-EQUIV-LISTP-WF-CONGRUENCE-OUTER-EQUIV-LIST
     ...
     (2 2
        (:TYPE-PRESCRIPTION DEFUN::OUTER-EQUIV-LIST))
     (2 1 (:REWRITE DEFAULT-<-2))
     (1 1 (:REWRITE DEFAULT-<-1)))
...
(DEFUN::CONGRUENCE-PAIRING-SPLIT-PAIRED-CONGRUENCES
     ...
     (105 3
          (:DEFINITION DEFUN::CONGRUENCE-PAIRING))
     ...
     (7 7 (:REWRITE DEFAULT-<-1))
     (6 6
        (:TYPE-PRESCRIPTION DEFUN::WF-CONGRUENCE-OUTER-EQUIV-LIST))
     (6 6
        (:TYPE-PRESCRIPTION DEFUN::SPLIT-PATTERN))
     (6 6
        (:TYPE-PRESCRIPTION DEFUN::SPLIT-PAIRED-CONGRUENCES))
     (6 6 (:TYPE-PRESCRIPTION DEFUN::MAP-LIST))
     (6 6 (:TYPE-PRESCRIPTION DEFUN::MAP-CONS))
     (3 3
        (:TYPE-PRESCRIPTION DEFUN::CONGRUENCE-SPEC)))
...
(DEFUN::ARG-EQUIV)
(DEFUN::SYMBOLP-ARG-EQUIV (18 18 (:REWRITE DEFAULT-CAR))
                          (6 6 (:REWRITE DEFAULT-CDR)))
...
(DEFUN::MAKE-CONGRUENCE-HINT (4 2
                                (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
                             (2 2 (:TYPE-PRESCRIPTION BINARY-APPEND)))
(DEFUN::TRUE-LISTP-MAKE-CONGRUENCE-HINT
     (57 1 (:DEFINITION DEFUN::ADD-TO-GOAL-HINT))
     (45 11 (:DEFINITION BINARY-APPEND))
     (38 4
         (:REWRITE DEFUN::SYMBOL-LISTP-IMPLIES-TRUE-LISTP))
