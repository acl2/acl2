...
(DEFUN::GET-KEY)
(DEFUN::GET-FTY-ENTRY)
(DEFUN::ALISTP-GET-FTY-ENTRY (8 2 (:DEFINITION ALISTP))
...
(DEFUN::CONSP-FTY-VAL-SPECS (5 5 (:REWRITE DEFAULT-CAR))
                            (4 4 (:REWRITE DEFAULT-CDR)))
(DEFUN::USE-FTY-SPECS)
(DEFUN::USE-FTY-SPECS-SIGNATURE (160 20 (:DEFINITION DEFUN::FTY-VAL-SPECS))
