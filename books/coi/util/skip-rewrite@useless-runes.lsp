...
(UNHIDE-UNHIDDEN (3 3 (:TYPE-PRESCRIPTION UNHIDE)))
...
(UNHIDE-P)
(HIDE-P)
(BETA-REDUCE-HIDE-WRAPPER (5 5 (:REWRITE DEFAULT-CDR))
                          (3 3
                             (:REWRITE TERM-LISTP-IMPLIES-PSEUDO-TERM-LISTP))
                          (3 3 (:REWRITE DEFAULT-CAR))
                          (2 2 (:REWRITE TERMP-IMPLIES-PSEUDO-TERMP))
                          (1 1
                             (:TYPE-PRESCRIPTION BETA-REDUCE-HIDE-WRAPPER)))
(*META*-BETA-REDUCE-HIDE (55 55 (:REWRITE DEFAULT-CDR))
...
(UNHIDE-HIDE-WRAPPER (60 60 (:REWRITE DEFAULT-CDR))
                     (50 6 (:DEFINITION LENGTH))
                     (45 9 (:DEFINITION LEN))
                     ...
                     (2 2 (:REWRITE DEFAULT-COERCE-1))
                     (1 1
                        (:TYPE-PRESCRIPTION UNHIDE-HIDE-WRAPPER)))
(*META*-UNHIDE-HIDE (82 82 (:REWRITE DEFAULT-CDR))
...
(FOO-0)
(FOO-10 (10 10 (:META *META*-UNHIDE-HIDE)))
