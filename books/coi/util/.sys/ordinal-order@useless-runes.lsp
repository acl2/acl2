...
(*TOO)
(*TOO-INDUCTION
 (5448 133 (:DEFINITION ACL2-COUNT))
 (3851 6 (:REWRITE O<=-O-FINP-DEF))
 (1788 859 (:REWRITE DEFAULT-+-2))
 (1600 186 (:META CANCEL_PLUS-LESSP-CORRECT))
 (1208 859 (:REWRITE DEFAULT-+-1))
