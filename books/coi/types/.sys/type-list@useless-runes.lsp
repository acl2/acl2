...
(TYPES::NTH-OF-NAT-LIST-FIX
 (197 38 (:REWRITE TYPES::NAT-LIST-FIX-WHEN-NAT-LIST-P))
 (121 121 (:TYPE-PRESCRIPTION TYPES::NAT-LIST-P))
 (66 66 (:REWRITE TYPES::NAT-LIST-P-WHEN-NOT-CONSP))
 (56 14 (:REWRITE TYPES::NATP-OF-CAR-WHEN-NAT-LIST-P))
 (56 14 (:REWRITE TYPES::NAT-LIST-P-OF-CDR-WHEN-NAT-LIST-P))
...
(TYPES::TRUE-LISTP-WHEN-INT-LISTP-COMPOUND-RECOGNIZER)
(TYPES::INT-LIST-FIX$INLINE)
(TYPES::INT-LISTP-OF-INT-LIST-FIX
 (12 5 (:REWRITE TYPES::INT-LISTP-WHEN-NOT-CONSP))
...
(TYPES::NTH-OF-INT-LIST-FIX
 (107 20 (:REWRITE TYPES::INT-LIST-FIX-WHEN-INT-LISTP))
 (69 69 (:TYPE-PRESCRIPTION TYPES::INT-LISTP))
 (61 25 (:REWRITE TMP-DEFTYPES-IFIX-WHEN-INTEGERP))
 (37 37 (:REWRITE TYPES::INT-LISTP-WHEN-NOT-CONSP))
 (36 9 (:REWRITE TYPES::INTEGERP-OF-CAR-WHEN-INT-LISTP))
 (32 8 (:REWRITE TYPES::INT-LISTP-OF-CDR-WHEN-INT-LISTP))
