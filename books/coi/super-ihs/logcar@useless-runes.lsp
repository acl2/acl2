...
(LOGCAR-EXPT (329 7 (:REWRITE LOGCAR-IDENTITY))
...
(LOGCAR-+-ALT (127 10 (:REWRITE LOGCAR-IDENTITY))
...
(LOGCAR-OF-LOGCAR
     ...
     (3 3
        (:REWRITE INTEGERP-*-CONSTANT-MEANS-1)))
(ODDP-TO-LOGCAR (143 11 (:REWRITE LOGCAR-IDENTITY))
                ...
                (2 2 (:REWRITE DEFAULT-*-2))
                (2 2 (:REWRITE DEFAULT-*-1)))
(ODDP-REWRITE-TO-LOGCAR-FACT (156 12 (:REWRITE LOGCAR-IDENTITY))
...
(EVENP-OF-LOGCAR (126 6 (:LINEAR LOGCAR-RANGE-LINEAR))
...
(LOGCAR-0-REWRITE (159 12 (:REWRITE LOGCAR-IDENTITY))
                  ...
                  (2 2 (:REWRITE DEFAULT-*-2))
                  (2 2 (:REWRITE DEFAULT-*-1)))
(LOGCAR-OF-TIMES (296 8 (:REWRITE LOGCAR-IDENTITY))
