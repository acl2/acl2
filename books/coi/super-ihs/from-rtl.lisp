...
(local (include-book "rtl/rel4/support/logxor" :dir :system))
(local (include-book "rtl/rel4/support/logior" :dir :system))
(local (include-book "rtl/rel4/arithmetic/integerp" :dir :system))
