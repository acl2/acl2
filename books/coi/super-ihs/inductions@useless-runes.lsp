(ADD1-ADD1-LOGCDR-INDUCTION (32 8 (:DEFINITION O-FIRST-EXPT))
                            ...
                            (2 1 (:REWRITE POSP-RW)))
(ADD1-ADD1-INDUCTION (32 8 (:DEFINITION O-FIRST-EXPT))
                     (22 22 (:REWRITE DEFAULT-CAR))
                     (20 5 (:DEFINITION O-FIRST-COEFF))
                     (11 8 (:REWRITE DEFAULT-<-1))
                     (10 10
                     ...
                     (2 2 (:TYPE-PRESCRIPTION NATP))
                     (2 1 (:REWRITE POSP-RW)))
(ADD1-LOGCDR-LOGCDR-INDUCTION (32 8 (:DEFINITION O-FIRST-EXPT))
                              (22 22 (:REWRITE DEFAULT-CAR))
                              (20 5 (:DEFINITION O-FIRST-COEFF))
                              (11 8 (:REWRITE DEFAULT-<-1))
                              (10 10
                              ...
                              (2 2 (:TYPE-PRESCRIPTION NATP))
                              (2 1 (:REWRITE POSP-RW)))
(LOGCDR-INDUCTION (7 5 (:REWRITE DEFAULT-<-1))
                  (5 5
                     (:REWRITE REMOVE-REDUNDANT-LESS-THANS))
...
(ADD1-SUB1-INDUCTION (32 8 (:DEFINITION O-FIRST-EXPT))
                     (22 22 (:REWRITE DEFAULT-CAR))
                     (20 5 (:DEFINITION O-FIRST-COEFF))
                     (11 8 (:REWRITE DEFAULT-<-1))
                     (10 10
                     ...
                     (2 2 (:TYPE-PRESCRIPTION NATP))
                     (2 1 (:REWRITE POSP-RW)))
(ADD1-INDUCTION (32 8 (:DEFINITION O-FIRST-EXPT))
                (22 22 (:REWRITE DEFAULT-CAR))
                (20 5 (:DEFINITION O-FIRST-COEFF))
                (11 8 (:REWRITE DEFAULT-<-1))
                (10 10
...
(SUB1-LOGCDR-LOGCDR-INDUCTION (4 4
                                 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
...
(ADD1-LOGCDR-INDUCTION (32 8 (:DEFINITION O-FIRST-EXPT))
                       (22 22 (:REWRITE DEFAULT-CAR))
                       (20 5 (:DEFINITION O-FIRST-COEFF))
                       (11 8 (:REWRITE DEFAULT-<-1))
                       (10 10
...
(LOGCDR-LOGCDR-INDUCTION (75 27
                         ...
                         (1 1
                            (:TYPE-PRESCRIPTION |x < y  =>  0 < y-x|)))
(SUB1-LOGCDR-INDUCTION (4 4
                          (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(SUB1-SUB1-INDUCTION (8 8
                        (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(SUB1-SUB1-LOGCDR-INDUCTION (8 8
                               (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(SUB1-SUB1-LOGCDR-LOGCDR-INDUCTION
     (8 8
        (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(ADD1-SUB1-LOGCDR-INDUCTION (4 4
                               (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
...
(LOGENDP)
(B-MAJ)
(LOGCDR-LOGEND-ACL2-COUNT (78 14
                              (:REWRITE INTEGERP-*-CONSTANT-MEANS-1))
...
(+-R (100 10
          (:REWRITE LOGCDR-LOGEND-ACL2-COUNT-2))
...
(LOGNOTR (8 6 (:REWRITE DEFAULT-<-1))
         ...
         (2 2
            (:REWRITE MOVE---TO-CONSTANT-IN-EQUAL)))
(LOGNOT-INDUCTION)
(LOGBINR (30 3 (:REWRITE LOGCDR-LOGEND-ACL2-COUNT-2))
...
(LOGLIST-LOGLISTR (18 18
                  ...
                  (1 1 (:REWRITE DEFAULT-+-1)))
(LOGLIST-LOGHEAD)
(LOGMASKPR (30 3 (:REWRITE LOGCDR-LOGEND-ACL2-COUNT-2))
           (18 3 (:REWRITE EQUAL-NEGATION-SAME-SIGN))
           (5 4 (:REWRITE DEFAULT-<-2))
           (5 4 (:REWRITE DEFAULT-<-1))
           (4 4
