(INTEGER-RANGE-P-EXTEND-UPPER (10 5 (:REWRITE DEFAULT-<-2))
                              (6 6
                                 (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                              (6 5 (:REWRITE DEFAULT-<-1)))
(INTEGER-RANGE-P-EXTEND-LOWER (10 5 (:REWRITE DEFAULT-<-2))
                              (6 6
                                 (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                              (6 5 (:REWRITE DEFAULT-<-1))
                              (1 1
...
(EXPT-EXPO-WHEN-POWER2P
 ...
 (264 70 (:REWRITE DEFAULT-+-2))
 (242 148 (:REWRITE DEFAULT-*-2))
 (192
     178
     (:REWRITE
          LESS-THAN-MULTIPLY-THROUGH-BY-INVERTED-FACTOR-FROM-LEFT-HAND-SIDE))
 (184 184 (:REWRITE NON-INTEGERP-<-INTEGERP))
 (184 184 (:REWRITE INTEGERP-<-NON-INTEGERP))
 (178
    178
    (:REWRITE
 ...
 (165 148 (:REWRITE DEFAULT-*-1))
 (158 156 (:REWRITE DEFAULT-<-2))
 (157 156 (:REWRITE DEFAULT-<-1))
 (133 41 (:REWRITE EXPT-WITH-I-NON-INTEGER))
 (113 79 (:REWRITE EXPO-OF-NOT-RATIONALP))
