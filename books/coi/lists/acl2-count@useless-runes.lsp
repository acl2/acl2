...
(ACL2-COUNT-WHEN-CONSP-LINEAR (10 4 (:REWRITE DEFAULT-+-2))
...
(ACL2-COUNT-OF-CAR-BOUND-WEAK (1 1 (:REWRITE DEFAULT-CAR)))
(ACL2-COUNT-OF-CAR-BOUND-TIGHT (12 6 (:REWRITE DEFAULT-<-2))
...
(ACL2-COUNT-OF-CDR-BOUND-WEAK-LINEAR
     ...
     (3 3
        (:LINEAR ACL2-COUNT-WHEN-CONSP-LINEAR)))
(ACL2-COUNT-OF-CDR-BOUND-WEAK (1 1 (:REWRITE DEFAULT-CDR)))
(ACL2-COUNT-OF-CDR-BOUND-TIGHT (12 6 (:REWRITE DEFAULT-<-2))
                               (9 6 (:REWRITE DEFAULT-<-1))
                               (5 2 (:REWRITE DEFAULT-+-2))
                               (3 2 (:REWRITE DEFAULT-+-1))
                               (1 1 (:REWRITE FOLD-CONSTS-IN-+))
                               (1 1 (:REWRITE DEFAULT-CAR)))
(ACL2-COUNT-OF-NTH-BOUND-WEAK-LINEAR (12 6 (:REWRITE DEFAULT-+-2))
                                     ...
                                     (4 4 (:REWRITE ZP-OPEN))
                                     (2 2 (:REWRITE FOLD-CONSTS-IN-+)))
(ACL2-COUNT-OF-NTH-BOUND-WEAK (6 1 (:DEFINITION NTH))
                              (1 1 (:REWRITE ZP-OPEN))
                              (1 1 (:REWRITE DEFAULT-CDR))
                              (1 1 (:REWRITE DEFAULT-CAR))
                              (1 1 (:REWRITE DEFAULT-+-2))
                              (1 1 (:REWRITE DEFAULT-+-1)))
(ACL2-COUNT-OF-NTH-BOUND-TIGHT (43 22 (:REWRITE DEFAULT-<-2))
...
(ACL2-COUNT-OF-NTH-BOUND-TIGHT-LINEAR (42 27 (:REWRITE DEFAULT-+-2))
