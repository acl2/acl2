...
(LIST::MEMBER-IS-MEMBERP-PROPOSITIONALLY (20 20 (:REWRITE DEFAULT-CAR))
...
(LIST::MEMBERP-OF-NIL)
(LIST::MEMBERP-OF-CONS (6 6
                          (:REWRITE LIST::MEMBERP-OF-NON-CONSP-CHEAP))
                       (3 3 (:REWRITE DEFAULT-CDR))
                       (3 3 (:REWRITE DEFAULT-CAR)))
(LIST::MEMBERP-OF-CONS-IRREL (8 2 (:DEFINITION LIST::MEMBERP))
                             (4 4
                                (:REWRITE LIST::MEMBERP-OF-NON-CONSP-CHEAP))
...
(LIST::MEMBERP-CAR (2 1
                      (:REWRITE LIST::MEMBERP-OF-CONS-REDUCE-CHEAP))
                   (1 1
                      (:REWRITE LIST::MEMBERP-OF-CONS-IRREL))
                   (1 1
                      (:REWRITE LIST::MEMBERP-OF-CONS-CHEAP)))
(LIST::MEMBERP-OF-CDR (4 4
                         (:REWRITE LIST::MEMBERP-OF-NON-CONSP-CHEAP)))
(LIST::MEMBERP-OF-CDR-CHEAP (4 4
                               (:REWRITE LIST::MEMBERP-OF-NON-CONSP-CHEAP)))
...
(LIST::MEMBER-OF-FIRSTN-FORWARD-TO-MEMBERP
     ...
     (270 7 (:LINEAR LIST::LEN-OF-CDR-LINEAR))
...
(LIST::MAX-MEMBER-BOUND-IMPLICATION
     ...
     (1 1 (:REWRITE DEFAULT-CDR)))
(LIST::NON-MEMBER)
(LIST::NOT-MEMBERP-NON-MEMBER (32 2 (:DEFINITION LIST::MAX-MEMBER))
