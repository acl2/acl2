...
(SET::CAR-OF-2LIST
 ...
 (14 11 (:REWRITE SET::HEAD-WHEN-EMPTYP))
...
(SET::2SET-OF-2LIST
 ...
 (978 151 (:REWRITE SET::TAIL-WHEN-EMPTYP))
 (890 290 (:REWRITE SET::TAIL-PRESERVES-EMPTYP))
 (714 109 (:REWRITE SET::HEAD-WHEN-EMPTYP))
 ...
 (370 51 (:REWRITE SET::EMPTYP-SUBSET))
 (332 51 (:REWRITE SET::EMPTYP-SUBSET-2))
 ...
 (24 3 (:REWRITE SET::EMPTYP-SFIX-CANCEL))
...
(SET::MEMBERP-OF-2LIST
 ...
 (20 10 (:REWRITE SET::TAIL-WHEN-EMPTYP))
 ...
 (10 6 (:REWRITE SET::TAIL-PRESERVES-EMPTYP))
...
(SET::SETEQUIV-IMPLIES-EQUAL-2SET-1
 ...
 (360 12 (:DEFINITION SET::SUBSET$INLINE))
 ...
 (102 34 (:REWRITE SET::EMPTYP-SUBSET))
...
(SET::REMOVE-2LIST
 ...
 (1054 18 (:DEFINITION SET::SUBSET$INLINE))
 (897 897 (:TYPE-PRESCRIPTION SET::EMPTYP-TYPE))
 (697 135 (:REWRITE SET::IN-TAIL-OR-HEAD))
 (642 87 (:REWRITE SET::DOUBLE-CONTAINMENT-EXPENSIVE))
 (421 216 (:REWRITE SET::TAIL-WHEN-EMPTYP))
 (375 10 (:REWRITE SET::DELETE-NONMEMBER-CANCEL))
 (355 283 (:REWRITE SET::TAIL-PRESERVES-EMPTYP))
 ...
 (204 42 (:REWRITE SET::EMPTYP-SUBSET-2))
 ...
 (77 42 (:REWRITE SET::EMPTYP-SUBSET))
 (49 16 (:REWRITE SET::DELETE-PRESERVES-EMPTYP))
...
(SET::DELETE-2SET
 ...
 (658 12 (:DEFINITION SET::SUBSET$INLINE))
