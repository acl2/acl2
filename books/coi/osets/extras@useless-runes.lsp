(SET::OPEN-SET2LIST (5 5 (:REWRITE SET::TAIL-WHEN-EMPTY))
...
(SET::HEAD-IS-LEAST-ELEMENT (65 3 (:DEFINITION SET::IN))
...
(SET::ORDERING-OVER-SUBSET (34 6 (:REWRITE SET::SUBSET-IN-2))
...
(SET::HEAD-OF-INSERT-UNDER-SUBSET
     ...
     (1 1
        (:REWRITE SET::PICK-A-POINT-SUBSET-CONSTRAINT-HELPER)))
(SET::NOT-EMPTY-SETP (38 10 (:REWRITE <<-TRICHOTOMY))
...
(SET::TAIL-OF-INSERT-UNDER-SUBSET
     ...
     (1 1
        (:REWRITE SET::PICK-A-POINT-SUBSET-CONSTRAINT-HELPER)))
(SET::CONSP-OF-INSERT (578 6 (:REWRITE SET::INSERT-IDENTITY))
                      (538 6 (:DEFINITION SET::IN))
                      (450 6
                           (:REWRITE SET::DOUBLE-CONTAINMENT-EXPENSIVE))
                      (364 63 (:REWRITE SET::NONEMPTY-MEANS-SET))
                      (294 75 (:REWRITE <<-TRICHOTOMY))
                      (192 33 (:REWRITE <<-ASYMMETRIC))
...
(SET::CDR-INSERT-NIL (7 1 (:REWRITE SET::INSERT-IDENTITY))
...
(SET::CAR-INSERT-NIL (7 1 (:REWRITE SET::INSERT-IDENTITY))
                     (2 2 (:TYPE-PRESCRIPTION SET::IN-TYPE))
                     (2 2 (:REWRITE SET::SUBSET-IN))
                     (2 1 (:REWRITE SET::IN-TAIL))
                     (1 1 (:REWRITE SET::INSERT-WHEN-EMPTY))
                     ...
                     (1 1 (:DEFINITION SET::IN)))
(SET::SUBSET-SINGLETONS-HACK (7 1 (:REWRITE SET::INSERT-IDENTITY))
                             (2 2 (:TYPE-PRESCRIPTION SET::IN-TYPE))
                             (2 2 (:REWRITE SET::SUBSET-IN))
                             (2 1 (:REWRITE SET::IN-TAIL))
                             (1 1 (:REWRITE SET::INSERT-WHEN-EMPTY))
                             (1 1 (:DEFINITION SET::IN)))
(SET::SETP-OF-SINGLETON (3 1 (:REWRITE SET::NONEMPTY-MEANS-SET))
                        (2 2 (:TYPE-PRESCRIPTION SET::EMPTY-TYPE))
                        (1 1 (:REWRITE SET::IN-SET))
                        (1 1 (:REWRITE DEFAULT-CDR)))
(SET::IN-OF-SINGLETON-HACK (29 3 (:REWRITE SET::IN-TAIL))
...
(SET::EMPTY-WHEN-SETP-MEANS-NIL (11 3 (:REWRITE SET::NONEMPTY-MEANS-SET))
                                (3 3 (:REWRITE SET::IN-SET)))
(SET::EMPTY-IMPLIES-NOT-SFIX (3 3 (:TYPE-PRESCRIPTION SET::SFIX)))
(SET::UNION-IFF (728 6 (:REWRITE SET::INSERT-IDENTITY))
...
(SET::DELETE-OF-UNION-PUSH-INTO-BOTH
     ...
     (2 2 (:DEFINITION NOT)))
(SET::SUBSET-OF-TWO-UNIONS (4797 95 (:DEFINITION SET::IN))
                           (3770 847
                                 (:REWRITE SET::EMPTY-WHEN-SETP-MEANS-NIL))
...
(SET::INSERT-WHEN-EMPTY-2 (21 3 (:REWRITE SET::INSERT-IDENTITY))
                          (14 3
                              (:REWRITE SET::EMPTY-WHEN-SETP-MEANS-NIL))
...
(SET::TAIL-OF-SINGLETON (6 2
                        ...
                        (2 2 (:TYPE-PRESCRIPTION SET::EMPTY-TYPE))
                        (1 1 (:REWRITE DEFAULT-CDR)))
(SET::HACKA (20 4 (:REWRITE SET::IN-TAIL))
            ...
            (3 1
               (:REWRITE SET::EMPTY-IMPLIES-NOT-SFIX))
            (1 1 (:REWRITE SET::SFIX-WHEN-NOT-SETP)))
(SET::FW (61 4 (:REWRITE SET::SUBSET-IN-2))
...
(SET::SUBSET-OF-DELETE (14449 213 (:DEFINITION SET::IN))
...
(SET::TAIL-WHEN-NOT-SETP (2 2 (:TYPE-PRESCRIPTION SET::SFIX)))
