...
(LIST::2SET (135 5 (:REWRITE SET::INSERT-IDENTITY))
...
(SET::SETP-2SET (81 3 (:REWRITE SET::INSERT-IDENTITY))
...
(SET::CONSP-OF-2LIST (10 1
                     ...
                     (1 1 (:REWRITE SET::IN-SET)))
(SET::SFIX-WHEN-NOT-SETP (5 5 (:TYPE-PRESCRIPTION SET::SFIX)))
(SET::2SET-OF-2LIST
     (3356 52 (:DEFINITION SET::IN))
     (2169 136 (:REWRITE SET::IN-TAIL))
     (1540 292 (:REWRITE SET::SUBSET-IN))
     ...
     (536 12 (:REWRITE SET::CDR-OF-2LIST))
     (395 109 (:REWRITE SET::IN-TAIL-OR-HEAD))
     (370 51 (:REWRITE SET::EMPTY-SUBSET))
     (332 51 (:REWRITE SET::EMPTY-SUBSET-2))
     (233 30 (:REWRITE SET::NEVER-IN-EMPTY))
     (184 12 (:REWRITE SET::CAR-OF-2LIST))
     (118 12 (:REWRITE SET::CONSP-OF-2LIST))
...
(SET::IN-OF-2SET (551 78 (:REWRITE SET::IN-TAIL))
                 (302 41
                      (:REWRITE SET::DOUBLE-CONTAINMENT-EXPENSIVE))
...
(SET::MEMBERP-OF-2LIST
     ...
     (2 2
        (:REWRITE LIST::MEMBERP-OF-CONS-CHEAP)))
(SET::2SET-REWRAP (65 5 (:REWRITE SET::INSERT-IDENTITY))
...
(SET::2SET-OF-CONS (65 5 (:REWRITE SET::INSERT-IDENTITY))
                   (55 5 (:REWRITE SET::IN-OF-2SET))
                   (15 15
                       (:TYPE-PRESCRIPTION LIST::MEMBERP-TYPE-1))
                   (15 15 (:TYPE-PRESCRIPTION LIST::MEMBERP))
...
(SET::REMOVE-2LIST (3164 8 (:DEFINITION REMOVE-EQUAL))
                   (2983 70 (:DEFINITION SET::IN))
                   (2244 1
                         (:DEFINITION LIST::SETEQUIV-REMOVE-DEFINITION))
                   ...
                   (4 4
                      (:REWRITE LIST::MEMBERP-OF-NON-CONSP-CHEAP))
                   (2 2 (:REWRITE DEFAULT-CDR)))
(SET::DELETE-2SET (1229 14 (:DEFINITION REMOVE-EQUAL))
...
(SET::EMPTY-2SET (75 6 (:REWRITE SET::INSERT-IDENTITY))
                 ...
                 (2 2 (:TYPE-PRESCRIPTION SET::SETP-TYPE))
                 (1 1 (:REWRITE SET::IN-SET)))
(SET::CONSP-2LIST (5 1 (:DEFINITION SET::2LIST))
