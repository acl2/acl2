(SET::MULTIAPPEND)
(SET::MULTIAPPEND-SET (62 62
                          (:TYPE-PRESCRIPTION SET::MULTIAPPEND))
...
(SET::LISTSETP-OF-MULTIAPPEND
     ...
     (1 1 (:TYPE-PRESCRIPTION SET::SFIX)))
(SET::MULTIAPPEND-2-INDUCTION (8 8 (:TYPE-PRESCRIPTION SET::SFIX)))
(SET::MULTIAPPEND-IN
     ...
     (122 2
          (:REWRITE SET::ALL-SFIX-NOT<TRUE-LISTP>))
