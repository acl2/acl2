(HYPOTHESIS-PARITY)
(CONCLUSION-PARITY)
(APPLY-FOR-DEFEVALUATOR (4 2 (:TYPE-PRESCRIPTION RETURN-LAST))
                        (2 2
                           (:TYPE-PRESCRIPTION THROW-NONEXEC-ERROR)))
(CONS-EV (63 2 (:DEFINITION ACL2-COUNT))
...
(CONS-EV-CONSTRAINT-1 (10 2 (:DEFINITION ASSOC-EQUAL))
                      (6 6 (:REWRITE DEFAULT-CAR))
                      (4 4 (:REWRITE DEFAULT-CDR)))
(CONS-EV-CONSTRAINT-2 (4 4 (:REWRITE DEFAULT-CAR))
                      (2 2 (:REWRITE DEFAULT-CDR)))
(CONS-EV-CONSTRAINT-3 (15 15 (:REWRITE DEFAULT-CAR))
                      (14 2 (:DEFINITION PAIRLIS$))
                      (12 12 (:REWRITE DEFAULT-CDR))
                      (4 2 (:REWRITE EV-LST-COMMUTES-CDR))
                      (4 2 (:REWRITE EV-COMMUTES-CAR)))
(CONS-EV-CONSTRAINT-4)
(CONS-EV-CONSTRAINT-5 (2 2 (:REWRITE DEFAULT-CDR))
                      (2 2 (:REWRITE DEFAULT-CAR)))
(CONS-EV-CONSTRAINT-6)
(CONS-EV-CONSTRAINT-7 (5 5 (:REWRITE DEFAULT-CAR))
                      (1 1 (:REWRITE DEFAULT-CDR)))
(CONS-EV-CONSTRAINT-8 (9 9 (:REWRITE DEFAULT-CAR))
                      (5 5 (:REWRITE DEFAULT-CDR)))
(CONS-EV-CONSTRAINT-9 (9 9 (:REWRITE DEFAULT-CAR))
                      (5 5 (:REWRITE DEFAULT-CDR)))
(CONS-EV-CONSTRAINT-10 (11 11 (:REWRITE DEFAULT-CAR))
