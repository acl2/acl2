...
(NINTP-1)
(NINTP-2)
(LEAVES (1965 943 (:REWRITE DEFAULT-+-2))
        (1264 943 (:REWRITE DEFAULT-+-1))
...
(COLLECT-BAGS)
(META-INTEGERP)
(NIQ-BOUNDS (95 81 (:REWRITE DEFAULT-<-2))
...
(FLOOR-BOUNDS-2 (3 3 (:REWRITE DEFAULT-UNARY-/))
...
(IND-HINT (32 8 (:DEFINITION O-FIRST-EXPT))
          (28 28 (:REWRITE DEFAULT-*-2))
          (28 28 (:REWRITE DEFAULT-*-1))
...
(LOGAND-BOUNDS (386 300 (:REWRITE DEFAULT-*-2))
...
(LOGAND-THM (180 4 (:DEFINITION BINARY-LOGAND))
...
(INTP-+)
(INTP-*)
(LEAVES (341 341 (:REWRITE DEFAULT-CDR))
...
(BIG-TREE (22 22
          ...
          (11 11
              (:REWRITE TERMP-IMPLIES-PSEUDO-TERMP)))
(BAG-LEAVES (256 4 (:DEFINITION PSEUDO-TERMP))
...
(BAG-TERMS (5594 66 (:DEFINITION BINARY-LOGAND))
...
(SUBTRACT-LEAF)
(TRUE-LISTP-SUBTRACT-LEAF (49 36 (:REWRITE DEFAULT-CDR))
                          (32 24 (:REWRITE DEFAULT-CAR)))
(SUBTRACT-BAG (679 34 (:DEFINITION SUBTRACT-LEAF))
              (373 291 (:REWRITE DEFAULT-CDR))
              (289 204 (:REWRITE DEFAULT-CAR)))
(TRUE-LISTP-SUBTRACT-BAG (194 10 (:DEFINITION SUBTRACT-LEAF))
                         (116 87 (:REWRITE DEFAULT-CDR))
                         (81 58 (:REWRITE DEFAULT-CAR))
                         (69 69 (:TYPE-PRESCRIPTION SUBTRACT-LEAF))
                         (28 14 (:DEFINITION TRUE-LISTP)))
(COLLECT-BAGS-INTP (840 12 (:DEFINITION SUBTRACT-BAG))
...
(COLLECT-BAGS-NON-INTP (816 12 (:DEFINITION SUBTRACT-BAG))
...
(PSEUDO-TERM-LIST-LISTP-COLLECT-BAGS-NON-INTP
     ...
     (20 20
         (:TYPE-PRESCRIPTION COLLECT-BAGS-NON-INTP)))
(PSEUDO-TERM-LIST-LISTP-COLLECT-BAGS
     ...
     (39 39
         (:TYPE-PRESCRIPTION COLLECT-BAGS-INTP))
...
(PSEUDO-TERM-LIST-LISTP-IMPLIES-TRUE-LIST-LISTP
     ...
     (8 8
        (:REWRITE TERMP-IMPLIES-PSEUDO-TERMP)))
(META-INTEGERP (11222 558
                      (:DEFINITION PSEUDO-TERM-LIST-LISTP))
...
(TREE-2)
(TREES (1974 1512 (:REWRITE DEFAULT-CAR))
...
(BIG-TREE-2)
(BIG-TREE-BIG-TREE-2 (2123 1232 (:REWRITE DEFAULT-CAR))
                     ...
                     (18 14 (:REWRITE DEFAULT-*-2)))
(TREE-2-LEAVES (509 411 (:REWRITE DEFAULT-CAR))
               ...
               (25 18 (:REWRITE DEFAULT-*-2)))
(ACL2-NUMBERP-TREE-2 (365 200 (:REWRITE DEFAULT-CAR))
                     ...
                     (1 1 (:REWRITE DEFAULT-*-2)))
(SUBTRACT-LEAF-GOOD-+ (551 331 (:REWRITE DEFAULT-CAR))
...
(SUBTRACT-LEAF-GOOD-* (1337 766 (:REWRITE DEFAULT-CAR))
...
(SUBTRACT-BAG-GOOD-+ (1249 719 (:REWRITE DEFAULT-CAR))
...
(SUBTRACT-BAG-GOOD-* (3527 2096 (:REWRITE DEFAULT-CAR))
                     ...
                     (3 3 (:REWRITE ARITH-FOLD-CONSTS-IN-*)))
(COLLECT-BAGS-INTP-GOOD-+ (3746 67 (:DEFINITION SUBTRACT-BAG))
...
(COLLECT-BAGS-INTP-GOOD-* (3746 67 (:DEFINITION SUBTRACT-BAG))
                          ...
                          (1 1
                             (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(COLLECT-BAGS-GOOD (19408 290 (:DEFINITION SUBTRACT-BAG))
...
(BIG-TREE-TERM (46 32 (:REWRITE DEFAULT-CAR))
               ...
               (3 2 (:REWRITE DEFAULT-*-2))
               (3 2 (:REWRITE DEFAULT-*-1)))
(META-INTEGERP-CORRECT (1738 1368 (:REWRITE DEFAULT-CAR))
