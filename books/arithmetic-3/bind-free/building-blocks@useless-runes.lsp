(NUMERIC-CONSTANT-P (1 1 (:REWRITE TERMP-IMPLIES-PSEUDO-TERMP))
                    (1 1 (:REWRITE DEFAULT-CDR))
                    (1 1 (:REWRITE DEFAULT-CAR)))
(RATIONAL-CONSTANT-P (1 1 (:REWRITE TERMP-IMPLIES-PSEUDO-TERMP))
                     (1 1 (:REWRITE DEFAULT-CDR))
                     (1 1 (:REWRITE DEFAULT-CAR)))
(NEGATIVE-ADDENDS-P (485 236 (:REWRITE DEFAULT-+-2))
                    (346 40 (:DEFINITION LENGTH))
                    (310 236 (:REWRITE DEFAULT-+-1))
...
(WEAK-NEGATIVE-ADDENDS-P (485 236 (:REWRITE DEFAULT-+-2))
                         (346 40 (:DEFINITION LENGTH))
                         (310 236 (:REWRITE DEFAULT-+-1))
                         (246 48 (:DEFINITION LEN))
                         (184 46 (:REWRITE COMMUTATIVITY-OF-+))
