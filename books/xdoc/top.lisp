...
<tt>:doc</tt>, and so on."
  ...
  :long "<h3>Starting Points</h3>

<dl>
<dt>@(csee defxdoc)</dt>
<dd>How to use write XDOC documentation.</dd>

<dt>@(csee manual-generation)</dt>
<dd>How to convert your XDOC documentation into HTML and other formats.</dd>

<dt>@(csee emacs-web-integration)</dt>
<dd>How to get direct links from the HTML documentation into emacs.</dd>
</dl>")
...
<dl>
 <dt>@(csee markup)</dt>
 <dd>Covers the basic formatting commands</dd>

 <dt>@(csee preprocessor)</dt>
 <dd>Describes the XDOC preprocessor, which inserts function definitions,
theorems, topic links, etc.</dd> 
</dl>
...
tags, i.e., <tt>@@(call fib)</tt> might become &lt;tt&gt;(fib x)&lt;/tt&gt;.</p>
...
fn)</tt> directives.  One good reason to use <tt>srclink</tt> is to link to 
