...
(PROGN
 (DEFMACRO SYMBOLS::*ACL2-SYMBOLS*0 NIL
           ''(GROUND-ZERO ACL2-WRAP FIND-POSSIBLE-PUT
                          ...
                          PRINT-ALL-PC-HELP PRINT-ALL-PC-HELP-FN
                          PRINT-PC-HELP-REC PRINT-HELP-SEPARATOR
                          ...
                          *DEFAULT-S-REPEAT-LIMIT*
                          ...
                          PC-HELP!-FN STATE-ONLY PC-HELP-FN
 ...
 (DEFMACRO
      ...
      ''(PC-PRIMITIVE-DEFUN-FORM REMOVE-DOC ADD-PC-DOC-HEADER
 ...
 (DEFMACRO
      ...
      ''(GET-UNAMBIGUOUS-XARGS-FLG GET-UNAMBIGUOUS-XARGS-FLG1
                                   ...
                                   TRANS1-FN TRANS TRANS-FN HELP HELP-FN
                                   PRINT-TOP-DOC-TOPICS DOCS DOCS-FN
                                   GET-DOCS-APROPOS GET-DOCS-APROPOS1
                                   GET-DOC-SECTION-SYMBOLS
                                   MORE-DOC MORE-DOC-FN
                                   DOC! DOC PRINT-DOC-OUTLINE-LST
                                   PRINT-DOC-OUTLINE MORE!
                                   MORE DOC!-FN MORE-FN DOC-FN END-DOC
                                   PRINT-DOC-DWIM FIND-LIKELY-NEAR-MISSES
                                   DEGREE-OF-MATCH DEGREE-OF-MATCH1
                                   DEGREE-OF-MATCH2 PRINT-DOC-LST
                                   PRINT-DOC PSTATE-GLOBAL-LET*
                                   GET-DOC-SECTION PRINT-DOC-STRING-PART
                                   PRINT-DOC-STRING-PART1
                                   LOOKUP-FMT-ALIST READ-POINTER-AND-TEXT
                                   READ-POINTER-AND-TEXT2
                                   READ-POINTER-AND-TEXT1
                                   APPLY-CHAR-SUBST-TABLE
                                   APPLY-CHAR-SUBST-TABLE1
                                   ASSOC-CHAR-ALIST-STRINGP
                                   DOC-SCAN-PAST-TILDE
                                   DOC-SCAN-PAST-TILDE-ARG
                                   DOC-SCAN-PAST-TILDE-KEY
                                   DOC-MARKUP-TABLE *TERMINAL-MARKUP-TABLE*
                                   DOC-FMT-ALIST DOC-CHAR-SUBST-TABLE
                                   SET-DOC-CHAR-SUBST-TABLE
                                   DOC-CHAR-SUBST-TABLE-P
                                   SAVE-MORE-DOC-STATE
                                   LENGTH-PREFIX PRINC-PREFIX
                                   DOC-PREFIX USE-DOC-STRING-DE-INDENT
                                   GET-DOC-STRING-DE-INDENT
                                   GET-DOC-STRING-DE-INDENT1 GET-DOC-STRING
                                   ACCESS-DOC-STRING-DATA-BASE
                                   REDUNDANT-LABELP
                                   GET-EVENT REDEFINED-WARNING
                                   PUTPROP-UNLESS UPDATE-DOC-DATA-BASE-LST
                                   UPDATE-DOC-DATA-BASE
                                   PUT-CITED-BYS UPDATE-ALPHA-<-ALIST
                                   MERGE-SORT-ALPHA-< MERGE-ALPHA-<
                                   ALPHA-< GET-CITES TRANSLATE-DOC-LST
                                   TRANSLATE-DOC CHK-WELL-FORMED-DOC-STRING
                                   CHK-DOC-STRING-CITATIONS
                                   DOC-TOPICP READ-DOC-STRING-CITATIONS
                                   READ-DOC-STRING-CITATIONS1
                                   GET-ONE-LINER-AS-STRING
                                   GET-ONE-LINER-AS-STRING1
                                   SCAN-TO-DOC-STRING-PART
                                   SCAN-TO-DOC-STRING-PART1
                                   SCAN-PAST-TILDE-SLASH
                                   SCAN-PAST-NEWLINES SCAN-PAST-NEWLINE
                                   READ-SYMBOL-FROM-STRING
                                   READ-SYMBOL-FROM-STRING2
                                   READ-SYMBOL-FROM-STRING1
 ...
 (DEFMACRO
      ...
      ''(COMMAND-BLOCK-NAMES1 REVERT-WORLD-ON-ERROR
                              ...
                              ZAP-DOC-STRING-FROM-EVENT-FORM
                              ZAP-DOC-STRING-FROM-EVENT-FORM/DOC-KEYWORD
                              ZAP-DOC-STRING-FROM-EVENT-FORM/MUTUAL-RECURSION
                              ZAP-DOC-STRING-FROM-EVENT-FORM/THIRD-ARG
                              ZAP-DOC-STRING-FROM-EVENT-FORM/SECOND-ARG
                              ZAP-DOC-STRING-FROM-EVENT-FORM/ALL-BUT-LAST
                              *ZAPPED-DOC-STRING*
                              DOC-STRINGP STRING-SEARCH STRING-SEARCH1
