; ACL2 Euclidean Domain books -- Book 4da -- Example: Integers.
;  The Integers are shown to be an Euclidean Domain with
;  unique factorization. Here Size is abs; Quotient is round
...
;;   Here rnd-rem is defined for integers x and nonzero integers y by
