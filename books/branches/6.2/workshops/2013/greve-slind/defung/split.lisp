...
(defthm true-fn-from-x
  (implies x (true-fn x))
  :rule-classes (:type-prescription))

(defthm not-true-fn-from-not-x
  (implies (not x) (not (true-fn x)))
  :rule-classes (:type-prescription))

(defthm true-fn-id
  (equal (equal (true-fn x) x) t)
  :hints (("Goal" :in-theory (enable true-fn))))
