...
(local
 (defthm logand-expt-4-1
   ...
   :hints (("goal"  :in-theory (disable expt-compare)
            :use ((:instance logand-slice (x (- (1- (expt 2 n)) (expt 2 l))))
                  (:instance expt-strong-monotone (n l) (m n)))))))
|#

(local
 (defthm logand-expt-4-2
   (implies (and (integerp n) (>= n 0)
                 (integerp k) (>= k 0)
                 (integerp l) (>= l 0) (< l k)
                 (< k n))
   ...
   :hints (("goal" :in-theory (e/d (bits
                                    ) ( EXPT-EXCEEDS-2 ;bozo why needed?
                                    expt-compare
                                    ))
            :use ((:instance logand-slice (x (- (1- (expt 2 n)) (expt 2 l))))
                  (:instance expt-strong-monotone (n l) (m n))
...
(local
 (defthm logand-expt-4-3
   ...
   :rule-classes ()
   :hints (("goal"   :in-theory (disable expt-compare)
            :use ((:instance expt-strong-monotone (n l) (m n))
;			(:instance expt-pos (x l))
                  (:instance mod-does-nothing (m (- (1- (expt 2 n)) (expt 2 l)))
                             (n (expt 2 n))))))))

(local
 (defthm logand-expt-4-4
   (implies (and (integerp n) (>= n 0)
                 (integerp k) (>= k 0)
                 (integerp l) (>= l 0) (< l k)
                 (< k n))
...
(local
 (defthm logand-expt-4-5
   ...
   :hints (("goal" :hands-off (expt mod fl)
            :use ((:instance logand-expt-4-2)
                  (:instance logand-expt-4-4))))))

(local
 (defthm logand-expt-4-6
   (implies (and (integerp n) (>= n 0)
                 (integerp k) (>= k 0)
                 (integerp l) (>= l 0) (< l k)
                 (< k n))
   ...
   :rule-classes ()
   :hints (("goal" :use ((:instance expt-split (r 2) (i (- n k)) (j k)))))))

(local
 (defthm logand-expt-4-8
   (implies (and (integerp n) (>= n 0)
                 (integerp k) (>= k 0)
                 (integerp l) (>= l 0) (< l k)
                 (< k n))
 ...
 (defthm logand-expt-4-9
   (implies (and (integerp n) (>= n 0)
            ...
            (= (fl (/ (- (1- (expt 2 n)) (expt 2 l)) (expt 2 k)))
               (- (expt 2 (- n k)) 1)))
   :rule-classes ()
   :hints (("goal" :use (logand-expt-4-8
                         logand-expt-4-6)))))

(local
 (defthm logand-expt-4-10
   (implies (and (integerp n) (>= n 0)
                 (integerp k) (>= k 0)
                 (integerp l) (>= l 0) (< l k)
                 (< k n))
   ...
   :rule-classes ()
   :hints (("goal" :hands-off (expt mod fl)
            :use ((:instance logand-expt-4-5)
                  (:instance logand-expt-4-9))))))
