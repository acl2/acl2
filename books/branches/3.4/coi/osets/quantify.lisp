...
#| 
 ...
 quantify.lisp
   ...
   As you can see, all of these functions are introduced in the SET
   ...
   And so forth.  You can also remove all of the computed hints generated
   for a particular predicate using:

     (disable-hints<integerp>) 
     (enable-hints<integerp>)
...
; And then we combine the positive and negative functions to
...
; We now COMBINE the positive and negative theorems to form a
