...
(local (include-book "../support/support/logs"))
(local (include-book "../support/support/lnot"))
(local (include-book "../support/support/shft"))
(local (include-book "../support/support/cat"))
(local (include-book "../support/support/mulcat"))
(local (include-book "../support/support/encode"))
(local (include-book "../support/support/decode"))
(local (include-book "../support/support/land"))
(local (include-book "../support/support/lior"))
(local (include-book "../support/support/lxor"))
