...
;  (set-difference-theories (current-theory :here) (universal-theory 'ground-zero)))
  ...
  '((:REWRITE U-PACKAGE)
    ...
    (:EXECUTABLE-COUNTERPART BINARY-LIOR)
    (:EXECUTABLE-COUNTERPART BINARY-LXOR)
    (:DEFINITION SETBITS)
    ...
    (:REWRITE LIOR-COMMUTATIVE)
    (:REWRITE LXOR-COMMUTATIVE)
    (:REWRITE LAND-ASSOCIATIVE)
    (:REWRITE LIOR-ASSOCIATIVE)
    (:REWRITE LXOR-ASSOCIATIVE)
    (:REWRITE LAND-COMMUTATIVE-2)
    (:REWRITE LIOR-COMMUTATIVE-2)
    (:REWRITE LXOR-COMMUTATIVE-2)
    (:REWRITE LAND-COMBINE-CONSTANTS)
    (:REWRITE LIOR-COMBINE-CONSTANTS)
    (:REWRITE LXOR-COMBINE-CONSTANTS)
    (:REWRITE LAND-SELF)
    (:REWRITE LIOR-SELF)
    (:REWRITE LXOR-SELF)
    (:REWRITE LAND-0)
    (:REWRITE LIOR-0)
    (:REWRITE LXOR-0)
    (:REWRITE LAND-ONES-REWRITE)
    (:REWRITE LIOR-ONES-REWRITE)
    (:REWRITE LXOR-ONES-REWRITE)
    (:REWRITE BITS-LAND)
    (:REWRITE BITN-LAND)
    (:REWRITE BITS-LIOR)
    (:REWRITE BITN-LIOR)
    ...
    (:REWRITE LIOR-BND)
    (:LINEAR LIOR-BND)
    (:REWRITE LIOR-BVECP-2)
    (:REWRITE LIOR-CAT-CONSTANT)
    ...
    (:DEFINITION ROUNDING-MODE-P)
    (:EXECUTABLE-COUNTERPART ROUNDING-MODE-P)
    (:TYPE-PRESCRIPTION ROUNDING-MODE-P)
    ...
    (:EXECUTABLE-COUNTERPART DRND)
    (:TYPE-PRESCRIPTION DRND)
    (:REWRITE DRND-0)
    (:EXECUTABLE-COUNTERPART SMALLEST-POSITIVE-NORMAL)
    (:TYPE-PRESCRIPTION SMALLEST-POSITIVE-NORMAL)
    (:LINEAR POSITIVE-SPN)
    (:REWRITE NREPP-SPN)
    (:REWRITE SMALLEST-SPN)
    (:EXECUTABLE-COUNTERPART SMALLEST-POSITIVE-DENORMAL)
    (:TYPE-PRESCRIPTION SMALLEST-POSITIVE-DENORMAL)
    (:REWRITE POSITIVE-SPD)
    (:REWRITE DREPP-SPD)
    (:REWRITE SMALLEST-SPD)
    (:REWRITE DRND-OF-DREPP-IS-NOP)
    (:REWRITE DRND-SPN-IS-SPN-GENERAL)
    (:REWRITE DRND-TRUNC-NEVER-GOES-AWAY-FROM-ZERO)
    (:REWRITE DRND-AWAY-NEVER-GOES-TOWARD-ZERO)
    (:REWRITE DRND-INF-NEVER-GOES-DOWN)
    (:REWRITE DRND-MINF-NEVER-GOES-UP)
    (:REWRITE DRND-TRUNC-SKIPS-NO-DENORMALS)
    (:REWRITE DRND-AWAY-SKIPS-NO-DENORMALS)
    (:REWRITE DRND-INF-SKIPS-NO-DENORMALS)
    (:REWRITE DRND-MINF-SKIPS-NO-DENORMALS)
    (:REWRITE DRND-DIFF)
    (:EXECUTABLE-COUNTERPART NEXT-DENORMAL)
    (:TYPE-PRESCRIPTION NEXT-DENORMAL)
    (:REWRITE DENORMAL-SPACING)
    (:REWRITE NO-DENORMAL-IS-CLOSER-THAN-WHAT-DRND-NEAR-RETURNS)
    (:DEFINITION GEN)
    ...
    (:DEFINITION LAMT)
    (:EXECUTABLE-COUNTERPART LAMT)
    (:TYPE-PRESCRIPTION LAMT)
    (:DEFINITION LAMG)
    (:EXECUTABLE-COUNTERPART LAMG)
    (:TYPE-PRESCRIPTION LAMG)
    (:DEFINITION LAMZ)
    (:EXECUTABLE-COUNTERPART LAMZ)
    (:TYPE-PRESCRIPTION LAMZ)
    (:DEFINITION LAM1)
    (:EXECUTABLE-COUNTERPART LAM1)
    (:TYPE-PRESCRIPTION LAM1)
    (:DEFINITION LAM2)
    (:EXECUTABLE-COUNTERPART LAM2)
    (:TYPE-PRESCRIPTION LAM2)
    (:DEFINITION LAM3)
    (:EXECUTABLE-COUNTERPART LAM3)
    (:TYPE-PRESCRIPTION LAM3)
    (:DEFINITION LAM4)
    (:EXECUTABLE-COUNTERPART LAM4)
    (:TYPE-PRESCRIPTION LAM4)
    (:DEFINITION LAM0)
    (:EXECUTABLE-COUNTERPART LAM0)
    (:TYPE-PRESCRIPTION LAM0)
    (:DEFINITION LAMB)
    (:EXECUTABLE-COUNTERPART LAMB)
    (:TYPE-PRESCRIPTION LAMB)
    (:REWRITE A1)
    (:REWRITE A2)
    (:REWRITE A3)
    (:REWRITE A4)
    ...
    (:DEFINITION FIRSTN)
    (:EXECUTABLE-COUNTERPART FIRSTN)
    (:TYPE-PRESCRIPTION FIRSTN)
    (:INDUCTION FIRSTN)
    (:DEFINITION DROPN)
    (:EXECUTABLE-COUNTERPART DROPN)
    (:TYPE-PRESCRIPTION DROPN)
    (:INDUCTION DROPN)
    (:DEFINITION WCMP)
    (:EXECUTABLE-COUNTERPART WCMP)
    (:TYPE-PRESCRIPTION WCMP)
    (:DEFINITION OCMP-AUX)
    (:EXECUTABLE-COUNTERPART OCMP-AUX)
    (:TYPE-PRESCRIPTION OCMP-AUX)
    (:INDUCTION OCMP-AUX)
    (:DEFINITION OCMP)
    (:EXECUTABLE-COUNTERPART OCMP)
    (:TYPE-PRESCRIPTION OCMP)
    (:DEFINITION OMEGA-TERM)
    (:EXECUTABLE-COUNTERPART OMEGA-TERM)
    (:TYPE-PRESCRIPTION OMEGA-TERM)
    (:DEFINITION OMEGA)
    (:EXECUTABLE-COUNTERPART OMEGA)
    (:TYPE-PRESCRIPTION OMEGA)
    (:DEFINITION O-MAX)
    (:EXECUTABLE-COUNTERPART O-MAX)
    (:TYPE-PRESCRIPTION O-MAX)
    (:DEFINITION LIMITPART)
    (:EXECUTABLE-COUNTERPART LIMITPART)
    (:TYPE-PRESCRIPTION LIMITPART)
    (:INDUCTION LIMITPART)
    (:DEFINITION NATPART)
    (:EXECUTABLE-COUNTERPART NATPART)
    (:TYPE-PRESCRIPTION NATPART)
    (:INDUCTION NATPART)
    (:DEFINITION LIMITP)
    (:EXECUTABLE-COUNTERPART LIMITP)
    (:TYPE-PRESCRIPTION LIMITP)
    (:DEFINITION OLEN)
    (:EXECUTABLE-COUNTERPART OLEN)
    (:TYPE-PRESCRIPTION OLEN)
    (:INDUCTION OLEN)
    (:DEFINITION O-LAST-EXPT)
    (:EXECUTABLE-COUNTERPART O-LAST-EXPT)
    (:TYPE-PRESCRIPTION O-LAST-EXPT)
    (:INDUCTION O-LAST-EXPT)
    (:DEFINITION OB+)
    (:EXECUTABLE-COUNTERPART OB+)
    (:TYPE-PRESCRIPTION OB+)
    (:INDUCTION OB+)
    (:DEFINITION O-)
    ...
    (:INDUCTION O-)
    (:DEFINITION COUNT1)
    (:EXECUTABLE-COUNTERPART COUNT1)
    (:TYPE-PRESCRIPTION COUNT1)
    (:INDUCTION COUNT1)
    (:DEFINITION COUNT2)
    (:EXECUTABLE-COUNTERPART COUNT2)
    (:TYPE-PRESCRIPTION COUNT2)
    (:DEFINITION PADD)
    (:EXECUTABLE-COUNTERPART PADD)
    (:TYPE-PRESCRIPTION PADD)
    (:INDUCTION PADD)
    (:DEFINITION PMULT)
    (:EXECUTABLE-COUNTERPART PMULT)
    (:TYPE-PRESCRIPTION PMULT)
    (:INDUCTION PMULT)
    (:DEFINITION OB*)
    (:EXECUTABLE-COUNTERPART OB*)
    (:TYPE-PRESCRIPTION OB*)
    (:INDUCTION OB*)
    (:DEFINITION O^1)
    (:EXECUTABLE-COUNTERPART O^1)
    (:TYPE-PRESCRIPTION O^1)
    (:INDUCTION O^1)
    (:DEFINITION O^2)
    (:EXECUTABLE-COUNTERPART O^2)
    (:TYPE-PRESCRIPTION O^2)
    (:DEFINITION O^3H)
    (:EXECUTABLE-COUNTERPART O^3H)
    (:TYPE-PRESCRIPTION O^3H)
    (:INDUCTION O^3H)
    (:DEFINITION O^3)
    (:EXECUTABLE-COUNTERPART O^3)
    (:TYPE-PRESCRIPTION O^3)
    (:DEFINITION O^4)
    (:EXECUTABLE-COUNTERPART O^4)
    (:TYPE-PRESCRIPTION O^4)
    (:DEFINITION OB^)
    (:EXECUTABLE-COUNTERPART OB^)
    (:TYPE-PRESCRIPTION OB^)
    (:INDUCTION OB^)
    ...
    (:DEFINITION COPYN)
    (:EXECUTABLE-COUNTERPART COPYN)
    (:TYPE-PRESCRIPTION COPYN)
    (:INDUCTION COPYN)
    (:EXECUTABLE-COUNTERPART CTOA)
    (:TYPE-PRESCRIPTION CTOA)
    (:REWRITE CTOA-<-EQUIV)
    (:FORWARD-CHAINING |oc.x  <=>  oa(ctoa.x)|)
    (:REWRITE |oc.x  <=>  oa(ctoa.x)|)
    (:EXECUTABLE-COUNTERPART ATOC)
    (:TYPE-PRESCRIPTION ATOC)
    (:REWRITE |oa.x  <=>  oc(atoc.x)|)
    (:REWRITE ATOC-<-EQUIV)
    (:WELL-FOUNDED-RELATION E0-ORDINAL-WELL-FOUNDED-CNF)
...
;   (set-difference-theories cgz here)))
  ...
  '((:DEFINITION FLOOR)
    ...
    (:INDUCTION BINARY-LOGAND)
    (:DEFINITION BINARY-LOGIOR)
    (:DEFINITION LOGORC1)
    (:DEFINITION BINARY-LOGEQV)
    (:DEFINITION BINARY-LOGXOR)))
