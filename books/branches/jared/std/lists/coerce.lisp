...
(defsection chars
  :parents (std/lists coerce)
  :short "@(call chars) is just shorthand for @('(coerce x 'list)')."
  :long "<p>This macro is useful for shortening up code and theorems about
strings.</p> @(def chars)"
...
(defsection std/lists/coerce
  :parents (std/lists coerce)
  :short "Lemmas about @(see coerce) available in the @(see std/lists)
library."
