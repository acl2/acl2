...
(defmacro add-thm (n) ; name &key spec (g-bindings '(4bit-default-bindings)))
...
(add-thm 64)  
(add-thm 128)  
(add-thm 256) ; took 10.14 seconds (with glucose 2.2)
(add-thm 512) ; took 49.71 seconds (with glucose 2.2)
