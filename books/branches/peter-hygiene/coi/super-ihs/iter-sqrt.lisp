 ...
 (local
  (defthm sqrt-epsilon-delta-aux-6
    ...
    :hints (("goal" :in-theory (enable
                                *-PRESERVES->=-FOR-NONNEGATIVES ;bzo enable this globally?
...
(encapsulate
 ...
 (local
  (defthm ceiling-greater-than-quotient-aux
    ...
    :hints (("Goal" :in-theory (disable <-*-/-LEFT
 ...
 (defthm ceiling-greater-than-quotient
   (implies (and (rationalp x)
                 ...
                 (> y 0))
            (>= (ceiling x y) (/ x y)))
   :hints ( ("goal" :in-theory (e/d (ceiling)
                                                          ...
                                                          (/ epsilon
                                                             (+ (if (< x 1)
                                                                ...
                                                                (if (< x 1)
                                                                    1
                                                                  x)))))))
             :in-theory (e/d ((:REWRITE *-PRESERVES->=-FOR-NONNEGATIVES)
                              )
                             ( ceiling
