(QUOTIENT-CANCELLATION (82 81 (:REWRITE DEFAULT-<-1))
...
(QUOTIENT-NUMER-DENOM-LEMMA (3 1 (:LINEAR X*Y>1-POSITIVE))
                            (1 1 (:REWRITE DEFAULT-<-2))
                            (1 1 (:REWRITE DEFAULT-<-1)))
(NUMER-DENOM-LEMMA-SILLY (8 7 (:REWRITE DEFAULT-*-2))
...
(NUMER-DENOM-LEMMA (48 34 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
...
(QUOTIENT-NUMER-DENOM-LEMMA2-SILLY
     ...
     (2 2
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(QUOTIENT-NUMER-DENOM-LEMMA2 (21 20 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
                             ...
                             (2 2 (:REWRITE FOLD-CONSTS-IN-*)))
(QUOTIENT-NUMER-DENOM-LEMMA3 (47 47 (:REWRITE DEFAULT-*-2))
...
(QUOTIENT-NUMER-DENOM (32 30 (:REWRITE DEFAULT-*-2))
                      (30 30 (:REWRITE DEFAULT-*-1))
...
(QUOTIENT-LOWER-BOUND (78 72 (:REWRITE DEFAULT-<-2))
...
(QUOTIENT-UPPER-BOUND (39 3
                      ...
                      (2 2 (:REWRITE NUMERATOR-WHEN-INTEGERP))
                      (2 2 (:REWRITE DEFAULT-UNARY-/)))
(TRUNCATE-LOWER-BOUND (99 93 (:REWRITE DEFAULT-<-2))
...
(TRUNCATE-UPPER-BOUND (130 10
                      ...
                      (2 2 (:REWRITE DEFAULT-DENOMINATOR))
                      (1 1 (:REWRITE FOLD-CONSTS-IN-*)))
(REM-LOWER-BOUND (99 93 (:REWRITE DEFAULT-<-2))
                 (94 93 (:REWRITE DEFAULT-<-1))
