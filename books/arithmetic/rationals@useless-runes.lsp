(DENOMINATOR-UNARY-MINUS (79 1 (:DEFINITION NONNEG-INT-GCD))
...
(NUMERATOR-GOES-DOWN-BY-INTEGER-DIVISION
     ...
     (2 2 (:DEFINITION FIX)))
(DENOMINATOR-PLUS (855 13 (:DEFINITION NONNEG-INT-MOD))
                  (733 30
                       (:REWRITE NONNEG-INT-MOD-WHEN-DIVIDES))
                  (167 18
                  ...
                  (3 1 (:DEFINITION IFF)))
(NUMERATOR-MINUS (79 1 (:DEFINITION NONNEG-INT-GCD))
                 (64 1 (:DEFINITION NONNEG-INT-MOD))
                 (48 4
                     (:REWRITE NONNEG-INT-MOD-WHEN-DIVIDES))
                 (24 1 (:REWRITE NONNEG-INT-MOD-MINUS-0))
                 ...
                 (1 1 (:REWRITE INVERSE-OF-*))
                 (1 1 (:REWRITE EQUAL-DENOMINATOR-1)))
(NUMERATOR-/X (96 1 (:DEFINITION NONNEG-INT-GCD))
