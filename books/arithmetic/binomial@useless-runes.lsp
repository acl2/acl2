...
(FACTORIAL-N/N-1 (40 4 (:LINEAR X*Y>1-POSITIVE))
...
(FACTORIAL-N/N-1/X (20 2 (:LINEAR X*Y>1-POSITIVE))
                   (13 2 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
                   (7 5 (:REWRITE DEFAULT-*-2))
...
(CHOOSE-REDUCTION (223 30 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
...
(CHOOSE-MK (6 5 (:REWRITE DEFAULT-<-1))
           (5 5 (:REWRITE DEFAULT-<-2))
           (1 1 (:REWRITE DEFAULT-+-2))
           (1 1 (:REWRITE DEFAULT-+-1)))
(CHOOSE-MK-CHOOSE (68 8 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
...
(BINOMIAL-EXPANSION-PASCAL-TRIANGLE
     ...
     (3 3
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(SILLY-INEQUALITY)
(CHOOSE-K-K (13 2 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
            (5 3 (:REWRITE DEFAULT-*-2))
...
(BINOMIAL-EXPANSION-PASCAL-TRIANGLE-CORRECT
     ...
     (2 2 (:REWRITE EXPONENTS-ADD)))
(BINOMIAL-EXPANSION-ZERO (4 3 (:REWRITE DEFAULT-<-2))
...
(CHOOSE-0-N (13 2 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
...
(BINOMIAL-THEOREM-INDUCTION-LEMMA
     (225 1
          (:DEFINITION BINOMIAL-EXPANSION-PASCAL-TRIANGLE))
     (211 36 (:REWRITE DEFAULT-*-2))
     (158 5 (:DEFINITION CHOOSE))
     (87 1
         (:DEFINITION BINOMIAL-EXPANSION-TRIANGLE))
     (83 58
         (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-INTEGERP))
     (77 4 (:REWRITE COMMUTATIVITY-2-OF-*))
     (76 76
         (:TYPE-PRESCRIPTION FACTORIAL-POSITIVE-INTEGER))
...
(N-EXPT (2 2
           (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(DISTRIBUTIVITY-2 (11 8 (:REWRITE DEFAULT-*-2))
                  (11 8 (:REWRITE DEFAULT-*-1))
                  (8 8
                     (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                  ...
                  (2 2 (:REWRITE DEFAULT-<-2))
                  (2 2 (:REWRITE DEFAULT-<-1)))
(BINOMIAL-THEOREM-FAKE (79 53 (:REWRITE DEFAULT-+-2))
                       ...
                       (12 12
                           (:TYPE-PRESCRIPTION BINOMIAL-EXPANSION))
...
(N-EXPT-EXPT (158 158
             ...
             (3 1 (:REWRITE <-0-+-NEGATIVE-1)))
(BINOMIAL-THEOREM (80 2 (:DEFINITION BINOMIAL-EXPANSION))
                  (21 21
                      (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-RATIONALP))
                  (21 21
                      (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-POSITIVE))
