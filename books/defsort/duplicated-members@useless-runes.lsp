(COLLECT-ADJACENT-DUPLICATES (68 29 (:REWRITE DEFAULT-+-2))
...
(COLLECT-ADJACENT-DUPLICATES-WHEN-NOT-CONSP-OF-CDR
     ...
     (1 1
        (:REWRITE COLLECT-ADJACENT-DUPLICATES-WHEN-NOT-CONSP)))
(COLLECT-ADJACENT-DUPLICATES-OF-CONS-AND-CONS
     (88 88 (:REWRITE DEFAULT-CDR))
     (53 26
         (:REWRITE COLLECT-ADJACENT-DUPLICATES-WHEN-NOT-CONSP-OF-CDR))
     (44 44 (:REWRITE DEFAULT-CAR))
     (26 26
         (:REWRITE COLLECT-ADJACENT-DUPLICATES-WHEN-NOT-CONSP)))
(LEMMA (737 29 (:DEFINITION MEMBER-EQUAL))
...
(LEMMA2 (9083 464 (:DEFINITION MEMBER-EQUAL))
        (4343 205 (:REWRITE SUBSETP-OF-CONS))
        (3223 3223
              (:TYPE-PRESCRIPTION COLLECT-ADJACENT-DUPLICATES))
        (1975 206
              (:REWRITE SUBSETP-IMPLIES-SUBSETP-CDR))
        (1545 66
...
(LEMMA3 (20093 223 (:REWRITE SUBSETP-OF-CONS))
        (17062 180 (:REWRITE LEMMA2))
        (12136 678 (:DEFINITION MEMBER-EQUAL))
        (2490 255
              (:REWRITE SUBSETP-IMPLIES-SUBSETP-CDR))
...
(LEMMA5 (1612 271 (:REWRITE SUBSETP-MEMBER . 1))
...
(MEMBER-EQUAL-OF-COLLECT-ADJACENT-DUPLICATES-WHEN-<<-ORDERED-P
     ...
     (3 3
        (:REWRITE COLLECT-ADJACENT-DUPLICATES-WHEN-NOT-CONSP))
     (1 1 (:REWRITE LEMMA)))
(CROCK0 (20 6 (:REWRITE <<-TRICHOTOMY))
        (18 4 (:REWRITE <<-ASYMMETRIC))
        (6 6 (:REWRITE <<-TRANSITIVE))
        (4 4 (:REWRITE DEFAULT-CAR)))
(CROCK1 (467 93 (:REWRITE SUBSETP-MEMBER . 1))
...
(CROCK3 (3189 269 (:REWRITE SUBSETP-CAR-MEMBER))
        (1937 81
              (:REWRITE DUPLICITY-WHEN-NON-MEMBER-EQUAL))
...
(NO-DUPLICATESP-EQUAL-OF-COLLECT-ADJACENT-DUPLICATES-WHEN-<<-ORDERED-P
     ...
     (539 34 (:DEFINITION MEMBER-EQUAL))
...
(ELEMENT-P-BY-DUPLICITY-IN-ELEMENT-LIST-P
 ...
 (425 47 (:DEFINITION MEMBER-EQUAL))
 (366 41
...
(ELEMENT-LIST-P-WHEN-SUBSET-OF-DUPLICATED-MEMBERS
 ...
 (32781 137
        (:DEFINITION ELEMENT-LIST-NONEMPTY-P))
 (30246 2521 (:DEFINITION MEMBER-EQUAL))
 (30209 333
        (:REWRITE ELEMENT-P-OF-CAR-WHEN-ELEMENT-LIST-P-WHEN-UNKNOWN-NIL))
 (28228
  333
...
(L1 (47 1
        (:REWRITE DUPLICITY-WHEN-NON-MEMBER-EQUAL))
    (45 1 (:REWRITE DUPLICITY-BADGUY-EXISTS))
...
(ALISTP-WHEN-HONS-DUPLICITY-ALIST-P (19 19 (:REWRITE DEFAULT-CDR))
...
(HONS-DUPLICITY-ALIST-P-OF-HONS-DUPLICITY-ALIST-AUX
     ...
     (19 16
         (:TYPE-PRESCRIPTION HONS-DUPLICITY-ALIST-AUX))
...
(IFF-OF-HONS-ASSOC-EQUAL
     (111 10 (:DEFINITION MEMBER-EQUAL))
...
(NO-DUPLICATESP-EQUAL-OF-STRIP-CARS-OF-HONS-SHRINK-ALIST
     ...
     (355 23 (:DEFINITION MEMBER-EQUAL))
...
(NO-DUPLICATESP-EQUAL-OF-STRIP-CARS-OF-HONS-DUPLICITY-ALIST
     ...
     (12 1 (:REWRITE IFF-OF-HONS-ASSOC-EQUAL))
     (6 6 (:REWRITE DEFAULT-CAR))
...
(MEMBER-EQUAL-OF-STRIP-CARS-WHEN-MEMBER-EQUAL-OF-HONS-DUPLICATED-MEMBERS-AUX
     (471 17 (:DEFINITION MEMBER-EQUAL))
...
(MEMBER-EQUAL-OF-HONS-DUPLICATED-MEMBERS-AUX
     (1294 75 (:DEFINITION MEMBER-EQUAL))
...
(NO-DUPLICATESP-EQUAL-OF-HONS-DUPLICATED-MEMBERS-AUX
     (739 45 (:DEFINITION MEMBER-EQUAL))
...
(MEMBER-EQUAL-OF-HONS-DUPLICATED-MEMBERS
     ...
     (6 1 (:DEFINITION STRIP-CARS))
     (2 2
        (:TYPE-PRESCRIPTION HONS-DUPLICITY-ALIST)))
