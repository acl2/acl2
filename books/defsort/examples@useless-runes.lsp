...
(DEFSORT-SUBST2-OK (2 2 (:REWRITE >-COMPARE<-TRANSITIVE))
                   (2 2
                      (:REWRITE >-COMPARE<-NEGATION-TRANSITIVE)))
(>-INSERTSORT)
(>-MERGESORT-EQUALS-INSERTSORT (7 5 (:REWRITE >-COMPARE<-TRANSITIVE)))
(>-INSERTSORT-PRESERVES-DUPLICITY)
(>-INSERTSORT-CREATES-COMPARABLE-LISTP)
(>-INSERTSORT-SORTS)
(>-INSERTSORT-NO-DUPLICATESP-EQUAL)
...
(DEFSORT-COMPARABLEP-OF-CAR)
(DEFSORT-COMPARABLE-LISTP-OF-CDR)
(BIGGER-ORDERED-P (13 13
                      (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
                  (7 7 (:REWRITE BIGGER-COMPARE<-TRANSITIVE))
                  (7 7
                     (:REWRITE BIGGER-COMPARE<-NEGATION-TRANSITIVE)))
(BIGGER-MERGE (18 18
                  (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
              (6 6 (:REWRITE BIGGER-COMPARE<-TRANSITIVE))
              (6 6
                 (:REWRITE BIGGER-COMPARE<-NEGATION-TRANSITIVE)))
(BIGGER-MERGE-TR (18 18
                     (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
                 (6 6 (:REWRITE BIGGER-COMPARE<-TRANSITIVE))
                 (6 6
                    (:REWRITE BIGGER-COMPARE<-NEGATION-TRANSITIVE)))
(BIGGER-MERGESORT-FIXNUM (2 2 (:REWRITE BIGGER-COMPARE<-TRANSITIVE))
                         (2 2
                            (:REWRITE BIGGER-COMPARE<-NEGATION-TRANSITIVE)))
...
(BIGGER-SORT (13 13
             ...
             (2 2
                (:REWRITE BIGGER-COMPARE<-NEGATION-TRANSITIVE)))
(DEFSORT-SUBST1-OK (23 5 (:REWRITE DEFSORT-COMPARABLEP-OF-CAR))
                   (21 10
                       (:REWRITE DEFSORT-COMPARABLEP-SUFFICIENT))
                   (12 12
                       (:REWRITE BIGGER-COMPARE<-TRANSITIVE))
                   (12 12
                       (:REWRITE BIGGER-COMPARE<-NEGATION-TRANSITIVE))
                   (11 4
                       (:REWRITE DEFSORT-COMPARABLE-LISTP-OF-CDR))
...
(BIGGER-INSERT (16 8
               ...
               (3 3
                  (:REWRITE BIGGER-COMPARE<-NEGATION-TRANSITIVE)))
(BIGGER-INSERTSORT (7 7 (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
                   (1 1 (:REWRITE BIGGER-COMPARE<-TRANSITIVE))
                   (1 1
                      (:REWRITE BIGGER-COMPARE<-NEGATION-TRANSITIVE)))
(DEFSORT-SUBST2-OK (2 2 (:REWRITE BIGGER-COMPARE<-TRANSITIVE))
                   (2 2
                      (:REWRITE BIGGER-COMPARE<-NEGATION-TRANSITIVE)))
(BIGGER-INSERTSORT)
...
(LITTLER-SORT-ORDERED-P
     (13 13
         (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
     (7 7
        (:REWRITE LITTLER-SORT-COMPARE<-TRANSITIVE))
     (7 7
        (:REWRITE LITTLER-SORT-COMPARE<-NEGATION-TRANSITIVE)))
(LITTLER-SORT-MERGE (18 18
                        (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
                    (6 6
                       (:REWRITE LITTLER-SORT-COMPARE<-TRANSITIVE))
                    (6 6
...
(LITTLER-SORT-NO-DUPLICATESP-EQUAL)
(LITTLER-SORT-TRUE-LISTP)
(LITTLER-SORT-LEN)
(LITTLER-SORT-CONSP)
(LITTLER-SORT-INSERT
     (16 8
...
(<<W-TYPE-OF-COMPARE<)
(<<W-COMPARE<-TRANSITIVE (57 16 (:REWRITE <<-TRICHOTOMY))
...
(<<W-SORT-SORTS)
(<<W-NO-DUPLICATESP-EQUAL)
(<<W-TRUE-LISTP)
(<<W-LEN)
(<<W-CONSP)
(<<-NEGATION-TRANSITIVE)
(<<-TYPE-OF-COMPARE<)
(<<-COMPARE<-TRANSITIVE (1 1 (:REWRITE <<-TRICHOTOMY)))
(<<-COMPARE<-NEGATION-TRANSITIVE (48 11 (:REWRITE <<-TRICHOTOMY))
...
(<<-SORT (13 13
             (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP)))
(DEFSORT-SUBST1-OK (8 8 (:REWRITE <<-COMPARE<-TRANSITIVE))
                   (8 8
                      (:REWRITE <<-COMPARE<-NEGATION-TRANSITIVE))
                   (2 2
                      (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP)))
...
(<<-INSERTSORT-CONSP)
(INTVAL-ALISTP)
(ALISTP-WHEN-INTVAL-ALISTP (21 21 (:REWRITE DEFAULT-CAR))
                           (12 12 (:REWRITE DEFAULT-CDR)))
(ASSOC-IN-INTVAL-ALISTP (40 40 (:REWRITE DEFAULT-CDR)))
(INTVAL-ALIST-< (44 44 (:REWRITE DEFAULT-CAR))
...
(INTVAL-ALIST-SORT-COMPARE<-TRANSITIVE
     ...
     (12 12
         (:TYPE-PRESCRIPTION INTVAL-ALIST-SORT-TYPE-OF-COMPARABLEP))
     (12 6
...
(INTVAL-ALIST-SORT-COMPARE<-NEGATION-TRANSITIVE
     ...
     (38 4
         (:REWRITE INTVAL-ALIST-SORT-COMPARE<-TRANSITIVE))
     (16 16
         (:TYPE-PRESCRIPTION INTVAL-ALIST-SORT-TYPE-OF-COMPARABLEP))
     (16 8
         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(INTVAL-ALIST-SORT-COMPARE<-STRICT
     ...
     (1 1
        (:REWRITE INTVAL-ALIST-SORT-COMPARE<-TRANSITIVE))
     (1 1
        (:REWRITE INTVAL-ALIST-SORT-COMPARE<-NEGATION-TRANSITIVE)))
(DEFSORT-COMPARABLEP-SUFFICIENT)
...
(INTVAL-ALIST-SORT-MERGESORT-INTEGERS
     (56 56
         (:REWRITE DEFSORT-COMPARABLEP-SUFFICIENT)))
(INTVAL-ALIST-SORT (27 27
                       (:REWRITE DEFSORT-COMPARABLEP-SUFFICIENT)))
(INTVAL-ALIST-SORT-SORT-PRESERVES-DUPLICITY)
(INTVAL-ALIST-SORT-SORT-CREATES-COMPARABLE-LISTP)
(INTVAL-ALIST-SORT-SORT-SORTS)
(INTVAL-ALIST-SORT-NO-DUPLICATESP-EQUAL)
(INTVAL-ALIST-SORT-TRUE-LISTP)
(INTVAL-ALIST-SORT-LEN)
(INTVAL-ALIST-SORT-CONSP)
(INTVAL-ALIST-SORT-INSERT
     ...
     (2 2
        (:REWRITE INTVAL-ALIST-SORT-COMPARE<-NEGATION-TRANSITIVE)))
(INTVAL-ALIST-SORT-INSERTSORT (7 7
                                 (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP)))
(DEFSORT-SUBST2-OK
     (2 2
        (:REWRITE INTVAL-ALIST-SORT-COMPARE<-TRANSITIVE))
...
(ALISTP-WHEN-INTVAL-ALISTP (21 21 (:REWRITE DEFAULT-CAR))
                           (12 12 (:REWRITE DEFAULT-CDR)))
(ASSOC-IN-INTVAL-ALISTP (18 18 (:REWRITE DEFAULT-CDR)))
(INTVAL-ALIST-<2 (10 10 (:REWRITE DEFAULT-CAR))
...
(INTVAL-ALIST-SORT2-COMPARE<-NEGATION-TRANSITIVE
     ...
     (44 16
         (:REWRITE INTVAL-ALIST-SORT2-COMPARE<-TRANSITIVE))
...
(INTVAL-ALIST-SORT2-COMPARE<-STRICT
     ...
     (1 1
        (:REWRITE INTVAL-ALIST-SORT2-COMPARE<-TRANSITIVE))
     (1 1
        (:REWRITE INTVAL-ALIST-SORT2-COMPARE<-NEGATION-TRANSITIVE))
...
(DEFSORT-SUBST1-OK
     ...
     (2 2
        (:REWRITE DEFSORT-COMPARABLEP-SUFFICIENT))
     (2 2
        (:REWRITE DEFSORT-COMPARABLEP-OF-CAR)))
(INTVAL-ALIST-SORT2-MERGESORT-FIXNUM)
(INTVAL-ALIST-SORT2-MERGESORT-INTEGERS
     (56 56
         (:REWRITE DEFSORT-COMPARABLEP-SUFFICIENT)))
(INTVAL-ALIST-SORT2 (27 27
                        (:REWRITE DEFSORT-COMPARABLEP-SUFFICIENT)))
(INTVAL-ALIST-SORT2-SORT-PRESERVES-DUPLICITY)
(INTVAL-ALIST-SORT2-SORT-CREATES-COMPARABLE-LISTP)
(INTVAL-ALIST-SORT2-SORT-SORTS)
(INTVAL-ALIST-SORT2-NO-DUPLICATESP-EQUAL)
(INTVAL-ALIST-SORT2-TRUE-LISTP)
(INTVAL-ALIST-SORT2-LEN)
(INTVAL-ALIST-SORT2-CONSP)
(INTVAL-ALIST-SORT2-INSERT
     ...
     (2 2
        (:REWRITE INTVAL-ALIST-SORT2-COMPARE<-NEGATION-TRANSITIVE)))
(INTVAL-ALIST-SORT2-INSERTSORT (7 7
                                  (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP)))
(DEFSORT-SUBST2-OK
     (2 2
        (:REWRITE INTVAL-ALIST-SORT2-COMPARE<-TRANSITIVE))
...
(STRING-LESS-P)
(LEMMA (484 49 (:REWRITE STRING<-L-ASYMMETRIC))
       ...
       (12 12
           (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(TRANSITIVITY-OF-STRING-LESS-P (44 2 (:REWRITE STRING<-L-ASYMMETRIC))
...
(DEFSORT-COMPARABLEP-OF-CAR)
(DEFSORT-COMPARABLE-LISTP-OF-CDR)
(STRING-ORDERED-P (13 13
                      (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
                  (4 4
                     (:REWRITE STRING-COMPARE<-TRANSITIVE)))
(STRING-MERGE (18 18
                  (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
              (4 4
                 (:REWRITE STRING-COMPARE<-TRANSITIVE)))
(STRING-MERGE-TR (18 18
                     (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
                 (4 4
                    (:REWRITE STRING-COMPARE<-TRANSITIVE)))
...
(STRING2-ORDERED-P (13 13
                       (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
                   (4 4
                      (:REWRITE STRING2-COMPARE<-TRANSITIVE)))
(STRING2-MERGE (18 18
                   (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
               (4 4
                  (:REWRITE STRING2-COMPARE<-TRANSITIVE)))
(STRING2-MERGE-TR (18 18
                      (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
                  (4 4
                     (:REWRITE STRING2-COMPARE<-TRANSITIVE)))
...
(DEFSORT-COMPARABLEP-OF-CAR)
(DEFSORT-COMPARABLE-LISTP-OF-CDR)
(ENTRY-KEY-ORDERED-P (13 13
                         (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
                     (4 4
                        (:REWRITE ENTRY-KEY-COMPARE<-TRANSITIVE)))
(ENTRY-KEY-MERGE (18 18
                     (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
                 (4 4
                    (:REWRITE ENTRY-KEY-COMPARE<-TRANSITIVE)))
(ENTRY-KEY-MERGE-TR (18 18
                        (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
                    (4 4
                       (:REWRITE ENTRY-KEY-COMPARE<-TRANSITIVE)))
(ENTRY-KEY-MERGESORT-FIXNUM)
(ENTRY-KEY-MERGESORT-INTEGERS)
(ENTRY-KEY-SORT (13 13
                    (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP)))
(DEFSORT-SUBST1-OK (15 4 (:REWRITE DEFSORT-COMPARABLEP-OF-CAR))
                   ...
                   (2 2
                      (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP)))
(ENTRY-KEY-MERGESORT-FIXNUM)
(ENTRY-KEY-MERGESORT-INTEGERS (2 2
                                 (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP)))
(ENTRY-KEY-SORT)
(ENTRY-KEY-SORT-PRESERVES-DUPLICITY)
(ENTRY-KEY-SORT-CREATES-COMPARABLE-LISTP)
(ENTRY-KEY-SORT-SORTS)
(ENTRY-KEY-NO-DUPLICATESP-EQUAL)
(ENTRY-KEY-TRUE-LISTP)
(ENTRY-KEY-LEN)
(ENTRY-KEY-CONSP)
(ENTRY-VAL-TYPE-OF-COMPARE<)
(ENTRY-VAL-TYPE-OF-COMPARABLEP)
(ENTRY-VAL-COMPARE<-TRANSITIVE (6 6 (:REWRITE DEFAULT-CDR)))
(ENTRY-VAL-LIST-P)
(DEFSORT-COMPARABLEP-OF-CAR)
(DEFSORT-COMPARABLE-LISTP-OF-CDR)
(ENTRY-VAL-ORDERED-P (13 13
                         (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
                     (4 4
                        (:REWRITE ENTRY-VAL-COMPARE<-TRANSITIVE)))
(ENTRY-VAL-MERGE (18 18
                     (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
                 (4 4
                    (:REWRITE ENTRY-VAL-COMPARE<-TRANSITIVE)))
(ENTRY-VAL-MERGE-TR (18 18
                        (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
                    (4 4
                       (:REWRITE ENTRY-VAL-COMPARE<-TRANSITIVE)))
(ENTRY-VAL-MERGESORT-FIXNUM)
(ENTRY-VAL-MERGESORT-INTEGERS)
(ENTRY-VAL-SORT (13 13
                    (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP)))
(DEFSORT-SUBST1-OK (15 4 (:REWRITE DEFSORT-COMPARABLEP-OF-CAR))
                   (14 4
                       (:REWRITE DEFSORT-COMPARABLE-LISTP-OF-CDR))
...
(DEFSORT-COMPARABLEP-OF-CAR)
(DEFSORT-COMPARABLE-LISTP-OF-CDR)
(GENSORT-ORDERED-P (13 13
                       (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
                   (4 4
                      (:REWRITE GENSORT-COMPARE<-TRANSITIVE)))
(GENSORT-MERGE (18 18
                   (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
               (4 4
                  (:REWRITE GENSORT-COMPARE<-TRANSITIVE)))
(GENSORT-MERGE-TR (18 18
                      (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
                  (4 4
                     (:REWRITE GENSORT-COMPARE<-TRANSITIVE)))
