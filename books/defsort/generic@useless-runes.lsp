...
(SUBSETP-OF-COMPARABLE-MERGESORT
     (1263 18
           (:REWRITE CONSP-OF-COMPARABLE-MERGESORT))
     (1051 8 (:REWRITE CONSP-OF-NTHCDR))
     (716 3
          (:REWRITE COMPARABLE-MERGE-WHEN-NOT-CONSP-RIGHT))
     (375 12 (:REWRITE ZP-OPEN))
     (302 16 (:REWRITE DEFAULT-CDR))
     (298 8 (:REWRITE CONSP-OF-TAKE))
     (235 12 (:REWRITE FLOOR-TYPE-2))
     (207 137 (:REWRITE DEFAULT-<-1))
     (193 19 (:REWRITE FLOOR-=-X/Y . 3))
     (193 19 (:REWRITE FLOOR-=-X/Y . 2))
     (189 3
          (:REWRITE COMPARABLE-MERGE-WHEN-NOT-CONSP-LEFT))
     (187 137 (:REWRITE DEFAULT-<-2))
     (177 3 (:REWRITE NTHCDR-WHEN-ZP))
     (158 13 (:REWRITE DEFAULT-CAR))
     (133 102 (:REWRITE DEFAULT-*-2))
     (133 102 (:REWRITE DEFAULT-*-1))
     (133 19 (:REWRITE FLOOR-TYPE-3 . 2))
     (102 102
          (:TYPE-PRESCRIPTION FLOOR-TYPE-1 . 2))
     (102 102
          (:TYPE-PRESCRIPTION FLOOR-TYPE-1 . 1))
     (97 19 (:REWRITE FLOOR-TYPE-3 . 3))
     (73 19 (:REWRITE FLOOR-TYPE-4 . 2))
     (72 8 (:LINEAR FLOOR-TYPE-2 . 1))
     (67 9
         (:TYPE-PRESCRIPTION TRUE-LISTP-NTHCDR-TYPE-PRESCRIPTION))
     (49 1 (:REWRITE CAR-OF-TAKE))
     (43 9 (:REWRITE FLOOR-RECURSION))
     (40 40
         (:TYPE-PRESCRIPTION TRUE-LISTP-OF-COMPARABLE-MERGESORT))
     (40 1 (:REWRITE CAR-OF-NTHCDR))
     (39 1 (:DEFINITION NTH))
     (38 38 (:REWRITE INTEGERP-+-MINUS-*))
     (33 8 (:LINEAR FLOOR-TYPE-2 . 2))
     (31 19 (:REWRITE FLOOR-TYPE-4 . 3))
     (23 9
         (:REWRITE COMPARABLE-MERGESORT-EQUALS-COMPARABLE-INSERTSORT))
     (20 7 (:LINEAR FLOOR-TYPE-1 . 2))
     (15 7
         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
     (15 7 (:REWRITE DEFAULT-+-2))
     (14 14
         (:TYPE-PRESCRIPTION COMPARE<-NEGATION-TRANSITIVE))
     (11 7 (:LINEAR FLOOR-TYPE-1 . 1))
...
(COMPARABLE-MERGESORT-UNDER-SET-EQUIV-LEMMA-2
     (65 10 (:REWRITE CONSP-OF-TAKE))
     (60 5 (:REWRITE CAR-OF-TAKE))
