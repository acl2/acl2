...
(REWRITE-LINEAR-EQUALITIES-TO-IFF
     ...
     (8 8
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(NORMALIZE-<-MINUS-/ (15 13 (:REWRITE DEFAULT-<-2))
...
(NORMALIZE-<-/-TO-* (36 36 (:REWRITE DEFAULT-<-2))
...
(NORMALIZE-<-/-TO-*-3 (80 48 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
