...
(ASH-PLUS-1 (3 3 (:REWRITE DEFAULT-*-2))
...
(ASH-MINUS-N (246 4
             ...
             (1 1 (:REWRITE NATP-RW)))
(ASH-PLUS-N (30 2 (:DEFINITION EXPT))
...
(IMOD$INLINE (210 4
             ...
             (2 2 (:REWRITE DEFAULT-DENOMINATOR)))
(IMOD-TYPE)
(EXPT2$INLINE (45 3 (:DEFINITION EXPT))
              (33 33
                  (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
              ...
              (1 1 (:REWRITE NATP-RW)))
(EXPT2-TYPE)
(BINARY-MINUS-FOR-GL (5 5
                        (:TYPE-PRESCRIPTION |x < y  =>  0 < y-x|)))
(BINARY--$INLINE (6 6
                    (:TYPE-PRESCRIPTION |x < y  =>  0 < y-x|)))
(LOGCAR$INLINE (1008 18
                     (:DEFINITION NONNEGATIVE-INTEGER-QUOTIENT))
...
(LOGCDR$INLINE (1 1
                  (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(LOGCDR-TYPE)
(LOGCONS$INLINE (18 18 (:REWRITE DEFAULT-*-2))
...
(LOGBIT$INLINE)
(LOGBIT-TYPE)
(LOGMASK$INLINE (75 5 (:DEFINITION EXPT))
                ...
                (1 1 (:REWRITE NATP-RW)))
(LOGMASK-TYPE)
(LOGMASKP (762 4 (:DEFINITION INTEGER-LENGTH))
          (406 7
               (:DEFINITION NONNEGATIVE-INTEGER-QUOTIENT))
...
(BITMASKP$INLINE (1192 6 (:DEFINITION INTEGER-LENGTH))
                 (640 11
                      (:DEFINITION NONNEGATIVE-INTEGER-QUOTIENT))
                 ...
                 (2 2 (:REWRITE EQUAL-CONSTANT-+)))
(LOGHEAD$INLINE (3681 4 (:DEFINITION BINARY-LOGAND))
                (1220 16
                      (:DEFINITION NONNEGATIVE-INTEGER-QUOTIENT))
...
(LOGHEAD-TYPE (64 1 (:REWRITE MOD-=-0 . 2))
...
(LOGREV1-TYPE (188 15 (:REWRITE BFIX-BITP))
...
(LOGREV$INLINE)
(LOGREV-TYPE)
(LOGSAT (26 10 (:REWRITE DEFAULT-<-1))
