(POWERLISTS::EVAL-POLY-U-UNARY---U
     (4378 28
           (:DEFINITION POWERLISTS::EVAL-POLY-AT-POINT))
...
(POWERLISTS::EVAL-POLY-OMEGA-N-AUX
     ...
     (24 24
         (:TYPE-PRESCRIPTION POWERLISTS::EVAL-POLY-AT-POINT))
     (24 8 (:DEFINITION FIX))
     (11 3 (:REWRITE DEFAULT-UNARY-MINUS))
     (11 1 (:DEFINITION POWERLISTS::P-UNARY--))
     (10 8
         (:REWRITE POWERLISTS::EVAL-POLY-LEMMA)))
(POWERLISTS::EVAL-POLY-OMEGA-N
     ...
     (2 2 (:REWRITE ZP-OPEN)))
(POWERLISTS::P-DEPTH (106 2 (:DEFINITION ACL2-COUNT))
...
(POWERLISTS::P-DEPTH-UNZIP (564 192
                                (:REWRITE POWERLISTS::BOOLEAN-NON-POWERLIST))
                           (378 192
                                (:REWRITE POWERLISTS::NUMERIC-NON-POWERLIST))
...
(POWERLISTS::FT-OMEGA-LEMMA
     ...
     (3 3
        (:REWRITE POWERLISTS::UNTIE-L-SIMILAR)))
(POWERLISTS::P-FFT-OMEGA (212 4 (:DEFINITION ACL2-COUNT))
...
(POWERLISTS::FFT-OMEGA->FT-OMEGA
     ...
     (285 285
          (:TYPE-PRESCRIPTION POWERLISTS::P-DEPTH))
