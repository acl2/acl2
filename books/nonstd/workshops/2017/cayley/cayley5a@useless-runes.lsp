...
(V_CONJUGATE)
(V_CONJUGATE-DEF (268 4 (:REWRITE FORALL-U-V_DOT-U-X=0-NECC))
                 (264 2
                 ...
                 (4 4
                    (:TYPE-PRESCRIPTION FORALL-U-V_DOT-U-X=0))
                 (4 2 (:REWRITE DEFAULT-<-2))
                 ...
                 (1 1
                    (:REWRITE DISTRIBUTIVITY-S_*-SCALAR-+)))
(V_*-ASSOCIATIVITY)
(V_*-COMMUTATIVITY (6 2 (:LINEAR X*Y>1-POSITIVE))
                   ...
                   (2 2 (:REWRITE DEFAULT-<-2))
                   (2 2 (:REWRITE DEFAULT-<-1)))
(V_CONJUGATE=IDENTITY (134 2 (:REWRITE FORALL-U-V_DOT-U-X=0-NECC))
                      (132 1
                           (:DEFINITION FORALL-U-V_DOT-U-X=0-DEF))
...
(V2_*-COMMUTATIVITY (10 10 (:REWRITE DEFAULT-CDR))
