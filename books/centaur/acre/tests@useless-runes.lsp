...
(ACRE::REGEX-TEST-FIX-WHEN-REGEX-TEST
     ...
     (2 2
        (:TYPE-PRESCRIPTION ACRE::REGEX-TEST-P)))
(ACRE::EQUAL-OF-REGEX-TEST (36 36 (:REWRITE STR-FIX-WHEN-STRINGP)))
...
(ACRE::TEST-BACKREFS (12 12 (:REWRITE DEFAULT-CAR))
                     (6 6
                        (:REWRITE ACRE::BACKREF-MATCHES-P-WHEN-NOT-CONSP))
...
(ACRE::REGEX-TESTLIST-FIX-OF-REPEAT
     ...
     (16 4
         (:REWRITE ACRE::REGEX-TEST-FIX-WHEN-REGEX-TEST-P))
     (12 2
         (:REWRITE ACRE::REGEX-TESTLIST-P-OF-REPEAT))
     (10 10
         (:TYPE-PRESCRIPTION ACRE::REGEX-TEST-P))
     (10 10
         (:REWRITE ACRE::REGEX-TEST-P-WHEN-MEMBER-EQUAL-OF-REGEX-TESTLIST-P))
...
(ACRE::NTH-OF-REGEX-TESTLIST-FIX
  ...
  (124 24
       (:REWRITE ACRE::REGEX-TESTLIST-P-OF-CDR-WHEN-REGEX-TESTLIST-P))
  (112 11
       (:REWRITE ACRE::REGEX-TEST-P-OF-NTH-WHEN-REGEX-TESTLIST-P))
  (106 106
       (:REWRITE ACRE::REGEX-TESTLIST-P-WHEN-SUBSETP-EQUAL))
  (53 53
      (:REWRITE ACRE::REGEX-TESTLIST-P-WHEN-NOT-CONSP))
  ...
  (15 15
      (:REWRITE ACRE::CONSP-OF-REGEX-TESTLIST-FIX))
  ...
  (2 2
     (:REWRITE-QUOTED-CONSTANT ACRE::REGEX-TEST-FIX-UNDER-REGEX-TEST-EQUIV)))
...
(ACRE::REGEX-TESTLIST-EQUIV-IMPLIES-REGEX-TESTLIST-EQUIV-TAKE-2
     ...
     (236 236
          (:REWRITE ACRE::REGEX-TESTLIST-P-WHEN-SUBSETP-EQUAL))
     (229 24
          (:REWRITE ACRE::REGEX-TESTLIST-P-OF-TAKE))
     (136 118
          (:REWRITE ACRE::REGEX-TESTLIST-P-WHEN-NOT-CONSP))
     (66 66
         (:TYPE-PRESCRIPTION ACRE::REGEX-TEST-P))
