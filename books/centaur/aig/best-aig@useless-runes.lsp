(AIG-LABEL-NODES)
(NATP-OF-AIG-LABEL-NODES.FREE (84 84 (:REWRITE DEFAULT-CAR))
...
(AIG-LABEL-NODES (56 2 (:DEFINITION AIG-LABEL-NODES))
...
(NATP-OF-AIG-LIST-LIST-LABEL-NODES.FREE
     ...
     (4 4
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (4 4 (:REWRITE DEFAULT-CDR)))
(AIG-COLLECT-ANDNODE-LABELS (264 12 (:REWRITE SET::INSERT-IDENTITY))
...
(AIG-COLLECT-LABELS (242 11 (:REWRITE SET::INSERT-IDENTITY))
                    ...
                    (6 6 (:TYPE-PRESCRIPTION SET::INSERT)))
(SETP-OF-AIG-COLLECT-LABELS (22 1 (:REWRITE SET::INSERT-IDENTITY))
                            (20 1 (:REWRITE SET::UNION-IN))
                            (16 4 (:REWRITE SET::IN-TAIL))
