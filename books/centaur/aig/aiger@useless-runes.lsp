...
(AIGER-GATE-LISTP)
(AIG-TO-AIGER (160 77 (:REWRITE DEFAULT-+-2))
...
(AIG-TO-AIGER-NATP-MAXVAR
     ...
     (3 3
        (:LINEAR LOOKUP-WHEN-NAMES-MAX-ENTRY)))
(AIG-TO-AIGER-TRUE-LISTP-GATES
     (8120 4060
           (:TYPE-PRESCRIPTION AIG-TO-AIGER-NATP-MAXVAR))
...
(AIG-TO-AIGER-MAXVAR-INCR
     ...
     (80 80
         (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
     (61 1
         (:REWRITE NAMES-MAX-ENTRY-OF-AIG-TO-AIGER))
...
(NAMES-MAX-ENTRY-PAIRLIS-NUMLIST
     ...
     (3 3
        (:TYPE-PRESCRIPTION NAMES-NUMLIST-IND))
     (3 3
        (:REWRITE INEQUALITY-WITH-NFIX-HYP-2)))
...
(AIG-LIST-TO-AIGER (94 94 (:REWRITE DEFAULT-CAR))
                   (50 50
                       (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
...
(AIGER-GATE-LISTP-REV (209 7 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
...
(NAT-LISTP-OF-AIGS-TO-AIGER
     (92 4
         (:REWRITE AIGER-GATE-LISTP-IMPLIES-TRUE-LISTP))
     (80 7
         (:REWRITE AIGER-GATES-P-AIG-LIST-TO-AIGER))
     (28 28 (:TYPE-PRESCRIPTION NAMES-MAX-ENTRY))
     (28 1
         (:LINEAR NAMES-MAX-ENTRY-OF-HONS-SHRINK-ALIST))
...
(AIGER-GET-LITS (8 8
                ...
                (8 8
                   (:TYPE-PRESCRIPTION BITOPS::LOGAND-NATP-TYPE-1)))
(AIGER-GET-LITS-TR-RW (952 7
                           (:REWRITE TRUE-LISTP-IMPLIES-NOT-STRINGP))
                      (798 14
                           (:REWRITE AIGER-GATE-LISTP-IMPLIES-TRUE-LISTP))
                      ...
                      (10 10
                          (:TYPE-PRESCRIPTION BITOPS::LOGAND-NATP-TYPE-1)))
(AIGER-GET-LITS (294 68 (:REWRITE DEFAULT-CDR))
...
(AIGER-WRITE-BINARY (432 8 (:DEFINITION AIGER-GATE-LISTP))
...
(AIGER-READ-GATE (19 9 (:REWRITE DEFAULT-+-2))
...
(AIGER-GATE-LISTP-OF-AIGER-READ-N-GATES-AUX
     (461 220 (:REWRITE DEFAULT-+-2))
     (435 263
          (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
     (405 100 (:REWRITE NATP-WHEN-GTE-0))
     (255 220 (:REWRITE DEFAULT-+-1))
...
(AIGER-PARSE-BINARY (9 1 (:REWRITE MAYBE-BYTE-P-OF-BYTE))
                    (7 3 (:REWRITE DEFAULT-*-2))
                    (6 3 (:REWRITE DEFAULT-+-2))
...
(OPEN-INPUT-CHANNEL-P1-OF-AIGER-PARSE-BINARY
     ...
     (16 16
         (:TYPE-PRESCRIPTION NATP-OF-AIGER-PARSE-HEADER.N-INS))
     (16 8 (:REWRITE DEFAULT-+-2))
