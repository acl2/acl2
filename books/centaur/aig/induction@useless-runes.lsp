(CHECK-PROPERTY (99 46 (:REWRITE DEFAULT-+-2))
...
(ALIST-EQUIV-IMPLIES-EQUAL-CHECK-PROPERTY-3
     (1026 24 (:DEFINITION FAST-ALIST-FORK))
     (826 14 (:DEFINITION AIG-EVAL-ALIST))
...
(ALIST-EQUIV-IMPLIES-EQUAL-CHECK-PROPERTY-1
     (4355 65 (:DEFINITION FAST-ALIST-FORK))
     (3279 49 (:DEFINITION AIG-EVAL-ALIST))
     (3027 38
           (:REWRITE AIG-EVAL-APPEND-WHEN-NOT-INTERSECTING-ALIST-KEYS))
     (2399 32
           (:REWRITE HONS-ASSOC-EQUAL-HSHRINK-ALIST))
...
(CHECK-AG-PROPERTY-IMPLIES-CHECK-PROPERTY-STRONG
     (5878 75
           (:REWRITE AIG-EVAL-APPEND-WHEN-NOT-INTERSECTING-ALIST-KEYS))
     (4767 58 (:DEFINITION AIG-EVAL-ALIST))
     ...
     (406 406
          (:TYPE-PRESCRIPTION AIG-ATOM-P$INLINE))
     (336 24 (:REWRITE INTERSECTP-EQUAL-COMMUTE))
     (300 300
          (:TYPE-PRESCRIPTION SET::EMPTY-TYPE))
     (287 116
          (:REWRITE HONS-ASSOC-EQUAL-WHEN-ATOM))
...
(PROP-HOLDS-WHEN-INVAR-HOLDS
     ...
     (450 10
          (:REWRITE SET::UNION-UNDER-SET-EQUIV))
     (379 7
          (:REWRITE AIG-EVAL-WHEN-VARS-SUBSET-OF-FIRST-KEYS))
     (372 7
          (:REWRITE AIG-EVAL-APPEND-WHEN-NOT-INTERSECTING-ALIST-KEYS))
     ...
     (46 4 (:REWRITE INTERSECTP-EQUAL-COMMUTE))
...
(INDUCTIVE-INVARIANT-IMPL-CHECK-PROPERTY
     ...
     (1006 12 (:DEFINITION FAST-ALIST-FORK))
     (965 9 (:DEFINITION AIG-EVAL-ALIST))
     (855 19
          (:REWRITE SET::UNION-UNDER-SET-EQUIV))
     (633 6
          (:REWRITE HONS-ASSOC-EQUAL-HSHRINK-ALIST))
...
(INDUCTIVE-INVARIANT-IMPL-CHECK-AG-PROPERTY
     ...
     (112 8 (:REWRITE INTERSECTP-EQUAL-COMMUTE))
     ...
     (51 51
         (:REWRITE PROP-HOLDS-WHEN-INVAR-HOLDS))
     (48 8
         (:REWRITE INTERSECTP-EQUAL-NON-CONS-1))
