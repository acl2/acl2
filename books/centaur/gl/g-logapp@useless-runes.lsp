...
(GL::LOGAPP-ZP-N (4 1 (:REWRITE ZP-WHEN-GT-0))
...
(GL::LOGAPP-ZIP-X (23 2 (:REWRITE RIGHT-SHIFT-TO-LOGTAIL))
...
(GL::LOGAPP-ZIP-Y (35 2 (:REWRITE LOGHEAD-IDENTITY))
...
(GL-THM::LOGAPP-DEPENDENCIES
     ...
     (4 4 (:META CANCEL_PLUS-LESSP-CORRECT))
     (3 3
        (:TYPE-PRESCRIPTION GL::G-LOGAPP-OF-INTEGERS))
     (1 1
...
(GL-THM::|ACL2::LOGAPP$-CORRECT|
     ...
     (336 168 (:DEFINITION GL::BOOL->SIGN))
     (324 162
          (:REWRITE GL::BFR-HYP-FIX-WHEN-HYP$AP))
     (321 321 (:REWRITE SUBSETP-MEMBER . 4))
     (321 321 (:REWRITE SUBSETP-MEMBER . 3))
