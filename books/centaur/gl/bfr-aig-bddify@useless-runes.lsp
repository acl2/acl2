...
(GL::AIG-Q-COMPOSE-VARS-TO-BDD-ENV
     (6969 13 (:DEFINITION AIG-Q-COMPOSE))
     (6311 313 (:REWRITE SUBSETP-CAR-MEMBER))
     (3764 3764
           (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
     (3696 428 (:REWRITE SUBSETP-MEMBER . 2))
     (3195 356 (:REWRITE SUBSETP-TRANS2))
     ...
     (832 160 (:REWRITE APPEND-WHEN-NOT-CONSP))
     (804 134
          (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV))
     (733 140
