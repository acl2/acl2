...
(GL::RATIONALP-COMPLEX (4 4 (:REWRITE DEFAULT-COMPLEX-2))
...
(GL::COMPLEX-<-1 (160 160 (:REWRITE DEFAULT-<-1))
                 (18 18
                     (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(GL::COMPLEX-<-2 (167 167 (:REWRITE DEFAULT-<-2))
                 (18 18
                     (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(GL::FOO (22 2 (:REWRITE <-UNARY-/-POSITIVE-RIGHT))
...
(GL::NONNEGATIVE-INTEGER-QUOTIENT-PRESERVES-<
   ...
   (3 3
      (:TYPE-PRESCRIPTION GL::NONNEGATIVE-INTEGER-QUOTIENT-PRESERVES-<-IND)))
(GL::NONNEGATIVE-INTEGER-QUOTIENT-PRESERVES->
...
(GL::SWITCH-MINUS-QUOTIENT
     ...
     (8 2
        (:REWRITE GL::NONNEGATIVE-INTEGER-QUOTIENT-PRESERVES->))
     (8 2
        (:REWRITE GL::NONNEGATIVE-INTEGER-QUOTIENT-PRESERVES-<))
...
(GL::SWITCH-QUOTIENT-MINUS1
     ...
     (4 4 (:REWRITE NATP-RW)))
(GL::CEIL)
(GL::<-OF-CEIL (341 341 (:REWRITE DEFAULT-<-1))
               (216 12
                    (:DEFINITION NONNEGATIVE-INTEGER-QUOTIENT))
               (130 130
                    (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(GL::FLO (5 5
            (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(GL::<-OF-FLO (317 317 (:REWRITE DEFAULT-<-2))
              (216 12
                   (:DEFINITION NONNEGATIVE-INTEGER-QUOTIENT))
...
(GL-SYM::|COMMON-LISP::<$|
 ...
 (176 8
      (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
 (172 172
      (:REWRITE GL::POSSIBILITIES-FOR-X-8))
 (172 172
      (:REWRITE GL::POSSIBILITIES-FOR-X-7))
 (140 4
      (:REWRITE GL::ACL2-NUMBERP-OF-GENERAL-NUMBER-FIX-OBJ))
 (119 119
      (:TYPE-PRESCRIPTION GL::BFR-HYP-FIX))
