...
(GL::APPLY-COND-EV-DISJOIN-ATOM
     (1 1
        (:REWRITE GL::APPLY-COND-EV-CONSTRAINT-8)))
(GL::APPLY-COND-EV-DISJOIN-APPEND
     (23 23
         (:REWRITE GL::APPLY-COND-EV-CONSTRAINT-8))
     (23 23
         (:REWRITE GL::APPLY-COND-EV-CONSTRAINT-2)))
...
(GL::APPLY-COND-EV-CONJOIN-CLAUSES-CONS
     ...
     (7 7
        (:REWRITE GL::APPLY-COND-EV-DISJOIN-ATOM))
     (5 5
        (:REWRITE GL::APPLY-COND-EV-CONJOIN-ATOM)))
...
(GL::COLLECT-CONDS-AND-DEFAULT (587 231 (:REWRITE DEFAULT-+-2))
                               (371 231 (:REWRITE DEFAULT-+-1))
...
(GL::COLLECT-CONDS-AND-DEFAULT-EVAL-CONDS
     ...
     (91 91
         (:REWRITE GL::APPLY-COND-EV-CONSTRAINT-9))
     (91 91
         (:REWRITE GL::APPLY-COND-EV-CONSTRAINT-10))
     (87 87
         (:REWRITE GL::APPLY-COND-EV-CONSTRAINT-3))
     (87 87
         (:REWRITE GL::APPLY-COND-EV-CONSTRAINT-2))
     (87 87
         (:REWRITE GL::APPLY-COND-EV-CONSTRAINT-1)))
(GL::NO-CONDS-WITH-SAME-FN)
(GL::NO-DUPLICATE-CONDSP)
(GL::ALIST-NO-COND-FNS)
(GL::EXCLUSIVE-CONDSP)
(GL::REMOVE-ASSOC)
(GL::HONS-ASSOC-EQUAL-REMOVE-ASSOC (164 164 (:REWRITE DEFAULT-CDR)))
(GL::EXCLUSIVE-CONDSP-ACONS1 (1429 1429 (:REWRITE DEFAULT-CDR))
                             (1064 1064 (:REWRITE DEFAULT-CAR))
                             (20 20 (:REWRITE FN-CHECK-DEF-NOT-QUOTE)))
(GL::REMOVE-ASSOC-WHEN-NOT-HONS-ASSOC-EQUAL (66 66 (:REWRITE DEFAULT-CAR))
                                            (20 20 (:REWRITE DEFAULT-CDR)))
(GL::EXCLUSIVE-CONDSP-ACONS (196 2 (:DEFINITION GL::EXCLUSIVE-CONDSP))
...
(GL::L0 (161 161 (:REWRITE DEFAULT-CDR))
...
(GL::APPLY-COND-OF-ASSOC-IS-EVAL-CONDS
     ...
     (1761 24
           (:DEFINITION GL::NO-CONDS-WITH-SAME-FN))
...
(GL::CONDS-MATCH-IMPL-EVAL-CONDS
     ...
     (22 22
         (:REWRITE GL::APPLY-COND-EV-CONSTRAINT-10))
     (10 10
         (:REWRITE GL::HONS-ALIST-KEYS-SUBSET-IMPL-EVAL-CONDS))
     (6 6 (:DEFINITION HONS-EQUAL)))
(GL::CONDS-MATCH-AND-NO-DUPLICATE-CONDS
     ...
     (6 6
        (:REWRITE GL::HONS-ASSOC-EQUAL-TRUE-COND-EVAL-CONDS))
     (6 6
        (:REWRITE GL::HONS-ALIST-KEYS-SUBSET-IMPL-EVAL-CONDS))
     (6 6
        (:REWRITE GL::CONDS-MATCH-IMPL-EVAL-CONDS))
     (4 4
        (:REWRITE GL::APPLY-COND-EV-DISJOIN-ATOM)))
(GL::APPLY-COND-TERMS-EQUAL)
(GL::APPLY-COND-TERMS-EQUAL-CORRECT
     (420 210
          (:DEFINITION GL::COLLECT-CONDS-AND-DEFAULT))
     ...
     (164 164
          (:REWRITE GL::APPLY-COND-EV-CONSTRAINT-1))
     (130 26
          (:DEFINITION GL::HONS-ALIST-KEYS-SUBSET))
     (78 26 (:DEFINITION HONS-GET))
     (57 27
         (:REWRITE GL::APPLY-COND-OF-ASSOC-IS-EVAL-CONDS))
...
(GL::APPLY-COND-CP)
(GL::LAST-IMPL-DISJOIN (95 95 (:TYPE-PRESCRIPTION LAST))
                       (36 19
                           (:REWRITE GL::APPLY-COND-EV-CONSTRAINT-9))
                       (36 19
                           (:REWRITE GL::APPLY-COND-EV-CONSTRAINT-10))
