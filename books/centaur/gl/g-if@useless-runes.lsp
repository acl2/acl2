(GL::G-IF-FN (3 3 (:TYPE-PRESCRIPTION MK-G-ITE))
             (2 1
                (:TYPE-PRESCRIPTION GL::MK-G-BDD-ITE)))
(GL::G-IF-FN-PRESERVES-HYP (18 18 (:TYPE-PRESCRIPTION GL::BFR-HYP-FIX))
                           (4 2
...
(GL::G-IF-FN-CORRECT (88 44 (:REWRITE GL::BFR-EVAL-BOOLEANP))
...
(GL::GOBJ-DEPENDS-ON-OF-G-IF-FN
     ...
     (2 1
        (:REWRITE GL::BFR-HYP-FIX-WHEN-HYP$AP))
     (1 1 (:TYPE-PRESCRIPTION GL::HYP$AP)))
(GL::G-OR-FN (3 3 (:TYPE-PRESCRIPTION MK-G-ITE))
             (2 1
                (:TYPE-PRESCRIPTION GL::MK-G-BDD-ITE)))
(GL::G-OR-FN-PRESERVES-HYP (18 18 (:TYPE-PRESCRIPTION GL::BFR-HYP-FIX))
                           (6 3
                              (:REWRITE GL::BFR-HYP-FIX-WHEN-HYP$AP))
