...
(GL-SYM::|ACL2::LOGAPP$|
 (651 651 (:TYPE-PRESCRIPTION BOOLEANP))
 (391 61 (:REWRITE GL::GLCP-CONFIG-P-WHEN-WRONG-TAG))
 (360 360 (:META CANCEL_TIMES-EQUAL-CORRECT))
 (360 360 (:META CANCEL_PLUS-EQUAL-CORRECT))
 (330 110 (:REWRITE STATE-P-IMPLIES-AND-FORWARD-TO-STATE-P1))
 (271 271 (:REWRITE GL::TAG-WHEN-ATOM))
 (110 55 (:REWRITE GL::TAG-WHEN-GLCP-CONFIG-P))
...
(GL-THM::|ACL2::LOGAPP$-CORRECT|
 ...
 (495 165 (:REWRITE GL::BFR-HYP-EVAL-WHEN-BAD-MODE))
 (495 165 (:REWRITE GL::BFR-HYP-EVAL-IN-TERMS-OF-BFR-HYP-MODE-EVAL))
 ...
 (165 165 (:TYPE-PRESCRIPTION IFF))
 (165 165 (:DEFINITION XOR))
 (165 165 (:DEFINITION IFF))
