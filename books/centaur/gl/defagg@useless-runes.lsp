...
(GL::FOO->A$INLINE)
(GL::FOO->B$INLINE)
(GL::FOO->A-OF-FOO (1 1 (:REWRITE DEFAULT-CAR)))
(GL::FOO->B-OF-FOO (1 1 (:REWRITE DEFAULT-CDR)))
(GL::FOO->A-ACL2-COUNT-THM (200 93 (:REWRITE DEFAULT-+-2))
...
(GL::FOO->B-ACL2-COUNT-THM (200 93 (:REWRITE DEFAULT-+-2))
                           (130 93 (:REWRITE DEFAULT-+-1))
                           (72 18 (:REWRITE COMMUTATIVITY-OF-+))
                           (72 18 (:DEFINITION INTEGER-ABS))
                           (72 9 (:DEFINITION LENGTH))
