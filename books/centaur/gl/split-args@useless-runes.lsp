(GL::HIDE-IF (1 1 (:TYPE-PRESCRIPTION GL::HIDE-IF)))
(GL::GL-ARGS-SPLIT-ITE-COND)
(GL::GL-ARGS-SPLIT-ITE)
(GL::G-ITE-DEPTH (134 4 (:DEFINITION ACL2-COUNT))
...
(GL::POSP-G-ITE-DEPTH (45 17 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
...
(GL::G-ITE-DEPTH-OF-G-ITE->THEN (18 2 (:REWRITE DEFAULT-<-2))
...
(GL::G-ITE-DEPTH-OF-G-ITE->ELSE (18 2 (:REWRITE DEFAULT-<-2))
                                (15 1 (:REWRITE DEFAULT-+-2))
                                (6 2 (:REWRITE DEFAULT-<-1))
                                (3 1 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
                                (2 2 (:TYPE-PRESCRIPTION BOOLEANP))
                                (2 2 (:REWRITE GL::TAG-WHEN-ATOM))
                                (1 1 (:REWRITE DEFAULT-+-1)))
(GL::G-ITE-DEPTH-SUM (6 6
                        (:TYPE-PRESCRIPTION GL::POSP-G-ITE-DEPTH)))
...
(GL::GL-FNCALL-SPLIT-ITE (4 2 (:REWRITE DEFAULT-<-2))
...
(GL::GL-FNCALL-SPLIT-ITE-CORRECT
     ...
     (172 172
          (:TYPE-PRESCRIPTION GL::GL-FNCALL-SPLIT-ITE))
     (170 116
...
(GL::GL-CONS-SPLIT-ITE (236 102 (:REWRITE DEFAULT-+-1))
                       ...
                       (24 24
                           (:TYPE-PRESCRIPTION GL::G-ITE-DEPTH-SUM))
                       (16 16
                           (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
...
(GL::GL-CONS-SPLIT-ITE-CORRECT
     ...
     (580 232
          (:REWRITE GL::BFR-LIST->S-WHEN-S-ENDP))
     (396 396
          (:TYPE-PRESCRIPTION GL::GL-CONS-SPLIT-ITE))
     (348 348
          (:TYPE-PRESCRIPTION GL::S-ENDP$INLINE))
     (348 348
          (:TYPE-PRESCRIPTION HONS-ASSOC-EQUAL))
