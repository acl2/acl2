(GL::LOGHEAD-OF-INTEGER-LENGTH-NONNEG
     (1468 18 (:REWRITE LOGHEAD-IDENTITY))
     (1366 34 (:DEFINITION UNSIGNED-BYTE-P))
     (1216 26 (:DEFINITION INTEGER-RANGE-P))
     (757 19 (:REWRITE ZIP-OPEN))
     (707 5
          (:REWRITE BITOPS::LOGBITP-UPPER-BOUND))
     (637 4 (:REWRITE IFIX-EQUAL-TO-NONZERO))
     (568 16 (:REWRITE UNSIGNED-BYTE-P-PLUS))
     (546 5 (:DEFINITION LOGBITP**))
     (461 8
     ...
     (32 5 (:REWRITE NEGP-WHEN-LESS-THAN-0))
...
(GL::INTEGER-LENGTH-OF-MOD
     ...
     (147 147 (:TYPE-PRESCRIPTION MOD-TYPE . 2))
     (147 147 (:TYPE-PRESCRIPTION MOD-TYPE . 1))
...
(GL::INTEGER-LENGTH-OF-PLUS-1
     ...
     (3870 20
           (:REWRITE BITOPS::LOGBITP-WHEN-BITMASKP))
     (3813 23 (:DEFINITION BITMASKP**))
     (2858 10 (:DEFINITION LOGBITP**))
     (2718 1287
           (:TYPE-PRESCRIPTION BITOPS::LOGCDR-NATP))
     (1474 1474 (:TYPE-PRESCRIPTION NATP))
     (1026 206 (:REWRITE DEFAULT-+-2))
     (1019 20 (:REWRITE BITOPS::LOGCAR-OF-+))
     (910 164 (:REWRITE BITOPS::LOGCAR-OF-BIT))
     (724 51 (:REWRITE BFIX-WHEN-NOT-1))
     (717 20 (:DEFINITION LOGXOR**))
     (586 131 (:REWRITE BITOPS::LOGCDR-OF-BIT))
     (576 31 (:REWRITE SIMPLIFY-BIT-FUNCTIONS))
     (567 20 (:REWRITE BITOPS::LOGCONS-B-0))
     (416 206 (:REWRITE DEFAULT-+-1))
     ...
     (172 86
          (:TYPE-PRESCRIPTION BITOPS::LOGCONS-NATP))
     (165 15 (:REWRITE NATP-WHEN-GTE-0))
     ...
     (54 9 (:REWRITE BITOPS::LOGCDR-<-CONST))
...
(GL::INTEGER-LENGTH-OF-BETWEEN-ABS-AND-MINUS-ABS
     (4980 76
           (:REWRITE BITOPS::LOGBITP-UPPER-BOUND))
     (4206 26 (:DEFINITION LOGBITP**))
     (2870 77
           (:REWRITE BITOPS::LOGBITP-WHEN-BITMASKP))
     (2639 77 (:DEFINITION BITMASKP**))
     (1459 25 (:REWRITE ZP-WHEN-INTEGERP))
     (1260 102 (:DEFINITION BIT->BOOL$INLINE))
     (611 25 (:REWRITE ZP-WHEN-GT-0))
     (578 233 (:REWRITE BITOPS::LOGCAR-OF-BIT))
     (516 115 (:LINEAR BITOPS::LOGCAR-BOUND))
     (512 151 (:REWRITE DEFAULT-+-2))
     (471 471 (:TYPE-PRESCRIPTION BITP))
     (408 398
          (:TYPE-PRESCRIPTION BITOPS::LOGCDR-NATP))
     (402 206 (:REWRITE DEFAULT-<-2))
     (392 165 (:REWRITE BITOPS::LOGCDR-OF-BIT))
     (385 385
          (:TYPE-PRESCRIPTION BITMASKP$INLINE))
     (317 206 (:REWRITE DEFAULT-<-1))
     (259 259 (:META CANCEL_TIMES-EQUAL-CORRECT))
     (230 230 (:TYPE-PRESCRIPTION LOGBITP))
     ...
     (128 3 (:REWRITE BITOPS::LOGCAR-OF-+))
     (119 3 (:DEFINITION LOGXOR**))
     ...
     (45 25 (:REWRITE BITOPS::LOGBITP-0-OF-BIT))
...
(GL::INTEGER-LENGTH-OF-REM
     ...
     (1060 1060 (:TYPE-PRESCRIPTION REM-TYPE . 2))
     (1060 1060 (:TYPE-PRESCRIPTION REM-TYPE . 1))
     ...
     (362 98
          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (354 4
          (:REWRITE GL::INTEGER-LENGTH-LTE-BY-COMPARE-NONNEG))
     (354 4
          (:REWRITE GL::INTEGER-LENGTH-LTE-BY-COMPARE-NEG))
...
(GL::REM-IS-MOD
     (145 50 (:REWRITE DEFAULT-UNARY-MINUS))
