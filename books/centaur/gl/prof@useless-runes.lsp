(GL::PROF-ARRAYP-IS-U32-LISTP (22 22 (:REWRITE DEFAULT-<-2))
                              (22 22 (:REWRITE DEFAULT-<-1))
                              (14 14 (:REWRITE DEFAULT-CAR))
                              (4 4 (:REWRITE DEFAULT-CDR)))
(GL::INTEGERP-+)
(GL::ACL2-NUMBERP-WHEN-INTEGERP)
(GL::PROF-ENSURE-INDEX (946 86 (:REWRITE NTH-IN-U32-LISTP-INTEGERP))
                       (860 129 (:DEFINITION U32-LISTP))
                       (800 164 (:DEFINITION LEN))
                       (775 595 (:REWRITE DEFAULT-+-2))
                       (698 549 (:REWRITE DEFAULT-<-2))
                       (639 408 (:REWRITE DEFAULT-*-2))
                       (610 549 (:REWRITE DEFAULT-<-1))
...
(GL::PROF-INDEX-IN-RANGE-OF-PROF-ENSURE-INDEX
     ...
     (4 4 (:TYPE-PRESCRIPTION ZP)))
(GL::PROF-ENSURE-INDEX-FRAME (440 42 (:REWRITE RESIZE-LIST-OF-LEN-FREE))
                             (404 14 (:DEFINITION RESIZE-LIST))
                             ...
                             (4 4 (:TYPE-PRESCRIPTION ZP)))
(GL::PROF-INCREMENT-STACKCOUNT (35 7 (:DEFINITION LEN))
...
(GL::PROF-INCREMENT-STACKCOUNT-LEN
     ...
     (6 3 (:REWRITE DEFAULT-DENOMINATOR))
     (3 3 (:REWRITE RATIONALP-*)))
(GL::PROF-DECREMENT-STACKCOUNT (95 19 (:DEFINITION LEN))
...
(GL::PROF-DECREMENT-STACKCOUNT-LEN
     ...
     (9 9
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(GL::PROF-PUSH (22 2 (:REWRITE NTH-IN-U32-LISTP-INTEGERP))
               (20 3 (:DEFINITION U32-LISTP))
               (15 3 (:DEFINITION LEN))
               (12 2
                   (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
...
(GL::PROF-INCREMENT-INDEX (170 34 (:DEFINITION LEN))
...
(GL::PROF-INCREMENT-INDEX-FRAME
     ...
     (2 2 (:REWRITE SUBSETP-MEMBER . 2))
     (2 2 (:REWRITE SUBSETP-MEMBER . 1)))
(GL::PROF-INCREMENT-BASE (25 5 (:DEFINITION LEN))
                         ...
                         (2 1
                            (:REWRITE GL::PROF-DECREMENT-STACKCOUNT-FRAME))
...
(GL::PROF-INCREMENT-BASE-FRAME
     ...
     (2 2 (:REWRITE FOLD-CONSTS-IN-+))
     (2 2 (:REWRITE DEFAULT-UNARY-MINUS)))
(GL::PROF-POP-INCREMENT (154 14 (:REWRITE NTH-IN-U32-LISTP-INTEGERP))
                        (140 21 (:DEFINITION U32-LISTP))
                        (84 14
                            (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
                        (56 7 (:DEFINITION TRUE-LISTP))
...
(GL::PROF-POP-INCREMENT-REDUCES-STACK
     ...
     (3 3
        (:REWRITE GL::ACL2-NUMBERP-WHEN-INTEGERP)))
(GL::PROF-POP-INCREMENT-FRAME (15 3 (:DEFINITION LEN))
                              (9 9 (:REWRITE DEFAULT-CAR))
                              ...
                              (3 3
                                 (:REWRITE GL::ACL2-NUMBERP-WHEN-INTEGERP)))
(GL::PROF-SIMPLE-INCREMENT (22 2 (:REWRITE NTH-IN-U32-LISTP-INTEGERP))
                           (20 3 (:DEFINITION U32-LISTP))
                           (15 3 (:DEFINITION LEN))
                           (12 2
                               (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
...
(GL::PROF-RESET)
(GL::PROF-UNWIND-STACK-AUX (22 2 (:REWRITE NTH-IN-U32-LISTP-INTEGERP))
                           (20 3 (:DEFINITION U32-LISTP))
                           (15 3 (:DEFINITION LEN))
                           (12 2
                               (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
...
(GL::PROF-ENTRY->NAME$INLINE (4 4 (:DEFINITION ASSOC-EQUAL)))
(GL::PROF-ENTRY->TRIES-SUCC$INLINE (4 4 (:DEFINITION ASSOC-EQUAL)))
(GL::PROF-ENTRY->TRIES-FAIL$INLINE (4 4 (:DEFINITION ASSOC-EQUAL)))
(GL::PROF-ENTRY->FRAMES-SUCC$INLINE (4 4 (:DEFINITION ASSOC-EQUAL)))
(GL::PROF-ENTRY->FRAMES-FAIL$INLINE (4 4 (:DEFINITION ASSOC-EQUAL)))
...
(GL::PROF-ENTRY-TRIES-COMPARE<-TRANSITIVE
     (222 150
          (:TYPE-PRESCRIPTION GL::RETURN-TYPE-OF-PROF-ENTRY->TRIES-SUCC))
     (222 150
          (:TYPE-PRESCRIPTION GL::RETURN-TYPE-OF-PROF-ENTRY->TRIES-FAIL))
     (144 144
          (:TYPE-PRESCRIPTION GL::PROF-ENTRY-TRIES-TYPE-OF-COMPARABLEP))
...
(DEFSORT-COMPARABLE-LIST-CHECK
     (7 4
        (:REWRITE GL::PROF-ENTRY-TRIES-COMPARE<-NEGATION-TRANSITIVE)))
...
(GL::PROF-ENTRY-TRIES-ORDERED-P
     ...
     (4 4
        (:REWRITE GL::PROF-ENTRY-TRIES-COMPARE<-TRANSITIVE))
     (4 4
        (:REWRITE GL::PROF-ENTRY-TRIES-COMPARE<-NEGATION-TRANSITIVE)))
...
(GL::PROF-ENTRY-TRIES-SORT (13 13
                               (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP)))
(DEFSORT-SUBST1-OK
     (8 8
        (:REWRITE GL::PROF-ENTRY-TRIES-COMPARE<-TRANSITIVE))
...
(GL::PROF-ENTRY-TRIES-NO-DUPLICATESP-EQUAL)
(GL::PROF-ENTRY-TRIES-TRUE-LISTP)
(GL::PROF-ENTRY-TRIES-LEN)
(GL::PROF-ENTRY-TRIES-CONSP)
...
(GL::PROF-ENTRY-TRIES-INSERT
     ...
     (2 2
        (:REWRITE GL::PROF-ENTRY-TRIES-COMPARE<-NEGATION-TRANSITIVE)))
(GL::PROF-ENTRY-TRIES-INSERTSORT (7 7
                                    (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP)))
(DEFSORT-SUBST2-OK
     (2 2
        (:REWRITE GL::PROF-ENTRY-TRIES-COMPARE<-TRANSITIVE))
...
(GL::PROF-ENTRY-FRAMES-COMPARE<-TRANSITIVE
     (222 150
          (:TYPE-PRESCRIPTION GL::RETURN-TYPE-OF-PROF-ENTRY->FRAMES-SUCC))
     (222 150
          (:TYPE-PRESCRIPTION GL::RETURN-TYPE-OF-PROF-ENTRY->FRAMES-FAIL))
     (144 144
          (:TYPE-PRESCRIPTION GL::PROF-ENTRY-FRAMES-TYPE-OF-COMPARABLEP))
     (36 12 (:REWRITE DEFAULT-+-2))
     (36 12 (:REWRITE DEFAULT-+-1))
     (15 3 (:REWRITE DEFAULT-<-2))
     (15 3 (:REWRITE DEFAULT-<-1)))
...
(DEFSORT-COMPARABLE-LIST-CHECK
     (7 4
        (:REWRITE GL::PROF-ENTRY-FRAMES-COMPARE<-NEGATION-TRANSITIVE)))
(DEFSORT-COMPARABLEP-OF-CAR)
(DEFSORT-COMPARABLE-LISTP-OF-CDR (1 1 (:REWRITE DEFAULT-CDR)))
(GL::PROF-ENTRY-FRAMES-ORDERED-P
     (13 13
         (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP))
     (4 4
        (:REWRITE GL::PROF-ENTRY-FRAMES-COMPARE<-TRANSITIVE))
     (4 4
        (:REWRITE GL::PROF-ENTRY-FRAMES-COMPARE<-NEGATION-TRANSITIVE)))
...
(GL::PROF-ENTRY-FRAMES-SORT (13 13
                                (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP)))
(DEFSORT-SUBST1-OK
     (8 8
        (:REWRITE GL::PROF-ENTRY-FRAMES-COMPARE<-TRANSITIVE))
...
(GL::PROF-ENTRY-FRAMES-NO-DUPLICATESP-EQUAL)
(GL::PROF-ENTRY-FRAMES-TRUE-LISTP)
(GL::PROF-ENTRY-FRAMES-LEN)
(GL::PROF-ENTRY-FRAMES-CONSP)
...
(GL::PROF-ENTRY-FRAMES-INSERT
     ...
     (2 2
        (:REWRITE GL::PROF-ENTRY-FRAMES-COMPARE<-NEGATION-TRANSITIVE)))
(GL::PROF-ENTRY-FRAMES-INSERTSORT (7 7
                                     (:REWRITE DEFSORT-LEN-WHEN-NOT-CONSP)))
(DEFSORT-SUBST2-OK
     (2 2
        (:REWRITE GL::PROF-ENTRY-FRAMES-COMPARE<-TRANSITIVE))
...
(GL::PROF->PROF-ENTRY (78 6 (:REWRITE NTH-IN-U32-LISTP-INTEGERP))
...
(GL::PROF-ENTRY-P-OF-PROF->PROF-ENTRY
     ...
     (3 3 (:REWRITE DEFAULT-+-1))
     (2 2
        (:REWRITE GL::PROF-ENTRY-P-WHEN-MEMBER-EQUAL-OF-PROF-ENTRYLIST-P))
     (1 1
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (1 1
        (:REWRITE GL::ACL2-NUMBERP-WHEN-INTEGERP)))
(GL::PROF->PROF-ENTRYLIST-AUX
     ...
     (2 2 (:REWRITE SUBSETP-MEMBER . 1))
     (2 2
        (:REWRITE GL::PROF-ENTRYLIST-P-WHEN-NOT-CONSP))
     (2 2 (:REWRITE SET::IN-SET)))
...
(GL::PROF-ENTRY-PRINT
     ...
     (2 2 (:DEFINITION MOD)))
(GL::PROF-ENTRYLIST-PRINT (1 1 (:REWRITE SUBSETP-TRANS2))
                          (1 1 (:REWRITE SUBSETP-TRANS))
                          (1 1
                             (:REWRITE GL::PROF-ENTRYLIST-P-WHEN-NOT-CONSP))
                          (1 1 (:REWRITE DEFAULT-CDR))
                          (1 1 (:REWRITE DEFAULT-CAR)))
(GL::PROF-PRINT-REPORT (22 2 (:REWRITE NTH-IN-U32-LISTP-INTEGERP))
                       (20 3 (:DEFINITION U32-LISTP))
                       (12 2
                           (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
                       (8 1 (:DEFINITION TRUE-LISTP))
