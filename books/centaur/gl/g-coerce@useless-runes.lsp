(GL::REVAPPEND-CONCRETE (1 1 (:TYPE-PRESCRIPTION MK-G-CONCRETE)))
...
(GL::REVAPPEND-CONCRETE-CORRECT
     ...
     (57 30
         (:TYPE-PRESCRIPTION GL::REVAPPEND-CONCRETE))
...
(GL::COERCE-STRING-OF-BFR-HYP-FIX
     ...
     (680 128
          (:DEFINITION GL::REVAPPEND-CONCRETE))
...
(GL::REVAPPEND-CHARACTER-LISTS
     ...
     (1 1
        (:REWRITE GL::REVAPPEND-NON-CHARACTER-LIST-NOT-CHARACTER-LIST)))
(GL::COERCE-REVAPPEND-ATOM
     ...
     (24 4
         (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
     (23 4
         (:REWRITE GL::REVAPPEND-CHARACTER-LISTS))
     ...
     (2 2
        (:REWRITE GL::MAKE-CHARACTER-LIST-CHARACTER-LIST))
...
(GL::CONSP-EVAL-G-BASE-BOOLEAN
     ...
     (2 1
        (:REWRITE GL::GENERAL-BOOLEAN-VALUE-CORRECT-FOR-EVAL-G-BASE))
     (2 1
        (:REWRITE GL::EVAL-G-BASE-GENERAL-CONCRETE-OBJ))
...
(GL::COERCE-STRING-CORRECT
     ...
     (813 105
          (:REWRITE GL::COERCE-STRING-NON-CONSP))
     ...
     (259 11
          (:DEFINITION GL::GENERAL-CONCRETE-OBJ))
     ...
     (165 63
          (:REWRITE GL::CONSP-EVAL-G-BASE-INTEGER))
     (165 63
          (:REWRITE GL::CONSP-EVAL-G-BASE-BOOLEAN))
     (156 78
          (:REWRITE GL::BFR-HYP-FIX-WHEN-HYP$AP))
...
(GL::COERCE-LIST
     ...
     (306 17
          (:REWRITE GL::G-IF-FN-OF-BFR-HYP-FIX))
     ...
     (94 94
         (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
     (85 85
         (:REWRITE GL::BFR-ASSUME$A-OF-BFR-HYP-FIX))
     (77 77
         (:REWRITE GL::GENERAL-CONCRETEP-OF-ATOMIC-CONSTANTS))
     (51 51
         (:TYPE-PRESCRIPTION GL::GENERAL-INTEGERP))
     ...
     (24 12
         (:TYPE-PRESCRIPTION GL::MK-G-BDD-ITE))
     (17 17
         (:REWRITE GL::MK-G-BDD-ITE-OF-BFR-HYP-FIX))
...
(GL-THM::|COMMON-LISP::COERCE$-CORRECT|
     (12747 643
            (:REWRITE GL::GENERAL-CONCRETE-OBJ-CORRECT-FOR-EVAL-G-BASE))
     (5595 1673
           (:REWRITE GL::ATOM-IMPL-GENERAL-CONCRETEP-1))
     (5106 5106
           (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
