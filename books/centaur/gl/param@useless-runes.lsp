...
(GL::GOBJ-TO-PARAM-SPACE)
(GL::NTH-OPEN-CONST-IDX (15 5 (:REWRITE ZP-OPEN))
                        (12 12
                            (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
...
(GL::FLAG-LEMMA-FOR-GOBJ-TO-PARAM-SPACE-CORRECT
     ...
     (1 1
        (:REWRITE GL::BFR-LIST->S-TO-PARAM-SPACE-LIST-WITH-UNPARAM-ENV))
     (1 1
...
(GL::EVAL-BFR-TO-PARAM-SPACE-SELF
     ...
     (28 6
         (:REWRITE ALISTP-WHEN-HONS-DUPLICITY-ALIST-P))
     (28 2 (:REWRITE INTERSECTP-EQUAL-COMMUTE))
     (27 27
...
(GL::TERM-EQUIVSP-WHEN-SAME-NEXT/BASE
     ...
     (13 13
         (:REWRITE GL::ALISTP-WHEN-TERM-EQUIVSP))
     (10 10
         (:TYPE-PRESCRIPTION HONS-DUPLICITY-ALIST-P))
...
(GL::PARAMETRIZE-BVAR-DB
     ...
     (2 2
        (:REWRITE GL::TERM-EQUIVSP-WHEN-SAME-NEXT/BASE))
     (2 2
        (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
     (2 2
        (:LINEAR GL::TERM-BVAR-LESS-THAN-NEXT-BVAR$A))
