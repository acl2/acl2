...
(BITOPS::FAST-LOGEXT-EXEC-IS-LOGEXT
 (4262 15 (:LINEAR BITOPS::LOGXOR-<-0-LINEAR-2))
 (4239 23 (:REWRITE LOGEXT-IDENTITY))
 (4170 53 (:REWRITE BITOPS::SIGNED-BYTE-P-OF-LOGCDR))
 (3170 23 (:DEFINITION SIGNED-BYTE-P))
 (3010 14 (:REWRITE BITOPS::LOGCDR-OF-LOGAND))
 (2183 252 (:REWRITE RIGHT-SHIFT-TO-LOGTAIL))
 (1923 820 (:REWRITE IFIX-WHEN-NOT-INTEGERP))
 (1870 47 (:DEFINITION BITOPS::LOGNOT$))
 ...
 (993 17 (:LINEAR BITOPS::LOGAND->=-0-LINEAR-2))
 (956 17 (:LINEAR BITOPS::UPPER-BOUND-OF-LOGAND . 2))
 (893 655 (:REWRITE DEFAULT-+-1))
 (868 868 (:TYPE-PRESCRIPTION BITP))
 (833 603 (:REWRITE DEFAULT-<-2))
 (792 792 (:TYPE-PRESCRIPTION BITOPS::LOGNOT-NATP))
 ...
 (520 462 (:TYPE-PRESCRIPTION BITOPS::LOGCONS-POSP-2))
...
(BITOPS::LOGEXT-OF-GREATER-THAN-LENGTH
 ...
 (180 2 (:REWRITE BITOPS::SIGNED-BYTE-P-OF-LOGCDR))
...
(BITOPS::LOGHEAD-OF-GREATER-THAN-LENGTH
 (2362 1070 (:TYPE-PRESCRIPTION BITOPS::LOGCDR-NATP))
 (1730 13 (:REWRITE LOGHEAD-IDENTITY))
 (1212 14 (:DEFINITION UNSIGNED-BYTE-P**))
 (1183 25 (:DEFINITION UNSIGNED-BYTE-P))
 (1152 20 (:DEFINITION INTEGER-RANGE-P))
 (1048 70 (:REWRITE ZIP-OPEN))
 (991 991 (:TYPE-PRESCRIPTION NATP))
 (800 119 (:REWRITE BITOPS::LOGCDR-OF-BIT))
 (779 30 (:REWRITE UNSIGNED-BYTE-P-PLUS))
 (710 101 (:REWRITE BITOPS::LOGCAR-OF-BIT))
 (563 41 (:DEFINITION BIT->BOOL$INLINE))
 (506 506 (:TYPE-PRESCRIPTION BITP))
 (417 39 (:REWRITE BITOPS::LOGBITP-NONZERO-OF-BIT))
 (407 40 (:REWRITE BITOPS::LOGCDR-<-CONST))
 (390 43 (:LINEAR BITOPS::LOGCAR-BOUND))
 (293 135 (:TYPE-PRESCRIPTION BITOPS::LOGCONS-POSP-1))
 (270 135 (:TYPE-PRESCRIPTION BITOPS::LOGCONS-POSP-2))
