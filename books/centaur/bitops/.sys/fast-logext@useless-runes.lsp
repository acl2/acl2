...
(BITOPS::FAST-LOGEXT-EXEC-IS-LOGEXT
 ...
 (4158 23 (:REWRITE LOGEXT-IDENTITY))
 (4112 53 (:REWRITE BITOPS::SIGNED-BYTE-P-OF-LOGCDR))
 ...
 (493 23 (:DEFINITION SIGNED-BYTE-P**))
