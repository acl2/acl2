...
(BITOPS::SMALLER-MODS-ARE-STILL-THE-SAME
 (20371 100 (:REWRITE LOGHEAD-IDENTITY))
 (11359 186 (:DEFINITION UNSIGNED-BYTE-P))
 (10769 214 (:DEFINITION UNSIGNED-BYTE-P**))
 (8763 428 (:REWRITE UNSIGNED-BYTE-P-PLUS))
 (6776 3335 (:TYPE-PRESCRIPTION BITOPS::LOGCDR-NATP))
 (6364 167 (:DEFINITION INTEGER-RANGE-P))
 (3734 215 (:DEFINITION ASH**))
...
(BITOPS::|(2^n + a mod 2^n) when a < 2^n+1|
 (6869 193 (:DEFINITION UNSIGNED-BYTE-P**))
 (6657 386 (:REWRITE UNSIGNED-BYTE-P-PLUS))
...
(BITOPS::UPPER-BOUND-OF-LOGXOR-FOR-NATURALS
 ...
 (1486 370 (:REWRITE BITOPS::LOGCDR-OF-BIT))
 (1322 1322 (:TYPE-PRESCRIPTION BITP))
 (1284 1053 (:REWRITE DEFAULT-<-2))
 (1283 293 (:REWRITE BITOPS::LOGCAR-OF-BIT))
 (1224 1053 (:REWRITE DEFAULT-<-1))
 (851 723 (:REWRITE IFIX-WHEN-NOT-INTEGERP))
 ...
 (407 47 (:LINEAR BITOPS::LOGXOR-<-0-LINEAR-2))
 (394 47 (:LINEAR BITOPS::LOGXOR->=-0-LINEAR-1))
 (394 47 (:LINEAR BITOPS::LOGXOR-<-0-LINEAR-1))
...
(BITOPS::RW-LESS-1
 (92 67 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(BITOPS::LOGHEAD-OF-NEGATIVE
 (18523 648 (:REWRITE UNSIGNED-BYTE-P-PLUS))
 (3369 3369 (:TYPE-PRESCRIPTION BITOPS::LOGNOT-NATP))
 (3191 974 (:REWRITE DEFAULT-+-2))
 (3057 974 (:REWRITE DEFAULT-+-1))
 (2144 2144 (:TYPE-PRESCRIPTION BITP))
 (1918 723 (:REWRITE DEFAULT-<-1))
