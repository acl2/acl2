...
(BITOPS::INTEGER-LENGTH-OF-LOGHEAD
 (239 2 (:REWRITE LOGHEAD-IDENTITY))
 (201 1 (:DEFINITION LOGHEAD**))
...
(BITOPS::SMALLER-MODS-ARE-STILL-THE-SAME
 (20355 100 (:REWRITE LOGHEAD-IDENTITY))
 (11346 186 (:DEFINITION UNSIGNED-BYTE-P))
 (10753 214 (:DEFINITION UNSIGNED-BYTE-P**))
 (8761 428 (:REWRITE UNSIGNED-BYTE-P-PLUS))
 (6776 3335 (:TYPE-PRESCRIPTION BITOPS::LOGCDR-NATP))
 (6364 167 (:DEFINITION INTEGER-RANGE-P))
 (3721 215 (:DEFINITION ASH**))
...
(BITOPS::|(2^n + a mod 2^n) when a < 2^n+1|
 ...
 (193 45 (:REWRITE COMMUTATIVITY-OF-*))
...
(BITOPS::|(2^n + a mod 2^n) when 2^n+1 <= a, a[n] = 1|
 (8499 360 (:REWRITE UNSIGNED-BYTE-P-PLUS))
 (7224 180 (:DEFINITION UNSIGNED-BYTE-P**))
 (2687 346 (:REWRITE BITOPS::LOGCDR-OF-BIT))
 (2675 2675 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
 ...
 (864 78 (:REWRITE EXPONENTS-ADD))
 (784 79 (:REWRITE ZIP-OPEN))
 (772 97 (:REWRITE ZP-WHEN-GT-0))
 (771 540 (:REWRITE DEFAULT-+-2))
...
(BITOPS::UPPER-BOUND-OF-LOGXOR-FOR-NATURALS
 (2948 2948 (:TYPE-PRESCRIPTION POSP))
 (2257 377 (:REWRITE RIGHT-SHIFT-TO-LOGTAIL))
 (1492 370 (:REWRITE BITOPS::LOGCDR-OF-BIT))
 (1322 1322 (:TYPE-PRESCRIPTION BITP))
 (1289 293 (:REWRITE BITOPS::LOGCAR-OF-BIT))
 (1284 1053 (:REWRITE DEFAULT-<-2))
 (1224 1053 (:REWRITE DEFAULT-<-1))
 (866 723 (:REWRITE IFIX-WHEN-NOT-INTEGERP))
 ...
 (419 47 (:LINEAR BITOPS::LOGXOR-<-0-LINEAR-2))
 (406 47 (:LINEAR BITOPS::LOGXOR->=-0-LINEAR-1))
 (406 47 (:LINEAR BITOPS::LOGXOR-<-0-LINEAR-1))
...
(BITOPS::|(logcar (expt 2 n))|
 (57 7 (:REWRITE BITOPS::LOGCAR-OF-BIT))
...
(BITOPS::RW-LESS-1
 (83 61 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(BITOPS::MOD-POSITIVE-BOUND
 ...
 (145 113 (:REWRITE DEFAULT-UNARY-MINUS))
...
(BITOPS::|(logbitp n (+ (expt 2 n) a))|
 (8699 56 (:REWRITE BITOPS::LOGBITP-WHEN-BITMASKP))
 (8539 53 (:DEFINITION BITMASKP**))
 (2319 1026 (:TYPE-PRESCRIPTION BITOPS::LOGCDR-NATP))
 (1220 41 (:REWRITE BITOPS::LOGCDR-OF-LEFT-SHIFT))
 ...
 (658 242 (:REWRITE DEFAULT-+-1))
 (516 242 (:REWRITE DEFAULT-+-2))
...
(BITOPS::LOGHEAD-OF-NEGATIVE
 (18535 648 (:REWRITE UNSIGNED-BYTE-P-PLUS))
 (3369 3369 (:TYPE-PRESCRIPTION BITOPS::LOGNOT-NATP))
 (3203 976 (:REWRITE DEFAULT-+-2))
 (3065 976 (:REWRITE DEFAULT-+-1))
 (2146 2146 (:TYPE-PRESCRIPTION BITP))
 (1930 727 (:REWRITE DEFAULT-<-1))
 (1914 24 (:REWRITE <-MINUS-ZERO))
 (1608 208 (:REWRITE ZP-WHEN-GT-0))
 (1442 17 (:REWRITE <-*-/-RIGHT-COMMUTED))
 (1226 1226 (:META CANCEL_PLUS-LESSP-CORRECT))
 (1176 13 (:REWRITE BITOPS::EXPT-2-LOWER-BOUND-BY-LOGBITP))
 (1012 727 (:REWRITE DEFAULT-<-2))
 (884 884 (:REWRITE BITOPS::UNSIGNED-BYTE-P-INCR))
 (843 74 (:REWRITE EQUAL-CONSTANT-+))
 (827 827 (:META CANCEL_TIMES-EQUAL-CORRECT))
 (827 827 (:META CANCEL_PLUS-EQUAL-CORRECT))
 (808 8 (:DEFINITION LOGBITP**))
 (665 572 (:REWRITE EXPT-WITH-VIOLATED-GUARDS))
 (652 16 (:REWRITE BITOPS::LOGBITP-WHEN-BITMASKP))
 (604 16 (:DEFINITION BITMASKP**))
 (557 151 (:REWRITE EXPONENTS-ADD))
 (484 484 (:TYPE-PRESCRIPTION BIT->BOOL$INLINE))
 (459 108 (:REWRITE DEFAULT-*-2))
 (450 17 (:REWRITE COMMUTATIVITY-OF-*))
 (406 406 (:LINEAR BITOPS::LOGCDR-<=-LOGCDR))
 (388 8 (:REWRITE DISTRIBUTIVITY))
 (354 177 (:REWRITE BFIX-WHEN-NOT-BIT->BOOL))
 (354 177 (:REWRITE BFIX-WHEN-BIT->BOOL))
 (240 240 (:REWRITE-QUOTED-CONSTANT IFIX-UNDER-INT-EQUIV))
 (222 222 (:TYPE-PRESCRIPTION POSP))
 (196 98 (:REWRITE BFIX-WHEN-NOT-BITP))
 (124 62 (:LINEAR BITOPS::B-AND-BOUND))
 (119 108 (:REWRITE DEFAULT-*-1))
 (102 51 (:REWRITE POSP-NATP))
