...
(MOD-OF-Y-NEGATIVE-STEP
 (37 33 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
 (35 31 (:TYPE-PRESCRIPTION |x < y  =>  0 < y-x|))
...
(TRUNCATE-REM-IND
 (1121 182 (:REWRITE COMMUTATIVITY-OF-+))
 (1045 718 (:REWRITE DEFAULT-<-1))
 (1034 958 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(TRUNCATE-BOUND
 ...
 (92 76 (:REWRITE DEFAULT-UNARY-MINUS))
...
(TRUNCATE-UNIQUE
 ...
 (223 193 (:REWRITE DEFAULT-UNARY-MINUS))
...
(FLOOR-UNIQUE
 ...
 (97 79 (:REWRITE DEFAULT-UNARY-MINUS))
