...
(BITOPS::LOGCDR-LOGCDR-INDUCT (6 2 (:REWRITE ZP-WHEN-GT-0))
...
(BITOPS::LOGBITP-WHEN-TOO-SMALL (2 2 (:REWRITE EXPT-WITH-VIOLATED-GUARDS)))
...
(BITOPS::SMALLER-MODS-ARE-STILL-THE-SAME
     (19042 100 (:REWRITE LOGHEAD-IDENTITY))
     (9635 167 (:DEFINITION UNSIGNED-BYTE-P))
     (8705 234 (:DEFINITION UNSIGNED-BYTE-P**))
     (8618 468 (:REWRITE UNSIGNED-BYTE-P-PLUS))
     (6226 3062
           (:TYPE-PRESCRIPTION BITOPS::LOGCDR-NATP))
     (5523 167 (:DEFINITION INTEGER-RANGE-P))
     (2855 215 (:DEFINITION ASH**))
     (2727 221 (:REWRITE BITOPS::LOGCDR-OF-BIT))
     (2540 430 (:REWRITE RIGHT-SHIFT-TO-LOGTAIL))
     (1938 1938
           (:TYPE-PRESCRIPTION UNSIGNED-BYTE-P))
     (1405 1227 (:REWRITE DEFAULT-<-1))
     (1394 1227 (:REWRITE DEFAULT-<-2))
     (930 178 (:REWRITE LOGCDR-<-0))
     (836 836 (:LINEAR BITOPS::LOGCDR-<=-LOGCDR))
     (646 646 (:TYPE-PRESCRIPTION BITP))
     (635 635
          (:REWRITE BITOPS::UNSIGNED-BYTE-P-INCR))
...
(BITOPS::|(2^n + a mod 2^n) when a < 2^n+1|
     (6830 450 (:REWRITE UNSIGNED-BYTE-P-PLUS))
     (5732 225 (:DEFINITION UNSIGNED-BYTE-P**))
     (3127 394 (:REWRITE RIGHT-SHIFT-TO-LOGTAIL))
     (3080 3080
           (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
     (1585 37 (:REWRITE <-*-/-RIGHT-COMMUTED))
     (1564 391 (:REWRITE <-0-+-NEGATIVE-1))
     (1555 324 (:REWRITE BITOPS::LOGCDR-OF-BIT))
     (1443 1443 (:META CANCEL_PLUS-LESSP-CORRECT))
     (1236 503
           (:TYPE-PRESCRIPTION BITOPS::LOGCONS-POSP-1))
     (1192 933 (:REWRITE DEFAULT-<-2))
     (1122 933 (:REWRITE DEFAULT-<-1))
     (900 113 (:REWRITE ZP-WHEN-GT-0))
     (897 503
          (:TYPE-PRESCRIPTION BITOPS::LOGCONS-POSP-2))
     (882 96 (:REWRITE EXPONENTS-ADD))
     (814 814 (:TYPE-PRESCRIPTION BITP))
     (775 396 (:REWRITE IFIX-WHEN-NOT-INTEGERP))
     (600 600
          (:REWRITE BITOPS::UNSIGNED-BYTE-P-INCR))
     (535 427 (:REWRITE DEFAULT-+-2))
     (510 108 (:REWRITE BITOPS::LOGCAR-OF-BIT))
     (483 483 (:TYPE-PRESCRIPTION POSP))
     (464 464 (:LINEAR BITOPS::LOGCDR-<=-LOGCDR))
     (459 427 (:REWRITE DEFAULT-+-1))
     (421 370
          (:REWRITE EXPT-WITH-VIOLATED-GUARDS))
     (398 398
          (:TYPE-PRESCRIPTION BIT->BOOL$INLINE))
     ...
     (188 188 (:REWRITE BITOPS::LOGCDR-<-CONST))
     (180 45 (:REWRITE <-+-NEGATIVE-0-1))
     (151 111 (:REWRITE DEFAULT-*-1))
     (151 37 (:REWRITE COMMUTATIVITY-OF-*))
...
(BITOPS::|(2^n + a mod 2^n) when 2^n+1 <= a, a[n] = 1|
     (8525 404 (:REWRITE UNSIGNED-BYTE-P-PLUS))
     (6091 202 (:DEFINITION UNSIGNED-BYTE-P**))
     (2774 357 (:REWRITE BITOPS::LOGCDR-OF-BIT))
     (2599 325 (:REWRITE RIGHT-SHIFT-TO-LOGTAIL))
     (2554 2554
           (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
     (2048 35
           (:REWRITE BITOPS::LOGBITP-WHEN-BITMASKP))
     (1948 37 (:DEFINITION BITMASKP**))
     (1657 21 (:REWRITE <-*-/-RIGHT-COMMUTED))
     (1631 217 (:REWRITE BITOPS::LOGCAR-OF-BIT))
     (1420 355 (:REWRITE <-0-+-NEGATIVE-1))
     (1235 1235 (:META CANCEL_PLUS-LESSP-CORRECT))
     (1162 1162 (:TYPE-PRESCRIPTION BITP))
     (1110 429
           (:TYPE-PRESCRIPTION BITOPS::LOGCONS-POSP-1))
     (1048 760 (:REWRITE DEFAULT-<-1))
     (1032 760 (:REWRITE DEFAULT-<-2))
     (784 79 (:REWRITE ZIP-OPEN))
     (772 97 (:REWRITE ZP-WHEN-GT-0))
     (748 429
          (:TYPE-PRESCRIPTION BITOPS::LOGCONS-POSP-2))
     (727 70 (:LINEAR BITOPS::LOGCAR-BOUND))
     (686 686 (:LINEAR BITOPS::LOGCDR-<=-LOGCDR))
     (675 75 (:REWRITE EXPONENTS-ADD))
     (652 321 (:REWRITE IFIX-WHEN-NOT-INTEGERP))
     (545 545
          (:REWRITE BITOPS::UNSIGNED-BYTE-P-INCR))
     (482 399 (:REWRITE DEFAULT-+-2))
     ...
     (97 21 (:REWRITE COMMUTATIVITY-OF-*))
     (64 6
         (:REWRITE THIS-NEEDS-TO-BE-ADDED-TO-QUOTIENT-REMAINDER-LEMMAS))
...
(BITOPS::UPPER-BOUND-OF-LOGXOR-FOR-NATURALS
     ...
     (1 1
        (:LINEAR BITOPS::EXPT-2-LOWER-BOUND-BY-LOGBITP)))
(BITOPS::LEMMA1 (10 10 (:REWRITE EXPT-WITH-VIOLATED-GUARDS))
...
(BITOPS::LEMMA2-1 (3 3 (:REWRITE DEFAULT-<-2))
                  (3 3 (:REWRITE DEFAULT-<-1))
                  (2 2 (:REWRITE DEFAULT-UNARY-/)))
(BITOPS::LEMMA2 (105 85 (:REWRITE DEFAULT-<-2))
...
(BITOPS::LEMMA3)
(BITOPS::INTEGERP-OF-EXPT (56 3 (:DEFINITION EXPT))
                          ...
                          (2 2 (:REWRITE DEFAULT-UNARY-/)))
(BITOPS::|(logcdr (expt 2 n))| (13 3 (:REWRITE RIGHT-SHIFT-TO-LOGTAIL))
                               ...
                               (2 2 (:REWRITE DEFAULT-+-2))
                               (2 2 (:REWRITE DEFAULT-+-1)))
(BITOPS::|(logcar (expt 2 n))| (63 8 (:REWRITE BITOPS::LOGCAR-OF-BIT))
...
(BITOPS::EXPT->=-0 (25 17 (:REWRITE DEFAULT-<-1))
...
(BITOPS::RW-LESS-1 (90 65
                   ...
                   (1 1 (:META CANCEL_TIMES-EQUAL-CORRECT))
                   (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(BITOPS::RW-LESS-2 (4 2 (:REWRITE DEFAULT-*-2))
...
(BITOPS::RW-LESS-3 (6 4 (:REWRITE DEFAULT-*-2))
                   ...
                   (1 1 (:META CANCEL_TIMES-EQUAL-CORRECT))
                   (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(BITOPS::RW-LESS-4-1 (7 5 (:REWRITE DEFAULT-*-2))
...
(BITOPS::RW-LESS-4 (12 4 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
...
(BITOPS::LOGHEAD-OF-NEGATIVE
     (19901 698 (:REWRITE UNSIGNED-BYTE-P-PLUS))
     (3368 3368
           (:TYPE-PRESCRIPTION BITOPS::LOGNOT-NATP))
     (2963 839 (:REWRITE DEFAULT-+-1))
     (2958 839 (:REWRITE DEFAULT-+-2))
     (2222 2222 (:TYPE-PRESCRIPTION BITP))
     (1890 24 (:REWRITE <-MINUS-ZERO))
     (1835 708 (:REWRITE DEFAULT-<-1))
     (1596 206 (:REWRITE ZP-WHEN-GT-0))
     (1442 17 (:REWRITE <-*-/-RIGHT-COMMUTED))
     (1193 1193 (:META CANCEL_PLUS-LESSP-CORRECT))
     (1148 12
           (:REWRITE BITOPS::EXPT-2-LOWER-BOUND-BY-LOGBITP))
     (989 708 (:REWRITE DEFAULT-<-2))
     (914 914
          (:REWRITE BITOPS::UNSIGNED-BYTE-P-INCR))
     ...
     (488 145 (:REWRITE EXPONENTS-ADD))
     (470 470
          (:TYPE-PRESCRIPTION BIT->BOOL$INLINE))
     (450 17 (:REWRITE COMMUTATIVITY-OF-*))
     (423 99 (:REWRITE DEFAULT-*-2))
