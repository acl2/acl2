...
(BITOPS::SMALLER-MODS-ARE-STILL-THE-SAME
     (19399 100 (:REWRITE LOGHEAD-IDENTITY))
     (10521 186 (:DEFINITION UNSIGNED-BYTE-P))
     (10475 214 (:DEFINITION UNSIGNED-BYTE-P**))
     (8495 428 (:REWRITE UNSIGNED-BYTE-P-PLUS))
     (6776 3335
           (:TYPE-PRESCRIPTION BITOPS::LOGCDR-NATP))
     (6364 167 (:DEFINITION INTEGER-RANGE-P))
     (2863 215 (:DEFINITION ASH**))
...
(BITOPS::|(2^n + a mod 2^n) when a < 2^n+1|
     (6612 193 (:DEFINITION UNSIGNED-BYTE-P**))
     (6426 386 (:REWRITE UNSIGNED-BYTE-P-PLUS))
...
(BITOPS::|(2^n + a mod 2^n) when 2^n+1 <= a, a[n] = 1|
     (8204 360 (:REWRITE UNSIGNED-BYTE-P-PLUS))
     (7016 180 (:DEFINITION UNSIGNED-BYTE-P**))
...
(BITOPS::LOGHEAD-OF-NEGATIVE
     (18331 642 (:REWRITE UNSIGNED-BYTE-P-PLUS))
     (3278 3278
