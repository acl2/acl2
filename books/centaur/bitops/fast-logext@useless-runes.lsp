...
(BITOPS::LOGEXT-OF-GREATER-THAN-LENGTH
     (402 11 (:REWRITE LOGEXT-IDENTITY))
     (258 8 (:DEFINITION SIGNED-BYTE-P))
     (209 7 (:DEFINITION INTEGER-RANGE-P))
...
(BITOPS::LOGHEAD-OF-GREATER-THAN-LENGTH
     (2114 969
           (:TYPE-PRESCRIPTION BITOPS::LOGCDR-NATP))
     (1458 13 (:REWRITE LOGHEAD-IDENTITY))
     (1048 70 (:REWRITE ZIP-OPEN))
     (911 911 (:TYPE-PRESCRIPTION NATP))
     (851 122 (:REWRITE BITOPS::LOGCDR-OF-BIT))
     (735 21 (:DEFINITION UNSIGNED-BYTE-P))
     (723 42 (:REWRITE UNSIGNED-BYTE-P-PLUS))
     (710 101 (:REWRITE BITOPS::LOGCAR-OF-BIT))
     (708 20 (:DEFINITION INTEGER-RANGE-P))
     (642 20 (:DEFINITION UNSIGNED-BYTE-P**))
     ...
     (194 194 (:LINEAR BITOPS::LOGCDR-<=-LOGCDR))
     (187 125 (:REWRITE DEFAULT-<-2))
     (176 32 (:REWRITE BITOPS::LOGCDR-<-CONST))
     (171 171
     ...
     (61 61
         (:REWRITE BITOPS::UNSIGNED-BYTE-P-INCR))
     (54 37 (:REWRITE IFIX-WHEN-NOT-INTEGERP))
