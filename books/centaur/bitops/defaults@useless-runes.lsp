(BITOPS::LOGBITP-DEFAULT-1 (8 8 (:TYPE-PRESCRIPTION BITP))
...
(BITOPS::LOGAND-DEFAULT-2 (76 4 (:DEFINITION LOGAND**))
                          (48 12
                              (:REWRITE BITOPS::LOGAND-WITH-NEGATED-BITMASK))
                          (37 1
                              (:LINEAR BITOPS::LOGAND->=-0-LINEAR-2))
                          ...
                          (8 8 (:REWRITE SIMPLIFY-BIT-FUNCTIONS))
