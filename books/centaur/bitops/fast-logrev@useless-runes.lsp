...
(BITOPS::CROCK
 ...
 (9 3 (:REWRITE BITOPS::BASIC-UNSIGNED-BYTE-P-OF-*))
...
(BITOPS::CONSEQUENCE
 (3574 18 (:DEFINITION UNSIGNED-BYTE-P))
 ...
 (1530 918 (:TYPE-PRESCRIPTION BITOPS::LOGAND-NATP-TYPE-2))
 (1120 18 (:LINEAR BITOPS::LOGIOR-<-0-LINEAR-2))
 (1120 18 (:LINEAR BITOPS::LOGIOR-<-0-LINEAR-1))
 (953 171 (:TYPE-PRESCRIPTION BITOPS::LOGIOR-NATP-TYPE))
 (588 588 (:TYPE-PRESCRIPTION BITOPS::LOGAND-NATP-TYPE-1))
 (564 18 (:LINEAR BITOPS::LOGIOR->=-0-LINEAR))
 (420 36 (:LINEAR BITOPS::UPPER-BOUND-OF-LOGAND . 2))
 (388 36 (:LINEAR BITOPS::LOGAND->=-0-LINEAR-2))
 (360 117 (:REWRITE IFIX-WHEN-NOT-INTEGERP))
 (360 117 (:REWRITE IFIX-WHEN-INTEGERP))
 (348 36 (:LINEAR BITOPS::UPPER-BOUND-OF-LOGAND . 1))
 (300 36 (:LINEAR BITOPS::LOGAND->=-0-LINEAR-1))
 (296 162 (:REWRITE BITOPS::LOGAND-WITH-NEGATED-BITMASK))
 (296 162 (:REWRITE BITOPS::LOGAND-WITH-BITMASK))
 ...
 (36 18 (:REWRITE BITOPS::BASIC-UNSIGNED-BYTE-P-OF-*))
...
(BITOPS::CROCK2
 (145 1 (:REWRITE LOGHEAD-IDENTITY))
 ...
 (57 19 (:TYPE-PRESCRIPTION BITOPS::LOGIOR-NATP-TYPE))
 (36 36 (:TYPE-PRESCRIPTION BITMASKP$INLINE))
 (36 18 (:REWRITE BITOPS::LOGAND-WITH-NEGATED-BITMASK))
 (36 18 (:REWRITE BITOPS::LOGAND-WITH-BITMASK))
 (36 4 (:LINEAR BITOPS::LOGAND->=-0-LINEAR-2))
 (36 2 (:LINEAR BITOPS::LOGIOR->=-0-LINEAR))
 (28 4 (:LINEAR BITOPS::UPPER-BOUND-OF-LOGAND . 2))
 (28 4 (:LINEAR BITOPS::UPPER-BOUND-OF-LOGAND . 1))
 (28 4 (:LINEAR BITOPS::LOGAND->=-0-LINEAR-1))
...
(FAST-LOGREV-U8$INLINE
 ...
 (51 30 (:REWRITE BITOPS::LOGAND-WITH-NEGATED-BITMASK))
 ...
 (28 4 (:LINEAR BITOPS::UPPER-BOUND-OF-LOGAND . 2))
 (28 4 (:LINEAR BITOPS::UPPER-BOUND-OF-LOGAND . 1))
 (28 4 (:LINEAR BITOPS::LOGAND->=-0-LINEAR-2))
 (28 4 (:LINEAR BITOPS::LOGAND->=-0-LINEAR-1))
...
(FAST-LOGREV-U16)
(BITOPS::CROCK
 (2550 234 (:REWRITE BITOPS::LOGREV-WHEN-ZIP))
 (2000 19 (:LINEAR BITOPS::LOGIOR-<-0-LINEAR-2))
 (1933 235 (:REWRITE ZIP-OPEN))
 (1164 582 (:TYPE-PRESCRIPTION BITOPS::LOGTAIL-NATP))
 (965 63 (:LINEAR BITOPS::LOGREV-UPPER-BOUND . 2))
 (902 63 (:LINEAR BITOPS::LOGREV-UPPER-BOUND . 1))
 (898 19 (:LINEAR BITOPS::LOGIOR-<-0-LINEAR-1))
 ...
 (239 1 (:LINEAR BITOPS::LOGBITP-MISMATCH-UPPER-BOUND))
 (237 1 (:REWRITE BITOPS::LOGBITP-MISMATCH-UNDER-IFF))
