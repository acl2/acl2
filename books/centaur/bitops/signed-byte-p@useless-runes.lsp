...
(BITOPS::L0 (3 3 (:REWRITE DEFAULT-<-2))
            (3 3 (:REWRITE DEFAULT-<-1))
            (3 3 (:META CANCEL_PLUS-LESSP-CORRECT))
...
(BITOPS::SIGNED-BYTE-P-OF-DECREMENT-WHEN-NATURAL-SIGNED-BYTE-P
     ...
     (2 2 (:REWRITE EXPONENTS-ADD))
     (2 2 (:REWRITE DEFAULT-*-1)))
(BITOPS::LEM-MULTIPLY-BOUND (32 8 (:LINEAR X*Y>1-POSITIVE))
                            (8 8 (:REWRITE DEFAULT-<-2))
                            (8 8 (:REWRITE DEFAULT-<-1))
                            (8 8 (:META CANCEL_PLUS-LESSP-CORRECT)))
(BITOPS::STEP1 (30 2 (:DEFINITION EXPT))
               ...
               (2 2
                  (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(BITOPS::UPPER-BOUND (180 12 (:DEFINITION EXPT))
...
(BITOPS::LOUSY-UNSIGNED-BYTE-P-OF-*
     ...
     (2 2
        (:LINEAR EXPT-IS-INCREASING-FOR-BASE>1)))
(BITOPS::CROCK (10 2 (:LINEAR X*Y>1-POSITIVE))
               (5 5
                  (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(BITOPS::STEP1 (142 142
               ...
               (2 2
                  (:LINEAR EXPT-IS-INCREASING-FOR-BASE>1)))
(BITOPS::STEP2 (246 7 (:LINEAR X*Y>1-POSITIVE))
               ...
               (2 2
                  (:REWRITE MINUS-CANCELLATION-ON-LEFT)))
(BITOPS::STEP3 (194 41 (:REWRITE DEFAULT-*-2))
...
(BITOPS::POS-CASE-LOWER-BOUND
     (2 1
        (:TYPE-PRESCRIPTION BITOPS::POS-CASE-LOWER-BOUND)))
(BITOPS::POS-CASE (80 3 (:DEFINITION EXPT))
...
(BITOPS::STEP1B (294 294
                ...
                (2 2
                   (:LINEAR EXPT-IS-INCREASING-FOR-BASE>1)))
(BITOPS::MIX-CASE-CRUX (108 24 (:REWRITE DEFAULT-*-2))
                       ...
                       (3 3 (:REWRITE NATP-RW))
                       (2 2 (:REWRITE POSP-RW)))
(BITOPS::MIX-CASE-UNWINDING (102 4 (:DEFINITION EXPT))
...
(BITOPS::MIX-CASE (247 9 (:DEFINITION EXPT))
...
(BITOPS::STEP1C (191 191
                ...
                (1 1
                   (:REWRITE *-PRESERVES->-FOR-NONNEGATIVES-1)))
(BITOPS::NEG-CASE-CRUX (106 22 (:REWRITE DEFAULT-*-2))
                       (100 12 (:REWRITE ZIP-OPEN))
                       (88 12 (:LINEAR X*Y>1-POSITIVE))
                       ...
                       (1 1
                          (:REWRITE *-PRESERVES->-FOR-NONNEGATIVES-1)))
(BITOPS::NEG-CASE-FINISH (194 41 (:REWRITE DEFAULT-*-2))
                         (74 41 (:REWRITE DEFAULT-*-1))
                         (65 36 (:REWRITE DEFAULT-<-1))
                         (62 60 (:REWRITE DEFAULT-+-1))
                         (60 60 (:REWRITE DEFAULT-+-2))
...
(BITOPS::NEG-CASE-LOWER-BOUND
     (1 1
        (:TYPE-PRESCRIPTION BITOPS::NEG-CASE-LOWER-BOUND)))
(BITOPS::NEG-CASE (247 9 (:DEFINITION EXPT))
                  ...
                  (9 9
                     (:REWRITE EXPONENTS-ADD-FOR-NONNEG-EXPONENTS))
                  (9 9 (:REWRITE EXPONENTS-ADD)))
(BITOPS::LOUSY-SIGNED-BYTE-P-OF-* (19 7 (:REWRITE NATP-RW))
...
(BITOPS::GATHER-EXPONENTS
     ...
     (2 2 (:REWRITE NATP-RW)))
(BITOPS::SU-STEP2 (68 2 (:LINEAR X*Y>1-POSITIVE))
...
(BITOPS::SU-POS-UPPER-BOUND
     ...
     (4 1 (:LINEAR X*Y>1-POSITIVE))
     (2 2 (:REWRITE POSP-RW)))
(BITOPS::SU-POS-CASE (129 1
                          (:REWRITE BITOPS::LOUSY-SIGNED-BYTE-P-OF-*))
                     ...
                     (1 1
                        (:REWRITE BITOPS::BASIC-SIGNED-BYTE-P-OF-*)))
(BITOPS::LEM-MULTIPLY-BOUND-2 (32 8 (:LINEAR X*Y>1-POSITIVE))
                              (8 8 (:REWRITE DEFAULT-<-2))
                              (8 8 (:REWRITE DEFAULT-<-1))
                              (8 8 (:META CANCEL_PLUS-LESSP-CORRECT)))
(BITOPS::SU-NEG-STEP1 (116 116
                           (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
                      (28 2 (:LINEAR X*Y>1-POSITIVE))
                      (16 3 (:REWRITE DEFAULT-*-2))
                      (9 5 (:REWRITE DEFAULT-<-2))
                      ...
                      (1 1
                         (:REWRITE EXPONENTS-ADD-FOR-NONNEG-EXPONENTS))
                      (1 1 (:REWRITE EXPONENTS-ADD)))
(BITOPS::SU-NEG-CRUX (207 39 (:REWRITE DEFAULT-*-2))
                     (104 13 (:REWRITE ZIP-OPEN))
                     (84 67 (:REWRITE DEFAULT-+-1))
                     (72 18 (:REWRITE <-0-+-NEGATIVE-1))
                     (67 67 (:REWRITE DEFAULT-+-2))
...
(BITOPS::SU-NEG-CASE (130 25 (:REWRITE DEFAULT-*-2))
                     (129 1
                          (:REWRITE BITOPS::LOUSY-SIGNED-BYTE-P-OF-*))
...
(BITOPS::BASIC-SIGNED-BYTE-P-OF-LOGNOT
 ...
 (12 12 (:META CANCEL_PLUS-LESSP-CORRECT))
 (12 2
     (:REWRITE BITOPS::SIGNED-BYTE-P-N-MINUS1))
 (9 1
...
(BITOPS::SIGNED-BYTE-P-WHEN-SIGNED-BYTE-P-SMALLER
     ...
     (2 2 (:REWRITE ZP-OPEN))
     (2 2
        (:REWRITE BITOPS::LOGCDR-WHEN-NON-INTEGER)))
(BITOPS::MY-INDUCT (11 11
                       (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(BITOPS::SIGNED-BYTE-P-WHEN-UNSIGNED-BYTE-P-SMALLER
     ...
     (3 3
        (:REWRITE EXPONENTS-ADD-FOR-NONNEG-EXPONENTS))
     (3 3 (:REWRITE EXPONENTS-ADD)))
(BITOPS::L0 (107 3 (:REWRITE LOGHEAD-IDENTITY))
            (44 8
                (:LINEAR EXPT-IS-INCREASING-FOR-BASE>1))
...
(BITOPS::TRUNCATE-OF-ZERO (3 3
                          ...
                          (3 3
                             (:TYPE-PRESCRIPTION TRUNCATE-TYPE . 1)))
(BITOPS::MOD-OF-ZERO (15 15 (:TYPE-PRESCRIPTION RATIONALP-MOD))
                     ...
                     (1 1 (:REWRITE MOD-=-0 . 2)))
(BITOPS::REM-OF-ZERO (22 14 (:REWRITE DEFAULT-<-1))
                     ...
                     (1 1 (:REWRITE REM-=-0 . 2))
                     (1 1 (:REWRITE DEFAULT-UNARY-MINUS)))
(BITOPS::INTEGERP-OF-REM (20 20 (:TYPE-PRESCRIPTION REM-TYPE . 4))
...
(BITOPS::FLOOR-OF-1-WHEN-INTEGERP
     (6 3
        (:TYPE-PRESCRIPTION BITOPS::FLOOR-LOWER-BOUND-WHEN-NATURALS))
     (3 3 (:TYPE-PRESCRIPTION NATP))
...
(BITOPS::TRUNCATE-OF-NEGATIVE-1
     (6 3
        (:TYPE-PRESCRIPTION BITOPS::TRUNCATE-LOWER-BOUND-WHEN-NATURALS))
     (3 3
        (:TYPE-PRESCRIPTION TRUNCATE-TYPE . 4))
     (3 3
        (:TYPE-PRESCRIPTION TRUNCATE-TYPE . 3))
...
(BITOPS::MOD-WEAK-GLOBAL-UPPER-BOUND-WHEN-NATURALS
     ...
     (16 4
         (:REWRITE MOD-X-Y-=-X+Y-FOR-RATIONALS . 2))
     (16 1
         (:LINEAR BITOPS::MOD-WEAK-LEFT-UPPER-BOUND-WHEN-NATURALS))
     (16 1
         (:LINEAR BITOPS::MOD-STRONG-RIGHT-UPPER-BOUND-WHEN-NATURALS))
     (12 4 (:REWRITE DEFAULT-UNARY-/))
     (9 9 (:META CANCEL_TIMES-EQUAL-CORRECT))
     (9 9 (:META CANCEL_PLUS-EQUAL-CORRECT))
...
(BITOPS::REM-WEAK-GLOBAL-UPPER-BOUND-WHEN-NATURALS
     ...
     (16 1
         (:LINEAR BITOPS::REM-WEAK-LEFT-UPPER-BOUND-WHEN-NATURALS))
     (16 1
         (:LINEAR BITOPS::REM-STRONG-RIGHT-UPPER-BOUND-WHEN-NATURALS))
     (16 1
         (:LINEAR BITOPS::MOD-WEAK-LEFT-UPPER-BOUND-WHEN-NATURALS))
     (16 1
         (:LINEAR BITOPS::MOD-STRONG-RIGHT-UPPER-BOUND-WHEN-NATURALS))
...
(BITOPS::BASIC-UNSIGNED-BYTE-P-OF-REM
     ...
     (1 1 (:REWRITE DEFAULT-<-1))
     (1 1 (:META CANCEL_PLUS-LESSP-CORRECT)))
(BITOPS::|(< (- a) (- b))| (4 4 (:REWRITE DEFAULT-*-2))
                           (4 4 (:REWRITE DEFAULT-*-1))
                           (2 2 (:REWRITE DEFAULT-UNARY-MINUS))
                           (2 2 (:REWRITE DEFAULT-<-2))
                           (2 2 (:REWRITE DEFAULT-<-1))
...
(BITOPS::BASIC-SIGNED-BYTE-P-OF-FLOOR-WHEN-NATURALS
     ...
     (2 2
        (:LINEAR EXPT-IS-INCREASING-FOR-BASE>1))
     (2 1
        (:LINEAR BITOPS::FLOOR-LOWER-BOUND-WHEN-NATURALS)))
...
(BITOPS::BASIC-SIGNED-BYTE-P-OF-TRUNCATE-WHEN-NEGATIVES-EXCEPT-FOR-INT-MIN
 ...
 (54
   ...
   (:REWRITE
        BITOPS::BASIC-SIGNED-BYTE-P-OF-TRUNCATE-WHEN-NEGATIVE-OVER-POSITIVE))
 (54 1
     (:REWRITE BITOPS::BASIC-SIGNED-BYTE-P-OF-TRUNCATE-WHEN-NATURALS))
 (48 6 (:LINEAR EXPT->-1))
...
(BITOPS::BASIC-SIGNED-BYTE-P-OF-FLOOR-WHEN-NEGATIVES-EXCEPT-FOR-INT-MIN
 ...
 (162 3
      (:REWRITE
           BITOPS::BASIC-SIGNED-BYTE-P-OF-FLOOR-WHEN-NEGATIVE-OVER-POSITIVE))
 (162 3
      (:REWRITE BITOPS::BASIC-SIGNED-BYTE-P-OF-FLOOR-WHEN-NATURALS))
...
(BITOPS::BASIC-SIGNED-BYTE-P-OF-MOD-WHEN-NEGP-B
     ...
     (34 17
         (:TYPE-PRESCRIPTION BITOPS::MOD-LOWER-BOUND-WHEN-NATURALS))
...
(BITOPS::BASIC-SIGNED-BYTE-P-OF-MOD-WHEN-POSP-B
     (54 1
         (:REWRITE BITOPS::BASIC-SIGNED-BYTE-P-OF-MOD-WHEN-NEGP-B))
     (51 51
         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(BITOPS::BASIC-SIGNED-BYTE-P-OF-REM-WHEN-NEGP-B
     (1374 1374
           (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
     (608 304
          (:TYPE-PRESCRIPTION BITOPS::REM-LOWER-BOUND-WHEN-NATURALS))
     ...
     (112 8
          (:LINEAR BITOPS::REM-WEAK-LEFT-UPPER-BOUND-WHEN-NATURALS))
     (112 8
          (:LINEAR BITOPS::REM-WEAK-GLOBAL-UPPER-BOUND-WHEN-NATURALS))
     (112 8
          (:LINEAR BITOPS::REM-STRONG-RIGHT-UPPER-BOUND-WHEN-NATURALS))
     (112 8
          (:LINEAR BITOPS::REM-LOWER-BOUND-WHEN-NATURALS))
...
(BITOPS::BASIC-SIGNED-BYTE-P-OF-REM-WHEN-POSP-B
     ...
     (60 24 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
     (54 1
         (:REWRITE BITOPS::BASIC-SIGNED-BYTE-P-OF-REM-WHEN-NEGP-B))
