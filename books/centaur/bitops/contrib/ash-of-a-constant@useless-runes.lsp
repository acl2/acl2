...
(EXPT-COMPUTE-LEMMA
     ...
     (3 3
        (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-NON-ZERO-BASE)))
(TEST-2-75 (3 3 (:REWRITE DEFAULT-<-2))
           (3 3 (:REWRITE DEFAULT-<-1)))
(TEST-4-75 (3 3 (:REWRITE DEFAULT-<-2))
           (3 3 (:REWRITE DEFAULT-<-1)))
(TEST-6-75 (3 3 (:REWRITE DEFAULT-<-2))
           (3 3 (:REWRITE DEFAULT-<-1)))
(TEST-8-82 (3 3 (:REWRITE DEFAULT-<-2))
           (3 3 (:REWRITE DEFAULT-<-1)))
(TEST-1-82 (3 3 (:REWRITE DEFAULT-<-2))
           (3 3 (:REWRITE DEFAULT-<-1)))
