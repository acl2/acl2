...
(AIGNET::CAR-OF-BIT-LIST-FIX-X-NORMALIZE-CONST-UNDER-BIT-EQUIV)
...
(AIGNET::CONS-OF-BFIX-X-UNDER-BIT-LIST-EQUIV
 ...
 (2
   ...
   (:REWRITE
        AIGNET::CDR-OF-BIT-LIST-FIX-X-NORMALIZE-CONST-UNDER-BIT-LIST-EQUIV)))
(AIGNET::CONS-OF-BFIX-X-NORMALIZE-CONST-UNDER-BIT-LIST-EQUIV)
...
(AIGNET::LEN-OF-UPDATE-NTH-LIT (18 2 (:REWRITE NFIX-WHEN-NATP))
                               (15 3 (:DEFINITION LEN))
                               ...
                               (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT))
                               (1 1 (:LINEAR LEQ-POSITION-EQUAL-LEN)))
(AIGNET::UPDATE-NTH-LIT-SAME (36 3 (:DEFINITION UPDATE-NTH))
                             ...
                             (3 3 (:REWRITE DEFAULT-+-1))
                             (3 3 (:META CANCEL_PLUS-LESSP-CORRECT)))
(AIGNET::UPDATE-NTH-LIT-SWITCH (84 5 (:DEFINITION UPDATE-NTH))
...
(AIGNET::SET-LIT$INLINE (7 1 (:DEFINITION AIGNET::LITARR$AP))
