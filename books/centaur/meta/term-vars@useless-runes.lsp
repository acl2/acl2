(CMR::MEMBER-OF-UNION (58 4 (:DEFINITION MEMBER-EQUAL))
                      (14 2
...
(CMR::FLAG-LEMMA-FOR-TERM-VARS-ACC-IS-TERM-VARS-LEMMA
 (435 17 (:DEFINITION MEMBER-EQUAL))
 (256 28 (:REWRITE SUBSETP-CAR-MEMBER))
 (240 2 (:REWRITE CMR::MEMBER-OF-UNION))
 ...
 (20 20
     (:TYPE-PRESCRIPTION CMR::TERMLIST-VARS))
 (16 1 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
...
(CMR::TERM-VARS-ACC-IS-TERM-VARS
  (114 2 (:DEFINITION UNION-EQUAL))
  (70 2 (:DEFINITION CMR::TERM-VARS))
...
(CMR::TERMLIST-VARS-ACC-IS-TERMLIST-VARS
     (200 4 (:DEFINITION UNION-EQUAL))
     (96 4 (:DEFINITION MEMBER-EQUAL))
     (92 2 (:DEFINITION CMR::TERMLIST-VARS))
...
(CMR::UNION-EQ-NIL (25 5 (:REWRITE SUBSETP-CAR-MEMBER))
...
(CMR::FLAG-LEMMA-FOR-TERM-VARS-OF-PSEUDO-TERM-FIX-X
 (5879 35 (:DEFINITION PSEUDO-TERMP))
 (5203 21
       (:REWRITE PSEUDO-TERM-FIX-WHEN-PSEUDO-TERMP))
 (3226 37 (:DEFINITION PSEUDO-TERM-LISTP))
 (2251 87
...
(CMR::SUBSETP-OF-UNION-1 (3 3 (:TYPE-PRESCRIPTION UNION-EQUAL)))
(CMR::SUBSETP-OF-UNION-2 (3 3 (:TYPE-PRESCRIPTION UNION-EQUAL)))
(CMR::FLAG-LEMMA-FOR-BASE-EV-WHEN-AGREE-ON-TERM-VARS
 (817 19 (:DEFINITION UNION-EQUAL))
...
(CMR::FLAG-LEMMA-FOR-RETURN-TYPE-OF-TERM-FREE-VARS-ACC.VARS
 (181 11 (:DEFINITION MEMBER-EQUAL))
 (156 47
      (:REWRITE CMR::PSEUDO-VAR-LIST-P-WHEN-NOT-CONSP))
...
(CMR::FLAG-LEMMA-FOR-TERM-FREE-VARS-ACC-IS-TERM-FREE-VARS-LEMMA
 (592 27 (:DEFINITION MEMBER-EQUAL))
 (256 28 (:REWRITE SUBSETP-CAR-MEMBER))
 (240 2 (:REWRITE CMR::MEMBER-OF-UNION))
 ...
 (24 24
     (:REWRITE CMR::PSEUDO-VAR-LIST-P-WHEN-SUBSETP-EQUAL))
 (20 20
     (:TYPE-PRESCRIPTION CMR::TERMLIST-FREE-VARS))
 (16 16
     (:REWRITE PSEUDO-TERM-VAR->NAME-OF-PSEUDO-TERM-FIX-X-NORMALIZE-CONST))
 (16 1 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
 (14 1 (:REWRITE LIST-FIX-WHEN-LEN-ZERO))
...
(CMR::TERM-FREE-VARS-ACC-IS-TERM-FREE-VARS
  (114 2 (:DEFINITION UNION-EQUAL))
  (102 2 (:DEFINITION CMR::TERM-FREE-VARS))
...
(CMR::TERMLIST-FREE-VARS-ACC-IS-TERMLIST-FREE-VARS
     (200 4 (:DEFINITION UNION-EQUAL))
     (96 4 (:DEFINITION MEMBER-EQUAL))
     (92 2 (:DEFINITION CMR::TERMLIST-FREE-VARS))
     (74 8 (:REWRITE SUBSETP-CAR-MEMBER))
     (26 8 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
     (26 8 (:REWRITE MEMBER-WHEN-ATOM))
     (20 14 (:REWRITE DEFAULT-CDR))
     (20 14 (:REWRITE DEFAULT-CAR))
     (16 16
         (:TYPE-PRESCRIPTION CMR::TERM-FREE-VARS))
     (16 16 (:TYPE-PRESCRIPTION SUBSETP-EQUAL))
     (10 10
         (:REWRITE CMR::CONSP-OF-PSEUDO-VAR-LIST-FIX))
     (8 8 (:REWRITE SUBSETP-WHEN-ATOM-LEFT))
...
(CMR::UNION-EQUAL-NIL (25 5 (:REWRITE SUBSETP-CAR-MEMBER))
                      (8 8 (:REWRITE DEFAULT-CAR))
                      (5 5 (:TYPE-PRESCRIPTION SUBSETP-EQUAL))
                      (5 5 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
                      (5 5 (:REWRITE SUBSETP-TRANS2))
...
(CMR::TERM-FREE-VARS
 ...
 (289 289
      (:TYPE-PRESCRIPTION CMR::PSEUDO-VAR-LIST-P))
 (257 18 (:DEFINITION MEMBER-EQUAL))
...
(CMR::FLAG-LEMMA-FOR-TERM-FREE-VARS-IN-TERMS-OF-TERM-VARS
 (2151 130 (:DEFINITION MEMBER-EQUAL))
...
(CMR::TERM-FREE-VARS-OF-PSEUDO-TERM-FIX-X-NORMALIZE-CONST)
(CMR::TERM-FREE-VARS-PSEUDO-TERM-EQUIV-CONGRUENCE-ON-X)
(CMR::TERMLIST-FREE-VARS-OF-PSEUDO-TERM-LIST-FIX-X-NORMALIZE-CONST)
(CMR::TERMLIST-FREE-VARS-PSEUDO-TERM-LIST-EQUIV-CONGRUENCE-ON-X)
(CMR::CONSP-OF-MEMBER-IS-MEMBER (14 2 (:DEFINITION MEMBER-EQUAL))
...
(CMR::MEMBER-TERM-VARS
  ...
  (354 354
       (:REWRITE CMR::PSEUDO-VAR-LIST-P-WHEN-SUBSETP-EQUAL))
  (283 24 (:DEFINITION MEMBER-EQUAL))
