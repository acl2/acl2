(CMR::MEMBER-OF-UNION (66 4 (:DEFINITION MEMBER-EQUAL))
                      (14 2
...
(CMR::TERM-FREE-VARS-ACC-IS-TERM-FREE-VARS
  (122 2 (:DEFINITION UNION-EQUAL))
  (122 2 (:DEFINITION CMR::TERM-FREE-VARS))
...
(CMR::CONSP-OF-MEMBER-IS-MEMBER (18 2 (:DEFINITION MEMBER-EQUAL))
