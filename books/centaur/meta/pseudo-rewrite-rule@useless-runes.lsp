(CMR::PSEUDO-REWRITE-RULE-P (95 95 (:REWRITE DEFAULT-CDR))
...
(CMR::MEXTRACT-GOOD-REWRITE-RULESP-BY-BADGUY
     ...
     (2008 67
           (:REWRITE CMR::MEXTRACT-GOOD-REWRITE-RULESP-OF-CDR))
     (630 336
          (:REWRITE MEXTRACT-EV-OF-TYPESPEC-CHECK-CALL))
...
(CMR::PSEUDO-REWRITE-RULE-LISTP-OF-CONS (3 3 (:REWRITE DEFAULT-CDR))
                                        (3 3 (:REWRITE DEFAULT-CAR)))
(CMR::PSEUDO-REWRITE-RULE-LISTP-OF-CDR (1 1 (:REWRITE DEFAULT-CDR))
                                       (1 1 (:REWRITE DEFAULT-CAR)))
(CMR::PSEUDO-REWRITE-RULE-P-OF-CAR (1 1 (:REWRITE DEFAULT-CAR)))
(CMR::REWRITE-RULE-TERM-ALT-DEF (50 50 (:REWRITE DEFAULT-CDR))
