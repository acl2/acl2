...
(CMR::TERM-UNIFY-STRICT
 (119 1 (:DEFINITION CMR::TERM-UNIFY-STRICT))
 (76 12
     (:REWRITE CMR::PSEUDO-TERM-LIST-P-WHEN-PSEUDO-VAR-LIST-P))
...
(CMR::FLAG-LEMMA-FOR-<FN>-PRESERVES-PAIRS
 ...
 (368 24 (:DEFINITION MEMBER-EQUAL))
 (366 46
      (:REWRITE CMR::PSEUDO-TERM-LIST-P-WHEN-PSEUDO-VAR-LIST-P))
...
(CMR::ALIST-KEYS-SUBSETP-OF-TERM-UNIFY-STRICT
 (1539 10 (:DEFINITION CMR::TERM-UNIFY-STRICT))
 (310 310
...
(CMR::TERM-VARS-SUBSETP-OF-TERM-UNIFY-STRICT
 (1092 7 (:DEFINITION CMR::TERM-UNIFY-STRICT))
 (217 217
      (:TYPE-PRESCRIPTION SYMBOLP-OF-PSEUDO-TERM-KIND))
 (217 217
      (:TYPE-PRESCRIPTION PSEUDO-TERM-KIND$INLINE))
