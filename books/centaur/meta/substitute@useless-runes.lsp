(CMR::TERM-SUBST (6 3 (:REWRITE DEFAULT-<-2))
...
(CMR::TERM-SUBST-FLAG (36 2 (:TYPE-PRESCRIPTION RETURN-LAST))
...
(CMR::TERM-SUBST-STRICT (6 3 (:REWRITE DEFAULT-<-2))
                        (6 3 (:REWRITE DEFAULT-<-1))
                        (3 3 (:REWRITE SUBSETP-MEMBER . 4))
                        (3 3 (:REWRITE SUBSETP-MEMBER . 3))
                        (3 3 (:REWRITE SUBSETP-MEMBER . 2))
                        ...
                        (2 2 (:REWRITE DEFAULT-CDR))
                        (2 2 (:REWRITE DEFAULT-CAR)))
(CMR::TERM-SUBST-STRICT-FLAG (32 2 (:TYPE-PRESCRIPTION RETURN-LAST))
                             (6 3 (:REWRITE DEFAULT-<-2))
                             (6 3 (:REWRITE DEFAULT-<-1))
                             (3 3 (:REWRITE SUBSETP-MEMBER . 4))
                             (3 3 (:REWRITE SUBSETP-MEMBER . 3))
