...
(CMR::FLAG-LEMMA-FOR-RETURN-TYPE-OF-TERM-SUBST.NEW-X
 (4302 28 (:DEFINITION PSEUDO-TERMP))
 (2356 204 (:REWRITE CMR::PSEUDO-TERM-LIST-P-WHEN-PSEUDO-VAR-LIST-P))
 (1785 9 (:REWRITE PSEUDO-TERM-FIX-WHEN-PSEUDO-TERMP))
 (1654 42 (:REWRITE PSEUDO-TERMP-CAR-WHEN-PSEUDO-TERM-LISTP))
 (1202 104 (:REWRITE PSEUDO-TERM-LISTP-CDR-WHEN-PSEUDO-TERM-LISTP))
 (958 138 (:REWRITE PSEUDO-VAR-LIST-P-OF-CDR-WHEN-PSEUDO-VAR-LIST-P))
 (618 618 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-SUBSETP-EQUAL))
 (567 566 (:REWRITE DEFAULT-CAR))
 (509 507 (:REWRITE DEFAULT-CDR))
 (420 84 (:DEFINITION LEN))
 (355 309 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-NOT-CONSP))
...
(CMR::LEN-OF-TERMLIST-SUBST
 (619 1 (:DEFINITION CMR::TERM-SUBST))
 (542 3 (:REWRITE PSEUDO-TERM-FIX-WHEN-PSEUDO-TERMP))
 (526 3 (:DEFINITION PSEUDO-TERMP))
 (226 1 (:REWRITE CMR::ASSOC-OF-PSEUDO-TERM-SUBST-FIX))
...
(CMR::TERM-SUBST
 (847 83 (:REWRITE CMR::PSEUDO-TERM-LIST-P-WHEN-PSEUDO-VAR-LIST-P))
 (738 17 (:REWRITE PSEUDO-TERMP-CAR-WHEN-PSEUDO-TERM-LISTP))
 (532 47 (:REWRITE PSEUDO-TERM-LISTP-CDR-WHEN-PSEUDO-TERM-LISTP))
 (343 62 (:REWRITE PSEUDO-VAR-LIST-P-OF-CDR-WHEN-PSEUDO-VAR-LIST-P))
 (260 260 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-SUBSETP-EQUAL))
 (254 254 (:REWRITE DEFAULT-CAR))
 (225 225 (:REWRITE DEFAULT-CDR))
 (224 44 (:DEFINITION LEN))
 (168 28 (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
 (133 130 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-NOT-CONSP))
...
(CMR::FLAG-LEMMA-FOR-BASE-EV-OF-TERM-SUBST
 (3025 12 (:REWRITE PSEUDO-TERM-FIX-WHEN-PSEUDO-TERMP))
 (2589 16 (:DEFINITION PSEUDO-TERMP))
 (1464 32 (:REWRITE PSEUDO-TERMP-CAR-WHEN-PSEUDO-TERM-LISTP))
 (1112 85 (:REWRITE CMR::PSEUDO-TERM-LIST-P-WHEN-PSEUDO-VAR-LIST-P))
 (748 8 (:DEFINITION PSEUDO-TERM-LISTP))
 (602 78 (:REWRITE PSEUDO-VAR-LIST-P-OF-CDR-WHEN-PSEUDO-VAR-LIST-P))
 (500 57 (:REWRITE PSEUDO-TERM-LISTP-CDR-WHEN-PSEUDO-TERM-LISTP))
 (391 388 (:REWRITE DEFAULT-CAR))
 (338 334 (:REWRITE DEFAULT-CDR))
 (292 292 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-SUBSETP-EQUAL))
 ...
 (146 146 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-NOT-CONSP))
...
(CMR::FLAG-LEMMA-FOR-ACONS-NON-VAR-PRESERVES-<FN>
 (11479 48 (:REWRITE PSEUDO-TERM-FIX-WHEN-PSEUDO-TERMP))
 (9926 61 (:DEFINITION PSEUDO-TERMP))
 (5391 117 (:REWRITE PSEUDO-TERMP-CAR-WHEN-PSEUDO-TERM-LISTP))
 (4214 324 (:REWRITE CMR::PSEUDO-TERM-LIST-P-WHEN-PSEUDO-VAR-LIST-P))
 (2618 28 (:DEFINITION PSEUDO-TERM-LISTP))
 (2270 296 (:REWRITE PSEUDO-VAR-LIST-P-OF-CDR-WHEN-PSEUDO-VAR-LIST-P))
 (1938 216 (:REWRITE PSEUDO-TERM-LISTP-CDR-WHEN-PSEUDO-TERM-LISTP))
 (1387 1379 (:REWRITE DEFAULT-CAR))
 (1213 1200 (:REWRITE DEFAULT-CDR))
 (1108 1108 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-SUBSETP-EQUAL))
 ...
 (554 554 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-NOT-CONSP))
...
(CMR::FLAG-LEMMA-FOR-TERM-SUBST-OF-PSEUDO-TERM-FIX-X
 (9113 61 (:DEFINITION PSEUDO-TERMP))
 (4110 336 (:REWRITE CMR::PSEUDO-TERM-LIST-P-WHEN-PSEUDO-VAR-LIST-P))
 (4014 52 (:DEFINITION PSEUDO-TERM-LISTP))
 (3858 137 (:REWRITE PSEUDO-TERMP-CAR-WHEN-PSEUDO-TERM-LISTP))
 (3187 229 (:REWRITE PSEUDO-TERM-LISTP-CDR-WHEN-PSEUDO-TERM-LISTP))
 (2098 308 (:REWRITE PSEUDO-VAR-LIST-P-OF-CDR-WHEN-PSEUDO-VAR-LIST-P))
 (1226 1226 (:REWRITE DEFAULT-CAR))
 (1182 1182 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-SUBSETP-EQUAL))
 (1142 1138 (:REWRITE DEFAULT-CDR))
 (1098 1098 (:TYPE-PRESCRIPTION LEN))
 (915 183 (:DEFINITION LEN))
 (732 122 (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
 (671 61 (:DEFINITION TRUE-LISTP))
 (598 591 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-NOT-CONSP))
 (366 183 (:REWRITE DEFAULT-+-2))
 (366 61 (:DEFINITION SYMBOL-LISTP))
...
(CMR::FLAG-LEMMA-FOR-RETURN-TYPE-OF-TERM-SUBST-STRICT.NEW-X
 (2984 20 (:DEFINITION PSEUDO-TERMP))
 (1860 160 (:REWRITE CMR::PSEUDO-TERM-LIST-P-WHEN-PSEUDO-VAR-LIST-P))
 (1243 34 (:REWRITE PSEUDO-TERMP-CAR-WHEN-PSEUDO-TERM-LISTP))
 (891 76 (:REWRITE PSEUDO-TERM-LISTP-CDR-WHEN-PSEUDO-TERM-LISTP))
 (713 98 (:REWRITE PSEUDO-VAR-LIST-P-OF-CDR-WHEN-PSEUDO-VAR-LIST-P))
 (578 7 (:REWRITE PSEUDO-TERM-FIX-WHEN-PSEUDO-TERMP))
 ...
 (286 237 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-NOT-CONSP))
...
(CMR::LEN-OF-TERMLIST-SUBST-STRICT
 (457 1 (:DEFINITION CMR::TERM-SUBST-STRICT))
 (379 2 (:REWRITE PSEUDO-TERM-FIX-WHEN-PSEUDO-TERMP))
 (367 2 (:DEFINITION PSEUDO-TERMP))
 (226 1 (:REWRITE CMR::ASSOC-OF-PSEUDO-TERM-SUBST-FIX))
 (148 11 (:REWRITE CMR::PSEUDO-TERM-LIST-P-WHEN-PSEUDO-VAR-LIST-P))
 (114 2 (:REWRITE PSEUDO-TERMP-CAR-WHEN-PSEUDO-TERM-LISTP))
 (82 10 (:REWRITE PSEUDO-VAR-LIST-P-OF-CDR-WHEN-PSEUDO-VAR-LIST-P))
 (81 77 (:REWRITE DEFAULT-CDR))
 (80 7 (:REWRITE PSEUDO-TERM-LISTP-CDR-WHEN-PSEUDO-TERM-LISTP))
...
(CMR::TERM-SUBST-STRICT
 (795 78 (:REWRITE CMR::PSEUDO-TERM-LIST-P-WHEN-PSEUDO-VAR-LIST-P))
 (689 16 (:REWRITE PSEUDO-TERMP-CAR-WHEN-PSEUDO-TERM-LISTP))
 (498 44 (:REWRITE PSEUDO-TERM-LISTP-CDR-WHEN-PSEUDO-TERM-LISTP))
 (321 58 (:REWRITE PSEUDO-VAR-LIST-P-OF-CDR-WHEN-PSEUDO-VAR-LIST-P))
 (244 244 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-SUBSETP-EQUAL))
 (239 239 (:REWRITE DEFAULT-CAR))
 (211 211 (:REWRITE DEFAULT-CDR))
 (209 41 (:DEFINITION LEN))
 (156 26 (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
 (125 122 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-NOT-CONSP))
...
(CMR::FLAG-LEMMA-FOR-BASE-EV-OF-TERM-SUBST-STRICT
 (1706 7 (:REWRITE PSEUDO-TERM-FIX-WHEN-PSEUDO-TERMP))
 (1482 9 (:DEFINITION PSEUDO-TERMP))
 (791 17 (:REWRITE PSEUDO-TERMP-CAR-WHEN-PSEUDO-TERM-LISTP))
 (634 48 (:REWRITE CMR::PSEUDO-TERM-LIST-P-WHEN-PSEUDO-VAR-LIST-P))
 (374 4 (:DEFINITION PSEUDO-TERM-LISTP))
 (346 44 (:REWRITE PSEUDO-VAR-LIST-P-OF-CDR-WHEN-PSEUDO-VAR-LIST-P))
 (290 32 (:REWRITE PSEUDO-TERM-LISTP-CDR-WHEN-PSEUDO-TERM-LISTP))
 (221 218 (:REWRITE DEFAULT-CAR))
 (197 187 (:REWRITE DEFAULT-CDR))
 (164 164 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-SUBSETP-EQUAL))
 ...
 (82 82 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-NOT-CONSP))
...
(CMR::FLAG-LEMMA-FOR-ACONS-NON-VAR-PRESERVES-<FN>
 (6023 26 (:REWRITE PSEUDO-TERM-FIX-WHEN-PSEUDO-TERMP))
 (5238 32 (:DEFINITION PSEUDO-TERMP))
 (2783 60 (:REWRITE PSEUDO-TERMP-CAR-WHEN-PSEUDO-TERM-LISTP))
 (2219 170 (:REWRITE CMR::PSEUDO-TERM-LIST-P-WHEN-PSEUDO-VAR-LIST-P))
 (1309 14 (:DEFINITION PSEUDO-TERM-LISTP))
 (1199 155 (:REWRITE PSEUDO-VAR-LIST-P-OF-CDR-WHEN-PSEUDO-VAR-LIST-P))
 (1026 113 (:REWRITE PSEUDO-TERM-LISTP-CDR-WHEN-PSEUDO-TERM-LISTP))
 (765 761 (:REWRITE DEFAULT-CAR))
 (682 657 (:REWRITE DEFAULT-CDR))
 (580 580 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-SUBSETP-EQUAL))
 ...
 (290 290 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-NOT-CONSP))
 ...
 (13 13 (:REWRITE PSEUDO-TERM-CALL-WHEN-LAMBDA))
 (13 13 (:REWRITE PSEUDO-TERM-CALL-WHEN-FUNCTION))
 (12 12 (:REWRITE PSEUDO-VAR-P-WHEN-MEMBER-EQUAL-OF-PSEUDO-VAR-LIST-P))
 (11 11 (:REWRITE SUBSETP-TRANS2))
 (11 11 (:REWRITE SUBSETP-TRANS))
 (10 1 (:REWRITE SUBSETP-IMPLIES-SUBSETP-CDR))
 (3 3 (:REWRITE-QUOTED-CONSTANT PSEUDO-TERM-LIST-FIX-UNDER-PSEUDO-TERM-LIST-EQUIV))
...
(CMR::FLAG-LEMMA-FOR-TERM-SUBST-STRICT-OF-PSEUDO-TERM-FIX-X
 (7070 50 (:DEFINITION PSEUDO-TERMP))
 (4014 52 (:DEFINITION PSEUDO-TERM-LISTP))
 (3274 275 (:REWRITE CMR::PSEUDO-TERM-LIST-P-WHEN-PSEUDO-VAR-LIST-P))
 (3223 126 (:REWRITE PSEUDO-TERMP-CAR-WHEN-PSEUDO-TERM-LISTP))
 (2741 190 (:REWRITE PSEUDO-TERM-LISTP-CDR-WHEN-PSEUDO-TERM-LISTP))
 (1628 252 (:REWRITE PSEUDO-VAR-LIST-P-OF-CDR-WHEN-PSEUDO-VAR-LIST-P))
 (982 982 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-SUBSETP-EQUAL))
 ...
 (498 491 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-NOT-CONSP))
