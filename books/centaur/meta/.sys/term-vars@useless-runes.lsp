...
(CMR::FLAG-LEMMA-FOR-TERM-VARS-OF-PSEUDO-TERM-FIX-X
 (5704 35 (:DEFINITION PSEUDO-TERMP))
 (5073 21 (:REWRITE PSEUDO-TERM-FIX-WHEN-PSEUDO-TERMP))
 (3156 37 (:DEFINITION PSEUDO-TERM-LISTP))
 (2226 87 (:REWRITE PSEUDO-TERMP-CAR-WHEN-PSEUDO-TERM-LISTP))
 (2156 190 (:REWRITE CMR::PSEUDO-TERM-LIST-P-WHEN-PSEUDO-VAR-LIST-P))
 (1901 129 (:REWRITE PSEUDO-TERM-LISTP-CDR-WHEN-PSEUDO-TERM-LISTP))
...
(CMR::TERM-FREE-VARS
 ...
 (153 18 (:REWRITE SUBSETP-CAR-MEMBER))
 (152 18 (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
