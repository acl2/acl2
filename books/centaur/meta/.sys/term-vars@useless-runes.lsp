...
(CMR::FLAG-LEMMA-FOR-TERM-VARS-OF-PSEUDO-TERM-FIX-X
 (6614 35 (:DEFINITION PSEUDO-TERMP))
 (5749 21 (:REWRITE PSEUDO-TERM-FIX-WHEN-PSEUDO-TERMP))
 (3520 37 (:DEFINITION PSEUDO-TERM-LISTP))
 (2356 87 (:REWRITE PSEUDO-TERMP-CAR-WHEN-PSEUDO-TERM-LISTP))
 (2156 190 (:REWRITE CMR::PSEUDO-TERM-LIST-P-WHEN-PSEUDO-VAR-LIST-P))
 (2031 129 (:REWRITE PSEUDO-TERM-LISTP-CDR-WHEN-PSEUDO-TERM-LISTP))
