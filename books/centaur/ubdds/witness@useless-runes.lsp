(IS-PREFIX)
(SUBGOAL-OF)
(BDD-DIFF-WITNESS (2070 986 (:REWRITE DEFAULT-+-2))
...
(EVAL-BDD-DIFF-WITNESS (545 545 (:REWRITE DEFAULT-CDR))
                       (470 470 (:REWRITE DEFAULT-CAR))
                       (194 194 (:REWRITE EVAL-BDD-WHEN-NOT-CONSP))
                       (78 78
                           (:REWRITE EVAL-BDD-WHEN-NON-CONSP-VALUES)))
(EVAL-BDD-DIFF-WITNESS-CORR (60 2 (:DEFINITION BDD-DIFF-WITNESS))
...
(BDD-CP-EV-DISJOIN-ATOM (1 1 (:REWRITE BDD-CP-EV-CONSTRAINT-16)))
(BDD-CP-EV-DISJOIN-APPEND (23 23 (:REWRITE BDD-CP-EV-CONSTRAINT-2))
                          (23 23 (:REWRITE BDD-CP-EV-CONSTRAINT-16)))
(BDD-CP-EV-CONJOIN-CONS)
(BDD-CP-EV-CONJOIN-WHEN-CONSP)
(BDD-CP-EV-CONJOIN-ATOM (1 1 (:REWRITE BDD-CP-EV-CONSTRAINT-16)))
(BDD-CP-EV-CONJOIN-APPEND (23 23 (:REWRITE BDD-CP-EV-CONSTRAINT-2))
                          (23 23 (:REWRITE BDD-CP-EV-CONSTRAINT-16)))
(BDD-CP-EV-CONJOIN-CLAUSES-CONS (100 50 (:DEFINITION DISJOIN))
...
(BDD-CP-EV-CONJOIN-CLAUSES-ATOM (1 1 (:REWRITE BDD-CP-EV-CONSTRAINT-16)))
(BDD-CP-EV-CONJOIN-CLAUSES-APPEND (65 65 (:REWRITE BDD-CP-EV-CONSTRAINT-2))
...
(COLLECT-EVAL-BDD-VALS-FLAG (332 160 (:REWRITE DEFAULT-+-2))
...
(FLAG-LEMMA-FOR-PSEUDO-TERM-LISTP-COLLECT-EVAL-BDD-VALS
     ...
     (15 15
         (:TYPE-PRESCRIPTION COLLECT-EVAL-BDD-VALS)))
...
(INSTANTIATE-EVAL-BDDS-CORRECT
     ...
     (3 3
        (:REWRITE NOT-EQUAL-HYPS-TO-EVAL-BDDS-CORRECT))
...
(INSTANTIATE-EQUALS-WITH-EVAL-BDDS-CORRECT
     ...
     (1446 1446
           (:REWRITE NOT-EQUAL-HYPS-TO-EVAL-BDDS-CORRECT))
     (108 108
          (:TYPE-PRESCRIPTION INSTANTIATE-EVAL-BDDS)))
...
(STRIP-CDRS-PAIRLIS$ (36 12 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
...
(EVAL-BDD-CP-CORRECT
     ...
     (20 1
         (:DEFINITION REPLACE-ALIST-TO-BINDINGS-BDD))
     ...
     (12 12
         (:TYPE-PRESCRIPTION INSTANTIATE-EQUALS-WITH-EVAL-BDDS))
     (12 12
         (:REWRITE TERM-LISTP-IMPLIES-PSEUDO-TERM-LISTP))
     ...
     (6 1
        (:REWRITE BDD-CP-EV-CONJOIN-CLAUSES-ATOM))
     (5 1 (:DEFINITION BINARY-APPEND))
     (4 4 (:REWRITE DEFAULT-<-2))
     (3 3 (:TYPE-PRESCRIPTION PAIRLIS$))
     (2 2
        (:TYPE-PRESCRIPTION REPLACE-ALIST-TO-BINDINGS-BDD))
     (1 1
        (:TYPE-PRESCRIPTION NOT-EQUAL-HYPS-TO-EVAL-BDDS))
     (1 1 (:TYPE-PRESCRIPTION EVAL-BDD-VALS)))
(FIND-UBDDP-TERMS)
(EVAL-BDD-CP-HINT)
(EX1 (333 3 (:DEFINITION Q-ITE-FN))
