(FIND-DIFF (408 204 (:DEFINITION INTEGER-ABS))
...
(FIND-DIFF-OF-LENGTH (11 11
                         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(HEAD-TAIL-BIND-FN)
(Q-ITE-LIST (240 120 (:DEFINITION INTEGER-ABS))
...
(Q-ZIPPER (3 3 (:REWRITE FOLD-CONSTS-IN-+)))
(QV-LIST (7 7
            (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(BFIX-LIST)
(Q-PARAM (4 4
...
(Q-PARAM-INV (8 8
                (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(MAX-MAX-DEPTH)
(EXTEND-LIST (3 3 (:REWRITE FOLD-CONSTS-IN-+)))
(EBMDE-IND)
(EVAL-BDD-MAX-DEPTH-EXTEND (4441 4441 (:REWRITE DEFAULT-CAR))
...
(LEN-EVAL-BDD-LIST (21 3 (:DEFINITION EVAL-BDD))
                   ...
                   (3 3
                      (:REWRITE EVAL-BDD-WHEN-NON-CONSP-VALUES)))
(UBDDP-CONS-FORWARD-CHAIN (12 4 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
                          (8 8 (:TYPE-PRESCRIPTION BOOLEANP)))
(UBDDP-ATOM-FORWARD-CHAIN)
(CAR-NTHCDR (51 7 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
            (44 44
...
(NTH-IMPLIES-CONSP-NTHCDR (27 27
                              (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(EVAL-BDD-DIFF (194 194 (:REWRITE EVAL-BDD-WHEN-NOT-CONSP))
               (194 78
                    (:REWRITE EVAL-BDD-WHEN-NON-CONSP-VALUES)))
(EVAL-BDD-DIFF-OF-LENGTH (1464 1464 (:REWRITE FOLD-CONSTS-IN-+))
                         (1396 1396 (:REWRITE EVAL-BDD-WHEN-NOT-CONSP))
                         (1362 479
                               (:REWRITE EVAL-BDD-WHEN-NON-CONSP-VALUES))
                         (288 288 (:REWRITE <-0-+-NEGATIVE-1)))
(FIND-DIFF-OF-LENGTH-LEN (180 180
                              (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(Q-COMPOSE-TO-EVAL-BDD (1261 13 (:DEFINITION Q-ITE-FN))
...
(Q-ITE-LIST-CORRECT (1973 26 (:DEFINITION Q-ITE-FN))
                    (1340 352
                          (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
...
(EVAL-BDD-Q-COMPOSE-COMMUTES-WITH-Q-ITE
     ...
     (2 2 (:DEFINITION LEN)))
(Q-COMPOSE-COMMUTES-WITH-Q-ITE (5149 60 (:DEFINITION Q-ITE-FN))
...
(Q-COMPOSE-LIST-CORRECT (309 3 (:DEFINITION Q-COMPOSE))
...
(Q-COMPOSE-ASSOCIATIVE (4142 40 (:DEFINITION Q-COMPOSE))
...
(NTH-QV-LIST-IND (6 6
                    (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(NTH-QV-LIST (74 10 (:DEFINITION QV))
...
(EVAL-BDD-EXTEND-LIST (217 31 (:DEFINITION EVAL-BDD))
...
(EVAL-Q-ZIPPER (605 605 (:REWRITE EVAL-BDD-WHEN-NOT-CONSP))
               (605 605
                    (:REWRITE EVAL-BDD-OF-NON-CONSP-CHEAP))
               (338 338 (:TYPE-PRESCRIPTION BOOLEANP))
               (265 265 (:TYPE-PRESCRIPTION Q-ZIPPER)))
(UBDDP-QV-ALL)
(UBDD-LISTP-QV-LIST (20 8 (:REWRITE UBDD-LISTP-WHEN-ATOM))
                    (16 4 (:DEFINITION UBDDP))
...
(MAX-DEPTH-QV (11 7 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
              ...
              (1 1 (:REWRITE NATP-RW)))
(MAX-MAX-DEPTH-QV-LIST (108 108 (:TYPE-PRESCRIPTION MAX-DEPTH))
...
(MAX-MAX-DEPTH-MAKE-LIST-AC (11 11 (:META CANCEL_PLUS-LESSP-CORRECT))
                            (6 3 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
                            (4 4 (:REWRITE ZP-OPEN))
...
(MAX-MAX-DEPTH-Q-PARAM (249 249
                       ...
                       (3 2 (:REWRITE DEFAULT-*-2))
                       (2 2 (:REWRITE DEFAULT-*-1)))
(MAX-MAX-DEPTH-Q-PARAM-INV (251 251
                                (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
                           ...
                           (2 2 (:REWRITE DEFAULT-*-1)))
(NOT-EVAL-BDD-QV-NIL)
(EVAL-BDD-QV1 (4 2 (:DEFINITION NTH))
              (2 2 (:REWRITE ZP-OPEN)))
(TAKE-BFIX-LIST (321 18 (:REWRITE TAKE-OF-LEN-FREE))
                (68 24 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
                (40 40
                    (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
                (10 10 (:TYPE-PRESCRIPTION BOOLEANP))
                (9 9 (:REWRITE EQUAL-CONSTANT-+)))
(BFIX-LIST-BFIX-LIST (36 6 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
                     (12 12 (:TYPE-PRESCRIPTION BOOLEANP)))
(EVAL-QV-LIST (393 21 (:REWRITE TAKE-OF-LEN-FREE))
              ...
              (8 8 (:DEFINITION HONS))
              (6 6 (:REWRITE NATP-RW)))
(UBDD-LISTP-MAKE-LIST-AC (133 40 (:REWRITE UBDD-LISTP-WHEN-ATOM))
                         (104 20 (:DEFINITION UBDDP))
                         (40 40 (:TYPE-PRESCRIPTION BOOLEANP))
                         (27 27
                             (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
                         (7 7 (:REWRITE ZP-OPEN)))
(UBDD-LISTP-Q-PARAM (40 16 (:REWRITE UBDD-LISTP-WHEN-ATOM))
                    (32 8 (:DEFINITION UBDDP))
                    (24 8 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
                    (16 16 (:TYPE-PRESCRIPTION BOOLEANP))
                    (6 3 (:DEFINITION QV-LIST)))
(LEN-OF-MAKE-LIST-AC (10 5 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
                     (5 5 (:REWRITE ZP-OPEN))
                     (5 5 (:REWRITE EQUAL-CONSTANT-+)))
(LEN-Q-PARAM (146 146
                  (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
             ...
             (8 4 (:DEFINITION QV-LIST))
             (4 4 (:REWRITE EQUAL-CONSTANT-+)))
(Q-PARAM-EVAL-BDD-IND (4 4
                         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(EVAL-Q-PARAM (3254 160 (:DEFINITION EVAL-BDD-LIST))
...
(BFIX-LIST-LIST-FIX (90 13 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
...
(EQPIB-IND)
(EXTEND-LIST-LEN (15 7 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
                 (8 8 (:TYPE-PRESCRIPTION BOOLEANP)))
(UBDD-LISTP-Q-PARAM-INV (48 6 (:DEFINITION UBDD-LISTP))
                        ...
                        (12 12 (:TYPE-PRESCRIPTION BOOLEANP))
                        (6 3 (:DEFINITION QV-LIST)))
(EVAL-Q-PARAM-INV (1944 108 (:DEFINITION MAX-MAX-DEPTH))
...
(LEN-Q-PARAM-INV-UPPER-BOUND (234 234
                                  (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
                             ...
                             (9 8 (:REWRITE ZP-OPEN))
                             (8 4 (:DEFINITION QV-LIST)))
(LEN-BFIX-LIST (12 6 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
               (1 1 (:REWRITE EQUAL-CONSTANT-+)))
(COMPOSE-Q-PARAM-INV (109 1 (:DEFINITION Q-COMPOSE-LIST))
                     ...
                     (2 1 (:DEFINITION Q-NOT)))
(BFIX-LIST-BOOLEAN-LIST (126 36 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
...
(EXISTS-Y-SUCH-THAT-X-IS-PARAM-OF-Y
     ...
     (2 2 (:TYPE-PRESCRIPTION BOOLEANP))
     (1 1 (:DEFINITION HONS)))
(X-IS-PARAM-OF-Y-COMPOSE-EVAL (109 1 (:DEFINITION Q-COMPOSE-LIST))
                              (105 1 (:DEFINITION Q-COMPOSE))
                              (97 1 (:DEFINITION Q-ITE-FN))
                              (66 3 (:DEFINITION QCONS$INLINE))
...
(TO-PARAM-SPACE-MEMOIZE-CONDITION)
(UBDDP-TO-PARAM-SPACE (366 122
                           (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
                      (244 244 (:TYPE-PRESCRIPTION BOOLEANP)))
(PARAM-ENV)
(PARAM-ENV-TO-PARAM-SPACE (444 444 (:TYPE-PRESCRIPTION BOOLEANP))
                          (431 431 (:REWRITE EVAL-BDD-WHEN-NOT-CONSP)))
(UNPARAM-ENV (12 6 (:DEFINITION INTEGER-ABS))
...
(EVAL-WITH-UNPARAM-ENV (25 11
                       ...
                       (10 10 (:TYPE-PRESCRIPTION BOOLEANP)))
(UNPARAM-ENV-IND (12 6 (:DEFINITION INTEGER-ABS))
                 (12 3 (:DEFINITION LENGTH))
                 (8 8 (:REWRITE FOLD-CONSTS-IN-+))
                 (6 6 (:REWRITE DEFAULT-UNARY-MINUS))
                 (6 6 (:REWRITE COMMUTATIVITY-OF-+))
                 ...
                 (3 3 (:REWRITE DEFAULT-COERCE-1))
                 (3 3 (:DEFINITION LEN)))
(UNPARAM-ENV-TO-PARAM-SPACE (788 788 (:TYPE-PRESCRIPTION BOOLEANP))
...
(Q-PARAM-TO-PARAM-IND (4 4
                         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(NTH-MAKE-LIST-AC-NIL (77 77 (:META CANCEL_PLUS-LESSP-CORRECT))
                      (18 18
                          (:TYPE-PRESCRIPTION |x < y  =>  0 < y-x|))
...
(Q-NOT-EQUAL-T (4 1 (:DEFINITION UBDDP))
               (3 1 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
               (2 2 (:TYPE-PRESCRIPTION BOOLEANP))
               (2 1 (:DEFINITION Q-NOT))
               (1 1 (:DEFINITION HONS)))
(NOT-Q-NOT-X (6 2 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
             (4 4 (:TYPE-PRESCRIPTION BOOLEANP))
             (4 1 (:DEFINITION UBDDP)))
(Q-NOT-TO-PARAM (2067 655
                      (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
                (1310 1310 (:TYPE-PRESCRIPTION BOOLEANP)))
(NOT-CONSP-NOT-NIL-IMPLIES-T (114 38 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
                             (76 76 (:TYPE-PRESCRIPTION BOOLEANP)))
(Q-AND-TO-PARAM-IND)
(Q-AND-TO-PARAM (16228 4553
                       (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
                (7646 7646 (:TYPE-PRESCRIPTION BOOLEANP)))
(Q-ITE-IN-TERMS-OF-AND-AND-NOT (873 9 (:DEFINITION Q-ITE-FN))
                               ...
                               (8 2 (:DEFINITION BOOLEAN-LISTP))
                               (1 1 (:DEFINITION LEN)))
(Q-ITE-TO-PARAM (312 24 (:DEFINITION QCONS$INLINE))
...
(TO-FROM-PARAM-SPACE (2587 634
                           (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
                     (1040 1040 (:TYPE-PRESCRIPTION BOOLEANP)))
(EVAL-BDD-OF-QCONS (112 112 (:REWRITE EVAL-BDD-WHEN-NOT-CONSP))
                   (112 112
                        (:REWRITE EVAL-BDD-OF-NON-CONSP-CHEAP))
                   (20 20 (:TYPE-PRESCRIPTION BOOLEANP)))
(TO-FROM-IND)
(FROM-PARAM-SPACE-OF-QCONS (1718 1697
                                 (:TYPE-PRESCRIPTION FROM-PARAM-SPACE))
                           (747 140
                                (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
                           (268 268 (:TYPE-PRESCRIPTION BOOLEANP)))
(CONSP-QCONS (6 6 (:TYPE-PRESCRIPTION BOOLEANP)))
(TO-FROM-PARAM-SPACE-EVAL (4680 360 (:REWRITE TO-FROM-PARAM-SPACE))
                          (3858 3018 (:REWRITE EVAL-BDD-WHEN-NOT-CONSP))
                          (3600 360 (:DEFINITION UBDDP))
                          (2520 2520 (:TYPE-PRESCRIPTION UBDDP))
                          (1458 1434
                                (:TYPE-PRESCRIPTION FROM-PARAM-SPACE)))
(TO-PARAM-SPACE-SELF (39 13 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
                     (26 26 (:TYPE-PRESCRIPTION BOOLEANP))
                     (20 2 (:DEFINITION QCONS$INLINE))
                     (6 6 (:DEFINITION HONS)))
(FROM-TO-PARAM-SPACE (871 194
                          (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
                     (388 388 (:TYPE-PRESCRIPTION BOOLEANP)))
(PARAM-ENV-IND)
(EVAL-OF-FROM-PARAM-SPACE (6747 6747
                                (:TYPE-PRESCRIPTION FROM-PARAM-SPACE))
...
(TO-PARAM-SPACE2-MEMOIZE-CONDITION)
(UBDDP-TO-PARAM-SPACE2 (1562 292
                             (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
                       (584 584 (:TYPE-PRESCRIPTION BOOLEANP)))
(EVAL-OF-TO-PARAM-SPACE2-IND)
(EVAL-OF-TO-PARAM-SPACE2 (359 290 (:REWRITE EVAL-BDD-WHEN-NOT-CONSP))
                         (138 138
                              (:TYPE-PRESCRIPTION TO-PARAM-SPACE2)))
(TO-PARAM-SPACE2-LIST (1 1 (:TYPE-PRESCRIPTION TO-PARAM-SPACE2)))
