...
(FTY::STUDENT-FIX-WHEN-STUDENT (3 1
                               ...
                               (2 2 (:TYPE-PRESCRIPTION FTY::STUDENT-P))
                               (2 2 (:TYPE-PRESCRIPTION NATP)))
(FTY::EQUAL-OF-STUDENT (24 24 (:REWRITE STR-FIX-WHEN-STRINGP)))
...
(FTY::TEACHER-FIX-WHEN-TEACHER (3 1
                               ...
                               (2 2 (:TYPE-PRESCRIPTION FTY::TEACHER-P))
                               (2 2 (:TYPE-PRESCRIPTION NATP)))
(FTY::EQUAL-OF-TEACHER (24 24 (:REWRITE STR-FIX-WHEN-STRINGP)))
...
(FTY::CANDY-CHOCOLATE->MAKER-OF-CANDY-CHOCOLATE
     (9 9
        (:TYPE-PRESCRIPTION FTY::CANDY-CHOCOLATE)))
(FTY::CANDY-CHOCOLATE-OF-FIELDS (3 1
                                   (:REWRITE FTY::CANDY-FIX-WHEN-CANDY-P))
                                (2 2 (:TYPE-PRESCRIPTION FTY::CANDY-P)))
(FTY::CANDY-FIX-WHEN-CHOCOLATE (3 1
                                  (:REWRITE FTY::CANDY-FIX-WHEN-CANDY-P))
                               (2 2 (:TYPE-PRESCRIPTION FTY::CANDY-P)))
(FTY::EQUAL-OF-CANDY-CHOCOLATE (11 11 (:REWRITE DEFAULT-CDR))
...
(FTY::CANDY-HARD->STYLE-WHEN-WRONG-KIND
     (2 2 (:REWRITE STR-FIX-WHEN-STRINGP)))
(FTY::CANDY-HARD)
(FTY::RETURN-TYPE-OF-CANDY-HARD (3 1 (:REWRITE BOOL-FIX-WHEN-BOOLEANP))
                                (2 2 (:TYPE-PRESCRIPTION BOOLEANP))
                                (1 1 (:REWRITE STR-FIX-WHEN-STRINGP)))
(FTY::CANDY-HARD->HAS-SUGARP-OF-CANDY-HARD)
(FTY::CANDY-HARD->STYLE-OF-CANDY-HARD
     (9 9 (:TYPE-PRESCRIPTION FTY::CANDY-HARD)))
(FTY::CANDY-HARD-OF-FIELDS (3 1
                              (:REWRITE FTY::CANDY-FIX-WHEN-CANDY-P))
                           (2 2 (:TYPE-PRESCRIPTION FTY::CANDY-P)))
(FTY::CANDY-FIX-WHEN-HARD (3 1
                             (:REWRITE FTY::CANDY-FIX-WHEN-CANDY-P))
                          (2 2 (:TYPE-PRESCRIPTION FTY::CANDY-P)))
(FTY::EQUAL-OF-CANDY-HARD (24 24 (:REWRITE BOOL-FIX-WHEN-BOOLEANP)))
