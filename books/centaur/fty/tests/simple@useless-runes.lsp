...
(FTY::STUDENT-FIX-WHEN-STUDENT-P (3 3 (:DEFINITION STRIP-CARS)))
(FTY::STUDENT-FIX$INLINE (3 3 (:DEFINITION STRIP-CARS)))
...
(FTY::STUDENT->NAME$INLINE (3 3 (:DEFINITION STRIP-CARS)))
(FTY::STRINGP-OF-STUDENT->NAME)
(FTY::STUDENT->NAME$INLINE-OF-STUDENT-FIX-X
     (9 3
        (:REWRITE FTY::STUDENT-FIX-WHEN-STUDENT-P))
     (6 6 (:TYPE-PRESCRIPTION FTY::STUDENT-P))
     (6 6
        (:TYPE-PRESCRIPTION FTY::STUDENT-FIX$INLINE))
     (3 1
        (:REWRITE TMP-DEFTYPES-NFIX-WHEN-NATP))
     (2 2 (:TYPE-PRESCRIPTION NATP)))
(FTY::STUDENT->NAME$INLINE-OF-STUDENT-FIX-X-NORMALIZE-CONST)
(FTY::STUDENT->NAME$INLINE-STUDENT-EQUIV-CONGRUENCE-ON-X)
(FTY::STUDENT->AGE$INLINE (3 3 (:DEFINITION STRIP-CARS)))
...
(FTY::STUDENT->AGE$INLINE-OF-STUDENT-FIX-X-NORMALIZE-CONST)
(FTY::STUDENT->AGE$INLINE-STUDENT-EQUIV-CONGRUENCE-ON-X)
(FTY::STUDENT)
(FTY::STUDENT-P-OF-STUDENT (15 5
                               (:REWRITE TMP-DEFTYPES-NFIX-WHEN-NATP))
                           ...
                           (1 1 (:REWRITE STR-FIX-DEFAULT)))
(FTY::STUDENT->NAME-OF-STUDENT (6 6 (:TYPE-PRESCRIPTION FTY::STUDENT)))
(FTY::STUDENT->AGE-OF-STUDENT (10 10 (:TYPE-PRESCRIPTION NATP))
                              (6 6 (:TYPE-PRESCRIPTION FTY::STUDENT)))
(FTY::STUDENT-OF-FIELDS (3 1
                           (:REWRITE FTY::STUDENT-FIX-WHEN-STUDENT-P))
                        (2 2 (:TYPE-PRESCRIPTION FTY::STUDENT-P))
                        (2 2 (:TYPE-PRESCRIPTION NATP)))
(FTY::STUDENT-FIX-WHEN-STUDENT (3 1
                                  (:REWRITE FTY::STUDENT-FIX-WHEN-STUDENT-P))
                               (2 2 (:TYPE-PRESCRIPTION FTY::STUDENT-P))
                               (2 2 (:TYPE-PRESCRIPTION NATP)))
(FTY::EQUAL-OF-STUDENT
    ...
    (4 4
       (:REWRITE FTY::STUDENT->NAME$INLINE-OF-STUDENT-FIX-X-NORMALIZE-CONST))
    (4 4
       (:REWRITE FTY::STUDENT->AGE$INLINE-OF-STUDENT-FIX-X-NORMALIZE-CONST)))
(FTY::STUDENT-OF-STR-FIX-NAME (4 2
                                 (:REWRITE TMP-DEFTYPES-NFIX-WHEN-NATP))
                              (2 2 (:TYPE-PRESCRIPTION NATP)))
(FTY::STUDENT-OF-STR-FIX-NAME-NORMALIZE-CONST)
(FTY::STUDENT-STREQV-CONGRUENCE-ON-NAME)
(FTY::STUDENT-OF-NFIX-AGE (2 2 (:TYPE-PRESCRIPTION NATP))
                          (2 2 (:REWRITE STR-FIX-WHEN-STRINGP)))
(FTY::STUDENT-OF-NFIX-AGE-NORMALIZE-CONST)
...
(FTY::TEACHER-P-OF-TEACHER-FIX (26 8
                               ...
                               (3 1 (:DEFINITION NATP))
                               (1 1 (:REWRITE STR-FIX-DEFAULT)))
(FTY::TEACHER-FIX-WHEN-TEACHER-P (3 3 (:DEFINITION STRIP-CARS)))
(FTY::TEACHER-FIX$INLINE (3 3 (:DEFINITION STRIP-CARS)))
(FTY::TMP-DEFFIXTYPE-IDEMPOTENT)
...
(FTY::TEACHER->NAME$INLINE (3 3 (:DEFINITION STRIP-CARS)))
(FTY::STRINGP-OF-TEACHER->NAME)
(FTY::TEACHER->NAME$INLINE-OF-TEACHER-FIX-X
     (9 3
        (:REWRITE FTY::TEACHER-FIX-WHEN-TEACHER-P))
     (6 6 (:TYPE-PRESCRIPTION FTY::TEACHER-P))
     (6 6
        (:TYPE-PRESCRIPTION FTY::TEACHER-FIX$INLINE))
     (3 1
        (:REWRITE TMP-DEFTYPES-NFIX-WHEN-NATP))
     (2 2 (:TYPE-PRESCRIPTION NATP)))
(FTY::TEACHER->NAME$INLINE-OF-TEACHER-FIX-X-NORMALIZE-CONST)
(FTY::TEACHER->NAME$INLINE-TEACHER-EQUIV-CONGRUENCE-ON-X)
(FTY::TEACHER->GRADE$INLINE (3 3 (:DEFINITION STRIP-CARS)))
...
(FTY::TEACHER->GRADE$INLINE-OF-TEACHER-FIX-X
     ...
     (6 6
        (:TYPE-PRESCRIPTION FTY::TEACHER-FIX$INLINE))
     (1 1 (:REWRITE STR-FIX-WHEN-STRINGP)))
(FTY::TEACHER->GRADE$INLINE-OF-TEACHER-FIX-X-NORMALIZE-CONST)
(FTY::TEACHER->GRADE$INLINE-TEACHER-EQUIV-CONGRUENCE-ON-X)
(FTY::TEACHER)
(FTY::TEACHER-P-OF-TEACHER (15 5
                               (:REWRITE TMP-DEFTYPES-NFIX-WHEN-NATP))
                           (7 7 (:TYPE-PRESCRIPTION NATP))
                           (4 4 (:REWRITE STR-FIX-WHEN-STRINGP))
                           (3 3 (:REWRITE DEFAULT-<-2))
                           ...
                           (2 2 (:REWRITE DEFAULT-CAR))
                           (1 1 (:REWRITE STR-FIX-DEFAULT)))
(FTY::TEACHER->NAME-OF-TEACHER (6 6 (:TYPE-PRESCRIPTION FTY::TEACHER)))
(FTY::TEACHER->GRADE-OF-TEACHER (10 10 (:TYPE-PRESCRIPTION NATP))
                                (6 6 (:TYPE-PRESCRIPTION FTY::TEACHER)))
(FTY::TEACHER-OF-FIELDS (3 1
                           (:REWRITE FTY::TEACHER-FIX-WHEN-TEACHER-P))
                        (2 2 (:TYPE-PRESCRIPTION FTY::TEACHER-P))
                        (2 2 (:TYPE-PRESCRIPTION NATP)))
(FTY::TEACHER-FIX-WHEN-TEACHER (3 1
                                  (:REWRITE FTY::TEACHER-FIX-WHEN-TEACHER-P))
                               (2 2 (:TYPE-PRESCRIPTION FTY::TEACHER-P))
                               (2 2 (:TYPE-PRESCRIPTION NATP)))
(FTY::EQUAL-OF-TEACHER
  (24 24 (:REWRITE STR-FIX-WHEN-STRINGP))
  (4 4
     (:REWRITE FTY::TEACHER->NAME$INLINE-OF-TEACHER-FIX-X-NORMALIZE-CONST))
  (4 4
     (:REWRITE FTY::TEACHER->GRADE$INLINE-OF-TEACHER-FIX-X-NORMALIZE-CONST)))
(FTY::TEACHER-OF-STR-FIX-NAME (4 2
                                 (:REWRITE TMP-DEFTYPES-NFIX-WHEN-NATP))
                              (2 2 (:TYPE-PRESCRIPTION NATP)))
(FTY::TEACHER-OF-STR-FIX-NAME-NORMALIZE-CONST)
(FTY::TEACHER-STREQV-CONGRUENCE-ON-NAME)
(FTY::TEACHER-OF-NFIX-GRADE (2 2 (:TYPE-PRESCRIPTION NATP))
                            (2 2 (:REWRITE STR-FIX-WHEN-STRINGP)))
(FTY::TEACHER-OF-NFIX-GRADE-NORMALIZE-CONST)
(FTY::TEACHER-NAT-EQUIV-CONGRUENCE-ON-GRADE)
(FTY::TEACHER-FIX-REDEF)
(FTY::TAG-OF-TEACHER)
(FTY::PERSON-P)
(FTY::CONSP-WHEN-PERSON-P)
(FTY::PERSON-P-WHEN-STUDENT-P (6 2
                                 (:REWRITE FTY::STUDENT-P-WHEN-WRONG-TAG))
                              (4 2 (:REWRITE FTY::TAG-WHEN-TEACHER-P)))
(FTY::PERSON-P-WHEN-TEACHER-P (6 2
                                 (:REWRITE FTY::TEACHER-P-WHEN-WRONG-TAG))
...
(FTY::PERSON-P-WHEN-INVALID-TAG
     ...
     (1 1
        (:REWRITE FTY::TEACHER-P-BY-TAG-WHEN-PERSON-P)))
(FTY::TAG-WHEN-PERSON-P-FORWARD)
(FTY::PERSON-FIX$INLINE)
(FTY::PERSON-P-OF-PERSON-FIX (54 3
                                 (:REWRITE FTY::STUDENT-FIX-WHEN-STUDENT-P))
                             ...
                             (24 3
                                 (:REWRITE FTY::TEACHER-FIX-WHEN-TEACHER-P))
                             (12 6
                                 (:REWRITE FTY::PERSON-P-WHEN-TEACHER-P))
                             (12 6
                                 (:REWRITE FTY::PERSON-P-WHEN-STUDENT-P))
                             (5 1
                                (:REWRITE FTY::TEACHER-P-WHEN-WRONG-TAG))
                             (1 1
                                (:REWRITE FTY::STUDENT-P-WHEN-WRONG-TAG)))
(FTY::PERSON-FIX-WHEN-PERSON-P
     (8 2
        (:REWRITE FTY::STUDENT-P-BY-TAG-WHEN-PERSON-P))
     (6 2
        (:REWRITE FTY::PERSON-P-WHEN-TEACHER-P))
     (6 2
        (:REWRITE FTY::PERSON-P-WHEN-STUDENT-P))
     (2 2
        (:REWRITE FTY::TEACHER-P-BY-TAG-WHEN-PERSON-P))
     (1 1
        (:REWRITE FTY::PERSON-P-WHEN-INVALID-TAG)))
(FTY::PERSON-FIX$INLINE (8 2
                           (:REWRITE FTY::STUDENT-P-BY-TAG-WHEN-PERSON-P))
                        (6 2
                           (:REWRITE FTY::PERSON-P-WHEN-TEACHER-P))
                        (6 2
...
(FTY::CANDY-P-OF-CANDY-FIX (12 4 (:REWRITE BOOL-FIX-WHEN-BOOLEANP))
...
(FTY::CANDY-KIND$INLINE-OF-CANDY-FIX-X
     ...
     (1 1
        (:REWRITE FTY::CANDY-FIX-WHEN-CANDY-P)))
(FTY::CANDY-KIND$INLINE-OF-CANDY-FIX-X-NORMALIZE-CONST)
(FTY::CANDY-KIND$INLINE-CANDY-EQUIV-CONGRUENCE-ON-X)
(FTY::CONSP-OF-CANDY-FIX)
(FTY::TAG-WHEN-CANDY-P-FORWARD
     (2 2
        (:REWRITE FTY::CANDY-KIND$INLINE-OF-CANDY-FIX-X-NORMALIZE-CONST)))
...
(FTY::CANDY-CHOCOLATE->DARKNESS$INLINE-OF-CANDY-FIX-X
     (13 5
         (:REWRITE FTY::CANDY-FIX-WHEN-CANDY-P))
     (9 9
        (:TYPE-PRESCRIPTION FTY::CONSP-OF-CANDY-FIX))
     (9 9
        (:TYPE-PRESCRIPTION FTY::CANDY-FIX$INLINE))
     (8 8 (:TYPE-PRESCRIPTION FTY::CANDY-P))
     (8 8
        (:REWRITE FTY::CANDY-KIND$INLINE-OF-CANDY-FIX-X-NORMALIZE-CONST))
     (2 2 (:REWRITE STR-FIX-WHEN-STRINGP)))
(FTY::CANDY-CHOCOLATE->DARKNESS$INLINE-OF-CANDY-FIX-X-NORMALIZE-CONST)
...
(FTY::CANDY-CHOCOLATE->MAKER$INLINE-OF-CANDY-FIX-X
     ...
     (2 2
        (:REWRITE TMP-DEFTYPES-IFIX-WHEN-INTEGERP)))
(FTY::CANDY-CHOCOLATE->MAKER$INLINE-OF-CANDY-FIX-X-NORMALIZE-CONST)
...
(FTY::CANDY-CHOCOLATE->DARKNESS-OF-CANDY-CHOCOLATE
 (9 9
    (:TYPE-PRESCRIPTION FTY::CANDY-CHOCOLATE))
 (1
  1
  (:REWRITE
      FTY::CANDY-CHOCOLATE->DARKNESS$INLINE-OF-CANDY-FIX-X-NORMALIZE-CONST)))
...
(FTY::CANDY-CHOCOLATE-OF-IFIX-DARKNESS (2 2 (:REWRITE STR-FIX-WHEN-STRINGP)))
(FTY::CANDY-CHOCOLATE-OF-IFIX-DARKNESS-NORMALIZE-CONST)
(FTY::CANDY-CHOCOLATE-INT-EQUIV-CONGRUENCE-ON-DARKNESS)
(FTY::CANDY-CHOCOLATE-OF-STR-FIX-MAKER
     (2 2
        (:REWRITE TMP-DEFTYPES-IFIX-WHEN-INTEGERP)))
(FTY::CANDY-CHOCOLATE-OF-STR-FIX-MAKER-NORMALIZE-CONST)
...
(FTY::CANDY-HARD->HAS-SUGARP$INLINE-OF-CANDY-FIX-X
     ...
     (7 7
        (:REWRITE FTY::CANDY-KIND$INLINE-OF-CANDY-FIX-X-NORMALIZE-CONST))
     (1 1 (:REWRITE STR-FIX-WHEN-STRINGP)))
(FTY::CANDY-HARD->HAS-SUGARP$INLINE-OF-CANDY-FIX-X-NORMALIZE-CONST)
...
(FTY::CANDY-HARD->STYLE$INLINE-OF-CANDY-FIX-X
     ...
     (3 1 (:REWRITE BOOL-FIX-WHEN-BOOLEANP))
     (2 2 (:TYPE-PRESCRIPTION BOOLEANP)))
(FTY::CANDY-HARD->STYLE$INLINE-OF-CANDY-FIX-X-NORMALIZE-CONST)
...
(FTY::CANDY-HARD->STYLE-WHEN-WRONG-KIND
 ...
 (2 2
    (:REWRITE FTY::CANDY-KIND$INLINE-OF-CANDY-FIX-X-NORMALIZE-CONST))
 (1 1
    (:REWRITE FTY::CANDY-HARD->STYLE$INLINE-OF-CANDY-FIX-X-NORMALIZE-CONST)))
(FTY::CANDY-HARD)
...
(FTY::CANDY-HARD-OF-BOOL-FIX-HAS-SUGARP
     (2 2 (:REWRITE STR-FIX-WHEN-STRINGP)))
(FTY::CANDY-HARD-OF-BOOL-FIX-HAS-SUGARP-NORMALIZE-CONST)
(FTY::CANDY-HARD-IFF-CONGRUENCE-ON-HAS-SUGARP)
(FTY::CANDY-HARD-OF-STR-FIX-STYLE (4 2 (:REWRITE BOOL-FIX-WHEN-BOOLEANP))
                                  (2 2 (:TYPE-PRESCRIPTION BOOLEANP)))
(FTY::CANDY-HARD-OF-STR-FIX-STYLE-NORMALIZE-CONST)
...
(FTY::CANDY-FIX-REDEF
 ...
 (1 1
    (:REWRITE FTY::CANDY-KIND$INLINE-OF-CANDY-FIX-X-NORMALIZE-CONST))
 (1 1
    (:REWRITE FTY::CANDY-HARD-OF-STR-FIX-STYLE-NORMALIZE-CONST))
 (1 1
    (:REWRITE FTY::CANDY-HARD-OF-BOOL-FIX-HAS-SUGARP-NORMALIZE-CONST))
 (1 1
    (:REWRITE FTY::CANDY-HARD->STYLE$INLINE-OF-CANDY-FIX-X-NORMALIZE-CONST))
 (1 1
    (:REWRITE
         FTY::CANDY-HARD->HAS-SUGARP$INLINE-OF-CANDY-FIX-X-NORMALIZE-CONST))
 (1 1
    (:REWRITE FTY::CANDY-CHOCOLATE-OF-STR-FIX-MAKER-NORMALIZE-CONST))
 (1 1
    (:REWRITE FTY::CANDY-CHOCOLATE-OF-IFIX-DARKNESS-NORMALIZE-CONST))
 (1 1
    (:REWRITE
         FTY::CANDY-CHOCOLATE->MAKER$INLINE-OF-CANDY-FIX-X-NORMALIZE-CONST))
 (1
...
(FTY::WOLFCHOW-P-OF-WOLFCHOW-FIX
     ...
     (16 8
         (:REWRITE FTY::WOLFCHOW-P-WHEN-PERSON-P))
     (16 8
         (:REWRITE FTY::WOLFCHOW-P-WHEN-CANDY-P))
     (2 2
        (:REWRITE FTY::PERSON-P-WHEN-INVALID-TAG)))
(FTY::WOLFCHOW-FIX-WHEN-WOLFCHOW-P
     (8 2
        (:REWRITE FTY::PERSON-P-BY-TAG-WHEN-WOLFCHOW-P))
     (6 2
        (:REWRITE FTY::WOLFCHOW-P-WHEN-PERSON-P))
     (6 2
        (:REWRITE FTY::WOLFCHOW-P-WHEN-CANDY-P))
     (2 2
        (:REWRITE FTY::CANDY-P-BY-TAG-WHEN-WOLFCHOW-P))
     (1 1
        (:REWRITE FTY::WOLFCHOW-P-WHEN-INVALID-TAG)))
(FTY::WOLFCHOW-FIX$INLINE (8 2
                             (:REWRITE FTY::PERSON-P-BY-TAG-WHEN-WOLFCHOW-P))
                          (6 2
                             (:REWRITE FTY::WOLFCHOW-P-WHEN-PERSON-P))
                          (6 2
...
(FTY::CONSTEST->FOO$INLINE-OF-CONSTEST-FIX-X
     (9 3
        (:REWRITE FTY::CONSTEST-FIX-WHEN-CONSTEST-P))
     (6 6 (:TYPE-PRESCRIPTION FTY::CONSTEST-P))
     (6 6
        (:TYPE-PRESCRIPTION FTY::CONSTEST-FIX$INLINE))
     (3 1
        (:REWRITE MAYBE-NATP-FIX-WHEN-MAYBE-NATP))
     (2 2
        (:TYPE-PRESCRIPTION MAYBE-NATP$INLINE)))
(FTY::CONSTEST->FOO$INLINE-OF-CONSTEST-FIX-X-NORMALIZE-CONST)
...
(FTY::CONSTEST->BAR$INLINE-OF-CONSTEST-FIX-X
     ...
     (6 6 (:TYPE-PRESCRIPTION FTY::CONSTEST-P))
     (1 1 (:REWRITE STR-FIX-WHEN-STRINGP)))
(FTY::CONSTEST->BAR$INLINE-OF-CONSTEST-FIX-X-NORMALIZE-CONST)
(FTY::CONSTEST->BAR$INLINE-CONSTEST-EQUIV-CONGRUENCE-ON-X)
(FTY::CONSTEST)
(FTY::CONSTEST-P-OF-CONSTEST)
(FTY::CONSTEST->FOO-OF-CONSTEST (6 6 (:TYPE-PRESCRIPTION FTY::CONSTEST)))
(FTY::CONSTEST->BAR-OF-CONSTEST)
(FTY::CONSTEST-OF-FIELDS (3 1
                            (:REWRITE FTY::CONSTEST-FIX-WHEN-CONSTEST-P))
...
(FTY::EQUAL-OF-CONSTEST
  (9 9
     (:REWRITE FTY::CONSTEST->FOO$INLINE-OF-CONSTEST-FIX-X-NORMALIZE-CONST))
  (9 9
     (:REWRITE FTY::CONSTEST->BAR$INLINE-OF-CONSTEST-FIX-X-NORMALIZE-CONST)))
(FTY::CONSTEST-OF-STR-FIX-FOO (4 2
                                 (:REWRITE MAYBE-NATP-FIX-WHEN-MAYBE-NATP))
                              (2 2
                                 (:TYPE-PRESCRIPTION MAYBE-NATP$INLINE)))
(FTY::CONSTEST-OF-STR-FIX-FOO-NORMALIZE-CONST)
(FTY::CONSTEST-STREQV-CONGRUENCE-ON-FOO)
(FTY::CONSTEST-OF-MAYBE-NATP-FIX-BAR (2 2 (:REWRITE STR-FIX-WHEN-STRINGP)))
(FTY::CONSTEST-OF-MAYBE-NATP-FIX-BAR-NORMALIZE-CONST)
