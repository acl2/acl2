...
(FTY::INT-TREE-P (242 80 (:REWRITE DEFAULT-+-2))
...
(FTY::INT-TREE-FLAG (288 96 (:REWRITE DEFAULT-+-2))
...
(FTY::INT-TREELIST-P-OF-CONS (5 5 (:REWRITE DEFAULT-CDR))
                             (5 5 (:REWRITE DEFAULT-CAR)))
(FTY::INT-TREE-P-WHEN-CONSP (8 2 (:DEFINITION FTY::INT-TREELIST-P))
                            (2 2 (:REWRITE DEFAULT-CDR))
                            (2 2 (:REWRITE DEFAULT-CAR)))
(FTY::INT-TREE-P-WHEN-ATOM (1 1
                              (:REWRITE FTY::INT-TREE-P-WHEN-CONSP)))
(FTY::INT-TREELIST-P-WHEN-CONSP (13 13 (:REWRITE DEFAULT-CAR))
                                (7 7 (:REWRITE FTY::INT-TREE-P-WHEN-CONSP))
                                (7 7 (:REWRITE FTY::INT-TREE-P-WHEN-ATOM))
                                (7 7 (:REWRITE DEFAULT-CDR)))
(FTY::INT-TREELIST-P-WHEN-ATOM (1 1
                                  (:REWRITE FTY::INT-TREELIST-P-WHEN-CONSP)))
(FTY::INT-TREE-FIX (722 18 (:DEFINITION ACL2-COUNT))
                   ...
                   (2 2
                      (:LINEAR ACL2-COUNT-OF-CONSP-POSITIVE)))
(FTY::INT-TREE-FIX-FLAG (844 20 (:DEFINITION ACL2-COUNT))
...
(FTY::FLAG-LEMMA-FOR-RETURN-TYPE-OF-INT-TREE-FIX.ITREE
     (14 7
         (:REWRITE FTY::INT-TREELIST-P-WHEN-ATOM))
...
(FTY::TMP-DEFFIXTYPE-IDEMPOTENT
     ...
     (10 2
         (:REWRITE FTY::INT-TREE-FIX-WHEN-INT-TREE-P))
...
(CDR-OF-INT-TREELIST-FIX-X-UNDER-INT-TREELIST-EQUIV
 (38 8
     (:REWRITE FTY::INT-TREELIST-FIX-WHEN-INT-TREELIST-P))
 (25 5
     (:REWRITE FTY::INT-TREE-FIX-WHEN-INT-TREE-P))
 (14 14
     (:TYPE-PRESCRIPTION FTY::INT-TREELIST-P))
 ...
 (1
  1
  (:REWRITE-QUOTED-CONSTANT FTY::INT-TREELIST-FIX-UNDER-INT-TREELIST-EQUIV)))
(CDR-OF-INT-TREELIST-FIX-X-NORMALIZE-CONST-UNDER-INT-TREELIST-EQUIV)
...
(CONS-OF-INT-TREELIST-FIX-Y-UNDER-INT-TREELIST-EQUIV
 ...
 (5
   ...
   (:REWRITE
        CDR-OF-INT-TREELIST-FIX-X-NORMALIZE-CONST-UNDER-INT-TREELIST-EQUIV)))
(CONS-OF-INT-TREELIST-FIX-Y-NORMALIZE-CONST-UNDER-INT-TREELIST-EQUIV)
...
(CONS-OF-INT-TREE-FIX-X-UNDER-INT-TREELIST-EQUIV
 ...
 (2
  ...
  (:REWRITE
       CONS-OF-INT-TREELIST-FIX-Y-NORMALIZE-CONST-UNDER-INT-TREELIST-EQUIV)))
(CONS-OF-INT-TREE-FIX-X-NORMALIZE-CONST-UNDER-INT-TREELIST-EQUIV)
...
(CAR-OF-INT-TREELIST-FIX-X-UNDER-INT-TREE-EQUIV
 ...
 (5 5
    (:TYPE-PRESCRIPTION FTY::INT-TREELIST-FIX))
 (4 4
    (:REWRITE FTY::INT-TREELIST-P-WHEN-CONSP))
 (4 4
    (:REWRITE FTY::INT-TREELIST-P-WHEN-ATOM))
 ...
 (3
   ...
   (:REWRITE
        CDR-OF-INT-TREELIST-FIX-X-NORMALIZE-CONST-UNDER-INT-TREELIST-EQUIV)))
(CAR-OF-INT-TREELIST-FIX-X-NORMALIZE-CONST-UNDER-INT-TREE-EQUIV)
(CAR-INT-TREELIST-EQUIV-CONGRUENCE-ON-X-UNDER-INT-TREE-EQUIV)
(FTY::COUNT-LEAVES (722 18 (:DEFINITION ACL2-COUNT))
...
(FTY::COUNT-LEAVES-FLAG (844 20 (:DEFINITION ACL2-COUNT))
                        (336 116 (:REWRITE DEFAULT-+-2))
                        (204 116 (:REWRITE DEFAULT-+-1))
                        (133 1 (:DEFINITION O-P))
                        (120 24 (:REWRITE COMMUTATIVITY-OF-+))
...
(FTY::COUNT-LEAVES-OF-INT-TREE-FIX-X-NORMALIZE-CONST)
(FTY::COUNT-LEAVES-INT-TREE-EQUIV-CONGRUENCE-ON-X)
(FTY::COUNT-LEAVES-LIST-OF-INT-TREELIST-FIX-X-NORMALIZE-CONST)
...
(FTY::NTH-LEAF
 ...
 (8 8 (:REWRITE DEFAULT-COERCE-1))
 (8 8
    (:REWRITE FTY::COUNT-LEAVES-OF-INT-TREE-FIX-X-NORMALIZE-CONST))
 (7 7
    (:REWRITE FTY::INT-TREELIST-P-WHEN-ATOM))
 (7 7
    (:REWRITE FTY::COUNT-LEAVES-LIST-OF-INT-TREELIST-FIX-X-NORMALIZE-CONST))
 (7
   7
   (:REWRITE CAR-OF-INT-TREELIST-FIX-X-NORMALIZE-CONST-UNDER-INT-TREE-EQUIV))
 (4 4
    (:REWRITE
         CDR-OF-INT-TREELIST-FIX-X-NORMALIZE-CONST-UNDER-INT-TREELIST-EQUIV))
 (1 1
...
(FTY::NTH-LEAF-OF-NFIX-N-NORMALIZE-CONST)
(FTY::NTH-LEAF-NAT-EQUIV-CONGRUENCE-ON-N)
(FTY::NTH-LEAF-LIST-OF-NFIX-N-NORMALIZE-CONST)
...
(FTY::FLAG-LEMMA-FOR-NTH-LEAF-OF-INT-TREE-FIX-X
 ...
 (213 213
      (:TYPE-PRESCRIPTION FTY::INT-TREE-P))
 ...
 (156
   ...
   (:REWRITE CAR-OF-INT-TREELIST-FIX-X-NORMALIZE-CONST-UNDER-INT-TREE-EQUIV))
 (149 149
      (:REWRITE FTY::INT-TREE-P-WHEN-ATOM))
 (133 133
      (:REWRITE FTY::COUNT-LEAVES-OF-INT-TREE-FIX-X-NORMALIZE-CONST))
 (127 99
      (:REWRITE INEQUALITY-WITH-NFIX-HYP-2))
 (95 95
     (:REWRITE FTY::NTH-LEAF-LIST-OF-NFIX-N-NORMALIZE-CONST))
 (89 49 (:REWRITE IFIX-WHEN-NOT-INTEGERP))
 (89 49 (:REWRITE IFIX-WHEN-INTEGERP))
 (87 29
     (:REWRITE CAR-OF-INT-TREELIST-FIX-X-UNDER-INT-TREE-EQUIV))
 (30 30
 ...
 (19
    ...
    (:REWRITE
         CDR-OF-INT-TREELIST-FIX-X-NORMALIZE-CONST-UNDER-INT-TREELIST-EQUIV))
 (16 16
     (:REWRITE FTY::NTH-LEAF-OF-NFIX-N-NORMALIZE-CONST))
 (15 5 (:REWRITE IFIX-EQUAL-TO-0)))
(FTY::NTH-LEAF-OF-INT-TREE-FIX-X)
(FTY::NTH-LEAF-LIST-OF-INT-TREELIST-FIX-X)
(FTY::NTH-LEAF-OF-INT-TREE-FIX-X-NORMALIZE-CONST)
(FTY::NTH-LEAF-INT-TREE-EQUIV-CONGRUENCE-ON-X)
(FTY::NTH-LEAF-LIST-OF-INT-TREELIST-FIX-X-NORMALIZE-CONST)
...
(FTY::UPDATE-NTH-LEAF-OF-NFIX-N-NORMALIZE-CONST)
(FTY::UPDATE-NTH-LEAF-NAT-EQUIV-CONGRUENCE-ON-N)
(FTY::UPDATE-NTH-LEAF-LIST-OF-NFIX-N-NORMALIZE-CONST)
...
(FTY::FLAG-LEMMA-FOR-UPDATE-NTH-LEAF-OF-INT-TREE-FIX-X
 ...
 (10 10
     (:REWRITE FTY::COUNT-LEAVES-OF-INT-TREE-FIX-X-NORMALIZE-CONST))
 (8 8
    (:REWRITE FTY::UPDATE-NTH-LEAF-LIST-OF-NFIX-N-NORMALIZE-CONST))
 (8
   8
   (:REWRITE CAR-OF-INT-TREELIST-FIX-X-NORMALIZE-CONST-UNDER-INT-TREE-EQUIV))
 (8 4 (:REWRITE DEFAULT-UNARY-MINUS))
 ...
 (4 4
    (:REWRITE FTY::UPDATE-NTH-LEAF-OF-NFIX-N-NORMALIZE-CONST)))
(FTY::UPDATE-NTH-LEAF-OF-INT-TREE-FIX-X)
(FTY::UPDATE-NTH-LEAF-LIST-OF-INT-TREELIST-FIX-X)
(FTY::UPDATE-NTH-LEAF-OF-INT-TREE-FIX-X-NORMALIZE-CONST)
(FTY::UPDATE-NTH-LEAF-INT-TREE-EQUIV-CONGRUENCE-ON-X)
(FTY::UPDATE-NTH-LEAF-LIST-OF-INT-TREELIST-FIX-X-NORMALIZE-CONST)
...
(FTY::FLAG-LEMMA-FOR-UPDATE-NTH-LEAF-OF-IFIX-V
 ...
 (8
  8
  (:REWRITE FTY::UPDATE-NTH-LEAF-LIST-OF-INT-TREELIST-FIX-X-NORMALIZE-CONST))
 (8 8
    (:REWRITE FTY::COUNT-LEAVES-OF-INT-TREE-FIX-X-NORMALIZE-CONST))
 (8 4 (:REWRITE DEFAULT-UNARY-MINUS))
 (8 4 (:REWRITE DEFAULT-+-2))
 ...
 (4 4
    (:REWRITE FTY::UPDATE-NTH-LEAF-OF-NFIX-N-NORMALIZE-CONST))
 (4 4
    (:REWRITE FTY::UPDATE-NTH-LEAF-OF-INT-TREE-FIX-X-NORMALIZE-CONST))
 (2 2
    (:TYPE-PRESCRIPTION FTY::INT-TREELIST-P))
 (2 2 (:TYPE-PRESCRIPTION FTY::INT-TREE-P))
 (1 1
...
(FTY::UPDATE-NTH-LEAF-OF-IFIX-V-NORMALIZE-CONST)
(FTY::UPDATE-NTH-LEAF-INT-EQUIV-CONGRUENCE-ON-V)
(FTY::UPDATE-NTH-LEAF-LIST-OF-IFIX-V-NORMALIZE-CONST)
