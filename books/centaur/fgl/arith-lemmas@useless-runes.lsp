(FGL::LOGHEAD-OF-INTEGER-LENGTH-NONNEG
...
(FGL::INTEGER-LENGTH-LTE-BY-COMPARE-NONNEG
     (853 7
          (:REWRITE BITOPS::LOGBITP-UPPER-BOUND))
     ...
     (1 1 (:REWRITE BITOPS::LOGCDR-<-CONST)))
(FGL::INTEGER-LENGTH-LTE-BY-COMPARE-NEG
     (1203 8
           (:REWRITE BITOPS::LOGBITP-UPPER-BOUND))
...
(FGL::LOGEXT-OF-INTEGER-LENGTH-BOUND
...
(FGL::INTEGER-LENGTH-OF-BETWEEN-ABS-AND-MINUS-ABS
     (4980 76
           (:REWRITE BITOPS::LOGBITP-UPPER-BOUND))
...
(FGL::INTEGER-LENGTH-OF-REM
     ...
     (362 98
          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (354 4
          (:REWRITE FGL::INTEGER-LENGTH-LTE-BY-COMPARE-NONNEG))
     (354 4
          (:REWRITE FGL::INTEGER-LENGTH-LTE-BY-COMPARE-NEG))
