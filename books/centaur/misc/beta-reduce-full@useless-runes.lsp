...
(BETA-REDUCE-FULL-REC (405 175 (:REWRITE DEFAULT-+-2))
...
(BETA-REDUCE-FLG (405 175 (:REWRITE DEFAULT-+-2))
                 (245 175 (:REWRITE DEFAULT-+-1))
                 (128 32 (:DEFINITION INTEGER-ABS))
                 (128 16 (:DEFINITION LENGTH))
                 (80 16 (:DEFINITION LEN))
...
(LEN-OF-BETA-REDUCE-FULL-REC-LIST (49 45 (:REWRITE DEFAULT-CDR))
...
(BETA-REDUCE-FULL-REC (343 328 (:REWRITE DEFAULT-CDR))
                      ...
                      (18 6
                          (:DEFINITION BETA-REDUCE-FULL-REC-LIST))
                      (14 14 (:REWRITE DEFAULT-COERCE-2))
                      (14 14 (:REWRITE DEFAULT-COERCE-1))
                      (8 8 (:TYPE-PRESCRIPTION PAIRLIS$)))
(BETA-EVAL-ALIST)
(BETA-EVAL-ALIST-OF-PAIRLIS (24 24 (:REWRITE BETA-EVAL-CONSTRAINT-3))
                            (24 24 (:REWRITE BETA-EVAL-CONSTRAINT-2)))
(LOOKUP-IN-BETA-EVAL-ALIST (116 112 (:REWRITE DEFAULT-CAR))
...
(STRIP-CDRS-OF-PAIRLIS (28 25 (:REWRITE DEFAULT-CDR))
...
(BETA-REDUCE-FULL (336 321 (:REWRITE DEFAULT-CDR))
                  (283 268 (:REWRITE DEFAULT-CAR))
                  (224 111 (:REWRITE DEFAULT-+-2))
