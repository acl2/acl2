...
(FILTER-ALIST-KEEP)
(FILTER-ALIST-SKIP)
(L0 (154 9 (:DEFINITION BINARY-APPEND))
...
(L1 (154 9 (:DEFINITION BINARY-APPEND))
    (67 40 (:REWRITE DEFAULT-CAR))
    (60 35 (:REWRITE CONSP-OF-REV))
    (48 21 (:REWRITE DEFAULT-CDR))
    (32 8 (:REWRITE REV-WHEN-NOT-CONSP))
...
(HONS-ASSOC-EQUAL-OF-FILTER-ALIST-KEEP
     (1755 117 (:DEFINITION MEMBER-EQUAL))
...
(HONS-ASSOC-EQUAL-OF-FILTER-ALIST-SKIP
     ...
     (77 77
         (:REWRITE HONS-ASSOC-EQUAL-WHEN-FOUND-BY-FAL-FIND-ANY)))
(L0 (2198 89 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
    ...
    (8 8
       (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV)))
(L1 (848 56 (:DEFINITION MEMBER-EQUAL))
    ...
    (9 9
       (:REWRITE HONS-ASSOC-EQUAL-WHEN-FOUND-BY-FAL-FIND-ANY)))
(L2 (848 56 (:DEFINITION MEMBER-EQUAL))
    (784 112 (:REWRITE SUBSETP-CAR-MEMBER))
    (320 125
         (:REWRITE NO-DUPLICATESP-EQUAL-NON-CONS))
    (263 251 (:REWRITE DEFAULT-CDR))
    ...
    (9 9
       (:REWRITE HONS-ASSOC-EQUAL-WHEN-FOUND-BY-FAL-FIND-ANY)))
(FILTER-ALIST-CORRECT (36 1 (:DEFINITION NO-DUPLICATESP-EQUAL))
