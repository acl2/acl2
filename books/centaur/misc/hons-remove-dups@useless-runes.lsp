...
(MEMBER-APPEND (58 4 (:DEFINITION MEMBER-EQUAL))
               (14 2
...
(REMOVE-DUPLICATES-EQUAL-OF-APPEND
     (690 40 (:DEFINITION MEMBER-EQUAL))
...
(SET-DIFFERENCE-EQUAL-APPEND (228 18 (:DEFINITION MEMBER-EQUAL))
...
(SET-DIFFERENCE-EQUAL-REMOVE-INSIDE-SET-DIFFERENCE
     ...
     (279 20 (:DEFINITION MEMBER-EQUAL))
     (78 12
         (:REWRITE SUBSETP-IMPLIES-SUBSETP-CDR))
...
(HONS-REMOVE-DUPS1-IS-REMOVE-DUPLICATES
     ...
     (585 37 (:DEFINITION MEMBER-EQUAL))
