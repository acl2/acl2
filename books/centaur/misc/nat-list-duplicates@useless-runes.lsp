...
(MAX-NAT-EXEC (10 4 (:REWRITE NATP-RW))
...
(MAX-NAT (5 5 (:TYPE-PRESCRIPTION MAX)))
(NATP-OF-MAX-NAT (44 11 (:REWRITE INTEGERP-WHEN-NATP))
...
(MAX-NAT-EXEC-REMOVAL (269 44 (:REWRITE DEFAULT-<-1))
...
(MAX-NAT (105 6 (:REWRITE DEFAULT-<-1))
...
(MAX-NAT-AND-LEN (15 6 (:REWRITE NATP-RW))
                 ...
                 (1 1 (:REWRITE DEFAULT-CDR))
                 (1 1 (:REWRITE DEFAULT-CAR)))
(MAX-NAT-AND-LEN-REMOVAL (302 75 (:REWRITE INTEGERP-WHEN-NATP))
...
(NAT-REMOVE-DUPS-WHEN-VERY-SHORT (26 11 (:REWRITE NATP-RW))
...
(DUMB-MAKE-TABLE)
(HONS-ASSOC-EQUAL-DUMB-MAKE-TABLE (68 61 (:REWRITE DEFAULT-CAR))
...
(NATP-OF-NAT-REMOVE-DUPS-ARRP (72 72
...
(UPPER-BOUND-OF-NAT-REMOVE-DUPS-ARRP
     ...
     (82 82
         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
     (68 6
         (:REWRITE NATP-OF-NAT-REMOVE-DUPS-ARRP))
...
(ALIST-AND-STOBJ-STILL-AGREE-AFTER-EXTENSION
     ...
     (142 142
          (:REWRITE ALIST-AND-STOBJ-AGREE-NECC))
...
(NAT-REMOVE-DUPS-WITH-STOBJ-AUX-ELIM
    ...
    (148 52
         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
    (144 12
         (:REWRITE NAT-REMOVE-DUPS-ARRI-OF-UPDATE-NAT-REMOVE-DUPS-ARRI-DIFF))
    (33 33
        (:REWRITE ALIST-AND-STOBJ-AGREE-NECC)))
(NAT-REMOVE-DUPS-WITH-STOBJ-AUX-WHEN-ATOM)
(BASE-CASE (5 2 (:REWRITE NATP-RW))
           ...
           (1 1
              (:REWRITE ALIST-AND-STOBJ-AGREE-CONSEQUENCE))
...
(NAT-LIST-REMOVE-DUPLICATES-EXEC
     ...
     (8 8
        (:TYPE-PRESCRIPTION HONS-REMOVE-DUPLICATES1-TAIL))
     (5 5 (:META CANCEL_TIMES-EQUAL-CORRECT))
     (5 5 (:META CANCEL_PLUS-EQUAL-CORRECT))
     (4 4 (:REWRITE NATP-*))
     ...
     (2 2
        (:REWRITE NAT-REMOVE-DUPS-WITH-STOBJ-AUX-WHEN-ATOM)))
(NAT-LIST-REMOVE-DUPLICATES)
