...
(U32P-NTH-OF-1D-ARR-TMP-LISTP (96 7 (:REWRITE NTH-WITH-LARGE-INDEX))
                              (30 30
...
(U32S$CP-OF-UPDATE-NTH (69 23 (:REWRITE U32P-BOUND))
...
(U32ARR$AP)
(U32ARR$AP-REWRITE-TO-1D-ARR-TMP-LISTP (10 10 (:REWRITE DEFAULT-CAR))
...
(GET-U32{CORRESPONDENCE} (59 6 (:REWRITE NTH-WITH-LARGE-INDEX))
                         (30 6 (:DEFINITION LEN))
...
(GET-U32{GUARD-THM})
(SET-U32{CORRESPONDENCE} (72 6 (:REWRITE NTH-WITH-LARGE-INDEX))
                         (35 6 (:DEFINITION LEN))
...
(SET-U32{GUARD-THM} (45 3 (:REWRITE NTH-WITH-LARGE-INDEX))
                    (25 5 (:DEFINITION LEN))
