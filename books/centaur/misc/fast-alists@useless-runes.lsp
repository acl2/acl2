...
(ALIST-KEYS-HONS-PUT-LIST
     (2390 74 (:REWRITE SUBSETP-OF-CONS))
     (1572 117 (:DEFINITION MEMBER-EQUAL))
     (1316 1286 (:REWRITE DEFAULT-CAR))
     (1094 1021 (:REWRITE DEFAULT-CDR))
     (976 142 (:REWRITE SUBSETP-CAR-MEMBER))
     (778 176 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
     (732 96
          (:REWRITE SUBSETP-IMPLIES-SUBSETP-CDR))
     (660 528 (:REWRITE ALIST-KEYS-WHEN-ATOM))
     (634 444 (:REWRITE SUBSETP-TRANS2))
     (480 10 (:REWRITE SUBSETP-APPEND1))
     (446 320 (:REWRITE SUBSETP-WHEN-ATOM-LEFT))
     (444 444 (:REWRITE SUBSETP-TRANS))
     (404 320 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
     (352 352 (:TYPE-PRESCRIPTION ALISTP))
     (330 330 (:REWRITE SUBSETP-MEMBER . 2))
     (254 138
          (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV))
     (228 188
          (:REWRITE HONS-ASSOC-EQUAL-WHEN-ATOM))
     (215 43 (:REWRITE HONS-ASSOC-EQUAL-OF-CONS))
     (202 202 (:REWRITE SUBSETP-MEMBER . 4))
     (191 176 (:REWRITE ALISTP-WHEN-ATOM))
     (111 111
          (:REWRITE HONS-ASSOC-EQUAL-WHEN-FOUND-BY-FAL-FIND-ANY))
...
(KEYS-EQUIV-IMPLIES-SET-EQUIV-ALIST-KEYS-1
     ...
     (3 3
        (:REWRITE HONS-ASSOC-EQUAL-WHEN-ATOM)))
(KEYS-EQUIV-WHEN-ALIST-KEYS (11 11 (:REWRITE ALIST-KEYS-WHEN-ATOM))
