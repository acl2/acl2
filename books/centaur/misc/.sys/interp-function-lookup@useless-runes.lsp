...
(HONS-ASSOC-EQUAL-INTERP-DEFS-ALISTP
 (5344 223 (:REWRITE PSEUDO-TERMP-CAR))
 (4820 140 (:REWRITE PSEUDO-TERMP-CADR-FROM-PSEUDO-TERM-LISTP))
 (3425 93 (:DEFINITION PSEUDO-TERM-LISTP))
 (2845 372 (:REWRITE PSEUDO-TERMP-LIST-CDR))
...
(IFL-EV-META-EXTRACT-FUNCTION-FORMALS/BODY
 (4850 80 (:DEFINITION PSEUDO-TERM-LISTP))
 (4614 48 (:DEFINITION PSEUDO-TERMP))
 (4310 130 (:REWRITE PSEUDO-TERMP-CADR-FROM-PSEUDO-TERM-LISTP))
 (4124 302 (:REWRITE PSEUDO-TERM-LISTP-CDR))
 (3358 302 (:REWRITE PSEUDO-TERMP-LIST-CDR))
 (2700 138 (:REWRITE PSEUDO-TERMP-CAR))
 (1888 258 (:REWRITE PSEUDO-TERMP-OPENER))
 (1184 1184 (:TYPE-PRESCRIPTION PSEUDO-TERM-LISTP))
 (956 94 (:DEFINITION LENGTH))
 (916 871 (:REWRITE DEFAULT-CAR))
 (887 887 (:REWRITE DEFAULT-CDR))
 (790 146 (:DEFINITION LEN))
...
(META-EXTRACT-FUNCTION-FORMALS/BODY-WELL-FORMED
 (1749 20 (:DEFINITION PSEUDO-TERM-LISTP))
 (1746 12 (:DEFINITION PSEUDO-TERMP))
 (1506 39 (:REWRITE PSEUDO-TERMP-CADR-FROM-PSEUDO-TERM-LISTP))
 (1431 88 (:REWRITE PSEUDO-TERM-LISTP-CDR))
 (1186 88 (:REWRITE PSEUDO-TERMP-LIST-CDR))
 (917 41 (:REWRITE PSEUDO-TERMP-CAR))
 (658 77 (:REWRITE PSEUDO-TERMP-OPENER))
 (358 36 (:DEFINITION LENGTH))
...
(INTERP-FUNCTION-LOOKUP-DEFS-ALISTP
 (19053 776 (:REWRITE PSEUDO-TERMP-CAR))
 (18223 464 (:REWRITE PSEUDO-TERMP-CADR-FROM-PSEUDO-TERM-LISTP))
 (15581 279 (:DEFINITION PSEUDO-TERM-LISTP))
 (11069 1202 (:REWRITE PSEUDO-TERMP-LIST-CDR))
 (7309 3611 (:REWRITE DEFAULT-CDR))
 (7062 3298 (:REWRITE DEFAULT-CAR))
 (5415 573 (:DEFINITION LEN))
 (5336 1130 (:REWRITE PSEUDO-TERMP-OPENER))
...
(INTERP-FUNCTION-LOOKUP-DEFS-ALISTP-MEANS-IN-DEFS-ALISTP
 (4501 188 (:REWRITE PSEUDO-TERMP-CAR))
 (3953 123 (:REWRITE PSEUDO-TERMP-CADR-FROM-PSEUDO-TERM-LISTP))
 (3273 74 (:DEFINITION PSEUDO-TERM-LISTP))
 (2520 297 (:REWRITE PSEUDO-TERMP-LIST-CDR))
 (1438 1438 (:TYPE-PRESCRIPTION PSEUDO-TERM-LISTP))
 (1024 189 (:DEFINITION LEN))
...
(INTERP-FUNCTION-LOOKUP-WFP
 (2042 12 (:DEFINITION PSEUDO-TERMP))
 (1754 76 (:REWRITE PSEUDO-TERM-LISTP-CDR))
 (1224 40 (:REWRITE PSEUDO-TERMP-CAR))
 (1222 32 (:REWRITE PSEUDO-TERMP-CADR-FROM-PSEUDO-TERM-LISTP))
 (548 76 (:REWRITE PSEUDO-TERMP-LIST-CDR))
 (532 16 (:DEFINITION PSEUDO-TERM-LISTP))
 (474 36 (:DEFINITION LENGTH))
 (390 62 (:DEFINITION LEN))
 (368 368 (:TYPE-PRESCRIPTION PSEUDO-TERM-LISTP))
 (368 350 (:REWRITE DEFAULT-CAR))
 (319 307 (:REWRITE DEFAULT-CDR))
...
(INTERP-DEFS-ALIST-CLAUSES
 ...
 (337 24 (:REWRITE PSEUDO-TERM-LISTP-CDR))
 (313 15 (:REWRITE PSEUDO-TERMP-CAR))
...
(INTERP-FUNCTION-LOOKUP-THEOREMP-DEFS-HISTORY
 (2910 19 (:DEFINITION PSEUDO-TERMP))
 (2353 105 (:REWRITE PSEUDO-TERM-LISTP-CDR))
 (1877 50 (:REWRITE PSEUDO-TERMP-CADR-FROM-PSEUDO-TERM-LISTP))
 (1789 62 (:REWRITE PSEUDO-TERMP-CAR))
 (1327 24 (:DEFINITION PSEUDO-TERM-LISTP))
 (1035 105 (:REWRITE PSEUDO-TERMP-LIST-CDR))
 (675 57 (:DEFINITION LENGTH))
 (635 635 (:REWRITE DEFAULT-CAR))
 (546 96 (:DEFINITION LEN))
