...
(HONS-ASSOC-EQUAL-AL-SHRINK
 (12 1 (:DEFINITION FAST-ALIST-FORK))
...
(MAKE-FAL-ALIST-EQUIV-APPEND
 (14 1 (:DEFINITION MAKE-FAL))
...
(ALIST-KEYS-HONS-PUT-LIST
 ...
 (100 58 (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV))
