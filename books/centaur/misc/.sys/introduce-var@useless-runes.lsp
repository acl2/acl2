...
(FLAG-LEMMA-FOR-BETA-REDUCE-INTRODUCE-VARS-CORRECT
 (1157 42 (:REWRITE PSEUDO-TERMP-CADR-FROM-PSEUDO-TERM-LISTP))
...
(FLAG-LEMMA-FOR-PSEUDO-TERMP-BETA-REDUCE-INTRODUCE-VARS
 (1304 47 (:REWRITE PSEUDO-TERMP-CADR-FROM-PSEUDO-TERM-LISTP))
...
(EVAL-DISJOIN-OF-BETA-REDUCE-INTRODUCE-VARS-LIST
 (1219 5 (:DEFINITION PSEUDO-TERMP))
 (888 42 (:REWRITE PSEUDO-TERM-LISTP-CDR))
