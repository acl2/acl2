...
(INTERP-FUNCTION-LOOKUP-DEFS-ALISTP
     (20957 807 (:REWRITE PSEUDO-TERMP-CAR))
     (20292 478
            (:REWRITE PSEUDO-TERMP-CADR-FROM-PSEUDO-TERM-LISTP))
     (16364 279 (:DEFINITION PSEUDO-TERM-LISTP))
     (11805 1264 (:REWRITE PSEUDO-TERMP-LIST-CDR))
     (7757 3939 (:REWRITE DEFAULT-CDR))
     (7380 3490 (:REWRITE DEFAULT-CAR))
     (5531 1175 (:REWRITE PSEUDO-TERMP-OPENER))
     (5110 257 (:DEFINITION TRUE-LISTP))
     (5030 514 (:DEFINITION LEN))
     (3172 514
           (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
     (1877 1877
           (:REWRITE PSEUDO-TERM-LISTP-OF-ATOM))
     (1876 1876
           (:REWRITE TERM-LISTP-IMPLIES-PSEUDO-TERM-LISTP))
     (1578 91 (:DEFINITION MEMBER-EQUAL))
...
(INTERP-FUNCTION-LOOKUP-THEOREMP-DEFS-HISTORY
     ...
     (170 5 (:DEFINITION NO-DUPLICATESP-EQUAL))
     (159 159
          (:REWRITE TERM-LISTP-IMPLIES-PSEUDO-TERM-LISTP))
     (159 159
          (:REWRITE PSEUDO-TERM-LISTP-OF-ATOM))
...
(INTERP-FUNCTION-LOOKUP-CORRECT-1
     ...
     (390 30 (:DEFINITION MEMBER-EQUAL))
...
(IFL-EV-LST-PAIRLIS (277 12 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
                    ...
                    (179 11 (:DEFINITION MEMBER-EQUAL))
