...
(SVL::RP-STATEP-OF-NOT-SIMPLIFIED-ACTION
 ...
 (512 8 (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
 (495 8 (:DEFINITION QUOTEP))
 ...
 (129 4 (:REWRITE RP::INTEGERP-OF-*RW-BACKCHAIN-LIMIT*))
 (127 7 (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-1))
 (125 3 (:REWRITE RP::BOOLEANP-OF-RW-CONTEXT-DISABLED))
...
(SVL::RW-SVL-RUN-TO-SVEX-ALIST-FN
 (90619 6 (:REWRITE RP::RP-TERM-LISTP-IS-TRUE-LISTP))
 (90617 2 (:DEFINITION TRUE-LISTP))
 (90283 6 (:DEFINITION APPLY$-BADGEP))
 (90279 49 (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
 (78524 2 (:DEFINITION SUBSETP-EQUAL))
 (78494 28 (:DEFINITION MEMBER-EQUAL))
 (72666 23 (:DEFINITION RP::RP-RW))
 (65956 23 (:DEFINITION RP::RP-EX-COUNTERPART))
 (52322 14 (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-1))
 (41089 185 (:REWRITE INTEGERP-OF-CAR-WHEN-INTEGER-LISTP))
 (40261 50 (:REWRITE INTEGER-LISTP-OF-CDR-WHEN-INTEGER-LISTP))
 (34036 10914 (:DEFINITION NTH))
 (26462 73 (:REWRITE NATP-OF-CAR-WHEN-NAT-LISTP))
 (24248 112 (:REWRITE ZP-OPEN))
 (24082 34 (:REWRITE NAT-LISTP-OF-CDR-WHEN-NAT-LISTP))
 (20241 89 (:DEFINITION RP::RP-RW-SUBTERMS))
 (19604 13500 (:REWRITE DEFAULT-CDR))
 (12250 294 (:REWRITE DEFAULT-<-2))
 (11956 112 (:REWRITE SVL::INTEGERP-IMPLIES-ACL2-NUMBERP))
 (10914 10914 (:REWRITE-QUOTED-CONSTANT NFIX-UNDER-NAT-EQUIV))
 (10914 10914 (:REWRITE-QUOTED-CONSTANT IFIX-UNDER-INT-EQUIV))
 (10914 10914 (:REWRITE NTH-WHEN-PREFIXP))
 (4680 73 (:REWRITE NATP-WHEN-GTE-0))
 (3800 3800 (:REWRITE DEFAULT-CAR))
 (3673 358 (:REWRITE SYMBOLP-OF-CAR-WHEN-SYMBOL-LISTP))
 (2778 183 (:DEFINITION SYMBOL-LISTP))
 (2388 48 (:DEFINITION NAT-LISTP))
 ...
 (326 37 (:REWRITE RP::RP-TERMP-IMPLIES-CDR-LISTP))
 ...
 (124 3 (:REWRITE RP::BOOLEANP-OF-RW-CONTEXT-DISABLED))
