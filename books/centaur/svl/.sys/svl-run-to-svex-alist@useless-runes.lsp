...
(SVL::RP-STATEP-OF-NOT-SIMPLIFIED-ACTION
 ...
 (237 4 (:REWRITE RP::INTEGERP-OF-*RW-BACKCHAIN-LIMIT*))
 (235 235 (:REWRITE DEFAULT-CDR))
 (233 3 (:REWRITE RP::BOOLEANP-OF-RW-CONTEXT-DISABLED))
 (211 1 (:DEFINITION SUBSETP-EQUAL))
 (196 14 (:DEFINITION MEMBER-EQUAL))
 (142 71 (:DEFINITION NTH))
...
(SVL::RW-SVL-RUN-TO-SVEX-ALIST-FN
 (97039 6 (:REWRITE RP::RP-TERM-LISTP-IS-TRUE-LISTP))
 (97033 2 (:DEFINITION TRUE-LISTP))
 (96703 6 (:DEFINITION APPLY$-BADGEP))
 (96699 49 (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
 (83780 2 (:DEFINITION SUBSETP-EQUAL))
 (83750 28 (:DEFINITION MEMBER-EQUAL))
 (74390 23 (:DEFINITION RP::RP-RW))
 (66278 23 (:DEFINITION RP::RP-EX-COUNTERPART))
 (55826 14 (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-1))
 (41673 185 (:REWRITE INTEGERP-OF-CAR-WHEN-INTEGER-LISTP))
 (40845 50 (:REWRITE INTEGER-LISTP-OF-CDR-WHEN-INTEGER-LISTP))
 (35482 11637 (:DEFINITION NTH))
 (30840 112 (:REWRITE ZP-OPEN))
 (27338 73 (:REWRITE NATP-OF-CAR-WHEN-NAT-LISTP))
 (25385 89 (:DEFINITION RP::RP-RW-SUBTERMS))
 (24666 34 (:REWRITE NAT-LISTP-OF-CDR-WHEN-NAT-LISTP))
 (20934 14830 (:REWRITE DEFAULT-CDR))
 (15546 294 (:REWRITE DEFAULT-<-2))
 (15252 112 (:REWRITE SVL::INTEGERP-IMPLIES-ACL2-NUMBERP))
 (11637 11637 (:REWRITE NTH-WHEN-PREFIXP))
 (11623 11623 (:REWRITE-QUOTED-CONSTANT NFIX-UNDER-NAT-EQUIV))
 (11623 11623 (:REWRITE-QUOTED-CONSTANT IFIX-UNDER-INT-EQUIV))
 (5264 73 (:REWRITE NATP-WHEN-GTE-0))
 (3908 3908 (:REWRITE DEFAULT-CAR))
 (3739 360 (:REWRITE SYMBOLP-OF-CAR-WHEN-SYMBOL-LISTP))
 (2839 184 (:DEFINITION SYMBOL-LISTP))
 (2680 48 (:DEFINITION NAT-LISTP))
 (2516 2034 (:REWRITE DEFAULT-+-2))
 (2034 2034 (:REWRITE DEFAULT-+-1))
 (1496 162 (:DEFINITION RP::UNQUOTE-ALL))
 (1332 666 (:TYPE-PRESCRIPTION SVL::INTEGERP-OF-SVEX-EXTN-LISTP-IS-ALIST-P))
 (1032 172 (:DEFINITION ASSOC-EQUAL))
 (857 857 (:META RP::BINARY-OR**/AND**-GUARD-META-CORRECT))
 (698 92 (:DEFINITION INTEGER-LISTP))
 (472 472 (:REWRITE LEN-MEMBER-EQUAL-LOOP$-AS))
 (467 467 (:REWRITE RP::RP-STATE-PRESERVEDP-IMPLIES-ALISTP))
 (465 91 (:REWRITE RP::IS-IF-RP-TERMP))
 ...
 (338 48 (:REWRITE RP::RP-TERMP-CADR))
 ...
 (232 3 (:REWRITE RP::BOOLEANP-OF-RW-CONTEXT-DISABLED))
 (204 204 (:TYPE-PRESCRIPTION RP::EX-FROM-SYNP))
 ...
 (161 161 (:REWRITE EXPEV-META-EXTRACT-FNCALL))
 (161 161 (:REWRITE EVMETA-EV-META-EXTRACT-FNCALL))
