...
(SVL::SVEX-ENV-LOOKUP-IS-SVEX-ENV-FASTLOOKUP-WOG
 (4151 19 (:REWRITE APPLY$-BADGEP-PROPERTIES . 1))
...
(SVL::SVEX-APPLY-IS-SVEX-APPLY-WOG
 (4859 430 (:REWRITE SV::4VECLIST-FIX-WHEN-4VECLIST-P))
 (2289 406 (:REWRITE SV::4VECLIST-P-OF-CDR-WHEN-4VECLIST-P))
 (2129 1443 (:REWRITE DEFAULT-CDR))
 (1562 1562 (:REWRITE SV::4VECLIST-P-WHEN-SUBSETP-EQUAL))
 (964 964 (:REWRITE DEFAULT-CAR))
 (934 312 (:REWRITE SV::FNSYM-FIX-WHEN-FNSYM-P))
 (806 806 (:REWRITE NTH-WHEN-PREFIXP))
 (781 781 (:REWRITE SV::4VECLIST-P-WHEN-NOT-CONSP))
 (622 622 (:TYPE-PRESCRIPTION SV::FNSYM-P))
 (545 545 (:REWRITE-QUOTED-CONSTANT SV::MAYBE-4VEC-FIX-UNDER-MAYBE-4VEC-EQUIV))
