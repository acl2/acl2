...
(NREV::MAP-SPEC)
(NREV::MAP-TR)
(NREV::MAP-TR-CORRECT (86 5 (:REWRITE REV-UNDER-IFF))
...
(NREV::MAP-TRADITIONAL (6 1 (:REWRITE REV-WHEN-NOT-CONSP))
                       (3 1
                          (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP)))
(NREV::MAP-IMPL)
(NREV::MAP-IMPL-CORRECT (88 4 (:REWRITE LIST-FIX-WHEN-LEN-ZERO))
                        (56 28
                            (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
