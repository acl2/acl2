...
(SV::BOOTHPIPE-CORRECT-GEN
 (927 2 (:REWRITE SV::SVARLIST-NONOVERRIDE-P-WHEN-SVARLIST-ADDR-P))
 (834 1 (:REWRITE SV::SVARLIST-ADDR-P-BY-BADGUY))
 (461 1 (:DEFINITION MEMBER-EQUAL))
 (260 2 (:REWRITE MEMBER-WHEN-ATOM))
 (189 1 (:REWRITE SV::SVARLIST-FIX-WHEN-SVARLIST-P))
