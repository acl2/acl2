...
(SV::BOOTHPIPE-CORRECT-GEN
 (1020 2 (:REWRITE SV::SVARLIST-NONOVERRIDE-P-WHEN-SVARLIST-ADDR-P))
 (927 1 (:REWRITE SV::SVARLIST-ADDR-P-BY-BADGUY))
 (461 1 (:DEFINITION MEMBER-EQUAL))
 (282 1 (:REWRITE SV::SVARLIST-FIX-WHEN-SVARLIST-P))
 (260 2 (:REWRITE MEMBER-WHEN-ATOM))
 (189 2 (:REWRITE SV::SVARLIST-P-WHEN-SUBSETP-EQUAL))
 (174 4 (:REWRITE SV::CONSP-OF-SVARLIST-FIX))
 (150 12 (:REWRITE SV::OUR-LOGEXT-IDENTITY))
 (114 10 (:DEFINITION SIGNED-BYTE-P))
 (104 10 (:DEFINITION INTEGER-RANGE-P))
 (89 2 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
 (88 2 (:REWRITE SUBSETP-WHEN-ATOM-LEFT))
 (87 1 (:REWRITE SV::SVARLIST-P-WHEN-NOT-CONSP))
 (87 1 (:REWRITE SV::SVARLIST-ADDR-P-WHEN-NOT-CONSP))
 ...
 (17 17 (:TYPE-PRESCRIPTION SV::SVEX-ENVLIST-ALL-KEYS))
 ...
 (3 3 (:TYPE-PRESCRIPTION SV::BOOTHPIPE-RUN-OVERRIDEKEYS))
 ...
 (1 1 (:TYPE-PRESCRIPTION SV::BOOTHPIPE-RUN-INPUT-VARS))
 ...
 (1 1 (:REWRITE SV::SVARLIST-P-OF-BOOTHPIPE-RUN-OVERRIDEKEYS))
 (1 1 (:REWRITE SV::SVARLIST-P-OF-BOOTHPIPE-RUN-INPUT-VARS))
...
(SV::BOOTHPIPE-CORRECT-SVTV
 (26 4 (:REWRITE TRUTH::UNSIGNED-BYTE-P-WHEN-TRUTH-IDX-P))
 (20 2 (:REWRITE TRUTH::TRUTH-IDX-P-WHEN-UNSIGNED-BYTE-P))
 (16 4 (:REWRITE SV::OUR-LOGEXT-IDENTITY))
 (12 4 (:REWRITE TRUTH::UNSIGNED-BYTE-P-WHEN-TRUTH4-P))
 (8 2 (:DEFINITION SIGNED-BYTE-P))
 (6 6 (:TYPE-PRESCRIPTION TRUTH::TRUTH-IDX-P))
 ...
 (1 1 (:REWRITE-QUOTED-CONSTANT SV::MAYBE-SVAR-P-FIX-UNDER-MAYBE-SVAR-P-EQUIV))
