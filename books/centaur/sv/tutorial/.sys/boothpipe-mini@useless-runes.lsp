...
(SV::BOOTHPIPE-CORRECT-GEN
 (392 4 (:REWRITE SV::SVTV-OVERRIDE-TRIPLEMAPLIST-ENVS-MATCH-RELEVANT-VARS-TEST-ONLY))
 (382 6 (:REWRITE SV::SVEX-ENV-REDUCE-WHEN-ALIST-KEYS-EQUAL))
 (178 2 (:REWRITE SV::SVEX-ENV-FIX-WHEN-SVEX-ENV-P))
 (178 2 (:REWRITE ALIST-KEYS-WHEN-ATOM))
 (172 2 (:REWRITE SV::SVEX-ENV-P-WHEN-NOT-CONSP))
 ...
 (8 4 (:REWRITE SV::SVTV-OVERRIDE-TRIPLEMAPLIST-ENVS-MATCH-RELEVANT-VARS))
