...
(SV::FLAG-LEMMA-FOR-RETURN-TYPE-OF-SVEX-XEVAL.VAL
     ...
     (190 21 (:DEFINITION MEMBER-EQUAL))
     (172 48
...
(SV::SVEX-XEVAL
 ...
 (623 623
      (:REWRITE SV::SVEX-APPLY-OF-4VECLIST-FIX-ARGS-NORMALIZE-CONST))
 (616 499 (:REWRITE DEFAULT-CAR))
 (534 88
      (:REWRITE SV::4VEC->LOWER-WHEN-2VEC-P))
 (473 238 (:REWRITE DEFAULT-+-2))
...
(SV::FLAG-LEMMA-FOR-SVEX-XEVAL-OF-SVEX-FIX-EXPR
 (82 7 (:REWRITE SV::SVEX-FIX-WHEN-SVEX-P))
 (35 7
     (:REWRITE SV::SVEX-P-WHEN-MAYBE-SVEX-P))
 (28 28
     (:REWRITE SV::SVEX-KIND$INLINE-OF-SVEX-FIX-X-NORMALIZE-CONST))
