...
(SV::SVEX-LOOKUP-UNDER-IFF
 (96 2 (:DEFINITION SV::SVEX-ALIST-KEYS))
...
(SV::SVEX-ALIST-EVAL-EQUIV!!-IMPLIES-SVEX-EVAL-EQUIV-SVEX-LOOKUP-2
 (6082 503 (:REWRITE SV::SVAR-P-OF-CAR-WHEN-SVARLIST-P))
 (4596 503 (:REWRITE SV::SVAR-P-OF-CAAR-WHEN-SVEX-ALIST-P))
 (4596 503 (:REWRITE SV::SVAR-P-OF-CAAR-WHEN-SVAR-MAP-P))
 (4596 503 (:REWRITE SV::SVAR-P-OF-CAAR-WHEN-SVAR-ALIST-P))
 (3064 503 (:REWRITE SV::SVARLIST-P-OF-CAR-WHEN-SVARLIST-LIST-P))
 (3064 503 (:REWRITE SV::SVAR-P-OF-CAAR-WHEN-SVEX-ENV-P))
 (3064 503 (:REWRITE SV::SVAR-P-OF-CAAR-WHEN-SVAR-BOOLMASKS-P))
 (1980 1980 (:REWRITE SV::SVEX-ALIST-P-WHEN-SUBSETP-EQUAL))
 (1866 311 (:REWRITE SV::SVEX-ALIST-P-OF-CDR-WHEN-SVEX-ALIST-P))
 (1672 106 (:REWRITE SV::SVEX-FIX-WHEN-SVEX-P))
 (1600 1600 (:REWRITE SV::SVAR-P-WHEN-MEMBER-EQUAL-OF-SVARLIST-P))
 (1578 263 (:REWRITE SV::SVAR-MAP-P-OF-CDR-WHEN-SVAR-MAP-P))
 (1578 263 (:REWRITE SV::SVAR-ALIST-P-OF-CDR-WHEN-SVAR-ALIST-P))
 (1532 1532 (:REWRITE SV::SVAR-MAP-P-WHEN-SUBSETP-EQUAL))
 (1532 1532 (:REWRITE SV::SVAR-ALIST-P-WHEN-SUBSETP-EQUAL))
 (1052 263 (:REWRITE SV::SVEX-ENV-P-OF-CDR-WHEN-SVEX-ENV-P))
 (1052 263 (:REWRITE SV::SVARLIST-LIST-P-OF-CDR-WHEN-SVARLIST-LIST-P))
 (1052 263 (:REWRITE SV::SVAR-BOOLMASKS-P-OF-CDR-WHEN-SVAR-BOOLMASKS-P))
 (1006 1006 (:REWRITE SV::SVARLIST-P-WHEN-SUBSETP-EQUAL))
 (1006 998 (:REWRITE SV::SVEX-ALIST-P-WHEN-NOT-CONSP))
 (766 766 (:REWRITE SV::SVEX-ENV-P-WHEN-NOT-CONSP))
 (766 766 (:REWRITE SV::SVARLIST-LIST-P-WHEN-NOT-CONSP))
 (766 766 (:REWRITE SV::SVAR-MAP-P-WHEN-NOT-CONSP))
 (766 766 (:REWRITE SV::SVAR-BOOLMASKS-P-WHEN-NOT-CONSP))
 (766 766 (:REWRITE SV::SVAR-ALIST-P-WHEN-NOT-CONSP))
 (764 116 (:REWRITE SV::SVEX-ALIST-FIX-WHEN-SVEX-ALIST-P))
 (760 220 (:REWRITE SV::SVAR-FIX-WHEN-SVAR-P))
 (530 106 (:REWRITE SV::SVEX-P-WHEN-MAYBE-SVEX-P))
 (503 503 (:REWRITE SV::SVARLIST-P-WHEN-NOT-CONSP))
 (456 51 (:REWRITE SV::SVEX-P-OF-CDR-OF-HONS-ASSOC-EQUAL-WHEN-SVEX-ALIST-P))
 (318 318 (:TYPE-PRESCRIPTION SV::SVEX-P))
 (241 241 (:REWRITE-QUOTED-CONSTANT SV::SVEXLIST-FIX-UNDER-SVEXLIST-EQUIV))
 (212 212 (:TYPE-PRESCRIPTION SV::MAYBE-SVEX-P))
 (212 212 (:REWRITE SV::SVEX-P-WHEN-MEMBER-EQUAL-OF-SVEXLIST-P))
 (212 106 (:REWRITE SV::MAYBE-SVEX-P-WHEN-SVEX-P))
...
(SV::SVEX-ALIST-EVAL-EQUIV!!-IMPLIES-EQUAL-SVEX-ALIST-KEYS-1)
(SV::SVEX-ALIST-EVAL-EQUIV!!-IMPLIES-SVEXLIST-EVAL-EQUIV-SVEX-ALIST-VALS-1)
...
(SV::SVEX-ALIST-EVAL-EQUIV!!-IMPLIES-EQUAL-SVEX-ALIST-EVAL-1
...
(SV::SVEX-ENVLISTS-EQUIVALENT-REDEF
...
(SV::SVEX-ALIST-KEYS-IS-ALIST-KEYS-OF-SVEX-ALIST-FIX
 (248 95 (:REWRITE DEFAULT-CAR))
 (140 14 (:REWRITE SV::SVAR-P-OF-CAR-WHEN-SVARLIST-P))
 (132 17 (:REWRITE SV::SVEX-ALIST-FIX-WHEN-SVEX-ALIST-P))
 (112 7 (:REWRITE SV::SVEX-FIX-WHEN-SVEX-P))
...
(SV::SET-EQUIV-FORWARD-TO-SVEX-ALIST-KEYS-EQUIV)
...
(SV::SVEX-ALIST-KEYS-EQUIV-LOOKUP-WITNESS)
(SV::SVAR-P-OF-SVEX-ALIST-KEYS-EQUIV-LOOKUP-WITNESS)
(SV::SVEX-ALIST-KEYS-EQUIV-IN-TERMS-OF-LOOKUP
 ...
 (11 11 (:REWRITE SV::SVEX-ALIST-KEYS-NOT-SET-EQUIV-BY-SVEX-LOOKUP-2))
 (11 11 (:REWRITE SV::SVEX-ALIST-KEYS-NOT-SET-EQUIV-BY-SVEX-LOOKUP-1))
 (8 8 (:REWRITE SV::REWRITE-MEMBER-OF-APPEND-UNDER-SET-EQUIV))
 (8 8 (:REWRITE DEFAULT-CDR))
 (8 8 (:REWRITE DEFAULT-CAR))
 )
(SV::SVEX-ALIST-KEYS-EQUIV-IMPLIES-SET-EQUIV-SVEX-ALIST-KEYS-1)
