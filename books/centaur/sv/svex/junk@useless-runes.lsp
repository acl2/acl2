...
(SV::CONS-OF-SVEX-FIX-K-UNDER-SVEX-MEMOTABLE-EQUIV
     ...
     (3 3
        (:REWRITE SV::SVEX-MEMOTABLE-P-WHEN-NOT-CONSP)))
(SV::CONS-OF-SVEX-FIX-K-NORMALIZE-CONST-UNDER-SVEX-MEMOTABLE-EQUIV)
...
(SV::CONS-OF-4VEC-FIX-V-UNDER-SVEX-MEMOTABLE-EQUIV
 ...
 (2 2
    (:REWRITE
         SV::CONS-OF-SVEX-FIX-K-NORMALIZE-CONST-UNDER-SVEX-MEMOTABLE-EQUIV)))
(SV::CONS-OF-4VEC-FIX-V-NORMALIZE-CONST-UNDER-SVEX-MEMOTABLE-EQUIV)
...
(SV::CONS-OF-SVEX-MEMOTABLE-FIX-Y-UNDER-SVEX-MEMOTABLE-EQUIV
     ...
     (4 4
        (:REWRITE SV::SVEX-MEMOTABLE-P-WHEN-NOT-CONSP)))
(SV::CONS-OF-SVEX-MEMOTABLE-FIX-Y-NORMALIZE-CONST-UNDER-SVEX-MEMOTABLE-EQUIV)
...
(SV::SVEX-EVAL-MEMO-OF-SVEX-FIX-X-NORMALIZE-CONST)
(SV::SVEX-EVAL-MEMO-SVEX-EQUIV-CONGRUENCE-ON-X)
(SV::SVEX-EVAL-MEMO-OF-SVEX-ENV-FIX-ENV-NORMALIZE-CONST)
(SV::SVEX-EVAL-MEMO-SVEX-ENV-EQUIV-CONGRUENCE-ON-ENV)
(SV::SVEX-EVAL-MEMO-OF-SVEX-MEMOTABLE-FIX-MEMO-NORMALIZE-CONST)
(SV::SVEX-EVAL-MEMO-SVEX-MEMOTABLE-EQUIV-CONGRUENCE-ON-MEMO)
(SV::SVEXLIST-EVAL-MEMO-OF-SVEXLIST-FIX-X-NORMALIZE-CONST)
(SV::SVEXLIST-EVAL-MEMO-SVEXLIST-EQUIV-CONGRUENCE-ON-X)
(SV::SVEXLIST-EVAL-MEMO-OF-SVEX-ENV-FIX-ENV-NORMALIZE-CONST)
(SV::SVEXLIST-EVAL-MEMO-SVEX-ENV-EQUIV-CONGRUENCE-ON-ENV)
(SV::SVEXLIST-EVAL-MEMO-OF-SVEX-MEMOTABLE-FIX-MEMO-NORMALIZE-CONST)
(SV::SVEXLIST-EVAL-MEMO-SVEX-MEMOTABLE-EQUIV-CONGRUENCE-ON-MEMO)
(SV::SVEX-EVAL-MEMO
 (43 11
     (:REWRITE SV::SVEX-P-WHEN-MAYBE-SVEX-P))
 (39 1 (:DEFINITION SV::SVEX-EVAL-MEMO))
 (32 6
     (:REWRITE SV::SVEXLIST-P-WHEN-SUBSETP-EQUAL))
 (23 9
     (:REWRITE SV::MAYBE-SVEX-P-WHEN-SVEX-P))
 ...
 (8 1 (:DEFINITION SV::SVEXLIST-EVAL-MEMO))
 (6 6
    (:REWRITE SV::SVEX-MEMOTABLE-P-WHEN-NOT-CONSP))
 (6 6
    (:REWRITE SV::SVEX-KIND$INLINE-OF-SVEX-FIX-X-NORMALIZE-CONST))
 ...
 (1 1
    (:REWRITE SV::SVEXLIST-EVAL-MEMO-OF-SVEXLIST-FIX-X-NORMALIZE-CONST))
 (1 1
    (:REWRITE
         SV::SVEXLIST-EVAL-MEMO-OF-SVEX-MEMOTABLE-FIX-MEMO-NORMALIZE-CONST))
 (1 1
    (:REWRITE SV::SVEXLIST-EVAL-MEMO-OF-SVEX-ENV-FIX-ENV-NORMALIZE-CONST))
 (1 1
    (:REWRITE SV::SVEX-QUOTE->VAL$INLINE-OF-SVEX-FIX-X-NORMALIZE-CONST))
 (1 1
    (:REWRITE SV::SVEX-EVAL-MEMO-OF-SVEX-MEMOTABLE-FIX-MEMO-NORMALIZE-CONST))
 (1 1
    (:REWRITE SV::SVEX-EVAL-MEMO-OF-SVEX-FIX-X-NORMALIZE-CONST))
 (1 1
    (:REWRITE SV::SVEX-EVAL-MEMO-OF-SVEX-ENV-FIX-ENV-NORMALIZE-CONST))
 (1 1
    (:REWRITE SV::SVEX-ENV-LOOKUP-OF-SVEX-ENV-FIX-ENV-NORMALIZE-CONST))
 (1 1
    (:REWRITE SV::SVEX-ENV-LOOKUP-OF-SVAR-FIX-VAR-NORMALIZE-CONST))
...
(SV::SVEX-EVAL-MEMOTABLE-OK-EXTEND
     (112 112
          (:TYPE-PRESCRIPTION SV::SVEX-KIND$INLINE))
     (103 19 (:REWRITE SV::SVEX-EVAL-WHEN-QUOTE))
     (89 19 (:REWRITE SV::SVEX-EVAL-WHEN-FNCALL))
