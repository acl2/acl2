...
(SV::SVEX-MULTIREFS-POSTORDER
     ...
     (30 1
         (:DEFINITION SV::SVEX-MULTIREFS-POSTORDER))
...
(SV::SVEX-MULTIREFS-POSTORDER-OF-SVEX-FIX-X-NORMALIZE-CONST)
(SV::SVEX-MULTIREFS-POSTORDER-SVEX-EQUIV-CONGRUENCE-ON-X)
(SV::SVEX-MULTIREFS-POSTORDER-OF-SVEX-KEY-ALIST-FIX-SEEN-NORMALIZE-CONST)
(SV::SVEX-MULTIREFS-POSTORDER-SVEX-KEY-ALIST-EQUIV-CONGRUENCE-ON-SEEN)
(SV::SVEX-MULTIREFS-POSTORDER-OF-SVEX-KEY-ALIST-FIX-MULTIREF-NORMALIZE-CONST)
(SV::SVEX-MULTIREFS-POSTORDER-SVEX-KEY-ALIST-EQUIV-CONGRUENCE-ON-MULTIREF)
(SV::SVEXLIST-MULTIREFS-POSTORDER-OF-SVEXLIST-FIX-X-NORMALIZE-CONST)
(SV::SVEXLIST-MULTIREFS-POSTORDER-SVEXLIST-EQUIV-CONGRUENCE-ON-X)
(SV::SVEXLIST-MULTIREFS-POSTORDER-OF-SVEX-KEY-ALIST-FIX-SEEN-NORMALIZE-CONST)
(SV::SVEXLIST-MULTIREFS-POSTORDER-SVEX-KEY-ALIST-EQUIV-CONGRUENCE-ON-SEEN)
(SV::SVEXLIST-MULTIREFS-POSTORDER-OF-SVEX-KEY-ALIST-FIX-MULTIREF-NORMALIZE-CONST)
...
(SV::SVEXLIST-P-OF-SVEX-KEY-ALIST-COLLECT-ORDERED
   ...
   (603 46
        (:REWRITE SV::SVEXLIST-P-WHEN-SUBSETP-EQUAL))
   (536 24 (:DEFINITION SUBSETP-EQUAL))
   (436 8
        (:REWRITE SV::SVEX-P-OF-CAR-WHEN-SVEXLIST-P))
   ...
   (1 1 (:REWRITE CDR-CONS))
   (1 1 (:REWRITE CAR-CONS)))
(SV::MAKE-N-SVARS (17 1 (:DEFINITION BINARY-APPEND))
                  (12 12
...
(SV::SVARLIST-P-OF-MAKE-N-SVARS
  ...
  (199 5 (:DEFINITION SUBSETP-EQUAL))
  (145 7 (:DEFINITION MEMBER-EQUAL))
  (75 3 (:REWRITE SV::EQUAL-OF-SVAR))
  (56 8
...
(SV::SVEXLIST-P-OF-SVARLIST->SVEXES
    (204 18
         (:REWRITE SV::SVEXLIST-P-WHEN-SUBSETP-EQUAL))
    (179 5 (:DEFINITION SUBSETP-EQUAL))
    (118 6 (:DEFINITION MEMBER-EQUAL))
    (70 2 (:REWRITE SV::EQUAL-OF-SVEX-VAR))
    (33 9
        (:REWRITE SV::SVEXLIST-P-WHEN-NOT-CONSP))
...
(SV::SVEX-SVEX-ALIST-P-OF-HONS-SHRINK-ALIST
     (56 10
         (:REWRITE SV::SVEX-SVEX-ALIST-P-OF-CDR-WHEN-SVEX-SVEX-ALIST-P))
     (16 16
         (:REWRITE SV::SVEX-SVEX-ALIST-P-WHEN-NOT-CONSP)))
...
(SV::SVEX-SVEX-ALIST-P-OF-SVEX-SVEX-ALIST-FIX
  ...
  (227 17
       (:REWRITE SV::SVEX-P-OF-CAAR-WHEN-SVEX-SVEX-ALIST-P))
  (174 12
       (:REWRITE SV::SVEX-SVEX-ALIST-P-OF-CDR-WHEN-SVEX-SVEX-ALIST-P))
  (102 16
       (:REWRITE SV::SVEX-P-WHEN-MAYBE-SVEX-P))
  (79 17
      (:REWRITE SV::SVEX-P-OF-CDAR-WHEN-SVEX-SVEX-ALIST-P))
...
(SV::CONS-OF-SVEX-FIX-K-UNDER-SVEX-SVEX-ALIST-EQUIV
     (27 4
         (:REWRITE SV::SVEX-SVEX-ALIST-FIX-WHEN-SVEX-SVEX-ALIST-P))
     (18 2
         (:REWRITE SV::SVEX-SVEX-ALIST-P-OF-CONS))
     (6 6
        (:TYPE-PRESCRIPTION SV::SVEX-SVEX-ALIST-P))
     (3 3
        (:REWRITE SV::SVEX-SVEX-ALIST-P-WHEN-NOT-CONSP)))
(SV::CONS-OF-SVEX-FIX-K-NORMALIZE-CONST-UNDER-SVEX-SVEX-ALIST-EQUIV)
...
(SV::CONS-OF-SVEX-FIX-V-UNDER-SVEX-SVEX-ALIST-EQUIV
 ...
 (2
   ...
   (:REWRITE
        SV::CONS-OF-SVEX-FIX-K-NORMALIZE-CONST-UNDER-SVEX-SVEX-ALIST-EQUIV)))
(SV::CONS-OF-SVEX-FIX-V-NORMALIZE-CONST-UNDER-SVEX-SVEX-ALIST-EQUIV)
...
(SV::CONS-OF-SVEX-SVEX-ALIST-FIX-Y-UNDER-SVEX-SVEX-ALIST-EQUIV
     ...
     (4 4
        (:REWRITE SV::SVEX-SVEX-ALIST-P-WHEN-NOT-CONSP)))
(SV::CONS-OF-SVEX-SVEX-ALIST-FIX-Y-NORMALIZE-CONST-UNDER-SVEX-SVEX-ALIST-EQUIV)
...
(SV::SVEX-SVEX-ALIST-FIX-OF-APPEND
 ...
 (60 6
     (:REWRITE SV::SVEX-SVEX-ALIST-P-OF-APPEND))
...
(SV::SVEX-REPLACE-SUBTERMS
 ...
 (9 3 (:REWRITE DEFAULT-<-1))
 (7 2
    (:REWRITE SV::CONSP-CAR-OF-SVEX-SVEX-ALIST-FIX))
 (6 6
    (:REWRITE SV::SVEX-COUNT-OF-SVEX-FIX-X-NORMALIZE-CONST))
 (5 1
    (:REWRITE SV::SVEX-P-WHEN-MAYBE-SVEX-P))
...
(SV::SVEX-REPLACE-SUBTERMS
     ...
     (6 6
        (:REWRITE SV::SVEX-SVEX-ALIST-P-WHEN-NOT-CONSP))
     (5 1
        (:DEFINITION SV::SVEXLIST-REPLACE-SUBTERMS))
     (4 4
        (:REWRITE SV::REWRITE-MEMBER-OF-APPEND-UNDER-SET-EQUIV))
     (3 3
        (:REWRITE SV::SVEXLIST-P-WHEN-NOT-CONSP))
...
(SV::CONSP-OF-SVEXLIST-REPLACE-SUBTERMS
     (55 1
         (:DEFINITION SV::SVEX-REPLACE-SUBTERMS))
     (19 3
         (:REWRITE SV::SVEXLIST-FIX-WHEN-SVEXLIST-P))
...
(SV::SVEX-ALIST-P-OF-SVEXLIST-LET*-ABSTRACT.ABS-ALIST
 ...
 (13 3
     (:REWRITE SV::SVEX-ALIST-P-WHEN-NOT-CONSP))
 (12 12
     (:TYPE-PRESCRIPTION SV::SVEX-KEY-ALIST-COLLECT-ORDERED))
 (12 12
...
(SV::SVEXLIST-P-OF-SVEXLIST-LET*-ABSTRACT.NEW-X
 ...
 (7
  ...
  (:REWRITE
   SV::SVEXLIST-MULTIREFS-POSTORDER-OF-SVEX-KEY-ALIST-FIX-MULTIREF-NORMALIZE-CONST))
 (6 6
    (:TYPE-PRESCRIPTION SV::SVEX-SUBST-ALIST-LET*-ABSTRACT))
 (6 3 (:REWRITE DEFAULT-+-2))
 (4 4 (:TYPE-PRESCRIPTION SV::MAKE-N-SVARS))
 (3 3 (:TYPE-PRESCRIPTION LEN))
 (3 3 (:REWRITE DEFAULT-+-1))
