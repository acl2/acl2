...
(SV::SVTV-NAMEMAP-P-OF-REMOVE-ASSOC
     ...
     (1 1
        (:TYPE-PRESCRIPTION SV::BOOLEANP-OF-STRINGP-FOR-SVTV-NAMEMAP-P-VAL)))
...
(SV::CONS-OF-STR-FIX-V-UNDER-SVTV-NAMEMAP-EQUIV
     ...
     (3 3
        (:REWRITE SV::SVTV-NAMEMAP-P-WHEN-NOT-CONSP)))
(SV::CONS-OF-STR-FIX-V-NORMALIZE-CONST-UNDER-SVTV-NAMEMAP-EQUIV)
...
(SV::CONS-OF-SVTV-NAMEMAP-FIX-Y-NORMALIZE-CONST-UNDER-SVTV-NAMEMAP-EQUIV)
...
(SV::SVTV-NAMEMAP-FIX-OF-ACONS
 ...
 (1
  1
  (:REWRITE SV::CONS-OF-STR-FIX-V-NORMALIZE-CONST-UNDER-SVTV-NAMEMAP-EQUIV)))
(SV::HONS-ASSOC-EQUAL-OF-SVTV-NAMEMAP-FIX
  ...
  (84 21
      (:REWRITE SV::STRINGP-OF-CDAR-WHEN-SVTV-NAMEMAP-P))
  (43 8
      (:REWRITE SV::STRINGP-OF-CDR-OF-HONS-ASSOC-EQUAL-WHEN-SVTV-NAMEMAP-P)))
(SV::SVTV-NAMEMAP-FIX-OF-APPEND
 (183 17
      (:REWRITE SV::SVTV-NAMEMAP-FIX-WHEN-SVTV-NAMEMAP-P))
 (85 5
     (:REWRITE SV::SVTV-NAMEMAP-P-OF-APPEND))
 (68 68
     (:TYPE-PRESCRIPTION SV::SVTV-NAMEMAP-P))
 (66 42
     (:REWRITE SV::SVTV-NAMEMAP-P-WHEN-NOT-CONSP))
 ...
 (33 5
     (:REWRITE SV::SVTV-NAMEMAP-P-OF-LIST-FIX))
...
(SV::CONS-OF-LHS-FIX-V-UNDER-SVTV-NAME-LHS-MAP-EQUIV
     ...
     (3 3
        (:REWRITE SV::SVTV-NAME-LHS-MAP-P-WHEN-NOT-CONSP)))
(SV::CONS-OF-LHS-FIX-V-NORMALIZE-CONST-UNDER-SVTV-NAME-LHS-MAP-EQUIV)
...
(SV::CONS-OF-SVTV-NAME-LHS-MAP-FIX-Y-UNDER-SVTV-NAME-LHS-MAP-EQUIV
     ...
     (2 2
        (:REWRITE SV::SVTV-NAME-LHS-MAP-P-WHEN-NOT-CONSP)))
(SV::CONS-OF-SVTV-NAME-LHS-MAP-FIX-Y-NORMALIZE-CONST-UNDER-SVTV-NAME-LHS-MAP-EQUIV)
...
(SV::SVTV-NAME-LHS-MAP-FIX-OF-APPEND
 (185 17
      (:REWRITE SV::SVTV-NAME-LHS-MAP-FIX-WHEN-SVTV-NAME-LHS-MAP-P))
 (85 5
     (:REWRITE SV::SVTV-NAME-LHS-MAP-P-OF-APPEND))
 (68 68
     (:TYPE-PRESCRIPTION SV::SVTV-NAME-LHS-MAP-P))
 (66 42
     (:REWRITE SV::SVTV-NAME-LHS-MAP-P-WHEN-NOT-CONSP))
 (38 1
     (:REWRITE SV::SVTV-NAME-LHS-MAP-P-OF-CONS))
 (33 5
     (:REWRITE SV::SVTV-NAME-LHS-MAP-P-OF-LIST-FIX))
 (27 27 (:TYPE-PRESCRIPTION TRUE-LIST-FIX))
...
(SV::SVAR-P-WHEN-LOOKUP
     ...
     (6 6
        (:REWRITE SV::LHSLIST-P-WHEN-NOT-CONSP)))
(SV::BASE-FSM-P (6 6 (:DEFINITION STRIP-CARS)))
...
(SV::BASE-FSM-P-OF-BASE-FSM-FIX
     ...
     (4 4
        (:REWRITE SV::SVEX-ALIST-P-WHEN-NOT-CONSP)))
(SV::BASE-FSM-FIX-WHEN-BASE-FSM-P (3 3 (:DEFINITION STRIP-CARS)))
(SV::BASE-FSM-FIX$INLINE (3 3 (:DEFINITION STRIP-CARS)))
(FTY::TMP-DEFFIXTYPE-IDEMPOTENT)
...
(SV::BASE-FSM->VALUES$INLINE (3 3 (:DEFINITION STRIP-CARS)))
...
(SV::BASE-FSM->VALUES$INLINE-OF-BASE-FSM-FIX-X-NORMALIZE-CONST)
(SV::BASE-FSM->VALUES$INLINE-BASE-FSM-EQUIV-CONGRUENCE-ON-X)
(SV::BASE-FSM->NEXTSTATE$INLINE (3 3 (:DEFINITION STRIP-CARS)))
...
(SV::SVTV-FSM-P-OF-SVTV-FSM-FIX
     ...
     (2 2
        (:REWRITE SV::SVTV-NAME-LHS-MAP-P-WHEN-NOT-CONSP)))
(SV::SVTV-FSM-FIX-WHEN-SVTV-FSM-P (3 3 (:DEFINITION STRIP-CARS)))
(SV::SVTV-FSM-FIX$INLINE (3 3 (:DEFINITION STRIP-CARS)))
(FTY::TMP-DEFFIXTYPE-IDEMPOTENT)
...
(SV::SVTV-FSM->BASE-FSM$INLINE (3 3 (:DEFINITION STRIP-CARS)))
...
(SV::SVTV-FSM->BASE-FSM$INLINE-OF-SVTV-FSM-FIX-X
     ...
     (2 2
        (:TYPE-PRESCRIPTION SV::SVTV-NAME-LHS-MAP-P)))
(SV::SVTV-FSM->BASE-FSM$INLINE-OF-SVTV-FSM-FIX-X-NORMALIZE-CONST)
(SV::SVTV-FSM->BASE-FSM$INLINE-SVTV-FSM-EQUIV-CONGRUENCE-ON-X)
(SV::SVTV-FSM->NAMEMAP$INLINE (3 3 (:DEFINITION STRIP-CARS)))
...
(SV::SVTV-FSM->NAMEMAP$INLINE-OF-SVTV-FSM-FIX-X
     ...
     (3 1
        (:REWRITE SV::BASE-FSM-FIX-WHEN-BASE-FSM-P))
     (2 2 (:TYPE-PRESCRIPTION SV::BASE-FSM-P)))
(SV::SVTV-FSM->NAMEMAP$INLINE-OF-SVTV-FSM-FIX-X-NORMALIZE-CONST)
...
(SV::SVTV-FSM-OF-BASE-FSM-FIX-BASE-FSM
     ...
     (2 2
        (:TYPE-PRESCRIPTION SV::SVTV-NAME-LHS-MAP-P)))
(SV::SVTV-FSM-OF-BASE-FSM-FIX-BASE-FSM-NORMALIZE-CONST)
(SV::SVTV-FSM-BASE-FSM-EQUIV-CONGRUENCE-ON-BASE-FSM)
(SV::SVTV-FSM-OF-SVTV-NAME-LHS-MAP-FIX-NAMEMAP
     (4 2
        (:REWRITE SV::BASE-FSM-FIX-WHEN-BASE-FSM-P))
     (2 2 (:TYPE-PRESCRIPTION SV::BASE-FSM-P)))
(SV::SVTV-FSM-OF-SVTV-NAME-LHS-MAP-FIX-NAMEMAP-NORMALIZE-CONST)
