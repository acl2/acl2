...
(SV::SVTV-NAMEMAP-FIX-WHEN-SVTV-NAMEMAP-P
 (247 28 (:REWRITE SV::SVTV-NAMEMAP-P-OF-CDR-WHEN-SVTV-NAMEMAP-P))
 (215 19 (:REWRITE SV::STRINGP-OF-CDAR-WHEN-SVTV-NAMEMAP-P))
...
(SV::SVTV-NAME-LHS-MAP-FIX-WHEN-SVTV-NAME-LHS-MAP-P
 (530 28 (:REWRITE SV::SVTV-NAME-LHS-MAP-P-OF-CDR-WHEN-SVTV-NAME-LHS-MAP-P))
 (411 15 (:REWRITE SV::LHS-P-OF-CDR-WHEN-LHS-P))
 (394 52 (:REWRITE SV::LHS-P-WHEN-SUBSETP-EQUAL))
 (377 31 (:REWRITE SV::LHS-P-OF-CDAR-WHEN-SVTV-NAME-LHS-MAP-P))
...
(SV::SVAR-P-WHEN-LOOKUP
 (237 10 (:REWRITE SV::SVAR-P-OF-CAAR-WHEN-SVTV-NAME-LHS-MAP-P))
 (182 8 (:REWRITE SV::LHS-P-OF-CDAR-WHEN-SVTV-NAME-LHS-MAP-P))
...
(FTY::TMP-DEFFIXTYPE-IDEMPOTENT)
(SV::FSM-EQUIV$INLINE)
(SV::FSM-EQUIV-IS-AN-EQUIVALENCE)
(SV::FSM-EQUIV-IMPLIES-EQUAL-FSM-FIX-1)
(SV::FSM-FIX-UNDER-FSM-EQUIV)
(SV::EQUAL-OF-FSM-FIX-1-FORWARD-TO-FSM-EQUIV)
(SV::EQUAL-OF-FSM-FIX-2-FORWARD-TO-FSM-EQUIV)
(SV::FSM-EQUIV-OF-FSM-FIX-1-FORWARD)
(SV::FSM-EQUIV-OF-FSM-FIX-2-FORWARD)
(SV::FSM->VALUES$INLINE
 (4 1 (:REWRITE FTY::PROVE-EQUAL-OF-CONS-WHEN-FIRST-QUOTEP))
 (1 1 (:DEFINITION STRIP-CARS))
 )
(SV::SVEX-ALIST-P-OF-FSM->VALUES)
(SV::FSM->VALUES$INLINE-OF-FSM-FIX-X
 (9 3 (:REWRITE SV::FSM-FIX-WHEN-FSM-P))
 (6 6 (:TYPE-PRESCRIPTION SV::FSM-P))
 )
(SV::FSM->VALUES$INLINE-FSM-EQUIV-CONGRUENCE-ON-X)
(SV::FSM->NEXTSTATE$INLINE
 (4 1 (:REWRITE FTY::PROVE-EQUAL-OF-CONS-WHEN-FIRST-QUOTEP))
 )
(SV::SVEX-ALIST-P-OF-FSM->NEXTSTATE)
(SV::FSM->NEXTSTATE$INLINE-OF-FSM-FIX-X
 (9 3 (:REWRITE SV::FSM-FIX-WHEN-FSM-P))
 (6 6 (:TYPE-PRESCRIPTION SV::FSM-P))
 )
(SV::FSM->NEXTSTATE$INLINE-FSM-EQUIV-CONGRUENCE-ON-X)
(SV::FSM)
(SV::FSM-P-OF-FSM
 (14 6 (:REWRITE SV::SVEX-ALIST-FIX-WHEN-SVEX-ALIST-P))
 (8 8 (:TYPE-PRESCRIPTION SV::SVEX-ALIST-P))
 )
(SV::FSM->VALUES-OF-FSM)
(SV::FSM->NEXTSTATE-OF-FSM)
(SV::FSM-OF-FIELDS
...
(SV::FSM-OF-SVEX-ALIST-FIX-VALUES)
(SV::FSM-SVEX-ALIST-EQUIV-CONGRUENCE-ON-VALUES)
(SV::FSM-OF-SVEX-ALIST-FIX-NEXTSTATE)
(SV::FSM-SVEX-ALIST-EQUIV-CONGRUENCE-ON-NEXTSTATE)
(SV::FSM-FIX-REDEF)
(SV::SVTV-FSM-P
 (40 10 (:REWRITE FTY::PROVE-EQUAL-OF-CONS-WHEN-FIRST-QUOTEP))
 (14 14 (:REWRITE DEFAULT-CAR))
...
(SV::SVTV-FSM->FSM$INLINE
 (4 1 (:REWRITE FTY::PROVE-EQUAL-OF-CONS-WHEN-FIRST-QUOTEP))
 (1 1 (:DEFINITION STRIP-CARS))
 )
(SV::FSM-P-OF-SVTV-FSM->FSM)
(SV::SVTV-FSM->FSM$INLINE-OF-SVTV-FSM-FIX-X
...
(SV::SVTV-FSM->FSM$INLINE-SVTV-FSM-EQUIV-CONGRUENCE-ON-X)
...
(SV::SVTV-FSM-P-OF-SVTV-FSM
 ...
 (6 2 (:REWRITE SV::FSM-FIX-WHEN-FSM-P))
 (4 4 (:TYPE-PRESCRIPTION SV::SVTV-NAME-LHS-MAP-P))
 (4 4 (:TYPE-PRESCRIPTION SV::FSM-P))
 )
(SV::SVTV-FSM->FSM-OF-SVTV-FSM)
...
(SV::SVTV-FSM-OF-FSM-FIX-FSM
 (4 2 (:REWRITE SV::SVTV-NAME-LHS-MAP-FIX-WHEN-SVTV-NAME-LHS-MAP-P))
 (2 2 (:TYPE-PRESCRIPTION SV::SVTV-NAME-LHS-MAP-P))
 )
(SV::SVTV-FSM-FSM-EQUIV-CONGRUENCE-ON-FSM)
