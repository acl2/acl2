...
(SV::BASE-FSM-FIX$INLINE
 (290 16 (:REWRITE SV::SVEX-ALIST-P-WHEN-SUBSETP-EQUAL))
 (262 12 (:DEFINITION SUBSETP-EQUAL))
 (232 4 (:REWRITE SV::SVEX-ALIST-P-OF-CDR-WHEN-SVEX-ALIST-P))
 ...
 (16 16 (:REWRITE FTY::OPEN-MEMBER-EQUAL-ON-LIST-OF-TAGS))
