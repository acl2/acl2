...
(SV::FSM-P-OF-FSM-REWRITE)
(SV::FSM-EVAL-EQUIV-OF-FSM-REWRITE
...
(SV::LEN-OF-SVEXLIST-NORMALIZE-CONCATS)
(SV::SVEXLIST-EVAL-EQUIV-OF-SVEXLIST-NORMALIZE-CONCATS
 (4 2 (:REWRITE SV::SVEXLIST-UNQUOTE-CORRECT))
 (2 2 (:TYPE-PRESCRIPTION SV::SVEXLIST-QUOTESP))
 (2 2 (:REWRITE SV::SVEXLIST-UNIFY-CORRECT))
 (2 2 (:REWRITE SV::SVEXLIST-EVAL-WHEN-ATOM-CHEAP))
 )
(SV::FSM-NORM-CONCATS-FN
 (206 2 (:DEFINITION TAKE))
 (197 2 (:DEFINITION PAIRLIS$))
 (159 23 (:DEFINITION LEN))
 (132 2 (:REWRITE TAKE-WHEN-PREFIXP))
 (131 35 (:REWRITE DEFAULT-CDR))
 (122 4 (:REWRITE TAKE-OF-LEN-FREE))
...
(SV::FSM-P-OF-FSM-NORM-CONCATS)
(SV::FSM-EVAL-EQUIV-OF-FSM-NORM-CONCATS
 (402 4 (:DEFINITION PAIRLIS$))
 (252 36 (:DEFINITION LEN))
 (236 56 (:REWRITE DEFAULT-CDR))
 (193 6 (:REWRITE TAKE-OF-LEN-FREE))
 ...
 (64 64 (:LINEAR LISTPOS-UPPER-BOUND-STRONG-2))
 (64 64 (:LINEAR LEN-WHEN-PREFIXP))
 (61 3 (:REWRITE PREFIXP-WHEN-PREFIXP))
 (60 6 (:DEFINITION BINARY-APPEND))
 (45 37 (:REWRITE DEFAULT-<-1))
 (39 12 (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV))
 (38 2 (:REWRITE CAR-OF-TAKE))
...
(SV::SVTV-DATA-REWRITE-PHASE-FSM-FN
 ...
 (8 8 (:REWRITE SV::SVTV-DATA$C->PHASE-FSM-OF-UPDATE))
 (7 7 (:REWRITE SV::SVTV-DATA$C->PHASE-FSM-VALIDP-OF-UPDATE))
 (6 6 (:REWRITE SV::SVTV-DATA$C->PHASE-FSM-SETUP-OF-UPDATE))
 (6 6 (:REWRITE SV::SVTV-DATA$C->FLATNORM-OF-UPDATE))
...
(SV::SVTV-DATA-CONCATNORM-PHASE-FSM-FN
 (8 8 (:REWRITE SV::SVTV-DATA$C->PHASE-FSM-OF-UPDATE))
 (7 7 (:REWRITE SV::SVTV-DATA$C->PHASE-FSM-VALIDP-OF-UPDATE))
 (6 6 (:REWRITE SV::SVTV-DATA$C->PHASE-FSM-SETUP-OF-UPDATE))
 (6 6 (:REWRITE SV::SVTV-DATA$C->FLATNORM-OF-UPDATE))
...
(SV::SVTV-DATA$C-GET-OF-SVTV-DATA-CONCATNORM-PHASE-FSM
 (3 1 (:REWRITE SV::SVTV-DATA$C-FIELD-FIX-IDEMPOTENT))
 (2 2 (:TYPE-PRESCRIPTION SV::SVTV-DATA$C-FIELD-P))
 (1 1 (:REWRITE SV::SVTV-DATA$C->PHASE-FSM-OF-UPDATE))
 )
...
(SV::SVTV-DATA-MAYBE-CONCATNORM-PHASE-FSM-FN)
(SV::SVTV-DATA$C-GET-OF-SVTV-DATA-MAYBE-CONCATNORM-PHASE-FSM
 (9 3 (:REWRITE SV::SVTV-DATA$C-FIELD-FIX-IDEMPOTENT))
 (6 6 (:TYPE-PRESCRIPTION SV::SVTV-DATA$C-FIELD-P))
 (3 3 (:TYPE-PRESCRIPTION SV::SVTV-DATA-MAYBE-CONCATNORM-PHASE-FSM-FN))
 )
...
(SV::SVTV-DATA-CONCATNORM-CYCLE-FSM-FN
 (5 5 (:REWRITE SV::SVTV-DATA$C->CYCLE-FSM-VALIDP-OF-UPDATE))
 (2 2 (:REWRITE SV::SVTV-DATA$C->PIPELINE-VALIDP-OF-UPDATE))
 (2 2 (:REWRITE SV::SVTV-DATA$C->CYCLE-FSM-OF-UPDATE))
 )
(SV::SVTV-DATA$C-GET-OF-SVTV-DATA-CONCATNORM-CYCLE-FSM
 (3 1 (:REWRITE SV::SVTV-DATA$C-FIELD-FIX-IDEMPOTENT))
 (2 2 (:TYPE-PRESCRIPTION SV::SVTV-DATA$C-FIELD-P))
 (1 1 (:REWRITE SV::SVTV-DATA$C->CYCLE-FSM-OF-UPDATE))
 )
...
(SV::EVAL-LOOKUP-OF-SVEX-ALIST-NORMALIZE-CONCATS
 (15 3 (:REWRITE SV::SVEX-EVAL-WHEN-FNCALL))
 (12 3 (:DEFINITION EQ))
 (7 7 (:REWRITE SV::SVEX-UNIFY-CORRECT))
 (3 3 (:REWRITE SV::SVEX-EVAL-OF-QUOTED))
...
(SV::SVEX-ALIST-NORMALIZE-CONCATS-UNDER-SVEX-ALIST-EVAL-EQUIV
 (8 8 (:TYPE-PRESCRIPTION SV::SVEX-KIND$INLINE))
 (7 2 (:REWRITE SV::SVEX-EVAL-WHEN-QUOTE))
 (6 2 (:REWRITE SV::SVEX-EVAL-WHEN-FNCALL))
 (4 1 (:DEFINITION EQ))
...
(SV::SVEX-ALIST-EVAL-EQUIV!-WHEN-SVEX-ALIST-EVAL-EQUIV-DOUBLE-REWRITE)
(SV::SVTV-DATA-REWRITE-FLATNORM-FN
 (4622 236 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-MODALIST-ADDR-P))
 (4090 262 (:REWRITE SV::SVARLIST-ADDR-P-BY-BADGUY))
 (2465 192 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-PIPELINE-OKP))
 (2060 90 (:DEFINITION MEMBER-EQUAL))
 (1986 139 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-CYCLE-FSM-OKP))
 (1854 108 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-FLATTEN-OKP))
 (1628 94 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-NAMEMAP-OKP))
 (1605 429 (:REWRITE SUBSETP-TRANS2))
 (1242 134 (:REWRITE SV::SVARLIST-ADDR-P-BADGUY-NOT-MEMBER-WHEN-ADDR-P))
 (949 325 (:REWRITE SUBSETP-TRANS))
 (886 886 (:TYPE-PRESCRIPTION SV::MODALIST-VARS))
 (570 246 (:REWRITE MEMBER-WHEN-ATOM))
 (540 108 (:REWRITE SV::SVARLIST-FIX-WHEN-SVARLIST-P))
 (486 294 (:REWRITE SUBSETP-MEMBER . 2))
 (486 262 (:REWRITE SUBSETP-MEMBER . 3))
 (416 26 (:REWRITE SV::SVARLIST-ADDR-P-BADGUY-NOT-EQUAL-SVAR-ADDR))
 (401 401 (:REWRITE SV::SVTV-DATA$C->FLATTEN-OF-UPDATE))
 (388 194 (:REWRITE-QUOTED-CONSTANT SV::MODDB-FIX-UNDER-MODDB-EQUIV))
 (360 360 (:REWRITE SV::SVARLIST-ADDR-P-WHEN-SUBSETP-EQUAL))
 (357 357 (:REWRITE SV::SVTV-DATA$C->FLATNORM-OF-UPDATE))
 (354 354 (:REWRITE SV::SVTV-DATA$C->DESIGN-OF-UPDATE))
 (309 309 (:REWRITE SV::SVTV-DATA$C->FLATNORM-SETUP-OF-UPDATE))
 (286 26 (:REWRITE SV::SVARLIST-ADDR-P-OF-CDR-WHEN-SVARLIST-ADDR-P))
 (278 278 (:REWRITE SUBSETP-MEMBER . 1))
 (278 278 (:REWRITE INTERSECTP-MEMBER . 3))
 (278 278 (:REWRITE INTERSECTP-MEMBER . 2))
 (273 273 (:REWRITE SV::SVTV-DATA$C->PIPELINE-VALIDP-OF-UPDATE))
 (260 26 (:REWRITE SV::SVAR-ADDR-P-OF-CAR-WHEN-SVARLIST-ADDR-P))
 (258 180 (:REWRITE SV::SVARLIST-ADDR-P-WHEN-NOT-CONSP))
 (220 110 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-FLATNORM-OKP))
 (205 205 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
 (205 205 (:REWRITE SUBSETP-WHEN-ATOM-LEFT))
 (204 204 (:REWRITE SV::SVTV-DATA$C->PHASE-FSM-VALIDP-OF-UPDATE))
 (198 139 (:REWRITE SV::CYCLE-FSM-OKP-WHEN-EQUIVALENT-FSM))
 (194 194 (:REWRITE-QUOTED-CONSTANT SV::LHSLIST-FIX-UNDER-LHSLIST-EQUIV))
 (194 194 (:REWRITE SV::MODDB-FIX-UNDER-MODDB-EQUIV))
 (192 192 (:REWRITE SV::SVTV-DATA$C->PIPELINE-OF-UPDATE))
 (192 192 (:REWRITE SV::PIPELINE-OKP-UPDATER-INDEPENDENCE))
 (190 190 (:TYPE-PRESCRIPTION SV::SVARLIST-P))
 (190 190 (:REWRITE SV::SVARLIST-P-OF-MODALIST-VARS))
 (180 180 (:REWRITE SV::SVTV-DATA$C->CYCLE-FSM-VALIDP-OF-UPDATE))
 (179 179 (:REWRITE SV::SVTV-DATA$C->FLATNORM-VALIDP-OF-UPDATE))
 (139 139 (:REWRITE SV::CYCLE-FSM-OKP-UPDATER-INDEPENDENCE))
 (134 134 (:REWRITE SV::SVTV-DATA$C->FLATTEN-VALIDP-OF-UPDATE))
 (126 126 (:REWRITE SV::SVTV-DATA$C->NAMEMAP-VALIDP-OF-UPDATE))
 (121 121 (:REWRITE SV::SVTV-DATA$C->CYCLE-FSM-OF-UPDATE))
 (115 115 (:REWRITE SV::SVTV-DATA$C->ALIASES-OF-UPDATE))
 (110 110 (:REWRITE SV::SVTV-DATA$C-FLATNORM-OKP-UPDATER-INDEPENDENCE))
 (108 108 (:REWRITE SV::SVTV-DATA$C-FLATTEN-OKP-UPDATER-INDEPENDENCE))
 (105 35 (:REWRITE NATP-WHEN-GTE-0))
 (104 104 (:REWRITE SUBSETP-REFL))
 (94 94 (:REWRITE SV::SVTV-DATA$C-NAMEMAP-OKP-UPDATER-INDEPENDENCE))
 (90 90 (:REWRITE SV::REWRITE-MEMBER-OF-APPEND-UNDER-SET-EQUIV))
 (90 90 (:REWRITE DEFAULT-CDR))
 (90 90 (:REWRITE DEFAULT-CAR))
 (82 82 (:REWRITE SV::SVTV-DATA$C->NAMEMAP-OF-UPDATE))
 (59 59 (:TYPE-PRESCRIPTION SV::FSM-EVAL-EQUIV))
 (52 52 (:TYPE-PRESCRIPTION SV::SVARLIST-ADDR-P-BADGUY))
 (52 52 (:TYPE-PRESCRIPTION SV::SVAR-ADDR-P))
 (52 52 (:REWRITE SV::SVAR-ADDR-P-WHEN-MEMBER-EQUAL-OF-SVARLIST-ADDR-P))
 (35 35 (:REWRITE NATP-WHEN-INTEGERP))
 (35 35 (:REWRITE DEFAULT-<-2))
 (35 35 (:REWRITE DEFAULT-<-1))
 (26 26 (:REWRITE SV::SVAR-ADDR-P-WHEN-SVAR-IDXADRR-OKP))
 )
(SV::SVTV-DATA$C-GET-OF-SVTV-DATA-REWRITE-FLATNORM
 (3 1 (:REWRITE SV::SVTV-DATA$C-FIELD-FIX-IDEMPOTENT))
 (2 2 (:TYPE-PRESCRIPTION SV::SVTV-DATA$C-FIELD-P))
 (1 1 (:REWRITE SV::SVTV-DATA$C->FLATNORM-OF-UPDATE))
 )
(SV::SVTV-DATA-CONCATNORM-FLATNORM-FN
 (4622 236 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-MODALIST-ADDR-P))
 (4090 262 (:REWRITE SV::SVARLIST-ADDR-P-BY-BADGUY))
 (2465 192 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-PIPELINE-OKP))
 (2060 90 (:DEFINITION MEMBER-EQUAL))
...
(SV::SVTV-DATA$C-GET-OF-SVTV-DATA-CONCATNORM-FLATNORM
 (3 1 (:REWRITE SV::SVTV-DATA$C-FIELD-FIX-IDEMPOTENT))
 (2 2 (:TYPE-PRESCRIPTION SV::SVTV-DATA$C-FIELD-P))
 (1 1 (:REWRITE SV::SVTV-DATA$C->FLATNORM-OF-UPDATE))
 )
(SV::SVTV-DATA-MAYBE-REWRITE-FLATNORM-FN)
(SV::SVTV-DATA$C-GET-OF-SVTV-DATA-MAYBE-REWRITE-FLATNORM
 (15 5 (:REWRITE SV::SVTV-DATA$C-FIELD-FIX-IDEMPOTENT))
 (10 10 (:TYPE-PRESCRIPTION SV::SVTV-DATA$C-FIELD-P))
 (9 3 (:REWRITE NATP-WHEN-GTE-0))
 (3 3 (:TYPE-PRESCRIPTION SV::SVTV-DATA-MAYBE-REWRITE-FLATNORM-FN))
 (3 3 (:REWRITE SV::SVTV-DATA$C->PHASE-FSM-VALIDP-OF-UPDATE))
 (3 3 (:REWRITE NATP-WHEN-INTEGERP))
 (3 3 (:REWRITE DEFAULT-<-2))
 (3 3 (:REWRITE DEFAULT-<-1))
 )
(SV::SVTV-DATA-MAYBE-CONCATNORM-FLATNORM-FN)
(SV::SVTV-DATA$C-GET-OF-SVTV-DATA-MAYBE-CONCATNORM-FLATNORM
 (9 3 (:REWRITE SV::SVTV-DATA$C-FIELD-FIX-IDEMPOTENT))
 (6 6 (:TYPE-PRESCRIPTION SV::SVTV-DATA$C-FIELD-P))
 (3 3 (:TYPE-PRESCRIPTION SV::SVTV-DATA-MAYBE-CONCATNORM-FLATNORM-FN))
...
(SV::SVTV-DATA-CONCATNORM-PIPELINE-FN
 (2 2 (:REWRITE SV::SVTV-DATA$C->PIPELINE-VALIDP-OF-UPDATE))
 (2 2 (:REWRITE SV::SVTV-DATA$C->PIPELINE-OF-UPDATE))
 (1 1 (:REWRITE SV::PIPELINE-OKP-UPDATER-INDEPENDENCE))
 )
(SV::SVTV-DATA$C-GET-OF-SVTV-DATA-CONCATNORM-PIPELINE
 (3 1 (:REWRITE SV::SVTV-DATA$C-FIELD-FIX-IDEMPOTENT))
 (2 2 (:TYPE-PRESCRIPTION SV::SVTV-DATA$C-FIELD-P))
 (1 1 (:REWRITE SV::SVTV-DATA$C->PIPELINE-OF-UPDATE))
 )
(SV::SVTV-DATA-MAYBE-CONCATNORM-PIPELINE-FN)
(SV::SVTV-DATA$C-GET-OF-SVTV-DATA-MAYBE-CONCATNORM-PIPELINE
 (9 3 (:REWRITE SV::SVTV-DATA$C-FIELD-FIX-IDEMPOTENT))
 (6 6 (:TYPE-PRESCRIPTION SV::SVTV-DATA$C-FIELD-P))
 (3 3 (:TYPE-PRESCRIPTION SV::SVTV-DATA-MAYBE-CONCATNORM-PIPELINE-FN))
 )
