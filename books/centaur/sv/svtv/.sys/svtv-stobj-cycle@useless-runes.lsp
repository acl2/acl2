...
(SV::FSM-EVAL-EQUIV-CONGRUENCE-OF-SVTV-CYCLE-COMPILE-OUTS
 (5 5 (:REWRITE SV::SVTV-DATA$C-PIPELINE-OKP-NECC))
 )
(SV::FSM-EVAL-EQUIV-CONGRUENCE-OF-SVTV-CYCLE-COMPILE-NEXTST
...
(SV::SVEX-ALIST-EVAL-EQUIV-IMPLIES-FSM-EVAL-EQUIV-FSM-1
...
(SV::SVEX-ALIST-EVAL-EQUIV!-IMPLIES-FSM-EVAL-EQUIV-FSM-2
 (19 4 (:REWRITE SV::SVEX-ALIST-FIX-WHEN-SVEX-ALIST-P))
 (6 6 (:TYPE-PRESCRIPTION SV::SVEX-ALIST-P))
 (6 6 (:REWRITE SV::SVEX-ALIST-P-WHEN-SUBSETP-EQUAL))
 (3 3 (:REWRITE SV::SVEX-ALIST-P-WHEN-NOT-CONSP))
 )
(SV::FSM-EVAL-EQUIV-IMPLIES-FSM-EVAL-EQUIV-FSM-TO-CYCLE-2
 (6 6 (:REWRITE SV::SVTV-DATA$C-CYCLE-FSM-OKP-NECC))
 )
(SV::CYCLE-FSM-OKP-OF-FSM-TO-CYCLE
