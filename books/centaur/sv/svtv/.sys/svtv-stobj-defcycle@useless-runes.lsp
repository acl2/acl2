(SV::SVTV-DATA-DEFCYCLE-CORE-FN
 ...
 (14 14 (:REWRITE SV::SVTV-DATA$C-GET-OF-SVTV-DATA-MAYBE-COMPUTE-FLATNORM))
...
(SV::SVTV-DATA-DEFCYCLE-CORE-CORRECT
 (92 92 (:REWRITE-QUOTED-CONSTANT SV::SVTV-DATA$C-FIELD-FIX-UNDER-SVTV-DATA$C-FIELD-EQUIV))
 (30 30 (:REWRITE SV::SVTV-DATA$C-GET-OF-SVTV-DATA-SET-DESIGN))
 (10 4 (:REWRITE SV::SVTV-CYCLEPHASELIST-FIX-WHEN-SVTV-CYCLEPHASELIST-P))
 (8 4 (:REWRITE SV::DESIGN-FIX-WHEN-DESIGN-P))
