...
(SV::SVTV-PIPELINE-CORRECT-WHEN-SVTV-DATA$AP
 ...
 (1880 144 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-PIPELINE-OKP))
 (1248 96 (:REWRITE LOWER-BOUND-OF-LEN-WHEN-SUBLISTP))
 (1020 80 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-CYCLE-FSM-OKP))
 (960 64 (:REWRITE ZP-WHEN-GT-0))
 (770 58 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-MODALIST-ADDR-P))
 ...
 (453 38 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-NAMEMAP-OKP))
 ...
 (369 29 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-FLATTEN-OKP))
