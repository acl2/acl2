...
(SV::SVTV-PIPELINE-CORRECT-WHEN-SVTV-DATA$AP
 ...
 (1720 144 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-PIPELINE-OKP))
 (1248 96 (:REWRITE LOWER-BOUND-OF-LEN-WHEN-SUBLISTP))
 (960 64 (:REWRITE ZP-WHEN-GT-0))
 (940 80 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-CYCLE-FSM-OKP))
 (726 58 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-MODALIST-ADDR-P))
 ...
 (347 29 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-FLATTEN-OKP))
...
(SV::SVTV-CYCLE-CORRECT-WHEN-SVTV-DATA$AP
 (956 80 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-CYCLE-FSM-OKP))
 (924 80 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-PIPELINE-OKP))
 (582 42 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-MODALIST-ADDR-P))
 (514 43 (:REWRITE SV::SVARLIST-ADDR-P-BY-BADGUY))
 (361 30 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-NAMEMAP-OKP))
 (306 306 (:TYPE-PRESCRIPTION SV::SVTV-DATA$AP))
 (275 21 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-FLATTEN-OKP))
...
(SV::PSEUDO-TERM-MAPPING-P-OF-CYCLE-OKP-HINT-SUBST.SUBST
 (2720 6 (:REWRITE PSEUDO-TERM-FIX-WHEN-PSEUDO-TERMP))
 (2562 6 (:DEFINITION PSEUDO-TERMP))
 (456 36 (:LINEAR SV::SUM-OF-LENGTHS-OF-CDR))
