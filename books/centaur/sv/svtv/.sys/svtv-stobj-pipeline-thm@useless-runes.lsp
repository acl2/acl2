...
(SV::META-EXTRACT-CONST-VALUE-CORRECT
 (2406 6 (:REWRITE PSEUDO-TERM-FIX-WHEN-PSEUDO-TERMP))
 (2376 6 (:DEFINITION PSEUDO-TERMP))
 (450 30 (:LINEAR SV::SUM-OF-LENGTHS-OF-CDR))
 (384 6 (:REWRITE PSEUDO-TERMP-CAR-WHEN-PSEUDO-TERM-LISTP))
 (276 48 (:DEFINITION LEN))
 (266 248 (:REWRITE DEFAULT-CDR))
...
(SV::PSEUDO-TERM-MAPPING-P-OF-PIPELINE-OKP-HINT-SUBST.SUBST
 (3434 8 (:REWRITE PSEUDO-TERM-FIX-WHEN-PSEUDO-TERMP))
 (3264 8 (:DEFINITION PSEUDO-TERMP))
 (600 40 (:LINEAR SV::SUM-OF-LENGTHS-OF-CDR))
...
(SV::PSEUDO-TERM-MAPPING-P-OF-CYCLE-OKP-HINT-SUBST.SUBST
 (2606 6 (:REWRITE PSEUDO-TERM-FIX-WHEN-PSEUDO-TERMP))
 (2448 6 (:DEFINITION PSEUDO-TERMP))
 (450 30 (:LINEAR SV::SUM-OF-LENGTHS-OF-CDR))
