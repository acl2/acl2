...
(SV::SVTV-DATA-COMPUTE-PIPELINE-FN
 (1614 162 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-CYCLE-FSM-OKP))
 (1606 16 (:REWRITE SV::NO-DUPLICATESP-NEXTSTATE-KEYS-OF-SVTV-DATA->PHASE-FSM))
 (1524 141 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-PIPELINE-OKP))
 (1274 94 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-MODALIST-ADDR-P))
 (1158 97 (:REWRITE SV::SVARLIST-ADDR-P-BY-BADGUY))
 (859 80 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-NAMEMAP-OKP))
 (589 47 (:REWRITE SV::SVTV-DATA$AP-IMPLIES-FLATTEN-OKP))
