...
(SV::SVTV-DATA$C-GET-OF-SVTV-DATA-MAYBE-COMPUTE-FLATNORM
 ...
 (15 5 (:REWRITE SV::FLATNORM-SETUP-FIX-WHEN-FLATNORM-SETUP-P))
 (10 10 (:TYPE-PRESCRIPTION SV::FLATNORM-SETUP-P))
 (5 5 (:REWRITE SV::SVTV-DATA$C->FLATNORM-VALIDP-OF-UPDATE))
 (5 5 (:REWRITE SV::SVTV-DATA$C->FLATNORM-SETUP-OF-UPDATE))
 )
(SV::SVTV-DATA$C->FLATNORM-VALIDP-OF-SVTV-DATA-MAYBE-COMPUTE-FLATNORM
 ...
 (3 3 (:REWRITE SV::SVTV-DATA$C->FLATNORM-SETUP-OF-UPDATE))
 )
(SV::SVTV-DATA$C->FLATNORM-SETUP-OF-SVTV-DATA-MAYBE-COMPUTE-FLATNORM
 (17 7 (:REWRITE SV::FLATNORM-SETUP-FIX-WHEN-FLATNORM-SETUP-P))
 (12 6 (:REWRITE DEFAULT-CDR))
 (12 6 (:REWRITE DEFAULT-CAR))
 (10 10 (:TYPE-PRESCRIPTION SV::FLATNORM-SETUP-P))
 (6 4 (:REWRITE SV::UPDATE-SVTV-DATA$C->FLATNORM-SETUP-PRESERVES-OTHERS))
