...
(GOOD-ESIM-MODULEP-GOOD-OCCP-LOOKUP-IN-OCCMAP
     ...
     (472 4 (:REWRITE MEMBER-EQUAL-APPEND))
     (444 48 (:REWRITE SUBSETP-CAR-MEMBER))
     (443 15 (:DEFINITION COLLECT-SIGNAL-LIST))
     (386 4 (:DEFINITION HONS-SUBSET1))
     (354 8 (:DEFINITION HONS-GET))
     (354 4 (:DEFINITION HONS-SUBSET2))
     (338 15
          (:REWRITE PAT-FLATTEN-IS-PAT-FLATTEN1))
     (314 4
          (:REWRITE HONS-ASSOC-EQUAL-HONS-PUT-LIST))
     (314 4 (:DEFINITION HONS-MEMBER-EQUAL))
     (313 28
     ...
     (208 60 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
     (197 153 (:REWRITE DEFAULT-CDR))
     ...
     (76 60 (:REWRITE SUBSETP-WHEN-ATOM-LEFT))
...
(SET-EQUIV-IMPLIES-SET-EQUIV-COLLECT-SIGNAL-LIST-2
     ...
     (310 13 (:DEFINITION MEMBER-EQUAL))
...
(HONS-INTERSECT-P2-INTERSECTP
     (463 22 (:DEFINITION MEMBER-EQUAL))
     (425 41 (:REWRITE SUBSETP-CAR-MEMBER))
     (354 177
          (:TYPE-PRESCRIPTION TRUE-LISTP-MEMBER-EQUAL))
     (344 344
          (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
     ...
     (131 49 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
     (81 29 (:REWRITE INTERSECTP-EQUAL-NON-CONS))
     (72 8
         (:REWRITE SUBSETP-IMPLIES-SUBSETP-CDR))
...
(HONS-SUBSET2-SUBSETP-EQUAL
     (566 21 (:DEFINITION MEMBER-EQUAL))
     (248 248
          (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
     (224 112
          (:TYPE-PRESCRIPTION TRUE-LISTP-MEMBER-EQUAL))
