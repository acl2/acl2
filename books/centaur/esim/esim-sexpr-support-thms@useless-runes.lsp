...
(HONS-SUBSET-SUBSETP-EQUAL
     ...
     (1 1 (:DEFINITION HONS-ACONS)))
(TRUE-LISTP-PAT->AL (20 2 (:DEFINITION TRUE-LISTP))
                    (19 4
                        (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
                    (16 16
                        (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
...
(OCCS-STATE-OF-LIST-FIX (285 12 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
