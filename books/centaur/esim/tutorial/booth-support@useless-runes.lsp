...
(BOOTH-SUM-IS-MULTIPLY (1431 727 (:REWRITE DEFAULT-*-2))
...
(INTEGERP-EXPT-WHEN-NOT-NEGP
     ...
     (2 2 (:DEFINITION FIX)))
(FLOOR-1-WHEN-INTEGER (2 2
                         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
                      (2 2 (:REWRITE DEFAULT-*-2))
                      (2 2 (:REWRITE DEFAULT-*-1)))
(LEFT-SHIFT-TO-EXPT (8 2 (:REWRITE DEFAULT-*-2))
                    (4 4
                       (:TYPE-PRESCRIPTION BITOPS::ASH-NATP-TYPE))
...
(BOOTH-SUM-INTEGERP (18 5 (:REWRITE DEFAULT-*-2))
...
(BOOTH-SUM-IMPL-IS-BOOTH-SUM-IMPL1
     (880 176
          (:TYPE-PRESCRIPTION BOOTH-ENC-ONE-INTEGERP))
     ...
     (28 28
         (:TYPE-PRESCRIPTION INTEGERP-EXPT-WHEN-NOT-NEGP))
     (28 28
         (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-POSITIVE))
     (28 28
         (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-NONZERO))
