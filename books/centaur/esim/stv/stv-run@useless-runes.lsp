...
(STV-RUN-MAKE-EVAL-ENV (6 6 (:TYPE-PRESCRIPTION MAKE-FAST-ALIST)))
(STV-RUN-FN)
...
(STV-RUN-FOR-ALL-DONTCARES-WHEN-INDEPENDENT
     ...
     (47814 2
            (:DEFINITION 4V-SEXPR-BOOLCONST-EVAL-ALIST-FIND-ENV-FOR-DIFF))
     ...
     (30836 2
            (:DEFINITION 4V-SEXPR-BOOLCONST-EVAL-ALIST))
