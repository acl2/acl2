...
(CHARACTER-LISTP-OF-STV-NAME-BITS-TO-XML
     ...
     (21 21
         (:TYPE-PRESCRIPTION NATP-OF-VL-HTML-ENCODE-STRING-AUX))
     (7 7
...
(STV-LINES-TO-XML (324 10 (:DEFINITION TRUE-LISTP))
                  (180 20
                       (:REWRITE TRUE-LISTP-WHEN-CHARACTER-LISTP-REWRITE))
                  (120 20
                       (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
...
(STV-LABELS-TO-XML (9 9 (:REWRITE DEFAULT-CAR))
...
(RETURN-TYPE-OF-STV-TO-XML
     ...
     (524 4
          (:REWRITE CHARACTER-LISTP-OF-STV-LINES-TO-XML))
     (214 25
          (:REWRITE CHARACTER-LISTP-WHEN-NOT-CONSP))
     (179 16
          (:REWRITE STR::CHARACTER-LISTP-WHEN-DIGIT-LISTP))
