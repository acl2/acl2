...
(STV-EXPAND-INPUT-ENTRY
 (262 37 (:REWRITE SET::DOUBLE-CONTAINMENT))
...
(STV-RESTRICT-ALIST
 ...
 (113 26 (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
...
(STV-EXPAND-INTERNAL-LINES
 (224 5 (:REWRITE TRUE-LISTP-WHEN-ATOM))
 (154 5 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
