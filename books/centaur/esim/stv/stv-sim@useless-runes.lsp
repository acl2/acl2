...
(LEN-STV-FULLY-GENERAL-IN-ALISTS
     ...
     (2 2
        (:TYPE-PRESCRIPTION STV-FULLY-GENERAL-IN-ALISTS-AUX))
     (2 2
...
(STV-FULLY-GENERAL-SIMULATION-RUN
   ...
   (1 1 (:REWRITE DEFAULT-+-2))
   (1 1 (:REWRITE DEFAULT-+-1)))
(STV-RUN-ESIM-DEBUG (448 7 (:DEFINITION MOD-INTERNAL-PATHS))
...
(STV-PROCESS
   (12 6
       (:TYPE-PRESCRIPTION RETURN-TYPE-OF-COMPILED-STV->OUT-EXTRACT-ALISTS))
   (12 6
       (:TYPE-PRESCRIPTION RETURN-TYPE-OF-COMPILED-STV->NST-EXTRACT-ALISTS)))
(RETURN-TYPE-OF-STV-PROCESS
     ...
     (15 15
         (:TYPE-PRESCRIPTION STV-EXTRACT-RELEVANT-SIGNALS))
