...
(SYMBOL-PATH-P-OF-CONS (26 6 (:REWRITE SYMBOL-PATH-P-WHEN-ATOM))
                       (14 14
                           (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-CONS-LISTP))
                       (14 14
                           (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
...
(SYMBOL-PATH-LIST-P-WHEN-SYMBOL-LISTP
     ...
     (30 30
         (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
     (27 11
         (:REWRITE SYMBOL-PATH-LIST-P-WHEN-NOT-CONSP))
     (20 2 (:DEFINITION MEMBER-EQUAL))
     (19 1 (:REWRITE SUBSETP-OF-CONS))
     (18 3
         (:REWRITE SYMBOL-PATH-LIST-P-OF-CDR-WHEN-SYMBOL-PATH-LIST-P))
     (16 16 (:REWRITE DEFAULT-CDR))
     (16 2
         (:REWRITE SYMBOL-PATH-P-WHEN-MEMBER-EQUAL-OF-SYMBOL-PATH-LIST-P))
...
(MOD-VCD-PATHS (36 18 (:REWRITE DEFAULT-<-1))
...
(FLAG-MOD-VCD-PATHS (36 18 (:REWRITE DEFAULT-<-1))
                    (28 28 (:REWRITE DEFAULT-CDR))
                    (26 3 (:DEFINITION MEMBER-EQUAL))
                    (22 18 (:REWRITE DEFAULT-<-2))
                    (18 18 (:REWRITE DEFAULT-CAR))
...
(SYMBOL-PATH-LIST-P-OF-EXTEND-INTERNAL-PATHS
     (149 10
          (:REWRITE SYMBOL-PATH-LIST-P-WHEN-SYMBOL-LISTP))
...
(FLAG-LEMMA-FOR-SYMBOL-PATH-LIST-P-OF-MOD-VCD-PATHS
     ...
     (179 179
          (:TYPE-PRESCRIPTION REMOVE-BAD-PATH-PARTS))
...
(CONS-LISTP-OF-MOD-VCD-ALIST-AUX
     ...
     (18 18
         (:TYPE-PRESCRIPTION MOD-VCD-ALIST-AUX))
     (16 16
         (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
...
(CONS-LISTP-OF-MOD-VCD-ALIST
     ...
     (1 1
        (:TYPE-PRESCRIPTION FAST-CANONICALIZE-PATH-MVTYPES-0)))
(MOD-INS-FAL)
(MOD-OUTS-FAL)
