...
(VL::VL-PRETTY-DELAY
 (1
   1
   (:REWRITE
        VL::VL-GATEDELAY->RISE$INLINE-OF-VL-GATEDELAY-FIX-X-NORMALIZE-CONST))
 (1
   1
   (:REWRITE
        VL::VL-GATEDELAY->HIGH$INLINE-OF-VL-GATEDELAY-FIX-X-NORMALIZE-CONST))
 (1
  1
  (:REWRITE
       VL::VL-GATEDELAY->FALL$INLINE-OF-VL-GATEDELAY-FIX-X-NORMALIZE-CONST)))
