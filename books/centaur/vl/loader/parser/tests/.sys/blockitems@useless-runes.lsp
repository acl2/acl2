...
(VL::VL-MAKE-VARDECLTESTS-FAIL
 (76 4 (:DEFINITION LEN))
 (15 1 (:REWRITE VL::VL-VARDECLTESTLIST-P-WHEN-NOT-CONSP))
...
(VL::VL-VARDECLTESTLIST-P-OF-VL-MAKE-VARDECLTESTS-FAIL
 ...
 (135 16 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
...
(VL::RUN-VARDECLTEST-AUX
 (6080 10 (:DEFINITION VL::RUN-VARDECLTEST-AUX))
 (3952 72 (:REWRITE VL::STRING-LISTP-WHEN-NO-NILS-IN-VL-MAYBE-STRING-LISTP))
 (2588 72 (:DEFINITION MEMBER-EQUAL))
 (1796 144 (:REWRITE MEMBER-WHEN-ATOM))
 (1626 594 (:REWRITE DEFAULT-CDR))
 (1530 102 (:REWRITE APPEND-WHEN-NOT-CONSP))
 (1008 24 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
 ...
 (816 24 (:REWRITE LIST-FIX-WHEN-LEN-ZERO))
 ...
 (360 24 (:REWRITE LIST-FIX-WHEN-NOT-CONSP))
