...
(VL::VL-MAKE-VARDECLTESTS-FAIL
 (84 4 (:DEFINITION LEN))
 (17 1 (:REWRITE VL::VL-VARDECLTESTLIST-P-WHEN-NOT-CONSP))
...
(VL::VL-VARDECLTESTLIST-P-OF-VL-MAKE-VARDECLTESTS-FAIL
 (168 16 (:REWRITE SUBSETP-WHEN-ATOM-LEFT))
 (149 16 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
...
(VL::RUN-VARDECLTEST-AUX
 (6500 10 (:DEFINITION VL::RUN-VARDECLTEST-AUX))
 (4280 72 (:REWRITE VL::STRING-LISTP-WHEN-NO-NILS-IN-VL-MAYBE-STRING-LISTP))
 (2824 72 (:DEFINITION MEMBER-EQUAL))
 (2032 144 (:REWRITE MEMBER-WHEN-ATOM))
 (1770 594 (:REWRITE DEFAULT-CDR))
 (1734 102 (:REWRITE APPEND-WHEN-NOT-CONSP))
 (960 24 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
 ...
 (864 24 (:REWRITE LIST-FIX-WHEN-LEN-ZERO))
 (740 318 (:REWRITE DEFAULT-+-2))
 (696 24 (:DEFINITION TRUE-LISTP))
 ...
 (408 24 (:REWRITE LIST-FIX-WHEN-NOT-CONSP))
 (390 318 (:REWRITE DEFAULT-+-1))
 (368 8 (:DEFINITION LENGTH))
