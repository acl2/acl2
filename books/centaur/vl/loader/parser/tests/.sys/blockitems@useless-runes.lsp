...
(VL::VL-MAKE-VARDECLTESTS-FAIL
 (68 4 (:DEFINITION LEN))
 (13 1 (:REWRITE VL::VL-VARDECLTESTLIST-P-WHEN-NOT-CONSP))
...
(VL::RUN-VARDECLTEST-AUX
 (5580 10 (:DEFINITION VL::RUN-VARDECLTEST-AUX))
 (3624 72 (:REWRITE VL::STRING-LISTP-WHEN-NO-NILS-IN-VL-MAYBE-STRING-LISTP))
 (2352 72 (:DEFINITION MEMBER-EQUAL))
 (1560 144 (:REWRITE MEMBER-WHEN-ATOM))
