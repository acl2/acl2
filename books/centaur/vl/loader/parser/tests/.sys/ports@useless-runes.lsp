...
(VL::VL-TOKENLIST-P-OF-VL-PARSE-NONNULL-PORT-TOP.TOKENS
 (1 1 (:REWRITE VL::VL-PARSE-NONNULL-PORT-FAILS-GRACEFULLY))
 )
...
(VL::VL-REGULARPORTLIST->EXPRS-NREV-REMOVAL
 (178 5 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
...
(VL::VL-REGULARPORTLIST->EXPRS-NREV
 ...
 (17 1 (:REWRITE VL::VL-REGULARPORT-P-BY-TAG-WHEN-VL-CTXELEMENT-P))
...
(VL::VL-TOKENLIST-P-OF-VL-PARSE-MODULE-PORT-LIST-TOP-TOP.TOKENS
 (1 1 (:REWRITE VL::VL-PARSE-MODULE-PORT-LIST-TOP-FAILS-GRACEFULLY))
 )
