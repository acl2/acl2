...
(VL::VL-READ-WHILE-CTYPE-IMPL
 ...
 (4 4
    (:REWRITE VL::VL-CTYPE-P-WHEN-MEMBER-EQUAL-OF-VL-CTYPE-LIST-P))
...
(VL::EQUIV-OF-VL-READ-WHILE-CTYPE-IMPL
 ...
 (5 5
    (:TYPE-PRESCRIPTION VL::VL-READ-WHILE-CTYPE-IMPL))
 (5 5
...
(VL::VL-READ-WHILE-CTYPE-SOUND
 ...
 (201 26
      (:REWRITE VL::VL-CTYPE-P-WHEN-MEMBER-EQUAL-OF-VL-CTYPE-LIST-P))
 (161 6
      (:REWRITE VL::MEMBER-OF-VL-ECHAR->CHAR-IN-VL-ECHARLIST->CHARS))
 (159 8
      (:REWRITE VL::VL-ECHARLIST->CHARS-WHEN-NOT-CONSP))
 (158 10
      (:REWRITE VL::PREFIX-OF-VL-READ-WHILE-CTYPE-WHEN-VL-CTYPE-P))
 ...
 (65 4
     (:REWRITE VL::VL-CTYPE-LIST-P-WHEN-NOT-CONSP))
 (61 15 (:REWRITE DEFAULT-CAR))
 (54 54
     (:TYPE-PRESCRIPTION VL::PREFIX-OF-VL-READ-WHILE-CTYPE))
 (50 50
     (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-CONS-LISTP))
 (50 50
     (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
 ...
 (19 19
     (:TYPE-PRESCRIPTION VL::CHARACTERP-OF-VL-ECHAR->CHAR))
...
(VL::VL-READ-WHILE-CTYPE-COMPLETE
 (344 172
      (:TYPE-PRESCRIPTION VL::REMAINDER-OF-VL-READ-WHILE-CTYPE))
...
(VL::ACL2-COUNT-OF-VL-READ-WHILE-CTYPE-WEAK
 ...
 (158 8
      (:REWRITE VL::NO-CHANGE-LOSER-OF-VL-READ-WHILE-CTYPE))
...
(VL::VL-READ-WHILE-NINE-IMPL
 ...
 (4 4
    (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
 (2 2
    (:REWRITE VL::VL-NINE-P-WHEN-MEMBER-EQUAL-OF-VL-NINE-LIST-P))
 (2 2
    (:REWRITE VL::VL-ECHARLIST-P-WHEN-NOT-CONSP))
 (2 2 (:REWRITE DEFAULT-CAR))
 (2 2 (:REWRITE CAR-WHEN-ALL-EQUALP))
...
(VL::VL-READ-WHILE-NINE$INLINE
 ...
 (16 2
     (:REWRITE VL::VL-ECHARLIST-P-WHEN-NOT-CONSP))
 (16 1
     (:DEFINITION VL::VL-READ-WHILE-NINE-IMPL))
 (14 1
     (:REWRITE TRUE-LISTP-WHEN-STRING-LISTP-REWRITE))
 (13 1
     (:REWRITE TRUE-LISTP-WHEN-SYMBOL-LISTP-REWRITE))
...
(VL::VL-READ-WHILE-NINE-SOUND
     (53 15
         (:REWRITE VL::VL-NINE-LIST-P-WHEN-NOT-CONSP))
     (30 30
         (:REWRITE VL::VL-NINE-LIST-P-WHEN-SUBSETP-EQUAL))
     ...
     (18 9
         (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
     (18 3
         (:REWRITE VL::VL-NINE-P-OF-CAR-WHEN-VL-NINE-LIST-P))
     (18 3
         (:REWRITE VL::VL-NINE-LIST-P-OF-CDR-WHEN-VL-NINE-LIST-P))
...
(VL::ACL2-COUNT-OF-VL-READ-WHILE-NINE-WEAK
     (12 6
         (:TYPE-PRESCRIPTION VL::REMAINDER-OF-VL-READ-WHILE-NINE))
     (12 4
...
(VL::VL-READ-WHILE-NOT-NINE-IMPL
 ...
 (4 4
    (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
 (2 2
    (:REWRITE VL::VL-NOT-NINE-P-WHEN-MEMBER-EQUAL-OF-VL-NOT-NINE-LIST-P))
 (2 2
    (:REWRITE VL::VL-ECHARLIST-P-WHEN-NOT-CONSP))
 (2 2 (:REWRITE DEFAULT-CAR))
 (2 2 (:REWRITE CAR-WHEN-ALL-EQUALP))
...
(VL::VL-READ-WHILE-NOT-NINE$INLINE
 ...
 (16 2
     (:REWRITE VL::VL-ECHARLIST-P-WHEN-NOT-CONSP))
 (16 1
     (:DEFINITION VL::VL-READ-WHILE-NOT-NINE-IMPL))
 (14 1
     (:REWRITE TRUE-LISTP-WHEN-STRING-LISTP-REWRITE))
 (13 1
     (:REWRITE TRUE-LISTP-WHEN-SYMBOL-LISTP-REWRITE))
...
(VL::VL-READ-WHILE-NOT-NINE-SOUND
     (53 15
         (:REWRITE VL::VL-NOT-NINE-LIST-P-WHEN-NOT-CONSP))
     (30 30
         (:REWRITE VL::VL-NOT-NINE-LIST-P-WHEN-SUBSETP-EQUAL))
     (27 3 (:REWRITE SET::DOUBLE-CONTAINMENT))
     (18 18
         (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-CONS-LISTP))
     (18 18
     ...
     (18 9
         (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
     (18 3
         (:REWRITE VL::VL-NOT-NINE-P-OF-CAR-WHEN-VL-NOT-NINE-LIST-P))
     (18 3
         (:REWRITE VL::VL-NOT-NINE-LIST-P-OF-CDR-WHEN-VL-NOT-NINE-LIST-P))
     (11 11 (:TYPE-PRESCRIPTION TRUE-LISTP))
     (9 9 (:REWRITE CONSP-BY-LEN))
     (6 6 (:TYPE-PRESCRIPTION SET::SETP-TYPE))
     (6 3 (:REWRITE SET::NONEMPTY-MEANS-SET))
...
(VL::ACL2-COUNT-OF-VL-READ-WHILE-NOT-NINE-WEAK
     (12 6
         (:TYPE-PRESCRIPTION VL::REMAINDER-OF-VL-READ-WHILE-NOT-NINE))
     (12 4
         (:TYPE-PRESCRIPTION VL::ACL2-COUNT-POSITIVE-WHEN-CONSP))
     (8 4
        (:TYPE-PRESCRIPTION ACL2-COUNT-OF-CONSP-POSITIVE))
