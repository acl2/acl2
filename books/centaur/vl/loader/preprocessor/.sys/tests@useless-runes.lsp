...
(VL::SIMPLE-TEST-DEFINES
 (3630 20 (:REWRITE VL::STRINGP-WHEN-TRUE-LISTP))
 (2535 162 (:REWRITE STRING-LISTP-WHEN-SUBSETP-EQUAL))
 (1267 29 (:REWRITE TRUE-LISTP-WHEN-ATOM))
 ...
 (869 18 (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
 ...
 (705 9 (:DEFINITION TRUE-LIST-LISTP))
