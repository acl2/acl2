...
(VL::SIMPLE-TEST-DEFINES
 ...
 (2545 162 (:REWRITE STRING-LISTP-WHEN-SUBSETP-EQUAL))
 (1384 29 (:REWRITE TRUE-LISTP-WHEN-ATOM))
 (1084 9 (:REWRITE STRINGP-OF-CAR-WHEN-STRING-LISTP))
 (1067 150 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
 (960 73 (:REWRITE VL::STRING-LISTP-WHEN-NO-NILS-IN-VL-MAYBE-STRING-LISTP))
 (887 18 (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
 (875 150 (:REWRITE SUBSETP-WHEN-ATOM-LEFT))
