...
(VL::NATP-OF-VL-READ-FILE-LOOP-AUX.LEN
     ...
     (7 7
        (:REWRITE VL::VL-ECHAR-OF-VL-LOCATION-FIX-LOC-NORMALIZE-CONST))
     (7 7
        (:REWRITE VL::VL-ECHAR-OF-CHAR-FIX-CHAR-NORMALIZE-CONST))
...
(VL::VL-READ-FILE-LOOP-AUX-REDEF
 ...
 (76 76
     (:REWRITE
          VL::MAKE-VL-ECHAR-FAST$INLINE-OF-STR-FIX-FILENAME-NORMALIZE-CONST))
 (76
    76
    (:REWRITE VL::MAKE-VL-ECHAR-FAST$INLINE-OF-POS-FIX-LINE-NORMALIZE-CONST))
 (76 76
     (:REWRITE VL::MAKE-VL-ECHAR-FAST$INLINE-OF-NFIX-COL-NORMALIZE-CONST))
 (76
   76
   (:REWRITE VL::MAKE-VL-ECHAR-FAST$INLINE-OF-CHAR-FIX-CHAR-NORMALIZE-CONST))
 (44 44
     (:REWRITE VL::TRUE-LISTP-WHEN-MEMBER-EQUAL-OF-TRUE-LIST-LISTP))
...
(VL::STATE-P1-OF-VL-READ-FILE-HOOK-DEFAULT
     (3 3
        (:TYPE-PRESCRIPTION VL::VL-READ-FILE-HOOK-DEFAULT)))
(VL::VL-READ-FILE-FN
     (60 1
         (:REWRITE VL::STRINGP-WHEN-TRUE-LISTP))
     (33 7
...
(VL::BOOLEANP-OF-VL-READ-FILE.OKP
     ...
     (5 2
        (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
     (4 4
        (:TYPE-PRESCRIPTION VL::TRUE-LISTP-OF-VL-READ-FILE-LOOP))
     (4 4 (:TYPE-PRESCRIPTION TRUE-LISTP))
     (4 4
        (:REWRITE STRINGP-WHEN-MEMBER-EQUAL-OF-STRING-LISTP))
     (4 4
