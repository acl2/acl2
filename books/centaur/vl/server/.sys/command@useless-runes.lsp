...
(VL::VLS-SUCCESS-FN
 (106 1 (:REWRITE VL::STRINGP-WHEN-TRUE-LISTP))
...
(VL::VLS-COMMAND-ARGS-TO-EFORMALS-NREV-REMOVAL
 (366 3 (:REWRITE LIST-FIX-WHEN-LEN-ZERO))
 (322 5 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
...
(VL::VLS-COMMAND-ARGS-TO-EFORMALS-NREV
 ...
 (18 4 (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
 (15 1 (:REWRITE TRUE-LISTP-WHEN-SYMBOL-LISTP-REWRITE-BACKCHAIN-1))
 (14 1 (:REWRITE TRUE-LISTP-WHEN-STRING-LISTP-REWRITE))
 (12 1 (:REWRITE TRUE-LISTP-WHEN-CHARACTER-LISTP-REWRITE))
 (9 7 (:TYPE-PRESCRIPTION TRUE-LISTP-MEMBER-EQUAL))
