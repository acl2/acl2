...
(VL::VLS-COMMAND-ARGS-TO-EFORMALS-NREV-REMOVAL
 (318 3 (:REWRITE LIST-FIX-WHEN-LEN-ZERO))
 (295 5 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
 (138 3 (:REWRITE |(equal 0 (len x))|))
 (135 3 (:REWRITE TRUE-LISTP-WHEN-ATOM))
 (135 3 (:REWRITE LIST-FIX-WHEN-NOT-CONSP))
 (135 3 (:REWRITE LEN-WHEN-ATOM))
