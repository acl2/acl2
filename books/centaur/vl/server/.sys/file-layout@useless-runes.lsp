...
(VL::VL-SCAN-FOR-ZIPINFOS-AUX-FN
 (1051 4 (:REWRITE VL::STRINGP-WHEN-TRUE-LISTP))
 (660 12 (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
 (651 6 (:DEFINITION TRUE-LIST-LISTP))
 (307 13 (:REWRITE TRUE-LISTP-WHEN-ATOM))
