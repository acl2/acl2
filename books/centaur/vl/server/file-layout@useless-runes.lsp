...
(VL::VL-ZIPINFO-P (12 12 (:DEFINITION STRIP-CARS)))
...
(VL::VL-ZIPINFO-FIX-WHEN-VL-ZIPINFO-P (6 6 (:DEFINITION STRIP-CARS)))
(VL::VL-ZIPINFO-FIX$INLINE (6 6 (:DEFINITION STRIP-CARS)))
...
(VL::VL-ZIPINFO->FILENAME$INLINE (6 6 (:DEFINITION STRIP-CARS)))
...
(VL::VL-ZIPINFO->FILENAME$INLINE-OF-VL-ZIPINFO-FIX-X
     ...
     (6 6
        (:TYPE-PRESCRIPTION VL::VL-ZIPINFO-FIX$INLINE))
     (3 1
        (:REWRITE TMP-DEFTYPES-NFIX-WHEN-NATP))
...
(VL::VL-ZIPINFO->NAME$INLINE (6 6 (:DEFINITION STRIP-CARS)))
...
(VL::VL-ZIPINFO->NAME$INLINE-OF-VL-ZIPINFO-FIX-X
     ...
     (3 1
        (:REWRITE TMP-DEFTYPES-NFIX-WHEN-NATP))
     (2 2 (:TYPE-PRESCRIPTION NATP)))
(VL::VL-ZIPINFO->NAME$INLINE-OF-VL-ZIPINFO-FIX-X-NORMALIZE-CONST)
(VL::VL-ZIPINFO->NAME$INLINE-VL-ZIPINFO-EQUIV-CONGRUENCE-ON-X)
(VL::VL-ZIPINFO->SYNTAX$INLINE (6 6 (:DEFINITION STRIP-CARS)))
...
(VL::VL-ZIPINFO->SYNTAX$INLINE-OF-VL-ZIPINFO-FIX-X
     ...
     (3 1
        (:REWRITE TMP-DEFTYPES-NFIX-WHEN-NATP))
     (2 2 (:TYPE-PRESCRIPTION NATP)))
(VL::VL-ZIPINFO->SYNTAX$INLINE-OF-VL-ZIPINFO-FIX-X-NORMALIZE-CONST)
(VL::VL-ZIPINFO->SYNTAX$INLINE-VL-ZIPINFO-EQUIV-CONGRUENCE-ON-X)
(VL::VL-ZIPINFO->DATE$INLINE (6 6 (:DEFINITION STRIP-CARS)))
...
(VL::VL-ZIPINFO->DATE$INLINE-OF-VL-ZIPINFO-FIX-X
     ...
     (3 1
        (:REWRITE TMP-DEFTYPES-NFIX-WHEN-NATP))
     (2 2 (:TYPE-PRESCRIPTION NATP)))
(VL::VL-ZIPINFO->DATE$INLINE-OF-VL-ZIPINFO-FIX-X-NORMALIZE-CONST)
(VL::VL-ZIPINFO->DATE$INLINE-VL-ZIPINFO-EQUIV-CONGRUENCE-ON-X)
(VL::VL-ZIPINFO->LTIME$INLINE (6 6 (:DEFINITION STRIP-CARS)))
...
(VL::VL-ZIPINFO->LTIME$INLINE-OF-VL-ZIPINFO-FIX-X-NORMALIZE-CONST)
(VL::VL-ZIPINFO->LTIME$INLINE-VL-ZIPINFO-EQUIV-CONGRUENCE-ON-X)
(VL::VL-ZIPINFO)
(VL::VL-ZIPINFO-P-OF-VL-ZIPINFO (23 23 (:REWRITE STR-FIX-WHEN-STRINGP))
                                (16 8
                                    (:REWRITE TMP-DEFTYPES-NFIX-WHEN-NATP)))
...
(VL::EQUAL-OF-VL-ZIPINFO
 ...
 (4
  4
  (:REWRITE VL::VL-ZIPINFO->NAME$INLINE-OF-VL-ZIPINFO-FIX-X-NORMALIZE-CONST))
 (4 4
    (:REWRITE
         VL::VL-ZIPINFO->LTIME$INLINE-OF-VL-ZIPINFO-FIX-X-NORMALIZE-CONST))
 (4
...
(VL::VL-ZIPINFO-OF-STR-FIX-FILENAME
     (4 2
        (:REWRITE TMP-DEFTYPES-NFIX-WHEN-NATP))
     (2 2 (:TYPE-PRESCRIPTION NATP)))
(VL::VL-ZIPINFO-OF-STR-FIX-FILENAME-NORMALIZE-CONST)
(VL::VL-ZIPINFO-STREQV-CONGRUENCE-ON-FILENAME)
(VL::VL-ZIPINFO-OF-STR-FIX-NAME (4 2
                                   (:REWRITE TMP-DEFTYPES-NFIX-WHEN-NATP))
                                (2 2 (:TYPE-PRESCRIPTION NATP)))
(VL::VL-ZIPINFO-OF-STR-FIX-NAME-NORMALIZE-CONST)
(VL::VL-ZIPINFO-STREQV-CONGRUENCE-ON-NAME)
(VL::VL-ZIPINFO-OF-STR-FIX-SYNTAX (4 2
                                     (:REWRITE TMP-DEFTYPES-NFIX-WHEN-NATP))
                                  (2 2 (:TYPE-PRESCRIPTION NATP)))
(VL::VL-ZIPINFO-OF-STR-FIX-SYNTAX-NORMALIZE-CONST)
(VL::VL-ZIPINFO-STREQV-CONGRUENCE-ON-SYNTAX)
(VL::VL-ZIPINFO-OF-STR-FIX-DATE (4 2
                                   (:REWRITE TMP-DEFTYPES-NFIX-WHEN-NATP))
                                (2 2 (:TYPE-PRESCRIPTION NATP)))
(VL::VL-ZIPINFO-OF-STR-FIX-DATE-NORMALIZE-CONST)
(VL::VL-ZIPINFO-STREQV-CONGRUENCE-ON-DATE)
(VL::VL-ZIPINFO-OF-NFIX-LTIME (8 8 (:REWRITE STR-FIX-WHEN-STRINGP))
                              (2 2 (:TYPE-PRESCRIPTION NATP)))
(VL::VL-ZIPINFO-OF-NFIX-LTIME-NORMALIZE-CONST)
...
(VL::VL-ZIPINFOLIST-P-OF-VL-ZIPINFOLIST-FIX
     ...
     (2 1
        (:REWRITE VL::VL-ZIPINFOLIST-P-OF-CDR-WHEN-VL-ZIPINFOLIST-P)))
...
(VL::CAR-OF-VL-ZIPINFOLIST-FIX-X-UNDER-VL-ZIPINFO-EQUIV
     ...
     (18 3
         (:REWRITE VL::VL-ZIPINFO-P-OF-CAR-WHEN-VL-ZIPINFOLIST-P))
     (18 2
         (:REWRITE VL::VL-ZIPINFOLIST-FIX-WHEN-VL-ZIPINFOLIST-P))
     (12 12
         (:TYPE-PRESCRIPTION VL::VL-ZIPINFOLIST-P))
     (12 12
         (:REWRITE VL::VL-ZIPINFOLIST-P-WHEN-SUBSETP-EQUAL))
...
(VL::CDR-OF-VL-ZIPINFOLIST-FIX-X-UNDER-VL-ZIPINFOLIST-EQUIV
     ...
     (4 4
        (:REWRITE VL::VL-ZIPINFO-P-WHEN-MEMBER-EQUAL-OF-VL-ZIPINFOLIST-P)))
(VL::CDR-OF-VL-ZIPINFOLIST-FIX-X-NORMALIZE-CONST-UNDER-VL-ZIPINFOLIST-EQUIV)
...
(VL::CONS-OF-VL-ZIPINFO-FIX-X-UNDER-VL-ZIPINFOLIST-EQUIV
 (34 4
     (:REWRITE VL::VL-ZIPINFOLIST-FIX-WHEN-VL-ZIPINFOLIST-P))
 (17 2
     (:REWRITE VL::VL-ZIPINFOLIST-P-OF-CONS))
 (10 10
     (:REWRITE VL::VL-ZIPINFOLIST-P-WHEN-SUBSETP-EQUAL))
 (8 8
    (:REWRITE VL::VL-ZIPINFO-P-WHEN-MEMBER-EQUAL-OF-VL-ZIPINFOLIST-P))
 ...
 (2
  ...
  (:REWRITE
   VL::CDR-OF-VL-ZIPINFOLIST-FIX-X-NORMALIZE-CONST-UNDER-VL-ZIPINFOLIST-EQUIV)))
(VL::CONS-OF-VL-ZIPINFO-FIX-X-NORMALIZE-CONST-UNDER-VL-ZIPINFOLIST-EQUIV)
...
(VL::CONS-OF-VL-ZIPINFOLIST-FIX-Y-UNDER-VL-ZIPINFOLIST-EQUIV
 ...
 (2
  ...
  (:REWRITE
   VL::CDR-OF-VL-ZIPINFOLIST-FIX-X-NORMALIZE-CONST-UNDER-VL-ZIPINFOLIST-EQUIV)))
(VL::CONS-OF-VL-ZIPINFOLIST-FIX-Y-NORMALIZE-CONST-UNDER-VL-ZIPINFOLIST-EQUIV)
...
(VL::VL-ZIPINFOLIST-FIX-OF-APPEND
 ...
 (36 32
     (:REWRITE VL::VL-ZIPINFOLIST-P-WHEN-SUBSETP-EQUAL))
 (36 2
     (:REWRITE VL::VL-ZIPINFOLIST-P-OF-APPEND))
 (14 4
     (:REWRITE VL::VL-ZIPINFOLIST-P-OF-CDR-WHEN-VL-ZIPINFOLIST-P))
 (12 2
     (:REWRITE VL::VL-ZIPINFO-FIX-WHEN-VL-ZIPINFO-P))
...
(VL::VL-ZIPINFOLIST-FIX-OF-REPEAT
 ...
 (16 2
     (:REWRITE VL::VL-ZIPINFOLIST-FIX-WHEN-VL-ZIPINFOLIST-P))
 (12 2
     (:REWRITE VL::VL-ZIPINFOLIST-P-OF-REPEAT))
 (10 10
...
(VL::VL-SCAN-FOR-ZIPINFOS-AUX-FN
 ...
 (24 1
     (:DEFINITION VL::VL-SCAN-FOR-ZIPINFOS-AUX-FN))
 ...
 (1 1
    (:REWRITE VL::VL-ZIPINFO-OF-STR-FIX-SYNTAX-NORMALIZE-CONST))
 (1 1
    (:REWRITE VL::VL-ZIPINFO-OF-STR-FIX-NAME-NORMALIZE-CONST))
 (1 1
    (:REWRITE VL::VL-ZIPINFO-OF-STR-FIX-FILENAME-NORMALIZE-CONST))
 (1 1
    (:REWRITE VL::VL-ZIPINFO-OF-STR-FIX-DATE-NORMALIZE-CONST))
 (1 1
    (:REWRITE VL::VL-ZIPINFO-OF-NFIX-LTIME-NORMALIZE-CONST))
