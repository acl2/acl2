...
(VL::VL-ZIPINFO-FIX-WHEN-VL-ZIPINFO
     ...
     (2 2 (:TYPE-PRESCRIPTION VL::VL-ZIPINFO-P))
     (2 2 (:TYPE-PRESCRIPTION NATP)))
(VL::EQUAL-OF-VL-ZIPINFO (120 120 (:REWRITE STR-FIX-WHEN-STRINGP)))
...
(VL::NTH-OF-VL-ZIPINFOLIST-FIX
     ...
     (102 102
          (:REWRITE VL::VL-ZIPINFOLIST-P-WHEN-SUBSETP-EQUAL))
     (100 10
          (:REWRITE VL::VL-ZIPINFO-P-OF-NTH-WHEN-VL-ZIPINFOLIST-P))
     (86 4 (:REWRITE NTH-WHEN-ATOM))
     (86 4 (:REWRITE VL::NTH-OF-ATOM))
     (78 18
         (:REWRITE VL::CONSP-OF-VL-ZIPINFOLIST-FIX))
...
(VL::VL-ZIPINFOLIST-EQUIV-IMPLIES-VL-ZIPINFOLIST-EQUIV-TAKE-2
     ...
     (234 234
          (:REWRITE VL::VL-ZIPINFOLIST-P-WHEN-SUBSETP-EQUAL))
     (215 23
          (:REWRITE VL::VL-ZIPINFOLIST-P-OF-TAKE))
     (135 117
          (:REWRITE VL::VL-ZIPINFOLIST-P-WHEN-NOT-CONSP))
     (64 64
         (:TYPE-PRESCRIPTION VL::VL-ZIPINFO-P))
