...
(VL::ACL2-COUNT-ZERO-WHEN-STRINGP
     ...
     (1 1
        (:REWRITE STR::EXPLODE-WHEN-NOT-STRINGP)))
(VL::O<-WHEN-NATPS (52 6 (:REWRITE VL::NATP-WHEN-POSP))
...
(VL::ACL2-COUNT-OF-LIST-FIX-WEAK
     ...
     (40 5 (:REWRITE ACL2-COUNT-WHEN-MEMBER))
     (36 36
         (:REWRITE SYMBOL-LISTP-WHEN-SUBSETP-EQUAL))
     (36 36
         (:REWRITE STRING-LISTP-WHEN-SUBSETP-EQUAL))
     ...
     (20 5
         (:REWRITE VL::MEMBER-EQUAL-OF-LIST-FIX))
     (19 18
         (:REWRITE SYMBOL-LISTP-WHEN-NOT-CONSP))
     (19 18
         (:REWRITE STRING-LISTP-WHEN-NOT-CONSP))
...
(VL::NTH-OF-ATOM (2 2 (:TYPE-PRESCRIPTION NATP))
                 (2 2
                    (:REWRITE INTEGERP-WHEN-MEMBER-EQUAL-OF-INTEGER-LISTP))
                 (2 2
                    (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-CONS-LISTP))
...
(VL::NTH-OF-CONS (291 6 (:REWRITE NTH-WITH-LARGE-INDEX))
...
(VL::NTH-WHEN-ZP (32 1 (:REWRITE NTH-WHEN-TOO-LARGE-CHEAP))
...
(VL::NTH-WHEN-TOO-BIG)
(VL::LAST-WHEN-ATOM (38 19 (:TYPE-PRESCRIPTION TRUE-LISTP-LAST))
                    ...
                    (2 1
                       (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
                    (1 1 (:REWRITE CONSP-BY-LEN)))
(VL::LAST-OF-CONS (48 2 (:DEFINITION LAST))
...
(VL::LAST-UNDER-IFF (31 1 (:DEFINITION LAST))
...
(VL::CONSP-OF-LAST (6 3 (:TYPE-PRESCRIPTION TRUE-LISTP-LAST))
                   (3 3 (:TYPE-PRESCRIPTION TRUE-LISTP))
...
(VL::PREFIXP-IMPOSSIBLE-BY-LEN
     ...
     (2 2
        (:LINEAR LISTPOS-UPPER-BOUND-STRONG-2)))
(VL::ALISTP-OF-INSERT (910 25 (:REWRITE SET::DOUBLE-CONTAINMENT))
                      (714 61
                           (:REWRITE ALISTP-WHEN-HONS-DUPLICITY-ALIST-P))
...
(VL::L1
 ...
 (3332 3332
       (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
 (2194 22 (:REWRITE SUBSETP-OF-CONS))
 ...
 (799 799
      (:TYPE-PRESCRIPTION HONS-DUPLICATED-MEMBERS-AUX))
 (704 10
      (:REWRITE NO-DUPLICATESP-EQUAL-OF-CONS))
 (658 64
      (:REWRITE ALISTP-WHEN-HONS-DUPLICITY-ALIST-P))
...
(VL::STRIP-CARS-OF-HONS-SHRINK-ALIST-UNDER-SET-EQUIV
 (543 3 (:DEFINITION FAST-ALIST-FORK))
 (393 3 (:REWRITE VL::L0))
 (386
  16
  (:REWRITE
...
(VL::L2
 ...
 (332 11
      (:REWRITE VL::STRIP-CARS-OF-HONS-SHRINK-ALIST-UNDER-SET-EQUIV))
 (270 270
      (:TYPE-PRESCRIPTION HONS-DUPLICATED-MEMBERS-AUX))
 (253 253
      (:TYPE-PRESCRIPTION FAST-ALIST-FORK))
...
(VL::SUBSETP-EQUAL-OF-STRIP-CARS-OF-HONS-SHRINK-ALIST
 (312 4 (:DEFINITION FAST-ALIST-FORK))
 (290
  5
  (:REWRITE
   MEMBER-EQUAL-OF-STRIP-CARS-WHEN-MEMBER-EQUAL-OF-HONS-DUPLICATED-MEMBERS-AUX))
 ...
 (25 1
     (:REWRITE HONS-ASSOC-EQUAL-IN-FAST-ALIST-FORK))
...
(VL::SUBSETP-EQUAL-OF-APPEND-WHEN-EMPTY-INTERSECT-LEFT
     ...
     (3790 315 (:REWRITE SUBSETP-CAR-MEMBER))
     (3085 335
           (:REWRITE VL::MEMBER-EQUAL-WHEN-MEMBER-EQUAL-OF-CDR-UNDER-IFF))
     (2627 512 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
     (2124 900
           (:TYPE-PRESCRIPTION TRUE-LISTP-MEMBER-EQUAL))
     (1733 1733 (:TYPE-PRESCRIPTION TRUE-LISTP))
     (1383 543 (:REWRITE SUBSETP-TRANS))
     (1345 638
           (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
     (1276 1276
           (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-CONS-LISTP))
     (1276 1276
           (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
     (705 543 (:REWRITE SUBSETP-TRANS2))
     (686 4 (:REWRITE SUBSETP-APPEND1))
     (638 638 (:REWRITE CONSP-BY-LEN))
     (390 195
          (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
     (345 23 (:REWRITE CONSP-APPEND))
     (339 285 (:REWRITE DEFAULT-CDR))
     (335 335
          (:REWRITE MEMBER-EQUAL-WHEN-ALL-EQUALP))
     (314 314 (:REWRITE SUBSETP-MEMBER . 2))
     (240 30 (:REWRITE MEMBER-WHEN-ATOM))
     ...
     (131 16
          (:REWRITE INTERSECTP-EQUAL-OF-ATOM-RIGHT))
     (107 13 (:REWRITE INTERSECTP-EQUAL-NON-CONS))
...
(VL::SUBSETP-EQUAL-OF-APPEND-WHEN-EMPTY-INTERSECT-RIGHT
     ...
     (3636 303 (:REWRITE SUBSETP-CAR-MEMBER))
     (2981 323
           (:REWRITE VL::MEMBER-EQUAL-WHEN-MEMBER-EQUAL-OF-CDR-UNDER-IFF))
     (2464 475 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
     (2048 862
           (:TYPE-PRESCRIPTION TRUE-LISTP-MEMBER-EQUAL))
     (1701 1701 (:TYPE-PRESCRIPTION TRUE-LISTP))
     (1357 644
           (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
     (1346 506 (:REWRITE SUBSETP-TRANS))
     (1288 1288
           (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-CONS-LISTP))
     (1288 1288
           (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
     (686 4 (:REWRITE SUBSETP-APPEND1))
     (668 506 (:REWRITE SUBSETP-TRANS2))
     (644 644 (:REWRITE CONSP-BY-LEN))
     (390 195
          (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
     (345 23 (:REWRITE CONSP-APPEND))
     (329 275 (:REWRITE DEFAULT-CDR))
     (323 323
          (:REWRITE MEMBER-EQUAL-WHEN-ALL-EQUALP))
     (302 302 (:REWRITE SUBSETP-MEMBER . 2))
     (251 34
          (:REWRITE INTERSECTP-EQUAL-OF-ATOM-RIGHT))
     (224 28 (:REWRITE MEMBER-WHEN-ATOM))
     (215 26 (:REWRITE INTERSECTP-EQUAL-NON-CONS))
     (195 195 (:TYPE-PRESCRIPTION BINARY-APPEND))
...
(VL::STRING-LISTP-OF-STRIP-CDRS-OF-PAIRLIS$
     ...
     (16 1 (:REWRITE PREFIXP-WHEN-EQUAL-LENGTHS))
     (14 14
         (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-CONS-LISTP))
     (14 14
         (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
...
(VL::STRING-APPEND-LST-OF-CONS
     (43 6
         (:REWRITE VL::STRING-APPEND-LST-WHEN-NOT-CONSP))
     (14 14
         (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-CONS-LISTP))
     (14 14
         (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
...
(VL::NTH-OF-EXPLODE-WHEN-CHAR-FIX-KNOWN
     ...
     (2 2
        (:REWRITE ACL2-NUMBERP-WHEN-MEMBER-EQUAL-OF-ACL2-NUMBER-LISTP)))
(VL::L0 (75 1 (:DEFINITION FAST-ALIST-FORK))
...
(VL::NATSTR-WHEN-ZP
     ...
     (2 2 (:REWRITE DEFAULT-<-1))
     (2 2 (:META CANCEL_PLUS-LESSP-CORRECT)))
(VL::LEN-OF-CDR-STRONG (114 2
                            (:REWRITE LOWER-BOUND-OF-LEN-WHEN-SUBLISTP))
                       (86 2 (:REWRITE SUBLISTP-WHEN-PREFIXP))
                       (54 4 (:REWRITE PREFIXP-WHEN-EQUAL-LENGTHS))
