...
(VL::CHARACTER-LISTP-OF-FLATTEN
 (720 46 (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
 (598 1 (:REWRITE SUBSETP-APPEND1))
 (449 5 (:REWRITE APPEND-UNDER-IFF))
 (441 92 (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
 (365 19 (:REWRITE SUBSETP-TRANS2))
 (334 16 (:REWRITE SUBSETP-WHEN-ATOM-LEFT))
 (332 16 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
 ...
 (142 3 (:REWRITE APPEND-WHEN-NOT-CONSP))
 ...
 (75 4 (:REWRITE SUBSETP-IMPLIES-SUBSETP-CDR))
