...
(VL::CHARACTER-LISTP-OF-FLATTEN
 (689 46 (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
 (558 1 (:REWRITE SUBSETP-APPEND1))
 (434 5 (:REWRITE APPEND-UNDER-IFF))
 (395 92 (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
 (345 19 (:REWRITE SUBSETP-TRANS2))
 (314 16 (:REWRITE SUBSETP-WHEN-ATOM-LEFT))
 (305 16 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
 (293 11 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
 (267 3 (:REWRITE CHARACTER-LISTP-WHEN-NOT-CONSP))
 ...
 (72 4 (:REWRITE SUBSETP-IMPLIES-SUBSETP-CDR))
...
(VL::VL-CHARACTER-LIST-LIST-VALUES-P-OF-HONS-SHRINK-ALIST
 ...
 (403 23 (:REWRITE VL::CHARACTER-LIST-LISTP-OF-CDR-WHEN-CHARACTER-LIST-LISTP))
 ...
 (174 34 (:REWRITE OMAP::MFIX-IMPLIES-MAPP))
 ...
 (72 68 (:TYPE-PRESCRIPTION OMAP::MFIX))
...
(VL::CHARACTER-LIST-LISTP-OF-EXPLODE-LIST
 (137 1 (:REWRITE STR::EXPLODE-WHEN-NOT-STRINGP))
 (105 2 (:REWRITE VL::STRINGP-WHEN-TRUE-LISTP))
...
(VL::EXPLODE-LIST-OF-CONS
 (471 5 (:REWRITE STR::EXPLODE-WHEN-NOT-STRINGP))
 (396 5 (:REWRITE VL::STRINGP-WHEN-TRUE-LISTP))
 (92 5 (:REWRITE TRUE-LISTP-WHEN-ATOM))
