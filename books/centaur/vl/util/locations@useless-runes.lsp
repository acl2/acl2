...
(VL::VL-LINECOL$INLINE (27 27 (:REWRITE DEFAULT-<-2))
                       ...
                       (1 1 (:REWRITE NATP-WHEN-INTEGERP)))
(VL::VL-LINECOL-P-OF-VL-LINECOL (78 6 (:REWRITE POS-FIX-WHEN-POSP))
...
(VL::VL-LINECOL$INLINE-OF-POS-FIX-LINE
     (12 12
         (:TYPE-PRESCRIPTION BITOPS::ASH-NATP-TYPE)))
(VL::VL-LINECOL$INLINE-OF-POS-FIX-LINE-NORMALIZE-CONST)
(VL::VL-LINECOL$INLINE-POS-EQUIV-CONGRUENCE-ON-LINE)
(VL::VL-LINECOL$INLINE-OF-NFIX-COL
     (12 12
         (:TYPE-PRESCRIPTION BITOPS::ASH-NATP-TYPE)))
(VL::VL-LINECOL$INLINE-OF-NFIX-COL-NORMALIZE-CONST)
(VL::VL-LINECOL$INLINE-NAT-EQUIV-CONGRUENCE-ON-COL)
(VL::VL-LINECOL->LINE$INLINE (59 59
                                 (:TYPE-PRESCRIPTION BITOPS::ASH-NATP-TYPE))
...
(VL::VL-LINECOL->LINE$INLINE-OF-VL-LINECOL-FIX-X
     ...
     (12 12
         (:TYPE-PRESCRIPTION BITOPS::ASH-NATP-TYPE)))
(VL::VL-LINECOL->LINE$INLINE-OF-VL-LINECOL-FIX-X-NORMALIZE-CONST)
(VL::VL-LINECOL->LINE$INLINE-VL-LINECOL-EQUIV-CONGRUENCE-ON-X)
(VL::VL-LINECOL->COL$INLINE-OF-VL-LINECOL-FIX-X
     (18 18
         (:TYPE-PRESCRIPTION VL::VL-LINECOL-FIX$INLINE)))
(VL::VL-LINECOL->COL$INLINE-OF-VL-LINECOL-FIX-X-NORMALIZE-CONST)
...
(VL::VL-LOCATION->FILENAME-OF-VL-LOCATION
     ...
     (1 1
        (:REWRITE VL::VL-LINECOL$INLINE-OF-POS-FIX-LINE-NORMALIZE-CONST))
     (1 1
        (:REWRITE VL::VL-LINECOL$INLINE-OF-NFIX-COL-NORMALIZE-CONST)))
...
(VL::VL-LOCATION->LINE-OF-VL-LOCATION
 ...
 (1
  1
  (:REWRITE VL::VL-LINECOL->LINE$INLINE-OF-VL-LINECOL-FIX-X-NORMALIZE-CONST))
 (1 1
    (:REWRITE VL::VL-LINECOL$INLINE-OF-POS-FIX-LINE-NORMALIZE-CONST))
 (1 1
    (:REWRITE VL::VL-LINECOL$INLINE-OF-NFIX-COL-NORMALIZE-CONST))
...
(VL::VL-LOCATION->COL-OF-VL-LOCATION
 ...
 (1
   1
   (:REWRITE VL::VL-LINECOL->COL$INLINE-OF-VL-LINECOL-FIX-X-NORMALIZE-CONST))
 (1 1
    (:REWRITE VL::VL-LINECOL$INLINE-OF-POS-FIX-LINE-NORMALIZE-CONST))
 (1 1
    (:REWRITE VL::VL-LINECOL$INLINE-OF-NFIX-COL-NORMALIZE-CONST))
...
(VL::CDR-OF-VL-LOCATIONLIST-FIX-X-UNDER-VL-LOCATIONLIST-EQUIV
     ...
     (4 4
        (:TYPE-PRESCRIPTION VL::VL-LOCATION-P$INLINE)))
(VL::CDR-OF-VL-LOCATIONLIST-FIX-X-NORMALIZE-CONST-UNDER-VL-LOCATIONLIST-EQUIV)
...
(VL::CONS-OF-VL-LOCATION-FIX-X-UNDER-VL-LOCATIONLIST-EQUIV
 ...
 (2
  ...
  (:REWRITE
   VL::CDR-OF-VL-LOCATIONLIST-FIX-X-NORMALIZE-CONST-UNDER-VL-LOCATIONLIST-EQUIV)))
(VL::CONS-OF-VL-LOCATION-FIX-X-NORMALIZE-CONST-UNDER-VL-LOCATIONLIST-EQUIV)
...
(VL::CONS-OF-VL-LOCATIONLIST-FIX-Y-UNDER-VL-LOCATIONLIST-EQUIV
 ...
 (2
  ...
  (:REWRITE
   VL::CDR-OF-VL-LOCATIONLIST-FIX-X-NORMALIZE-CONST-UNDER-VL-LOCATIONLIST-EQUIV)))
(VL::CONS-OF-VL-LOCATIONLIST-FIX-Y-NORMALIZE-CONST-UNDER-VL-LOCATIONLIST-EQUIV)
...
(VL::VL-LOCATION-STRING-OF-VL-LOCATION-FIX-LOC
 (298 12 (:DEFINITION BINARY-APPEND))
 (192 48 (:REWRITE STR::CONSP-OF-EXPLODE))
 (108 30 (:REWRITE DEFAULT-CDR))
 ...
 (20 8 (:DEFINITION NOT))
 (20 4 (:REWRITE STR::DIGIT-LISTP-OF-APPEND))
 (13 13
     (:REWRITE
          VL::VL-LOCATION->COL$INLINE-OF-VL-LOCATION-FIX-X-NORMALIZE-CONST))
 (12 12 (:REWRITE STR::DIGIT-LISTP-OF-CONS))
 (11 11
     (:REWRITE
          VL::VL-LOCATION->LINE$INLINE-OF-VL-LOCATION-FIX-X-NORMALIZE-CONST))
 (10 10
 ...
 (2 2
    (:TYPE-PRESCRIPTION VL::VL-LOCATION-P$INLINE)))
(VL::VL-LOCATION-STRING-OF-VL-LOCATION-FIX-LOC-NORMALIZE-CONST)
...
(VL::VL-LOCATION-BETWEEN-P-OF-VL-LOCATION-FIX-X
 ...
 (2 2
    (:TYPE-PRESCRIPTION VL::VL-LOCATION-P$INLINE)))
(VL::VL-LOCATION-BETWEEN-P-OF-VL-LOCATION-FIX-X-NORMALIZE-CONST)
