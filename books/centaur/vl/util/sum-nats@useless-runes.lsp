...
(VL::SETP-OF-NATS-FROM
     (19800 94
            (:REWRITE VL::RATIONALP-WHEN-INTEGERP))
     (16619 991 (:REWRITE VL::INTEGERP-WHEN-NATP))
     (10468 704 (:REWRITE VL::NATP-WHEN-POSP))
     (6735 138
           (:REWRITE NAT-LISTP-OF-CDR-WHEN-NAT-LISTP))
     (6157 75
           (:REWRITE VL::NATP-OF-CAR-WHEN-NAT-LISTP))
     ...
     (3386 44
           (:REWRITE VL::POS-LISTP-OF-CDR-WHEN-POS-LISTP))
     (2777 674 (:REWRITE POSP-RW))
     (2598 15
           (:REWRITE SYMBOLP-OF-CAR-WHEN-SYMBOL-LISTP))
     (2357 1408 (:REWRITE DEFAULT-<-2))
     (2273 27
           (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (1982 1982
           (:REWRITE INTEGERP-WHEN-MEMBER-EQUAL-OF-INTEGER-LISTP))
     ...
     (1759 1614 (:REWRITE DEFAULT-+-2))
     (1754 25
           (:REWRITE ACL2-NUMBER-LISTP-OF-CDR-WHEN-ACL2-NUMBER-LISTP))
     (1614 1614 (:REWRITE DEFAULT-+-1))
     (1552 1552 (:META CANCEL_PLUS-LESSP-CORRECT))
     ...
     (1350 9
           (:REWRITE SYMBOL-LISTP-OF-CDR-WHEN-SYMBOL-LISTP))
     (1348 1348 (:TYPE-PRESCRIPTION POSP))
     (1348 1348
           (:REWRITE VL::POSP-WHEN-MEMBER-EQUAL-OF-POS-LISTP))
     (1348 674 (:REWRITE NATP-POSP))
     (1323 9
           (:REWRITE CHARACTER-LISTP-OF-CDR-WHEN-CHARACTER-LISTP))
     (1256 496 (:REWRITE VL::|(< c2 (+ c1 a))|))
     (1176 24
           (:REWRITE SYMBOL-LISTP-WHEN-BOOLEAN-LISTP))
     (1024 40 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
     (873 9
     ...
     (473 34 (:REWRITE ALISTP-OF-CDR))
     (444 81 (:REWRITE SET::DOUBLE-CONTAINMENT))
     (387 24
          (:REWRITE VL::STRING-LISTP-WHEN-NO-NILS-IN-VL-MAYBE-STRING-LISTP))
     (380 244 (:REWRITE NAT-LISTP-WHEN-NOT-CONSP))
     (362 153
          (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
     (347 347 (:REWRITE DEFAULT-UNARY-MINUS))
     ...
     (244 244
          (:REWRITE NAT-LISTP-WHEN-UNSIGNED-BYTE-LISTP))
     (240 68 (:REWRITE <<-IMPLIES-LEXORDER))
     (236 74
          (:REWRITE VL::ALISTP-WHEN-ALL-HAVE-LEN))
     (227 83 (:REWRITE MEMBER-WHEN-ATOM))
     (188 188 (:TYPE-PRESCRIPTION RATIONAL-LISTP))
     (188 188 (:TYPE-PRESCRIPTION VL::POS-LISTP))
     ...
     (171 24
          (:REWRITE STR::CHARACTER-LISTP-WHEN-HEX-DIGIT-LISTP))
     (168 168 (:TYPE-PRESCRIPTION VL::NAT-LISTP))
     (168 168
          (:REWRITE VL::NAT-LISTP-WHEN-SUBSETP-EQUAL))
     (166 94
          (:REWRITE RATIONAL-LISTP-WHEN-NOT-CONSP))
     ...
     (40 40 (:REWRITE CONSP-BY-LEN))
     (37 37 (:REWRITE ALPHORDER-TRANSITIVE))
     (33 24
