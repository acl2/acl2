...
(VL::NLP-BADGUY-UNDER-IFF
     (1876 56 (:REWRITE VL::NATP-WHEN-POSP))
     (854 16 (:REWRITE POSP-RW))
     (834 16 (:REWRITE NATP-POSP))
...
(VL::NLP-BADGUY-BAD
     (1034 30 (:REWRITE VL::NATP-WHEN-POSP))
     (649 10 (:REWRITE NATP-POSP))
     (613 52
          (:REWRITE VL::NAT-LISTP-WHEN-NO-NILS-IN-VL-MAYBE-NAT-LISTP))
     (305 30 (:REWRITE NATP-RW))
     (290 28 (:REWRITE NAT-LISTP-WHEN-NOT-CONSP))
     (270 8
          (:LINEAR LOWER-BOUND-OF-CAR-WHEN-NAT-LISTP))
     (240 30
          (:REWRITE VL::NATP-OF-CAR-WHEN-NAT-LISTP))
...
(VL::SUM-NATS-OF-CONS
     (224 10 (:REWRITE VL::NEGATIVE-WHEN-NATP))
     (202 15 (:REWRITE VL::INTEGERP-WHEN-NATP))
...
(VL::SUM-NATS-OF-LIST-FIX
     (687 14 (:REWRITE VL::NEGATIVE-WHEN-NATP))
     (552 21 (:REWRITE VL::INTEGERP-WHEN-NATP))
...
(VL::SUM-NATS-OF-APPEND
     (1032 34 (:REWRITE VL::NEGATIVE-WHEN-NATP))
     (900 51 (:REWRITE VL::INTEGERP-WHEN-NATP))
...
(VL::SUM-NATS-OF-REV
     ...
     (6206 202 (:REWRITE VL::INTEGERP-WHEN-NATP))
     (5715 125
           (:REWRITE VL::NATP-OF-CAR-WHEN-NAT-LISTP))
     ...
     (2368 56 (:REWRITE VL::NAT-LISTP-OF-REV))
     (1910 1910
           (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-CONS-LISTP))
     (1910 1910
           (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
...
(VL::SUM-NATS-OF-REVERSE
     (356 2 (:DEFINITION VL::SUM-NATS))
     (310 2 (:DEFINITION NFIX))
     (140 4 (:REWRITE VL::NEGATIVE-WHEN-NATP))
     (118 6 (:REWRITE VL::INTEGERP-WHEN-NATP))
...
(VL::SUM-NATS-WHEN-ALL-EQUALP
     (514 50 (:REWRITE VL::INTEGERP-WHEN-NATP))
...
(VL::MAX-NATS-WHEN-ATOM (2 2
                        ...
                        (1 1 (:REWRITE CONSP-BY-LEN)))
(VL::MAX-NATS-OF-CONS
     (1091 66 (:REWRITE VL::INTEGERP-WHEN-NATP))
...
(VL::MAX-NATS-OF-APPEND
     (7656 342 (:REWRITE VL::INTEGERP-WHEN-NATP))
     (6074 193
           (:REWRITE VL::NATP-OF-CAR-WHEN-NAT-LISTP))
...
(VL::MAX-NATS-OF-REV
     ...
     (8827 295 (:REWRITE VL::INTEGERP-WHEN-NATP))
     ...
     (3024 72 (:REWRITE VL::NAT-LISTP-OF-REV))
     (2572 2572
           (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-CONS-LISTP))
     (2572 2572
           (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
...
(VL::NATP-OF-MIN-NATS)
(VL::MIN-NATS-BOUND
     (760 20 (:REWRITE VL::NEGATIVE-WHEN-NATP))
     (650 30 (:REWRITE VL::INTEGERP-WHEN-NATP))
     (480 20
          (:REWRITE VL::NATP-OF-CAR-WHEN-NAT-LISTP))
...
(VL::SETP-OF-NATS-FROM
     (21902 100
            (:REWRITE VL::RATIONALP-WHEN-INTEGERP))
     (18423 1117 (:REWRITE VL::INTEGERP-WHEN-NATP))
     ...
     (3782 47
           (:REWRITE VL::POS-LISTP-OF-CDR-WHEN-POS-LISTP))
     (3297 70 (:REWRITE <<-IMPLIES-LEXORDER))
