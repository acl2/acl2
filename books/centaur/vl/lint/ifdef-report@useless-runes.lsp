...
(VL::VL-IFDEF-USE-MAP-P-OF-VL-CLEAN-IFDEF-MAP
 ...
 (115 1 (:DEFINITION TRUE-LIST-LISTP))
 (102 2 (:REWRITE TRUE-LISTP-WHEN-ATOM))
...
(VL::VL-PRINT-IFDEF-BRIEF-SUMMARY-FN
 ...
 (125 15 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
 (102 7 (:REWRITE VL::VL-IFDEF-USE-MAP-P-WHEN-NOT-CONSP))
...
(VL::VL-LOCATIONLIST-P-OF-INSERT
 (1292 21 (:REWRITE SET::DOUBLE-CONTAINMENT))
...
(VL::VL-JP-DEFINFO-1-FN
 (457 3 (:DEFINITION SET::MERGESORT))
