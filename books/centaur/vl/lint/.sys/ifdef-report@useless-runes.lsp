...
(VL::VL-IFDEF-USE-MAP-P-OF-VL-CLEAN-IFDEF-MAP
 (342 1 (:REWRITE VL::STRINGP-WHEN-TRUE-LISTP))
 (297 15 (:REWRITE VL::VL-IFDEF-USE-MAP-FIX-WHEN-VL-IFDEF-USE-MAP-P))
 (218 1 (:DEFINITION SET::MERGESORT))
...
(VL::VL-PRINT-IFDEF-BRIEF-SUMMARY-FN
 ...
 (221 2 (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
 (183 1 (:DEFINITION TRUE-LIST-LISTP))
 (164 2 (:REWRITE TRUE-LISTP-WHEN-ATOM))
 (129 15 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
 (110 7 (:REWRITE VL::VL-IFDEF-USE-MAP-P-WHEN-NOT-CONSP))
...
(VL::VL-LOCATIONLIST-P-OF-INSERT
 (1352 21 (:REWRITE SET::DOUBLE-CONTAINMENT))
 (277 277 (:REWRITE DEFAULT-CDR))
 (238 232 (:REWRITE <<-TRANSITIVE))
 (225 65 (:REWRITE SET::SFIX-WHEN-EMPTY))
 ...
 (141 36 (:REWRITE SET::HEAD-WHEN-EMPTY))
 (102 17 (:REWRITE SET::TAIL-WHEN-EMPTY))
 ...
 (51 11 (:REWRITE SET::INSERT-WHEN-EMPTY))
...
(VL::VL-JP-DEFINFO-1-FN
 (475 3 (:DEFINITION SET::MERGESORT))
...
(VL::VL-JP-DEFINFO-AUX-FN
 (629 17 (:REWRITE DEFAULT-CDR))
 (465 1 (:REWRITE VL::STRINGP-WHEN-TRUE-LISTP))
 (262 28 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
 (247 146 (:TYPE-PRESCRIPTION TRUE-LISTP-MEMBER-EQUAL))
 (237 2 (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
 (220 8 (:REWRITE VL::VL-IFDEF-USE-MAP-P-WHEN-NOT-CONSP))
 (220 8 (:REWRITE VL::VL-DEF-USE-MAP-P-WHEN-NOT-CONSP))
 (195 1 (:DEFINITION TRUE-LIST-LISTP))
