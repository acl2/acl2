(VL::<<-OF-CONS
 (291 65 (:REWRITE <<-IMPLIES-LEXORDER))
...
(VL::<<-OF-MODULES
 (4044 8 (:REWRITE VL::STRINGP-WHEN-TRUE-LISTP))
 (3572 64 (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
 (3516 36 (:DEFINITION TRUE-LIST-LISTP))
 (2780 80 (:REWRITE TRUE-LIST-LISTP-OF-CDR-WHEN-TRUE-LIST-LISTP))
...
(VL::SETP-OF-VL-MODULELIST->NAMES-WHEN-NO-DUPLICATES
 (35977 2560 (:REWRITE VL::VL-MODULE-P-WHEN-MEMBER-EQUAL-OF-VL-MODULELIST-P))
 (30538 10 (:DEFINITION SET::MERGESORT))
 (27185 38 (:REWRITE VL::MEMBER-OF-VL-MODULE->NAME-IN-VL-MODULELIST->NAMES))
 (24876 1216 (:REWRITE VL::SETP-OF-CDR))
 (19710 24 (:REWRITE SET::INSERT-IDENTITY))
 (18906 12 (:REWRITE SET::IN-MERGESORT-UNDER-IFF))
 (15438 1671 (:REWRITE SUBSETP-CAR-MEMBER))
 (11117 2210 (:REWRITE VL::SUBSETP-EQUAL-WHEN-CDR-ATOM))
 (8870 82 (:REWRITE SET::IN-TAIL))
 (8660 12 (:DEFINITION SET::INSERT))
 (5578 5578 (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-CONS-LISTP))
 (4180 4180 (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
 (4012 2058 (:REWRITE VL::VL-MODULE-P-WHEN-VL-MAYBE-MODULE-P))
 (3921 6 (:REWRITE VL::LEN-OF-MERGESORT-WHEN-NO-DUPLICATESP-EQUAL))
 (3659 78 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
 (3528 64 (:REWRITE VL::VL-MODULE-P-OF-CAR-WHEN-VL-MODULELIST-P))
 (3218 792 (:REWRITE SET::DOUBLE-CONTAINMENT))
 ...
 (643 74 (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
...
(VL::VL-MODULELIST->NAMES-OF-INSERT
 (82738 116 (:DEFINITION SET::MERGESORT))
 (40924 294 (:REWRITE SET::INSERT-IDENTITY))
 (33979 3608 (:REWRITE SET::DOUBLE-CONTAINMENT))
 (30365 3441 (:REWRITE VL::SUBSETP-EQUAL-WHEN-CDR-ATOM))
 (27673 4948 (:REWRITE SET::SFIX-WHEN-EMPTY))
 (26027 5913 (:REWRITE <<-TRANSITIVE))
 (24862 2399 (:REWRITE SUBSETP-CAR-MEMBER))
 (24683 2986 (:REWRITE SET::TAIL-WHEN-EMPTY))
 (18174 1940 (:REWRITE SET::HEAD-WHEN-EMPTY))
 (16242 16242 (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-CONS-LISTP))
 (16070 150 (:DEFINITION SET::SFIX))
 (15718 88 (:REWRITE SET::IN-MERGESORT-UNDER-IFF))
 ...
 (7485 3 (:DEFINITION SET::SUBSET))
 (7218 176 (:REWRITE VL::MEMBER-OF-VL-MODULE->NAME-IN-VL-MODULELIST->NAMES))
 ...
 (4598 1940 (:REWRITE SET::IN-TAIL-OR-HEAD))
 (4596 84 (:REWRITE SET::SUBSET-IN-2))
 ...
 (2098 31 (:REWRITE VL::VL-MODULELIST-P-OF-CDR-WHEN-VL-MODULELIST-P))
 ...
 (948 6 (:REWRITE SET::EMPTY-SUBSET-2))
 ...
 (491 6 (:REWRITE SET::EMPTY-SUBSET))
...
(VL::VL-MODULELIST->NAMES-OF-MERGESORT
 (4976 67 (:REWRITE VL::NO-DUPLICATESP-EQUAL-WHEN-SAME-LENGTH-MERGESORT))
 (3830 124 (:REWRITE VL::SETP-OF-VL-MODULELIST->NAMES-WHEN-NO-DUPLICATES))
 (3515 114 (:REWRITE SET::MERGESORT-SET-IDENTITY))
 (3364 70 (:REWRITE SET::INSERT-IDENTITY))
 (1918 103 (:REWRITE VL::MEMBER-OF-VL-MODULE->NAME-IN-VL-MODULELIST->NAMES))
 ...
 (1241 187 (:REWRITE VL::PROMOTE-MEMBER-EQUAL-TO-MEMBERSHIP))
...
(VL::SETP-OF-VL-MODULELIST->NAMES-OF-MERGESORT
 (365 3 (:DEFINITION SET::MERGESORT))
 (278 7 (:REWRITE SET::MERGESORT-SET-IDENTITY))
 (265 5 (:REWRITE VL::NO-DUPLICATESP-EQUAL-WHEN-SAME-LENGTH-MERGESORT))
 (261 6 (:REWRITE VL::SETP-OF-VL-MODULELIST->NAMES-WHEN-NO-DUPLICATES))
 (152 3 (:REWRITE SET::INSERT-IDENTITY))
 (149 3 (:REWRITE SET::IN-MERGESORT-UNDER-IFF))
 ...
 (76 4 (:REWRITE VL::MEMBER-OF-VL-MODULE->NAME-IN-VL-MODULELIST->NAMES))
