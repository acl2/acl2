...
(VL::PARSE-VL-GATHER-OPTS-AUX
 ...
 (1478 14
       (:REWRITE VL::STRINGP-WHEN-TRUE-LISTP))
 (1353 3 (:REWRITE SUBLISTP-WHEN-PREFIXP))
 (1170 6 (:REWRITE PREFIXP-WHEN-EQUAL-LENGTHS))
 (876 12 (:REWRITE SUBSETP-OF-CONS))
 (837 211 (:REWRITE DEFAULT-CAR))
 (710 20 (:REWRITE TRUE-LISTP-WHEN-ATOM))
 (644 644
      (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
 (535 269 (:REWRITE DEFAULT-CDR))
 (505 101
      (:REWRITE VL::SUBSETP-EQUAL-WHEN-CDR-ATOM))
 (476 86 (:REWRITE SET::DOUBLE-CONTAINMENT))
 (410 20
      (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
