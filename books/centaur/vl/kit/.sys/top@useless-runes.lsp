...
(VL::VL-HELP-FN
 (312 3 (:REWRITE VL::STRING-LISTP-WHEN-NO-NILS-IN-VL-MAYBE-STRING-LISTP))
 (268 1 (:REWRITE VL::STRINGP-WHEN-TRUE-LISTP))
 (231 3 (:REWRITE STRING-LISTP-WHEN-NOT-CONSP))
 (230 2 (:REWRITE MEMBER-WHEN-ATOM))
 (149 3 (:REWRITE TRUE-LISTP-WHEN-ATOM))
...
(VL::VL-MAIN-FN
 ...
 (548 2 (:REWRITE VL::STRINGP-WHEN-TRUE-LISTP))
 (298 4 (:REWRITE TRUE-LISTP-WHEN-ATOM))
