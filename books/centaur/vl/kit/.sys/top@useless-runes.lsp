...
(VL::VL-HELP-FN
 (310 3 (:REWRITE VL::STRING-LISTP-WHEN-NO-NILS-IN-VL-MAYBE-STRING-LISTP))
 (267 1 (:REWRITE VL::STRINGP-WHEN-TRUE-LISTP))
 (229 3 (:REWRITE STRING-LISTP-WHEN-NOT-CONSP))
 (228 2 (:REWRITE MEMBER-WHEN-ATOM))
 (148 3 (:REWRITE TRUE-LISTP-WHEN-ATOM))
 (53 4 (:REWRITE VL::PROMOTE-MEMBER-EQUAL-TO-MEMBERSHIP))
 (46 3 (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
 (43 1 (:DEFINITION TRUE-LIST-LISTP))
 (35 5 (:REWRITE OMAP::SETP-WHEN-MAPP))
...
(VL::VL-MAIN-FN
 (884 116 (:REWRITE SET::DOUBLE-CONTAINMENT))
 (546 2 (:REWRITE VL::STRINGP-WHEN-TRUE-LISTP))
 (296 4 (:REWRITE TRUE-LISTP-WHEN-ATOM))
