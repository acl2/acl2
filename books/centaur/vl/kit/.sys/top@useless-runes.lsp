...
(VL::VL-HELP-FN
 (290 3 (:REWRITE VL::STRING-LISTP-WHEN-NO-NILS-IN-VL-MAYBE-STRING-LISTP))
 (253 1 (:REWRITE VL::STRINGP-WHEN-TRUE-LISTP))
 (235 3 (:REWRITE STRING-LISTP-WHEN-NOT-CONSP))
 (234 2 (:REWRITE MEMBER-WHEN-ATOM))
...
(VL::VL-MAIN-FN
 ...
 (518 2 (:REWRITE VL::STRINGP-WHEN-TRUE-LISTP))
