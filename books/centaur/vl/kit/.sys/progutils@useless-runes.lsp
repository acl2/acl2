...
(VL::SPLIT-PLUSARGS-EXEC
 (1667 122 (:REWRITE VL::SUBSETP-EQUAL-WHEN-FIRST-TWO-SAME-YADA-YADA))
 (1122 30 (:REWRITE VL::STRINGP-WHEN-TRUE-LISTP))
 (919 14 (:REWRITE STR::EXPLODE-WHEN-NOT-STRINGP))
 (793 137 (:REWRITE DEFAULT-CAR))
 ...
 (457 26 (:REWRITE VL::STRING-LISTP-WHEN-NO-NILS-IN-VL-MAYBE-STRING-LISTP))
