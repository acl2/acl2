...
(NTH-OPEN-QUOTEP (111 6 (:REWRITE NTH-WHEN-TOO-LARGE-CHEAP))
...
(4V-SEXPR-APPLY (90 45 (:REWRITE DEFAULT-+-2))
                (90 15
...
(4V-SEXPR-EVAL)
(4V-SEXPR-EVAL-REDEF (5035 260 (:REWRITE NTH-WHEN-TOO-LARGE-CHEAP))
...
(4V-FIX-4V-SEXPR-EVAL (671 2 (:DEFINITION 4V-SEXPR-EVAL))
                      (303 303
...
(4V-SEXPR-EVAL-ALIST)
(4V-SEXPR-EVAL-ALIST1-REMOVAL (2550 6 (:DEFINITION 4V-SEXPR-EVAL))
                              (1242 1242
                                    (:TYPE-PRESCRIPTION 4V-SEXPR-EVAL-LIST))
...
(4V-SEXPR-EVAL-ALIST (2975 7 (:DEFINITION 4V-SEXPR-EVAL))
                     (1449 1449
                           (:TYPE-PRESCRIPTION 4V-SEXPR-EVAL-LIST))
...
(LOOKUP-SEXPR-EVAL-ALIST
     ...
     (48 48
         (:REWRITE HONS-ASSOC-EQUAL-WHEN-FOUND-BY-FAL-FIND-ANY)))
(4V-SEXPR-EVAL-ALIST-APPEND (8075 19 (:DEFINITION 4V-SEXPR-EVAL))
                            (3933 3933
                                  (:TYPE-PRESCRIPTION 4V-SEXPR-EVAL-LIST))
...
(4V-SEXPR-EVAL-ALISTS1-REMOVAL (2646 6 (:DEFINITION 4V-SEXPR-EVAL-ALIST))
                               ...
                               (6 6
                                  (:REWRITE HONS-ASSOC-EQUAL-WHEN-ATOM)))
(4V-SEXPR-EVAL-ALISTS (2213 5 (:DEFINITION 4V-SEXPR-EVAL-ALIST))
...
(4V-SEXPR-EVAL-LIST-LIST1-REMOVAL (42 6 (:DEFINITION 4V-SEXPR-EVAL-LIST))
                                  (24 6 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
                                  (12 12 (:TYPE-PRESCRIPTION ALISTP))
                                  (12 12 (:REWRITE DEFAULT-CAR))
                                  (10 10 (:REWRITE DEFAULT-CDR))
                                  (6 6 (:REWRITE ALISTP-WHEN-ATOM)))
(4V-SEXPR-EVAL-LIST-LIST (43 5 (:DEFINITION 4V-SEXPR-EVAL-LIST))
...
(4V-SEXPR-RESTRICT-ALIST1-REMOVAL (48 6 (:DEFINITION 4V-SEXPR-RESTRICT))
                                  ...
                                  (6 6 (:REWRITE ALISTP-WHEN-ATOM))
                                  (6 6 (:DEFINITION HONS)))
(4V-SEXPR-RESTRICT-ALIST (56 7 (:DEFINITION 4V-SEXPR-RESTRICT))
                         (44 7 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
...
(4V-SEXPR-COMPOSE-ALIST1-REMOVAL (48 6 (:DEFINITION 4V-SEXPR-COMPOSE))
                                 (34 34 (:REWRITE DEFAULT-CAR))
                                 (26 26 (:REWRITE DEFAULT-CDR))
                                 (24 6 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
                                 (12 12 (:TYPE-PRESCRIPTION ALISTP))
                                 ...
                                 (6 6 (:REWRITE ALISTP-WHEN-ATOM))
                                 (6 6 (:DEFINITION HONS)))
(4V-SEXPR-COMPOSE-ALIST (56 7 (:DEFINITION 4V-SEXPR-COMPOSE))
                        (44 7 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
                        (35 35 (:REWRITE DEFAULT-CDR))
                        (35 35 (:REWRITE DEFAULT-CAR))
                        (22 22 (:TYPE-PRESCRIPTION ALISTP))
...
(ALIST-KEYS-4V-SEXPR-COMPOSE-ALIST
     ...
     (9 9 (:REWRITE HONS-ASSOC-EQUAL-WHEN-ATOM))
     (9 9 (:DEFINITION HONS)))
(4V-SEXPR-COMPOSE-ALIST-APPEND (189 99 (:REWRITE DEFAULT-CDR))
...
(ALIST-EQUIV-IMPLIES-EQUAL-4V-SEXPR-ALIST-EXTRACT-2
     ...
     (12 12 (:REWRITE DEFAULT-CAR)))
(4V-LOOKUP-DEFAULT)
(4VP-OF-4V-LOOKUP-DEFAULT (34 8 (:REWRITE 4V-FIX-WHEN-4VP))
                          (27 27
                              (:REWRITE HONS-ASSOC-EQUAL-WHEN-ATOM))
                          (14 14 (:REWRITE DEFAULT-CDR)))
(4V-FIX-4V-LOOKUP-DEFAULT (28 5 (:REWRITE 4V-FIX-WHEN-4VP))
                          (9 9 (:REWRITE HONS-ASSOC-EQUAL-WHEN-ATOM))
...
(4V-SEXPR-EVAL-DEFAULT-ALISTS1-REMOVAL
     (96 6
         (:DEFINITION 4V-SEXPR-EVAL-DEFAULT-ALIST))
     (48 12 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
     (30 30 (:REWRITE DEFAULT-CAR))
     (24 24 (:TYPE-PRESCRIPTION ALISTP))
     (22 22 (:REWRITE DEFAULT-CDR))
     (12 12 (:REWRITE ALISTP-WHEN-ATOM)))
(4V-SEXPR-EVAL-DEFAULT-ALIST (44 7 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
                             (28 28 (:REWRITE DEFAULT-CAR))
                             (22 22 (:TYPE-PRESCRIPTION ALISTP))
                             (21 21 (:REWRITE DEFAULT-CDR))
                             (16 4 (:REWRITE ALISTP-OF-CDR))
                             (11 11 (:REWRITE ALISTP-WHEN-ATOM)))
(4V-SEXPR-EVAL-DEFAULT-ALISTS (88 5
                                  (:DEFINITION 4V-SEXPR-EVAL-DEFAULT-ALIST))
                              (48 10 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
