...
(UPDATE-DEPTABLE (6 3
                    (:TYPE-PRESCRIPTION REDUNDANT-APPEND)))
...
(TRACE-LOOP)
(SEXPR-DFS (136 136 (:REWRITE DEFAULT-CDR))
...
(SEXPR-DFS (64 1 (:DEFINITION SEXPR-DFS))
           (24 24
               (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
           (24 10
               (:REWRITE HONS-ASSOC-EQUAL-WHEN-ATOM))
...
(SEXPR-FIXPOINTS)
(NAT-VAL-ALISTP)
(TRANSLATE-DOMAIN (8 1 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
                  (6 6
                     (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
                  (4 4 (:REWRITE DEFAULT-CAR))
                  (4 1
