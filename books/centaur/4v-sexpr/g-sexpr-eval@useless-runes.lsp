...
(NO-DUPLICATESP-NUMLIST (75 3 (:DEFINITION MEMBER-EQUAL))
...
(NOT-MEMBER-NUMLIST-WHEN-NOT-NUMBER
     ...
     (28 4
         (:REWRITE NOT-MEMBER-NUMLIST-WHEN-LESS-THAN-START))
     (26 26
         (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
     (23 1 (:REWRITE SUBSETP-OF-CONS))
...
(GOOD-SVARMAP-NUM-VARMAP1
     ...
     (1 1 (:DEFINITION IFF)))
(GOOD-SVARMAP-NUM-VARMAP (41 2 (:DEFINITION NUMLIST))
                         (18 2 (:REWRITE ZP-OPEN))
...
(MY-EVENP (8 8
          ...
          (1 1 (:META CANCEL_TIMES-EQUAL-CORRECT))
          (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(MY-EVENP-INTEGER-HALF (5 5 (:REWRITE ZP-OPEN))
                       ...
                       (2 2 (:REWRITE NATP-RW)))
(NOT-MY-EVENP-INTEGERP-MINUS-HALF (8 8 (:REWRITE DEFAULT-+-2))
                                  (8 8 (:REWRITE DEFAULT-+-1))
                                  (5 5 (:REWRITE ZP-OPEN))
                                  (5 5 (:META CANCEL_TIMES-EQUAL-CORRECT))
                                  (5 5 (:META CANCEL_PLUS-EQUAL-CORRECT))
                                  ...
                                  (4 4 (:REWRITE DEFAULT-*-1))
                                  (2 2 (:REWRITE NATP-RW)))
(MY-EVENP-INTEGERP-HALF-DIFF (6 6
                                (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(SVAR-ASSOC-NUM-VARMAP (294 8 (:REWRITE NTH-WHEN-TOO-LARGE-CHEAP))
...
(NATP-IND (3 3
             (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(MY-EVENP-*-2 (11 2 (:REWRITE ZP-OPEN))
              (9 9
                 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(NOT-MY-EVENP-*-2-+-1 (8 8
                      ...
                      (1 1 (:REWRITE ZP-OPEN))
                      (1 1 (:DEFINITION FIX)))
(NOT-MY-EVENP-DIFF-TIMES-2-+-1 (9 5 (:REWRITE DEFAULT-*-2))
                               (8 8
                                  (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                               (7 6 (:REWRITE DEFAULT-+-2))
                               (7 6 (:REWRITE DEFAULT-+-1))
...
(NAT-*-2-LTE-1 (4 1 (:REWRITE X*Y>1-POSITIVE))
               (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
               (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT))
               (2 2 (:REWRITE DEFAULT-<-2))
               (2 2 (:REWRITE DEFAULT-<-1))
               ...
               (1 1 (:REWRITE DEFAULT-*-2))
               (1 1 (:REWRITE DEFAULT-*-1)))
(L0 (30 2 (:DEFINITION MEMBER-EQUAL))
    (12 12
        (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
...
(LEN-OF-EACH)
(APPEND-LISTS (20 1 (:DEFINITION TRUE-LISTP))
              (12 2
                  (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
...
(LEN-4V-SEXPR-EVAL-LIST (708 1 (:DEFINITION 4V-SEXPR-EVAL))
...
(4V->FAIG-CONST-OF-BOOL-TO-4V-GL (3 2 (:REWRITE DEFAULT-CDR))
                                 (3 2 (:REWRITE DEFAULT-CAR))
                                 (1 1 (:META CANCEL_TIMES-EQUAL-CORRECT))
                                 (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(FAIG-CONST->4V-EQUAL-X-GL)
(FAIG-CONST->4V-EQUAL-T-GL (5 5 (:META CANCEL_TIMES-EQUAL-CORRECT))
                           (5 5 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(FAIG-CONST->4V-EQUAL-F-GL (5 5 (:META CANCEL_TIMES-EQUAL-CORRECT))
                           (5 5 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(4V->FAIG-CONST-OF-FAIG-CONST->4V-GL)
(4VP-OF-FAIG-CONST->4V-REWRITE)
(EQUAL-OF-BOOL-TO-4V-1 (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
                       (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(EQUAL-OF-BOOL-TO-4V-2 (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
                       (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(EQUAL-OF-FAIG-CONST->4V-1 (14 14 (:META CANCEL_TIMES-EQUAL-CORRECT))
                           (14 14 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(EQUAL-OF-FAIG-CONST->4V-2 (14 14 (:META CANCEL_TIMES-EQUAL-CORRECT))
                           (14 14 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(4V-TO-NAT-CONS)
(4V-TO-NAT-REDEF (486 36 (:REWRITE SUBSETP-CAR-MEMBER))
                 (216 40
                      (:REWRITE SUBSETP-IMPLIES-SUBSETP-CDR))
