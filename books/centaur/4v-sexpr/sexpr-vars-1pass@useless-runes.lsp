...
(HELPER-1 (1622 41 (:DEFINITION MEMBER-EQUAL))
...
(HELPER-2 (100 2 (:DEFINITION 4V-SEXPR-VARS-LIST))
...
(MAIN-COROLLARY (10 2 (:DEFINITION 4V-SEXPR-VARS))
                (9 1
                   (:DEFINITION 4V-SEXPR-VARS-1PASS-EXEC))
                (6 6
                   (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
...
(L0 (386 25 (:DEFINITION BINARY-APPEND))
    (338 338
         (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
    (299 50
         (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV))
...
(4V-SEXPR-VARS-1PASS-LIST-LIST-EXEC-CORRECT
     ...
     (22 22
         (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
     (20 1
         (:DEFINITION 4V-SEXPR-VARS-1PASS-LIST-LIST-EXEC))
