...
(STR::STRJOIN (5 5 (:TYPE-PRESCRIPTION CONSP-REVERSE)))
...
(STRING-LISTP-OF-VERILOG-LOOP-FROM-TRANSLATED-LOOP
 ...
 (10 1
     (:REWRITE VL2014::CAR-OF-VL-EMODWIRELIST->BASENAMES))
...
(STRING-LIST-LISTP-OF-VERILOG-LOOPS-FROM-TRANSLATED-LOOPS-AUX
     ...
     (79 79
         (:TYPE-PRESCRIPTION VERILOG-LOOPS-FROM-TRANSLATED-LOOPS-AUX))
...
(VERILOG-SUMMARIZE-TRANSLATED-LOOPS
 ...
 (202 1
      (:REWRITE SET::IN-MERGESORT-UNDER-IFF))
 (193 11
      (:DEFINITION VERILOG-LOOPS-FROM-TRANSLATED-LOOPS-AUX))
