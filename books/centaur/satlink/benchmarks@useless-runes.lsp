(SATLINK::GATHER-BENCHMARKS-HOOK
 (1716 858 (:TYPE-PRESCRIPTION LRAT::NTH-N59-LISTP))
 (1716 858 (:TYPE-PRESCRIPTION LRAT::NTH-I60-LISTP))
 (858 858 (:TYPE-PRESCRIPTION LRAT::N59-LISTP))
 (858 858 (:TYPE-PRESCRIPTION LRAT::I60-LISTP))
