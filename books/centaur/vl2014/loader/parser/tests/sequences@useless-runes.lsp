...
(VL2014::VL-PRETTY-DISTITEM
 ...
 (1
  1
  (:REWRITE
    VL2014::VL-DISTITEM->WEIGHT$INLINE-OF-VL-DISTITEM-FIX-X-NORMALIZE-CONST))
 (1
  1
  (:REWRITE
      VL2014::VL-DISTITEM->TYPE$INLINE-OF-VL-DISTITEM-FIX-X-NORMALIZE-CONST))
 (1
  1
  (:REWRITE
     VL2014::VL-DISTITEM->RIGHT$INLINE-OF-VL-DISTITEM-FIX-X-NORMALIZE-CONST))
 (1
  1
  (:REWRITE
     VL2014::VL-DISTITEM->LEFT$INLINE-OF-VL-DISTITEM-FIX-X-NORMALIZE-CONST)))
...
(VL2014::VL-PRETTY-CYCLEDELAYRANGE
 (1
  1
  (:REWRITE
   VL2014::VL-CYCLEDELAYRANGE->RIGHT$INLINE-OF-VL-CYCLEDELAYRANGE-FIX-X-NORMALIZE-CONST))
 (1
  1
  (:REWRITE
   VL2014::VL-CYCLEDELAYRANGE->LEFT$INLINE-OF-VL-CYCLEDELAYRANGE-FIX-X-NORMALIZE-CONST)))
...
(VL2014::VL-PRETTY-REPETITION
 (1
  1
  (:REWRITE
   VL2014::VL-REPETITION->RIGHT$INLINE-OF-VL-REPETITION-FIX-X-NORMALIZE-CONST))
 (1
  1
  (:REWRITE
   VL2014::VL-REPETITION->LEFT$INLINE-OF-VL-REPETITION-FIX-X-NORMALIZE-CONST)))
