...
(VL2014::CHARACTER-LISTP-OF-VL-URL-ENCODE-CHAR
     ...
     (67 15 (:REWRITE STR::DIGIT-LISTP-OF-CONS))
...
(VL2014::VL-URL-ENCODE-CHAR-OF-CHAR-FIX-X-NORMALIZE-CONST)
...
(VL2014::TEST (3 3
                 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(VL2014::L0
     (104 12 (:REWRITE VL2014::NATP-WHEN-POSP))
...
(VL2014::CHARACTER-LISTP-OF-VL-URL-ENCODE-CHARS-AUX
     ...
     (10 10
         (:REWRITE MEMBER-EQUAL-WHEN-ALL-EQUALP))
     (10 2 (:REWRITE STR::DIGIT-LISTP-OF-REV))
...
(VL2014::VL-URL-ENCODE-CHARS$INLINE-OF-MAKE-CHARACTER-LIST-X-NORMALIZE-CONST)
...
(VL2014::VL-URL-ENCODE-STRING$INLINE-OF-STR-FIX-X-NORMALIZE-CONST)
