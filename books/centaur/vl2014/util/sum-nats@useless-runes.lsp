...
(VL2014::NLP-BADGUY-UNDER-IFF
     (1876 56 (:REWRITE VL2014::NATP-WHEN-POSP))
...
(VL2014::NLP-BADGUY-MEMBER
    ...
    (12 1
        (:REWRITE VL2014::VL-MAYBE-NAT-LISTP-OF-CONS))
...
(VL2014::NLP-BADGUY-BAD
     (1034 30 (:REWRITE VL2014::NATP-WHEN-POSP))
...
(VL2014::SUM-NATS-OF-REV
 ...
 (2368 56 (:REWRITE VL2014::NAT-LISTP-OF-REV))
 (1910 1910
       (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-CONS-LISTP))
 (1910 1910
       (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
...
(VL2014::SUM-NATS-OF-REVERSE
   (356 2 (:DEFINITION VL2014::SUM-NATS))
   (310 2 (:DEFINITION NFIX))
   (140 4 (:REWRITE VL2014::NEGATIVE-WHEN-NATP))
   (118 6 (:REWRITE VL2014::INTEGERP-WHEN-NATP))
...
(VL2014::MAX-NATS-OF-CONS
     ...
     (226 30
          (:REWRITE VL2014::MAX-NATS-WHEN-ATOM))
     (196 28
          (:REWRITE NATP-OF-CAR-WHEN-NAT-LISTP))
     (196 28
          (:LINEAR LOWER-BOUND-OF-CAR-WHEN-NAT-LISTP))
...
(VL2014::MAX-NATS-OF-REV
 ...
 (3024 72 (:REWRITE VL2014::NAT-LISTP-OF-REV))
 (2572 2572
       (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-CONS-LISTP))
 (2572 2572
       (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
...
(VL2014::NAT-LISTP-OF-NATS-FROM
     ...
     (172 172
          (:REWRITE INTEGERP-WHEN-MEMBER-EQUAL-OF-INTEGER-LISTP))
     (154 154
          (:TYPE-PRESCRIPTION VL2014::TRUE-LISTP-OF-NATS-FROM))
...
(VL2014::MEMBER-EQUAL-NATS-FROM
     ...
     (747 38
          (:REWRITE VL2014::CONSP-OF-NATS-FROM))
     (724 528
          (:REWRITE INTEGERP-WHEN-MEMBER-EQUAL-OF-INTEGER-LISTP))
     (666 420
          (:REWRITE NATP-WHEN-MEMBER-EQUAL-OF-NAT-LISTP))
...
(VL2014::NO-DUPLICATESP-EQUAL-OF-NATS-FROM
     ...
     (4 4
        (:REWRITE ACL2-NUMBERP-WHEN-MEMBER-EQUAL-OF-ACL2-NUMBER-LISTP)))
(VL2014::IND (50 8 (:REWRITE VL2014::INTEGERP-WHEN-NATP))
             (46 4 (:REWRITE VL2014::NATP-WHEN-POSP))
             (22 4 (:REWRITE NATP-RW))
             (18 18 (:TYPE-PRESCRIPTION NATP))
...
(VL2014::SETP-OF-NATS-FROM
  ...
  (65 65
      (:REWRITE VL2014::NAT-LISTP-OF-NATS-FROM))
