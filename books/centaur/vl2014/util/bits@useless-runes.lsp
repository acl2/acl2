...
(VL2014::NTH-OF-VL-BITLIST-FIX
     ...
     (124 24
          (:REWRITE VL2014::VL-BITLIST-P-OF-CDR-WHEN-VL-BITLIST-P))
     (112 11
          (:REWRITE VL2014::VL-BIT-P-OF-NTH-WHEN-VL-BITLIST-P))
     (106 106
          (:REWRITE VL2014::VL-BITLIST-P-WHEN-SUBSETP-EQUAL))
     (32 32
         (:TYPE-PRESCRIPTION VL2014::VL-BIT-P))
     ...
     (2 2
        (:REWRITE-QUOTED-CONSTANT VL2014::VL-BIT-FIX-UNDER-VL-BIT-EQUIV)))
...
(VL2014::VL-BITLIST-EQUIV-IMPLIES-VL-BITLIST-EQUIV-TAKE-2
 ...
 (234 234
      (:REWRITE VL2014::VL-BITLIST-P-WHEN-SUBSETP-EQUAL))
 (215 23
      (:REWRITE VL2014::VL-BITLIST-P-OF-TAKE))
 (135 117
      (:REWRITE VL2014::VL-BITLIST-P-WHEN-NOT-CONSP))
 (64 64
     (:TYPE-PRESCRIPTION VL2014::VL-BIT-P))
...
(VL2014::VL-BITLIST->CHARLIST-EXEC-REMOVAL (5 5 (:REWRITE DEFAULT-CDR))
