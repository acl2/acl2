...
(VL2014::PREFIX-LEN-OF-TAKE
     ...
     (2328 186
           (:REWRITE PREFIXP-WHEN-NOT-CONSP-RIGHT))
     (1465 1465 (:TYPE-PRESCRIPTION TRUE-LISTP))
     ...
     (1238 1238
           (:LINEAR LISTPOS-UPPER-BOUND-STRONG-2))
     (1238 1238 (:LINEAR LEN-WHEN-PREFIXP))
     (1034 349 (:REWRITE SET::DOUBLE-CONTAINMENT))
     (983 983 (:REWRITE CONSP-OF-CDR-BY-LEN))
     (947 909 (:REWRITE DEFAULT-CDR))
     (868 62 (:REWRITE APPEND-UNDER-IFF))
     (789 100 (:REWRITE TAKE-OF-LEN-FREE))
     (770 265 (:REWRITE DEFAULT-CAR))
     (619 619 (:LINEAR LEQ-POSITION-EQUAL-LEN))
     (619 619 (:LINEAR INDEX-OF-<-LEN))
     (619 619
          (:LINEAR STR::COUNT-LEADING-CHARSET-LEN))
     ...
     (410 100 (:REWRITE TAKE-WHEN-ATOM))
     ...
     (155 110 (:REWRITE DEFAULT-<-1))
     (154 110 (:REWRITE DEFAULT-<-2))
     (122 98 (:REWRITE ZP-OPEN))
