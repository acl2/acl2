...
(BED::BITP-OF-BED-EVAL
 (16 16 (:REWRITE DEFAULT-CDR))
 (13 13 (:REWRITE DEFAULT-CAR))
 (3 1 (:REWRITE BED::BED-OP-FIX-WHEN-BED-OP-P))
 (2 2 (:TYPE-PRESCRIPTION BED::BED-OP-P))
 (2 2 (:REWRITE BED::BED-OP-EVAL-WHEN-FIX-IS-EXACT))
 )
(BED::BED-EVAL
 (28 2 (:DEFINITION BED::BED-EVAL))
 (12 12 (:REWRITE DEFAULT-CDR))
 (12 12 (:REWRITE DEFAULT-CAR))
 (9 3 (:REWRITE BED::BED-OP-FIX-WHEN-BED-OP-P))
 (6 6 (:TYPE-PRESCRIPTION BED::BED-OP-P))
 (4 4 (:REWRITE BED::BED-OP-EVAL-WHEN-FIX-IS-EXACT))
 (4 2 (:REWRITE BED::BED-OP-EVAL-OF-BED-OP-FIX))
 )
