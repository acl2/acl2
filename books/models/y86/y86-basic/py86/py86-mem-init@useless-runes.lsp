(RMBYTES (156 78 (:TYPE-PRESCRIPTION NATP-NTH-OF-RGF))
...
(M86-CLEAR-MEM-DWORD-ADDR (200 100
                          ...
                          (2 2 (:REWRITE ZP-OPEN))
                          (1 1 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE)))
(M86-CLEAR-MEM-DWORD-ADDR-PRESERVES-X86-32P (12 12 (:LINEAR INDEX-OF-<-LEN))
...
(M86-CLEAR-MEM (112 56 (:TYPE-PRESCRIPTION NATP-NTH-OF-RGF))
...
(M86-MEM-UPDATES-PRESERVES-X86-32P
     ...
     (16 8
         (:REWRITE CONSP-OF-CAR-WHEN-ATOM-LISTP)))
(M32-GET-REGS-AND-FLAGS (40 20 (:TYPE-PRESCRIPTION NATP-NTH-OF-RGF))
                        (16 8 (:TYPE-PRESCRIPTION NATP-RGFI))
                        (2 1 (:TYPE-PRESCRIPTION NATP-EIP)))
(M86-CLEAR-REGS (40 20
                    (:TYPE-PRESCRIPTION NATP-NTH-OF-RGF)))
(M86-CLEAR-REGS-PRESERVES-X86-32P (20 10
                                      (:TYPE-PRESCRIPTION NATP-NTH-OF-RGF)))
(INIT-Y86-STATE (208 78 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
                ...
                (2 2
                   (:REWRITE DEFAULT-SYMBOL-PACKAGE-NAME))
                (2 2 (:LINEAR INDEX-OF-<-LEN)))
(INIT-Y86-STATE-PRESERVES-X86-32P (20 10
                                      (:TYPE-PRESCRIPTION NATP-NTH-OF-RGF)))
