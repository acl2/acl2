...
(NATP-MEMI-WHEN-N30P-ADDR (8 4 (:TYPE-PRESCRIPTION NATP-NTH-OF-RGF)))
...
(X86-32P-!FLG (460 230
              ...
              (1 1 (:LINEAR INDEX-OF-<-LEN))
              (1 1 (:DEFINITION UPDATE-NTH)))
(MEMP-UPDATE-NTH (8 8 (:REWRITE DEFAULT-<-2))
...
(RM08 (572 286
      ...
      (2 2
         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(RM16 (152 76 (:TYPE-PRESCRIPTION NATP-NTH-OF-RGF))
...
(RM32 (620 310
      ...
      (2 2
         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(NATP-RM08)
(RM08-LESS-THAN-EXPT-2-32 (92 46 (:TYPE-PRESCRIPTION NATP-NTH-OF-RGF))
...
(LOGIOR-ASH-BYTES-<-4294967296
     (2 2
        (:REWRITE GL::SHAPE-SPEC-OBJ-IN-RANGE-BACKCHAIN-INTEGER-2)))
(INTEGERP-RM16 (92 46 (:TYPE-PRESCRIPTION NATP-NTH-OF-RGF))
...
(ANOTHER-LOGAND-FACT
     (3 3
        (:REWRITE GL::SHAPE-SPEC-OBJ-IN-RANGE-BACKCHAIN-INTEGER-2)))
(WM08 (2189 1536 (:REWRITE DEFAULT-<-1))
...
(LOGIOR-ASH-BYTES-<-4294967296
     (4 4
        (:REWRITE GL::SHAPE-SPEC-OBJ-IN-RANGE-BACKCHAIN-INTEGER-2)))
(WM16 (2300 1612 (:REWRITE DEFAULT-<-1))
...
(HACK2 (2 2
          (:REWRITE GL::SHAPE-SPEC-OBJ-IN-RANGE-BACKCHAIN-INTEGER-2)))
(WM32 (31888 16675 (:REWRITE DEFAULT-<-1))
      (21127 21
             (:LINEAR N30P-LOGIOR-N30P-LESS-THAN-1073741824))
      (21127 21
             (:LINEAR N24P-LOGIOR-N24P-LESS-THAN-16777216))
...
(LOGIOR-<=-EXPT-2-TO-N
     ...
     (3 1
        (:LINEAR N01P-LOGIOR-N01P-LESS-THAN-2))
     (2 2 (:TYPE-PRESCRIPTION NATP)))
(LOGIOR-BOUND-2^32 (2 2 (:TYPE-PRESCRIPTION NATP)))
(HACK3 (2 2
          (:REWRITE GL::SHAPE-SPEC-OBJ-IN-RANGE-BACKCHAIN-INTEGER-2)))
(WM08-PRESERVES-X86-32P (20 10
                            (:TYPE-PRESCRIPTION NATP-NTH-OF-RGF)))
(WM16-PRESERVES-X86-32P (20 10
                            (:TYPE-PRESCRIPTION NATP-NTH-OF-RGF)))
(WM32-PRESERVES-X86-32P (20 10
                            (:TYPE-PRESCRIPTION NATP-NTH-OF-RGF)))
