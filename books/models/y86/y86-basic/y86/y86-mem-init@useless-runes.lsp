(RMBYTES (10 10 (:LINEAR INDEX-OF-<-LEN))
         (3 3 (:REWRITE DEFAULT-<-2))
         (3 3 (:REWRITE DEFAULT-<-1))
         (2 1 (:TYPE-PRESCRIPTION NATP-RM08))
         (1 1 (:REWRITE ZP-OPEN))
         (1 1 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE)))
(M86-CLEAR-MEM-DWORD-ADDR (20 20 (:LINEAR INDEX-OF-<-LEN))
...
(M86-CLEAR-MEM (26 26 (:REWRITE DEFAULT-<-2))
               (26 26 (:REWRITE DEFAULT-<-1))
               (10 10 (:LINEAR INDEX-OF-<-LEN))
               (2 2 (:REWRITE DEFAULT-+-2))
               (2 2 (:REWRITE DEFAULT-+-1)))
(M86-REGP)
(M86-REG-UPDATES (682 229
...
(M86-MEMP)
(M86-MEM-UPDATES (90 90 (:LINEAR INDEX-OF-<-LEN))
