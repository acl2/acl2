...
(M1::NATP-LIST)
(M1::ASSOC-OF-AP (358 358 (:TYPE-PRESCRIPTION M1::AP))
                 (57 3
...
(M1::LEN-NATS
     ...
     (18 18 (:TYPE-PRESCRIPTION M1::NATS))
...
(M1::PROD-AP (261 29 (:REWRITE ACL2-NUMBERP-X))
...
(M1::PROD-NATS
     ...
     (1 1 (:REWRITE |(< 0 (* x y))|)))
(M1::NTHCDR-AP
     (1190 1190 (:TYPE-PRESCRIPTION M1::AP))
     (494 17
          (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
     (458 295 (:REWRITE DEFAULT-PLUS-2))
     (403 51 (:REWRITE ACL2-NUMBERP-X))
...
(M1::HELPER2-ALT-DEF
     ...
     (122 108 (:REWRITE DEFAULT-LESS-THAN-2))
     (122 106
          (:REWRITE REMOVE-STRICT-INEQUALITIES))
     (118 118
          (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
     ...
     (101 87
          (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-<))
     (101 87 (:REWRITE PREFER-POSITIVE-ADDENDS-<))
