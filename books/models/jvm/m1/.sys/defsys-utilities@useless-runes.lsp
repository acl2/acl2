...
(M1::NUMBER-OF-EXPLICIT-ELEMENTS
 (3885 74 (:DEFINITION INTEGER-ABS))
 (1421 520 (:REWRITE DEFAULT-PLUS-1))
 (1359 520 (:REWRITE DEFAULT-PLUS-2))
 (1295 37 (:REWRITE |(+ (if a b c) x)|))
 (1147 37 (:REWRITE NUMERATOR-NEGATIVE))
 (370 37 (:DEFINITION LENGTH))
 (333 333 (:TYPE-PRESCRIPTION NUMERATOR-ZERO))
 (333 333 (:TYPE-PRESCRIPTION NUMERATOR-POSITIVE . 2))
 (333 333 (:TYPE-PRESCRIPTION NUMERATOR-POSITIVE . 1))
 (333 333 (:TYPE-PRESCRIPTION NUMERATOR-NEGATIVE . 2))
 (333 333 (:TYPE-PRESCRIPTION NUMERATOR-NEGATIVE . 1))
 (328 328 (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
 (321 126 (:REWRITE DEFAULT-LESS-THAN-1))
 (259 74 (:REWRITE DEFAULT-MINUS))
 (259 37 (:DEFINITION LEN))
 (176 44 (:REWRITE RATIONALP-X))
 (149 126 (:REWRITE DEFAULT-LESS-THAN-2))
 ...
 (126 124 (:REWRITE |(< c (/ x)) negative c --- obj t or nil|))
 ...
 (124 124 (:REWRITE |(< (- x) c)|))
 (124 124 (:REWRITE |(< (- x) (- y))|))
 (116 87 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-<))
 (116 87 (:REWRITE PREFER-POSITIVE-ADDENDS-<))
 (111 111 (:REWRITE |(< (/ x) 0)|))
 ...
 (37 37 (:REWRITE DEFAULT-RATIONAL-DENOMINATOR))
