...
(M5::INTP-F (4 4 (:REWRITE DEFAULT-<-2))
            (4 4 (:REWRITE DEFAULT-<-1))
            (4 4 (:META CANCEL_PLUS-LESSP-CORRECT))
            (1 1 (:REWRITE M5::INT-LEMMA0)))
(M5::POISED-AT-UNIVERSAL-LOOP)
(M5::UNIVERSAL-LOOP-SCHED (1 1
                             (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(M5::UNIVERSAL-LOOP-HINT (3 3
                            (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(M5::UNIVERSAL-LOOP-BEHAVIOR (1595 145 (:DEFINITION ASSOC-EQUAL))
...
(M5::UNIVERSAL-SCHED)
(M5::UNIVERSAL-IS-CORRECT (1897 1897 (:META CANCEL_TIMES-EQUAL-CORRECT))
                          ...
                          (180 6
                               (:DEFINITION M5::UNIVERSAL-LOOP-SCHED))
...
(M5::INT-FIX-NAT)
(M5::NATP-INT-FIX-NAT (10 3 (:REWRITE M5::INT-LEMMA0))
