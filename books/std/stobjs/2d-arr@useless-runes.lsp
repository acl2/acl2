(STOBJS::2DARR-INDEX (128 128 (:META CANCEL_PLUS-LESSP-CORRECT))
...
(STOBJS::2DARR-INDEX-IN-BOUNDS (88 34 (:REWRITE NATP-WHEN-GTE-0))
...
(STOBJS::2DARR-INDICES-SAME (542 112 (:REWRITE NFIX-WHEN-NOT-NATP))
...
(STOBJS::2DARR-INDEX-INVERSE (1 1 (:TYPE-PRESCRIPTION MOD-TYPE . 3))
...
(STOBJS::NONLINEAR-LEMMA (40 10 (:LINEAR X*Y>1-POSITIVE))
...
(STOBJS::2DARR-FIX (4 1 (:REWRITE NATP-WHEN-GTE-0))
...
(STOBJS::2DARR-P-OF-2DARR-FIX (9 1 (:REWRITE NFIX-WHEN-NATP))
                              ...
                              (1 1 (:REWRITE DEFAULT-<-1))
                              (1 1 (:META CANCEL_PLUS-LESSP-CORRECT)))
(STOBJS::2DARR-FIX-WHEN-2DARR-P (4 1 (:REWRITE NATP-WHEN-GTE-0))
                                (3 3 (:REWRITE DEFAULT-CDR))
                                (2 2 (:REWRITE DEFAULT-CAR))
                                (2 1 (:DEFINITION TRUE-LISTP))
                                (1 1 (:REWRITE NFIX-WHEN-NOT-NATP))
...
(STOBJS::2DARR->NCOLS-OF-2DARR-FIX
     (18 1
         (:REWRITE STOBJS::2DARR-FIX-WHEN-2DARR-P))
...
(STOBJS::SUBST-SUBSTRS (422 6 (:REWRITE SUBLISTP-WHEN-PREFIXP))
