...
(OPEN-INPUT-CHANNEL-P1-UNDER-OPEN-INPUT-CHANNEL
     ...
     (69 48 (:REWRITE DEFAULT-UNARY-MINUS))
...
(OPEN-INPUT-CHANNEL-P1-UNDER-CLOSE-OUTPUT-CHANNEL
     ...
     (1 1
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (1 1 (:REWRITE DEFAULT-+-1)))
(OPEN-INPUT-CHANNEL-P1-UNDER-READ-CHAR$ (35 35 (:REWRITE DEFAULT-CAR))
                                        ...
                                        (2 2 (:REWRITE SYMBOL-<-TRANSITIVE))
                                        (2 2 (:REWRITE SYMBOL-<-ASYMMETRIC)))
(OPEN-INPUT-CHANNEL-P1-UNDER-READ-BYTE$ (35 35 (:REWRITE DEFAULT-CAR))
                                        (30 6 (:DEFINITION ASSOC-EQUAL))
                                        (24 2 (:DEFINITION ADD-PAIR))
                                        (23 23 (:REWRITE DEFAULT-CDR))
                                        (2 2 (:TYPE-PRESCRIPTION SYMBOL-<))
                                        ...
                                        (2 2 (:REWRITE SYMBOL-<-TRANSITIVE))
                                        (2 2 (:REWRITE SYMBOL-<-ASYMMETRIC)))
(OPEN-INPUT-CHANNEL-P1-UNDER-READ-OBJECT (51 51 (:REWRITE DEFAULT-CAR))
...
(OPEN-INPUT-CHANNEL-P1-UNDER-SET-SERIALIZE-CHARACTER
     ...
     (3 3
        (:TYPE-PRESCRIPTION SET-SERIALIZE-CHARACTER)))
