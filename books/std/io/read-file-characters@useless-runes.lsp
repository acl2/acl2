...
(TR-READ-CHAR$-ALL-REMOVAL (4 1 (:REWRITE REV-WHEN-NOT-CONSP)))
(READ-CHAR$-ALL
     ...
     (14 14
         (:REWRITE CHARACTERP-WHEN-MEMBER-EQUAL-OF-CHARACTER-LISTP))
     (7 7
        (:REWRITE OPEN-INPUT-CHANNEL-P1-OF-READ-CHAR$))
...
(TYPE-OF-READ-FILE-CHARACTERS
     ...
     (2 2
        (:REWRITE STR::EXPLODE-WHEN-NOT-STRINGP)))
(READ-FILE-CHARACTERS-REV (13 4 (:REWRITE REV-WHEN-NOT-CONSP))
                          (4 4
                             (:REWRITE STR::EXPLODE-WHEN-NOT-STRINGP))
