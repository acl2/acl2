...
(STR::CHARACTER-LISTP-OF-INSERT-UNDERSCORES
     ...
     (59 10 (:REWRITE STR::DIGIT-LISTP-OF-CONS))
...
(STR::HEXIFY (116 16
             ...
             (68 16 (:REWRITE STR::DIGIT-LISTP-OF-CONS))
...
(STR::HEXIFY-WIDTH (1326 74 (:DEFINITION LEN))
                   ...
                   (30 8
                       (:REWRITE STR::DIGIT-LISTP-WHEN-NOT-CONSP))
                   (22 2 (:REWRITE STR::DIGIT-LISTP-OF-APPEND))
...
(STR::CHARACTER-LISTP-OF-NTHCDR
     ...
     (2 2
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (1 1 (:REWRITE CONSP-OF-CDDDR-BY-LEN)))
(STR::BINIFY-WIDTH (1326 74 (:DEFINITION LEN))
                   (890 148 (:REWRITE LEN-WHEN-ATOM))
                   (430 100 (:REWRITE DEFAULT-CDR))
                   (286 20 (:REWRITE NTHCDR-WHEN-ZP))
                   (218 126 (:REWRITE DEFAULT-+-2))
