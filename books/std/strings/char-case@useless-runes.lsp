(STR::UP-ALPHA-P$INLINE (3 3 (:REWRITE DEFAULT-<-2))
                        (3 3 (:REWRITE DEFAULT-<-1))
                        (1 1 (:REWRITE DEFAULT-CHAR-CODE)))
(STR::CHAREQV-IMPLIES-EQUAL-UP-ALPHA-P-1)
(STR::EXHAUSTIVE-TEST (3 3
                         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(STR::LEMMA1 (9 1 (:REWRITE STR::DEFAULT-CODE-CHAR))
...
(STR::LEMMA2 (205 65 (:REWRITE STR::DEFAULT-CODE-CHAR))
...
(STR::LEMMA3 (10 1 (:REWRITE STR::DEFAULT-CODE-CHAR))
...
(STR::LEMMA4)
(STR::LEMMA5 (4 4 (:REWRITE DEFAULT-CHAR-CODE))
             (4 4 (:REWRITE DEFAULT-<-2))
             (4 4 (:REWRITE DEFAULT-<-1))
             (1 1 (:REWRITE STR::LEMMA4)))
(STR::UPPER-CASE-P-IS-UP-ALPHA-P (4 4 (:REWRITE DEFAULT-<-2))
                                 (4 4 (:REWRITE DEFAULT-<-1))
                                 (3 3 (:REWRITE DEFAULT-CHAR-CODE)))
(STR::DOWN-ALPHA-P$INLINE (3 3 (:REWRITE DEFAULT-<-2))
                          (3 3 (:REWRITE DEFAULT-<-1))
                          (1 1 (:REWRITE DEFAULT-CHAR-CODE)))
...
(STR::LEMMA5 (4 4 (:REWRITE DEFAULT-CHAR-CODE))
             ...
             (4 4 (:REWRITE DEFAULT-<-1))
             (1 1 (:REWRITE STR::LEMMA4)))
(STR::LOWER-CASE-P-IS-DOWN-ALPHA-P (4 4 (:REWRITE DEFAULT-<-2))
                                   (4 4 (:REWRITE DEFAULT-<-1))
                                   (3 3 (:REWRITE DEFAULT-CHAR-CODE)))
(STR::DOWN-ALPHA-P-WHEN-UP-ALPHA-P)
(STR::UPCASE-CHAR$INLINE (19 17 (:REWRITE DEFAULT-<-1))
...
(STR::LEMMA1 (9 1 (:REWRITE STR::DEFAULT-CODE-CHAR))
             ...
             (1 1 (:REWRITE NATP-RW))
             (1 1 (:REWRITE DEFAULT-CODE-CHAR)))
(STR::LEMMA2 (515 122 (:REWRITE STR::DEFAULT-CODE-CHAR))
             ...
             (36 36 (:REWRITE NATP-RW)))
(STR::LEMMA3 (30 3 (:REWRITE STR::DEFAULT-CODE-CHAR))
             (26 26
                 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
             ...
             (4 4 (:REWRITE DEFAULT-+-2))
             (4 4 (:REWRITE DEFAULT-+-1)))
(STR::LEMMA4 (1 1 (:REWRITE STR::LEMMA3))
...
(STR::NOT-DOWN-ALPHA-P-OF-UPCASE-CHAR
     ...
     (6 6 (:REWRITE DEFAULT-+-2))
     (6 6 (:REWRITE DEFAULT-+-1)))
(STR::DOWNCASE-CHAR$INLINE (16 16 (:REWRITE DEFAULT-<-2))
...
(STR::DOWNCASE-CHAR-OF-DOWNCASE-CHAR
     ...
     (2 2
        (:REWRITE STR::EQUAL-OF-CODE-CODE-AND-CONSTANT)))
(STR::DOWNCASE-CHAR-OF-UPCASE-CHAR (83 11 (:REWRITE STR::DEFAULT-CODE-CHAR))
...
(STR::LEMMA1 (9 1 (:REWRITE STR::DEFAULT-CODE-CHAR))
             ...
             (1 1 (:REWRITE NATP-RW))
             (1 1 (:REWRITE DEFAULT-CODE-CHAR)))
(STR::LEMMA2 (431 122 (:REWRITE STR::DEFAULT-CODE-CHAR))
...
(STR::LEMMA3 (22 3 (:REWRITE STR::DEFAULT-CODE-CHAR))
...
(STR::LEMMA4 (1 1 (:REWRITE STR::LEMMA3))
             (1 1 (:REWRITE STR::LEMMA2)))
(STR::LEMMA5 (19 19 (:REWRITE DEFAULT-CHAR-CODE))
             (16 16 (:REWRITE DEFAULT-<-2))
             (16 16 (:REWRITE DEFAULT-<-1))
             ...
             (2 2 (:REWRITE NEGATIVE-WHEN-NATP))
             (1 1 (:REWRITE STR::LEMMA2)))
(STR::CHAR-DOWNCASE-IS-DOWNCASE-CHAR (16 2 (:REWRITE STR::DEFAULT-CODE-CHAR))
                                     (12 12 (:REWRITE DEFAULT-CHAR-CODE))
                                     (12 12 (:REWRITE DEFAULT-<-2))
