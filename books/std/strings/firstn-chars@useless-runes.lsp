...
(STR::FIRSTN-CHARS-AUX-REMOVAL
     ...
     (4 2 (:DEFINITION ATOM))
     (3 3 (:REWRITE NATP-RW)))
(STR::FIRSTN-CHARS (288 54 (:REWRITE LEN-WHEN-ATOM))
                   (210 1 (:DEFINITION STR::FIRSTN-CHARS-AUX))
                   (156 2 (:DEFINITION CHAR))
...
(STR::APPEND-FIRSTN-CHARS (252 46 (:REWRITE LEN-WHEN-ATOM))
...
(STR::STREQV-IMPLIES-EQUAL-APPEND-FIRSTN-CHARS-2
     (6 6
        (:TYPE-PRESCRIPTION STR::APPEND-FIRSTN-CHARS)))
...
(STR::CONSP-OF-FIRSTN-CHARS (132 7 (:DEFINITION LEN))
                            ...
                            (2 2 (:REWRITE POSP-RW))
                            (1 1 (:TYPE-PRESCRIPTION NFIX)))
(STR::CONSP-OF-FIRSTN-CHARS-OF-1 (57 3 (:DEFINITION LEN))
