...
(STR::UPCASE-FIRST
     ...
     (68 2 (:REWRITE NATP-POSP--1))
     (64 33 (:REWRITE DEFAULT-+-2))
     (64 2 (:REWRITE NATP-POSP))
     (59 35
         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
     (53 1
         (:REWRITE STR::MAKE-CHARACTER-LIST-WHEN-ATOM))
     (49 1 (:REWRITE CONSP-OF-TAKE))
     (44 44 (:REWRITE CONSP-OF-CDR-BY-LEN))
     (43 10 (:REWRITE DEFAULT-CAR))
...
(STR::ISTREQV-IMPLIES-ISTREQV-UPCASE-FIRST-1
     ...
     (26 26 (:REWRITE CONSP-OF-CDR-BY-LEN))
     (26 2 (:DEFINITION CHARACTER-LISTP))
     (25 4
         (:REWRITE STR::ICHARLISTEQV-WHEN-NOT-CONSP-RIGHT))
     (25 4
         (:REWRITE STR::ICHARLISTEQV-WHEN-NOT-CONSP-LEFT))
