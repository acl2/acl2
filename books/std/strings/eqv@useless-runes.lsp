...
(STR::CHARLISTEQV-IMPLIES-CHARLISTEQV-TAKE-2
 ...
 (734 734 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(STR::CHARLISTEQV-IMPLIES-CHARLISTEQV-NTHCDR-2
 (12134 86 (:REWRITE STR::MAKE-CHARACTER-LIST-WHEN-CHARACTER-LISTP))
 (11814 186 (:DEFINITION CHARACTER-LISTP))
 (9679 274 (:REWRITE CHARACTER-LISTP-OF-CDR-WHEN-CHARACTER-LISTP))
