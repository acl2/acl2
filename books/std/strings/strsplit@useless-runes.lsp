...
(STR::CHARACTER-LISTP-OF-SPLIT-LIST-1-1 (22 22 (:REWRITE DEFAULT-CAR))
                                        (11 11 (:REWRITE DEFAULT-CDR))
                                        (11 11 (:REWRITE CONSP-BY-LEN)))
(STR::SPLIT-LIST* (102 2 (:DEFINITION ACL2-COUNT))
...
(STR::STRING-LISTP-OF-COERCE-LIST-TO-STRINGS (8 7 (:REWRITE DEFAULT-CAR))
