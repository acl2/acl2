(STR::CHARLISTNAT< (191 42 (:REWRITE LEN-WHEN-ATOM))
                   (76 22
...
(STR::MY-INDUCTION)
(STR::LEMMA-2 (363 130 (:REWRITE LEN-WHEN-ATOM))
...
(STR::CHARLISTNAT<-TRICHOTOMY-WEAK
     ...
     (4 2 (:REWRITE STR::DIGIT-LISTP-OF-CONS))
