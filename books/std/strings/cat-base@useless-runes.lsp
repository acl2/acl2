...
(STR::REVAPPEND-CHARS-AUX (50 10 (:DEFINITION LEN))
...
(STR::NTHCDR-OF-NIL (6 2 (:REWRITE COMMUTATIVITY-OF-+))
                    (4 4 (:REWRITE ZP-OPEN))
                    (4 4 (:REWRITE DEFAULT-+-2))
                    (4 4 (:REWRITE DEFAULT-+-1)))
(STR::CONSP-NTHCDR (34 27 (:REWRITE DEFAULT-<-2))
...
(STR::CDR-OF-NTHCDR (148 6 (:REWRITE STR::CONSP-NTHCDR))
...
(STR::CAR-OF-NTHCDR (108 13 (:REWRITE DEFAULT-CAR))
...
(STR::REVAPPEND-CHARS$INLINE
     (38 38
         (:TYPE-PRESCRIPTION STR::REVAPPEND-CHARS-AUX))
     (10 2 (:DEFINITION LEN))
...
(STR::CHARACTER-LISTP-OF-REVAPPEND-CHARS (6 2 (:DEFINITION CHARACTER-LISTP))
