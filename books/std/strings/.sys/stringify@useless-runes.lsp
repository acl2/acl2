...
(STR::NOT-MEMBER-MINUS-CHAR-DEC-DIGIT-CHAR-LIST*P
...
(STR::SWITCH-COERCE-CONS-STRING
 (66 12 (:REWRITE STR::CHARACTER-LISTP-WHEN-DEC-DIGIT-CHAR-LIST*P))
...
(STR::NOT-MEMBER-SLASH-CHAR-DEC-DIGIT-CHAR-LIST*P
 (9 9 (:REWRITE DEFAULT-CAR))
 (3 3 (:REWRITE DEFAULT-CDR))
 )
(STR::NOT-MEMBER-/-STRINGIFY-INTEGER
 (40 5 (:REWRITE STR::CONSP-OF-EXPLODE))
 (35 5 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-WHEN-NOT-CONSP))
 (33 33 (:TYPE-PRESCRIPTION STR::STRINGP-OF-NAT-TO-DEC-STRING))
 (19 1 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-OF-CDR-WHEN-DEC-DIGIT-CHAR-LIST*P))
...
(STR::STRINGIFY-RATIONAL-ONE-TO-ONE
 ...
 (32 16 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-WHEN-NOT-CONSP))
...
(STR::NOT-MEMBER-SHARP-CHAR-DEC-DIGIT-CHAR-LIST*P
 (9 9 (:REWRITE DEFAULT-CAR))
 (3 3 (:REWRITE DEFAULT-CDR))
 )
...
(STR::NOT-MEMBER-SHARP-STRINGIFY-INTEGER
 (54 3 (:REWRITE STR::NOT-MEMBER-SHARP-CHAR-DEC-DIGIT-CHAR-LIST*P))
 (40 5 (:REWRITE STR::CONSP-OF-EXPLODE))
 (35 5 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-WHEN-NOT-CONSP))
...
(STR::NOT-MEMBER-SHARP-STRINGIFY-RATIONAL
 ...
 (104 4 (:REWRITE STR::NOT-MEMBER-SHARP-CHAR-DEC-DIGIT-CHAR-LIST*P))
 (73 73 (:TYPE-PRESCRIPTION STR::STRINGIFY-INTEGER))
 (56 1 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-OF-CDR-WHEN-DEC-DIGIT-CHAR-LIST*P))
 (43 8 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-WHEN-NOT-CONSP))
 ...
 (16 1 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-OF-APPEND))
 (14 14 (:TYPE-PRESCRIPTION STRINGP-OF-IMPLODE))
...
(STR::NOT-MEMBER-SPACE-CHAR-DEC-DIGIT-CHAR-LIST*P
 (9 9 (:REWRITE DEFAULT-CAR))
 (3 3 (:REWRITE DEFAULT-CDR))
 )
...
(STR::NOT-MEMBER-SPACE-STRINGIFY-INTEGER
 (54 3 (:REWRITE STR::NOT-MEMBER-SPACE-CHAR-DEC-DIGIT-CHAR-LIST*P))
 (40 5 (:REWRITE STR::CONSP-OF-EXPLODE))
 (35 5 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-WHEN-NOT-CONSP))
 (31 31 (:TYPE-PRESCRIPTION STR::STRINGP-OF-NAT-TO-DEC-STRING))
 (19 1 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-OF-CDR-WHEN-DEC-DIGIT-CHAR-LIST*P))
...
(STR::NOT-MEMBER-SPACE-STRINGIFY-RATIONAL
 (118 5 (:DEFINITION BINARY-APPEND))
 (109 25 (:REWRITE STR::CONSP-OF-EXPLODE))
 (104 4 (:REWRITE STR::NOT-MEMBER-SPACE-CHAR-DEC-DIGIT-CHAR-LIST*P))
 (73 73 (:TYPE-PRESCRIPTION STR::STRINGIFY-INTEGER))
 (56 1 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-OF-CDR-WHEN-DEC-DIGIT-CHAR-LIST*P))
 (43 8 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-WHEN-NOT-CONSP))
 (38 11 (:REWRITE DEFAULT-CDR))
...
(STR::SWITCH-COERCE-LIST*-APPEND-STRING
 (358 38 (:REWRITE STR::CHARACTER-LISTP-WHEN-DEC-DIGIT-CHAR-LIST*P))
 (156 18 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-OF-CONS))
 (116 116 (:TYPE-PRESCRIPTION STR::DEC-DIGIT-CHAR-LIST*P))
 (106 70 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-WHEN-NOT-CONSP))
 (84 14 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-OF-APPEND))
...
(STR::STRINGIFY-NUMBER-ONE-TO-ONE
 ...
 (322 47 (:REWRITE STR::CHARACTER-LISTP-WHEN-DEC-DIGIT-CHAR-LIST*P))
 ...
 (143 49 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-WHEN-NOT-CONSP))
 (102 102 (:REWRITE DEFAULT-COMPLEX-2))
 (102 102 (:REWRITE DEFAULT-COMPLEX-1))
 (100 18 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-OF-APPEND))
 (99 99 (:TYPE-PRESCRIPTION STR::DEC-DIGIT-CHAR-LIST*P))
...
(STR::UPPER-CASE-OR-DEC-DIGIT-CHAR-LIST*P
...
(STR::STRINGIFY-SYMBOL
 ...
 (322 34 (:REWRITE STR::CHARACTER-LISTP-WHEN-DEC-DIGIT-CHAR-LIST*P))
 (158 42 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-WHEN-NOT-CONSP))
 (145 145 (:REWRITE DEFAULT-SYMBOL-NAME))
 (112 112 (:REWRITE DEFAULT-SYMBOL-PACKAGE-NAME))
 (84 7 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-OF-APPEND))
 (80 23 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-OF-CONS))
 ...
 (6 3 (:REWRITE STR::DEC-DIGIT-CHAR-P-OF-CAR-WHEN-DEC-DIGIT-CHAR-LIST*P))
