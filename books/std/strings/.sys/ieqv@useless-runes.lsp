...
(STR::ICHARLISTEQV
 (40 10 (:REWRITE CHARACTER-LISTP-OF-CDR-WHEN-CHARACTER-LISTP))
 (32 6 (:REWRITE CHARACTERP-OF-CAR-WHEN-CHARACTER-LISTP))
...
(STR::ICHARLISTEQV-IMPLIES-ICHARLISTEQV-NTHCDR-2
 ...
 (161 151 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(STR::LEMMA
 (442 7 (:REWRITE LEN-OF-NTHCDR))
 (381 329 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
 (334 91 (:REWRITE DEFAULT-CDR))
 (269 160 (:REWRITE DEFAULT-+-2))
 (225 27 (:REWRITE NATP-RW))
 (218 45 (:REWRITE ZP-OPEN))
 (205 205 (:REWRITE CONSP-BY-LEN))
 (194 152 (:REWRITE DEFAULT-<-2))
 (190 152 (:REWRITE DEFAULT-<-1))
 (172 160 (:REWRITE DEFAULT-+-1))
 (127 7 (:REWRITE STR::ICHARLISTEQV-WHEN-NOT-CONSP-LEFT))
...
(STR::LEMMA2
 (4420 76 (:REWRITE STR::ICHARLISTEQV-WHEN-NOT-SAME-LENS))
 (1165 42 (:REWRITE CONSP-OF-NTHCDR))
 (1104 636 (:REWRITE DEFAULT-+-2))
 (955 955 (:REWRITE CONSP-BY-LEN))
 (762 12 (:REWRITE LEN-OF-NTHCDR))
 (739 711 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
 (679 679 (:REWRITE CONSP-OF-CDR-BY-LEN))
 (672 636 (:REWRITE DEFAULT-+-1))
 ...
 (365 278 (:TYPE-PRESCRIPTION |x < y  =>  0 < y-x|))
