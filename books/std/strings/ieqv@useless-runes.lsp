...
(STR::ICHAREQV-IMPLIES-EQUAL-DOWNCASE-CHAR-STR-1
     ...
     (8 8
        (:TYPE-PRESCRIPTION STR::UP-ALPHA-P$INLINE)))
(STR::ICHARLISTEQV (24 2 (:DEFINITION CHARACTER-LISTP))
                   (10 10 (:REWRITE CONSP-BY-LEN))
                   (8 8 (:REWRITE DEFAULT-CAR))
                   (4 4 (:REWRITE DEFAULT-CDR)))
(STR::ICHARLISTEQV-IS-AN-EQUIVALENCE (242 242 (:REWRITE DEFAULT-CAR))
...
(STR::ICHARLISTEQV-IMPLIES-ICHAREQV-CAR-1 (3 3 (:REWRITE CONSP-BY-LEN)))
(STR::ICHARLISTEQV-IMPLIES-ICHARLISTEQV-CDR-1 (3 3 (:REWRITE CONSP-BY-LEN))
                                              (2 2 (:REWRITE DEFAULT-CAR)))
(STR::ICHAREQV-IMPLIES-ICHARLISTEQV-CONS-1 (2 2 (:REWRITE DEFAULT-CDR))
                                           (2 2 (:REWRITE DEFAULT-CAR)))
(STR::ICHARLISTEQV-IMPLIES-ICHARLISTEQV-CONS-2 (4 4 (:REWRITE DEFAULT-CDR))
                                               (4 4 (:REWRITE DEFAULT-CAR))
                                               (3 3 (:REWRITE CONSP-BY-LEN)))
(STR::ICHARLISTEQV-IMPLIES-EQUAL-LEN-1 (28 28 (:REWRITE CONSP-BY-LEN))
...
(STR::ICHARLISTEQV-IMPLIES-ICHARLISTEQV-MAKE-CHARACTER-LIST-1
     ...
     (768 61 (:DEFINITION CHARACTER-LISTP))
     (397 397
          (:TYPE-PRESCRIPTION CHARACTER-LISTP))
     (370 86
          (:REWRITE CHARACTER-LISTP-OF-CDR-WHEN-CHARACTER-LISTP))
     (255 142 (:REWRITE DEFAULT-CAR))
     (254 141 (:REWRITE DEFAULT-CDR))
...
(STR::ICHARLISTEQV-WHEN-NOT-CONSP-LEFT (3 3 (:REWRITE CONSP-BY-LEN)))
...
(STR::LEMMA (438 7 (:REWRITE LEN-OF-NTHCDR))
            (373 321
                 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(STR::ISTREQV-AUX-REMOVAL
     ...
     (6 6 (:REWRITE NATP-RW)))
(STR::ISTREQV$INLINE (129 24 (:REWRITE LEN-WHEN-ATOM))
                     (64 2
                         (:REWRITE STR::ICHARLISTEQV-WHEN-NOT-SAME-LENS))
...
(STR::ISTREQV-IMPLIES-ISTREQV-STRING-APPEND-1
     ...
     (64 2
         (:REWRITE STR::ICHARLISTEQV-WHEN-NOT-SAME-LENS))
     (52 31 (:REWRITE STR::CONSP-OF-EXPLODE))
