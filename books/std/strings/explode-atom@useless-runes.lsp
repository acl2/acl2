...
(CHARACTER-LISTP-OF-EXPLODE-ATOM
     ...
     (46 5 (:REWRITE STR::DIGIT-LISTP-OF-APPEND))
     (19 12 (:REWRITE STR::DIGIT-LISTP-OF-CONS))
     (16 8
...
(CHARACTER-LISTP-EXPLODE-ATOM+
     ...
     (90 90
         (:TYPE-PRESCRIPTION STR::DIGIT-LISTP))
     (57 32 (:REWRITE STR::DIGIT-LISTP-OF-CONS))
     (45 18 (:REWRITE DEFAULT-UNARY-/))
     (38 5 (:REWRITE STR::DIGIT-LISTP-OF-APPEND))
     (36 36
         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     ...
     (2 2
        (:TYPE-PRESCRIPTION STR::NONZERO-DIGITP$INLINE))
     (2 1
        (:REWRITE DIGIT-LISTP-OF-EXPLODE-NONNEGATIVE-INTEGER)))
