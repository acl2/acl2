...
(STR::HTML-ENCODE-NEXT-COL$INLINE (10 2 (:REWRITE NATP-WHEN-GTE-0))
                                  (10 1 (:REWRITE NATP-POSP))
...
(STR::HTML-ENCODE-CHARS-AUX (12 1 (:DEFINITION CHARACTER-LISTP))
                            (10 2 (:REWRITE NATP-WHEN-GTE-0))
                            (10 1 (:REWRITE NATP-POSP))
...
(STR::HTML-ENCODE-CHARS-AUX-OF-NFIX-COL (19 6 (:REWRITE NFIX-WHEN-NOT-NATP))
                                        (12 4 (:REWRITE NATP-WHEN-GTE-0))
                                        (10 10 (:TYPE-PRESCRIPTION NATP))
...
(STR::HTML-ENCODE-STRING (19 1 (:DEFINITION LEN))
