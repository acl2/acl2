...
(OBAG::BAGP-WHEN-SETP (54 54 (:REWRITE DEFAULT-CDR))
...
(OBAG::BFIX (1 1 (:TYPE-PRESCRIPTION OBAG::BFIX)))
(OBAG::BAGP-OF-BFIX (17 2 (:REWRITE OBAG::BAGP-WHEN-SETP))
                    (6 2 (:REWRITE SET::NONEMPTY-MEANS-SET))
                    (4 4 (:TYPE-PRESCRIPTION SET::SETP-TYPE))
                    (4 4 (:TYPE-PRESCRIPTION SET::EMPTY-TYPE))
                    (3 3 (:TYPE-PRESCRIPTION OBAG::BFIX))
                    (2 2 (:REWRITE SET::IN-SET)))
(OBAG::BFIX-WHEN-BAGP (19 19 (:TYPE-PRESCRIPTION OBAG::BFIX))
                      (14 2 (:REWRITE OBAG::BAGP-WHEN-SETP))
                      (6 2 (:REWRITE SET::NONEMPTY-MEANS-SET))
                      (4 4 (:TYPE-PRESCRIPTION SET::SETP-TYPE))
                      (4 4 (:TYPE-PRESCRIPTION SET::EMPTY-TYPE))
                      (2 2 (:REWRITE SET::IN-SET)))
(OBAG::EMPTY (6 6 (:TYPE-PRESCRIPTION OBAG::BFIX)))
(OBAG::BOOLEANP-OF-EMPTY)
(OBAG::BAGP-WHEN-NOT-EMPTY (11 11 (:TYPE-PRESCRIPTION OBAG::BFIX))
...
(OBAG::BFIX-WHEN-EMPTY (4 4 (:TYPE-PRESCRIPTION OBAG::BFIX)))
(OBAG::HEAD (25 1 (:REWRITE FAST-<<-IS-<<))
...
(OBAG::HEAD-WHEN-EMPTY (1 1 (:TYPE-PRESCRIPTION OBAG::BFIX)))
(OBAG::HEAD-COUNT (229 112 (:REWRITE DEFAULT-+-2))
...
(OBAG::HEAD-COUNT-BUILT-IN (229 112 (:REWRITE DEFAULT-+-2))
                           (176 26 (:REWRITE OBAG::BAGP-WHEN-NOT-EMPTY))
                           (164 43 (:REWRITE <<-TRICHOTOMY))
                           (163 25 (:REWRITE OBAG::BAGP-WHEN-SETP))
                           (155 112 (:REWRITE DEFAULT-+-1))
                           ...
                           (12 12 (:REWRITE DEFAULT-COERCE-1))
                           (11 11 (:TYPE-PRESCRIPTION OBAG::BFIX)))
(OBAG::TAIL (25 1 (:REWRITE FAST-<<-IS-<<))
            (22 4 (:REWRITE OBAG::BAGP-WHEN-SETP))
            (20 8 (:REWRITE OBAG::BFIX-WHEN-EMPTY))
            (20 4 (:REWRITE OBAG::BAGP-WHEN-NOT-EMPTY))
            (19 5 (:REWRITE <<-TRICHOTOMY))
            ...
            (3 3 (:REWRITE SET::IN-SET)))
(OBAG::BAGP-OF-TAIL (85 12 (:REWRITE OBAG::BAGP-WHEN-SETP))
...
(OBAG::TAIL-WHEN-EMPTY (1 1 (:TYPE-PRESCRIPTION OBAG::BFIX)))
(OBAG::TAIL-COUNT (183 48 (:REWRITE <<-TRICHOTOMY))
...
(OBAG::TAIL-COUNT-BUILT-IN (183 48 (:REWRITE <<-TRICHOTOMY))
                           (171 25 (:REWRITE OBAG::BAGP-WHEN-NOT-EMPTY))
                           (162 77 (:REWRITE DEFAULT-+-2))
                           (162 24 (:REWRITE OBAG::BAGP-WHEN-SETP))
                           (159 28 (:REWRITE <<-ASYMMETRIC))
                           ...
                           (5 5 (:REWRITE DEFAULT-COERCE-1)))
(OBAG::INSERT (30 30
                  (:TYPE-PRESCRIPTION OBAG::HEAD-WHEN-EMPTY))
              (1 1
                 (:TYPE-PRESCRIPTION OBAG::TAIL-WHEN-EMPTY)))
(OBAG::BAGP-OF-INSERT (3627 494 (:REWRITE OBAG::BAGP-WHEN-SETP))
...
(OBAG::DELETE (29 29
              ...
              (6 6
                 (:TYPE-PRESCRIPTION OBAG::TAIL-WHEN-EMPTY)))
(OBAG::BAGP-OF-DELETE (4397 635 (:REWRITE OBAG::BAGP-WHEN-SETP))
...
(OBAG::NATP-OF-OCCS (2 2
                       (:TYPE-PRESCRIPTION OBAG::HEAD-WHEN-EMPTY)))
(OBAG::CARDINALITY (14 2 (:REWRITE OBAG::BAGP-WHEN-SETP))
                   (6 2 (:REWRITE SET::NONEMPTY-MEANS-SET))
...
(OBAG::UNION (3 3
             ...
             (1 1
                (:TYPE-PRESCRIPTION OBAG::TAIL-WHEN-EMPTY)))
(OBAG::BAGP-OF-UNION (77 8 (:REWRITE OBAG::BAGP-WHEN-SETP))
...
(OBAG::INTERSECT (4 4
                 ...
                 (4 4
                    (:TYPE-PRESCRIPTION OBAG::HEAD-WHEN-EMPTY)))
(OBAG::BAGP-OF-INTERSECT (130 13 (:REWRITE OBAG::BAGP-WHEN-SETP))
...
(OBAG::DIFFERENCE (4 4
                  ...
                  (4 4
                     (:TYPE-PRESCRIPTION OBAG::HEAD-WHEN-EMPTY)))
(OBAG::BAGP-OF-DIFFERENCE (130 13 (:REWRITE OBAG::BAGP-WHEN-SETP))
                          (39 13 (:REWRITE SET::NONEMPTY-MEANS-SET))
                          (39 13 (:REWRITE OBAG::BAGP-WHEN-NOT-EMPTY))
                          (26 26 (:TYPE-PRESCRIPTION SET::SETP-TYPE))
                          (26 26 (:TYPE-PRESCRIPTION SET::EMPTY-TYPE))
