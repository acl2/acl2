...
(STD::FOO-P
 (1551 41 (:LINEAR ACL2-COUNT-CAR-CDR-LINEAR))
 (1207 617 (:REWRITE DEFAULT-+-2))
 (819 617 (:REWRITE DEFAULT-+-1))
...
(STD::TRUE-LISTP-WHEN-FOO-LIST-P-COMPOUND-RECOGNIZER)
...
(STD::TAGLESS-TREE-TEST-P)
(STD::TAGLESS-TREE-TEST
 (5 5 (:TYPE-PRESCRIPTION STD::PROD-CONS-WHEN-EITHER))
 )
(STD::HONSED-TAGLESS-TREE-TEST)
(STD::TAGLESS-TREE-TEST->F1$INLINE)
(STD::TAGLESS-TREE-TEST->F2$INLINE)
(STD::REMAKE-TAGLESS-TREE-TEST)
(STD::TYPE-OF-TAGLESS-TREE-TEST)
(STD::BOOLEANP-OF-TAGLESS-TREE-TEST-P)
(STD::TAGLESS-TREE-TEST-P-OF-TAGLESS-TREE-TEST
 (2 2 (:TYPE-PRESCRIPTION STD::PROD-CONS-WHEN-EITHER))
 )
(STD::TYPE-WHEN-TAGLESS-TREE-TEST-P)
(STD::TAGLESS-TREE-TEST->F1-OF-TAGLESS-TREE-TEST)
(STD::TAGLESS-TREE-TEST->F2-OF-TAGLESS-TREE-TEST)
(STD::RETURN-TYPE-OF-TAGLESS-TREE-TEST->F1)
(STD::RETURN-TYPE-OF-TAGLESS-TREE-TEST->F2)
