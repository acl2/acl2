(STD::FOOF-P)
(STD::CONTAINERF-P (3 3
                      (:TYPE-PRESCRIPTION CONSP-ASSOC-EQUAL)))
(STD::CONTAINERF)
(STD::HONSED-CONTAINERF)
(STD::CONTAINERF->THING$INLINE (1 1 (:DEFINITION ASSOC-EQUAL)))
...
(STD::CONTAINERM-P (3 3
                      (:TYPE-PRESCRIPTION CONSP-ASSOC-EQUAL)))
(STD::CONTAINERM)
(STD::HONSED-CONTAINERM)
(STD::CONTAINERM->THING$INLINE (1 1 (:DEFINITION ASSOC-EQUAL)))
...
(STD::FOO-P (676 332 (:REWRITE DEFAULT-+-2))
...
(STD::FOO)
(STD::HONSED-FOO)
(STD::FOO->BAR$INLINE (4 4 (:DEFINITION ASSOC-EQUAL)))
(STD::CONSP-OF-FOO)
...
(STD::FOO->BAR-OF-FOO)
(STD::FOO-LIST-P-OF-FOO->BAR (1 1 (:DEFINITION ASSOC-EQUAL))
...
(STD::PAIR-O-INTS-P (2 2
                       (:TYPE-PRESCRIPTION CONSP-ASSOC-EQUAL)))
(STD::PAIR-O-INTS)
(STD::HONSED-PAIR-O-INTS)
(STD::PAIR-O-INTS->LEFT$INLINE (2 2 (:DEFINITION ASSOC-EQUAL)))
(STD::PAIR-O-INTS->RIGHT$INLINE (2 2 (:DEFINITION ASSOC-EQUAL)))
...
(STD::SUM-A-PAIR (10 2
                     (:REWRITE STD::PAIR-O-INTS-P-WHEN-WRONG-TAG))
                 (2 2
                    (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                 (2 1
                    (:REWRITE STD::TAG-WHEN-PAIR-O-INTS-P))
                 (2 1 (:REWRITE STD::TAG-WHEN-FOO-P))
                 (2 1 (:REWRITE STD::TAG-WHEN-CONTAINERM-P))
                 (2 1 (:REWRITE STD::TAG-WHEN-CONTAINERF-P))
                 (1 1
                    (:TYPE-PRESCRIPTION STD::BOOLEANP-OF-FOO-P))
                 (1 1
                    (:TYPE-PRESCRIPTION STD::BOOLEANP-OF-CONTAINERM-P))
                 (1 1
                    (:TYPE-PRESCRIPTION STD::BOOLEANP-OF-CONTAINERF-P)))
(STD::EMPLOYEE-P)
(STD::EMPLOYEE (4 4
...
(STD::EMPLOYEE4->NAME$INLINE (2 2 (:DEFINITION ASSOC-EQUAL)))
(STD::EMPLOYEE4->SALARY$INLINE (2 2 (:DEFINITION ASSOC-EQUAL)))
...
(STD::STUDENT->FULLNAME (3 3 (:REWRITE DEFAULT-CDR))
...
(STD::POINT)
(STD::HONSED-POINT)
(STD::POINT->X$INLINE (2 2 (:DEFINITION ASSOC-EQUAL)))
(STD::POINT->Y$INLINE (2 2 (:DEFINITION ASSOC-EQUAL)))
(STD::CONSP-OF-POINT)
