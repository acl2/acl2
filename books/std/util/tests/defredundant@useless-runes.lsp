...
(STD::NATP-OF-F2)
(STD::F3)
(STD::F4-TERM (8 8 (:REWRITE DEFAULT-CDR))
              (4 4
                 (:REWRITE TERM-LISTP-IMPLIES-PSEUDO-TERM-LISTP))
              (4 4 (:REWRITE DEFAULT-CAR))
              (3 3
                 (:REWRITE TERMP-IMPLIES-PSEUDO-TERMP)))
(STD::F5$INLINE (1 1 (:TYPE-PRESCRIPTION STD::F5$INLINE)))
(STD::F6$INLINE)
(STD::F7)
(STD::F8$INLINE)
(STD::M)
(STD::F9 (1250 597 (:REWRITE DEFAULT-+-2))
...
(STD::G0-TERM$INLINE (50 6 (:DEFINITION LENGTH))
