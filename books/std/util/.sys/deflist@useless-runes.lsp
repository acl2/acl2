...
(STD::DEFLIST-LEMMA-SFIX-WHEN-NOT-SETP
 (5 5 (:TYPE-PRESCRIPTION SET::SFIX$INLINE))
 )
(STD::DEFLIST-LEMMA-SFIX-WHEN-SETP
 (9 3 (:REWRITE SET::NONEMPTY-MEANS-SET))
 (9 2 (:DEFINITION SET::EMPTYP$INLINE))
...
(STD::DEFLIST-LEMMA-SUBSETP-OF-DIFFERENCE
 ...
 (252 252 (:TYPE-PRESCRIPTION SET::SFIX$INLINE))
...
(STD::G1
 ...
 (7 7 (:TYPE-PRESCRIPTION SET::SFIX$INLINE))
...
(STD::DEFLIST-LEMMA-SUBSETP-OF-INTERSECT
 ...
 (432 432 (:TYPE-PRESCRIPTION SET::SFIX$INLINE))
