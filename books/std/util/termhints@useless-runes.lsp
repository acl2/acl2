(HQ)
(PROCESS-TERMHINT (866 420 (:REWRITE DEFAULT-+-2))
...
(POSTPROCESS-ONE-TERMHINT (1 1
                             (:TYPE-PRESCRIPTION POSTPROCESS-ONE-TERMHINT)))
(POSTPROCESS-TERMHINT (1 1
                         (:TYPE-PRESCRIPTION POSTPROCESS-TERMHINT)))
(USE-TERMHINT-FIND-HINT (6 6
                           (:TYPE-PRESCRIPTION POSTPROCESS-TERMHINT)))
(TERMHINT-UNHIDE (1 1 (:TYPE-PRESCRIPTION TERMHINT-UNHIDE)))
(TERMHINT-UNHIDE-OF-HIDE (3 3 (:TYPE-PRESCRIPTION TERMHINT-UNHIDE)))
(TERMHINT-APPEND-HINTS)
(MARK-CLAUSE)
(MARK-CLAUSE-IS-TRUE)
(HINTCONTEXT-CASES-P)
(HINTCONTEXT-FIND-CASE (22 22 (:REWRITE DEFAULT-CAR))
