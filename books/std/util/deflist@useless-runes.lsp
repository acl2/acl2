...
(STD::DEFLIST-LEMMA-SUBSETP-OF-INTERSECTION-EQUAL
     (529 10 (:DEFINITION INTERSECTION-EQUAL))
     (412 15 (:DEFINITION MEMBER-EQUAL))
...
(STD::DEFLIST-LEMMA-SUBSETP-OF-NTHCDR
     ...
     (381 23 (:REWRITE CONSP-OF-NTHCDR))
     (310 18 (:REWRITE SUBSETP-WHEN-ATOM-LEFT))
     (189 33 (:DEFINITION LEN))
     (165 60 (:REWRITE DEFAULT-CDR))
     (156 5
          (:REWRITE SUBSETP-IMPLIES-SUBSETP-CDR))
     (134 8 (:REWRITE SUBSETP-MEMBER . 3))
     (131 131 (:TYPE-PRESCRIPTION LEN))
     (124 62
          (:TYPE-PRESCRIPTION TRUE-LISTP-NTHCDR-TYPE-PRESCRIPTION))
     (123 39 (:REWRITE ZP-OPEN))
     (112 8 (:REWRITE SUBSETP-MEMBER . 1))
     (108 87 (:REWRITE DEFAULT-<-2))
     (105 66 (:REWRITE DEFAULT-+-2))
     (102 2 (:REWRITE CAR-OF-NTHCDR))
     ...
     (37 18 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
     (28 4 (:REWRITE SET::EMPTY-SET-UNIQUE))
     (24 4 (:REWRITE NTH-WHEN-ZP))
...
(STD::DEFLIST-LEMMA-TRUE-LISTP-OF-LAST (3 3 (:TYPE-PRESCRIPTION LAST)))
(STD::C0 (5 5
...
(STD::DEFLIST-LEMMA-LEN-OVER-ZERO (30 3 (:REWRITE SET::EMPTY-SET-UNIQUE))
...
(STD::DEFLIST-LEMMA-NTH-WHEN-ZP (19 1 (:REWRITE NTH-WHEN-TOO-LARGE-CHEAP))
                                (5 1 (:DEFINITION LEN))
                                (4 1 (:DEFINITION NFIX))
                                (3 2 (:REWRITE DEFAULT-<-2))
...
(STD::DEFLIST-LEMMA-NTH-WHEN-ATOM (1 1 (:REWRITE DEFAULT-<-2))
                                  (1 1 (:REWRITE DEFAULT-<-1))
...
(STD::L0 (115 5 (:REWRITE SUBSETP-MEMBER . 3))
...
(STD::L1 (299 14 (:REWRITE TAKE-OF-TOO-MANY))
...
(STD::DEFLIST-LEMMA-SFIX-WHEN-NOT-SETP (5 5 (:TYPE-PRESCRIPTION SET::SFIX)))
(STD::DEFLIST-LEMMA-SFIX-WHEN-SETP (9 3 (:REWRITE SET::NONEMPTY-MEANS-SET))
                                   (9 2 (:DEFINITION SET::EMPTY))
                                   (6 1 (:REWRITE SET::SFIX-WHEN-EMPTY))
                                   (4 4 (:TYPE-PRESCRIPTION SET::EMPTY-TYPE))
                                   (3 3 (:REWRITE SET::IN-SET)))
(STD::DEFLIST-LEMMA-SUBSETP-OF-DIFFERENCE
     (1271 35 (:DEFINITION MEMBER-EQUAL))
...
(STD::G1 (108 3 (:DEFINITION SET::IN))
...
(STD::DEFLIST-LEMMA-SUBSETP-OF-INTERSECT
     (1610 10 (:DEFINITION INTERSECTION-EQUAL))
     (1580 28 (:DEFINITION MEMBER-EQUAL))
...
(STD::DEFLIST-LEMMA-TRUE-LISTP-OF-SFIX (5 5 (:TYPE-PRESCRIPTION SET::SFIX)))
