...
(STRING-STRING-ALISTP-OF-MAKE-FAL
   (73 10
       (:REWRITE STRING-STRING-ALISTP-OF-CDR-WHEN-STRING-STRING-ALISTP))
   (32 32
       (:REWRITE STRING-STRING-ALISTP-WHEN-SUBSETP-EQUAL))
   (16 16
       (:REWRITE STRING-STRING-ALISTP-WHEN-NOT-CONSP))
   (2 2
      (:TYPE-PRESCRIPTION BOOLEANP-OF-STRINGP-FOR-STRING-STRING-ALISTP-VAL)))
...
(STRINGP-OF-CDR-OF-ASSOC-EQUAL-WHEN-STRING-STRING-ALISTP
    ...
    (3 3 (:DEFINITION NULL)))
(STRING-STRING-ALISTP-OF-PUT-ASSOC-EQUAL
    (838 174
         (:REWRITE STRING-STRING-ALISTP-WHEN-SUBSETP-EQUAL))
    (601 27 (:DEFINITION MEMBER-EQUAL))
    (543 60
         (:REWRITE STRINGP-OF-CDR-WHEN-MEMBER-EQUAL-OF-STRING-STRING-ALISTP))
    (521 54 (:REWRITE SUBSETP-CAR-MEMBER))
    (494 50
         (:REWRITE STRINGP-OF-CAR-WHEN-MEMBER-EQUAL-OF-STRING-STRING-ALISTP))
    (421 25
         (:REWRITE STRINGP-OF-CAAR-WHEN-STRING-STRING-ALISTP))
    (372 30
         (:REWRITE STRINGP-OF-CDAR-WHEN-STRING-STRING-ALISTP))
    (333 127 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
    (320 15
         (:REWRITE STRING-STRING-ALISTP-OF-CDR-WHEN-STRING-STRING-ALISTP))
    (314 165
         (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-STRING-STRING-ALISTP
    ...
    (278 127 (:REWRITE SUBSETP-WHEN-ATOM-LEFT))
    (272 201 (:REWRITE DEFAULT-CAR))
