...
(SET::MERGESORT-MEMBERSHIP-2
 ...
 (2692 32 (:DEFINITION SET::SUBSET$INLINE))
...
(SET::MERGESORT-MEMBERSHIP-1
 (1520 15 (:DEFINITION SET::SUBSET$INLINE))
 ...
 (159 53 (:REWRITE SET::EMPTYP-SUBSET-2))
 (123 53 (:REWRITE SET::EMPTYP-SUBSET))
 (115 71 (:REWRITE SET::TAIL-WHEN-EMPTYP))
...
(SET::IN-MERGESORT
 ...
 (96 54 (:REWRITE SET::TAIL-WHEN-EMPTYP))
 ...
 (9 1 (:DEFINITION SET::SUBSET$INLINE))
...
(SET::MERGESORT$INLINE
 ...
 (600 14 (:DEFINITION SET::SUBSET$INLINE))
 (527 17 (:DEFINITION SET::MERGESORT$INLINE))
 ...
 (101 43 (:REWRITE SET::INSERT-WHEN-EMPTYP))
 (90 36 (:REWRITE SET::EMPTYP-SUBSET))
 (74 36 (:REWRITE SET::EMPTYP-SUBSET-2))
...
(SET::MERGESORT-SET-IDENTITY
 ...
 (1102 361 (:REWRITE SET::SFIX-WHEN-EMPTYP))
 (918 184 (:REWRITE SET::TAIL-WHEN-EMPTYP))
 (745 175 (:REWRITE SET::HEAD-WHEN-EMPTYP))
 (705 175 (:REWRITE SET::IN-TAIL-OR-HEAD))
 (447 20 (:DEFINITION SET::SFIX$INLINE))
 (289 47 (:REWRITE SET::NEVER-IN-EMPTY))
 (130 23 (:REWRITE SET::INSERT-WHEN-EMPTYP))
