...
(ELEMENT-LIST-P-OF-DELETE
 ...
 (430 172 (:REWRITE SET::NONEMPTY-MEANS-SET))
 (264 93
      (:REWRITE ELEMENT-LIST-P-WHEN-NOT-CONSP-NON-TRUE-LIST))
...
(ELEMENT-LIST-P-OF-INTERSECT-1
 ...
 (2078 532 (:REWRITE <<-TRICHOTOMY))
 (1320 228 (:REWRITE <<-ASYMMETRIC))
 (985 70
      (:REWRITE ELEMENT-P-OF-CAR-WHEN-ELEMENT-LIST-NONEMPTY-P))
 (930 807 (:REWRITE DEFAULT-CDR))
 (903 36
      (:DEFINITION ELEMENT-LIST-NONEMPTY-P))
 (701 701 (:REWRITE SET::IN-SET))
 (686 170 (:REWRITE SET::SFIX-WHEN-EMPTY))
 (582 106 (:REWRITE SET::TAIL-WHEN-EMPTY))
 (538 530 (:REWRITE <<-TRANSITIVE))
...
(ELEMENT-P-WHEN-IN-ELEMENT-LIST-P
 (677 34 (:REWRITE SET::IN-TAIL))
 (296 117 (:REWRITE SET::NONEMPTY-MEANS-SET))
...
(ELEMENT-LIST-P-OF-INTERSECT-2
 ...
 (2503 42
       (:REWRITE ELEMENT-LIST-P-OF-INTERSECT-1))
 (2232 20 (:REWRITE SET::INSERT-IDENTITY))
 (2192 20 (:REWRITE SET::INTERSECT-IN))
 (2126 128
       (:REWRITE ELEMENT-P-OF-CAR-WHEN-ELEMENT-LIST-NONEMPTY-P))
 (1999 512 (:REWRITE <<-TRICHOTOMY))
 (1961 79
       (:DEFINITION ELEMENT-LIST-NONEMPTY-P))
 (1273 220 (:REWRITE <<-ASYMMETRIC))
 (974 857 (:REWRITE DEFAULT-CDR))
 (690 111
      (:REWRITE ELEMENT-LIST-NONEMPTY-P-OF-CDR-WHEN-ELEMENT-LIST-NONEMPTY-P))
...
(ELEMENT-LIST-P-OF-DIFFERENCE
 ...
 (2390 610 (:REWRITE <<-TRICHOTOMY))
 (1476 254 (:REWRITE <<-ASYMMETRIC))
 (1127 72
       (:REWRITE ELEMENT-P-OF-CAR-WHEN-ELEMENT-LIST-NONEMPTY-P))
 (1077 915 (:REWRITE DEFAULT-CDR))
 (1042 37
       (:DEFINITION ELEMENT-LIST-NONEMPTY-P))
 (894 894 (:REWRITE SET::IN-SET))
 (721 172 (:REWRITE SET::SFIX-WHEN-EMPTY))
 (616 608 (:REWRITE <<-TRANSITIVE))
 ...
 (264 192
      (:REWRITE ELEMENT-P-WHEN-IN-ELEMENT-LIST-P))
 (247 247
      (:TYPE-PRESCRIPTION ELEMENT-LIST-NONEMPTY-P))
 (179 43
      (:REWRITE ELEMENT-LIST-NONEMPTY-P-OF-CDR-WHEN-ELEMENT-LIST-NONEMPTY-P))
