(SET::MEMBER-OF-APPEND (168 24 (:REWRITE SET::EMPTY-SET-UNIQUE))
...
(SET::MEMBER-OF-REV (301 43 (:REWRITE SET::EMPTY-SET-UNIQUE))
...
(SET::HALVE-LIST-AUX-WHEN-NOT-CONSP-OF-CDR
     ...
     (1 1
        (:REWRITE SET::HALVE-LIST-AUX-WHEN-NOT-CONSP)))
(SET::HALVE-LIST-AUX-LEN-1 (288 142 (:REWRITE DEFAULT-+-2))
...
(SET::HALVE-LIST-AUX-LEN-2 (165 85 (:REWRITE DEFAULT-+-2))
...
(SET::HALVE-LIST-CORRECT
     ...
     (10 2 (:DEFINITION LEN))
     (8 4
        (:REWRITE SET::HALVE-LIST-AUX-WHEN-NOT-CONSP-OF-CDR))
     (4 4
        (:REWRITE SET::HALVE-LIST-AUX-WHEN-NOT-CONSP))
...
(SET::MERGESORT-EXEC (42 21 (:REWRITE DEFAULT-+-2))
                     (32 32 (:REWRITE DEFAULT-CDR))
                     (21 21 (:REWRITE DEFAULT-+-1))
                     (8 4 (:REWRITE DEFAULT-<-2))
                     (8 4 (:REWRITE DEFAULT-<-1)))
(SET::MERGESORT-EXEC-SET (21 3 (:REWRITE SET::INSERT-IDENTITY))
...
(SET::MERGESORT-MEMBERSHIP-1
     ...
     (244 13
          (:REWRITE SET::MERGESORT-MEMBERSHIP-2))
     ...
     (15 15
         (:REWRITE SET::PICK-A-POINT-SUBSET-CONSTRAINT-HELPER))
     (3 3 (:REWRITE SET::INSERT-WHEN-EMPTY)))
(SET::MERGESORT-EXEC-MEMBERSHIP (152 10 (:DEFINITION SET::IN))
                                ...
                                (1 1
                                   (:REWRITE SET::SUBSET-MEMBERSHIP-TAIL-2)))
(SET::MERGESORT-EXEC (7 1 (:REWRITE SET::INSERT-IDENTITY))
...
(SET::MERGESORT)
(SET::MERGESORT-SET (102 3 (:REWRITE SET::INSERT-IDENTITY))
                    ...
                    (3 3 (:REWRITE DEFAULT-CAR))
                    (2 2 (:REWRITE DEFAULT-CDR)))
(SET::IN-MERGESORT (1028 33 (:DEFINITION SET::IN))
...
(SET::MERGESORT (823 43 (:REWRITE SET::INSERT-IDENTITY))
...
(SET::MERGESORT-SET-IDENTITY (6973 134 (:REWRITE SET::EMPTY-SET-UNIQUE))
                             (6240 177 (:REWRITE SET::IN-TAIL))
                             (4757 44 (:REWRITE SET::INSERT-IDENTITY))
                             (2708 2708 (:REWRITE DEFAULT-CDR))
                             (1482 1482 (:REWRITE DEFAULT-CAR))
