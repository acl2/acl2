(FINAL-CDR)
(FINAL-CDR-WHEN-ATOM)
(FINAL-CDR-OF-CONS (6 6 (:REWRITE FINAL-CDR-WHEN-ATOM))
                   (3 3 (:REWRITE DEFAULT-CDR)))
(FINAL-CDR-WHEN-TRUE-LISTP (7 7 (:REWRITE FINAL-CDR-WHEN-ATOM))
                           (6 6 (:REWRITE DEFAULT-CDR)))
(EQUAL-FINAL-CDR-NIL (25 8 (:DEFINITION TRUE-LISTP))
                     (12 12 (:REWRITE DEFAULT-CDR)))
(EQUAL-OF-FINAL-CDR-AND-SELF (19 3 (:REWRITE FINAL-CDR-WHEN-TRUE-LISTP))
                             (11 11 (:TYPE-PRESCRIPTION TRUE-LISTP))
                             (11 3 (:DEFINITION TRUE-LISTP))
                             (11 1 (:DEFINITION FINAL-CDR))
                             (3 3 (:REWRITE DEFAULT-CDR)))
(FINAL-CDR-OF-APPEND (364 21 (:REWRITE FINAL-CDR-WHEN-TRUE-LISTP))
...
(FINAL-CDR-OF-REVAPPEND (333 20 (:REWRITE FINAL-CDR-WHEN-TRUE-LISTP))
                        (209 19 (:DEFINITION TRUE-LISTP))
                        (62 20 (:REWRITE FINAL-CDR-WHEN-ATOM))
                        (43 31 (:REWRITE DEFAULT-CDR))
                        (2 2 (:REWRITE DEFAULT-CAR)))
(FINAL-CDR-OF-UNION-EQUAL (322 29 (:REWRITE FINAL-CDR-WHEN-TRUE-LISTP))
...
(FINAL-CDR-OF-HONS-SHRINK-ALIST (393 36 (:REWRITE FINAL-CDR-WHEN-TRUE-LISTP))
...
(FINAL-CDR-OF-ADD-TO-SET-EQUAL (45 4 (:REWRITE FINAL-CDR-WHEN-TRUE-LISTP))
...
(FINAL-CDR-OF-LAST (206 18 (:REWRITE FINAL-CDR-WHEN-TRUE-LISTP))
                   (131 19 (:DEFINITION TRUE-LISTP))
                   (95 95 (:TYPE-PRESCRIPTION LAST))
                   (81 81 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(FINAL-CDR-OF-NTHCDR (575 43 (:REWRITE FINAL-CDR-WHEN-TRUE-LISTP))
...
(APPEND-SELF-ONTO-FINAL-CDR (101 101 (:TYPE-PRESCRIPTION BINARY-APPEND))
