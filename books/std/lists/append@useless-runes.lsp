...
(EQUAL-WHEN-APPEND-SAME (636 318
                             (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
...
(APPEND-OF-NIL (120 24 (:DEFINITION TRUE-LISTP))
...
(LIST-FIX-OF-APPEND (212 10 (:REWRITE LIST-FIX-WHEN-LEN-ZERO))
                    ...
                    (1 1 (:REWRITE FOLD-CONSTS-IN-+)))
(CAR-OF-APPEND (58 58 (:TYPE-PRESCRIPTION BINARY-APPEND))
               (33 12 (:REWRITE DEFAULT-CAR))
               (12 3 (:DEFINITION BINARY-APPEND))
               (3 3 (:REWRITE DEFAULT-CDR))
               (3 3 (:REWRITE CONSP-OF-APPEND)))
(CAR-OF-APPEND-WHEN-CONSP (38 19
                              (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
                          (19 19 (:TYPE-PRESCRIPTION TRUE-LISTP))
                          (19 19 (:TYPE-PRESCRIPTION BINARY-APPEND))
...
(CDR-OF-APPEND-WHEN-CONSP (78 39
                              (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
                          ...
                          (6 6 (:REWRITE APPEND-WHEN-NOT-CONSP))
                          (4 4 (:REWRITE DEFAULT-CAR)))
(ASSOCIATIVITY-OF-APPEND (1576 638
                               (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
...
(ELEMENT-LIST-P-OF-APPEND-TRUE-LIST
 ...
 (36 9
     (:REWRITE ELEMENT-LIST-P-OF-APPEND-NON-TRUE-LIST))
