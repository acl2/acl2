(LAST-WHEN-ATOM (19 19 (:TYPE-PRESCRIPTION LAST)))
(LAST-WHEN-ATOM-OF-CDR (19 19 (:TYPE-PRESCRIPTION LAST))
                       (2 2 (:REWRITE DEFAULT-CDR))
                       (1 1 (:REWRITE LAST-WHEN-ATOM)))
(LAST-OF-CONS (13 6 (:REWRITE LAST-WHEN-ATOM-OF-CDR))
              (12 12 (:REWRITE DEFAULT-CDR))
              (6 6 (:REWRITE LAST-WHEN-ATOM)))
(CONSP-OF-LAST (12 12 (:REWRITE DEFAULT-CDR))
               (5 5 (:REWRITE LAST-WHEN-ATOM)))
(TRUE-LISTP-OF-LAST (22 18 (:REWRITE DEFAULT-CDR))
                    (5 5 (:REWRITE LAST-WHEN-ATOM)))
(LEN-OF-LAST (27 22 (:REWRITE DEFAULT-CDR))
             (12 6 (:REWRITE DEFAULT-+-2))
             (7 7 (:REWRITE LAST-WHEN-ATOM))
             (6 6 (:REWRITE DEFAULT-+-1))
             (1 1 (:REWRITE CONSP-OF-LAST)))
(UPPER-BOUND-OF-LEN-OF-LAST (6 1 (:DEFINITION LAST))
                            (4 4 (:REWRITE DEFAULT-CDR))
                            (4 2 (:REWRITE LAST-WHEN-ATOM-OF-CDR))
                            (2 2 (:REWRITE LAST-WHEN-ATOM))
                            (1 1 (:REWRITE DEFAULT-<-2))
                            (1 1 (:REWRITE DEFAULT-<-1)))
(MEMBER-OF-CAR-OF-LAST (38 38 (:REWRITE DEFAULT-CDR))
                       (14 14 (:REWRITE LAST-WHEN-ATOM))
                       (1 1 (:REWRITE CONSP-OF-LAST)))
(L0 (43 43 (:REWRITE DEFAULT-CAR))
    (22 22 (:REWRITE DEFAULT-CDR)))
(SUBSETP-OF-LAST (67 58 (:REWRITE DEFAULT-CDR))
...
(LAST-OF-APPEND (159 57 (:REWRITE LAST-WHEN-ATOM))
                (71 44 (:REWRITE DEFAULT-CAR))
                (6 6 (:REWRITE CONSP-OF-LAST)))
(LAST-OF-REV (30 6 (:REWRITE LAST-WHEN-ATOM-OF-CDR))
