(REMOVE-WHEN-ATOM)
(REMOVE-OF-CONS (15 15 (:REWRITE REMOVE-WHEN-ATOM))
                (10 10 (:REWRITE DEFAULT-CDR))
                (10 10 (:REWRITE DEFAULT-CAR)))
(CONSP-OF-REMOVE (124 76 (:REWRITE SUBSETP-TRANS))
...
(REMOVE-UNDER-IFF (136 88 (:REWRITE SUBSETP-TRANS))
                  ...
                  (3 3 (:REWRITE SUBSETP-MEMBER . 3))
                  (2 2 (:REWRITE SUBSETP-NIL)))
(REMOVE-WHEN-NON-MEMBER (106 12 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
...
(UPPER-BOUND-OF-LEN-OF-REMOVE-WEAK
     ...
     (220 15 (:DEFINITION MEMBER-EQUAL))
...
(LEN-OF-REMOVE-EXACT (2023 170 (:DEFINITION MEMBER-EQUAL))
...
(REMOVE-IS-COMMUTATIVE (1882 137 (:DEFINITION MEMBER-EQUAL))
                       (993 229 (:REWRITE DEFAULT-CDR))
                       (811 110 (:REWRITE REMOVE-WHEN-ATOM))
                       (752 55 (:REWRITE SUBSETP-CAR-MEMBER))
                       (737 175 (:REWRITE SUBSETP-CONS-2))
                       (636 144
                            (:REWRITE SUBSETP-IMPLIES-SUBSETP-CDR))
                       (616 234 (:REWRITE DEFAULT-CAR))
                       (462 21 (:REWRITE MEMBER-OF-REMOVE))
                       (447 286 (:REWRITE SUBSETP-MEMBER . 4))
                       (405 312 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
                       (393 304 (:REWRITE SUBSETP-MEMBER . 2))
                       (375 4 (:REWRITE SUBSETP-OF-REMOVE1))
                       ...
                       (53 3 (:REWRITE MEMBER-OF-CONS))
                       (4 2 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
                       (1 1 (:TYPE-PRESCRIPTION TRUE-LISTP))
                       (1 1 (:REWRITE SUBSETP-REFL))
                       (1 1 (:DEFINITION TRUE-LISTP)))
(REMOVE-IS-IDEMPOTENT (90 2 (:DEFINITION REMOVE-EQUAL))
...
(DUPLICITY-OF-REMOVE (2345 207 (:DEFINITION MEMBER-EQUAL))
                     (654 60 (:REWRITE DUPLICITY-WHEN-NOT-CONSP))
                     (590 470 (:REWRITE SUBSETP-MEMBER . 2))
                     (570 6 (:REWRITE SUBSETP-OF-REMOVE1))
                     (558 18 (:REWRITE CONSP-OF-REMOVE))
                     (541 301 (:REWRITE SUBSETP-MEMBER . 4))
...
(REMOVE-OF-APPEND (1092 64 (:DEFINITION MEMBER-EQUAL))
                  (441 7 (:REWRITE MEMBER-OF-APPEND))
                  ...
                  (1 1 (:REWRITE SUBSETP-REFL)))
(REMOVE-OF-REVAPPEND (2088 114 (:DEFINITION MEMBER-EQUAL))
                     ...
                     (1 1 (:REWRITE SUBSETP-REFL))
                     (1 1 (:DEFINITION TRUE-LISTP)))
(REMOVE-OF-REV (1944 103 (:DEFINITION MEMBER-EQUAL))
               ...
               (1 1 (:REWRITE SUBSETP-REFL))
               (1 1 (:DEFINITION TRUE-LISTP)))
(REMOVE-OF-UNION-EQUAL (2435 151 (:DEFINITION MEMBER-EQUAL))
                       (2249 147 (:REWRITE SUBSETP-CAR-MEMBER))
                       (1271 17 (:REWRITE SUBSETP-OF-REMOVE1))
                       (832 290 (:REWRITE SUBSETP-MEMBER . 4))
                       (713 32 (:REWRITE SUBSETP-OF-REMOVE2))
                       ...
                       (379 339 (:REWRITE SUBSETP-TRANS2))
...
(REMOVE-OF-INTERSECTION-EQUAL (2620 172 (:REWRITE SUBSETP-CAR-MEMBER))
                              (2478 160 (:DEFINITION MEMBER-EQUAL))
                              (1543 23 (:REWRITE SUBSETP-OF-REMOVE1))
                              (925 361 (:REWRITE SUBSETP-MEMBER . 1))
                              (888 328 (:REWRITE SUBSETP-MEMBER . 4))
                              (794 35 (:REWRITE SUBSETP-OF-REMOVE2))
                              (582 9
                              ...
                              (512 397 (:REWRITE SUBSETP-TRANS))
                              (478 397 (:REWRITE SUBSETP-TRANS2))
...
(REMOVE-OF-SET-DIFFERENCE-EQUAL
     (1809 91 (:DEFINITION MEMBER-EQUAL))
...
(ELEMENT-LIST-P-OF-REMOVE
 ...
 (2424 214 (:DEFINITION MEMBER-EQUAL))
 (1895 21 (:REWRITE SUBSETP-OF-REMOVE1))
 (1396
  83
  (:REWRITE
 ...
 (886 191 (:REWRITE SUBSETP-MEMBER . 4))
