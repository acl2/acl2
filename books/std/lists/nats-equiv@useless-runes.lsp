(NATS-EQUIV (525 258 (:REWRITE DEFAULT-+-2))
...
(NATS-EQUIV-REFLEXIVE (6 6 (:REWRITE DEFAULT-CDR))
                      (4 4 (:REWRITE DEFAULT-CAR))
                      (4 4 (:REWRITE DEFAULT-<-2))
                      (4 4 (:REWRITE DEFAULT-<-1)))
(NATS-EQUIV-SYMMETRIC (151 149 (:REWRITE DEFAULT-<-1))
                      (149 149 (:REWRITE DEFAULT-<-2))
                      (2 2
                         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(NATS-EQUIV-TRANSITIVE)
(NATS-EQUIV-IS-AN-EQUIVALENCE (1957 1938 (:REWRITE DEFAULT-<-1))
                              (1938 1938 (:REWRITE DEFAULT-<-2))
                              (19 19
                                  (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(LIST-EQUIV-REFINES-NATS-EQUIV (12 12 (:REWRITE DEFAULT-CAR))
...
(NATS-EQUIV-IMPLIES-NAT-EQUIV-CAR-1
     ...
     (2 2
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(NATS-EQUIV-IMPLIES-NATS-EQUIV-CDR-1 (20 20 (:REWRITE DEFAULT-<-2))
                                     (20 20 (:REWRITE DEFAULT-<-1)))
(NATS-EQUIV-IMPLIES-NATS-EQUIV-CONS-2 (5 5 (:REWRITE DEFAULT-CDR))
                                      (5 5 (:REWRITE DEFAULT-CAR))
                                      (5 5 (:REWRITE DEFAULT-<-2))
                                      (5 5 (:REWRITE DEFAULT-<-1)))
(NATS-EQUIV-OF-CONS (12 12 (:REWRITE DEFAULT-CAR))
                    (12 12 (:REWRITE DEFAULT-<-2))
                    (12 12 (:REWRITE DEFAULT-<-1))
                    (10 10 (:REWRITE DEFAULT-CDR)))
(MY-IND)
(NATS-EQUIV-IMPLIES-NAT-EQUIV-NTH-2 (79 25 (:REWRITE ZP-OPEN))
...
(NATS-EQUIV-IMPLIES-NATS-EQUIV-REVAPPEND-2 (63 33 (:REWRITE DEFAULT-CAR))
                                           (61 31 (:REWRITE DEFAULT-CDR))
                                           (28 28 (:REWRITE DEFAULT-<-2))
                                           (28 28 (:REWRITE DEFAULT-<-1)))
(NATS-EQUIV-IMPLIES-NATS-EQUIV-TAKE-2 (897 68 (:REWRITE TAKE-OF-LEN-FREE))
...
(NATS-EQUIV-IMPLIES-NATS-EQUIV-NTHCDR-2 (134 95 (:REWRITE DEFAULT-CAR))
...
(NATS-EQUIV-IMPLIES-NATS-EQUIV-MAKE-LIST-AC-3 (37 27 (:REWRITE DEFAULT-CDR))
