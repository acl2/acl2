...
(FLATTEN)
(TRUE-LISTP-OF-FLATTEN (9 3 (:DEFINITION BINARY-APPEND))
                       (8 8 (:REWRITE DEFAULT-CDR))
                       (6 6 (:REWRITE DEFAULT-CAR))
                       (6 3 (:DEFINITION TRUE-LISTP)))
(FLATTEN-WHEN-NOT-CONSP)
(FLATTEN-OF-CONS (15 5 (:DEFINITION BINARY-APPEND))
                 (8 8 (:REWRITE DEFAULT-CDR))
                 (8 8 (:REWRITE DEFAULT-CAR))
                 (6 6 (:REWRITE FLATTEN-WHEN-NOT-CONSP)))
(FLATTEN-OF-LIST-FIX (72 9 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
