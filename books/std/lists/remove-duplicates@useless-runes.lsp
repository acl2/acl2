...
(REV-OF-REMOVE-EQUAL)
(L0 (1895 86 (:DEFINITION MEMBER-EQUAL))
...
(HONS-REMOVE-DUPLICATES (134 2 (:DEFINITION REMOVE-DUPLICATES-EQUAL))
...
(HONS-REMOVE-DUPLICATES1-ACL2-COUNT (215 102 (:REWRITE DEFAULT-+-2))
