...
(NTHCDR-WHEN-ZP (38 19
                    (:TYPE-PRESCRIPTION TRUE-LISTP-NTHCDR-TYPE-PRESCRIPTION))
                (19 19 (:TYPE-PRESCRIPTION TRUE-LISTP))
                (1 1 (:REWRITE ZP-OPEN)))
(NTHCDR-WHEN-ATOM (10 10 (:REWRITE DEFAULT-+-2))
                  (10 10 (:REWRITE DEFAULT-+-1))
                  (9 9 (:REWRITE DEFAULT-<-2))
                  (9 9 (:REWRITE DEFAULT-<-1)))
(NTHCDR-OF-CONS (44 6 (:REWRITE NTHCDR-WHEN-ZP))
...
(LEN-OF-NTHCDR (193 121 (:REWRITE DEFAULT-+-2))
...
(CONSP-OF-NTHCDR
     ...
     (2 2
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(OPEN-SMALL-NTHCDR (44 6 (:REWRITE NTHCDR-WHEN-ZP))
                   (42 11 (:REWRITE ZP-OPEN))
                   (17 7 (:DEFINITION NOT))
                   (12 12 (:REWRITE DEFAULT-<-2))
                   (12 12 (:REWRITE DEFAULT-<-1))
                   ...
                   (6 2 (:REWRITE FOLD-CONSTS-IN-+))
                   (5 5 (:REWRITE DEFAULT-CDR)))
(ACL2-COUNT-OF-CDR (100 48 (:REWRITE DEFAULT-+-2))
...
(ACL2-COUNT-OF-CDR-WEAK (133 66 (:REWRITE DEFAULT-+-2))
...
(ACL2-COUNT-OF-CONSP-POSITIVE (34 20 (:REWRITE DEFAULT-+-2))
...
(ACL2-COUNT-OF-NTHCDR-LINEAR-WEAK
     ...
     (56 16
         (:LINEAR ACL2-COUNT-OF-NTHCDR-LINEAR))
...
(CAR-OF-NTHCDR (108 13 (:REWRITE DEFAULT-CAR))
...
(NTHCDR-OF-CDR (115 5 (:REWRITE CONSP-OF-NTHCDR))
               ...
               (15 5 (:DEFINITION NFIX))
               (6 2 (:REWRITE FOLD-CONSTS-IN-+)))
(NTHCDR-WHEN-LESS-THAN-LEN-UNDER-IFF (90 20 (:REWRITE DEFAULT-CDR))
...
(NTHCDR-OF-NTHCDR (898 102 (:REWRITE DEFAULT-CDR))
                  (794 38 (:REWRITE CONSP-OF-NTHCDR))
                  ...
                  (1 1
                     (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(APPEND-OF-TAKE-AND-NTHCDR (531 177 (:TYPE-PRESCRIPTION BINARY-APPEND))
                           ...
                           (6 2 (:REWRITE FOLD-CONSTS-IN-+)))
(NTHCDR-OF-LIST-FIX (355 20 (:REWRITE LIST-FIX-WHEN-LEN-ZERO))
...
(SUBSETP-OF-NTHCDR (672 124 (:REWRITE SUBSETP-TRANS))
                   ...
                   (10 1 (:DEFINITION NTH)))
(REST-N (220 35 (:REWRITE NTHCDR-WHEN-ZP))
