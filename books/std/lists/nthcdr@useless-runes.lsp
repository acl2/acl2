...
(NTHCDR-OF-LIST-FIX
 (355 20 (:REWRITE LIST-FIX-WHEN-LEN-ZERO))
...
(ELEMENT-LIST-P-OF-NTHCDR
 (1575 60 (:REWRITE ELEMENT-P-OF-CAR-WHEN-ELEMENT-LIST-NONEMPTY-P))
 (1378 30 (:DEFINITION ELEMENT-LIST-NONEMPTY-P))
 (880 44 (:REWRITE ELEMENT-LIST-NONEMPTY-P-OF-CDR-WHEN-ELEMENT-LIST-NONEMPTY-P))
