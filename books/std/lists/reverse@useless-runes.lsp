(STRINGP-OF-REVERSE (15 2 (:DEFINITION REVAPPEND))
                    (5 5
...
(TRUE-LISTP-OF-REVERSE (15 2 (:DEFINITION REVAPPEND))
                       ...
                       (1 1
                          (:REWRITE STR::EXPLODE-WHEN-NOT-STRINGP)))
(LEN-ZERO (9 5 (:REWRITE DEFAULT-+-2))
          (5 5 (:REWRITE DEFAULT-+-1))
          (4 4 (:REWRITE DEFAULT-CDR)))
(IND (121 58 (:REWRITE DEFAULT-+-2))
...
(L0 (710 70 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
    ...
    (56 7
        (:REWRITE EQUAL-OF-REVAPPENDS-WHEN-TRUE-LISTPS)))
(L1 (182 91
    ...
    (1 1 (:REWRITE L0)))
(L2 (40 4 (:REWRITE LIST-FIX-WHEN-LEN-ZERO))
...
(REVAPPEND-LEMMA
     ...
     (4 4 (:REWRITE LIST-FIX-WHEN-NOT-CONSP))
     (4 4 (:DEFINITION ATOM)))
(EQUAL-OF-REVERSES (108 12 (:DEFINITION REVAPPEND))
