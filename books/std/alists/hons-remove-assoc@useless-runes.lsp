(HONS-REMOVE-ASSOC-OF-CONS (26 26 (:REWRITE DEFAULT-CAR))
                           (18 18 (:REWRITE DEFAULT-CDR)))
(HONS-REMOVE-ASSOC-OF-ATOM)
(HONS-REMOVE-ASSOC-COMMUTES (193 193 (:REWRITE DEFAULT-CAR))
                            (119 119 (:REWRITE DEFAULT-CDR)))
(HONS-ASSOC-EQUAL-REMOVE-ASSOC (292 283 (:REWRITE DEFAULT-CAR))
                               (127 124 (:REWRITE DEFAULT-CDR)))
(HONS-REMOVE-ASSOC-OF-FAST-ALIST-FORK (299 288 (:REWRITE DEFAULT-CAR))
                                      (190 182 (:REWRITE DEFAULT-CDR)))
(HONS-REMOVE-ASSOC-OF-APPEND (110 109 (:REWRITE DEFAULT-CAR))
...
(HONS-REMOVE-ASSOC-OF-ALIST-FIX
     ...
     (560 31
          (:REWRITE HONS-ASSOC-EQUAL-OF-ALIST-FIX))
