(PAIRLIS$-WHEN-ATOM)
(PAIRLIS$-OF-CONS (8 8 (:REWRITE DEFAULT-CDR))
                  (8 8 (:REWRITE DEFAULT-CAR))
                  (6 6 (:REWRITE PAIRLIS$-WHEN-ATOM)))
(LEN-OF-PAIRLIS$ (14 7 (:REWRITE DEFAULT-+-2))
                 (11 10 (:REWRITE DEFAULT-CDR))
                 (7 7 (:REWRITE DEFAULT-+-1))
                 (6 6 (:REWRITE DEFAULT-CAR)))
(ALISTP-OF-PAIRLIS$ (11 10 (:REWRITE DEFAULT-CAR))
                    (9 8 (:REWRITE DEFAULT-CDR)))
(STRIP-CARS-OF-PAIRLIS$ (98 11 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
...
(PAIRLIS$-OF-LIST-FIX-LEFT (72 9 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
