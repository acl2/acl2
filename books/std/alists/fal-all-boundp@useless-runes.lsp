...
(FAL-ALL-BOUNDP-OF-CONS (50 5 (:DEFINITION HONS-ASSOC-EQUAL))
...
(L1 (24 2 (:DEFINITION HONS-ASSOC-EQUAL))
...
(FAL-ALL-BOUNDP-OF-APPEND (166 166 (:REWRITE DEFAULT-CAR))
...
(FAL-ALL-BOUNDP-OF-REVAPPEND (64 4 (:DEFINITION FAL-ALL-BOUNDP))
