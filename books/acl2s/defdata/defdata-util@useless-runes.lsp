...
(DEFDATA::JOIN-NAMES (13 13 (:REWRITE DEFAULT-CAR))
                     (8 8 (:REWRITE DEFAULT-CDR))
                     (1 1 (:REWRITE DEFAULT-SYMBOL-NAME)))
(DEFDATA::JOIN-NAMES-IS-STRINGP)
(DEFDATA::EXTRACT-KWD-VAL-FN)
(DEFDATA::KEYWORD-LISTP)
(DEFDATA::REMOVE-KEYWORDS (105 102 (:REWRITE DEFAULT-CDR))
                          (66 65 (:REWRITE DEFAULT-CAR))
                          (38 38
                              (:REWRITE DEFAULT-SYMBOL-PACKAGE-NAME)))
(DEFDATA::REMOVE-KEYWORDS-FROM-ARGS)
(DEFDATA::S+-FN (33 33 (:REWRITE DEFAULT-CAR))
                (16 16 (:REWRITE DEFAULT-CDR))
                (6 6
                   (:REWRITE DEFAULT-SYMBOL-PACKAGE-NAME)))
(DEFDATA::MODIFY-SYMBOL-LST (12 12 (:REWRITE DEFAULT-CAR))
                            (7 7 (:REWRITE DEFAULT-CDR)))
(DEFDATA::GET-DEST-PREFIX)
(DEFDATA::GET-MODIFIER-PREFIX (2 2 (:REWRITE DEFAULT-SYMBOL-NAME))
                              (2 2 (:REWRITE DEFAULT-CDR))
                              (2 2 (:REWRITE DEFAULT-CAR)))
(DEFDATA::SYMBOL-NAMES (2 2 (:REWRITE DEFAULT-CAR))
                       (1 1 (:REWRITE DEFAULT-CDR)))
(DEFDATA::STRIP-CADRS (15 15 (:REWRITE DEFAULT-CDR))
                      (12 12 (:REWRITE DEFAULT-CAR)))
(DEFDATA::GET-EVENT-NAMES (235 235 (:REWRITE DEFAULT-CAR))
                          (114 114 (:REWRITE DEFAULT-CDR)))
(DEFDATA::KEYWORDIFY)
(DEFDATA::LIST-UP-LISTS (16 16 (:REWRITE DEFAULT-CDR))
...
(DEFDATA::PROPER-SYMBOL-LISTP-IS-SYMBOL-LIST
     (28 4
         (:REWRITE DEFDATA::PROPER-SYMBOL-DISJOINT-WITH-KEYS))
     (20 4 (:DEFINITION KEYWORDP))
     (12 12
         (:TYPE-PRESCRIPTION STRINGP-SYMBOL-PACKAGE-NAME))
     (12 4
         (:REWRITE DEFDATA::PROPER-SYMBOL-DISJOINT-WITH-BOOL))
...
(DEFDATA::BASE-ALIAS-TYPE (101 101 (:REWRITE DEFAULT-CAR))
                          (50 10 (:DEFINITION SYMBOL-ALISTP))
                          (38 38 (:REWRITE DEFAULT-CDR)))
(DEFDATA::BASE-ALIAS-PRED (101 101 (:REWRITE DEFAULT-CAR))
                          (50 10 (:DEFINITION SYMBOL-ALISTP))
                          (38 38 (:REWRITE DEFAULT-CDR)))
...
(DEFDATA::GET-TYPESYMBOL-FROM-PRED-P-NAMING-CONVENTION
     ...
     (1 1
        (:REWRITE DEFAULT-SYMBOL-PACKAGE-NAME))
     (1 1 (:REWRITE DEFAULT-SYMBOL-NAME)))
(DEFDATA::MAKE-PREDICATE-SYMBOL (2 2 (:REWRITE DEFAULT-CAR))
                                (1 1 (:REWRITE DEFAULT-CDR)))
(DEFDATA::MAKE-PREDICATE-SYMBOL-LST
     ...
     (2 2 (:REWRITE DEFAULT-CAR))
     (1 1 (:REWRITE DEFAULT-CDR)))
(DEFDATA::MAKE-ENUMERATOR-SYMBOL (3 3 (:REWRITE DEFAULT-CAR))
                                 (2 2 (:REWRITE DEFAULT-CDR)))
(DEFDATA::MAKE-UNIFORM-ENUMERATOR-SYMBOL (3 3 (:REWRITE DEFAULT-CAR))
                                         (2 2 (:REWRITE DEFAULT-CDR)))
...
(DEFDATA::REPLACE-CALLS-WITH-NAMES (121 58 (:REWRITE DEFAULT-+-2))
                                   (81 58 (:REWRITE DEFAULT-+-1))
                                   (48 12 (:REWRITE COMMUTATIVITY-OF-+))
                                   (48 12 (:DEFINITION INTEGER-ABS))
                                   (48 6 (:DEFINITION LENGTH))
...
(DEFDATA::TO-STRING1)
(DEFDATA::FUNCALL-W)
(DEFDATA::EXPAND-LAMBDA (405 175 (:REWRITE DEFAULT-+-2))
...
(DEFDATA::KEEP-NAMES)
(DEFDATA::REMOVE-NAMES (1 1
                          (:TYPE-PRESCRIPTION DEFDATA::REMOVE-NAMES)))
(DEFDATA::PAIR-PREFIX)
...
(DEFDATA::REMOVE1-ASSOC-ALL (2 2 (:REWRITE DEFAULT-CAR))
                            (1 1 (:REWRITE DEFAULT-CDR)))
(DEFDATA::UNION-ALIST2 (68 67 (:REWRITE DEFAULT-CAR))
                       (40 39 (:REWRITE DEFAULT-CDR)))
(DEFDATA::ALIST-EQUIV (1624 752 (:REWRITE DEFAULT-+-2))
...
(DEFDATA::CONVERT-LISTPAIRS-TO-CONSPAIRS (16 16 (:REWRITE DEFAULT-CAR))
                                         (11 11 (:REWRITE DEFAULT-CDR)))
(DEFDATA::CONVERT-CONSPAIRS-TO-LISTPAIRS (8 8 (:REWRITE DEFAULT-CAR))
                                         (2 2 (:REWRITE DEFAULT-CDR)))
(DEFDATA::GET-TAU-INT)
(DEFDATA::FLATTEN-ANDS (16 16 (:REWRITE DEFAULT-CAR))
                       (11 11 (:REWRITE DEFAULT-CDR))
                       (10 10
