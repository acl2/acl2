...
(DEFDATA::RANDOM-BOOLEAN-TYPE (3 2 (:REWRITE DEFAULT-CAR))
                              (2 1 (:REWRITE DEFAULT-CDR)))
(DEFDATA::RANDOM-NATURAL-BASEMAX1
     (182 2
          (:DEFINITION DEFDATA::RANDOM-NATURAL-BASEMAX1))
...
(DEFDATA::RANDOM-NATURAL-BASEMAX2
     (214 2
          (:DEFINITION DEFDATA::RANDOM-NATURAL-BASEMAX2))
...
(DEFDATA::RANDOM-NATURAL-SEED-TYPE-CAR (4 4 (:REWRITE DEFAULT-<-2))
                                       (4 4 (:REWRITE DEFAULT-<-1))
                                       (1 1 (:REWRITE DEFAULT-CAR)))
(DEFDATA::RANDOM-NATURAL-SEED-TYPE-CAR-TYPE
     (16 8
         (:TYPE-PRESCRIPTION DEFDATA::RANDOM-NATURAL-SEED-TYPE-CAR))
     (8 8 (:TYPE-PRESCRIPTION UNSIGNED-BYTE-P))
     (6 6 (:REWRITE DEFAULT-<-2))
     (6 6 (:REWRITE DEFAULT-<-1))
     (2 2 (:REWRITE DEFAULT-CAR)))
(DEFDATA::RANDOM-NATURAL-SEED-TYPE-CADR (6 6 (:REWRITE DEFAULT-<-2))
                                        (6 6 (:REWRITE DEFAULT-<-1))
...
(DEFDATA::RANDOM-NATURAL-SEED-TYPE-CADR-TYPE (2 2 (:REWRITE DEFAULT-<-2))
...
(DEFDATA::RANDOM-NATURAL-BASEMAX1-TYPE-CADR-TYPE
     ...
     (24 4
         (:LINEAR DEFDATA::RANDOM-NATURAL-BASEMAX1-TYPE-CADR-0))
...
(DEFDATA::RANDOM-NATURAL-BASEMAX2-TYPE-CADR-TYPE
     ...
     (29 29 (:REWRITE DEFAULT-*-1))
     (24 4
         (:LINEAR DEFDATA::RANDOM-NATURAL-BASEMAX2-TYPE-CADR-0))
     (16 4 (:DEFINITION UNSIGNED-BYTE-P))
     (14 2
         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (12 4 (:DEFINITION INTEGER-RANGE-P))
...
(DEFDATA::RANDOM-NATURAL-SEED-TYPE/0.5-CAR
     ...
     (10 10
         (:TYPE-PRESCRIPTION DEFDATA::GENRANDOM-SEED))
     (8 4 (:REWRITE DEFAULT-CAR))
     (7 7
        (:TYPE-PRESCRIPTION DEFDATA::GENRANDOM-NATURAL2-TYPE))
     (6 6 (:REWRITE DEFAULT-<-2))
     (6 3 (:REWRITE DEFAULT-CDR))
     (5 5 (:REWRITE DEFAULT-+-1))
     (4 4
        (:TYPE-PRESCRIPTION DEFDATA::GENRANDOM-NATURAL1))
...
(DEFDATA::RANDOM-NATURAL-SEED-TYPE/0.5-CAR-TYPE
     ...
     (16 8
         (:TYPE-PRESCRIPTION DEFDATA::RANDOM-NATURAL-SEED-TYPE/0.5-CAR))
...
(DEFDATA::RANDOM-NATURAL-SEED-TYPE/0.5-CADR
     ...
     (28 28
         (:TYPE-PRESCRIPTION DEFDATA::RANDOM-NATURAL-BASEMAX1))
     (28 14
         (:TYPE-PRESCRIPTION DEFDATA::RANDOM-NATURAL-BASEMAX1-TYPE-CAR))
     (28 10 (:REWRITE DEFAULT-+-2))
     (24 2 (:REWRITE ASSOCIATIVITY-OF-+))
     (24 2 (:DEFINITION NFIX))
...
(DEFDATA::RANDOM-NATURAL-SEED-TYPE/0.25-CAR-TYPE
     ...
     (20 10 (:REWRITE DEFAULT-<-1))
     (16 8
         (:TYPE-PRESCRIPTION DEFDATA::RANDOM-NATURAL-SEED-TYPE/0.25-CAR))
     (16 8 (:REWRITE DEFAULT-CAR))
     (14 14
         (:TYPE-PRESCRIPTION DEFDATA::GENRANDOM-NATURAL2-TYPE))
     (12 6 (:REWRITE DEFAULT-CDR))
...
(DEFDATA::RANDOM-NATURAL-SEED-TYPE/0.25-CADR
     ...
     (52 12 (:DEFINITION MV-NTH))
     (28 28
         (:TYPE-PRESCRIPTION DEFDATA::RANDOM-NATURAL-BASEMAX2))
     (28 14
         (:TYPE-PRESCRIPTION DEFDATA::RANDOM-NATURAL-BASEMAX2-TYPE-CAR))
     (28 10 (:REWRITE DEFAULT-+-2))
     (24 2 (:REWRITE ASSOCIATIVITY-OF-+))
     (24 2 (:DEFINITION NFIX))
     (22 10 (:REWRITE DEFAULT-<-1))
...
(DEFDATA::RANDOM-INTEGER-SEED (8 5 (:REWRITE DEFAULT-<-1))
                              (6 3 (:REWRITE DEFAULT-CDR))
                              (6 3 (:REWRITE DEFAULT-CAR))
                              (5 5 (:REWRITE DEFAULT-<-2)))
(DEFDATA::RANDOM-INTEGER-BETWEEN-SEED (16 16 (:REWRITE DEFAULT-<-2))
