(CONS-SIZE)
(CONS-SIZE-TYPE)
(ACONS-CONS-SIZE-LEMMA (71 27 (:REWRITE DEFAULT-+-2))
...
(SPLIT-LIST-1-CONS-SIZE (92 41 (:REWRITE DEFAULT-+-2))
...
(HEAD-CONS-SIZE (55 22 (:REWRITE DEFAULT-+-2))
...
(TAIL-CONS-SIZE (55 22 (:REWRITE DEFAULT-+-2))
                (33 22 (:REWRITE DEFAULT-+-1))
                (30 9 (:REWRITE SET::NONEMPTY-MEANS-SET))
...
(REV-CONS-SIZE-LEMMA (52 22 (:REWRITE DEFAULT-+-2))
                     (33 22 (:REWRITE DEFAULT-+-1))
...
(CONS-SIZE-EVENS-STRONG (705 294 (:REWRITE DEFAULT-+-2))
...
(CONS-SIZE-EVENS-WEAK (241 97 (:REWRITE DEFAULT-+-2))
...
(CONS-SIZE-OF-REMOVE-ASSOC-EQUAL-UPPER-BOUND
     ...
     (5 5 (:REWRITE CONSP-OF-CDR-BY-LEN)))
(CONS-SIZE-WHEN-MEMBER (89 40 (:REWRITE DEFAULT-+-2))
...
(CONS-SIZE-OF-NTH-LINEAR-WEAK (42 18 (:REWRITE DEFAULT-+-2))
...
(CONS-SIZE-OF-NTH-LINEAR (256 115 (:REWRITE DEFAULT-+-2))
                         ...
                         (3 3
                            (:REWRITE HONS-DUPLICITY-ALIST-P-WHEN-NOT-CONSP))
                         (3 3 (:REWRITE ALISTP-WHEN-ATOM)))
(CONS-SIZE-OF-PROD-CONS1 (25 10 (:REWRITE DEFAULT-+-2))
                         (24 24
...
(CONS-SIZE-OF-PROD-CONS2 (48 20 (:REWRITE DEFAULT-+-2))
                         (32 32
                             (:TYPE-PRESCRIPTION STD::PROD-CONS-WHEN-EITHER))
                         (32 11
                             (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
...
(RECORDS-CONS-SIZE-LINEAR-ARITH-<
     ...
     (24 24 (:TYPE-PRESCRIPTION ACL2->MAP)))
(RECORDS-CONS-SIZE (3550 251 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
                   (1735 359
                         (:REWRITE ALISTP-WHEN-HONS-DUPLICITY-ALIST-P))
                   (1188 583
                         (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
...
(LEN-<=-CONS-SIZE (45 18 (:REWRITE DEFAULT-+-2))
                  (28 14
                      (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
                  ...
                  (3 3 (:REWRITE ALISTP-WHEN-ATOM)))
(CONS-SIZE-<=-ACL2-COUNT (82 37 (:REWRITE DEFAULT-+-2))
                         ...
                         (2 2 (:REWRITE CONSP-OF-CDR-BY-LEN))
                         (2 2 (:REWRITE ALISTP-WHEN-ATOM)))
(ACL2-SIZE (1103 483 (:REWRITE DEFAULT-+-2))
