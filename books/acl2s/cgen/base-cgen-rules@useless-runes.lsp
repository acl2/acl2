(TLP-FXR)
(TLP-FXR-TYPE)
(TLP-FXR-TYPE2 (4 4 (:REWRITE DEFAULT-CAR))
               (3 3 (:REWRITE DEFAULT-CDR)))
(TLP-FXR-TYPE3 (14 7 (:REWRITE DEFAULT-+-2))
               (10 8 (:REWRITE DEFAULT-CDR))
               (8 8 (:TYPE-PRESCRIPTION TLP-FXR-TYPE2))
               (7 7 (:REWRITE DEFAULT-+-1))
               (3 3 (:REWRITE TLP-FXR-TYPE2))
               (3 3 (:REWRITE DEFAULT-CAR)))
(MEMBER-FIXER1 (86 7 (:DEFINITION MEMBER-EQUAL))
...
(MEMBER-FIXER2 (7 7 (:TYPE-PRESCRIPTION TLP-FXR-TYPE2)))
(LEN-FIXER/REPEAT (70 36 (:REWRITE DEFAULT-+-2))
...
(_MAX-LST)
(_MAKE-NUMLIST)
(NOT-INTERSECTP-FIX2 (11 11 (:TYPE-PRESCRIPTION TLP-FXR-TYPE2)))
(NO-DUPS-FIX (4 4 (:TYPE-PRESCRIPTION TLP-FXR-TYPE2)))
(REM-EQL-FIXER2)
(REMOVE1-EQUAL-FIXER2)
(SUBSETP-FIXER1)
(CONSP-FIXER/FOR-ALIST-FIXER)
(ALIST-FIXER)
(ALIST-FIXER-TYPE (24 6 (:REWRITE O-P-O-INFP-CAR))
                  (14 8 (:REWRITE ACL2S::DEF=>ALIST))
                  (8 7 (:REWRITE DEFAULT-CAR))
                  (7 6 (:REWRITE DEFAULT-CDR))
                  (6 6 (:REWRITE O-P-DEF-O-FINP-1)))
(ALIST-FIXER-TYPE2 (16 4 (:REWRITE O-P-O-INFP-CAR))
                   (8 8 (:TYPE-PRESCRIPTION O-P))
                   (4 4 (:REWRITE O-P-DEF-O-FINP-1))
                   (4 4 (:REWRITE DEFAULT-CAR))
                   (3 3 (:REWRITE DEFAULT-CDR)))
(ALIST-FIXER-TYPE3 (14 7 (:REWRITE DEFAULT-+-2))
                   (12 3 (:REWRITE O-P-O-INFP-CAR))
                   (10 8 (:REWRITE DEFAULT-CDR))
                   (8 8
                      (:TYPE-PRESCRIPTION ALIST-FIXER-TYPE2))
                   (7 7 (:REWRITE DEFAULT-+-1))
