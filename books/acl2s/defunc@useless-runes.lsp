...
(ACL2S::SIMPLE-TERMP
     ...
     (474 17 (:DEFINITION TRUE-LIST-LISTP))
     (423 18
          (:REWRITE ACL2S::SYMBOL-LISTP-IMPLIES-TLP))
     (348 326 (:REWRITE DEFAULT-CAR))
     (326 326 (:REWRITE CAR-WHEN-ALL-EQUALP))
     (275 113 (:REWRITE DEFAULT-+-2))
     (256 18
          (:REWRITE ACL2S::PROPER-SYMBOL-LISTP-IMPLIES-TLP))
     (207 22 (:DEFINITION NAT-LISTP))
     (207 15
          (:DEFINITION ACL2S::PROPER-SYMBOL-LISTP))
     (202 192 (:REWRITE DEFAULT-CDR))
     (172 18
...
(ACL2S::MAKE-VERIFY-GUARDS-EV (18 18
...
(MODIFY-XARGS-DECL)
(UPDATE-XARGS-DECLS-FN (5 5 (:TYPE-PRESCRIPTION LAST)))
(ACL2S::PRINT-TIME-TAKEN)
(ACL2S::PRINT-SUMMARY-EV (1 1
                            (:TYPE-PRESCRIPTION DEFDATA::GET1-FN)))
...
(COLLECT-XARGS-INTO-SINGLE-DECLARE
     (3 3
        (:TYPE-PRESCRIPTION ACL2S::UNION-KEYWORD-VALUE-LISTS)))
