(ACL2S-SIZE)
(ACL2S-SIZE-TYPE-FC)
(ACONS-ACL2S-SIZE-LEMMA (71 27 (:REWRITE DEFAULT-+-2))
...
(ACL2S-SIZE-WHEN-MEMBER (112 14 (:DEFINITION LENGTH))
...
(TAIL-ACL2S-SIZE (55 22 (:REWRITE DEFAULT-+-2))
...
(HEAD-ACL2S-SIZE (50 2 (:DEFINITION ACL2S-SIZE))
...
(SPLIT-LIST-1-ACL2S-SIZE (102 45 (:REWRITE DEFAULT-+-2))
...
(RECORDS-ACL2S-SIZE-LINEAR-ARITH-<2
     ...
     (21 21
         (:REWRITE MEMBER-EQUAL-WHEN-ALL-EQUALP))
     (14 14 (:TYPE-PRESCRIPTION ACL2->MAP)))
(RECORDS-ACL2S-SIZE (3412 272 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
                    (1665 354
                          (:REWRITE ALISTP-WHEN-HONS-DUPLICITY-ALIST-P))
                    (1188 583
                          (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
                    ...
                    (1 1
                       (:LINEAR STR::COUNT-LEADING-CHARSET-LEN)))
(ACL2S-SIZE-EVENS-WEAK (241 96 (:REWRITE DEFAULT-+-2))
...
(ACL2S-SIZE-EVENS-STRONG
     ...
     (5 5
        (:REWRITE MEMBER-EQUAL-WHEN-ALL-EQUALP)))
(ACL2-SIZE-APPEND (535 259 (:REWRITE DEFAULT-+-2))
                  ...
                  (2 2
                     (:REWRITE HONS-DUPLICITY-ALIST-P-WHEN-NOT-CONSP))
                  (2 2 (:REWRITE ALISTP-WHEN-ATOM)))
(ACL2S-SIZE-APPEND-TLP (170 70 (:REWRITE DEFAULT-+-2))
...
(REV-ACL2S-SIZE (54 21
                ...
                (2 1 (:REWRITE SUBSETP-CAR-MEMBER))
                (1 1 (:TYPE-PRESCRIPTION SUBSETP-EQUAL)))
(REV-ACL2S-SIZE-TLP (222 96 (:REWRITE DEFAULT-+-2))
...
(ACL2S-SIZE-OF-HONS-REMOVE-DUPLICATES
     ...
     (1 1
        (:REWRITE REMOVE-DUPLICATES-EQUAL-UNDER-SET-EQUIV))
...
(ACL2S-SIZE-<=-ACL2-COUNT
     ...
     (1 1 (:REWRITE |(< y (+ (- c) x))|))
     (1 1 (:REWRITE |(< x (+ c/d y))|)))
(LEN-<=-ACL2S-SIZE (1078 489 (:REWRITE DEFAULT-+-2))
...
(ACL2S-SIZE-O<-< (116 4 (:DEFINITION ACL2S-SIZE))
                 ...
                 (2 2
                    (:REWRITE MEMBER-EQUAL-WHEN-ALL-EQUALP)))
(ACL2S-SIZE-BUILT-IN-2 (50 2 (:DEFINITION ACL2S-SIZE))
                       (10 4 (:REWRITE DEFAULT-+-2))
                       (8 1 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
                       (8 1 (:DEFINITION LENGTH))
                       (6 4 (:REWRITE DEFAULT-+-1))
                       ...
                       (1 1 (:REWRITE DEFAULT-<-1))
                       (1 1 (:REWRITE ALISTP-WHEN-ATOM)))
(ACL2S-SIZE-BUILT-IN-3 (519 233 (:REWRITE DEFAULT-+-2))
                       ...
                       (3 3
                          (:REWRITE MEMBER-EQUAL-WHEN-ALL-EQUALP)))
(ACL2S-SIZE-BUILT-IN-4 (50 2 (:DEFINITION ACL2S-SIZE))
                       (10 4 (:REWRITE DEFAULT-+-2))
                       (8 1 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
                       (8 1 (:DEFINITION LENGTH))
                       (6 4 (:REWRITE DEFAULT-+-1))
                       ...
                       (1 1 (:REWRITE DEFAULT-<-1))
                       (1 1 (:REWRITE ALISTP-WHEN-ATOM)))
(ACL2S-SIZE-BUILT-IN-5 (43 2 (:DEFINITION ACL2S-SIZE))
                       (10 4 (:REWRITE DEFAULT-+-2))
                       (8 1 (:DEFINITION LENGTH))
...
(ACL2S-SIZE-BUILT-IN-6 (50 2 (:DEFINITION ACL2S-SIZE))
                       (10 4 (:REWRITE DEFAULT-+-2))
                       (8 1 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
                       (8 1 (:DEFINITION LENGTH))
                       (6 4 (:REWRITE DEFAULT-+-1))
                       ...
                       (1 1 (:REWRITE DEFAULT-<-1))
                       (1 1 (:REWRITE ALISTP-WHEN-ATOM)))
(ACL2S-SIZE-BUILT-IN-7 (43 2 (:DEFINITION ACL2S-SIZE))
                       (10 4 (:REWRITE DEFAULT-+-2))
                       (8 1 (:DEFINITION LENGTH))
                       (7 2 (:REWRITE ACL2S-SIZE-WHEN-MEMBER))
                       (6 4 (:REWRITE DEFAULT-+-1))
