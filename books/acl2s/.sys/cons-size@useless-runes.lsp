...
(RECORDS-CONS-SIZE-LINEAR-ARITH-<=
 (418 39 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
 (260 100 (:REWRITE DEFAULT-+-2))
 (225 62 (:REWRITE <<-TRICHOTOMY))
 (208 52 (:REWRITE ALISTP-WHEN-HONS-DUPLICITY-ALIST-P))
 (199 37 (:REWRITE <<-ASYMMETRIC))
 (154 76 (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
...
(RECORDS-CONS-SIZE-LINEAR-ARITH-<
 ...
 (66 66 (:LINEAR CONS-SIZE-WHEN-MEMBER))
 )
(RECORDS-CONS-SIZE
 (1576 174 (:REWRITE CONSP-OF-CAR-WHEN-ALISTP))
 (1071 13 (:LINEAR RECORDS-CONS-SIZE-LINEAR-ARITH-<))
 (1067 287 (:REWRITE <<-TRICHOTOMY))
 (955 172 (:REWRITE <<-ASYMMETRIC))
 (784 196 (:REWRITE ALISTP-WHEN-HONS-DUPLICITY-ALIST-P))
 (615 253 (:REWRITE DEFAULT-+-2))
 (519 255 (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
 (511 511 (:REWRITE CAR-WHEN-ALL-EQUALP))
 (392 392 (:TYPE-PRESCRIPTION HONS-DUPLICITY-ALIST-P))
 (392 392 (:TYPE-PRESCRIPTION ALISTP))
 (373 253 (:REWRITE DEFAULT-+-1))
 (300 281 (:REWRITE <<-TRANSITIVE))
 (255 255 (:TYPE-PRESCRIPTION TRUE-LISTP))
 (255 255 (:REWRITE CONSP-BY-LEN))
 (240 30 (:REWRITE ALISTP-OF-CDR))
 (196 196 (:REWRITE HONS-DUPLICITY-ALIST-P-WHEN-NOT-CONSP))
 (196 196 (:REWRITE ALISTP-WHEN-ATOM))
 (54 54 (:LINEAR CONS-SIZE-WHEN-MEMBER))
...
(ACL2-SIZE
 (1663 739 (:REWRITE DEFAULT-+-2))
 (1065 739 (:REWRITE DEFAULT-+-1))
