...
;; that should be certified to build ACL2s, with the possible
;; exception of books/system/doc/acl2-doc-wrap.lisp.  The
;; book mode-acl2s-dependencies.lisp includes that as well.
