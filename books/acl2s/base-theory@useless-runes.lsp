...
(ACL2S::GEN-CAR-CDR-AUX-CONTRACT
    ...
    (21610 176 (:REWRITE STR::EXPLODE-OF-IMPLODE))
    (18242 160
           (:REWRITE STR::MAKE-CHARACTER-LIST-OF-APPEND))
    (18192 7364 (:REWRITE DEFAULT-CAR))
    (17152 128 (:DEFINITION MAKE-CHARACTER-LIST))
    (15040 470
           (:REWRITE ACL2S::TRUE-LIST-LISTP-IMPLIES-TLP))
    (14288 188 (:DEFINITION TRUE-LIST-LISTP))
    (14234 9757 (:REWRITE DEFAULT-CDR))
    (11283 247 (:REWRITE APPEND-UNDER-IFF))
    (11008 344 (:DEFINITION CHARACTER-LISTP))
    (10042 470
           (:REWRITE ACL2S::PROPER-SYMBOL-LISTP-IMPLIES-TLP))
    ...
    (7614 470
          (:REWRITE ACL2S::BOOLEAN-LISTP-IMPLIES-TLP))
    (7392 7392 (:REWRITE CAR-WHEN-ALL-EQUALP))
    (6969 6969
          (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-SYMBOL-SYMBOL-ALISTP
                    . 2))
    (6969 6969
...
(ACL2S::GEN-CAR-CDR-DEFS-FN
     (422 28 (:REWRITE STR::CONSP-OF-EXPLODE))
     (331 5 (:DEFINITION BINARY-APPEND))
     (302 6
          (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV))
