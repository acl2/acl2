...
(INTEGERP-FMLA (1 1 (:REWRITE DEFAULT-*-2))
...
(FIND-MAXIMAL)
(FIND-MAXIMAL1-INCREASES (116 27 (:REWRITE DEFAULT-<-1))
                         (70 22
...
(INTEGERP-FIND-MAXIMAL1 (48 18 (:REWRITE DEFAULT-<-1))
...
(ABOVE-ALL (9 9 (:REWRITE DEFAULT-+-2))
           (9 9 (:REWRITE DEFAULT-+-1))
           ...
           (1 1
              (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(ABOVE-ALL-FIND-MAXIMAL1 (294 128 (:REWRITE DEFAULT-<-1))
...
(FIND-MAXIMAL-CORRECT (136 3 (:DEFINITION ABOVE-ALL))
