...
(TAU-BOUNDER-+
 ...
 (398 398 (:REWRITE PREFER-POSITIVE-ADDENDS-<))
 ...
 (362 362 (:LINEAR IN-TAU-INTERVALP-RULES . 2))
 (362 362 (:LINEAR IN-TAU-INTERVALP-RULES . 1))
 )
(TAU-BOUNDER-+-CORRECT
...
(TAU-BOUNDER-*
 ...
 (20335 20335 (:REWRITE THE-FLOOR-BELOW))
 (20335 20335 (:REWRITE THE-FLOOR-ABOVE))
 (20335 20335 (:REWRITE REMOVE-STRICT-INEQUALITIES))
 (20335 20335 (:REWRITE REDUCE-RATIONAL-MULTIPLICATIVE-CONSTANT-<))
 (20335 20335 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-<))
 (20335 20335 (:REWRITE REDUCE-ADDITIVE-CONSTANT-<))
 (20335 20335 (:REWRITE INTEGERP-<-CONSTANT))
 (20335 20335 (:REWRITE CONSTANT-<-INTEGERP))
 (20335 20335 (:REWRITE |(< c (/ x)) positive c --- present in goal|))
 (20335 20335 (:REWRITE |(< c (/ x)) positive c --- obj t or nil|))
 (20335 20335 (:REWRITE |(< c (/ x)) negative c --- present in goal|))
 (20335 20335 (:REWRITE |(< c (/ x)) negative c --- obj t or nil|))
 (20335 20335 (:REWRITE |(< c (- x))|))
 (20335 20335 (:REWRITE |(< (/ x) c) positive c --- present in goal|))
 (20335 20335 (:REWRITE |(< (/ x) c) positive c --- obj t or nil|))
 (20335 20335 (:REWRITE |(< (/ x) c) negative c --- present in goal|))
 (20335 20335 (:REWRITE |(< (/ x) c) negative c --- obj t or nil|))
 (20335 20335 (:REWRITE |(< (/ x) (/ y))|))
 (20335 20335 (:REWRITE |(< (- x) c)|))
 (20335 20335 (:REWRITE |(< (- x) (- y))|))
 (19840 19840 (:REWRITE PREFER-POSITIVE-ADDENDS-<))
 ...
 (5940 5940 (:LINEAR IN-TAU-INTERVALP-RULES . 2))
 (5940 5940 (:LINEAR IN-TAU-INTERVALP-RULES . 1))
...
(|tau-intervalp tau-bounder-*|
 ...
 (14491 14491 (:LINEAR IN-TAU-INTERVALP-RULES . 4))
 (14491 14491 (:LINEAR IN-TAU-INTERVALP-RULES . 3))
 (13906 13906 (:LINEAR IN-TAU-INTERVALP-RULES . 2))
 (13906 13906 (:LINEAR IN-TAU-INTERVALP-RULES . 1))
...
(|in-tau-intervalp tau-bounder-*|
 (472002 472002 (:REWRITE ARITH-NORMALIZE-FACTORS-SCATTER-EXPONENTS))
 (442558 442558 (:REWRITE |arith (* c (* d x))|))
 (229014 67688 (:REWRITE |extended-rationalp is rationalp when not nil or t|))
 (221086 221086 (:REWRITE |arith (- (* c x))|))
 (221086 221086 (:REWRITE |arith (* (- x) y)|))
 (169760 48392 (:REWRITE |rationalp is extended-rationalp|))
 (169136 67688 (:REWRITE |rationalp when acl2-numberp and extended-rationalp|))
 (142958 142958 (:TYPE-PRESCRIPTION EXTENDED-RATIONALP))
 (33988 33988 (:LINEAR IN-TAU-INTERVALP-RULES . 2))
 (33988 33988 (:LINEAR IN-TAU-INTERVALP-RULES . 1))
 (33982 33982 (:LINEAR IN-TAU-INTERVALP-RULES . 4))
 (33982 33982 (:LINEAR IN-TAU-INTERVALP-RULES . 3))
 (22398 22398 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-<))
 (22398 22398 (:REWRITE DEFAULT-LESS-THAN-2))
 (22398 22398 (:REWRITE DEFAULT-LESS-THAN-1))
 (20530 20530 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-REMAINDER))
 (20530 20530 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-COMMON))
 (19022 11942 (:REWRITE RATIONALP-X))
 (17744 2218 (:REWRITE ACL2-NUMBERP-X))
 (16187 16187 (:REWRITE REDUCE-INTEGERP-+))
 (14001 14001 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-=-0))
 (8256 8256 (:REWRITE DEFAULT-CDR))
 (7576 7576 (:REWRITE DEFAULT-TIMES-2))
 (7576 7576 (:REWRITE DEFAULT-TIMES-1))
 (2064 2064 (:REWRITE DEFAULT-CAR))
...
(TAU-BOUNDER-MOD-CORRECT
 ...
 (203582 44346 (:REWRITE |extended-rationalp is rationalp when not nil or t|))
 (168234 29332 (:REWRITE |rationalp is extended-rationalp|))
 (121968 44346 (:REWRITE |rationalp when acl2-numberp and extended-rationalp|))
 (91634 91634 (:TYPE-PRESCRIPTION NOT-INTEGERP-3B))
 (91634 91634 (:TYPE-PRESCRIPTION NOT-INTEGERP-2B))
 (91634 91634 (:TYPE-PRESCRIPTION NOT-INTEGERP-1B))
 (84258 84258 (:TYPE-PRESCRIPTION EXTENDED-RATIONALP))
 (82283 69716 (:REWRITE PREFER-POSITIVE-ADDENDS-<))
 (81743 69716 (:REWRITE SIMPLIFY-SUMS-<))
 (69889 69889 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-<))
 (69889 69889 (:REWRITE REDUCE-ADDITIVE-CONSTANT-<))
 (69889 69889 (:REWRITE INTEGERP-<-CONSTANT))
 (69889 69889 (:REWRITE CONSTANT-<-INTEGERP))
 (62076 4829 (:REWRITE |(mod (+ x (mod a b)) y)|))
 (62076 4829 (:REWRITE |(mod (+ x (- (mod a b))) y)|))
 (56140 6034 (:LINEAR MOD-BOUNDS-3))
 (46344 5226 (:REWRITE ACL2-NUMBERP-X))
 (44346 44346 (:REWRITE RATIONALP-MINUS-X))
 (31225 13753 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
 ...
 (25710 10690 (:REWRITE RATIONALP-X))
 (23588 4829 (:REWRITE DEFAULT-MOD-RATIO))
 (20905 19449 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
 (20283 20251 (:REWRITE REDUCE-INTEGERP-+))
 (20251 20251 (:REWRITE INTEGERP-MINUS-X))
 (19449 19449 (:REWRITE SIMPLIFY-SUMS-EQUAL))
 (19449 19449 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-EQUAL))
 (19449 19449 (:REWRITE REDUCE-ADDITIVE-CONSTANT-EQUAL))
 (19449 19449 (:REWRITE EQUAL-OF-PREDICATES-REWRITE))
 (19449 19449 (:REWRITE |(equal c (/ x))|))
 (19449 19449 (:REWRITE |(equal c (- x))|))
 (19449 19449 (:REWRITE |(equal (/ x) c)|))
 (19449 19449 (:REWRITE |(equal (/ x) (/ y))|))
 (19449 19449 (:REWRITE |(equal (- x) c)|))
 (19449 19449 (:REWRITE |(equal (- x) (- y))|))
 (18332 18268 (:REWRITE DEFAULT-TIMES-2))
 (18268 18268 (:REWRITE DEFAULT-TIMES-1))
 (17388 17388 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-<-0-RATIONAL-REMAINDER))
 (17388 17388 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-<-0-RATIONAL-COMMON))
 (17388 17388 (:REWRITE |(< (/ x) 0)|))
 (17388 17388 (:REWRITE |(< (* x y) 0)|))
 (17063 17063 (:REWRITE |(< 0 (/ x))|))
 (17063 17063 (:REWRITE |(< 0 (* x y))|))
 (17020 17020 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-REMAINDER))
 (17020 17020 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-COMMON))
 (16682 14546 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-<))
 (15628 14560 (:REWRITE DEFAULT-LESS-THAN-1))
 (12051 12051 (:REWRITE NORMALIZE-TERMS-SUCH-AS-1/AX+BX))
 (12051 12051 (:REWRITE DEFAULT-DIVIDE))
 (10861 10861 (:REWRITE NORMALIZE-FACTORS-GATHER-EXPONENTS))
 ...
 (9590 9590 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-=-0))
...
(LOGAND-TAU-BOUNDER-BOTH-NONNEGATIVE
 (65 65 (:TYPE-PRESCRIPTION |(< (logand x y) 0)| . 3))
 (65 65 (:TYPE-PRESCRIPTION |(< (logand x y) 0)| . 2))
...
(LOGAND-BOTH-NEGATIVE-LOWER-BOUND
 ...
 (24898 1420 (:REWRITE DEFAULT-FLOOR-RATIO))
 (15200 320 (:REWRITE FLOOR-CANCEL-*-CONST))
 (15040 320 (:REWRITE FLOOR-X-Y-=--1 . 2))
 (12884 6974 (:REWRITE DEFAULT-PLUS-2))
 (11704 2008 (:REWRITE |(< c (- x))|))
 (10924 6974 (:REWRITE DEFAULT-PLUS-1))
 (10589 9533 (:TYPE-PRESCRIPTION |(< (logand x y) 0)| . 2))
 (10083 2255 (:REWRITE |(equal c (- x))|))
 (9842 1406 (:REWRITE |(* x (+ y z))|))
 (9319 9319 (:REWRITE NORMALIZE-FACTORS-GATHER-EXPONENTS))
 (8264 4052 (:REWRITE |(* c (* d x))|))
 (7145 1269 (:REWRITE |(* (* x y) z)|))
 (6884 297 (:REWRITE |(not (equal (* (/ x) y) -1))|))
 (6884 297 (:REWRITE |(equal (* (/ x) y) -1)|))
 (6141 1661 (:REWRITE SIMPLIFY-SUMS-EQUAL))
 ...
 (5857 1367 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
 (5280 320 (:REWRITE CANCEL-FLOOR-+))
 (5245 5245 (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
 (5233 3633 (:REWRITE INTEGERP-MINUS-X))
 (4953 3313 (:REWRITE REDUCE-INTEGERP-+))
 (4480 32 (:REWRITE FLOOR-X-Y-=--1 . 1))
 (3467 1661 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
 (3320 2637 (:REWRITE DEFAULT-MINUS))
 (3309 3309 (:META META-INTEGERP-CORRECT))
 (2776 2271 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-EQUAL))
 (2727 1612 (:REWRITE SIMPLIFY-SUMS-<))
 (2724 2008 (:REWRITE |(< (/ x) c) negative c --- present in goal|))
 (2533 2074 (:REWRITE REDUCE-RATIONAL-MULTIPLICATIVE-CONSTANT-<))
 (2533 2074 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-<))
 (2400 320 (:REWRITE FLOOR-=-X/Y . 3))
 (2400 320 (:REWRITE FLOOR-=-X/Y . 2))
 (2255 2255 (:REWRITE REDUCE-ADDITIVE-CONSTANT-EQUAL))
 (2255 2255 (:REWRITE |(equal c (/ x))|))
 (2255 2255 (:REWRITE |(equal (/ x) c)|))
 (2255 2255 (:REWRITE |(equal (/ x) (/ y))|))
 (2255 2255 (:REWRITE |(equal (- x) (- y))|))
 ...
 (2092 2092 (:REWRITE THE-FLOOR-BELOW))
 (2092 2092 (:REWRITE THE-FLOOR-ABOVE))
 (2008 2008 (:REWRITE |(< c (/ x)) positive c --- present in goal|))
 (2008 2008 (:REWRITE |(< c (/ x)) positive c --- obj t or nil|))
 (2008 2008 (:REWRITE |(< c (/ x)) negative c --- present in goal|))
 (2008 2008 (:REWRITE |(< c (/ x)) negative c --- obj t or nil|))
 (2008 2008 (:REWRITE |(< (/ x) c) positive c --- present in goal|))
 (2008 2008 (:REWRITE |(< (/ x) c) positive c --- obj t or nil|))
 (2008 2008 (:REWRITE |(< (/ x) c) negative c --- obj t or nil|))
 (2008 2008 (:REWRITE |(< (/ x) (/ y))|))
 (2008 2008 (:REWRITE |(< (- x) (- y))|))
 (1971 118 (:LINEAR EXPT-<=-1-TWO))
 (1772 1420 (:REWRITE DEFAULT-FLOOR-1))
 (1766 966 (:REWRITE |(* (- x) y)|))
 (1661 1661 (:REWRITE EQUAL-OF-PREDICATES-REWRITE))
 (1661 1661 (:REWRITE |(equal (- x) c)|))
 (1624 1624 (:REWRITE INTEGERP-<-CONSTANT))
 (1624 1624 (:REWRITE CONSTANT-<-INTEGERP))
 (1624 1624 (:REWRITE |(< (- x) c)|))
 (1420 1420 (:REWRITE DEFAULT-FLOOR-2))
 (1344 168 (:REWRITE ZIP-OPEN))
 (1314 256 (:REWRITE DEFAULT-LOGAND-2))
 (1279 1279 (:REWRITE NORMALIZE-FACTORS-SCATTER-EXPONENTS))
 (1258 1258 (:REWRITE |(floor x 2)| . 2))
 (1231 1231 (:TYPE-PRESCRIPTION ABS))
 (1166 677 (:REWRITE DEFAULT-EXPT-2))
 (960 160 (:REWRITE |(* y (* x z))|))
 (818 818 (:REWRITE |(- (- x))|))
 (768 256 (:REWRITE DEFAULT-LOGAND-1))
 (695 695 (:REWRITE |(< (* x y) 0)|))
 (689 689 (:REWRITE |(< (/ x) 0)|))
 (687 687 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-<-0-RATIONAL-REMAINDER))
 (687 687 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-<-0-RATIONAL-COMMON))
 (677 677 (:REWRITE DEFAULT-EXPT-1))
 (642 98 (:LINEAR LOGAND-BOUNDS-POS . 2))
 (642 98 (:LINEAR LOGAND-BOUNDS-POS . 1))
 (631 631 (:REWRITE |(expt 1/c n)|))
 (631 631 (:REWRITE |(expt (- x) n)|))
 (483 483 (:REWRITE LOGAND-CONSTANT-MASK))
 ...
 (218 118 (:LINEAR EXPT-<-1-TWO))
 (218 4 (:REWRITE |(integerp (- x))|))
 (196 196 (:LINEAR LOGAND-TAU-BOUNDER-BOTH-NONNEGATIVE))
 (193 193 (:REWRITE |(< (+ c/d x) y)|))
 (184 68 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-<))
 (179 179 (:REWRITE |(< (+ (- c) x) y)|))
...
(TAU-BOUNDER-ASH
 ...
 (536 536 (:LINEAR IN-TAU-INTERVALP-RULES . 2))
 (536 536 (:LINEAR IN-TAU-INTERVALP-RULES . 1))
 (504 504 (:LINEAR IN-TAU-INTERVALP-RULES . 4))
 (504 504 (:LINEAR IN-TAU-INTERVALP-RULES . 3))
