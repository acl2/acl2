(SUM-LIST (2 2 (:REWRITE NAT-LISTP-WHEN-NOT-CONSP))
          (1 1 (:REWRITE DEFAULT-CDR)))
(SUM-LIST-WHEN-NOT-CONSP)
(SUM-LIST-OF-CONS (10 5 (:REWRITE DEFAULT-+-2))
...
(SUM-LIST-OF-LIST-FIX (43 4 (:REWRITE LIST-FIX-WHEN-LEN-ZERO))
...
(SUM-LIST-OF-APPEND (36 18
                    ...
                    (3 3
                       (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(NATP-OF-SUM-LIST-WHEN-NAT-LISTP (16 16 (:REWRITE SUM-LIST-WHEN-NOT-CONSP))
