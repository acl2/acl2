...
(Z-LISTP-OF-CONS (12 12 (:REWRITE Z-LISTP-WHEN-NOT-CONSP))
                 (8 8 (:REWRITE DEFAULT-CDR))
                 (8 8 (:REWRITE DEFAULT-CAR))
                 (5 5 (:REWRITE DEFAULT-<-2))
                 (5 5 (:REWRITE DEFAULT-<-1))
                 (1 1 (:REWRITE ZP-OPEN)))
(Z-LISTP-OF-LIST-FIX (61 7 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
...
(Z-LISTP-FORWARD-TO-ZP-OF-CAR (15 15 (:REWRITE DEFAULT-CAR))
