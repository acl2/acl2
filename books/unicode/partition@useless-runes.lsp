(PARTITION (2 2 (:REWRITE NAT-LISTP-WHEN-NOT-CONSP))
...
(CONSP-OF-PARTITION-UNDER-IFF (172 2 (:DEFINITION PARTITION))
...
(REASSEMBLE-LEMMA (370 26 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
...
(FLATTEN-OF-PARTITION
     ...
     (272 40
          (:REWRITE SUM-LIST-WHEN-NAT-LISTP-AND-Z-LISTP))
     ...
     (56 14
         (:REWRITE Z-LISTP-OF-CDR-WHEN-Z-LISTP))
     ...
     (1 1 (:REWRITE NATP-RW)))
(LEN-OF-CAR-OF-PARTITION (59 9 (:DEFINITION LEN))
