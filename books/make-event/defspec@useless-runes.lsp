...
(FOO-IDENTITY (3 3 (:TYPE-PRESCRIPTION F)))
(G (1 1 (:TYPE-PRESCRIPTION G)))
(G-IS-IDENTITY (3 3 (:TYPE-PRESCRIPTION G)))
(F (1 1 (:TYPE-PRESCRIPTION F)))
(G)
(G-IS-ARBITRARY)
(F (1 1 (:TYPE-PRESCRIPTION F)))
(F-IS-IDENTITY (3 3 (:TYPE-PRESCRIPTION F)))
(G)
(G-IS-IDENTITY)
(F (1 1 (:TYPE-PRESCRIPTION F)))
(F-IS-IDENTITY (3 3 (:TYPE-PRESCRIPTION F)))
...
(DOM2-INV2)
(BIJ2-IS-INJECTIVE)
(BIJ2-IS-SURJECTIVE (1 1 (:REWRITE DEFAULT-CDR))
                    (1 1 (:REWRITE DEFAULT-CAR)))
(LEMMA1 (88 4 (:DEFINITION SUM))
...
(LEMMA3 (488 29 (:DEFINITION SUM))
        ...
        (4 4 (:REWRITE DEFAULT-CAR))
        (2 2 (:REWRITE DEFAULT-CDR)))
(CANTOR-PAIRING-IS-BIJECTION (13533 869 (:DEFINITION SUM))
