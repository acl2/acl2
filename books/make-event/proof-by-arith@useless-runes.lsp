(PROOF-BY-ARITH-1 (14 14 (:REWRITE DEFAULT-CDR))
                  (14 7 (:DEFINITION TRUE-LISTP))
                  (9 9 (:REWRITE DEFAULT-CAR)))
(NNID (2 2 (:REWRITE INTEGERP==>DENOMINATOR=1))
...
(NNID2 (2 2 (:REWRITE INTEGERP==>DENOMINATOR=1))
       (2 2 (:REWRITE DEFAULT-DENOMINATOR))
       (2 2 (:REWRITE DEFAULT-*-2))
       (2 2 (:REWRITE DEFAULT-*-1))
       (1 1 (:REWRITE DEFAULT-<-2))
...
(|proof-by-arith.lisp easy|
     ...
     (1 1 (:REWRITE |(+ 0 x)|)))
(|proof-by-arith.lisp harder| (16 14 (:REWRITE DEFAULT-<-2))
