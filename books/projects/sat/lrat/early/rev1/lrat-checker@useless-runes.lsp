...
(FORMULA-FAL-P)
(FORMULA-FAL-MAX (257 257 (:REWRITE DEFAULT-CDR))
...
(FORMULA-P (76 76 (:REWRITE DEFAULT-CDR))
...
(DRAT-HINT-P)
(DRAT-HINT-LISTP)
(DRAT-HINT-LISTP-FORWARD-TO-TRUE-LISTP (18 3 (:DEFINITION POS-LISTP))
...
(DRAT-INDICES-AND-HINTS (6 6 (:REWRITE DEFAULT-CAR))
...
(CLAUSE-OR-ASSIGNMENT-P-UNIT-PROPAGATION
     (10710 10710 (:REWRITE DEFAULT-CAR))
     (10469 10469 (:REWRITE DEFAULT-CDR))
     (9854 172 (:DEFINITION EVALUATE-CLAUSE))
     (7758 525
           (:REWRITE CLAUSE-OR-ASSIGNMENT-P-CDR))
     (1623 872 (:REWRITE DEFAULT-UNARY-MINUS))
     (931 931
          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(RATP1 (492 6 (:DEFINITION UNIT-PROPAGATION))
...
(ADD-PROOF-CLAUSE)
(VERIFY-PROOF (702 680 (:REWRITE DEFAULT-CAR))
...
(VALID-PROOFP)
(REFUTATION-P)
(EVALUATE-FORMULA-FAL (21 1 (:DEFINITION EVALUATE-CLAUSE))
