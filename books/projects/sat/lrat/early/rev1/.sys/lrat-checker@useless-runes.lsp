...
(RATP1
 (952 150 (:REWRITE BACKCHAIN-TO-CLAUSE-OR-ASSIGNMENT-P))
 (638 65 (:REWRITE CLAUSE-OR-ASSIGNMENT-P-CDR))
 (492 6 (:DEFINITION UNIT-PROPAGATION))
 (348 89 (:DEFINITION MEMBER-EQUAL))
 (335 331 (:REWRITE DEFAULT-CDR))
 (283 282 (:REWRITE DEFAULT-CAR))
