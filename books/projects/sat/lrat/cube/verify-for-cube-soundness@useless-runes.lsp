(LRAT::CUBE-SOUNDNESS-2
     ...
     (108 9
          (:REWRITE LRAT::CONFLICTING-LITERALS-P-SUFF))
     (106 31
     ...
     (18 18
         (:REWRITE LRAT::MEMBER-NEGATE-IMPLIES-MEMBER-ASSIGNMENT))
     ...
     (5 1
        (:REWRITE LRAT::FORMULA-P-EXTEND-FORMULA-WITH-CUBE))
     (2 2 (:TYPE-PRESCRIPTION LRAT::LITERALP))
     (2 2 (:TYPE-PRESCRIPTION LRAT::FORMULA-P))
     (1 1
        (:REWRITE LRAT::ORDERED-FORMULA-P-IMPLIES-FORMULA-P))
     (1 1
        (:REWRITE LRAT::LITERAL-LISTP-NEGATE-CUBE)))
