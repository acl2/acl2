...
(LRAT::SUBSETP-CONS-REMOVE-LITERAL
     ...
     (154 32
          (:REWRITE LRAT::MEMBER-REMOVE-LITERAL))
     ...
     (85 77
         (:REWRITE LRAT::MEMBER-EQUAL-MONOTONE))
     (60 56
         (:REWRITE LRAT::SUBSETP-PRESERVES-ASSIGNMENT))
     (56 56
         (:REWRITE LRAT::UNIT-PROPAGATION-MONOTONICITY))
     (41 9
         (:REWRITE LRAT::CLAUSE-OR-ASSIGNMENT-P-CDR))
     (31 3
         (:REWRITE LRAT::MEMBER-EQUAL-REMOVE-LITERAL))
     (11 11
         (:REWRITE LRAT::IS-UNIT-CLAUSE-T-MONOTONE)))
(LRAT::SAT-DRAT-CLAIM-2-1
 (308 1
      (:REWRITE LRAT::TRUTH-REMOVE-IRRELEVANT-LIT-CONS))
 ...
 (12 2 (:DEFINITION LRAT::REMOVE-LITERAL))
 (9 9
    (:REWRITE LRAT::TRUTH-REMOVE-IRRELEVANT-LIT-3))
 (8 4
    (:REWRITE LRAT::CLAUSE-OR-ASSIGNMENT-P-FORWARD))
...
(LRAT::SAT-DRAT-CLAIM-2-2-1
 ...
 (154 10
      (:REWRITE LRAT::UNIT-PROPAGATION-CORRECT))
 (126 4
      (:REWRITE LRAT::TRUTH-REMOVE-IRRELEVANT-LIT-2))
 (124 20
      (:REWRITE LRAT::CLAUSE-OR-ASSIGNMENT-P-CDR))
 ...
 (64 16
     (:REWRITE LRAT::CLAUSE-OR-ASSIGNMENT-P-FLIP-LITERAL))
 (54 10
     (:REWRITE LRAT::SUBSETP-PRESERVES-EVALUATE-CLAUSE-NIL))
 (36 36
     (:REWRITE LRAT::MEMBER-EQUAL-MONOTONE))
 ...
 (20 20
     (:TYPE-PRESCRIPTION LRAT::FLIP-LITERAL))
 (20 1
     (:REWRITE LRAT::CONTRADICTION-IMPLIES-CONFLICTING-LITERALSP))
...
(LRAT::SAT-DRAT-CLAIM-2-2
 ...
 (139
     10
     (:REWRITE LRAT::CLAUSE-OR-ASSIGNMENTP-CDR-HONS-ASSOC-EQUAL-FOR-FORMULA))
