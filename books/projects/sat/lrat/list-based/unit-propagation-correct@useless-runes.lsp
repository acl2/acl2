...
(LRAT::NOT-CONFLICTING-LITERALSP-IMPLIES-NEGATE-IS-NOT-MEMBER-SUBSET
     ...
     (2 2
        (:REWRITE LRAT::IS-UNIT-CLAUSE-T-MONOTONE))
...
(LRAT::SUBSETP-UNION-EQUAL-2
     ...
     (24 6
         (:REWRITE LRAT::CLAUSE-OR-ASSIGNMENT-P-UNION-EQUAL))
     (13 13
         (:REWRITE LRAT::IS-UNIT-CLAUSE-T-MONOTONE))
...
(LRAT::UNION-PRESERVES-SUBSETP-2
     (783 113
          (:REWRITE LRAT::CLAUSE-OR-ASSIGNMENT-P-HAS-LITERALS))
     (510 29
          (:REWRITE LRAT::SUBSETP-UNION-EQUAL-2))
     (388 388
          (:TYPE-PRESCRIPTION LRAT::CLAUSE-OR-ASSIGNMENT-P))
     (275 74
          (:REWRITE LRAT::CLAUSE-OR-ASSIGNMENT-P-CDR))
     ...
     (161 3
          (:REWRITE LRAT::CONS-PRESERVES-SUBSETP))
...
(LRAT::CONFLICTING-LITERALSP-PRESERVED-BY-UNION-EQUAL-CONS-2
 ...
 (120 20
      (:REWRITE LRAT::CLAUSE-OR-ASSIGNMENT-P-CONS))
 (87 76
     (:REWRITE LRAT::CONTRADICTION-IMPLIES-CONFLICTING-LITERALSP))
 (76 76
     (:REWRITE LRAT::NOT-CONFLICTING-LITERALSP-SUBSETP))
 (63 36
     (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(LRAT::CONFLICTING-LITERALSP-UNION-WHEN-MEMBER
     (18859 2736
            (:REWRITE LRAT::CLAUSE-OR-ASSIGNMENT-P-HAS-LITERALS))
     (15190 1521
            (:REWRITE LRAT::SUBSETP-EQUAL-CONS-LEMMA))
     (15190 1521
            (:REWRITE LRAT::CONS-PRESERVES-SUBSETP))
     (12873 12873
            (:TYPE-PRESCRIPTION LRAT::CLAUSE-OR-ASSIGNMENT-P))
     ...
     (8753 8753
           (:REWRITE LRAT::MEMBER-EQUAL-MONOTONE))
     (6552 6552
           (:REWRITE LRAT::SUBSETP-TRANSITIVE))
     (6436 6436
           (:REWRITE LRAT::UNIT-PROPAGATION-MONOTONICITY))
     (6050 736
           (:REWRITE LRAT::BACKCHAIN-TO-CLAUSE-OR-ASSIGNMENT-P))
     ...
     (34 34
         (:REWRITE LRAT::SUBSETP-EQUAL-REFLEXIVE))
...
(LRAT::NOT-CONFLICTING-LITERALSP-UNION-LEMMA
 ...
 (143 7
      (:REWRITE LRAT::MEMBER-EQUAL-NEGATE-CLAUSE-OR-ASSIGNMENT-REC-LEMMA))
 (128 16
      (:REWRITE LRAT::SUBSETP-PRESERVES-EVALUATE-CLAUSE-NIL))
 (112 28
      (:REWRITE LRAT::CLAUSE-OR-ASSIGNMENT-P-FORWARD))
 (105
   ...
   (:REWRITE
        LRAT::NOT-CONFLICTING-LITERALSP-IMPLIES-NEGATE-IS-NOT-MEMBER-SUBSET))
 (104 4
      (:REWRITE LRAT::CONFLICTING-LITERALSP-UNION-WHEN-MEMBER))
 (66 33
     (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
 (49 7
     (:REWRITE LRAT::MEMBER-EQUAL-NEGATE-CLAUSE-OR-ASSIGNMENT-REC))
 (46 46
     (:REWRITE LRAT::NOT-CONFLICTING-LITERALSP-SUBSETP))
 (46 46
     (:REWRITE LRAT::CONTRADICTION-IMPLIES-CONFLICTING-LITERALSP))
...
(LRAT::EVALUATE-CLAUSE-UNION-EQUAL-NIL
 ...
 (16 16
     (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
 (9 9
    (:REWRITE LRAT::EVALUATE-CLAUSE-UNION-EQUAL-CONS-2)))
...
(LRAT::NOT-CONFLICTING-LITERALSP-UNION
 ...
 (6 6
    (:REWRITE LRAT::CONTRADICTION-IMPLIES-CONFLICTING-LITERALSP))
 (5 1
    (:DEFINITION LRAT::NEGATE-CLAUSE-OR-ASSIGNMENT-REC))
 (4 4
    (:REWRITE LRAT::TRUTH-MONOTONE-CLAUSE))
 (4 1
    (:REWRITE LRAT::MEMBER-EQUAL-NEGATE-CLAUSE-OR-ASSIGNMENT-REC-LEMMA))
 (2 2
    (:TYPE-PRESCRIPTION LRAT::NEGATE-CLAUSE-OR-ASSIGNMENT-REC))
