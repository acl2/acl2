...
(LRAT::SAT-DRAT-CLAIM-2-2
 (319 2 (:DEFINITION LRAT::EVALUATE-CLAUSE))
 (257 15 (:REWRITE LRAT::CLAUSE-OR-ASSIGNMENT-P-HAS-LITERALS))
 (194 5 (:REWRITE LRAT::UNIT-PROPAGATION-CORRECT))
 (183 19 (:REWRITE LRAT::CLAUSE-OR-ASSIGNMENT-P-CDR))
 (158 4 (:REWRITE LRAT::CLAUSE-OR-ASSIGNMENT-P-REMOVE-LITERAL))
 (154 2 (:REWRITE LRAT::TRUTH-REMOVE-IRRELEVANT-LIT-2))
 (144 18 (:DEFINITION HONS-ASSOC-EQUAL))
 (136 2 (:DEFINITION LRAT::EVALUATE-LITERAL))
 (127 10 (:REWRITE LRAT::CLAUSE-OR-ASSIGNMENTP-CDR-HONS-ASSOC-EQUAL-FOR-FORMULA))
 (115 7 (:REWRITE LRAT::CLAUSE-OR-ASSIGNMENT-P-CDR-HONS-ASSOC-EQUAL))
 (107 105 (:REWRITE DEFAULT-CAR))
 (103 80 (:REWRITE DEFAULT-CDR))
 (79 1 (:REWRITE LRAT::MEMBER-REMOVE-LITERAL))
