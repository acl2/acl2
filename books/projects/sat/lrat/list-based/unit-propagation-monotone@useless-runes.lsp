(LRAT::MEMBER-EQUAL-MONOTONE (17 17 (:REWRITE DEFAULT-CAR))
...
(LRAT::SUBSETP-TRANSITIVE (113 23 (:DEFINITION MEMBER-EQUAL))
...
(LRAT::IS-UNIT-CLAUSE-SUPERSET
     ...
     (42 42
         (:REWRITE LRAT::IS-UNIT-CLAUSE-T-MONOTONE))
     (42 2
         (:REWRITE LRAT::IS-UNIT-CLAUSE-UNCHANGED))
...
(LRAT::UNIT-PROPAGATION-T-MONOTONE
     ...
     (14567 14287 (:REWRITE DEFAULT-CAR))
     (11784 11631 (:REWRITE DEFAULT-CDR))
     (8102 8102
     ...
     (4458 2680
           (:REWRITE LRAT::CLAUSE-OR-ASSIGNMENT-P-CDR))
     (3977 1811 (:REWRITE DEFAULT-UNARY-MINUS))
...
(LRAT::UNIT-PROPAGATION-MONOTONICITY
     ...
     (126094 3114
             (:REWRITE LRAT::EVALUATE-CLAUSE-NIL-IMPLIES-IS-UNIT-CLAUSE-T))
     (35922 35098 (:REWRITE DEFAULT-CAR))
     (28547 28131 (:REWRITE DEFAULT-CDR))
     (21287 6097
            (:REWRITE LRAT::SUBSETP-PRESERVES-EVALUATE-CLAUSE-NIL))
     (16805 16805
            (:TYPE-PRESCRIPTION LRAT::LITERALP))
     ...
     (9122 5370
           (:REWRITE LRAT::CLAUSE-OR-ASSIGNMENT-P-CDR))
     (8801 4013 (:REWRITE DEFAULT-UNARY-MINUS))
