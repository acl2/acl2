...
(LRAT::LRAT-PROOFP-IMPLIES-PROOFP
     ...
     (5712 254
           (:DEFINITION LRAT::ORDERED-LITERALSP))
     (2502 532 (:DEFINITION ABS))
     (1608 1608 (:REWRITE DEFAULT-CDR))
     (1567 953 (:REWRITE DEFAULT-<-1))
     (1404 1404 (:REWRITE DEFAULT-CAR))
     (1203 953 (:REWRITE DEFAULT-<-2))
     (907 907
          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (592 549 (:REWRITE DEFAULT-UNARY-MINUS))
     (412 312
          (:REWRITE LRAT::ORDERED-LITERALSP-IMPLIES-NOT-MEMBER))
     (240 240 (:REWRITE LRAT::CLAUSEP$-FORWARD))
     (194 146
          (:REWRITE LRAT::ORDERED-LITERALSP-IMPLIES-NOT-MEMBER-NEGATE))
     (158 158
          (:REWRITE LRAT::CLAUSEP$-IMPLIES-CLAUSEP))
