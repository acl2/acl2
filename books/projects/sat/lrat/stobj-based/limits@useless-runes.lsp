(LRAT::N59-LISTP)
(LRAT::N59-LISTP-FORWARD (6 6 (:REWRITE DEFAULT-<-2))
                         (6 6 (:REWRITE DEFAULT-<-1))
                         (4 4 (:REWRITE DEFAULT-CDR))
                         (4 2 (:DEFINITION TRUE-LISTP))
                         (3 3 (:REWRITE DEFAULT-CAR)))
(LRAT::NTH-N59-LISTP (57 48 (:REWRITE DEFAULT-<-2))
...
(LRAT::I60-LISTP)
(LRAT::I60-LISTP-FORWARD (52 4 (:REWRITE LRAT::N59-LISTP-FORWARD))
...
(LRAT::NTH-I60-LISTP (82 56 (:REWRITE DEFAULT-<-1))
