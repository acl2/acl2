(PROOF-CHECKER-ARRAY::SUBSETP
    (37 2
        (:REWRITE PROOF-CHECKER-ARRAY::LITERAL-LISTP-IMPLIES-EQLABLE-LISTP))
    (32 3
...
(PROOF-CHECKER-ARRAY::SUBSETP-CDR (50 50 (:REWRITE DEFAULT-CAR))
...
(PROOF-CHECKER-ARRAY::SUBSETP-SET-DIFFERENCE-VARIABLES
 ...
 (27 1
     (:REWRITE PROOF-CHECKER-ARRAY::MEMBER-SET-DIFFERENCE-VARIABLES))
 (14
  14
  (:REWRITE
    PROOF-CHECKER-ARRAY::SUBSET-VARIABLESP-IMPLIES-MEMBER-OR-MEMBER-NEGATE)))
