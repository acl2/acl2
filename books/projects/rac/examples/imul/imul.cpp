...
ui64 Imul(ui32 s1, ui32 s2) {
  ...
  cout << "Booth digits: \n";
  for (int i = 0; i < 17; i++) {
    cout << i << ": " << bd[i].to_string(AC_HEX, false) << '\n';
  }
#endif
  ...
  for (int i = 0; i < 17; i++) {
    cout << i << ": " << pp[i].to_string(AC_HEX, false) << '\n';
  }
#endif
  ...
  for (int i = 0; i < 17; i++) {
    cout << i << ": " << tble[i].to_string(AC_HEX, false) << '\n';
  }
#endif
...
#ifdef DEBUG
  cout << "Product: " << prod.to_string(AC_HEX, false) << "\n\n";
#endif
...
int main(int argc, char *argv[]) {
  ...
  while (!cin.eof()) {
    ...
    cout << "Spec: " << spec_result.to_string(AC_HEX, false) << '\n';
    cout << "Imul: " << imul_result.to_string(AC_HEX, false) << '\n';
