...
void
FunDef::displayDec (ostream &os, const char *prefix, unsigned indent)
{
...
void
FunDef::display (ostream &os, const char *prefix, unsigned indent)
{
...
void
FunDef::displayACL2Expr (ostream &os)
{
...
void
Template::display (ostream &os, const char *prefix, unsigned indent)
{
  os << "\n";
  if (indent)
    os << setw (indent) << " ";
...
void
Template::bindParams (List<Expression> *actuals)
{
...
void
Template::displayACL2Expr (ostream &os)
{
