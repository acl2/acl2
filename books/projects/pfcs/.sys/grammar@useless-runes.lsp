...
(PFCS::ABNF-TREE-LISTP-WHEN-ABNF-TREE-LIST-WITH-ROOT-P
 (205 19 (:REWRITE PFCS::ABNF-TREE-LIST-WITH-ROOT-P-OF-CDR-WHEN-ABNF-TREE-LIST-WITH-ROOT-P))
 (201 19 (:REWRITE PFCS::ABNF-TREE-WITH-ROOT-P-OF-CAR-WHEN-ABNF-TREE-LIST-WITH-ROOT-P))
 (142 88 (:REWRITE PFCS::ABNF-TREE-LIST-WITH-ROOT-P-WHEN-SUBSETP-EQUAL))
...
(PFCS::ABNF-TREE-WRAP-FN-OF-STRING-LIST-FIX-RULENAMES
 (677 49 (:REWRITE STR::STRING-LIST-FIX-WHEN-STRING-LISTP))
 (577 72 (:DEFINITION STRING-LISTP))
