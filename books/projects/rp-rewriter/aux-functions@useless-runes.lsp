...
(RP::EX-FROM-RP-LOOSE-ACL2-COUNT
 (9616 2691 (:REWRITE RP::CONSP-EX-FROM-RP-LOOSE))
 (8491 2691 (:REWRITE RP::CONSP-EXTRACT-FROM-RP))
 ...
 (617 617 (:TYPE-PRESCRIPTION RP::IS-RP$INLINE))
