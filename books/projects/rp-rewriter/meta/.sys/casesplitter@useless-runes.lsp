...
(RP::CASESPLITTER_VALID
 (15441 6 (:DEFINITION RP::VALID-RULESP))
 (13854 6 (:DEFINITION RP::VALID-RULEP))
 (13836 6 (:DEFINITION RP::VALID-RULEP-SK))
 (13830 6 (:DEFINITION RP::VALID-RULEP-SK-BODY))
 (9400 4 (:REWRITE RP::VALID-RULESP-IMPLIES-RULE-LIST-SYNTAXP))
 (5952 14 (:DEFINITION APPLY$-BADGEP))
 (5682 46 (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
 (4792 120 (:DEFINITION RP::INCLUDE-FNC))
 (4726 2 (:DEFINITION RP::RULE-LIST-SYNTAXP))
