...
(CMR::LET-ABSTRACT-FULL-CLAUSE-PROC-EXCLUDE-HYPS
 (1317 4 (:DEFINITION PSEUDO-TERMP))
 (1272 25 (:REWRITE PSEUDO-TERMP-CAR-WHEN-PSEUDO-TERM-LISTP))
 (865 67 (:REWRITE PSEUDO-TERM-LISTP-CDR))
 (620 67 (:REWRITE PSEUDO-TERM-LISTP-CDR-WHEN-PSEUDO-TERM-LISTP))
 (518 110 (:REWRITE CMR::PSEUDO-TERM-LIST-P-WHEN-PSEUDO-VAR-LIST-P))
 (517 15 (:DEFINITION PSEUDO-TERM-LISTP))
 (288 67 (:REWRITE PSEUDO-TERMP-LIST-CDR))
 (279 47 (:REWRITE PSEUDO-TERMP-OPENER))
 (203 33 (:REWRITE PSEUDO-VAR-LIST-P-OF-CDR-WHEN-PSEUDO-VAR-LIST-P))
 (195 25 (:REWRITE PSEUDO-TERMP-CAR))
 (162 21 (:REWRITE PSEUDO-TERMP-CADR-FROM-PSEUDO-TERM-LISTP))
 (154 154 (:REWRITE DEFAULT-CDR))
 (134 134 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-SUBSETP-EQUAL))
 ...
 (67 67 (:REWRITE PSEUDO-VAR-LIST-P-WHEN-NOT-CONSP))
...
(CMR::LET-ABSTRACT-FULL-CLAUSE-PROC-EXCLUDE-HYPS-CORRECT
 (462 7 (:DEFINITION PSEUDO-TERM-LISTP))
 (224 42 (:REWRITE CMR::PSEUDO-TERM-LIST-P-WHEN-PSEUDO-VAR-LIST-P))
 (117 117 (:REWRITE DEFAULT-CDR))
 (106 106 (:REWRITE DEFAULT-CAR))
 (84 7 (:REWRITE PSEUDO-TERMP-CAR-WHEN-PSEUDO-TERM-LISTP))
 (84 7 (:REWRITE PSEUDO-TERM-LISTP-CDR-WHEN-PSEUDO-TERM-LISTP))
 ...
 (42 7 (:REWRITE PSEUDO-VAR-LIST-P-OF-CDR-WHEN-PSEUDO-VAR-LIST-P))
