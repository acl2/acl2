...
(RP::EX-FROM-RP-ALL2-FLAG
 (1101 530 (:REWRITE DEFAULT-+-2))
 (756 54 (:DEFINITION LENGTH))
 (731 530 (:REWRITE DEFAULT-+-1))
 (594 54 (:DEFINITION LEN))
 (432 108 (:DEFINITION INTEGER-ABS))
 (410 248 (:REWRITE DEFAULT-CDR))
 (179 138 (:REWRITE DEFAULT-<-2))
