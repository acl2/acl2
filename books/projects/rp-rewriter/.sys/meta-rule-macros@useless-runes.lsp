...
(RP::ADD-META-RULE-FN
 (5076 79 (:DEFINITION MEMBER-EQUAL))
 (4776 3 (:DEFINITION SUBSETP-EQUAL))
 (3525 27 (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-1))
 (1966 1958 (:REWRITE DEFAULT-CAR))
 (1889 1873 (:REWRITE DEFAULT-CDR))
 (750 125 (:REWRITE INTERN-IN-PACKAGE-OF-SYMBOL-SYMBOL-NAME))
 (705 141 (:DEFINITION ASSOC-EQUAL))
 (608 59 (:REWRITE TRUE-LIST-LISTP-IMPLIES-TRUE-LISTP-XXX))
 (500 500 (:TYPE-PRESCRIPTION STRINGP-SYMBOL-PACKAGE-NAME))
 (416 32 (:DEFINITION TRUE-LIST-LISTP))
 (375 125 (:REWRITE INTERN-IN-PACKAGE-OF-SYMBOL-IS-IDENTITY))
 (282 141 (:DEFINITION NTH))
 (250 250 (:TYPE-PRESCRIPTION MEMBER-SYMBOL-NAME))
 (190 38 (:DEFINITION TRUE-LISTP))
 (184 184 (:REWRITE SYMBOL-LISTP-IMPLIES-SYMBOLP))
 (141 141 (:REWRITE NTH-WHEN-PREFIXP))
 (135 135 (:REWRITE DEFAULT-SYMBOL-NAME))
 (125 125 (:REWRITE DEFAULT-SYMBOL-PACKAGE-NAME))
 (125 125 (:REWRITE DEFAULT-INTERN-IN-PACKAGE-OF-SYMBOL))
 (108 54 (:REWRITE DEFAULT-+-2))
 (96 32 (:REWRITE STATE-P-IMPLIES-AND-FORWARD-TO-STATE-P1))
 (59 59 (:REWRITE ALWAYS$-P-LST-IMPLIES-P-ELEMENT-COROLLARY))
...
(RP::ADD-PROCESSOR-FN
 (2000 24 (:DEFINITION MEMBER-EQUAL))
 (1928 1 (:DEFINITION SUBSETP-EQUAL))
 (1355 9 (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-1))
 (704 32 (:DEFINITION RP::FIX-ARGS/RETURNS-PACKAGE))
 (693 693 (:REWRITE DEFAULT-CAR))
 (662 662 (:REWRITE DEFAULT-CDR))
 (305 61 (:DEFINITION ASSOC-EQUAL))
 (192 32 (:REWRITE INTERN-IN-PACKAGE-OF-SYMBOL-SYMBOL-NAME))
 (144 17 (:REWRITE TRUE-LIST-LISTP-IMPLIES-TRUE-LISTP-XXX))
 (128 128 (:TYPE-PRESCRIPTION STRINGP-SYMBOL-PACKAGE-NAME))
 (122 61 (:DEFINITION NTH))
 (96 32 (:REWRITE INTERN-IN-PACKAGE-OF-SYMBOL-IS-IDENTITY))
 (90 7 (:DEFINITION TRUE-LIST-LISTP))
...
(RP::RP-EVLT-OF-EX-FROM-RP-REVERSE-FOR-ATOM
 ...
 (38 36 (:REWRITE RP::RP-EVL-OF-FORCE$-CALL))
 (38 36 (:REWRITE RP::RP-EVL-OF-EQUALS-CALL))
 ...
 (38 36 (:REWRITE RP::RP-EVL-OF-BINARY-*-CALL))
 (38 36 (:REWRITE RP::RP-EVL-OF-BADGE-USERFN-CALL))
 (38 36 (:REWRITE RP::RP-EVL-OF-BAD-ATOM<=-CALL))
 (38 36 (:REWRITE RP::RP-EVL-OF-APPLY$-USERFN-CALL))
 (38 36 (:REWRITE RP::RP-EVL-OF-APPLY$-CALL))
