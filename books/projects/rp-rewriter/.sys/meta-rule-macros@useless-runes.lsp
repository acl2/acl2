...
(RP::ADD-META-RULE-FN
 (4453 71 (:DEFINITION MEMBER-EQUAL))
 (4405 3 (:DEFINITION SUBSETP-EQUAL))
 (3173 29 (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-1))
 (1502 1498 (:REWRITE DEFAULT-CAR))
 (1433 1425 (:REWRITE DEFAULT-CDR))
 (690 115 (:REWRITE INTERN-IN-PACKAGE-OF-SYMBOL-SYMBOL-NAME))
 (485 97 (:DEFINITION ASSOC-EQUAL))
 (460 460 (:TYPE-PRESCRIPTION STRINGP-SYMBOL-PACKAGE-NAME))
 (345 115 (:REWRITE INTERN-IN-PACKAGE-OF-SYMBOL-IS-IDENTITY))
 (230 230 (:TYPE-PRESCRIPTION MEMBER-SYMBOL-NAME))
 (228 37 (:REWRITE TRUE-LIST-LISTP-IMPLIES-TRUE-LISTP-XXX))
 (194 97 (:DEFINITION NTH))
 (150 150 (:REWRITE SYMBOL-LISTP-IMPLIES-SYMBOLP))
 (121 121 (:REWRITE DEFAULT-SYMBOL-NAME))
 (115 115 (:REWRITE DEFAULT-SYMBOL-PACKAGE-NAME))
 (115 115 (:REWRITE DEFAULT-INTERN-IN-PACKAGE-OF-SYMBOL))
 (104 8 (:DEFINITION TRUE-LIST-LISTP))
