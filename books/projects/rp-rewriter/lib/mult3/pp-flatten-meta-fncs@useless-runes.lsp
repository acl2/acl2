...
(RP::PP-LISTS-P)
(RP::PP-HAS-BITP-RP (14252 48 (:LINEAR ACL2-COUNT-OF-SUM))
                    (11268 28 (:DEFINITION APPLY$-BADGEP))
                    (7426 3 (:REWRITE O<=-O-FINP-DEF))
                    (7224 74
...
(RP::TRUE-LISTP-OF-CUT-LIST-BY-HALF.SECOND
     ...
     (10465 108
            (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
     (10220 108 (:DEFINITION QUOTEP))
     (10152 50 (:DEFINITION RP::RP-TERM-LISTP))
     (9851 37 (:DEFINITION APPLY$-BADGEP))
     (8889 74
           (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
     (8239 108
           (:REWRITE RP::RP-TERMP-IMPLIES-CDR-LISTP))
     ...
     (148 37 (:DEFINITION WEAK-APPLY$-BADGE-P))
     (145 29
          (:REWRITE RP::ATOM-RP-TERMP-IS-SYMBOLP))
...
(RP::CUT-LIST-BY-HALF-RETURNS-PP-LISTS
     (16146 63
            (:REWRITE RP::RP-TERM-LISTP-IS-TRUE-LISTP))
     (14508 21 (:DEFINITION TRUE-LISTP))
     (8712 42 (:DEFINITION RP::RP-TERM-LISTP))
     (8271 147
           (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
     (7620 147 (:DEFINITION QUOTEP))
     (7158 84
           (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
     (7095 84 (:DEFINITION APPLY$-BADGEP))
     (6825 147
           (:REWRITE RP::RP-TERMP-IMPLIES-CDR-LISTP))
     ...
     (357 357
          (:TYPE-PRESCRIPTION RP::RP-TERM-LISTP))
     (336 336 (:TYPE-PRESCRIPTION APPLY$-BADGEP))
     (294 294
          (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-2))
...
(RP::TRUE-LISTP-OF-MERGE-SORTED-AND$-LISTS
     ...
     (45622 203 (:DEFINITION RP::RP-TERM-LISTP))
     (40722 438
            (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
     (39645 438 (:DEFINITION QUOTEP))
     (38646 114
            (:DEFINITION RP::FALIST-CONSISTENT-AUX))
     (38481 203 (:DEFINITION APPLY$-BADGEP))
     (37475 3671 (:REWRITE RP::POS-LEN-IMPLIES))
     (35227 314
            (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
     (25654 24400 (:REWRITE DEFAULT-CDR))
     (25314 135 (:DEFINITION SUBSETP-EQUAL))
     (22590 1890 (:DEFINITION MEMBER-EQUAL))
     (14070 945
            (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-1))
     (13407 11905 (:REWRITE DEFAULT-CAR))
     ...
     (2835 2835
           (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-3))
     (2665 270 (:DEFINITION NATP))
     (2289 203 (:DEFINITION WEAK-APPLY$-BADGE-P))
     (1890 1890
           (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-2))
     (1839 117
           (:REWRITE RP::ATOM-RP-TERMP-IS-SYMBOLP))
     (1779 135 (:DEFINITION ALL-NILS))
     (1739 1739 (:TYPE-PRESCRIPTION APPLY$-BADGEP))
...
(RP::TRUE-LISTP-OF-SORT-AND$-LIST
     ...
     (43165 336
            (:REWRITE RP::RP-TERMP-IMPLIES-CDR-LISTP))
     (35153 151 (:DEFINITION RP::RP-TERM-LISTP))
     (34384 93 (:DEFINITION RP::FALIST-CONSISTENT))
     (30342 336
            (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
     (29390 336 (:DEFINITION QUOTEP))
     (28737 152 (:DEFINITION APPLY$-BADGEP))
     (26787 85
            (:DEFINITION RP::FALIST-CONSISTENT-AUX))
     (25245 234
            (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
     (18761 17586 (:REWRITE DEFAULT-CDR))
     (18556 98 (:DEFINITION SUBSETP-EQUAL))
     (16572 1372 (:DEFINITION MEMBER-EQUAL))
     (10459 8580 (:REWRITE DEFAULT-CAR))
     (10324 686
            (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-1))
     ...
     (2093 152 (:DEFINITION WEAK-APPLY$-BADGE-P))
     (2058 2058
           (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-3))
     (1942 196 (:DEFINITION NATP))
     (1623 100
           (:REWRITE RP::ATOM-RP-TERMP-IS-SYMBOLP))
     (1372 1372
           (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-2))
     ...
     (1291 1291 (:TYPE-PRESCRIPTION APPLY$-BADGEP))
...
(RP::PP-LISTS-P-IMPLIES-ALISTP
     ...
     (157 36 (:DEFINITION WEAK-APPLY$-BADGE-P))
...
(RP::PP-LISTS-P-OF-SORT-PP-LISTS
     (49942 123
            (:REWRITE RP::RP-TERM-LISTP-IS-TRUE-LISTP))
     (44384 41 (:DEFINITION TRUE-LISTP))
     (27140 135 (:DEFINITION RP::RP-TERMP))
     (25986 369
            (:REWRITE RP::RP-TERMP-IMPLIES-CDR-LISTP))
     (23412 128 (:DEFINITION RP::RP-TERM-LISTP))
     (21355 369
            (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
     (18948 369 (:DEFINITION QUOTEP))
     (17867 292 (:DEFINITION APPLY$-BADGEP))
     (17836 210
            (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
     ...
     (1281 292 (:DEFINITION WEAK-APPLY$-BADGE-P))
     (1271 1271 (:TYPE-PRESCRIPTION MEMBER-EQUAL))
     (1088 1088
           (:REWRITE RP::RP-TERMP-SHOULD-TERM-BE-IN-CONS-LHS))
     (984 82 (:DEFINITION NATP))
     (948 948 (:TYPE-PRESCRIPTION APPLY$-BADGEP))
     (902 287
          (:REWRITE APPLY$-BADGEP-PROPERTIES . 3))
     (861 861
          (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-3))
...
(RP::PP-LISTS-P-OF-AND$-PP-LISTS-AUX
     (32045 132
            (:REWRITE RP::RP-TERM-LISTP-IS-TRUE-LISTP))
     (28577 44 (:DEFINITION TRUE-LISTP))
     (16571 94 (:DEFINITION RP::RP-TERM-LISTP))
     (15797 294
            (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
     (14410 124 (:DEFINITION RP::RP-TERMP))
     (14255 294 (:DEFINITION QUOTEP))
     (14199 294
            (:REWRITE RP::RP-TERMP-IMPLIES-CDR-LISTP))
     (13317 162
            (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
     (13156 152 (:DEFINITION APPLY$-BADGEP))
     ...
     (616 616
          (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-2))
     (606 606 (:TYPE-PRESCRIPTION APPLY$-BADGEP))
     (506 506
          (:TYPE-PRESCRIPTION RP::AND$-PP-LISTS-AUX))
     (478 478 (:REWRITE O-P-DEF-O-FINP-1))
     (403 152 (:DEFINITION WEAK-APPLY$-BADGE-P))
     (396 396
          (:TYPE-PRESCRIPTION RP::FALIST-CONSISTENT-AUX))
...
(RP::AND$-PP-LISTS (40652 160
                          (:REWRITE RP::RP-TERM-LISTP-IS-TRUE-LISTP))
                   (36217 53 (:DEFINITION TRUE-LISTP))
                   (21924 108 (:DEFINITION RP::RP-TERM-LISTP))
                   (21164 360
                          (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
                   (19427 359 (:DEFINITION QUOTEP))
                   (18094 200 (:DEFINITION APPLY$-BADGEP))
                   (18006 208
                          (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
                   ...
                   (635 102
                        (:LINEAR APPLY$-BADGEP-PROPERTIES . 2))
                   (531 200 (:DEFINITION WEAK-APPLY$-BADGE-P))
...
(RP::PP-LISTS-P-OF-AND$-PP-LISTS
     (34434 135
            (:REWRITE RP::RP-TERM-LISTP-IS-TRUE-LISTP))
     (30290 45 (:DEFINITION TRUE-LISTP))
     (17906 96 (:DEFINITION RP::RP-TERM-LISTP))
     (17177 331
            (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
     (15382 331 (:DEFINITION QUOTEP))
     (15270 147 (:DEFINITION RP::RP-TERMP))
     (14958 331
            (:REWRITE RP::RP-TERMP-IMPLIES-CDR-LISTP))
     (14304 186
            (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
     (14124 186 (:DEFINITION APPLY$-BADGEP))
     ...
     (475 186 (:DEFINITION WEAK-APPLY$-BADGE-P))
...
(RP::APPEND-OF-PP-LIST-P
     (8829 36
           (:REWRITE RP::RP-TERM-LISTP-IS-TRUE-LISTP))
     (7905 12 (:DEFINITION TRUE-LISTP))
     (4599 24 (:DEFINITION RP::RP-TERM-LISTP))
     (4359 84
           (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
     (3990 84 (:DEFINITION QUOTEP))
     (3885 84
           (:REWRITE RP::RP-TERMP-IMPLIES-CDR-LISTP))
     (3876 36 (:DEFINITION RP::RP-TERMP))
     (3726 48
           (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
     (3690 48 (:DEFINITION APPLY$-BADGEP))
...
(RP::PP-LISTS-P-IMPLIES-TRUE-LISTP
     (3363 15
           (:REWRITE RP::RP-TERM-LISTP-IS-TRUE-LISTP))
     (3091 5 (:DEFINITION TRUE-LISTP))
     (1729 10 (:DEFINITION RP::RP-TERM-LISTP))
     (1612 29
           (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
     (1541 29
           (:REWRITE RP::RP-TERMP-IMPLIES-CDR-LISTP))
     (1516 11 (:DEFINITION RP::RP-TERMP))
     (1501 29 (:DEFINITION QUOTEP))
     (1413 16
           (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
     (1400 14 (:DEFINITION APPLY$-BADGEP))
...
(RP::PP-LISTS-P-OF-APPLY-SIGN-TO-PP-LISTS
     (17256 66
            (:REWRITE RP::RP-TERM-LISTP-IS-TRUE-LISTP))
     (15048 22 (:DEFINITION TRUE-LISTP))
     (9036 50 (:DEFINITION RP::RP-TERM-LISTP))
     (8692 168
           (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
     (7729 168 (:DEFINITION QUOTEP))
     (7664 76 (:DEFINITION RP::RP-TERMP))
     (7438 168
           (:REWRITE RP::RP-TERMP-IMPLIES-CDR-LISTP))
     (7167 94
           (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
     (7056 94 (:DEFINITION APPLY$-BADGEP))
...
(RP::PP-LISTS-P-OF-PP-TERM-TO-PP-LISTS
     (590928 2418
             (:REWRITE RP::RP-TERM-LISTP-IS-TRUE-LISTP))
     (528036 806 (:DEFINITION TRUE-LISTP))
     (305544 1612 (:DEFINITION RP::RP-TERM-LISTP))
     (288636 5642
             (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
     (263644 5642 (:DEFINITION QUOTEP))
     (261992 5642
             (:REWRITE RP::RP-TERMP-IMPLIES-CDR-LISTP))
     (261192 2418 (:DEFINITION RP::RP-TERMP))
     (245888 3224
             (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
     (243452 3224 (:DEFINITION APPLY$-BADGEP))
     ...
     (8066 3224 (:DEFINITION WEAK-APPLY$-BADGE-P))
...
(RP::PP-LISTS-P-OF-SORT-SUM-META-AUX
     (118793 51
             (:REWRITE RP::RP-TERM-LISTP-IS-TRUE-LISTP))
     (113991 246 (:DEFINITION RP::RP-TERM-LISTP))
     (77998 929
            (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
     (66037 737 (:DEFINITION QUOTEP))
     (65448 65448 (:REWRITE DEFAULT-CDR))
     (64773 198
            (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
     (64422 198 (:DEFINITION APPLY$-BADGEP))
     ...
     (25926 25926 (:REWRITE DEFAULT-CAR))
     ...
     (426 426
          (:TYPE-PRESCRIPTION RP::IS-RP$INLINE))
     (414 198 (:DEFINITION WEAK-APPLY$-BADGE-P))
     (297 297 (:TYPE-PRESCRIPTION APPLY$-BADGEP))
     (279 279 (:TYPE-PRESCRIPTION MEMBER-EQUAL))
     (277 277
          (:REWRITE SYMBOL-LISTP-IMPLIES-SYMBOLP))
