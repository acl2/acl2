...
(RP::SUM-PPS-BY-ROW (528 3
                         (:REWRITE APPLY$-BADGEP-PROPERTIES . 1))
                    (526 1 (:DEFINITION APPLY$-BADGEP))
...
(RP::LOGHEAD-OF-*-IS-MULT-FINAL-SPEC
     ...
     (2 2
        (:LINEAR BITOPS::EXPT-2-LOWER-BOUND-BY-LOGBITP))
     (2 1 (:REWRITE NATP-WHEN-INTEGERP)))
(RP::EQUAL-OF-LOGHEAD-LOGAPP-1-LEMMA
     (2903 17 (:REWRITE LOGHEAD-IDENTITY))
     (1689 16 (:DEFINITION UNSIGNED-BYTE-P**))
     (1165 16 (:DEFINITION UNSIGNED-BYTE-P))
     (996 16 (:DEFINITION INTEGER-RANGE-P))
     (556 556 (:TYPE-PRESCRIPTION NATP))
     (457 104
          (:REWRITE RP::SUM-OF-NEGATED-ELEMENTS))
     (348 36 (:REWRITE BITOPS::LOGCDR-<-CONST))
     (283 27 (:REWRITE BIT->BOOL-OF-BOOL->BIT))
     (282 144 (:REWRITE DEFAULT-<-1))
     (210 15 (:REWRITE NATP-WHEN-INTEGERP))
     (199 144 (:REWRITE DEFAULT-<-2))
     (174 27 (:REWRITE ZP-WHEN-INTEGERP))
     (172 52
          (:REWRITE BITOPS::LOGBITP-NONZERO-OF-BIT))
     (160 27 (:REWRITE ZP-WHEN-GT-0))
     (156 156 (:TYPE-PRESCRIPTION BITP))
     (140 140 (:LINEAR BITOPS::LOGCDR-<=-LOGCDR))
     (114 15 (:REWRITE NATP-WHEN-GTE-0))
     (112 16 (:REWRITE IFIX-NEGATIVE-TO-NEGP))
     (95 95 (:TYPE-PRESCRIPTION LOGBITP))
     (81 81
         (:REWRITE INTEGER-LISTP-IMPLIES-INTEGERP))
     (80 80 (:TYPE-PRESCRIPTION UNSIGNED-BYTE-P))
     (80 32 (:REWRITE RP::SUM-COMM-1))
     (78 4 (:REWRITE NFIX-POSITIVE-TO-NON-ZP))
     (62 3 (:LINEAR LOGHEAD-LEQ))
     (51 18
         (:REWRITE RP::DUMMY-SUM-CANCEL-LEMMA1))
     (48 16 (:REWRITE NEGP-WHEN-LESS-THAN-0))
     (41 38 (:REWRITE EXPT-WITH-VIOLATED-GUARDS))
     (35 18 (:REWRITE RP::SUM-COMM-2))
     ...
     (29 29
         (:REWRITE BITOPS::NORMALIZE-LOGBITP-WHEN-MODS-EQUAL))
     (28 4 (:LINEAR BITOPS::LOGCAR-BOUND))
     (27 3 (:REWRITE BFIX-WHEN-NOT-1))
     (24 5 (:REWRITE NFIX-WHEN-NOT-NATP))
     (24 1 (:REWRITE NFIX-EQUAL-TO-ZERO))
     (19 19
         (:LINEAR BITOPS::EXPT-2-LOWER-BOUND-BY-LOGBITP))
     (16 16 (:TYPE-PRESCRIPTION NEGP))
     (15 8 (:REWRITE NFIX-EQUAL-TO-NONZERO))
     (14 2
     ...
     (1 1
        (:REWRITE ACL2-NUMBER-LISTP-IMPLIES-ACL2-NUMBERP)))
(RP::EQUAL-OF-LOGHEAD-LOGAPP-1
     (266 4 (:REWRITE LOGHEAD-IDENTITY))
     (200 6 (:DEFINITION UNSIGNED-BYTE-P))
     (168 6 (:DEFINITION INTEGER-RANGE-P))
     (78 4 (:REWRITE LOGTAIL-LESSP))
     (54 54 (:TYPE-PRESCRIPTION RP::BINARY-SUM))
     (53 25 (:REWRITE DEFAULT-<-1))
     (52 2 (:REWRITE UNSIGNED-BYTE-P-OF-LOGTAIL))
     ...
     (16 2 (:REWRITE LOGTAIL-UNSIGNED-BYTE-P))
...
(RP::TO-M2
     ...
     (2 2
        (:REWRITE THIS-NEEDS-TO-BE-ADDED-TO-QUOTIENT-REMAINDER-LEMMAS)))
(RP::LOGTAIL-TO-FLOOR (226 4
                           (:DEFINITION NONNEGATIVE-INTEGER-QUOTIENT))
                      (216 36
                           (:REWRITE RP::SUM-OF-NEGATED-ELEMENTS))
                      (156 156 (:TYPE-PRESCRIPTION RP::--))
                      (10 8 (:REWRITE DEFAULT-UNARY-MINUS))
                      (6 6 (:REWRITE DEFAULT-<-2))
                      (6 6 (:REWRITE DEFAULT-<-1))
                      (6 3
...
(RP::LOGAPP-OF-THE-SAME (11 11
                        ...
                        (1 1
                           (:REWRITE BITOPS::UNSIGNED-BYTE-P-INCR)))
(RP::F2-OF-M2
     (574 68 (:REWRITE IFIX-WHEN-NOT-INTEGERP))
     (574 68 (:REWRITE IFIX-WHEN-INTEGERP))
     (490 490
          (:TYPE-PRESCRIPTION NOT-INTEGERP-3A))
     (490 490
          (:TYPE-PRESCRIPTION NOT-INTEGERP-2A))
     ...
     (340 340
          (:TYPE-PRESCRIPTION NOT-INTEGERP-1B))
     (332 149 (:REWRITE DEFAULT-PLUS-2))
     (322 10 (:REWRITE DEFAULT-FLOOR-RATIO))
     (300 160 (:REWRITE DEFAULT-TIMES-2))
     (250 149 (:REWRITE DEFAULT-PLUS-1))
     (190 160 (:REWRITE DEFAULT-TIMES-1))
     (174 14 (:REWRITE |(* y x)|))
     ...
     (126 126
          (:REWRITE NORMALIZE-FACTORS-GATHER-EXPONENTS))
     (102 4 (:REWRITE |(floor (+ x r) i)|))
     (96 96
         (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
     (90 2 (:REWRITE IFIX-NEGATIVE-TO-NEGP))
     (76 2 (:REWRITE NEGP-WHEN-LESS-THAN-0))
     (74 2 (:REWRITE IFIX-EQUAL-TO-NONZERO))
     (72 2 (:REWRITE |(* (if a b c) x)|))
     (68 4 (:REWRITE DEFAULT-LESS-THAN-1))
     (66 28 (:REWRITE RP::STUPID-LEMMA1))
     (62 2 (:REWRITE ZIP-OPEN))
     (38 8
         (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
     (34 10 (:REWRITE DEFAULT-FLOOR-1))
     (28 28
         (:REWRITE REDUCE-INTEGERP-+-CONSTANT))
     ...
     (2 2 (:REWRITE |(< (- x) (- y))|))
     (2 2 (:REWRITE |(< (* x y) 0)|)))
(RP::BITP-OF-F2 (60 10 (:REWRITE O-INFP->NEQ-0))
                (30 30 (:TYPE-PRESCRIPTION O-FINP))
                (30 10 (:REWRITE O-FIRST-EXPT-O-INFP))
                (20 10 (:REWRITE O-FIRST-EXPT-DEF-O-FINP)))
(RP::LOGHEAD-OF-+-IS-2VEC-ADDER
     (1595 134
           (:REWRITE RP::DUMMY-SUM-CANCEL-LEMMA1))
     (244 87 (:REWRITE RP::F2-OF-BIT))
     (132 9 (:REWRITE LOGHEAD-IDENTITY))
     (115 4 (:DEFINITION UNSIGNED-BYTE-P))
     (76 4 (:DEFINITION INTEGER-RANGE-P))
     (62 15
         (:REWRITE BITOPS::LOGBITP-NONZERO-OF-BIT))
     (62 15 (:REWRITE BITOPS::LOGBITP-0-OF-BIT))
     (41 15
         (:REWRITE BITOPS::LOGBITP-WHEN-BITMASKP))
     ...
     (4 4
        (:REWRITE BITOPS::UNSIGNED-BYTE-P-INCR))
     (2 2 (:REWRITE ZP-OPEN)))
(RP::LOGHEAD-OF-+-IS-2VEC-ADDER-WITHOUT-CARRY
     (131 6 (:REWRITE LOGHEAD-IDENTITY))
     (115 5 (:DEFINITION UNSIGNED-BYTE-P))
