...
(RP::MULT-BYCOL-SPEC-IS-MULT-BYROW-SPEC-LEMMA
     (17746 32 (:REWRITE LOGHEAD-IDENTITY))
     (10179 78 (:DEFINITION UNSIGNED-BYTE-P**))
     (7986 156 (:REWRITE UNSIGNED-BYTE-P-PLUS))
     (7333 55 (:DEFINITION UNSIGNED-BYTE-P))
     (7152 55 (:DEFINITION INTEGER-RANGE-P))
     (2422 28 (:REWRITE BITOPS::LOGCDR-<-CONST))
     (1783 390 (:REWRITE DEFAULT-+-1))
     (1665 390 (:REWRITE DEFAULT-+-2))
     (1656 1656 (:TYPE-PRESCRIPTION BITP-OF-B-AND))
     (1470 14 (:REWRITE IFIX-NEGATIVE-TO-NEGP))
     (728 14 (:REWRITE NEGP-WHEN-LESS-THAN-0))
     (639 639
          (:TYPE-PRESCRIPTION UNSIGNED-BYTE-P))
     (618 256 (:REWRITE DEFAULT-<-1))
     (532 65 (:REWRITE IFIX-WHEN-NOT-INTEGERP))
     (492 492 (:TYPE-PRESCRIPTION BITP))
     (448 14 (:REWRITE NEGP-WHEN-INTEGERP))
     (403 39 (:DEFINITION RP::SUM-PPS-BY-ROW))
     (366 256 (:REWRITE DEFAULT-<-2))
...
(RP::STRIP-LOGBITS-OF-CREATE-PPS-IS-GET-COL
     (10758 134 (:DEFINITION BITMASKP**))
     (2794 1267
           (:TYPE-PRESCRIPTION BITOPS::LOGCDR-NATP))
     (2317 768
           (:REWRITE BITOPS::LOGBITP-NONZERO-OF-BIT))
     (1911 835 (:REWRITE BITOPS::LOGBITP-0-OF-BIT))
     ...
     (271 5 (:REWRITE BFIX-WHEN-NOT-1))
     (259 111 (:REWRITE FOLD-CONSTS-IN-+))
     (246 5 (:REWRITE EQUAL-1-OF-BOOL->BIT))
     ...
     (148 8 (:REWRITE BOOL->BIT-OF-NOT))
     (140 4 (:REWRITE BITOPS::B-NOT-B-NOT))
     (110 55
          (:TYPE-PRESCRIPTION BITOPS::LOGCONS-POSP-2))
     (110 55
          (:TYPE-PRESCRIPTION BITOPS::LOGCONS-POSP-1))
...
(RP::SUM-PPS-BY-COL-OF-NIL
     (1476 8 (:REWRITE LOGHEAD-IDENTITY))
     (819 399
          (:TYPE-PRESCRIPTION BITOPS::LOGCDR-NATP))
     (802 20 (:DEFINITION UNSIGNED-BYTE-P**))
     (676 40 (:REWRITE UNSIGNED-BYTE-P-PLUS))
     (656 43 (:DEFINITION LOGBITP**))
     (614 14 (:DEFINITION UNSIGNED-BYTE-P))
     (568 14 (:DEFINITION INTEGER-RANGE-P))
     ...
     (164 164
          (:TYPE-PRESCRIPTION UNSIGNED-BYTE-P))
     (150 30 (:REWRITE BITOPS::LOGCDR-<-CONST))
...
(RP::STRIP-LOGCARS-OF-STRIP-LOGTAIL-IS-STRIP-LOGBITS
     (1447 53
           (:REWRITE BITOPS::LOGBITP-WHEN-BITMASKP))
     (1412 11 (:DEFINITION BITMASKP**))
     (1253 9 (:REWRITE LOGTAIL-IDENTITY))
     (1203 5 (:DEFINITION LOGTAIL**))
     (746 14 (:DEFINITION LOGBITP**))
     (687 18 (:DEFINITION UNSIGNED-BYTE-P**))
     (567 1 (:REWRITE BITOPS::LOGCDR-OF-LOGTAIL))
     (562 14 (:DEFINITION UNSIGNED-BYTE-P))
     (554 274
          (:TYPE-PRESCRIPTION BITOPS::LOGCDR-NATP))
     (520 14 (:DEFINITION INTEGER-RANGE-P))
     (504 36 (:REWRITE UNSIGNED-BYTE-P-PLUS))
     (264 23 (:REWRITE BIT->BOOL-OF-BOOL->BIT))
     (261 36 (:REWRITE BITOPS::LOGCDR-OF-BIT))
     (243 243 (:TYPE-PRESCRIPTION LOGCDR-TYPE))
     ...
     (156 39
          (:REWRITE BITOPS::LOGBITP-NONZERO-OF-BIT))
     (130 22 (:REWRITE BITOPS::LOGCDR-<-CONST))
     (103 103
          (:TYPE-PRESCRIPTION BITMASKP$INLINE))
     (103 75 (:REWRITE DEFAULT-<-2))
     (99 99 (:TYPE-PRESCRIPTION LOGBITP))
     (95 75 (:REWRITE DEFAULT-<-1))
     (91 39 (:REWRITE BITOPS::LOGBITP-0-OF-BIT))
     ...
     (31 16 (:REWRITE IFIX-WHEN-INTEGERP))
...
(RP::STRIP-LOGCDRS-STRIP-LOGTAIL-IS-STRIP-LOGTAIL
     (3438 20 (:REWRITE LOGTAIL-IDENTITY))
     (1744 36 (:DEFINITION UNSIGNED-BYTE-P**))
     (1586 28 (:DEFINITION UNSIGNED-BYTE-P))
     (1502 28 (:DEFINITION INTEGER-RANGE-P))
     (1472 667
           (:TYPE-PRESCRIPTION BITOPS::LOGCDR-NATP))
     (1232 72 (:REWRITE UNSIGNED-BYTE-P-PLUS))
     (592 592 (:TYPE-PRESCRIPTION LOGCDR-TYPE))
     (567 49 (:REWRITE BITOPS::LOGCDR-OF-BIT))
     (428 60 (:REWRITE BITOPS::LOGCDR-<-CONST))
     (312 312
          (:TYPE-PRESCRIPTION UNSIGNED-BYTE-P))
     (195 116 (:REWRITE DEFAULT-<-1))
     (182 182 (:LINEAR BITOPS::LOGCDR-<=-LOGCDR))
     (172 116 (:REWRITE DEFAULT-<-2))
     (112 28 (:REWRITE ZP-WHEN-INTEGERP))
     (102 43 (:REWRITE IFIX-WHEN-NOT-INTEGERP))
     (102 43 (:REWRITE IFIX-WHEN-INTEGERP))
     (100 100
          (:REWRITE BITOPS::UNSIGNED-BYTE-P-INCR))
