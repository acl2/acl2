...
(RP::SUM-LIST-OF-TRUE-LIST-FIX
     ...
     (1 1 (:REWRITE |(equal (- x) (- y))|)))
(RP::AND-LIST-IS-AND$
     (11256 10 (:REWRITE RP::BIT-FIX-OPENER))
     (11236 10 (:DEFINITION BITP))
     (10692 8 (:DEFINITION APPLY$-BADGEP))
     (9224 32
     ...
     (1047 314
           (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
     (680 8 (:DEFINITION RP::RP-TERM-LISTP))
