(RP::BIT-OF-BIT-OF-WHEN-0
 (2943 19 (:REWRITE DEFAULT-FLOOR-RATIO))
 (2616 20 (:REWRITE |(* (* x y) z)|))
 (2602 10 (:REWRITE FLOOR-X-Y-=-1 . 2))
 (2559 2559
 ...
 (2252 10 (:REWRITE FLOOR-ZERO . 3))
 (2250 270 (:REWRITE DEFAULT-TIMES-2))
 (1932 10 (:REWRITE CANCEL-FLOOR-+))
 ...
 (1392 20 (:REWRITE BUBBLE-DOWN-*-BUBBLE-DOWN))
 (1376 10 (:REWRITE FLOOR-=-X/Y . 3))
 (1268 10 (:REWRITE FLOOR-=-X/Y . 2))
 (1234 56
 ...
 (484 16 (:REWRITE |(* (/ c) (expt d n))|))
 (446 10 (:REWRITE |(integerp (- x))|))
 (384 34 (:REWRITE DEFAULT-PLUS-2))
 (378 2 (:REWRITE SIMPLIFY-SUMS-EQUAL))
 (378 2
