...
(RP::RP-TERM-LISTP-OF-C/D-FIX-ARG-AUX.COUGHED-LST
     ...
     (49102 759
            (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
     (47742 784 (:DEFINITION QUOTEP))
     (45666 78 (:DEFINITION APPLY$-BADGEP))
     (40823 152
            (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
...
(RP::RP-TERM-LISTP-OF-C/D-FIX-ARG-AUX.CLEANED-LST
     ...
     (55123 861
            (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
     (51176 88 (:DEFINITION APPLY$-BADGEP))
     (46353 172
            (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
...
(RP::RP-TERMP-OF-D-SUM
     (39360 60 (:DEFINITION APPLY$-BADGEP))
     (31155 120
            (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
...
(RP::GOOD-4VEC-TERM-P
     (32947 324 (:DEFINITION RP::EX-FROM-RP))
     (29051 5884 (:REWRITE RP::MEASURE-LEMMA1))
     (28707 791 (:REWRITE RP::NOT-INCLUDE-RP))
     (27684 351 (:DEFINITION RP::INCLUDE-FNC))
     (25277 2218 (:REWRITE RP::MEASURE-LEMMA1-2))
     (21460 214 (:DEFINITION APPLY$-BADGEP))
     (20262 262
            (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
     ...
     (6 6
        (:REWRITE |a < b & b < c  =>  a < c|)))
(RP::4VEC->PP-TERM (33583 361 (:DEFINITION RP::EX-FROM-RP))
                   (29122 828 (:REWRITE RP::NOT-INCLUDE-RP))
                   (28891 5708 (:REWRITE RP::MEASURE-LEMMA1))
                   (27988 388 (:DEFINITION RP::INCLUDE-FNC))
                   (25249 2174 (:REWRITE RP::MEASURE-LEMMA1-2))
                   (21527 231 (:DEFINITION APPLY$-BADGEP))
                   (20283 263
                          (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
