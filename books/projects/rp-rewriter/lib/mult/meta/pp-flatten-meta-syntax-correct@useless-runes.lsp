...
(RP::RP-TERMP-PP-LISTS-TO-TERM-P+
     (1704 42
           (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
     (1618 26 (:DEFINITION QUOTEP))
     (1540 15
           (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
     (1520 10 (:DEFINITION APPLY$-BADGEP))
     (1037 939 (:REWRITE DEFAULT-CDR))
     (975 5 (:DEFINITION SUBSETP-EQUAL))
     (910 70 (:DEFINITION MEMBER-EQUAL))
     (796 4 (:DEFINITION RP::FALIST-CONSISTENT))
     (670 632 (:REWRITE DEFAULT-CAR))
     (616 4
          (:DEFINITION RP::FALIST-CONSISTENT-AUX))
     (570 35
          (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-1))
...
(RP::FLATTEN-PP-MAIN-RETURNS-PSEUDO-TERM2
     (6369 6129 (:REWRITE DEFAULT-CDR))
     (5739 292
           (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
     (4392 4276 (:REWRITE DEFAULT-CAR))
     (3925 89
           (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
     (3807 89 (:DEFINITION APPLY$-BADGEP))
     (3392 292
           (:REWRITE RP::RP-TERMP-IMPLIES-CDR-LISTP))
...
(RP::VALID-SC-SUBTERMS-LST-PP-TERM-TO-PP-LISTS
     (146651 221 (:DEFINITION RP::VALID-SC))
...
(RP::VALID-SC-PP-LISTS-TO-TERM-AND$
     (3046 122 (:DEFINITION RP::INCLUDE-FNC))
     ...
     (1298 4
           (:REWRITE RP::RP-TERMP-PP-LISTS-TO-TERM-AND$))
     (1159 19
           (:REWRITE RP::EVL-OF-EXTRACT-FROM-RP-2))
     (1068 11 (:DEFINITION RP::RP-TERMP))
     (942 88
          (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
     (874 158 (:DEFINITION QUOTEP))
     (797 19 (:DEFINITION RP::RP-TRANS))
     (770 86 (:DEFINITION APPLY$-BADGEP))
     (762 171 (:REWRITE O-P-O-INFP-CAR))
     (676 8
          (:REWRITE RP::RP-TERMP-IMPLIES-CDR-LISTP))
     (616 4 (:DEFINITION RP::RP-TERM-LISTP))
     (562 8
          (:REWRITE RP::RP-TERMP-IMPLIES-SUBTERMS))
...
(RP::VALID-SC-PP-LISTS-TO-TERM-P+
     ...
     (20 20
         (:TYPE-PRESCRIPTION RP::RP-TERM-LISTP))
     (20 20
         (:TYPE-PRESCRIPTION RP::RP-TERM-LIST-LISTP))
     (20 20
         (:REWRITE SYMBOL-LISTP-IMPLIES-SYMBOLP))
     (20 20
         (:REWRITE RP::RP-TERMP-SHOULD-TERM-BE-IN-CONS-LHS))
