...
(RP::PP-OR$-ORDER)
(RP::SANITY-OR$-ORDER
 (6060 303 (:DEFINITION RP::LEXORDER2))
 (5248 5248 (:REWRITE DEFAULT-CDR))
 (5005 1001 (:DEFINITION RP::EX-FROM-RP))
 (1377 935 (:REWRITE RP::LEXORDER2-SANITY-LEMMA2))
 (1001 1001 (:TYPE-PRESCRIPTION RP::IS-RP$INLINE))
 (909 303 (:REWRITE RP::SMALL-ALPHORDER-SANITY))
 (606 606 (:TYPE-PRESCRIPTION RP::SMALL-ALPHORDER))
