...
(RP::BIT-LISTP-APPEND
     (2343 91 (:REWRITE RP::POS-LEN-IS-CONSP))
     (687 24
          (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
     (686 45 (:DEFINITION LEN))
     (586 62 (:REWRITE DEFAULT-CDR))
     (538 48 (:REWRITE ACL2-NUMBERP-X))
     (435 6 (:REWRITE LEN-OF-APPEND))
     (403 403 (:TYPE-PRESCRIPTION LEN))
     (361 6 (:REWRITE CONSP-OF-APPEND))
     (306 3 (:REWRITE CAR-OF-APPEND))
     (245 24 (:REWRITE RATIONALP-X))
     (208 6 (:REWRITE APPEND-WHEN-NOT-CONSP))
     (197 24
          (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
     (178 22 (:REWRITE DEFAULT-CAR))
     (172 12 (:REWRITE O-INFP->NEQ-0))
     (150 3 (:REWRITE CDR-OF-APPEND-WHEN-CONSP))
...
(RP::LEMMA2
     (267 1 (:DEFINITION RP::[]-CDR))
     (205 4 (:REWRITE ZP-OPEN))
     (197 5 (:REWRITE DEFAULT-CDR))
...
(RP::ARRAY-CDR-1-IS-CDR
     (124 7 (:REWRITE DEFAULT-CDR))
     (120 6 (:REWRITE RP::POS-LEN-IS-CONSP))
     (38 3 (:DEFINITION LEN))
...
(RP::CONS-OF-CAR-AND-CDR-TO-[]
     (105 4 (:REWRITE RP::POS-LEN-IS-CONSP))
...
(RP::CONS-OF-CAR-AND-CDR-TO-[]-2
     (5553 39 (:REWRITE RP::POS-LEN-IS-CONSP))
     (5389 10 (:REWRITE APPEND-WHEN-NOT-CONSP))
     (5219 9 (:DEFINITION LEN))
     (5127 12
           (:REWRITE APPLY$-BADGEP-PROPERTIES . 3))
     (5121 3 (:DEFINITION APPLY$-BADGEP))
     (4176 12 (:DEFINITION SUBSETP-EQUAL))
     (3888 90 (:DEFINITION MEMBER-EQUAL))
     (2385 30 (:REWRITE SUBSETP-REFLEXIVE-LEMMA))
     (1680 48
     ...
     (900 72 (:REWRITE ACL2-NUMBERP-X))
     (564 564 (:TYPE-PRESCRIPTION RP::BIT-LISTP))
     (499 445 (:REWRITE DEFAULT-CDR))
     (474 36 (:REWRITE RATIONALP-X))
     (382 130
          (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
     ...
     (136 130 (:REWRITE SIMPLIFY-SUMS-EQUAL))
     ...
     (93 93 (:TYPE-PRESCRIPTION APPLY$-BADGEP))
...
(RP::[]-CDR-TO-CONS-2-LEMMA
     ...
     (1 1 (:REWRITE |(< (- x) (- y))|)))
(RP::[]-CDR-TO-CONS-2
     (2333 52 (:REWRITE RP::POS-LEN-IS-CONSP))
     (1669 2
           (:REWRITE APPLY$-BADGEP-PROPERTIES . 3))
     (1667 1 (:DEFINITION APPLY$-BADGEP))
     (1392 4 (:DEFINITION SUBSETP-EQUAL))
     (1296 30 (:DEFINITION MEMBER-EQUAL))
     (795 10 (:REWRITE SUBSETP-REFLEXIVE-LEMMA))
     (560 16
          (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-1))
     (418 57
          (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
     (376 188
          (:TYPE-PRESCRIPTION RP::BITP-CAR-LIST))
     (288 22 (:REWRITE ACL2-NUMBERP-X))
     (221 187 (:REWRITE DEFAULT-CDR))
     (188 188 (:TYPE-PRESCRIPTION RP::BIT-LISTP))
     (153 11 (:REWRITE RATIONALP-X))
     (152 57
          (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
     ...
     (71 57 (:REWRITE SIMPLIFY-SUMS-EQUAL))
...
(RP::[]-CDR-TO-CONS
     ...
     (612 15 (:REWRITE DEFAULT-CDR))
     (415 19 (:REWRITE RP::POS-LEN-IS-CONSP))
     (311 32
          (:REWRITE REDUCE-ADDITIVE-CONSTANT-<))
     ...
     (1 1 (:REWRITE |(< (+ (- c) x) y)|)))
(RP::[]-TAKE-TO-LIST
     (386 22 (:REWRITE RP::POS-LEN-IS-CONSP))
...
(RP::BIT-LISTP-IS-TRUE-LISTP
     (321 14 (:REWRITE RP::POS-LEN-IS-CONSP))
     (168 84
          (:TYPE-PRESCRIPTION RP::BITP-CAR-LIST))
     (168 6
          (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
     ...
     (1 1 (:REWRITE |(< x (if a b c))|)))
(RP::APPEND-[]-TAKE
     (35212 57 (:REWRITE RP::[]-TAKE-TO-LIST))
     (34540 164 (:DEFINITION LEN))
     (31306 128
            (:REWRITE APPLY$-BADGEP-PROPERTIES . 3))
     (31278 14 (:DEFINITION APPLY$-BADGEP))
     (20748 56 (:DEFINITION SUBSETP-EQUAL))
     (20341 500 (:REWRITE RP::POS-LEN-IS-CONSP))
     (18144 420 (:DEFINITION MEMBER-EQUAL))
     (12075 140 (:REWRITE SUBSETP-REFLEXIVE-LEMMA))
     (10528 5 (:REWRITE EQUAL-LEN-1))
     (7840 224
           (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-1))
     (7550 711
           (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
     (7028 3514
           (:TYPE-PRESCRIPTION RP::BITP-CAR-LIST))
     (5656 448 (:REWRITE ACL2-NUMBERP-X))
     (4892 28
           (:REWRITE RP::BIT-LISTP-IS-TRUE-LISTP))
     (4808 28 (:DEFINITION RP::BIT-LISTP))
     (3752 28 (:DEFINITION BITP))
     (3654 3654 (:TYPE-PRESCRIPTION RP::BIT-LISTP))
     (2996 224 (:REWRITE RATIONALP-X))
     (2946 14 (:DEFINITION TRUE-LISTP))
     (2360 46 (:REWRITE APPEND-WHEN-NOT-CONSP))
     (2343 711
           (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
     (2006 2006 (:TYPE-PRESCRIPTION LEN))
     (1673 14 (:DEFINITION WEAK-APPLY$-BADGE-P))
     (1372 28 (:DEFINITION NATP))
     (1311 23 (:DEFINITION BINARY-APPEND))
     (995 730
          (:REWRITE REDUCE-ADDITIVE-CONSTANT-EQUAL))
     (887 887 (:TYPE-PRESCRIPTION APPLY$-BADGEP))
     (840 840 (:TYPE-PRESCRIPTION MEMBER-EQUAL))
     (792 711 (:REWRITE SIMPLIFY-SUMS-EQUAL))
     (730 730
          (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-EQUAL))
     (728 728 (:REWRITE SUBSETP-IMPLIES-MEMBER))
     (711 711
          (:REWRITE EQUAL-OF-PREDICATES-REWRITE))
     (711 711 (:REWRITE |(equal c (/ x))|))
     (711 711 (:REWRITE |(equal c (- x))|))
     (711 711 (:REWRITE |(equal (/ x) c)|))
     (711 711 (:REWRITE |(equal (/ x) (/ y))|))
     (711 711 (:REWRITE |(equal (- x) c)|))
     (711 711 (:REWRITE |(equal (- x) (- y))|))
     (672 672
          (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-3))
     ...
     (448 224
          (:REWRITE APPLY$-BADGEP-PROPERTIES . 1))
     (436 259 (:REWRITE DEFAULT-LESS-THAN-2))
     (427 259
     ...
     (252 126
          (:LINEAR APPLY$-BADGEP-PROPERTIES . 2))
     (251 251 (:LINEAR BOUNDS-POSITION-EQUAL-AC))
     (251 251 (:LINEAR BOUNDS-POSITION-EQUAL))
     (239 239
          (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
     ...
     (140 140
          (:REWRITE TRANSITIVITY-OF-SUBSETP-EQUAL))
     (131 8 (:REWRITE EQUAL-LEN-0))
     (70 70 (:TYPE-PRESCRIPTION ALL-NILS))
     (55 1 (:REWRITE RP::LEN-CONS))
...
(RP::APPEND-NIL)
(RP::[]-OF-TAKE
     (1467 58 (:REWRITE RP::POS-LEN-IS-CONSP))
     (977 11 (:REWRITE RP::[]-TAKE-TO-LIST))
     (853 32 (:DEFINITION LEN))
     (556 16 (:REWRITE DEFAULT-CAR))
     ...
     (2 2 (:REWRITE |(+ 0 x)|)))
(RP::[]-OF-NTHCDR
     (2663 42 (:REWRITE RP::POS-LEN-IS-CONSP))
     (1120 7 (:REWRITE RP::LEN-OF-NTHCDR))
     (1078 73
           (:REWRITE REDUCE-ADDITIVE-CONSTANT-<))
     (825 11 (:REWRITE |(< x (if a b c))|))
     (770 52 (:REWRITE PREFER-POSITIVE-ADDENDS-<))
     (739 7 (:DEFINITION NFIX))
     (478 478 (:TYPE-PRESCRIPTION LEN))
     (410 20 (:DEFINITION LEN))
     (280 188 (:REWRITE DEFAULT-PLUS-2))
     (218 98 (:REWRITE NORMALIZE-ADDENDS))
     (206 188 (:REWRITE DEFAULT-PLUS-1))
     (183 18 (:REWRITE ZP-OPEN))
     (143 11 (:REWRITE |(< (+ (- c) x) y)|))
...
(RP::TRUE-LISTP-CONS
     (9815 16
           (:REWRITE RP::BIT-LISTP-IS-TRUE-LISTP))
     (9760 7 (:DEFINITION BITP))
     (9742 6 (:DEFINITION RP::BIT-LISTP))
     (9358 12 (:DEFINITION APPLY$-BADGEP))
     (7966 26
           (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
     (7104 28 (:DEFINITION SUBSETP-EQUAL))
     (6556 196 (:DEFINITION MEMBER-EQUAL))
     (3466 68 (:REWRITE SUBSETP-REFLEXIVE-LEMMA))
     (3248 124
           (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-1))
     (3010 300
           (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
     (2736 176 (:REWRITE ACL2-NUMBERP-X))
     (2120 88 (:REWRITE RATIONALP-X))
     (1596 90
           (:REWRITE APPLY$-BADGEP-PROPERTIES . 1))
     ...
     (372 372
          (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-3))
     (340 340 (:REWRITE SUBSETP-IMPLIES-MEMBER))
     (310 300 (:REWRITE SIMPLIFY-SUMS-EQUAL))
     ...
     (248 248
          (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-2))
     (226 226 (:TYPE-PRESCRIPTION APPLY$-BADGEP))
