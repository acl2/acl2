...
(RP::FLAG-VALID-SC
     (987 716 (:REWRITE RP::MEASURE-LEMMA1))
     (699 3 (:DEFINITION RP::RP-TRANS))
     (542 34 (:DEFINITION RP::EX-FROM-RP))
     (437 163 (:REWRITE DEFAULT-CDR))
     (413 1 (:DEFINITION RP::EVAL-AND-ALL))
...
(RP::EVAL-AND-ALL-NT (4 1
                     ...
                     (2 2 (:REWRITE DEFAULT-CAR)))
(RP::VALID-SC-NT
     (519 428 (:REWRITE RP::MEASURE-LEMMA1))
     (180 1 (:DEFINITION RP::EVAL-AND-ALL-NT))
