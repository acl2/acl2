...
(DROP)
(INSERT)
(ORDEREDP (179 83 (:REWRITE DEFAULT-+-2))
...
(UNIQUEP)
(MEMBERP-INSERT-SAME (36 30 (:REWRITE DEFAULT-CAR))
                     (25 25 (:REWRITE <<-TRANSITIVE))
                     (15 9 (:REWRITE DEFAULT-CDR)))
(MEMBERP-INSERT-DIFF (271 71 (:REWRITE <<-TRICHOTOMY))
...
(MEMBERP-DROP-SAME (24 23 (:REWRITE DEFAULT-CAR))
                   (18 17 (:REWRITE DEFAULT-CDR)))
(MEMBERP-DROP-DIFF (37 35 (:REWRITE DEFAULT-CAR))
                   (25 24 (:REWRITE DEFAULT-CDR)))
(ORDERED-IMPLIES-UNIQUE (653 177 (:REWRITE <<-TRICHOTOMY))
                        (76 76 (:REWRITE DEFAULT-CAR)))
(MEMBERP-YES-REDUCE-INSERT)
(MEMBERP-NO-REDUCE-DROP (21 21 (:REWRITE DEFAULT-CAR))
                        (15 15 (:REWRITE DEFAULT-CDR)))
(DROP-IS-MONOTONIC (1165 319 (:REWRITE <<-TRICHOTOMY))
...
(DROP-PRESERVES-ORDEREDP (338 82 (:REWRITE <<-TRICHOTOMY))
...
(INSERT-PRESERVES-ORDEREDP (439 349 (:REWRITE <<-TRANSITIVE))
                           (9 9 (:REWRITE <<-IRREFLEXIVE)))
(DROP-OF-INSERT-IS-SAME (209 7 (:REWRITE MEMBERP-YES-REDUCE-INSERT))
...
(INSERT-OF-DROP-IS-SAME (508 483 (:REWRITE DEFAULT-CAR))
...
(INSERT-RETURNS-TRUE-LISTS (236 8 (:REWRITE MEMBERP-YES-REDUCE-INSERT))
