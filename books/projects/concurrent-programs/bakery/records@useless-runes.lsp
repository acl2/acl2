...
(KEYS-AUX)
(KEYS (3 3 (:TYPE-PRESCRIPTION ACL2->RCD)))
...
(G-KEYS-AUX-RELATIONSHIP (460 447 (:REWRITE DEFAULT-CAR))
                         (193 182 (:REWRITE DEFAULT-CDR)))
(S-KEYS-AUX-REDUCTION (2456 658 (:REWRITE <<-TRICHOTOMY))
...
(KEYS-AUX-ARE-ORDERED (733 200 (:REWRITE <<-TRICHOTOMY))
...
(S-DIFF-S (208 5 (:DEFINITION S-AUX))
          ...
          (15 15 (:REWRITE DEFAULT-CDR))
          (6 6 (:TYPE-PRESCRIPTION ACL2->RCD)))
(G-KEYS-RELATIONSHIP (162 6 (:REWRITE G-AUX-IS-NIL-FOR-<<))
...
(S-KEYS-REDUCTION (248 4 (:REWRITE G-KEYS-AUX-RELATIONSHIP))
...
(NON-NIL-IF-G-NON-NIL (13 1 (:REWRITE G-AUX-IS-NIL-FOR-<<))
                      ...
                      (2 1 (:REWRITE <<-ASYMMETRIC))
                      (1 1 (:TYPE-PRESCRIPTION RCDP)))
(S-SAME-G-BACK-CHAINING (67 1 (:DEFINITION G-AUX))
                        (54 2 (:REWRITE G-AUX-IS-NIL-FOR-<<))
                        (39 10 (:REWRITE <<-TRICHOTOMY))
                        (29 1 (:DEFINITION RCDP))
                        (25 5 (:REWRITE <<-ASYMMETRIC))
