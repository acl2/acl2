...
(PUMP-ORD)
(MSR->ORD)
(BINARY-INDUCT (3 3 (:REWRITE DEFAULT-<-2))
               (3 3 (:REWRITE DEFAULT-<-1))
               (2 2 (:REWRITE ZP-OPEN))
               (1 1 (:REWRITE DEFAULT-+-2))
               (1 1 (:REWRITE DEFAULT-+-1)))
(CONSP-PUMP-ORD-REDUCTION (14 9 (:REWRITE DEFAULT-+-2))
...
(PUMP-ORD-TYPE-PRESCRIPTION (13 11 (:REWRITE DEFAULT-<-2))
                            ...
                            (2 2
                               (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(E0-ORD-<-PUMP-ORD-M<N (42 14 (:REWRITE DEFAULT-CAR))
...
(E0-ORD-<-ASYMMETRY (70 70 (:REWRITE DEFAULT-CAR))
                    (25 25 (:REWRITE DEFAULT-<-2))
                    (25 25 (:REWRITE DEFAULT-<-1))
                    (20 20 (:REWRITE DEFAULT-CDR)))
(PUMP-ORD-IS-AN-E0-ORDINALP (177 6 (:DEFINITION E0-ORD-<))
                            ...
                            (4 4 (:REWRITE ZP-OPEN)))
(CAR-MSR->ORD-CONDITIONAL (104 13 (:REWRITE ZP-OPEN))
                          ...
                          (2 2
                             (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(PUMP-ORD-MAPS-E0-ORD-<-TO-<1 (967 23 (:REWRITE E0-ORD-<-ASYMMETRY))
...
(PUMP-ORD-MAPS-E0-ORD-<-TO-<2 (463 9 (:REWRITE E0-ORD-<-ASYMMETRY))
...
(MSR<-IMPLIES-EQUAL-LENGTHS (31 31 (:REWRITE DEFAULT-CAR))
                            (28 14 (:REWRITE DEFAULT-+-2))
                            (20 20 (:REWRITE DEFAULT-CDR))
                            (14 14 (:REWRITE DEFAULT-+-1))
                            (13 13 (:REWRITE DEFAULT-<-2))
                            (13 13 (:REWRITE DEFAULT-<-1)))
(MSR->ORD-RETURNS-E0-ORDINALS (1018 18 (:DEFINITION E0-ORD-<))
                              ...
                              (40 40
                                  (:REWRITE MSR<-IMPLIES-EQUAL-LENGTHS))
                              (18 18
                                  (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(MSR<-IS-WELL-FOUNDED-VIA-MSR->ORD
     ...
     (44 44
         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (26 2
         (:REWRITE PUMP-ORD-MAPS-E0-ORD-<-TO-<2)))
(MSR-1-DECREASES-NON0-MEASURES (204 169 (:REWRITE DEFAULT-CAR))
...
(MSR<-IS-IRREFLEXIVE (25 25 (:REWRITE DEFAULT-CAR))
                     (20 4 (:DEFINITION LEN))
...
(MSR<-IS-ASYMMETRIC (153 153 (:REWRITE DEFAULT-CAR))
                    (76 76 (:REWRITE DEFAULT-CDR))
                    (60 30 (:REWRITE DEFAULT-+-2))
                    (42 42 (:REWRITE DEFAULT-<-2))
                    (42 42 (:REWRITE DEFAULT-<-1))
                    (30 30 (:REWRITE DEFAULT-+-1)))
(MSR<-IS-TRANSITIVE (1011 1011 (:REWRITE DEFAULT-CAR))
...
(MSR<-CONS-REDUCTION (245 8 (:REWRITE MSR<-IS-ASYMMETRIC))
...
(LEN-APPEND-REDUCTION (46 23 (:REWRITE DEFAULT-+-2))
...
(MSR<-APPEND-REDUCTION (5410 126 (:REWRITE MSR<-IS-ASYMMETRIC))
