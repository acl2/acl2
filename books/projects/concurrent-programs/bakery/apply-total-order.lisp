...
In this book, we describe some simple functions like insert and drop on a
totally ordered list, and provide rules to manipulate them. The functions that
we introduce are insert, drop, memberp, orderedp, and uniquep. Then we prove
some theorems that we wish to export from this book.
