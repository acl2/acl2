...
Note from Sandip: This book is an older version of records.lisp distributed
with ACL2 (and developed by Kaufmann and Sumners).  We use this version rather
than the distributed version because I make critical use of the definition of
keys for the proof.
