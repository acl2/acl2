...
(LENGTH-EQUIV-IMPLIES-EQUAL-INPUT-LISTP-2
     (1844 217 (:REWRITE INPUT-LIST-ELTP-THM))
     (1299 38
           (:REWRITE INPUT-LIST-ELTP-OF-CAR-WHEN-INPUT-LISTP))
     (251 170 (:REWRITE DEFAULT-<-1))
...
(INPUT-LISTP-PSEUDO
 (2358 20 (:DEFINITION BACKREF-LISTP))
 (1782 132 (:REWRITE INPUT-LIST-ELTP-THM))
 (1708 20 (:DEFINITION BACKREFP))
 (1630 46 (:REWRITE INPUT-LIST-ELTP-SUFFIC))
 (1517 16
       (:REWRITE INPUT-LIST-ELTP-OF-CAR-WHEN-INPUT-LISTP))
 (620 124 (:DEFINITION LEN))
 (267 143 (:REWRITE DEFAULT-<-1))
