...
(STORE-BACKREFS-INPUT-LIST
     ...
     (171 15 (:REWRITE INPUT-LIST-ELTP-SUFFIC))
...
(RUN-REGEX-INPUT-LISTP (1881 627 (:REWRITE R-REPEAT-NOT-REGEX))
                       ...
                       (321 321
                            (:TYPE-PRESCRIPTION RUN-REPEAT-LIST))
...
(RUN-REGEX
     ...
     (8 1
        (:DEFINITION REMOVE-ALL-LONGER-EQUAL-FN))
     (6 1
        (:REWRITE INPUT-LIST-ELTP-OF-NTH-WHEN-INPUT-LISTP))
...
(MATCH-REGEX-FUN
     ...
     (465 75
          (:REWRITE RUN-REGEX-PSUEDO-INPUT-LISTP))
     ...
     (160 160
          (:TYPE-PRESCRIPTION REG-STR-BR-GUARD))
...
(MATCH-REGEX (31 2 (:REWRITE IMPLIES-LENGTH-EQUIV))
             (28 1 (:DEFINITION =))
...
(STRING-OR-NULL-LISTP-CDR (2 2 (:REWRITE DEFAULT-CDR))
...
(MATCH-REGEX-STRING (43 26 (:REWRITE DEFAULT-<-1))
...
(MATCH-REGEX-STRLIST (38 23 (:REWRITE DEFAULT-<-1))
