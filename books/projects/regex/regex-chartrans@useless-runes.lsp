(IS-UPPERCASE)
(IS-LOWERCASE)
(MAKE-CASE-INSENS-TRANSLATION (12 12 (:REWRITE DEFAULT-<-2))
...
(ASSOC-TRANSLATION-TABLE (104 104 (:REWRITE DEFAULT-CAR))
                         (32 32 (:REWRITE DEFAULT-CDR)))
(APPLY-TRANSLATION1 (187 187 (:REWRITE DEFAULT-CAR))
                    (70 70 (:REWRITE DEFAULT-CDR))
                    (5 1 (:DEFINITION EQLABLE-ALISTP)))
(CHARACTER-LISTP-APPLY-TRANSLATION1 (85 81 (:REWRITE DEFAULT-CAR))
                                    (64 60 (:REWRITE DEFAULT-CDR))
                                    (50 10 (:DEFINITION ASSOC-EQUAL))
                                    (42 6 (:DEFINITION TRANSLATION-TABLE-P)))
(APPLY-TRANSLATION1-LENGTH (60 56 (:REWRITE DEFAULT-CDR))
                           (50 10 (:DEFINITION ASSOC-EQUAL))
                           (42 21 (:REWRITE DEFAULT-+-2))
                           (41 41 (:REWRITE DEFAULT-CAR))
                           (21 21 (:REWRITE DEFAULT-+-1)))
(APPLY-TRANSLATION (10 1 (:DEFINITION APPLY-TRANSLATION1))
...
(APPLY-TRANSLATION-LENGTH (10 2 (:DEFINITION LEN))
...
(CASE-INSENS-TRANS-LENGTH (10 2 (:DEFINITION LEN))
                          (4 2 (:REWRITE DEFAULT-+-2))
                          (2 2 (:TYPE-PRESCRIPTION LEN))
