...
; DO NOT EDIT THIS FILE EXCEPT the version found on /books/projects/apply-model
; under the name apply.lisp!

; In particular, do not edit:
; /books/projects/apply-model/ex1/evaluation-apply.lisp
; /books/projects/apply-model/ex2/evaluation-apply.lisp
; which are copies of this file.

; Recall also that as of ACL2 Version_7.4 the books on /books/projects/apply/
; are just copies of their namesakes on /books/projects/apply-model/ EXCEPT for
; the initial IN-PACKAGE.  On that other directory, apply-prim.lisp,
; constraints.lisp, and apply.lisp all start with (in-package "ACL2") but here
; all start with (in-package "MODAPP").  Over time, as the implementation
; changes, we expect the books on /books/projects/apply/ to evolve, along with
; the ACL2 source file apply-raw.lisp, to support the new, improved APPLY$ and
; DEF-WARRANT.  But we expect the files here to remain static and in compliance
; with the paper ``Limited Second-Order Functionality in a First-Order
; Setting.''

; Furthermore, during certification of /books/projects/apply-model/ex1/ and
; /books/projects/apply-model/ex2/, the version of this file on
; /books/projects/apply-model/ is copied to ex1/evaluation-apply.lisp and
...
; have the function occur in our proofs and so we always expand it away.
