...
(META-APPLY$-PRIM (3615 3615 (:REWRITE DEFAULT-CDR))
...
(APPLY$-COMPOSITION (36685 36373 (:REWRITE DEFAULT-CDR))
                    (9343 8839 (:REWRITE DEFAULT-CAR))
                    (8000 284 (:REWRITE APPLY$-LAMBDA-OPENER))
                    (6820 1605 (:REWRITE O-P-O-INFP-CAR))
                    (5416 752 (:DEFINITION LEN))
                    (3648 1350 (:REWRITE APPLY$-PRIMP-BADGE))
                    (3210 3210 (:TYPE-PRESCRIPTION O-P))
                    (2380 84
                          (:REWRITE APPLY$-BADGEP-PROPERTIES . 1))
                    (2324 28 (:DEFINITION APPLY$-BADGEP))
                    (2005 1605 (:REWRITE O-P-DEF-O-FINP-1))
                    (1651 899 (:REWRITE DEFAULT-+-2))
                    (1264 476 (:REWRITE APPLY$-PRIMITIVE))
                    ...
                    (376 376
                         (:REWRITE UNTAME-APPLY$-TAKES-ARITY-ARGS))
                    (331 331 (:REWRITE DEFAULT-COERCE-2))
                    (331 331 (:REWRITE DEFAULT-COERCE-1))
                    (266 266 (:TYPE-PRESCRIPTION APPLY$-BADGEP))
                    (264 264 (:META APPLY$-PRIM-META-FN-CORRECT))
                    (211 183 (:REWRITE DEFAULT-<-2))
                    (183 183 (:REWRITE DEFAULT-<-1))
                    (160 160 (:TYPE-PRESCRIPTION O-FINP))
                    (160 20 (:REWRITE APPLY$-APPLY$))
                    (140 70
                         (:LINEAR APPLY$-BADGEP-PROPERTIES . 1))
                    (112 56
                         (:REWRITE APPLY$-BADGEP-PROPERTIES . 3))
