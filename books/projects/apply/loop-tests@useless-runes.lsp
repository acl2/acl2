...
(F2-ALT (2 2
           (:REWRITE INTEGER-LISTP-IMPLIES-INTEGERP)))
(SUM-SQUARES-2 (448 8 (:DEFINITION ALWAYS$))
...
(SUM-SQUARES-3 (224 4 (:DEFINITION ALWAYS$))
               (138 4 (:REWRITE APPLY$-SYMBOL-ARITY-1))
               ...
               (1 1
                  (:REWRITE ACL2-NUMBER-LISTP-FROM-TO-BY)))
(SUM-SQUARES-3 (448 8 (:DEFINITION ALWAYS$))
               (276 8 (:REWRITE APPLY$-SYMBOL-ARITY-1))
               (196 2 (:REWRITE PLAIN-UQI-TRUE-LIST-LISTP))
               (130 2 (:REWRITE PLAIN-UQI-SYMBOL-LISTP))
               (130 2 (:REWRITE PLAIN-UQI-RATIONAL-LISTP))
...
(APPLY$-DOUBLE (8 2 (:REWRITE DEFAULT-+-2))
               ...
               (2 1 (:REWRITE APPLY$-PRIMITIVE)))
(SUM-DOUBLES)
(SUM-DOUBLES (896 1 (:DEFINITION MEMBER-EQUAL))
...
(APPLY$-LOOP1 (24500 52 (:DEFINITION TAMEP))
