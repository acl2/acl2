...
(OK-FNP-COMPOSE
 (15634 15634 (:REWRITE DEFAULT-CDR))
 (5622 77 (:DEFINITION APPLY$-BADGEP))
 (5284 5284 (:REWRITE DEFAULT-CAR))
 (4320 248 (:REWRITE APPLY$-BADGEP-PROPERTIES . 1))
 (3628 488 (:DEFINITION LEN))
 (3584 823 (:REWRITE O-P-O-INFP-CAR))
 (2044 758 (:REWRITE APPLY$-PRIMP-BADGE))
 (1401 35 (:DEFINITION SUBSETP-EQUAL))
 (1296 154 (:DEFINITION NATP))
 ...
 (383 285 (:REWRITE DEFAULT-<-2))
 (336 168 (:REWRITE APPLY$-BADGEP-PROPERTIES . 3))
 (308 77 (:DEFINITION WEAK-APPLY$-BADGE-P))
 ...
 (154 77 (:REWRITE APPLY$-BADGEP-PROPERTIES . 2))
 (154 77 (:LINEAR APPLY$-BADGEP-PROPERTIES . 2))
