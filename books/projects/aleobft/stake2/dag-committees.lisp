...
(defxdoc+ dag-committees
  ...
  (xdoc::topstring
   ...
   (xdoc::p
    "When a certificate is moved into a DAG via @('accept'),
...
(defsection dag-committees-p-of-next
  ...
  (xdoc::topstring
   (xdoc::p
    "For @('create') and @('accept'), which may extend DAGs,
     we open @(tsee create-possiblep) and @(tsee accept-possiblep)
  ...
  (defruled dag-committees-p-of-accept-next
    (implies (and (dag-committees-p systate)
                  (accept-possiblep msg systate))
             (dag-committees-p (accept-next msg systate)))
    :enable (dag-committees-p
             dag-has-committees-p-of-insert
             dag-in-committees-p-of-insert
             dag-committees-p-necc
