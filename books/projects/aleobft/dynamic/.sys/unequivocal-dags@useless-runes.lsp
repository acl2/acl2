(ALEOBFT-DYNAMIC::UNEQUIVOCAL-DAGS-P)
(ALEOBFT-DYNAMIC::UNEQUIVOCAL-DAGS-P-NECC
 (4 4 (:DEFINITION MV-NTH))
 )
(ALEOBFT-DYNAMIC::BOOLEANP-OF-UNEQUIVOCAL-DAGS-P)
(ALEOBFT-DYNAMIC::UNEQUIVOCAL-DAGS-P
...
(ALEOBFT-DYNAMIC::UNEQUIVOCAL-DAGS-NECC-SINGLE
...
(ALEOBFT-DYNAMIC::UNEQUIVOCAL-DAGS-P-WHEN-UNEQUIVOCAL-ACCEPTED-CERTIFICATES-P
 (88 88 (:TYPE-PRESCRIPTION SET::EMPTYP-TYPE))
 (80 20 (:REWRITE SET::IN-TAIL))
 (38 14 (:REWRITE SET::UNION-EMPTYP-Y))
 (38 14 (:REWRITE SET::UNION-EMPTYP-X))
 (30 10 (:REWRITE SET::TAIL-WHEN-EMPTYP))
 (30 10 (:REWRITE SET::NEVER-IN-EMPTY))
 )
