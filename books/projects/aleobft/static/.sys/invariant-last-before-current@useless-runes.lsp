(ALEOBFT-STATIC::SYSTEM-LAST-BEFORE-CURRENT-P)
(ALEOBFT-STATIC::SYSTEM-LAST-BEFORE-CURRENT-P-NECC)
(ALEOBFT-STATIC::BOOLEANP-OF-SYSTEM-LAST-BEFORE-CURRENT-P)
(ALEOBFT-STATIC::SYSTEM-LAST-BEFORE-CURRENT-P
...
(ALEOBFT-STATIC::SYSTEM-LAST-BEFORE-CURRENT-P-WHEN-SYSTEM-STATE-INITP
...
(ALEOBFT-STATIC::SYSTEM-LAST-BEFORE-CURRENT-P-OF-CREATE-CERTIFICATE-NEXT
 ...
 (6 2 (:REWRITE ALEOBFT-STATIC::SYSTEM-LAST-BEFORE-CURRENT-P-WHEN-SYSTEM-STATE-INITP))
...
(ALEOBFT-STATIC::SYSTEM-LAST-BEFORE-CURRENT-P-OF-RECEIVE-CERTIFICATE-NEXT
 (10 10 (:TYPE-PRESCRIPTION ALEOBFT-STATIC::SYSTEM-STATE-INITP))
 (10 4 (:REWRITE ALEOBFT-STATIC::VALIDATOR-INIT-WHEN-SYSTEM-INITP))
 (8 2 (:REWRITE SET::IN-TAIL))
 (6 2 (:REWRITE ALEOBFT-STATIC::SYSTEM-LAST-BEFORE-CURRENT-P-WHEN-SYSTEM-STATE-INITP))
...
(ALEOBFT-STATIC::SYSTEM-LAST-BEFORE-CURRENT-P-OF-STORE-CERTIFICATE-NEXT
 (35 13 (:REWRITE ALEOBFT-STATIC::VALIDATOR-INIT-WHEN-SYSTEM-INITP))
 ...
 (18 6 (:REWRITE ALEOBFT-STATIC::SYSTEM-LAST-BEFORE-CURRENT-P-WHEN-SYSTEM-STATE-INITP))
...
(ALEOBFT-STATIC::SYSTEM-LAST-BEFORE-CURRENT-P-OF-ADVANCE-ROUND-NEXT
 (33 13 (:REWRITE ALEOBFT-STATIC::VALIDATOR-INIT-WHEN-SYSTEM-INITP))
...
(ALEOBFT-STATIC::SYSTEM-LAST-BEFORE-CURRENT-P-OF-COMMIT-ANCHORS-NEXT
 (27 11 (:REWRITE ALEOBFT-STATIC::VALIDATOR-INIT-WHEN-SYSTEM-INITP))
 ...
 (12 4 (:REWRITE ALEOBFT-STATIC::SYSTEM-LAST-BEFORE-CURRENT-P-WHEN-SYSTEM-STATE-INITP))
 (9 3 (:REWRITE SET::TAIL-WHEN-EMPTYP))
 (9 3 (:REWRITE SET::NEVER-IN-EMPTY))
 (6 6 (:TYPE-PRESCRIPTION ALEOBFT-STATIC::GET-VALIDATOR-STATE))
 )
(ALEOBFT-STATIC::SYSTEM-LAST-BEFORE-CURRENT-P-OF-TIMER-EXPIRES-NEXT
 (10 10 (:TYPE-PRESCRIPTION ALEOBFT-STATIC::SYSTEM-STATE-INITP))
 (10 4 (:REWRITE ALEOBFT-STATIC::VALIDATOR-INIT-WHEN-SYSTEM-INITP))
 (8 2 (:REWRITE SET::IN-TAIL))
 (6 2 (:REWRITE ALEOBFT-STATIC::SYSTEM-LAST-BEFORE-CURRENT-P-WHEN-SYSTEM-STATE-INITP))
...
(ALEOBFT-STATIC::SYSTEM-LAST-BEFORE-CURRENT-P-OF-EVENT-NEXT
 (3 1 (:REWRITE ALEOBFT-STATIC::SYSTEM-LAST-BEFORE-CURRENT-P-WHEN-SYSTEM-STATE-INITP))
