...
(defsection signed-previous-quorum-p-of-next
  ...
  (defruled validator-signed-previous-quorum-p-of-receive-next
  ...
  (defruled signed-previous-quorum-p-of-receive-next
    (implies (and (signed-previous-quorum-p systate)
                  (receive-possiblep msg systate))
             (signed-previous-quorum-p (receive-next msg systate)))
    :enable (signed-previous-quorum-p
             signed-previous-quorum-p-necc
             signed-certs-of-receive-next
             validator-signed-previous-quorum-p-of-receive-next))

  ;; store:

  (defruled validator-signed-previous-quorum-p-of-store-next
    (implies (and (validator-signed-previous-quorum-p
                   cert1
  ...
  (defruled signed-previous-quorum-p-of-store-next
    (implies (and (signed-previous-quorum-p systate)
                  (store-possiblep val cert systate))
             (signed-previous-quorum-p (store-next val cert systate)))
    :enable (signed-previous-quorum-p
             signed-previous-quorum-p-necc
             signed-certs-of-store-next
             validator-signed-previous-quorum-p-of-store-next))
  ...
  (defruled validator-signed-previous-quorum-p-of-timeout-next
    (implies (and (validator-signed-previous-quorum-p
                   cert
                   (get-validator-state val1 systate))
  ...
  (defruled signed-previous-quorum-p-of-timeout-next
    (implies (and (signed-previous-quorum-p systate)
                  (timeout-possiblep val systate))
             (signed-previous-quorum-p (timeout-next val systate)))
    :enable (signed-previous-quorum-p
             signed-previous-quorum-p-necc
             signed-certs-of-timeout-next
             validator-signed-previous-quorum-p-of-timeout-next))
