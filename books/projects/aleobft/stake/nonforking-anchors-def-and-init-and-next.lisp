...
(defsection nonforking-anchors-p-of-next
  ...
  (defruled nonforking-anchors-p-of-receive-next
    (implies (and (nonforking-anchors-p systate)
                  (receive-possiblep msg systate))
             (nonforking-anchors-p (receive-next msg systate)))
    :enable (nonforking-anchors-p
             nonforking-anchors-p-necc))

  ;; store:

  (defruled nonforking-anchors-p-of-store-next
    (implies (and (nonforking-anchors-p systate)
                  (system-committees-fault-tolerant-p systate)
                  (backward-closed-p systate)
                  (same-associated-certs-p systate)
                  ...
                  (addressp val)
                  (certificatep cert))
             (nonforking-anchors-p (store-next val cert systate)))
    :enable (nonforking-anchors-p
             nonforking-anchors-p-necc))
  ...
  (defruled nonforking-anchors-p-of-timer-expired-next
    (implies (and (nonforking-anchors-p systate)
             ...
             (nonforking-anchors-p (timeout-next val systate)))
    :enable (nonforking-anchors-p
             nonforking-anchors-p-necc))
