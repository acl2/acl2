...
(defsection blockchain-redundant-p-of-next
  ...
  (defruled validator-blockchain-redundant-p-of-receive-next
  ...
  (defruled blockchain-redundant-p-of-receive-next
    (implies (and (blockchain-redundant-p systate)
                  (receive-possiblep msg systate))
             (blockchain-redundant-p (receive-next msg systate)))
    :enable (blockchain-redundant-p
             blockchain-redundant-p-necc
             validator-blockchain-redundant-p-of-receive-next))

  ;; store:

  (defruled validator-blockchain-redundant-p-of-store-next
    (implies (and (system-committees-fault-tolerant-p systate)
                  (backward-closed-p systate)
                  (same-associated-certs-p systate)
                  (dag-committees-p systate)
                  ...
                  (validator-blockchain-redundant-p
                   (get-validator-state val systate)))
             (validator-blockchain-redundant-p
              (get-validator-state val (store-next val1 cert systate))))
    :enable (validator-blockchain-redundant-p
             validator-state->dag-of-store-next
             unequivocal-dags-p-of-store-next
             list-in-when-certificates-dag-paths-p
             certificates-dag-paths-p-of-committed-anchors
             last-anchor-present-p-necc
             last-anchor-in-dag
    ...
    :use ((:instance calculate-blockchain-of-unequivocal-superdag
                     ...
                     (dag (validator-state->dag
                           (get-validator-state
                            val1 (store-next val1 cert systate))))
                     (anchors (committed-anchors
                               (get-validator-state val1 systate))))
          (:instance unequivocal-dags-p-necc-single
                     (val val1)
                     (systate (store-next val1 cert systate)))))

  (defruled blockchain-redundant-p-of-store-next
    (implies (and (blockchain-redundant-p systate)
                  (system-committees-fault-tolerant-p systate)
                  (backward-closed-p systate)
                  (same-associated-certs-p systate)
                  ...
                  (addressp val1)
                  (certificatep cert))
             (blockchain-redundant-p (store-next val1 cert systate)))
    :enable (blockchain-redundant-p
             blockchain-redundant-p-necc
             validator-blockchain-redundant-p-of-store-next))
  ...
  (defruled validator-blockchain-redundant-p-of-timeout-next
    (implies (and (set::in val (correct-addresses systate))
                  (timeout-possiblep val1 systate)
                  (validator-blockchain-redundant-p
                   (get-validator-state val systate)))
             (validator-blockchain-redundant-p
              (get-validator-state val (timeout-next val1 systate))))
    :enable validator-blockchain-redundant-p)

  (defruled blockchain-redundant-p-of-timeout-next
    (implies (and (blockchain-redundant-p systate)
                  (timeout-possiblep val systate))
             (blockchain-redundant-p (timeout-next val systate)))
    :enable (blockchain-redundant-p
             blockchain-redundant-p-necc
             validator-blockchain-redundant-p-of-timeout-next))
