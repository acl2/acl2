...
(defsection no-self-endorsed-p-of-next
  ...
  (defruled no-self-endorsed-p-of-receive-next
    (implies (and (no-self-endorsed-p systate)
                  (receive-possiblep msg systate))
             (no-self-endorsed-p (receive-next msg systate)))
    :enable (no-self-endorsed-p
             no-self-endorsed-p-necc))

  (defruled no-self-endorsed-p-of-store-next
    (implies (and (no-self-endorsed-p systate)
                  (store-possiblep val cert systate))
             (no-self-endorsed-p (store-next val cert systate)))
    :enable (no-self-endorsed-p
             no-self-endorsed-p-necc-fixing
  ...
  (defruled no-self-endorsed-p-of-timeout-next
    (implies (and (no-self-endorsed-p systate)
                  (timeout-possiblep val systate))
             (no-self-endorsed-p (timeout-next val systate)))
    :enable (no-self-endorsed-p
             no-self-endorsed-p-necc))
