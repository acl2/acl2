...
(SB::INV)
(SB::STEP-INV
 (137 5 (:REWRITE SB::SB-LATEST-NO-PENDING-2))
 (74 4 (:REWRITE SB::NO-PENDING-WHEN-NOT-CONSP))
 (66 3 (:REWRITE SB::SB-LATEST-IMPLIES-NOT-EMPTY))
 (50 11 (:REWRITE SB::SB-LATEST-SB-NEXT-FLUSH))
 (42 2 (:REWRITE SB::NO-PENDING-SB-SB-LATEST))
 (39 10 (:REWRITE SB::SB-LATEST-SB-DEQ-3))
 (39 10 (:REWRITE SB::NO-PENDING-SB-SB-NEXT-DEQ))
 (19 3 (:REWRITE SB::NO-PENDING-SB-NOT-CONSP))
 (18 18 (:TYPE-PRESCRIPTION SB::SB-P))
 (18 18 (:REWRITE SB::SB-P-OF-PROC->SB))
 (15 3 (:REWRITE SB::NO-PENDING-SB-SB-LATEST-2))
...
(SB::INV-PC-1)
(SB::STUPID-CORRECT
 (45 1 (:REWRITE SB::READ-SB-NO-PENDING-2))
 (37 3 (:REWRITE SB::PROC-NUM-<-LEN-NUM-PROCS))
 (25 1 (:DEFINITION LEN))
 (18 3 (:REWRITE SB::SB-LATEST-IMPLIES-NOT-EMPTY))
 ...
 (11 1 (:REWRITE SB::NO-PENDING-WHEN-NOT-CONSP))
 (9 2 (:REWRITE SB::SB-P-WHEN-NOT-CONSP))
 (8 4 (:REWRITE DEFAULT-<-2))
 (6 3 (:REWRITE SB::LEN-CONSP))
 (6 1 (:REWRITE SB::ORACLE-P-WHEN-NOT-CONSP))
 (5 5 (:TYPE-PRESCRIPTION SB::SB-P))
 (4 4 (:REWRITE DEFAULT-<-1))
 (3 3 (:TYPE-PRESCRIPTION SB::MACHINE-P))
 (2 1 (:REWRITE SB::PROC-NUM-<-NUM-PROCS-LEN))
