...
(SB::INV)
(SB::STEP-GHOST-V0 (11 3 (:REWRITE SB::LOCKP-IS-INTEGERP))
...
(SB::STEP-GHOST-V1 (11 3 (:REWRITE SB::LOCKP-IS-INTEGERP))
                   (7 1 (:REWRITE SB::LOCK-IF-NATP))
                   (4 4 (:TYPE-PRESCRIPTION SB::LOCKP))
                   (2 2 (:REWRITE DEFAULT-<-2))
                   (2 2 (:REWRITE DEFAULT-<-1))
...
(SB::INV-STARTING-STATE (242 4
                        ...
                        (4 4
                           (:REWRITE SB::CONSP-WHEN-NOT-NO-PENDING)))
(SB::RUN-WITH-GHOST (92 46 (:REWRITE DEFAULT-<-1))
                    (75 9
...
(SB::BOOLEANP-OF-RUN-WITH-GHOST.FINAL-V1
     ...
     (20 5 (:REWRITE SB::SB-P-OF-CDR-WHEN-SB-P))
     (10 10 (:REWRITE DEFAULT-CDR)))
(SB::RUN-INV (925 37 (:DEFINITION LEN))
             (693 117
                  (:REWRITE SB::SB-LATEST-IMPLIES-NOT-EMPTY))
             (444 444
