...
(SB::INV)
(SB::STEP-GHOST (489 60 (:REWRITE SB::LEN-CONSP))
...
(SB::INV-STARTING-STATE (242 4
                        ...
                        (4 4
                           (:REWRITE SB::CONSP-WHEN-NOT-NO-PENDING)))
(SB::RUN-WITH-GHOST (84 42 (:REWRITE DEFAULT-<-1))
                    (75 9
...
(SB::GHOST-STATE-P-OF-RUN-WITH-GHOST.FINAL-GHOST
     ...
     (21 21 (:REWRITE DEFAULT-<-2))
     (20 5 (:REWRITE SB::SB-P-OF-CDR-WHEN-SB-P)))
(SB::RUN-INV (309 69 (:REWRITE SB::LEN-CONSP))
             (274 69
                  (:REWRITE SB::SB-LATEST-IMPLIES-NOT-EMPTY))
             (248 8
                  (:REWRITE SB::GHOST-STATE-P-WHEN-NOT-CONSP))
