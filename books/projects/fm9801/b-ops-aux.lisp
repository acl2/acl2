...
;; Logbitp is not enabled by default in v2.3, but it is in v2.4. 
;; This in-theory event preserves the compatibility.
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; Theories used for the proof using BDD.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defthm mod-x-y-=-minus-x-y
 (implies (and (integerp x) (integerp y) (< 0 y)
	       (<= y x) (< x (* 2 y)))
	  (equal (mod x y) (- x y)))
 :Hints (; Matt K. mod: avoid disabling rune that no longer exists
         ;; ("goal" :in-theory (disable (:generalize floor-bounds)))
	 ("subgoal 1" :cases ((<= j 1)))))
)
