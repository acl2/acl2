...
(MODAPP::EV$-DEF-FACT (57879 27 (:DEFINITION MODAPP::APPLY$-USERFN))
                      (57852 27 (:DEFINITION MODAPP::APPLY$-USERFN!))
                      (57825 27
...
(MODAPP::EV$-DEF)
(MODAPP::EV$-OPENER (8544 2 (:DEFINITION MODAPP::APPLY$))
                    (7556 2 (:DEFINITION MODAPP::APPLY$-USERFN))
                    (7554 2 (:DEFINITION MODAPP::APPLY$-USERFN!))
                    (7552 2 (:DEFINITION MODAPP::APPLY$-USERFN1!))
                    ...
                    (1538 94 (:DEFINITION MODAPP::UNTAME-APPLY$!))
                    (1440 94 (:DEFINITION TAKE))
                    ...
                    (100 100 (:TYPE-PRESCRIPTION MODAPP::TAMEP!))
...
(MODAPP::APPLY$-SUITABLY-TAMEP-LISTP
     ...
     (1 1
        (:TYPE-PRESCRIPTION MODAPP::APPLY$-PRIMP)))
(MODAPP::APPLY$-APPLY$ (6710 2 (:DEFINITION MODAPP::APPLY$-USERFN))
                       (6708 2 (:DEFINITION MODAPP::APPLY$-USERFN!))
                       (6706 2 (:DEFINITION MODAPP::APPLY$-USERFN1!))
                       (3226 734 (:REWRITE O-P-O-INFP-CAR))
                       (2633 2019 (:REWRITE DEFAULT-CDR))
                       (2604 84
                             (:DEFINITION MODAPP::TAMEP-FUNCTIONP!))
                       (2436 1030 (:REWRITE DEFAULT-CAR))
                       (1656 94 (:DEFINITION MODAPP::UNTAME-APPLY$!))
                       (1558 94 (:DEFINITION TAKE))
