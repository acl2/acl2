...
(MODAPP::FILTER-V-ALL (1047 13 (:REWRITE MODAPP::TAMEP-IMPLICANT-1))
...
(MODAPP::REV-REV-VERSION-2 (6520 76 (:REWRITE MODAPP::TAMEP-IMPLICANT-1))
                           ...
                           (22 22
                               (:REWRITE MODAPP::APPLY$-WARRANT-FOLDR-NECC)))
(MODAPP::REV-REV-VERSION-3 (8703 101
...
(MODAPP::GENERAL-COLLECT-IS-A-FOLDR (161 160 (:REWRITE DEFAULT-CDR))
                                    ...
                                    (4 4 (:REWRITE DEFAULT-COERCE-2))
                                    (4 4 (:REWRITE DEFAULT-COERCE-1)))
(MODAPP::FOLDR-AS-COLLECT (146 145 (:REWRITE DEFAULT-CDR))
                          ...
                          (4 4 (:REWRITE DEFAULT-COERCE-2))
                          (4 4 (:REWRITE DEFAULT-COERCE-1)))
(MODAPP::FOLDR-AS-SUMLIST (146 145 (:REWRITE DEFAULT-CDR))
                          (130 129 (:REWRITE DEFAULT-CAR))
                          (68 4 (:DEFINITION LENGTH))
                          (56 8 (:DEFINITION LEN))
                          ...
                          (4 4 (:REWRITE DEFAULT-COERCE-2))
                          (4 4 (:REWRITE DEFAULT-COERCE-1)))
(MODAPP::FOLDR-AS-FILTER (186 184 (:REWRITE DEFAULT-CDR))
...
(MODAPP::FOLDR-AS-ALL (159 158 (:REWRITE DEFAULT-CDR))
                      ...
                      (5 5 (:REWRITE DEFAULT-COERCE-2))
                      (5 5 (:REWRITE DEFAULT-COERCE-1)))
(MODAPP::FOLDR-AS-XISTS (159 158 (:REWRITE DEFAULT-CDR))
                        (126 125 (:REWRITE DEFAULT-CAR))
                        (85 5 (:DEFINITION LENGTH))
                        (70 10 (:DEFINITION LEN))
                        (42 14 (:REWRITE MODAPP::APPLY$-PRIMITIVE))
                        ...
                        (5 5 (:REWRITE DEFAULT-COERCE-2))
                        (5 5 (:REWRITE DEFAULT-COERCE-1)))
(MODAPP::MAXLIST-NON-NIL (504 7 (:DEFINITION MODAPP::TAMEP))
...
(MODAPP::FOLDR-AS-MAXLIST (1145 1142 (:REWRITE DEFAULT-CDR))
