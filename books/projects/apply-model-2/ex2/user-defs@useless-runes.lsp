...
(MODAPP::APPLY$-OK-FNP (62 48 (:REWRITE DEFAULT-CDR))
...
(MODAPP::APPLY$-COLLECT (352 4 (:DEFINITION MODAPP::TAMEP))
...
(MODAPP::APPLY$-FILTER (352 4 (:DEFINITION MODAPP::TAMEP))
...
(MODAPP::APPLY$-ALL (352 4 (:DEFINITION MODAPP::TAMEP))
                    (273 224 (:REWRITE DEFAULT-CDR))
                    (162 36 (:REWRITE O-P-O-INFP-CAR))
                    (117 109 (:REWRITE DEFAULT-CAR))
                    (77 11 (:DEFINITION SYMBOL-LISTP))
...
(MODAPP::APPLY$-XISTS (352 4 (:DEFINITION MODAPP::TAMEP))
                      (273 224 (:REWRITE DEFAULT-CDR))
                      (162 36 (:REWRITE O-P-O-INFP-CAR))
                      (117 109 (:REWRITE DEFAULT-CAR))
                      (77 11 (:DEFINITION SYMBOL-LISTP))
...
(MODAPP::APPLY$-MAXLIST (704 8 (:DEFINITION MODAPP::TAMEP))
...
(MODAPP::APPLY$-APPLY$2 (360 4 (:DEFINITION MODAPP::TAMEP))
...
(MODAPP::APPLY$-RUSSELL (540 6 (:DEFINITION MODAPP::TAMEP))
...
(MODAPP::APPLY$-FOLDL (352 4 (:DEFINITION MODAPP::TAMEP))
                      (279 230 (:REWRITE DEFAULT-CDR))
                      (162 36 (:REWRITE O-P-O-INFP-CAR))
                      (125 117 (:REWRITE DEFAULT-CAR))
                      (77 11 (:DEFINITION SYMBOL-LISTP))
...
(MODAPP::APPLY$-COLLECT-FROM-TO
     (646 6
          (:REWRITE MODAPP::APPLY$-BADGEP-PROPERTIES . 1))
     (642 2 (:DEFINITION MODAPP::APPLY$-BADGEP))
     (400 4 (:REWRITE MODAPP::TAMEP-IMPLICANT-1))
     (392 8 (:DEFINITION MODAPP::TAMEP))
...
(MODAPP::APPLY$-RECUR-BY-COLLECT
     (932 2 (:DEFINITION MODAPP::COLLECT))
...
(MODAPP::APPLY$-FN-5 (1056 12 (:DEFINITION MODAPP::TAMEP))
...
(MODAPP::APPLY$-MAP-FN-5
     (1040 12 (:DEFINITION MODAPP::TAMEP))
...
(MODAPP::APPLY$-SUMLIST-EXPR (113 92 (:REWRITE DEFAULT-CDR))
...
(MODAPP::APPLY$-TWOFER (408 335 (:REWRITE DEFAULT-CDR))
...
(MODAPP::APPLY$-COLLECT-E
     (2438 2 (:DEFINITION MODAPP::COLLECT-D))
     (2108 14 (:DEFINITION MODAPP::TAMEP))
...
(MODAPP::APPLY$-COLLECT-MY-REV (12 2 (:REWRITE O-P-O-INFP-CAR))
                               (6 3 (:REWRITE MODAPP::APPLY$-PRIMITIVE))
                               (6 2 (:REWRITE O-P-DEF-O-FINP-1))
                               (4 4 (:TYPE-PRESCRIPTION O-P))
                               (4 4 (:TYPE-PRESCRIPTION O-FINP))
