...
(RIGHT-LT)
(IS-EMPTY-LT)
(PROPER-LT (730 323 (:REWRITE DEFAULT-+-2))
...
(MAKE-LT)
(MERGE-LT (3226 1337 (:REWRITE DEFAULT-+-2))
...
(INSERT-LT)
(FIND-MIN-LT)
(DELETE-MIN-LT (5 5 (:TYPE-PRESCRIPTION MERGE-LT)))
(BUILD-LT)
(SIZE-LT (730 323 (:REWRITE DEFAULT-+-2))
         (449 323 (:REWRITE DEFAULT-+-1))
         (248 62 (:REWRITE COMMUTATIVITY-OF-+))
         (248 62 (:DEFINITION INTEGER-ABS))
         (248 31 (:DEFINITION LENGTH))
         ...
         (31 31 (:REWRITE DEFAULT-COERCE-2))
         (31 31 (:REWRITE DEFAULT-COERCE-1)))
(MEMBER-LT (730 323 (:REWRITE DEFAULT-+-2))
           (449 323 (:REWRITE DEFAULT-+-1))
           (248 62 (:REWRITE COMMUTATIVITY-OF-+))
           (248 62 (:DEFINITION INTEGER-ABS))
           (248 31 (:DEFINITION LENGTH))
...
(LENGTH-RIGHT-SPINE-LT (436 190 (:REWRITE DEFAULT-+-2))
...
(LENGTH-TO-NIL-LT (730 323 (:REWRITE DEFAULT-+-2))
                  (449 323 (:REWRITE DEFAULT-+-1))
                  (248 62 (:REWRITE COMMUTATIVITY-OF-+))
                  (248 62 (:DEFINITION INTEGER-ABS))
                  (248 31 (:DEFINITION LENGTH))
