...
(MILAWA::FAST-STRIP-THIRDS$
     ...
     (1 1
        (:REWRITE MILAWA::<-WHEN-MEMBERP-OF-ALL-AT-LEASTP)))
(MILAWA::STRIP-THIRDS-WHEN-NOT-CONSP
     (6 1
        (:REWRITE MILAWA::CONSP-WHEN-NATP-CHEAP))
     (3 1
        (:REWRITE MILAWA::CONSP-WHEN-TRUE-LISTP-CHEAP))
     ...
     (1 1
        (:REWRITE MILAWA::CONSP-WHEN-MEMBERP-CHEAP)))
(MILAWA::STRIP-THIRDS-OF-CONS
 (77 12
     (:REWRITE MILAWA::CDR-WHEN-NOT-CONSP))
 (73 6
     (:REWRITE MILAWA::STRIP-THIRDS-WHEN-NOT-CONSP))
 (62 7 (:REWRITE MILAWA::CAR-WHEN-NOT-CONSP))
 (47 22
     (:REWRITE MILAWA::CONSP-WHEN-NATP-CHEAP))
 (34 22
     (:REWRITE MILAWA::CONSP-WHEN-TRUE-LISTP-CHEAP))
 ...
 (2 2 (:REWRITE MILAWA::TRUE-LISTP-OF-CDR)))
(MILAWA::TRUE-LISTP-OF-STRIP-THIRDS
     (131 31
          (:REWRITE MILAWA::TRUE-LISTP-WHEN-NOT-CONSP))
     (130 25
          (:REWRITE MILAWA::CONSP-WHEN-NATP-CHEAP))
...
(MILAWA::LEN-OF-STRIP-THIRDS
     ...
     (11 11
         (:REWRITE MILAWA::NATP-WHEN-NOT-ZP-CHEAP))
     (10 10
         (:REWRITE MILAWA::TRUE-LISTP-OF-STRIP-THIRDS))
     (9 9
        (:REWRITE MILAWA::PREFIXP-WHEN-NOT-CONSP-TWO))
     (9 9
        (:REWRITE MILAWA::PREFIXP-WHEN-NOT-CONSP-ONE))
...
(MILAWA::CAR-OF-STRIP-THIRDS
 ...
 (25 25
     (:REWRITE MILAWA::CONSP-WHEN-MEMBERP-CHEAP))
 (20 4
     (:REWRITE MILAWA::CONSP-OF-STRIP-THIRDS))
 (16 4
     (:REWRITE MILAWA::SAME-LENGTH-PREFIXES-EQUAL-CHEAP))
 (13 13
     (:REWRITE MILAWA::CAR-WHEN-MEMBERP-OF-SINGLETON-LIST-CHEAP))
...
(MILAWA::STRIP-THIRDS-UNDER-IFF
     ...
     (12 12
         (:REWRITE MILAWA::CONSP-OF-CDR-WHEN-LEN-TWO-CHEAP)))
(MILAWA::STRIP-THIRDS-OF-LIST-FIX
 (119 11
 ...
 (13 2 (:REWRITE MILAWA::CAR-WHEN-NOT-CONSP))
 (12 12
     (:REWRITE MILAWA::CDR-WHEN-TRUE-LISTP-WITH-LEN-FREE-PAST-THE-END))
 (11 11
     (:REWRITE MILAWA::NATP-WHEN-ZP-CHEAP))
...
(MILAWA::FIRSTN-OF-STRIP-THIRDS
 ...
 (74 74
     (:REWRITE MILAWA::EQUAL-WHEN-MEMBERP-OF-ALL-EQUALP))
 (74 7
     (:REWRITE MILAWA::LEN-OF-STRIP-THIRDS))
 (65 10
...
(MILAWA::RESTN-OF-STRIP-THIRDS
 ...
 (2
   2
   (:REWRITE MILAWA::CDR-OF-CDR-WHEN-TRUE-LISTP-WITH-LEN-FREE-PAST-THE-END)))
(MILAWA::REV-OF-STRIP-THIRDS)
(MILAWA::MEMBERP-OF-THIRD-IN-STRIP-THIRDS-WHEN-MEMBERP
 (756 44
 ...
 (428 38
      (:REWRITE MILAWA::STRIP-THIRDS-WHEN-NOT-CONSP))
 (320 12 (:REWRITE MILAWA::SUBSETP-OF-CONS))
 (290 45
...
(MILAWA::SUBSETP-OF-STRIP-THIRDSS-WHEN-SUBSETP
 (221 26
      (:REWRITE MILAWA::SUBSETP-WHEN-NOT-CONSP-TWO))
 (188 29
      (:REWRITE MILAWA::CONSP-OF-STRIP-THIRDS))
 ...
 (28 28 (:REWRITE MILAWA::NATP-OF-LEN-FREE))
 (25 1
     (:REWRITE MILAWA::CDR-OF-STRIP-THIRDS))
 (24 2
     (:REWRITE MILAWA::SAME-LENGTH-PREFIXES-EQUAL-CHEAP))
 (19 19
     (:REWRITE MILAWA::CONSP-OF-CDR-WITH-LEN-FREE))
 ...
 (12 1
     (:REWRITE MILAWA::MEMBERP-WHEN-NOT-CONSP))
 (12 1 (:REWRITE MILAWA::CAR-WHEN-NOT-CONSP))
 (11 11 (:REWRITE MILAWA::TRUE-LISTP-OF-CDR))
 (10 10
     (:REWRITE MILAWA::CDR-WHEN-TRUE-LISTP-WITH-LEN-FREE-PAST-THE-END))
 (9 7
...
(MILAWA::NTH-OF-STRIP-THIRDS
 ...
 (1 1
    (:REWRITE MILAWA::<-OF-CAR-WHEN-ALL-AT-LEASTP)))
(MILAWA::FAST-STRIP-THIRDS$-REMOVAL
 (893 300
      (:REWRITE MILAWA::CONSP-WHEN-TRUE-LISTP-CHEAP))
 (541 226
      (:REWRITE MILAWA::CONSP-WHEN-NATP-CHEAP))
 ...
 (300 300
      (:REWRITE MILAWA::CONSP-WHEN-MEMBERP-CHEAP))
 (240 46 (:REWRITE MILAWA::REV-UNDER-IFF))
 (228 78
      (:REWRITE MILAWA::TRUE-LISTP-WHEN-NOT-CONSP))
 (124 124
      (:REWRITE MILAWA::TRUE-LISTP-WHEN-TUPLEP))
 ...
 (52 13
     (:REWRITE MILAWA::APP-OF-CONS-WHEN-NOT-CONSP-RIGHT))
 (46 46 (:REWRITE MILAWA::TRUE-LISTP-OF-REV))
 (42 42
     (:REWRITE MILAWA::CDR-OF-CDR-WITH-LEN-FREE-PAST-THE-END))
 (42
    42
...
(MILAWA::RANK-OF-STRIP-THIRDS-WEAK
