...
(EXLD::!ELF-!ELF-INTRA-FIELD-ARRANGE-WRITES
 (40 40 (:TYPE-PRESCRIPTION EXLD::ELF-ELEM-FIX))
 (24 6 (:REWRITE EXLD::ELF-ELEM-FIX-WHEN-ELF-ELEM-P))
 (12 12 (:TYPE-PRESCRIPTION EXLD::ELF-ELEM-P))
 (8 3 (:REWRITE EXLD::ELFREC-SET-OF-ELFREC-SET-DIFF))
