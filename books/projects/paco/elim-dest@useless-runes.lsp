...
(PACO::GENERATE-VARIABLE-ROOT (138 70 (:REWRITE DEFAULT-+-2))
...
(PACO::FIND-FIRST-VAR)
(PACO::FIND-FIRST-FNSYMB (130 64 (:REWRITE DEFAULT-+-2))
...
(PACO::SECOND-NOMINATION (2 2
                            (:TYPE-PRESCRIPTION PACO::UNION-EQUAL)))
(PACO::SOME-HYP-PROBABLY-NILP)
(PACO::SUBLIS-EXPR)
(PACO::ACL2-COUNT-NTH (182 90 (:REWRITE DEFAULT-+-2))
                      ...
                      (14 1
                          (:LINEAR PACO::TYPE-SET-ADMISSION-LEMMA2))
...
(PACO::NOMINATE-DESTRUCTOR-CANDIDATES
     (6 6
        (:TYPE-PRESCRIPTION PACO::NOMINATE-DESTRUCTOR-CANDIDATE)))
(PACO::MAX-LEVEL-NO (67 2 (:DEFINITION ACL2-COUNT))
...
(PACO::CONVERT-TYPE-SET-TO-TERM-LST
     (3 3
        (:TYPE-PRESCRIPTION PACO::ADD-TO-SET-EQUAL)))
(PACO::CONVERT-TYPE-SET-TO-TERM)
(PACO::TYPE-RESTRICTION-SEGMENT)
(PACO::SUBTERM-ONE-WAY-UNIFY)
(PACO::APPLY-GENERALIZE-RULE (1 1
                                (:TYPE-PRESCRIPTION PACO::SUBST-EXPR)))
