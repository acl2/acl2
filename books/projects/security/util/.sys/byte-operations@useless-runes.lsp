...
(NOT-NOT-BIT-LIST
 (2432 258 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
 (2340 452 (:REWRITE ACL2-NUMBERP-X))
 (944 226 (:REWRITE RATIONALP-X))
 (544 258 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
...
(AND-BIT-LIST-CORRECT
 (15224 1647 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
 (14920 2984 (:REWRITE ACL2-NUMBERP-X))
 (6092 123 (:REWRITE AND-BIT-CORRECT))
 (5968 1492 (:REWRITE RATIONALP-X))
 (3450 66 (:DEFINITION AND-BIT))
 (3288 1647 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
 (1796 1647 (:REWRITE SIMPLIFY-SUMS-EQUAL))
 (1754 1648 (:REWRITE DEFAULT-CAR))
 (1647 1647 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-EQUAL))
 (1647 1647 (:REWRITE REDUCE-ADDITIVE-CONSTANT-EQUAL))
 (1647 1647 (:REWRITE EQUAL-OF-PREDICATES-REWRITE))
 (1647 1647 (:REWRITE |(equal c (/ x))|))
 (1647 1647 (:REWRITE |(equal c (- x))|))
 (1647 1647 (:REWRITE |(equal (/ x) c)|))
 (1647 1647 (:REWRITE |(equal (/ x) (/ y))|))
 (1647 1647 (:REWRITE |(equal (- x) c)|))
 (1647 1647 (:REWRITE |(equal (- x) (- y))|))
 (1615 1509 (:REWRITE DEFAULT-CDR))
 (1492 1492 (:REWRITE REDUCE-RATIONALP-+))
 (1492 1492 (:REWRITE REDUCE-RATIONALP-*))
 (1492 1492 (:REWRITE REDUCE-INTEGERP-+))
 (1492 1492 (:REWRITE RATIONALP-MINUS-X))
 (1492 1492 (:REWRITE INTEGERP-MINUS-X))
 (1492 1492 (:META META-RATIONALP-CORRECT))
 (1492 1492 (:META META-INTEGERP-CORRECT))
 (746 746 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-=-0))
