...
(RTL::QUOT-EXACT-1
 (49084 28 (:REWRITE |(<= x (/ y)) with (< 0 y)|))
 (48352 40 (:REWRITE |(< (/ x) y) with (< 0 x)|))
 (37678 282 (:REWRITE |(< x (+ c/d y))|))
 (18231 1363 (:REWRITE DEFAULT-PLUS-2))
 (13458 1136 (:REWRITE DEFAULT-TIMES-2))
 (10817 10817 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-NONPOSITIVE-BASE-EVEN-EXPONENT))
 (10817 10817 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-NEGATIVE-BASE-ODD-EXPONENT))
 (10817 10817 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-NEGATIVE-BASE-EVEN-EXPONENT))
 (10817 10817 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-INTEGERP-BASE-B))
