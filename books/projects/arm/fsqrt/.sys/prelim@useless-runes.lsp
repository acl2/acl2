...
(RTL::FSQRT64-LOOP-0-LEMMA
 (39496 4420 (:REWRITE ACL2-NUMBERP-X))
 (21616 21616 (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
 (17538 4377 (:REWRITE RATIONALP-X))
 (6779 4572 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
 (5379 4572 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
 (4774 4774 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-EQUAL))
 (4696 4572 (:REWRITE SIMPLIFY-SUMS-EQUAL))
 (4588 4580 (:REWRITE |(equal (/ x) (/ y))|))
 (4580 4580 (:REWRITE |(equal c (/ x))|))
 (4580 4580 (:REWRITE |(equal (- x) (- y))|))
 (4572 4572 (:REWRITE EQUAL-OF-PREDICATES-REWRITE))
 (4572 4572 (:REWRITE |(equal c (- x))|))
 (4572 4572 (:REWRITE |(equal (- x) c)|))
 (4551 4551 (:REWRITE REDUCE-INTEGERP-+))
 (4551 4551 (:REWRITE INTEGERP-MINUS-X))
 (4551 4551 (:META META-INTEGERP-CORRECT))
 (4377 4377 (:REWRITE REDUCE-RATIONALP-+))
 (4377 4377 (:REWRITE REDUCE-RATIONALP-*))
 (4377 4377 (:REWRITE RATIONALP-MINUS-X))
 (4377 4377 (:META META-RATIONALP-CORRECT))
 (2599 2599 (:REWRITE |(equal (+ (- c) x) y)|))
 (2564 2466 (:REWRITE DEFAULT-LESS-THAN-2))
 (2511 2466 (:REWRITE DEFAULT-LESS-THAN-1))
 (2466 2466 (:REWRITE THE-FLOOR-BELOW))
 (2466 2466 (:REWRITE THE-FLOOR-ABOVE))
 (2442 2442 (:REWRITE REDUCE-RATIONAL-MULTIPLICATIVE-CONSTANT-<))
 (2442 2442 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-<))
 (2341 2341 (:TYPE-PRESCRIPTION NOT-INTEGERP-3A))
 (2341 2341 (:TYPE-PRESCRIPTION NOT-INTEGERP-2A))
 (2341 2341 (:TYPE-PRESCRIPTION NOT-INTEGERP-1A))
 (2330 2223 (:REWRITE PREFER-POSITIVE-ADDENDS-<))
 (2328 2328 (:REWRITE REMOVE-STRICT-INEQUALITIES))
 ...
 (2049 2049 (:REWRITE |(< x (+ c/d y))|))
 (2011 1046 (:REWRITE DEFAULT-LOGAND-1))
 (1843 1843 (:REWRITE |(< 0 (* x y))|))
 (1835 1827 (:REWRITE |(< 0 (/ x))|))
 (1827 1827 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-REMAINDER))
 (1827 1827 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-COMMON))
 (1624 1046 (:REWRITE DEFAULT-LOGAND-2))
 (1184 1184 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-=-0))
 ...
 (312 24 (:REWRITE |(<= (/ x) y) with (< 0 x)|))
 (226 214 (:TYPE-PRESCRIPTION BUBBLE-DOWN))
 (197 197 (:REWRITE |(< (+ c/d x) y)|))
 (176 176 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-NONPOSITIVE-BASE-ODD-EXPONENT))
 ...
 (40 24 (:REWRITE |(<= (/ x) y) with (< x 0)|))
 (40 24 (:REWRITE |(< x (/ y)) with (< y 0)|))
...
(RTL::Q-N-REWRITE
 ...
 (318 39 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
...
(RTL::QN-N-REWRITE
 (592 80 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
...
(RTL::EXPINC-N-REWRITE
 ...
 (468 54 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
