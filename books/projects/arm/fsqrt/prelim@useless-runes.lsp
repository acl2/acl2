...
(RTL::FSQRT64-LOOP-0-LEMMA
 ...
 (20980 20980 (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
 (16350 4080 (:REWRITE RATIONALP-X))
 (6134 4062 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
 (4839 4062 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
 (4264 4264 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-EQUAL))
 ...
 (4062 4062 (:REWRITE EQUAL-OF-PREDICATES-REWRITE))
 ...
 (2331 2331 (:REWRITE REDUCE-RATIONAL-MULTIPLICATIVE-CONSTANT-<))
 (2331 2331 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-<))
 (2321 2321 (:TYPE-PRESCRIPTION NOT-INTEGERP-3A))
 (2321 2321 (:TYPE-PRESCRIPTION NOT-INTEGERP-2A))
 (2321 2321 (:TYPE-PRESCRIPTION NOT-INTEGERP-1A))
 (2219 2112 (:REWRITE PREFER-POSITIVE-ADDENDS-<))
 (2217 2217 (:REWRITE REMOVE-STRICT-INEQUALITIES))
 (2217 2217 (:REWRITE INTEGERP-<-CONSTANT))
 (2217 2217 (:REWRITE CONSTANT-<-INTEGERP))
 (2217 2217 (:REWRITE |(< c (/ x)) positive c --- present in goal|))
 (2217 2217 (:REWRITE |(< c (/ x)) positive c --- obj t or nil|))
 (2217 2217 (:REWRITE |(< c (/ x)) negative c --- present in goal|))
 (2217 2217 (:REWRITE |(< c (/ x)) negative c --- obj t or nil|))
 (2217 2217 (:REWRITE |(< c (- x))|))
 (2217 2217 (:REWRITE |(< (/ x) c) positive c --- present in goal|))
 (2217 2217 (:REWRITE |(< (/ x) c) positive c --- obj t or nil|))
 (2217 2217 (:REWRITE |(< (/ x) c) negative c --- present in goal|))
 (2217 2217 (:REWRITE |(< (/ x) c) negative c --- obj t or nil|))
 ...
 (1716 1716 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-REMAINDER))
 (1716 1716 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-COMMON))
 (1624 1046 (:REWRITE DEFAULT-LOGAND-2))
 (1168 712 (:REWRITE DEFAULT-TIMES-2))
 (1118 1118 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-=-0))
