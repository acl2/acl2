...
(RTL::D-BOUNDS)
(RTL::NATP-2^PREC-1*X
 (28943 531 (:REWRITE RTL::BITS-TAIL-GEN))
 (16904 13 (:LINEAR RTL::BVECP-BMUX4SIGNED))
 (16632 179 (:REWRITE |(< (if a b c) x)|))
 (13868 1092 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-<))
 (9306 195 (:LINEAR RTL::SIG-LOWER-BOUND))
 (9210 530 (:REWRITE ACL2-NUMBERP-X))
 (7772 32 (:REWRITE RTL::BITS-BVECP))
 (6012 27 (:REWRITE RTL::BVECP-BITN-1))
 (6005 27 (:REWRITE RTL::BVECP-BITN-0))
 (5671 531 (:REWRITE RTL::BITS-NEG-INDICES))
 (4864 1335 (:REWRITE DEFAULT-LESS-THAN-1))
 (4340 344 (:REWRITE RATIONALP-X))
 (4181 51 (:REWRITE |(< x (if a b c))|))
 (3676 1348 (:REWRITE DEFAULT-LESS-THAN-2))
 (3101 715 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
 (2028 39 (:REWRITE |(<= x (/ y)) with (< 0 y)|))
 (1844 91 (:REWRITE |(< (+ (- c) x) y)|))
 (1794 39 (:REWRITE |(< (/ x) y) with (< 0 x)|))
 (1646 715 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
 (1625 13 (:LINEAR EXPT-<=-1-TWO))
 (1625 13 (:LINEAR EXPT-<-1-TWO))
 (1624 971 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-<))
 (1624 971 (:REWRITE PREFER-POSITIVE-ADDENDS-<))
 (1608 711 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
 (1348 1348 (:REWRITE THE-FLOOR-BELOW))
 (1348 1348 (:REWRITE THE-FLOOR-ABOVE))
 (1280 27 (:REWRITE RTL::NEG-BITN-0))
 (1242 1014 (:REWRITE REDUCE-RATIONAL-MULTIPLICATIVE-CONSTANT-<))
 (1205 971 (:REWRITE CONSTANT-<-INTEGERP))
 (1152 48 (:REWRITE |(+ (if a b c) x)|))
 (1119 529 (:REWRITE DEFAULT-TIMES-2))
 (1025 715 (:REWRITE SIMPLIFY-SUMS-EQUAL))
 (971 971 (:REWRITE SIMPLIFY-SUMS-<))
 (971 971 (:REWRITE REMOVE-STRICT-INEQUALITIES))
 (971 971 (:REWRITE INTEGERP-<-CONSTANT))
 (971 971 (:REWRITE |(< c (/ x)) positive c --- present in goal|))
 (971 971 (:REWRITE |(< c (/ x)) positive c --- obj t or nil|))
 (971 971 (:REWRITE |(< c (/ x)) negative c --- present in goal|))
 (971 971 (:REWRITE |(< c (/ x)) negative c --- obj t or nil|))
 (971 971 (:REWRITE |(< c (- x))|))
 (971 971 (:REWRITE |(< (/ x) c) positive c --- present in goal|))
 (971 971 (:REWRITE |(< (/ x) c) positive c --- obj t or nil|))
 (971 971 (:REWRITE |(< (/ x) c) negative c --- present in goal|))
 (971 971 (:REWRITE |(< (/ x) c) negative c --- obj t or nil|))
 (971 971 (:REWRITE |(< (/ x) (/ y))|))
 (971 971 (:REWRITE |(< (- x) c)|))
 (971 971 (:REWRITE |(< (- x) (- y))|))
 (948 173 (:LINEAR RTL::EXPW-LOWER-BOUND))
 (855 27 (:REWRITE RTL::BITN-NEG))
 (826 321 (:REWRITE O-INFP->NEQ-0))
 (743 662 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-INTEGERP-BASE-B))
 (743 662 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-INTEGERP-BASE-A))
 (743 662 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-INTEGERP-BASE))
 (715 715 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-EQUAL))
 (715 715 (:REWRITE REDUCE-ADDITIVE-CONSTANT-EQUAL))
 (715 715 (:REWRITE EQUAL-OF-PREDICATES-REWRITE))
 (715 715 (:REWRITE |(equal c (/ x))|))
 (715 715 (:REWRITE |(equal c (- x))|))
 (715 715 (:REWRITE |(equal (/ x) c)|))
 (715 715 (:REWRITE |(equal (/ x) (/ y))|))
 (715 715 (:REWRITE |(equal (- x) c)|))
 (715 715 (:REWRITE |(equal (- x) (- y))|))
 (708 708 (:REWRITE REDUCE-INTEGERP-+))
 (708 708 (:REWRITE INTEGERP-MINUS-X))
 (708 708 (:META META-INTEGERP-CORRECT))
 (662 662 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-NONPOSITIVE-BASE-EVEN-EXPONENT))
 (662 662 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-NEGATIVE-BASE-ODD-EXPONENT))
 (662 662 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-NEGATIVE-BASE-EVEN-EXPONENT))
 (577 529 (:REWRITE DEFAULT-TIMES-1))
 ...
 (344 344 (:REWRITE REDUCE-RATIONALP-+))
 (344 344 (:REWRITE REDUCE-RATIONALP-*))
 (344 344 (:REWRITE RATIONALP-MINUS-X))
 (344 344 (:META META-RATIONALP-CORRECT))
 (335 27 (:REWRITE RTL::NEG-BITN-1))
 ...
 (13 13 (:TYPE-PRESCRIPTION RTL::ZENCODE))
...
(RTL::NATP-2^PREC-1*D
 ...
 (3676 1348 (:REWRITE DEFAULT-LESS-THAN-2))
 (2670 671 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
 (2028 39 (:REWRITE |(<= x (/ y)) with (< 0 y)|))
 (1844 91 (:REWRITE |(< (+ (- c) x) y)|))
 (1794 39 (:REWRITE |(< (/ x) y) with (< 0 x)|))
 (1625 13 (:LINEAR EXPT-<=-1-TWO))
 ...
 (1624 971 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-<))
 (1624 971 (:REWRITE PREFER-POSITIVE-ADDENDS-<))
 (1550 671 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
 (1476 667 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
 (1348 1348 (:REWRITE THE-FLOOR-BELOW))
 (1348 1348 (:REWRITE THE-FLOOR-ABOVE))
 (1280 27 (:REWRITE RTL::NEG-BITN-0))
 (1242 1014 (:REWRITE REDUCE-RATIONAL-MULTIPLICATIVE-CONSTANT-<))
 ...
 (1152 48 (:REWRITE |(+ (if a b c) x)|))
 (1119 529 (:REWRITE DEFAULT-TIMES-2))
 (981 671 (:REWRITE SIMPLIFY-SUMS-EQUAL))
 (971 971 (:REWRITE SIMPLIFY-SUMS-<))
 (971 971 (:REWRITE REMOVE-STRICT-INEQUALITIES))
 (971 971 (:REWRITE INTEGERP-<-CONSTANT))
 (971 971 (:REWRITE |(< c (/ x)) positive c --- present in goal|))
 ...
 (948 173 (:LINEAR RTL::EXPW-LOWER-BOUND))
 (855 27 (:REWRITE RTL::BITN-NEG))
 (760 310 (:REWRITE O-INFP->NEQ-0))
 (743 662 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-INTEGERP-BASE-B))
 (743 662 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-INTEGERP-BASE-A))
 (743 662 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-INTEGERP-BASE))
 (671 671 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-EQUAL))
 (671 671 (:REWRITE REDUCE-ADDITIVE-CONSTANT-EQUAL))
 (671 671 (:REWRITE EQUAL-OF-PREDICATES-REWRITE))
 (671 671 (:REWRITE |(equal c (/ x))|))
 (671 671 (:REWRITE |(equal c (- x))|))
 (671 671 (:REWRITE |(equal (/ x) c)|))
