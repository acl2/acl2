(RTL::RP1-REWRITE
 ...
 (7330 4 (:REWRITE RTL::BITS-TAIL))
 (7322 4 (:DEFINITION RTL::BVECP))
 (1740 8 (:REWRITE |(< x (/ y)) with (< 0 y)|))
 (1642 1642 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-NONPOSITIVE-BASE-EVEN-EXPONENT))
 (1642 1642 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-NEGATIVE-BASE-ODD-EXPONENT))
 (1642 1642 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-NEGATIVE-BASE-EVEN-EXPONENT))
 (1642 1642 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-INTEGERP-BASE-B))
 (1565 4 (:REWRITE |(<= x (/ y)) with (< y 0)|))
 (1455 4 (:REWRITE |(< (/ x) y) with (< x 0)|))
