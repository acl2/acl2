(FIRST-UNMATCHED-SYMBOL-PAIR (484 232 (:REWRITE DEFAULT-+-2))
...
(FUNCTION-SYMBOLS* (155 72 (:REWRITE DEFAULT-+-2))
...
(DEEPSUBST)
(DEEPMEMBER)
(APPLY-UNIFIER (6 6 (:TYPE-PRESCRIPTION DEEPSUBST)))
(NEGATIVE-LITERALP)
(STRIP-NEGATION)
(LST-INTERSECTION (121 58 (:REWRITE DEFAULT-+-2))
...
(STANDARDIZE-CLAUSE (6 6 (:TYPE-PRESCRIPTION DEEPSUBST)))
(STANDARDIZE-APART)
(UNIFY* (24 24 (:TYPE-PRESCRIPTION DEEPSUBST)))
(UNIFY (3 3 (:TYPE-PRESCRIPTION TRUE-LISTP)))
