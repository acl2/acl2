...
; The defun and encapsulate forms below wree generated by starting up ACL2 in
; the present directory and evaluating the following.

; (ld "cert.acl2")
; (in-package "ZF")
; (ld "eval-poly-thy.lisp")
; (pe 'HOL::EVAL-POLY$HTA)
; (pe 'HOL::EVAL-POLY$PROP)

; The last of the forms above generated the encapsulate event below.  That form
; was just pasted in below, after killing the rectangle of space against the
; left margin so as to put the "(ENCAPSULATE" against the left margin.
; Comments were then inserted manually.

; Finally, a comment at the end shows the translation of the goal theorem.
...
; The type of the HOL pair produced by COND is as expected:
 ...
 (DEFTHM HOL::COMMA$TYPE
  (IMPLIES
   ...
   (AND
    (HPP
     (HOL::COMMA
          (TYP (:ARROW* HOL::A HOL::B (:HASH HOL::A HOL::B))))
     (HOL::EVAL-POLY$HTA))
    (EQUAL
     (HP-TYPE
      (HOL::COMMA
 ...
 (DEFTHM HOL::FST$TYPE
  (IMPLIES
   ...
   (AND
    (HPP
       (HOL::FST (TYP (:ARROW* (:HASH HOL::A HOL::B) HOL::A)))
       (HOL::EVAL-POLY$HTA))
    (EQUAL
        (HP-TYPE (HOL::FST (TYP (:ARROW* (:HASH HOL::A HOL::B)
                                         HOL::A))))
 ...
 (DEFTHM HOL::SND$TYPE
  (IMPLIES
   ...
   (AND
    (HPP
       (HOL::SND (TYP (:ARROW* (:HASH HOL::A HOL::B) HOL::B)))
       (HOL::EVAL-POLY$HTA))
    (EQUAL
        (HP-TYPE (HOL::SND (TYP (:ARROW* (:HASH HOL::A HOL::B)
                                         HOL::B))))
        (TYP (:ARROW* (:HASH HOL::A HOL::B)
                      HOL::B))))))
 (DEFTHM HOL::SUC$TYPE
 ...
 (DEFTHM HOL::<=$TYPE
  (IMPLIES
   (FORCE (HOL::EVAL-POLY$PROP))
   (AND
    (HPP (HOL::<= (TYP (:ARROW* :NUM :NUM :BOOL)))
         (HOL::EVAL-POLY$HTA))
 ...
 (DEFTHM HOL::HD$TYPE
  (IMPLIES
   (FORCE (HOL::EVAL-POLY$PROP))
   (AND
    (HPP (HOL::HD (TYP (:ARROW* (:LIST HOL::A) HOL::A)))
         (HOL::EVAL-POLY$HTA))
    (EQUAL
     (HP-TYPE (HOL::HD (TYP (:ARROW* (:LIST HOL::A) HOL::A))))
     (TYP (:ARROW* (:LIST HOL::A) HOL::A))))))
 (DEFTHM HOL::NULL$TYPE
  (IMPLIES
   (FORCE (HOL::EVAL-POLY$PROP))
   (AND
    (HPP (HOL::NULL (TYP (:ARROW* (:LIST HOL::A) :BOOL)))
         (HOL::EVAL-POLY$HTA))
    (EQUAL
        (HP-TYPE
             (HOL::NULL (TYP (:ARROW* (:LIST HOL::A) :BOOL))))
        (TYP (:ARROW* (:LIST HOL::A) :BOOL))))))
 (DEFTHM HOL::EXP$TYPE
  (IMPLIES
   (FORCE (HOL::EVAL-POLY$PROP))
   (AND
    (HPP (HOL::EXP (TYP (:ARROW* :NUM :NUM :NUM)))
         (HOL::EVAL-POLY$HTA))
 ...
 (DEFTHM HOL::POLYP$TYPE
  (IMPLIES
   (FORCE (HOL::EVAL-POLY$PROP))
   (AND
    (HPP (HOL::POLYP (TYP (:ARROW* (:LIST (:HASH :NUM :NUM))
                                   :BOOL)))
         (HOL::EVAL-POLY$HTA))
    (EQUAL
      (HP-TYPE
           (HOL::POLYP (TYP (:ARROW* (:LIST (:HASH :NUM :NUM))
                                     :BOOL))))
 ...
 (DEFTHM HOL::EVAL_POLY$TYPE
  (IMPLIES
   ...
   (AND
    (HPP
       (HOL::EVAL_POLY (TYP (:ARROW* (:LIST (:HASH :NUM :NUM))
                                     :NUM :NUM)))
       (HOL::EVAL-POLY$HTA))
    (EQUAL
     (HP-TYPE
...
; has been translated.
 ...
 (DEFTHM HOL::HOL{HD}
  (IMPLIES
    (AND (ALIST-SUBSETP (HOL::EVAL-POLY$HTA)
         ...
         (FORCE (HOL::EVAL-POLY$PROP)))
    (EQUAL
         (HAP* (HOL::HD (TYP (:ARROW* (:LIST HOL::A) HOL::A)))
               (HP-CONS HOL::H HOL::T))
         HOL::H)))
 (DEFTHM HOL::HOL{NULL}0
  (IMPLIES
   (FORCE (HOL::EVAL-POLY$PROP))
   (EQUAL
        (HAP* (HOL::NULL (TYP (:ARROW* (:LIST HOL::A) :BOOL)))
              (HP-NIL (TYP HOL::A)))
        (HP-TRUE))))
   ...
   (EQUAL
    ...
    (HP-AND
     ...
     (HP-AND
      ...
      (HP-OR
       (HAP*
            (HOL::NULL (TYP (:ARROW* (:LIST (:HASH :NUM :NUM))
                                     :BOOL)))
            HOL::R)
       (HP<
        (HAP*
         (HOL::SND (TYP (:ARROW* (:HASH :NUM :NUM) :NUM)))
         (HAP*
              (HOL::HD (TYP (:ARROW* (:LIST (:HASH :NUM :NUM))
                                     (:HASH :NUM :NUM))))
              HOL::R))
        HOL::E)))))))
...
; Here is the output of the hol-theory-print command.
