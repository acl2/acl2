...
; Specifically, it displays the encapsulate event generated by the form
; (close-theory) in ex1-thy.lisp.  Comments below explain that event and its
; groups of events, which may be viewed as the axioms exported by that
; encapsulate event.
...
; Include the book that produces the translated theory.
