...
(RTL::LEAST-DIVISOR-2
 ...
 (1 1 (:LINEAR EXPT-<-1-TWO))
 (1 1 (:LINEAR EXPT-<-1-ONE)))
(RTL::HACK-1 (15 11 (:REWRITE DEFAULT-TIMES-2))
             ...
             (1 1 (:REWRITE |(< 0 (* x y))|)))
(RTL::HACK-2 (15 11 (:REWRITE DEFAULT-TIMES-2))
             (11 11 (:REWRITE DEFAULT-TIMES-1))
             (5 5 (:REWRITE THE-FLOOR-BELOW))
             (5 5 (:REWRITE THE-FLOOR-ABOVE))
             (5 5
...
(RTL::HACK-5 (38 38 (:TYPE-PRESCRIPTION NOT-INTEGERP-4B))
...
(RTL::MERSENNE-999671-REVISITED (2 2 (:TYPE-PRESCRIPTION MOD-ZERO . 2))
