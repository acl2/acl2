...
;; u/seful in establishing the inverse property:
...
;; elements (i.e., each is a sublist of the other), then they are equal:
...
;; Obvoiusly, (elts g) is ordered with respect to g:
