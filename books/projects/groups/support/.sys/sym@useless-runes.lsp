...
(DM::GROUPP-SYM
 ...
 (1794 22 (:DEFINITION MEMBER-EQUAL))
 (1443 12 (:REWRITE DM::MEMBER-PERM-SLIST))
 (1050 42 (:REWRITE |(< y (+ (- c) x))|))
 ...
 (123 123 (:TYPE-PRESCRIPTION DM::NINIT))
 (114 32 (:REWRITE MEMBER-WHEN-ATOM))
