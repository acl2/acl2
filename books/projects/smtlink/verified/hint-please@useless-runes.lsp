...
(SMT::PSEUDO-TERM-LIST-LISTP-OF-REMOVE-HINT-PLEASE
 (24228 67 (:REWRITE SMT::EQUAL-FIXED-AND-X-OF-PSEUDO-TERMP))
 (23960 67 (:DEFINITION PSEUDO-TERMP))
 (6745 237 (:DEFINITION SYMBOL-LISTP))
 (6330 340 (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
 (5830 170 (:DEFINITION TRUE-LIST-LISTP))
 (4080 680 (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
...
(SMT::CORRECTNESS-OF-REMOVE-HINT-PLEASE
 (106 5 (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
