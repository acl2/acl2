...
(SMT::PARAGRAPHP-OF-TRANSLATE-SYMBOL
     ...
     (2 1
        (:REWRITE SMT::PARAGRAPHP-COROLLARY-2)))
(SMT::TRANSLATE-SYMBOL-LST (598 18
...
(SMT::PARAGRAPHP-OF-TRANSLATE-SYMBOL-LST
     ...
     (6 3
        (:REWRITE ACL2-NUMBER-LISTP-OF-CDR-WHEN-ACL2-NUMBER-LISTP)))
(SMT::TRANSLATE-TYPE)
(SMT::STRINGP-OF-TRANSLATE-TYPE (22 22 (:REWRITE SYMBOL-FIX-WHEN-SYMBOLP))
...
(SMT::PARAGRAPHP-OF-TRANSLATE-FTY-FIELD-LST
     ...
     (58 23
         (:REWRITE SMT::CONSP-CAR-OF-FTY-FIELD-ALIST-FIX))
     (38 10
         (:REWRITE SMT::WORDP-OF-CAR-WHEN-WORD-LISTP))
     (22 4
...
(SMT::PARAGRAPHP-OF-TRANSLATE-FTY-ALIST-ASSOC
     ...
     (2 1
        (:REWRITE ACL2-NUMBER-LISTP-OF-CDR-WHEN-ACL2-NUMBER-LISTP)))
(SMT::MAKE-PAIR-TYPE (34 2 (:DEFINITION BINARY-APPEND))
...
(SMT::PARAGRAPHP-OF-TRANSLATE-FTY-ALIST
     ...
     (5 5 (:REWRITE DEFAULT-CAR))
     (4 4
        (:TYPE-PRESCRIPTION SMT::TRANSLATE-FTY-OPTION))
     (4 4
        (:TYPE-PRESCRIPTION SMT::TRANSLATE-FTY-ALIST-TYPE))
     (4 4
        (:TYPE-PRESCRIPTION SMT::TRANSLATE-FTY-ALIST-ASSOC-RETURN))
     (4 4
        (:TYPE-PRESCRIPTION SMT::TRANSLATE-FTY-ALIST-ASSOC))
     (4 4
        (:TYPE-PRESCRIPTION SMT::TRANSLATE-FTY-ALIST-ACONS))
     (4 2
        (:REWRITE DEFAULT-SYMBOL-PACKAGE-NAME))
     (3 3
     ...
     (1 1
        (:REWRITE SMT::STRINGP-OF-TRANSLATE-TYPE)))
...
(SMT::TRANSLATE-ABSTRACT-TYPES (10 10
                                   (:REWRITE SYMBOL-LISTP-WHEN-NOT-CONSP))
