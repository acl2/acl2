...
(SMT::INVERTER->INPUT$INLINE-OF-INVERTER-FIX-X-NORMALIZE-CONST)
...
(SMT::INVERTER->OUTPUT$INLINE-OF-INVERTER-FIX-X
     (9 3
        (:REWRITE SMT::INVERTER-FIX-WHEN-INVERTER-P))
     (6 6 (:TYPE-PRESCRIPTION SMT::INVERTER-P)))
(SMT::INVERTER->OUTPUT$INLINE-OF-INVERTER-FIX-X-NORMALIZE-CONST)
...
(SMT::INVERTER-OF-SIG-PATH-FIX-INPUT-NORMALIZE-CONST)
(SMT::INVERTER-SIG-PATH-EQUIV-CONGRUENCE-ON-INPUT)
(SMT::INVERTER-OF-SIG-PATH-FIX-OUTPUT)
(SMT::INVERTER-OF-SIG-PATH-FIX-OUTPUT-NORMALIZE-CONST)
