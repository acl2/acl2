...
(MODAPP::APPLY$-REV (12 2 (:REWRITE O-P-O-INFP-CAR))
                    ...
                    (2 1 (:REWRITE MODAPP::APPLY$-PRIMP-BADGE))
                    (2 1 (:REWRITE MODAPP::APPLY$-PRIMITIVE)))
(MODAPP::FLATTEN (1 1 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(MODAPP::APPLY$-WARRANT-FLATTEN)
(MODAPP::APPLY$-WARRANT-FLATTEN-NECC)
(MODAPP::APPLY$-FLATTEN (12 2 (:REWRITE O-P-O-INFP-CAR))
...
(MODAPP::APPLY$-SUM (364 4 (:DEFINITION MODAPP::TAMEP))
...
(MODAPP::APPLY$-FOLDT (352 8 (:DEFINITION MODAPP::TAMEP))
...
(MODAPP::APPLY$-SUM-SQUARES (12 2 (:REWRITE O-P-O-INFP-CAR))
                            (8 4 (:REWRITE DEFAULT-+-2))
                            (8 4 (:REWRITE DEFAULT-+-1))
                            (6 2 (:REWRITE O-P-DEF-O-FINP-1))
                            (4 4 (:TYPE-PRESCRIPTION O-P))
                            ...
                            (2 1 (:REWRITE MODAPP::APPLY$-PRIMP-BADGE))
                            (2 1 (:REWRITE MODAPP::APPLY$-PRIMITIVE)))
(MODAPP::T1 (24 12 (:REWRITE DEFAULT-+-2))
            (24 12 (:REWRITE DEFAULT-+-1))
            (12 12
                (:TYPE-PRESCRIPTION NONNEGATIVE-PRODUCT))
            (12 12
...
(MODAPP::T2 (70 35 (:REWRITE DEFAULT-+-2))
...
(MODAPP::APPLY$-SUM-SQUARES-OF-EVENS
     ...
     (2 1 (:REWRITE MODAPP::APPLY$-PRIMP-BADGE))
     (2 1 (:REWRITE MODAPP::APPLY$-PRIMITIVE)))
(MODAPP::T4 (47 29 (:REWRITE DEFAULT-*-2))
...
(MODAPP::T8 (133 114 (:REWRITE DEFAULT-CAR))
...
(MODAPP::WEIRD-LITTLE-LEMMA2
     ...
     (17 2
         (:REWRITE MODAPP::WEIRD-LITTLE-LEMMA1))
...
(MODAPP::T9 (258 257 (:REWRITE DEFAULT-CDR))
...
(MODAPP::T10 (326 324 (:REWRITE DEFAULT-CDR))
...
(MODAPP::T11-LEMMA (635 632 (:REWRITE DEFAULT-CDR))
...
(MODAPP::T11 (322 4 (:DEFINITION MODAPP::TAMEP))
             ...
             (4 4 (:REWRITE DEFAULT-COERCE-2))
             (4 4 (:REWRITE DEFAULT-COERCE-1)))
(MODAPP::T12-LEMMA (1339 1231 (:REWRITE DEFAULT-CAR))
...
(MODAPP::T12 (18 2 (:DEFINITION MODAPP::FLATTEN))
             (12 2 (:DEFINITION BINARY-APPEND))
             (6 4 (:REWRITE DEFAULT-CDR))
...
(MODAPP::FN-EQUAL-IMPLIES-EQUAL-MAXLIST-2
     ...
     (12 6 (:REWRITE DEFAULT-<-2))
     (12 6 (:REWRITE DEFAULT-<-1)))
(MODAPP::T14 (258 257 (:REWRITE DEFAULT-CDR))
             (178 177 (:REWRITE DEFAULT-CAR))
             (136 8 (:DEFINITION LENGTH))
             (112 16 (:DEFINITION LEN))
             (68 8 (:DEFINITION SYMBOL-LISTP))
             ...
             (8 8 (:REWRITE DEFAULT-COERCE-2))
             (8 8 (:REWRITE DEFAULT-COERCE-1)))
(MODAPP::T15 (273 272 (:REWRITE DEFAULT-CDR))
             ...
             (8 8 (:REWRITE DEFAULT-COERCE-2))
             (8 8 (:REWRITE DEFAULT-COERCE-1)))
(MODAPP::T16 (299 298 (:REWRITE DEFAULT-CDR))
             ...
             (10 10 (:REWRITE DEFAULT-COERCE-2))
             (10 10 (:REWRITE DEFAULT-COERCE-1)))
(MODAPP::T17 (299 298 (:REWRITE DEFAULT-CDR))
             (186 185 (:REWRITE DEFAULT-CAR))
             (170 10 (:DEFINITION LENGTH))
             (140 20 (:DEFINITION LEN))
             (85 10 (:DEFINITION SYMBOL-LISTP))
             ...
             (10 10 (:REWRITE DEFAULT-COERCE-1)))
(MODAPP::T18)
(MODAPP::T19 (1127 14 (:DEFINITION MODAPP::TAMEP))
             (644 14
                  (:REWRITE MODAPP::WEIRD-LITTLE-LEMMA1))
...
(MODAPP::T20 (638 635 (:REWRITE DEFAULT-CDR))
...
(MODAPP::T21 (159 159 (:REWRITE DEFAULT-CDR))
             ...
             (4 4 (:REWRITE DEFAULT-COERCE-2))
             (4 4 (:REWRITE DEFAULT-COERCE-1)))
(MODAPP::T22 (21 13 (:REWRITE DEFAULT-CDR))
             (8 8 (:REWRITE DEFAULT-CAR))
             (1 1
                (:REWRITE MODAPP::APPLY$-EQUIVALENCE-NECC)))
(MODAPP::T23 (56 4 (:DEFINITION MODAPP::SUM))
...
(MODAPP::FN-EQUAL-IMPLIES-EQUAL-COLLECT*-2
     ...
     (6 6 (:REWRITE DEFAULT-CAR))
     (4 4 (:REWRITE DEFAULT-CDR)))
(MODAPP::T24 (18 9 (:REWRITE MODAPP::APPLY$-PRIMITIVE))
             (1 1
