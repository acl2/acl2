...
(MODAPP::COLLECT*-COLLECT-EXAMPLE
     ...
     (1 1
        (:REWRITE MODAPP::APPLY$-WARRANT-COLLECT-NECC)))
(MODAPP::COLLECT-MY-APPEND1 (45 15 (:REWRITE MODAPP::APPLY$-PRIMITIVE))
                            (30 30
                                (:TYPE-PRESCRIPTION MODAPP::APPLY$-PRIMP))
                            (24 22 (:REWRITE DEFAULT-CAR))
                            (21 19 (:REWRITE DEFAULT-CDR)))
(MODAPP::SUMLIST-MY-APPEND1 (70 35 (:REWRITE DEFAULT-+-2))
...
(MODAPP::ALL-MY-APPEND1 (87 29 (:REWRITE MODAPP::APPLY$-PRIMITIVE))
                        (58 58
                            (:TYPE-PRESCRIPTION MODAPP::APPLY$-PRIMP))
                        ...
                        (22 22
                            (:TYPE-PRESCRIPTION MODAPP::MY-APPEND1)))
(MODAPP::XISTS-MY-APPEND1 (90 30 (:REWRITE MODAPP::APPLY$-PRIMITIVE))
                          (60 60
                              (:TYPE-PRESCRIPTION MODAPP::APPLY$-PRIMP))
                          ...
                          (24 24
                              (:TYPE-PRESCRIPTION MODAPP::MY-APPEND1)))
(MODAPP::LEN-FILTER (24 12 (:REWRITE DEFAULT-+-2))
...
(MODAPP::FILTER-V-ALL (1071 13 (:REWRITE MODAPP::TAMEP-IMPLICANT-1))
                      (1033 13 (:DEFINITION MODAPP::TAMEP))
...
(MODAPP::FILTER-V-XISTS (63 21 (:REWRITE MODAPP::APPLY$-PRIMITIVE))
                        (42 42
                            (:TYPE-PRESCRIPTION MODAPP::APPLY$-PRIMP))
...
(MODAPP::REV-REV-VERSION-1
     (6668 76 (:REWRITE MODAPP::TAMEP-IMPLICANT-1))
     (6442 76 (:DEFINITION MODAPP::TAMEP))
...
(MODAPP::FOLDR-AS-MY-APPEND1 (81 81
                                 (:TYPE-PRESCRIPTION MODAPP::MY-APPEND1))
                             (18 18 (:REWRITE DEFAULT-CAR))
                             (11 11 (:REWRITE DEFAULT-CDR)))
(MODAPP::FOLDR-AS-MY-REV (133 114 (:REWRITE DEFAULT-CAR))
                         (84 74 (:REWRITE DEFAULT-CDR))
                         (27 27
                             (:TYPE-PRESCRIPTION MODAPP::EV$-LIST))
                         (26 6 (:DEFINITION MODAPP::MY-APPEND1))
                         (4 4
                            (:REWRITE MODAPP::APPLY$-WARRANT-FOLDR-NECC)))
(MODAPP::REV-REV-VERSION-2 (6668 76 (:REWRITE MODAPP::TAMEP-IMPLICANT-1))
                           ...
                           (22 22
                               (:REWRITE MODAPP::APPLY$-WARRANT-FOLDR-NECC)))
(MODAPP::REV-REV-VERSION-3 (8901 101
...
(MODAPP::LAMB-X-X-IS-IDENTITY (21 13 (:REWRITE DEFAULT-CDR))
...
(MODAPP::GENERAL-COLLECT-IS-A-FOLDR (169 168 (:REWRITE DEFAULT-CDR))
                                    ...
                                    (4 4 (:REWRITE DEFAULT-COERCE-2))
                                    (4 4 (:REWRITE DEFAULT-COERCE-1)))
(MODAPP::FOLDR-AS-COLLECT (154 153 (:REWRITE DEFAULT-CDR))
                          ...
                          (4 4 (:REWRITE DEFAULT-COERCE-2))
                          (4 4 (:REWRITE DEFAULT-COERCE-1)))
(MODAPP::FOLDR-AS-SUMLIST (154 153 (:REWRITE DEFAULT-CDR))
                          (130 129 (:REWRITE DEFAULT-CAR))
                          (68 4 (:DEFINITION LENGTH))
                          (56 8 (:DEFINITION LEN))
                          ...
                          (4 4 (:REWRITE DEFAULT-COERCE-2))
                          (4 4 (:REWRITE DEFAULT-COERCE-1)))
(MODAPP::FOLDR-AS-FILTER (196 194 (:REWRITE DEFAULT-CDR))
...
(MODAPP::FOLDR-AS-ALL (169 168 (:REWRITE DEFAULT-CDR))
                      ...
                      (5 5 (:REWRITE DEFAULT-COERCE-2))
                      (5 5 (:REWRITE DEFAULT-COERCE-1)))
(MODAPP::FOLDR-AS-XISTS (169 168 (:REWRITE DEFAULT-CDR))
                        (126 125 (:REWRITE DEFAULT-CAR))
                        (85 5 (:DEFINITION LENGTH))
                        (70 10 (:DEFINITION LEN))
                        (42 14 (:REWRITE MODAPP::APPLY$-PRIMITIVE))
                        ...
                        (5 5 (:REWRITE DEFAULT-COERCE-2))
                        (5 5 (:REWRITE DEFAULT-COERCE-1)))
(MODAPP::MAXLIST-NON-NIL (518 7 (:DEFINITION MODAPP::TAMEP))
...
(MODAPP::FOLDR-AS-MAXLIST (1187 1184 (:REWRITE DEFAULT-CDR))
