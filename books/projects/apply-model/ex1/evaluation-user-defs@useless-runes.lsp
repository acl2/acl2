...
(MODAPP::APPLY$-SUMLIST (558 6 (:DEFINITION MODAPP::TAMEP))
...
(MODAPP::APPLY$-FOLDR (1178 1100 (:REWRITE DEFAULT-CDR))
...
(MODAPP::APPLY$-PROW (1030 952 (:REWRITE DEFAULT-CDR))
...
(MODAPP::APPLY$-WARRANT-PROW*)
(MODAPP::APPLY$-WARRANT-PROW*-NECC)
(MODAPP::APPLY$-PROW* (2883 3 (:DEFINITION MODAPP::PROW))
