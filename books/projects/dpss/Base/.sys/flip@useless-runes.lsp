...
(ITH-UAV-FLIP-ON-EVENTS
 ...
 (77 1 (:DEFINITION FLIP-ON-EVENTS-REC))
 ...
 (23 1 (:REWRITE WEAK-UAV-ID-FIX-UAV-ID-P))
...
(NOT-EXISTS-UAV-WITH-EVENT-FLIP-ON-EVENTS
 ...
 (102 21 (:REWRITE UAV-P-OF-CAR-WHEN-UAV-LIST-P))
 (94 2 (:DEFINITION PICK-A-POINT::UAV-LIST-EQUIV-POINT))
 (70 4 (:REWRITE UAV-FIX-WHEN-UAV-P))
...
(SEQUENTIAL-ID-LIST-P-FLIP-ON-EVENTS
 (299 24 (:REWRITE WF-ENSEMBLE-IMPLIES-BODY))
 (287 7 (:REWRITE BODY-IMPLIES-WF-ENSEMBLE))
 (102 7 (:DEFINITION UAV-LIST-P))
 (88 4 (:DEFINITION SEQUENTIAL-ID-LIST-AUX-P-WITNESS))
 (73 8 (:REWRITE SEQUENTIAL-ID-LIST-AUX-P-WITNESS-WHEN-SEQUENTIAL))
 (70 1 (:DEFINITION LEN))
 (64 1 (:REWRITE ORDERED-LOCATION-LIST-P-FLIP-ON-EVENTS))
 (60 2 (:DEFINITION ORDERED-LOCATION-LIST-P))
 (55 8 (:REWRITE UAV-LIST-P-OF-CDR-WHEN-UAV-LIST-P))
 (55 5 (:DEFINITION SEQUENTIAL-ID-LIST-AUX-P))
 (52 52 (:TYPE-PRESCRIPTION UAV-LIST-P))
 (52 11 (:DEFINITION UAV-FIX!))
 (41 9 (:REWRITE UAV-P-OF-CAR-WHEN-UAV-LIST-P))
 (32 2 (:REWRITE UAV-FIX-WHEN-UAV-P))
...
(MIN-TIME-TO-IMPACT-FOR-UAV-FLIP-ON-EVENTS-INVARIANT
 ...
 (218 194 (:REWRITE UAV-LIST-P-WHEN-NOT-CONSP))
...
(IMPENDING-EVENT-FOR-UAV-STILL-IMPENDING-FLIP-ON-EVENTS
 ...
 (504 432 (:REWRITE UAV-LIST-P-WHEN-NOT-CONSP))
 ...
 (252 228 (:REWRITE DEFAULT-CDR))
 (252 228 (:REWRITE DEFAULT-CAR))
...
(NOT-ESCORT-FOR-UAV-FLIP-ON-EVENTS-INVARIANT
 ...
 (90 87 (:REWRITE UAV-LIST-P-WHEN-NOT-CONSP))
...
(IMPENDING-ESCORT-FOR-UAV-STILL-IMPENDING-FLIP-ON-EVENTS
 ...
 (112 10 (:DEFINITION =))
 (108 96 (:REWRITE UAV-LIST-P-WHEN-NOT-CONSP))
