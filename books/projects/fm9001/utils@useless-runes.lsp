...
(FM9001::ISTRPREFIXP-STRING-APPEND-RELATION-2
     (431 18 (:REWRITE STR::CONSP-OF-EXPLODE))
     (187 11
          (:REWRITE FM9001::NOT-PREFIXP-NOT-EQUAL))
     ...
     (48 9 (:REWRITE LIST-EQUIV-WHEN-ATOM-RIGHT))
...
(FM9001::SI-OF-DIFF-SYMBOLS-2
     (265 16 (:REWRITE STR::CONSP-OF-EXPLODE))
     (114 5 (:DEFINITION LEN))
     (95 15 (:REWRITE SIMPLIFY-SUMS-EQUAL))
     ...
     (15 15 (:REWRITE |(equal (- x) (- y))|))
     (15 1 (:REWRITE |(+ y x)|))
     (10 10 (:REWRITE FM9001::SYMBOL-INEQUALITY))
