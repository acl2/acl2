...
(FM9001::TV-IF&
     ...
     (12950 210 (:REWRITE PREFIXP-OF-CONS-LEFT))
     (12290 60
            (:REWRITE STR::IPREFIXP-OF-CONS-LEFT))
     (9880 280
           (:REWRITE PREFIXP-WHEN-EQUAL-LENGTHS))
     (2820 2820 (:TYPE-PRESCRIPTION LEN))
     (2680 300 (:DEFINITION LEN))
     (2100 40 (:DEFINITION INTEGER-ABS))
     (1530 140 (:REWRITE STR::CONSP-OF-EXPLODE))
     (1227 556 (:REWRITE DEFAULT-PLUS-2))
     (1130 687
           (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
     (1045 556 (:REWRITE DEFAULT-PLUS-1))
     (994 687
          (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
     (980 980 (:LINEAR LEN-WHEN-PREFIXP))
     (754 604 (:REWRITE DEFAULT-CDR))
     (750 750
          (:TYPE-PRESCRIPTION STR::TRUE-LISTP-OF-EXPLODE))
     (714 687 (:REWRITE SIMPLIFY-SUMS-EQUAL))
...
(FM9001::TV-IF$VALUE-AUX
     ...
     (591 8 (:REWRITE TAKE-OF-TOO-MANY))
