...
(FM9001::BV-AS-SUBSEQ
     ...
     (112 1 (:REWRITE TAKE-WHEN-PREFIXP))
...
(FM9001::CHIP-MODULE$STATE
     ...
     (793 429
          (:REWRITE FM9001::ALL-UNBOUND-IN-BODY-ATOM-NAMES))
     (760 190
          (:DEFINITION FM9001::MD-OUTS$INLINE))
     (633 171
...
(FM9001::CHIP$VALUE
     ...
     (1101 246
           (:REWRITE FM9001::ASSOC-EQ-OF-NON-FN-NETLIST))
     (1008 56
           (:REWRITE FM9001::TTL-INPUT-PADS$VALUE))
     (1004 389
           (:TYPE-PRESCRIPTION FM9001::BVP-CVZBV))
     (734 734
          (:TYPE-PRESCRIPTION FM9001::NET-SYNTAX-OKP))
     ...
     (6 6
        (:TYPE-PRESCRIPTION FM9001::A-IMMEDIATE))
     (4 4
        (:TYPE-PRESCRIPTION FM9001::MEMORY-OKP)))
(FM9001::CHIP$STATE
     (26400 12720
     ...
     (8 8
        (:TYPE-PRESCRIPTION FM9001::MEMORY-OKP))
     (2 1
        (:REWRITE FM9001::ASSOC-EQ-VALUES-UPDATE-ALIST-NOT-MEMBER)))
(FM9001::CHIP-SYSTEM*)
...
(FM9001::CHIP-SYSTEM$STATE
     ...
     (7 7
        (:TYPE-PRESCRIPTION FM9001::MEMORY-VALUE))
     (7 7
     ...
     (3 3
        (:TYPE-PRESCRIPTION FM9001::F$NEXT-CNTL-STATE))
     (3 3
        (:TYPE-PRESCRIPTION FM9001::F$EXTEND-IMMEDIATE))
     (3 3
        (:TYPE-PRESCRIPTION FM9001::A-IMMEDIATE))
     (2 2
        (:TYPE-PRESCRIPTION FM9001::MEMORY-OKP))
...
(FM9001::FM9001-PRESERVES-CHIP-SYSTEM-INVARIANT
     ...
     (38 5
         (:REWRITE FM9001::F$NEXT-CNTL-STATE=NEXT-CNTL-STATE))
     (28 28
         (:TYPE-PRESCRIPTION FM9001::V-PULLUP))
     (28 28
         (:TYPE-PRESCRIPTION FM9001::MEMORY-VALUE))
...
(FM9001::MAP-UP-INPUTS (38 5 (:REWRITE FM9001::BVP-IS-TRUE-LISTP))
                       (26 2 (:DEFINITION TRUE-LISTP))
...
(FM9001::OPEN-MAP-UP-INPUTS (131 131 (:REWRITE DEFAULT-CDR))
...
(FM9001::CHIP-SYSTEM=RUN-FM9001
     ...
     (152 40
          (:TYPE-PRESCRIPTION TRUE-LISTP-NTHCDR-TYPE-PRESCRIPTION))
     (144 144
          (:TYPE-PRESCRIPTION FM9001::MAP-UP-1-INPUT))
