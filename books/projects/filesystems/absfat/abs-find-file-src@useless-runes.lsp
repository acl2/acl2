...
(ABS-FIND-FILE-SRC-CORRECTNESS-2
 ...
 (64433 6625 (:DEFINITION LEN))
 (32195 235 (:REWRITE NTHCDR-WHEN->=-N-LEN-L))
 (27269 2059 (:REWRITE ABS-FS-P-CORRECTNESS-1))
 (25233 434
 ...
 (1224 6 (:DEFINITION REMOVE-ASSOC-EQUAL))
 (1199 375
       (:TYPE-PRESCRIPTION ABS-ADDRS-WHEN-M1-FILE-ALIST-P))
