...
(L5-WRCHS-RETURNS-FS (1319 535 (:REWRITE DEFAULT-CDR))
                     (1143 381
                           (:TYPE-PRESCRIPTION ASSOC-WHEN-ZP-LEN))
...
(L5-RDCHS-CORRECTNESS-1
     ...
     (1098 856 (:REWRITE DEFAULT-CDR))
     (848 13 (:DEFINITION TAKE))
     (784 733 (:REWRITE DEFAULT-CAR))
     (757 111 (:DEFINITION LEN))
...
(L5-READ-AFTER-WRITE-1
     ...
     (62149 24022 (:REWRITE DEFAULT-CDR))
     ...
     (43044 1286
            (:REWRITE MAKE-BLOCKS-CORRECTNESS-5 . 1))
     (34178 21591 (:REWRITE DEFAULT-CAR))
     (32702 2199
            (:REWRITE L5-REGULAR-FILE-ENTRY-P-CORRECTNESS-3
                      . 2))
     (31638 517 (:DEFINITION L5-STAT))
     ...
     (22566 277
            (:DEFINITION FETCH-BLOCKS-BY-INDICES))
     (21212 305 (:DEFINITION TAKE))
     (19249 5663 (:REWRITE ZP-OPEN))
     (16726 277 (:DEFINITION UNMAKE-BLOCKS))
     (16464 46 (:DEFINITION L3-STAT))
     (15722 210
            (:REWRITE L4-WRCHS-CORRECTNESS-1-LEMMA-18))
     (14904 648 (:DEFINITION L5-TO-L4-FS))
     (14700 210 (:DEFINITION INDICES-MARKED-P))
     (13535 2707 (:DEFINITION ASSOC-EQUAL))
     (13348 1380 (:REWRITE NFIX-WHEN-ZP))
     (12563 610 (:REWRITE TAKE-OF-LEN-FREE))
     (12396 8473 (:REWRITE DEFAULT-<-2))
     (11143 28 (:REWRITE CAR-OF-NTHCDR))
     (10838 6229 (:REWRITE DEFAULT-+-2))
     (10049 773 (:REWRITE ASSOC-OF-CAR-WHEN-MEMBER))
     (9034 826 (:REWRITE L5-FS-P-ASSOC))
     (9014 8473 (:REWRITE DEFAULT-<-1))
     ...
     (6760 6229 (:REWRITE DEFAULT-+-1))
     (6184 773 (:DEFINITION MEMBER-EQUAL))
     (5982 1994
           (:REWRITE REMOVE1-ASSOC-WHEN-ABSENT . 1))
     ...
     (4921 4921 (:TYPE-PRESCRIPTION ZP))
     (4601 997
           (:REWRITE L2-READ-AFTER-WRITE-1-LEMMA-1))
     (4126 440
           (:REWRITE L5-WRCHS-CORRECTNESS-1-LEMMA-7))
     (4107 28 (:DEFINITION NTHCDR))
     (3865 3865 (:TYPE-PRESCRIPTION MEMBER-EQUAL))
     (3833 1380 (:REWRITE NFIX-WHEN-NATP))
     (3806 1916
           (:TYPE-PRESCRIPTION TRUE-LISTP-OF-INSERT-TEXT))
     ...
     (1615 205
           (:REWRITE L5-STAT-CORRECTNESS-1-LEMMA-3))
     (1546 1546 (:REWRITE SUBSETP-MEMBER . 2))
     (1546 1546 (:REWRITE SUBSETP-MEMBER . 1))
...
(L5-READ-AFTER-WRITE-2
     (3201 126 (:REWRITE TAKE-OF-LEN-FREE))
     (2578 172
           (:REWRITE UNMAKE-BLOCKS-CORRECTNESS-2))
     (2441 63 (:DEFINITION TAKE))
     ...
     (629 252 (:REWRITE NFIX-WHEN-NATP))
