...
(L5-FS-P
 ...
 (64 8 (:REWRITE LENGTH-WHEN-STRINGP))
 (40 8 (:DEFINITION LEN))
...
(L5-WRCHS
 ...
 (1198 376 (:REWRITE DEFAULT-CDR))
 (1188 44 (:REWRITE MAKE-BLOCKS-CORRECTNESS-5 . 1))
 (866 294 (:TYPE-PRESCRIPTION ASSOC-WHEN-ZP-LEN))
 (660 24 (:REWRITE NTH-WHEN->=-N-LEN-L))
 (480 6 (:DEFINITION FETCH-BLOCKS-BY-INDICES))
 (452 20 (:REWRITE L4-WRCHS-CORRECTNESS-1-LEMMA-18))
 (450 50 (:REWRITE UNMAKE-BLOCKS-CORRECTNESS-2))
 (420 6 (:DEFINITION INDICES-MARKED-P))
 (408 12 (:DEFINITION NTH))
 (363 120 (:REWRITE ZP-OPEN))
 (319 209 (:REWRITE DEFAULT-<-2))
 (306 43 (:REWRITE NFIX-WHEN-ZP))
 (292 166 (:REWRITE DEFAULT-+-2))
 (274 18 (:DEFINITION L5-FS-P))
 (261 261 (:REWRITE DEFAULT-CAR))
 (260 20 (:DEFINITION COUNT-FREE-BLOCKS))
 (238 41 (:REWRITE L5-REGULAR-FILE-ENTRY-P-CORRECTNESS-3 . 2))
 (235 209 (:REWRITE DEFAULT-<-1))
 ...
 (30 30 (:TYPE-PRESCRIPTION INDICES-MARKED-P))
