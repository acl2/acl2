...
(FLATTEN-EQUIV-OF-APPEND-OF-CONS-LEMMA-1
 (6548 276 (:DEFINITION MEMBER-EQUAL))
 (3891 457 (:REWRITE NO-DUPLICATESP-OF-MEMBER))
 (3154 124 (:DEFINITION NO-DUPLICATESP-EQUAL))
 (1267 181 (:REWRITE SUBSETP-CAR-MEMBER))
 (1153 846 (:REWRITE DEFAULT-CDR))
 (1078 682 (:REWRITE DEFAULT-CAR))
 (1027 29 (:DEFINITION TRUE-LIST-LISTP))
 (923 457 (:REWRITE MEMBER-WHEN-ATOM))
 (756 84
      (:REWRITE TRUE-LISTP-WHEN-STRING-LIST))
 (652 652
      (:TYPE-PRESCRIPTION NO-DUPLICATESP-EQUAL))
 (619 619 (:REWRITE SUBSETP-MEMBER . 2))
 (619 619 (:REWRITE SUBSETP-MEMBER . 1))
 (549 42 (:DEFINITION TRUE-LISTP))
 ...
 (181 181 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
 (181 181 (:REWRITE SUBSETP-WHEN-ATOM-LEFT))
