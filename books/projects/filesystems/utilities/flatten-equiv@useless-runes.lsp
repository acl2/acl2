...
(FLATTEN-EQUIV-IMPLIES-EQUAL-NOT-INTERSECTP-LIST-2-LEMMA-1
 (3511 70 (:DEFINITION TRUE-LIST-LISTP))
 (2366 15 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
 (2281 107 (:DEFINITION MEMBER-EQUAL))
 (2163 20 (:DEFINITION INTERSECTP-EQUAL))
 (2123 112 (:DEFINITION TRUE-LISTP))
 (1926 19 (:REWRITE TRUE-LIST-LIST-FIX-WHEN-TRUE-LIST-LISTP))
 (1901 112 (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
 (1702 218 (:REWRITE TRUE-LISTP-WHEN-STRING-LIST))
 (1676 113 (:REWRITE TRUE-LIST-LISTP-OF-CDR-WHEN-TRUE-LIST-LISTP))
 (1507 45 (:REWRITE REMOVE-WHEN-ABSENT))
 (1168 218 (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
 ...
 (390 15 (:REWRITE TRUE-LIST-FIX-WHEN-TRUE-LISTP))
 ...
 (21 1 (:REWRITE EQUAL-OF-LIST-FIX-AND-SELF))
...
(FLATTEN-EQUIV-IMPLIES-EQUAL-NOT-INTERSECTP-LIST-2
 ...
 (51 1 (:REWRITE TRUE-LIST-LIST-FIX-WHEN-TRUE-LIST-LISTP))
...
(FLATTEN-EQUIV-IMPLIES-EQUAL-MEMBER-INTERSECTP-EQUAL-1-LEMMA-1
 ...
 (2707 50 (:DEFINITION TRUE-LIST-LISTP))
 (2087 87 (:DEFINITION MEMBER-EQUAL))
 (1951 13 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
 (1740 87 (:DEFINITION TRUE-LISTP))
 (1528 87 (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
 (1487 126 (:REWRITE NO-DUPLICATESP-OF-MEMBER))
 (1405 15 (:REWRITE TRUE-LIST-LIST-FIX-WHEN-TRUE-LIST-LISTP))
 (1382 174 (:REWRITE TRUE-LISTP-WHEN-STRING-LIST))
 (1313 39 (:REWRITE REMOVE-WHEN-ABSENT))
 (1248 48 (:DEFINITION NO-DUPLICATESP-EQUAL))
 (1110 76 (:REWRITE TRUE-LIST-LISTP-OF-CDR-WHEN-TRUE-LIST-LISTP))
 (929 174 (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
 ...
 (338 13 (:REWRITE TRUE-LIST-FIX-WHEN-TRUE-LISTP))
...
(FLATTEN-EQUIV-IMPLIES-EQUAL-MEMBER-INTERSECTP-EQUAL-1
 ...
 (102 2 (:REWRITE TRUE-LIST-LIST-FIX-WHEN-TRUE-LIST-LISTP))
...
(FLATTEN-EQUIV-IMPLIES-EQUAL-MEMBER-INTERSECTP-EQUAL-2
 ...
 (204 4 (:REWRITE TRUE-LIST-LIST-FIX-WHEN-TRUE-LIST-LISTP))
...
(SET-EQUIV-IMPLIES-EQUAL-TRUE-LIST-LISTP-OF-LIST-FIX-1-LEMMA-1
 ...
 (635 115 (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
...
(SET-EQUIV-IMPLIES-EQUAL-TRUE-LIST-LISTP-OF-LIST-FIX-1
 (508 5 (:DEFINITION TRUE-LIST-LISTP))
 (291 15 (:DEFINITION TRUE-LISTP))
 (240 3 (:REWRITE CDR-OF-LIST-FIX))
 (230 30 (:REWRITE TRUE-LISTP-WHEN-STRING-LIST))
 (190 5 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
 (155 30 (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
 (150 25 (:DEFINITION STRING-LISTP))
 (133 6 (:REWRITE TRUE-LIST-LISTP-OF-LIST-FIX))
 (125 125 (:TYPE-PRESCRIPTION STRING-LISTP))
 (125 5 (:REWRITE TRUE-LIST-FIX-WHEN-TRUE-LISTP))
...
(COMMUTATIVITY-2-OF-CONS-UNDER-FLATTEN-EQUIV
 ...
 (740 37 (:DEFINITION TRUE-LISTP))
 (664 14 (:REWRITE TRUE-LIST-LIST-FIX-WHEN-TRUE-LIST-LISTP))
 (611 13 (:DEFINITION TRUE-LIST-LISTP))
 (570 74 (:REWRITE TRUE-LISTP-WHEN-STRING-LIST))
 (458 14 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
 (384 74 (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
 (375 10 (:REWRITE MEMBER-OF-CONS))
 (372 62 (:DEFINITION STRING-LISTP))
 (310 310 (:TYPE-PRESCRIPTION STRING-LISTP))
 (302 14 (:REWRITE TRUE-LIST-FIX-WHEN-TRUE-LISTP))
...
(FLATTEN-EQUIV-IMPLIES-FLATTEN-EQUIV-APPEND-2
 ...
 (256 6 (:REWRITE TRUE-LIST-LIST-FIX-WHEN-TRUE-LIST-LISTP))
 (235 5 (:DEFINITION TRUE-LIST-LISTP))
...
(FLATTEN-EQUIV-OF-REMOVE-OF-NIL
 (5217 110 (:DEFINITION TRUE-LIST-LISTP))
 (5090 57 (:REWRITE TRUE-LIST-LIST-FIX-WHEN-TRUE-LIST-LISTP))
 (3698 200 (:DEFINITION MEMBER-EQUAL))
 (2392 118 (:DEFINITION TRUE-LISTP))
 (2020 236 (:REWRITE TRUE-LISTP-WHEN-STRING-LIST))
 (1471 152 (:REWRITE TRUE-LIST-LISTP-OF-CDR-WHEN-TRUE-LIST-LISTP))
 (1415 236 (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
 (1338 223 (:DEFINITION STRING-LISTP))
 (1115 1115 (:TYPE-PRESCRIPTION STRING-LISTP))
 (1034 698 (:REWRITE DEFAULT-CAR))
 (999 16 (:REWRITE TRUE-LIST-LISTP-OF-REMOVE))
 (985 826 (:REWRITE DEFAULT-CDR))
 (782 116 (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
 (753 8 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
 ...
 (131 7 (:REWRITE TRUE-LIST-FIX-WHEN-TRUE-LISTP))
...
(FLATTEN-EQUIV-OF-CONS-WHEN-ATOM
 ...
 (53 3 (:REWRITE TRUE-LIST-LIST-FIX-WHEN-TRUE-LIST-LISTP))
 (47 1 (:DEFINITION TRUE-LIST-LISTP))
...
(FLATTEN-EQUIV-IMPLIES-FLATTEN-EQUIV-CONS-2
 ...
 (408 8 (:REWRITE TRUE-LIST-LIST-FIX-WHEN-TRUE-LIST-LISTP))
 (376 8 (:DEFINITION TRUE-LIST-LISTP))
 (280 14 (:DEFINITION TRUE-LISTP))
 (228 28 (:REWRITE TRUE-LISTP-WHEN-STRING-LIST))
 (153 28 (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
 (150 25 (:DEFINITION STRING-LISTP))
 (131 73 (:REWRITE DEFAULT-CAR))
 (125 125 (:TYPE-PRESCRIPTION STRING-LISTP))
 (120 120 (:TYPE-PRESCRIPTION MEMBER-EQUAL))
 (115 4 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
 (112 90 (:REWRITE DEFAULT-CDR))
 (102 48 (:REWRITE MEMBER-WHEN-ATOM))
 (82 2 (:REWRITE MEMBER-OF-CONS))
 (76 4 (:REWRITE TRUE-LIST-FIX-WHEN-TRUE-LISTP))
