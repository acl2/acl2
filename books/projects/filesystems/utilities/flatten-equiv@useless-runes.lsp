...
(FLATTEN-EQUIV-OF-REMOVE-OF-NIL
 ...
 (2023 237
       (:REWRITE TRUE-LISTP-WHEN-STRING-LIST))
 (1653 119 (:DEFINITION TRUE-LISTP))
 (1339 224 (:DEFINITION STRING-LISTP))
 (1187 152
       (:REWRITE TRUE-LIST-LISTP-OF-CDR-WHEN-TRUE-LIST-LISTP))
 (1116 1116 (:TYPE-PRESCRIPTION STRING-LISTP))
 (1034 698 (:REWRITE DEFAULT-CAR))
 (985 826 (:REWRITE DEFAULT-CDR))
 (769 16 (:REWRITE TRUE-LIST-LISTP-OF-REMOVE))
 (638 116
      (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
 (555 9 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
 (483 483 (:TYPE-PRESCRIPTION TRUE-LISTP))
 (436 399 (:REWRITE NO-DUPLICATESP-OF-MEMBER))
 (405 405 (:REWRITE INTERSECTP-MEMBER . 3))
 (405 405 (:REWRITE INTERSECTP-MEMBER . 2))
