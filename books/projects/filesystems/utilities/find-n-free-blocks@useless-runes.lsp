...
(FIND-N-FREE-BLOCKS-HELPER-CORRECTNESS-2
     ...
     (13 2 (:REWRITE PAINFUL-DEBUGGING-LEMMA-22))
     (6 2 (:DEFINITION NATP))
...
(FIND-N-FREE-BLOCKS-HELPER-CORRECTNESS-4
     ...
     (104 28 (:REWRITE SUBSETP-MEMBER . 1))
...
(COUNT-FREE-BLOCKS-ALT-CORRECTNESS-1
     (1400 47 (:REWRITE NTH-WHEN->=-N-LEN-L))
...
(COUNT-FREE-BLOCKS-ALT-CORRECTNESS-2
     (253 2 (:DEFINITION COUNT-FREE-BLOCKS-ALT))
