...
(L5-RDCHS (264 4 (:DEFINITION FETCH-BLOCKS-BY-INDICES))
          (209 20
               (:REWRITE L5-REGULAR-FILE-ENTRY-P-CORRECTNESS-3
                         . 2))
...
(L5-WRCHS (1028 20
          ...
          (972 18 (:DEFINITION INDICES-MARKED-P))
          (936 48 (:REWRITE NTH-WHEN->=-N-LEN-L))
          (810 274
               (:TYPE-PRESCRIPTION ASSOC-WHEN-ZP-LEN))
...
(L5-WRCHS-RETURNS-FS-LEMMA-2
     ...
     (858 44 (:REWRITE NTH-WHEN->=-N-LEN-L))
     (832 13
          (:DEFINITION FETCH-BLOCKS-BY-INDICES))
     (724 13 (:DEFINITION UNMAKE-BLOCKS))
     (572 22 (:DEFINITION NTH))
     (516 12
          (:REWRITE L4-WRCHS-CORRECTNESS-1-LEMMA-18))
     (486 9 (:DEFINITION INDICES-MARKED-P))
...
(L5-WRCHS-RETURNS-FS (1143 381
                     ...
                     (663 34 (:REWRITE NTH-WHEN->=-N-LEN-L))
                     (588 4 (:DEFINITION SET-INDICES))
                     (576 9 (:DEFINITION FETCH-BLOCKS-BY-INDICES))
                     (480 9 (:DEFINITION UNMAKE-BLOCKS))
                     (457 9
                          (:REWRITE L4-WRCHS-CORRECTNESS-1-LEMMA-18))
                     (442 17 (:DEFINITION NTH))
                     (432 8 (:DEFINITION INDICES-MARKED-P))
...
(L5-WRCHS-CORRECTNESS-1-LEMMA-2
     (14305 257 (:DEFINITION INDICES-MARKED-P))
     (11221 514 (:REWRITE NTH-WHEN->=-N-LEN-L))
     (7024 257 (:DEFINITION NTH))
...
(L5-WRCHS-CORRECTNESS-1
     ...
     (14859 762 (:REWRITE NTH-WHEN->=-N-LEN-L))
     (12864 201
            (:DEFINITION FETCH-BLOCKS-BY-INDICES))
     (12737 901
            (:REWRITE UNMAKE-BLOCKS-CORRECTNESS-2))
     ...
     (10620 180
            (:REWRITE L4-WRCHS-CORRECTNESS-1-LEMMA-18))
     (9906 381 (:DEFINITION NTH))
     (9720 180 (:DEFINITION INDICES-MARKED-P))
...
(L5-RDCHS-CORRECTNESS-1-LEMMA-2
     ...
     (451 22 (:REWRITE NTH-WHEN->=-N-LEN-L))
...
(L5-RDCHS-CORRECTNESS-1
     (4440 74 (:DEFINITION L5-STAT))
     (2589 185
           (:REWRITE L5-REGULAR-FILE-ENTRY-P-CORRECTNESS-3
                     . 2))
     (1949 120 (:DEFINITION LEN))
     (1913 1182 (:REWRITE DEFAULT-CDR))
     (1800 128 (:DEFINITION L5-FS-P))
     (1450 6 (:REWRITE L5-STAT-CORRECTNESS-2 . 1))
     (1136 12 (:REWRITE INSERT-TEXT-CORRECTNESS-4))
     (1074 1023 (:REWRITE DEFAULT-CAR))
     (988 76 (:REWRITE ASSOC-OF-CAR-WHEN-MEMBER))
     (881 12 (:REWRITE DEFAULT-COERCE-1))
     (850 170 (:DEFINITION ASSOC-EQUAL))
     (838 78 (:REWRITE L5-FS-P-ASSOC))
     (798 13 (:DEFINITION TAKE))
     (640 2 (:DEFINITION L3-STAT))
     (608 76 (:DEFINITION MEMBER-EQUAL))
     (594 9 (:DEFINITION FETCH-BLOCKS-BY-INDICES))
     (578 9 (:DEFINITION UNMAKE-BLOCKS))
     (577 36
          (:REWRITE UNMAKE-BLOCKS-CORRECTNESS-2))
     (541 26 (:REWRITE NTH-WHEN->=-N-LEN-L))
     (503 13 (:DEFINITION NTH))
     (500 26 (:REWRITE TAKE-OF-LEN-FREE))
     (486 162
          (:TYPE-PRESCRIPTION ASSOC-WHEN-ZP-LEN))
     (380 380 (:TYPE-PRESCRIPTION MEMBER-EQUAL))
     (371 4 (:REWRITE CAR-OF-NTHCDR))
...
(L5-WRCHS-RETURNS-DISK
     ...
     (1715 86 (:REWRITE NTH-WHEN->=-N-LEN-L))
     (1656 30 (:DEFINITION INDICES-MARKED-P))
     (1605 1025 (:REWRITE DEFAULT-CAR))
     (1302 434
           (:TYPE-PRESCRIPTION ASSOC-WHEN-ZP-LEN))
     (1176 8 (:DEFINITION SET-INDICES))
     (1135 43 (:DEFINITION NTH))
     (1122 17 (:DEFINITION INDICES-MARKED-LISTP))
     (834 13
          (:DEFINITION FETCH-BLOCKS-BY-INDICES))
     (744 14
          (:REWRITE L4-WRCHS-CORRECTNESS-1-LEMMA-18))
...
(L5-READ-AFTER-WRITE-1-LEMMA-1
     ...
     (7215 370 (:REWRITE NTH-WHEN->=-N-LEN-L))
     (6080 95
           (:DEFINITION FETCH-BLOCKS-BY-INDICES))
     (5510 95 (:DEFINITION UNMAKE-BLOCKS))
     (5147 107
           (:REWRITE L4-WRCHS-CORRECTNESS-1-LEMMA-18))
     (4860 90 (:DEFINITION INDICES-MARKED-P))
     (4810 185 (:DEFINITION NTH))
     (4648 346
           (:REWRITE UNMAKE-BLOCKS-CORRECTNESS-2))
     ...
     (2317 1666 (:REWRITE DEFAULT-<-2))
     (2272 2070 (:REWRITE DEFAULT-+-1))
     (2052 228
           (:REWRITE UNMAKE-BLOCKS-CORRECTNESS-1))
     (1844 1666 (:REWRITE DEFAULT-<-1))
...
(L5-READ-AFTER-WRITE-1-LEMMA-2
     ...
     (9750 500 (:REWRITE NTH-WHEN->=-N-LEN-L))
     (8256 129
           (:DEFINITION FETCH-BLOCKS-BY-INDICES))
     (6920 144
           (:REWRITE L4-WRCHS-CORRECTNESS-1-LEMMA-18))
     ...
     (6770 498
           (:REWRITE UNMAKE-BLOCKS-CORRECTNESS-2))
     (6534 121 (:DEFINITION INDICES-MARKED-P))
     (6500 250 (:DEFINITION NTH))
     ...
     (3199 2298 (:REWRITE DEFAULT-<-2))
     (3121 2848 (:REWRITE DEFAULT-+-1))
     (2898 322
           (:REWRITE UNMAKE-BLOCKS-CORRECTNESS-1))
     (2572 643 (:REWRITE ZP-OPEN))
     (2540 2298 (:REWRITE DEFAULT-<-1))
     (2388 808
           (:REWRITE REMOVE1-ASSOC-WHEN-ABSENT . 1))
...
(L5-READ-AFTER-WRITE-1-LEMMA-3
     ...
     (156 8 (:REWRITE NTH-WHEN->=-N-LEN-L))
     (142 10
          (:REWRITE UNMAKE-BLOCKS-CORRECTNESS-2))
     (142 10 (:DEFINITION L5-FS-P))
     (128 2 (:DEFINITION FETCH-BLOCKS-BY-INDICES))
     (116 2 (:DEFINITION UNMAKE-BLOCKS))
     (114 2
          (:REWRITE L4-WRCHS-CORRECTNESS-1-LEMMA-18))
     (108 2 (:DEFINITION INDICES-MARKED-P))
...
(L5-READ-AFTER-WRITE-1
     (121162 157 (:DEFINITION L5-WRCHS))
     (86244 2584
            (:REWRITE INSERT-TEXT-CORRECTNESS-4))
     (73646 29446 (:REWRITE DEFAULT-CDR))
     (68152 1286
            (:REWRITE MAKE-BLOCKS-CORRECTNESS-5 . 1))
     (56576 210 (:DEFINITION SET-INDICES))
     (54439 53 (:DEFINITION L4-WRCHS))
     (53725 24865 (:REWRITE DEFAULT-CAR))
     (44308 721 (:DEFINITION L5-STAT))
     (41479 2762
            (:REWRITE L5-REGULAR-FILE-ENTRY-P-CORRECTNESS-3
                      . 2))
     (39042 1203
            (:REWRITE UNMAKE-BLOCKS-CORRECTNESS-2))
     (22954 305 (:DEFINITION TAKE))
     (21708 1030 (:REWRITE NTH-WHEN->=-N-LEN-L))
     (21560 515 (:DEFINITION NTH))
     (18032 210
            (:REWRITE FIND-N-FREE-BLOCKS-CORRECTNESS-2))
     (17996 277
            (:DEFINITION FETCH-BLOCKS-BY-INDICES))
     (17227 749 (:DEFINITION L5-TO-L4-FS))
     (16750 9143 (:REWRITE DEFAULT-+-2))
     (16726 277 (:DEFINITION UNMAKE-BLOCKS))
     (16359 2763 (:REWRITE DEFAULT-COERCE-1))
     (16065 46 (:DEFINITION L3-STAT))
     (15690 3138 (:DEFINITION ASSOC-EQUAL))
     (14138 610 (:REWRITE TAKE-OF-LEN-FREE))
     (12701 977 (:REWRITE ASSOC-OF-CAR-WHEN-MEMBER))
     (12362 210
            (:REWRITE L4-WRCHS-CORRECTNESS-1-LEMMA-18))
     (11708 1030 (:REWRITE L5-FS-P-ASSOC))
     (11340 210 (:DEFINITION INDICES-MARKED-P))
     (10857 661 (:DEFINITION CHARACTER-LISTP))
     (10810 28 (:REWRITE CAR-OF-NTHCDR))
     (10412 6799 (:REWRITE DEFAULT-<-2))
     (9716 9143 (:REWRITE DEFAULT-+-1))
     (8973 997 (:DEFINITION REMOVE1-ASSOC-EQUAL))
     (8550 2850
           (:TYPE-PRESCRIPTION ASSOC-WHEN-ZP-LEN))
     (7816 977 (:DEFINITION MEMBER-EQUAL))
     (7632 212
           (:REWRITE L5-WRCHS-CORRECTNESS-1-LEMMA-1))
     (7341 25 (:REWRITE L5-STAT-CORRECTNESS-2 . 1))
     (7340 6799 (:REWRITE DEFAULT-<-1))
     ...
     (5120 76
           (:REWRITE L5-STAT-CORRECTNESS-2-LEMMA-1))
     (4885 4885 (:TYPE-PRESCRIPTION MEMBER-EQUAL))
     (4601 997
           (:REWRITE L2-READ-AFTER-WRITE-1-LEMMA-1))
     (4126 440
           (:REWRITE L5-WRCHS-CORRECTNESS-1-LEMMA-7))
     (3883 28 (:DEFINITION NTHCDR))
     (3836 1380 (:REWRITE NFIX-WHEN-NATP))
     (2873 223 (:DEFINITION COUNT-FREE-BLOCKS))
     (2850 2850 (:TYPE-PRESCRIPTION ZP))
     (2842 2842 (:REWRITE DEFAULT-COERCE-2))
     (2764 76
           (:REWRITE L5-STAT-CORRECTNESS-1-LEMMA-4))
     (2674 2674 (:LINEAR POSITION-WHEN-MEMBER))
     (2674 2674
           (:LINEAR POSITION-EQUAL-AC-WHEN-MEMBER))
     (2465 56 (:REWRITE NTHCDR-WHEN->=-N-LEN-L))
     (2360 28 (:REWRITE CONSP-OF-TAKE))
     (2312 2312 (:TYPE-PRESCRIPTION NATP))
     (2310 210 (:DEFINITION MIN))
     (2230 28 (:REWRITE LEN-OF-NTHCDR))
     ...
     (1898 28 (:REWRITE CONSP-OF-NTHCDR))
     (1615 205
           (:REWRITE L5-STAT-CORRECTNESS-1-LEMMA-3))
...
(L5-READ-AFTER-WRITE-2-LEMMA-5
     ...
     (35685 1830 (:REWRITE NTH-WHEN->=-N-LEN-L))
     (35264 551
            (:DEFINITION FETCH-BLOCKS-BY-INDICES))
     (32060 554 (:DEFINITION UNMAKE-BLOCKS))
     (23790 915 (:DEFINITION NTH))
     (23760 1707
            (:REWRITE UNMAKE-BLOCKS-CORRECTNESS-2))
     (21484 376
            (:REWRITE L4-WRCHS-CORRECTNESS-1-LEMMA-18))
     (19656 364 (:DEFINITION INDICES-MARKED-P))
     ...
     (13732 9684 (:REWRITE DEFAULT-<-2))
     (12106 11022 (:REWRITE DEFAULT-+-1))
     (10716 9684 (:REWRITE DEFAULT-<-1))
     (9793 1069
           (:REWRITE UNMAKE-BLOCKS-CORRECTNESS-1))
...
(L5-READ-AFTER-WRITE-2-LEMMA-8
     ...
     (3608 42
           (:REWRITE FIND-N-FREE-BLOCKS-CORRECTNESS-2))
     (3276 168 (:REWRITE NTH-WHEN->=-N-LEN-L))
     (2982 210
           (:REWRITE UNMAKE-BLOCKS-CORRECTNESS-2))
     (2688 42
           (:DEFINITION FETCH-BLOCKS-BY-INDICES))
...
(L5-READ-AFTER-WRITE-2
     (2775 126 (:REWRITE TAKE-OF-LEN-FREE))
     (2424 160
           (:REWRITE UNMAKE-BLOCKS-CORRECTNESS-2))
     (2255 63 (:DEFINITION TAKE))
     (1389 63 (:REWRITE LEN-OF-NTHCDR))
