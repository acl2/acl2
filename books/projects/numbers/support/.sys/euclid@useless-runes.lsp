...
(DM::DIVIDES-MOD-EQUAL
 (1371132 1371132 (:TYPE-PRESCRIPTION NOT-INTEGERP-3B))
 (1371132 1371132 (:TYPE-PRESCRIPTION NOT-INTEGERP-2B))
 (1371132 1371132 (:TYPE-PRESCRIPTION NOT-INTEGERP-1B))
 (1067174 396814 (:TYPE-PRESCRIPTION MOD-ZERO . 2))
 (766094 396513 (:TYPE-PRESCRIPTION RTL::NATP-MOD))
 (760351 25159 (:REWRITE MOD-X-Y-=-X . 4))
 (759941 25159 (:REWRITE MOD-X-Y-=-X . 3))
 (625184 25159 (:REWRITE RTL::MOD-DOES-NOTHING))
 (446544 25159 (:REWRITE CANCEL-MOD-+))
 (431518 2339 (:REWRITE MOD-X-Y-=-X-Y . 1))
 (416435 25165 (:REWRITE MOD-X-Y-=-X+Y . 2))
 (399746 25165 (:REWRITE MOD-X-Y-=-X-Y . 2))
 (396513 396513 (:TYPE-PRESCRIPTION RTL::NATP-MOD-2))
 (396513 396513 (:TYPE-PRESCRIPTION INTEGERP-MOD-2))
 (396513 396513 (:TYPE-PRESCRIPTION INTEGERP-MOD-1))
 (396513 396513 (:TYPE-PRESCRIPTION RTL::INTEGERP-MOD))
 (394984 394984 (:TYPE-PRESCRIPTION MOD-ZERO . 3))
 (387071 25165 (:REWRITE MOD-X-Y-=-X+Y . 3))
 (369581 369581 (:TYPE-PRESCRIPTION NATP))
 (365117 25165 (:REWRITE MOD-X-Y-=-X-Y . 3))
 (343254 40204 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
 (340442 25165 (:REWRITE MOD-ZERO . 4))
 (338094 305820 (:REWRITE DEFAULT-TIMES-2))
 (337960 337960 (:TYPE-PRESCRIPTION MOD-NEGATIVE . 1))
 (336126 336126 (:TYPE-PRESCRIPTION MOD-POSITIVE . 1))
 (329275 44077 (:REWRITE REDUCE-RATIONALP-*))
 (323414 323414 (:TYPE-PRESCRIPTION NOT-INTEGERP-3A))
 (257476 48012 (:REWRITE RATIONALP-X))
 (218799 2339 (:REWRITE MOD-X-Y-=-X+Y . 1))
 (213332 213332 (:TYPE-PRESCRIPTION RTL::RATIONALP-MOD))
 (192405 130585 (:REWRITE DEFAULT-PLUS-2))
 (171066 164987 (:REWRITE DEFAULT-LESS-THAN-1))
 (168890 161762 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-<))
 (165737 165737 (:REWRITE THE-FLOOR-BELOW))
 (165737 165737 (:REWRITE THE-FLOOR-ABOVE))
 (165026 161762 (:REWRITE PREFER-POSITIVE-ADDENDS-<))
 (164338 164338 (:REWRITE REDUCE-RATIONAL-MULTIPLICATIVE-CONSTANT-<))
 (164338 164338 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-<))
 (163710 163710 (:REWRITE INTEGERP-<-CONSTANT))
 (163710 163710 (:REWRITE CONSTANT-<-INTEGERP))
 (163710 163710 (:REWRITE |(< c (/ x)) positive c --- present in goal|))
 (163710 163710 (:REWRITE |(< c (/ x)) positive c --- obj t or nil|))
 (163710 163710 (:REWRITE |(< c (/ x)) negative c --- present in goal|))
 (163710 163710 (:REWRITE |(< c (/ x)) negative c --- obj t or nil|))
 (163710 163710 (:REWRITE |(< c (- x))|))
 (163710 163710 (:REWRITE |(< (/ x) c) positive c --- present in goal|))
 (163710 163710 (:REWRITE |(< (/ x) c) positive c --- obj t or nil|))
 (163710 163710 (:REWRITE |(< (/ x) c) negative c --- present in goal|))
 (163710 163710 (:REWRITE |(< (/ x) c) negative c --- obj t or nil|))
 (163710 163710 (:REWRITE |(< (/ x) (/ y))|))
 (163710 163710 (:REWRITE |(< (- x) c)|))
 (163710 163710 (:REWRITE |(< (- x) (- y))|))
 (137666 137666 (:REWRITE NORMALIZE-FACTORS-GATHER-EXPONENTS))
 (132028 11030 (:DEFINITION RFIX))
 (115072 40204 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
 (100139 100139 (:REWRITE NORMALIZE-TERMS-SUCH-AS-1/AX+BX))
 (99941 38752 (:REWRITE SIMPLIFY-SUMS-EQUAL))
 (77906 77906 (:META META-INTEGERP-CORRECT))
 (58718 8270 (:REWRITE ACL2-NUMBERP-X))
 (57840 25159 (:REWRITE MOD-X-Y-=-X . 2))
 (57840 25159 (:REWRITE |(mod (+ x (mod a b)) y)|))
 (57840 25159 (:REWRITE |(mod (+ x (- (mod a b))) y)|))
 (56779 56779 (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
 (56463 56463 (:REWRITE |(< (* x y) 0)|))
 (56051 56051 (:REWRITE |(< (/ x) 0)|))
 (55405 55405 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-<-0-RATIONAL-REMAINDER))
 (55405 55405 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-<-0-RATIONAL-COMMON))
 (51495 50527 (:REWRITE |(< 0 (* x y))|))
 (50527 50527 (:REWRITE |(< 0 (/ x))|))
 (49799 49799 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-REMAINDER))
 (49799 49799 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-COMMON))
 (47531 25159 (:REWRITE MOD-CANCEL-*-REWRITING-GOAL-LITERAL))
 (47531 25159 (:REWRITE |(mod x (* y (/ z))) rewriting-goal-literal|))
 (47531 25159 (:REWRITE |(mod (* x (/ y)) z) rewriting-goal-literal|))
 (44077 44077 (:REWRITE RATIONALP-MINUS-X))
 (42937 42937 (:META META-RATIONALP-CORRECT))
 (42619 40365 (:REWRITE |(equal (/ x) c)|))
 (42431 25159 (:REWRITE MOD-CANCEL-*-CONST))
 (40365 40365 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-EQUAL))
 (40365 40365 (:REWRITE REDUCE-ADDITIVE-CONSTANT-EQUAL))
 (40365 40365 (:REWRITE |(equal c (/ x))|))
 (40365 40365 (:REWRITE |(equal (/ x) (/ y))|))
 (40365 40365 (:REWRITE |(equal (- x) (- y))|))
 (40204 40204 (:REWRITE EQUAL-OF-PREDICATES-REWRITE))
 (40204 40204 (:REWRITE |(equal c (- x))|))
 (40204 40204 (:REWRITE |(equal (- x) c)|))
 (35415 3935 (:REWRITE RATIONALP-/))
 (34852 34852 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-=-0))
 (28462 28462 (:REWRITE |(- (* c x))|))
 (25159 25159 (:REWRITE MOD-CANCEL-*-NOT-REWRITING-GOAL-LITERAL))
 (25159 25159 (:REWRITE |(mod x (- y))| . 3))
 (25159 25159 (:REWRITE |(mod x (- y))| . 2))
 (25159 25159 (:REWRITE |(mod x (- y))| . 1))
 (25159 25159 (:REWRITE |(mod x (* y (/ z))) not rewriting-goal-literal|))
 (25159 25159 (:REWRITE |(mod (- x) y)| . 3))
 (25159 25159 (:REWRITE |(mod (- x) y)| . 2))
 (25159 25159 (:REWRITE |(mod (- x) y)| . 1))
 (25159 25159 (:REWRITE |(mod (* x (/ y)) z) not rewriting-goal-literal|))
 (11136 11136 (:TYPE-PRESCRIPTION BUBBLE-DOWN))
 ...
 (6971 2191 (:REWRITE |(equal (mod (+ x y) z) x)|))
 (5053 5053 (:REWRITE |(< (+ c/d x) y)|))
 (4641 4641 (:REWRITE |(< (+ (- c) x) y)|))
 (4595 4595 (:REWRITE INTEGERP-+-REDUCE-CONSTANT))
 ...
 (4165 4165 (:LINEAR RTL::MOD-BND-3))
 (3935 3935 (:REWRITE INTEGERP-/))
 (3843 507 (:REWRITE RATIONALP-MOD))
 (3639 3639 (:REWRITE |(equal (+ (- c) x) y)|))
 (3351 715 (:REWRITE MOD-ZERO . 2))
 ...
 (2592 507 (:REWRITE RTL::RATIONALP-MOD))
 (1940 1940 (:REWRITE FOLD-CONSTS-IN-+))
 (1758 507 (:REWRITE INTEGERP-MOD-2))
 (1758 507 (:REWRITE INTEGERP-MOD-1))
 (1758 507 (:REWRITE RTL::INTEGERP-MOD))
 ...
 (1064 1064 (:REWRITE |(not (equal x (/ y)))|))
...
(DM::G-C-D-POS
 (1099 17 (:DEFINITION DM::G-C-D-NAT))
...
(DM::DIVIDES-G-C-D-NAT
 ...
 (3 3 (:TYPE-PRESCRIPTION DM::G-C-D-NAT))
 (2 2 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-=-0))
 )
(DM::G-C-D-DIVIDES
