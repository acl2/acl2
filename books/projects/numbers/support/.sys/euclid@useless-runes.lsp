...
(DM::DIVIDES-MOD-EQUAL
 (1365311 1365311 (:TYPE-PRESCRIPTION NOT-INTEGERP-3B))
 (1365311 1365311 (:TYPE-PRESCRIPTION NOT-INTEGERP-2B))
 (1365311 1365311 (:TYPE-PRESCRIPTION NOT-INTEGERP-1B))
 (1063020 397364 (:TYPE-PRESCRIPTION MOD-ZERO . 2))
 (765528 25326 (:REWRITE MOD-X-Y-=-X . 4))
 (765118 25326 (:REWRITE MOD-X-Y-=-X . 3))
 (765061 396026 (:TYPE-PRESCRIPTION RTL::NATP-MOD))
 (629526 25326 (:REWRITE RTL::MOD-DOES-NOTHING))
 (449583 25326 (:REWRITE CANCEL-MOD-+))
 (437812 26445 (:REWRITE MOD-X-Y-=-X+Y . 2))
 (436660 2361 (:REWRITE MOD-X-Y-=-X-Y . 1))
 (420907 26445 (:REWRITE MOD-X-Y-=-X-Y . 2))
 (408448 26445 (:REWRITE MOD-X-Y-=-X+Y . 3))
 (396026 396026 (:TYPE-PRESCRIPTION RTL::NATP-MOD-2))
 (396026 396026 (:TYPE-PRESCRIPTION INTEGERP-MOD-2))
 (396026 396026 (:TYPE-PRESCRIPTION INTEGERP-MOD-1))
 (396026 396026 (:TYPE-PRESCRIPTION RTL::INTEGERP-MOD))
 (395534 395534 (:TYPE-PRESCRIPTION MOD-ZERO . 3))
 (386278 26445 (:REWRITE MOD-X-Y-=-X-Y . 3))
 (369035 369035 (:TYPE-PRESCRIPTION NATP))
 (351238 26445 (:REWRITE MOD-ZERO . 4))
 (347606 41317 (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
 (345350 313036 (:REWRITE DEFAULT-TIMES-2))
 (338510 338510 (:TYPE-PRESCRIPTION MOD-NEGATIVE . 1))
 (336676 336676 (:TYPE-PRESCRIPTION MOD-POSITIVE . 1))
 (332149 44609 (:REWRITE REDUCE-RATIONALP-*))
 (321491 321491 (:TYPE-PRESCRIPTION NOT-INTEGERP-3A))
 (260791 48593 (:REWRITE RATIONALP-X))
 (221304 2361 (:REWRITE MOD-X-Y-=-X+Y . 1))
 (214835 214835 (:TYPE-PRESCRIPTION RTL::RATIONALP-MOD))
 (194885 132954 (:REWRITE DEFAULT-PLUS-2))
 (174839 168760 (:REWRITE DEFAULT-LESS-THAN-1))
 (174415 165535 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-<))
 (169510 169510 (:REWRITE THE-FLOOR-BELOW))
 (169510 169510 (:REWRITE THE-FLOOR-ABOVE))
 (168799 165535 (:REWRITE PREFER-POSITIVE-ADDENDS-<))
 (168111 168111 (:REWRITE REDUCE-RATIONAL-MULTIPLICATIVE-CONSTANT-<))
 (168111 168111 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-<))
 (167483 167483 (:REWRITE INTEGERP-<-CONSTANT))
 (167483 167483 (:REWRITE CONSTANT-<-INTEGERP))
 (167483 167483 (:REWRITE |(< c (/ x)) positive c --- present in goal|))
 (167483 167483 (:REWRITE |(< c (/ x)) positive c --- obj t or nil|))
 (167483 167483 (:REWRITE |(< c (/ x)) negative c --- present in goal|))
 (167483 167483 (:REWRITE |(< c (/ x)) negative c --- obj t or nil|))
 (167483 167483 (:REWRITE |(< c (- x))|))
 (167483 167483 (:REWRITE |(< (/ x) c) positive c --- present in goal|))
 (167483 167483 (:REWRITE |(< (/ x) c) positive c --- obj t or nil|))
 (167483 167483 (:REWRITE |(< (/ x) c) negative c --- present in goal|))
 (167483 167483 (:REWRITE |(< (/ x) c) negative c --- obj t or nil|))
 (167483 167483 (:REWRITE |(< (/ x) (/ y))|))
 (167483 167483 (:REWRITE |(< (- x) c)|))
 (167483 167483 (:REWRITE |(< (- x) (- y))|))
 (140486 140486 (:REWRITE NORMALIZE-FACTORS-GATHER-EXPONENTS))
 (133108 11144 (:DEFINITION RFIX))
 (116710 41317 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
 (102803 102803 (:REWRITE NORMALIZE-TERMS-SUCH-AS-1/AX+BX))
 (101490 39851 (:REWRITE SIMPLIFY-SUMS-EQUAL))
 (78908 78908 (:META META-INTEGERP-CORRECT))
 (60185 8481 (:REWRITE ACL2-NUMBERP-X))
 (58215 25326 (:REWRITE MOD-X-Y-=-X . 2))
 (58215 25326 (:REWRITE |(mod (+ x (mod a b)) y)|))
 (58215 25326 (:REWRITE |(mod (+ x (- (mod a b))) y)|))
 (58080 58080 (:REWRITE |(< (* x y) 0)|))
 (57668 57668 (:REWRITE |(< (/ x) 0)|))
 (57022 57022 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-<-0-RATIONAL-REMAINDER))
 (57022 57022 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-<-0-RATIONAL-COMMON))
 (56985 56985 (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
 (53194 52226 (:REWRITE |(< 0 (* x y))|))
 (52226 52226 (:REWRITE |(< 0 (/ x))|))
 (51498 51498 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-REMAINDER))
 (51498 51498 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-COMMON))
 (47698 25326 (:REWRITE MOD-CANCEL-*-REWRITING-GOAL-LITERAL))
 (47698 25326 (:REWRITE |(mod x (* y (/ z))) rewriting-goal-literal|))
 (47698 25326 (:REWRITE |(mod (* x (/ y)) z) rewriting-goal-literal|))
 (44827 41551 (:REWRITE |(equal (/ x) c)|))
 (44609 44609 (:REWRITE RATIONALP-MINUS-X))
 (43469 43469 (:META META-RATIONALP-CORRECT))
 (42598 25326 (:REWRITE MOD-CANCEL-*-CONST))
 (41551 41551 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-EQUAL))
 (41551 41551 (:REWRITE REDUCE-ADDITIVE-CONSTANT-EQUAL))
 (41551 41551 (:REWRITE |(equal c (/ x))|))
 (41551 41551 (:REWRITE |(equal (/ x) (/ y))|))
 (41551 41551 (:REWRITE |(equal (- x) (- y))|))
 (41317 41317 (:REWRITE EQUAL-OF-PREDICATES-REWRITE))
 (41317 41317 (:REWRITE |(equal c (- x))|))
 (41317 41317 (:REWRITE |(equal (- x) c)|))
 (35897 35897 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-=-0))
 (35856 3984 (:REWRITE RATIONALP-/))
 (28621 28621 (:REWRITE |(- (* c x))|))
 (25326 25326 (:REWRITE MOD-CANCEL-*-NOT-REWRITING-GOAL-LITERAL))
 (25326 25326 (:REWRITE |(mod x (- y))| . 3))
 (25326 25326 (:REWRITE |(mod x (- y))| . 2))
 (25326 25326 (:REWRITE |(mod x (- y))| . 1))
 (25326 25326 (:REWRITE |(mod x (* y (/ z))) not rewriting-goal-literal|))
 (25326 25326 (:REWRITE |(mod (- x) y)| . 3))
 (25326 25326 (:REWRITE |(mod (- x) y)| . 2))
 (25326 25326 (:REWRITE |(mod (- x) y)| . 1))
 (25326 25326 (:REWRITE |(mod (* x (/ y)) z) not rewriting-goal-literal|))
 (11442 11442 (:TYPE-PRESCRIPTION BUBBLE-DOWN))
 (10782 1198 (:REWRITE |(<= 1 (* x (/ y))) with (< y 0)|))
 (10782 1198 (:REWRITE |(<= 1 (* x (/ y))) with (< 0 y)|))
 (10782 1198 (:REWRITE |(< (* x (/ y)) 1) with (< y 0)|))
 (10782 1198 (:REWRITE |(< (* x (/ y)) 1) with (< 0 y)|))
 (7105 2213 (:REWRITE |(equal (mod (+ x y) z) x)|))
 (5126 5126 (:REWRITE |(< (+ c/d x) y)|))
 (4714 4714 (:REWRITE |(< (+ (- c) x) y)|))
 (4601 4601 (:REWRITE INTEGERP-+-REDUCE-CONSTANT))
 (4299 2235 (:TYPE-PRESCRIPTION FLOOR-ZERO . 2))
 (4299 2235 (:TYPE-PRESCRIPTION FLOOR-POSITIVE . 1))
 (4299 2235 (:TYPE-PRESCRIPTION FLOOR-NONPOSITIVE . 1))
 (4299 2235 (:TYPE-PRESCRIPTION FLOOR-NONNEGATIVE . 1))
 (4299 2235 (:TYPE-PRESCRIPTION FLOOR-NEGATIVE . 1))
 (4253 4253 (:LINEAR RTL::MOD-BND-3))
 (3984 3984 (:REWRITE INTEGERP-/))
 (3861 509 (:REWRITE RATIONALP-MOD))
 (3679 3679 (:REWRITE |(equal (+ (- c) x) y)|))
 (3379 717 (:REWRITE MOD-ZERO . 2))
 (3279 2235 (:TYPE-PRESCRIPTION FLOOR-ZERO . 4))
 (3279 2235 (:TYPE-PRESCRIPTION FLOOR-ZERO . 3))
 (3279 2235 (:TYPE-PRESCRIPTION FLOOR-ZERO . 1))
 (3279 2235 (:TYPE-PRESCRIPTION FLOOR-POSITIVE . 3))
 (3279 2235 (:TYPE-PRESCRIPTION FLOOR-POSITIVE . 2))
 (3279 2235 (:TYPE-PRESCRIPTION FLOOR-NONPOSITIVE . 3))
 (3279 2235 (:TYPE-PRESCRIPTION FLOOR-NONPOSITIVE . 2))
 (3279 2235 (:TYPE-PRESCRIPTION FLOOR-NONNEGATIVE . 3))
 (3279 2235 (:TYPE-PRESCRIPTION FLOOR-NONNEGATIVE . 2))
 (3279 2235 (:TYPE-PRESCRIPTION FLOOR-NEGATIVE . 3))
 (3279 2235 (:TYPE-PRESCRIPTION FLOOR-NEGATIVE . 2))
 (2604 509 (:REWRITE RTL::RATIONALP-MOD))
 (1940 1940 (:REWRITE FOLD-CONSTS-IN-+))
 (1766 509 (:REWRITE INTEGERP-MOD-2))
 (1766 509 (:REWRITE INTEGERP-MOD-1))
 (1766 509 (:REWRITE RTL::INTEGERP-MOD))
 (1186 1186 (:REWRITE |(not (equal x (/ y)))|))
 (1186 1186 (:REWRITE |(equal x (/ y))|))
 (1128 1128 (:REWRITE |(< y (+ (- c) x))|))
 (1128 1128 (:REWRITE |(< x (+ c/d y))|))
 (1120 1120 (:REWRITE |(< (* x y) 0) rationalp (* x y)|))
 (1104 144 (:REWRITE |(<= 1 (* (/ x) y)) with (< x 0)|))
 (1104 144 (:REWRITE |(<= 1 (* (/ x) y)) with (< 0 x)|))
 (356 356 (:REWRITE |(< (* x (/ y)) 0) rationalp (* x (/ y))|))
 (327 327 (:REWRITE MOD-NEGATIVE . 3))
 (327 327 (:REWRITE MOD-NEGATIVE . 2))
 (323 323 (:REWRITE MOD-POSITIVE . 3))
 (323 323 (:REWRITE MOD-POSITIVE . 2))
 )
(DM::DIVIDES-MOD-0
