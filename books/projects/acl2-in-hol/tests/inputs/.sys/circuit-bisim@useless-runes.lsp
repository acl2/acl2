...
(C-BISIMILAR-EQUIV-IMPLIES-INIT->INIT-N->M
 ...
 (56 2 (:DEFINITION TRANSITION-SUBSET-P))
...
(C-BISIMILAR-WITNESS-MEMBER-OF-STATES-M->N
 ...
 (74 2 (:DEFINITION TRANSITION-SUBSET-P))
