(ADE::FIX-BREADTH-TREE-STACK (1 1 (:TYPE-PRESCRIPTION BINARY-APPEND)))
...
(ADE::TRUE-LIST-LISTP-BREADTH-TREE
     ...
     (61 5
         (:DEFINITION ADE::FIX-BREADTH-TREE-STACK))
...
(ADE::COLLECT-BREADTH-TREE (6 2 (:REWRITE ADE::BV-IS-TRUE-LIST))
