...
(ADE::ASSOC-EQ-VALUE-NTH-PAIRLIS$
     ...
     (172 3 (:REWRITE LEN-WHEN-PREFIXP))
     (141 137 (:REWRITE DEFAULT-CAR))
     (112 6 (:REWRITE PREFIXP-WHEN-EQUAL-LENGTHS))
     (110 110 (:REWRITE DEFAULT-+-1))
     (89 6 (:REWRITE PREFIXP-WHEN-PREFIXP))
...
(ADE::ASSOC-EQ-VALUES-PAIRLIS$-APPEND-WHEN-SUBSET
     ...
     (64 4 (:REWRITE PREFIXP-WHEN-EQUAL-LENGTHS))
     (54 27
         (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
...
(ADE::ASSOC-EQ-VALUES-PAIRLIS$-APPEND-WHEN-DISJOINT
     (3015 24 (:REWRITE TAKE-OF-TOO-MANY))
     (2167 23 (:REWRITE LEN-WHEN-PREFIXP))
     (1843 1843 (:TYPE-PRESCRIPTION LEN))
     (1608 800 (:REWRITE DEFAULT-CDR))
     (1596 532
           (:TYPE-PRESCRIPTION TRUE-LISTP-NTHCDR-TYPE-PRESCRIPTION))
     (1543 69
     ...
     (1435 66
           (:REWRITE ADE::ASSOC-EQ-VALUE-PAIRLIS$-NOT-MEMBER))
     (1233 69 (:REWRITE PREFIXP-WHEN-PREFIXP))
     (1144 176 (:DEFINITION LEN))
     (1117 645 (:REWRITE DEFAULT-CAR))
     (1073 33 (:REWRITE ADE::LEN-NTHCDR))
     (795 12 (:DEFINITION TAKE))
     (738 41 (:DEFINITION NTHCDR))
     (697 697 (:TYPE-PRESCRIPTION TRUE-LISTP))
     (446 270 (:REWRITE DEFAULT-+-2))
...
(ADE::ASSOC-EQ-VALUES-OF-REPEAT-CONS-2
     ...
     (1 1
        (:REWRITE ADE::ASSOC-EQ-VALUES-OF-REPEAT-CONS-1)))
