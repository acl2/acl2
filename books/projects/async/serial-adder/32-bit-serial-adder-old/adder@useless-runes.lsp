...
(ADE::HALF-ADDER$OUTPUTS (1 1 (:TYPE-PRESCRIPTION ADE::F-XOR)))
(ADE::HALF-ADDER$VALUE (48 46 (:REWRITE DEFAULT-CAR))
...
(ADE::FULL-ADDER$OUTPUTS (1 1 (:TYPE-PRESCRIPTION ADE::F-XOR)))
(ADE::FULL-ADDER$VALUE (585 585 (:REWRITE DEFAULT-CDR))
...
(ADE::RIPPLE-ADD-BODY)
(ADE::RIPPLE-ADD* (20 10 (:TYPE-PRESCRIPTION ADE::CONSP-SIS))
                  (10 10 (:TYPE-PRESCRIPTION POSP)))
(ADE::RIPPLE-ADD*$DESTRUCTURE (210 105 (:TYPE-PRESCRIPTION ADE::CONSP-SIS))
...
(ADE::RIPPLE-ADD$UNBOUND-IN-BODY-SUM
     (12 12
         (:TYPE-PRESCRIPTION ADE::RIPPLE-ADD-BODY))
...
(ADE::RIPPLE-ADD$VALUE (64 4 (:REWRITE ADE::DISJOINT-ATOM))
