...
(ADE::VALIDP)
(ADE::4V->LINK-ST)
(ADE::MAP-TO-LINKS1 (24 8 (:REWRITE ADE::BV-IS-TRUE-LIST))
                    (16 16 (:TYPE-PRESCRIPTION ADE::BVP))
                    (16 16 (:REWRITE DEFAULT-CDR))
                    (8 8 (:REWRITE DEFAULT-CAR)))
(ADE::MAP-TO-LINKS (24 8 (:REWRITE ADE::BV-IS-TRUE-LIST))
                   (16 16 (:TYPE-PRESCRIPTION ADE::BVP))
                   (16 16 (:REWRITE DEFAULT-CDR))
                   (8 8 (:REWRITE DEFAULT-CAR)))
(ADE::REMOVE-DUP-NEIGHBORS)
(ADE::PRETTY-LIST)
(ADE::SIGNAL-VALS-GEN (54 18
...
(ADE::JOINT-ACT-REWRITE (3 3 (:TYPE-PRESCRIPTION BOOLEANP)))
(ADE::JOINT-ACT-REMOVES-F-BUF
     (20 8
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-JOINT-ACT))
     (8 8 (:TYPE-PRESCRIPTION BOOLEANP)))
(ADE::JOINT-CNTL$VALUE (67 67 (:REWRITE DEFAULT-CAR))
...
(ADE::CLICK-LINK$VALUE (266 266 (:REWRITE DEFAULT-CAR))
...
(ADE::CLICK-LINK$STATE (931 931 (:REWRITE DEFAULT-CAR))
...
(ADE::LINK1$VALID-ST)
(ADE::LINK1$VALUE (10 4 (:REWRITE ADE::F-BUF-OF-NOT-BOOLEANP))
                  (10 4 (:REWRITE ADE::F-BUF-OF-3VP))
                  (6 6 (:TYPE-PRESCRIPTION BOOLEANP))
                  (6 6 (:TYPE-PRESCRIPTION ADE::3VP)))
(ADE::LINK1$STEP (1 1 (:TYPE-PRESCRIPTION ADE::F-SR))
...
(ADE::LINK$INS-LEN (1 1 (:REWRITE DEFAULT-<-2))
                   (1 1 (:REWRITE DEFAULT-<-1)))
(ADE::LINK* (16 8 (:TYPE-PRESCRIPTION ADE::CONSP-SIS))
            (8 8 (:TYPE-PRESCRIPTION POSP)))
(ADE::LINK*$DESTRUCTURE (60 30 (:TYPE-PRESCRIPTION ADE::CONSP-SIS))
...
(ADE::LINK$VALID-ST)
(ADE::LINK$VALID-ST=>CONSTRAINT (5 1 (:DEFINITION LEN))
...
(ADE::LINK$STATE (262 131 (:REWRITE DEFAULT-+-2))
