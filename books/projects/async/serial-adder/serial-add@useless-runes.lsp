...
(ADE::SERIAL-ADD$INS-LEN)
(ADE::SERIAL-ADD* (29 29 (:TYPE-PRESCRIPTION POSP)))
(ADE::SERIAL-ADD*$DESTRUCTURE (240 24 (:DEFINITION BINARY-APPEND))
                              (174 48 (:REWRITE APPEND-WHEN-NOT-CONSP))
                              (135 135 (:TYPE-PRESCRIPTION POSP))
                              (34 34 (:REWRITE DEFAULT-CDR))
                              (29 29 (:REWRITE DEFAULT-CAR)))
(ADE::NOT-PRIMP-SERIAL-ADD
     (72 36
     ...
     (36 36 (:REWRITE |(equal (- x) c)|))
     (36 36 (:REWRITE |(equal (- x) (- y))|)))
(ADE::SERIAL-ADD$NETLIST)
(ADE::SERIAL-ADD&)
(ADE::CHECK-SERIAL-ADD$NETLIST-64-7)
(ADE::SERIAL-ADD$ST-FORMAT)
(ADE::SERIAL-ADD$ST-FORMAT=>CONSTRAINT
     ...
     (1 1 (:REWRITE |(< (/ x) 0)|))
     (1 1 (:REWRITE |(< (* x y) 0)|)))
(ADE::SERIAL-ADD$VALID-ST)
(ADE::SERIAL-ADD$VALID-ST=>CONSTRAINT
     (192 24
          (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
...
(ADE::SERIAL-ADD$VALID-ST=>ST-FORMAT
     (192 24
          (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
     (180 36 (:REWRITE ACL2-NUMBERP-X))
...
(ADE::SERIAL-ADD$DATA0-IN
     ...
     (1 1 (:REWRITE |(< (* x y) 0)|))
     (1 1 (:META META-INTEGERP-CORRECT)))
(ADE::LEN-SERIAL-ADD$DATA0-IN)
(ADE::SERIAL-ADD$DATA1-IN
     (6 2 (:REWRITE ADE::BV-IS-TRUE-LIST))
     (5 1 (:DEFINITION TRUE-LISTP))
     (4 4 (:TYPE-PRESCRIPTION ADE::BVP))
     (1 1 (:REWRITE THE-FLOOR-BELOW))
...
(ADE::LEN-SERIAL-ADD$DATA1-IN
     ...
     (1 1 (:REWRITE ZP-OPEN))
     (1 1 (:REWRITE |(< (+ c/d x) y)|)))
(ADE::SERIAL-ADD$PISO2-INPUTS (2 2 (:TYPE-PRESCRIPTION ADE::F-BUF)))
(ADE::SERIAL-ADD$SIPO-INPUTS (1 1 (:TYPE-PRESCRIPTION ADE::F-BUF)))
(ADE::SERIAL-ADD$IN-ACT
     (10 5
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-PISO2-SREG$IN-ACT))
     (5 5
        (:TYPE-PRESCRIPTION ADE::PISO2-SREG$INPUT-FORMAT)))
(ADE::SERIAL-ADD$IN-ACT-INACTIVE
     ...
     (5 5
        (:TYPE-PRESCRIPTION ADE::SERIAL-ADD$DATA1-IN))
     (5 5
        (:TYPE-PRESCRIPTION ADE::SERIAL-ADD$DATA0-IN))
     (5 5
        (:LINEAR ADE::A-HELPFUL-LEMMA-FOR-TREE-INDUCTIONS))
...
(ADE::SERIAL-ADD$DATA-OUT)
(ADE::LEN-SERIAL-ADD$DATA-OUT-1
...
(ADE::BVP-SERIAL-ADD$DATA-OUT
     ...
     (1536 64
           (:REWRITE ADE::SERIAL-ADD$OUT-ACT-INACTIVE))
     ...
     (1 1
        (:REWRITE ADE::LEN-OF-SIPO-SREG$EXTRACT-CONTRAPOSITIVE-LEMMA-1)))
(ADE::SERIAL-ADD$OUTPUTS)
(ADE::SERIAL-ADD$VALUE
     (850 178 (:DEFINITION BINARY-APPEND))
     (700 354 (:REWRITE DEFAULT-PLUS-2))
     (422 354 (:REWRITE DEFAULT-PLUS-1))
     (372 318
          (:REWRITE ADE::F-BUF-OF-NOT-BOOLEANP))
     (372 318 (:REWRITE ADE::F-BUF-OF-3VP))
     (318 91
          (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
     ...
     (195 91 (:REWRITE SIMPLIFY-SUMS-EQUAL))
     (194 91
          (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
     ...
     (111 13
          (:REWRITE ADE::SIPO-SREG$OUT-ACT-INACTIVE))
     (95 93 (:REWRITE |(equal (/ x) (/ y))|))
     (94 94
         (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-EQUAL))
     (94 74 (:REWRITE TAKE-WHEN-ATOM))
     ...
     (4 1
        (:REWRITE ADE::SERIAL-ADD$IN-ACT-INACTIVE))
...
(ADE::SERIAL-ADD$STATE
     (1984 532 (:DEFINITION BINARY-APPEND))
     (1449 731 (:REWRITE DEFAULT-PLUS-2))
     (1035 957
           (:REWRITE ADE::F-BUF-OF-NOT-BOOLEANP))
     (1035 957 (:REWRITE ADE::F-BUF-OF-3VP))
     (827 731 (:REWRITE DEFAULT-PLUS-1))
     (604 237
          (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
     (601 601
          (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
     ...
     (424 237
          (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
     (341 237 (:REWRITE SIMPLIFY-SUMS-EQUAL))
     (316 299 (:REWRITE TAKE-WHEN-ATOM))
     (312 48
          (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV))
     (289 69
          (:REWRITE ADE::PISO2-SREG$OUT1-ACT-INACTIVE))
     ...
     (2 2 (:REWRITE DEFAULT-SYMBOL-NAME))
     (2 2 (:REWRITE |(equal (+ (- c) x) y)|)))
(ADE::SERIAL-ADD$INPUT-FORMAT)
(ADE::SERIAL-ADD$INPUT-FORMAT=>PISO2$INPUT-FORMAT
     ...
     (2 2
        (:REWRITE ADE::LEN-OF-SIPO-SREG$EXTRACT-CONTRAPOSITIVE-LEMMA-1)))
(ADE::SERIAL-ADD$INPUT-FORMAT=>SIPO$INPUT-FORMAT
     ...
     (2 2
        (:REWRITE ADE::LEN-OF-SIPO-SREG$EXTRACT-CONTRAPOSITIVE-LEMMA-1)))
(ADE::BOOLEANP-SERIAL-ADD$IN-ACT
     (107 1
          (:REWRITE ADE::LENS-OF-PISO2-SREG$EXTRACTS-CONTRAPOSITIVE-LEMMA-2))
...
(ADE::BOOLEANP-SERIAL-ADD$OUT-ACT
     (83 83 (:REWRITE NTH-WHEN-PREFIXP))
     (49 1
         (:REWRITE ADE::LEN-OF-SIPO-SREG$EXTRACT-CONTRAPOSITIVE-LEMMA-2))
     ...
     (1 1
        (:LINEAR ADE::A-HELPFUL-LEMMA-FOR-TREE-INDUCTIONS)))
(ADE::SERIAL-ADD$ST-FORMAT-PRESERVED
     (151 15 (:REWRITE ADE::F-GATES=B-GATES))
     ...
     (6 6
        (:TYPE-PRESCRIPTION ADE::SERIAL-ADD$PISO2-INPUTS))
     (6 6
        (:TYPE-PRESCRIPTION ADE::SERIAL-ADD$INPUT-FORMAT))
     (6 6 (:TYPE-PRESCRIPTION ADE::F-OR))
     (6 2
        (:REWRITE ADE::SERIAL-ADD$INPUT-FORMAT=>PISO2$INPUT-FORMAT))
     (6 1
     ...
     (3 3
        (:TYPE-PRESCRIPTION ADE::SIPO-SREG$IN-ACT))
     (3 3
        (:TYPE-PRESCRIPTION ADE::SERIAL-ADD$SIPO-INPUTS))
     (3 3
     ...
     (3 3 (:REWRITE |(< (* x y) 0)|))
     (3 1
        (:REWRITE ADE::SERIAL-ADD$INPUT-FORMAT=>SIPO$INPUT-FORMAT))
     (2 2
        (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-<-0-RATIONAL-REMAINDER))
     (2 2
        (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-<-0-RATIONAL-COMMON))
...
(DEFOPENER-TEMP)
(ADE::OPEN-SERIAL-ADD$RUN-ZP)
(DEFOPENER-HINT (5 5 (:TYPE-PRESCRIPTION LAST)))
(DEFOPENER-TEMP)
(ADE::OPEN-SERIAL-ADD$RUN)
(ADE::SERIAL-ADD$RUN-PLUS
...
(DEFOPENER-HINT (5 5 (:TYPE-PRESCRIPTION LAST)))
(DEFOPENER-TEMP)
(ADE::OPEN-SERIAL-ADD$INPUT-FORMAT-N-ZP)
(DEFOPENER-HINT (5 5 (:TYPE-PRESCRIPTION LAST)))
(DEFOPENER-TEMP)
(ADE::OPEN-SERIAL-ADD$INPUT-FORMAT-N)
(ADE::SERIAL-ADD$INPUT-FORMAT-PLUS
     (472 51
          (:REWRITE REDUCE-ADDITIVE-CONSTANT-<))
...
(ADE::SERIAL-ADD$DE-N
     ...
     (408 36
          (:REWRITE REDUCE-ADDITIVE-CONSTANT-<))
     (158 2 (:DEFINITION ADE::SERIAL-ADD$RUN))
     (48 12 (:REWRITE |(+ c (+ d x))|))
     (41 3
         (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
     ...
     (3 3
        (:REWRITE ADE::SERIAL-ADD$INPUT-FORMAT-PLUS))
     (3 3
        (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-EQUAL))
     (3 3
        (:REWRITE REDUCE-ADDITIVE-CONSTANT-EQUAL))
     ...
     (2 2 (:META META-RATIONALP-CORRECT))
     (2 2 (:META META-INTEGERP-CORRECT)))
(ADE::SERIAL-ADD$OP-MAP)
(ADE::SERIAL-ADD$OP-MAP-OF-APPEND
     ...
     (3 3 (:REWRITE |(equal (- x) c)|))
     (3 3 (:REWRITE |(equal (- x) (- y))|)))
(ADE::SERIAL-ADD$EXTRACT (6 6 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(ADE::SERIAL-ADD$INV (6 6 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(ADE::SERIAL-ADD$EXTRACT-NOT-EMPTY
     ...
     (74 74
         (:LINEAR ADE::LEN-OF-SIPO-SREG$EXTRACT-UPPER-BOUND-WHEN-IN-ACT))
     (72 36
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-SERIAL-ADD$OUT-ACT))
     (66 22
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-SIPO-SREG$IN-ACT))
...
(ADE::SERIAL-ADD$PISO2-OUT0-ACT-INACTIVE
     ...
     (2 2 (:REWRITE |(< x (+ c/d y))|))
     (1 1 (:TYPE-PRESCRIPTION NATP)))
(ADE::SERIAL-ADD$PISO2-OUT1-ACT-INACTIVE
     (660 8 (:REWRITE TAKE-OF-TOO-MANY))
     (285 4 (:DEFINITION TAKE))
     (266 4 (:REWRITE ADE::LEN-NTHCDR))
     (128 64
     ...
     (2 2 (:REWRITE |(< x (+ c/d y))|))
     (1 1 (:TYPE-PRESCRIPTION NATP)))
(ADE::SERIAL-ADD$SIPO-IN-ACT-INACTIVE
...
(ADE::SIPO-SREG$CNT-OUT=1-REWRITE
 ...
 (1 1
    (:REWRITE ADE::LEN-OF-SIPO-SREG$EXTRACT-CONTRAPOSITIVE-LEMMA-1)))
(ADE::SERIAL-ADD$INV-PRESERVED
     (111735 111735 (:REWRITE NTH-WHEN-PREFIXP))
     (17143 17143
            (:REWRITE EQUAL-OF-PREDICATES-REWRITE))
     (17143 17143 (:REWRITE |(equal c (/ x))|))
     (17143 17143 (:REWRITE |(equal c (- x))|))
     (17143 17143 (:REWRITE |(equal (/ x) c)|))
     (17143 17143 (:REWRITE |(equal (/ x) (/ y))|))
     (17143 17143 (:REWRITE |(equal (- x) c)|))
     (17143 17143 (:REWRITE |(equal (- x) (- y))|))
     (16947 16363
            (:REWRITE REDUCE-ADDITIVE-CONSTANT-<))
     (16743 313 (:DEFINITION BINARY-APPEND))
     (16363 16363 (:REWRITE THE-FLOOR-BELOW))
     (16363 16363 (:REWRITE THE-FLOOR-ABOVE))
     (16363 16363
            (:REWRITE REDUCE-RATIONAL-MULTIPLICATIVE-CONSTANT-<))
     (16363 16363
            (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-<))
     (16339 16339 (:REWRITE SIMPLIFY-SUMS-<))
     (16339 16339
            (:REWRITE REMOVE-STRICT-INEQUALITIES))
     (16339 16339 (:REWRITE INTEGERP-<-CONSTANT))
     (16339 16339 (:REWRITE CONSTANT-<-INTEGERP))
     (16339 16339
            (:REWRITE |(< c (/ x)) positive c --- present in goal|))
     (16339 16339
            (:REWRITE |(< c (/ x)) positive c --- obj t or nil|))
     ...
     (16339 16339
            (:REWRITE |(< c (/ x)) negative c --- obj t or nil|))
     (16339 16339 (:REWRITE |(< c (- x))|))
     (16339 16339 (:REWRITE |(< 0 (* x y))|))
     (16339 16339
            (:REWRITE |(< (/ x) c) positive c --- present in goal|))
     (16339 16339
            (:REWRITE |(< (/ x) c) positive c --- obj t or nil|))
     ...
     (16339 16339
            (:REWRITE |(< (/ x) c) negative c --- obj t or nil|))
     (16339 16339 (:REWRITE |(< (/ x) (/ y))|))
     (16339 16339 (:REWRITE |(< (- x) c)|))
     (16339 16339 (:REWRITE |(< (- x) (- y))|))
     (16315 16315
            (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-REMAINDER))
     (16315 16315
            (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-COMMON))
     (16315 16315 (:REWRITE |(< 0 (/ x))|))
     (12268 12268
            (:TYPE-PRESCRIPTION NOT-INTEGERP-3A))
     (12268 12268
            (:TYPE-PRESCRIPTION NOT-INTEGERP-2A))
     ...
     (12004 12004
            (:LINEAR ADE::A-HELPFUL-LEMMA-FOR-TREE-INDUCTIONS))
     (6434 580 (:DEFINITION NTHCDR))
     (5455 554
           (:REWRITE ADE::PISO2-SREG$OUT0-ACT-INACTIVE))
     (5385 549
           (:REWRITE ADE::PISO2-SREG$OUT1-ACT-INACTIVE))
     (4895 4895 (:REWRITE FOLD-CONSTS-IN-+))
     (4298 2815 (:REWRITE DEFAULT-TIMES-2))
     (2815 2815 (:REWRITE DEFAULT-TIMES-1))
     (2156 2156
           (:REWRITE NORMALIZE-FACTORS-GATHER-EXPONENTS))
     (1685 567
           (:REWRITE ADE::F-BUF-OF-NOT-BOOLEANP))
     (1685 567 (:REWRITE ADE::F-BUF-OF-3VP))
     (1118 1118 (:TYPE-PRESCRIPTION ADE::3VP))
     (954 266
          (:REWRITE ADE::SIPO-SREG$IN-OUT-ACTS-MUTUALLY-EXCLUSIVE))
     (882 500
          (:REWRITE ADE::PISO2-SREG$IN-ACT-INACTIVE))
     ...
     (216 216
          (:TYPE-PRESCRIPTION ADE::BOOLEANP-PISO2-SREG$BIT0-OUT))
     (207 207 (:TYPE-PRESCRIPTION ADE::F-AND))
     (192 192
     ...
     (192 192
          (:TYPE-PRESCRIPTION ADE::BOOLEANP-SIPO-SREG$CNT-OUT=1-1))
     (120 120 (:TYPE-PRESCRIPTION ADE::F-XOR))
     (105 105 (:REWRITE |(equal x (if a b c))|))
     (105 105 (:REWRITE |(equal (if a b c) x)|))
     (93 93 (:TYPE-PRESCRIPTION ADE::F-OR))
     ...
     (33 33 (:REWRITE |(* (- x) y)|))
     (28 28 (:TYPE-PRESCRIPTION ADE::BVP-LEN))
     (24 24 (:TYPE-PRESCRIPTION ADE::F-BUF))
     (24 24 (:REWRITE |(< x (+ c/d y))|))
     (24 12 (:REWRITE ADE::BOOLEANP-OF-F-BUF))
     (8 8 (:REWRITE |(+ x (if a b c))|))
     (8 8 (:REWRITE |(+ (if a b c) x)|)))
(ADE::SERIAL-ADD$EXTRACTED-STEP
     (24 12
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-SERIAL-ADD$IN-ACT))
     (18 18
         (:TYPE-PRESCRIPTION ADE::SERIAL-ADD$INPUT-FORMAT))
     (12 6
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-SERIAL-ADD$OUT-ACT)))
(ADE::SERIAL-ADD-AUX-1
...
(ADE::NTH-0-IS-CAR (11 3 (:REWRITE ACL2-NUMBERP-X))
                   ...
                   (1 1 (:META META-RATIONALP-CORRECT))
                   (1 1 (:META META-INTEGERP-CORRECT)))
(ADE::SERIAL-ADD$EXTRACTED-STEP-CORRECT
     (352237 1373 (:DEFINITION BINARY-APPEND))
     (215284 2177 (:REWRITE TAKE-OF-TOO-MANY))
     (143723 2746 (:REWRITE APPEND-WHEN-NOT-CONSP))
     (130361 130361 (:REWRITE NTH-WHEN-PREFIXP))
     (67346 67346 (:REWRITE THE-FLOOR-BELOW))
     (67346 67346 (:REWRITE THE-FLOOR-ABOVE))
     (67343 67322
            (:REWRITE REDUCE-RATIONAL-MULTIPLICATIVE-CONSTANT-<))
     (64713 64669
            (:REWRITE |(< c (/ x)) negative c --- present in goal|))
     (64669 64669 (:REWRITE INTEGERP-<-CONSTANT))
     (64669 64669 (:REWRITE CONSTANT-<-INTEGERP))
     (64669 64669
            (:REWRITE |(< c (/ x)) positive c --- present in goal|))
     (64669 64669
            (:REWRITE |(< c (/ x)) positive c --- obj t or nil|))
     ...
     (64669 64669
            (:REWRITE |(< (/ x) c) negative c --- obj t or nil|))
     (64669 64669 (:REWRITE |(< (/ x) (/ y))|))
     (64669 64669 (:REWRITE |(< (- x) c)|))
     (64669 64669 (:REWRITE |(< (- x) (- y))|))
     (61590 61590 (:REWRITE |(< 0 (* x y))|))
     (61407 61407
            (:REWRITE REMOVE-WEAK-INEQUALITIES))
     (59884 59884 (:REWRITE |(< 0 (/ x))|))
     (58509 2004 (:REWRITE ADE::LEN-OF-V-ADDER))
     (58346 58346
            (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-REMAINDER))
     (58346 58346
            (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-COMMON))
     ...
     (28730 28730
            (:REWRITE EQUAL-OF-PREDICATES-REWRITE))
     (28730 28730 (:REWRITE |(equal c (/ x))|))
     (28730 28730 (:REWRITE |(equal c (- x))|))
     (28730 28730 (:REWRITE |(equal (/ x) c)|))
     (28730 28730 (:REWRITE |(equal (/ x) (/ y))|))
     (28730 28730 (:REWRITE |(equal (- x) c)|))
     (28730 28730 (:REWRITE |(equal (- x) (- y))|))
     (24925 24925
            (:TYPE-PRESCRIPTION ADE::BOOLEANP-SERIAL-ADD$OUT-ACT))
     (18712 18712
            (:LINEAR ADE::A-HELPFUL-LEMMA-FOR-TREE-INDUCTIONS))
     (18509 984 (:REWRITE |(< (+ (- c) x) y)|))
     (9712 796 (:DEFINITION NTHCDR))
     (9668 1127
           (:REWRITE ADE::PISO2-SREG$OUT1-ACT-INACTIVE))
     (8559 4320 (:TYPE-PRESCRIPTION ADE::F-IF))
     (8476 8476
           (:TYPE-PRESCRIPTION NOT-INTEGERP-3A))
     (8476 8476
           (:TYPE-PRESCRIPTION NOT-INTEGERP-2A))
     (8476 8476
           (:TYPE-PRESCRIPTION NOT-INTEGERP-1A))
     (8177 8177 (:REWRITE FOLD-CONSTS-IN-+))
     (7131 2377 (:REWRITE ADE::BOOL-FIX-CAR-X=X))
     (6672 4780 (:REWRITE DEFAULT-TIMES-2))
     (5694 5694 (:REWRITE |(< x (+ c/d y))|))
     (4780 4780 (:REWRITE DEFAULT-TIMES-1))
     (4419 519
           (:REWRITE ADE::PISO2-SREG$OUT0-ACT-INACTIVE))
     (4253 2177 (:REWRITE TAKE-WHEN-ATOM))
     (3822 273
           (:REWRITE ADE::SERIAL-ADD$OUT-ACT-INACTIVE))
     (3538 3538 (:REWRITE |(< y (+ (- c) x))|))
     (3233 3233
           (:REWRITE NORMALIZE-FACTORS-GATHER-EXPONENTS))
     (2830 2830
           (:TYPE-PRESCRIPTION ADE::BOOLEANP-PISO2-SREG$BIT1-OUT))
     (2437 2437 (:TYPE-PRESCRIPTION ADE::V-ADDER))
     (2105 2105 (:TYPE-PRESCRIPTION NFIX))
     (2012 2012
           (:TYPE-PRESCRIPTION ADE::BOOLEANP-PISO2-SREG$BIT0-OUT))
     (1920 744
           (:REWRITE ADE::PISO2-SREG$IN-ACT-INACTIVE))
     ...
     (1724 650
           (:REWRITE ADE::F-BUF-OF-NOT-BOOLEANP))
     (1724 650 (:REWRITE ADE::F-BUF-OF-3VP))
     (1508 608
           (:REWRITE ADE::SIPO-SREG$IN-ACT-INACTIVE))
     (1390 1390 (:REWRITE |(< (+ c/d x) y)|))
     (1343 1343
           (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-=-0))
     (1074 1074 (:TYPE-PRESCRIPTION ADE::3VP))
     (842 842
          (:REWRITE ADE::BOOLEANP-CAR-OF-PISO2-SREG$EXTRACT1))
     (672 336
          (:REWRITE ADE::SERIAL-ADD$IN-ACT-INACTIVE))
     (439 439
          (:TYPE-PRESCRIPTION ADE::BOOLEANP-SIPO-SREG$CNT-OUT=1-2))
     (315 315
          (:TYPE-PRESCRIPTION ADE::SIPO-SREG$CNT-OUT=1))
     (201 201 (:TYPE-PRESCRIPTION ADE::F-AND))
     (140 48
          (:REWRITE ADE::BOOLEANP-PISO2-SREG$OUT1-ACT))
     (120 120 (:TYPE-PRESCRIPTION ADE::F-XOR))
     (119 119
          (:REWRITE ADE::BOOLEANP-PISO2-SREG$BIT1-OUT))
     (108 108 (:REWRITE |(equal x (if a b c))|))
     (105 105
          (:REWRITE ADE::BOOLEANP-SIPO-SREG$CNT-OUT=1-2))
     (105 105
          (:REWRITE ADE::BOOLEANP-SIPO-SREG$CNT-OUT=1-1))
     ...
     (82 82
         (:REWRITE ADE::BOOLEANP-PISO2-SREG$BIT0-OUT))
     (76 76 (:TYPE-PRESCRIPTION ADE::F-BUF))
     (76 38 (:REWRITE ADE::BOOLEANP-OF-F-BUF))
     (36 36 (:REWRITE |(* (- x) y)|))
     (25 25
     ...
     (1 1 (:REWRITE |(< (/ x) 0)|))
     (1 1 (:REWRITE |(< (* x y) 0)|)))
(ADE::SERIAL-ADD$VALID-ST-PRESERVED
     ...
     (144 144 (:TYPE-PRESCRIPTION ADE::F-XOR))
     ...
     (80 80
         (:REWRITE ADE::BOOLEANP-SIPO-SREG$CNT-OUT=1-1)))
(ADE::SERIAL-ADD$EXTRACT-LEMMA
     (5547 5547 (:REWRITE NTH-WHEN-PREFIXP))
     (1716 1144
           (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
     (1287 33 (:DEFINITION NTHCDR))
     (1174 1174 (:REWRITE |(equal c (/ x))|))
     (1174 1174 (:REWRITE |(equal (/ x) (/ y))|))
     (1174 1174 (:REWRITE |(equal (- x) (- y))|))
     (1167 1167
           (:REWRITE EQUAL-OF-PREDICATES-REWRITE))
     (1167 1167 (:REWRITE |(equal c (- x))|))
     (1167 1167 (:REWRITE |(equal (- x) c)|))
     (990 33 (:REWRITE ZP-OPEN))
     (773 773
          (:LINEAR ADE::A-HELPFUL-LEMMA-FOR-TREE-INDUCTIONS))
     (742 53
          (:REWRITE ADE::SERIAL-ADD$OUT-ACT-INACTIVE))
     (728 270 (:DEFINITION BINARY-APPEND))
     (686 49
          (:REWRITE ADE::SIPO-SREG$OUT-ACT-INACTIVE))
     (441 49
          (:REWRITE ADE::SIPO-SREG$IN-OUT-ACTS-MUTUALLY-EXCLUSIVE))
     ...
     (120 115 (:REWRITE REMOVE-WEAK-INEQUALITIES))
     (119 119
          (:REWRITE NORMALIZE-FACTORS-GATHER-EXPONENTS))
     ...
     (2 2 (:REWRITE |(< (/ x) 0)|))
     (2 2 (:REWRITE |(< (* x y) 0)|)))
(ADE::SERIAL-ADD$IN-SEQ
     (12 6
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-SERIAL-ADD$IN-ACT))
     (6 6
        (:TYPE-PRESCRIPTION ADE::SERIAL-ADD$INPUT-FORMAT)))
(ADE::SERIAL-ADD$IN-SEQ-NETLIST)
(ADE::SERIAL-ADD$IN-SEQ-LEMMA
     ...
     (6 6
        (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV)))
(ADE::SERIAL-ADD$OUT-SEQ
     (12 6
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-SERIAL-ADD$OUT-ACT))
     (6 6
        (:TYPE-PRESCRIPTION ADE::SERIAL-ADD$INPUT-FORMAT)))
(ADE::SERIAL-ADD$OUT-SEQ-NETLIST)
(ADE::SERIAL-ADD$OUT-SEQ-LEMMA
     (2213 65 (:REWRITE ZP-OPEN))
     (1066 134
           (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
     (960 40
     ...
     (29 29
         (:REWRITE ADE::SERIAL-ADD$EXTRACT-LEMMA))
     (28 14
         (:REWRITE ADE::SERIAL-ADD$IN-ACT-INACTIVE))
     (24 24 (:REWRITE |(+ 0 x)|))
     ...
     (6 6
        (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV)))
(ADE::SERIAL-ADD$DATAFLOW-CORRECT-AUX
     ...
     (12 2 (:DEFINITION ADE::SERIAL-ADD$OP-MAP))
     ...
     (1 1 (:META META-RATIONALP-CORRECT))
     (1 1 (:META META-INTEGERP-CORRECT)))
(ADE::SERIAL-ADD$DATAFLOW-CORRECT
     ...
     (158 14
          (:LINEAR ADE::SERIAL-ADD$EXTRACT-NOT-EMPTY))
     (156 156
          (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
     (147 147
          (:REWRITE REMOVE-STRICT-INEQUALITIES))
     ...
     (108 108
          (:TYPE-PRESCRIPTION ADE::SERIAL-ADD$IN-SEQ))
     ...
     (64 64 (:REWRITE |(equal (- x) (- y))|))
     (48 48
         (:TYPE-PRESCRIPTION ADE::SERIAL-ADD$STEP))
     (33 33 (:REWRITE |(< y (+ (- c) x))|))
     (29 29
         (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-AX+BX-RATIONAL-REMAINDER))
     (29 29
     ...
     (14 14
         (:TYPE-PRESCRIPTION ADE::SERIAL-ADD$RUN))
     (14 14 (:REWRITE ADE::SERIAL-ADD$RUN-PLUS))
     (12 12
         (:REWRITE ADE::SERIAL-ADD$INPUT-FORMAT-PLUS))
     ...
     (4 4 (:REWRITE |(< (* x y) 0)|)))
(ADE::SERIAL-ADD$FUNCTIONALLY-CORRECT
     (514 4 (:DEFINITION ADE::SERIAL-ADD$OUT-SEQ))
     (250 4
          (:REWRITE ADE::SERIAL-ADD$EXTRACT-LEMMA))
     (204 3 (:DEFINITION NTHCDR))
     (176 4 (:DEFINITION ADE::SERIAL-ADD$IN-SEQ))
     ...
     (32 16
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-SERIAL-ADD$IN-ACT))
     (32 4 (:DEFINITION ADE::SERIAL-ADD$OP-MAP))
     (28 28
         (:TYPE-PRESCRIPTION ADE::SERIAL-ADD$IN-SEQ))
     (27 15 (:REWRITE SIMPLIFY-SUMS-EQUAL))
     (27 3 (:DEFINITION LEN))
     (24 6
         (:REWRITE ADE::OPEN-SERIAL-ADD$INPUT-FORMAT-N-ZP))
     (24 6
         (:REWRITE ADE::OPEN-SERIAL-ADD$INPUT-FORMAT-N))
     (20 20
         (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
     ...
     (18 3 (:REWRITE |(+ c (+ d x))|))
     (16 16
         (:TYPE-PRESCRIPTION ADE::SERIAL-ADD$OUT-ACT))
     (16 16
         (:TYPE-PRESCRIPTION ADE::SERIAL-ADD$IN-ACT))
     ...
     (14 14
         (:TYPE-PRESCRIPTION ADE::SERIAL-ADD$RUN))
     (12 3
         (:REWRITE ADE::OPEN-SERIAL-ADD$RUN-ZP))
     (12 3 (:REWRITE ADE::OPEN-SERIAL-ADD$RUN))
     (8 8 (:REWRITE NTH-WHEN-PREFIXP))
     (8 4
        (:REWRITE ADE::SERIAL-ADD$IN-ACT-INACTIVE))
     (6 3
