...
(ADE::Q10-COMP-GCD& (162 9 (:DEFINITION ASSOC-EQUAL))
                    (40 10
...
(ADE::Q10-COMP-GCD$Q10-INPUTS (1 1 (:TYPE-PRESCRIPTION ADE::F-BUF)))
(ADE::Q10-COMP-GCD$COMP-GCD-INPUTS (1 1 (:TYPE-PRESCRIPTION ADE::F-BUF)))
...
(ADE::Q10-COMP-GCD$IN-ACT-INACTIVE
     ...
     (5 5
        (:TYPE-PRESCRIPTION ADE::Q10-COMP-GCD$DATA-IN))
     (5 5
...
(ADE::LEN-Q10-COMP-GCD$DATA-OUT-1
     ...
     (3 1
        (:REWRITE ADE::LEN-COMP-GCD$DATA-OUT-2))
     (2 2
        (:TYPE-PRESCRIPTION ADE::COMP-GCD$VALID-ST))
     (2 2
        (:REWRITE NORMALIZE-FACTORS-GATHER-EXPONENTS))
     (2 2 (:REWRITE DEFAULT-*-2))
     (2 2 (:REWRITE DEFAULT-*-1))
...
(ADE::BVP-Q10-COMP-GCD$DATA-OUT
     ...
     (12 2
         (:REWRITE ADE::Q10-COMP-GCD$OUT-ACT-INACTIVE))
     (12 2
         (:REWRITE ADE::COMP-GCD$OUT-ACT-INACTIVE))
...
(ADE::Q10-COMP-GCD$VALUE
     ...
     (21 3
         (:REWRITE ADE::COMP-GCD$IN-ACT-INACTIVE))
     (20 5
         (:REWRITE ADE::NOT-EQUAL-WITH-SI-OF-DIFF-SYMBOL
                   . 2))
     (19 19
     ...
     (4 1
        (:REWRITE ADE::Q10-COMP-GCD$IN-ACT-INACTIVE))
...
(ADE::Q10-COMP-GCD$STEP
     (12 6
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-COMP-GCD$IN-ACT))
     (6 6
        (:TYPE-PRESCRIPTION ADE::COMP-GCD$INPUT-FORMAT)))
...
(ADE::Q10-COMP-GCD$ST-FORMAT-PRESERVED
     ...
     (6 6
        (:TYPE-PRESCRIPTION ADE::Q10-COMP-GCD$Q10-INPUTS))
     (6 6 (:REWRITE DEFAULT-CAR))
     (6 2
        (:REWRITE ADE::Q10-COMP-GCD$INPUT-FORMAT=>Q10$INPUT-FORMAT))
     (5 1 (:DEFINITION PAIRLIS$))
     (4 4
        (:TYPE-PRESCRIPTION ADE::Q10-COMP-GCD$INPUT-FORMAT))
     (4 4 (:TYPE-PRESCRIPTION BOOLEANP))
...
(ADE::Q10-COMP-GCD$DE-N
     ...
     (3 3
        (:REWRITE ADE::Q10-COMP-GCD$INPUT-FORMAT-PLUS))
     (3 3 (:REWRITE |(equal (- x) (- y))|))
...
(ADE::Q10-COMP-GCD$EXTRACT-NOT-EMPTY
     ...
     (46 6
         (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV))
     (44 22
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-Q10-COMP-GCD$OUT-ACT))
     (28 28 (:TYPE-PRESCRIPTION ADE::GCD$OP-MAP))
     (23 23 (:REWRITE NTH-WHEN-PREFIXP))
     (20 20
         (:TYPE-PRESCRIPTION ADE::COMP-GCD$EXTRACT))
     ...
     (9 9
        (:TYPE-PRESCRIPTION ADE::QUEUE10$EXTRACT))
     (9 9
        (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
     (9 9 (:REWRITE NORMALIZE-ADDENDS))
...
(ADE::Q10-COMP-GCD$EXTRACTED-STEP
     (24 12
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-Q10-COMP-GCD$IN-ACT))
     (18 18
         (:TYPE-PRESCRIPTION ADE::Q10-COMP-GCD$INPUT-FORMAT))
     (12 6
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-Q10-COMP-GCD$OUT-ACT)))
...
(ADE::Q10-COMP-GCD$OUT-SEQ-LEMMA
     ...
     (111 29
          (:REWRITE ADE::Q10-COMP-GCD$EXTRACT-LEMMA))
     (104 104
          (:REWRITE REMOVE-WEAK-INEQUALITIES-TWO))
     (92 92
         (:REWRITE REMOVE-WEAK-INEQUALITIES-ONE))
     ...
     (56 56 (:REWRITE DEFAULT-+-1))
     (30 10
         (:REWRITE ADE::Q10-COMP-GCD$VALID-ST-PRESERVED))
...
(ADE::Q10-COMP-GCD$DATAFLOW-CORRECT
     ...
     (207 21
          (:LINEAR ADE::Q10-COMP-GCD$EXTRACT-NOT-EMPTY))
     ...
     (20 20 (:REWRITE |(+ x (- x))|))
     (14 14
         (:REWRITE ADE::Q10-COMP-GCD$RUN-PLUS))
     (12 12
         (:REWRITE ADE::Q10-COMP-GCD$INPUT-FORMAT-PLUS))
     (12 8
         (:REWRITE ADE::Q10-COMP-GCD$INV-PRESERVED))
     (3 3
        (:TYPE-PRESCRIPTION ADE::Q10-COMP-GCD$RUN))
...
(ADE::Q10-COMP-GCD$FUNCTIONALLY-CORRECT
     (340 4
          (:DEFINITION ADE::Q10-COMP-GCD$OUT-SEQ))
     (168 4
          (:REWRITE ADE::Q10-COMP-GCD$EXTRACT-LEMMA))
     (156 4
          (:DEFINITION ADE::Q10-COMP-GCD$IN-SEQ))
     ...
     (24 6
         (:REWRITE ADE::OPEN-Q10-COMP-GCD$INPUT-FORMAT-N-ZP))
     (24 6
         (:REWRITE ADE::OPEN-Q10-COMP-GCD$INPUT-FORMAT-N))
     (24 4
         (:REWRITE ADE::Q10-COMP-GCD$OUT-ACT-INACTIVE))
     (20 20
         (:TYPE-PRESCRIPTION ADE::Q10-COMP-GCD$OUT-ACT))
     (20 20
         (:TYPE-PRESCRIPTION ADE::Q10-COMP-GCD$IN-ACT))
     (20 20
         (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
     ...
     (15 3 (:REWRITE |(+ c (+ d x))|))
     (12 3
         (:REWRITE ADE::OPEN-Q10-COMP-GCD$RUN-ZP))
