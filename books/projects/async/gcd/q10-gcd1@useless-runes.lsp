...
(ADE::Q10-GCD1& (162 9 (:DEFINITION ASSOC-EQUAL))
                (40 10
...
(ADE::Q10-GCD1$VALID-ST=>ST-FORMAT
     ...
     (2 2 (:REWRITE DEFAULT-CAR))
     (1 1 (:REWRITE DEFAULT-CDR)))
(ADE::Q10-GCD1$DATA-IN (6 2 (:REWRITE ADE::BV-IS-TRUE-LIST))
...
(ADE::Q10-GCD1$Q10-INPUTS (1 1 (:TYPE-PRESCRIPTION ADE::F-BUF)))
(ADE::Q10-GCD1$GCD1-INPUTS (1 1 (:TYPE-PRESCRIPTION ADE::F-BUF)))
(ADE::Q10-GCD1$IN-ACT)
(ADE::Q10-GCD1$IN-ACT-INACTIVE
     ...
     (5 5
        (:TYPE-PRESCRIPTION ADE::Q10-GCD1$DATA-IN))
     (5 5
...
(ADE::BVP-Q10-GCD1$DATA-OUT
     ...
     (12 2
         (:REWRITE ADE::Q10-GCD1$OUT-ACT-INACTIVE))
...
(ADE::Q10-GCD1$VALUE
     ...
     (4 1
        (:REWRITE ADE::Q10-GCD1$IN-ACT-INACTIVE))
...
(ADE::Q10-GCD1$ST-FORMAT-PRESERVED
     ...
     (6 6
        (:TYPE-PRESCRIPTION ADE::Q10-GCD1$Q10-INPUTS))
     (6 6 (:REWRITE DEFAULT-CAR))
     (6 2
        (:REWRITE ADE::Q10-GCD1$INPUT-FORMAT=>Q10$INPUT-FORMAT))
     (5 1 (:DEFINITION PAIRLIS$))
     (4 4
        (:TYPE-PRESCRIPTION ADE::Q10-GCD1$INPUT-FORMAT))
     (4 4 (:TYPE-PRESCRIPTION BOOLEANP))
...
(ADE::Q10-GCD1$INPUT-FORMAT-PLUS
     ...
     (2 1
        (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
     (1 1 (:REWRITE |(equal (- x) (- y))|)))
(ADE::Q10-GCD1$DE-N (265 30 (:REWRITE ZP-OPEN))
                    ...
                    (3 3
                       (:REWRITE ADE::Q10-GCD1$INPUT-FORMAT-PLUS))
                    (3 3 (:REWRITE |(equal (- x) (- y))|))
...
(ADE::Q10-GCD1$EXTRACT-NOT-EMPTY
     ...
     (46 6
         (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV))
     (44 22
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-Q10-GCD1$OUT-ACT))
...
(ADE::Q10-GCD1$EXTRACTED-STEP
     (24 12
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-Q10-GCD1$IN-ACT))
     (18 18
         (:TYPE-PRESCRIPTION ADE::Q10-GCD1$INPUT-FORMAT))
     (12 6
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-Q10-GCD1$OUT-ACT)))
...
(ADE::Q10-GCD1$OUT-SEQ-LEMMA
     ...
     (111 29
          (:REWRITE ADE::Q10-GCD1$EXTRACT-LEMMA))
     (104 104
          (:REWRITE REMOVE-WEAK-INEQUALITIES-TWO))
     (92 92
         (:REWRITE REMOVE-WEAK-INEQUALITIES-ONE))
     ...
     (56 56 (:REWRITE DEFAULT-+-1))
     (30 10
         (:REWRITE ADE::Q10-GCD1$VALID-ST-PRESERVED))
...
(ADE::Q10-GCD1$DATAFLOW-CORRECT
     ...
     (207 21
          (:LINEAR ADE::Q10-GCD1$EXTRACT-NOT-EMPTY))
     ...
     (12 12
         (:REWRITE ADE::Q10-GCD1$INPUT-FORMAT-PLUS))
     (6 2
        (:REWRITE ADE::Q10-GCD1$INV-PRESERVED))
     (3 3
        (:TYPE-PRESCRIPTION ADE::Q10-GCD1$RUN))
...
(ADE::Q10-GCD1$FUNCTIONALLY-CORRECT
     ...
     (24 6
         (:REWRITE ADE::OPEN-Q10-GCD1$INPUT-FORMAT-N-ZP))
     (24 6
         (:REWRITE ADE::OPEN-Q10-GCD1$INPUT-FORMAT-N))
     (24 4
         (:REWRITE ADE::Q10-GCD1$OUT-ACT-INACTIVE))
     (20 20
         (:TYPE-PRESCRIPTION ADE::Q10-GCD1$OUT-ACT))
     (20 20
         (:TYPE-PRESCRIPTION ADE::Q10-GCD1$IN-ACT))
     (20 20
         (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
