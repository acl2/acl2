...
(defun comp-gcd-body2$ins-len (data-width)
  (declare (xargs :guard (natp data-width)))
  (+ (comp-gcd-body2$data-ins-len data-width)
     *comp-gcd-body2$go-num*))

(module-generator
 comp-gcd-body2* (data-width)
...
(defund comp-gcd-body2$netlist (data-width cnt-width)
  (declare (xargs :guard (and (posp data-width)
                              (natp cnt-width)
                              (<= 3 cnt-width))))
  (cons (comp-gcd-body2* data-width)
...
(defund comp-gcd-body2& (netlist data-width cnt-width)
  (declare (xargs :guard (and (alistp netlist)
                              ...
                              (natp cnt-width)
                              (<= 3 cnt-width))))
  (b* ((subnetlist (delete-to-eq (si 'comp-gcd-body2 data-width) netlist)))
    (and (equal (assoc (si 'comp-gcd-body2 data-width) netlist)
                (comp-gcd-body2* data-width))
...
(defund comp-gcd-body2$st-format (st data-width cnt-width)
...
(defthm comp-gcd-body2$st-format=>constraint
  (implies (comp-gcd-body2$st-format st data-width cnt-width)
           (and (posp data-width)
                (natp cnt-width)
                (<= 4 cnt-width)))
...
(defund comp-gcd-body2$valid-st (st data-width cnt-width)
  (b* ((l0 (get-field *comp-gcd-body2$l0* st))
       (l1 (get-field *comp-gcd-body2$l1* st))
       (l2 (get-field *comp-gcd-body2$l2* st))
       (sub (get-field *comp-gcd-body2$sub* st)))
...
(defthmd comp-gcd-body2$valid-st=>constraint
  (implies (comp-gcd-body2$valid-st st data-width cnt-width)
           (and (posp data-width)
                (natp cnt-width)
                (<= 4 cnt-width)))
...
(defthmd comp-gcd-body2$valid-st=>st-format
  (implies (comp-gcd-body2$valid-st st data-width cnt-width)
           (comp-gcd-body2$st-format st data-width cnt-width))
...
(progn
  ...
  (defun comp-gcd-body2$data-in (inputs data-width)
  ...
  (defthm len-comp-gcd-body2$data-in
    (equal (len (comp-gcd-body2$data-in inputs data-width))
           (* 2 (nfix data-width))))
  ...
  (defund comp-gcd-body2$a<b (inputs data-width)
    (b* ((data-in (comp-gcd-body2$data-in inputs data-width)))
      (fv-< nil t
  ...
  (defund comp-gcd-body2$sub-inputs (inputs st data-width)
    (b* ((go-signals (nthcdr (comp-gcd-body2$data-ins-len data-width) inputs))
  ...
  (defund comp-gcd-body2$in-act (inputs st data-width)
    (b* ((full-in (nth 0 inputs))
         (go-signals (nthcdr (comp-gcd-body2$data-ins-len data-width) inputs))
  ...
  (defthm comp-gcd-body2$in-act-inactive
    (implies (not (nth 0 inputs))
             (not (comp-gcd-body2$in-act inputs st data-width)))
    :hints (("Goal" :in-theory (enable comp-gcd-body2$in-act))))

  ;; Extract the "out-act" signal

  (defund comp-gcd-body2$out-act (inputs st data-width)
  ...
  (defthm comp-gcd-body2$out-act-inactive
    (implies (equal (nth 1 inputs) t)
             (not (comp-gcd-body2$out-act inputs st data-width)))
    :hints (("Goal" :in-theory (enable comp-gcd-body2$out-act))))

  (defthm comp-gcd-body2$in-out-acts-mutually-exclusive
    (implies (and (comp-gcd-body2$valid-st st data-width cnt-width)
                  (comp-gcd-body2$in-act inputs st data-width))
             (not (comp-gcd-body2$out-act inputs st data-width)))
  ...
  (defthm bvp-comp-gcd-body2$data-out
    (implies (and (comp-gcd-body2$valid-st st data-width cnt-width)
                  (comp-gcd-body2$out-act inputs st data-width))
             (bvp (comp-gcd-body2$data-out st)))
    :hints (("Goal" :in-theory (enable comp-gcd-body2$valid-st
                                       comp-gcd-body2$out-act
                                       comp-gcd-body2$data-out))))

  (defun comp-gcd-body2$outputs (inputs st data-width)
    (list* (comp-gcd-body2$in-act inputs st data-width)
           (comp-gcd-body2$out-act inputs st data-width)
...
(defthm comp-gcd-body2$value
  (b* ((inputs (list* full-in empty-out-
    ...
    (implies (and (comp-gcd-body2& netlist data-width cnt-width)
                  (true-listp data-in)
                  (equal (len data-in) (* 2 data-width))
                  (true-listp go-signals)
                  (equal (len go-signals) *comp-gcd-body2$go-num*)
                  (comp-gcd-body2$st-format st data-width cnt-width))
             (equal (se (si 'comp-gcd-body2 data-width) inputs st netlist)
                    (comp-gcd-body2$outputs inputs st data-width))))
  :hints (("Goal"
           :do-not-induct t
           :expand (:free (inputs data-width)
                          (se (si 'comp-gcd-body2 data-width)
                              inputs st netlist))
...
(defun comp-gcd-body2$step (inputs st data-width cnt-width)
  (b* ((data-in (comp-gcd-body2$data-in inputs data-width))
       ...
       (in-act (comp-gcd-body2$in-act inputs st data-width))
       (out-act (comp-gcd-body2$out-act inputs st data-width))
       ...
       (a<b (comp-gcd-body2$a<b inputs data-width))
       (d0-in (fv-if a<b
...
(defthm len-of-comp-gcd-body2$step
  (equal (len (comp-gcd-body2$step inputs st data-width cnt-width))
...
(defthm comp-gcd-body2$state
  (b* ((inputs (list* full-in empty-out-
    ...
    (implies (and (comp-gcd-body2& netlist data-width cnt-width)
                  ...
                  (equal (len go-signals) *comp-gcd-body2$go-num*)
                  (comp-gcd-body2$st-format st data-width cnt-width))
             (equal (de (si 'comp-gcd-body2 data-width) inputs st netlist)
                    (comp-gcd-body2$step inputs st data-width cnt-width))))
  :hints (("Goal"
           :do-not-induct t
           :expand (:free (inputs data-width)
                          (de (si 'comp-gcd-body2 data-width)
                              inputs st netlist))
           :in-theory (e/d (de-rules
                            comp-gcd-body2&
                            comp-gcd-body2*$destructure
...
(defund comp-gcd-body2$input-format (inputs data-width)
  (declare (xargs :guard (and (true-listp inputs)
                              (natp data-width))))
  (b* ((full-in    (nth 0 inputs))
       (empty-out- (nth 1 inputs))
       (data-in    (comp-gcd-body2$data-in inputs data-width))
       (go-signals (nthcdr (comp-gcd-body2$data-ins-len data-width) inputs)))
    (and
     (booleanp full-in)
     (booleanp empty-out-)
...
(local
 (defthm comp-gcd-body2$input-format=>sub$input-format
   (implies (and (comp-gcd-body2$input-format inputs data-width)
                 (comp-gcd-body2$valid-st st data-width cnt-width))
            (serial-sub$input-format
             (comp-gcd-body2$sub-inputs inputs st data-width)
             data-width))
   :hints (("Goal"
...
(defthm booleanp-comp-gcd-body2$in-act
  (implies (and (comp-gcd-body2$input-format inputs data-width)
                (comp-gcd-body2$valid-st st data-width cnt-width))
           (booleanp (comp-gcd-body2$in-act inputs st data-width)))
  :hints (("Goal"
...
(defthm booleanp-comp-gcd-body2$out-act
  (implies (and (comp-gcd-body2$input-format inputs data-width)
                (comp-gcd-body2$valid-st st data-width cnt-width))
           (booleanp (comp-gcd-body2$out-act inputs st data-width)))
  :hints (("Goal"
           :in-theory (e/d (comp-gcd-body2$input-format
                            comp-gcd-body2$valid-st
                            comp-gcd-body2$out-act)
...
(simulate-lemma comp-gcd-body2 :sizes (data-width cnt-width))
...
(defthm comp-gcd-body2$extract-not-empty
  (implies (and (comp-gcd-body2$out-act inputs st data-width)
                (comp-gcd-body2$valid-st st data-width cnt-width))
           (< 0 (len (comp-gcd-body2$extract st data-width))))
  :hints (("Goal"
...
(progn
  (defund comp-gcd-body2$inv (st data-width)
    (b* ((l0 (get-field *comp-gcd-body2$l0* st))
         (l1 (get-field *comp-gcd-body2$l1* st))
         (l2 (get-field *comp-gcd-body2$l2* st))
         (sub (get-field *comp-gcd-body2$sub* st))
...
(defund comp-gcd-body2$extracted-step (inputs st data-width)
  (b* ((data (comp-gcd-body2$op (comp-gcd-body2$data-in inputs data-width)))
       (extracted-st (comp-gcd-body2$extract st data-width))
       (n (1- (len extracted-st))))
    (cond
     ((equal (comp-gcd-body2$out-act inputs st data-width) t)
      (take n extracted-st))
     ((equal (comp-gcd-body2$in-act inputs st data-width) t)
      (cons data extracted-st))
     (t extracted-st))))

(local
 (defthm comp-gcd-body2$input-format-lemma-1
   (implies (comp-gcd-body2$input-format inputs data-width)
...
(local
 (defthm comp-gcd-body2$input-format-lemma-3
   (implies (and (comp-gcd-body2$input-format inputs data-width)
                 (nth 0 inputs))
            (bvp (comp-gcd-body2$data-in inputs data-width)))
   :hints (("Goal" :in-theory (enable comp-gcd-body2$input-format)))))
...
(encapsulate
  ...
  (local
   (defthm comp-gcd-body2$extracted-step-correct-aux-1
     (b* ((sub-inputs (comp-gcd-body2$sub-inputs inputs st data-width))
  ...
  (defthm comp-gcd-body2$extracted-step-correct
    (b* ((next-st (comp-gcd-body2$step inputs st data-width cnt-width)))
      (implies (and (comp-gcd-body2$input-format inputs data-width)
                    (comp-gcd-body2$valid-st st data-width cnt-width)
                    (comp-gcd-body2$inv st data-width))
               (equal (comp-gcd-body2$extract next-st data-width)
                      (comp-gcd-body2$extracted-step inputs st data-width))))
    :hints (("Goal"
             :use comp-gcd-body2$input-format=>sub$input-format
             :in-theory (e/d (get-field
                              joint-act
...
(defthm comp-gcd-body2$extract-lemma
  (implies (and (comp-gcd-body2$valid-st st data-width cnt-width)
           ...
           (equal (list (comp-gcd-body2$data-out st))
                  (nthcdr (1- (len (comp-gcd-body2$extract st data-width)))
                          (comp-gcd-body2$extract st data-width))))
  :hints (("Goal"
           :do-not-induct t
...
(seq-gen comp-gcd-body2 in in-act 0
         (comp-gcd-body2$data-in inputs data-width)
...
(encapsulate
  ...
  (defthmd comp-gcd-body2$dataflow-correct
    (b* ((extracted-st (comp-gcd-body2$extract st data-width))
         (final-st (comp-gcd-body2$run
                    inputs-seq st data-width cnt-width n))
         (final-extracted-st (comp-gcd-body2$extract final-st data-width)))
      (implies
       (and (comp-gcd-body2$input-format-n inputs-seq data-width n)
            (comp-gcd-body2$valid-st st data-width cnt-width)
            (comp-gcd-body2$inv st data-width))
  ...
  (defthmd comp-gcd-body2$functionally-correct
    (b* ((extracted-st (comp-gcd-body2$extract st data-width))
         (final-st (de-n (si 'comp-gcd-body2 data-width)
                         inputs-seq st netlist n))
         (final-extracted-st (comp-gcd-body2$extract final-st data-width)))
      (implies
       (and (comp-gcd-body2& netlist data-width cnt-width)
            (comp-gcd-body2$input-format-n inputs-seq data-width n)
            (comp-gcd-body2$valid-st st data-width cnt-width)
            (comp-gcd-body2$inv st data-width))
       (equal (append final-extracted-st
                      (comp-gcd-body2$netlist-out-seq
                       inputs-seq st netlist data-width n))
              (append (comp-gcd-body2$op-map
                       (comp-gcd-body2$netlist-in-seq
                        inputs-seq st netlist data-width n))
                      extracted-st))))
    :hints (("Goal"
