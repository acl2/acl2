...
(ADE::GCD2$INS-LEN)
(ADE::GCD2*)
(ADE::GCD2*$DESTRUCTURE (360 36 (:DEFINITION BINARY-APPEND))
...
(ADE::NOT-PRIMP-GCD2 (72 36 (:REWRITE SIMPLIFY-SUMS-EQUAL))
                     (72 36
...
(ADE::GCD2$NETLIST)
(ADE::GCD2& (216 12 (:DEFINITION ASSOC-EQUAL))
            (52 13
...
(ADE::GCD2$VALID-ST=>ST-FORMAT
     ...
     (6 2 (:REWRITE ADE::BV-IS-TRUE-LIST))
     (5 1 (:DEFINITION TRUE-LISTP)))
(ADE::GCD2$DATA-IN (6 2 (:REWRITE ADE::BV-IS-TRUE-LIST))
                   (5 1 (:DEFINITION TRUE-LISTP))
                   ...
                   (1 1 (:REWRITE |(< (- x) (- y))|))
                   (1 1 (:META META-INTEGERP-CORRECT)))
(ADE::LEN-GCD2$DATA-IN (14 1 (:DEFINITION NATP))
                       (3 3
                          (:REWRITE SIMPLIFY-TERMS-SUCH-AS-A+AB-<-0))
                       (3 3 (:REWRITE SIMPLIFY-SUMS-<))
                       (3 3
...
(ADE::GCD2$ME-INPUTS)
(ADE::GCD2$BR-INPUTS (1 1 (:TYPE-PRESCRIPTION ADE::F-BUF)))
(ADE::GCD2$BODY-INPUTS (2 2 (:TYPE-PRESCRIPTION ADE::F-BUF)))
(ADE::GCD2$IN-ACT)
(ADE::GCD2$IN-ACT-INACTIVE
     ...
     (5 5
        (:TYPE-PRESCRIPTION ADE::GCD2$DATA-IN))
     (5 5
        (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
...
(ADE::BVP-GCD2$DATA-OUT
     ...
     (97 97 (:REWRITE |(< (- x) (- y))|))
     (96 16
         (:REWRITE ADE::GCD2$OUT-ACT-INACTIVE))
...
(ADE::GCD2$VALUE
     ...
     (6 6
        (:TYPE-PRESCRIPTION ADE::GCD-COND$DATA1-OUT))
     (6 6
...
(ADE::GCD2$STATE
     ...
     (10 10
         (:TYPE-PRESCRIPTION ADE::GCD-BODY2$VALID-ST))
     (9 3
        (:REWRITE ADE::BOOLEANP-GCD-BODY2$OUT-ACT))
     (8 8
        (:REWRITE SIMPLIFY-TERMS-SUCH-AS-0-<-A+AB))
     (8 8 (:REWRITE |(< 0 (- x))|))
     ...
     (5 5
        (:REWRITE SIMPLIFY-TERMS-SUCH-AS-A+AB-<-0))
     (5 5
        (:REWRITE ADE::LEN-GCD-BODY2$DATA-OUT-2))
     (5 5 (:REWRITE |(< (- x) 0)|))
...
(ADE::GCD2$ST-FORMAT-PRESERVED
     ...
     (6 6
        (:TYPE-PRESCRIPTION ADE::GCD2$BODY-INPUTS))
     (6 6
     ...
     (6 2
        (:REWRITE ADE::GCD2$INPUT-FORMAT=>BODY$INPUT-FORMAT))
     (6 1 (:DEFINITION BINARY-APPEND))
     (5 2 (:REWRITE APPEND-WHEN-NOT-CONSP))
     (4 4
        (:TYPE-PRESCRIPTION ADE::GCD2$INPUT-FORMAT))
     (4 4
        (:TYPE-PRESCRIPTION ADE::GCD-BODY2$VALID-ST))
     (4 4 (:REWRITE REDUCE-INTEGERP-+))
     (4 4 (:REWRITE INTEGERP-MINUS-X))
     ...
     (1 1 (:REWRITE |(< 0 (* x y))|))
     (1 1 (:REWRITE |(< (* x y) 0)|)))
(ADE::GCD2$VALUE-ALT (442 34 (:DEFINITION NTHCDR))
                     ...
                     (9 9 (:REWRITE |(< (- x) (- y))|))
                     (4 4 (:REWRITE |(* (- x) y)|)))
(ADE::GCD2$STATE-ALT (403 31 (:DEFINITION NTHCDR))
...
(ADE::GCD2$RUN-PLUS
     ...
     (2 2 (:META META-INTEGERP-CORRECT))
     (1 1 (:REWRITE |(equal (- x) (- y))|)))
(ADE::GCD2$INPUT-FORMAT-N (6 2 (:REWRITE ADE::BV-IS-TRUE-LIST))
                          (5 1 (:DEFINITION TRUE-LISTP))
                          (4 4 (:TYPE-PRESCRIPTION ADE::BVP))
                          (4 4
                             (:REWRITE SIMPLIFY-TERMS-SUCH-AS-A+AB-<-0))
...
(ADE::GCD2$INPUT-FORMAT-PLUS
     ...
     (2 1
        (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
     (1 1 (:REWRITE |(equal (- x) (- y))|)))
(ADE::GCD2$DE-N (265 30 (:REWRITE ZP-OPEN))
                ...
                (7 7 (:REWRITE DEFAULT-+-1))
                (3 3
                   (:REWRITE ADE::GCD2$INPUT-FORMAT-PLUS))
                (3 3 (:REWRITE |(equal (- x) (- y))|))
...
(ADE::GCD2$EXTRACT-NOT-EMPTY
     ...
     (56 28
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-GCD2$OUT-ACT))
     (56 8 (:REWRITE ADE::CAR-V-THREEFIX))
     ...
     (10 10
         (:TYPE-PRESCRIPTION ADE::GCD-BODY2$EXTRACT))
...
(ADE::GCD2$INPUT-FORMAT-LEMMA-2
     ...
     (3 3 (:REWRITE DEFAULT-+-1))
     (2 2
        (:TYPE-PRESCRIPTION ADE::GCD2$INPUT-FORMAT-LEMMA-1))
     (2 2
        (:REWRITE SIMPLIFY-TERMS-SUCH-AS-A+AB-<-0))
     (2 2 (:REWRITE SIMPLIFY-SUMS-<))
     (2 2
     ...
     (1 1
        (:REWRITE NORMALIZE-FACTORS-GATHER-EXPONENTS))
     (1 1
        (:REWRITE ADE::GCD2$INPUT-FORMAT-LEMMA-1))
     (1 1 (:REWRITE DEFAULT-CDR))
     (1 1 (:REWRITE DEFAULT-*-2))
     (1 1 (:REWRITE DEFAULT-*-1)))
(ADE::GCD2$INPUT-FORMAT-LEMMA-3
     ...
     (3 3 (:REWRITE DEFAULT-+-1))
     (2 2
        (:TYPE-PRESCRIPTION ADE::GCD2$INPUT-FORMAT-LEMMA-2))
     (2 2
        (:REWRITE SIMPLIFY-TERMS-SUCH-AS-A+AB-<-0))
     (2 2 (:REWRITE SIMPLIFY-SUMS-<))
     (2 2
     ...
     (1 1
        (:REWRITE NORMALIZE-FACTORS-GATHER-EXPONENTS))
     (1 1
        (:REWRITE ADE::GCD2$INPUT-FORMAT-LEMMA-2))
     (1 1
        (:REWRITE ADE::GCD2$INPUT-FORMAT-LEMMA-1))
     (1 1 (:REWRITE DEFAULT-CDR))
     (1 1 (:REWRITE DEFAULT-*-2))
...
(ADE::GCD2$INV-PRESERVED
     ...
     (22 7
         (:REWRITE ADE::GCD2$INPUT-FORMAT-LEMMA-3))
...
(ADE::GCD2$EXTRACTED-STEP
     (24 12
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-GCD2$IN-ACT))
     (18 18
         (:TYPE-PRESCRIPTION ADE::GCD2$INPUT-FORMAT))
     (12 6
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-GCD2$OUT-ACT)))
...
(ADE::GCD2$EXTRACT-LEMMA
     ...
     (17 17
         (:TYPE-PRESCRIPTION ADE::GCD-COND$DATA-INS-LEN))
...
(ADE::GCD2$IN-SEQ-LEMMA
     ...
     (160 160
          (:TYPE-PRESCRIPTION ADE::GCD2$ME-INPUTS))
...
(ADE::GCD2$OUT-SEQ-LEMMA
     ...
     (725 65 (:REWRITE ZP-OPEN))
     (680 680
          (:TYPE-PRESCRIPTION ADE::GCD2$BR-INPUTS))
     ...
     (30 10
         (:REWRITE ADE::GCD2$VALID-ST-PRESERVED))
...
(ADE::GCD2$DATAFLOW-CORRECT
     ...
     (207 21
          (:LINEAR ADE::GCD2$EXTRACT-NOT-EMPTY))
     ...
     (108 108
          (:TYPE-PRESCRIPTION ADE::GCD2$IN-SEQ))
...
(ADE::GCD2$FUNCTIONALLY-CORRECT
     ...
     (24 6
         (:REWRITE ADE::OPEN-GCD2$INPUT-FORMAT-N-ZP))
     (24 6
         (:REWRITE ADE::OPEN-GCD2$INPUT-FORMAT-N))
     (20 20
         (:TYPE-PRESCRIPTION ADE::GCD2$OUT-ACT))
     (20 20
         (:TYPE-PRESCRIPTION ADE::GCD2$IN-ACT))
     (20 20
         (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
