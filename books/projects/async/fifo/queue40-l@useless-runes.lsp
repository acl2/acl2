(ADE::QUEUE40-L$DATA-INS-LEN (1 1 (:REWRITE NATP-RW)))
(ADE::QUEUE40-L$INS-LEN)
(ADE::QUEUE40-L* (25 25 (:TYPE-PRESCRIPTION POSP)))
(ADE::QUEUE40-L*$DESTRUCTURE (180 18 (:DEFINITION BINARY-APPEND))
...
(ADE::QUEUE40-L$ST-FORMAT=>CONSTRAINT (2 2 (:REWRITE NTH-WHEN-PREFIXP))
                                      (1 1 (:REWRITE NATP-RW)))
(ADE::QUEUE40-L$VALID-ST)
(ADE::QUEUE40-L$VALID-ST=>CONSTRAINT (2 2 (:REWRITE NTH-WHEN-PREFIXP))
                                     (1 1 (:REWRITE NATP-RW)))
(ADE::QUEUE40-L$VALID-ST=>ST-FORMAT (4 4 (:REWRITE NTH-WHEN-PREFIXP)))
(ADE::QUEUE40-L$IN-ACT)
(ADE::QUEUE40-L$OUT-ACT)
(ADE::QUEUE40-L$DATA-IN (6 2 (:REWRITE ADE::BV-IS-TRUE-LIST))
...
(ADE::QUEUE40-L$READY-IN-
     (5 5
        (:TYPE-PRESCRIPTION ADE::BOOLEANP-QUEUE20-L$READY-IN-)))
(ADE::BOOLEANP-QUEUE40-L$READY-IN- (2 2 (:REWRITE NTH-WHEN-PREFIXP)))
(ADE::QUEUE40-L$READY-OUT
     (5 5
        (:TYPE-PRESCRIPTION ADE::BOOLEANP-QUEUE20-L$READY-OUT)))
(ADE::BOOLEANP-QUEUE40-L$READY-OUT (2 2 (:REWRITE NTH-WHEN-PREFIXP)))
...
(ADE::LEN-QUEUE40-L$DATA-OUT-1
     ...
     (1 1
        (:REWRITE ADE::LEN-QUEUE20-L$DATA-OUT-2)))
(ADE::LEN-QUEUE40-L$DATA-OUT-2
     (4 4 (:LINEAR LEN-WHEN-PREFIXP))
     (3 3 (:REWRITE NTH-WHEN-PREFIXP))
     (2 2
        (:LINEAR ADE::A-HELPFUL-LEMMA-FOR-TREE-INDUCTIONS)))
(ADE::BVP-QUEUE40-L$DATA-OUT (4 4 (:REWRITE NTH-WHEN-PREFIXP)))
...
(ADE::QUEUE40-L$STEP-V-THREEFIX-OF-DATA-IN-CANCELED
     ...
     (10 10
         (:TYPE-PRESCRIPTION ADE::QUEUE20-L$DATA-OUT))
     (10 4
...
(ADE::QUEUE40-L$STATE
     ...
     (3 3
        (:REWRITE ADE::BVP-QUEUE20-L$DATA-OUT))
...
(ADE::BOOLEANP-QUEUE40-L$OUT-ACT
     ...
     (4 1 (:REWRITE COMMUTATIVITY-OF-+))
     (3 3
        (:TYPE-PRESCRIPTION ADE::BOOLEANP-QUEUE40-L$IN-ACT))
     (3 3 (:REWRITE DEFAULT-+-2))
     (3 3 (:REWRITE DEFAULT-+-1))
     (3 1 (:REWRITE FOLD-CONSTS-IN-+))
     (2 2 (:TYPE-PRESCRIPTION NATP))
     ...
     (1 1 (:REWRITE DEFAULT-<-1))
     (1 1
        (:REWRITE ADE::BOOLEANP-QUEUE40-L$IN-ACT)))
(ADE::QUEUE40-L$ST-FORMAT-PRESERVED (7 7 (:REWRITE NTH-WHEN-PREFIXP)))
(ADE::QUEUE40-L$VALUE-ALT
     ...
     (12 12
         (:REWRITE ADE::BOOLEANP-QUEUE40-L$OUT-ACT))
     (7 7
        (:REWRITE ADE::BOOLEANP-QUEUE40-L$IN-ACT)))
...
(ADE::QUEUE40-L$DE-N (114 30 (:REWRITE ZP-OPEN))
                     (36 36
                         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
                     ...
                     (3 3
                        (:REWRITE ADE::QUEUE40-L$INPUT-FORMAT-PLUS))
                     (2 2 (:REWRITE ADE::DE-PLUS)))
(ADE::QUEUE40-L$EXTRACT)
(ADE::QUEUE40-L$EXTRACT-NOT-EMPTY
     (21 3 (:DEFINITION LEN))
     (17 17
         (:TYPE-PRESCRIPTION ADE::QUEUE20-L$EXTRACT))
...
(ADE::QUEUE40-L$EXTRACTED-STEP
     (12 12
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-QUEUE40-L$IN-ACT))
     (6 6
        (:TYPE-PRESCRIPTION ADE::BOOLEANP-QUEUE40-L$OUT-ACT)))
...
(ADE::QUEUE40-L$Q20-L0-DATA-IN-REWRITE
     ...
     (1 1
        (:REWRITE ADE::QUEUE20-L$READY-OUT-LEMMA))
     (1 1 (:REWRITE NATP-RW)))
...
(ADE::QUEUE40-L$Q20-L1-IN-ACT-=-Q20-L0-OUT-ACT
     ...
     (18 18
         (:LINEAR ADE::A-HELPFUL-LEMMA-FOR-TREE-INDUCTIONS))
     (15 15
         (:TYPE-PRESCRIPTION ADE::QUEUE40-L$DATA-IN))
     (15 15
         (:TYPE-PRESCRIPTION ADE::QUEUE20-L$DATA-OUT))
...
(ADE::QUEUE40-L$EXTRACTED-STEP-CORRECT
     ...
     (5 5
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (4 4 (:REWRITE NATP-RW)))
(ADE::QUEUE40-L$VALID-ST-PRESERVED (17 17 (:REWRITE NTH-WHEN-PREFIXP)))
...
(ADE::QUEUE40-L$OUT-SEQ-LEMMA
     ...
     (42 42 (:REWRITE NTH-WHEN-PREFIXP))
     (34 20
         (:REWRITE ADE::QUEUE40-L$EXTRACT-LEMMA-1))
     (30 30
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-QUEUE40-L$OUT-ACT))
     (30 10 (:REWRITE FOLD-CONSTS-IN-+))
     (20 4 (:DEFINITION NTHCDR))
     (14 14
         (:TYPE-PRESCRIPTION ADE::QUEUE40-L$VALID-ST))
...
(ADE::QUEUE40-L$DATAFLOW-CORRECT
     ...
     (3 3
        (:TYPE-PRESCRIPTION ADE::QUEUE40-L$RUN))
...
(ADE::QUEUE40-L$FUNCTIONALLY-CORRECT
     ...
     (20 5
         (:REWRITE ADE::OPEN-QUEUE40-L$INPUT-FORMAT-N-ZP))
     (20 5
         (:REWRITE ADE::OPEN-QUEUE40-L$INPUT-FORMAT-N))
