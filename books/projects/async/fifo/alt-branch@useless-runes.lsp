(ADE::ALT-BRANCH$DATA-INS-LEN (1 1 (:REWRITE DEFAULT-<-2))
                              (1 1 (:REWRITE DEFAULT-<-1)))
(ADE::ALT-BRANCH$INS-LEN)
(ADE::ALT-BRANCH* (12 12 (:TYPE-PRESCRIPTION POSP)))
(ADE::ALT-BRANCH*$DESTRUCTURE (66 12 (:REWRITE APPEND-WHEN-NOT-CONSP))
...
(ADE::ALT-BRANCH$DATA-IN (6 2 (:REWRITE ADE::BV-IS-TRUE-LIST))
...
(ADE::ALT-BRANCH$ACT0 (10 5
                          (:TYPE-PRESCRIPTION ADE::BOOLEANP-JOINT-ACT))
                      (5 5 (:TYPE-PRESCRIPTION BOOLEANP)))
(ADE::ALT-BRANCH$ACT0-INACTIVE (25 8 (:REWRITE ADE::F-GATES=B-GATES))
...
(ADE::ALT-BRANCH$ACT1 (10 5
                          (:TYPE-PRESCRIPTION ADE::BOOLEANP-JOINT-ACT))
                      (5 5 (:TYPE-PRESCRIPTION BOOLEANP)))
(ADE::ALT-BRANCH$ACT1-INACTIVE (31 10 (:REWRITE ADE::F-GATES=B-GATES))
                               (19 19 (:REWRITE NTH-WHEN-PREFIXP))
                               ...
                               (2 2 (:REWRITE DEFAULT-CDR)))
(ADE::ALT-BRANCH$ACT)
(ADE::ALT-BRANCH$ACT-INACTIVE (4 4 (:REWRITE NTH-WHEN-PREFIXP)))
...
(ADE::BOOLEANP-ALT-BRANCH$ACT1
     ...
     (3 1 (:DEFINITION NATP))
     (1 1 (:TYPE-PRESCRIPTION NATP)))
(ADE::BOOLEANP-ALT-BRANCH$ACT (13 13 (:REWRITE NTH-WHEN-PREFIXP))
                              (7 1
                                 (:REWRITE ADE::ALT-BRANCH$ACT-INACTIVE))
                              (6 1
                                 (:REWRITE ADE::ALT-BRANCH$ACT1-INACTIVE))
