(ADE::QUEUE2$DATA-INS-LEN (1 1 (:REWRITE DEFAULT-<-2))
                          (1 1 (:REWRITE DEFAULT-<-1)))
(ADE::QUEUE2$INS-LEN)
(ADE::QUEUE2* (24 24 (:TYPE-PRESCRIPTION POSP)))
(ADE::QUEUE2*$DESTRUCTURE (66 12 (:REWRITE APPEND-WHEN-NOT-CONSP))
...
(ADE::QUEUE2$ST-FORMAT=>CONSTRAINT (5 1 (:DEFINITION LEN))
                                   (3 3 (:REWRITE NTH-WHEN-PREFIXP))
                                   (2 1 (:REWRITE DEFAULT-+-2))
                                   (1 1 (:REWRITE DEFAULT-CDR))
                                   (1 1 (:REWRITE DEFAULT-+-1)))
(ADE::QUEUE2$VALID-ST)
(ADE::QUEUE2$VALID-ST=>CONSTRAINT (5 5 (:REWRITE NTH-WHEN-PREFIXP))
                                  (5 1 (:DEFINITION LEN))
                                  (2 1 (:REWRITE DEFAULT-+-2))
                                  (1 1 (:REWRITE DEFAULT-CDR))
                                  (1 1 (:REWRITE DEFAULT-+-1)))
(ADE::QUEUE2$VALID-ST=>ST-FORMAT (14 14 (:REWRITE NTH-WHEN-PREFIXP))
                                 (8 2 (:DEFINITION STRIP-CARS))
                                 (4 4 (:REWRITE DEFAULT-CAR))
                                 (2 2 (:REWRITE DEFAULT-CDR)))
(ADE::QUEUE2$DATA-IN (6 2 (:REWRITE ADE::BV-IS-TRUE-LIST))
...
(ADE::QUEUE2$IN-ACT (10 5
                        (:TYPE-PRESCRIPTION ADE::BOOLEANP-JOINT-ACT))
                    (5 5 (:TYPE-PRESCRIPTION BOOLEANP)))
(ADE::QUEUE2$IN-ACT-INACTIVE (8 1 (:DEFINITION NTHCDR))
...
(ADE::QUEUE2$OUT-ACT (10 5
                         (:TYPE-PRESCRIPTION ADE::BOOLEANP-JOINT-ACT))
                     (5 5 (:TYPE-PRESCRIPTION BOOLEANP)))
(ADE::QUEUE2$OUT-ACT-INACTIVE (8 1 (:DEFINITION NTHCDR))
                              (5 5 (:REWRITE NTH-WHEN-PREFIXP))
                              (5 1 (:REWRITE ADE::NFIX-OF-NAT))
                              (4 1 (:REWRITE COMMUTATIVITY-OF-+))
                              (3 3 (:REWRITE DEFAULT-+-2))
...
(ADE::LEN-QUEUE2$DATA-OUT-2
     ...
     (2 2
        (:LINEAR ADE::A-HELPFUL-LEMMA-FOR-TREE-INDUCTIONS)))
(ADE::BVP-QUEUE2$DATA-OUT (32 32 (:REWRITE NTH-WHEN-PREFIXP))
...
(ADE::QUEUE2$OUTPUTS)
(ADE::QUEUE2$VALUE (418 209 (:REWRITE DEFAULT-+-2))
...
(ADE::QUEUE2$STEP (12 6
                      (:TYPE-PRESCRIPTION ADE::BOOLEANP-JOINT-ACT))
                  (6 6 (:TYPE-PRESCRIPTION BOOLEANP)))
(ADE::QUEUE2$STATE (777 389 (:REWRITE DEFAULT-+-2))
...
(ADE::BOOLEANP-QUEUE2$IN-ACT (40 40 (:REWRITE NTH-WHEN-PREFIXP))
                             (40 8 (:DEFINITION LEN))
                             ...
                             (3 1 (:DEFINITION NATP))
                             (1 1 (:TYPE-PRESCRIPTION NATP)))
(ADE::BOOLEANP-QUEUE2$OUT-ACT (40 40 (:REWRITE NTH-WHEN-PREFIXP))
                              (40 8 (:DEFINITION LEN))
                              (40 5 (:DEFINITION NTHCDR))
                              (31 23 (:REWRITE DEFAULT-+-2))
                              (26 4 (:REWRITE ADE::BV-IS-TRUE-LIST))
...
(ADE::QUEUE2$ST-FORMAT-PRESERVED
     ...
     (6 6
        (:TYPE-PRESCRIPTION ADE::QUEUE2$IN-ACT))
     (6 6 (:TYPE-PRESCRIPTION ADE::JOINT-ACT))
     (6 2 (:REWRITE FOLD-CONSTS-IN-+))
     (6 2
        (:REWRITE ADE::BOOLEANP-QUEUE2$IN-ACT))
     (4 2
        (:REWRITE ADE::QUEUE2$IN-ACT-INACTIVE))
...
(ADE::QUEUE2$INPUT-FORMAT-N (6 2 (:REWRITE ADE::BV-IS-TRUE-LIST))
                            (5 1 (:DEFINITION TRUE-LISTP))
                            (4 4 (:TYPE-PRESCRIPTION ADE::BVP))
                            (4 4 (:REWRITE DEFAULT-<-2))
...
(ADE::QUEUE2$INPUT-FORMAT-PLUS
     ...
     (23 23 (:REWRITE DEFAULT-+-1))
     (12 12 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(ADE::QUEUE2$DE-N (90 30 (:REWRITE ZP-OPEN))
                  ...
                  (3 3
                     (:REWRITE ADE::QUEUE2$INPUT-FORMAT-PLUS))
...
(ADE::QUEUE2$EXTRACT-LEMMA
     ...
     (8 4
        (:REWRITE ADE::QUEUE2$OUT-ACT-INACTIVE))
     (4 4 (:TYPE-PRESCRIPTION BOOLEANP)))
(ADE::QUEUE2$IN-SEQ (12 6
                        (:TYPE-PRESCRIPTION ADE::BOOLEANP-QUEUE2$IN-ACT))
                    (6 6
                       (:TYPE-PRESCRIPTION ADE::QUEUE2$INPUT-FORMAT)))
(ADE::QUEUE2$IN-SEQ-NETLIST)
(ADE::QUEUE2$IN-SEQ-LEMMA (416 208
                               (:TYPE-PRESCRIPTION ADE::BOOLEANP-JOINT-ACT))
                          ...
                          (6 6
                             (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV)))
(ADE::QUEUE2$OUT-SEQ (12 6
                         (:TYPE-PRESCRIPTION ADE::BOOLEANP-QUEUE2$OUT-ACT))
                     (6 6
                        (:TYPE-PRESCRIPTION ADE::QUEUE2$INPUT-FORMAT)))
(ADE::QUEUE2$OUT-SEQ-NETLIST)
(ADE::QUEUE2$OUT-SEQ-LEMMA (416 208
                                (:TYPE-PRESCRIPTION ADE::BOOLEANP-JOINT-ACT))
...
(ADE::QUEUE2$DATAFLOW-CORRECT
     ...
     (32 32
         (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV))
     (28 28
         (:TYPE-PRESCRIPTION ADE::QUEUE2$STEP))
...
(ADE::QUEUE2$FUNCTIONALLY-CORRECT
     ...
     (20 5
         (:REWRITE ADE::OPEN-QUEUE2$INPUT-FORMAT-N-ZP))
     (20 5
         (:REWRITE ADE::OPEN-QUEUE2$INPUT-FORMAT-N))
     (16 16
         (:TYPE-PRESCRIPTION ADE::QUEUE2$INPUT-FORMAT))
     (16 8
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-QUEUE2$OUT-ACT))
