(ADE::QUEUE4$DATA-INS-LEN (1 1 (:REWRITE DEFAULT-<-2))
                          (1 1 (:REWRITE DEFAULT-<-1)))
(ADE::QUEUE4$INS-LEN)
(ADE::QUEUE4* (38 38 (:TYPE-PRESCRIPTION POSP)))
(ADE::QUEUE4*$DESTRUCTURE (66 12 (:REWRITE APPEND-WHEN-NOT-CONSP))
...
(ADE::QUEUE4$ST-FORMAT=>CONSTRAINT (5 5 (:REWRITE NTH-WHEN-PREFIXP))
                                   (5 1 (:DEFINITION LEN))
                                   (2 1 (:REWRITE DEFAULT-+-2))
                                   (1 1 (:REWRITE DEFAULT-CDR))
                                   (1 1 (:REWRITE DEFAULT-+-1)))
(ADE::QUEUE4$VALID-ST)
(ADE::QUEUE4$VALID-ST=>CONSTRAINT (7 7 (:REWRITE NTH-WHEN-PREFIXP))
                                  (5 1 (:DEFINITION LEN))
                                  (2 1 (:REWRITE DEFAULT-+-2))
                                  (1 1 (:REWRITE DEFAULT-CDR))
                                  (1 1 (:REWRITE DEFAULT-+-1)))
(ADE::QUEUE4$VALID-ST=>ST-FORMAT (76 76 (:REWRITE NTH-WHEN-PREFIXP))
                                 (16 4 (:DEFINITION STRIP-CARS))
                                 (8 8 (:REWRITE DEFAULT-CAR))
                                 (4 4 (:REWRITE DEFAULT-CDR)))
(ADE::QUEUE4$DATA-IN (6 2 (:REWRITE ADE::BV-IS-TRUE-LIST))
...
(ADE::QUEUE4$IN-ACT (10 5
                        (:TYPE-PRESCRIPTION ADE::BOOLEANP-JOINT-ACT))
                    (5 5 (:TYPE-PRESCRIPTION BOOLEANP)))
(ADE::QUEUE4$IN-ACT-INACTIVE (8 1 (:DEFINITION NTHCDR))
...
(ADE::QUEUE4$OUT-ACT (10 5
                         (:TYPE-PRESCRIPTION ADE::BOOLEANP-JOINT-ACT))
                     (5 5 (:TYPE-PRESCRIPTION BOOLEANP)))
(ADE::QUEUE4$OUT-ACT-INACTIVE (8 1 (:DEFINITION NTHCDR))
                              (5 5 (:REWRITE NTH-WHEN-PREFIXP))
                              (5 1 (:REWRITE ADE::NFIX-OF-NAT))
                              (4 1 (:REWRITE COMMUTATIVITY-OF-+))
                              (3 3 (:REWRITE DEFAULT-+-2))
...
(ADE::LEN-QUEUE4$DATA-OUT-2
     ...
     (2 2
        (:LINEAR ADE::A-HELPFUL-LEMMA-FOR-TREE-INDUCTIONS)))
(ADE::BVP-QUEUE4$DATA-OUT (128 16 (:DEFINITION NTHCDR))
                          ...
                          (32 16
                              (:TYPE-PRESCRIPTION ADE::BOOLEANP-JOINT-ACT))
                          (32 16
                              (:REWRITE ADE::QUEUE4$OUT-ACT-INACTIVE))
                          (24 24 (:REWRITE DEFAULT-CAR))
                          (20 4 (:DEFINITION LEN))
                          (16 16 (:TYPE-PRESCRIPTION BOOLEANP)))
(ADE::QUEUE4$OUTPUTS)
(ADE::QUEUE4$VALUE (882 441 (:REWRITE DEFAULT-+-2))
...
(ADE::BOOLEANP-QUEUE4$IN-ACT (136 17 (:DEFINITION NTHCDR))
                             (112 112 (:REWRITE NTH-WHEN-PREFIXP))
                             ...
                             (3 1 (:DEFINITION NATP))
                             (1 1 (:TYPE-PRESCRIPTION NATP)))
(ADE::BOOLEANP-QUEUE4$OUT-ACT (136 17 (:DEFINITION NTHCDR))
                              (112 112 (:REWRITE NTH-WHEN-PREFIXP))
                              (71 61 (:REWRITE DEFAULT-+-2))
                              (68 17 (:REWRITE COMMUTATIVITY-OF-+))
                              (61 61 (:REWRITE DEFAULT-+-1))
...
(ADE::QUEUE4$ST-FORMAT-PRESERVED
     ...
     (12 6
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-QUEUE4$IN-ACT))
     (12 4 (:REWRITE FOLD-CONSTS-IN-+))
     (10 10
         (:TYPE-PRESCRIPTION ADE::QUEUE4$INPUT-FORMAT))
     (6 6
        (:TYPE-PRESCRIPTION ADE::QUEUE4$IN-ACT))
     (6 2
        (:REWRITE ADE::BOOLEANP-QUEUE4$IN-ACT))
...
(ADE::QUEUE4$INPUT-FORMAT-N (6 2 (:REWRITE ADE::BV-IS-TRUE-LIST))
                            (5 1 (:DEFINITION TRUE-LISTP))
                            (4 4 (:TYPE-PRESCRIPTION ADE::BVP))
                            (4 4 (:REWRITE DEFAULT-<-2))
                            (4 4 (:REWRITE DEFAULT-<-1))
...
(ADE::QUEUE4$INPUT-FORMAT-PLUS
     ...
     (12 12 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(ADE::QUEUE4$DE-N (90 30 (:REWRITE ZP-OPEN))
                  ...
                  (3 3
                     (:REWRITE ADE::QUEUE4$INPUT-FORMAT-PLUS))
...
(ADE::QUEUE4$EXTRACT-NOT-EMPTY
     ...
     (72 36
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-QUEUE4$OUT-ACT))
     (64 16 (:REWRITE COMMUTATIVITY-OF-+))
     (48 16 (:REWRITE FOLD-CONSTS-IN-+))
...
(ADE::QUEUE4$EXTRACT-LEMMA
     ...
     (32 16
         (:REWRITE ADE::QUEUE4$OUT-ACT-INACTIVE))
     (16 16 (:TYPE-PRESCRIPTION BOOLEANP)))
(ADE::QUEUE4$IN-SEQ (12 6
                        (:TYPE-PRESCRIPTION ADE::BOOLEANP-QUEUE4$IN-ACT))
                    (6 6
                       (:TYPE-PRESCRIPTION ADE::QUEUE4$INPUT-FORMAT)))
(ADE::QUEUE4$IN-SEQ-NETLIST)
(ADE::QUEUE4$IN-SEQ-LEMMA (416 208
                               (:TYPE-PRESCRIPTION ADE::BOOLEANP-JOINT-ACT))
                          ...
                          (6 6
                             (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV)))
(ADE::QUEUE4$OUT-SEQ (12 6
                         (:TYPE-PRESCRIPTION ADE::BOOLEANP-QUEUE4$OUT-ACT))
                     (6 6
                        (:TYPE-PRESCRIPTION ADE::QUEUE4$INPUT-FORMAT)))
(ADE::QUEUE4$OUT-SEQ-NETLIST)
(ADE::QUEUE4$OUT-SEQ-LEMMA (416 208
                                (:TYPE-PRESCRIPTION ADE::BOOLEANP-JOINT-ACT))
...
(ADE::QUEUE4$DATAFLOW-CORRECT
     ...
     (56 6
         (:LINEAR ADE::QUEUE4$EXTRACT-NOT-EMPTY))
     ...
     (32 32
         (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV))
     (28 28
         (:TYPE-PRESCRIPTION ADE::QUEUE4$STEP))
...
(ADE::QUEUE4$FUNCTIONALLY-CORRECT
     ...
     (20 5
         (:REWRITE ADE::OPEN-QUEUE4$INPUT-FORMAT-N-ZP))
     (20 5
         (:REWRITE ADE::OPEN-QUEUE4$INPUT-FORMAT-N))
     (16 16
         (:TYPE-PRESCRIPTION ADE::QUEUE4$INPUT-FORMAT))
     (16 8
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-QUEUE4$OUT-ACT))
     ...
     (8 8
        (:TYPE-PRESCRIPTION ADE::QUEUE4$OUT-ACT))
     (8 8
        (:TYPE-PRESCRIPTION ADE::QUEUE4$IN-ACT))
     (8 8 (:REWRITE NTH-WHEN-PREFIXP))
     (8 8
