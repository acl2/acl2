(ADE::QUEUE3-L$DATA-INS-LEN (1 1 (:REWRITE DEFAULT-<-2))
                            (1 1 (:REWRITE DEFAULT-<-1)))
(ADE::QUEUE3-L$INS-LEN)
(ADE::QUEUE3-L* (27 27 (:TYPE-PRESCRIPTION POSP)))
(ADE::QUEUE3-L*$DESTRUCTURE (66 12 (:REWRITE APPEND-WHEN-NOT-CONSP))
...
(ADE::QUEUE3-L$ST-FORMAT=>CONSTRAINT (5 1 (:DEFINITION LEN))
                                     (4 4 (:REWRITE NTH-WHEN-PREFIXP))
                                     (2 1 (:REWRITE DEFAULT-+-2))
                                     (1 1 (:REWRITE DEFAULT-CDR))
                                     (1 1 (:REWRITE DEFAULT-+-1)))
(ADE::QUEUE3-L$VALID-ST)
(ADE::QUEUE3-L$VALID-ST=>CONSTRAINT (6 6 (:REWRITE NTH-WHEN-PREFIXP))
                                    (5 1 (:DEFINITION LEN))
                                    (2 1 (:REWRITE DEFAULT-+-2))
                                    (1 1 (:REWRITE DEFAULT-CDR))
                                    (1 1 (:REWRITE DEFAULT-+-1)))
(ADE::QUEUE3-L$VALID-ST=>ST-FORMAT (33 33 (:REWRITE NTH-WHEN-PREFIXP))
                                   (12 3 (:DEFINITION STRIP-CARS))
                                   (6 6 (:REWRITE DEFAULT-CAR))
                                   (3 3 (:REWRITE DEFAULT-CDR)))
(ADE::QUEUE3-L$IN-ACT)
(ADE::QUEUE3-L$OUT-ACT)
(ADE::QUEUE3-L$DATA-IN (6 2 (:REWRITE ADE::BV-IS-TRUE-LIST))
...
(ADE::QUEUE3-L$READY-IN- (5 5 (:TYPE-PRESCRIPTION ADE::F-BUF)))
(ADE::BOOLEANP-QUEUE3-L$READY-IN- (15 3 (:DEFINITION LEN))
...
(ADE::QUEUE3-L$READY-OUT (5 5 (:TYPE-PRESCRIPTION ADE::F-BUF)))
(ADE::BOOLEANP-QUEUE3-L$READY-OUT (15 3 (:DEFINITION LEN))
                                  (12 12 (:REWRITE NTH-WHEN-PREFIXP))
                                  (12 3 (:DEFINITION STRIP-CARS))
                                  (6 6 (:REWRITE DEFAULT-CDR))
                                  (6 6 (:REWRITE DEFAULT-CAR))
...
(ADE::LEN-QUEUE3-L$DATA-OUT-2
     ...
     (2 2
        (:LINEAR ADE::A-HELPFUL-LEMMA-FOR-TREE-INDUCTIONS)))
(ADE::BVP-QUEUE3-L$DATA-OUT (28 7 (:DEFINITION STRIP-CARS))
...
(ADE::QUEUE3-L$STATE (799 400 (:REWRITE DEFAULT-+-2))
...
(ADE::BOOLEANP-QUEUE3-L$OUT-ACT
     ...
     (4 1 (:REWRITE COMMUTATIVITY-OF-+))
     (3 3
        (:TYPE-PRESCRIPTION ADE::BOOLEANP-QUEUE3-L$IN-ACT))
     (3 3 (:REWRITE DEFAULT-+-2))
     (3 3 (:REWRITE DEFAULT-+-1))
     (3 1 (:REWRITE FOLD-CONSTS-IN-+))
     (3 1 (:DEFINITION NATP))
     ...
     (1 1 (:REWRITE DEFAULT-CDR))
     (1 1
        (:REWRITE ADE::BOOLEANP-QUEUE3-L$IN-ACT)))
...
(ADE::QUEUE3-L$VALUE-ALT
     ...
     (12 12
         (:REWRITE ADE::BOOLEANP-QUEUE3-L$OUT-ACT))
     (7 7
        (:REWRITE ADE::BOOLEANP-QUEUE3-L$IN-ACT)))
...
(ADE::QUEUE3-L$DE-N (90 30 (:REWRITE ZP-OPEN))
                    ...
                    (3 3
                       (:REWRITE ADE::QUEUE3-L$INPUT-FORMAT-PLUS))
...
(ADE::QUEUE3-L$EXTRACTED-STEP
     (12 12
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-QUEUE3-L$IN-ACT))
     (6 6
        (:TYPE-PRESCRIPTION ADE::BOOLEANP-QUEUE3-L$OUT-ACT)))
...
(ADE::QUEUE3-L$EXTRACT-LEMMA-1
     ...
     (1 1
        (:REWRITE ADE::BOOLEANP-QUEUE3-L$IN-ACT)))
(ADE::QUEUE3-L$EXTRACT-LEMMA-2 (144 36 (:DEFINITION STRIP-CARS))
...
(ADE::QUEUE3-L$OUT-SEQ-LEMMA
     ...
     (42 42 (:REWRITE NTH-WHEN-PREFIXP))
     (34 20
         (:REWRITE ADE::QUEUE3-L$EXTRACT-LEMMA-1))
     (30 10 (:REWRITE FOLD-CONSTS-IN-+))
     (24 24
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-QUEUE3-L$OUT-ACT))
     (20 4 (:DEFINITION NTHCDR))
     (14 14
         (:TYPE-PRESCRIPTION ADE::QUEUE3-L$VALID-ST))
...
(ADE::QUEUE3-L$DATAFLOW-CORRECT
     ...
     (3 3
        (:TYPE-PRESCRIPTION ADE::QUEUE3-L$RUN)))
(ADE::QUEUE3-L$FUNCTIONALLY-CORRECT
     ...
     (20 5
         (:REWRITE ADE::OPEN-QUEUE3-L$INPUT-FORMAT-N-ZP))
     (20 5
         (:REWRITE ADE::OPEN-QUEUE3-L$INPUT-FORMAT-N))
