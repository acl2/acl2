...
(ADE::ALT-MERGE* (24 24 (:TYPE-PRESCRIPTION POSP)))
(ADE::ALT-MERGE*$DESTRUCTURE (180 18 (:DEFINITION BINARY-APPEND))
...
(ADE::ALT-MERGE$DATA0-IN (6 2 (:REWRITE ADE::BV-IS-TRUE-LIST))
...
(ADE::ALT-MERGE$DATA1-IN (6 2 (:REWRITE ADE::BV-IS-TRUE-LIST))
                         (5 1 (:DEFINITION TRUE-LISTP))
                         (4 4 (:TYPE-PRESCRIPTION ADE::BVP))
                         (1 1
                            (:REWRITE SIMPLIFY-TERMS-SUCH-AS-A+AB-<-0))
...
(ADE::ALT-MERGE$STATE
     ...
     (164 38
          (:REWRITE ADE::ASSOC-EQ-VALUES-OF-SIS-PAIRLIS$-SIS))
