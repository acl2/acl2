...
(ADE::ROUND-ROBIN2* (49 49 (:TYPE-PRESCRIPTION POSP)))
(ADE::ROUND-ROBIN2*$DESTRUCTURE (360 36 (:DEFINITION BINARY-APPEND))
...
(ADE::ROUND-ROBIN2$IN-ACT-INACTIVE
     ...
     (5 5
        (:TYPE-PRESCRIPTION ADE::ROUND-ROBIN2$DATA-IN))
     (5 5
...
(ADE::BVP-ROUND-ROBIN2$DATA-OUT
     ...
     (96 4
         (:REWRITE ADE::ROUND-ROBIN2$OUT-ACT-INACTIVE))
     (94 48
         (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
...
(ADE::ROUND-ROBIN2$VALUE
     ...
     (4 1
        (:REWRITE ADE::ROUND-ROBIN2$IN-ACT-INACTIVE))
...
(ADE::ROUND-ROBIN2$DE-N
     ...
     (3 3
        (:REWRITE ADE::ROUND-ROBIN2$INPUT-FORMAT-PLUS))
     (3 3
        (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-EQUAL))
     (3 3
        (:REWRITE REDUCE-ADDITIVE-CONSTANT-EQUAL))
...
(ADE::ROUND-ROBIN2$EXTRACT-NOT-EMPTY
     ...
     (52 26
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-ROUND-ROBIN2$OUT-ACT))
...
(ADE::ROUND-ROBIN2$INPUT-FORMAT-LEMMA-2
     ...
     (4 4 (:REWRITE NORMALIZE-ADDENDS))
     (2 2
        (:TYPE-PRESCRIPTION ADE::ROUND-ROBIN2$INPUT-FORMAT-LEMMA-1))
     (2 2 (:REWRITE THE-FLOOR-BELOW))
     (2 2 (:REWRITE THE-FLOOR-ABOVE))
     (2 2
        (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-<-0-RATIONAL-REMAINDER))
     ...
     (1 1 (:TYPE-PRESCRIPTION NATP))
     (1 1
        (:REWRITE ADE::ROUND-ROBIN2$INPUT-FORMAT-LEMMA-1))
     (1 1 (:REWRITE DEFAULT-CDR)))
(ADE::ROUND-ROBIN2$Q4-L+Q5-L-IN-ACT-INACTIVE
     ...
     (10 4
         (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV))
     (8 8
        (:TYPE-PRESCRIPTION ADE::ROUND-ROBIN2$ME-INPUTS))
     (8 8 (:TYPE-PRESCRIPTION NFIX))
...
(ADE::ROUND-ROBIN2$Q4-L-IN-ACT-INACTIVE-1
     (775 596
          (:TYPE-PRESCRIPTION ADE::ROUND-ROBIN2$INPUT-FORMAT-LEMMA-2))
     (446 24
          (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
     ...
     (4 4
        (:TYPE-PRESCRIPTION ADE::ROUND-ROBIN2$ME-INPUTS))
     (4 4
        (:REWRITE ADE::ROUND-ROBIN2$INPUT-FORMAT-LEMMA-2))
...
(ADE::ROUND-ROBIN2$Q4-L-OUT-ACT-INACTIVE-1
     ...
     (22 22 (:LINEAR LEN-WHEN-PREFIXP))
     (20 20
         (:TYPE-PRESCRIPTION ADE::ROUND-ROBIN2$BR-INPUTS))
     (18 18 (:REWRITE REDUCE-RATIONALP-+))
     (18 18 (:REWRITE REDUCE-RATIONALP-*))
     (18 18 (:REWRITE RATIONALP-MINUS-X))
     (18 18 (:META META-RATIONALP-CORRECT))
...
(ADE::ROUND-ROBIN2$REWRITE-TO-Q5-L-IN-ACT
     ...
     (3 3
        (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-<-0-RATIONAL-COMMON))
     (3 3
        (:REWRITE ADE::ROUND-ROBIN2$REWRITE-TO-Q4-L-IN-ACT))
     (3 3 (:REWRITE |(< y (+ (- c) x))|))
     (3 3 (:REWRITE |(< x (+ c/d y))|))
     (3 1 (:REWRITE ADE::F-BUF-OF-3VP))
     (2 2 (:TYPE-PRESCRIPTION TRUE-LISTP-TAKE))
...
(ADE::ROUND-ROBIN2$REWRITE-TO-Q5-L-OUT-ACT
     ...
     (73 14
         (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
     (73 3
         (:REWRITE ADE::ROUND-ROBIN2$REWRITE-TO-Q4-L-OUT-ACT))
     (69 15 (:REWRITE DEFAULT-CAR))
...
(ADE::ROUND-ROBIN2$INV-PRESERVED
     ...
     (592 208
          (:REWRITE ADE::ROUND-ROBIN2$Q4-L+Q5-L-IN-ACT-INACTIVE))
     (552 12
          (:REWRITE ADE::ALT-MERGE$ACT-INACTIVE))
...
(ADE::ROUND-ROBIN2$EXTRACTED-STEP
     (24 12
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-ROUND-ROBIN2$IN-ACT))
     (18 18
         (:TYPE-PRESCRIPTION ADE::ROUND-ROBIN2$INPUT-FORMAT))
     (12 6
         (:TYPE-PRESCRIPTION ADE::BOOLEANP-ROUND-ROBIN2$OUT-ACT)))
...
(ADE::ROUND-ROBIN2$EXTRACTED-STEP-CORRECT
     ...
     (869 154
          (:REWRITE ADE::ROUND-ROBIN2$Q4-L-IN-ACT-INACTIVE-2))
     (840 336
          (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV))
     (838 226
          (:REWRITE ADE::ROUND-ROBIN2$Q4-L+Q5-L-IN-ACT-INACTIVE))
     ...
     (786 131
          (:REWRITE ADE::ROUND-ROBIN2$OUT-ACT-INACTIVE))
     (773 138
          (:REWRITE ADE::ROUND-ROBIN2$Q5-L-IN-ACT-INACTIVE-2))
...
(ADE::ROUND-ROBIN2$EXTRACT-LEMMA
     ...
     (596 20
          (:REWRITE ADE::ROUND-ROBIN2$Q4-L-OUT-ACT-INACTIVE-1))
     ...
     (486 18
          (:REWRITE ADE::ROUND-ROBIN2$Q5-L-OUT-ACT-INACTIVE-1))
     ...
     (50 50
         (:REWRITE NORMALIZE-FACTORS-GATHER-EXPONENTS))
     (50 10
         (:REWRITE ADE::BVP-QUEUE4-L$DATA-OUT))
     (48 8
         (:REWRITE ADE::ROUND-ROBIN2$OUT-ACT-INACTIVE))
     (42 18
         (:REWRITE ADE::BVP-QUEUE5-L$DATA-OUT))
     (38 38
     ...
     (20 20
         (:REWRITE ADE::ROUND-ROBIN2$Q4-L-OUT-ACT-INACTIVE-2))
     (18 18
         (:REWRITE ADE::ROUND-ROBIN2$Q5-L-OUT-ACT-INACTIVE-2))
     (16 16
         (:REWRITE SIMPLIFY-TERMS-SUCH-AS-AX+BX-=-0))
     (16 16 (:REWRITE |(equal x (if a b c))|))
     (12 4 (:REWRITE ADE::BOOL-FIX-CAR-X=X))
...
(ADE::ROUND-ROBIN2$OUT-SEQ-LEMMA
     ...
     (112 112 (:REWRITE |(equal (- x) (- y))|))
     (103 29
          (:REWRITE ADE::ROUND-ROBIN2$EXTRACT-LEMMA))
     (88 88 (:REWRITE THE-FLOOR-BELOW))
     (88 88 (:REWRITE THE-FLOOR-ABOVE))
     (88 88
         (:REWRITE REDUCE-RATIONAL-MULTIPLICATIVE-CONSTANT-<))
     ...
     (64 64
         (:TYPE-PRESCRIPTION ADE::ROUND-ROBIN2$VALID-ST))
     (64 64 (:REWRITE SIMPLIFY-SUMS-<))
     (64 64
         (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-<))
     (64 64
     ...
     (40 40 (:REWRITE |(< 0 (* x y))|))
     (30 10
         (:REWRITE ADE::ROUND-ROBIN2$VALID-ST-PRESERVED))
...
(ADE::ROUND-ROBIN2$DATAFLOW-CORRECT-AUX
     ...
     (96 2
         (:DEFINITION ADE::ROUND-ROBIN2$IN-SEQ))
     ...
     (8 8
        (:TYPE-PRESCRIPTION ADE::ROUND-ROBIN2$INPUT-FORMAT))
     (8 8
        (:TYPE-PRESCRIPTION ADE::ROUND-ROBIN2$IN-ACT))
     (8 8
        (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV))
     (8 2
        (:REWRITE ADE::ROUND-ROBIN2$IN-ACT-INACTIVE))
...
(ADE::ROUND-ROBIN2$DATAFLOW-CORRECT
     ...
     (92 8
         (:LINEAR ADE::ROUND-ROBIN2$EXTRACT-NOT-EMPTY))
     (90 90
         (:TYPE-PRESCRIPTION ADE::ROUND-ROBIN2$INPUT-FORMAT-LEMMA-1))
     ...
     (84 84 (:REWRITE |(< 0 (* x y))|))
     (68 68
         (:TYPE-PRESCRIPTION ADE::ROUND-ROBIN2$STEP))
     (64 58 (:REWRITE |(+ 0 x)|))
     ...
     (14 14
         (:REWRITE ADE::ROUND-ROBIN2$RUN-PLUS))
     (12 12
         (:REWRITE ADE::ROUND-ROBIN2$INPUT-FORMAT-PLUS))
     (12 12
         (:LINEAR ADE::A-HELPFUL-LEMMA-FOR-TREE-INDUCTIONS))
     ...
     (4 4 (:REWRITE |(+ x (- x))|))
     (3 3
        (:TYPE-PRESCRIPTION ADE::ROUND-ROBIN2$RUN)))
(ADE::ROUND-ROBIN2$FUNCTIONALLY-CORRECT
     (332 4
          (:DEFINITION ADE::ROUND-ROBIN2$OUT-SEQ))
     (192 4
          (:DEFINITION ADE::ROUND-ROBIN2$IN-SEQ))
     (160 4
          (:REWRITE ADE::ROUND-ROBIN2$OUT-ACT-INACTIVE))
     ...
     (24 6
         (:REWRITE ADE::OPEN-ROUND-ROBIN2$INPUT-FORMAT-N-ZP))
     (24 6
         (:REWRITE ADE::OPEN-ROUND-ROBIN2$INPUT-FORMAT-N))
     (16 16
         (:TYPE-PRESCRIPTION ADE::ROUND-ROBIN2$OUT-ACT))
     (16 16
         (:TYPE-PRESCRIPTION ADE::ROUND-ROBIN2$IN-ACT))
     (16 4
         (:REWRITE ADE::ROUND-ROBIN2$IN-ACT-INACTIVE))
     ...
     (15 15 (:REWRITE |(equal (- x) (- y))|))
     (12 3
         (:REWRITE ADE::OPEN-ROUND-ROBIN2$RUN-ZP))
