...
(ADE::UNBOUND-IN-BODY-LISTP (15 5 (:DEFINITION MEMBER-EQUAL))
                            (8 8 (:REWRITE DEFAULT-CDR))
                            (8 8 (:REWRITE DEFAULT-CAR))
                            (6 6 (:REWRITE ADE::UNBOUND-IN-BODY-ATOM)))
(ADE::ALL-UNBOUND-IN-BODY)
(ADE::ALL-UNBOUND-IN-BODY-ATOM)
(ADE::ALL-UNBOUND-IN-BODY-LISTP (45 10 (:REWRITE ADE::DISJOINT-COMMUTATIVE))
...
(ADE::ALL-UNBOUND-IN-BODY-APPEND (331 100 (:REWRITE ADE::DISJOINT-ATOM))
...
(ADE::ALL-UNBOUND-IN-BODY-CONS (460 115 (:REWRITE ADE::DISJOINT-ATOM))
                               (246 63 (:DEFINITION MEMBER-EQUAL))
                               (119 119 (:REWRITE DEFAULT-CDR))
                               (115 115 (:TYPE-PRESCRIPTION ATOM))
                               (114 114 (:REWRITE DEFAULT-CAR)))
(ADE::ALL-UNBOUND-IN-BODY-ATOM-NAMES (5 5 (:REWRITE DEFAULT-CAR))
