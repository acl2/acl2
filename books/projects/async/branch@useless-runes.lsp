(ADE::BRANCH$DATA-INS-LEN (1 1 (:REWRITE DEFAULT-<-2))
                          (1 1 (:REWRITE DEFAULT-<-1)))
(ADE::BRANCH$INS-LEN)
(ADE::BRANCH* (13 13 (:TYPE-PRESCRIPTION POSP)))
(ADE::BRANCH*$DESTRUCTURE (66 12 (:REWRITE APPEND-WHEN-NOT-CONSP))
...
(ADE::BRANCH$DATA-IN (6 2 (:REWRITE ADE::BV-IS-TRUE-LIST))
...
(ADE::BRANCH$ACT0 (10 5
                      (:TYPE-PRESCRIPTION ADE::BOOLEANP-JOINT-ACT))
                  (5 5 (:TYPE-PRESCRIPTION BOOLEANP)))
(ADE::BRANCH$ACT0-INACTIVE (15 3 (:REWRITE ADE::NFIX-OF-NAT))
...
(ADE::BRANCH$ACT1 (10 5
                      (:TYPE-PRESCRIPTION ADE::BOOLEANP-JOINT-ACT))
                  (5 5 (:TYPE-PRESCRIPTION BOOLEANP)))
(ADE::BRANCH$ACT1-INACTIVE (15 4 (:REWRITE ADE::F-GATES=B-GATES))
...
(ADE::BRANCH$ACT)
(ADE::BRANCH$ACT-INACTIVE (8 8 (:REWRITE NTH-WHEN-PREFIXP))
