...
(ADE::F$FAST-ZERO=V-ZP
     ...
     (1 1
        (:LINEAR ADE::A-HELPFUL-LEMMA-FOR-TREE-INDUCTIONS)))
(ADE::FAST-ZERO* (6 6 (:REWRITE DEFAULT-<-2))
                 (6 6 (:REWRITE DEFAULT-<-1))
...
(ADE::FAST-ZERO$NETLIST (3 3 (:REWRITE DEFAULT-<-2))
                        (3 3 (:REWRITE DEFAULT-<-1))
                        (1 1 (:REWRITE DEFAULT-+-2))
                        (1 1 (:REWRITE DEFAULT-+-1)))
(ADE::FAST-ZERO& (44 4 (:DEFINITION ASSOC-EQUAL))
...
(ADE::FAST-ZERO$VALUE (355 31 (:REWRITE ADE::TR-OR-NOR=BTR-OR-NOR))
