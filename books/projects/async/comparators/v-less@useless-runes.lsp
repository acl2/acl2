...
(ADE::1-BIT-<$VALUE (75 33 (:REWRITE ADE::F-GATES=B-GATES))
...
(ADE::3V-FIX-FV-< (114 30 (:REWRITE ADE::F-GATES=B-GATES))
...
(ADE::FV-<-OF-F-BUF-CANCELED (378 109 (:REWRITE ADE::F-GATES=B-GATES))
...
(ADE::V-<)
(ADE::BOOLEANP-V-<)
(ADE::FV-<=V-< (342 342 (:REWRITE DEFAULT-CAR))
...
(ADE::V-<-LEMMA (160 160 (:REWRITE DEFAULT-CAR))
...
(ADE::V-<-APPEND (1492 1030 (:REWRITE DEFAULT-CDR))
...
(ADE::V-<-CORRECT-1 (875 527 (:REWRITE DEFAULT-CDR))
...
(ADE::V-<-CORRECT-2 (1102 691 (:REWRITE DEFAULT-CDR))
...
(ADE::V-<-BODY-INDUCT)
(ADE::V-<-BODY$VALUE (211 95 (:REWRITE ADE::F-GATES=B-GATES))
