...
(ADE::NOT-ISTRPREFIXP-STR-APPEND-SYMBOL-UNDERSCORE
 ...
 (406 406 (:TYPE-PRESCRIPTION STR::STRINGP-OF-NAT-TO-DEC-STRING))
 ...
 (196 196 (:REWRITE STR::NAT-TO-DEC-STRING-NONEMPTY))
 (112 112 (:TYPE-PRESCRIPTION TAKE))
...
(ADE::NOT-EQUAL-WITH-SI-OF-DIFF-SYMBOL
 (1555 94 (:DEFINITION LEN))
 (1432 309 (:REWRITE STR::CONSP-OF-EXPLODE))
 (1260 6 (:REWRITE PREFIXP-OF-APPEND-ARG1))
 (763 763 (:TYPE-PRESCRIPTION ADE::STR-APPEND-SYMBOL-UNDERSCORE))
 (588 112 (:REWRITE DEFAULT-CDR))
 (336 14 (:DEFINITION BINARY-APPEND))
 (306 201 (:REWRITE ADE::SYMBOL-INEQUALITY))
 ...
 (110 20 (:REWRITE LIST-EQUIV-WHEN-ATOM-RIGHT))
 (98 14 (:REWRITE LEN-WHEN-PREFIXP))
 (94 20 (:REWRITE LIST-EQUIV-WHEN-ATOM-LEFT))
 ...
 (49 49 (:TYPE-PRESCRIPTION STR::STRINGP-OF-NAT-TO-DEC-STRING))
 ...
 (19 19 (:REWRITE STR::NAT-TO-DEC-STRING-NONEMPTY))
...
(ADE::NOT-MEMBER-UNDERSCORE-NAT-TO-DEC-STRING
...
(ADE::SI-OF-DIFF-SYMBOLS-AUX-3
 ...
 (2140 362 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-OF-APPEND))
 (1924 962 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-WHEN-NOT-CONSP))
 ...
 (228 228 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-OF-CONS))
 ...
 (177 177 (:TYPE-PRESCRIPTION STR::STRINGP-OF-NAT-TO-DEC-STRING))
...
(ADE::SI-OF-DIFF-SYMBOLS-AUX-4
 ...
 (200 34 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-OF-APPEND))
 (168 144 (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV))
 (168 84 (:REWRITE STR::DEC-DIGIT-CHAR-LIST*P-WHEN-NOT-CONSP))
