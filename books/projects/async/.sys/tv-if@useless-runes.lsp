...
(ADE::TV-IF&
 ...
 (783 292 (:REWRITE DEFAULT-PLUS-1))
 (700 20 (:REWRITE |(+ (if a b c) x)|))
 (689 292 (:REWRITE DEFAULT-PLUS-2))
...
(ADE::TV-IF$VALUE
 (31072 81 (:DEFINITION ADE::TV-IF-INDUCTION))
 (8478 4268 (:REWRITE DEFAULT-PLUS-2))
 (6569 4268 (:REWRITE DEFAULT-PLUS-1))
 ...
 (2033 183 (:REWRITE REPEAT-WHEN-ZP))
 (1628 19 (:DEFINITION MEMBER-EQUAL))
 (1552 330 (:REWRITE PREFER-POSITIVE-ADDENDS-<))
 ...
 (834 450 (:REWRITE DEFAULT-LESS-THAN-2))
 (804 330 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-<))
 (738 738 (:REWRITE ADE::NTHCDR-OF-POS-CONST-IDX))
 (718 450 (:REWRITE DEFAULT-LESS-THAN-1))
 (688 312 (:REWRITE SIMPLIFY-SUMS-<))
