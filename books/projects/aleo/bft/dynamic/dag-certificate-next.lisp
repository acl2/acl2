...
(defsection cert-with-author+round-of-next
  ...
  (defruled cert-with-author+round-of-create-certificate-next
  ...
  (defruled cert-with-author+round-of-receive-certificate-next
  ...
  (defruled cert-with-author+round-of-store-certificate-next
    (implies (and (unequivocal-accepted-certificates-p systate)
                  (signer-records-p systate)
                  (committees-in-system-p systate)
                  (system-fault-tolerant-p systate)
  ...
  (defruled cert-with-author+round-of-advance-round-next
    (implies (and (set::in val (correct-addresses systate))
  ...
  (defruled cert-with-author+round-of-commit-anchors-next
    (implies (and (set::in val (correct-addresses systate))
  ...
  (defruled cert-with-author+round-of-timer-expires-next
    (implies (and (set::in val (correct-addresses systate))
  ...
  (defruled cert-with-author+round-of-event-next
    ...
    :enable (event-possiblep
             ...
             cert-with-author+round-of-receive-certificate-next
             cert-with-author+round-of-store-certificate-next
             cert-with-author+round-of-advance-round-next
             cert-with-author+round-of-commit-anchors-next
             cert-with-author+round-of-timer-expires-next)))
