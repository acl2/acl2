...
(defsection field-div-checked-correctness
  ...
  (defruled field-div-checked-circuit-to-spec
    (implies (and (equal (pfcs::lookup-definition (name "field_div_checked") defs)
                         (field-div-checked-circuit))
                  (equal (pfcs::lookup-definition (name "field_inv_checked") defs)
             ...
             (equal (pfcs::definition-satp
                      (name "field_div_checked") defs (list x y z) prime)
                    (field-div-checked-spec x y z prime)))
