...
(defsection boolean-assert-eq-correctness
  ...
  (defruled boolean-assert-eq-circuit-to-spec
    (implies (and (equal (pfcs::lookup-definition (name "boolean_assert_eq") defs)
                         (boolean-assert-eq-circuit))
                  (equal (pfcs::lookup-definition (name "boolean_assert_true") defs)
                         (boolean-assert-true-circuit))
                  (equal (pfcs::lookup-definition (name "boolean_eq") defs)
                         (boolean-eq-circuit))
             ...
             (equal (pfcs::definition-satp
                      (name "boolean_assert_eq") defs (list x y) prime)
                    (boolean-assert-eq-spec x y prime)))
