(R1CS::SPEC
 (524 16 (:REWRITE R1CS::BITP-IN-FIELD))
 (500 12 (:REWRITE BITP-BECOMES-UNSIGNED-BYTE-P))
 (488 4 (:DEFINITION NATP))
 (332 12 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (256 12 (:REWRITE R1CS::INTEGERP-WHEN-FEP-SPECIAL))
