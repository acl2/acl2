...
(X86ISA::CREATE-EXTRA-INFO-DOC (10 10 (:REWRITE DEFAULT-CDR))
                               (10 10 (:REWRITE DEFAULT-CAR)))
...
(X86ISA::STRINGP-OF-GET-ADDRESSING-METHOD-DOC (3 3 (:REWRITE DEFAULT-CDR))
...
(X86ISA::GET-OPERAND-TYPE-CODE-DOC
     ...
     (2 2
        (:REWRITE HONS-DUPLICITY-ALIST-P-WHEN-NOT-CONSP)))
(X86ISA::STRINGP-OF-GET-OPERAND-TYPE-CODE-DOC (3 3 (:REWRITE DEFAULT-CDR))
                                              (3 3 (:REWRITE DEFAULT-CAR)))
...
(X86ISA::CREATE-ARGS-DOC (20 20 (:REWRITE DEFAULT-CDR))
...
(X86ISA::CREATE-INSTS-DOC-FN (89 5 (:DEFINITION BINARY-APPEND))
