...
(X86ISA::EVEX-DECODE-AND-EXECUTE
 ...
 (127
  127
  (:REWRITE
   X86ISA::EVEX-PREFIXES->BYTE1$INLINE-OF-EVEX-PREFIXES-FIX-X-NORMALIZE-CONST))
 (103 15
      (:REWRITE X86ISA::UNSIGNED-BYTE-P-WHEN-VEX3-BYTE2-P))
 (103 15
      (:REWRITE X86ISA::UNSIGNED-BYTE-P-WHEN-VEX3-BYTE1-P))
 ...
 (84
    84
    (:REWRITE
         X86ISA::EVEX-BYTE2->RES$INLINE-OF-EVEX-BYTE2-FIX-X-NORMALIZE-CONST))
 (72 72
 ...
 (66
  66
  (:REWRITE
      X86ISA::EVEX-BYTE1->MM$INLINE-OF-EVEX-BYTE1-FIX-BYTE1-NORMALIZE-CONST))
 (65 65
     (:REWRITE X86ISA::EVEX-BYTE1->RES-OF-WRITE-WITH-MASK))
 (65
  65
  (:REWRITE
     X86ISA::EVEX-BYTE1->RES$INLINE-OF-EVEX-BYTE1-FIX-BYTE1-NORMALIZE-CONST))
 (54
  54
  (:REWRITE
   X86ISA::!EVEX-PREFIXES->BYTE2$INLINE-OF-EVEX-PREFIXES-FIX-X-NORMALIZE-CONST))
 (54
  54
  (:REWRITE
    X86ISA::!EVEX-PREFIXES->BYTE2$INLINE-OF-8BITS-FIX-BYTE2-NORMALIZE-CONST))
 (43 43
