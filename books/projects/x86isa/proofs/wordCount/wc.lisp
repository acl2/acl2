...
(in-theory (e/d* ()
                 ((:DEFINITION CREATE-ADDR-BYTES-ALIST)
                  ...
                  (:REWRITE DEFAULT-+-1)
                  (:DEFINITION ACONS)
                  (:REWRITE CONS-AND-CREATE-ADDR-BYTES-ALIST)
                  ...
                  (:TYPE-PRESCRIPTION TRUE-LISTP-CREATE-CANONICAL-ADDRESS-LIST)
                  (:TYPE-PRESCRIPTION ACL2::|x < y  =>  0 < y-x|)
                  (:TYPE-PRESCRIPTION NATP-GET-PREFIXES)
                  ;; (:REWRITE DISJOINT-P-TWO-CREATE-CANONICAL-ADDRESS-LISTS-THM-0)
                  (:REWRITE CAR-CREATE-CANONICAL-ADDRESS-LIST)
                  (:TYPE-PRESCRIPTION CONSP-CREATE-ADDR-BYTES-ALIST)
                  ;; (:REWRITE DISJOINT-P-TWO-CREATE-CANONICAL-ADDRESS-LISTS-THM-1)
