...
(defun create-canonical-address-list-alt (iteration count lin-addr)
  (declare (xargs :measure (nfix (- count iteration))))
...
(defthmd create-canonical-address-list-alt-is-create-canonical-address-list
  ...
  :hints (("Subgoal *1/2'"
	   :expand ((create-canonical-address-list (+ count (- iteration))
						   (+ iteration lin-addr))))))

(def-gl-export open-mv-nth-0-las-to-pas-for-same-1G-page-helper-1
  :hyp (and (< ITERATION M)
	    (CANONICAL-ADDRESS-P LIN-ADDR)
...
(def-gl-export open-mv-nth-0-las-to-pas-for-same-1G-page-helper-2
  :hyp (and (< ITERATION M)
	    (INTEGERP M)
	    (<= M 1073741824)
	    (NATP ITERATION))
...
(defthmd open-mv-nth-0-las-to-pas-for-same-1G-page-helper-3
  (IMPLIES
   (AND
    (< ITERATION M)
	...
	8
	(PML4-TABLE-ENTRY-ADDR LIN-ADDR (PML4-TABLE-BASE-ADDR X86)))
       :R (LOGHEAD 2 (XR :SEG-VISIBLE 1 X86))
       X86))
     (ADDR-RANGE 8
		 (PML4-TABLE-ENTRY-ADDR LIN-ADDR (PML4-TABLE-BASE-ADDR X86))))
    (EQUAL
   ...
   (NOT (MV-NTH 0
		(IA32E-LA-TO-PA (+ ITERATION LIN-ADDR)
				R-W-X CPL X86))))
  :hints (("Goal"
	   :use ((:instance open-mv-nth-0-las-to-pas-for-same-1G-page-helper-1))
	   :in-theory (e/d* (las-to-pas
			     open-mv-nth-0-las-to-pas
			     mv-nth-0-ia32e-la-to-pa-for-same-1G-page)
			    (open-mv-nth-0-las-to-pas-for-same-1G-page-helper-1
			     not
...
(defthmd open-mv-nth-0-las-to-pas-for-same-1G-page-helper
  (implies
   (and
    (equal pml4-table-base-addr (pml4-table-base-addr x86))
    (equal pml4-table-entry-addr (pml4-table-entry-addr lin-addr pml4-table-base-addr))
  ...
  :hints (("Goal"
	   ...
	   :in-theory (e/d* (las-to-pas
			     open-mv-nth-0-las-to-pas-for-same-1G-page-helper-3
			     open-mv-nth-0-las-to-pas
			     mv-nth-0-ia32e-la-to-pa-for-same-1G-page)
			    (not
			     pml4-table-base-addr
...
(defthm open-mv-nth-0-las-to-pas-for-same-1G-page
  (implies
   ...
   (equal (mv-nth 0 (las-to-pas (create-canonical-address-list *2^30* lin-addr)
	  ...
	  nil))
  :hints (("Goal"
	   :use ((:instance open-mv-nth-0-las-to-pas-for-same-1G-page-helper
			    (iteration 0)
			    (m *2^30*)))
...
(def-gl-export open-mv-nth-1-las-to-pas-for-same-1G-page-helper-1
  :hyp (and (< ITERATION M)
	    (CANONICAL-ADDRESS-P LIN-ADDR)
	    (CANONICAL-ADDRESS-P (+ -1 LIN-ADDR M))
	    (INTEGERP M)
...
(defthmd open-mv-nth-1-las-to-pas-for-same-1G-page-helper
  (implies
   (and
    (equal pml4-table-base-addr (pml4-table-base-addr x86))
    (equal pml4-table-entry-addr (pml4-table-entry-addr lin-addr pml4-table-base-addr))
  ...
  :hints (("Goal"
	   :induct (create-canonical-address-list-alt iteration m lin-addr)
	   :in-theory (e/d* (las-to-pas
			     open-mv-nth-1-las-to-pas-for-same-1G-page-helper-1
			     open-mv-nth-0-las-to-pas-for-same-1G-page-helper-1
			     open-mv-nth-0-las-to-pas-for-same-1G-page-helper-2
			     open-mv-nth-0-las-to-pas-for-same-1G-page-helper-3
			     open-mv-nth-0-las-to-pas-for-same-1G-page-helper
...
(def-gl-export open-mv-nth-1-las-to-pas-for-same-1G-page-helper-2
  :hyp (and (canonical-address-p lin-addr)
	    (equal (loghead 30 lin-addr) 0))
   ...
   (equal (mv-nth 1 (las-to-pas
	   ...
	   *2^30*
	   (ash
	    ...
	    30))))
  :hints (("Goal"
	   :use ((:instance open-mv-nth-1-las-to-pas-for-same-1G-page-helper
			    (iteration 0)
			    (m *2^30*))
		 (:instance open-mv-nth-1-las-to-pas-for-same-1G-page-helper-2))
	   :in-theory (e/d* (create-canonical-address-list-alt-is-create-canonical-address-list)
			    (open-mv-nth-1-las-to-pas-for-same-1G-page-helper-2
			     las-to-pas
			     open-mv-nth-0-las-to-pas
			     mv-nth-0-ia32e-la-to-pa-for-same-1G-page
			     not
...
(defthm car-of-create-canonical-address-list-forced
  (implies (force (canonical-address-p lin-addr))
	   (equal (car (create-canonical-address-list 1073741824 lin-addr))
		  lin-addr)))

(defthmd las-to-pas-values-1G-pages-and-wb-to-page-dir-ptr-table-entry-addr-helper
  (implies
   (and
    (equal pml4-table-base-addr (pml4-table-base-addr x86))
    (equal pml4-table-entry-addr (pml4-table-entry-addr lin-addr pml4-table-base-addr))
...
(defthm las-to-pas-values-1G-pages-and-wb-to-page-dir-ptr-table-entry-addr
  ...
  :hints (("Goal"
	   :do-not '(preprocess)
	   :do-not-induct t
	   :use ((:instance las-to-pas-values-1G-pages-and-wb-to-page-dir-ptr-table-entry-addr-helper
			    (m *2^30*)
			    (iteration 0))
		 (:instance open-mv-nth-1-las-to-pas-for-same-1G-page-helper-2))
	   :in-theory (e/d* (create-canonical-address-list-alt-is-create-canonical-address-list)
...
(defthm rewire_dst_to_src-after-the-copy-source-p-addrs-open
  ...
  :hints (("Goal"
	   :use ((:instance ;; las-to-pas-open-up-for-a-1G-page-setup
		  las-to-pas-values-1G-pages-and-wb-to-page-dir-ptr-table-entry-addr-helper
