...
(defthm xlate-equiv-memory-and-xlate-equiv-entries-rm-low-64-with-page-directory-entry-addr
...
(defthm xlate-equiv-memory-and-logtail-12-rm-low-64-with-page-directory-entry-addr
  (implies (xlate-equiv-memory x86-1 x86-2)
           (equal (logtail 12 (rm-low-64 (page-directory-entry-addr lin-addr base-addr) x86-1))
                  (logtail 12 (rm-low-64 (page-directory-entry-addr lin-addr base-addr) x86-2))))
  :hints (("Goal"
           ...
           :use ((:instance xlate-equiv-entries-and-logtail
                            ...
                            (e-2 (rm-low-64 (page-directory-entry-addr lin-addr base-addr) x86-2))
                            (n 12))
                 (:instance xlate-equiv-memory-and-xlate-equiv-entries-rm-low-64-with-page-directory-entry-addr))))
  :rule-classes :congruence)

(defthm xlate-equiv-memory-and-logtail-21-rm-low-64-with-page-directory-entry-addr
  (implies (xlate-equiv-memory x86-1 x86-2)
           (equal (logtail 21 (rm-low-64 (page-directory-entry-addr lin-addr base-addr) x86-1))
                  (logtail 21 (rm-low-64 (page-directory-entry-addr lin-addr base-addr) x86-2))))
  :hints (("Goal"
...
(defthm xlate-equiv-memory-and-mv-nth-0-ia32e-la-to-pa-page-directory
  (implies (xlate-equiv-memory x86-1 x86-2)
           (equal (mv-nth
                   0
                   (ia32e-la-to-pa-page-directory
...
(defthm xlate-equiv-memory-and-mv-nth-1-ia32e-la-to-pa-page-directory
  (implies (xlate-equiv-memory x86-1 x86-2)
           (equal (mv-nth
                   1
                   (ia32e-la-to-pa-page-directory
