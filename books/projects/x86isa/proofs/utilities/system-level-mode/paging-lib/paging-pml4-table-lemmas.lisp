...
(local
 (defthmd ia32e-la-to-pa-PML4T-with-xlate-equiv-structures
...
(defthm mv-nth-0-ia32e-la-to-pa-PML4T-with-xlate-equiv-structures
  (implies (xlate-equiv-structures x86-1 x86-2)
           (equal (mv-nth
                   0
                   (ia32e-la-to-pa-PML4T
                  ...
                  (mv-nth
                   ...
                   (ia32e-la-to-pa-PML4T
                    lin-addr wp smep nxe r-w-x cpl x86-2))))
  :hints (("Goal"
           :use ((:instance ia32e-la-to-pa-pml4t-with-xlate-equiv-structures))))
  :rule-classes :congruence)

(defthm mv-nth-1-ia32e-la-to-pa-PML4T-with-xlate-equiv-structures
  (implies (xlate-equiv-structures x86-1 x86-2)
           (equal (mv-nth
                   1
                   (ia32e-la-to-pa-PML4T
...
(defthm xlate-equiv-structures-with-mv-nth-2-ia32e-la-to-pa-PML4T
...
(defthm xlate-equiv-x86s-with-mv-nth-2-ia32e-la-to-pa-PML4T
  (implies
   (not (mv-nth 0 (ia32e-la-to-pa-PML4T lin-addr wp smep nxe r-w-x cpl x86)))
   (xlate-equiv-x86s
    (mv-nth 2 (ia32e-la-to-pa-PML4T lin-addr wp smep nxe r-w-x cpl x86))
    (double-rewrite x86)))
  :hints (("Goal"
...
(defthm xr-not-mem-and-mv-nth-2-ia32e-la-to-pa-PML4T
  (implies (and
            (not (mv-nth 0 (ia32e-la-to-pa-PML4T
                            lin-addr wp smep nxe r-w-x cpl x86)))
            (not (equal fld :mem)))
           (equal (xr fld index
                      (mv-nth 2 (ia32e-la-to-pa-PML4T
                                 lin-addr wp smep nxe r-w-x cpl x86)))
                  (xr fld index x86)))
  ...
  :hints (("Goal"
           ...
           :use ((:instance xlate-equiv-structures-and-xlate-equiv-entries-at-qword-addresses?
                 ...
                 (:instance booleanp-xlate-equiv-entries-at-qword-addresses?
                            (addrs (gather-all-paging-structure-qword-addresses x86))
                            (x x86)
                            (y (mv-nth 2 (ia32e-la-to-pa-PML4T lin-addr wp smep nxe r-w-x cpl x86))))))))
