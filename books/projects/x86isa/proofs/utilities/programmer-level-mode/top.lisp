...
(defsection programmer-level-mode-proof-utilities
  ...
  these rules in @(see
  unwind-x86-interpreter-in-programmer-level-mode).</p>
...
(defsection unwind-x86-interpreter-in-programmer-level-mode
  :parents (programmer-level-mode-proof-utilities)
  ...
  :short "Definitions of rules to monitor in the programmer-level
  mode"
