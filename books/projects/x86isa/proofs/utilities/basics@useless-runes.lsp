(X86ISA::LOGHEAD-UNEQUAL
 (18743 30 (:REWRITE LOGHEAD-IDENTITY))
 (13209 46 (:DEFINITION UNSIGNED-BYTE-P))
 (12623 46 (:DEFINITION INTEGER-RANGE-P))
 (9065 144 (:DEFINITION UNSIGNED-BYTE-P**))
 (6088 126 (:REWRITE UNSIGNED-BYTE-P-PLUS))
 (4498 143
 ...
 (2632 170 (:REWRITE BITOPS::LOGCDR-OF-BIT))
 (2109 854 (:REWRITE DEFAULT-LESS-THAN-2))
 (1934 1934 (:TYPE-PRESCRIPTION NATP))
 (1849
  1849
 ...
 (1580 76 (:REWRITE BITOPS::LOGCDR-<-CONST))
 (1520 40 (:REWRITE FLOOR-ZERO . 5))
 (1483 828 (:REWRITE DEFAULT-LESS-THAN-1))
 (1449 41 (:LINEAR EXPT-X->-X))
 (1439 41 (:LINEAR EXPT-X->=-X))
 ...
 (1190 444 (:REWRITE DEFAULT-PLUS-2))
 (1123 663 (:REWRITE SIMPLIFY-SUMS-<))
 (1100 41 (:LINEAR EXPT-<=-1-TWO))
 (1074 48 (:REWRITE ZP-WHEN-INTEGERP))
 (943 46 (:REWRITE ODD-EXPT-THM))
 (877 877
 ...
 (663 663 (:REWRITE INTEGERP-<-CONSTANT))
 (663 663 (:REWRITE CONSTANT-<-INTEGERP))
 (663 663
 ...
 (508 41 (:LINEAR EXPT-<-1-TWO))
 (460 40 (:REWRITE FLOOR-=-X/Y . 2))
 (420 420 (:REWRITE DEFAULT-PLUS-1))
 ...
 (116 41 (:LINEAR EXPT-LINEAR-LOWER-<=))
 ...
 (80 52 (:REWRITE IFIX-WHEN-NOT-INTEGERP))
