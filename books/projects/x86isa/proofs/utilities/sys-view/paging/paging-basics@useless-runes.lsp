...
(X86ISA::LOGHEAD-SMALLER-EQUALITY
     (7122 47 (:REWRITE LOGHEAD-IDENTITY))
     (7105 127 (:DEFINITION UNSIGNED-BYTE-P**))
     (4349 93 (:DEFINITION INTEGER-RANGE-P))
     (4259 105 (:DEFINITION UNSIGNED-BYTE-P))
     (2798 1279
           (:TYPE-PRESCRIPTION BITOPS::LOGCDR-NATP))
     (2705 137
           (:REWRITE FTY::BITP-WHEN-UNSIGNED-BYTE-P-1))
     (2477 134 (:REWRITE UNSIGNED-BYTE-P-PLUS))
     (1858 144 (:REWRITE BITOPS::LOGCDR-OF-BIT))
     (1643 53 (:REWRITE BITOPS::LOGCAR-OF-BIT))
     (1252 1252 (:TYPE-PRESCRIPTION LOGCDR-TYPE))
     (1227 60
           (:REWRITE BITOPS::UNSIGNED-BYTE-P-OF-0-X))
     (1078 142 (:REWRITE BITOPS::LOGCDR-<-CONST))
...
(X86ISA::LOGBITP-N-OF-SET-ACCESSED-BIT
 ...
 (107 32 (:REWRITE BITOPS::LOGBITP-OF-MASK))
 (87 32
     (:REWRITE BITOPS::LOGBITP-WHEN-BITMASKP))
 (87 32 (:REWRITE BITOPS::LOGBITP-OF-CONST))
 (82 33
     (:REWRITE FTY::UNSIGNED-BYTE-P-1-WHEN-BITP))
 (80 20
...
(X86ISA::LOGBITP-N-OF-SET-DIRTY-BIT
 ...
 (115 23
      (:REWRITE X86ISA::UNSIGNED-BYTE-P-WHEN-64BITS-P))
 (105 30 (:REWRITE BITOPS::LOGBITP-OF-MASK))
 (90 90 (:TYPE-PRESCRIPTION BITP))
 (85 30 (:REWRITE BITOPS::LOGBITP-OF-CONST))
 (81 30
     (:REWRITE BITOPS::LOGBITP-WHEN-BITMASKP))
 (80 20
     (:TYPE-PRESCRIPTION BITOPS::ASH-NATP-TYPE))
