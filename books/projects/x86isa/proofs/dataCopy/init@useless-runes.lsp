...
(X86ISA::SOURCE-BYTES (3 3
                         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(X86ISA::DESTINATION-BYTES (3 3
                              (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(X86ISA::LOOP-INVARIANT)
(X86ISA::LOOP-PRECONDITIONS (30 16
...
(X86ISA::CLK)
(X86ISA::PROGRAM-CLK)
(X86ISA::ASH-N-2-BOUND (33 33 (:TYPE-PRESCRIPTION FLOOR-ZERO . 2))
...
(X86ISA::MOD-THM-1 (17 17 (:TYPE-PRESCRIPTION MOD-TYPE . 3))
