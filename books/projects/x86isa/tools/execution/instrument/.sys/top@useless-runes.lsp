...
(X86ISA::BIG-STEP
 (178 89 (:TYPE-PRESCRIPTION X86ISA::N08P-ELEMENT-OF-BYTE-LISTP))
 (89 89 (:TYPE-PRESCRIPTION X86ISA::BYTE-LISTP))
 )
(X86ISA::ONE-STEP)
(X86ISA::LOG-INSTR-FN
 (1110 555 (:TYPE-PRESCRIPTION X86ISA::N08P-ELEMENT-OF-BYTE-LISTP))
 (555 555 (:TYPE-PRESCRIPTION X86ISA::BYTE-LISTP))
