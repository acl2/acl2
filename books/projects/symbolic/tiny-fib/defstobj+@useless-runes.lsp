...
(CDR-LASTN (52 52 (:REWRITE DEFAULT-CDR))
           (19 19
               (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
...
(CONSP-LASTN (18 14
             ...
             (4 4 (:REWRITE |(< (- x) 0)|))
             (1 1 (:REWRITE |(< (+ c x) d)|)))
(LASTN-ALT-DEF (48 6 (:DEFINITION NTH))
...
(LASTN-NIL (40 5 (:REWRITE LASTN-ALT-DEF))
           ...
           (3 3 (:REWRITE |(< (- x) 0)|))
           (1 1 (:REWRITE |(< (+ c x) d)|)))
(LASTN-0 (10 10 (:TYPE-PRESCRIPTION TRUE-LISTP))
         (10 2 (:DEFINITION TRUE-LISTP))
         (8 1 (:REWRITE LASTN-NIL))
         (8 1 (:REWRITE LASTN-ALT-DEF))
         (2 2 (:REWRITE DEFAULT-CDR)))
(NTH-UPDATE-NTH2 (16 2 (:DEFINITION NTH))
                 (10 10 (:REWRITE SIMPLIFY-SUMS-EQUAL))
                 (10 10
                     (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
                 (10 10
...
(NTH-UPDATE-NTH-2 (10 10 (:REWRITE DEFAULT-CDR))
...
(NTH-REPEAT2)
(UPDATE-NTH-NIL2 (26 10 (:REWRITE DEFAULT-CDR))
...
(UPDATE-NTH-UPDATE-NTH-SAME
     ...
     (3 3 (:REWRITE |(equal (- x) (- y))|)))
(LEN-REPEAT2 (16 10 (:REWRITE DEFAULT-+-2))
             (14 7
                 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
...
(CAR-UPDATE-NTH (19 1 (:DEFINITION NTH-REPEAT2))
                ...
                (2 1
                   (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
                (1 1 (:TYPE-PRESCRIPTION BINARY-APPEND)))
(CDR-UPDATE-NTH (29 5 (:REWRITE ZP-OPEN))
                (18 2 (:REWRITE |(< d (+ c x))|))
...
(COPY-TO-STOBJ-ARRAY-IGNORES-SECOND-ARG-L1
     ...
     (12 12
         (:REWRITE COPY-TO-STOBJ-ARRAY-FIRSTN))
...
(COPY-TO-STOBJ-ARRAY-IGNORES-SECOND-ARG
     ...
     (1 1 (:REWRITE |(equal (- x) 0)|))
     (1 1 (:REWRITE |(< 0 (- x))|)))
(LEN-0-ATOM (9 5 (:REWRITE DEFAULT-+-2))
            (8 4 (:REWRITE SIMPLIFY-SUMS-EQUAL))
            (8 4
               (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
            (8 4
            ...
            (4 4 (:REWRITE |(equal (- x) 0)|))
            (4 4 (:REWRITE |(equal (- x) (- y))|)))
(CONS-EQUAL-CAR (6 6 (:REWRITE SIMPLIFY-SUMS-EQUAL))
                (6 6
                   (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
                (6 6
                   (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
