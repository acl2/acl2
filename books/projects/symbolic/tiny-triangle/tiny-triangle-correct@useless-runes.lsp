...
(CONCRETE-STEPS-TO-CUTPOINT-TAIL-DEF
     ...
     (1 1
        (:TYPE-PRESCRIPTION TINY-TRI-PRECONDITION))
     (1 1
        (:TYPE-PRESCRIPTION TINY-TRI-EXITPOINT))
     (1 1 (:TYPE-PRESCRIPTION NEXT)))
...
(|TINY-TRI-PARTIAL-EXITSTEPS-TAIL-arity-1|
 (1
  1
  (:TYPE-PRESCRIPTION |TINY-TRI-PARTIAL-EXITSTEPS-TAIL-arity-1-defpun-stn|)))
...
(ASSERTION-INVARIANT-OVER-CUTPOINTS
     ...
     (1444 752 (:REWRITE DEFAULT-+-2))
     (769 752 (:REWRITE DEFAULT-+-1))
     (699 679
     ...
     (1 1 (:TYPE-PRESCRIPTION NATP)))
(TINY-TRI-PARTIAL-EXITSTEPS (12 2 (:TYPE-PRESCRIPTION RETURN-LAST))
                            (2 2
                               (:TYPE-PRESCRIPTION THROW-NONEXEC-ERROR)))
...
(|TINY-TRI-TOTAL-EXITSTEPS-TAIL-arity-1|
 (1 1
    (:TYPE-PRESCRIPTION |TINY-TRI-TOTAL-EXITSTEPS-TAIL-arity-1-defpun-stn|)))
...
(TOTAL-CORRECTNESS-PROOF-OBLIGATION
     ...
     (2047 1082 (:REWRITE DEFAULT-+-2))
     (1482 80 (:REWRITE NEXT-INSTR-HALT))
     (1113 1082 (:REWRITE DEFAULT-+-1))
     (1032 954
           (:TYPE-PRESCRIPTION TYPSET-LEN-ZERO))
     ...
     (19 19
         (:TYPE-PRESCRIPTION TINY-TRI-MEASURE))
...
(TINY-TRI-TOTAL-EXITSTEPS (12 2 (:TYPE-PRESCRIPTION RETURN-LAST))
                          (2 2
                             (:TYPE-PRESCRIPTION THROW-NONEXEC-ERROR)))
