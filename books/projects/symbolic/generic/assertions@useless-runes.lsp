...
(STEPS-TO-CUTPOINT-TAIL-INV (115 115
                            ...
                            (2 2
                               (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(CUTPOINT-MINIMAL (24 4 (:DEFINITION RUN))
...
(NATP-IMPLIES-CUTPOINT (24 3 (:DEFINITION RUN))
...
(STEPS-=-1+-FOR-NATP (5 5 (:TYPE-PRESCRIPTION NATP)))
(STEPS-=-1-FOR-NATP (32 32
                        (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
                    ...
                    (1 1 (:REWRITE NATP-RW))
                    (1 1
                       (:REWRITE CUTPOINT-IMPLIES-STEPS-TO-CUTPOINT-NATP)))
(RUN-EXPANDS (38 38
                 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(NATP-NEXTT-IMPLIES-NATP
     (43 31
         (:TYPE-PRESCRIPTION NATP-STEPS-IMPLIES-NATP-NEXTT))
...
(|nextt cutpoint for cutpoint|
     ...
     (1 1
        (:REWRITE |nextt cutpoint for not cutpoint|)))
