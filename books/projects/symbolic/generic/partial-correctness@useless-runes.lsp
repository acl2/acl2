...
(NO-BIG-EXITPOINT (12 12
                  ...
                  (1 1 (:REWRITE DEFAULT-+-2))
                  (1 1 (:REWRITE DEFAULT-+-1)))
(CUTPOINT-IMPLIES-ASSERTION (492 43 (:DEFINITION RUN))
...
(LITTLE-BIG-INVERSE (354 182 (:REWRITE DEFAULT-+-2))
                    ...
                    (2 1 (:REWRITE O-INFP->NEQ-0)))
(LITTLE-STEPS-BIT-STEPS (177 177
                             (:TYPE-PRESCRIPTION STEPS-TO-CUTPOINT-IS-NATP))
...
(FALSIFIER-IF-NATP-IS-LESS-THAN-N
     ...
     (7 7 (:REWRITE RUN-ALWAYS-EXPANDS)))
(FALSIFIER-FALSIFIES-1 (102 6 (:DEFINITION NEXTT-CUTPOINT))
...
(BIG-STEPS-IS-NATP->0 (266 266
                      ...
                      (1 1
                         (:LINEAR STEPS-TO-CUTPOINT-IS-MINIMAL)))
(|partial correctness| (652 24 (:LINEAR LITTLE-IS-MONOTONIC))
