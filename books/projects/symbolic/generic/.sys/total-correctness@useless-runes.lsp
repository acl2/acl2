...
(BIG-STEP-ENCOUNTERS-NO-EXITPOINT
 ...
 (579 10 (:REWRITE LITTLE-STEPS=0-BIGS-STEP-RUN=IDENTITY))
 (465 5 (:DEFINITION BIG-STEP-RUN))
...
(FALSIFIER-FALSIFIES-2
 (3327 54 (:LINEAR LITTLE-IS-MONOTONIC))
 (1153 430 (:REWRITE DEFAULT-+-2))
 (1074 1074 (:TYPE-PRESCRIPTION STEPS-TO-CUTPOINT-IS-NATP))
 (850 66 (:REWRITE ASSOCIATIVITY-OF-+))
 (755 430 (:REWRITE DEFAULT-+-1))
...
(LESS-THAN-EXITPOINT-IMPLIES-NO-EXITPOINT
 (1210 2 (:REWRITE LITTLE-STEPS=0-BIGS-STEP-RUN=IDENTITY))
 (1078 10 (:LINEAR LITTLE-IS-MONOTONIC))
 (757 1 (:DEFINITION BIG-STEP-RUN))
 (613 12 (:DEFINITION LITTLE-STEPS))
...
(|partial correctness|
 (688 24 (:LINEAR LITTLE-IS-MONOTONIC))
