...
(ASSERTION-INVARIANT-OVER-CUTPOINTS
 ...
 (2548 1294 (:REWRITE DEFAULT-+-2))
 (1299 1294 (:REWRITE DEFAULT-+-1))
 ...
 (119 115 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(TOTAL-CORRECTNESS-PROOF-OBLIGATION
 ...
 (187 179 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
