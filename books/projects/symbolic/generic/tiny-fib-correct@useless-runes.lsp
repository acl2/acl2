(FIB-SPEC (5 1 (:REWRITE O<=-O-FINP-DEF))
...
(CONCRETE-STEPS-TO-CUTPOINT-TAIL-DEF
     ...
     (1 1
        (:TYPE-PRESCRIPTION TINY-FIB-PRECONDITION))
     (1 1
        (:TYPE-PRESCRIPTION TINY-FIB-EXITPOINT))
     (1 1 (:TYPE-PRESCRIPTION NEXT)))
...
(|TINY-FIB-PARTIAL-EXITSTEPS-TAIL-arity-1|
 (1
  1
  (:TYPE-PRESCRIPTION |TINY-FIB-PARTIAL-EXITSTEPS-TAIL-arity-1-defpun-stn|)))
...
(CONCRETE-NEXTT-CUTPOINT (12 2 (:TYPE-PRESCRIPTION RETURN-LAST))
...
(TINY-FIB-PARTIAL-EXITSTEPS (12 2 (:TYPE-PRESCRIPTION RETURN-LAST))
                            (2 2
                               (:TYPE-PRESCRIPTION THROW-NONEXEC-ERROR)))
...
(|TINY-FIB-TOTAL-EXITSTEPS-TAIL-arity-1|
 (1 1
    (:TYPE-PRESCRIPTION |TINY-FIB-TOTAL-EXITSTEPS-TAIL-arity-1-defpun-stn|)))
...
(TOTAL-CORRECTNESS-PROOF-OBLIGATION
     ...
     (38 38
         (:TYPE-PRESCRIPTION TINY-FIB-MEASURE))
     (36 36
         (:REWRITE REDUCE-INTEGERP-+-CONSTANT))
...
(TINY-FIB-TOTAL-EXITSTEPS (12 2 (:TYPE-PRESCRIPTION RETURN-LAST))
                          (2 2
                             (:TYPE-PRESCRIPTION THROW-NONEXEC-ERROR)))
