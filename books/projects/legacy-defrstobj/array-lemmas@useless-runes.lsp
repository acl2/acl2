(RSTOBJ::LEN-OF-MAKE-LIST-AC (68 38 (:REWRITE DEFAULT-+-2))
...
(RSTOBJ::TRUE-LISTP-MAKE-LIST-AC (13 11 (:REWRITE DEFAULT-CDR))
                                 (4 4 (:REWRITE ZP-OPEN))
                                 (2 2 (:REWRITE DEFAULT-+-2))
                                 (2 2 (:REWRITE DEFAULT-+-1)))
(RSTOBJ::ACL2-COUNT-OF-NTH-WEAK (162 82 (:REWRITE DEFAULT-+-2))
                                ...
                                (3 3 (:REWRITE ZP-OPEN)))
(RSTOBJ::ACL2-COUNT-OF-NTH-STRONG (657 332 (:REWRITE DEFAULT-+-2))
...
(RSTOBJ::TRUE-LISTP-OF-UPDATE-NTH
     ...
     (11 11
         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(RSTOBJ::UPDATE-NTH-SAME (1309 581
...
(RSTOBJ::UPDATE-NTH-DIFF (3527 1579
                               (:TYPE-PRESCRIPTION TRUE-LISTP-UPDATE-NTH))
...
(RSTOBJ::UPDATE-NTH-DIFF-GATHER-CONSTANTS
     ...
     (4 4
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(RSTOBJ::UPDATE-NTH-OF-NTH (1652 826
                                 (:TYPE-PRESCRIPTION TRUE-LISTP-UPDATE-NTH))
...
(RSTOBJ::EQUAL-OF-CONS-REWRITE (3 3 (:REWRITE DEFAULT-CDR))
                               (3 3 (:REWRITE DEFAULT-CAR)))
(RSTOBJ::EXPAND-NTH (11 5 (:REWRITE ZP-OPEN))
