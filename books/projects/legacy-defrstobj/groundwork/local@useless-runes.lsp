...
(ACL2-COUNT-OF-NTH-WEAK (162 82 (:REWRITE DEFAULT-+-2))
                        ...
                        (3 3 (:REWRITE ZP-OPEN)))
(ACL2-COUNT-OF-NTH-STRONG (657 332 (:REWRITE DEFAULT-+-2))
...
(UPDATE-NTH-SWITCH (413 130 (:REWRITE DEFAULT-CAR))
                   ...
                   (4 4
                      (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(UPDATE-NTH-OF-NTH (18 12 (:REWRITE DEFAULT-<-2))
...
(UPDATE-NTH-OF-NTH-OTHER (10 2 (:DEFINITION LEN))
                         (6 6 (:REWRITE DEFAULT-<-2))
...
(S-NIL-NIL)
(UPDATE-NTH-SAME (149 62 (:REWRITE DEFAULT-CDR))
...
(TRUE-LISTP-MAKE-LIST-AC (13 11 (:REWRITE DEFAULT-CDR))
                         (4 4 (:REWRITE ZP-OPEN))
