...
(BRANCH-TO-NODE (5 5 (:TYPE-PRESCRIPTION ORDERLY-APPEND)))
(NUM-MOVES)
(MV-ROOT-HELPER (424 9
                     (:REWRITE SUBSET-REV-FLATTEN-SUBSET-MYTIPS))
...
(CONSP-THROUG-APP (134 134 (:TYPE-PRESCRIPTION APP))
...
(LEN-APP-GREATER (27 16 (:REWRITE DEFAULT-CDR))
...
(LEN-0-NOT-CONSP (7 4 (:REWRITE DEFAULT-+-2))
                 (6 3 (:REWRITE SIMPLIFY-SUMS-EQUAL))
                 (6 3
                    (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
                 (6 3
                 ...
                 (3 3 (:REWRITE |(equal (- x) (- y))|)))
(TO-LEN-GREATER-2 (28 15 (:REWRITE DEFAULT-+-2))
