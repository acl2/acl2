...
(SUM-FREQUENCIES-LIST
 (5180 1804 (:REWRITE DEFAULT-+-2))
 (2355 1804 (:REWRITE DEFAULT-+-1))
 (1804 1804 (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
 (1106 381 (:REWRITE DEFAULT-UNARY-MINUS))
 (920 20 (:DEFINITION HONS-ASSOC-EQUAL))
 (904 737 (:REWRITE DEFAULT-CDR))
 (771 488 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-<))
 (756 60 (:REWRITE NOT-MEMBER-NOT-CONSP-ASSOC))
 (739 681 (:REWRITE REMOVE-WEAK-INEQUALITIES-TWO))
 (701 569 (:REWRITE DEFAULT-CAR))
 (688 688 (:TYPE-PRESCRIPTION NUMERATOR-POSITIVE . 2))
 (688 688 (:TYPE-PRESCRIPTION NUMERATOR-POSITIVE . 1))
 (688 688 (:TYPE-PRESCRIPTION NUMERATOR-NEGATIVE . 2))
 (688 688 (:TYPE-PRESCRIPTION NUMERATOR-NEGATIVE . 1))
 (681 681 (:REWRITE |(+ c (+ d x))|))
 (660 660 (:REWRITE |(< (- x) (- y))|))
 (575 575 (:REWRITE FOLD-CONSTS-IN-+))
 (570 461 (:REWRITE DEFAULT-<-2))
 (567 461 (:REWRITE DEFAULT-<-1))
 (527 527 (:REWRITE |(< (- x) 0)|))
 (382 130 (:LINEAR MEMBER-OF-ALL-IMPLIES-SMALLER-THAN-SMALLEST))
 (345 345 (:REWRITE SIMPLIFY-TERMS-SUCH-AS-A+AB-<-0))
 (234 60 (:REWRITE NOT-CONSP-ASSOC-NOT-ASSOC-HQUAL))
 (232 58 (:REWRITE MEMBER-GEN-WHEN-NOT-CONS))
 (204 204 (:TYPE-PRESCRIPTION MEMBER-OF-ALL))
 (204 102 (:TYPE-PRESCRIPTION INTEGER-ASSOC-HQUAL-INTEGER-HALISTP))
 (199 83 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
 (192 192 (:REWRITE SMALLEST-IN-LIST-WHEN-NOT-CONSP))
 ...
 (172 172 (:REWRITE INTEGERP==>NUMERATOR-=-X))
 (172 172 (:REWRITE INTEGERP==>DENOMINATOR-=-1))
 (172 172 (:REWRITE DEFAULT-REALPART))
 (172 172 (:REWRITE DEFAULT-NUMERATOR))
 (172 172 (:REWRITE DEFAULT-IMAGPART))
 (172 172 (:REWRITE DEFAULT-DENOMINATOR))
 (172 172 (:REWRITE DEFAULT-COERCE-2))
 (172 172 (:REWRITE DEFAULT-COERCE-1))
 (148 148 (:LINEAR SUBTREEP-SMALLER))
 (148 148 (:LINEAR MEMBER-HQUAL-IMPLIES-SMALLER))
 (148 148 (:LINEAR MEMBER-EQUAL-IMPLIES-SMALLER))
 ...
 (102 102 (:REWRITE MEMBER-OF-ALL-WHEN-NOT-CONSP))
 ...
 (58 31 (:REWRITE |(< (+ c x) d)|))
 (37 37 (:REWRITE IF-CONS-RANGE-MEMBER-OF-ALL-HALISTP-WHEN-NOT-CONSP))
