(REPLETE-TREES)
(REPLETE-TREES-WHEN-NOT-CONSP (19 19 (:TYPE-PRESCRIPTION REPLETE-TREES)))
...
(REPLETE-TREES-LIST-TOP1 (1 1 (:TYPE-PRESCRIPTION REPLETE-TREES)))
...
(SUM-FREQUENCIES-LIST-OF-CONSP
     ...
     (36 8
         (:REWRITE SUM-FREQUENCIES-LIST-WHEN-NOT-CONSP))
     ...
     (4 4
        (:TYPE-PRESCRIPTION GOOD-INDEX-TAXON-HALIST))
     (2 2
        (:TYPE-PRESCRIPTION IF-CONS-RANGE-MEMBER-OF-ALL-HALISTP))
