(NOT-CONFLICTING (101 32 (:REWRITE APP-WHEN-NOT-CONSP))
                 (63 9 (:REWRITE MEMBER-GEN-WHEN-NOT-CONS))
                 (63 9
                     (:REWRITE BTREES-TO-FRINGES-WHEN-NOT-CONSP))
                 (60 10 (:REWRITE MEMBER-APP))
                 (32 8 (:REWRITE SUBSET-LIST-WHEN-NOT-CONSP))
                 (28 2
                     (:REWRITE SORT-BDD-FRINGES-WHEN-NOT-CONSP))
                 ...
                 (20 2
                     (:REWRITE Q-NO-CONFLICTS-LIST-WHEN-NOT-CONSP))
                 (16 2
...
(INTEGERP-COUNT-SUPPORT (9 9 (:REWRITE REDUCE-INTEGERP-+))
...
(INTEGERP-HOW-MUCH-SUPPORT
     ...
     (6 1 (:REWRITE NOT-MEMBER-NIL-INTSYMLIST))
     (5 5
        (:TYPE-PRESCRIPTION TRUE-LISTP-TERM-TO-BFRINGES))
