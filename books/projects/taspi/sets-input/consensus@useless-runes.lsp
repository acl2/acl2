...
(VALID-BDD-LIST-THROUGH-COLLECT
     ...
     (78 78
         (:TYPE-PRESCRIPTION COLLECT-WHEN-SIZE-IS-AT-LEAST-CUTOFF))
...
(COMPUTE-CONSENSUS-HELPER
     (285 1
          (:DEFINITION COLLECT-WHEN-SIZE-IS-AT-LEAST-CUTOFF))
...
(COMPUTE-FREQUENCIES (24 1 (:DEFINITION FAST-ALIST-FORK))
                     (14 2 (:DEFINITION LEN))
                     (12 2 (:REWRITE NOT-MEMBER-NIL-INTSYMLIST))
