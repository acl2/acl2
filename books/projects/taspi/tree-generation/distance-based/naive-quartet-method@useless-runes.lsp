...
(INDEXP-BOUNDS)
(INDEXP-TYPE)
(NAT-LIST-P-NTH-DIST (54 44 (:REWRITE DEFAULT-<-2))
...
(INDEXP-INCR (10 9 (:REWRITE DEFAULT-<-2))
...
(GET-DISTANCE (827 403 (:REWRITE INDEXP-BOUNDS))
              ...
              (6 1 (:DEFINITION NTH))
              (1 1 (:REWRITE ZP-OPEN)))
(GET-DISTANCE-NATP (23 1 (:DEFINITION DIST-MATRIX-HELPER))
                   (20 4 (:DEFINITION LEN))
                   (12 2 (:DEFINITION NTH))
...
(QUARTET-GUARD (25 1 (:DEFINITION DIST-MATRIX-HELPER))
               (15 3 (:DEFINITION LEN))
               (12 1 (:DEFINITION NAT-LISTP))
               ...
               (1 1 (:REWRITE DEFAULT-<-1)))
(GET-QUARTET)
(QUARTET-P-GET-QUARTET (4804 2402
                             (:TYPE-PRESCRIPTION GET-DISTANCE-NATP))
...
(GET-QUARTETS (2665 533 (:DEFINITION LEN))
              (2283 1746 (:REWRITE DEFAULT-+-2))
              (1750 1746 (:REWRITE DEFAULT-+-1))
              ...
              (205 201 (:REWRITE DEFAULT-UNARY-MINUS))
              (147 147 (:REWRITE INDEXP-TYPE))
              (12 12
                  (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(QUARTET-LISTP-GET-QUARTETS (4218 2417 (:REWRITE DEFAULT-+-2))
                            (3839 2417 (:REWRITE DEFAULT-+-1))
...
(QUARTET-MEMBER (66 66 (:REWRITE DEFAULT-CAR))
...
(QUARTETS-MEMBER (220 220 (:REWRITE DEFAULT-CDR))
...
(CHECK-SIBLING (224 224 (:REWRITE DEFAULT-CAR))
               ...
               (6 6 (:REWRITE DEFAULT-<-1)))
(CHECK-SIBLINGS (225 225 (:REWRITE DEFAULT-CDR))
...
(MPQL-QUARTET-LISTP (99 99 (:REWRITE DEFAULT-CAR))
                    ...
                    (16 16 (:REWRITE DEFAULT-<-1)))
(FIND-SIBLINGS (2576 56 (:DEFINITION CHECK-SIBLINGS))
...
(FIND-SIBLINGS-QUARTETS-MEMBER (12167 12152 (:REWRITE DEFAULT-CAR))
...
(FIND-SIBLINGS-CONSP (10049 10049 (:REWRITE DEFAULT-CAR))
...
(FIND-SIBLINGS-EQLABLEP (13200 11308 (:REWRITE DEFAULT-CAR))
                        ...
                        (82 41 (:REWRITE DEFAULT-+-2))
                        (41 41 (:REWRITE DEFAULT-+-1)))
(REMOVE-FROM-QUARTETS (220 220 (:REWRITE DEFAULT-CDR))
                      (204 204 (:REWRITE DEFAULT-CAR))
                      (96 48 (:REWRITE INDEXP-BOUNDS))
                      (48 48 (:TYPE-PRESCRIPTION INDEXP))
                      (48 48 (:REWRITE INDEXP-TYPE))
                      (24 24 (:REWRITE DEFAULT-<-2))
                      (24 24 (:REWRITE DEFAULT-<-1)))
(REMOVE-FROM-QUARTETS-MEASURE (112 59 (:REWRITE DEFAULT-+-2))
...
(REMOVE-FROM-QUARTETS-QUARTET-LIST (296 295 (:REWRITE DEFAULT-CDR))
...
(ADD-SIBLING (306 146 (:REWRITE DEFAULT-+-2))
             ...
             (12 4 (:REWRITE INDEXP-INCR)))
(NAIVE-QUARTET-RECURSION (230 221 (:REWRITE DEFAULT-CAR))
...
(NAIVE-QUARTET-METHOD (754 1 (:DEFINITION GET-QUARTETS))
