...
(PLUS-NIL-INF)
(MIN-NIL-INF)
(MIN-LIST (82 82 (:REWRITE DEFAULT-CAR))
...
(SUM-LIST (80 80 (:REWRITE DEFAULT-CAR))
          (62 62 (:REWRITE DEFAULT-CDR))
          (22 22
          ...
          (22 22 (:REWRITE DEFAULT-+-2))
          (22 22 (:REWRITE DEFAULT-+-1)))
(RATIONALP-MIN-LIST (38 38 (:REWRITE DEFAULT-CAR))
                    ...
                    (6 6 (:REWRITE |(< (- x) (- y))|)))
(SUM-MINIMA)
(RATIONALP-SUM-MINIMA (105 105 (:REWRITE DEFAULT-CAR))
...
(SUM-MINIMA (96 8 (:DEFINITION MIN-LIST))
...
(LEN-CONST-LIST-ACC (36 19 (:REWRITE DEFAULT-+-2))
                    (19 19
                        (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
...
(LEN-NIL-LIST (11 1 (:DEFINITION LEN))
...
(LEN-MAKE-LIST-AC (36 19 (:REWRITE DEFAULT-+-2))
                  (19 19
                      (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
                  (19 19 (:REWRITE NORMALIZE-ADDENDS))
                  (19 19 (:REWRITE DEFAULT-+-1))
                  ...
                  (1 1 (:REWRITE FOLD-CONSTS-IN-+)))
(ZERO-SCORES)
(ZERO-SCORES-LEN (14 7 (:REWRITE DEFAULT-+-2))
                 ...
                 (3 3 (:REWRITE |(equal (- x) (- y))|)))
(ZERO-SCORES-RATIONAL-OR-NIL-LISP (10 9 (:REWRITE DEFAULT-CDR))
                                  (10 8 (:REWRITE DEFAULT-CAR)))
(CHARSTATE-SCORELIST-MAP-P)
(ASSOC-HQUAL-STATE-SCORELIST-MAP
     (330 6
          (:REWRITE VALID-SEQUENCES-SAME-LENGTH-ASSOC-HQUAL))
     (318 6
...
(MAKE-LEAF-SCORE-LIST (46 1 (:DEFINITION HONS-ASSOC-EQUAL))
...
(COST-MATRIX-HET
     ...
     (12 12
         (:REWRITE COST-MATRIXP-NSTATES-COST-MATRIXP))
