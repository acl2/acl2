...
(ALISTP-GEN-MAPPING-FROM-MATRIX
     ...
     (942 28
          (:DEFINITION SMALL-INTEGER-LIST-LISTP))
     (774 28
          (:DEFINITION SMALL-INTEGER-TRANSITION-ROWP))
     ...
     (174 174
          (:TYPE-PRESCRIPTION MAPPING-FROM-MATRIX))
     (140 140
          (:TYPE-PRESCRIPTION SMALL-INTEGER-TRANSITION-ROWP))
     (140 140
          (:TYPE-PRESCRIPTION SMALL-INTEGER-LISTP))
     (140 140
          (:TYPE-PRESCRIPTION SMALL-INTEGER-LIST-LISTP))
...
(ALISTP-GEN-MAKE-NUMBERFIED-SEQS
     ...
     (177 177
          (:TYPE-PRESCRIPTION MAKE-NUMBERFIED-SEQS))
     (170 170
          (:TYPE-PRESCRIPTION SMALL-INTEGER-TRANSITION-ROWP))
     (170 170
          (:TYPE-PRESCRIPTION SMALL-INTEGER-LISTP))
