...
(CANCEL_PLUS-EQUAL$1
 (10936 754 (:REWRITE PSEUDO-TERM-LISTP-CDR))
 (8639 754 (:REWRITE PSEUDO-TERMP-LIST-CDR))
 (7966 375 (:REWRITE PSEUDO-TERMP-CAR))
 (5187 301 (:REWRITE PSEUDO-TERMP-CADR-FROM-PSEUDO-TERM-LISTP))
 (1586 1565 (:REWRITE DEFAULT-CDR))
