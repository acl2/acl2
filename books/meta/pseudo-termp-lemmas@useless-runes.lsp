(PSEUDO-TERM-LISTP-CDR (1 1 (:REWRITE TERMP-IMPLIES-PSEUDO-TERMP))
                       (1 1
                          (:REWRITE TERM-LISTP-IMPLIES-PSEUDO-TERM-LISTP)))
(PSEUDO-TERMP-OPENER (76 10 (:REWRITE PSEUDO-TERM-LISTP-CDR))
...
(PSEUDO-TERMP-LIST-CDR (7 1 (:REWRITE PSEUDO-TERM-LISTP-CDR))
...
(PSEUDO-TERMP-CAR (1 1 (:REWRITE TERMP-IMPLIES-PSEUDO-TERMP))
                  (1 1
                     (:REWRITE TERM-LISTP-IMPLIES-PSEUDO-TERM-LISTP))
