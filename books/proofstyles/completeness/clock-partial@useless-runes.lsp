...
(|CLOCK-FN-TAIL-arity-1|
     (1 1
        (:TYPE-PRESCRIPTION |CLOCK-FN-TAIL-arity-1-defpun-stn|)))
(|CLOCK-FN-TAIL-arity-1-DEF|)
(CLOCK-FN-TAIL)
(CLOCK-FN-TAIL-DEF (6 6 (:REWRITE DEFAULT-CAR))
...
(N-IS-FIRST-REDUCES-TO-CLOCK (31 3 (:DEFINITION RUN-FN))
                             ...
                             (1 1 (:REWRITE NATP-RW)))
(|clock fn is natp|)
(|clock fn is minimal| (2 2 (:TYPE-PRESCRIPTION CLOCK-FN-IS-NATP))
                       (1 1
                          (:REWRITE N-IS-FIRST-REDUCES-TO-CLOCK)))
(|clock fn produces exitpoint| (19 2 (:DEFINITION RUN-FN))
                               ...
                               (1 1 (:REWRITE DEFAULT-<-1))
                               (1 1 (:META CANCEL_PLUS-LESSP-CORRECT)))
(|clock fn produces postcondition| (42 4 (:DEFINITION RUN-FN))
