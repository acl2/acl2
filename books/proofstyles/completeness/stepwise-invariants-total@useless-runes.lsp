...
(INV)
(INV-SUFF (6 6 (:DEFINITION MV-NTH)))
(CUTPOINT-INDUCTION (3 3
                       (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(CLOCK-FN-TAIL-INV (115 115
...
(|pre implies inv| (8 8 (:TYPE-PRESCRIPTION CLOCK-FN-IS-NATP))
                   (5 1 (:REWRITE ZP-OPEN))
...
(|inv implies step-fn inv| (25 20 (:REWRITE DEFAULT-<-1))
                           ...
                           (7 7
                              (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                           (6 6 (:REWRITE NATP-RW)))
(|inv and exitpoint implies post| (201 201
                                       (:TYPE-PRESCRIPTION CLOCK-FN-IS-NATP))
...
(M (5 5
   ...
   (5 5
      (:TYPE-PRESCRIPTION CLOCK-FN-IS-NATP)))
(RUN-FN-+-REDUCTION (38 10 (:REWRITE ZP-OPEN))
                    ...
                    (1 1 (:META CANCEL_TIMES-EQUAL-CORRECT))
                    (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(INV-IMPLIES-EXITPOINT (85 60 (:REWRITE DEFAULT-<-1))
...
(STEPS-DECREASE (147 147
                ...
                (1 1 (:REWRITE ZP-OPEN))
                (1 1 (:REWRITE NATP-RW)))
(M-DECREASES (136 8 (:REWRITE ZP-OPEN))
             (92 26
                 (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
