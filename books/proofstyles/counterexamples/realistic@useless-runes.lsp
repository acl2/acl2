...
(MODIFY-FACTORIAL)
(RUN)
(RUN-EXPANSION (120 10 (:DEFINITION NTH))
...
(MEMORY-CLEARED-AFTER-SOME-TIME (22 12 (:REWRITE DEFAULT-CDR))
                                (2 1 (:REWRITE DEFAULT-CAR))
                                (1 1 (:REWRITE DEFAULT-<-2))
                                (1 1 (:REWRITE DEFAULT-<-1)))
(MEMORY-CLEARED-AFTER-MODIFY (10 4 (:DEFINITION NTH))
                             (10 1 (:DEFINITION !))
                             ...
                             (1 1 (:REWRITE DEFAULT-*-1)))
(CLEAR-IS-HALTED)
(HALTED-TO-STEPW (18 2 (:DEFINITION NTH))
                 (15 3 (:DEFINITION LEN))
...
(RUN-S-STEPW (1962 213 (:DEFINITION NTH))
