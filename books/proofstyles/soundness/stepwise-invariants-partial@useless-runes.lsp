...
(N-IS-FIRST)
(N-IS-FIRST-NECC)
(NO-EXIT (4 4 (:REWRITE DEFAULT-<-2))
         (4 4 (:REWRITE DEFAULT-<-1))
         (1 1 (:REWRITE ZP-OPEN))
         (1 1 (:REWRITE DEFAULT-+-2))
         (1 1 (:REWRITE DEFAULT-+-1)))
(NO-EXIT-TO-EXITPOINT (11 11 (:REWRITE DEFAULT-<-2))
                      (11 11 (:REWRITE DEFAULT-<-1))
                      (4 4 (:REWRITE ZP-OPEN))
                      (4 4 (:REWRITE DEFAULT-+-2))
                      (4 4 (:REWRITE DEFAULT-+-1)))
(NO-EXIT-TO-NO-EXIT (11 11 (:REWRITE DEFAULT-<-2))
                    (11 11 (:REWRITE DEFAULT-<-1))
                    (5 5 (:REWRITE ZP-OPEN))
                    (4 4 (:REWRITE DEFAULT-+-2))
                    (4 4 (:REWRITE DEFAULT-+-1)))
(INV-AND-NO-EXIT (11 11 (:REWRITE |pre satisfies inv|))
                 (9 9 (:REWRITE ZP-OPEN))
                 (8 8 (:REWRITE NO-EXIT-TO-NO-EXIT))
                 (4 4 (:REWRITE DEFAULT-+-2))
                 (4 4 (:REWRITE DEFAULT-+-1)))
(N-IS-FIRST-TO-N-IS-FIRST (64 64
