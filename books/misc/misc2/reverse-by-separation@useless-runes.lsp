...
(LIST-FOR)
(SEPARATE)
(SPEC (12 12 (:TYPE-PRESCRIPTION TRUE-LISTP))
      (12 6
...
(EXEC-ADD (1342 69 (:DEFINITION RD))
...
(EXEC-OPEN (385 24 (:DEFINITION RD))
...
(STRIP-CARS-APPEND (174 30 (:REWRITE DEFAULT-CAR))
                   (148 134
                        (:TYPE-PRESCRIPTION LIST::APPEND-CONSP-TYPE-TWO))
...
(RD-LISTP-OPEN (104 5 (:DEFINITION RD))
               (40 4
                   (:REWRITE LIST::EQUAL-CAR-DIFFERENTIAL))
               ...
               (4 4
                  (:REWRITE LIST::CARS-MATCH-FROM-FIRSTN-FACT)))
(RD-PC-HACK)
(RD-PC-HACK-CONS (11 11 (:REWRITE DEFAULT-CAR))
                 ...
                 (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(RD-PC-HACK-INTRO)
(NEXT-OPENER (316 26 (:DEFINITION RD))
...
(SPEC-BODY (348737 345369 (:REWRITE DEFAULT-CAR))
           (196553 192348 (:REWRITE DEFAULT-+-1))
           (192254 192254
...
(SPEC-LOOP-BASE (6959 4232 (:REWRITE DEFAULT-CAR))
                (6081 5678 (:REWRITE DEFAULT-+-2))
                (5683 5678 (:REWRITE DEFAULT-+-1))
...
(APPEND-REVAPPEND (688 344
                  ...
                  (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
                  (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(SPEC-LOOP-STEP (168 106 (:REWRITE DEFAULT-+-2))
                ...
                (1 1 (:LINEAR SYN::LEN-IMPLIES-ACL2-LEN)))
(SPEC-LOOP-INDUCT (3 3 (:TYPE-PRESCRIPTION EXEC)))
(SPEC-LOOP)
(SPEC-INIT (24947 24551 (:REWRITE DEFAULT-CAR))
...
(SPEC-REV (17 10 (:REWRITE DEFAULT-+-2))
          (16 2 (:DEFINITION LEN))
