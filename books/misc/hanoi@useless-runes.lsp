...
(HANOI::DEL)
(HANOI::PERM)
(HANOI::PERM-OPENER (66 66 (:REWRITE DEFAULT-<-2))
                    (66 66 (:REWRITE DEFAULT-<-1))
                    (31 31 (:REWRITE DEFAULT-CAR))
                    (28 28 (:REWRITE DEFAULT-CDR)))
(HANOI::APP-ASSOC (248 248 (:TYPE-PRESCRIPTION HANOI::APP))
                  (21 20 (:REWRITE DEFAULT-CAR))
                  (17 16 (:REWRITE DEFAULT-CDR)))
(HANOI::APP-RIGHT-ID (5 5 (:REWRITE DEFAULT-CDR))
                     (3 3 (:REWRITE DEFAULT-CAR)))
(HANOI::GET)
(HANOI::PUT)
(HANOI::GET-PUT (86 41 (:REWRITE ZP-OPEN))
...
(HANOI::PUT-GET (21 14 (:REWRITE DEFAULT-+-2))
...
(HANOI::PUT-PUT-1 (922 86 (:REWRITE HANOI::PUT-GET))
...
(HANOI::PUT-PUT-2 (192 19 (:REWRITE HANOI::PUT-GET))
...
(HANOI::TRUE-LISTP-PUT (57 6 (:REWRITE HANOI::PUT-GET))
...
(HANOI::LEN-PUT (57 6 (:REWRITE HANOI::PUT-GET))
                (51 7 (:DEFINITION HANOI::GET))
...
(HANOI::TOWER)
(HANOI::EXAMPLES)
(HANOI::TRUE-LISTP-TOWER (36 29 (:REWRITE DEFAULT-CDR))
...
(HANOI::PLAY-APP (8157 5125 (:REWRITE DEFAULT-CDR))
...
(HANOI::H-LEMMA (9465 2985 (:REWRITE ZP-OPEN))
...
(HANOI::HANOI-CORRECT (391 1 (:DEFINITION HANOI::PLAY))
