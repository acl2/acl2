...
; WARNING: Before saving this file in emacs, consider evaluating the following
; form to set the indicated buffer-local variable.

; (setq save-buffer-coding-system 'utf-8)

; If you have not done this, then in a linux shell, executing
;   file -i character-encoding-test.lisp
; will show what character encoding the file was saved with.
...
;   iso-8859-1 (see function acl2-set-character-encoding in the ACL2 sources)
;   did not affect reading directly from standard input.  Since .acl2 files are
