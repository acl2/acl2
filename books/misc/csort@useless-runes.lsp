(FIRSTN)
(MEMBER-EQUAL-CAR-FIRSTN (71 43 (:REWRITE DEFAULT-CAR))
                         (18 18 (:REWRITE DEFAULT-CDR))
                         (3 3 (:REWRITE DEFAULT-<-2))
                         (3 3 (:REWRITE DEFAULT-<-1))
                         (2 2 (:REWRITE DEFAULT-+-2))
                         (2 2 (:REWRITE DEFAULT-+-1)))
(FIRSTN-TOO-LONG (14 9 (:REWRITE DEFAULT-+-2))
...
(PERM-CONS (321 321 (:REWRITE DEFAULT-CAR))
           (255 255 (:REWRITE DEFAULT-CDR)))
(PERM-SYMMETRIC (115 23 (:DEFINITION DELETE-EQUAL))
                (113 113 (:REWRITE DEFAULT-CAR))
                (90 90 (:REWRITE DEFAULT-CDR)))
(MEMBER-EQUAL-DELETE-EQUAL (40 40 (:REWRITE DEFAULT-CAR))
                           (24 24 (:REWRITE DEFAULT-CDR)))
(PERM-MEMBER-EQUAL (194 24 (:REWRITE PERM-SYMMETRIC))
                   (67 67 (:REWRITE DEFAULT-CAR))
                   (45 45 (:REWRITE DEFAULT-CDR))
                   (45 9 (:DEFINITION DELETE-EQUAL)))
(MEMBER-EQUAL-DELETE-EQUAL2 (28 28 (:REWRITE DEFAULT-CAR))
                            (20 20 (:REWRITE PERM-MEMBER-EQUAL))
                            (20 20 (:REWRITE MEMBER-EQUAL-DELETE-EQUAL))
                            (12 12 (:REWRITE DEFAULT-CDR)))
(COMM-DELETE-EQUAL (79 79 (:REWRITE DEFAULT-CAR))
                   (68 68 (:REWRITE DEFAULT-CDR)))
(PERM-DELETE-EQUAL (190 28 (:DEFINITION MEMBER-EQUAL))
                   (126 126 (:REWRITE DEFAULT-CAR))
                   (101 101 (:REWRITE DEFAULT-CDR))
                   (85 55 (:REWRITE PERM-MEMBER-EQUAL))
                   (55 55
                       (:REWRITE MEMBER-EQUAL-DELETE-EQUAL)))
(PERM-TRANSITIVE (255 40 (:DEFINITION MEMBER-EQUAL))
                 (143 143 (:REWRITE DEFAULT-CAR))
                 (115 23 (:DEFINITION DELETE-EQUAL))
                 (105 105 (:REWRITE DEFAULT-CDR))
                 (78 78
                     (:REWRITE MEMBER-EQUAL-DELETE-EQUAL)))
(PERM-IS-AN-EQUIVALENCE (168 6 (:DEFINITION PERM))
                        ...
                        (14 14
                            (:REWRITE MEMBER-EQUAL-DELETE-EQUAL)))
(PERM-IMPLIES-PERM-CONS-2 (52 2 (:DEFINITION PERM))
                          (12 12 (:REWRITE DEFAULT-CAR))
                          (9 9 (:REWRITE DEFAULT-CDR))
                          (5 5 (:REWRITE PERM-MEMBER-EQUAL))
                          (5 5 (:REWRITE MEMBER-EQUAL-DELETE-EQUAL)))
(PERM-IMPLIES-IFF-MEMBER-EQUAL-2 (104 4 (:DEFINITION PERM))
...
(ATOM-PERM (2 2 (:REWRITE PERM-TRANSITIVE)))
(MEMBER-EQUAL-APPEND (69 61 (:REWRITE PERM-MEMBER-EQUAL))
...
(PERM-IMPLIES-PERM-APPEND-1 (987 150 (:REWRITE PERM-TRANSITIVE))
                            (694 676 (:REWRITE DEFAULT-CAR))
                            (514 257
                                 (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
                            (503 296 (:REWRITE PERM-MEMBER-EQUAL))
                            (482 23
                                 (:REWRITE MEMBER-EQUAL-DELETE-EQUAL2))
...
(PERM-IMPLIES-PERM-APPEND-2 (679 14 (:DEFINITION PERM))
...
(PERM-APPEND-CONS (384 264 (:REWRITE DEFAULT-CAR))
                  ...
                  (94 94
                      (:REWRITE MEMBER-EQUAL-DELETE-EQUAL)))
(PERM-IMPLIES-EQUAL-LEN-1 (322 39 (:REWRITE PERM-SYMMETRIC))
...
(PERM-REV (315 3 (:REWRITE PERM-CONS))
...
(PERM-APPEND-NIL (180 6 (:DEFINITION PERM))
...
(APPEND-REPEAT (23 10 (:REWRITE DEFAULT-CDR))
               (17 13 (:REWRITE DEFAULT-CAR))
               (6 6 (:REWRITE ZP-OPEN))
               (4 4 (:REWRITE DEFAULT-+-2))
               (4 4 (:REWRITE DEFAULT-+-1)))
(REV-REPEAT (15 3 (:DEFINITION BINARY-APPEND))
            (8 7 (:REWRITE DEFAULT-CDR))
            (8 7 (:REWRITE DEFAULT-CAR))
            (6 6 (:REWRITE ZP-OPEN))
            (4 4 (:REWRITE DEFAULT-+-2))
            (4 4 (:REWRITE DEFAULT-+-1)))
(LEN-REPEAT (13 9 (:REWRITE DEFAULT-+-2))
            (9 9 (:REWRITE DEFAULT-+-1))
...
(CONSP-REPEAT (5 5 (:REWRITE DEFAULT-+-2))
              (5 5 (:REWRITE DEFAULT-+-1))
              (1 1 (:REWRITE DEFAULT-<-2))
              (1 1 (:REWRITE DEFAULT-<-1)))
(CAR-REPEAT (31 6 (:REWRITE DEFAULT-CAR))
...
(ORDERED)
(ALL-GTE)
(ALL-GTE-DELETE-EQUAL-1 (22 22
                            (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                        (22 11 (:REWRITE DEFAULT-<-2))
                        (22 11 (:REWRITE DEFAULT-<-1))
                        (21 21 (:REWRITE DEFAULT-CAR))
                        (12 12 (:REWRITE DEFAULT-CDR)))
(ALL-GTE-DELETE-EQUAL-2 (82 82
                            (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                        (82 41 (:REWRITE DEFAULT-<-2))
                        (82 41 (:REWRITE DEFAULT-<-1))
                        (58 58 (:REWRITE DEFAULT-CAR))
                        (41 41 (:REWRITE DEFAULT-CDR)))
(LEMMA (327 34 (:REWRITE PERM-SYMMETRIC))
       (124 21 (:DEFINITION MEMBER-EQUAL))
       (97 97 (:REWRITE DEFAULT-CAR))
       (70 14 (:DEFINITION DELETE-EQUAL))
       (65 65 (:REWRITE DEFAULT-CDR))
       (51 34 (:REWRITE PERM-TRANSITIVE))
       (44 40 (:REWRITE PERM-MEMBER-EQUAL))
       (40 40 (:REWRITE MEMBER-EQUAL-DELETE-EQUAL))
       (32 32
           (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
       (32 16 (:REWRITE DEFAULT-<-2))
       (32 16 (:REWRITE DEFAULT-<-1))
       (3 3 (:REWRITE ALL-GTE-DELETE-EQUAL-1)))
(PERM-IMPLIES-EQUAL-ALL-GTE-2 (454 51 (:REWRITE PERM-SYMMETRIC))
                              (194 194 (:REWRITE DEFAULT-CAR))
                              (155 31 (:DEFINITION DELETE-EQUAL))
                              (141 141 (:REWRITE DEFAULT-CDR))
                              (96 96
                                  (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                              (96 48 (:REWRITE DEFAULT-<-2))
                              (96 48 (:REWRITE DEFAULT-<-1))
                              (84 76 (:REWRITE PERM-MEMBER-EQUAL))
                              (76 76 (:REWRITE MEMBER-EQUAL-DELETE-EQUAL))
                              (68 51 (:REWRITE PERM-TRANSITIVE))
                              (52 4 (:REWRITE MEMBER-EQUAL-DELETE-EQUAL2))
                              (44 4 (:REWRITE COMM-DELETE-EQUAL)))
...
(GTE-CAR-FIRSTN (1 1 (:REWRITE PERM-MEMBER-EQUAL))
                (1 1 (:REWRITE MEMBER-EQUAL-DELETE-EQUAL)))
(ALL-GTE-HELPER (40 40
                    (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                ...
                (17 17 (:REWRITE ALL-GTE-DELETE-EQUAL-2)))
(ALL-ALL-GTE)
(PERM-IMPLIES-EQUAL-ALL-ALL-GTE-1
     (972 108
          (:LINEAR ALL-GTE-IMPLIES-GTE-MEMBER-EQUAL))
...
(ALL-ALL-GTE-CDR (46 46 (:REWRITE DEFAULT-CAR))
...
(ALL-GTE-APPEND-CONS (10 10
                     ...
                     (3 3 (:REWRITE DEFAULT-CAR)))
(ORDERED-APPEND (498 480 (:REWRITE DEFAULT-CDR))
                ...
                (31 31
                    (:REWRITE MEMBER-EQUAL-DELETE-EQUAL)))
(ORDERED-CONS-APPEND-CONS (18 18
                              (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(ALL-ALL-GTE-APPEND1 (193 193 (:REWRITE DEFAULT-CAR))
                     (146 146
                          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                     ...
                     (2 2
                        (:LINEAR ALL-GTE-IMPLIES-GTE-MEMBER-EQUAL)))
(ALL-ALL-GTE-APPEND2 (84 75 (:REWRITE DEFAULT-CAR))
...
(ALL-ALL-GTE-NIL (5 5 (:REWRITE DEFAULT-CAR))
                 (5 5 (:REWRITE ALL-GTE-HELPER))
                 (5 5 (:REWRITE ALL-GTE-DELETE-EQUAL-2))
                 (2 2 (:REWRITE DEFAULT-CDR)))
(ORDERED-REPEAT (28 13 (:REWRITE DEFAULT-CDR))
...
(ALL-ALL-GTE-REPEAT (72 8 (:DEFINITION ALL-GTE))
...
(ALL-ALL-GTE-REPEAT-2 (32 18 (:REWRITE DEFAULT-<-2))
...
(MAX-PAIR)
(MIN-PAIR)
(CSTEP (153 71 (:REWRITE DEFAULT-+-2))
...
(CDRAIN)
(CSORT)
(PERM-CSTEP (447 447 (:REWRITE DEFAULT-CAR))
            ...
            (20 20
                (:LINEAR ALL-GTE-IMPLIES-GTE-MEMBER-EQUAL)))
(PERM-CFEED (281 3 (:DEFINITION PERM))
...
(PERM-CDRAIN (214 6 (:DEFINITION PERM))
...
(LEN-CSTEP)
(LEN-CFEED)
(TRUE-LISTP-CSTEP (18 18 (:REWRITE DEFAULT-CDR))
                  (4 4
                     (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                  (4 4 (:REWRITE DEFAULT-CAR))
                  (4 2 (:REWRITE DEFAULT-<-2))
                  (4 2 (:REWRITE DEFAULT-<-1)))
(TRUE-LISTP-CFEED (80 80 (:REWRITE DEFAULT-CAR))
                  ...
                  (4 4
                     (:LINEAR ALL-GTE-IMPLIES-GTE-MEMBER-EQUAL)))
(TRUE-LISTP-CDRAIN (60 3 (:DEFINITION CSTEP))
...
(LEN-CDRAIN (15 3 (:DEFINITION LEN))
            (6 3 (:REWRITE DEFAULT-+-2))
            (3 3 (:REWRITE DEFAULT-CDR))
            (3 3 (:REWRITE DEFAULT-+-1))
            (2 1 (:REWRITE DEFAULT-<-1))
            (1 1 (:REWRITE DEFAULT-<-2)))
(CFEED-OPENER (578 21 (:DEFINITION CSTEP))
              ...
              (88 88
                  (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(CSTEP-APPEND1 (115 98 (:REWRITE DEFAULT-CDR))
               ...
               (18 6 (:REWRITE CAR-APPEND)))
(CSTEP-NOOP (75 73 (:REWRITE DEFAULT-CDR))
...
(PHI (132 61 (:REWRITE DEFAULT-+-2))
     ...
     (2 2 (:REWRITE MEMBER-EQUAL-DELETE-EQUAL)))
(ALL-GTE-CSTEP)
(PHI-CSTEP (183 16 (:REWRITE CSTEP-NOOP))
           ...
           (10 10
               (:REWRITE MEMBER-EQUAL-DELETE-EQUAL)))
(PHI-CONS (24 24 (:REWRITE DEFAULT-CDR))
          (20 20
              (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(PHI-CFEED (59 6 (:DEFINITION ALL-GTE))
           ...
           (2 2
              (:LINEAR ALL-GTE-IMPLIES-GTE-MEMBER-EQUAL)))
(PERM-CSORT (63 2 (:DEFINITION PERM))
...
(ORDERED-FIRSTN-CDRAIN (1996 188 (:DEFINITION TRUE-LISTP))
...
(ORDERED-CSORT (205 3 (:DEFINITION CDRAIN))
...
(POSITIVE-INFINITY-GEN (12950 550 (:REWRITE CSTEP-NOOP))
...
(POSITIVE-INFINITY (183 183 (:TYPE-PRESCRIPTION CDRAIN))
                   ...
                   (2 2 (:REWRITE CAR-CONS)))
(NEGATIVE-INFINITY-GEN (2924 367 (:DEFINITION TRUE-LISTP))
...
(NEGATIVE-INFINITY (216 2 (:DEFINITION CFEED))
