(FAST-COERCE-AUX1 (155 31 (:DEFINITION LEN))
...
(FAST-COERCE-AUX2 (70 14 (:DEFINITION LEN))
...
(LEMMA (630 315
       ...
       (2 2 (:REWRITE NATP-RW)))
(LEMMA2 (753 251 (:TYPE-PRESCRIPTION CONSP-NTHCDR))
        (480 240
             (:TYPE-PRESCRIPTION TRUE-LISTP-NTHCDR-TYPE-PRESCRIPTION))
...
(LEMMA3 (648 216 (:TYPE-PRESCRIPTION CONSP-NTHCDR))
        ...
        (5 5 (:META CANCEL_TIMES-EQUAL-CORRECT))
        (5 5 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(FAST-COERCE-AUX2-EQUIV (1414 66 (:REWRITE NTH-WITH-LARGE-INDEX))
                        ...
                        (4 4
                           (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(FAST-COERCE (40 21 (:REWRITE DEFAULT-<-1))
             (25 5 (:DEFINITION LEN))
