(SYMBOL-BTREEP (306 138 (:REWRITE DEFAULT-+-2))
...
(SYMBOL-BTREE-UPDATE (1330 630 (:REWRITE DEFAULT-+-2))
...
(SYMBOL-BTREEP-SYMBOL-BTREE-UPDATE (187 143 (:REWRITE DEFAULT-CDR))
                                   (52 52 (:REWRITE SYMBOL-<-TRANSITIVE)))
(SYMBOL-BTREE-FIND (1330 630 (:REWRITE DEFAULT-+-2))
                   (876 630 (:REWRITE DEFAULT-+-1))
                   (560 140 (:DEFINITION INTEGER-ABS))
                   (560 70 (:DEFINITION LENGTH))
                   (350 70 (:DEFINITION LEN))
...
(SYMBOL-BTREE-TO-ALIST-AUX (380 178 (:REWRITE DEFAULT-+-2))
...
(SYMBOL-BTREE-TO-ALIST (380 178 (:REWRITE DEFAULT-+-2))
                       (248 178 (:REWRITE DEFAULT-+-1))
                       (144 36 (:REWRITE COMMUTATIVITY-OF-+))
                       (144 36 (:DEFINITION INTEGER-ABS))
                       (144 18 (:DEFINITION LENGTH))
...
(SYMBOL-ALISTP-SYMBOL-BTREE-TO-ALIST (425 337 (:REWRITE DEFAULT-CAR))
                                     (346 302 (:REWRITE DEFAULT-CDR)))
(ALISTP-SYMBOL-BTREE-TO-ALIST)
(SYMBOL-BTREE-TO-ALIST (68 68 (:REWRITE DEFAULT-CDR))
                       (55 55 (:REWRITE DEFAULT-CAR)))
(SYMBOL-ALIST-SORTEDP (607 263 (:REWRITE DEFAULT-+-2))
...
(SYMBOL-BTREE-FIND-THM-CAR (197 85 (:REWRITE SYMBOL-<-TRANSITIVE))
...
(EQUAL-OF-BOOLEANS)
(SYMBOL-ALIST-SORTEDP-APPEND (132 132 (:TYPE-PRESCRIPTION LAST)))
...
(SYMBOL-ALIST-SORTEDP-AND-SYMBOL-<-FIRST-IMPLIES-NOT-ASSOC
    (969 54
         (:REWRITE SYMBOL-ALIST-SORTEDP-AND-SYMBOL-<-LAST-IMPLIES-NOT-ASSOC))
    (255 255 (:REWRITE DEFAULT-CDR))
    (131 43 (:DEFINITION LAST))
    (112 112 (:TYPE-PRESCRIPTION LAST)))
(SYMBOLP-CAAR-LAST-OF-SYMBOL-ALISTP (45 25 (:REWRITE DEFAULT-CAR))
...
(ASSOC-WHEN-NOT-SYMBOLP-KEY
   ...
   (143 8
        (:REWRITE SYMBOL-ALIST-SORTEDP-AND-SYMBOL-<-LAST-IMPLIES-NOT-ASSOC))
   (143 8
        (:REWRITE SYMBOL-ALIST-SORTEDP-AND-SYMBOL-<-FIRST-IMPLIES-NOT-ASSOC))
...
(ASSOC-IN-SYMBOL-BTREE-TO-ALIST-WHEN-SYMBOLP-KEY
     (318 318
          (:REWRITE SYMBOL-BTREE-FIND-WHEN-NOT-SYMBOLP-KEY))
     (170 170
          (:REWRITE ASSOC-WHEN-NOT-SYMBOLP-KEY))
     (136 96 (:TYPE-PRESCRIPTION BINARY-APPEND))
     (8 8 (:REWRITE SYMBOL-<-IRREFLEXIVE)))
(ASSOC-IN-SYMBOL-BTREE-TO-ALIST (96 2 (:DEFINITION SYMBOL-BTREE-FIND))
                                ...
                                (14 14 (:REWRITE SYMBOL-<-TRANSITIVE)))
(CONSP-SYMBOL-BTREE-TO-ALIST (99 99 (:REWRITE DEFAULT-CAR))
...
(NOT-SYMBOL-<-TRANSITIVE1 (13 9 (:REWRITE SYMBOL-<-TRANSITIVE)))
(NOT-SYMBOL-<-TRANSITIVE2 (12 12 (:REWRITE SYMBOL-<-TRANSITIVE)))
(SYMBOL-<-TRANSITIVE1 (2 2 (:REWRITE NOT-SYMBOL-<-TRANSITIVE2))
                      (1 1 (:REWRITE SYMBOL-<-TRICHOTOMY))
                      (1 1 (:REWRITE SYMBOL-<-TRANSITIVE)))
(SYMBOL-<-TRANSITIVE2 (2 2 (:REWRITE SYMBOL-<-TRANSITIVE1))
                      (1 1 (:REWRITE SYMBOL-<-TRICHOTOMY))
                      (1 1 (:REWRITE SYMBOL-<-TRANSITIVE))
                      (1 1 (:REWRITE NOT-SYMBOL-<-TRANSITIVE1)))
(SYMBOL-<=/<-TRANSITIVE2 (2 2 (:REWRITE SYMBOL-<-TRANSITIVE2))
                         (2 2 (:REWRITE SYMBOL-<-TRANSITIVE1))
                         (2 2 (:REWRITE NOT-SYMBOL-<-TRANSITIVE2))
                         (1 1 (:REWRITE SYMBOL-<-TRICHOTOMY))
                         (1 1 (:REWRITE SYMBOL-<-TRANSITIVE)))
(SYMBOL-</<=-TRANSITIVE1)
(SYMBOL-</<=-TRANSITIVE2 (1 1 (:REWRITE SYMBOL-<=/<-TRANSITIVE2))
                         (1 1 (:REWRITE SYMBOL-</<=-TRANSITIVE1)))
(SYMBOL-<=/<-TRANSITIVE1 (1 1 (:REWRITE SYMBOL-<=/<-TRANSITIVE2))
                         (1 1 (:REWRITE SYMBOL-</<=-TRANSITIVE2))
                         (1 1 (:REWRITE SYMBOL-</<=-TRANSITIVE1)))
(SYMBOLP-CAAR-SYMBOL-BTREE-TO-ALIST (164 90 (:REWRITE DEFAULT-CAR))
                                    (135 9 (:DEFINITION BINARY-APPEND))
                                    (64 61 (:REWRITE DEFAULT-CDR)))
(NOT-SYMBOL-<-LAST-SORTED (287 69 (:REWRITE SYMBOL-<-TRICHOTOMY))
...
(FLOOR-X-2-NATP (1 1 (:TYPE-PRESCRIPTION FLOOR-TYPE-3 . 2))
...
(FLOOR-X-2-<-X (25 25
               ...
               (1 1 (:LINEAR FLOOR-TYPE-1 . 1)))
(SYMBOL-ALIST-TO-BTREE-AUX (13 6 (:REWRITE DEFAULT-<-1))
                           ...
                           (2 2 (:REWRITE ZP-OPEN)))
(NTHCDR-CDR (9 9 (:REWRITE DEFAULT-CDR))
...
(CDR-NTHCDR (32 32 (:REWRITE DEFAULT-+-2))
...
(SYMBOL-ALIST-TO-BTREE-AUX-IS-NTHCDR (337 26 (:REWRITE NTHCDR-FUDGE))
...
(SYMBOL-ALISTP-NTHCDR (39 39 (:REWRITE DEFAULT-CAR))
...
(ALISTP-NTHCDR (13 13
               ...
               (1 1 (:REWRITE DEFAULT-<-2))
               (1 1 (:REWRITE DEFAULT-<-1)))
(LEN-NTHCDR (238 149 (:REWRITE DEFAULT-+-2))
            ...
            (11 11
                (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
            (4 4 (:REWRITE EQUAL-CONSTANT-+)))
(SYMBOL-ALIST-SORTEDP-NTHCDR (148 52 (:REWRITE DEFAULT-CAR))
                             (68 68
                                 (:TYPE-PRESCRIPTION |x < y  =>  0 < y-x|))
...
(CONSP-NTHCDR-WHEN-ALISTP (10 10 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(CONSP-CAR-NTHCDR-WHEN-ALISTP (211 27 (:REWRITE DEFAULT-CAR))
                              ...
                              (10 10 (:REWRITE DEFAULT-<-2))
                              (10 10 (:REWRITE DEFAULT-<-1)))
(SYMBOL-ALIST-TO-BTREE-AUX (67 11 (:REWRITE ZP-OPEN))
                           ...
                           (8 2
                              (:REWRITE CONSP-CAR-NTHCDR-WHEN-ALISTP))
                           (4 2 (:REWRITE DEFAULT-UNARY-MINUS)))
(SYMBOLP-CAR-NTH-OF-SYMBOL-ALIST (26 26 (:REWRITE DEFAULT-CAR))
                                 (5 5 (:REWRITE ZP-OPEN))
                                 (4 4 (:REWRITE DEFAULT-CDR))
                                 (2 2 (:REWRITE DEFAULT-+-2))
                                 (2 2 (:REWRITE DEFAULT-+-1)))
(CONSP-NTH-OF-SYMBOL-ALIST (32 32 (:REWRITE DEFAULT-CAR))
...
(TAKE-APPEND (407 25 (:REWRITE TAKE-OF-LEN-FREE))
...
(SYMBOL-BTREE-TO-ALIST-OF-SYMBOL-ALIST-TO-BTREE-AUX
     ...
     (84 6
         (:REWRITE CONSP-SYMBOL-BTREE-TO-ALIST))
     ...
     (12 6
         (:REWRITE SYMBOL-BTREEP-SYMBOL-ALIST-TO-BTREE-AUX))
     (12 6 (:REWRITE CONSP-NTH-SYMBOL-ALIST))
     (2 2 (:REWRITE <-+-NEGATIVE-0-2)))
(LEN-EVENS-< (42 22 (:REWRITE DEFAULT-+-2))
...
(MERGE-SORT-SYMBOL-ALIST-< (38 19 (:REWRITE DEFAULT-+-2))
                           ...
                           (4 2 (:REWRITE DEFAULT-<-2))
                           (4 2 (:REWRITE DEFAULT-<-1)))
(SYMBOL-ALISTP-MERGE-SYMBOL-ALIST-< (129 115 (:REWRITE DEFAULT-CDR))
                                    (38 38 (:REWRITE SYMBOL-<-TRICHOTOMY))
                                    (38 38 (:REWRITE SYMBOL-<-ASYMMETRIC)))
(SYMBOL-ALISTP-EVENS (51 45 (:REWRITE DEFAULT-CAR))
...
(SYMBOL-BTREEP-REBALANCE
     ...
     (268 2
          (:REWRITE SYMBOL-ALIST-TO-BTREE-AUX-IS-NTHCDR))
...
(SYMBOL-BTREE-FIND-REBALANCE
    ...
    (2 2
       (:REWRITE SYMBOL-ALISTP-SYMBOL-BTREE-TO-ALIST))
    (2 2 (:REWRITE ASSOC-WHEN-NOT-SYMBOLP-KEY))
    (1 1
       (:REWRITE SYMBOLP-CAAR-SYMBOL-BTREE-TO-ALIST))
    (1 1
       (:REWRITE ASSOC-IN-SYMBOL-BTREE-TO-ALIST-WHEN-SYMBOLP-KEY)))
(SYMBOL-BTREE-KEY-DEPTH (1330 630 (:REWRITE DEFAULT-+-2))
                        (876 630 (:REWRITE DEFAULT-+-1))
                        (560 140 (:DEFINITION INTEGER-ABS))
                        (560 70 (:DEFINITION LENGTH))
                        (350 70 (:DEFINITION LEN))
...
(SYMBOL-BTREE-FIND/DEPTH-AUX (1330 630 (:REWRITE DEFAULT-+-2))
                             (876 630 (:REWRITE DEFAULT-+-1))
                             (560 140 (:DEFINITION INTEGER-ABS))
                             (560 70 (:DEFINITION LENGTH))
                             (350 70 (:DEFINITION LEN))
...
(SYMBOL-BTREE-FIND/DEPTH-AUX-REDEF
     ...
     (98 98
         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (90 90
         (:TYPE-PRESCRIPTION SYMBOL-BTREE-KEY-DEPTH))
     (52 52
         (:REWRITE SYMBOL-BTREE-FIND-WHEN-NOT-SYMBOLP-KEY)))
...
(SYMBOL-BTREE-FIND/DEPTH-REDEF
     ...
     (204 204
          (:REWRITE SYMBOL-BTREE-FIND-WHEN-NOT-SYMBOLP-KEY)))
(SYMBOL-BTREE-UPDATE/DEPTH (1456 701 (:REWRITE DEFAULT-+-2))
