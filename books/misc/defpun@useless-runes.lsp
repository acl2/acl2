...
(DEFPUN-F)
(DEFPUN-TEST-FCH (4 1 (:REWRITE ZP-OPEN))
                 (1 1 (:REWRITE DEFAULT-<-2))
                 (1 1 (:REWRITE DEFAULT-<-1))
                 (1 1 (:REWRITE DEFAULT-+-2))
                 (1 1 (:REWRITE DEFAULT-+-1)))
(DEFPUN-TEST-DEFPUN-F-DEF (7 1 (:DEFINITION DEFPUN-STN))
                          (2 2 (:REWRITE DEFAULT-<-2))
                          (2 2 (:REWRITE DEFAULT-<-1))
                          (1 1 (:REWRITE DEFAULT-+-2))
                          (1 1 (:REWRITE DEFAULT-+-1)))
(OPEN-DEFPUN-STN (8 2 (:REWRITE ZP-OPEN))
...
(|+1-1| (3 3
        ...
        (2 2 (:REWRITE DEFAULT-+-1)))
(DEFPUN-ST-DEFPUN-STN-FCH (16 4 (:REWRITE ZP-OPEN))
                          (6 6 (:REWRITE DEFAULT-<-2))
                          (6 6 (:REWRITE DEFAULT-<-1))
                          (5 5 (:REWRITE DEFAULT-+-2))
                          (5 5 (:REWRITE DEFAULT-+-1))
                          (3 3 (:REWRITE DEFPUN-TEST-FCH)))
(DEFPUN-TEST-NIL-FCH (12 10 (:REWRITE DEFAULT-+-2))
                     ...
                     (2 2
                        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(DEFPUN-FN-DEFPUN-ST (28 28 (:REWRITE ZP-OPEN))
                     (8 8 (:REWRITE DEFAULT-+-2))
                     (8 8 (:REWRITE DEFAULT-+-1)))
(GENERIC-TAIL-RECURSIVE-DEFPUN-F (25 25 (:REWRITE DEFAULT-+-2))
