(RCDP1 (5 5 (:REWRITE DEFAULT-CAR))
       (3 3 (:REWRITE DEFAULT-CDR)))
(RCDP (2024 553 (:REWRITE <<-TRICHOTOMY))
      (1748 320 (:REWRITE <<-ASYMMETRIC))
      (506 506 (:REWRITE DEFAULT-CAR))
      (320 320 (:REWRITE DEFAULT-CDR))
      (9 9 (:REWRITE <<-IRREFLEXIVE)))
(IFRP (45 23 (:REWRITE DEFAULT-+-2))
...
(RCD->ACL2 (1 1 (:REWRITE DEFAULT-CAR)))
(G-AUX (58 28 (:REWRITE DEFAULT-+-2))
...
(S-AUX (58 28 (:REWRITE DEFAULT-+-2))
       ...
       (3 3 (:REWRITE DEFAULT-COERCE-2))
       (3 3 (:REWRITE DEFAULT-COERCE-1)))
(S-AUX-IS-BOUNDED (132 132 (:REWRITE DEFAULT-CAR))
                  (46 46 (:REWRITE DEFAULT-CDR)))
(S-AUX-PRESERVES-RCDP (233 233 (:REWRITE DEFAULT-CAR))
                      (218 168 (:REWRITE <<-TRANSITIVE))
                      (114 114 (:REWRITE DEFAULT-CDR)))
(S (486 86 (:REWRITE <<-ASYMMETRIC))
...
(RCD->ACL2-OF-RECORD-NON-NIL (43 1 (:DEFINITION IFRP))
                             ...
                             (10 10 (:REWRITE <<-TRANSITIVE)))
(G-SAME-S (77 2 (:DEFINITION S-AUX))
...
(G-DIFF-S (150 5 (:REWRITE G-AUX-IS-NIL-FOR-<<))
          ...
          (1 1
             (:REWRITE S-AUX-NON-NIL-CANNOT-BE-NIL)))
(G-OF-S-REDUX (361 10 (:REWRITE G-AUX-IS-NIL-FOR-<<))
              ...
              (3 3
                 (:REWRITE S-AUX-NON-NIL-CANNOT-BE-NIL)))
(S-SAME-G (67 1 (:DEFINITION G-AUX))
          ...
          (5 5 (:REWRITE DEFAULT-CDR)))
(S-SAME-S (108 3 (:DEFINITION S-AUX))
...
(S-DIFF-S (208 5 (:DEFINITION S-AUX))
...
(S-NON-NIL-CANNOT-BE-NIL (70 2 (:DEFINITION S-AUX))
                         (38 10 (:REWRITE <<-TRICHOTOMY))
                         (34 6 (:REWRITE <<-ASYMMETRIC))
...
(NON-NIL-IF-G-NON-NIL (13 1 (:REWRITE G-AUX-IS-NIL-FOR-<<))
                      ...
                      (2 1 (:REWRITE <<-ASYMMETRIC))
                      (1 1 (:TYPE-PRESCRIPTION RCDP)))
(RECORD-UPDATE-MACRO (190 89 (:REWRITE DEFAULT-+-2))
