(FAST-ALPHORDER (38 10 (:REWRITE SYMBOL-<-TRICHOTOMY))
...
(FAST-LEXORDER)
(FAST-LEXORDER-IS-LEXORDER (114 30 (:REWRITE SYMBOL-<-TRICHOTOMY))
...
(<<-IMPLIES-LEXORDER)
(L0 (6 6 (:REWRITE DEFAULT-CHAR-CODE)))
(FAST-<<-IS-<< (1669 272 (:REWRITE <<-IMPLIES-LEXORDER))
