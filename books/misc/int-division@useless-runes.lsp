...
(INTEGER-QUOTIENT-SPEC-0-B
     (1 1
        (:TYPE-PRESCRIPTION INTEGER-QUOTIENT-ARG-1-TYPE)))
(INTEGER-QUOTIENT-SPEC-A-A (6 4 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
                           (2 2 (:REWRITE NUMERATOR-WHEN-INTEGERP))
                           (2 2 (:REWRITE DEFAULT-UNARY-/))
...
(INEQUALITY-LEMMA-1)
(INEQUALITY-LEMMA-2)
(INEQUALITY-LEMMA-3 (24 20 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
...
(INTEGER-QUOTIENT-COMMUTES-WITH-UNARY-MINUS-2
     ...
     (1 1
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(IND-INT-ABS (4 4 (:REWRITE DEFAULT-<-2))
             (4 4 (:REWRITE DEFAULT-<-1))
             (2 2
                (:TYPE-PRESCRIPTION INTEGER-QUOTIENT-ARG-2-TYPE))
             (2 2
...
(INTEGER-QUOTIENT-COMMUTES-WITH-*
     ...
     (161 4
          (:REWRITE INTEGER-QUOTIENT-COMMUTES-WITH-+))
...
(INTEGER-QUOTIENT-*-CANCELLATION
     ...
     (2 2 (:REWRITE DEFAULT-*-2))
     (2 2 (:REWRITE DEFAULT-*-1)))
(CRAP001 (10 6 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
...
(INTEGER-QUOTIENT-FACTORIZATION (38 22 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
...
(DIVIDES-SPEC-0-B)
(DIVIDES-SPEC-A-1)
(DIVIDES-SPEC-1-B (1 1
                     (:TYPE-PRESCRIPTION INTEGER-QUOTIENT-ARG-2-TYPE))
                  (1 1
                     (:TYPE-PRESCRIPTION INTEGER-QUOTIENT-ARG-1-TYPE))
                  (1 1 (:REWRITE DEFAULT-*-2))
                  (1 1 (:REWRITE DEFAULT-*-1)))
(DIVIDE-SUM (76 48 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
...
(DIVIDE-FACTOR (8 8
               ...
               (2 2 (:REWRITE DEFAULT-*-2))
               (2 2 (:REWRITE DEFAULT-*-1)))
(DIVIDES-REFLEXIVITY (2 2 (:REWRITE DEFAULT-*-2))
                     (2 2 (:REWRITE DEFAULT-*-1))
                     (1 1
                        (:TYPE-PRESCRIPTION INTEGER-QUOTIENT-ARG-2-TYPE))
                     (1 1
...
(DIVIDE-PRODUCT (60 36 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
                ...
                (1 1 (:REWRITE DIVIDE-FACTOR)))
(DIVIDE-FACTORIZATION (3 3
                         (:TYPE-PRESCRIPTION INTEGER-QUOTIENT-ARG-2-TYPE))
                      (3 3
                         (:TYPE-PRESCRIPTION INTEGER-QUOTIENT-ARG-1-TYPE)))
(INEQUALITY-LEMMA-4 (10 10
                        (:TYPE-PRESCRIPTION INTEGER-QUOTIENT-ARG-2-TYPE))
                    (10 10
                        (:TYPE-PRESCRIPTION INTEGER-QUOTIENT-ARG-1-TYPE))
                    (5 5 (:REWRITE DEFAULT-<-2))
                    ...
                    (1 1 (:REWRITE DEFAULT-*-2))
                    (1 1 (:REWRITE DEFAULT-*-1)))
(DIVIDER-< (9 9 (:REWRITE DEFAULT-<-2))
           (9 9 (:REWRITE DEFAULT-<-1))
           (2 2 (:REWRITE DEFAULT-*-2))
           (2 2 (:REWRITE DEFAULT-*-1)))
(DIVIDE-TRANSITIVITY (84 50 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
                     (41 41 (:REWRITE DEFAULT-*-2))
                     ...
                     (2 2 (:REWRITE DEFAULT-<-2))
                     (2 2 (:REWRITE DEFAULT-<-1)))
(EQUALITY-FROM-DIVISION (230 34 (:LINEAR X*Y>1-POSITIVE))
                        ...
                        (1 1 (:REWRITE CRAP003)))
(DIVIDE-LINEAR-COMBINATION (52 32 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
