...
(FORMAL-CONSP)
(FORMAL-TRUE-LISTP (176 85 (:REWRITE DEFAULT-+-2))
...
(FORMAL-NTH (243 238 (:REWRITE DEFAULT-CDR))
...
(REDUCE-NTH-META (156 152 (:REWRITE DEFAULT-CDR))
...
(FORMAL-TRUE-LISTP-IMPLIES-TRUE-LISTP-META-EV
     ...
     (396 34 (:DEFINITION LENGTH))
     (334 57 (:DEFINITION LEN))
...
(REDUCE-NTH-META-CORRECT-LEMMA
     ...
     (636 619 (:REWRITE DEFAULT-CAR))
     (554 102 (:DEFINITION LEN))
     (298 188 (:REWRITE DEFAULT-+-2))
...
(REDUCE-NTH-META-CORRECT (156 154 (:REWRITE DEFAULT-CDR))
                         (108 2 (:DEFINITION FORMAL-NTH))
...
(FORMAL-MEMBER (1 1 (:REWRITE DEFAULT-CDR))
               (1 1 (:REWRITE DEFAULT-CAR)))
(EXPAND-MEMBER-META (8 8 (:REWRITE DEFAULT-CDR))
                    (3 3
                       (:REWRITE TERM-LISTP-IMPLIES-PSEUDO-TERM-LISTP))
                    (3 3 (:REWRITE DEFAULT-CAR))
                    (2 2 (:REWRITE TERMP-IMPLIES-PSEUDO-TERMP))
                    (1 1
                       (:TYPE-PRESCRIPTION EXPAND-MEMBER-META)))
