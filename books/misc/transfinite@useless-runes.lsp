(O-FIX (1 1 (:TYPE-PRESCRIPTION O-FIX)))
...
(TRANSFINITE-INDUCTION-SCHEME (278 278 (:REWRITE DEFAULT-CAR))
                              (117 117 (:REWRITE DEFAULT-CDR))
                              (80 50 (:REWRITE DEFAULT-<-1))
                              (78 50 (:REWRITE DEFAULT-<-2))
                              (57 56
                                  (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(PRED-FOR-ALL-ORDINALS (510 10 (:DEFINITION O<))
...
(FOO-FOR-ALL-ORDINALS
     ...
     (1 1
        (:REWRITE FOO-FOR-ALL-ORDINALS-SMALLER-THAN-NECC)))
