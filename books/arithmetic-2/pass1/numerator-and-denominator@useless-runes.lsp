(NUMERATOR-MINUS (31 1 (:DEFINITION NONNEG-INT-GCD))
...
(DENOMINATOR-MINUS (31 1 (:DEFINITION NONNEG-INT-GCD))
                   (23 1 (:DEFINITION NONNEG-INT-MOD))
...
(NUMERATOR-INTEGERP-LEMMA (8 8 (:REWRITE DEFAULT-*-2))
                          ...
                          (2 2 (:REWRITE DEFAULT-UNARY-/)))
(NUMERATOR-WHEN-INTEGERP (101 3 (:REWRITE UNIQUE-RATIONALP))
                         (64 2
...
(EQUAL-DENOMINATOR-1 (4 4 (:REWRITE INTEGERP==>DENOMINATOR=1))
                     ...
                     (1 1 (:REWRITE DEFAULT-*-2))
                     (1 1 (:REWRITE DEFAULT-*-1)))
(*-R-DENOMINATOR-R (8 7 (:REWRITE DEFAULT-*-2))
