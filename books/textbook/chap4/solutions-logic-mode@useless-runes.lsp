...
(FROM-END (3 1 (:DEFINITION REVAPPEND))
...
(MEM)
(NO-DUPLS-P)
(GET-KEYS (2 2 (:REWRITE DEFAULT-CAR))
          (1 1 (:REWRITE DEFAULT-CDR)))
(DEL)
(PERM (27 27 (:REWRITE DEFAULT-CAR))
      (24 24 (:REWRITE DEFAULT-CDR)))
(UPDATE-ALIST-REC (2 2 (:REWRITE DEFAULT-CAR))
                  (1 1 (:REWRITE DEFAULT-CDR)))
(NEXT-K-ITER-LIST)
(NEXT-K-ITER)
(NEXT-K-MAX-ITERATIONS)
(SUM-BASE-10-DIGITS (175 10 (:REWRITE NIQ-TYPE . 3))
...
(FACT-TAILREC)
(FACT1)
(GET-KEYS-TAIL-REC (4 2 (:DEFINITION TRUE-LISTP))
...
(SPLIT-LIST)
(MERGE2 (48 23 (:REWRITE DEFAULT-+-2))
...
(RATIONAL-LISTP-MV-NTH-SPLIT-LIST (53 40 (:REWRITE DEFAULT-CAR))
                                  (48 35 (:REWRITE DEFAULT-CDR)))
(LEN-MV-NTH-SPLIT-LIST (69 50 (:REWRITE DEFAULT-CDR))
                       (55 29 (:REWRITE DEFAULT-+-2))
                       (53 34 (:REWRITE DEFAULT-CAR))
                       (29 29 (:REWRITE DEFAULT-+-1))
                       (27 14 (:REWRITE DEFAULT-<-2))
                       (26 14 (:REWRITE DEFAULT-<-1)))
(MERGESORT (42 42 (:REWRITE DEFAULT-CDR))
           (42 21 (:REWRITE DEFAULT-+-2))
           (21 21 (:REWRITE DEFAULT-+-1))
           (14 14 (:REWRITE DEFAULT-CAR))
           (8 4 (:REWRITE DEFAULT-<-2))
           (8 4 (:REWRITE DEFAULT-<-1)))
(RATIONAL-LISTP-MERGESORT (497 493 (:REWRITE DEFAULT-CAR))
...
(MERGESORT)
(ACL2-BASIC-TERMP)
(ACL2-SUB (3 3 (:REWRITE DEFAULT-CAR))
          (2 2 (:REWRITE DEFAULT-CDR)))
(ACL2-GOOD-TERMP)
(SAFE-TIMES)
(SAFE-PLUS)
