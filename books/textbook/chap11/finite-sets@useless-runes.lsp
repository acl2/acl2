...
(EXAMPLE-54)
(INDUCT-HINT1 (258 124 (:REWRITE DEFAULT-+-2))
...
(CONS-PRESERVES-SUBSET (28 28 (:REWRITE DEFAULT-CDR))
                       (28 28 (:REWRITE DEFAULT-CAR)))
(SUBSET-REFLEXIVE (24 24 (:REWRITE DEFAULT-CAR))
                  (22 22 (:REWRITE DEFAULT-CDR)))
(ACL2-COUNT-CONS (24 12 (:REWRITE DEFAULT-+-2))
                 (16 12 (:REWRITE DEFAULT-+-1))
                 (6 6 (:REWRITE FOLD-CONSTS-IN-+))
                 (4 4 (:REWRITE DEFAULT-CDR))
                 (4 4 (:REWRITE DEFAULT-CAR)))
(IND-2 (5544 2539 (:REWRITE DEFAULT-+-2))
...
(SUBSET-TRANSITIVE (682 682 (:REWRITE DEFAULT-CAR)))
(==-IS-AN-EQUIVALENCE (40 7 (:DEFINITION =<))
