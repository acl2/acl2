(COMPRESS (66 28 (:REWRITE DEFAULT-+-2))
...
(CAR-COMPRESS (60 50 (:REWRITE DEFAULT-CAR))
              (42 42 (:REWRITE DEFAULT-CDR)))
(COMPRESS-COMPRESS (80 59 (:REWRITE DEFAULT-CDR))
                   (50 48 (:REWRITE DEFAULT-CAR)))
(CAR-APPEND (69 69 (:TYPE-PRESCRIPTION BINARY-APPEND))
            (45 15 (:REWRITE DEFAULT-CAR))
            (5 5 (:REWRITE DEFAULT-CDR)))
(CONSP-COMPRESS (10 10 (:REWRITE DEFAULT-CDR))
                (6 6 (:REWRITE DEFAULT-CAR)))
(COMPRESS-APPEND-COMPRESS (925 925 (:TYPE-PRESCRIPTION BINARY-APPEND))
...
(MEM-COMPRESS (70 62 (:REWRITE DEFAULT-CAR))
              (69 58 (:REWRITE DEFAULT-CDR)))
(NUMBER-LISTP)
(NO-DUPLS-P-COMPRESS (209 209
                          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                     (4 4 (:REWRITE CONSP-COMPRESS)))
(SAME-COMPRESS (10 10 (:TYPE-PRESCRIPTION COMPRESS)))
(SAME-COMPRESS-IS-AN-EQUIVALENCE (6 6 (:TYPE-PRESCRIPTION COMPRESS)))
(EQUAL-COMPRESSES-FORWARD-TO-EQUAL-CARS (15 13 (:REWRITE DEFAULT-CAR))
...
(COMPRESS-APPEND-TO-SINGLETON (323 21 (:REWRITE APPEND-TO-NIL))
                              (211 23 (:DEFINITION TRUE-LISTP))
                              (184 146 (:REWRITE DEFAULT-CAR))
                              (97 97 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(CAR-LAST-REV (978 325 (:REWRITE DEFAULT-CDR))
              (278 57 (:REWRITE CAR-APPEND)))
(TRUE-LISTP-REV (13 3 (:DEFINITION BINARY-APPEND))
                (12 3 (:DEFINITION TRUE-LISTP))
                (8 8 (:REWRITE DEFAULT-CDR))
                (6 6 (:REWRITE DEFAULT-CAR)))
(TRUE-LISTP-COMPRESS (45 38 (:REWRITE DEFAULT-CDR))
                     (18 18 (:REWRITE DEFAULT-CAR)))
(REV-COMPRESS (299 257 (:REWRITE DEFAULT-CDR))
