(HOW-MANY)
(SPLIT (153 71 (:REWRITE DEFAULT-+-2))
...
(MERGELIST (192 89 (:REWRITE DEFAULT-+-2))
...
(MEASURE-FOR-MERGESORT (2448 1180 (:REWRITE DEFAULT-+-2))
...
(MV-NTH-CADR)
(MERGESORT (134 4 (:DEFINITION ACL2-COUNT))
...
(HOW-MANY-MERGELIST (202 102 (:REWRITE DEFAULT-+-2))
...
(BETA)
(HOW-MANY-ALPHA-BETA)
(PERM-IMPLIES-PERM-CONS-2 (9 9 (:REWRITE DEFAULT-CAR))
...
(RMV)
(APPEND-REP-RMV (529 334 (:REWRITE DEFAULT-CAR))
...
(SUBSETP-APPEND-2 (191 140 (:REWRITE DEFAULT-CAR))
                  (170 85
                       (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
...
(HINT)
(HOW-MANY-RMV (80 77 (:REWRITE DEFAULT-CDR))
              (71 68 (:REWRITE DEFAULT-CAR))
              (50 25 (:REWRITE DEFAULT-+-2))
              (25 25 (:REWRITE DEFAULT-+-1)))
(BOUNDED-QUANTIFIERP-RMV (88 88 (:REWRITE DEFAULT-CDR))
                         (86 86 (:REWRITE DEFAULT-CAR))
                         (80 16 (:DEFINITION RMV))
                         (52 26 (:REWRITE DEFAULT-+-2))
                         (26 26 (:REWRITE DEFAULT-+-1)))
(FUNDAMENTAL (196 14 (:DEFINITION REP))
...
(SUBSETP-RMV-CDR (73 72 (:REWRITE DEFAULT-CAR))
                 (58 57 (:REWRITE DEFAULT-CDR)))
(RESTRICT-SUBSETP (21 21 (:REWRITE DEFAULT-CAR))
...
(BOUNDED-QUANTIFIERP-ALPHA-BETA (42 6 (:DEFINITION HOW-MANY))
                                (14 14 (:REWRITE DEFAULT-CDR))
                                (12 12 (:REWRITE DEFAULT-CAR))
                                (12 6 (:REWRITE DEFAULT-+-2))
                                (6 6 (:REWRITE DEFAULT-+-1)))
(PERM-ALPHA-BETA (7 7 (:REWRITE DEFAULT-CAR))
                 (6 6 (:REWRITE DEFAULT-CDR))
