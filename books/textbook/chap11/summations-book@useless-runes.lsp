...
(SUM1-THM (67 35 (:REWRITE DEFAULT-+-2))
...
(SUM2 (1 1
         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(SUM2-THM (208 63 (:REWRITE DEFAULT-+-2))
...
(SUM3 (1 1
         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(SUM3-THM (909 179 (:REWRITE DEFAULT-+-2))
...
(SUM4 (1 1
         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(SUM4-THM (696 166 (:REWRITE DEFAULT-+-2))
...
(SUM5 (1 1
         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(SUM5-THM (3445 474 (:REWRITE DEFAULT-+-2))
...
(SUM6 (1 1
         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(ABSORB-1 (16 2 (:LINEAR X*Y>1-POSITIVE))
...
(SUM6-THM-AUX (68 68
              ...
              (1 1 (:REWRITE NUMERATOR-WHEN-INTEGERP)))
(SUM6-THM (561 82 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
          (329 329
               (:TYPE-PRESCRIPTION NONNEGATIVE-PRODUCT))
...
(SUM7)
(SUM7-THM (85 44 (:REWRITE DEFAULT-+-2))
          ...
          (1 1
             (:TYPE-PRESCRIPTION |x < y  =>  0 < y-x|)))
(SUM8-THM (127 72 (:REWRITE DEFAULT-*-2))
