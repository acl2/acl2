...
(COMMUTATIVITY-OF---*-LEFT (6 4 (:REWRITE DEFAULT-*-2))
                           (6 4 (:REWRITE DEFAULT-*-1))
                           (5 5
                              (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                           (4 3 (:REWRITE DEFAULT-UNARY-MINUS)))
(SUM1-THM (59 35 (:REWRITE DEFAULT-+-2))
...
(SUM2)
(SUM2-THM (171 65 (:REWRITE DEFAULT-+-2))
...
(SUM3)
(SUM3-THM (586 184 (:REWRITE DEFAULT-+-2))
...
(RIGHT-UNICITY-OF-1-FOR-EXPT
     ...
     (5 3 (:REWRITE DEFAULT-*-1)))
(SUM4-THM (485 171 (:REWRITE DEFAULT-+-2))
          ...
          (4 4 (:REWRITE DEFAULT-<-1)))
(SUM5)
(SUM5-THM (2250 504 (:REWRITE DEFAULT-+-2))
          ...
          (4 4 (:REWRITE DEFAULT-<-1)))
(SUM6)
(ABSORB-1 (7 6 (:REWRITE DEFAULT-*-2))
...
(COMBINE-NUMERATOR (9 7 (:REWRITE DEFAULT-*-2))
...
(SIMPLIFY-FRACTIONS-* (9 7 (:REWRITE DEFAULT-UNARY-MINUS))
                      ...
                      (1 1 (:REWRITE DEFAULT-<-2))
                      (1 1 (:REWRITE DEFAULT-<-1)))
(SIMPLIFY-FRACTIONS-+ (6 5 (:REWRITE DEFAULT-UNARY-MINUS))
                      ...
                      (1 1 (:REWRITE FOLD-CONSTS-IN-*)))
(RIGHT-CANCELLATION-FOR-* (23 16 (:REWRITE DEFAULT-*-1))
                          (21 21
                              (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
                          (19 16 (:REWRITE DEFAULT-*-2))
                          (7 4 (:REWRITE DEFAULT-UNARY-/))
                          (2 2 (:REWRITE FOLD-CONSTS-IN-*)))
(EQUAL-/ (5 4 (:REWRITE DEFAULT-*-2))
         (5 4 (:REWRITE DEFAULT-*-1))
         (3 3
            (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
         (2 2 (:REWRITE DEFAULT-UNARY-/)))
(SUM6-THM-AUX (16 14 (:REWRITE DEFAULT-*-1))
              ...
              (1 1 (:REWRITE DEFAULT-<-2))
              (1 1 (:REWRITE DEFAULT-<-1)))
(SUM6-THM (42 35 (:REWRITE DEFAULT-+-2))
          ...
          (5 5 (:REWRITE DEFAULT-<-1)))
(SUM7)
(SUM7-THM (72 44 (:REWRITE DEFAULT-+-2))
          ...
          (4 4 (:REWRITE DEFAULT-<-2))
          (4 4 (:REWRITE DEFAULT-<-1)))
(SUM8-THM (78 35 (:REWRITE DEFAULT-+-2))
