(W-LARGER-THAN-NATS (1 1 (:REWRITE DEFAULT-<-2))
                    (1 1 (:REWRITE DEFAULT-<-1)))
(W-SMALLER-THAN-NON-NATS (72 72 (:REWRITE DEFAULT-CAR))
                         (43 43 (:REWRITE DEFAULT-CDR))
                         (31 29 (:REWRITE DEFAULT-<-2))
                         (29 29 (:REWRITE DEFAULT-<-1))
                         (2 2
                            (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(E0-CONS-POS (5 5 (:REWRITE DEFAULT-<-2))
             (5 5 (:REWRITE DEFAULT-<-1))
             (2 2 (:REWRITE DEFAULT-CDR))
             (2 2 (:REWRITE DEFAULT-CAR)))
(E0-CONS (3 3 (:REWRITE DEFAULT-<-2))
         (3 3 (:REWRITE DEFAULT-<-1))
         (1 1 (:REWRITE DEFAULT-+-2))
         (1 1 (:REWRITE DEFAULT-+-1)))
(E0-<-NATS (10 10 (:REWRITE DEFAULT-<-2))
           (10 10 (:REWRITE DEFAULT-<-1))
           (6 6 (:REWRITE DEFAULT-+-2))
           (6 6 (:REWRITE DEFAULT-+-1))
           (4 4 (:REWRITE DEFAULT-CAR))
           (2 2 (:REWRITE DEFAULT-CDR)))
(DEC (17 9 (:REWRITE DEFAULT-+-2))
...
(DEC-DECREASES (122 65 (:REWRITE DEFAULT-CAR))
...
(TRUE-LISTP-APPEND-REWRITE (133 133 (:TYPE-PRESCRIPTION BINARY-APPEND))
                           (18 15 (:REWRITE DEFAULT-CDR))
                           (3 3 (:REWRITE DEFAULT-CAR)))
(APPEND-RIGHT-ID (2 1 (:DEFINITION TRUE-LISTP))
                 (1 1 (:REWRITE DEFAULT-CDR)))
(PREFIX (82 36 (:REWRITE DEFAULT-+-2))
...
(LEN-NON-0 (7 4 (:REWRITE DEFAULT-+-2))
           (4 4 (:REWRITE DEFAULT-+-1))
           (3 3 (:REWRITE DEFAULT-CDR)))
(TRUE-LISTP-LAST)
(LEN-LAST (30 15 (:REWRITE DEFAULT-+-2))
          (15 15 (:REWRITE DEFAULT-+-1)))
(PREFIX-LAST-ELIM (44 25 (:REWRITE DEFAULT-CDR))
                  (32 13 (:REWRITE DEFAULT-CAR)))
(NATP-CAR-LAST (22 11 (:REWRITE DEFAULT-+-2))
               ...
               (4 1
                  (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(ACL2-COUNT-PREFIX (227 105 (:REWRITE DEFAULT-+-2))
                   (166 83
                        (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
...
(EQUAL-LEX-0 (59 58 (:REWRITE DEFAULT-CDR))
             ...
             (3 3
                (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(LEN-APPEND (95 14 (:LINEAR LEN-NON-0))
            (74 37
                (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
...
(NATSP-PREFIX (182 91
              ...
              (8 4 (:DEFINITION TRUE-LISTP))
              (5 5 (:REWRITE DEFAULT-+-1)))
(NATSP-APPEND (94 73 (:REWRITE DEFAULT-CAR))
              (54 27
                  (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
...
(LEN-PREFIX (88 44
            ...
            (3 3 (:REWRITE DEFAULT-CAR)))
(E0-ORDINALP-LEX (62 54 (:REWRITE DEFAULT-CAR))
...
(LEX-< (74 36 (:REWRITE DEFAULT-+-2))
       ...
       (2 2
          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(EQUAL-APPEND (363 363 (:TYPE-PRESCRIPTION BINARY-APPEND))
              (20 14 (:REWRITE DEFAULT-CDR))
              (18 12 (:REWRITE DEFAULT-CAR)))
(LEX-EQUAL-HINT (129 58 (:REWRITE DEFAULT-+-2))
                (83 58 (:REWRITE DEFAULT-+-1))
                ...
                (4 4 (:REWRITE DEFAULT-COERCE-2))
                (4 4 (:REWRITE DEFAULT-COERCE-1)))
(LEX-EQUAL (1464 1416 (:REWRITE DEFAULT-CDR))
           ...
           (2 2
              (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(LEX-<-ALTERNATIVE-DEF (740 370 (:TYPE-PRESCRIPTION NATP-CAR-LAST))
...
(EQUAL-0-LEN (2 1 (:REWRITE DEFAULT-+-2))
             (1 1 (:REWRITE DEFAULT-CDR))
             (1 1 (:REWRITE DEFAULT-+-1))
...
(EQUAL-1-+-1 (2 2
             ...
             (1 1 (:REWRITE DEFAULT-+-1)))
(LEX-IS-ORDER-PRESERVING (2897 2715 (:REWRITE DEFAULT-CDR))
...
(G (11 10 (:REWRITE DEFAULT-+-2))
   ...
   (1 1 (:REWRITE FOLD-CONSTS-IN-+)))
(G-EXAMPLES)
(MLEN (1250 597 (:REWRITE DEFAULT-+-2))
...
(F7)
(F7-CONSTRAINT)
(F7-IS-UNIQUE (6 3 (:REWRITE ZP-OPEN))
              (3 3 (:REWRITE DEFAULT-+-2))
              (3 3 (:REWRITE DEFAULT-+-1))
              ...
              (1 1 (:REWRITE DEFAULT-<-1)))
(F8)
(F8-CONSTRAINT (3 3 (:REWRITE DEFAULT-<-2))
               (3 3 (:REWRITE DEFAULT-<-1))
               (2 2 (:REWRITE DEFAULT-+-2))
               (2 2 (:REWRITE DEFAULT-+-1))
               (1 1 (:REWRITE ZP-OPEN)))
(F8-IS-UNIQUE (7 6 (:REWRITE DEFAULT-+-2))
              (6 6 (:REWRITE DEFAULT-+-1))
              (6 3 (:REWRITE ZP-OPEN))
...
(F10)
(F10-CONSTRAINT)
(F10-INDUCTION (20 12 (:REWRITE DEFAULT-+-2))
               ...
               (1 1 (:REWRITE DEFAULT-CAR)))
(TIMES-ZERO)
(F10-IS-UNIQUE (16 4 (:REWRITE FOLD-CONSTS-IN-+))
               (15 15 (:REWRITE DEFAULT-+-2))
               (15 15 (:REWRITE DEFAULT-+-1))
               (14 9 (:REWRITE DEFAULT-*-1))
