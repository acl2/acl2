(CADN-FN)
(TYPE-CASE-KEYWORD-ALISTP (938 448 (:REWRITE DEFAULT-+-2))
                          (609 448 (:REWRITE DEFAULT-+-1))
...
(TYPE-CASE-TYPE (190 89 (:REWRITE DEFAULT-+-2))
...
(TYPE-CASE-CLAUSES (190 89 (:REWRITE DEFAULT-+-2))
                   (124 89 (:REWRITE DEFAULT-+-1))
                   (72 18 (:REWRITE COMMUTATIVITY-OF-+))
                   (72 18 (:DEFINITION INTEGER-ABS))
                   (72 9 (:DEFINITION LENGTH))
