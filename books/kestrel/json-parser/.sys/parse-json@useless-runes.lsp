...
(JSON-TOKEN-LISTP-OF-MV-NTH-1-OF-TOKENIZE-JSON-CHARS-AUX
 (15418 10366 (:REWRITE DEFAULT-+-2))
 (14008 10194 (:REWRITE DEFAULT-CDR))
 (13819 12250 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
 (10366 10366 (:REWRITE DEFAULT-+-1))
 (6032 3596 (:REWRITE EQUAL-OF-LEN-AND-0))
 (4733 1949 (:REWRITE DEFAULT-<-2))
 (3958 2555 (:REWRITE DEFAULT-CAR))
 (3306 1653 (:DEFINITION NTHCDR))
 (3140 3140 (:REWRITE LEN-OF-CDDR-WHEN-EQUAL-OF-LEN))
 (2299 63 (:DEFINITION TAKE))
 (2172 2172 (:REWRITE CONSP-WHEN-LEN-GREATER))
 (1949 1949 (:REWRITE DEFAULT-<-1))
 (1566 522 (:TYPE-PRESCRIPTION TRUE-LISTP-NTHCDR-TYPE-PRESCRIPTION))
 (1340 128 (:DEFINITION REVAPPEND))
 (1240 62 (:REWRITE ZP-OPEN))
 (1065 69 (:REWRITE DEFAULT-COERCE-3))
 (875 34 (:DEFINITION CHARACTER-LISTP))
 (522 522 (:TYPE-PRESCRIPTION TRUE-LISTP))
 (315 315 (:TYPE-PRESCRIPTION TRUE-LISTP-TAKE))
 (136 34 (:REWRITE CHARACTERP-OF-CAR-WHEN-CHARACTER-LISTP-STRONG))
 (136 34 (:REWRITE CHARACTER-LISTP-OF-CDR))
 (82 14 (:LINEAR LEN-OF-MV-NTH-2-OF-PARSE-JSON-STRING-BOUND))
 (82 14 (:LINEAR LEN-OF-MV-NTH-2-OF-PARSE-JSON-NUMBER-BOUND))
