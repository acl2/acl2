...
(LEN-OF-SKIP-JSON-WHITESPACE-BOUND
     ...
     (20 20
         (:TYPE-PRESCRIPTION SKIP-JSON-WHITESPACE))
     (20 20 (:REWRITE DEFAULT-+-1))
     (14 14 (:REWRITE DEFAULT-CDR)))
(CHARACTER-LISTP-OF-SKIP-JSON-WHITESPACE (108 108 (:REWRITE DEFAULT-CAR))
                                         (54 54 (:REWRITE DEFAULT-CDR)))
(LEN-OF-CDR (10 5 (:REWRITE DEFAULT-+-2))
            (5 5 (:REWRITE DEFAULT-CDR))
            (5 5 (:REWRITE DEFAULT-+-1)))
(TRUE-LISTP-OF-CDR)
(LEN-OF-CDR-LINEAR (45 3 (:LINEAR LEN-OF-CDR))
...
(CHARACTER-LISTP-OF-MV-NTH-2-OF-PARSE-JSON-NULL-LITERAL
     ...
     (4 2 (:DEFINITION NTHCDR)))
(HEX-DIGITP)
(PARSE-UNICODE-DIGITS (144 31 (:REWRITE CHARACTER-LISTP-OF-CDR))
                      (63 63 (:REWRITE DEFAULT-CDR))
                      (24 24 (:REWRITE DEFAULT-CAR)))
(LEN-OF-MV-NTH-2-OF-PARSE-UNICODE-DIGITS-BOUND (88 88 (:REWRITE DEFAULT-CDR))
                                               (58 29 (:REWRITE DEFAULT-+-2))
                                               (29 29 (:REWRITE DEFAULT-+-1))
...
(PARSE-JSON-STRING-CHAR (6 6 (:REWRITE DEFAULT-CAR))
                        (5 5 (:REWRITE DEFAULT-CDR)))
(MV-NTH-2-OF-PARSE-JSON-STRING-CHAR-BOUND (194 97 (:REWRITE DEFAULT-+-2))
...
(CHAR-VALUE)
(PARSE-JSON-DIGITS)
(NATP-OF-EXPT (29 25 (:REWRITE DEFAULT-<-1))
...
(PARSE-JSON-DIGITS (28 28 (:TYPE-PRESCRIPTION NATP-OF-EXPT)))
(CHARACTER-LISTP-OF-MV-NTH-2-OF-PARSE-JSON-DIGITS
     ...
     (84 84
         (:TYPE-PRESCRIPTION NATP-OF-MV-NTH-0-OF-PARSE-JSON-DIGITS))
...
(LEN-OF-MV-NTH-2-OF-PARSE-JSON-DIGITS-BOUND-BOUND
     ...
     (66 66
         (:TYPE-PRESCRIPTION NATP-OF-MV-NTH-0-OF-PARSE-JSON-DIGITS)))
(PARSE-INTEGER-PART-OF-JSON-NUMBER (75 75 (:REWRITE DEFAULT-CAR))
...
(CHARACTER-LISTP-OF-MV-NTH-2-OF-PARSE-INTEGER-PART-OF-JSON-NUMBER
     ...
     (8 8
        (:TYPE-PRESCRIPTION NATP-OF-MV-NTH-1-OF-PARSE-JSON-DIGITS))
     (8 2 (:REWRITE CHARACTER-LISTP-OF-CDR))
...
(PARSE-FRACTIONAL-PART-OF-JSON-NUMBER
  ...
  (60 30
      (:TYPE-PRESCRIPTION NATP-OF-MV-NTH-2-OF-PARSE-ONE-OR-MORE-JSON-DIGITS))
...
(CHARACTER-LISTP-OF-MV-NTH-2-OF-PARSE-FRACTIONAL-PART-OF-JSON-NUMBER
  ...
  (3 3 (:REWRITE DEFAULT-CAR))
  (1 1
     (:TYPE-PRESCRIPTION NATP-OF-MV-NTH-1-OF-PARSE-ONE-OR-MORE-JSON-DIGITS))
  (1 1 (:REWRITE DEFAULT-<-2))
  (1 1 (:REWRITE DEFAULT-<-1)))
(LEN-OF-MV-NTH-2-OF-PARSE-FRACTIONAL-PART-OF-JSON-NUMBER-BOUND
  ...
  (1 1
     (:TYPE-PRESCRIPTION NATP-OF-MV-NTH-1-OF-PARSE-ONE-OR-MORE-JSON-DIGITS))
  (1 1 (:REWRITE DEFAULT-CAR)))
(PARSE-EXPONENT-PART-OF-JSON-NUMBER (27 27 (:REWRITE DEFAULT-CAR))
...
(LEN-OF-MV-NTH-2-OF-PARSE-EXPONENT-PART-OF-JSON-NUMBER-BOUND
     ...
     (2 1 (:REWRITE DEFAULT-<-2))
     (2 1 (:REWRITE DEFAULT-<-1)))
(PARSE-NON-NEGATIVE-JSON-NUMBER (18 16 (:TYPE-PRESCRIPTION NATP-OF-EXPT))
...
(RATIONALP-OF-MV-NTH-1-OF-PARSE-NON-NEGATIVE-JSON-NUMBER
 ...
 (12 3
     (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
 (9 3
    (:REWRITE RATIONALP-OF-MV-NTH-1-OF-PARSE-FRACTIONAL-PART-OF-JSON-NUMBER))
 (7 1 (:DEFINITION CHARACTER-LISTP))
 (6 2 (:REWRITE COMMUTATIVITY-OF-+))
 (4 1 (:REWRITE CHARACTER-LISTP-OF-CDR))
 (3 3
...
(CHARACTER-LISTP-OF-MV-NTH-2-OF-PARSE-NON-NEGATIVE-JSON-NUMBER
 ...
 (6
  6
  (:TYPE-PRESCRIPTION NATP-OF-MV-NTH-1-OF-PARSE-INTEGER-PART-OF-JSON-NUMBER))
 (6 2 (:REWRITE COMMUTATIVITY-OF-+))
 (3 3
    (:REWRITE
         CHARACTER-LISTP-OF-MV-NTH-2-OF-PARSE-INTEGER-PART-OF-JSON-NUMBER))
...
(RATIONALP-OF-MV-NTH-1-OF-PARSE-JSON-NUMBER
     ...
     (4 1
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (3 1
        (:REWRITE RATIONALP-OF-MV-NTH-1-OF-PARSE-NON-NEGATIVE-JSON-NUMBER))
     (2 2 (:REWRITE DEFAULT-CDR))
     (2 2 (:REWRITE DEFAULT-CAR))
     (1 1 (:REWRITE DEFAULT-*-1)))
...
(CHARACTER-LISTP-OF-MV-NTH-2-OF-PARSE-JSON-NUMBER
     ...
     (3 1
        (:REWRITE RATIONALP-OF-MV-NTH-1-OF-PARSE-NON-NEGATIVE-JSON-NUMBER))
     (1 1 (:REWRITE DEFAULT-*-1)))
(TOKENIZE-JSON-CHARS-AUX (337 337 (:REWRITE DEFAULT-CAR))
...
(TRUE-LISTP-OF-MV-NTH-1-OF-TOKENIZE-JSON-CHARS-AUX
     (4224 288
           (:REWRITE TRUE-LISTP-WHEN-CHARACTER-LISTP2))
...
(NOT-O<-SELF (30 30 (:REWRITE DEFAULT-CAR))
             (18 18 (:REWRITE DEFAULT-CDR))
             (8 8
                (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(O-P-OF-MAKE-ORD-SUFF (8 8 (:REWRITE DEFAULT-CAR))
                      (4 4 (:REWRITE DEFAULT-<-2))
                      (4 4 (:REWRITE DEFAULT-<-1))
                      (3 3 (:REWRITE DEFAULT-CDR)))
(PARSE-JSON-OBJECT-PAIRS (180 92 (:REWRITE DEFAULT-+-2))
...
(FLAG-PARSE-JSON-OBJECT-PAIRS (164 86 (:REWRITE DEFAULT-+-2))
...
(LEN-OF-MV-NTH-2-PARSE-JSON-VALUE-BOUND-STRONG
     ...
     (16 8 (:REWRITE DEFAULT-<-1))
     (10 10 (:REWRITE DEFAULT-CAR)))
(PARSE-JSON-OBJECT-PAIRS (156 12
                              (:REWRITE TRUE-LISTP-WHEN-CHARACTER-LISTP2))
