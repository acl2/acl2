...
(defsection dim-equivalence-stronger-rules
  :short "Stronger versions of the defining rules of dimension equivalence."
  :long
  (xdoc::topstring
   (xdoc::p
    "The theorems generated by @(tsee definductive)
...
(defsection shape/ispace-equivalence-stronger-rules
  :short "Stronger versions of the defining rules of
          shape and ispace equivalence."
  :long
  (xdoc::topstring
   (xdoc::p
    "This is analogous to @(see dim-equivalence-stronger-rules),
