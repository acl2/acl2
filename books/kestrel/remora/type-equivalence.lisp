...
(definductive type-equiv-definition
...
(defsection type-equiv-holds-only-on-types
  ...
  (defruled typep-when-type=-proof-validp
    ...
    :hints (("Goal"
             ...
             :in-theory (enable* type-equiv-definition-validp-defs
...
(defsection type-equiv-guard-verification
  ...
  (verify-guards type=-proof-validp
    :hints (("Goal" :in-theory (enable* type-equiv-definition-validp-defs))))
