...
(defsection type-equivalence-guard-verification
  :short "Guard verification of the functions generated by
          ...
          and of @(tsee type-eq-proof-list-validp)."
  :long
  (xdoc::topstring
   (xdoc::p
   ...
   (xdoc::p
    "The guards of @(tsee type-eq-proof-list-validp) are verified here,
     after those of the proof validity function that it calls."))
  ...
  ;; list proof validity function:

  (verify-guards type-eq-proof-list-validp)
