...
(acl2::assert-equal
 (eval-primop-tfun (primop-value-head) (list *tv-int*))
...
(acl2::assert-equal
 (eval-primop-tfun (primop-value-tail) (list *tv-int*))
...
; mismatch: the Haskell implementation reverses the flattened elements,
; giving [[6 5 4] [3 2 1]]
(acl2::assert-equal
