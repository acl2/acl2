...
; A map from type-variable name strings to types is used to resolve type
; arguments.  We use the STRING-TYPE-MAP omap so that the type-variable
; substitution operations below can be applied directly to it.
