  ...
  (b* ((op (unop-fix op))
    ...
    (value-result-case
     ...
     :ok (unop-case
          ...
          :minus (if (acl2::sbyte32p (- (sint->get arg.get)))
                     (sint-minus arg.get)
                   (error (list :exec-unary op arg)))
          :bitnot (error (list :exec-unary op arg))
          :lognot (error (list :exec-unary op arg)))))
  :hooks (:fix))
  ...
  (b* ((op (binop-fix op))
    ...
    (if (value-result-case arg1 :ok)
        (if (value-result-case arg2 :ok)
            (binop-case
             op
             :mul (if (acl2::sbyte32p (* (sint->get arg1)
                                         (sint->get arg2)))
                      (sint-mul arg1 arg2)
                    (error (list :exec-binary op arg1 arg2)))
             :div (if (and (not (equal (sint->get arg2) 0))
                           (acl2::sbyte32p (truncate (sint->get arg1)
                                                     (sint->get arg2))))
                      (sint-div arg1 arg2)
                    (error (list :exec-binary op arg1 arg2)))
             :rem (if (and (not (equal (sint->get arg2) 0))
                           (acl2::sbyte32p (truncate (sint->get arg1)
                                                     (sint->get arg2))))
                      (sint-rem arg1 arg2)
                    (error (list :exec-binary op arg1 arg2)))
             :add (if (acl2::sbyte32p (+ (sint->get arg1)
                                         (sint->get arg2)))
                      (sint-add arg1 arg2)
                    (error (list :exec-binary op arg1 arg2)))
             :sub (if (acl2::sbyte32p (- (sint->get arg1)
                                         (sint->get arg2)))
                      (sint-sub arg1 arg2)
                    (error (list :exec-binary op arg1 arg2)))
             :shl (error (list :exec-binary op arg1 arg2))
             :shr (error (list :exec-binary op arg1 arg2))
             :lt (error (list :exec-binary op arg1 arg2))
             :gt (error (list :exec-binary op arg1 arg2))
             :le (error (list :exec-binary op arg1 arg2))
             :ge (error (list :exec-binary op arg1 arg2))
             :eq (error (list :exec-binary op arg1 arg2))
             :ne (error (list :exec-binary op arg1 arg2))
             :bitand (error (list :exec-binary op arg1 arg2))
             :bitxor (error (list :exec-binary op arg1 arg2))
             :bitior (error (list :exec-binary op arg1 arg2))
