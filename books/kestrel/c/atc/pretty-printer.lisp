...
(define pprint-transunit-to-filesystem ((tunit transunitp)
                                        (include maybe-stringp)
                                        (options pprint-options-p)
                                        (filepath stringp)
                                        state)
  ...
  (pprinted-lines-to-file (pprint-transunit tunit include options)
                          filepath
                          state))
...
(define pprint-transunit-ensemble ((tunits transunit-ensemblep)
  ...
  (b* (((transunit-ensemble tunits) tunits)
    ...
    (if tunits.dot-h
        (b* (((er &) (pprint-transunit-to-filesystem tunits.dot-h
                                                     nil
                                                     options
                                                     path-dot-h
                                                     state)))
          (pprint-transunit-to-filesystem tunits.dot-c
                                          (str::cat file-name ".h")
                                          options
                                          path-dot-c
                                          state))
