...
(define defstruct-gen-reader ((struct-tag symbolp)
  ...
  (xdoc::topstring
   ...
   (xdoc::p
    "Also return the name of the return type theorem of the reader,
     which is generated by @(tsee define)."))
...
(define defstruct-gen-readers ((struct-tag symbolp)
  ...
  (xdoc::topstring
   (xdoc::p
    "Also return the list of return type theorems of the readers."))
...
(define defstruct-gen-writer ((struct-tag symbolp)
  ...
  (xdoc::topstring
   ...
   (xdoc::p
    "Also return the name of the return type theorem of the writer,
     which is generated by @(tsee define)."))
  (b* ((typep (atc-type-predicate type))
...
(define defstruct-gen-everything ((tag symbolp)
  ...
  (b* ((struct-tag (packn-pos (list 'struct- tag) tag))
       ...
       ((mv reader-events reader-return-thms)
        (defstruct-gen-readers
          struct-tag struct-tag-p struct-tag-fix members members))
       ((mv writer-events writer-return-thms)
        (defstruct-gen-writers
          struct-tag struct-tag-p struct-tag-fix members members))
