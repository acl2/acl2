...
(fty::deflist atc-var-info-list
  :short "Fixtype of lists of information associated to
          an ACL2 variable translated to a C variable."
...
(fty::defoption atc-var-info-option
  atc-var-info
  :short "Fixtype of optional information associated to
          an ACL2 variable translated to a C variable."
...
(fty::deflist atc-var-info-option-list
  :short "Fixtype of lists of optional information associated to
          an ACL2 variable translated to a C variable."
...
(define atc-get-var-check-innermost ((var symbolp)
  ...
  (xdoc::topstring
   ...
   (xdoc::p
    "The @('innermostp') flag passed to the recursive function
     is @('t') only at the beginning, i.e. for the innermost scope,
     and is set to (and stays) @('nil') for any other scope."))
  ...
  (xdoc::topstring
   (xdoc::p
    "If the variable is in the symbol table, we return its information,
     ...
     (as in @(tsee atc-get-var-check-innermost)).
...
(define atc-symbol-varinfo-alist-list-to-thms
  ...
  ;; Promoting the following inclusion to the file level
  ;; causes a certification error saying that DUPLICATE-MEMBERS is not defined.
  ;; Presumably, the function is brought in by this book,
  ;; and theorems involving it are generated by the FTY::DEFLISTs above.
  ;; This looks like a bug in Std that should be fixed.
