...
(|i| (19526 427
            (:REWRITE INTEGERP-OF-CAR-WHEN-INTEGER-LISTP))
     (13889 217 (:DEFINITION INTEGER-LISTP))
     (12734 348
            (:REWRITE INTEGER-LISTP-OF-CDR-WHEN-INTEGER-LISTP))
     (6285 565
           (:REWRITE INTEGER-LISTP-WHEN-NOT-CONSP))
     (3666 595 (:REWRITE DEFAULT-CAR))
     (3265 516 (:REWRITE DEFAULT-<-2))
     (2508 30
     ...
     (2400 18 (:DEFINITION ACL2-NUMBER-LISTP))
     (2256 78 (:DEFINITION RATIONAL-LISTP))
     (2157 516 (:REWRITE DEFAULT-<-1))
     (1800 30
           (:REWRITE ACL2-NUMBER-LISTP-OF-CDR-WHEN-ACL2-NUMBER-LISTP))
     (1183 595 (:REWRITE DEFAULT-CDR))
     (1152 126
...
(|j| (4430 182
           (:REWRITE INTEGERP-OF-CAR-WHEN-INTEGER-LISTP))
     (3816 108 (:DEFINITION INTEGER-LISTP))
     (2880 180
           (:REWRITE INTEGER-LISTP-OF-CDR-WHEN-INTEGER-LISTP))
     (2088 288
           (:REWRITE INTEGER-LISTP-WHEN-NOT-CONSP))
     (430 170 (:REWRITE DEFAULT-CAR))
     (278 278
          (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-SYMBOL-TRUELIST-ALISTP
                    . 2))
     (278 278
...
(|f-RETURNS-VALUE| (2 2 (:TYPE-PRESCRIPTION |f|)))
...
(C::|*PROGRAM*-h-CORRECT|)
(|i-RETURNS-VALUE| (2 2 (:TYPE-PRESCRIPTION |i|)))
