...
(C::FUN-INFOP-OF-FUN-INFO-FIX
 ...
 (25 9 (:REWRITE C::TYNAME-FIX-WHEN-TYNAMEP))
...
(C::FUN-INFOP-OF-FUN-INFO
 ...
 (17 7 (:REWRITE C::TYNAME-FIX-WHEN-TYNAMEP))
...
(C::FUN-ENV-RESULTP-OF-INIT-FUN-ENV-AUX
 (138 23 (:REWRITE C::FUN-ENV-RESULTP-WHEN-ERRORP))
...
(C::INIT-FUN-ENV-AUX-OF-EXT-DECLON-LIST-FIX-DECLONS
 (2238 1131 (:REWRITE DEFAULT-CDR))
 (883 544 (:REWRITE DEFAULT-CAR))
 (815 137 (:REWRITE C::EXT-DECLON-LIST-FIX-WHEN-EXT-DECLON-LISTP))
 (564 188 (:REWRITE C::FUN-ENV-FIX-WHEN-FUN-ENVP))
 (376 376 (:TYPE-PRESCRIPTION C::FUN-ENVP))
 (264 66 (:REWRITE C::EXT-DECLON-LISTP-OF-CDR-WHEN-EXT-DECLON-LISTP))
 (213 203 (:REWRITE C::EXT-DECLON-LISTP-WHEN-NOT-CONSP))
 )
