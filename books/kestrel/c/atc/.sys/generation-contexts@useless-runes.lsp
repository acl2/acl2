...
(C::ATC-PREMISE-OTHER)
(C::RETURN-TYPE-OF-ATC-PREMISE-OTHER)
(C::ATC-PREMISE-FIX-WHEN-OTHER
 (3 1 (:REWRITE C::ATC-PREMISE-FIX-WHEN-ATC-PREMISEP))
 (2 2 (:TYPE-PRESCRIPTION C::ATC-PREMISEP))
 )
(C::EQUAL-OF-ATC-PREMISE-OTHER)
(C::ATC-PREMISE-FIX-REDEF
 (9 3 (:REWRITE C::ATC-PREMISE-FIX-WHEN-ATC-PREMISEP))
...
(C::NTH-OF-ATC-CONTEXT-FIX
 ...
 (2 1 (:REWRITE C::ATC-PREMISE-FIX-WHEN-OTHER))
 (1 1 (:TYPE-PRESCRIPTION C::ATC-PREMISE-KIND$INLINE))
