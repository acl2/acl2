...
(fty::defprod atc-tag-info
  ...
  ((defstruct defstruct-info)
   (exec-memberp-thms symbol-list)
   (exec-asg-memberp-thms symbol-listp))
  :pred atc-tag-infop)
...
(define atc-string-taginfo-alist-to-exec-asg-memberp-thms
  ((prec-tags atc-string-taginfo-alistp))
  :returns (thms symbol-listp)
  ...
  (b* (((when (endp prec-tags)) nil)
       (info (cdar prec-tags))
       (thms (atc-tag-info->exec-asg-memberp-thms info))
       (more-thms
...
(define atc-gen-tag-declon ((tag symbolp)
  ...
  (b* ((irr (list (irr-tag-declon) nil nil nil))
       ...
       (info (make-atc-tag-info :defstruct info
                                ...
                                :exec-asg-memberp-thms write-thm-names))
