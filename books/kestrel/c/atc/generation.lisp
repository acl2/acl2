...
(define atc-gen-tag-member-read-thm ((tag identp)
                                     (recognizer symbolp)
                                     ...
                                     (wrld plist-worldp))
  :returns (mv (local-events "A @(tsee pseudo-event-form-listp).")
               (member-read-thm "A @(tsee symbolp).")
               (updated-names-to-avoid "A @(tsee symbol-listp)."))
  :mode :program
  :short "Generate a theorem to rewrite
          the execution of a pure expression to a structure reader."
  :long
  (xdoc::topstring
   (xdoc::p
...
(define atc-gen-tag-member-read-thms ((tag identp)
  ...
  (b* (((when (endp members)) (mv nil nil names-to-avoid))
       ((mv events thm names-to-avoid)
        (atc-gen-tag-member-read-thm tag
                                     recognizer
                                     fixer-recognizer-thm
                                     not-error-thm
                                     (car members)
...
(define atc-gen-tag-member-write-thm ((recognizer symbolp)
                                      (fixer-recognizer-thm symbolp)
                                      (not-error-thm symbolp)
                                      (member member-typep)
                                      (writer symbolp)
                                      ...
                                      (wrld plist-worldp))
  :returns (mv (local-events "A @(tsee pseudo-event-form-listp).")
               (member-write-thm "A @(tsee symbolp).")
               (updated-names-to-avoid "A @(tsee symbol-listp)."))
  :mode :program
  :short "Generate a theorem to rewrite
          the execution of an assignment to a structure writer."
  :long
  (xdoc::topstring
   (xdoc::p
    "This class of theorems are the structure counterpart of
...
(define atc-gen-tag-member-write-thms ((recognizer symbolp)
  ...
  (b* (((when (endp members)) (mv nil nil names-to-avoid))
       ((mv events thm names-to-avoid)
        (atc-gen-tag-member-write-thm recognizer
                                      fixer-recognizer-thm
                                      not-error-thm
                                      (car members)
                                      (car writers)
...
(define atc-gen-tag-declon ((tag symbolp)
  ...
  (b* ((irr (list (irr-tag-declon) nil nil nil))
       ...
       ((mv read-thm-events read-thm-names names-to-avoid)
        (if proofs
            (atc-gen-tag-member-read-thms tag-ident
                                          recognizer
                                          fixer-recognizer-thm
                                          not-error-thm
                                          meminfos
