...
(define atc-gen-fn-run-correct-thm ((fn symbolp)
  ...
  (xdoc::topstring
   ...
   (xdoc::p
    "We also generate, as part of the local event for this theorem,
     an event for the theorem generated by @(tsee atc-gen-fn-exec-correct-thm).
     So we can use it in the proof of this theorem.")
   (xdoc::p
  ...
  (b* (((unless proofs) (acl2::value (list nil nil names-to-avoid)))
       (name (acl2::packn (list prog-const "-" (symbol-name fn) "-CORRECT")))
       ...
       ((mv lemma-event lemma-name names-to-avoid)
        (atc-gen-fn-exec-correct-thm
         fn prec-fns fenv-const names-to-avoid wrld))
       (formals (acl2::formals+ fn wrld))
       (guard (untranslate (acl2::uguard fn wrld) t wrld))
...
(define atc-gen-ext-decl ((fn symbolp)
  ...
  (b* ((name (symbol-name fn))
       ...
       ((er (list local-events exported-events names-to-avoid))
        (atc-gen-fn-run-correct-thm fn prec-fns prog-const proofs print-info/all
