  ...
  (xdoc::topstring
   ...
   (xdoc::p
    "We also generate, as part of the local event for this theorem,
     and event for the lemma generated by @(tsee atc-gen-fn-lemma-thm).
     This is independent from the theorem generated here for now,
     but we plan to use the lemma to prove the theorem soon.")
   (xdoc::p
    "We generate singleton lists of events if @(':proofs') is @('t'),
     empty lists otherwise."))
  (b* (((unless proofs) (acl2::value (list nil nil)))
