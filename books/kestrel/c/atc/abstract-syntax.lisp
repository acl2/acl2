...
(defxdoc+ atc-abstract-syntax
  ...
  (xdoc::topstring
   ...
   (xdoc::p
    "However, in the future we plan to use the "
    (xdoc::seetopic "c$::abstract-syntax"
                    "abstract syntax for tools")
    ", for at least the following reasons:")
   (xdoc::ol
    (xdoc::li
     "The abstract syntax from the C language formalization
      captures (mostly) syntax after preprocessing,
      ...
      preprocessing constructs with the preprocessed construct,
      which is exactly what the syntax for tools does;
      this mix should not be part of the language formalization,
      which should differentiate between before and after preprocessing,
