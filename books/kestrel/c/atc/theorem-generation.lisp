  ...
  (xdoc::topstring
   ...
   (xdoc::p
    "This ACL2 function goes through the given symbol table @('inscope')
     ...
     wih the same scopes and variables, but different theorems (see below).
   ...
   (xdoc::p
    "Since the generated theorem names involve the names of the variables,
     ...
     The updates theorem index, returned by this ACL2 function,
     is just one more than the input index."))
