  ...
  (xdoc::topstring
   (xdoc::p
    "In order to support the generation of proofs for
     ...
     Here we provide a formal static semantics,
     which support the generation of proofs for the C code generated by ATC.")
   (xdoc::p
    "This static semantics may be extended in the future,
   ...
   (xdoc::p
    "The static semantics is defined over the C abstract syntax,
     ...
     just because ATC currently does not generate those constructs.
     ...
     regardless of the fact that valid C programs (not generated by ATC)
...
(define check-param-declon ((param param-declonp) (vartab var-tablep))
  ...
  (b* (((param-declon param) param)
       ...
       (pointerp (obj-declor->pointerp param.declor))
       (var (obj-declor->ident param.declor))
       (wf (check-ident var))
