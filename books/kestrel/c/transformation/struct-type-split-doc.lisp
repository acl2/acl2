...
(defxdoc+ struct-type-split
  ...
  (xdoc::topstring
   ...
   (xdoc::section
     ...
     (xdoc::ul
       (xdoc::li
         "The struct type must not appear in array types, union types,
          other struct types, or function return types. "
         (xdoc::b "These constraints are not yet checked")
         "; violating them may produce invalid code.")
       (xdoc::li
       ...
       (xdoc::li
         "The members of the struct type must all be named;
          e.g. the struct type may not contain anonymous bit-fields.")
       (xdoc::li
