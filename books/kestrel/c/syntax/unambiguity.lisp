...
(defsection abstract-syntax-unambp-additional-theorems
  ...
  ;; The following theorem is not currently generated by DEFFOLD-REDUCE.

  (defruled trans-unit-unambp-of-cdr-assoc-when-filepath-trans-unit-map-unambp
    (implies (and (filepath-trans-unit-mapp map)
                  (filepath-trans-unit-map-unambp map)
                  (omap::assoc key map))
             (trans-unit-unambp (cdr (omap::assoc key map))))
    :induct t
    :enable filepath-trans-unit-map-unambp)
  ...
  (add-to-ruleset
   ...
   '(expr-unambp-when-ident
     ...
     trans-unit-unambp-of-cdr-assoc-when-filepath-trans-unit-map-unambp)))
