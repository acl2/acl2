...
"
  :cond (b* ((filepath-transunit-map (transunit-ensemble->units ast))
             ...
             (foo-init1 (first (declon-declon->declors (extdecl-decl->decl (first edecls1)))))
             ...
             (foo-init2 (first (declon-declon->declors (block-item-decl->decl bar-body-decl1))))
             ...
             (foo-init3 (first (declon-declon->declors (block-item-decl->decl bar-body-decl2))))
             ...
             (bar-init (first (declon-declon->declors (extdecl-decl->decl (first edecls2)))))
