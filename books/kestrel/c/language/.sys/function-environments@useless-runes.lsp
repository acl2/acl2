...
(C::FUN-INFOP-OF-CDR-OF-IN-FUN-ENVP
 (283 15 (:REWRITE OMAP::IN-WHEN-IN-TAIL))
 (215 7 (:DEFINITION C::FUN-ENVP))
 (187 143 (:TYPE-PRESCRIPTION OMAP::TAIL-WHEN-EMPTY))
...
(C::EQUAL-OF-FUN-ENV-RESULT-ERR
 ...
 (156 4 (:REWRITE C::MAPP-WHEN-FUN-ENVP))
 (144 4 (:DEFINITION C::FUN-ENVP))
...
(C::NOT-RESERRP-WHEN-FUN-ENVP
 (77 2 (:DEFINITION C::FUN-ENVP))
 (52 1 (:REWRITE OMAP::ALISTP-WHEN-MAPP))
 (40 2 (:REWRITE FAST-<<-IS-<<))
 (39 1 (:REWRITE C::MAPP-WHEN-FUN-ENVP))
...
(C::FUN-INFO-OPTIONP-OF-FUN-ENV-LOOKUP
 ...
 (8 2 (:REWRITE C::EMPTY-OF-FUN-ENV-FIX-TO-NOT-FUN-ENV-OR-EMPTY))
...
(C::FUN-ENV-EXTEND-OF-FUNDEF-FIX-FUNDEF
 ...
 (12 2 (:REWRITE OMAP::UPDATE-WHEN-EMPTY))
 (8 2 (:REWRITE C::EMPTY-OF-FUN-ENV-FIX-TO-NOT-FUN-ENV-OR-EMPTY))
