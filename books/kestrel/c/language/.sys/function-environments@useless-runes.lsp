...
(C::FUN-INFOP-OF-CDR-OF-ASSOC-FUN-ENVP
 (224 13 (:REWRITE OMAP::ASSOC-WHEN-ASSOC-TAIL))
 (215 7 (:DEFINITION C::FUN-ENVP))
 (161 119 (:TYPE-PRESCRIPTION OMAP::TAIL-WHEN-EMPTYP))
 (125 5 (:REWRITE FAST-<<-IS-<<))
