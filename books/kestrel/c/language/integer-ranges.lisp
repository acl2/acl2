...
; hold for some choices of bit width values consistent with [C].
...
; The following theorems are weaker than those above, but they hold for all
; bit width values consistent with [C]. They are therefore enabled.
