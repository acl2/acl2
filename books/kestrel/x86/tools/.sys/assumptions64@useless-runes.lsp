(X::BYTES-LOADED-AT-ADDRESS-64
 ...
 (312 8 (:REWRITE X86ISA::CANONICAL-ADDRESS-P-BETWEEN))
...
(X::CANONICAL-ADDRESS-LISTP-OF-ADDRESSES-OF-SUBSEQUENT-STACK-SLOTS-AUX
 (2844 28 (:REWRITE SIGNED-BYTE-P-WHEN-UNSIGNED-BYTE-P))
 (1704 22 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (1551 191 (:REWRITE DEFAULT-<-1))
 (1468 34 (:REWRITE NATP-WHEN-INTEGERP-CHEAP))
 ...
 (163 153 (:REWRITE NOT-<-WHEN-SBVLT-ALT))
