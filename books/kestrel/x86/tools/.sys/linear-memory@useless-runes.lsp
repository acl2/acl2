...
(X86ISA::MV-NTH-0-OF-RB-1-OF-XW
 (1260 52 (:REWRITE ASH-0))
 (1164 48 (:REWRITE ZIP-OPEN))
 (948 32 (:LINEAR X86ISA::SIZE-OF-RB-1))
...
(X86ISA::RB-1-RX-IRREL
 (1216 52 (:REWRITE ASH-0))
 (1120 48 (:REWRITE ZIP-OPEN))
 (904 32 (:LINEAR X86ISA::SIZE-OF-RB-1))
