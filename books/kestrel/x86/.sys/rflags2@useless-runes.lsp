...
(X::LOGEXT-OF-ZF-SPEC
 (544 2 (:LINEAR <-OF-LOGEXT-SAME-LINEAR))
 (465 465 (:TYPE-PRESCRIPTION EVENP))
 (412 4 (:REWRITE LOGEXT-IDENTITY))
 (405 11 (:REWRITE LOGEXT-WHEN-TOP-BIT-0))
 ...
 (164 11 (:LINEAR GETBIT-BOUND-LINEAR))
...
(X::OF-SPEC-OF-LOGEXT-32
 ...
 (10 1 (:REWRITE LOGEXT-WHEN-SIGNED-BYTE-P))
...
(X::SF-SPEC64-OF-BVCHOP-64
 (165 9 (:LINEAR GETBIT-BOUND-LINEAR))
 (125 6 (:REWRITE BFIX-WHEN-NOT-1))
