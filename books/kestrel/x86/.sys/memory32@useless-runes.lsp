...
(X::WRITE-BYTE-TO-SEGMENT
 ...
 (42 1 (:LINEAR BVCHOP-WHEN-TOP-BIT-0-LINEAR-CHEAP))
...
(X::WRITE-TO-SEGMENT
 ...
 (26 3 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
...
(X::READ-BYTE-FROM-SEGMENT-OF-WRITE-BYTE-TO-SEGMENT-BOTH
 (688 10 (:REWRITE BVCHOP-IDENTITY))
