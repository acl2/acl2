(REMOVE-TRIVIAL-VARS-AUX (125 63 (:REWRITE DEFAULT-+-2))
...
(REMOVE-TRIVIAL-VARS-AUX-SAME-LEN (32 16 (:REWRITE DEFAULT-+-2))
...
(REMOVE-TRIVIAL-VARS-TERMINATION-LEMMA (335 166 (:REWRITE DEFAULT-+-2))
...
(REMOVE-TRIVIAL-VARS (717 331 (:REWRITE DEFAULT-+-2))
                     ...
                     (19 19
                         (:REWRITE TERMP-IMPLIES-PSEUDO-TERMP)))
(REMOVE-TRIVIAL-VARS-FLAG (956 445 (:REWRITE DEFAULT-+-2))
