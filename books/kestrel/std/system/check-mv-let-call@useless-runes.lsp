(CHECK-MV-LET-CALL-AUX (108 108 (:REWRITE DEFAULT-CDR))
...
(CHECK-MV-LET-CALL
     ...
     (32 32
         (:REWRITE TERMP-IMPLIES-PSEUDO-TERMP)))
(BOOLEANP-OF-CHECK-MV-LET-CALL.YES/NO (12 12 (:REWRITE DEFAULT-CAR))
...
(ACL2-COUNT-OF-CHECK-MV-LET-CALL.BODY-TERM
     ...
     (4 4
        (:LINEAR ACL2-COUNT-OF-CHECK-MV-LET-CALL.MV-TERM-LEMMA)))
