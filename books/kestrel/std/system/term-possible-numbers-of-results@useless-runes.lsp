(POS-LISTP-OF-INTERSECTION-EQUAL (32 31 (:REWRITE DEFAULT-CAR))
                                 (21 20 (:REWRITE DEFAULT-CDR))
                                 (11 11 (:REWRITE DEFAULT-<-2))
                                 (11 11 (:REWRITE DEFAULT-<-1)))
(EQLABLE-LISTP-WHEN-POS-LISTP (11 11 (:REWRITE DEFAULT-CAR))
                              (4 4 (:REWRITE DEFAULT-CDR))
                              (4 4 (:REWRITE DEFAULT-<-2))
                              (4 4 (:REWRITE DEFAULT-<-1)))
(TERM-POSSIBLE-NUMBERS-OF-RESULTS (1419 646 (:REWRITE DEFAULT-+-2))
...
(TERM-POSSIBLE-NUMBERS-OF-RESULTS
     ...
     (90 2
         (:DEFINITION TERM-POSSIBLE-NUMBERS-OF-RESULTS))
     (88 88
...
(LEN-OF-INTERSECTION-EQUAL-UPPER-BOUND (24 12 (:REWRITE DEFAULT-+-2))
