(CHECK-IF-CALL (51 51 (:REWRITE DEFAULT-CDR))
...
(BOOLEANP-OF-CHECK-IF-CALL.YES/NO (8 8 (:REWRITE DEFAULT-CDR))
...
(ACL2-COUNT-OF-CHECK-IF-CALL.TEST (110 50 (:REWRITE DEFAULT-+-2))
...
(ACL2-COUNT-OF-CHECK-IF-CALL.THEN (110 50 (:REWRITE DEFAULT-+-2))
                                  (66 50 (:REWRITE DEFAULT-+-1))
                                  (46 46 (:REWRITE DEFAULT-CDR))
                                  (32 8 (:REWRITE COMMUTATIVITY-OF-+))
                                  (32 8 (:DEFINITION INTEGER-ABS))
                                  ...
                                  (4 4 (:REWRITE DEFAULT-COERCE-2))
                                  (4 4 (:REWRITE DEFAULT-COERCE-1)))
(ACL2-COUNT-OF-CHECK-IF-CALL.ELSE (462 215 (:REWRITE DEFAULT-+-2))
                                  (292 215 (:REWRITE DEFAULT-+-1))
