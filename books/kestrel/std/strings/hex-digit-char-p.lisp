...
(str::defcharset hex-digit
  (and (standard-char-p x)
       (digit-char-p x 16)
       t)
  :parents (character-kinds)
  :short "Recognize ASCII hexadecimal digits."
  :long
  (xdoc::topstring
   (xdoc::p
    "These include both uppercase @('A-F') and lowercase @('a-f').")
   (xdoc::p
    "The built-in @(tsee digit-char-p),
     which can be used with optional radix argument 16,
