...
(ZKSEMAPHORE::PEDERSEN-BASE-POINT-AUX
 (1230 15 (:DEFINITION BINARY-APPEND))
 (850 30 (:REWRITE CONSP-OF-REPEAT))
 (800 50 (:REWRITE ZP-OPEN))
 (640 20 (:REWRITE REPEAT-WHEN-ZP))
 (400 20 (:DEFINITION LEN))
 (390 10 (:REWRITE CDR-OF-REPEAT))
 (252 141 (:REWRITE DEFAULT-<-2))
 (210 210 (:TYPE-PRESCRIPTION STR::STRINGP-OF-INT-TO-DEC-STRING))
 (200 40 (:LINEAR STR::STRRPOS-UPPER-BOUND-STRONG))
