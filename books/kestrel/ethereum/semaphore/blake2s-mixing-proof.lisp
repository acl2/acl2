...
;; Print the prime compactly:
(table acl2::evisc-table 21888242871839275222246405745257275088548364400416034343698204186575808495617 "<p>")
...
(acl2::prove-implication-with-r1cs-prover
 ;; The assumption (assumes that the r1cs holds and that vars have the right types):
 (acl2::conjoin-term-with-dag! (acl2::make-conjunction-from-list
                                (cons
                                 ;; Assume that all vars are field elements:
                                 (pfield::gen-fe-listp-assumption (acl2::dag-vars *blake2s-mixingg-0-r1cs-lifted*)
                                                                  ''21888242871839275222246405745257275088548364400416034343698204186575808495617)
                                 ;; And assume that the input vars are bits:
                                 (acl2::make-bitp-claims '(|main.in_v[0][0]| |main.in_v[0][1]| |main.in_v[0][2]| |main.in_v[0][3]|
                                                           |main.in_v[0][4]| |main.in_v[0][5]| |main.in_v[0][6]| |main.in_v[0][7]|
                                                           |main.in_v[0][8]| |main.in_v[0][9]| |main.in_v[0][10]| |main.in_v[0][11]|
                                                           |main.in_v[0][12]| |main.in_v[0][13]| |main.in_v[0][14]| |main.in_v[0][15]|
                                                           |main.in_v[0][16]| |main.in_v[0][17]| |main.in_v[0][18]| |main.in_v[0][19]|
                               ...
                               ;; Assume the R1CS holds:
                               *blake2s-mixingg-0-r1cs-lifted*)
 ;; The conclusion (this says that spec holds on the inputs and outputs):
