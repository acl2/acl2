...
(defthm add-of-mul-and-mul-when-bitps-and-adjacent-coeffs
  (implies (and (syntaxp (and (quotep k1)
           ...
           (equal (add (mul k1 bit1 p) (mul k2 bit2 p) p)
                  (mul k2 (bvcat 1 bit1 1 bit2) p)))
  :hints (("Goal" :in-theory (enable ;pfield::div
                              pfield::equal-of-div
                              add mul bvcat acl2::logapp))))
...
(defthm add-of-mul-and-mul-when-bitps-and-adjacent-coeffs-extra
  (implies (and (syntaxp (and (quotep k1)
           ...
           (equal (add (mul k1 bit1 p) (add (mul k2 bit2 p) extra p) p)
                  (add (mul k2 (bvcat 1 bit1 1 bit2) p) extra p)))
...
(defthmd add-of-mul-and-mul-when-bvs
  (implies (and (syntaxp (and (quotep k1)
           ...
           (equal (add (mul k1 bv1 p) (mul k2 bv2 p) p)
                  (mul k2 (bvcat size1 bv1 size2 bv2) p)))
  :hints (("Goal" :in-theory (enable ;pfield::div
                              pfield::equal-of-div
                              add mul bvcat acl2::logapp))))
...
(defthmd add-of-mul-and-mul-when-bvs-bvcat-version
  (implies (and (syntaxp (and (quotep k1)
                ...
                (natp ls2)
                (natp hs2))
           (equal (add (mul k1 (bvcat hs1 hv1 ls1 lv1) p) (mul k2 (bvcat hs2 hv2 ls2 lv2) p) p)
                  (mul k2 (bvcat (+ hs1 ls1) (bvcat hs1 hv1 ls1 lv1) (+ hs2 ls2) (bvcat hs2 hv2 ls2 lv2)) p)))
  :hints (("Goal" :use (:instance add-of-mul-and-mul-when-bvs
                                  (bv1 (bvcat hs1 hv1 ls1 lv1))
                                  (bv2 (bvcat hs2 hv2 ls2 lv2))
                                  (size1 (+ hs1 ls1))
                                  (size2 (+ hs2 ls2))))))
...
(defthmd add-of-mul-and-mul-when-bvs-bvcat-version-alt
  (implies (and (syntaxp (and (quotep k1)
                ...
                (natp ls2)
                (natp hs2))
           (equal (add (mul k2 (bvcat hs2 hv2 ls2 lv2) p) (mul k1 (bvcat hs1 hv1 ls1 lv1) p) p)
                  (mul k2 (bvcat (+ hs1 ls1) (bvcat hs1 hv1 ls1 lv1) (+ hs2 ls2) (bvcat hs2 hv2 ls2 lv2)) p)))
...
(defthmd add-of-mul-and-mul-when-bvs-bvcat-version-extra
  (implies (and (syntaxp (and (quotep k1)
                ...
                (natp ls2)
                (natp hs2))
           (equal (add (mul k1 (bvcat hs1 hv1 ls1 lv1) p) (add (mul k2 (bvcat hs2 hv2 ls2 lv2) p) extra p) p)
                  (add (mul k2 (bvcat (+ hs1 ls1) (bvcat hs1 hv1 ls1 lv1) (+ hs2 ls2) (bvcat hs2 hv2 ls2 lv2)) p) extra p)))
  :hints (("Goal" :use (:instance add-of-mul-and-mul-when-bvs-bvcat-version)
           :in-theory (disable add-of-mul-and-mul-when-bvs-bvcat-version
...
(defthmd add-of-mul-and-mul-when-bvs-bvcat-version-extra-alt
  (implies (and (syntaxp (and (quotep k1)
                ...
                (natp ls2)
                (natp hs2))
           (equal (add (mul k2 (bvcat hs2 hv2 ls2 lv2) p) (add (mul k1 (bvcat hs1 hv1 ls1 lv1) p) extra p) p)
                  (add (mul k2 (bvcat (+ hs1 ls1) (bvcat hs1 hv1 ls1 lv1) (+ hs2 ls2) (bvcat hs2 hv2 ls2 lv2)) p) extra p)))
  :hints (("Goal" :use (:instance add-of-mul-and-mul-when-bvs-bvcat-version)
           :in-theory (disable add-of-mul-and-mul-when-bvs-bvcat-version))))
...
(defthmd add-of-mul-and-mul-when-bitp-and-bvcat
  (implies (and (syntaxp (and (quotep k1)
                ...
                (natp ls2)
                (natp hs2))
           (equal (add (mul k1 bit p) (mul k2 (bvcat hs2 hv2 ls2 lv2) p) p)
                  (mul k2 (bvcat 1 bit (+ hs2 ls2) (bvcat hs2 hv2 ls2 lv2)) p)))
  :hints (("Goal" :use (:instance add-of-mul-and-mul-when-bvs
                                  (bv1 bit)
                                  (bv2 (bvcat hs2 hv2 ls2 lv2))
                                  (size1 1)
...
(defthmd add-of-mul-and-mul-when-bitp-and-bvcat-alt
  (implies (and (syntaxp (and (quotep k1)
                ...
                (natp ls2)
                (natp hs2))
           (equal (add (mul k2 (bvcat hs2 hv2 ls2 lv2) p) (mul k1 bit p) p)
                  (mul k2 (bvcat 1 bit (+ hs2 ls2) (bvcat hs2 hv2 ls2 lv2)) p)))
  :hints (("Goal" :use (:instance add-of-mul-and-mul-when-bvs
                                  (bv1 bit)
                                  (bv2 (bvcat hs2 hv2 ls2 lv2))
...
(defthmd add-of-mul-and-mul-when-bitp-and-bvcat-extra
  (implies (and (syntaxp (and (quotep k1)
                ...
                (natp ls2)
                (natp hs2))
           (equal (add (mul k1 bit p) (add (mul k2 (bvcat hs2 hv2 ls2 lv2) p) extra p) p)
                  (add (mul k2 (bvcat 1 bit (+ hs2 ls2) (bvcat hs2 hv2 ls2 lv2)) p) extra p)))
  :hints (("Goal" :use (:instance add-of-mul-and-mul-when-bvs
                                  (bv1 bit)
                                  (bv2 (bvcat hs2 hv2 ls2 lv2))
                                  (size1 1)
...
(defthmd add-of-mul-and-mul-when-bitp-and-bvcat-extra-alt
  (implies (and (syntaxp (and (quotep k1)
                ...
                (natp ls2)
                (natp hs2))
           (equal (add (mul k2 (bvcat hs2 hv2 ls2 lv2) p) (add (mul k1 bit p) extra p) p)
                  (add (mul k2 (bvcat 1 bit (+ hs2 ls2) (bvcat hs2 hv2 ls2 lv2)) p) extra p)))
  :hints (("Goal" :use (:instance add-of-mul-and-mul-when-bvs
                                  (bv1 bit)
                                  (bv2 (bvcat hs2 hv2 ls2 lv2))
...
(defthmd add-of-mul-and-mul-when-bvcat-and-bitp
  (implies (and (syntaxp (and (quotep k1)
                ...
                (natp ls)
                (natp hs))
           (equal (add (mul k1 (bvcat hs highval ls lowval) p) (mul k2 bit p) p)
                  (mul k2 (bvcat (+ hs ls) (bvcat hs highval ls lowval) 1 bit) p)))
  :hints (("Goal" :use (:instance add-of-mul-and-mul-when-bvs
                                  (bv2 bit)
                                  (size1 (+ hs ls))
                                  (bv1 (bvcat hs highval ls lowval))
                                  (size2 1)))))
...
(defthmd add-of-mul-and-mul-when-bvcat-and-bitp-alt
  (implies (and (syntaxp (and (quotep k1)
                ...
                (natp ls)
                (natp hs))
           (equal (add (mul k2 bit p) (mul k1 (bvcat hs highval ls lowval) p) p)
                  (mul k2 (bvcat (+ hs ls) (bvcat hs highval ls lowval) 1 bit) p)))
  :hints (("Goal" :use (:instance add-of-mul-and-mul-when-bvs
                                  (bv2 bit)
                                  (size1 (+ hs ls))
...
(defthmd add-of-mul-and-mul-when-bvcat-and-bitp-extra
  (implies (and (syntaxp (and (quotep k1)
                ...
                (natp ls)
                (natp hs))
           (equal (add (mul k1 (bvcat hs highval ls lowval) p) (add (mul k2 bit p) extra p) p)
                  (add (mul k2 (bvcat (+ hs ls) (bvcat hs highval ls lowval) 1 bit) p) extra p)))
  :hints (("Goal" :use (:instance add-of-mul-and-mul-when-bvs
                                  (bv2 bit)
                                  (size1 (+ hs ls))
                                  (bv1 (bvcat hs highval ls lowval))
...
(defthmd add-of-mul-and-mul-when-bvcat-and-bitp-extra-alt
  (implies (and (syntaxp (and (quotep k1)
                ...
                (natp ls)
                (natp hs))
           (equal (add (mul k2 bit p) (add (mul k1 (bvcat hs highval ls lowval) p) extra p) p)
                  (add (mul k2 (bvcat (+ hs ls) (bvcat hs highval ls lowval) 1 bit) p) extra p)))
  :hints (("Goal" :use (:instance add-of-mul-and-mul-when-bvs
                                  (bv2 bit)
                                  (size1 (+ hs ls))
...
(defthmd add-of-mul-of-2-and-bvcat-and-bit
  (implies (and (posp p)
                ...
                (natp ls)
                (natp hs))
           (equal (add (mul 2 (bvcat hs highval ls lowval) p) bit p)
                  (bvcat (+ hs ls) (bvcat hs highval ls lowval) 1 bit)))
  :otf-flg t
  :hints (("Goal" ;:in-theory (enable mul add bvcat acl2::logapp)
           :in-theory (disable ACL2::BVCAT-EQUAL-REWRITE
                               ACL2::BVCAT-EQUAL-REWRITE-ALT
                               )
           :use (:instance add-of-mul-and-mul-when-bvcat-and-bitp
                                  (k2 1)
                                  (k1 2)))))
...
(defthmd add-of-mul-of-2-and-bvcat-and-bit-alt
  (implies (and (posp p)
                ...
                (natp ls)
                (natp hs))
           (equal (add bit (mul 2 (bvcat hs highval ls lowval) p) p)
                  (bvcat (+ hs ls) (bvcat hs highval ls lowval) 1 bit)))
  :otf-flg t
  :hints (("Goal" ;:in-theory (enable mul add bvcat acl2::logapp)
           :in-theory (disable ACL2::BVCAT-EQUAL-REWRITE
...
(defthmd add-of-mul-of-2-and-bvcat-and-bit-extra
  (implies (and (posp p)
                ...
                (natp ls)
                (natp hs))
           (equal (add (mul 2 (bvcat hs highval ls lowval) p) (add bit extra p) p)
                  (add (bvcat (+ hs ls) (bvcat hs highval ls lowval) 1 bit) extra p)))
  :otf-flg t
  :hints (("Goal" ;:in-theory (enable mul add bvcat acl2::logapp)
           :in-theory (disable ACL2::BVCAT-EQUAL-REWRITE
                               ACL2::BVCAT-EQUAL-REWRITE-ALT
...
(defthmd add-of-mul-of-2-and-bvcat-and-bit-extra-alt
  (implies (and (posp p)
                ...
                (natp ls)
                (natp hs))
           (equal (add bit (add (mul 2 (bvcat hs highval ls lowval) p) extra p) p)
                  (add (bvcat (+ hs ls) (bvcat hs highval ls lowval) 1 bit) extra p)))
  :otf-flg t
  :hints (("Goal" ;:in-theory (enable mul add bvcat acl2::logapp)
           :in-theory (disable ACL2::BVCAT-EQUAL-REWRITE
