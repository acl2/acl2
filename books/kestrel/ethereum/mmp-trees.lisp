; Ethereum Library -- Modified Merkle Patricia Trees
;
...
(defsection mmp-encode-c-max
  ...
  (xdoc::topapp
   ...
   (xdoc::p
    "[YP:(194)] uses @($\\arg\\max$), but it should be @($\\max$) instead:
     ...
     Therefore, we use @(tsee acl2::defmax-nat) to introduce this maximum.")
   (xdoc::p
   ...
   (xdoc::p
    "With these two theorems in hand,
     ...
     generated by @(tsee acl2::defmax-nat),
  ...
  (acl2::defmax-nat mmp-encode-c-max x (map)
