...
(SEGMENT-P-OF-SEGMENT-FIX
 (26 10 (:REWRITE 2DPOINT-FIX-WHEN-2DPOINT-P))
 (16 16 (:TYPE-PRESCRIPTION 2DPOINT-P))
 )
...
(SEGMENT-P-OF-SEGMENT
 (14 6 (:REWRITE 2DPOINT-FIX-WHEN-2DPOINT-P))
 (8 8 (:TYPE-PRESCRIPTION 2DPOINT-P))
 )
...
(ONE/TWO/THREE-KIND$INLINE-OF-ONE/TWO/THREE-FIX-X
 (13 9 (:REWRITE ONETWO-FIX-WHEN-ONETWO-P))
