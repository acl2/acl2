...
(NTH-OF-SBYTE16-LIST-FIX
 (253 25 (:REWRITE SBYTE16-FIX-WHEN-SBYTE16P))
 (166 23 (:REWRITE SBYTE16-LIST-FIX-WHEN-SBYTE16-LISTP))
 (98 98 (:REWRITE SBYTE16-LISTP-WHEN-SUBSETP-EQUAL))
 (93 93 (:TYPE-PRESCRIPTION SBYTE16-LISTP))
 (80 15 (:REWRITE SBYTE16-LISTP-OF-CDR-WHEN-SBYTE16-LISTP))
 (74 7 (:REWRITE SBYTE16P-OF-NTH-WHEN-SBYTE16-LISTP))
 (54 9 (:REWRITE SBYTE16P-OF-CAR-WHEN-SBYTE16-LISTP))
 (50 50 (:TYPE-PRESCRIPTION SBYTE16P))
 (50 50 (:REWRITE SBYTE16P-WHEN-MEMBER-EQUAL-OF-SBYTE16-LISTP))
 (49 49 (:REWRITE SBYTE16-LISTP-WHEN-NOT-CONSP))
