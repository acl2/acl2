...
(ACL2-USER::TRUE-LISTP-WHEN-POS-EVEN-LIST-P-COMPOUND-RECOGNIZER)
...
(ACL2-USER::POS-EVEN-LIST-P-OF-POS-EVEN-LIST-FIX
 ...
 (12 5 (:REWRITE ACL2-USER::POS-EVEN-LIST-P-WHEN-NOT-CONSP))
...
(ACL2-USER::NTH-OF-POS-EVEN-LIST-FIX
 (134 30 (:REWRITE ACL2-USER::POSITIVE-EVEN-FIX-WHEN-POSITIVE-EVEN-P))
 (110 23 (:REWRITE ACL2-USER::POS-EVEN-LIST-FIX-WHEN-POS-EVEN-LIST-P))
 (73 73 (:TYPE-PRESCRIPTION ACL2-USER::POS-EVEN-LIST-P))
 (60 60 (:TYPE-PRESCRIPTION ACL2-USER::POSITIVE-EVEN-P))
 (44 11 (:REWRITE ACL2-USER::POSITIVE-EVEN-P-OF-CAR-WHEN-POS-EVEN-LIST-P))
 (39 39 (:REWRITE ACL2-USER::POS-EVEN-LIST-P-WHEN-NOT-CONSP))
 (32 8 (:REWRITE ACL2-USER::POS-EVEN-LIST-P-OF-CDR-WHEN-POS-EVEN-LIST-P))
