...
(USE-ALIAS-P-OF-USE-ALIAS-FIX (49 15
...
(2DPOINT-FIX$INLINE)
(2DPOINT-P-OF-2DPOINT-FIX (15 15
...
(SEGMENT-FIX$INLINE)
(SEGMENT-P-OF-SEGMENT-FIX (7 7 (:REWRITE DEFAULT-CDR))
                          (7 3 (:REWRITE 2DPOINT-FIX-WHEN-2DPOINT-P))
                          (5 5 (:REWRITE DEFAULT-CAR)))
(SEGMENT-FIX-WHEN-SEGMENT-P (24 24 (:REWRITE DEFAULT-CDR))
                            (20 20 (:REWRITE DEFAULT-CAR))
                            (3 3 (:DEFINITION STRIP-CARS)))
(SEGMENT-FIX$INLINE (24 24 (:REWRITE DEFAULT-CDR))
                    (20 20 (:REWRITE DEFAULT-CAR))
                    (3 3 (:DEFINITION STRIP-CARS)))
(FTY::TMP-DEFFIXTYPE-IDEMPOTENT)
...
(SEGMENT->START$INLINE (15 15 (:REWRITE DEFAULT-CDR))
...
(SEGMENT->END$INLINE (17 17 (:REWRITE DEFAULT-CDR))
                     (12 12 (:REWRITE DEFAULT-CAR))
                     (3 3 (:DEFINITION STRIP-CARS)))
...
(SEGMENT)
(SEGMENT-P-OF-SEGMENT (7 3 (:REWRITE 2DPOINT-FIX-WHEN-2DPOINT-P))
                      (2 2 (:REWRITE DEFAULT-CDR))
                      (2 2 (:REWRITE DEFAULT-CAR)))
...
(ONETWO-ONE->GET-WHEN-WRONG-KIND (2 2 (:REWRITE STR-FIX-WHEN-STRINGP)))
(ONETWO-ONE)
(RETURN-TYPE-OF-ONETWO-ONE (1 1 (:REWRITE STR-FIX-WHEN-STRINGP)))
(ONETWO-ONE->GET-OF-ONETWO-ONE (9 9 (:TYPE-PRESCRIPTION ONETWO-ONE)))
(ONETWO-ONE-OF-FIELDS (3 1 (:REWRITE ONETWO-FIX-WHEN-ONETWO-P))
                      (2 2 (:TYPE-PRESCRIPTION ONETWO-P)))
(ONETWO-FIX-WHEN-ONE (3 1 (:REWRITE ONETWO-FIX-WHEN-ONETWO-P))
                     (2 2 (:TYPE-PRESCRIPTION ONETWO-P)))
(EQUAL-OF-ONETWO-ONE)
...
(ONETWO-TWO)
(RETURN-TYPE-OF-ONETWO-TWO (3 1 (:REWRITE LIST-FIX-WHEN-TRUE-LISTP))
                           (2 2 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(ONETWO-TWO->GET-OF-ONETWO-TWO (14 14 (:TYPE-PRESCRIPTION TRUE-LISTP))
                               (9 9 (:TYPE-PRESCRIPTION ONETWO-TWO)))
(ONETWO-TWO-OF-FIELDS (4 4 (:TYPE-PRESCRIPTION TRUE-LISTP))
                      (3 1 (:REWRITE ONETWO-FIX-WHEN-ONETWO-P))
                      (2 2 (:TYPE-PRESCRIPTION ONETWO-P)))
(ONETWO-FIX-WHEN-TWO (3 1 (:REWRITE ONETWO-FIX-WHEN-ONETWO-P))
                     (2 2 (:TYPE-PRESCRIPTION TRUE-LISTP))
                     (2 2 (:TYPE-PRESCRIPTION ONETWO-P)))
(EQUAL-OF-ONETWO-TWO)
(ONETWO-TWO-OF-LIST-FIX-GET (2 2 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(ONETWO-TWO-LIST-EQUIV-CONGRUENCE-ON-GET)
(ONETWO-FIX-REDEF (9 3 (:REWRITE ONETWO-FIX-WHEN-ONETWO-P))
...
(ONE/TWO/THREE-FIX-WHEN-ONE/TWO
     (3 1
        (:REWRITE ONE/TWO/THREE-FIX-WHEN-ONE/TWO/THREE-P))
     (2 2 (:TYPE-PRESCRIPTION ONE/TWO/THREE-P)))
(EQUAL-OF-ONE/TWO/THREE-ONE/TWO (6 2 (:REWRITE ONETWO-FIX-WHEN-ONETWO-P))
