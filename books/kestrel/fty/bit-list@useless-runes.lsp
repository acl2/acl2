...
(CONS-OF-BIT-LIST-FIX-Y-UNDER-BIT-LIST-EQUIV (4 2 (:REWRITE BFIX-BITP))
                                             (2 2 (:TYPE-PRESCRIPTION BITP)))
(CONS-BIT-LIST-EQUIV-CONGRUENCE-ON-Y-UNDER-BIT-LIST-EQUIV)
(CONSP-OF-BIT-LIST-FIX (6 2
                          (:REWRITE BIT-LIST-FIX-WHEN-BIT-LISTP))
                       (4 4 (:TYPE-PRESCRIPTION BIT-LISTP))
                       (3 1 (:REWRITE BFIX-BITP))
                       (2 2 (:TYPE-PRESCRIPTION BITP)))
(BIT-LIST-FIX-UNDER-IFF (6 2
                           (:REWRITE BIT-LIST-FIX-WHEN-BIT-LISTP))
                        (4 4 (:TYPE-PRESCRIPTION BIT-LISTP))
                        (3 1 (:REWRITE BFIX-BITP))
                        (2 2 (:TYPE-PRESCRIPTION BITP)))
(BIT-LIST-FIX-OF-CONS (7 3
                         (:REWRITE BIT-LIST-FIX-WHEN-BIT-LISTP))
                      (4 4 (:TYPE-PRESCRIPTION BIT-LISTP))
                      (4 2 (:REWRITE BFIX-BITP))
                      (2 2 (:TYPE-PRESCRIPTION BITP)))
(LEN-OF-BIT-LIST-FIX (12 4
                         (:REWRITE BIT-LIST-FIX-WHEN-BIT-LISTP))
                     (8 8 (:TYPE-PRESCRIPTION BIT-LISTP))
                     (3 1 (:REWRITE BFIX-BITP))
                     (2 2 (:TYPE-PRESCRIPTION BITP))
                     (1 1 (:REWRITE FTY::EQUAL-OF-LEN)))
(BIT-LIST-FIX-OF-APPEND (28 10
                            (:REWRITE BIT-LIST-FIX-WHEN-BIT-LISTP))
...
(NTH-OF-BIT-LIST-FIX (74 17 (:REWRITE BFIX-BITP))
                     (66 16
                         (:REWRITE BIT-LIST-FIX-WHEN-BIT-LISTP))
