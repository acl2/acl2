...
(CAR-OF-BV-ARRAY-AUX2
   (286 38 (:REWRITE CONSP-FROM-LEN-CHEAP))
   (215 20 (:REWRITE DEFAULT-CAR))
   (195 10 (:REWRITE BVCHOP-IDENTITY))
   (120 11
        (:REWRITE USE-ALL-UNSIGNED-BYTE-P-FOR-CAR))
   (89 10 (:REWRITE DEFAULT-CDR))
   (77 12
       (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-CONSP))
...
(LIST-TO-BV-ARRAY2 (15 1 (:DEFINITION TRUE-LISTP))
...
(LEN-OF-LIST-TO-BV-ARRAY2
     (13 1 (:DEFINITION LIST-TO-BV-ARRAY-AUX2))
     (5 4 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
     (5 3
        (:LINEAR LEN-POSITIVE-WHEN-CONSP-LINEAR-CHEAP))
     (3 3 (:REWRITE LEN-WHEN-BV-ARRAYP))
...
(NTHCDR-OF-LIST-TO-BV-ARRAY-AUX2
    ...
    (228 24 (:REWRITE CONSP-FROM-LEN-CHEAP))
...
(NTHCDR-OF-LIST-TO-BV-ARRAY-AUX2-CASE2
     (1363 182 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (857 112 (:REWRITE DEFAULT-CDR))
     (697 55 (:REWRITE DEFAULT-CAR))
     (391 294 (:REWRITE DEFAULT-<-2))
     (340 294 (:REWRITE DEFAULT-<-1))
     (322 308 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
     (302 302 (:REWRITE LEN-WHEN-BV-ARRAYP))
     (301 7 (:REWRITE BVCHOP-IDENTITY))
     ...
     (172 17
          (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-CONSP))
     (150 6 (:REWRITE USE-ALL-UNSIGNED-BYTE-P))
     (145 11 (:DEFINITION TRUE-LISTP))
     (134 6 (:REWRITE CAR-OF-NTHCDR))
     (132 6 (:DEFINITION MEMBER-EQUAL))
     (128 6 (:DEFINITION NTH))
