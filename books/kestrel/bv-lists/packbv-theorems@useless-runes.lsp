...
(LOGTAIL-OF-PACKBV-GEN
     (2391 283 (:LINEAR X*Y>1-POSITIVE))
     (1882 84 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
     (1781 117 (:DEFINITION EXPT))
     (1405 868 (:REWRITE DEFAULT-*-2))
     (1384 16 (:REWRITE <-UNARY-/-POSITIVE-RIGHT))
     (1260 53 (:REWRITE SLICE-TOO-HIGH-IS-0))
     (1021 955 (:REWRITE DEFAULT-<-1))
     (1012 868 (:REWRITE DEFAULT-*-1))
     (991 911 (:REWRITE DEFAULT-+-2))
     (963 955 (:REWRITE DEFAULT-<-2))
     (911 911 (:REWRITE DEFAULT-+-1))
     (776 2 (:REWRITE BVCHOP-OF-PACKBV))
     (628 86 (:REWRITE 0-<-*))
     (461 42
          (:REWRITE LOGTAIL-WHEN-NOT-POSP-ARG1))
     (375 26 (:REWRITE BVCHOP-IDENTITY))
     ...
     (130 130
          (:REWRITE EQUAL-CONSTANT-WHEN-BVCHOP-EQUAL-CONSTANT-FALSE))
     (124 34 (:REWRITE NUMERATOR-WHEN-INTEGERP))
     (116 58 (:REWRITE NATP-WHEN-POWER-OF-2P))
     ...
     (106 53
          (:REWRITE SLICE-WHEN-VAL-IS-NOT-AN-INTEGER))
     (90 18 (:REWRITE ZERO-IS-ONLY-ZERO-DIVISOR))
