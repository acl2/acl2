...
(ALL-UNSIGNED-BYTE-P-OF-LIST-TO-BV-ARRAY-AUX
     (208 4 (:DEFINITION LIST-TO-BV-ARRAY-AUX))
     (153 3
...
(ENDP-OF-BV-ARRAY-TO-LIST (4 2 (:REWRITE DEFAULT-<-2))
                          ...
                          (1 1
                             (:LINEAR LEN-POSITIVE-WHEN-CONSP-LINEAR-CHEAP)))
(INTEGER-LISTP-OF-BV-ARRAY-TO-LIST (2 1 (:REWRITE INTEGERP-WHEN-POWER-OF-2P))
                                   (1 1 (:TYPE-PRESCRIPTION POWER-OF-2P))
                                   (1 1 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
                                   (1 1 (:REWRITE LEN-WHEN-BV-ARRAYP))
                                   (1 1 (:REWRITE DEFAULT-<-2))
...
(BV-ARRAY-READ-OF-CDR
     (781 7 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
     (682 5 (:REWRITE NATP-OF-NTH-FROM-ALL-NATP))
     (588 8 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
     (569 13 (:DEFINITION NAT-LISTP))
     (285 3 (:REWRITE ALL-NATP-OF-CDR))
