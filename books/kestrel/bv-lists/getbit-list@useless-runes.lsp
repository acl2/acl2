(GETBIT-LIST (2 1 (:DEFINITION TRUE-LISTP))
...
(GETBIT-LIST-OF-BVCHOP-LIST
    (233 3 (:REWRITE CDR-OF-BVCHOP-LIST))
    (187 15 (:REWRITE BVCHOP-IDENTITY))
    (118 12 (:REWRITE BVCHOP-LIST-DOES-NOTHING))
    (92 3 (:REWRITE CAR-OF-BVCHOP-LIST))
    (70 9
        (:REWRITE USE-ALL-UNSIGNED-BYTE-P-FOR-CAR))
    (69 17
...
(ALL-UNSIGNED-BYTE-P-OF-GETBIT-LIST
     (106 3 (:DEFINITION ALL-UNSIGNED-BYTE-P))
     (82 13
         (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-CONSP))
