...
(UNPACKBV-OPENER (75 5 (:REWRITE SLICE-TOO-HIGH-IS-0))
...
(UNPACKBV-WHEN-NOT-INTEGERP
     (201 6 (:REWRITE SLICE-TOO-HIGH-IS-0))
...
(UNPACKBV-OF-1 (10 2 (:REWRITE BVCHOP-IDENTITY))
               ...
               (1 1 (:REWRITE DEFAULT-*-2))
               (1 1 (:REWRITE DEFAULT-*-1)))
(CAR-OF-UNPACKBV (16 2 (:REWRITE SLICE-WHEN-LOW-IS-NEGATIVE))
