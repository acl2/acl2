...
(BVCHOP-LIST-EXEC-DOES-NOTHING-REWRITE
 ...
 (33 11 (:REWRITE UNSIGNED-BYTE-P-OF-CAR-WHEN-UNSIGNED-BYTE-LISTP-2))
...
(BVCHOP-LIST
 (629 89 (:REWRITE USE-ALL-UNSIGNED-BYTE-P))
 (487 40 (:DEFINITION MEMBER-EQUAL))
 (468 36 (:DEFINITION EXPT))
 (445 366 (:REWRITE DEFAULT-CDR))
...
(BVCHOP-LIST-DOES-NOTHING
 (421 45 (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-CONSP))
 (411 40 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (322 26 (:REWRITE UNSIGNED-BYTE-P-OF-CAR-WHEN-ALL-UNSIGNED-BYTE-P))
 (317 26 (:REWRITE USE-ALL-UNSIGNED-BYTE-P-FOR-CAR))
 (179 34 (:REWRITE LEN-OF-CDR))
 (165 22 (:REWRITE ALL-UNSIGNED-BYTE-P-OF-CDR))
...
(ALL-UNSIGNED-BYTE-P-OF-BVCHOP-LIST
 (1698 24 (:DEFINITION ALL-UNSIGNED-BYTE-P))
 (1603 24 (:REWRITE BVCHOP-LIST-DOES-NOTHING))
 (1236 71 (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-CONSP))
 (768 56 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (722 39 (:REWRITE USE-ALL-UNSIGNED-BYTE-P))
 (683 6 (:DEFINITION MEMBER-EQUAL))
 (566 39 (:REWRITE ALL-UNSIGNED-BYTE-P-OF-CDR))
 (390 60 (:REWRITE LEN-OF-CDR))
 (240 9 (:REWRITE BVCHOP-IDENTITY))
 (205 28 (:REWRITE UNSIGNED-BYTE-P-OF-CAR-WHEN-ALL-UNSIGNED-BYTE-P))
 (200 1 (:REWRITE UNSIGNED-BYTE-P-OF-BVCHOP-WHEN-ALREADY))
...
(ALL-UNSIGNED-BYTE-P-OF-BVCHOP-LIST-GEN
 (1419 21 (:DEFINITION ALL-UNSIGNED-BYTE-P))
 (1315 20 (:REWRITE BVCHOP-LIST-DOES-NOTHING))
 (1180 65 (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-CONSP))
 (698 51 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (446 34 (:REWRITE ALL-UNSIGNED-BYTE-P-OF-CDR))
 (396 35 (:REWRITE USE-ALL-UNSIGNED-BYTE-P))
 (365 2 (:DEFINITION MEMBER-EQUAL))
 (345 51 (:REWRITE LEN-OF-CDR))
 (197 24 (:REWRITE UNSIGNED-BYTE-P-OF-CAR-WHEN-ALL-UNSIGNED-BYTE-P))
 (188 1 (:REWRITE UNSIGNED-BYTE-P-OF-BVCHOP-WHEN-ALREADY))
...
(NTHCDR-OF-BVCHOP-LIST
 (1362 33 (:REWRITE BVCHOP-LIST-DOES-NOTHING))
 (1265 126 (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-CONSP))
...
(CDR-OF-BVCHOP-LIST
 (259 7 (:REWRITE BVCHOP-LIST-DOES-NOTHING))
 (199 13 (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-CONSP))
 (184 18 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (83 9 (:REWRITE LEN-OF-CDR))
...
(BVCHOP-LIST-WHEN-CONSP
 (157 6 (:REWRITE BVCHOP-LIST-DOES-NOTHING))
 (107 15 (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-CONSP))
...
(NTHCDR-OF-BVCHOP-LIST-BETTER
 (4044 86 (:REWRITE BVCHOP-LIST-DOES-NOTHING))
 (3143 200 (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-CONSP))
 (2358 231 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (1170 7 (:REWRITE CDR-OF-BVCHOP-LIST))
 (988 103 (:REWRITE ALL-UNSIGNED-BYTE-P-OF-CDR))
 (985 163 (:REWRITE LEN-OF-CDR))
...
(EQUAL-OF-TRUE-LIST-FIX-AND-BVCHOP-LIST-SAME
 (1061 93 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (801 35 (:REWRITE BVCHOP-LIST-DOES-NOTHING))
 (499 23 (:DEFINITION TRUE-LISTP))
 (391 74 (:REWRITE LEN-OF-CDR))
 ...
 (70 3 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
 (69 23 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
 (61 21 (:REWRITE UNSIGNED-BYTE-P-OF-CAR-WHEN-UNSIGNED-BYTE-LISTP-2))
