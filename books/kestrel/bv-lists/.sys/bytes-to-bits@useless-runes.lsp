...
(NTH-OF-BYTES-TO-BITS
 (1499 1493 (:REWRITE DEFAULT-*-2))
 (1493 1493 (:REWRITE DEFAULT-*-1))
 (1037 59 (:REWRITE GETBIT-WHEN-N-IS-NEGATIVE))
 (460 34 (:REWRITE INTEGERP-OF-NTH-WHEN-ALL-INTEGERP))
 (429 39 (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
 (324 291 (:REWRITE DEFAULT-<-1))
 (302 291 (:REWRITE DEFAULT-<-2))
 (253 11 (:LINEAR MOD-BOUND-LINEAR-ARG1))
 (229 11 (:LINEAR MOD-BOUND-LINEAR-ARG2-STRONG))
 (229 11 (:LINEAR MOD-BOUND-LINEAR-ARG2))
 (156 39 (:REWRITE MULTIPLE-WHEN-MOD-0-CHEAP))
 (143 143 (:TYPE-PRESCRIPTION RATIONALP-OF-MOD))
...
(TAKE-OF-TIMES-8-AND-BYTES-TO-BITS
 ...
 (406 406 (:TYPE-PRESCRIPTION GETBIT))
