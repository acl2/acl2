...
(NTH-OF-GETBIT-LIST
 ...
 (118 22 (:REWRITE GETBIT-WHEN-VAL-IS-NOT-AN-INTEGER))
...
(GETBIT-LIST-OF-0-AND-GETBIT-LIST-OF-0
 (264 9 (:REWRITE BITP-BECOMES-UNSIGNED-BYTE-P))
 (99 9 (:REWRITE GETBIT-IDENTITY))
 (84 18 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (72 18 (:REWRITE USE-ALL-UNSIGNED-BYTE-P-FOR-CAR))
 (72 18 (:REWRITE UNSIGNED-BYTE-P-OF-CAR-WHEN-ALL-UNSIGNED-BYTE-P))
...
(GETBIT-LIST-OF-BVCHOP-LIST
 (265 3 (:REWRITE CDR-OF-BVCHOP-LIST))
 (107 29 (:REWRITE ALL-UNSIGNED-BYTE-P-OF-CDR))
...
(ALL-UNSIGNED-BYTE-P-OF-GETBIT-LIST
 (209 3 (:DEFINITION ALL-UNSIGNED-BYTE-P))
...
(GETBIT-LIST-OF-TRUE-LIST-FIX
 (89 11 (:REWRITE ALL-UNSIGNED-BYTE-P-OF-CDR))
 (87 9 (:REWRITE ALL-UNSIGNED-BYTE-P-OF-TRUE-LIST-FIX))
 (45 28 (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-CONSP))
 (43 8 (:REWRITE GETBIT-WHEN-N-IS-NEGATIVE))
 (40 1 (:REWRITE ALL-UNSIGNED-BYTE-P-OF-CONS))
