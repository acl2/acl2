...
(NTH-OF-GETBIT-LIST
 (193 22 (:REWRITE GETBIT-WHEN-VAL-IS-NOT-AN-INTEGER))
 (127 22 (:REWRITE GETBIT-WHEN-N-IS-NEGATIVE))
 (114 6 (:REWRITE INTEGERP-OF-NTH-WHEN-ALL-INTEGERP))
 (104 41 (:REWRITE DEFAULT-<-1))
 (60 9 (:REWRITE ALL-INTEGERP-WHEN-UNSIGNED-BYTE-LISTP-8))
...
(GETBIT-LIST-OF-0-AND-GETBIT-LIST-OF-0
 (327 9 (:REWRITE BITP-BECOMES-UNSIGNED-BYTE-P))
...
(GETBIT-LIST-OF-BVCHOP-LIST
 (361 3 (:REWRITE CDR-OF-BVCHOP-LIST))
 (120 29 (:REWRITE ALL-UNSIGNED-BYTE-P-OF-CDR))
 (120 11 (:REWRITE BVCHOP-LIST-WHEN-UNSIGNED-BYTE-LISTP))
 (96 11 (:REWRITE BVCHOP-LIST-DOES-NOTHING-BETTER))
 (96 11 (:REWRITE BVCHOP-LIST-DOES-NOTHING))
 (65 13 (:REWRITE UNSIGNED-BYTE-LISTP-OF-CDR))
 (48 48 (:TYPE-PRESCRIPTION UNSIGNED-BYTE-LISTP))
 (47 47 (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-UNSIGNED-BYTE-LISTP-CHEAP))
 (47 47 (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-INTEGERP-WIDTH))
 (47 47 (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NEGATIVE-WIDTH))
 ...
 (6 3 (:REWRITE CAR-OF-BVCHOP-LIST))
 (3 3 (:REWRITE CONSP-OF-BVCHOP-LIST))
 )
(ALL-UNSIGNED-BYTE-P-OF-GETBIT-LIST
 (236 3 (:DEFINITION ALL-UNSIGNED-BYTE-P))
...
(GETBIT-LIST-OF-TRUE-LIST-FIX
 ...
 (50 1 (:REWRITE ALL-UNSIGNED-BYTE-P-OF-CONS))
