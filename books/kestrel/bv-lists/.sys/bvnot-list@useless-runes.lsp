...
(BVNOT-LIST-OF-BVNOT-LIST
 (142 4 (:REWRITE BVCHOP-IDENTITY))
 (111 3 (:REWRITE UNSIGNED-BYTE-P-OF-IF))
...
(BVNOT-LIST-OF-BVCHOP-LIST
 ...
 (53 8 (:REWRITE BVCHOP-LIST-DOES-NOTHING-BETTER))
 (53 8 (:REWRITE BVCHOP-LIST-DOES-NOTHING))
