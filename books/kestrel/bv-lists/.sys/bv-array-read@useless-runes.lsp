...
(BV-ARRAY-READ-OF-BVCHOP-GEN
 (832 41 (:REWRITE BVCHOP-IDENTITY))
 (590 19 (:REWRITE UNSIGNED-BYTE-P-OF-CEILING-OF-LG-WHEN-<))
...
(BV-ARRAY-READ-OF-CONS-BASE
 (116 3 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
...
(BV-ARRAY-READ-SHORTEN-CORE
 ...
 (131 3 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
...
(BV-ARRAY-READ-OF-APPEND
 (1293 21 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
 (612 2 (:REWRITE UNSIGNED-BYTE-P-OF-+))
 (412 412 (:TYPE-PRESCRIPTION CEILING-OF-LG))
 (300 141 (:REWRITE DEFAULT-<-1))
 (294 2 (:REWRITE USB-PLUS-FROM-BOUNDS))
