...
(GETBIT-OF-BVNTH-WHEN-GETBIT-IS-ALWAYS-0
 (173 15 (:REWRITE BVCHOP-IDENTITY))
 (98 14 (:REWRITE UNSIGNED-BYTE-P-OF-NTH))
 (65 5 (:DEFINITION EXPT))
 (62 12 (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER))
...
(GETBIT-OF-BVNTH-WHEN-GETBIT-IS-ALWAYS-1
 (65 6 (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER))
 (61 1 (:REWRITE INTEGERP-OF-NTH-WHEN-ALL-INTEGERP))
 (47 8 (:REWRITE BVCHOP-IDENTITY))
