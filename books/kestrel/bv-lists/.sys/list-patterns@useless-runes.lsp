...
(GETBIT-OF-NTH-WHEN-GETBIT-IS-ALWAYS-0
 (49 3 (:REWRITE INTEGERP-OF-NTH-WHEN-ALL-INTEGERP))
 (30 15 (:REWRITE GETBIT-TOO-HIGH-CHEAP-2))
 (25 4 (:REWRITE ALL-INTEGERP-WHEN-UNSIGNED-BYTE-LISTP-8))
...
(GETBIT-OF-BVNTH-WHEN-GETBIT-IS-ALWAYS-0
 (257 15 (:REWRITE BVCHOP-IDENTITY))
 (132 12 (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER))
 (112 14 (:REWRITE UNSIGNED-BYTE-P-OF-NTH))
 (110 10 (:REWRITE INTEGERP-OF-NTH-WHEN-ALL-INTEGERP))
 (70 14 (:REWRITE UNSIGNED-BYTE-P-OF-NTH-WHEN-UNSIGNED-BYTE-LISTP-2))
...
(GETBIT-IS-ALWAYS-1-IMPLIES-ALL-INTEGERP
 (45 7 (:REWRITE ALL-INTEGERP-WHEN-UNSIGNED-BYTE-LISTP-8))
