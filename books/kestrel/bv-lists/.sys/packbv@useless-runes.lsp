...
(GETBIT-OF-PACKBV-1
 (1117 46 (:REWRITE GETBIT-OF-0-WHEN-BITP))
 (1029 42 (:REWRITE BITP-BECOMES-UNSIGNED-BYTE-P))
 (797 163 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (684 46 (:REWRITE GETBIT-IDENTITY))
 (505 24 (:REWRITE UNSIGNED-BYTE-P-OF-IF))
 (328 182 (:REWRITE DEFAULT-<-1))
 (292 70 (:REWRITE UNSIGNED-BYTE-P-OF-NTH))
 (230 34 (:REWRITE INTEGERP-OF-NTH-WHEN-ALL-INTEGERP))
 (197 163 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
 (182 182 (:REWRITE DEFAULT-<-2))
 (180 180 (:TYPE-PRESCRIPTION ALL-UNSIGNED-BYTE-P))
 ...
 (150 79 (:REWRITE GETBIT-WHEN-NOT-1))
 (117 23 (:REWRITE UNSIGNED-BYTE-P-OF-CAR-WHEN-ALL-UNSIGNED-BYTE-P))
 ...
 (109 23 (:REWRITE USE-ALL-UNSIGNED-BYTE-P-FOR-CAR))
 (100 90 (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-CONSP))
 (94 79 (:REWRITE GETBIT-WHEN-N-IS-NEGATIVE))
 ...
 (70 16 (:REWRITE ALL-UNSIGNED-BYTE-P-OF-CDR))
 ...
 (46 46 (:REWRITE UNSIGNED-BYTE-P-OF-0-ARG1))
...
(GETBIT-OF-PACKBV-TOO-HIGH
 ...
 (52 10 (:REWRITE GETBIT-WHEN-N-IS-NEGATIVE))
 ...
 (17 10 (:REWRITE GETBIT-WHEN-NOT-INTEGERP-ARG1))
