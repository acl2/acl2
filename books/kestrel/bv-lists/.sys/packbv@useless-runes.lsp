...
(LOGTAIL-OF-PACKBV-SIMPLE
 ...
 (1141 902 (:REWRITE DEFAULT-*-2))
 (1088 832 (:REWRITE DEFAULT-+-2))
 (906 902 (:REWRITE DEFAULT-*-1))
...
(PACKBV-OF-TRUE-LIST-FIX
 (2117 26 (:REWRITE BVCHOP-OF-PACKBV))
