...
(NTH-OF-BV-ARRAY-CLEAR-BETTER
 ...
 (372 1 (:REWRITE UPDATE-NTH2-TOO-HIGH))
 (264 4 (:REWRITE ALL-UNSIGNED-BYTE-P-OF-IF))
 (210 16 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
 (203 4 (:REWRITE BVCHOP-BOUND-2))
 (183 164 (:REWRITE DEFAULT-<-2))
...
(NTH-OF-BV-ARRAY-CLEAR-RANGE-LOW
 (217 20 (:REWRITE BVCHOP-IDENTITY))
 ...
 (37 25 (:REWRITE UNSIGNED-BYTE-LISTP-WHEN-NOT-CONSP))
