...
(UNSIGNED-BYTE-LISTP-OF-REVAPPEND
 ...
 (108 20 (:REWRITE ALL-UNSIGNED-BYTE-P-OF-TRUE-LIST-FIX))
 (100 52 (:TYPE-PRESCRIPTION TRUE-LISTP-REVAPPEND-TYPE-PRESCRIPTION))
 (84 20 (:REWRITE ALL-UNSIGNED-BYTE-P-OF-REVAPPEND))
 (64 52 (:REWRITE DEFAULT-CDR))
 (60 48 (:REWRITE DEFAULT-CAR))
 (52 52 (:TYPE-PRESCRIPTION REVAPPEND))
 (48 48 (:TYPE-PRESCRIPTION TRUE-LISTP))
...
(UNSIGNED-BYTE-LISTP-OF-BUTLAST
 (464 77 (:REWRITE UNSIGNED-BYTE-P-OF-CAR-WHEN-ALL-UNSIGNED-BYTE-P))
 (362 77 (:REWRITE USE-ALL-UNSIGNED-BYTE-P-FOR-CAR))
 (312 312 (:TYPE-PRESCRIPTION ALL-UNSIGNED-BYTE-P))
 (198 121 (:REWRITE DEFAULT-+-2))
 (185 185 (:REWRITE DEFAULT-CDR))
 (159 156 (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-CONSP))
 (156 156 (:REWRITE ALL-UNSIGNED-BYTE-P-FROM-ALL-UNSIGNED-BYTE-P-NARROWER))
 (128 121 (:REWRITE DEFAULT-+-1))
 (99 31 (:REWRITE ALL-UNSIGNED-BYTE-P-OF-CDR))
 ...
 (60 14 (:REWRITE ALL-UNSIGNED-BYTE-P-OF-TAKE))
...
(UNSIGNED-BYTE-P-OF-NTH-WHEN-UNSIGNED-BYTE-LISTP-2
 (88 10 (:REWRITE UNSIGNED-BYTE-P-OF-CAR-WHEN-UNSIGNED-BYTE-LISTP-2))
