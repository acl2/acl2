(BYTES-TO-BITS-OF-BVCHOP-LIST
 ...
 (2064 290 (:REWRITE GETBIT-IDENTITY))
 (1916 1915 (:REWRITE DEFAULT-CDR))
 (1583 118 (:REWRITE BVCHOP-LIST-DOES-NOTHING))
 ...
 (1344 274 (:REWRITE ALL-UNSIGNED-BYTE-P-OF-CDR))
 (855 855 (:TYPE-PRESCRIPTION ALL-UNSIGNED-BYTE-P))
 (768 72 (:REWRITE UNSIGNED-BYTE-P-OF-CAR-WHEN-ALL-UNSIGNED-BYTE-P))
 (736 118 (:REWRITE BVCHOP-LIST-WHEN-UNSIGNED-BYTE-LISTP))
 (712 712 (:TYPE-PRESCRIPTION UNSIGNED-BYTE-LISTP))
 (646 218 (:REWRITE UNSIGNED-BYTE-LISTP-OF-CDR))
 (590 428 (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-CONSP))
 (488 72 (:REWRITE USE-ALL-UNSIGNED-BYTE-P-FOR-CAR))
 (455 65 (:REWRITE BVCHOP-IDENTITY))
 (428 428 (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-UNSIGNED-BYTE-LISTP-CHEAP))
