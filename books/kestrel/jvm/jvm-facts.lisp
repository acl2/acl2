...
(defthm thread-classp-returns-false
  (implies (and (not (equal class-name "java.lang.Thread"))
                ...
                (not (member-equal "java.lang.Thread" (jvm::get-superclasses class-name class-table)))
                (not (member-equal "java.lang.ThreadGroup" (jvm::get-superclasses class-name class-table))) ;why?
                )
