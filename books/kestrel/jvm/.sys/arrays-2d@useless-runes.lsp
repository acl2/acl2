...
(EQUAL-OF-AD-AND-NTH-OF-GET-FIELD-SAME
 (509 19 (:REWRITE REFS-DIFFER-WHEN-ARRAY-DIMENSIONS-DIFFER))
 (454 6 (:DEFINITION GET-ARRAY-DIMENSIONS-OF-REF))
 (352 9 (:REWRITE GET-ARRAY-DIMENSIONS-OF-REF-AUX-UNROLL))
 ...
 (24 4 (:REWRITE MEMBERP-OF-CONS-IRREL-STRONG))
...
(ARRAY-REFP-OF-SET-FIELD-2D-WHEN-SET-ROW
 (189 1 (:REWRITE ARRAY-REFP-OF-SET-FIELD-CONTENTS-MAY-ALIAS))
 (159 1 (:DEFINITION SET::DELETE))
 (141 16 (:REWRITE REFS-DIFFER-WHEN-ARRAY-DIMENSIONS-DIFFER))
