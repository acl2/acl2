...
(EQUAL-OF-AD-AND-NTH-OF-GET-FIELD-SAME
 (511 15 (:REWRITE REFS-DIFFER-WHEN-ARRAY-DIMENSIONS-DIFFER))
 (457 6 (:DEFINITION GET-ARRAY-DIMENSIONS-OF-REF))
 (355 9 (:REWRITE GET-ARRAY-DIMENSIONS-OF-REF-AUX-UNROLL))
