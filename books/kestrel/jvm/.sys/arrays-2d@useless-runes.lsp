...
(EQUAL-OF-AD-AND-NTH-OF-GET-FIELD-SAME
 (485 19 (:REWRITE REFS-DIFFER-WHEN-ARRAY-DIMENSIONS-DIFFER))
 (433 6 (:DEFINITION GET-ARRAY-DIMENSIONS-OF-REF))
 (331 9 (:REWRITE GET-ARRAY-DIMENSIONS-OF-REF-AUX-UNROLL))
 (132 21 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (126 6 (:REWRITE GET-ARRAY-DIMENSIONS-OF-REF-AUX-BASE-2))
 (117 6 (:REWRITE EQUAL-OF-LEN-AND-0))
...
(LEN-OF-FIRST-ROW-CONTENTS-WHEN-ARRAY-REFP
 ...
 (68 1 (:REWRITE MEMBER-EQUAL-BECOMES-MEMBERP))
 (45 1 (:REWRITE MEMBERP-OF-CDR-WHEN-NOT-MEMBERP))
 (41 1 (:REWRITE MEMBERP-NTH-OF-SELF))
...
(ARRAY-REFP-OF-SET-FIELD-2D-WHEN-SET-ROW
 (191 1 (:REWRITE ARRAY-REFP-OF-SET-FIELD-CONTENTS-MAY-ALIAS))
 ...
 (43 1 (:REWRITE EQUAL-EQUAL-A-HEAD-HACK))
