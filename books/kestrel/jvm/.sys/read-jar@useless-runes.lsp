...
(EVENTS-FOR-CLASSES-FROM-ALIST
 (736 80 (:REWRITE BYTE-LISTP-OF-CDR))
 (480 141 (:REWRITE JVM::CONSP-OF-CAR-WHEN-FIELD-INFO-ALISTP))
 (318 318 (:TYPE-PRESCRIPTION JVM::FIELD-INFO-ALISTP))
 (295 56 (:REWRITE UNSIGNED-BYTE-P-OF-CAR-WHEN-ALL-UNSIGNED-BYTE-P))
 (194 51 (:REWRITE USE-ALL-UNSIGNED-BYTE-P-FOR-CAR))
 ...
 (84 58 (:REWRITE USE-ALL-UNSIGNED-BYTE-P))
