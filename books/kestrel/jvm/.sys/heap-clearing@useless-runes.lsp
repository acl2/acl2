...
(CLEAR-BINDING-OF-CONS
 (404 15 (:REWRITE CLEAR-BINDING-DOES-NOTHING))
 (82 16 (:DEFINITION STRIP-CARS))
...
(CLEAR-FIELD-OF-SET-FIELDS
 (297 11 (:REWRITE SET-FIELD-OF-GET-FIELD-SAME-ERIC-2))
 (234 9 (:REWRITE GET-FIELD-OF-SET-FIELDS))
...
(SET-FIELDS-OF-CLEAR-BINDING
 (265 8 (:REWRITE SET-FIELD-OF-GET-FIELD-SAME-ERIC-2))
 (214 8 (:REWRITE GET-FIELD-OF-SET-FIELDS))
 (52 52 (:TYPE-PRESCRIPTION MEMBERP))
 (49 9 (:DEFINITION STRIP-CARS))
 (42 41 (:REWRITE DEFAULT-CAR))
 (34 12 (:REWRITE SET-FIELDS-BASE-CASE))
 (28 4 (:REWRITE CLEAR-BINDING-DOES-NOTHING))
...
(CLEAR-FIELD-OF-SET-FIELDS-DIFF
 (164 7 (:REWRITE SET-FIELD-OF-GET-FIELD-SAME-ERIC-2))
 (130 5 (:REWRITE GET-FIELD-OF-SET-FIELDS))
...
(CLR-OF-CLEAR-FIELD)
(CLR-OF-SET-FIELDS
 (256 8 (:REWRITE SET-FIELD-OF-GET-FIELD-SAME-ERIC-2))
 (241 16 (:REWRITE CLR-WHEN-NOT-IN-RKEYS))
 (208 8 (:REWRITE GET-FIELD-OF-SET-FIELDS))
