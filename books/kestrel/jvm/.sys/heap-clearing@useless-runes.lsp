(CLR-OF-SET-FIELD
 (174 5 (:REWRITE CLR-WHEN-NOT-IN-RKEYS))
 (86 1 (:REWRITE RKEYS-S-TWO))
...
(EQUAL-SET-FIELD-DESTRUCT
 (323 15 (:REWRITE EQUAL-S-RECORD-EQUALITY))
 (265 5 (:DEFINITION SET::DELETE))
 (170 8 (:REWRITE S-SAME-G-STRONG))
...
(CLEAR-FIELD-OF-SET-FIELD-BOTH
 (2911 70 (:REWRITE CLR-WHEN-NOT-IN-RKEYS))
 (1525 36 (:REWRITE S-SAME-G-STRONG))
 (958 9 (:REWRITE RKEYS-S-TWO))
 (955 17 (:DEFINITION SET::DELETE))
 (815 12 (:REWRITE IN-OF-IF))
 (723 37 (:REWRITE SET::DELETE-IN))
 (574 34 (:REWRITE SET::DELETE-NONMEMBER-CANCEL))
 (548 8 (:REWRITE RKEYS-OF-CLR))
 (487 177 (:REWRITE SET::IN-TAIL))
 (482 6 (:REWRITE CLR-OVER-CLR))
...
(CLEAR-FIELD-OF-SET-FIELD-DIFF
 (2300 30 (:REWRITE EQUAL-S-RECORD-EQUALITY))
 (1972 32 (:DEFINITION SET::DELETE))
 (1196 65 (:REWRITE SET::DELETE-NONMEMBER-CANCEL))
 (918 292 (:REWRITE SET::IN-TAIL))
 (700 700 (:REWRITE SET::SUBSET-IN))
 (693 693 (:TYPE-PRESCRIPTION SET::EMPTYP-TYPE))
 (691 35 (:REWRITE S-SAME-G-STRONG))
 (600 32 (:REWRITE EQUAL-EQUAL-A-HEAD-HACK))
 (454 49 (:REWRITE SET::INSERT-IDENTITY))
 ...
 (172 1 (:REWRITE SET::DELETE-DELETE))
...
(CLEAR-FIELD-OF-S
 (160 3 (:REWRITE CLR-WHEN-NOT-IN-RKEYS))
 (86 1 (:REWRITE RKEYS-S-TWO))
 (55 1 (:REWRITE IN-OF-IF))
 (53 1 (:DEFINITION SET::DELETE))
...
(CLEAR-BINDING-OF-CONS
 (431 15 (:REWRITE CLEAR-BINDING-DOES-NOTHING))
...
(CLEAR-FIELD-OF-SET-FIELDS
 (325 11 (:REWRITE SET-FIELD-OF-GET-FIELD-SAME-ERIC-2))
...
(SET-FIELDS-OF-CLEAR-BINDING
 (295 8 (:REWRITE SET-FIELD-OF-GET-FIELD-SAME-ERIC-2))
...
(CLEAR-FIELD-OF-SET-FIELDS-DIFF
 (180 7 (:REWRITE SET-FIELD-OF-GET-FIELD-SAME-ERIC-2))
...
(CLR-OF-SET-FIELD-DIFF
 (226 7 (:REWRITE CLR-WHEN-NOT-IN-RKEYS))
