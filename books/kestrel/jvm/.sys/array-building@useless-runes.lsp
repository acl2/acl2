...
(JVM::HEAPP-OF-INITIALIZE-ONE-DIM-ARRAY
 (14 4 (:REWRITE SET-FIELD-OF-GET-FIELD-SAME-ERIC-2))
...
(JVM::G-OF-INITIALIZE-ONE-DIM-ARRAY
 (444 5 (:REWRITE CLR-WHEN-NOT-IN-RKEYS))
 (260 4 (:REWRITE RKEYS-S-TWO))
 (181 3 (:REWRITE IN-OF-IF))
 (149 5 (:REWRITE SET::IN-INSERT))
 (106 6 (:REWRITE SET::INSERT-IDENTITY))
 (96 2 (:DEFINITION SET::DELETE))
...
(JVM::GET-FIELD-OF-INITIALIZE-ONE-DIM-ARRAY-IRREL-FIELD
 ...
 (8 4 (:REWRITE GET-FIELD-OF-SET-FIELD-DIFF-2))
 (8 4 (:REWRITE GET-FIELD-OF-SET-FIELD-DIFF-1))
