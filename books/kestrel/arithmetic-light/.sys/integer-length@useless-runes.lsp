...
(<-OF-0-AND-INTEGER-LENGTH
 (41 2 (:DEFINITION INTEGER-LENGTH))
...
(INTEGER-LENGTH-OF-*-OF-EXPT2
 (694 6 (:REWRITE FLOOR-WHEN-<))
 (516 2 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
 (392 2 (:LINEAR EXPT-HALF-LINEAR))
 ...
 (98 12 (:REWRITE INTEGER-LENGTH-WHEN-NOT-INTEGERP-CHEAP))
...
(<-OF-INTEGER-LENGTH-ARG1
 ...
 (744 36 (:LINEAR EXPT-WHEN-NEGATIVE-EXPONENT-LINEAR-2))
...
(INTEGER-LENGTH-OF-+-OF--1-WHEN-POWER-OF-2
 (607 19 (:DEFINITION INTEGER-LENGTH))
 (237 237 (:TYPE-PRESCRIPTION EVENP))
 (201 38 (:REWRITE INTEGER-LENGTH-WHEN-NOT-INTEGERP-CHEAP))
 (196 16 (:LINEAR <-OF-EXPT-AND-EXPT-SAME-EXPONENTS-LINEAR))
 (195 3 (:REWRITE FLOOR-OF-ONE-LESS-GEN))
 ...
 (79 79 (:TYPE-PRESCRIPTION EXPT-TYPE-SMALL-BASE-NEGATIVE-EXPONENT))
 (76 20 (:REWRITE <-OF-INTEGER-LENGTH-ARG1))
...
(INTEGER-LENGTH-OF-+-OF--1-WHEN-NOT-POWER-OF-2
 (24046 22 (:REWRITE FLOOR-UNIQUE-EQUAL-VERSION))
 (13736 332 (:REWRITE <-OF-INTEGER-LENGTH-ARG2))
 (11998 1240 (:REWRITE FLOOR-WHEN-<))
 (9408 180 (:LINEAR <-OF-EXPT-AND-EXPT-SAME-EXPONENTS-LINEAR))
 (7493 165 (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
 (5440 140 (:REWRITE <-OF-INTEGER-LENGTH-ARG1))
 (4964 4964 (:TYPE-PRESCRIPTION <=-OF-FLOOR-AND-0-WHEN-NONPOSITIVE-AND-NONNEGATIVE-TYPE))
 (4964 4964 (:TYPE-PRESCRIPTION <=-OF-FLOOR-AND-0-WHEN-NONNEGATIVE-AND-NONPOSITIVE-TYPE))
 (4964 4964 (:TYPE-PRESCRIPTION <=-OF-0-AND-FLOOR-WHEN-BOTH-NONPOSITIVE-TYPE))
 (4964 4964 (:TYPE-PRESCRIPTION <-OF-FLOOR-AND-0-WHEN-POSITIVE-AND-NEGATIVE-TYPE))
 (4964 4964 (:TYPE-PRESCRIPTION <-OF-FLOOR-AND-0-WHEN-NEGATIVE-AND-POSITIVE-TYPE))
 (4753 90 (:LINEAR EXPT-WHEN-NEGATIVE-EXPONENT-LINEAR-2))
 (4152 180 (:LINEAR <-OF-EXPT-AND-EXPT-SAME-EXPONENTS-LINEAR-NEGATIVE-EXPONENT))
 (2790 2790 (:TYPE-PRESCRIPTION EVENP))
 (2252 2051 (:REWRITE DEFAULT-<-2))
 (2076 90 (:LINEAR EXPT-WHEN-NEGATIVE-EXPONENT-LINEAR-1))
 (2055 2051 (:REWRITE DEFAULT-<-1))
 (1891 1254 (:REWRITE FLOOR-WHEN-NOT-RATIONALP-OF-QUOTIENT))
 (1861 931 (:TYPE-PRESCRIPTION EXPT-TYPE-ODD-EXPONENT-NEGATIVE-BASE))
 (1861 931 (:TYPE-PRESCRIPTION EXPT-TYPE-EVEN-EXPONENT-2))
 (1861 931 (:TYPE-PRESCRIPTION EXPT-TYPE-EVEN-EXPONENT-1))
 (1854 258 (:REWRITE INTEGER-LENGTH-WHEN-NOT-INTEGERP-CHEAP))
 (1835 1240 (:REWRITE FLOOR-WHEN-NEGATIVE-AND-SMALL-CHEAP))
 (1835 1240 (:REWRITE FLOOR-WHEN-I-IS-NOT-AN-ACL2-NUMBERP))
 (1460 563 (:REWRITE DEFAULT-+-2))
 (1284 428 (:REWRITE <-OF-FLOOR-OF-CONSTANT-AND-CONSTANT-GEN))
 (1240 1240 (:REWRITE FLOOR-MINUS-NEGATIVE-CONSTANT))
 (1232 16 (:REWRITE <-OF-1-AND-INTEGER-LENGTH))
 (1106 1106 (:REWRITE FLOOR-WHEN-NOT-RATIONALP-ARG1))
 (1081 13 (:REWRITE <-OF-+-COMBINE-CONSTANTS-1))
 (1070 986 (:REWRITE DEFAULT-*-2))
 (1070 986 (:REWRITE DEFAULT-*-1))
 (990 563 (:REWRITE DEFAULT-+-1))
 (986 216 (:REWRITE EQUAL-OF-BOOLEANS-CHEAP))
 (931 931 (:TYPE-PRESCRIPTION EXPT-TYPE-SMALL-BASE-NEGATIVE-EXPONENT))
 (907 21 (:REWRITE MOD-WHEN-<))
 (483 21 (:REWRITE MOD-WHEN-MULTIPLE))
 (483 21 (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
 (396 74 (:REWRITE <-OF-0-AND-FLOOR))
 (252 42 (:REWRITE MULTIPLE-WHEN-MOD-0-CHEAP))
 (226 226 (:REWRITE EXPT-WHEN-NOT-ACL2-NUMBERP-CHEAP))
 (180 180 (:LINEAR <=-OF-EXPT-AND-EXPT-SAME-BASE-LINEAR))
 (180 180 (:LINEAR <-OF-EXPT-AND-EXPT-SAME-BASE-LINEAR))
 (152 152 (:LINEAR FLOOR-WEAK-MONOTONE-LINEAR=-2))
 (87 45 (:REWRITE MOD-WHEN-<-OF-0))
 (63 21 (:REWRITE MOD-WHEN-RATIONALP-ARG1-AND-NOT-RATIONALP-ARG2))
 (63 21 (:REWRITE MOD-WHEN-NOT-RATIONALP-ARG1-AND-RATIONALP-ARG2))
 (63 21 (:REWRITE MOD-WHEN-NOT-ACL2-NUMBERP-ARG1))
 (63 21 (:REWRITE MOD-OF-2-WHEN-EVEN-CHEAP))
 ...
 (18 18 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
 (18 18 (:LINEAR <-OF-*-SAME-LINEAR-2))
