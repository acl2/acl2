...
(FLOOR-OF-TIMES-2-EXPT
 ...
 (150 150 (:TYPE-PRESCRIPTION INTEGERP-OF-EXPT-TYPE))
...
(FLOOR-SHIFTING-LEMMA
 (4618 24 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
 (1711 11 (:REWRITE FLOOR-WHEN-<))
 (1692 9 (:REWRITE INTEGERP-OF-*-OF-/-WHEN-<-AND-NEGATIVE))
 (1478 28 (:LINEAR MY-FLOOR-LOWER-BOUND-LINEAR))
 (1370 28 (:LINEAR FLOOR-UPPER-BOUND-LINEAR))
 (1368 24 (:LINEAR *-OF-FLOOR-UPPER-BOUND-LINEAR))
 (632 28 (:LINEAR FLOOR-BOUND-ARG1-LINEAR))
 (624 24 (:LINEAR FLOOR-UPPER-BOUND-ALT-LINEAR))
 (622 28 (:LINEAR FLOOR-BOUND-STRICT-LINEAR))
 (565 145 (:REWRITE DEFAULT-<-2))
 (500 4 (:REWRITE <-OF-*-AND-0))
