...
(REM-OF-0-ARG1)
(REM-BECOMES-MOD
 (874 874 (:TYPE-PRESCRIPTION <=-OF-0-AND-FLOOR-WHEN-BOTH-NONPOSITIVE-TYPE))
 (874 874 (:TYPE-PRESCRIPTION <=-OF-0-AND-FLOOR-WHEN-BOTH-NONNEGATIVE-TYPE))
 (874 874 (:TYPE-PRESCRIPTION <-OF-FLOOR-AND-0-WHEN-POSITIVE-AND-NEGATIVE-TYPE))
 (732 60 (:LINEAR <-OF-*-SAME-LINEAR-2))
 (600 208 (:REWRITE DEFAULT-*-2))
 (427 208 (:REWRITE DEFAULT-*-1))
 (410 112 (:REWRITE DEFAULT-+-2))
 (398 6 (:REWRITE <-OF-+-COMBINE-CONSTANTS-2))
 (318 60 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
 (296 12 (:LINEAR MY-FLOOR-LOWER-BOUND-LINEAR))
 (284 99 (:REWRITE DEFAULT-UNARY-MINUS))
 (272 12 (:LINEAR FLOOR-UPPER-BOUND-LINEAR))
 (228 2 (:REWRITE <-OF-+-COMBINE-CONSTANTS-1))
 (222 208 (:REWRITE DEFAULT-<-1))
 (220 208 (:REWRITE DEFAULT-<-2))
 (201 201 (:TYPE-PRESCRIPTION INTEGERP-OF-MOD-TYPE))
 (156 12 (:LINEAR FLOOR-BOUND-ARG1-LINEAR))
 (140 46 (:REWRITE MOD-WHEN-<-OF-0))
 (124 110 (:REWRITE FLOOR-WHEN-<))
 (120 120 (:LINEAR <-OF-*-AND-*-LINEAR))
 (112 112 (:REWRITE DEFAULT-+-1))
 (110 110 (:REWRITE FLOOR-WHEN-NOT-RATIONALP-OF-QUOTIENT))
 (110 110 (:REWRITE FLOOR-WHEN-NOT-RATIONALP-ARG1))
 (110 110 (:REWRITE FLOOR-WHEN-NEGATIVE-AND-SMALL-CHEAP))
 (110 110 (:REWRITE FLOOR-WHEN-I-IS-NOT-AN-ACL2-NUMBERP))
 (110 110 (:REWRITE FLOOR-MINUS-NEGATIVE-CONSTANT))
 (93 93 (:TYPE-PRESCRIPTION <=-OF-FLOOR-WHEN-<-TYPE))
 (76 16 (:REWRITE INTEGERP-OF-*-OF-/-WHEN-<-AND-MIXED-1))
 (64 64 (:LINEAR <=-OF-/-LINEAR))
 (63 16 (:REWRITE INTEGERP-OF-*-OF-/-WHEN-<-AND-MIXED-2))
 (60 60 (:LINEAR <-OF-*-WHEN-<-OF-CONSTANT-AND-<-OF-CONSTANT-LINEAR))
 ...
 (40 24 (:LINEAR <=-OF-*-OF-/-WHEN-NEGATIVE-LINEAR))
 (40 24 (:LINEAR <=-OF-*-OF-/-WHEN-NEGATIVE-AND-POSITIVE-LINEAR))
 (40 24 (:LINEAR <=-OF-*-OF-/-WHEN-BOTH-NONNEGATIVE-LINEAR))
 (38 32 (:REWRITE MOD-WHEN-<))
 (38 16 (:REWRITE INTEGERP-OF-*-OF-/-WHEN-<-AND-NEGATIVE-ALT))
...
(REM-X-Y-=-X-BETTER
 ...
 (73 31 (:REWRITE DEFAULT-UNARY-MINUS))
 ...
 (26 12 (:REWRITE FLOOR-WHEN-<))
 (25 15 (:LINEAR <=-OF-*-OF-/-WHEN-NEGATIVE-LINEAR))
