...
(REM-BECOMES-MOD
 ...
 (1170 1170 (:TYPE-PRESCRIPTION FLOOR-TYPE-NON-NEGATIVE))
 (724 40 (:LINEAR MY-FLOOR-LOWER-BOUND-LINEAR))
 (652 40 (:LINEAR FLOOR-UPPER-BOUND-LINEAR))
 (556 40 (:LINEAR FLOOR-BOUND-ARG1-LINEAR))
 (399 191 (:REWRITE DEFAULT-*-2))
 (346 4 (:REWRITE <-OF-+-COMBINE-CONSTANTS-1))
 (330 184 (:REWRITE DEFAULT-<-2))
 (319 191 (:REWRITE DEFAULT-*-1))
 (233 97 (:REWRITE DEFAULT-+-2))
 (200 98 (:REWRITE DEFAULT-UNARY-MINUS))
 (199 173 (:REWRITE FLOOR-WHEN-<))
 (197 173 (:REWRITE FLOOR-WHEN-NOT-RATIONALP-OF-QUOTIENT))
 (194 184 (:REWRITE DEFAULT-<-1))
 (180 180 (:TYPE-PRESCRIPTION INTEGERP-OF-MOD-TYPE))
 (177 173 (:REWRITE FLOOR-WHEN-I-IS-NOT-AN-ACL2-NUMBERP))
 (173 173 (:REWRITE FLOOR-WHEN-NOT-RATIONALP-ARG1))
 (173 173 (:REWRITE FLOOR-WHEN-NEGATIVE-AND-SMALL-CHEAP))
 (173 173 (:REWRITE FLOOR-MINUS-NEGATIVE-CONSTANT))
 ...
 (44 40 (:LINEAR FLOOR-BOUND-STRICT-LINEAR))
