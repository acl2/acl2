...
(EQUAL-OF-*-AND-CONSTANT
 (68 15 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
 (68 15 (:LINEAR <-OF-*-SAME-LINEAR-2))
...
(<-OF-*-WHEN-<-OF-CONSTANT-AND-<-OF-CONSTANT-LINEAR
 ...
 (3 1 (:REWRITE <-OF-*-AND-*-SAME-HELPER))
 (3 1 (:REWRITE <-OF-*-AND-*-CANCEL))
