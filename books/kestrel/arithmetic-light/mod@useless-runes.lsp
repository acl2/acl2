...
(MOD-OF-MOD-WHEN-MULT
     ...
     (35848 35848
            (:TYPE-PRESCRIPTION FLOOR-TYPE-NON-NEGATIVE))
     (34545 4937 (:REWRITE DEFAULT-<-2))
     (29965 68 (:REWRITE |(< (if a b c) x)|))
     (28561 319
     ...
     (5445 5445
           (:REWRITE REMOVE-WEAK-INEQUALITIES-TWO))
     (5369 5369 (:REWRITE |(< (- x) (- y))|))
     (5157 4937 (:REWRITE DEFAULT-<-1))
     (4844 4844
     ...
     (1424 1424 (:TYPE-PRESCRIPTION NATP))
