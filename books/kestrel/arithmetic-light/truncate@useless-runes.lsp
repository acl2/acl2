...
(<=-OF-TRUNCATE-SAME-LINEAR
 (43 43 (:TYPE-PRESCRIPTION <=-OF-TRUNCATE-AND-0-WHEN-NONPOSITIVE-AND-NONPOSITIVE-TYPE))
...
(TRUNCATE-BECOMES-FLOOR-GEN1
 (32 4 (:REWRITE NONNEGATIVE-INTEGER-QUOTIENT-WHEN-<))
 (28 4 (:REWRITE <-OF-NUMERATOR-AND-DENOMINATOR-SAME))
...
(TRUNCATE-BECOMES-FLOOR-GEN2
 ...
 (12 6 (:REWRITE NONNEGATIVE-INTEGER-QUOTIENT-WHEN-<))
...
(TRUNCATE-BECOMES-FLOOR-OTHER
 (32 6 (:REWRITE NONNEGATIVE-INTEGER-QUOTIENT-WHEN-<))
 (20 3 (:REWRITE <-OF-NUMERATOR-AND-DENOMINATOR-SAME))
