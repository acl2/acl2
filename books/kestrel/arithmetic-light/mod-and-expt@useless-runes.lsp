...
(MOD-EXPT-SPLIT2
     (1291 15 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
     (603 603
...
(MOD-OF-HALF-AND-EXPT-OF-ONE-LESS
     ...
     (1000 14 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
...
(MOD-OF-HALF-AND-EXPT-OF-ONE-LESS-ALT
     (450 6 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
...
(MOD-OF-*-OF-EXPT-AND-EXPT-BOUND
     ...
     (2173 16 (:REWRITE MOD-X-Y-=-X . 3))
     (1914 16 (:REWRITE CANCEL-MOD-+))
     (1538 16 (:REWRITE MOD-ZERO . 3))
     (1287 15 (:REWRITE MOD-WHEN-<))
     (1121 4 (:REWRITE |(equal (* x y) 0)|))
