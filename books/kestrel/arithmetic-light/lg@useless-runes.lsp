...
(LG-OF-EXPT (2 2 (:REWRITE DEFAULT-<-2))
            ...
            (2 2 (:REWRITE DEFAULT-+-1)))
(LG-OF-BOTH-SIDES)
(EQUAL-OF-EXPT-AND-CONSTANT (39 39 (:TYPE-PRESCRIPTION NATP-OF-EXPT))
                            (2 2 (:REWRITE DEFAULT-<-2))
                            (2 2 (:REWRITE DEFAULT-<-1)))
(EQUAL-OF-0-AND-LG (13 1 (:DEFINITION INTEGER-LENGTH))
...
(NATP-OF-LG (2 2 (:REWRITE DEFAULT-<-2))
            (2 2 (:REWRITE DEFAULT-<-1))
            (2 1 (:REWRITE DEFAULT-+-2))
            (1 1 (:REWRITE DEFAULT-+-1)))
(POSP-OF-LG (7 7 (:REWRITE DEFAULT-<-2))
...
(<-OF-EXPT-2-OF-LG-SAME-LINEAR
   ...
   (1 1 (:REWRITE DEFAULT-<-2))
   (1 1 (:REWRITE DEFAULT-<-1)))
(<-OF-LG-AND-0 (2 1 (:REWRITE DEFAULT-+-2))
               (1 1 (:REWRITE DEFAULT-+-1)))
(LG-OF-*-OF-1/2 (10 5 (:REWRITE DEFAULT-+-2))
