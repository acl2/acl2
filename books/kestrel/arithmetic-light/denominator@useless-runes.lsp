...
(EQUAL-OF-1-AND-DENOMINATOR (1 1 (:REWRITE INTEGERP==>DENOMINATOR=1))
                            (1 1 (:REWRITE DENOMINATOR-WHEN-INTEGERP))
                            (1 1 (:REWRITE DEFAULT-DENOMINATOR)))
(DENOMINATOR-OF-/-WHEN-INTEGERP (33 24 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
...
(DENOMINATOR-OF-- (5 5 (:REWRITE DENOMINATOR-WHEN-INTEGERP))
...
(<=-OF-DENOMINATOR-OF-*-OF-/ (3 2 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
                             ...
                             (1 1 (:REWRITE DEFAULT-DENOMINATOR)))
(DENOMINATOR-OF-*-OF---ARG2 (5 3 (:REWRITE DEFAULT-*-2))
