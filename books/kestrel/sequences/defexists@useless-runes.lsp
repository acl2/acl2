...
(GENERIC-EXISTS-OF-CDR (39 5 (:REWRITE CONSP-FROM-LEN-CHEAP))
...
(GENERIC-EXISTS-OF-NTHCDR
     (904 55 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (641 38 (:REWRITE DEFAULT-CDR))
     (418 28 (:REWRITE LEN-OF-CDR))
...
(GENERIC-EXISTS-OF-FIRSTN (962 56 (:REWRITE CONSP-FROM-LEN-CHEAP))
                          (594 64 (:REWRITE LEN-OF-CDR))
                          (585 49 (:REWRITE DEFAULT-CDR))
                          (264 22 (:REWRITE LEN-OF-FIRSTN))
                          (199 137 (:REWRITE DEFAULT-<-2))
                          (141 137 (:REWRITE DEFAULT-<-1))
                          (136 11 (:REWRITE FIRSTN-BECOMES-TAKE))
                          ...
                          (40 14 (:REWRITE EQUAL-OF-LEN-AND-0))
                          (30 30
                              (:REWRITE CONSP-OF-CDR-WHEN-LEN-KNOWN))
...
(GENERIC-EXISTS-OF-TAKE (1958 57 (:REWRITE TAKE-DOES-NOTHING))
                        (746 82 (:REWRITE DEFAULT-CDR))
...
(GENERIC-EXISTS-OF-TRUE-LIST-FIX
     (763 43 (:REWRITE GENERIC-EXISTS-OF-CDR))
     (551 42 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (293 34 (:REWRITE DEFAULT-CDR))
     (168 15 (:REWRITE LEN-OF-CDR))
     (88 67 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
     (84 28
         (:LINEAR LEN-POSITIVE-WHEN-CONSP-LINEAR-CHEAP))
     (61 28 (:REWRITE DEFAULT-<-2))
     (53 15 (:REWRITE EQUAL-OF-LEN-AND-0))
...
(GENERIC-EXISTS-OF-REVERSE-LIST
     (1061 61 (:REWRITE GENERIC-EXISTS-OF-CDR))
     (816 59 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (370 53 (:REWRITE DEFAULT-CDR))
     ...
     (76 20 (:REWRITE EQUAL-OF-LEN-AND-0))
...
(GENERIC-EXISTS-OF-REMOVE1
     (1017 65 (:REWRITE GENERIC-EXISTS-OF-CDR))
     (841 79 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (481 133 (:REWRITE DEFAULT-CDR))
     (301 28
          (:REWRITE GENERIC-EXISTS-WHEN-NOT-CONSP))
     (300 42 (:REWRITE LEN-OF-CDR))
     ...
     (54 20 (:REWRITE EQUAL-OF-LEN-AND-0))
     (42 42 (:REWRITE DEFAULT-+-1))
     (38 38
         (:REWRITE CONSP-OF-CDR-WHEN-LEN-KNOWN))
...
(GENERIC-EXISTS-OF-REMOVE-EQUAL
     (1199 65 (:REWRITE GENERIC-EXISTS-OF-CDR))
     (1006 78 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (545 121 (:REWRITE DEFAULT-CDR))
     (369 28
          (:REWRITE GENERIC-EXISTS-WHEN-NOT-CONSP))
     (343 43 (:REWRITE LEN-OF-CDR))
     ...
     (81 65
         (:REWRITE GENERIC-PREDICATE-WHEN-GENERIC-EXISTS))
     (74 20 (:REWRITE EQUAL-OF-LEN-AND-0))
     ...
     (12 4 (:REWRITE FOLD-CONSTS-IN-+))
     (1 1 (:REWRITE CDR-CONS)))
(GENERIC-EXISTS-WHEN-PERM (607 39 (:REWRITE GENERIC-EXISTS-OF-CDR))
                          (603 55 (:REWRITE CONSP-FROM-LEN-CHEAP))
                          (275 65 (:REWRITE DEFAULT-CDR))
                          ...
                          (42 14 (:REWRITE EQUAL-OF-LEN-AND-0))
...
(GENERIC-EXISTS-OF-SUBRANGE
     (1895 40 (:REWRITE GENERIC-EXISTS-OF-CDR))
     (1581 12 (:REWRITE CDR-OF-TAKE))
     (1247 28 (:REWRITE TAKE-DOES-NOTHING))
     (931 21 (:REWRITE LEN-OF-CDR))
     (815 25 (:REWRITE DEFAULT-CDR))
