...
(GENERIC-EXISTS-OF-TAKE (2078 57 (:REWRITE TAKE-DOES-NOTHING))
                        (753 82 (:REWRITE DEFAULT-CDR))
...
(GENERIC-EXISTS-OF-REVERSE-LIST
     (1063 61 (:REWRITE GENERIC-EXISTS-OF-CDR))
     (818 59 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (371 53 (:REWRITE DEFAULT-CDR))
...
(GENERIC-EXISTS-OF-REMOVE1
     (1021 65 (:REWRITE GENERIC-EXISTS-OF-CDR))
     (845 79 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (483 133 (:REWRITE DEFAULT-CDR))
     (301 28
          (:REWRITE GENERIC-EXISTS-WHEN-NOT-CONSP))
...
(GENERIC-EXISTS-OF-REMOVE-EQUAL
     (1203 65 (:REWRITE GENERIC-EXISTS-OF-CDR))
     (1010 78 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (547 121 (:REWRITE DEFAULT-CDR))
     (369 28
          (:REWRITE GENERIC-EXISTS-WHEN-NOT-CONSP))
...
(GENERIC-EXISTS-OF-SUBRANGE
     (1898 40 (:REWRITE GENERIC-EXISTS-OF-CDR))
     (1584 12 (:REWRITE CDR-OF-TAKE))
