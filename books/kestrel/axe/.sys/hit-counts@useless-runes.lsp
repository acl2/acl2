...
(ALISTP-OF-SUBTRACT-HIT-COUNT-ALISTS
 (7205 52 (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
 (7201 68 (:REWRITE DEFAULT-+-1))
 (7115 19 (:REWRITE USE-ALL-CDRS-RATIONALP-FOR-CAR))
 (7000 23 (:REWRITE ALL-CDRS-RATIONALP-WHEN-HIT-COUNT-ALISTP))
 (6946 27 (:DEFINITION HIT-COUNT-ALISTP))
 (4525 56 (:DEFINITION SYMBOL-ALISTP))
 (2531 257 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (1570 48 (:DEFINITION NAT-LISTP))
 (1406 110 (:REWRITE SYMBOL-ALISTP-OF-CDR))
 (989 69 (:DEFINITION STRIP-CDRS))
 (954 4 (:REWRITE ALL-CDRS-RATIONALP-OF-CDR))
 (934 4 (:REWRITE HIT-COUNT-ALISTP-OF-CDR))
