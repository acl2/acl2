...
(ALL-<-OF-STRIP-CDRS-OF-MAKE-DAG-VARIABLE-ALIST-AUX
 (1724 37 (:REWRITE ALL-<-TRANSITIVE-FREE-2))
 (848 22 (:DEFINITION NAT-LISTP))
 (797 13 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
 (636 52 (:DEFINITION STRIP-CDRS))
 (494 13 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
 (491 26 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (488 126 (:REWRITE DEFAULT-CDR))
 (458 29 (:REWRITE ALL-<-WHEN-NOT-CONSP))
 (263 26 (:REWRITE ALL-NATP-WHEN-NOT-CONSP))
 (180 84 (:REWRITE USE-ALL-<))
 (160 160 (:TYPE-PRESCRIPTION NAT-LISTP))
 (156 52 (:REWRITE CONSP-OF-CAR-WHEN-PSEUDO-DAGP))
 (146 20 (:REWRITE USE-ALL-<-FOR-CAR))
 (132 20 (:REWRITE USE-ALL-NATP-FOR-CAR))
...
(MAKE-DAG-VARIABLE-ALIST-OF-ASET1-EXPANDABLE
 ...
 (32 4 (:DEFINITION MAKE-DAG-VARIABLE-ALIST-AUX))
