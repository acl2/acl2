...
(ALL-<-OF-STRIP-CDRS-OF-MAKE-DAG-VARIABLE-ALIST-AUX
 (2079 37 (:REWRITE ALL-<-TRANSITIVE-FREE-2))
 (988 22 (:DEFINITION NAT-LISTP))
 (966 13 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
 (946 128 (:REWRITE DEFAULT-CDR))
 (727 29 (:REWRITE ALL-<-WHEN-NOT-CONSP))
 (540 26 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (539 13 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
 (381 26 (:REWRITE ALL-NATP-WHEN-NOT-CONSP))
...
(MAKE-DAG-VARIABLE-ALIST-AUX-OF-ASET1-EXPANDABLE
 (1262 1250 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
 ...
 (104 80 (:REWRITE AREF1-WHEN-TOO-LARGE-CHEAP))
...
(<-OF-CDR-OF-ASSOC-EQUAL-OF-MAKE-DAG-VARIABLE-ALIST-AUX
 (104 2 (:DEFINITION MAKE-DAG-VARIABLE-ALIST-AUX))
