(BOUNDED-DARG-LISTP-WHEN-<-OF-LARGEST-NON-QUOTEP
 (3965 33 (:REWRITE <-OF-LARGEST-NON-QUOTEP))
 (2954 98 (:REWRITE BOUNDED-DARG-LISTP-OF-CDR))
 (2367 86 (:REWRITE USE-ALL-NATP-FOR-CAR))
 (2125 90 (:DEFINITION NATP))
 (2021 48 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (1895 61 (:DEFINITION NAT-LISTP))
 (1721 55 (:REWRITE DARGP-LESS-THAN-WHEN-NOT-CONSP-CHEAP))
 (1554 146 (:REWRITE USE-ALL-<-FOR-CAR))
 (855 9 (:LINEAR LARGEST-NON-QUOTEP-BOUND))
 (538 16 (:REWRITE ALL-DARGP-OF-CDR))
 (489 9 (:LINEAR LARGEST-NON-QUOTEP-BOUND-ALT))
 (477 12 (:REWRITE ALL-NATP-OF-CDR))
 ...
 (195 153 (:REWRITE BOUNDED-DARG-LISTP-MONOTONE))
