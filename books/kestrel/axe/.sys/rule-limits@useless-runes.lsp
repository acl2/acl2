...
(INTEGERP-OF-CDR-OF-ASSOC-EQUAL-WHEN-RULE-LIMITSP
 ...
 (100 24 (:REWRITE DEFAULT-CDR))
 (88 72 (:REWRITE DEFAULT-CAR))
 (68 2 (:REWRITE CONSP-OF-ASSOC-EQUAL))
...
(LIMIT-REACHEDP
 ...
 (351 7 (:REWRITE PSEUDO-TERMP-OF-STORED-RULE-RHS))
 (247 7 (:REWRITE PSEUDO-TERM-LISTP-OF-STORED-RULE-LHS-ARGS))
 (236 118 (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP-TYPE))
 (233 7 (:REWRITE BOUND-VARS-SUITABLE-FOR-HYPSP-OF-VAR-IN-TERMS-OF-STORED-RULE-LHS-ARGS-AND-STORED-RULE-HYPS))
 (230 7 (:REWRITE AXE-RULE-HYP-LISTP-OF-STORED-RULE-HYPS))
 (219 2 (:REWRITE SYMBOLP-OF-STORED-RULE-SYMBOL))
...
(DECREMENT-RULE-LIMIT
 (8745 77 (:DEFINITION PSEUDO-TERMP))
 (3861 77 (:REWRITE PSEUDO-TERMP-OF-STORED-RULE-RHS))
 (3082 1541 (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP-TYPE))
 (2717 77 (:REWRITE PSEUDO-TERM-LISTP-OF-STORED-RULE-LHS-ARGS))
 (2563 77 (:REWRITE BOUND-VARS-SUITABLE-FOR-HYPSP-OF-VAR-IN-TERMS-OF-STORED-RULE-LHS-ARGS-AND-STORED-RULE-HYPS))
 (2530 77 (:REWRITE AXE-RULE-HYP-LISTP-OF-STORED-RULE-HYPS))
 (2409 22 (:REWRITE SYMBOLP-OF-STORED-RULE-SYMBOL))
 (2079 231 (:DEFINITION LENGTH))
 (2024 374 (:DEFINITION LEN))
 (1913 1913 (:TYPE-PRESCRIPTION SYMBOL-TERM-ALISTP))
 (1885 1611 (:REWRITE DEFAULT-CDR))
 ...
 (262 10 (:REWRITE CONSP-OF-ASSOC-EQUAL))
 ...
 (77 77 (:REWRITE PSEUDO-TERMP-OF-LAMBDA-BODY-CHEAP))
