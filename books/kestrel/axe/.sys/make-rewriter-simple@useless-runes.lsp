...
(PSEUDO-DAG-ARRAYP-OF-+-OF-1-AND-LARGEST-NON-QUOTEP-OF-CAR
 ...
 (216 1 (:LINEAR LARGEST-NON-QUOTEP-BOUND-ALT))
...
(BOUNDED-AXE-TREEP-WHEN-BOUNDED-DAG-EXPRP
 (6534 24 (:REWRITE BOUNDED-DARG-LISTP-WHEN-ALL-<))
 (6420 33 (:REWRITE ALL-<-TRANSITIVE-FREE-2))
 (5603 32 (:DEFINITION NAT-LISTP))
 (3460 16 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
 (2984 31 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (2745 16 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
 (2196 175 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (1880 22 (:REWRITE BOUNDED-DARG-LISTP-OF-DARGS-WHEN-<-SIMPLE))
 (1624 28 (:REWRITE NATP-OF-NTH-WHEN-DARG-LISTP))
 (1436 22 (:REWRITE BOUNDED-DARG-LISTP-WHEN-BOUNDED-DAG-EXPRP))
 (1436 22 (:REWRITE BOUNDED-DARG-LISTP-OF-DARGS-WHEN-BOUNDED-DAG-EXPRP))
 (1360 28 (:REWRITE NATP-OF-NTH-OF-DARGS))
 ...
 (366 11 (:DEFINITION MEMBER-EQUAL))
 (354 90 (:REWRITE DARG-LISTP-OF-DARGS-WHEN-POSSIBLY-NEGATED-NODENUMP))
 (349 104 (:REWRITE <-WHEN-BOUNDED-DARG-LISTP-GEN))
 ...
 (252 36 (:REWRITE CAR-OF-DARGS-BECOMES-NTH-0-OF-DARGS))
 ...
 (134 5 (:REWRITE QUOTE-LEMMA-FOR-BOUNDED-DARG-LISTP-GEN-ALT))
