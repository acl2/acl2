...
(<-OF-NTH-OF-0-AND-0-WHEN-ALL-NATP-CHEAP
 (184 2 (:DEFINITION ALL-NATP))
 (178 8 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (166 4 (:DEFINITION NAT-LISTP))
 (109 5 (:REWRITE USE-ALL-NATP-FOR-CAR))
...
(NATP-OF-MAXELEM-2
 ...
 (520 17 (:REWRITE USE-ALL-NATP-FOR-CAR))
 (382 8 (:DEFINITION ALL-NATP))
 ...
 (130 16 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
