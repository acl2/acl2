...
(BITOR-TRIM-ARG1-AXE
 ...
 (7 3 (:REWRITE BITOR-WHEN-X-IS-NOT-AN-INTEGER))
...
(BITOR-TRIM-ARG2-AXE
 (27 1 (:REWRITE BVCHOP-IDENTITY))
 (14 1 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (12 5 (:REWRITE BITOR-WHEN-Y-IS-NOT-AN-INTEGER))
 (11 5 (:REWRITE BITOR-WHEN-X-IS-NOT-AN-INTEGER))
...
(RIGHTROTATE32-TRIM-ARG1-AXE)
(RIGHTROTATE32-TRIM-ARG1-AXE-ALL)
