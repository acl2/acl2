...
(LOGEXT-TRIM-ARG-AXE-ALL
 (1694 56 (:REWRITE LOGEXT-WHEN-NON-NEGATIVE-BECOMES-BVCHOP))
 (1092 24 (:DEFINITION EXPT))
 (918 56 (:REWRITE LOGEXT-WHEN-TOP-BIT-0))
 (635 49 (:REWRITE LOGEXT-WHEN-SIGNED-BYTE-P))
 (480 20 (:REWRITE ZIP-OPEN))
 (363 11 (:REWRITE SIGNED-BYTE-P-WHEN-TOP-BIT-0))
 (256 7 (:REWRITE GETBIT-OF-BVCHOP-BOTH))
