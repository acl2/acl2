...
(LOGEXT-CONVERT-ARG2-TO-BV-AXE
 (864 12 (:REWRITE LOGEXT-WHEN-SIGNED-BYTE-P))
 (841 11 (:DEFINITION SIGNED-BYTE-P))
 (691 23 (:DEFINITION EXPT))
 (613 19 (:REWRITE LOGEXT-WHEN-TOP-BIT-0))
 (412 11 (:DEFINITION INTEGER-RANGE-P))
...
(BV-ARRAY-READ-CONVERT-ARG3-TO-BV-AXE
 (31 1 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
 (30 3 (:DEFINITION LEN))
 (26 1 (:REWRITE BVCHOP-IDENTITY))
 (17 1 (:REWRITE <-OF-CEILING-OF-LG-ARG2-WHEN-CONSTANT))
 (16 1 (:REWRITE UNSIGNED-BYTE-P-OF-CEILING-OF-LG-WHEN-<))
