(LEN-OF-CADAR-WHEN-PSEUDO-TERMP
 (311 32 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (139 3 (:DEFINITION SYMBOL-LISTP))
 (129 61 (:REWRITE DEFAULT-CAR))
 (101 5 (:REWRITE USE-ALL-CONSP-FOR-CAR))
 (88 49 (:REWRITE DEFAULT-CDR))
...
(LEN-OF-CADAR-WHEN-AXE-TREEP
 (9587 6 (:DEFINITION AXE-TREE-LISTP))
 (8239 35 (:DEFINITION PSEUDO-TERMP))
 (8050 21 (:REWRITE AXE-TREE-LISTP-OF-CDR-2))
 (7467 21 (:REWRITE AXE-TREE-LISTP-OF-CDR))
 (4276 19 (:REWRITE AXE-TREEP-WHEN-PSEUDO-TERMP))
 (4083 388 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (2217 45 (:DEFINITION SYMBOL-LISTP))
 (1793 27 (:REWRITE AXE-TREE-LISTP-WHEN-PSEUDO-TERM-LISTP))
 (1709 27 (:DEFINITION PSEUDO-TERM-LISTP))
 (1561 98 (:REWRITE USE-ALL-CONSP-FOR-CAR))
 (1299 9 (:REWRITE AXE-TREEP-OF-CAR))
 (1272 724 (:REWRITE DEFAULT-CAR))
 (1044 656 (:REWRITE DEFAULT-CDR))
 (943 943 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
 (942 942 (:REWRITE LEN-WHEN-DARGP-LESS-THAN))
 (941 19 (:REWRITE AXE-TREEP-WHEN-DARGP))
 (896 105 (:DEFINITION LENGTH))
 (866 173 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
 (764 27 (:REWRITE AXE-TREE-LISTP-WHEN-ALL-DARGP))
 (762 281 (:LINEAR LEN-POSITIVE-WHEN-CONSP-LINEAR-CHEAP))
...
(PSEUDO-TERMP-OF-CADDDR-WHEN-AXE-TREEP
 (784 2 (:REWRITE AXE-TREE-LISTP-OF-CDR))
 (633 57 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (427 2 (:REWRITE AXE-TREEP-WHEN-PSEUDO-TERMP))
