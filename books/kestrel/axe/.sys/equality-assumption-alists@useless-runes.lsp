...
(TERM-LIST-TO-TERM-ALISTP-OF-ACONS
 (762 5 (:DEFINITION PSEUDO-TERMP))
 (269 15 (:DEFINITION LEN))
...
(PAIRS-TO-EQUALITY-ASSUMPTION-ALIST
 (1155 10 (:DEFINITION TERM-LIST-TO-TERM-ALISTP))
 (672 36 (:DEFINITION LEN))
