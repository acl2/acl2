...
(APPLY-TACTIC-REWRITE-WITH-PRECISE-CONTEXTS
 ...
 (757 88 (:REWRITE DEFAULT-CAR))
 (686 686 (:TYPE-PRESCRIPTION ALL-NATP))
 (468 6 (:REWRITE PSEUDO-DAGP-OF-MV-NTH-1-OF-SIMPLIFY-TERM-BASIC))
...
(LOOKUP-NODES-IN-COUNTEREXAMPLE
 (55544 281 (:DEFINITION NAT-LISTP))
 (46862 71 (:REWRITE ALL-<-OF-STRIP-CARS-OF-CDR))
 (38990 35 (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
 (38357 1276 (:REWRITE DEFAULT-+-2))
 (34986 46 (:REWRITE RATIONALP-WHEN-NATP))
 (33995 37 (:REWRITE <-OF-MAXELEM-WHEN-ALL-<))
 (33621 781 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (32853 768 (:REWRITE STRIP-CARS-OF-NON-CONSP))
 (31113 715 (:REWRITE NAT-LISTP-WHEN-ALL-NATP))
 (29282 775 (:REWRITE ALL-NATP-WHEN-NOT-CONSP))
 (28173 19 (:REWRITE NOT-<-OF-CAR-WHEN-ALL-<-2))
 (27383 319 (:REWRITE ALL-<-TRANSITIVE-FREE-2))
 (26906 241 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
 (25514 223 (:REWRITE USE-ALL-<-FOR-CAR))
 (24737 241 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
 (19996 7 (:REWRITE <-OF-+-AND-+-COMBINE-CONSTANTS))
 (17700 322 (:REWRITE EQUAL-OF-+-WHEN-NEGATIVE-CONSTANT))
 (15278 7647 (:TYPE-PRESCRIPTION RATIONALP-OF-CAR-WHEN-RATIONAL-LISTP-CHEAP))
 (13341 4 (:REWRITE NOT-<-OF-MAXELEM-WHEN-ALL-<))
 (13076 19 (:REWRITE USE-ALL-<=-FOR-CAR))
 (12792 10 (:REWRITE ALL-<=-WHEN-<=-AND-DECREASINGP))
 (10117 60 (:REWRITE ALL-<-OF-CONS))
 (9354 27 (:REWRITE ALL-NATP-OF-CONS))
 (9271 219 (:REWRITE MAXELEM-SINGLETON-ALT))
 (7681 325 (:REWRITE USE-ALL-NATP-FOR-CAR))
 (4997 3199 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
 (4872 1012 (:REWRITE DEFAULT-<-1))
 (4566 36 (:REWRITE RATIONALP-OF-CAR-OF-CAR))
 (4388 4388 (:TYPE-PRESCRIPTION NAT-LISTP))
 (4189 4 (:REWRITE NATP-OF-MAXELEM-2))
 (3819 317 (:REWRITE ALL-<-WHEN-NOT-CONSP))
 (3729 176 (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
 (3565 16 (:REWRITE INTEGER-LISTP-WHEN-ALL-NATP))
 (3516 8 (:REWRITE ACL2-NUMBERP-OF-MAXELEM))
 ...
 (1860 4 (:REWRITE NATP-OF-MAXELEM-OF-STRIP-CARS-WHEN-COUNTEREXAMPLEP))
 (1780 644 (:TYPE-PRESCRIPTION INTEGERP-OF-NTH-WHEN-ALL-NATP))
 (1719 1309 (:REWRITE DEFAULT-CDR))
 (1659 1659 (:REWRITE CONSP-WHEN-LEN-EQUAL-CONSTANT))
 (1635 4 (:REWRITE NOT-<-OF-MAXELEM-WHEN-ALL-<-2))
 (1604 1015 (:REWRITE <-TRANS))
 (1562 781 (:REWRITE ALL-NATP-WHEN-NAT-LISTP-CHEAP))
 (1307 3 (:REWRITE NATP-OF-+-WHEN-NATP-AND-NATP))
 ...
 (933 7 (:REWRITE NOT-<-OF-MAXELEM-AND-0))
 (909 7 (:REWRITE INTEGERP-OF-IF))
 ...
 (708 12 (:REWRITE INTEGERP-OF-MAXELEM2))
 (702 6 (:REWRITE INTEGERP-OF-+-WHEN-INTEGERP-1-CHEAP))
 (684 335 (:DEFINITION FIX))
