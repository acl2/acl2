...
(CONSP-OF-MERGE-CDR-<
 (343 24 (:REWRITE CONSP-FROM-LEN-CHEAP))
...
(PRINT-SYMBOLS-4-PER-LINE
 (11910 586 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (5239 581 (:REWRITE DEFAULT-CDR))
 (3476 158 (:REWRITE LEN-OF-NTHCDR))
 (2104 190 (:REWRITE LEN-OF-CDR))
...
(TABULATE-DAG-FNS)
(PRINT-DAG-INFO
 (391 20 (:REWRITE CONSP-FROM-LEN-CHEAP))
