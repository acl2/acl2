...
(AXE-TREE-LISTP-OF-LOOKUP-ARGS-IN-RESULT-ARRAY
 (1965 11 (:REWRITE AXE-TREEP-WHEN-PSEUDO-TERMP))
 (1922 11 (:DEFINITION PSEUDO-TERMP))
 (1051 5 (:REWRITE AXE-TREE-LISTP-OF-CDR))
 (640 30 (:DEFINITION LENGTH))
 (535 45 (:DEFINITION LEN))
...
(BOUNDED-AXE-TREE-LISTP-OF-LOOKUP-ARGS-IN-RESULT-ARRAY
 (270 5 (:DEFINITION PSEUDO-TERM-LISTP))
