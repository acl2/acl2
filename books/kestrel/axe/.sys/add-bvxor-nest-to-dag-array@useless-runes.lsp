...
(ADD-BVXOR-NEST-TO-DAG-ARRAY
 (3536 46 (:REWRITE ALL-<-OF-CONS))
 (1322 95 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (1247 19 (:DEFINITION NAT-LISTP))
 (1229 26 (:REWRITE NATP-WHEN-BOUNDED-DARG-LISTP-GEN))
 (861 65 (:REWRITE USE-ALL-<-FOR-CAR))
 (724 135 (:REWRITE ALL-<-TRANSITIVE-FREE-2))
 (620 120 (:REWRITE <-WHEN-BOUNDED-DARG-LISTP-GEN))
 (538 8 (:REWRITE <-OF-CAR-AND-ALEN1))
 (483 4 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (443 193 (:REWRITE DEFAULT-CAR))
 (368 120 (:REWRITE DEFAULT-<-1))
 (266 19 (:REWRITE ALL-<-OF-CDR))
 (232 60 (:REWRITE USE-ALL-CONSP-FOR-CAR))
 (212 8 (:REWRITE <-OF-CAR-AND-ALEN1-WHEN-PSEUDO-DAG-ARRAYP-LIST))
 (195 105 (:REWRITE ALL-<-WHEN-NOT-CONSP))
 (182 1 (:REWRITE ALL-NATP-OF-CDR))
...
(TYPE-OF-ADD-BVXOR-NEST-TO-DAG-ARRAY
 (4554 40 (:REWRITE ALL-<-OF-CONS))
 (3113 162 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (2170 28 (:DEFINITION NAT-LISTP))
 (1601 325 (:REWRITE DEFAULT-CAR))
 (1335 57 (:REWRITE USE-ALL-<-FOR-CAR))
 (1218 29 (:REWRITE NATP-WHEN-BOUNDED-DARG-LISTP-GEN))
 (1070 186 (:REWRITE <-WHEN-BOUNDED-DARG-LISTP-GEN))
 (947 8 (:REWRITE <-OF-CAR-AND-ALEN1))
 (921 17 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (824 121 (:REWRITE ALL-<-TRANSITIVE-FREE-2))
 (597 186 (:REWRITE DEFAULT-<-1))
 (522 28 (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
 (392 17 (:REWRITE ALL-<-OF-CDR))
 (366 9 (:REWRITE ALL-NATP-OF-CDR))
...
(DARGP-OF-MV-NTH-1-OF-ADD-BVXOR-NEST-TO-DAG-ARRAY
 (4424 37 (:REWRITE ALL-<-OF-CONS))
 (2169 27 (:DEFINITION NAT-LISTP))
 (1931 118 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (1323 53 (:REWRITE USE-ALL-<-FOR-CAR))
 (1218 29 (:REWRITE NATP-WHEN-BOUNDED-DARG-LISTP-GEN))
 (947 8 (:REWRITE <-OF-CAR-AND-ALEN1))
 (918 16 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
...
(DARGP-LESS-THAN-OF-MV-NTH-1-OF-ADD-BVXOR-NEST-TO-DAG-ARRAY
 (5042 50 (:REWRITE ALL-<-OF-CONS))
 (2273 33 (:DEFINITION NAT-LISTP))
 (2246 133 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (1423 71 (:REWRITE USE-ALL-<-FOR-CAR))
 (1233 36 (:REWRITE NATP-WHEN-BOUNDED-DARG-LISTP-GEN))
 (1061 145 (:REWRITE ALL-<-TRANSITIVE-FREE-2))
 (975 163 (:REWRITE <-WHEN-BOUNDED-DARG-LISTP-GEN))
 (961 19 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (960 12 (:REWRITE <-OF-CAR-AND-ALEN1))
 (883 272 (:REWRITE DEFAULT-CAR))
 (605 163 (:REWRITE DEFAULT-<-1))
 (392 17 (:REWRITE ALL-<-OF-CDR))
 (366 9 (:REWRITE ALL-NATP-OF-CDR))
 (275 68 (:REWRITE USE-ALL-CONSP-FOR-CAR))
 (274 12 (:REWRITE <-OF-CAR-AND-ALEN1-WHEN-PSEUDO-DAG-ARRAYP-LIST))
