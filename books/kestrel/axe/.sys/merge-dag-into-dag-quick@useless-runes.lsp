...
(DARGP-LESS-THAN-OF-MV-NTH-1-OF-MERGE-DAG-INTO-DAG-QUICK
 ...
 (4949 57 (:DEFINITION NAT-LISTP))
 (3604 596 (:REWRITE DEFAULT-CAR))
 (3261 73 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (3003 78 (:REWRITE USE-ALL-<-FOR-CAR))
 (2593 73 (:REWRITE ALL-NATP-WHEN-NOT-CONSP))
 (1972 54 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
 (907 75 (:REWRITE ALL-<-WHEN-NOT-CONSP))
