...
(INSTANTIATE-HYP
 (6718 319 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (1616 32 (:DEFINITION STRIP-CDRS))
 (1584 86 (:REWRITE LEN-OF-CDR))
 (1531 306 (:REWRITE DEFAULT-CDR))
 (1172 586 (:REWRITE LEN-WHEN-DARGP-CHEAP))
 (1119 477 (:REWRITE DEFAULT-CAR))
 (864 32 (:REWRITE DARG-LISTP-WHEN-NOT-CONSP))
 (654 590 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
 (586 586 (:TYPE-PRESCRIPTION DARGP))
 ...
 (287 65 (:REWRITE CONSP-OF-CAR-WHEN-PSEUDO-DAGP))
 (274 274 (:REWRITE LEN-OF-CAR-WHEN-ITEMS-HAVE-LEN-STRONG))
 (274 274 (:REWRITE LEN-OF-CAR-WHEN-ITEMS-HAVE-LEN))
 ...
 (186 93 (:REWRITE SYMBOL-ALISTP-WHEN-SYMBOL-TERM-ALISTP-CHEAP))
 (180 10 (:REWRITE LEN-OF-MV-NTH-1-OF-INSTANTIATE-HYP-LST))
 (168 92 (:REWRITE EQUAL-OF-BOOLEANS-CHEAP))
