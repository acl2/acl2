...
(NTH-OF-PLUS-OF-BV-AND-MINUS
 ...
 (122 4 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
...
(REPEAT-OF-PLUS-OF-BV-AND-MINUS
 (626 6 (:REWRITE UNSIGNED-BYTE-P-OF-+))
 (605 25 (:DEFINITION EXPT))
 (317 12 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
 (262 2 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR-2))
 (232 1 (:LINEAR BVCHOP-UPPER-BOUND-LINEAR-STRONG))
 (229 1 (:LINEAR BVCHOP-UPPER-BOUND-LINEAR))
 (186 6 (:REWRITE USB-PLUS-FROM-BOUNDS))
 (160 35 (:REWRITE COMMUTATIVITY-OF-+))
 (115 25 (:REWRITE ZIP-OPEN))
...
(FIRSTN-OF-+-OF-MINUS
 (1031 11 (:REWRITE BVCHOP-IDENTITY))
 (962 8 (:DEFINITION TAKE))
 (928 39 (:DEFINITION EXPT))
 (885 16 (:REWRITE TAKE-WHEN-<-OF-LEN))
 (756 47 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
 (733 2 (:REWRITE FIRSTN-WHEN-<=-OF-LEN))
 (576 11 (:REWRITE UNSIGNED-BYTE-P-OF-+))
 (400 155 (:REWRITE BOUND-WHEN-USB))
 (336 28 (:DEFINITION LEN))
 (326 11 (:REWRITE USB-PLUS-FROM-BOUNDS))
 (282 226 (:REWRITE DEFAULT-+-2))
 (238 183 (:REWRITE DEFAULT-<-2))
 (236 226 (:REWRITE DEFAULT-+-1))
 (229 183 (:REWRITE DEFAULT-<-1))
 (219 39 (:REWRITE ZIP-OPEN))
