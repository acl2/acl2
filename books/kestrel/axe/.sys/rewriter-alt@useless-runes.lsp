...
(POPULATE-EQUALITY-ARRAY
 (13352 43 (:REWRITE AXE-TREEP-OF-CAR))
 (12605 15 (:DEFINITION AXE-TREE-LISTP))
 (11542 59 (:REWRITE AXE-TREEP-WHEN-DARGP))
 (10440 33 (:REWRITE AXE-TREE-LISTP-OF-CDR))
 (10297 37 (:DEFINITION DARGP))
 (10071 8 (:DEFINITION AXE-TREEP))
 (9541 57 (:DEFINITION PSEUDO-TERMP))
 (6449 112 (:DEFINITION NAT-LISTP))
 (5404 100 (:REWRITE USE-ALL-<-FOR-CAR))
 (4676 244 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (3842 148 (:REWRITE USE-ALL-NATP-FOR-CAR))
 (3622 33 (:REWRITE AXE-TREE-LISTP-OF-CDR-2))
 (2833 88 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
 (1830 88 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
 (1799 65 (:REWRITE AXE-TREE-LISTP-WHEN-PSEUDO-TERM-LISTP))
 (1794 61 (:DEFINITION SYMBOL-LISTP))
 (1733 82 (:DEFINITION PSEUDO-TERM-LISTP))
 (1718 80 (:REWRITE ALL-NATP-OF-CDR))
 (1596 236 (:REWRITE NAT-LISTP-WHEN-ALL-NATP))
 (1488 301 (:REWRITE SET::EMPTY-SET-UNIQUE))
 (1341 57 (:DEFINITION MYQUOTEP))
 (1275 1275 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
 (1275 153 (:DEFINITION LENGTH))
 (1146 57 (:DEFINITION QUOTEP))
 (1113 65 (:REWRITE AXE-TREE-LISTP-WHEN-ALL-DARGP))
 (974 16 (:REWRITE ALL-<-OF-CDR))
 (765 228 (:REWRITE JVM::CONSP-OF-CAR-WHEN-FIELD-INFO-ALISTP))
 (643 301 (:REWRITE EQUAL-OF-BOOLEANS-CHEAP))
 (625 625 (:REWRITE WFR-HACK5))
 (625 625 (:REWRITE CAR-OF-CAR-WHEN-PSEUDO-DAGP-AUX))
 (592 244 (:REWRITE ALL-NATP-WHEN-NOT-CONSP))
 (583 11 (:REWRITE BOUNDED-AXE-TREEP-OF-CAR))
 ...
 (354 9 (:REWRITE BOUNDED-AXE-TREE-LISTP-WHEN-PSEUDO-TERM-LISTP))
 ...
 (271 136 (:REWRITE SYMBOLP-OF-CAR-WHEN-AXE-TREEP-CHEAP))
