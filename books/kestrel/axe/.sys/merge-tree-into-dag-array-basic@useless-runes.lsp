...
(FLAG-LEMMA-FOR-MERGE-TREE-INTO-DAG-ARRAY-BASIC-RETURN-TYPE
 (200138 343 (:REWRITE AXE-TREEP-OF-CAR))
 ...
 (72073 2370 (:DEFINITION LENGTH))
 (70168 1350 (:REWRITE ALL-<-OF-CDR))
 (61207 2599 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
 (53838 2599 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
 (49107 1009 (:DEFINITION PSEUDO-TERM-LISTP))
 (45279 4436 (:DEFINITION MEMBER-EQUAL))
 (44259 3594 (:REWRITE NATP-WHEN-BOUNDED-DARG-LISTP-GEN))
 (43513 629 (:REWRITE AXE-TREE-LISTP-WHEN-PSEUDO-TERM-LISTP))
 (41757 32493 (:REWRITE DEFAULT-CAR))
 (36359 32453 (:REWRITE DEFAULT-CDR))
 (30744 2149 (:REWRITE USE-ALL-CONSP-FOR-CAR))
 (22176 22176 (:TYPE-PRESCRIPTION MEMBER-EQUAL))
 (19272 19272 (:REWRITE USE-ALL-CONSP-2))
 (19272 19272 (:REWRITE USE-ALL-CONSP))
 ...
 (9811 4905 (:REWRITE DEFAULT-+-2))
 (9101 9101 (:REWRITE CAR-OF-CAR-WHEN-PSEUDO-DAGP-AUX))
 (8676 8676 (:REWRITE LEN-WHEN-PSEUDO-DAGP-AUX))
 (8676 8676 (:REWRITE LEN-WHEN-DARGP-LESS-THAN))
 (8676 8676 (:REWRITE LEN-WHEN-BOUNDED-DAG-EXPRP-AND-QUOTEP))
 ...
 (7559 7559 (:TYPE-PRESCRIPTION PSEUDO-TERM-LISTP))
 ...
 (4377 34 (:REWRITE BOUNDED-AXE-TREE-LISTP-WHEN-PSEUDO-TERM-LISTP))
 ...
 (2772 2772 (:REWRITE TERMP-IMPLIES-PSEUDO-TERMP))
 ...
 (2129 1637 (:REWRITE <-WHEN-BOUNDED-DARG-LISTP-GEN))
 ...
 (767 767 (:REWRITE DEFAULT-COERCE-2))
 (767 767 (:REWRITE DEFAULT-COERCE-1))
 ...
 (139 42 (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(MERGE-TREE-INTO-DAG-ARRAY-BASIC
 (102464 96 (:REWRITE AXE-TREEP-OF-CAR))
 (85054 22 (:DEFINITION AXE-TREEP))
 (84876 112 (:REWRITE AXE-TREE-LISTP-OF-CDR))
 (82782 52 (:DEFINITION AXE-TREE-LISTP))
 (81501 112 (:REWRITE AXE-TREE-LISTP-OF-CDR-2))
 ...
 (2726 1366 (:REWRITE DEFAULT-+-2))
 (2600 446 (:REWRITE ALL-CONSP-OF-CDR))
 (2462 906 (:REWRITE ALL-<-WHEN-NOT-CONSP))
 (2384 2384 (:REWRITE LEN-WHEN-PSEUDO-DAGP-AUX))
 (2384 2384 (:REWRITE LEN-WHEN-DARGP-LESS-THAN))
 (2384 2384 (:REWRITE LEN-WHEN-BOUNDED-DAG-EXPRP-AND-QUOTEP))
 ...
 (1924 41 (:REWRITE BOUNDED-AXE-TREE-LISTP-WHEN-PSEUDO-TERM-LISTP))
 ...
 (199 199 (:REWRITE DEFAULT-COERCE-2))
 (199 199 (:REWRITE DEFAULT-COERCE-1))
