...
(NAT-LISTP-OF-MV-NTH-1-OF-SPLIT-LIST-FAST-AUX
 ...
 (694 75 (:REWRITE USE-ALL->=-FOR-CAR))
 (303 303 (:TYPE-PRESCRIPTION ALL-<))
 (273 185 (:REWRITE DEFAULT-CDR))
 (208 23 (:REWRITE ALL-<-OF-CDR))
 (206 100 (:REWRITE ALL-<-WHEN-NOT-CONSP))
 (204 98 (:REWRITE ALL->=-WHEN-NOT-CONSP))
 (196 196 (:TYPE-PRESCRIPTION ALL->=))
 (196 102 (:REWRITE DEFAULT-CAR))
...
(ALL-<-OF-MERGE-SORT->-AND-REMOVE-DUPS
 (25734 194 (:REWRITE ALL-<-WHEN-NOT-CONSP))
 (22511 675 (:REWRITE ZP-OPEN))
 (9954 2135 (:REWRITE DEFAULT-+-2))
 (8052 671 (:REWRITE <-OF-0-AND-FLOOR))
 ...
 (263 263 (:REWRITE NOT-ALL-<-WHEN-MEMBERP))
 (263 263 (:REWRITE NOT-ALL-<-WHEN-MEMBER-EQUAL))
 ...
 (34 34 (:REWRITE ALL-<-OF-TAKE-WHEN-ALL-<-OF-TAKE))
