...
(ALL-NATP-OF-GET-UNEXAMINED-NODENUM-ARGS
 ...
 (954 17 (:DEFINITION NAT-LISTP))
 (348 18 (:REWRITE USE-ALL-<-FOR-CAR))
 (199 18 (:REWRITE USE-ALL-NATP-FOR-CAR))
 (198 7 (:REWRITE ALL-<-OF-GET-UNEXAMINED-NODENUM-ARGS))
 (144 40 (:REWRITE NAT-LISTP-WHEN-ALL-NATP-CHEAP))
 (142 142 (:TYPE-PRESCRIPTION NAT-LISTP))
 (105 105 (:TYPE-PRESCRIPTION GET-UNEXAMINED-NODENUM-ARGS))
