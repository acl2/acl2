...
(ASSUMPTION-ARRAYP-AUX-OF-EXPAND-ARRAY-HELPER
 (19468 18392 (:REWRITE DEFAULT-CDR))
 ...
 (1244 1244 (:REWRITE USE-ALL-CONSP-2))
 (1244 1244 (:REWRITE USE-ALL-CONSP))
...
(BOUNDED-DARG-LISTP-OF-MAYBE-REPLACE-ARGS-USING-ASSUMPTION-ARRAY
 (672 72 (:REWRITE ALL-<-WHEN-NOT-CONSP))
