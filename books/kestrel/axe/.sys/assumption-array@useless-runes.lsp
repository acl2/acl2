...
(<-OF-IF-ARG1-ALT)
(ASSUMPTION-ARRAYP-AUX-OF-NEW-ARRAY1-WITH-DEFAULT
...
(ASSUMPTION-ARRAYP-OF-NEW-ARRAY1-WITH-DEFAULT
...
(ASSUMPTION-ARRAYP-OF-NEW-ARRAY1
 (4 4 (:REWRITE USE-ALL-<-2))
 (4 4 (:REWRITE USE-ALL-<))
 (4 4 (:REWRITE DEFAULT-<-2))
 (4 4 (:REWRITE DEFAULT-<-1))
...
(BOUNDED-DARG-LISTP-OF-MAYBE-REPLACE-ARGS-USING-ASSUMPTION-ARRAY
 ...
 (16 1 (:REWRITE <-OF-MAYBE-REPLACE-NODENUM-USING-ASSUMPTION-ARRAY))
