(FIXUP-POSSIBLY-NEGATED-NODENUMS
 (4710 108 (:REWRITE USE-ALL-<-FOR-CAR))
 (4117 149 (:DEFINITION NAT-LISTP))
 (3287 186 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (3214 173 (:REWRITE USE-ALL-NATP-FOR-CAR))
 (1678 114 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
 (1403 113 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
 (1384 65 (:REWRITE ALL-<-OF-CDR))
 (996 530 (:TYPE-PRESCRIPTION TRUE-LISTP-OF-AREF1-WHEN-DAG-PARENT-ARRAYP))
 (851 851 (:TYPE-PRESCRIPTION NAT-LISTP))
 (755 66 (:REWRITE ALL-NATP-OF-CDR))
