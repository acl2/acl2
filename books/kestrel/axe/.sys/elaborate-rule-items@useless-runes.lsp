(RULE-ITEMP)
(RULE-ITEM-LISTP)
(RULE-ITEM-LISTP-OF-UNION-EQUAL
 (92 40 (:REWRITE SYMBOLP-OF-CAR-WHEN-SYMBOL-LISTP-CHEAP))
...
(RULE-ITEM-LISTP-FORWARD-TO-TRUE-LISTP
 (15 3 (:DEFINITION LEN))
 (10 10 (:REWRITE DEFAULT-CDR))
 (10 5 (:DEFINITION TRUE-LISTP))
 (9 6 (:REWRITE SYMBOLP-OF-CAR-WHEN-SYMBOL-LISTP-CHEAP))
