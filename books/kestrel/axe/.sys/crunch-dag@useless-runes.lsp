...
(CRUNCH-DAG-ARRAY-AUX
 ...
 (1421 7 (:REWRITE BOUNDED-DARG-LISTP-WHEN-ALL-<))
 (1360 14 (:REWRITE ALL-<-TRANSITIVE-FREE-2))
 (1127 12 (:DEFINITION NAT-LISTP))
 (850 425 (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-AREF1))
 (661 6 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
 (593 6 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
 (578 10 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
