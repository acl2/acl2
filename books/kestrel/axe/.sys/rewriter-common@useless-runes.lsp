...
(AXE-TREE-LISTP-OF-CONS-IF-NOT-EQUAL-CAR
 (3074 9 (:REWRITE AXE-TREEP-WHEN-PSEUDO-TERMP))
 (3038 9 (:DEFINITION PSEUDO-TERMP))
 (1420 64 (:REWRITE CONSP-FROM-LEN-CHEAP))
 ...
 (97 6 (:REWRITE AXE-TREE-LISTP-WHEN-PSEUDO-TERM-LISTP))
 (80 4 (:DEFINITION PSEUDO-TERM-LISTP))
 (67 6 (:REWRITE AXE-TREE-LISTP-WHEN-DARG-LISTP))
...
(ALIST-SUITABLE-FOR-HYPSP-OF-ALIST-SUITABLE-FOR-HYPSP-OF-CAR
 (1566 76 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (551 36 (:REWRITE DEFAULT-CDR))
 (499 50 (:REWRITE DEFAULT-CAR))
 (460 4 (:DEFINITION ASSOC-KEYWORD))
 (457 21 (:REWRITE LEN-OF-CDR))
 (212 106 (:REWRITE LEN-WHEN-DARGP-CHEAP))
 (208 4 (:DEFINITION ASSOC-EQUAL))
 (172 2 (:REWRITE INTERSECTION-EQUAL-WHEN-SUBSETP-EQUAL))
 (166 2 (:DEFINITION SUBSETP-EQUAL))
 (147 3 (:DEFINITION STRIP-CARS))
 (140 2 (:REWRITE INTERSECTION-EQUAL-WHEN-NOT-INTERSECTION-EQUAL-OF-CDR-ARG2-IFF))
 ...
 (77 1 (:REWRITE ALL-<-WHEN-NOT-CONSP))
 (76 76 (:REWRITE CONSP-WHEN-LEN-EQUAL-CONSTANT))
 (71 1 (:DEFINITION SYMBOL-ALISTP))
 ...
 (38 1 (:REWRITE AXE-TREE-LISTP-WHEN-PSEUDO-TERM-LISTP))
