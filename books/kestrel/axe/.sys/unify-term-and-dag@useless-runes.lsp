...
(FLAG-UNIFY-TERM-AND-DAG
 (1000 28 (:DEFINITION INTEGER-ABS))
 (705 23 (:REWRITE USE-ALL-<-FOR-CAR))
 (604 14 (:DEFINITION NAT-LISTP))
 (565 30 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (346 5 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
 (319 5 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
 (297 14 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (251 125 (:REWRITE DEFAULT-+-2))
 (220 14 (:DEFINITION NATP))
