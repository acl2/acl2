...
(ALL-<-OF-STRIP-CDRS-OF-MAKE-DAG-CONSTANT-ALIST-AUX
 (4976 56 (:REWRITE ALL-<-TRANSITIVE-FREE-2))
 (2439 24 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
 (1838 45 (:REWRITE ALL-<-WHEN-NOT-CONSP))
 (1748 40 (:DEFINITION NAT-LISTP))
 (1430 195 (:REWRITE DEFAULT-CDR))
 (1391 48 (:REWRITE ALL-NATP-WHEN-NOT-CONSP))
