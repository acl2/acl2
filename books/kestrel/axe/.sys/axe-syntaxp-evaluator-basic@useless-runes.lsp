(EVAL-AXE-SYNTAXP-FUNCTION-APPLICATION-BASIC
 ...
 (89496 12308 (:REWRITE DEFAULT-CAR))
 (64715 64715 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
 (53000 500 (:LINEAR LARGEST-NON-QUOTEP-BOUND))
 (51371 51371 (:TYPE-PRESCRIPTION ALL-MYQUOTEP))
 (50006 26157 (:REWRITE DEFAULT-+-2))
 (48620 44048 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
 (44048 44048 (:REWRITE LEN-WHEN-PSEUDO-DAGP-AUX))
 (44048 44048 (:REWRITE LEN-WHEN-DARGP-LESS-THAN))
 (44048 44048 (:REWRITE LEN-WHEN-BOUNDED-DAG-EXPRP-AND-QUOTEP))
 (41537 1393 (:REWRITE USE-ALL-NATP-FOR-CAR))
 (36685 893 (:DEFINITION NAT-LISTP))
 (34666 4288 (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
 (26157 26157 (:REWRITE DEFAULT-+-1))
 ...
 (8793 8793 (:REWRITE <-OF-LEN-WHEN-NTH-NON-NIL))
 (8793 8793 (:REWRITE <-OF-LEN-WHEN-INTEGERP-OF-NTH))
 ...
 (6286 919 (:REWRITE CONSP-OF-CAR-WHEN-PSEUDO-DAGP))
 (5751 5751 (:TYPE-PRESCRIPTION NAT-LISTP))
 (5442 5442 (:TYPE-PRESCRIPTION ALL-CONSP))
 (5423 5423 (:REWRITE CONSP-OF-CDR-WHEN-LEN-KNOWN))
 (4190 4190 (:TYPE-PRESCRIPTION PSEUDO-DAGP))
 (4032 136 (:REWRITE BOUNDED-DARG-LISTP-WHEN-ALL-<))
 (3683 3683 (:REWRITE MYQUOTEP-WHEN-DARGP-LESS-THAN))
 (3683 3683 (:REWRITE MYQUOTEP-WHEN-BOUNDED-DAG-EXPRP))
 (3672 72 (:REWRITE <-OF-LARGEST-NON-QUOTEP))
 (3635 3635 (:REWRITE LOOKUP-EQUAL-WHEN-NOT-CONSP-CHEAP))
 (3635 3635 (:REWRITE LOOKUP-EQUAL-WHEN-NOT-ASSOC-EQUAL-CHEAP))
 (3596 1798 (:REWRITE SUBSETP-EQUAL-OF-CDR-ARG2-CHEAP))
 (3531 1177 (:REWRITE PSEUDO-DAGP-OF-CDR-WHEN-PSEUDO-DAGP))
 ...
 (1611 1611 (:REWRITE SYMBOLP-WHEN-BOUNDED-DAG-EXPRP))
 (1603 1603 (:REWRITE SYMBOLP-OF-CAR-WHEN-BOUNDED-DAG-EXPRP))
 (1475 1475 (:TYPE-PRESCRIPTION SYMBOL-TERM-ALISTP))
 ...
 (1112 556 (:REWRITE SYMBOL-ALISTP-WHEN-SYMBOL-TERM-ALISTP-CHEAP))
 ...
 (214 214 (:REWRITE ALISTP-WHEN-PSEUDO-DAGP-AUX))
 (214 214 (:REWRITE ALISTP-WHEN-BOUNDED-NATP-ALISTP))
