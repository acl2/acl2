(EVAL-AXE-SYNTAXP-FUNCTION-APPLICATION-BASIC
 (103878 51939 (:TYPE-PRESCRIPTION NATP-OF-LARGEST-NON-QUOTEP))
 (93345 20691 (:REWRITE DEFAULT-CDR))
 (89518 12322 (:REWRITE DEFAULT-CAR))
 (64715 64715 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
 (53000 500 (:LINEAR LARGEST-NON-QUOTEP-BOUND))
 (51389 51389 (:TYPE-PRESCRIPTION ALL-MYQUOTEP))
 (50418 26233 (:REWRITE DEFAULT-+-2))
 (48760 44182 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
 (44182 44182 (:REWRITE LEN-WHEN-PSEUDO-DAGP-AUX))
 (44182 44182 (:REWRITE LEN-WHEN-DARGP-LESS-THAN))
 (44182 44182 (:REWRITE LEN-WHEN-BOUNDED-DAG-EXPRP-AND-QUOTEP))
 (41591 1399 (:REWRITE USE-ALL-NATP-FOR-CAR))
 (36955 899 (:DEFINITION NAT-LISTP))
 (35248 4358 (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
 (26233 26233 (:REWRITE DEFAULT-+-1))
 (21298 899 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (19152 399 (:REWRITE ACL2-NUMBERP-OF-LOOKUP-EQUAL))
 (18000 500 (:LINEAR LARGEST-NON-QUOTEP-BOUND-ALT))
 (16602 919 (:REWRITE USE-ALL-CONSP-FOR-CAR))
 (15524 10279 (:REWRITE DEFAULT-<-2))
 (14574 808 (:REWRITE SUBSETP-EQUAL-OF-FREE-VARS-IN-TERMS-OF-CAR-CHAIN))
 (14399 899 (:REWRITE ALL-NATP-WHEN-NOT-CONSP))
 (14000 500 (:DEFINITION NTH))
 (10960 401 (:REWRITE ALL-DARGP-WHEN-NOT-CONSP))
 (10642 10642 (:REWRITE USE-ALL-CONSP-2))
 (10642 10642 (:REWRITE USE-ALL-CONSP))
 (10642 10642 (:REWRITE CONSP-WHEN-LEN-GREATER))
 (10639 10279 (:REWRITE DEFAULT-<-1))
 (10556 248 (:REWRITE PERM-OF-UNION-EQUAL-WHEN-DISJOINT))
 (10279 10279 (:REWRITE USE-ALL-<-2))
 (10279 10279 (:REWRITE USE-ALL-<))
 (10279 10279 (:REWRITE <-WHEN-BOUNDED-DARG-LISTP-GEN))
 (10010 149 (:DEFINITION INTERSECTION-EQUAL))
 (8863 8863 (:REWRITE <-OF-LEN-WHEN-NTH-NON-NIL))
 (8863 8863 (:REWRITE <-OF-LEN-WHEN-INTEGERP-OF-NTH))
 ...
 (5487 5487 (:REWRITE CONSP-OF-CDR-WHEN-LEN-KNOWN))
 ...
 (1987 1987 (:REWRITE NATP-WHEN-BOUNDED-DARG-LISTP-GEN))
 ...
 (1617 1617 (:REWRITE SYMBOLP-WHEN-BOUNDED-DAG-EXPRP))
 (1609 1609 (:REWRITE SYMBOLP-OF-CAR-WHEN-BOUNDED-DAG-EXPRP))
 (1485 543 (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
 (1478 1478 (:TYPE-PRESCRIPTION SYMBOL-TERM-ALISTP))
 (1428 42 (:REWRITE SUBSETP-EQUAL-OF-NIL-ARG2))
 (1399 899 (:REWRITE ALL-NATP-WHEN-NOT-CONSP-CHEAP))
 (1118 559 (:REWRITE SYMBOL-ALISTP-WHEN-SYMBOL-TERM-ALISTP-CHEAP))
 ...
 (220 220 (:REWRITE ALISTP-WHEN-PSEUDO-DAGP-AUX))
 (220 220 (:REWRITE ALISTP-WHEN-BOUNDED-NATP-ALISTP))
