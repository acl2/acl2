...
(BOUNDED-DAG-PARENT-ENTRIESP-AFTER-ADD-FUNCTION-CALL-EXPR-TO-DAG-ARRAY
 (855 45 (:REWRITE BOUNDED-DARG-LISTP-WHEN-ALL-<))
 (849 125 (:REWRITE <-WHEN-BOUNDED-DARG-LISTP-GEN))
 (662 68 (:DEFINITION MEMBER-EQUAL))
 (546 21 (:REWRITE ALL-<-OF-ALEN1-WHEN-PSEUDO-DAG-ARRAYP-LIST))
 (393 21 (:REWRITE PSEUDO-DAG-ARRAYP-LIST-WHEN-BOUNDED-DARG-LISTP-SPECIAL-ALT))
