...
// Following function tests two values and returns OF flag value using seto instruction
...
unsigned char get_overflow_flag(long x, long y) {
    ...
    __asm__ volatile (
        ...
        "testq %2, %%rax;"     // And y to RAX (this may set OF)
...
bool test_long_test_OF (long x, long y) {
