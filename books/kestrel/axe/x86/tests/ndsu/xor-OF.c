...
// Following function XORs two values and returns OF flag value using seto instruction
...
unsigned char get_overflow_flag(long x, long y) {
    ...
    __asm__ volatile (
        ...
        "xorq %2, %%rax;"     // XOR y to RAX (this may set OF)
...
bool test_long_xor_OF (long x, long y) {
