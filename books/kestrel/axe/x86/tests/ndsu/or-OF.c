...
// Following function ORs two values and returns OF flag value using seto instruction
...
unsigned char get_overflow_flag(long x, long y) {
    ...
    __asm__ volatile (
        ...
        "orq %2, %%rax;"     // OR y to RAX (this may set OF)
...
bool test_long_or_OF (long x, long y) {
