(X::NOT_MEM32)
(X::NOT_MEM32-MEMORY-AT-RBX
 (123 4 (:REWRITE SLICE-TOO-HIGH-IS-0))
 (119 2 (:REWRITE REWRITE-UNSIGNED-BYTE-P-WHEN-TERM-SIZE-IS-LARGER))
 (31 2 (:REWRITE EQUAL-OF-CONSTANT-AND-BVXOR-OF-CONSTANT))
