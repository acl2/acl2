...
;reorder params
;drop this wrapper?
(defun acl2::simp-term-to-term (term rule-names assumptions monitor wrld)
  ...
  (acl2::simp-term-x86 term
                       assumptions
                       (acl2::make-rule-alist! rule-names wrld)
                       nil
                       monitor
                       nil
                       t ; memoizep
...
(defun no-overlap-between-write-pairs (write-pair1
  ...
  (b* ((num-bytes1 (first write-pair1))
       ...
       ((mv erp result)
        (acl2::simplify-term-x86 separation-term assumptions rule-alist nil nil nil nil nil nil nil (w state)))
    ...
    (b* ((address-term (first address-terms))
         ...
         ((mv erp result)
          (acl2::simp-term-x86 address-unchanged-term nil ; assumptions
                               rule-alist nil nil nil nil nil nil nil (w state)))
         ((when erp) (mv erp nil state)))
      (if (equal result *t*)
...
;        (initial-params-terms (strip-cdrs paramnum-extractor-alist)) ;these are over :INITIAL-LOOP-TOP-STATE and perhaps previous state vars and inputs (may occur in addresses)
        ...
        ((mv erp loop-function-call-dag)
         ...
         (acl2::simplify-term-x86 loop-function-call-term
                                  ...
                                  nil nil nil nil nil nil nil (w state)))
        ((when erp) (mv erp nil nil nil state))
