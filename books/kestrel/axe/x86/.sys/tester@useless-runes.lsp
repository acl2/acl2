...
(X::MAKE-REGISTER-REPLACEMENT-ASSUMPTIONS64
 (4035 8 (:DEFINITION ACL2-COUNT))
 (2090 10 (:DEFINITION INTEGER-ABS))
 (1438 30 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (839 43 (:REWRITE INEQ-HACK2))
 (839 43 (:REWRITE INEQ-HACK))
 (734 8 (:REWRITE RATIONALP-OF-CAR-WHEN-RATIONAL-LISTP))
 (724 4 (:DEFINITION RATIONAL-LISTP))
 (604 20 (:REWRITE LEN-OF-CDR))
 (568 8 (:REWRITE RATIONAL-LISTP-WHEN-NOT-CONSP))
 (417 16 (:REWRITE SYMBOL-LISTP-WHEN-NOT-CONSP))
 ...
 (120 3 (:REWRITE EQUAL-OF-+-COMBINE-CONSTANTS-ALT))
...
(X::ANY-RESULT-UNEXPECTEDP
 ...
 (10 4 (:REWRITE SET::EMPTY-SET-UNIQUE))
