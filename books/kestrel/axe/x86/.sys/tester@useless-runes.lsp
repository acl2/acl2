...
(X::REGISTER-REPLACEMENT-ASSUMPTIONS64
 (2222 8 (:DEFINITION ACL2-COUNT))
 (1339 30 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (674 8 (:REWRITE RATIONALP-OF-CAR-WHEN-RATIONAL-LISTP))
 (664 4 (:DEFINITION RATIONAL-LISTP))
 (518 8 (:REWRITE RATIONAL-LISTP-WHEN-NOT-CONSP))
 (499 20 (:REWRITE LEN-OF-CDR))
 (392 10 (:DEFINITION INTEGER-ABS))
 (390 16 (:REWRITE SYMBOL-LISTP-WHEN-NOT-CONSP))
 ...
 (77 3 (:REWRITE EQUAL-OF-0-AND-+-OF-MINUS-2))
...
(X::REGISTER-REPLACEMENT-ASSUMPTIONS64-RETURN-TYPE
 ...
 (3166 73 (:REWRITE COLLECT-CONSTANTS-OVER-<))
 ...
 (121 25 (:REWRITE EQUAL-OF-+-COMBINE-CONSTANTS-ALT))
