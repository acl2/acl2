...
(X::MAKE-REGISTER-REPLACEMENT-ASSUMPTIONS64
 (4057 8 (:DEFINITION ACL2-COUNT))
 (2090 10 (:DEFINITION INTEGER-ABS))
 (1457 30 (:REWRITE CONSP-FROM-LEN-CHEAP))
...
(X::PRINT-TEST-SUMMARY-AUX
 (785 2 (:DEFINITION BIGMEM::PAGES-SERIALIZEDP))
 (650 1 (:REWRITE BIGMEM::MEM-SERIALIZEDP-IMPLIES-ALISTP))
 (647 1 (:DEFINITION BIGMEM::MEM-SERIALIZEDP))
 (382 4 (:REWRITE RATIONALP-OF-CAR-WHEN-RATIONAL-LISTP))
 (353 6 (:REWRITE USE-ALL-<-FOR-CAR))
 (340 6 (:REWRITE NATP-WHEN-INTEGERP-CHEAP))
 (327 1 (:REWRITE BIGMEM::PAGES-SERIALIZEDP-IMPLIES-ALISTP))
 (310 4 (:DEFINITION RATIONAL-LISTP))
 (266 4 (:REWRITE UNSIGNED-BYTE-LISTP-WHEN-NOT-CONSP))
...
(X::ANY-RESULT-UNEXPECTEDP
 (1648 4 (:DEFINITION BIGMEM::PAGES-SERIALIZEDP))
 (1378 2 (:REWRITE BIGMEM::MEM-SERIALIZEDP-IMPLIES-ALISTP))
 (1372 2 (:DEFINITION BIGMEM::MEM-SERIALIZEDP))
 (732 2 (:REWRITE BIGMEM::PAGES-SERIALIZEDP-IMPLIES-ALISTP))
 (532 8 (:REWRITE UNSIGNED-BYTE-LISTP-WHEN-NOT-CONSP))
 (432 9 (:REWRITE <-0-+-NEGATIVE-1))
