...
(X::MAKE-REGISTER-REPLACEMENT-ASSUMPTIONS64
 (2252 8 (:DEFINITION ACL2-COUNT))
 (1354 30 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (684 8 (:REWRITE RATIONALP-OF-CAR-WHEN-RATIONAL-LISTP))
 (674 4 (:DEFINITION RATIONAL-LISTP))
 (528 8 (:REWRITE RATIONAL-LISTP-WHEN-NOT-CONSP))
 (514 20 (:REWRITE LEN-OF-CDR))
 (412 10 (:DEFINITION INTEGER-ABS))
 (395 16 (:REWRITE SYMBOL-LISTP-WHEN-NOT-CONSP))
 (350 11 (:REWRITE COLLECT-CONSTANTS-OVER-<))
 ...
 (72 1 (:LINEAR ACL2-COUNT-OF-CONSP-POSITIVE))
 ...
 (28 2 (:REWRITE INTEGER-LISTP-WHEN-ALL-NATP))
...
(X::MAKE-REGISTER-REPLACEMENT-ASSUMPTIONS64-RETURN-TYPE
 (9280 261 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (3174 73 (:REWRITE COLLECT-CONSTANTS-OVER-<))
 (987 14 (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
 (959 7 (:DEFINITION TRUE-LIST-LISTP))
 (876 438 (:REWRITE LEN-WHEN-DARGP-CHEAP))
 (840 14 (:REWRITE TRUE-LIST-LISTP-WHEN-NOT-CONSP))
 (764 4 (:REWRITE CDR-IFF))
