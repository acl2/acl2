(EVAL-AXE-SYNTAXP-FUNCTION-APPLICATION-X86
 (105650 20288 (:REWRITE DEFAULT-CDR))
 (104075 11913 (:REWRITE DEFAULT-CAR))
 (103842 51921 (:TYPE-PRESCRIPTION NATP-OF-LARGEST-NON-QUOTEP))
 (88428 44220 (:REWRITE LEN-WHEN-DARGP-CHEAP))
 (57000 500 (:LINEAR LARGEST-NON-QUOTEP-BOUND))
 (51369 51369 (:TYPE-PRESCRIPTION ALL-MYQUOTEP))
 (48788 44220 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
 (44220 44220 (:REWRITE LEN-WHEN-PSEUDO-DAGP-AUX))
 (44220 44220 (:REWRITE LEN-WHEN-DARGP-LESS-THAN))
 (44220 44220 (:REWRITE LEN-WHEN-BOUNDED-DAG-EXPRP-AND-QUOTEP))
 (40000 1000 (:REWRITE USE-ALL-NATP-FOR-CAR))
 (39028 39028 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
 (33668 4176 (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
 (31318 26333 (:REWRITE DEFAULT-+-2))
 ...
 (17694 935 (:REWRITE USE-ALL-CONSP-FOR-CAR))
 (15000 500 (:REWRITE ALL-NATP-WHEN-NOT-CONSP))
 (15000 500 (:DEFINITION NTH))
 (14742 808 (:REWRITE SUBSETP-EQUAL-OF-FREE-VARS-IN-TERMS-OF-CAR-CHAIN))
 (13900 9427 (:REWRITE DEFAULT-<-2))
 (11054 248 (:REWRITE PERM-OF-UNION-EQUAL-WHEN-DISJOINT))
 (10508 149 (:DEFINITION INTERSECTION-EQUAL))
 (9803 399 (:REWRITE DARG-LISTP-WHEN-NOT-CONSP))
 (9790 9790 (:REWRITE USE-ALL-CONSP-2))
 (9790 9790 (:REWRITE USE-ALL-CONSP))
 (9790 9790 (:REWRITE CONSP-WHEN-LEN-GREATER))
 (9787 9427 (:REWRITE DEFAULT-<-1))
 (9427 9427 (:REWRITE USE-ALL-<-2))
 (9427 9427 (:REWRITE USE-ALL-<))
 (9427 9427 (:REWRITE <-WHEN-BOUNDED-DARG-LISTP-GEN))
 (9185 2127 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
 (7915 7915 (:REWRITE <-OF-LEN-WHEN-NTH-NON-NIL))
 (7915 7915 (:REWRITE <-OF-LEN-WHEN-INTEGERP-OF-NTH))
 ...
 (1512 42 (:REWRITE SUBSETP-EQUAL-OF-NIL-ARG2))
 ...
 (798 399 (:REWRITE DARG-LISTP-WHEN-ALL-MYQUOTEP-CHEAP))
 (648 7 (:REWRITE SUBSETP-EQUAL-OF-FREE-VARS-IN-TERMS-OF-CDR-CHAIN))
 (616 14 (:REWRITE SUBSETP-EQUAL-OF-CONS-ARG2))
 ...
 (399 399 (:REWRITE DARG-LISTP-WHEN-BOUNDED-DARG-LISTP))
