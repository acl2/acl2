(BOUNDED-NATP-ALISTP-REDEF
     (4702 90 (:DEFINITION NAT-LISTP))
     (4179 121 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
     (3196 104 (:REWRITE USE-ALL-<-FOR-CAR))
     (1970 109 (:REWRITE USE-ALL-NATP-FOR-CAR))
     (1304 63 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
     (1026 63 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
     (898 449
     ...
     (218 109 (:REWRITE NATP-WHEN-POWER-OF-2P))
     ...
     (173 173 (:TYPE-PRESCRIPTION POWER-OF-2P))
...
(NATP-ALISTP-REDEF
     (1191 20 (:DEFINITION NAT-LISTP))
     (1105 31 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
     (687 19 (:REWRITE USE-ALL-<-FOR-CAR))
     (462 24 (:REWRITE USE-ALL-NATP-FOR-CAR))
     (318 15 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
     (216 15 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
...
(MAKE-NODE-REPLACEMENT-ALIST-AND-ADD-TO-DAG-ARRAY-RETURN-TYPE-COROLLARY
     ...
     (141 6 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
     (134 134 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
     (131 3 (:DEFINITION NAT-LISTP))
