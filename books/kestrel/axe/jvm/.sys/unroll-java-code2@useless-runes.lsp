...
(DAG-TO-TERM-LIMITED2
 (1024 4 (:DEFINITION PLIST-WORLDP))
 (302 151 (:TYPE-PRESCRIPTION INTEGERP-OF-NTH-WHEN-ALL-NATP))
 (260 2 (:REWRITE MYQUOTEP-WHEN-AXE-TREEP))
 (198 5 (:REWRITE <-0-+-NEGATIVE-1))
 ...
 (27 27 (:REWRITE STRENGTHEN-<-OF-CONSTANT-WHEN-NOT-EQUAL))
