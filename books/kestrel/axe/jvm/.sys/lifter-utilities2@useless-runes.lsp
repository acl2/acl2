...
(DESUGAR-PARAMS-IN-ASSUMPTION-TERM-TO-STACK-ITEMS
 (1676 838 (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP-TYPE))
 (1051 1051 (:TYPE-PRESCRIPTION SYMBOL-TERM-ALISTP))
 ...
 (211 7 (:REWRITE PSEUDO-TERMP-OF-CADDR))
