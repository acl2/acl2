...
(OUTPUT-EXTRACTION-TERM
 (3970 8 (:DEFINITION NATP))
 (2783 72 (:REWRITE ALL-NATP-WHEN-NOT-CONSP))
 (1745 8 (:REWRITE USE-ALL-<-FOR-CAR))
 (1713 8 (:REWRITE NOT-<-OF-CAR-WHEN-NAT-LISTP))
 (1633 40 (:REWRITE NAT-LISTP-WHEN-ALL-NATP))
 (1466 8 (:REWRITE USE-ALL-NATP-FOR-CAR))
 (1321 20 (:REWRITE ALL-<-WHEN-NOT-CONSP))
 (711 12 (:REWRITE ALL-<-OF-CDR))
 (659 24 (:REWRITE NAT-LISTP-OF-CDR))
 (643 40 (:REWRITE ALL-NATP-OF-CDR))
