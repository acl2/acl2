...
(STRIP-SET-FIELD-CALLS
 (2813 182 (:REWRITE DEFAULT-<-1))
 (2649 35 (:REWRITE INTEGERP-IMPLIES-ACL2-NUMBERP))
 (2539 47 (:REWRITE DAG-EXPRP-OF-LOOKUP-EQUAL-WHEN-PSEUDO-DAGP))
 (2318 1214 (:TYPE-PRESCRIPTION INTEGERP-OF-NTH-WHEN-ALL-NATP))
 (1978 20 (:REWRITE INTEGERP-OF-NTH-OF-DARGS-ALT))
 (1667 223 (:REWRITE INEQ-HACK))
 (1297 13 (:REWRITE BOUNDED-DAG-EXPRP-OF-LOOKUP-EQUAL-WHEN-PSEUDO-DAGP))
 (1154 1154 (:TYPE-PRESCRIPTION ALL-NATP))
 (426 142 (:REWRITE <-OF-LEN-WHEN-NTH-NON-NIL))
 (426 142 (:REWRITE <-OF-LEN-WHEN-INTEGERP-OF-NTH))
 (415 3 (:REWRITE NATP-OF-NTH-OF-DARGS))
 (382 191 (:REWRITE LEN-WHEN-DARGP-CHEAP))
 (374 116 (:REWRITE DEFAULT-+-2))
 (348 2 (:REWRITE DARGP-LESS-THAN-OF-NTH-WHEN-BOUNDED-DARG-LISTP-GEN))
 (298 1 (:REWRITE NATP-OF-+-WHEN-NATP-AND-NATP))
 ...
 (168 155 (:REWRITE NOT-<-WHEN-SBVLT))
 (156 155 (:REWRITE NOT-<-WHEN-SBVLT-ALT))
