...
(DESUGAR-NICE-OUTPUT-INDICATOR
 (1026 80 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (258 63 (:REWRITE DEFAULT-CDR))
 (209 11 (:DEFINITION TRUE-LISTP))
...
(SIMPLE-OUTPUT-INDICATORP-OF-DESUGAR-NICE-OUTPUT-INDICATOR
 (417 21 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (231 12 (:REWRITE LEN-OF-CDR))
 (123 3 (:DEFINITION RASSOC-EQUAL))
