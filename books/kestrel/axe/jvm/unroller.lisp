...
(defmacrodoc unroll-java-code (&whole whole-form
  ...
  :args ((defconst-name
         ...
         (extra-rules             "A symbol-list indicating rules to add to the usual set of rules")
         (remove-rules            "A symbol-list indicating rules to remove from the usual set of rules")
