...
(MEMBERP-OF-APPEND-WITH-KEY-FIRST-HALF-AXE
 (46 3 (:REWRITE MEMBERP-WHEN-SUBSETP-EQUAL-2))
 (39 2 (:DEFINITION SUBSETP-EQUAL))
...
(MEMBERP-OF-APPEND-WITH-KEY-SECOND-HALF-AXE
 (101 6 (:REWRITE MEMBERP-WHEN-SUBSETP-EQUAL-2))
 (91 3 (:DEFINITION SUBSETP-EQUAL))
...
(PFIELD::FEP-WHEN-FE-LISTP-AND-MEMBERP
 (19 2 (:REWRITE MEMBERP-WHEN-SUBSETP-EQUAL-2))
...
(R1CS::NATP-WHEN-FE-LISTP-AND-MEMBERP
 (228 9 (:REWRITE USE-ALL-<-2))
 (202 7 (:DEFINITION NAT-LISTP))
 (128 7 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (103 4 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
 (103 4 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
 (70 9 (:REWRITE MEMBERP-WHEN-SUBSETP-EQUAL-2))
 (62 2 (:DEFINITION SUBSETP-EQUAL))
 (56 9 (:REWRITE USE-ALL-NATP-2))
