...
(PFIELD::FE-LISTP$-KNOWN-BOOLEANS-JUSTIFICATION)
...
(R1CS::NATP-WHEN-FE-LISTP-AND-MEMBERP
 (234 9 (:REWRITE USE-ALL-<-2))
 (194 7 (:DEFINITION NAT-LISTP))
 (131 7 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (106 4 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
