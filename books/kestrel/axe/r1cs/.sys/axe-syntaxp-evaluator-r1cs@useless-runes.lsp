(EVAL-AXE-SYNTAXP-FUNCTION-APPLICATION-R1CS
 (115236 57618 (:TYPE-PRESCRIPTION NATP-OF-LARGEST-NON-QUOTEP))
 (95196 21828 (:REWRITE DEFAULT-CDR))
 (93963 13319 (:REWRITE DEFAULT-CAR))
 (71339 71339 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
 (63176 596 (:LINEAR LARGEST-NON-QUOTEP-BOUND))
 (57092 57092 (:TYPE-PRESCRIPTION ALL-MYQUOTEP))
 (54348 27883 (:REWRITE DEFAULT-+-2))
 (53192 47927 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
 (49184 1624 (:REWRITE USE-ALL-NATP-FOR-CAR))
 (47927 47927 (:REWRITE LEN-WHEN-PSEUDO-DAGP-AUX))
 (47927 47927 (:REWRITE LEN-WHEN-DARGP-LESS-THAN))
 (47927 47927 (:REWRITE LEN-WHEN-BOUNDED-DAG-EXPRP-AND-QUOTEP))
 (42088 1028 (:DEFINITION NAT-LISTP))
 (35305 4415 (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
 (27883 27883 (:REWRITE DEFAULT-+-1))
 (25300 1028 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (21456 596 (:LINEAR LARGEST-NON-QUOTEP-BOUND-ALT))
 (20736 432 (:REWRITE ACL2-NUMBERP-OF-LOOKUP-EQUAL))
 (18474 1081 (:REWRITE USE-ALL-CONSP-FOR-CAR))
 (17238 11312 (:REWRITE DEFAULT-<-2))
 (17120 1028 (:REWRITE ALL-NATP-WHEN-NOT-CONSP))
 ...
 (11792 11312 (:REWRITE DEFAULT-<-1))
 (11693 11693 (:REWRITE USE-ALL-CONSP-2))
 (11693 11693 (:REWRITE USE-ALL-CONSP))
 (11693 11693 (:REWRITE CONSP-WHEN-LEN-GREATER))
 (11312 11312 (:REWRITE USE-ALL-<-2))
 (11312 11312 (:REWRITE USE-ALL-<))
 (11312 11312 (:REWRITE <-WHEN-BOUNDED-DARG-LISTP-GEN))
 (10556 248 (:REWRITE PERM-OF-UNION-EQUAL-WHEN-DISJOINT))
 (10010 149 (:DEFINITION INTERSECTION-EQUAL))
 (9520 9520 (:REWRITE <-OF-LEN-WHEN-NTH-NON-NIL))
 (9520 9520 (:REWRITE <-OF-LEN-WHEN-INTEGERP-OF-NTH))
 ...
 (6600 6600 (:TYPE-PRESCRIPTION NAT-LISTP))
 (6330 6330 (:TYPE-PRESCRIPTION ALL-CONSP))
 (5839 5839 (:REWRITE CONSP-OF-CDR-WHEN-LEN-KNOWN))
 (4896 160 (:REWRITE BOUNDED-DARG-LISTP-WHEN-ALL-<))
 (4896 96 (:REWRITE <-OF-LARGEST-NON-QUOTEP))
 (4838 4838 (:TYPE-PRESCRIPTION PSEUDO-DAGP))
 (4043 4043 (:REWRITE LOOKUP-EQUAL-WHEN-NOT-CONSP-CHEAP))
 (4043 4043 (:REWRITE LOOKUP-EQUAL-WHEN-NOT-ASSOC-EQUAL-CHEAP))
 (4017 1339 (:REWRITE PSEUDO-DAGP-OF-CDR-WHEN-PSEUDO-DAGP))
 (4010 4010 (:REWRITE MYQUOTEP-WHEN-DARGP-LESS-THAN))
 (4010 4010 (:REWRITE MYQUOTEP-WHEN-BOUNDED-DAG-EXPRP))
 ...
 (2652 2652 (:TYPE-PRESCRIPTION ALL-NATP))
 (2419 2419 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP-CHEAP))
 (2332 2332 (:REWRITE USE-ALL-NATP-2))
 (2332 2332 (:REWRITE USE-ALL-NATP))
 (2332 2332 (:REWRITE NATP-WHEN-BOUNDED-DARG-LISTP-GEN))
 ...
 (1755 1755 (:REWRITE SYMBOLP-WHEN-BOUNDED-DAG-EXPRP))
 (1747 1747 (:REWRITE SYMBOLP-OF-CAR-WHEN-BOUNDED-DAG-EXPRP))
 (1721 1721 (:TYPE-PRESCRIPTION SYMBOL-TERM-ALISTP))
 (1696 32 (:REWRITE <=-OF-LARGEST-NON-QUOTEP-WHEN-BOUNDED-DARG-LISTP))
 (1680 624 (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
 (1624 1028 (:REWRITE ALL-NATP-WHEN-NOT-CONSP-CHEAP))
 (1280 640 (:REWRITE SYMBOL-ALISTP-WHEN-SYMBOL-TERM-ALISTP-CHEAP))
 ...
 (432 432 (:REWRITE NATP-OF-+-WHEN-NEGATIVE-CONSTANT))
 ...
 (262 262 (:REWRITE ALISTP-WHEN-PSEUDO-DAGP-AUX))
 (262 262 (:REWRITE ALISTP-WHEN-BOUNDED-NATP-ALISTP))
