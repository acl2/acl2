...
(ARRAY-OF-MEMO-ALISTSP-AUX-BEYOND-LENGTH
     ...
     (236 9 (:REWRITE ALL-DARGP-WHEN-NOT-CONSP))
     (225 45 (:REWRITE DEFAULT-CDR))
     (136 28 (:REWRITE USE-ALL-CONSP-FOR-CAR))
     (135 135 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
     (129 73
          (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-<))
     (121 43 (:REWRITE SIMPLIFY-SUMS-<))
     (82 75
         (:REWRITE REMOVE-WEAK-INEQUALITIES-TWO))
     (77 57 (:REWRITE NORMALIZE-ADDENDS))
     (73 73 (:REWRITE |(< (- x) (- y))|))
...
(ARRAY-OF-BOUNDED-MEMO-ALISTSP-AUX-BEYOND-LENGTH
     (686 21
          (:REWRITE TYPE-OF-AREF1-WHEN-ARRAY-OF-BOUNDED-MEMO-ALISTSP-AUX))
     (272 17 (:DEFINITION STRIP-CDRS))
     (213 43 (:REWRITE DEFAULT-CDR))
     (212 8
          (:REWRITE ALL-DARGP-LESS-THAN-WHEN-NOT-CONSP))
     (135 135 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
     ...
     (84 77
         (:REWRITE REMOVE-WEAK-INEQUALITIES-TWO))
     (84 60 (:REWRITE NORMALIZE-ADDENDS))
     (75 75 (:REWRITE |(< (- x) (- y))|))
