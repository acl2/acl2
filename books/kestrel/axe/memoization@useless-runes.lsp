...
(TREES-TO-MEMOIZEP-FORWARD-TO-TRUE-LISTP
    ...
    (1938 6
          (:REWRITE AXE-TREEP-WHEN-PSEUDO-TERMP))
    (1506 6 (:REWRITE AXE-TREEP-OF-CAR))
    (1416 3 (:DEFINITION ALL-AXE-TREEP))
    (1080 540
          (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP))
...
(TREES-TO-MEMOIZEP-OF-CONS
    ...
    (2638 9
          (:REWRITE AXE-TREEP-WHEN-PSEUDO-TERMP))
    (1592 4 (:REWRITE AXE-TREEP-OF-CAR))
    (1532 2 (:DEFINITION ALL-AXE-TREEP))
    (1158 579
          (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP))
    ...
    (653 653
         (:TYPE-PRESCRIPTION SYMBOL-TERM-ALISTP))
    (602 7 (:REWRITE ALL-AXE-TREEP-OF-CDR))
...
(DARGP-OF-LOOKUP-EQUAL-ALT
     ...
     (129 129
          (:TYPE-PRESCRIPTION SYMBOL-TERM-ALISTP))
     (107 23 (:REWRITE USE-ALL-CONSP-FOR-CAR))
     (82 11 (:REWRITE ALL-DARGP-WHEN-NOT-CONSP))
...
(FLAG-LEMMA-FOR-INTEGERP-OF-SUM-OF-NODENUMS-AUX-LST
    ...
    (1231 30 (:REWRITE AXE-TREEP-WHEN-DARGP))
    (1134 285
          (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
    ...
    (148 74
         (:REWRITE ALL-DARGP-WHEN-ALL-MYQUOTEP-CHEAP))
    (137 23 (:REWRITE DARGP-WHEN-CONSP-CHEAP))
...
(SUM-OF-NODENUMS-BOUND
     (855 1 (:DEFINITION AXE-TREEP))
     (812 3 (:DEFINITION PSEUDO-TERMP))
     (529 2
          (:REWRITE AXE-TREEP-WHEN-PSEUDO-TERMP))
     (276 1 (:REWRITE ALL-AXE-TREEP-OF-CDR))
...
(ARRAY-OF-MEMO-ALISTSP-AUX-OF-EXPAND-ARRAY-HELPER
     (11619 6828 (:REWRITE DEFAULT-CDR))
     (9612 225 (:REWRITE ALL-DARGP-WHEN-NOT-CONSP))
     (7312 454 (:DEFINITION STRIP-CDRS))
     (4356 4356 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
     (3847 3847 (:REWRITE DEFAULT-CAR))
     (3399 699 (:REWRITE USE-ALL-CONSP-FOR-CAR))
     (2096 1384
           (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-<))
     (1977 1037 (:REWRITE SIMPLIFY-SUMS-<))
     (1701 1701 (:REWRITE USE-ALL-CONSP-2))
     (1701 1701 (:REWRITE USE-ALL-CONSP))
     (1398 699
           (:REWRITE CONSP-OF-CAR-WHEN-SYMBOL-TERM-ALISTP-CHEAP))
     (1384 1384 (:REWRITE |(< (- x) (- y))|))
     (1380 983 (:REWRITE DEFAULT-<-2))
     (1350 1350 (:TYPE-PRESCRIPTION ALL-CONSP))
     (1337 878 (:REWRITE DEFAULT-+-2))
     (1245 516
           (:REWRITE AREF1-WHEN-TOO-LARGE-CHEAP))
     (1202 986 (:REWRITE NORMALIZE-ADDENDS))
     (1158 210 (:REWRITE |(< (+ d x) (+ c y))|))
     (1074 983 (:REWRITE DEFAULT-<-1))
     (988 2 (:REWRITE ARRAY1P-OF-CONS-HEADER))
     (983 983 (:REWRITE <-WHEN-BOUNDED-AXE-TREEP))
     (878 878
          (:REWRITE NORMALIZE-TERMS-SUCH-AS-A/A+B-+-B/A+B))
     ...
     (675 675
          (:REWRITE ALL-CONSP-WHEN-NOT-CONSP-CHEAP))
     (675 675 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
     (630 630
          (:REWRITE ALISTP-WHEN-BOUNDED-NATP-ALISTP))
     (520 310 (:REWRITE DEFAULT-*-2))
     (450 225
          (:REWRITE ALL-DARGP-WHEN-NOT-CONSP-CHEAP))
     (450 225
          (:REWRITE ALL-DARGP-WHEN-ALL-MYQUOTEP-CHEAP))
     ...
     (374 172 (:REWRITE |(< (+ c x) (+ d y))|))
     (310 310
          (:REWRITE NORMALIZE-FACTORS-GATHER-EXPONENTS))
     (310 310 (:REWRITE DEFAULT-*-1))
     (270 54 (:REWRITE |(+ y (+ x z))|))
     (225 225 (:TYPE-PRESCRIPTION ALL-MYQUOTEP))
     (225 225
          (:REWRITE ALL-DARGP-WHEN-ALL-DARGP-LESS-THAN))
...
(ARRAY-OF-MEMO-ALISTSP-OF-MAYBE-EXPAND-ARRAY
     (190 95 (:TYPE-PRESCRIPTION ALEN1-TYPE))
...
(ARRAY-OF-MEMO-ALISTSP-OF-MAKE-EMPTY-ARRAY
     ...
     (1 1 (:REWRITE |(< 0 (- x))|))
     (1 1 (:META META-INTEGERP-CORRECT)))
(MEMOIZATIONP (40 32 (:TYPE-PRESCRIPTION ALEN1-TYPE))
              (32 32 (:TYPE-PRESCRIPTION POSP-OF-ALEN1)))
...
(ADD-PAIRS-TO-MEMOIZATION
   ...
   (221530 136
           (:REWRITE TREE-TO-MEMOIZEP-WHEN-AXE-TREEP))
   (154640 208 (:DEFINITION AXE-TREEP))
   (151438 524
           (:REWRITE AXE-TREEP-WHEN-PSEUDO-TERMP))
   (127530 298 (:REWRITE AXE-TREEP-OF-CAR))
   (114956 148 (:DEFINITION ALL-AXE-TREEP))
   (76468 52 (:LINEAR SUM-OF-NODENUMS-BOUND))
   (64784 32392
          (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP))
   (60952 372 (:REWRITE ALL-AXE-TREEP-OF-CDR))
   ...
   (21378 5107
          (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
   (21166 5107 (:REWRITE SIMPLIFY-SUMS-EQUAL))
   (21166 5107
          (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
   (20132 5676
   ...
   (11840 372 (:REWRITE ALL-AXE-TREEP-OF-CDR-2))
   ...
   (3079 3079 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
   (2816 1408
         (:REWRITE ALL-DARGP-WHEN-ALL-MYQUOTEP-CHEAP))
   (2616 1408
...
(MEMOIZATIONP-OF-ADD-PAIRS-TO-MEMOIZATION
   ...
   (34015 65 (:REWRITE AXE-TREEP-OF-CAR))
   (29564 24 (:DEFINITION ALL-AXE-TREEP))
   (26616 9
          (:REWRITE TREE-TO-MEMOIZEP-WHEN-AXE-TREEP))
   (21775 89
          (:REWRITE AXE-TREEP-WHEN-PSEUDO-TERMP))
   (21312 70 (:REWRITE ALL-AXE-TREEP-OF-CDR))
   (10344 5172
          (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP))
   ...
   (3506 823
         (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
   (3466 823 (:REWRITE SIMPLIFY-SUMS-EQUAL))
   (3466 823
         (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
...
(LOOKUP-IN-MEMOIZATION
     ...
     (998 1
          (:REWRITE TREE-TO-MEMOIZEP-WHEN-AXE-TREEP))
     (998 1 (:LINEAR SUM-OF-NODENUMS-BOUND))
     (540 2
          (:REWRITE AXE-TREEP-WHEN-PSEUDO-TERMP))
     ...
     (112 33
          (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
     (110 33 (:REWRITE SIMPLIFY-SUMS-EQUAL))
     (110 33
          (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
...
(ARRAY-OF-BOUNDED-MEMO-ALISTSP-AUX-OF-EXPAND-ARRAY-HELPER
     (11257 6766 (:REWRITE DEFAULT-CDR))
     (8886 194
           (:REWRITE ALL-DARGP-LESS-THAN-WHEN-NOT-CONSP))
     (6828 423 (:DEFINITION STRIP-CDRS))
     (4356 4356 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
     (3816 3816 (:REWRITE DEFAULT-CAR))
     (3249 669 (:REWRITE USE-ALL-CONSP-FOR-CAR))
     (2261 1081 (:REWRITE SIMPLIFY-SUMS-<))
     (2166 1454
           (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-<))
     (1610 1610 (:REWRITE USE-ALL-CONSP-2))
     (1610 1610 (:REWRITE USE-ALL-CONSP))
     (1454 1454 (:REWRITE |(< (- x) (- y))|))
     (1404 1007 (:REWRITE DEFAULT-<-2))
     (1357 898 (:REWRITE DEFAULT-+-2))
     (1342 1046 (:REWRITE NORMALIZE-ADDENDS))
     (1338 669
           (:REWRITE CONSP-OF-CAR-WHEN-SYMBOL-TERM-ALISTP-CHEAP))
     (1290 1290 (:TYPE-PRESCRIPTION ALL-CONSP))
     (1183 485
           (:REWRITE AREF1-WHEN-TOO-LARGE-CHEAP))
     (1181 395
           (:REWRITE TYPE-OF-AREF1-WHEN-ARRAY-OF-MEMO-ALISTSP))
     (1164 216 (:REWRITE |(< (+ d x) (+ c y))|))
     (1098 1007 (:REWRITE DEFAULT-<-1))
     (1007 1007
     ...
     (645 645
          (:REWRITE ALL-CONSP-WHEN-NOT-CONSP-CHEAP))
     (645 645 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
     (630 630
          (:REWRITE ALISTP-WHEN-BOUNDED-NATP-ALISTP))
     (592 148 (:REWRITE |(+ y x)|))
     (528 264
     ...
     (395 395
          (:REWRITE TYPE-OF-AREF1-WHEN-ARRAY-OF-MEMO-ALISTSP-AUX))
     (380 178 (:REWRITE |(< (+ c x) (+ d y))|))
     (370 74 (:REWRITE |(+ y (+ x z))|))
     (310 310
          (:REWRITE NORMALIZE-FACTORS-GATHER-EXPONENTS))
     (310 310 (:REWRITE DEFAULT-*-1))
     (296 148 (:REWRITE BUBBLE-DOWN-+-MATCH-1))
     (264 264 (:TYPE-PRESCRIPTION ALL-MYQUOTEP))
     (172 2
          (:REWRITE BOUNDED-INTEGER-ALISTP-WHEN-BOUNDED-INTEGER-ALISTP))
...
(ARRAY-OF-BOUNDED-MEMO-ALISTSP-OF-MAKE-EMPTY-ARRAY
     ...
     (1 1 (:REWRITE |(< 0 (- x))|))
     (1 1 (:META META-INTEGERP-CORRECT)))
(BOUNDED-MEMOIZATIONP (46 38 (:TYPE-PRESCRIPTION ALEN1-TYPE))
...
(DARGP-LESS-THAN-OF-LOOKUP-IN-MEMOIZATION-WHEN-BOUNDED-MEMOIZATIONP
     ...
     (76 21
         (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
     (75 21 (:REWRITE SIMPLIFY-SUMS-EQUAL))
     (75 21
         (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
     (74 9 (:DEFINITION TRUE-LISTP))
     (63 63 (:REWRITE USE-ALL-CONSP-2))
...
(BOUNDED-MEMOIZATIONP-OF-ADD-PAIRS-TO-MEMOIZATION
   (38463 129 (:DEFINITION PSEUDO-TERMP))
   (34981 65 (:REWRITE AXE-TREEP-OF-CAR))
   (30530 24 (:DEFINITION ALL-AXE-TREEP))
   (27504 9
          (:REWRITE TREE-TO-MEMOIZEP-WHEN-AXE-TREEP))
   (21775 89
          (:REWRITE AXE-TREEP-WHEN-PSEUDO-TERMP))
   (21660 70 (:REWRITE ALL-AXE-TREEP-OF-CDR))
   (10960 5480
          (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP))
   (9467 652 (:DEFINITION LEN))
   (8493 378 (:DEFINITION LENGTH))
   ...
   (3660 845
         (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
   (3620 845 (:REWRITE SIMPLIFY-SUMS-EQUAL))
   (3620 845
         (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
