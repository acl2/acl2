...
(BVCAT-NEST-WITH-LOW-ZEROS-AUX
 ...
 (5132 25
       (:REWRITE ALL-DARGP-LESS-THAN-WHEN-ALL-<))
 (4790 48 (:DEFINITION NAT-LISTP))
 (4294 51
       (:REWRITE DAG-EXPRP0-OF-AREF1-WHEN-BOUNDED-DAG-EXPRP-OF-AREF1))
 (3897 43 (:REWRITE ALL-<-TRANSITIVE-FREE-2))
 (3074 28 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
...
(BIND-BV-ARRAY-LENGTH-AXE
     (712 13 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
     (689 21 (:REWRITE NATP-OF-NTH-FROM-ALL-NATP))
     (678 11 (:DEFINITION NAT-LISTP))
     (405 246 (:TYPE-PRESCRIPTION ALEN1-TYPE))
     (246 246 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
...
(BIND-BV-ARRAY-ELEMENT-SIZE-AXE
     (607 12 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
