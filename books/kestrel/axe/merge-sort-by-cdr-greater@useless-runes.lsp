...
(<-OF-ACL2-COUNT-OF-EVENS
     ...
     (375 147 (:REWRITE DEFAULT-CAR))
     (372 32 (:REWRITE USE-ALL-CONSP-FOR-CAR))
     ...
     (212 40 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
     (177 8 (:REWRITE ACL2-COUNT-OF-EVENS-BOUND))
...
(ALISTP-OF-MERGE-BY-CDR->
     ...
     (6 6
        (:REWRITE CONSP-OF-CDR-WHEN-LEN-KNOWN)))
(MERGE-SORT-BY-CDR->
     (7278 572 (:REWRITE CONSP-FROM-LEN-CHEAP))
...
(ALL-CDRS-RATIONALP-OF-MERGE-SORT-BY-CDR->
     ...
     (9 9
        (:REWRITE LEN-OF-CDDR-WHEN-EQUAL-OF-LEN)))
(MERGE-SORT-BY-CDR-> (738 62 (:REWRITE CONSP-FROM-LEN-CHEAP))
                     (494 2 (:DEFINITION MERGE-SORT-BY-CDR->))
                     (458 52 (:REWRITE DEFAULT-CDR))
                     (378 8 (:DEFINITION EVENS))
...
(ALISTP-OF-EVENS (271 25 (:REWRITE CONSP-FROM-LEN-CHEAP))
                 (170 11 (:REWRITE USE-ALL-CONSP-FOR-CAR))
                 (84 20 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
                 (79 10 (:REWRITE ALL-CONSP-OF-CDR))
                 (72 15 (:REWRITE LEN-OF-CDR))
                 (67 2 (:REWRITE ALL-CONPS-OF-EVENS))
...
(ALISTP-OF-MERGE-SORT-BY-CDR->
     (1915 8 (:DEFINITION MERGE-BY-CDR->))
     (1550 176 (:REWRITE DEFAULT-CDR))
     (1443 16
           (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (1396 42 (:DEFINITION EVENS))
     (1395 16
           (:REWRITE USE-ALL-CDRS-RATIONALP-FOR-CAR))
     (1315 16
     ...
     (1169 51
           (:REWRITE ALL-CDRS-RATIONALP-WHEN-NOT-CONSP))
     (945 136 (:REWRITE DEFAULT-<-1))
     (859 136 (:REWRITE DEFAULT-<-2))
     ...
     (248 2 (:REWRITE ALISTP-OF-MERGE-BY-CDR->))
     ...
     (44 22
         (:REWRITE CONSP-OF-CAR-WHEN-SYMBOL-TERM-ALISTP-CHEAP))
     (34 5 (:REWRITE ALL-CDRS-RATIONALP-OF-CDR))
     (29 29
         (:REWRITE CONSP-OF-CDR-WHEN-LEN-KNOWN))
