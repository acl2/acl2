(DARGP)
(DARGP-WHEN-MYQUOTEP-CHEAP (6 6 (:REWRITE DEFAULT-CDR))
                           (2 2 (:REWRITE DEFAULT-CAR)))
(DARGP-WHEN-MYQUOTEP (6 6 (:REWRITE DEFAULT-CDR))
                     (2 2 (:REWRITE DEFAULT-CAR)))
(DARGP-WHEN-NATP-CHEAP)
(DARGP-WHEN-NATP)
(DARGP-OF-LIST-OF-QUOTE)
(DARGP-WHEN-CONSP-CHEAP (6 6 (:REWRITE DEFAULT-CDR))
                        (2 2 (:REWRITE DEFAULT-CAR))
...
(MYQUOTEP-WHEN-DARGP (6 6 (:REWRITE DEFAULT-CDR))
                     (2 2 (:REWRITE DEFAULT-CAR))
                     (2 1 (:REWRITE DARGP-WHEN-NATP-CHEAP))
                     (2 1 (:REWRITE DARGP-WHEN-MYQUOTEP-CHEAP))
                     (1 1 (:TYPE-PRESCRIPTION NATP))
