...
(BOUNDED-AXE-TREEP-OF-CDR-OF-ASSOC-EQUAL-WHEN-ALL-DARGP-OF-STRIP-CDRS
     ...
     (1416 3 (:DEFINITION PSEUDO-TERMP))
...
(FLAG-LEMMA-FOR-AXE-TREEP-OF-MV-NTH-0-OF-INSTANTIATE-HYP-BASIC
    (37361 2541 (:REWRITE CONSP-FROM-LEN-CHEAP))
    (16164 37 (:REWRITE ALL-AXE-TREEP-OF-CDR))
    (11629 439 (:REWRITE USE-ALL-CONSP-FOR-CAR))
    (10058 264 (:REWRITE ALL-DARGP-WHEN-NOT-CONSP))
    (9580 533 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
    (9402 150
          (:REWRITE ALL-AXE-TREEP-WHEN-ALL-DARGP))
    (8994 79 (:REWRITE AXE-TREEP-WHEN-DARGP))
    (6796 4 (:DEFINITION AXE-TREEP))
    (6571 150
          (:REWRITE ALL-AXE-TREEP-WHEN-PSEUDO-TERM-LISTP))
    (6534 46 (:DEFINITION DARGP))
    (5749 2902 (:REWRITE DEFAULT-CDR))
    (5693 3249 (:REWRITE DEFAULT-CAR))
    (4811 4811
    ...
    (3442 1721
          (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP))
    (3054 1736 (:REWRITE DEFAULT-<-2))
    (2720 80 (:DEFINITION STRIP-CDRS))
    (2162 2162
          (:TYPE-PRESCRIPTION SYMBOL-TERM-ALISTP))
    (1830 1830 (:REWRITE USE-ALL-CONSP-2))
    (1830 1830 (:REWRITE USE-ALL-CONSP))
    (1830 1830 (:REWRITE CONSP-WHEN-LEN-GREATER))
    (1736 1736 (:REWRITE USE-ALL-<-2))
    (1736 1736 (:REWRITE USE-ALL-<))
    (1736 1736 (:REWRITE DEFAULT-<-1))
    (1736 1736
          (:REWRITE <-WHEN-BOUNDED-AXE-TREEP))
    (1720 82 (:DEFINITION NATP))
    (1667 83 (:REWRITE DARGP-WHEN-CONSP-CHEAP))
    (1518 66 (:REWRITE USE-ALL-NATP-FOR-CAR))
    (1376 949 (:REWRITE DEFAULT-+-2))
    (1287 33 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
    (1245 439
          (:REWRITE CONSP-OF-CAR-WHEN-PSEUDO-DAGP))
    (1188 33 (:DEFINITION NAT-LISTP))
    ...
    (756 4 (:REWRITE ALL-DARGP-OF-CONS))
    (716 358
         (:REWRITE PSEUDO-TERM-LISTP-OF-CDR-WHEN-PSEUDO-TERMP))
    (626 293
         (:REWRITE SYMBOLP-OF-CAR-WHEN-AXE-TREEP-CHEAP))
    ...
    (164 82 (:REWRITE NATP-WHEN-POWER-OF-2P))
...
(FLAG-LEMMA-FOR-BOUNDED-AXE-TREEP-OF-MV-NTH-0-OF-INSTANTIATE-HYP-BASIC
     (9616 682 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (2517 27 (:DEFINITION SYMBOL-LISTP))
     (2482 73 (:DEFINITION STRIP-CDRS))
     (2226 735 (:REWRITE DEFAULT-CDR))
     (1847 209 (:REWRITE LEN-OF-CDR))
     (1746 98 (:REWRITE USE-ALL-CONSP-FOR-CAR))
     (1716 26
           (:REWRITE ALL-DARGP-LESS-THAN-WHEN-ALL-<))
     (1541 809 (:REWRITE DEFAULT-CAR))
     (1508 26 (:REWRITE ALL-<-WHEN-NOT-CONSP))
     (1262 129 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
     (1231 1205
     ...
     (1205 1205
           (:REWRITE LEN-WHEN-DARGP-LESS-THAN))
     (1152 55 (:DEFINITION TRUE-LISTP))
     (891 99
          (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
     (888 75
          (:REWRITE EQUAL-OF-+-WHEN-NEGATIVE-CONSTANT))
     (765 421 (:REWRITE DEFAULT-<-2))
     ...
     (421 421 (:REWRITE <-WHEN-BOUNDED-AXE-TREEP))
     (294 98
          (:REWRITE CONSP-OF-CAR-WHEN-PSEUDO-DAGP))
     (272 136
          (:REWRITE PSEUDO-TERM-LISTP-WHEN-SYMBOL-LISTP-CHEAP))
     ...
     (184 92
          (:REWRITE PSEUDO-TERM-LISTP-OF-CDR-WHEN-PSEUDO-TERMP))
     (177 31 (:REWRITE ALL-CONSP-OF-CDR))
...
(FLAG-LEMMA-FOR-THEOREM-FOR-INSTANTIATE-HYP-BASIC4
     ...
     (1304 4 (:DEFINITION PSEUDO-TERMP))
