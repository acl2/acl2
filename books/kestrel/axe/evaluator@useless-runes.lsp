...
(BITOR-UNGUARDED-CORRECT
    (202 12 (:REWRITE GETBIT-IDENTITY))
    (120 10
    ...
    (6 2
       (:REWRITE INTEGERP-OF-*-1/2-OF-LOGNOT))
    (4 4
       (:REWRITE FLOOR-MINUS-NEGATIVE-CONSTANT))
...
(GETBIT-UNGUARDED-CORRECT
    (696 16 (:REWRITE BVCHOP-IDENTITY))
    (461 41
         (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
    (309 13 (:DEFINITION NATP))
    (266 5 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
    (229 11 (:LINEAR <=-OF-LOGTAIL-SAME-LINEAR))
    (188 8
...
(BVNOT-UNGUARDED-CORRECT
     ...
     (211 7 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
     ...
     (47 3 (:REWRITE BVCHOP-OF-MINUS-1))
...
(EQUAL-LST-EXEC)
(TAKE-EVERY-NTH-AUX
     (24214 726 (:REWRITE USE-ALL-<-FOR-CAR))
     (21872 472 (:DEFINITION NAT-LISTP))
     (14400 959 (:REWRITE LEN-OF-CDR))
     (14194 7263 (:REWRITE DEFAULT-+-2))
     (12070 118
            (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
     (11150 118 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
     (10664 372 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
     (10072 7263 (:REWRITE DEFAULT-+-1))
     (6060 372 (:DEFINITION NATP))
     ...
     (2357 76 (:REWRITE EQUAL-OF-LEN-AND-0))
     (2334 2334
           (:REWRITE SIZE-NON-NEGATIVE-WHEN-UNSIGNED-BYTE-P-FREE))
     (2283 2283
           (:REWRITE NONNEG-WHEN-DARGP-LESS-THAN))
     ...
     (1350 1350 (:TYPE-PRESCRIPTION POWER-OF-2P))
     ...
     (744 372 (:REWRITE NATP-WHEN-POWER-OF-2P))
     (744 372
     ...
     (242 242
          (:REWRITE TRUE-LISTP-WHEN-BV-ARRAYP))
...
(KEEP-ITEMS-LESS-THAN-UNGUARDED-CORRECT
     ...
     (336 3 (:REWRITE REVAPPEND-OF-CONS))
     (327 3 (:DEFINITION BINARY-APPEND))
     (135 3 (:REWRITE CAR-OF-REVAPPEND))
     (126 3 (:DEFINITION LAST))
     (102 3 (:REWRITE CDR-OF-REVAPPEND))
     (99 3 (:DEFINITION BUTLAST))
     (87 6 (:REWRITE LEN-OF-CDR))
     (81 3 (:REWRITE CONSP-OF-REVAPPEND))
...
(BVLT-UNGUARDED-CORRECT
     (416 38 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
     (397 122
          (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
     (210 21 (:DEFINITION NATP))
     (195 121 (:REWRITE DEFAULT-<-1))
     (192 26 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
...
(BVLE-UNGUARDED-CORRECT
     (417 39 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
     (398 123
          (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
     (210 21 (:DEFINITION NATP))
     (196 122 (:REWRITE DEFAULT-<-1))
     (192 26 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
...
(BVOR-UNGUARDED-CORRECT
     (864 6 (:DEFINITION EVENP))
     (774 6
          (:REWRITE INTEGERP-OF-*-1/2-OF-LOGNOT))
     (696 6 (:REWRITE INTEGERP-OF-SMALL))
     (328 6 (:LINEAR BVCHOP-UPPER-BOUND))
     (192 12 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR-2))
     (158 62
          (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
     (154 20 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
     (126 6 (:DEFINITION EXPT))
     (122 6 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
     (104 52 (:REWRITE INTEGERP-WHEN-POWER-OF-2P))
     (98 16 (:REWRITE BVCHOP-IMPOSSIBLE-VALUE))
...
(BVAND-UNGUARDED-CORRECT
     (786 6 (:DEFINITION EVENP))
     (696 6 (:REWRITE INTEGERP-OF-SMALL))
     (696 6 (:REWRITE FLOOR-WHEN-<))
     (656 12 (:LINEAR BVCHOP-UPPER-BOUND))
     (384 24 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR-2))
     (252 12 (:DEFINITION EXPT))
     (244 30 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
     (244 12 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
     (204 76
          (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
     ...
     (90 90
         (:REWRITE <-WHEN-ALL-DARGP-LESS-THAN-GEN))
     (90 8 (:REWRITE BVCHOP-IMPOSSIBLE-VALUE))
     (76 76
         (:REWRITE UNSIGNED-BYTE-P-WHEN-<=-CHEAP))
     (76 76
         (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
...
(BVMOD-UNGUARDED-CORRECT
     (2120 120 (:DEFINITION EXPT))
     (1646 22 (:REWRITE MOD-WHEN-<))
     (1230 42 (:REWRITE MULTIPLE-WHEN-<=))
     (923 7
          (:REWRITE UNSIGNED-BYTE-P-OF-MOD-WHEN-<=-OF-EXPT))
     (490 150
          (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
     (434 170 (:REWRITE DEFAULT-*-2))
     (408 36 (:DEFINITION NATP))
     (384 128 (:REWRITE COMMUTATIVITY-OF-+))
     (314 240 (:REWRITE DEFAULT-<-2))
     (290 42 (:REWRITE DEFAULT-UNARY-/))
     (290 22 (:REWRITE MOD-WHEN-MULTIPLE))
     ...
     (180 90 (:REWRITE INTEGERP-WHEN-POWER-OF-2P))
     (167 76
          (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER))
     (150 150
          (:REWRITE UNSIGNED-BYTE-P-WHEN-<=-CHEAP))
     ...
     (148 76 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
     (140 140
          (:REWRITE USE-ALL-UNSIGNED-BYTE-P-2))
     ...
     (6 6 (:REWRITE USE-ALL-RATIONALP-2))
     (6 6 (:REWRITE USE-ALL-RATIONALP))
     (6 6 (:REWRITE NOT-<-OF-EXPT-AND-BVCHOP))
     (6 6
        (:REWRITE EQUAL-CONSTANT-WHEN-BVCHOP-EQUAL-CONSTANT-FALSE))
     (6 6
        (:REWRITE ACL2-NUMBERP-WHEN-UNSIGNED-BYTE-P))
...
(BVDIV-UNGUARDED-CORRECT
     (369 17 (:DEFINITION EXPT))
     (134 32
          (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
     (117 21 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
...
(UNPACKBV-LESS-GUARDED-CORRECT
     ...
     (44 2 (:REWRITE UNSIGNED-BYTE-P-OF-0-ARG2))
...
(COERCE-UNGUARDED-CORRECT
     ...
     (100 5 (:REWRITE DEFAULT-COERCE-3))
     (81 3 (:DEFINITION MAKE-CHARACTER-LIST))
     (44 8
         (:LINEAR LEN-POSITIVE-WHEN-CONSP-LINEAR-CHEAP))
...
(SYMBOL-NAME-UNGUARDED-CORRECT
     ...
     (1 1 (:REWRITE CLR-DIFFERENTIAL)))
(SET::IN-UNGUARDED)
(SET::IN-UNGUARDED-CORRECT (20 4 (:REWRITE SET::IN-TAIL))
...
(NEGATED-ELEMS-LISTP-UNGUARDED-CORRECT
     ...
     (220 52
          (:REWRITE NEGATED-ELEMS-LISTP-REWRITE))
...
(FIRSTN-UNGUARDED-CORRECT
     (101 3 (:REWRITE FIRSTN-WHEN-<=-OF-LEN))
...
(GETBIT-IS-ALWAYS-0-UNGUARDED-CORRECT
    (766 22 (:REWRITE GETBIT-IDENTITY))
    (414 22
         (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
...
(GET-CALLED-FNS-AUX
     (5894 14 (:DEFINITION ACL2-COUNT))
     (4728 18 (:DEFINITION INTEGER-ABS))
     (4526 57 (:REWRITE USE-ALL-<-FOR-CAR))
     (4141 34 (:DEFINITION NAT-LISTP))
     (2610 27 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
     (2428 51 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
     (2205 25 (:REWRITE ALL-NATP-OF-CDR))
     (2090 27 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
     (1912 12 (:REWRITE ALL-<-OF-CDR))
     (1898 74 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (1367 93 (:REWRITE LEN-OF-CDR))
     (854 34 (:DEFINITION NATP))
     (431 34 (:REWRITE USE-ALL-NATP-FOR-CAR))
     (370 10 (:REWRITE CDR-IFF))
     (297 51 (:REWRITE ALL-NATP-WHEN-NOT-CONSP))
     (295 189 (:REWRITE DEFAULT-CAR))
     (254 170 (:REWRITE DEFAULT-+-2))
     (248 248 (:TYPE-PRESCRIPTION NAT-LISTP))
     (223 140 (:REWRITE DEFAULT-CDR))
     (219 3 (:REWRITE USE-ALL-RATIONALP-FOR-CAR))
     ...
     (67 8 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
...
(FLAG-GET-CALLED-FNS-AUX
     (5924 66 (:DEFINITION INTEGER-ABS))
     (5190 77 (:REWRITE USE-ALL-<-FOR-CAR))
     (4725 46 (:DEFINITION NAT-LISTP))
     (3059 129 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (2912 31 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
     (2714 63 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
     (2420 31 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
     (2223 27 (:REWRITE ALL-NATP-OF-CDR))
     (1928 138 (:REWRITE LEN-OF-CDR))
     (1912 12 (:REWRITE ALL-<-OF-CDR))
     (1046 46 (:DEFINITION NATP))
     (709 414 (:REWRITE DEFAULT-+-2))
     (587 259 (:REWRITE DEFAULT-CAR))
     (531 414 (:REWRITE DEFAULT-+-1))
     (511 46 (:REWRITE USE-ALL-NATP-FOR-CAR))
     (473 230 (:REWRITE DEFAULT-CDR))
     (370 10 (:REWRITE CDR-IFF))
     (312 312 (:TYPE-PRESCRIPTION NAT-LISTP))
     (312 308 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
     (309 63 (:REWRITE ALL-NATP-WHEN-NOT-CONSP))
     ...
     (269 14 (:REWRITE USE-ALL-CONSP-FOR-CAR))
     ...
     (251 251
          (:REWRITE <-WHEN-ALL-DARGP-LESS-THAN-GEN))
     (239 7 (:REWRITE USE-ALL-RATIONALP-FOR-CAR))
     (214 214 (:TYPE-PRESCRIPTION ALL-NATP))
     (212 106
          (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP))
     (203 1 (:DEFINITION SYMBOL-ALISTP))
     (195 11
          (:REWRITE ALL-RATIONALP-WHEN-NOT-CONSP))
     (187 24 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
     (182 182
          (:REWRITE LEN-OF-CAR-WHEN-ITEMS-HAVE-LEN-STRONG))
     (182 182
          (:REWRITE LEN-OF-CAR-WHEN-ITEMS-HAVE-LEN))
     (168 11 (:REWRITE ALL-CONSP-OF-CDR))
     ...
     (63 63
         (:REWRITE ALL-NATP-WHEN-NOT-CONSP-CHEAP))
     (61 31 (:REWRITE ALL-<-WHEN-NOT-CONSP))
...
(FLAG-LEMMA-FOR-SYMBOL-LISTP-OF-GET-CALLED-FNS-AUX
     ...
     (6600 1069 (:REWRITE DEFAULT-CDR))
     (2239 96 (:REWRITE USE-ALL-CONSP-FOR-CAR))
     (1780 1717
     ...
     (1692 1692
           (:REWRITE LEN-WHEN-DARGP-LESS-THAN))
     (1692 1692 (:REWRITE LEN-WHEN-BV-ARRAYP))
     (1692 1692
           (:REWRITE LEN-WHEN-BOUNDED-DAG-EXPRP-AND-QUOTEP))
     (1471 191 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
     (1095 832 (:REWRITE DEFAULT-+-2))
     (1061 616 (:REWRITE DEFAULT-<-2))
     (896 99 (:REWRITE ALL-CONSP-OF-CDR))
     ...
     (616 616
          (:REWRITE <-WHEN-ALL-DARGP-LESS-THAN-GEN))
     (598 420 (:REWRITE EQUAL-OF-BOOLEANS-CHEAP))
     (587 587
          (:REWRITE LEN-OF-CAR-WHEN-ITEMS-HAVE-LEN-STRONG))
     (587 587
          (:REWRITE LEN-OF-CAR-WHEN-ITEMS-HAVE-LEN))
     (556 12 (:DEFINITION STRIP-CARS))
     (420 420
          (:REWRITE EQUAL-CONSTANT-WHEN-BVCHOP-EQUAL-CONSTANT-FALSE))
...
(GET-CALLED-FNS-AUX
     (4882 344 (:REWRITE DEFAULT-CAR))
     (4402 559 (:REWRITE DEFAULT-CDR))
     (1589 12 (:DEFINITION SYMBOL-ALISTP))
     (1496 56 (:REWRITE USE-ALL-CONSP-FOR-CAR))
     (1088 1063
           (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
     (1051 1051
           (:REWRITE LEN-WHEN-PSEUDO-DAGP-AUX))
     (1051 1051
           (:REWRITE LEN-WHEN-DARGP-LESS-THAN))
     (1051 1051 (:REWRITE LEN-WHEN-BV-ARRAYP))
     (1051 1051
           (:REWRITE LEN-WHEN-BOUNDED-DAG-EXPRP-AND-QUOTEP))
     (958 138 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
     (772 83 (:REWRITE ALL-CONSP-OF-CDR))
     (650 610 (:REWRITE DEFAULT-+-2))
     (610 610 (:REWRITE DEFAULT-+-1))
     (430 305 (:REWRITE DEFAULT-<-2))
     (422 285 (:REWRITE EQUAL-OF-BOOLEANS-CHEAP))
     ...
     (285 285
          (:REWRITE EQUAL-CONSTANT-WHEN-BVCHOP-EQUAL-CONSTANT-FALSE))
     (285 285 (:REWRITE CLR-DIFFERENTIAL))
     (277 277 (:TYPE-PRESCRIPTION ALL-CONSP))
     (207 207
          (:REWRITE LEN-OF-CAR-WHEN-ITEMS-HAVE-LEN-STRONG))
     (207 207
          (:REWRITE LEN-OF-CAR-WHEN-ITEMS-HAVE-LEN))
     ...
     (138 138
          (:REWRITE ALL-CONSP-WHEN-NOT-CONSP-CHEAP))
     (136 5 (:DEFINITION GET-CALLED-FNS-AUX-LST))
     (112 56
          (:REWRITE CONSP-OF-CAR-WHEN-SYMBOL-TERM-ALISTP-CHEAP))
     (111 111 (:TYPE-PRESCRIPTION PSEUDO-DAGP))
     (108 54
          (:REWRITE PSEUDO-TERM-LISTP-WHEN-SYMBOL-LISTP-CHEAP))
     (104 104
          (:REWRITE <-OF-LEN-WHEN-NTH-NON-NIL))
...
(SYMBOL-LISTP-OF-GET-IMMEDIATE-SUPPORTING-FNS
     (1251 1 (:DEFINITION GET-CALLED-FNS-AUX))
     (996 26 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (572 39 (:REWRITE LEN-OF-CDR))
     (501 18 (:REWRITE DEFAULT-CAR))
     (380 32 (:REWRITE DEFAULT-CDR))
     (243 243 (:TYPE-PRESCRIPTION LEN))
     (149 81 (:REWRITE EQUAL-OF-BOOLEANS-CHEAP))
     (126 1 (:DEFINITION SYMBOL-ALISTP))
     (87 1 (:DEFINITION QUOTEP))
     (81 81
         (:REWRITE EQUAL-CONSTANT-WHEN-BVCHOP-EQUAL-CONSTANT-FALSE))
     ...
     (71 4 (:REWRITE USE-ALL-CONSP-FOR-CAR))
     ...
     (52 1 (:DEFINITION SAFE-UNQUOTE))
     (49 21 (:REWRITE DEFAULT-<-2))
     (48 1 (:DEFINITION STRIP-CARS))
     (40 10 (:REWRITE FOLD-CONSTS-IN-+))
     (39 39 (:REWRITE DEFAULT-+-1))
     (39 8 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
     (37 1 (:DEFINITION SYMBOL-LISTP))
     (33 4 (:REWRITE ALL-CONSP-OF-CDR))
     (31 1 (:DEFINITION UNION-EQUAL))
...
(EQUAL-OF-TRUE-LIST-FIX-AND-LIST-OF-CAR
     (178 7 (:DEFINITION TRUE-LIST-FIX))
     (75 15
         (:REWRITE TRUE-LIST-FIX-WHEN-TRUE-LISTP))
...
(CONSP-OF-LOOKUP-EQUAL-WHEN-ITEMS-HAVE-LEN-OF-STRIP-CDRS
     (346 30 (:REWRITE DEFAULT-CDR))
     (256 56 (:REWRITE DEFAULT-CAR))
     (238 119
          (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP))
     (163 139 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
     (156 2 (:REWRITE CONSP-OF-ASSOC-EQUAL))
...
(SUPPORTING-NON-BASE-FNS
    (21957 10986
           (:REWRITE EQUAL-OF-BOOLEANS-CHEAP))
    (13590 11432 (:REWRITE DEFAULT-CAR))
    (10986 10986
           (:REWRITE EQUAL-CONSTANT-WHEN-BVCHOP-EQUAL-CONSTANT-FALSE))
    (10986 10986 (:REWRITE CLR-DIFFERENTIAL))
    (10922 10922 (:TYPE-PRESCRIPTION BOOLEANP))
    (3106 57 (:REWRITE USE-ALL-CONSP-FOR-CAR))
    (2826 66 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
    (2350 413 (:REWRITE DEFAULT-CDR))
    (1564 34 (:DEFINITION STRIP-CDRS))
    (1258 17
          (:REWRITE ALL-INTERPRETED-FUNCTION-INFOP-WHEN-NOT-CONSP))
    (1130 25 (:REWRITE ALL-CONSP-OF-CDR))
    (735 718 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
    (718 718 (:REWRITE LEN-WHEN-PSEUDO-DAGP-AUX))
    (718 718 (:REWRITE LEN-WHEN-DARGP-LESS-THAN))
    (718 718 (:REWRITE LEN-WHEN-BV-ARRAYP))
    (718 718
         (:REWRITE LEN-WHEN-BOUNDED-DAG-EXPRP-AND-QUOTEP))
    ...
    (66 66
        (:REWRITE ALL-CONSP-WHEN-NOT-CONSP-CHEAP))
    (62 1
        (:REWRITE INTERPRETED-FUNCTION-INFOP-OF-CDR-OF-ASSOC-EQUAL))
    (57 57
        (:REWRITE TRUE-LISTP-OF-CAR-WHEN-WHEN-BOUNDED-NATP-ALISTP))
    (57 57
        (:REWRITE CONSP-OF-CAR-WHEN-PSEUDO-DAGP-AUX-2))
