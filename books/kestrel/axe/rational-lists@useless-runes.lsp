...
(CAR-BOUND-WHEN-ALL-< (18 2 (:REWRITE DEFAULT-<-2))
                      (16 2
                          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(<-OF-+-OF-1-STRENGTHEN (2 2 (:REWRITE USE-ALL-<=-2))
                        (2 2 (:REWRITE USE-ALL-<=))
                        (2 2 (:REWRITE USE-ALL-<-2))
                        (2 2 (:REWRITE USE-ALL-<))
                        (2 2 (:REWRITE DEFAULT-<-2))
...
(<-OF-+-OF-1-STRENGTHEN-2 (2 2 (:REWRITE USE-ALL-<=-2))
                          (2 2 (:REWRITE USE-ALL-<=))
                          (2 2 (:REWRITE USE-ALL-<-2))
                          (2 2 (:REWRITE USE-ALL-<))
                          (2 2 (:REWRITE DEFAULT-<-2))
...
(NOT-NEGATIVE-WHEN-ALL-<=-AND-ALL-NATP
     ...
     (2 2 (:REWRITE ALL-<-TRANSITIVE-FREE))
     (2 2 (:REWRITE ALL-<-TRANSITIVE)))
(ALL-<=-OF-ONE-LESS (70 7 (:REWRITE USE-ALL-<-FOR-CAR))
