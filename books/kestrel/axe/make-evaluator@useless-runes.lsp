...
(TYPE-OF-AREF1-WHEN-EVAL-ARRAYP
     ...
     (1 1
        (:REWRITE <-WHEN-ALL-DARGP-LESS-THAN-GEN)))
(EVAL-ARRAYP-MONOTONE (13 13 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
                      (8 2
...
(GET-ARGS-NOT-DONE-ARRAY
   (1010 28 (:DEFINITION NAT-LISTP))
   (857 39 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
   (827 20 (:REWRITE USE-ALL-<-FOR-CAR))
   (659 659
        (:TYPE-PRESCRIPTION TYPE-OF-AREF1-WHEN-PSEUDO-DAG-ARRAYP-AUX))
   (640 2 (:LINEAR LARGEST-NON-QUOTEP-BOUND))
   (466 31 (:REWRITE USE-ALL-NATP-FOR-CAR))
   (349 18 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
   (308 18 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
   (272 208 (:TYPE-PRESCRIPTION ALEN1-TYPE))
   ...
   (121 20 (:REWRITE ALL-<-TRANSITIVE-FREE-2))
   (93 33 (:REWRITE USE-ALL-NATP))
   ...
   (65 39 (:REWRITE ALL-NATP-WHEN-NOT-CONSP))
...
(GET-VALS-OF-ARGS-ARRAY
   ...
   (621 16 (:REWRITE USE-ALL-<-FOR-CAR))
   (597 4 (:LINEAR LARGEST-NON-QUOTEP-BOUND))
   (587 19 (:DEFINITION NAT-LISTP))
   (464 292 (:TYPE-PRESCRIPTION ALEN1-TYPE))
   (446 223
        (:TYPE-PRESCRIPTION NATP-OF-LARGEST-NON-QUOTEP))
   ...
   (113 16 (:REWRITE ALL-<-TRANSITIVE-FREE-2))
   ...
   (22 22
       (:REWRITE ALL-NATP-WHEN-NOT-CONSP-CHEAP))
   (21 16 (:REWRITE ALL-<-WHEN-NOT-CONSP))
   (20 20
       (:REWRITE CONSP-OF-CAR-WHEN-PSEUDO-DAGP-AUX-2))
   (20 20
       (:REWRITE CONSP-OF-CAR-WHEN-PSEUDO-DAGP-AUX))
