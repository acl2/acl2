...
(GET-ARGS-NOT-DONE-ARRAY
   (1078 34 (:DEFINITION NAT-LISTP))
   (932 24 (:REWRITE USE-ALL-<-FOR-CAR))
   (915 45 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
   (816 816
        (:TYPE-PRESCRIPTION TYPE-OF-AREF1-WHEN-PSEUDO-DAG-ARRAYP-AUX))
   (730 3 (:LINEAR LARGEST-NON-QUOTEP-BOUND))
   (564 39 (:REWRITE USE-ALL-NATP-FOR-CAR))
   (383 22 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
   (340 22 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
   (254 254 (:TYPE-PRESCRIPTION NAT-LISTP))
   (231 231 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
   (230 115
        (:TYPE-PRESCRIPTION NATP-OF-LARGEST-NON-QUOTEP))
   (174 6 (:REWRITE ALL-NATP-OF-CDR))
   (126 4 (:REWRITE ALL-<-OF-CDR))
   (124 25 (:REWRITE ALL-<-TRANSITIVE-FREE-2))
...
(GET-VALS-OF-ARGS-ARRAY
   (625 15 (:DEFINITION NATP))
   (592 16 (:REWRITE USE-ALL-<-FOR-CAR))
   (576 288
        (:TYPE-PRESCRIPTION NATP-OF-LARGEST-NON-QUOTEP))
   (531 19 (:DEFINITION NAT-LISTP))
   (399 22 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
   (360 23 (:REWRITE USE-ALL-NATP-FOR-CAR))
   (285 285 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
   (250 250 (:TYPE-PRESCRIPTION ALL-MYQUOTEP))
   (231 13 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
   (217 13 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
   (133 133 (:TYPE-PRESCRIPTION NAT-LISTP))
   (112 17 (:REWRITE ALL-<-TRANSITIVE-FREE-2))
   (110 110
        (:TYPE-PRESCRIPTION TYPE-OF-AREF1-WHEN-PSEUDO-DAG-ARRAYP-AUX))
