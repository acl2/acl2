...
(<-OF-FIND-EXPR-USING-PARENTS-WITH-NAME
   (257 1 (:REWRITE FIRST-ATOM-BOUND-LEMMA))
   (174 87
        (:TYPE-PRESCRIPTION NATP-OF-MV-NTH-0-OF-FIRST-ATOM))
   ...
   (50 4
       (:REWRITE ALL-DARGP-LESS-THAN-WHEN-ALL-<))
   (49 1 (:REWRITE USE-ALL-NATP-FOR-CAR))
   (48 12
       (:REWRITE AREF1-WHEN-TOO-LARGE-CHEAP))
   (48 8
       (:TYPE-PRESCRIPTION TRUE-LISTP-OF-AREF1-WHEN-DAG-PARENT-ARRAYP))
...
(ADD-TO-PARENTS-OF-ATOMS-WITH-NAME
  (2940 19
        (:REWRITE ALL-DARGP-LESS-THAN-MONOTONE))
  (2106 41 (:REWRITE ALL-<-TRANSITIVE-FREE-2))
  (1494 12 (:REWRITE USE-ALL-<-FOR-CAR))
  (1016 12 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
  (957 19
       (:REWRITE ALL-DARGP-LESS-THAN-WHEN-ALL-<))
  (903 12 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
  (869 18 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
  ...
  (2 2
     (:REWRITE ARRAY1P-WHEN-PSEUDO-DAG-ARRAYP)))
(ADD-TO-PARENTS-OF-ATOMS-WITH-NAME-WHEN-NO-ATOMS
...
(ARRAY1P-OF-ADD-TO-PARENTS-OF-ATOMS-WITH-NAME
  ...
  (32 16
      (:REWRITE ALL-DARGP-LESS-THAN-WHEN-ALL-MYQUOTEP-CHEAP))
  (28 14 (:REWRITE ALL-MYQUOTEP-OF-CDR-CHEAP))
  (27 14
      (:REWRITE ALL-DARGP-LESS-THAN-WHEN-NOT-CONSP))
...
(ALL-DAG-PARENT-ENTRIESP-OF-ADD-TO-PARENTS-OF-ATOMS-WITH-NAME
  ...
  (1242 19 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
  (1181 34 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
  ...
  (92 46
      (:REWRITE ALL-MYQUOTEP-WHEN-NO-ATOMS-AND-ALL-DARGP-CHEAP))
  (90 14 (:REWRITE ALL-DARGP-LESS-THAN-OF-0))
  ...
  (68 34
      (:REWRITE ALL-NATP-WHEN-NAT-LISTP-CHEAP))
  (68 34 (:REWRITE ALL-MYQUOTEP-OF-CDR-CHEAP))
...
(DAG-PARENT-ARRAYP-OF-ADD-TO-PARENTS-OF-ATOMS-WITH-NAME
   ...
   (28 3 (:REWRITE NO-ATOMS-WHEN-ALL-MYQUOTEP))
   (25 3
       (:REWRITE <-WHEN-ALL-DARGP-LESS-THAN-GEN))
...
(ALL-<-OF-AREF1-OF-ADD-TO-PARENTS-OF-ATOMS-WITH-NAME
  (1442 64 (:REWRITE ALL-<-WHEN-NOT-CONSP))
  ...
  (92 46 (:REWRITE ALL-MYQUOTEP-OF-CDR-CHEAP))
...
(ALEN1-OF-MAKE-DAG-PARENT-ARRAY-WITH-NAME-AUX
 ...
 (137 2 (:DEFINITION BOUNDED-DAG-EXPRP))
 (126 126
 ...
 (102 6 (:REWRITE NO-ATOMS-WHEN-ALL-MYQUOTEP))
 ...
 (86 7 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
...
(DAG-PARENT-ARRAYP-OF-MAKE-DAG-PARENT-ARRAY-WITH-NAME-AUX
 ...
 (86 7 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
 (85 5 (:REWRITE NO-ATOMS-WHEN-ALL-MYQUOTEP))
 (79 3
     (:REWRITE ALL-DARGP-LESS-THAN-WHEN-ALL-<))
 (73 73
     (:REWRITE AREF1-WHEN-TOO-LARGE-CHEAP))
...
(BOUNDED-DAG-PARENT-ENTRIESP-OF-MAKE-DAG-PARENT-ARRAY-WITH-NAME-AUX
 ...
 (274 4 (:DEFINITION BOUNDED-DAG-EXPRP))
 (244 244
      (:TYPE-PRESCRIPTION PSEUDO-DAGP-AUX))
 ...
 (158 6
      (:REWRITE ALL-DARGP-LESS-THAN-WHEN-ALL-<))
 (136 8 (:REWRITE NO-ATOMS-WHEN-ALL-MYQUOTEP))
 (133 133
      (:REWRITE AREF1-WHEN-TOO-LARGE-CHEAP))
 (122 122
      (:REWRITE PSEUDO-DAGP-AUX-WHEN-NOT-CONSP-CHEAP))
 ...
 (36 12
     (:REWRITE CONSP-OF-CAR-WHEN-PSEUDO-DAGP))
 (34 34 (:TYPE-PRESCRIPTION NO-ATOMS))
 (34 34
     (:REWRITE NONNEG-WHEN-DARGP-LESS-THAN))
 (32 4
     (:REWRITE DAG-EXPRP0-OF-AREF1-WHEN-PSEUDO-DAG-ARRAYP-AUX))
