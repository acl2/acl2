...
(mutual-recursion
              ...
              (if (and (eq fn 'if) ;bozo, consider also handling bvif, boolif, myif, maybe boolor and booland...
                  ...
                  (let* ((test (second form))
                    ...
                    (if (quotep test-result)
                      ...
                      (list 'if
                            test-result
                            (my-sublis-var-and-eval-basic alist (third form) interpreted-function-alist) ;then part
                            (my-sublis-var-and-eval-basic alist (fourth form) interpreted-function-alist) ;else part
                            )))
                ;;regular function call or lambda
                (mv-let (ground-termp args)
                  (my-sublis-var-and-eval-basic-lst alist (fargs form) interpreted-function-alist)
                  (if ground-termp
 ...
 (defund my-sublis-var-and-eval-basic-lst (alist l interpreted-function-alist)
   (declare (xargs
             :verify-guards nil
             :guard (and (symbol-alistp alist)
   ...
   (if (atom l)
       (mv t nil)
     (let ((new-car (my-sublis-var-and-eval-basic alist (car l) interpreted-function-alist)))
       (mv-let (cdr-ground-termp new-cdr)
         (my-sublis-var-and-eval-basic-lst alist (cdr l) interpreted-function-alist)
...
(defthm len-of-mv-nth-1-of-my-sublis-var-and-eval-basic-lst
  (equal (len (mv-nth 1 (my-sublis-var-and-eval-basic-lst alist l interpreted-function-alist)))
         (len l))
  :hints (("Goal" :induct (len l) :in-theory (enable my-sublis-var-and-eval-basic-lst (:i len)))))

(defthm true-listp-of-mv-nth-1-of-my-sublis-var-and-eval-basic-lst
  (true-listp (mv-nth 1 (my-sublis-var-and-eval-basic-lst alist l interpreted-function-alist)))
  :hints (("Goal" :induct (len l) :in-theory (enable my-sublis-var-and-eval-basic-lst (:i len)))))
...
;;              (pseudo-termp (my-sublis-var-and-eval-basic alist form interpreted-function-alist)))
...
;;                   ;(pseudo-term-listp (strip-cdrs alist))
;;                   (alistp interpreted-function-alist))
;;              (pseudo-term-listp (mv-nth 1 (my-sublis-var-and-eval-basic-lst alist l interpreted-function-alist))))
...
(defthm-flag-my-sublis-var-and-eval-basic
  (defthm myquotep-of-my-sublis-var-and-eval-basic
    (implies (and (eq 'quote (car (my-sublis-var-and-eval-basic alist form interpreted-function-alist)))
                  (all-dargp (strip-cdrs alist))
                  (pseudo-termp form)
                  )
             (myquotep (my-sublis-var-and-eval-basic alist form interpreted-function-alist)))
    :flag my-sublis-var-and-eval-basic)
  (defthm all-myquotep-of-mv-nth-1-of-my-sublis-var-and-eval-basic-lst
    (implies (and (mv-nth 0 (my-sublis-var-and-eval-basic-lst alist l interpreted-function-alist))
                  (all-dargp (strip-cdrs alist))
                  (pseudo-term-listp l))
             (all-myquotep (mv-nth 1 (my-sublis-var-and-eval-basic-lst alist l interpreted-function-alist))))
    :flag my-sublis-var-and-eval-basic-lst)
...
(defthm-flag-my-sublis-var-and-eval-basic
  (defthm axe-treep-of-my-sublis-var-and-eval-basic
    (implies (and ;(eq 'quote (car (my-sublis-var-and-eval-basic alist form interpreted-function-alist)))
             ...
             (axe-treep (my-sublis-var-and-eval-basic alist form interpreted-function-alist)))
    :flag my-sublis-var-and-eval-basic)
  (defthm all-axe-treep-of-mv-nth-1-of-my-sublis-var-and-eval-basic-lst
    (implies (and ;(mv-nth 0 (my-sublis-var-and-eval-basic-lst alist l interpreted-function-alist))
                  (all-dargp (strip-cdrs alist))
                  (pseudo-term-listp l))
             (all-axe-treep (mv-nth 1 (my-sublis-var-and-eval-basic-lst alist l interpreted-function-alist))))
    :flag my-sublis-var-and-eval-basic-lst)
  :hints (("Goal" :in-theory (e/d (my-sublis-var-and-eval-basic my-sublis-var-and-eval-basic-lst)
...
(defthm-flag-my-sublis-var-and-eval-basic
  (defthm bounded-axe-treep-of-my-sublis-var-and-eval-basic
    (implies (and ;(eq 'quote (car (my-sublis-var-and-eval-basic alist form interpreted-function-alist)))
             ...
             (bounded-axe-treep (my-sublis-var-and-eval-basic alist form interpreted-function-alist) dag-len))
    :flag my-sublis-var-and-eval-basic)
  (defthm all-bounded-axe-treep-of-mv-nth-1-of-my-sublis-var-and-eval-basic-lst
    (implies (and ;(mv-nth 0 (my-sublis-var-and-eval-basic-lst alist l interpreted-function-alist))
                  (all-dargp-less-than (strip-cdrs alist) dag-len)
                  (pseudo-term-listp l))
             (all-bounded-axe-treep (mv-nth 1 (my-sublis-var-and-eval-basic-lst alist l interpreted-function-alist)) dag-len))
    :flag my-sublis-var-and-eval-basic-lst)
