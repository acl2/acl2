(BOUNDED-NATP-ALISTP-REDEF
     ...
     (667 121 (:REWRITE ALL-NATP-WHEN-NOT-CONSP))
     (551 109 (:REWRITE USE-ALL-CONSP-FOR-CAR))
     (536 536
          (:TYPE-PRESCRIPTION SYMBOL-TERM-ALISTP))
     (463 98 (:REWRITE ALL-<-WHEN-NOT-CONSP))
     (285 109
     ...
     (106 106 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
     (101 101
...
(MAKE-NODE-REPLACEMENT-PAIRS-AND-ADD-TO-DAG-ARRAY-AUX
     ...
     (1 1
        (:REWRITE CAR-OF-CAR-WHEN-PSEUDO-DAGP-AUX)))
(MAKE-NODE-REPLACEMENT-PAIRS-AND-ADD-TO-DAG-ARRAY-AUX-RETURN-TYPE
     (1212 1212 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
     ...
     (2 2
        (:REWRITE NATP-WHEN-ALL-DARGP-LESS-THAN-GEN)))
(MAKE-NODE-REPLACEMENT-PAIRS-AND-ADD-TO-DAG-ARRAY
...
(MAKE-NODE-REPLACEMENT-PAIRS-AND-ADD-TO-DAG-ARRAY-RETURN-TYPE-COROLLARY
