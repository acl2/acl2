...
(MERGE-TREE-INTO-DAG-ARRAY-BASIC
    (17139 156 (:REWRITE AXE-TREEP-WHEN-DARGP))
    (14418 239 (:DEFINITION SYMBOL-LISTP))
    (13874 565 (:DEFINITION LENGTH))
    (13744 38 (:DEFINITION DARGP))
    (10245 656 (:REWRITE USE-ALL-CONSP-FOR-CAR))
    (9446 153
          (:REWRITE ALL-AXE-TREEP-WHEN-PSEUDO-TERM-LISTP))
    (9350 227 (:DEFINITION PSEUDO-TERM-LISTP))
    (9294 192 (:DEFINITION NAT-LISTP))
    (9216 90 (:DEFINITION NATP))
    (8229 104 (:REWRITE USE-ALL-<-FOR-CAR))
    (7156 276 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
    (6880 5661 (:REWRITE DEFAULT-CDR))
    (6475 205 (:REWRITE USE-ALL-NATP-FOR-CAR))
    ...
    (3573 239
          (:REWRITE QUOTE-LEMMA-FOR-ALL-DARGP-LESS-THAN-GEN-ALT))
    (3570 115 (:REWRITE ALL-NATP-OF-CDR))
    (3558 78 (:REWRITE ALL-<-OF-CDR))
    (3446 170 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
    (3384 170
          (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
