...
(ALL-<-OF-STRIP-CDRS-OF-MAKE-DAG-VARIABLE-ALIST-AUX
    ...
    (74 68
        (:TYPE-PRESCRIPTION MAKE-DAG-VARIABLE-ALIST-AUX))
    ...
    (48 4
        (:REWRITE DAG-VARIABLE-ALISTP-OF-MAKE-DAG-VARIABLE-ALIST-AUX))
    (41 41
        (:REWRITE NONNEG-WHEN-DARGP-LESS-THAN))
    (41 41
        (:REWRITE INTEGERP-WHEN-DARGP-LESS-THAN))
...
(MAKE-DAG-VARIABLE-ALIST-OF-ASET1-EXPANDABLE
     ...
     (52 4
         (:DEFINITION MAKE-DAG-VARIABLE-ALIST-AUX))
     (8 8
        (:TYPE-PRESCRIPTION TYPE-OF-AREF1-WHEN-PSEUDO-DAG-ARRAYP-AUX))
...
(<-OF-CDR-OF-ASSOC-EQUAL-OF-MAKE-DAG-VARIABLE-ALIST-ALT
     ...
     (4 1
        (:REWRITE BOUNDED-DAG-VARIABLE-ALISTP-OF-MAKE-DAG-VARIABLE-ALIST))
     (4 1
        (:REWRITE ALL-<-OF-STRIP-CDRS-OF-MAKE-DAG-VARIABLE-ALIST))
     (2 2
        (:TYPE-PRESCRIPTION BOUNDED-DAG-VARIABLE-ALISTP))
