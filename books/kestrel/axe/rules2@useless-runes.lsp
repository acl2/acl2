...
(NOT-MEMBERP-OF-SUBRANGE
     ...
     (22 11
         (:REWRITE MEMBERP-WHEN-NOT-CONS-OF-CDR-CHEAP))
     (22 5 (:REWRITE NTHCDR-WHEN-NOT-POSP))
     (21 21
         (:REWRITE EQUAL-CONSTANT-WHEN-BVCHOP-EQUAL-CONSTANT-FALSE))
...
(ODDP-9-TIGHTEN (4 2 (:REWRITE INTEGERP-WHEN-POWER-OF-2P))
                (2 2 (:TYPE-PRESCRIPTION POWER-OF-2P))
                (2 2
                   (:REWRITE INTEGERP-FROM-UNSIGNED-BYTE-P-SIZE-PARAM))
...
(MYIF-OF-LOGEXT-LOGIOR-32-HACK
     ...
     (2 2 (:TYPE-PRESCRIPTION BVOR-TYPE))
     (2 2 (:REWRITE MYIF-WHEN-NOT-NIL))
     (2 2 (:REWRITE MYIF-WHEN-NIL))
     (2 2
        (:REWRITE MYIF-OF-CONSTANT-WHEN-NOT-NIL))
...
(NOT-LESS-WHEN->=-MAX-OF-CONTAINING-BAG
     ...
     (27 2
         (:REWRITE MEMBERP-WHEN-SUBSETP-EQUAL-2))
     (23 1 (:REWRITE ACL2-NUMBERP-OF-MAXELEM))
...
(MEMBERP-OF-MAXELEM-SAME
     (536 1 (:LINEAR MAXELEM-OF-CDR-LINEAR))
     (490 30 (:REWRITE DEFAULT-<-1))
     (226 115
          (:TYPE-PRESCRIPTION RATIONALP-OF-MAXELEM))
     (203 9 (:REWRITE ACL2-NUMBERP-OF-MAXELEM))
     (194 18
          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (176 9 (:DEFINITION INTEGER-LISTP))
...
(MAXELEM-SUBRANGE-SHORTEN-HACKB
     ...
     (2268 346 (:REWRITE DEFAULT-<-2))
     (2058 27 (:REWRITE MAXELEM-SINGLETON-ALT))
     (1548 72
           (:REWRITE SUBRANGE-TO-END-BECOMES-NTHCDR))
     (1099 318 (:REWRITE INEQ-HACK))
     (915 11 (:REWRITE ACL2-NUMBERP-OF-MAXELEM))
     (882 11 (:DEFINITION INTEGER-LISTP))
     (827 42
          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(MAXELEM-OF-FIRST-N+1-WHEN-NTH-IS-GREATEST
    ...
    (6168 333 (:REWRITE DEFAULT-<-1))
    (3873 18 (:REWRITE ACL2-NUMBERP-OF-MAXELEM))
    (3819 18 (:DEFINITION INTEGER-LISTP))
    (3742 52
          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
    (3474 18 (:REWRITE RATIONALP-OF-MAXELEM))
    (3342 16 (:DEFINITION RATIONAL-LISTP))
    (3284 196 (:REWRITE DEFAULT-CDR))
    (2527 333 (:REWRITE DEFAULT-<-2))
...
(IF-HACK (35 35
         ...
         (1 1 (:REWRITE EQUAL-CONSTANT-+)))
(LOGEXT-OF-MYIF-BACK
     (20 3 (:REWRITE LOGEXT-WHEN-SIZE-NOT-POSP))
     (12 3
         (:REWRITE LOGEXT-WHEN-I-IS-NOT-AN-INTEGER))
     (11 1 (:REWRITE NATP-POSP))
     (10 5 (:REWRITE INTEGERP-WHEN-POWER-OF-2P))
...
(UPDATE-SUBRANGE-REWRITE-BETTER2
     ...
     (204 122
          (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
     (188 7 (:REWRITE TRUE-LISTP-OF-NTHCDR-2))
     (173 135 (:REWRITE DEFAULT-<-1))
     (165 135 (:REWRITE DEFAULT-<-2))
     ...
     (128 5 (:REWRITE UPDATE-SUBRANGE-ALL))
     (116 116
          (:REWRITE USE-<=-PLUS-CONSTANT-BOUND-TO-DROP-<=-HYP))
     (116 116 (:REWRITE DROP-LINEAR-HYPS3))
     (114 114
          (:REWRITE NOT-LESS-WHEN->=-MAX-OF-CONTAINING-BAG))
     (114 114 (:REWRITE INEQ-HACK2))
     (114 114 (:REWRITE INEQ-HACK))
...
(UPDATE-NTH-OF-APPEND
     (791 19 (:REWRITE NTHCDR-WHEN-<=-OF-LEN))
     (693 33
          (:REWRITE UPDATE-NTH-WITH-LAST-VAL-GEN))
     (627 35 (:REWRITE TAKE-WHEN-<-OF-LEN))
     ...
     (96 4 (:REWRITE TRUE-LISTP-OF-NTHCDR-2))
...
(UPDATE-SUBRANGE-OF-UPDATE-SUBRANGE-REORDER
     ...
     (88 20 (:REWRITE NTHCDR-WHEN-NOT-POSP))
     (88 20
         (:REWRITE NTHCDR-WHEN-NOT-CONSP-CHEAP))
...
(BVNTH-WHEN-DATA-ISNT-AN-ALL-UNSIGNED-BYTE-P
     (217 9 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
     (162 11 (:REWRITE NATP-RW))
     (161 13
          (:REWRITE INTEGERP-OF-NTH-WHEN-ALL-INTEGERP))
     (141 15 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
     (129 15
          (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER))
     ...
     (13 13 (:REWRITE INTEGERP-OF-NTH-FREE-LEN))
     (11 11
         (:REWRITE NATP-WHEN-UNSIGNED-BYTE-P-SIZE-ARG))
...
(ALL-SIGNED-BYTE-P-IMPLIES-ALL-INTEGERP
     (320 8 (:REWRITE SIGNED-BYTE-P-OF-NTH))
