(ASSUMPTION-ITEMP)
(ASSUMPTION-ARRAYP-AUX (148 148 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
...
(ASSUMPTION-ARRAYP-AUX-OF-0 (8 2 (:REWRITE AREF1-WHEN-TOO-LARGE-CHEAP))
...
(TYPE-OF-AREF1-WHEN-ASSUMPTION-ARRAYP-AUX
     ...
     (16 16
         (:REWRITE ASSUMPTION-ARRAYP-AUX-MONOTONE))
     (11 11
         (:REWRITE NONNEG-WHEN-DARGP-LESS-THAN))
     (11 11
         (:REWRITE INTEGERP-WHEN-DARGP-LESS-THAN))
...
(ASSUMPTION-ARRAYP-AUX-OF-ASET1-AT-END
     ...
     (15 3
         (:REWRITE ASSUMPTION-ARRAYP-AUX-OF-ASET1-TOO-HIGH))
...
(ASSUMPTION-ARRAYP-AUX-OF-CONS-OF-CONS-OF-HEADER-IRREL
     (189 13
          (:REWRITE ASSUMPTION-ARRAYP-AUX-OF-CONS-OF-CONS-OF-HEADER))
     (164 41
          (:REWRITE AREF1-WHEN-TOO-LARGE-CHEAP))
...
(TYPE-OF-AREF1-WHEN-ASSUMPTION-ARRAYP
     ...
     (2 2 (:LINEAR ARRAY2P-LINEAR)))
(ASSUMPTION-ARRAYP-OF-ASET1 (85 2 (:DEFINITION ASSUMPTION-ARRAYP-AUX))
                            (31 9
                                (:REWRITE ARRAY1P-WHEN-ASSUMPTION-ARRAYP))
