(EVAL-AXE-SYNTAXP-FUNCTION-APPLICATION-BASIC
   ...
   (54500 500 (:LINEAR LARGEST-NON-QUOTEP-BOUND))
   (51497 51497 (:TYPE-PRESCRIPTION ALL-MYQUOTEP))
   (48644 25296 (:REWRITE DEFAULT-+-2))
   (47588 43272
   ...
   (42555 1395 (:REWRITE USE-ALL-NATP-FOR-CAR))
   (38942 4340
          (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
   (38565 895 (:DEFINITION NAT-LISTP))
   (25296 25296 (:REWRITE DEFAULT-+-1))
   (22290 895 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
   (20000 500
