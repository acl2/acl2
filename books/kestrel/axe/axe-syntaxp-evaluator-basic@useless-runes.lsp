(EVAL-AXE-SYNTAXP-FUNCTION-APPLICATION-BASIC
   ...
   (89513 19434 (:REWRITE DEFAULT-CDR))
   (85383 11187 (:REWRITE DEFAULT-CAR))
   (62979 62979
          (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
   (62979 62979 (:TYPE-PRESCRIPTION ARRAY1P))
   (56500 500 (:LINEAR LARGEST-NON-QUOTEP-BOUND))
   (51497 51497 (:TYPE-PRESCRIPTION ALL-MYQUOTEP))
   (49434 25296 (:REWRITE DEFAULT-+-2))
   (47588 43272
   ...
   (40355 895 (:DEFINITION NAT-LISTP))
   (38942 4340
          (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
   (25296 25296 (:REWRITE DEFAULT-+-1))
   (23290 895 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
   (21000 500
   ...
   (16153 919 (:REWRITE USE-ALL-CONSP-FOR-CAR))
   (14904 9875 (:REWRITE DEFAULT-<-2))
   (14395 895 (:REWRITE ALL-NATP-WHEN-NOT-CONSP))
   ...
   (10172 373 (:REWRITE ALL-DARGP-WHEN-NOT-CONSP))
   ...
   (6534 1177 (:REWRITE ALL-CONSP-OF-CDR))
   (6152 6152
   ...
   (4190 4190 (:TYPE-PRESCRIPTION ALL-CONSP))
   (4032 136
         (:REWRITE ALL-DARGP-LESS-THAN-WHEN-ALL-<))
   (3966 1983 (:REWRITE NATP-WHEN-POWER-OF-2P))
   (3744 72 (:REWRITE <-OF-LARGEST-NON-QUOTEP))
   (3644 3644
   ...
   (1983 1983 (:TYPE-PRESCRIPTION POWER-OF-2P))
   ...
   (924 28 (:REWRITE SUBSETP-EQUAL-OF-NIL-ARG2))
   (919 919
...
(EVAL-AXE-SYNTAXP-EXPR-BASIC
    (14574 100 (:DEFINITION INTEGER-ABS))
    (13362 12 (:REWRITE USE-ALL-<-FOR-CAR))
    (11235 117 (:DEFINITION NAT-LISTP))
    (7473 111 (:REWRITE ALL-NATP-OF-CDR))
    (6804 33 (:REWRITE ALL-<-OF-0-WHEN-ALL-NATP))
    (6108 33 (:REWRITE ALL-<-OF-0-WHEN-NAT-LISTP))
    (6105 192 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
    (5241 21 (:REWRITE ALL-<-OF-CDR))
    (4601 126 (:REWRITE USE-ALL-CONSP-FOR-CAR))
    (4371 120 (:REWRITE USE-ALL-NATP-FOR-CAR))
