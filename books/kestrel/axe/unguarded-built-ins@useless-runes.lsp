(MV-NTH-UNGUARDED)
(MV-NTH-UNGUARDED-CORRECT (6 6 (:REWRITE DEFAULT-CAR))
                          (5 2 (:REWRITE ZP-OPEN))
...
(ZP-UNGUARDED)
(ZP-UNGUARDED-CORRECT (2 2 (:REWRITE DEFAULT-<-2))
                      (2 2 (:REWRITE DEFAULT-<-1)))
(ASSOC-EQUAL-UNGUARDED)
(ASSOC-EQUAL-UNGUARDED-CORRECT (39 39 (:REWRITE DEFAULT-CAR))
                               (11 11 (:REWRITE DEFAULT-CDR)))
(SYMBOL-<-UNGUARDED)
(SYMBOL-<-UNGUARDED-CORRECT (1 1 (:REWRITE SYMBOL-<-ASYMMETRIC)))
(NUMERATOR-UNGUARDED)
(NUMERATOR-UNGUARDED-CORRECT (2 2 (:REWRITE DEFAULT-NUMERATOR)))
(DENOMINATOR-UNGUARDED)
(DENOMINATOR-UNGUARDED-CORRECT (2 2 (:REWRITE DEFAULT-DENOMINATOR)))
...
(CEILING-UNGUARDED)
(CEILING-UNGUARDED-CORRECT (96 6
                               (:DEFINITION NONNEGATIVE-INTEGER-QUOTIENT))
                           (33 24 (:REWRITE DEFAULT-+-2))
                           (27 24 (:REWRITE DEFAULT-+-1))
                           (18 6 (:DEFINITION NFIX))
...
(MIN-UNGUARDED)
(MIN-UNGUARDED-CORRECT (11 11 (:TYPE-PRESCRIPTION MIN-UNGUARDED))
...
(MAX-UNGUARDED)
(MAX-UNGUARDED-CORRECT (11 11 (:TYPE-PRESCRIPTION MAX-UNGUARDED))
...
(=-UNGUARDED-CORRECT)
(NTH-UNGUARDED)
(NTH-UNGUARDED-CORRECT (74 72 (:REWRITE DEFAULT-CAR))
