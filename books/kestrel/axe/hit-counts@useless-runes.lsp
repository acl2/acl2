(SYMBOL-ALISTP-OF-EVENS
     (3057 227 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (1382 72 (:REWRITE USE-ALL-CONSP-FOR-CAR))
     (794 23 (:REWRITE ALL-CONPS-OF-EVENS))
     (741 158 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
     (559 537 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
     (486 68 (:REWRITE ALL-CONSP-OF-CDR))
     (370 185
          (:REWRITE SYMBOL-ALISTP-WHEN-SYMBOL-TERM-ALISTP-CHEAP))
     (363 297 (:REWRITE DEFAULT-CAR))
     ...
     (33 11 (:REWRITE EQUAL-OF-LEN-AND-0)))
...
(SYMBOL-ALISTP-OF-MERGE-BY-CDR->
     ...
     (811 81 (:REWRITE USE-ALL-CONSP-FOR-CAR))
     (436 436
          (:TYPE-PRESCRIPTION SYMBOL-TERM-ALISTP))
     (416 93 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
     (394 197
          (:REWRITE SYMBOL-ALISTP-WHEN-SYMBOL-TERM-ALISTP-CHEAP))
     (364 347 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
     (321 17
          (:REWRITE ALL-CONSP-OF-TRUE-LIST-FIX))
     (316 158
          (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP))
...
(SYMBOL-ALISTP-OF-MERGE-SORT-BY-CDR->
     (1177 5 (:DEFINITION MERGE-BY-CDR->))
     (920 105 (:REWRITE DEFAULT-CDR))
     (902 10
          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (872 10
          (:REWRITE USE-ALL-CDRS-RATIONALP-FOR-CAR))
     (831 24 (:DEFINITION EVENS))
     (822 10
          (:REWRITE ALL-CDRS-RATIONALP-OF-MERGE-SORT-BY-CDR->))
     (727 33
          (:REWRITE ALL-CDRS-RATIONALP-WHEN-NOT-CONSP))
     (581 84 (:REWRITE DEFAULT-<-1))
     (540 84 (:REWRITE DEFAULT-<-2))
     (382 13 (:REWRITE USE-ALL-CONSP-FOR-CAR))
     (282 6
          (:REWRITE ALL-CONSP-OF-MERGE-SORT-BY-CDR->))
     (278 25 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
     (196 173 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
     (174 10
          (:REWRITE ALL-CDRS-RATIONALP-OF-EVENS))
     (140 2
          (:REWRITE SYMBOL-ALISTP-OF-MERGE-BY-CDR->))
     ...
     (45 33
         (:REWRITE ALL-CDRS-RATIONALP-WHEN-NOT-CONSP-CHEAP))
     (32 3 (:REWRITE ALL-CONPS-OF-EVENS))
     (29 25
         (:REWRITE ALL-CONSP-WHEN-NOT-CONSP-CHEAP))
     (26 13
     ...
     (26 13
         (:REWRITE CONSP-OF-CAR-WHEN-SYMBOL-TERM-ALISTP-CHEAP))
     (26 4 (:REWRITE ALL-CDRS-RATIONALP-OF-CDR))
     (19 19
         (:REWRITE CONSP-OF-CDR-WHEN-LEN-KNOWN))
     (18 2 (:REWRITE ALL-CONSP-OF-CDR))
     (14 14
         (:REWRITE LEN-OF-CDDR-WHEN-EQUAL-OF-LEN))
...
(NAT-LISTP-OF-STRIP-CDRS-OF-MERGE-SORT-BY-CDR->
     (3319 13 (:DEFINITION MERGE-BY-CDR->))
     (2604 26
           (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (2526 26
           (:REWRITE USE-ALL-CDRS-RATIONALP-FOR-CAR))
     (2396 26
           (:REWRITE ALL-CDRS-RATIONALP-OF-MERGE-SORT-BY-CDR->))
     (2299 70 (:DEFINITION EVENS))
     (2114 92
           (:REWRITE ALL-CDRS-RATIONALP-WHEN-NOT-CONSP))
     (1618 217 (:REWRITE DEFAULT-<-1))
     (1533 217 (:REWRITE DEFAULT-<-2))
     ...
     (130 92
          (:REWRITE ALL-CDRS-RATIONALP-WHEN-NOT-CONSP-CHEAP))
     (84 12 (:REWRITE ALL-CDRS-RATIONALP-OF-CDR))
     (42 6 (:LINEAR LEN-OF-CDR-LINEAR-STRONG))
     (35 35
         (:REWRITE LEN-OF-CDDR-WHEN-EQUAL-OF-LEN))
...
(ACL2-NUMBERP-OF-GETPROP-WHEN-INFO-WORLDP
     (707 53 (:REWRITE CONSP-FROM-LEN-CHEAP))
...
(INFO-WORLDP-OF-INCREMENT-HIT-COUNT-IN-INFO-WORLD
     (963 353 (:REWRITE DEFAULT-CAR))
     (891 281 (:REWRITE DEFAULT-CDR))
     (634 317
          (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP))
     (366 366
          (:TYPE-PRESCRIPTION SYMBOL-TERM-ALISTP))
     (360 40 (:REWRITE EQUAL-OF-LEN-AND-0))
     ...
     (12 3
         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (9 3
        (:REWRITE RATIONALP-OF-GETPROP-WHEN-INFO-WORLDP))
     (4 4
...
(HIT-COUNT-ALISTP-FORWARD-TO-ALL-CONSP
     ...
     (200 15 (:REWRITE SYMBOL-ALISTP-OF-CDR))
     (166 83
          (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP))
     (117 117
          (:TYPE-PRESCRIPTION SYMBOL-TERM-ALISTP))
     (111 11 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
     (95 47 (:REWRITE USE-ALL-CONSP))
     (90 48 (:REWRITE DEFAULT-CDR))
...
(ALL-CDRS-RATIONALP-WHEN-HIT-COUNT-ALISTP
     ...
     (204 15 (:REWRITE SYMBOL-ALISTP-OF-CDR))
     (166 83
          (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP))
     (122 122
          (:TYPE-PRESCRIPTION SYMBOL-TERM-ALISTP))
...
(NATP-OF-LOOKUP-EQUAL-WHEN-HIT-COUNT-ALISTP
     ...
     (423 423
          (:TYPE-PRESCRIPTION SYMBOL-TERM-ALISTP))
     (291 155 (:REWRITE DEFAULT-CAR))
     (273 89 (:REWRITE DEFAULT-CDR))
...
(NAT-OF-CDR-OF-CAR-WHEN-HIT-COUNT-ALISTP
     ...
     (369 9 (:DEFINITION SYMBOL-ALISTP))
...
(MAKE-HIT-COUNT-ALIST
     (475 41 (:REWRITE CONSP-FROM-LEN-CHEAP))
...
(HIT-COUNT-ALISTP-OF-MAKE-HIT-COUNT-ALIST
     (2547 228 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (938 274 (:REWRITE DEFAULT-CDR))
     (590 293
          (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP))
     (419 419
          (:TYPE-PRESCRIPTION SYMBOL-TERM-ALISTP))
     (419 315 (:REWRITE DEFAULT-CAR))
     ...
     (146 26 (:REWRITE EQUAL-OF-LEN-AND-0))
     (134 67
          (:REWRITE SYMBOL-ALISTP-WHEN-SYMBOL-TERM-ALISTP-CHEAP))
     (118 59
          (:REWRITE CONSP-OF-CAR-WHEN-SYMBOL-TERM-ALISTP-CHEAP))
...
(ALL-CONSP-OF-MAKE-HIT-COUNT-ALIST
     (1147 106 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (907 69 (:REWRITE DEFAULT-CDR))
     (662 16 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
...
(TRUE-LISTP-OF-MAKE-HIT-COUNT-ALIST
     (549 52 (:REWRITE CONSP-FROM-LEN-CHEAP))
...
(ALISTP-OF-MAKE-HIT-COUNT-ALIST
     (1075 102 (:REWRITE CONSP-FROM-LEN-CHEAP))
...
(ALL-CDRS-RATIONALP-OF-MAKE-HIT-COUNT-ALIST
     (1149 98 (:REWRITE CONSP-FROM-LEN-CHEAP))
     ...
     (42 42
         (:TYPE-PRESCRIPTION HIT-COUNT-ALISTP))
     (42 21
         (:REWRITE CONSP-OF-CAR-WHEN-SYMBOL-TERM-ALISTP-CHEAP))
     (40 28
         (:TYPE-PRESCRIPTION MAKE-HIT-COUNT-ALIST))
...
(INFO-WORLDP-OF-UNIQUIFY-ALIST-EQ-AUX
     ...
     (541 308 (:REWRITE DEFAULT-CAR))
     (306 31
          (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
     (276 267 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
     (236 175 (:REWRITE DEFAULT-CDR))
...
(HIT-COUNT-ALISTP-OF-SORT-HIT-COUNT-ALIST
     (850 1 (:DEFINITION MERGE-SORT-BY-CDR->))
     (745 1 (:DEFINITION MERGE-BY-CDR->))
     (690 2
          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (684 2
          (:REWRITE USE-ALL-CDRS-RATIONALP-FOR-CAR))
     (650 40 (:REWRITE DEFAULT-<-1))
     (580 5
          (:REWRITE ALL-CDRS-RATIONALP-WHEN-HIT-COUNT-ALISTP))
     (507 50 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (479 1
          (:REWRITE ALL-CDRS-RATIONALP-OF-MERGE-SORT-BY-CDR->))
     (294 1
          (:REWRITE ALL-CDRS-RATIONALP-OF-EVENS))
     (244 49 (:REWRITE DEFAULT-CDR))
     (239 9 (:DEFINITION NAT-LISTP))
     (231 12 (:DEFINITION STRIP-CDRS))
     (220 220 (:TYPE-PRESCRIPTION LEN))
     (162 3 (:DEFINITION SYMBOL-ALISTP))
     (130 1 (:REWRITE ALL-CDRS-RATIONALP-OF-CDR))
     (121 40 (:REWRITE DEFAULT-<-2))
     (116 3 (:DEFINITION EVENS))
     (112 1 (:REWRITE HIT-COUNT-ALISTP-OF-CDR))
     (85 4
         (:REWRITE ALL-CDRS-RATIONALP-WHEN-NOT-CONSP))
     (85 3
         (:REWRITE NAT-LISTP-OF-STRIP-CDRS-OF-EVENS))
     (79 40
         (:LINEAR LEN-POSITIVE-WHEN-CONSP-LINEAR-CHEAP))
     (79 7 (:REWRITE LEN-OF-CDR))
     (76 63 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
     (52 1 (:DEFINITION ODDS))
     (48 16
...
(HIT-COUNT-ALISTP-OF-SUBTRACT-HIT-COUNT-ALISTS
    ...
    (2606 48
          (:REWRITE ALL-CDRS-RATIONALP-WHEN-HIT-COUNT-ALISTP))
    (2306 1079 (:REWRITE DEFAULT-CDR))
    (2180 41 (:REWRITE HIT-COUNT-ALISTP-OF-CDR))
    (1794 897
          (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP))
    (1614 1195 (:REWRITE DEFAULT-CAR))
    (1481 1481
          (:TYPE-PRESCRIPTION SYMBOL-TERM-ALISTP))
    (1277 459
          (:REWRITE SYMBOL-ALISTP-WHEN-INFO-WORLDP))
...
(ALISTP-OF-SUBTRACT-HIT-COUNT-ALISTS
     ...
     (562 281
          (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP))
     (516 261 (:REWRITE DEFAULT-CDR))
     (514 379 (:REWRITE DEFAULT-CAR))
     (473 38 (:REWRITE SYMBOL-ALISTP-OF-CDR))
     (430 430
          (:TYPE-PRESCRIPTION SYMBOL-TERM-ALISTP))
