...
(CONS-OF-BV-ARRAY-WRITE-GEN
     ...
     (1785 75
           (:REWRITE ALL-UNSIGNED-BYTE-P-OF-TAKE))
     (1529 24 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
     (1515 6
           (:REWRITE ALL-UNSIGNED-BYTE-P-OF-CONS))
     (852 45
          (:REWRITE BVCHOP-LIST-DOES-NOTHING-BETTER))
     (852 45 (:REWRITE BVCHOP-LIST-DOES-NOTHING))
     (822 6 (:REWRITE NATP-OF-NTH-FROM-ALL-NATP))
     (744 6 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
     (742 50
          (:REWRITE UPDATE-NTH-WITH-LAST-VAL-GEN))
     (726 6 (:DEFINITION NAT-LISTP))
     (673 29 (:DEFINITION EXPT))
     (642 544 (:REWRITE DEFAULT-<-1))
     (620 544 (:REWRITE DEFAULT-<-2))
     (589 589 (:REWRITE <-WHEN-BVLT))
     (565 65 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
     (562 23 (:REWRITE UNSIGNED-BYTE-P-OF-NTH))
     ...
     (532 507 (:REWRITE DEFAULT-+-2))
     (521 507 (:REWRITE DEFAULT-+-1))
     (474 65
          (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER))
     ...
     (154 154
          (:REWRITE ALL-UNSIGNED-BYTE-P-FROM-ALL-UNSIGNED-BYTE-P-NARROWER))
     (154 128 (:REWRITE UBP-LONGER-BETTER))
     (151 8
...
(MYIF-OF-BV-ARRAY-WRITE-ARG1-SAFE
     ...
     (190 2 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
     ...
     (126 2 (:REWRITE NATP-OF-NTH-FROM-ALL-NATP))
     ...
     (110 2 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
...
(MYIF-OF-BV-ARRAY-WRITE-ARG2-SAFE
     ...
     (39 1 (:REWRITE TRUE-LISTP-OF-NTHCDR-2))
     (38 2 (:DEFINITION EXPT))
