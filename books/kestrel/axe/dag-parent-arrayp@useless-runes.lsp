(ALL-DARGP-LESS-THAN-WHEN-<-OF-LARGEST-NON-QUOTEP
     ...
     (187 163 (:REWRITE ALL-<-TRANSITIVE-FREE-2))
     (177 154 (:REWRITE DEFAULT-<-2))
     (173 163 (:REWRITE ALL-<-WHEN-NOT-CONSP))
     (163 163
     ...
     (52 42 (:REWRITE ALL-NATP-WHEN-NOT-CONSP))
     (45 45
