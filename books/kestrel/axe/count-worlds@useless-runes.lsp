...
(MAKE-COUNT-ALIST
     (449 41 (:REWRITE CONSP-FROM-LEN-CHEAP))
...
(ALL-CONSP-OF-MAKE-COUNT-ALIST
     (1161 106 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (967 69 (:REWRITE DEFAULT-CDR))
     (699 16 (:REWRITE ALL-CONSP-WHEN-NOT-CONSP))
...
(TRUE-LISTP-OF-MAKE-COUNT-ALIST
     (555 52 (:REWRITE CONSP-FROM-LEN-CHEAP))
...
(ALL-CDRS-RATIONALP-OF-MAKE-COUNT-ALIST
     (1108 98 (:REWRITE CONSP-FROM-LEN-CHEAP))
