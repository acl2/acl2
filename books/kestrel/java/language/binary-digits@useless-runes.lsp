...
(JAVA::NTH-OF-BIN-DIGIT-LIST-FIX
    ...
    (167 16
         (:REWRITE JAVA::BIN-DIGIT-LIST-FIX-WHEN-BIN-DIGIT-LISTP))
    (160 15
         (:REWRITE JAVA::BIN-DIGITP-OF-NTH-WHEN-BIN-DIGIT-LISTP))
    (142 27
         (:REWRITE JAVA::BIN-DIGIT-LISTP-OF-CDR-WHEN-BIN-DIGIT-LISTP))
    (124 124
         (:REWRITE JAVA::BIN-DIGIT-LISTP-WHEN-SUBSETP-EQUAL))
    ...
    (13 13
        (:REWRITE JAVA::CONSP-OF-BIN-DIGIT-LIST-FIX))
    (12 6 (:REWRITE DEFAULT-CAR))
    (3 3
       (:REWRITE-QUOTED-CONSTANT JAVA::BIN-DIGIT-FIX-UNDER-BIN-DIGIT-EQUIV)))
...
(JAVA::BIN-DIGIT-LIST-EQUIV-IMPLIES-BIN-DIGIT-LIST-EQUIV-TAKE-2
     ...
     (236 236
          (:REWRITE JAVA::BIN-DIGIT-LISTP-WHEN-SUBSETP-EQUAL))
     (229 24
          (:REWRITE JAVA::BIN-DIGIT-LISTP-OF-TAKE))
     (136 118
          (:REWRITE JAVA::BIN-DIGIT-LISTP-WHEN-NOT-CONSP))
     (66 66
         (:TYPE-PRESCRIPTION JAVA::BIN-DIGITP))
