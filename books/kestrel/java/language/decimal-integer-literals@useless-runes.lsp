...
(JAVA::DECDIG/USCORE-FIX$INLINE (6 6
...
(JAVA::DECDIG/USCORE-DIGIT->GET$INLINE-OF-DECDIG/USCORE-FIX-X
 (25 25
     (:TYPE-PRESCRIPTION JAVA::DECDIG/USCORE-FIX$INLINE))
 (25 25
     (:TYPE-PRESCRIPTION JAVA::CONSP-OF-DECDIG/USCORE-FIX))
 (13 5
     (:REWRITE JAVA::DECDIG/USCORE-FIX-WHEN-DECDIG/USCORE-P))
 (8 8
...
(JAVA::DECDIG/USCORE-DIGIT->GET-OF-DECDIG/USCORE-DIGIT
 (71 58
     (:TYPE-PRESCRIPTION JAVA::DEC-DIGIT-FIX))
 (13 13
     (:TYPE-PRESCRIPTION JAVA::DECDIG/USCORE-DIGIT))
 (1
  1
  (:REWRITE
   JAVA::DECDIG/USCORE-DIGIT->GET$INLINE-OF-DECDIG/USCORE-FIX-X-NORMALIZE-CONST)))
...
(JAVA::DECDIG/USCORE-DIGIT-OF-DEC-DIGIT-FIX-GET-NORMALIZE-CONST)
...
(JAVA::DECDIG/USCORE-LISTP-OF-DECDIG/USCORE-LIST-FIX
 (30 1
     (:REWRITE JAVA::DECDIG/USCORE-FIX-WHEN-DECDIG/USCORE-P))
 (22 2
     (:REWRITE JAVA::DECDIG/USCORE-P-OF-CAR-WHEN-DECDIG/USCORE-LISTP))
 (18 10
     (:REWRITE JAVA::DECDIG/USCORE-LISTP-WHEN-SUBSETP-EQUAL))
 (15 1
     (:DEFINITION JAVA::DECDIG/USCORE-LISTP))
 (12
   6
...
(JAVA::CAR-OF-DECDIG/USCORE-LIST-FIX-X-UNDER-DECDIG/USCORE-EQUIV
 ...
 (12 12
     (:TYPE-PRESCRIPTION JAVA::DECDIG/USCORE-LISTP))
 (12 12
     (:REWRITE JAVA::DECDIG/USCORE-LISTP-WHEN-SUBSETP-EQUAL))
 (6 6
    (:TYPE-PRESCRIPTION JAVA::DECDIG/USCORE-P))
 ...
 (6 1
    (:REWRITE JAVA::DECDIG/USCORE-LISTP-OF-CDR-WHEN-DECDIG/USCORE-LISTP))
 (3 3
    (:TYPE-PRESCRIPTION JAVA::DECDIG/USCORE-LIST-FIX$INLINE)))
...
(JAVA::CONS-OF-DECDIG/USCORE-FIX-X-UNDER-DECDIG/USCORE-LIST-EQUIV
 (34 4
     (:REWRITE JAVA::DECDIG/USCORE-LIST-FIX-WHEN-DECDIG/USCORE-LISTP))
 (17 2
     (:REWRITE JAVA::DECDIG/USCORE-LISTP-OF-CONS))
 (10 10
     (:REWRITE JAVA::DECDIG/USCORE-LISTP-WHEN-SUBSETP-EQUAL))
 (8
   8
 ...
 (2
  ...
  (:REWRITE
   JAVA::CDR-OF-DECDIG/USCORE-LIST-FIX-X-NORMALIZE-CONST-UNDER-DECDIG/USCORE-LIST-EQUIV)))
(JAVA::CONS-OF-DECDIG/USCORE-FIX-X-NORMALIZE-CONST-UNDER-DECDIG/USCORE-LIST-EQUIV)
...
(JAVA::CONS-OF-DECDIG/USCORE-LIST-FIX-Y-UNDER-DECDIG/USCORE-LIST-EQUIV
 ...
 (2
  ...
  (:REWRITE
   JAVA::CDR-OF-DECDIG/USCORE-LIST-FIX-X-NORMALIZE-CONST-UNDER-DECDIG/USCORE-LIST-EQUIV)))
(JAVA::CONS-OF-DECDIG/USCORE-LIST-FIX-Y-NORMALIZE-CONST-UNDER-DECDIG/USCORE-LIST-EQUIV)
...
(JAVA::DECDIG/USCORE-LIST-FIX-OF-APPEND
 (114 10
      (:REWRITE JAVA::DECDIG/USCORE-LIST-FIX-WHEN-DECDIG/USCORE-LISTP))
 (58 2
     (:REWRITE JAVA::DECDIG/USCORE-LISTP-OF-APPEND))
 (40 36
     (:REWRITE JAVA::DECDIG/USCORE-LISTP-WHEN-SUBSETP-EQUAL))
 (29 29
     (:TYPE-PRESCRIPTION JAVA::DECDIG/USCORE-LISTP))
 (24 2
     (:REWRITE JAVA::DECDIG/USCORE-LISTP-OF-LIST-FIX))
 (22 16
     (:REWRITE JAVA::DECDIG/USCORE-LISTP-WHEN-NOT-CONSP))
 (14 4
     (:REWRITE JAVA::DECDIG/USCORE-LISTP-OF-CDR-WHEN-DECDIG/USCORE-LISTP))
...
(JAVA::DECDIG/USCORE-LIST-FIX-OF-REPEAT
 ...
 (16 4
     (:REWRITE JAVA::DECDIG/USCORE-FIX-WHEN-DECDIG/USCORE-P))
 (12 2
     (:REWRITE JAVA::DECDIG/USCORE-LISTP-OF-REPEAT))
 (10 10
     (:TYPE-PRESCRIPTION JAVA::DECDIG/USCORE-P))
 (10
   10
...
(JAVA::DECDIG/USCORE-LISTP-OF-DECDIG/USCORE-DIGIT-LIST
 ...
 (45 2
     (:REWRITE JAVA::EQUAL-OF-DECDIG/USCORE-DIGIT))
 (30 8
     (:REWRITE JAVA::DECDIG/USCORE-LISTP-WHEN-NOT-CONSP))
 (22 2
     (:REWRITE JAVA::DEC-DIGIT-FIX-WHEN-DEC-DIGITP))
 ...
 (6 6
    (:TYPE-PRESCRIPTION JAVA::DECDIG/USCORE-KIND$INLINE))
...
(JAVA::DECDIG/USCORES-TO-DIGITS-OF-DECDIG/USCORE-LIST-FIX-DUS
 ...
 (25
  ...
  (:REWRITE
   JAVA::CDR-OF-DECDIG/USCORE-LIST-FIX-X-NORMALIZE-CONST-UNDER-DECDIG/USCORE-LIST-EQUIV)))
(JAVA::DECDIG/USCORES-TO-DIGITS-OF-DECDIG/USCORE-LIST-FIX-DUS-NORMALIZE-CONST)
(JAVA::DECDIG/USCORES-TO-DIGITS-DECDIG/USCORE-LIST-EQUIV-CONGRUENCE-ON-DUS)
(JAVA::HOOKS-FIX-LEMMA
 (320 31
      (:REWRITE JAVA::DECDIG/USCORE-LIST-FIX-WHEN-DECDIG/USCORE-LISTP))
 (93 11
     (:REWRITE JAVA::DECDIG/USCORE-LISTP-OF-LAST))
 (86 86
     (:REWRITE JAVA::DECDIG/USCORE-LISTP-WHEN-SUBSETP-EQUAL))
 (60 43
     (:REWRITE JAVA::DECDIG/USCORE-LISTP-WHEN-NOT-CONSP))
...
(JAVA::DECDIG/USCORE-LIST-WFP-OF-DECDIG/USCORE-LIST-FIX-DUS
 ...
 (2 2
    (:REWRITE JAVA::DECDIG/USCORE-FIX-WHEN-UNDERSCORE)))
(JAVA::DECDIG/USCORE-LIST-WFP-OF-DECDIG/USCORE-LIST-FIX-DUS-NORMALIZE-CONST)
...
(JAVA::DEC-INTEGER-LITERAL-OF-DECDIG/USCORE-LIST-FIX-DIGITS/USCORES
 ...
 (2 2
    (:TYPE-PRESCRIPTION JAVA::OPTIONAL-INTEGER-TYPE-SUFFIX-P)))
(JAVA::DEC-INTEGER-LITERAL-OF-DECDIG/USCORE-LIST-FIX-DIGITS/USCORES-NORMALIZE-CONST)
...
(JAVA::DEC-INTEGER-LITERAL-OF-OPTIONAL-INTEGER-TYPE-SUFFIX-FIX-SUFFIX?
     ...
     (2 2
        (:TYPE-PRESCRIPTION JAVA::DECDIG/USCORE-LISTP)))
(JAVA::DEC-INTEGER-LITERAL-OF-OPTIONAL-INTEGER-TYPE-SUFFIX-FIX-SUFFIX?-NORMALIZE-CONST)
