...
(JAVA::SINGLETON-WHEN-GRAMMAR-BIN-DIGITP
 ...
 (1 1
    (:REWRITE JAVA::GRAMMAR-BIN-DIGITP-SUFF))
 (1 1
    (:REWRITE
...
(JAVA::RETURN-TYPE-OF-BIN-DIGIT-TREE
 ...
 (1 1
    (:REWRITE ABNF::TREE-NONLEAF->RULENAME?-OF-TREE-NONLEAF))
 (1 1
    (:REWRITE ABNF::TREE-MATCH-ELEMENT-P-OF-TREE-FIX-TREE-NORMALIZE-CONST))
 (1 1
    (:REWRITE
...
(JAVA::BIN-DIGIT-TREE-OF-BIN-DIGIT-FIX-DIGIT-NORMALIZE-CONST)
