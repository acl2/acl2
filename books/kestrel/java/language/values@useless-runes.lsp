(JAVA::LEMMA)
(JAVA::JVALUEP)
(JAVA::CONSP-WHEN-JVALUEP (9 3 (:REWRITE JAVA::LEMMA)))
...
(JAVA::JVALUE-KIND$INLINE-OF-JVALUE-FIX-X
     (7 5
        (:REWRITE JAVA::REFERENCE-VALUE-FIX-WHEN-REFERENCE-VALUEP))
     (1 1
        (:REWRITE JAVA::JVALUE-FIX-WHEN-JVALUEP)))
(JAVA::JVALUE-KIND$INLINE-OF-JVALUE-FIX-X-NORMALIZE-CONST)
...
(JAVA::JVALUE-PRIMITIVE->GET$INLINE
     ...
     (2 2
        (:REWRITE JAVA::JVALUE-KIND$INLINE-OF-JVALUE-FIX-X-NORMALIZE-CONST)))
...
(JAVA::JVALUE-PRIMITIVE->GET$INLINE-OF-JVALUE-FIX-X
     ...
     (4 4
        (:TYPE-PRESCRIPTION JAVA::REFERENCE-VALUEP)))
(JAVA::JVALUE-PRIMITIVE->GET$INLINE-OF-JVALUE-FIX-X-NORMALIZE-CONST)
...
(JAVA::JVALUE-PRIMITIVE->GET-WHEN-WRONG-KIND
 ...
 (1
   ...
   (:REWRITE
        JAVA::JVALUE-PRIMITIVE->GET$INLINE-OF-JVALUE-FIX-X-NORMALIZE-CONST)))
(JAVA::JVALUE-PRIMITIVE (3 1 (:REWRITE JAVA::LEMMA))
                        (2 2
                           (:TYPE-PRESCRIPTION JAVA::REFERENCE-VALUEP)))
...
(JAVA::JVALUE-PRIMITIVE-OF-PRIMITIVE-VALUE-FIX-GET-NORMALIZE-CONST)
...
(JAVA::JVALUE-REFERENCE->GET$INLINE-OF-JVALUE-FIX-X
     ...
     (6 6
        (:REWRITE JAVA::JVALUE-KIND$INLINE-OF-JVALUE-FIX-X-NORMALIZE-CONST))
     (6 2 (:REWRITE JAVA::LEMMA)))
(JAVA::JVALUE-REFERENCE->GET$INLINE-OF-JVALUE-FIX-X-NORMALIZE-CONST)
...
(JAVA::JVALUE-REFERENCE-OF-REFERENCE-VALUE-FIX-GET-NORMALIZE-CONST)
...
(JAVA::LEMMA)
(JAVA::JVALUEXP)
(JAVA::CONSP-WHEN-JVALUEXP (9 3 (:REWRITE JAVA::LEMMA)))
(JAVA::JVALUEX-KIND$INLINE)
(JAVA::JVALUEX-KIND-POSSIBILITIES)
(JAVA::JVALUEX-FIX$INLINE (1 1
                             (:TYPE-PRESCRIPTION JAVA::JVALUEX-FIX$INLINE)))
(JAVA::JVALUEXP-OF-JVALUEX-FIX
     (12 4
         (:REWRITE JAVA::REFERENCE-VALUE-FIX-WHEN-REFERENCE-VALUEP))
     (12 4
         (:REWRITE JAVA::PRIMITIVEX-VALUE-FIX-WHEN-PRIMITIVEX-VALUEP))
     (8 8
        (:TYPE-PRESCRIPTION JAVA::PRIMITIVEX-VALUEP))
     (3 3
        (:TYPE-PRESCRIPTION JAVA::JVALUEX-FIX$INLINE)))
...
(JAVA::JVALUEX-KIND$INLINE-OF-JVALUEX-FIX-X
     (7 5
        (:REWRITE JAVA::REFERENCE-VALUE-FIX-WHEN-REFERENCE-VALUEP))
     (1 1
        (:REWRITE JAVA::JVALUEX-FIX-WHEN-JVALUEXP)))
(JAVA::JVALUEX-KIND$INLINE-OF-JVALUEX-FIX-X-NORMALIZE-CONST)
...
(JAVA::JVALUEX-PRIMITIVE->GET$INLINE
    ...
    (6 6
       (:TYPE-PRESCRIPTION JAVA::REFERENCE-VALUEP))
    (2 2
       (:REWRITE JAVA::JVALUEX-KIND$INLINE-OF-JVALUEX-FIX-X-NORMALIZE-CONST))
    (1 1
       (:TYPE-PRESCRIPTION JAVA::JVALUEX-PRIMITIVE->GET$INLINE)))
...
(JAVA::JVALUEX-PRIMITIVE->GET$INLINE-OF-JVALUEX-FIX-X
    ...
    (4 4
       (:TYPE-PRESCRIPTION JAVA::REFERENCE-VALUEP)))
(JAVA::JVALUEX-PRIMITIVE->GET$INLINE-OF-JVALUEX-FIX-X-NORMALIZE-CONST)
...
(JAVA::JVALUEX-PRIMITIVE->GET-WHEN-WRONG-KIND
 ...
 (1
  ...
  (:REWRITE
      JAVA::JVALUEX-PRIMITIVE->GET$INLINE-OF-JVALUEX-FIX-X-NORMALIZE-CONST)))
(JAVA::JVALUEX-PRIMITIVE (3 1 (:REWRITE JAVA::LEMMA))
                         (2 2
                            (:TYPE-PRESCRIPTION JAVA::REFERENCE-VALUEP))
                         (1 1
                            (:TYPE-PRESCRIPTION JAVA::JVALUEX-PRIMITIVE)))
...
(JAVA::JVALUEX-PRIMITIVE-OF-PRIMITIVEX-VALUE-FIX-GET
     ...
     (9 6
        (:TYPE-PRESCRIPTION JAVA::JVALUEX-PRIMITIVE)))
(JAVA::JVALUEX-PRIMITIVE-OF-PRIMITIVEX-VALUE-FIX-GET-NORMALIZE-CONST)
...
(JAVA::JVALUEX-REFERENCE->GET$INLINE-OF-JVALUEX-FIX-X
    ...
    (6 6
       (:REWRITE JAVA::JVALUEX-KIND$INLINE-OF-JVALUEX-FIX-X-NORMALIZE-CONST))
    (6 2 (:REWRITE JAVA::LEMMA)))
(JAVA::JVALUEX-REFERENCE->GET$INLINE-OF-JVALUEX-FIX-X-NORMALIZE-CONST)
...
(JAVA::JVALUEX-REFERENCE-OF-REFERENCE-VALUE-FIX-GET-NORMALIZE-CONST)
