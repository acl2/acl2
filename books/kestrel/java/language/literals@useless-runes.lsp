...
(JAVA::LITERAL-FPOINT-OF-FIELDS
     (3 1
        (:REWRITE JAVA::LITERAL-FIX-WHEN-LITERALP))
     (2 2 (:TYPE-PRESCRIPTION JAVA::LITERALP)))
(JAVA::LITERAL-FIX-WHEN-FPOINT (3 1
                                  (:REWRITE JAVA::LITERAL-FIX-WHEN-LITERALP))
                               (2 2 (:TYPE-PRESCRIPTION JAVA::LITERALP)))
...
(JAVA::LITERAL-CHAR-OF-FIELDS (3 1
                                 (:REWRITE JAVA::LITERAL-FIX-WHEN-LITERALP))
                              (2 2 (:TYPE-PRESCRIPTION JAVA::LITERALP)))
(JAVA::LITERAL-FIX-WHEN-CHAR (3 1
                                (:REWRITE JAVA::LITERAL-FIX-WHEN-LITERALP))
                             (2 2 (:TYPE-PRESCRIPTION JAVA::LITERALP)))
...
(JAVA::LITERAL-STRING-OF-FIELDS
     (3 1
        (:REWRITE JAVA::LITERAL-FIX-WHEN-LITERALP))
     (2 2 (:TYPE-PRESCRIPTION JAVA::LITERALP)))
(JAVA::LITERAL-FIX-WHEN-STRING (3 1
                                  (:REWRITE JAVA::LITERAL-FIX-WHEN-LITERALP))
                               (2 2 (:TYPE-PRESCRIPTION JAVA::LITERALP)))
...
(JAVA::RETURN-TYPE-OF-LITERAL-BOOLEAN (3 1 (:REWRITE BOOL-FIX-WHEN-BOOLEANP))
                                      (2 2 (:TYPE-PRESCRIPTION BOOLEANP)))
