...
(defxdoc+ primitive-operations
  :parents (semantics)
  :short "Java primitive operations [JLS14:4.2]."
  :long
  (xdoc::topstring
   (xdoc::p
    "We formalize the Java boolean and integer operations
     [JLS14:4.2.5] [JLS14:4.2.2].
     ...
     Primitive conversions [JLS14:5.1.2-4] are formalized "
...
(defxdoc+ boolean-operations
  ...
  :short "Java boolean operations [JLS14:4.2.5]."
  :long
  (xdoc::topstring
   (xdoc::p
...
(def-boolean-unary boolean-not
  :short "Logical complement @('!') [JLS14:4.2.5] [JLS14:15.15.6]."
  :operation (not x))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-boolean-binary boolean-and
  :short "Logical conjunction @('&') [JLS14:4.2.5] [JLS14:15.22.2]."
  :operation (and x y)
  :commutative t
...
(def-boolean-binary boolean-xor
  :short "Logical exclusive disjunction @('^') [JLS14:4.2.5] [JLS14:15.22.2]."
...
(def-boolean-binary boolean-ior
  :short "Logical inclusive disjunction @('|') [JLS14:4.2.5] [JLS14:15.22.2]."
  :operation (or x y)
  :commutative t
  :commutative-hints (("Goal" :in-theory (enable boolean-value-fix
                                                 boolean-value->bool))))
...
(def-boolean-binary boolean-eq
  :short "Equality @('==') on @('boolean')s [JLS14:4.2.5] [JLS14:15.21.2]."
  :operation (equal x y)
  :commutative t)
...
(def-boolean-binary boolean-neq
  :short "Non-equality @('!=') on @('boolean')s [JLS14:4.2.5] [JLS14:15.21.2]."
  :operation (not (equal x y))
  :commutative t)
...
(defxdoc+ integer-operations
  :parents (primitive-operations)
  :short "Java integer operations [JLS14:4.2.2]."
  :long
  (xdoc::topstring
   (xdoc::p
...
(def-int-unary int-plus
  :short "Unary plus @('+') on @('int')s [JLS14:4.2.2] [JLS14:15.15.3]."
  :operation x)

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-long-unary long-plus
  :short "Unary plus @('+') on @('long')s [JLS14:4.2.2] [JLS14:15.15.3]."
  :operation x)

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-int-unary int-minus
  :short "Unary minus @('-') on @('int')s [JLS14:4.2.2] [JLS14:15.15.4]."
...
(def-long-unary long-minus
  :short "Unary minus @('-') on @('long')s [JLS14:4.2.2] [JLS14:15.15.4]."
...
(def-int-binary int-add
  :short "Addition @('+') on @('int')s [JLS14:4.2.2] [JLS14:15.18.2]."
...
(def-long-binary long-add
  :short "Addition @('+') on @('long')s [JLS14:4.2.2] [JLS14:15.18.2]."
...
(def-int-binary int-sub
  :short "Subtraction @('-') on @('int')s [JLS14:4.2.2] [JLS14:15.18.2]."
  :operation (logext 32 (- x y)))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-long-binary long-sub
  :short "Subtraction @('-') on @('long')s [JLS14:4.2.2] [JLS14:15.18.2]."
  :operation (logext 64 (- x y)))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-int-binary int-mul
  :short "Multiplication @('*') on @('int')s [JLS14:4.2.2] [JLS14:15.17.1]."
  :operation (logext 32 (* x y))
  :commutative t)
...
(def-long-binary long-mul
  :short "Multiplication @('*') on @('long')s [JLS14:4.2.2] [JLS14:15.17.1]."
  :operation (logext 64 (* x y))
  :commutative t)
...
(def-int-binary int-div
  :short "Division @('/') on @('int')s [JLS14:4.2.2] [JLS14:15.17.2]."
  :nonzero t
...
(def-long-binary long-div
  :short "Division @('/') on @('long')s [JLS14:4.2.2] [JLS14:15.17.2]."
  :nonzero t
...
(def-int-unary int-not
  :short "Bitwise complement @('~') on @('int')s [JLS14:4.2.2] [JLS14:15.15.5]."
  :operation (logext 32 (lognot x)))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-long-unary long-not
  :short "Bitwise complement @('~') on @('long')s [JLS14:4.2.2] [JLS14:15.15.5]."
  :operation (logext 64 (lognot x)))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-int-binary int-and
  :short "Bitwise conjunction @('&') on @('int')s [JLS14:4.2.2] [JLS14:15.22.1]."
...
(def-long-binary long-and
  :short "Bitwise conjunction @('&') on @('long')s [JLS14:4.2.2] [JLS14:15.22.1]."
...
(def-int=>boolean-binary int-eq
  :short "Equality @('==') on @('int')s [JLS14:4.2.2] [JLS14:15.21.1]."
  :operation (equal x y)
  :commutative t)
...
(def-long=>boolean-binary long-eq
  :short "Equality @('==') on @('long')s [JLS14:4.2.2] [JLS14:15.21.1]."
  :operation (equal x y)
  :commutative t)
...
(def-int=>boolean-binary int-neq
  :short "Non-equality @('!=') on @('int')s [JLS14:4.2.2] [JLS14:15.21.1]."
  :operation (not (equal x y))
  :commutative t)
...
(def-long=>boolean-binary long-neq
  :short "Non-equality @('!=') on @('long')s [JLS14:4.2.2] [JLS14:15.21.1]."
  :operation (not (equal x y))
  :commutative t)
...
(def-int-binary int-int-shiftl
  :short "Left shift of an @('int') by an @('int') [JLS14:4.2.2] [JLS14:15.19]."
  :long
  (xdoc::topstring-p
...
(def-long-binary long-long-shiftl
  :short "Left shift of a @('long') by a @('long') [JLS14:4.2.2] [JLS14:15.19]."
  :long
  (xdoc::topstring-p
...
(def-primitive-binary long-int-shiftl
  :short "Left shift of a @('long') by an @('int') [JLS14:4.2.2] [JLS14:15.19]."
  :long
  (xdoc::topstring-p
   "Only the low 6 bits of the distance are used [JLS14:15.19].")
...
(def-primitive-binary int-long-shiftl
  :short "Left shift of an @('int') by a @('long') [JLS14:4.2.2] [JLS14:15.19]."
  :long
  (xdoc::topstring-p
   "Only the low 5 bits of the distance are used [JLS14:15.19].")
...
(defxdoc+ floating-point-operations
  :parents (primitive-operations)
  :short "Java floating-point operations [JLS14:4.2.4]."
  :long
  (xdoc::topstring
   (xdoc::p
...
(def-float-unary float-plus
  :short "Unary plus @('+') on @('float')s [JLS14:4.2.4] [JLS14:15.15.3]."
  :operation (float-plus-abs x))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-double-unary double-plus
  :short "Unary plus @('+') on @('double')s [JLS14:4.2.4] [JLS14:15.15.3]."
  :operation (double-plus-abs x))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-float-unary float-minus
  :short "Unary minus @('-') on @('float')s [JLS14:4.2.4] [JLS14:15.15.4]."
  :operation (float-minus-abs x))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-double-unary double-minus
  :short "Unary minus @('-') on @('double')s [JLS14:4.2.4] [JLS14:15.15.4]."
  :operation (double-minus-abs x))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-float-binary float-add
  :short "Addition @('+') on @('float')s [JLS14:4.2.4] [JLS14:15.18.2]."
  :operation (float-add-abs x y))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-double-binary double-add
  :short "Addition @('+') on @('double')s [JLS14:4.2.4] [JLS14:15.18.2]."
  :operation (double-add-abs x y))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-float-binary float-sub
  :short "Subtraction @('-') on @('float')s [JLS14:4.2.4] [JLS14:15.18.2]."
  :operation (float-sub-abs x y))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-double-binary double-sub
  :short "Subtraction @('-') on @('double')s [JLS14:4.2.4] [JLS14:15.18.2]."
  :operation (double-sub-abs x y))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-float-binary float-mul
  :short "Multiplication @('*') on @('float')s [JLS14:4.2.4] [JLS14:15.17.1]."
  :operation (float-mul-abs x y))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-double-binary double-mul
  :short "Multiplication @('*') on @('double')s [JLS14:4.2.4] [JLS14:15.17.1]."
  :operation (double-mul-abs x y))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-float-binary float-div
  :short "Division @('/') on @('float')s [JLS14:4.2.4] [JLS14:15.17.2]."
  :operation (float-div-abs x y))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-double-binary double-div
  :short "Division @('/') on @('double')s [JLS14:4.2.4] [JLS14:15.17.2]."
  :operation (double-div-abs x y))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-float-binary float-rem
  :short "Remainder @('%') on @('float')s [JLS14:4.2.4] [JLS14:15.17.3]."
  :operation (float-rem-abs x y))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-double-binary double-rem
  :short "Remainder @('%') on @('double')s [JLS14:4.2.4] [JLS14:15.17.3]."
  :operation (double-rem-abs x y))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-float=>boolean-binary float-eq
  :short "Equality @('==') on @('float')s [JLS14:4.2.4] [JLS14:15.21.1]."
  :operation (float-eq-abs x y))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-double=>boolean-binary double-eq
  :short "Equality @('==') on @('double')s [JLS14:4.2.4] [JLS14:15.21.1]."
  :operation (double-eq-abs x y))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-float=>boolean-binary float-neq
  :short "Non-equality @('!=') on @('float')s [JLS14:4.2.4] [JLS14:15.21.1]."
  :operation (float-neq-abs x y))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(def-double=>boolean-binary double-neq
  :short "Non-equality @('!=') on @('double')s [JLS14:4.2.4] [JLS14:15.21.1]."
