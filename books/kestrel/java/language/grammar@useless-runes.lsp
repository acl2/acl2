...
(JAVA::UNICODE-ONLY-*GRAMMAR*
 ...
 (888 888
      (:REWRITE ABNF::CHARS-SENSITIVE-IN-TERMSET-P-WHEN-SUBSETP-EQUAL))
 (748
  748
  (:REWRITE
...
(JAVA::LIST-OF-INTEGERS-FROM-0-TO-FFFF-REWRITE-TO-UNICODE-LISTP
     (274 33
          (:REWRITE JAVA::UNICODE-LISTP-WHEN-ASCII-LISTP))
     (140 10
     ...
     (69 69
         (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-SYMBOL-SYMBOL-ALISTP
                   . 1))
     (58 6
         (:REWRITE JAVA::UNICODE-LISTP-OF-CDR-WHEN-UNICODE-LISTP))
     (56 30
     ...
     (42 7
         (:REWRITE JAVA::ASCII-LISTP-OF-CDR-WHEN-ASCII-LISTP))
     (38 2 (:REWRITE SUBSETP-OF-CONS))
     (30 5
         (:REWRITE SET::LIST-IN-OF-CDR-WHEN-LIST-IN))
     ...
     (10 1 (:REWRITE JAVA::ASCII-LISTP-OF-CONS))
...
(JAVA::ABNF-STRING-PARSABLEP-WHEN-TREE-WITH-ROOT-P
 ...
 (11 2
     (:REWRITE ABNF::PARSE-IS-PARSE!-WHEN-STRING-UNAMBIGUOUSP))
 (10 10
 ...
 (2 2
    (:REWRITE SET::IN-WHEN-MEMBER-EQUAL-OF-LIST-IN))
 (2
  1
  (:REWRITE
...
(JAVA::ABNF-TERMINAL-STRING-FOR-RULES-P-WHEN-TREE-WITH-ROOT-P
 ...
 (3
  1
  (:REWRITE ABNF::NAT-LISTP-OF-TREE->STRING-WHEN-MATCH-ELEMENT-NUM/CHAR-VAL))
 (2 2
    (:REWRITE
 ...
 (1 1
    (:REWRITE
         ABNF::TREE-MATCH-ELEMENT-P-OF-ELEMENT-FIX-ELEMENT-NORMALIZE-CONST))
 (1 1
    (:REWRITE ABNF::RETURN-TYPE-OF-ELEMENT-RULENAME))
 (1 1
    (:REWRITE ABNF::ELEMENT-RULENAME-OF-RULENAME-FIX-GET-NORMALIZE-CONST))
 (1 1
    (:REWRITE JAVA::ABNF-TREEP-WHEN-ABNF-TREE-WITH-ROOT-P)))
(JAVA::UNICODE-LISTP-OF-STRING-OF-ABNF-TREE-WITH-ROOT
     ...
     (3 1
        (:REWRITE INTEGERS-FROM-TO-NIL-WHEN-MIN>MAX))
     (2 2
        (:TYPE-PRESCRIPTION JAVA::ASCII-LISTP))
     (2 2
...
(JAVA::ABNF-TREE-LISTP-WHEN-ABNF-TREE-LIST-WITH-ROOT-P
 ...
 (20
  20
  (:REWRITE JAVA::ABNF-TREE-WITH-ROOT-P-OF-STR-FIX-RULENAME-NORMALIZE-CONST))
...
(JAVA::UNICODE-LISTP-OF-STRING-OF-ABNF-TREE-LIST-WITH-ROOT
 ...
 (54 9
     (:REWRITE JAVA::UNICODE-LISTP-WHEN-NOT-CONSP))
 (52 15 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
 (48 3 (:DEFINITION MEMBER-EQUAL))
 (43 15 (:REWRITE SUBSETP-WHEN-ATOM-LEFT))
 (40 26
     (:REWRITE JAVA::ASCII-LISTP-WHEN-SUBSETP-EQUAL))
 (40 1 (:REWRITE SUBSETP-APPEND1))
 (38 1
     (:REWRITE JAVA::ASCII-LISTP-OF-APPEND))
 (36 22 (:REWRITE SUBSETP-TRANS2))
 (24 24 (:REWRITE DEFAULT-CDR))
 (24 24 (:REWRITE DEFAULT-CAR))
 (24 10
