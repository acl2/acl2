...
(JAVA::REFERENCE-VALUE-KIND$INLINE-OF-REFERENCE-VALUE-FIX-X-NORMALIZE-CONST)
...
(JAVA::REFERENCE-VALUE-POINTER->GET$INLINE-OF-REFERENCE-VALUE-FIX-X
 ...
 (8
  ...
  (:REWRITE
   JAVA::REFERENCE-VALUE-KIND$INLINE-OF-REFERENCE-VALUE-FIX-X-NORMALIZE-CONST)))
(JAVA::REFERENCE-VALUE-POINTER->GET$INLINE-OF-REFERENCE-VALUE-FIX-X-NORMALIZE-CONST)
...
(JAVA::REFERENCE-VALUE-POINTER-OF-POINTER-FIX-GET-NORMALIZE-CONST)
