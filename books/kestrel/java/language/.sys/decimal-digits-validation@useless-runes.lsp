...
(JAVA::RETURN-TYPE-OF-DEC-DIGIT-TREE
 ...
 (32 6 (:REWRITE ABNF::TREE-LIST-LIST-TERMINATEDP-WHEN-NOT-CONSP))
 (32 6 (:REWRITE ABNF::TREE-LIST-LIST-TERMINATEDP-WHEN-ATOM))
...
(JAVA::TREE->STRING-OF-DEC-DIGIT-TREE
 (30 4 (:REWRITE ABNF::TREE-LIST-LIST->STRING-WHEN-ATOM))
...
(JAVA::LEMMA
 (12043 188 (:REWRITE ABNF::TREEP-OF-CAR-WHEN-TREE-LISTP))
 (6731 5750 (:REWRITE DEFAULT-CAR))
 (6615 5858 (:REWRITE DEFAULT-CDR))
 (6382 188 (:REWRITE ABNF::TREE-LISTP-OF-CAR-WHEN-TREE-LIST-LISTP))
 (5750 5750 (:REWRITE CAR-WHEN-ALL-EQUALP))
 (3504 219 (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
 (3285 219 (:REWRITE TRUE-LISTP-WHEN-ATOM))
 (2679 116 (:REWRITE ABNF::RULENAMEP-OF-CAR-WHEN-RULENAME-LISTP))
 (1930 107 (:REWRITE ABNF::RULENAME-LISTP-OF-CDR-WHEN-RULENAME-LISTP))
 ...
 (686 140 (:REWRITE NAT-LISTP-WHEN-NOT-CONSP))
 (620 40 (:REWRITE INTEGERP-OF-CAR-WHEN-INTEGER-LISTP))
 ...
 (540 20 (:DEFINITION INTEGER-LISTP))
 ...
 (400 20 (:REWRITE NAT-LIST-FIX-WHEN-NAT-LISTP))
 (386 386 (:REWRITE CONSP-OF-CDR-BY-LEN))
 (377 214 (:REWRITE ABNF::RULENAME-LISTP-WHEN-NOT-CONSP))
 (336 56 (:REWRITE JAVA::DEC-DIGIT-LISTP-WHEN-NOT-CONSP))
 (320 40 (:REWRITE INTEGER-LISTP-WHEN-NOT-CONSP))
 ...
 (77 39 (:REWRITE ABNF::TREE-LIST-LIST-TERMINATEDP-WHEN-NOT-CONSP))
 (77 39 (:REWRITE ABNF::TREE-LIST-LIST-TERMINATEDP-WHEN-ATOM))
...
(JAVA::DEC-DIGITP-WHEN-GRAMMAR-DEC-DIGITP
 (54 3 (:REWRITE JAVA::DEC-DIGITP-OF-CAR-WHEN-DEC-DIGIT-LISTP))
 (36 3 (:REWRITE DEFAULT-CAR))
 (36 3 (:REWRITE JAVA::DEC-DIGIT-LISTP-WHEN-NOT-CONSP))
