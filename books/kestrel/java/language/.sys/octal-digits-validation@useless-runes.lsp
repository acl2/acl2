...
(JAVA::LEMMA
 (2409 1908 (:REWRITE DEFAULT-CDR))
 (2253 1591 (:REWRITE DEFAULT-CAR))
 (2058 98 (:REWRITE TRUE-LISTP-WHEN-ATOM))
 (1764 98 (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
 (1591 1591 (:REWRITE CAR-WHEN-ALL-EQUALP))
 (1160 79 (:REWRITE ABNF::RULENAME-OPTIONP-WHEN-RULENAMEP))
 (744 98 (:REWRITE NAT-LISTP-WHEN-NOT-CONSP))
 (626 47 (:REWRITE ABNF::RULENAMEP-OF-CAR-WHEN-RULENAME-LISTP))
 (592 32 (:REWRITE INTEGERP-OF-CAR-WHEN-INTEGER-LISTP))
 (576 80 (:REWRITE ABNF::TREEP-OF-CAR-WHEN-TREE-LISTP))
 (528 16 (:DEFINITION INTEGER-LISTP))
 ...
 (416 16 (:REWRITE NAT-LIST-FIX-WHEN-NAT-LISTP))
 (368 128 (:REWRITE LEN-WHEN-ATOM))
 (352 32 (:REWRITE INTEGER-LISTP-WHEN-NOT-CONSP))
 (344 108 (:REWRITE ABNF::TREE-LISTP-OF-CAR-WHEN-TREE-LIST-LISTP))
 (304 43 (:REWRITE ABNF::RULENAME-LISTP-OF-CDR-WHEN-RULENAME-LISTP))
 ...
 (196 196 (:REWRITE TRUE-LISTP-OF-CDR-WHEN-MEMBER-EQUAL-OF-KEYWORD-TRUELIST-ALISTP))
 ...
 (196 98 (:REWRITE ABNF::SETP-WHEN-CHAR-VAL-SETP))
 (196 98 (:REWRITE SET::NONEMPTY-MEANS-SET))
 (184 86 (:REWRITE ABNF::RULENAME-LISTP-WHEN-NOT-CONSP))
 ...
 (98 98 (:TYPE-PRESCRIPTION ABNF::CHAR-VAL-SETP))
 ...
 (84 34 (:REWRITE ABNF::TREE-LIST-LIST-TERMINATEDP-WHEN-NOT-CONSP))
 (84 34 (:REWRITE ABNF::TREE-LIST-LIST-TERMINATEDP-WHEN-ATOM))
...
(JAVA::OCT-DIGITP-WHEN-GRAMMAR-OCT-DIGITP
 (72 3 (:REWRITE JAVA::OCT-DIGITP-OF-CAR-WHEN-OCT-DIGIT-LISTP))
 (54 3 (:REWRITE JAVA::OCT-DIGIT-LISTP-WHEN-NOT-CONSP))
