...
(JAVA::LEMMA
 (2201 1908 (:REWRITE DEFAULT-CDR))
 (2045 1575 (:REWRITE DEFAULT-CAR))
 (1575 1575 (:REWRITE CAR-WHEN-ALL-EQUALP))
 (1568 98 (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
 (1274 98 (:REWRITE TRUE-LISTP-WHEN-ATOM))
 (1120 79 (:REWRITE ABNF::RULENAME-OPTIONP-WHEN-RULENAMEP))
 (586 47 (:REWRITE ABNF::RULENAMEP-OF-CAR-WHEN-RULENAME-LISTP))
 ...
 (448 32 (:REWRITE INTEGERP-OF-CAR-WHEN-INTEGER-LISTP))
 (440 66 (:REWRITE NAT-LISTP-WHEN-NOT-CONSP))
 (384 16 (:DEFINITION INTEGER-LISTP))
 (368 128 (:REWRITE LEN-WHEN-ATOM))
 (344 108 (:REWRITE ABNF::TREE-LISTP-OF-CAR-WHEN-TREE-LIST-LISTP))
 (288 43 (:REWRITE ABNF::RULENAME-LISTP-OF-CDR-WHEN-RULENAME-LISTP))
 (286 47 (:REWRITE ABNF::RULENAMEP-WHEN-RULENAME-OPTIONP))
 (256 16 (:REWRITE NAT-LIST-FIX-WHEN-NAT-LISTP))
 ...
 (144 86 (:REWRITE ABNF::RULENAME-LISTP-WHEN-NOT-CONSP))
 ...
 (68 34 (:REWRITE ABNF::TREE-LIST-LIST-TERMINATEDP-WHEN-NOT-CONSP))
 (68 34 (:REWRITE ABNF::TREE-LIST-LIST-TERMINATEDP-WHEN-ATOM))
...
(JAVA::OCT-DIGITP-WHEN-GRAMMAR-OCT-DIGITP
 (48 3 (:REWRITE JAVA::OCT-DIGITP-OF-CAR-WHEN-OCT-DIGIT-LISTP))
 (30 3 (:REWRITE JAVA::OCT-DIGIT-LISTP-WHEN-NOT-CONSP))
