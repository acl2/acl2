...
(JAVA::LEMMA
 (713 552 (:REWRITE DEFAULT-CDR))
 (659 453 (:REWRITE DEFAULT-CAR))
 ...
 (416 32 (:REWRITE TRUE-LISTP-WHEN-ATOM))
 ...
 (128 18 (:REWRITE NAT-LISTP-WHEN-NOT-CONSP))
 ...
 (44 10 (:REWRITE ABNF::TREE-LIST-LIST-TERMINATEDP-WHEN-NOT-CONSP))
 (44 10 (:REWRITE ABNF::TREE-LIST-LIST-TERMINATEDP-WHEN-ATOM))
...
(JAVA::BIN-DIGITP-WHEN-GRAMMAR-BIN-DIGITP
 (48 3 (:REWRITE JAVA::BIN-DIGITP-OF-CAR-WHEN-BIN-DIGIT-LISTP))
 (30 3 (:REWRITE DEFAULT-CAR))
 (30 3 (:REWRITE JAVA::BIN-DIGIT-LISTP-WHEN-NOT-CONSP))
