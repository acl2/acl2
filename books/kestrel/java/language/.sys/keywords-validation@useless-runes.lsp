...
(JAVA::TREE->STRING-OF-KEYWORD-TREE
 (574 54 (:REWRITE JAVA::ASCII-LISTP-WHEN-NOT-CONSP))
 (164 1 (:REWRITE NAT-LISTP-WHEN-NOT-CONSP))
...
(JAVA::LEMMA
 (162331 5157 (:REWRITE NAT-LISTP-OF-CDR-WHEN-NAT-LISTP))
 (95857 54800 (:REWRITE DEFAULT-CDR))
 (87627 2770 (:REWRITE INTEGERP-OF-CAR-WHEN-INTEGER-LISTP))
 (85346 49124 (:REWRITE DEFAULT-CAR))
 (82854 2770 (:REWRITE INTEGERP-OF-CAR-WHEN-NAT-LISTP))
 (69951 4932 (:REWRITE INTEGER-LISTP-OF-CDR-WHEN-INTEGER-LISTP))
 (69872 580 (:REWRITE LOWER-BOUND-OF-CAR-WHEN-NAT-LISTP))
 (54200 2190 (:DEFINITION INTEGER-LISTP))
 (49124 49124 (:REWRITE CAR-WHEN-ALL-EQUALP))
 (14966 5990 (:REWRITE INTEGER-LISTP-WHEN-NOT-CONSP))
 (11026 7494 (:REWRITE NAT-LISTP-WHEN-NOT-CONSP))
 (10736 671 (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
 (10065 671 (:REWRITE TRUE-LISTP-WHEN-ATOM))
 ...
 (5430 423 (:REWRITE ABNF::RULENAME-OPTIONP-WHEN-RULENAMEP))
 (3672 510 (:REWRITE ABNF::TREEP-OF-CAR-WHEN-TREE-LISTP))
 (2660 219 (:REWRITE ABNF::RULENAMEP-OF-CAR-WHEN-RULENAME-LISTP))
 ...
 (2040 102 (:REWRITE NAT-LIST-FIX-WHEN-NAT-LISTP))
 ...
 (1324 215 (:REWRITE ABNF::RULENAME-LISTP-OF-CDR-WHEN-RULENAME-LISTP))
 ...
 (498 430 (:REWRITE ABNF::RULENAME-LISTP-WHEN-NOT-CONSP))
 ...
 (294 256 (:REWRITE ABNF::TREE-LIST-LIST-TERMINATEDP-WHEN-NOT-CONSP))
 (294 256 (:REWRITE ABNF::TREE-LIST-LIST-TERMINATEDP-WHEN-ATOM))
