...
(defxdoc+ grammar
  :parents (syntax)
  :short "Grammar of the Java language [JLS25]."
  :long
  (xdoc::topstring
   (xdoc::p
    "[JLS25] presents the grammar of Java using the notation in [JLS25:2.4],
   ...
   (xdoc::p
    "The ABNF grammar of Java is in the files
     ...
     in this directory;
     this splitting corresponds to [JLS25:2.2] and [JLS25:2.3].
   ...
   (xdoc::p
    "While ABNF lacks syntactic exceptions,
     it has constructs that are not in EBNF or in the notation in [JLS25:2.4],
     ...
     which allow us to define @('RawInputCharacter') [JLS25:3.3]
   ...
   (xdoc::p
    "The Java grammar in [JLS25] uses camelcase nonterminals.
     ...
     in the Java grammar in [JLS25];
     this is just for documentation,
     because, as noted above, we formalize these syntactic exceptions
     via extra-grammatical predicates elsewhere.
   ...
   (xdoc::p
    ...
    ". The correspondence with the notation in [JLS25] should be clear."))
  :order-subtopics t
  :default-parent t)
  ...
  (xdoc::topstring
   ...
   (xdoc::p
    "The goal symbol of the Java syntactic grammar is
     @('CompilationUnit') [JLS25:2.3] [JLS25:7.3].
   ...
   (xdoc::ul
    (xdoc::li
     "The syntactic grammar uses tokens as terminals [JLS25:2.3].
    ...
    (xdoc::li
     "Considering the lexical grammar as a whole would imply that
      ...
      However, [JLS25:3.2] distinguishes three lexical translation steps,
      ...
      The OpenJDK Java compiler indeed accepts @('\u0066\u006f\u0072')
      as the keyword @('for').
