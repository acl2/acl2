  ...
  (xdoc::topstring
   (xdoc::p
    "This is used by @(tsee atj-adapt-expr-to-type),
     when the source ATJ type is a @(':j...') type not ending in @('[]')
  ...
  (xdoc::topstring
   (xdoc::p
    "This is used by @(tsee atj-adapt-expr-to-type),
     ...
     and the destination ATJ type is a @(':j...') type not ending in @('[]').
...
(define convert-from-primarray-method-name
  ((type (member-eq type '(:jboolean :jchar :jbyte :jshort :jint :jlong))))
  ...
  (case type
    (:jboolean "$convertBooleanArrayToAcl2List")
    (:jchar "$convertCharArrayToAcl2List")
    (:jbyte "$convertByteArrayToAcl2List")
    (:jshort "$convertShortArrayToAcl2List")
    (:jint "$convertIntArrayToAcl2List")
    (:jlong "$convertLongArrayToAcl2List")
    (otherwise (impossible))))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(define atj-gen-shallow-primarray-to-list-method
  ((type (member-eq type '(:jboolean :jchar :jbyte :jshort :jint :jlong))))
...
(define convert-to-primarray-method-name
  ((type (member-eq type '(:jboolean :jchar :jbyte :jshort :jint :jlong))))
  :returns (method-name stringp :hyp :guard)
  :short "Name of the method to convert
  ...
  (case type
    (:jboolean "$convertAcl2ListToBooleanArray")
    (:jchar "$convertAcl2ListToCharArray")
    (:jbyte "$convertAcl2ListToByteArray")
    (:jshort "$convertAcl2ListShortArray")
    (:jint "$convertAcl2ListIntArray")
    (:jlong "$convertAcl2ListToLongArray")
    (otherwise (impossible))))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(define atj-gen-shallow-value-to-primarray-method
  ((type (member-eq type '(:jboolean :jchar :jbyte :jshort :jint :jlong))))
  :returns (method jmethodp)
  :short "Generate a Java method to convert
...
(defines atj-gen-shallow-term-fns
  ...
  (define atj-gen-shallow-jprimarr-length-app
    ...
    (b* (((mv array-block
              array-expr
              jvar-result-index)
          (atj-gen-shallow-term array jvar-result-base
                                jvar-result-index
                                pkg-class-names
                                fn-method-names
                                curr-pkg
...
(define atj-gen-shallow-mv-fields ((types atj-type-listp))
  ...
  (xdoc::topstring
   (xdoc::p
    "As explained in @(tsee atj-gen-shallow-mv-class-name),
     we generate Java classes that represent @(tsee mv) values.
     Each of these classes has a package-private instance field
  ...
  ((define atj-gen-shallow-mv-fields-aux ((types atj-type-listp) (index natp))
     ...
     (b* (((when (endp types)) nil)
          (field (make-jfield :access (jaccess-default)
                              :static? nil
                              :final? nil
                              :transient? nil
                              :volatile? nil
...
(define atj-gen-shallow-mv-class ((types atj-type-listp))
  ...
  (xdoc::topstring
   (xdoc::p
    "As explained in @(tsee atj-gen-shallow-mv-class-name),
     ...
     This is a private static final class, nested in the main class.
     It has a package-private instance field for each component type,
  ...
  (b* ((name (atj-gen-shallow-mv-class-name types))
       ...
       (method (make-jmethod :access (jaccess-default)
                             ...
                             :throws nil
                             :body method-body))
       (class (make-jclass :access (jaccess-default)
                           :abstract? nil
                           :static? t
                           :final? t
                           :strictfp? nil
