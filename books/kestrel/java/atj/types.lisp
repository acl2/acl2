...
(define atj-main-function-type-input-theorem ((formal symbolp)
                                              (type atj-typep)
                                              (fn symbolp)
                                              (wrld plist-worldp))
...
(define atj-main-function-type-input-theorems ((formals symbol-listp)
...
(define atj-main-function-type-output-theorem ((type atj-typep)
                                               (fn symbolp)
                                               (wrld plist-worldp))
  :mode :program
  :returns (event "A @(tsee acl2::pseudo-event-formp).")
...
(define def-atj-main-function-type-fn (fn
  ...
  (b* (((unless (symbolp fn))
       ...
       (formals (formals fn wrld))
       (input-thms
        (atj-main-function-type-input-theorems formals in-types fn wrld))
       (output-thm
        (atj-main-function-type-output-theorem out-type fn wrld))
