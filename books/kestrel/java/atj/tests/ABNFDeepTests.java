...
// for the reason given at the end  of the file test-abnf.lisp.
...
public class ABNFDeepTests {
    ...
    private static void test_ParseABNF(int n)
        ...
        Acl2Value input = getInputFromFile("test-abnf-files/abnf.txt");
    ...
    private static void test_ParseJSON(int n)
        ...
        Acl2Value input = getInputFromFile("test-abnf-files/json.txt");
        test_Parse(testName, input, n);
    }
    ...
    private static void test_ParseURI(int n)
        ...
        Acl2Value input = getInputFromFile("test-abnf-files/uri.txt");
        test_Parse(testName, input, n);
    }
    ...
    private static void test_ParseHTTP(int n)
        ...
        Acl2Value input = getInputFromFile("test-abnf-files/http.txt");
        test_Parse(testName, input, n);
    }
    ...
    private static void test_ParseIMF(int n)
        ...
        Acl2Value input = getInputFromFile("test-abnf-files/imf.txt");
        test_Parse(testName, input, n);
    }
    ...
    private static void test_ParseSMTP(int n)
        ...
        Acl2Value input = getInputFromFile("test-abnf-files/smtp.txt");
        test_Parse(testName, input, n);
    }
    ...
    private static void test_ParseIMAP(int n)
        ...
        Acl2Value input = getInputFromFile("test-abnf-files/imap.txt");
        test_Parse(testName, input, n);
    }
