...
public class HardErrorShallowUnguardedTests {
    ...
    private static void testError() {
        ...
        try {
            Acl2Value functionResult =
                HardErrorShallowUnguarded.ACL2.error_if_nil(Acl2Symbol.NIL);
    ...
    public static void main(String[] args) {
        HardErrorShallowUnguarded.initialize();
        testNoError();
        testError();
    }
}
