...
; (2) A macro DEF-ATJ-TUTORIAL-TOPICS to generate, from the table,
...
; it is reversed back by DEF-ATJ-TUTORIAL-TOPICS).
...
; from which the :SHORT is generated by DEF-ATJ-TUTORIAL-TOPIC;
; (iii) zero or more forms that must evaluate to XDOC trees
; from which the :LONG is generated by DEF-ATJ-TUTORIAL-TOPIC.
