  ...
  (xdoc::topstring
   (xdoc::p
    "When the dependencies in a parallel assignment are not circular,
     ...
     via a sequence of single assignments that respects the dependencies.
  ...
  (xdoc::topstring
   ...
   (xdoc::p
    "The temporary variables are called @('$1'), @('$2'), etc.,
     ...
     which are passed to this function along with their names,
  ...
  (xdoc::topstring
   ...
   (xdoc::p
    "In all other cases,
     ...
     that is, no change to that part of the Java code is made."))
