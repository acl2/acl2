...
(JAVA::JBLOCKP-OF-ATJ-SERIALIZE-PARALLEL-ASG
 ...
 (290 107 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
 (260 107 (:REWRITE SUBSETP-WHEN-ATOM-LEFT))
 (204 204 (:TYPE-PRESCRIPTION INDEX-OF))
 (178 112 (:REWRITE SUBSETP-TRANS2))
 (178 6 (:REWRITE SUBSETP-APPEND1))
...
(JAVA::ATJ-MAKE-PARALLEL-ASG
 ...
 (36 7 (:REWRITE SUBSETP-WHEN-ATOM-LEFT))
...
(JAVA::FLAG-LEMMA-FOR-RETURN-TYPE-OF-ATJ-ELIM-TAILREC-IN-JSTATEM.NEW-BLOCK
 (1848 132 (:DEFINITION MEMBER-EQUAL))
 (644 227 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
 ...
 (312 252 (:REWRITE SUBSETP-TRANS2))
