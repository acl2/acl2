...
(JAVA::SYMBOL-LISTP-OF-ATJ-PRE-TRANSLATE.NEW-FORMALS
 (2243 1 (:DEFINITION PSEUDO-TERMP))
 ...
 (37 4 (:REWRITE TRUE-LISTP-WHEN-SYMBOL-LISTP-REWRITE))
...
(JAVA::PSEUDO-TERMP-OF-ATJ-PRE-TRANSLATE.NEW-BODY
 (4509 2 (:DEFINITION PSEUDO-TERMP))
 ...
 (74 8 (:REWRITE TRUE-LISTP-WHEN-SYMBOL-LISTP-REWRITE))
