...
(JAVA::FLAG-LEMMA-FOR-RETURN-TYPE-OF-ATJ-RESTORE-OR-CALLS-IN-TERM.NEW-TERM
 ...
 (2759 90 (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
 (2701 1621 (:REWRITE DEFAULT-CAR))
 (2507 45 (:DEFINITION TRUE-LIST-LISTP))
...
(JAVA::LEN-OF-ATJ-RESTORE-OR-CALLS-IN-TERMS
 (1606 1 (:DEFINITION JAVA::ATJ-RESTORE-OR-CALLS-IN-TERM))
 (1530 2 (:REWRITE PSEUDO-TERM-FIX-WHEN-PSEUDO-TERMP))
