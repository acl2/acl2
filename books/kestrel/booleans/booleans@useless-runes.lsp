(NOT-OF-NOT (6 2 (:REWRITE BOOL-FIX-WHEN-BOOLEANP))
            (4 4 (:TYPE-PRESCRIPTION BOOLEANP)))
(BOOLIF-WHEN-QUOTEP-ARG1 (12 4 (:REWRITE BOOL-FIX-WHEN-BOOLEANP))
                         (8 8 (:TYPE-PRESCRIPTION BOOLEANP)))
(BOOLIF-WHEN-QUOTEP-ARG2 (3 1 (:REWRITE BOOL-FIX-WHEN-BOOLEANP))
...
(BOOLIF-WHEN-QUOTEP-ARG3 (3 1 (:REWRITE BOOL-FIX-WHEN-BOOLEANP))
                         (2 2 (:TYPE-PRESCRIPTION BOOLEANP))
...
(BOOLIF-WHEN-NOT-NIL (6 2 (:REWRITE BOOL-FIX-WHEN-BOOLEANP))
                     (4 4 (:TYPE-PRESCRIPTION BOOLEANP))
...
(NOT-OF-BOOLOR (1 1 (:REWRITE BOOLOR-OF-NON-NIL-ARG2))
               ...
               (1 1 (:REWRITE BOOLAND-OF-NON-NIL-ARG2))
               (1 1 (:REWRITE BOOLAND-OF-NON-NIL)))
(EQUAL-NIL-OF-NOT (8 8 (:TYPE-PRESCRIPTION BOOLEANP))
                  (7 3 (:REWRITE BOOL-FIX-DOES-NOTHING))
                  (6 2 (:REWRITE BOOL-FIX-WHEN-BOOLEANP)))
(NOT-EQUAL-NIL (8 8 (:TYPE-PRESCRIPTION BOOLEANP))
               (7 3 (:REWRITE BOOL-FIX-DOES-NOTHING))
               (6 2 (:REWRITE BOOL-FIX-WHEN-BOOLEANP)))
(EQUAL-OF-NIL-WHEN-BOOLEANP)
(BOOLOR-OF-BOOLAND-SAME (8 8 (:TYPE-PRESCRIPTION BOOLEANP))
                        (7 3 (:REWRITE BOOL-FIX-DOES-NOTHING))
                        (6 2 (:REWRITE BOOL-FIX-WHEN-BOOLEANP))
...
(BOOLIF-OF-BOOLAND-SAME (2 2 (:REWRITE BOOLIF-WHEN-QUOTEP-ARG3))
                        ...
                        (1 1 (:REWRITE BOOLAND-OF-NON-NIL-ARG2))
                        (1 1 (:REWRITE BOOLAND-OF-NON-NIL)))
(IFF-OF-T-ARG1 (8 8 (:TYPE-PRESCRIPTION BOOLEANP))
               (7 3 (:REWRITE BOOL-FIX-DOES-NOTHING))
               (6 2 (:REWRITE BOOL-FIX-WHEN-BOOLEANP)))
(IFF-OF-T-ARG2 (8 8 (:TYPE-PRESCRIPTION BOOLEANP))
               (7 3 (:REWRITE BOOL-FIX-DOES-NOTHING))
               (6 2 (:REWRITE BOOL-FIX-WHEN-BOOLEANP)))
(IFF-OF-NIL-ARG1)
(IFF-OF-NIL-ARG2)
(IFF-SAME)
(IMPLIES-OPENER (4 4 (:TYPE-PRESCRIPTION BOOLEANP))
                (4 2 (:REWRITE BOOL-FIX-DOES-NOTHING))
...
(MYIF-BECOMES-BOOLIF (1 1 (:REWRITE MYIF-WHEN-NOT-NIL))
                     ...
                     (1 1 (:REWRITE BOOLIF-WHEN-QUOTEP-ARG2))
                     (1 1 (:REWRITE BOOLIF-WHEN-QUOTEP-ARG1)))
(BOOLOR-OF-NOT-OF-BOOLOR-OF-NOT-SAME (8 8 (:TYPE-PRESCRIPTION BOOLEANP))
                                     (7 3 (:REWRITE BOOL-FIX-DOES-NOTHING))
                                     (6 2 (:REWRITE BOOL-FIX-WHEN-BOOLEANP))
                                     (2 2 (:REWRITE BOOLOR-OF-NON-NIL-ARG2))
                                     (2 2 (:REWRITE BOOLOR-OF-NON-NIL)))
