...
(BOOLIF-WHEN-NOT-NIL (3 1 (:REWRITE BOOL-FIX-WHEN-BOOLEANP))
                     (2 2 (:TYPE-PRESCRIPTION BOOLEANP))
...
(NOT-OF-BOOLOR (1 1 (:REWRITE BOOLOR-OF-NON-NIL-ARG2))
               ...
               (1 1 (:REWRITE BOOLAND-OF-NON-NIL-ARG2))
               (1 1 (:REWRITE BOOLAND-OF-NON-NIL)))
(NOT-OF-BOOL-FIX (4 4 (:TYPE-PRESCRIPTION BOOLEANP))
...
(BOOLOR-OF-BOOLAND-NOT-BOOLOR (4 4 (:TYPE-PRESCRIPTION BOOLEANP))
...
(BOOLOR-OF-NOT-OF-BOOLOR-OF-NOT-SAME (8 8 (:TYPE-PRESCRIPTION BOOLEANP))
                                     ...
                                     (6 2 (:REWRITE BOOL-FIX-DOES-NOTHING))
                                     (2 2 (:REWRITE BOOLOR-OF-NON-NIL-ARG2))
                                     (2 2 (:REWRITE BOOLOR-OF-NON-NIL)))
