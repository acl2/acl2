...
(BOOLIF-WHEN-QUOTEP-ARG2 (2 2 (:REWRITE BOOLAND-OF-NON-NIL))
...
(BOOLIF-WHEN-NOT-NIL (1 1 (:REWRITE BOOLIF-WHEN-QUOTEP-ARG3))
                     (1 1 (:REWRITE BOOLIF-WHEN-QUOTEP-ARG2))
                     (1 1 (:REWRITE BOOLIF-WHEN-QUOTEP-ARG1)))
(BOOLIF-WHEN-NIL (1 1 (:REWRITE BOOLIF-WHEN-QUOTEP-ARG3))
                 (1 1 (:REWRITE BOOLIF-WHEN-QUOTEP-ARG2)))
...
(NOT-OF-BOOLOR (1 1 (:REWRITE BOOLOR-OF-NON-NIL-ARG2))
               ...
               (1 1 (:REWRITE BOOLAND-OF-NON-NIL-ARG2))
               (1 1 (:REWRITE BOOLAND-OF-NON-NIL)))
(NOT-OF-BOOL-FIX (3 1 (:REWRITE BOOL-FIX-DOES-NOTHING))
                 (2 2 (:TYPE-PRESCRIPTION BOOLEANP)))
(EQUAL-NIL-OF-NOT (3 1 (:REWRITE BOOL-FIX-DOES-NOTHING))
                  (2 2 (:TYPE-PRESCRIPTION BOOLEANP)))
(NOT-EQUAL-NIL (3 1 (:REWRITE BOOL-FIX-DOES-NOTHING))
               (2 2 (:TYPE-PRESCRIPTION BOOLEANP)))
(EQUAL-OF-NIL-WHEN-BOOLEANP)
(BOOLOR-OF-BOOLAND-SAME (3 1 (:REWRITE BOOL-FIX-DOES-NOTHING))
                        (2 2 (:TYPE-PRESCRIPTION BOOLEANP))
                        (2 2 (:REWRITE BOOLAND-OF-NON-NIL-ARG2))
                        (2 2 (:REWRITE BOOLAND-OF-NON-NIL))
                        (1 1 (:REWRITE BOOLOR-OF-NON-NIL-ARG2))
                        (1 1 (:REWRITE BOOLOR-OF-NON-NIL)))
(BOOLOR-OF-BOOLAND-SAME-ALT (4 2 (:REWRITE BOOL-FIX-DOES-NOTHING))
                            (2 2 (:TYPE-PRESCRIPTION BOOLEANP))
                            (2 2 (:REWRITE BOOLAND-OF-NON-NIL-ARG2))
                            (2 2 (:REWRITE BOOLAND-OF-NON-NIL)))
...
(BOOLIF-OF-BOOLAND-SAME (2 2 (:REWRITE BOOLIF-WHEN-QUOTEP-ARG3))
                        ...
                        (1 1 (:REWRITE BOOLAND-OF-NON-NIL-ARG2))
                        (1 1 (:REWRITE BOOLAND-OF-NON-NIL)))
(IFF-OF-T-ARG1 (3 1 (:REWRITE BOOL-FIX-DOES-NOTHING))
               (2 2 (:TYPE-PRESCRIPTION BOOLEANP)))
(IFF-OF-T-ARG2 (3 1 (:REWRITE BOOL-FIX-DOES-NOTHING))
               (2 2 (:TYPE-PRESCRIPTION BOOLEANP)))
(IFF-OF-NIL-ARG1)
(IFF-OF-NIL-ARG2)
(IFF-SAME)
(IMPLIES-OPENER (3 1 (:REWRITE BOOL-FIX-DOES-NOTHING))
                (2 2 (:TYPE-PRESCRIPTION BOOLEANP))
...
(MYIF-BECOMES-BOOLIF (1 1 (:REWRITE MYIF-WHEN-NOT-NIL))
                     ...
                     (1 1 (:REWRITE BOOLIF-WHEN-QUOTEP-ARG2))
                     (1 1 (:REWRITE BOOLIF-WHEN-QUOTEP-ARG1)))
(BOOLOR-OF-NOT-OF-BOOLOR-OF-NOT-SAME (6 2 (:REWRITE BOOL-FIX-DOES-NOTHING))
