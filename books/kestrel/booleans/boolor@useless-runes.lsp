...
(BOOLOR-SAME (3 1 (:REWRITE BOOL-FIX-WHEN-BOOLEANP))
             (2 2 (:TYPE-PRESCRIPTION BOOLEANP)))
(BOOLOR-SAME-2)
(BOOLOR-OF-T-ARG1)
(BOOLOR-OF-T-ARG2)
(BOOLOR-OF-NIL-ARG1 (3 1 (:REWRITE BOOL-FIX-WHEN-BOOLEANP))
                    (2 2 (:TYPE-PRESCRIPTION BOOLEANP)))
...
(BOOLOR-OF-BOOL-FIX-ARG2 (3 1 (:REWRITE BOOL-FIX-WHEN-BOOLEANP))
                         ...
                         (2 2 (:REWRITE BOOLOR-OF-NON-NIL)))
(IFF-IMPLIES-EQUAL-BOOLOR-1 (2 2 (:REWRITE BOOLOR-OF-NON-NIL-ARG2))
                            (2 2 (:REWRITE BOOLOR-OF-NON-NIL)))
