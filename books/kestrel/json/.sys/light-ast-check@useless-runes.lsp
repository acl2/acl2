...
(JSON::ARRAY-VALUEP-IMPLIES-TOP-JARRAYP
 (575 10 (:REWRITE JSON::VALUEP-WHEN-MAYBE-VALUEP))
 (560 5 (:REWRITE JSON::MAYBE-VALUEP-WHEN-VALUEP))
 ...
 (31 3 (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
 (25 2 (:DEFINITION TRUE-LIST-LISTP))
 ...
 (15 15 (:TYPE-PRESCRIPTION JSON::MAYBE-VALUEP))
...
(JSON::TOP-JARRAYP-IMPLIES-NO-OTHER-KIND-OF-VALUE
 ...
 (53 3 (:REWRITE TRUE-LISTP-OF-CAR-WHEN-TRUE-LIST-LISTP))
 (47 2 (:DEFINITION TRUE-LIST-LISTP))
 (32 2 (:REWRITE JSON::VALUEP-WHEN-MAYBE-VALUEP))
 (29 1 (:REWRITE JSON::MAYBE-VALUEP-WHEN-VALUEP))
...
(JSON::MEMBERP-IMPLIES-TOP-JMEMBERP
 ...
 (72 18 (:REWRITE JSON::VALUEP-WHEN-MAYBE-VALUEP))
 (45 9 (:REWRITE JSON::MAYBE-VALUEP-WHEN-VALUEP))
 (27 27 (:TYPE-PRESCRIPTION JSON::MAYBE-VALUEP))
...
(JSON::OBJECT-VALUEP-IMPLIES-TOP-JOBJECTP
 (472 10 (:REWRITE JSON::VALUEP-WHEN-MAYBE-VALUEP))
 (457 5 (:REWRITE JSON::MAYBE-VALUEP-WHEN-VALUEP))
 ...
 (35 2 (:DEFINITION TRUE-LIST-LISTP))
...
(JSON::TOP-JOBJECTP-IMPLIES-NO-OTHER-KIND-OF-VALUE
 ...
 (24 2 (:REWRITE JSON::VALUEP-WHEN-MAYBE-VALUEP))
 (21 1 (:REWRITE JSON::MAYBE-VALUEP-WHEN-VALUEP))
