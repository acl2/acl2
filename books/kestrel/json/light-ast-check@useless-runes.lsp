...
(JSON::ARRAY-VALUEP-IMPLIES-TOP-JARRAYP
 (557 10 (:REWRITE JSON::VALUEP-WHEN-MAYBE-VALUEP))
 (542 5 (:REWRITE JSON::MAYBE-VALUEP-WHEN-VALUEP))
...
(JSON::TOP-JARRAYP-IMPLIES-NO-OTHER-KIND-OF-VALUE
 ...
 (30 2 (:REWRITE JSON::VALUEP-WHEN-MAYBE-VALUEP))
 (27 1 (:REWRITE JSON::MAYBE-VALUEP-WHEN-VALUEP))
...
(JSON::OBJECT-VALUEP-IMPLIES-TOP-JOBJECTP
 (428 10 (:REWRITE JSON::VALUEP-WHEN-MAYBE-VALUEP))
 (413 5 (:REWRITE JSON::MAYBE-VALUEP-WHEN-VALUEP))
