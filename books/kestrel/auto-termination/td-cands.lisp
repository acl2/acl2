   ...
   (((O-P (ACL2-COUNT ALIST)))
    ((NOT (CONSP ALIST))
     (O< (ACL2-COUNT (REMOVE-ASSOC-EQUAL (CAR (CAR ALIST))
                                         (CDR ALIST)))
         (ACL2-COUNT ALIST))))
   (ALIST-MAP-KEYS-EQUAL 1 :SYSTEM
                         .
                         "kestrel/utilities/alists/alist-map-keys")
   (ALIST-MAP-VALS-EQUAL :SYSTEM
                         .
                         "kestrel/utilities/alists/alist-map-vals"))
  ((JUSTIFICATION (ALIST)
                  (NIL O-P . O<)
                  ((ACL2-COUNT ALIST)
                   MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT ALIST)))
    ((NOT (CONSP ALIST))
     (O< (ACL2-COUNT (REMOVE-ASSOC-EQL-EXEC (CAR (CAR ALIST))
                                            (CDR ALIST)))
         (ACL2-COUNT ALIST))))
   (ALIST-MAP-KEYS-EQL-EXEC 1 :SYSTEM
                            .
                            "kestrel/utilities/alists/alist-map-keys")
   (ALIST-MAP-VALS-EQL-EXEC :SYSTEM
                            .
                            "kestrel/utilities/alists/alist-map-vals"))
