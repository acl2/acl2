...
(((JUSTIFICATION (I MAXIMUM)
 ...
 ((JUSTIFICATION (VL2014::I VL2014::N)
  ...
  ((JUSTIFICATION (VL2014::N VL2014::XL)
   ...
   (STR::STRTOK!-AUX :SYSTEM
                     . "kestrel/std/strings/strtok-bang")
 ...
 ((JUSTIFICATION (APT::J APT::M)
                 (NIL O-P . O<)
                 ((NFIX (BINARY-+ (BINARY-+ '1 (POS-FIX APT::M))
                                  (UNARY-- (POS-FIX APT::J))))
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (APT::J APT::M)
                  (NIL O-P . O<)
                  ((NFIX (BINARY-+ (BINARY-+ '1 (POS-FIX APT::M))
                                   (UNARY-- (POS-FIX APT::J))))
                   MV-LIST RETURN-LAST))
   (((O-P (NFIX (BINARY-+ (BINARY-+ '1 (POS-FIX APT::M))
                          (UNARY-- (POS-FIX APT::J))))))
    ((NOT (INTEGERP APT::J))
     (NOT (< '0 APT::J))
     (NOT (INTEGERP APT::M))
     (NOT (< '0 APT::M))
     (< APT::M APT::J)
     (O< (NFIX (BINARY-+ (BINARY-+ '1 (POS-FIX APT::M))
                         (UNARY-- (POS-FIX (BINARY-+ '1 APT::J)))))
         (NFIX (BINARY-+ (BINARY-+ '1 (POS-FIX APT::M))
                         (UNARY-- (POS-FIX APT::J)))))))
   (APT::ISODATA-PROCESS-ISOMAPS-RESS 4 :SYSTEM . "kestrel/apt/isodata")))
 ((JUSTIFICATION (ECURVE::S)
                 (NIL O-P . O<)
                 ((NFIX ECURVE::S) MV-LIST RETURN-LAST))
  ((JUSTIFICATION (N)
                  (NIL O-P . O<)
  ...
  ((JUSTIFICATION (ECURVE::S)
                  ...
                  ((NFIX ECURVE::S) MV-LIST RETURN-LAST))
   (((O-P (NFIX ECURVE::S)))
    ((NOT (INTEGERP ECURVE::S))
     (NOT (< '0 ECURVE::S))
     (EQUAL ECURVE::S '1)
     (EVENP ECURVE::S)
     (O< (NFIX (BINARY-+ '-1 ECURVE::S))
         (NFIX ECURVE::S)))
    ((NOT (INTEGERP ECURVE::S))
     (NOT (< '0 ECURVE::S))
     (EQUAL ECURVE::S '1)
     (NOT (EVENP ECURVE::S))
     (O< (NFIX (BINARY-* ECURVE::S '1/2))
         (NFIX ECURVE::S))))
   (ECURVE::CURVE-SCALAR-* 5 :SYSTEM
                           .
                           "kestrel/crypto/ecurve/short-weierstrass")))
 ((JUSTIFICATION (KECCAK::X KECCAK::Y)
                 (NIL O-P . O<)
                 ((TWO-NATS-MEASURE (BINARY-+ '5 (UNARY-- KECCAK::Y))
                                    (BINARY-+ '5 (UNARY-- KECCAK::X)))
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (KECCAK::X KECCAK::Y)
                  (NIL O-P . O<)
                  ((TWO-NATS-MEASURE (BINARY-+ '5 (UNARY-- KECCAK::Y))
                                     (BINARY-+ '5 (UNARY-- KECCAK::X)))
                   MV-LIST RETURN-LAST))
   (((O-P (TWO-NATS-MEASURE (BINARY-+ '5 (UNARY-- KECCAK::Y))
                            (BINARY-+ '5 (UNARY-- KECCAK::X)))))
    ((NOT (INTEGERP W))
     (< W '0)
     (NOT (INTEGERP KECCAK::X))
     (< KECCAK::X '0)
     (NOT (< KECCAK::X '5))
     (NOT (INTEGERP KECCAK::Y))
     (< KECCAK::Y '0)
     (NOT (< KECCAK::Y '5))
     (O< (TWO-NATS-MEASURE (BINARY-+ '5
                                     (UNARY-- (IF (EQUAL (BINARY-+ KECCAK::X '1) '5)
                                                  (BINARY-+ KECCAK::Y '1)
                                                  KECCAK::Y)))
                           (BINARY-+ '5
                                     (UNARY-- (IF (EQUAL (BINARY-+ KECCAK::X '1) '5)
         ...
         (TWO-NATS-MEASURE (BINARY-+ '5 (UNARY-- KECCAK::Y))
                           (BINARY-+ '5 (UNARY-- KECCAK::X))))))
   (KECCAK::K-THETA-AUX 5 :SYSTEM
                        . "kestrel/crypto/keccak/keccak")))
 ((JUSTIFICATION (KECCAK::I KECCAK::MAX-I)
                 (NIL O-P . O<)
                 ((NFIX (BINARY-+ '1
                                  (BINARY-+ KECCAK::MAX-I (UNARY-- KECCAK::I))))
                  MV-LIST RETURN-LAST))
  ...
  ((JUSTIFICATION (KECCAK::I KECCAK::MAX-I)
   ...
   (((O-P (NFIX (BINARY-+ '1
                          (BINARY-+ KECCAK::MAX-I (UNARY-- KECCAK::I))))))
    ((NOT (INTEGERP KECCAK::I))
     (NOT (INTEGERP KECCAK::MAX-I))
     (< KECCAK::MAX-I KECCAK::I)
     (O< (NFIX (BINARY-+ '1
                         (BINARY-+ KECCAK::MAX-I
                                   (UNARY-- (BINARY-+ KECCAK::I '1)))))
         (NFIX (BINARY-+ '1
                         (BINARY-+ KECCAK::MAX-I (UNARY-- KECCAK::I)))))))
   (KECCAK::K-DO-ROUNDS 4 :SYSTEM
                        . "kestrel/crypto/keccak/keccak")))
 ((JUSTIFICATION (X FLAG)
                 (NIL O-P . O<)
 ...
 ((JUSTIFICATION (TYPE)
                 (NIL O-P . O<)
                 ((JAVA::JTYPE-COUNT TYPE)
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (TYPE)
                  (NIL O-P . O<)
                  ((JAVA::JTYPE-COUNT TYPE)
                   MV-LIST RETURN-LAST))
   (((O-P (JAVA::JTYPE-COUNT TYPE)))
    ((EQUAL (JAVA::JTYPE-KIND$INLINE TYPE)
            ':PRIM)
     (EQUAL (JAVA::JTYPE-KIND$INLINE TYPE)
            ':CLASS)
     (O< (JAVA::JTYPE-COUNT (JAVA::JTYPE-ARRAY->COMP$INLINE TYPE))
         (JAVA::JTYPE-COUNT TYPE))))
   (JAVA::PRINT-JTYPE 1 :SYSTEM
                      .
                      "kestrel/java/atj/java-pretty-printer")))
 ((JUSTIFICATION (JAVA::FIELDS)
                 (NIL O-P . O<)
                 ((LEN JAVA::FIELDS)
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (L)
  ...
  ((JUSTIFICATION (X)
   ...
   (ABNF::LOOKUP-RULENAME :SYSTEM . "kestrel/abnf/semantics")
  ...
  ((JUSTIFICATION (BITCOIN::CUR-PATH)
                  (NIL O-P . O<)
                  ((LEN BITCOIN::CUR-PATH)
                   MV-LIST RETURN-LAST))
   (((O-P (LEN BITCOIN::CUR-PATH)))
    ((NOT (SET::IN (UBYTE32-LIST-FIX$INLINE BITCOIN::CUR-PATH)
                   (BITCOIN::BIP32-PATH-SFIX BITCOIN::ALL-PATHS)))
     (NOT (CONSP BITCOIN::CUR-PATH))
     (O< (LEN (BUTLAST BITCOIN::CUR-PATH '1))
         (LEN BITCOIN::CUR-PATH))))
   (BITCOIN::BIP32-PATH-SET-CLOSEDP-EXEC-INNER 2 :SYSTEM
                                               . "kestrel/bitcoin/bip32-executable"))
  ((JUSTIFICATION (JAVA::FIELDS)
                  (NIL O-P . O<)
                  ((LEN JAVA::FIELDS)
                   MV-LIST RETURN-LAST))
   (((O-P (LEN JAVA::FIELDS)))
    ((NOT (< '1 (LEN JAVA::FIELDS)))
     (O< (LEN (NTHCDR (FLOOR (LEN JAVA::FIELDS) '2)
                      JAVA::FIELDS))
         (LEN JAVA::FIELDS)))
    ((NOT (< '1 (LEN JAVA::FIELDS)))
     (O< (LEN (TAKE (FLOOR (LEN JAVA::FIELDS) '2)
                    JAVA::FIELDS))
         (LEN JAVA::FIELDS))))
   (JAVA::MERGESORT-JFIELDS 1 :SYSTEM
                            .
                            "kestrel/java/atj/java-syntax-operations")))
 ((JUSTIFICATION (BLOCK)
                 (NIL O-P . O<)
                 ((JAVA::JBLOCK-COUNT-IFS BLOCK)
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (BLOCK)
                  (NIL O-P . O<)
                  ((JAVA::JBLOCK-COUNT-IFS BLOCK)
                   MV-LIST RETURN-LAST))
   (((O-P (JAVA::JBLOCK-COUNT-IFS BLOCK)))
    ((NOT (MV-NTH '0
                  (JAVA::ATJ-CHECK-FOLDABLE-RETURN BLOCK)))
     (O< (JAVA::JBLOCK-COUNT-IFS (BINARY-APPEND (MV-NTH '5
                                                        (JAVA::ATJ-CHECK-FOLDABLE-RETURN BLOCK))
                                                (CONS (JAVA::JSTATEM-RETURN (MV-NTH '6
                                                                                    (JAVA::ATJ-CHECK-FOLDABLE-RETURN BLOCK)))
                                                      'NIL)))
         (JAVA::JBLOCK-COUNT-IFS BLOCK)))
    ((NOT (MV-NTH '0
                  (JAVA::ATJ-CHECK-FOLDABLE-RETURN BLOCK)))
     (O< (JAVA::JBLOCK-COUNT-IFS (BINARY-APPEND (MV-NTH '3
                                                        (JAVA::ATJ-CHECK-FOLDABLE-RETURN BLOCK))
                                                (CONS (JAVA::JSTATEM-RETURN (MV-NTH '4
                                                                                    (JAVA::ATJ-CHECK-FOLDABLE-RETURN BLOCK)))
                                                      'NIL)))
         (JAVA::JBLOCK-COUNT-IFS BLOCK))))
   (JAVA::ATJ-FOLD-RETURNS 1 :SYSTEM
                           . "kestrel/java/atj/post-translation")))
 ((JUSTIFICATION (EXP)
                 (NIL O-P . O<)
                 ((SIMPL-IMP::AEXP-COUNT EXP)
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (EXP)
                  (NIL O-P . O<)
                  ((SIMPL-IMP::AEXP-COUNT EXP)
                   MV-LIST RETURN-LAST))
   (((O-P (SIMPL-IMP::AEXP-COUNT EXP)))
    ((NOT (EQUAL (SIMPL-IMP::AEXP-KIND$INLINE EXP)
                 ':ADD))
     (O< (SIMPL-IMP::AEXP-COUNT (SIMPL-IMP::AEXP-ADD->RIGHT$INLINE EXP))
         (SIMPL-IMP::AEXP-COUNT EXP)))
    ((NOT (EQUAL (SIMPL-IMP::AEXP-KIND$INLINE EXP)
                 ':ADD))
     (O< (SIMPL-IMP::AEXP-COUNT (SIMPL-IMP::AEXP-ADD->LEFT$INLINE EXP))
         (SIMPL-IMP::AEXP-COUNT EXP)))
    ((EQUAL (SIMPL-IMP::AEXP-KIND$INLINE EXP)
            ':CONST)
     (EQUAL (SIMPL-IMP::AEXP-KIND$INLINE EXP)
            ':VAR)
     (EQUAL (SIMPL-IMP::AEXP-KIND$INLINE EXP)
            ':ADD)
     (O< (SIMPL-IMP::AEXP-COUNT (SIMPL-IMP::AEXP-MUL->RIGHT$INLINE EXP))
         (SIMPL-IMP::AEXP-COUNT EXP)))
    ((EQUAL (SIMPL-IMP::AEXP-KIND$INLINE EXP)
            ':CONST)
     (EQUAL (SIMPL-IMP::AEXP-KIND$INLINE EXP)
     ...
     (EQUAL (SIMPL-IMP::AEXP-KIND$INLINE EXP)
            ':ADD)
     (O< (SIMPL-IMP::AEXP-COUNT (SIMPL-IMP::AEXP-MUL->LEFT$INLINE EXP))
         (SIMPL-IMP::AEXP-COUNT EXP))))
   (SIMPL-IMP::AEVAL 2 :SYSTEM
                     . "kestrel/simpl-imp/semantics")))
 ...
 ((JUSTIFICATION (X)
  ...
  ((JUSTIFICATION (ID)
                  (NIL O-P . O<)
                  ((ACL2-COUNT ID) MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT ID)))
    ((NOT (EQUAL (AIGNET::ID->TYPE ID AIGNET) '1))
  ...
  ((JUSTIFICATION (STD::N)
                  ...
                  ((ACL2-COUNT STD::N)
                   MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT STD::N)))
    ((NOT (INTEGERP STD::N))
     (NOT (< '0 STD::N))
     (EQUAL STD::N '1)
     (O< (ACL2-COUNT (BINARY-+ '-2 STD::N))
         (ACL2-COUNT STD::N)))
    ((NOT (INTEGERP STD::N))
     (NOT (< '0 STD::N))
     (EQUAL STD::N '1)
     (O< (ACL2-COUNT (BINARY-+ '-1 STD::N))
         (ACL2-COUNT STD::N))))
   (STD::FIB 1 :SYSTEM . "std/util/defval-tests")
   (X86ISA::FIB32 :SYSTEM
                  .
   ...
   (BRIDGE::FIB :SYSTEM . "centaur/bridge/top"))
  ((JUSTIFICATION (VL2014::X)
                  (NIL O-P . O<)
                  ((ACL2-COUNT VL2014::X)
                   MV-LIST RETURN-LAST))
  ...
  ((JUSTIFICATION (SIZE)
   ...
   (PFIELD::POW :SYSTEM
                . "kestrel/prime-fields/prime-fields"))
  ...
  ((JUSTIFICATION (X)
   ...
   (BVCAT-SIZE :SYSTEM . "kestrel/bv/bvcat2"))
   ...
   (((O-P (ACL2-COUNT ACL2S::N)))
    ((NOT (INTEGERP ACL2S::N))
     ...
     (O< (ACL2-COUNT (FLOOR (NFIX ACL2S::N) '2))
         (ACL2-COUNT ACL2S::N))))
   (ACL2S::BITSIZE-AUX 2 :SYSTEM . "acl2s/defdata/base"))
  ((JUSTIFICATION (TS)
                  (NIL O-P . O<)
  ...
  ((JUSTIFICATION (TERM)
   ...
   (((O-P (ACL2-COUNT TERM)))
    ...
    ((NOT (CONSP TERM))
     ...
     (O< (ACL2-COUNT (CAR (CDR (CDR TERM))))
         (ACL2-COUNT TERM))))
   (APPLY-FN-INTO-IFS 2 :SYSTEM
                      .
                      "kestrel/std/system/apply-fn-into-ifs"))
  ((JUSTIFICATION (TERM)
                  (NIL O-P . O<)
                  ((ACL2-COUNT TERM) MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT TERM)))
    ...
    ((NOT (CONSP TERM))
     ...
     (O< (ACL2-COUNT (CAR (CDR (CDR (CAR TERM)))))
         (ACL2-COUNT TERM))))
   (MVIFY 1 :SYSTEM . "kestrel/std/system/mvify"))
  ((JUSTIFICATION (TERM)
                  (NIL O-P . O<)
                  ((ACL2-COUNT TERM) MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT TERM)))
  ...
  ((JUSTIFICATION (LARGER)
                  (NIL O-P . O<)
                  ((ACL2-COUNT LARGER)
                   MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT LARGER)))
    ((NOT (DAB-BASEP SMALLER))
     (NOT (DAB-BASEP LARGER))
     (NOT (INTEGERP (BINARY-* LARGER (UNARY-/ SMALLER))))
     (NOT (< '0
             (BINARY-* LARGER (UNARY-/ SMALLER))))
     (EQUAL (BINARY-* LARGER (UNARY-/ SMALLER))
            '1)
     (O< (ACL2-COUNT (BINARY-* LARGER (UNARY-/ SMALLER)))
         (ACL2-COUNT LARGER))))
   (DEFDIGIT-GROUPING-FIND-EXP 2 :SYSTEM
                               .
                               "kestrel/utilities/digits-any-base/defdigit-grouping"))
  ((JUSTIFICATION (MSG)
                  (NIL O-P . O<)
                  ((ACL2-COUNT MSG) MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT MSG)))
    ((NOT (CONSP MSG))
     (O< (ACL2-COUNT (NTHCDR '32 MSG))
         (ACL2-COUNT MSG))))
   (SHA2::SHA-256-MESSAGE-WORDS 1 :SYSTEM
                                . "kestrel/crypto/sha-2/sha-256"))
  ((JUSTIFICATION (SHA2::WORDS)
                  (NIL O-P . O<)
                  ((ACL2-COUNT SHA2::WORDS)
                   MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT SHA2::WORDS)))
    ((NOT (CONSP SHA2::WORDS))
     (O< (ACL2-COUNT (NTHCDR '16 SHA2::WORDS))
         (ACL2-COUNT SHA2::WORDS))))
   (SHA2::SHA-256-MESSAGE-BLOCKS 1 :SYSTEM
                                 . "kestrel/crypto/sha-2/sha-256")
   (SHA2::SHA-512-MESSAGE-BLOCKS :SYSTEM
                                 . "kestrel/crypto/sha-2/sha-512"))
  ((JUSTIFICATION (ECURVE::TRIPLES)
                  (NIL O-P . O<)
                  ((ACL2-COUNT ECURVE::TRIPLES)
                   MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT ECURVE::TRIPLES)))
    ((EQUAL ECURVE::TRIPLES 'NIL)
     (NOT (ECURVE::RUN-SECP256K1-TEST (CAR (CAR ECURVE::TRIPLES))
                                      (CAR (CDR (CAR ECURVE::TRIPLES)))
                                      (CAR (CDR (CDR (CAR ECURVE::TRIPLES))))))
     (O< (ACL2-COUNT (CDR ECURVE::TRIPLES))
         (ACL2-COUNT ECURVE::TRIPLES))))
   (ECURVE::RUN-SECP256K1-TESTS 1 :SYSTEM
                                .
                                "kestrel/crypto/ecurve/secp256k1-tests"))
  ((JUSTIFICATION (BITS)
                  (NIL O-P . O<)
                  ((ACL2-COUNT BITS) MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT BITS)))
    ((NOT (CONSP BITS))
     (O< (ACL2-COUNT (NTHCDR '8 BITS))
         (ACL2-COUNT BITS))))
   (BITS-TO-BYTES-LITTLE 1 :SYSTEM
                         .
                         "kestrel/bv-lists/bits-to-bytes-little")
   (BITS-TO-BYTES :SYSTEM
                  . "kestrel/bv-lists/bits-to-bytes"))
  ((JUSTIFICATION (MSG)
                  (NIL O-P . O<)
                  ((ACL2-COUNT MSG) MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT MSG)))
    ((NOT (CONSP MSG))
     (O< (ACL2-COUNT (NTHCDR '64 MSG))
         (ACL2-COUNT MSG))))
   (SHA2::SHA-512-MESSAGE-WORDS 1 :SYSTEM
                                . "kestrel/crypto/sha-2/sha-512"))
  ((JUSTIFICATION (ETHEREUM::X)
                  (NIL O-P . O<)
                  ((ACL2-COUNT ETHEREUM::X)
                   MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT ETHEREUM::X)))
    ((NOT (EQUAL (ETHEREUM::RLP-ERROR-KIND$INLINE ETHEREUM::X)
                 ':SUBTREE))
     (O< (ACL2-COUNT (CAR (CDR ETHEREUM::X)))
         (ACL2-COUNT ETHEREUM::X))))
   (ETHEREUM::RLP-ERROR-FIX$INLINE 1 :SYSTEM
                                   .
                                   "kestrel/ethereum/rlp/decoding-executable"))
  ((JUSTIFICATION (OMAP::NEW)
   ...
   (OMAP::UPDATE* 2 :SYSTEM
                  . "kestrel/utilities/omaps/core"))
  ((JUSTIFICATION (JAVA::X)
                  (NIL O-P . O<)
                  ((ACL2-COUNT JAVA::X)
                   MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT JAVA::X)))
    ((NOT (EQUAL (JAVA::JTYPE-KIND$INLINE JAVA::X)
                 ':ARRAY))
     (O< (ACL2-COUNT (CAR (CDR JAVA::X)))
         (ACL2-COUNT JAVA::X))))
   (JAVA::JTYPE-FIX$INLINE 1 :SYSTEM
                           .
                           "kestrel/java/atj/java-abstract-syntax"))
  ...
  ((JUSTIFICATION (SIMPL-IMP::X)
                  (NIL O-P . O<)
                  ((ACL2-COUNT SIMPL-IMP::X)
                   MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT SIMPL-IMP::X)))
    ((NOT (EQUAL (SIMPL-IMP::AEXP-KIND$INLINE SIMPL-IMP::X)
                 ':MUL))
     (O< (ACL2-COUNT (CAR (CDR (CDR SIMPL-IMP::X))))
         (ACL2-COUNT SIMPL-IMP::X)))
    ((NOT (EQUAL (SIMPL-IMP::AEXP-KIND$INLINE SIMPL-IMP::X)
                 ':MUL))
     (O< (ACL2-COUNT (CAR (CDR SIMPL-IMP::X)))
         (ACL2-COUNT SIMPL-IMP::X)))
    ((NOT (EQUAL (SIMPL-IMP::AEXP-KIND$INLINE SIMPL-IMP::X)
                 ':ADD))
     (O< (ACL2-COUNT (CAR (CDR (CDR SIMPL-IMP::X))))
    ...
    ((NOT (EQUAL (SIMPL-IMP::AEXP-KIND$INLINE SIMPL-IMP::X)
     ...
     (O< (ACL2-COUNT (CAR (CDR SIMPL-IMP::X)))
         (ACL2-COUNT SIMPL-IMP::X))))
   (SIMPL-IMP::AEXP-FIX$INLINE 1 :SYSTEM
                               . "kestrel/simpl-imp/abstract-syntax"))
  ((JUSTIFICATION (N)
                  (NIL O-P . O<)
                  ((ACL2-COUNT N) MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT N)))
  ...
  ((JUSTIFICATION (SIMPL-IMP::X)
                  ...
                  ((ACL2-COUNT SIMPL-IMP::X)
                   MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT SIMPL-IMP::X)))
    ((NOT (EQUAL (SIMPL-IMP::BEXP-KIND$INLINE SIMPL-IMP::X)
                 ':AND))
     (O< (ACL2-COUNT (CAR (CDR SIMPL-IMP::X)))
         (ACL2-COUNT SIMPL-IMP::X)))
    ((NOT (EQUAL (SIMPL-IMP::BEXP-KIND$INLINE SIMPL-IMP::X)
    ...
    ((NOT (EQUAL (SIMPL-IMP::BEXP-KIND$INLINE SIMPL-IMP::X)
     ...
     (O< (ACL2-COUNT (CAR (CDR SIMPL-IMP::X)))
         (ACL2-COUNT SIMPL-IMP::X))))
   (SIMPL-IMP::BEXP-FIX$INLINE 1 :SYSTEM
                               . "kestrel/simpl-imp/abstract-syntax"))
  ((JUSTIFICATION (X)
                  (NIL O-P . O<)
                  ((ACL2-COUNT X) MV-LIST RETURN-LAST))
 ...
 ((JUSTIFICATION (EXP)
                 (NIL O-P . O<)
                 ((SIMPL-IMP::BEXP-COUNT EXP)
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (EXP)
                  (NIL O-P . O<)
                  ((SIMPL-IMP::BEXP-COUNT EXP)
                   MV-LIST RETURN-LAST))
   (((O-P (SIMPL-IMP::BEXP-COUNT EXP)))
    ((NOT (EQUAL (SIMPL-IMP::BEXP-KIND$INLINE EXP)
                 ':NOT))
     (O< (SIMPL-IMP::BEXP-COUNT (SIMPL-IMP::BEXP-NOT->ARG$INLINE EXP))
         (SIMPL-IMP::BEXP-COUNT EXP)))
    ((EQUAL (SIMPL-IMP::BEXP-KIND$INLINE EXP)
            ':CONST)
     (EQUAL (SIMPL-IMP::BEXP-KIND$INLINE EXP)
            ':EQUAL)
     (EQUAL (SIMPL-IMP::BEXP-KIND$INLINE EXP)
     ...
     (EQUAL (SIMPL-IMP::BEXP-KIND$INLINE EXP)
            ':NOT)
     (O< (SIMPL-IMP::BEXP-COUNT (SIMPL-IMP::BEXP-AND->LEFT$INLINE EXP))
         (SIMPL-IMP::BEXP-COUNT EXP)))
    ((EQUAL (SIMPL-IMP::BEXP-KIND$INLINE EXP)
            ':CONST)
     (EQUAL (SIMPL-IMP::BEXP-KIND$INLINE EXP)
     ...
     (EQUAL (SIMPL-IMP::BEXP-KIND$INLINE EXP)
            ':NOT)
     (NOT (TD-STUB-2 (SIMPL-IMP::BEXP-AND->LEFT$INLINE EXP)
                     SIMPL-IMP::ENV))
     (O< (SIMPL-IMP::BEXP-COUNT (SIMPL-IMP::BEXP-AND->RIGHT$INLINE EXP))
         (SIMPL-IMP::BEXP-COUNT EXP))))
   (SIMPL-IMP::BEVAL 2 :SYSTEM
                     . "kestrel/simpl-imp/semantics")))
 ((JUSTIFICATION (SIMPL-IMP::X)
                 (NIL O-P . O<)
                 (((LAMBDA (SIMPL-IMP::X)
                           (ACL2-COUNT SIMPL-IMP::X))
                   (SIMPL-IMP::BEXP-FIX$INLINE SIMPL-IMP::X))
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (SIMPL-IMP::X)
                  (NIL O-P . O<)
                  (((LAMBDA (SIMPL-IMP::X)
                    ...
                    (SIMPL-IMP::BEXP-FIX$INLINE SIMPL-IMP::X))
                   MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT (SIMPL-IMP::BEXP-FIX$INLINE SIMPL-IMP::X))))
    ((NOT (EQUAL (SIMPL-IMP::BEXP-KIND$INLINE SIMPL-IMP::X)
                 ':AND))
     (O< (ACL2-COUNT (SIMPL-IMP::BEXP-FIX$INLINE (SIMPL-IMP::BEXP-AND->LEFT$INLINE SIMPL-IMP::X)))
         (ACL2-COUNT (SIMPL-IMP::BEXP-FIX$INLINE SIMPL-IMP::X))))
    ((NOT (EQUAL (SIMPL-IMP::BEXP-KIND$INLINE SIMPL-IMP::X)
                 ':AND))
     (O< (ACL2-COUNT (SIMPL-IMP::BEXP-FIX$INLINE (SIMPL-IMP::BEXP-AND->RIGHT$INLINE SIMPL-IMP::X)))
         (ACL2-COUNT (SIMPL-IMP::BEXP-FIX$INLINE SIMPL-IMP::X))))
    ((NOT (EQUAL (SIMPL-IMP::BEXP-KIND$INLINE SIMPL-IMP::X)
                 ':NOT))
     (O< (ACL2-COUNT (SIMPL-IMP::BEXP-FIX$INLINE (SIMPL-IMP::BEXP-NOT->ARG$INLINE SIMPL-IMP::X)))
         (ACL2-COUNT (SIMPL-IMP::BEXP-FIX$INLINE SIMPL-IMP::X)))))
   (SIMPL-IMP::BEXP-COUNT 1 :SYSTEM
                          . "kestrel/simpl-imp/abstract-syntax")))
 ((JUSTIFICATION (JAVA::METHODS2 JAVA::METHODS1)
                 (NIL O-P . O<)
                 ((BINARY-+ (LEN JAVA::METHODS1)
                            (LEN JAVA::METHODS2))
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (L2 L1)
                  (NIL O-P . O<)
  ...
  ((JUSTIFICATION (JAVA::FIELDS2 JAVA::FIELDS1)
                  (NIL O-P . O<)
                  ((BINARY-+ (LEN JAVA::FIELDS1)
                             (LEN JAVA::FIELDS2))
                   MV-LIST RETURN-LAST))
   (((O-P (BINARY-+ (LEN JAVA::FIELDS1)
                    (LEN JAVA::FIELDS2))))
    ((NOT (CONSP JAVA::FIELDS1))
     (NOT (CONSP JAVA::FIELDS2))
     (STRING<= (JAVA::JFIELD->NAME$INLINE (CAR JAVA::FIELDS1))
               (JAVA::JFIELD->NAME$INLINE (CAR JAVA::FIELDS2)))
     (O< (BINARY-+ (LEN JAVA::FIELDS1)
                   (LEN (CDR JAVA::FIELDS2)))
         (BINARY-+ (LEN JAVA::FIELDS1)
                   (LEN JAVA::FIELDS2))))
    ((NOT (CONSP JAVA::FIELDS1))
     (NOT (CONSP JAVA::FIELDS2))
     (NOT (STRING<= (JAVA::JFIELD->NAME$INLINE (CAR JAVA::FIELDS1))
                    (JAVA::JFIELD->NAME$INLINE (CAR JAVA::FIELDS2))))
     (O< (BINARY-+ (LEN (CDR JAVA::FIELDS1))
                   (LEN JAVA::FIELDS2))
         (BINARY-+ (LEN JAVA::FIELDS1)
                   (LEN JAVA::FIELDS2)))))
   (JAVA::MERGE-JFIELDS 2 :SYSTEM
                        .
                        "kestrel/java/atj/java-syntax-operations"))
  ((JUSTIFICATION (JAVA::METHODS2 JAVA::METHODS1)
                  (NIL O-P . O<)
                  ((BINARY-+ (LEN JAVA::METHODS1)
                             (LEN JAVA::METHODS2))
                   MV-LIST RETURN-LAST))
   (((O-P (BINARY-+ (LEN JAVA::METHODS1)
                    (LEN JAVA::METHODS2))))
    ((NOT (CONSP JAVA::METHODS1))
     (NOT (CONSP JAVA::METHODS2))
     (STRING<= (JAVA::JMETHOD->NAME$INLINE (CAR JAVA::METHODS1))
               (JAVA::JMETHOD->NAME$INLINE (CAR JAVA::METHODS2)))
     (O< (BINARY-+ (LEN JAVA::METHODS1)
                   (LEN (CDR JAVA::METHODS2)))
         (BINARY-+ (LEN JAVA::METHODS1)
                   (LEN JAVA::METHODS2))))
    ((NOT (CONSP JAVA::METHODS1))
     (NOT (CONSP JAVA::METHODS2))
     (NOT (STRING<= (JAVA::JMETHOD->NAME$INLINE (CAR JAVA::METHODS1))
                    (JAVA::JMETHOD->NAME$INLINE (CAR JAVA::METHODS2))))
     (O< (BINARY-+ (LEN (CDR JAVA::METHODS1))
                   (LEN JAVA::METHODS2))
         (BINARY-+ (LEN JAVA::METHODS1)
                   (LEN JAVA::METHODS2)))))
   (JAVA::MERGE-JMETHODS 2 :SYSTEM
                         .
                         "kestrel/java/atj/java-syntax-operations")))
 ((JUSTIFICATION (JAVA::X)
                 (NIL O-P . O<)
                 (((LAMBDA (JAVA::X) (ACL2-COUNT JAVA::X))
                   (JAVA::JTYPE-FIX$INLINE JAVA::X))
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (JAVA::X)
                  (NIL O-P . O<)
                  (((LAMBDA (JAVA::X) (ACL2-COUNT JAVA::X))
                    (JAVA::JTYPE-FIX$INLINE JAVA::X))
                   MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT (JAVA::JTYPE-FIX$INLINE JAVA::X))))
    ((NOT (EQUAL (JAVA::JTYPE-KIND$INLINE JAVA::X)
                 ':ARRAY))
     (O< (ACL2-COUNT (JAVA::JTYPE-FIX$INLINE (JAVA::JTYPE-ARRAY->COMP$INLINE JAVA::X)))
         (ACL2-COUNT (JAVA::JTYPE-FIX$INLINE JAVA::X)))))
   (JAVA::JTYPE-COUNT 1 :SYSTEM
                      .
                      "kestrel/java/atj/java-abstract-syntax")))
 ((JUSTIFICATION (ETHEREUM::X)
                 (NIL O-P . O<)
                 (((LAMBDA (ETHEREUM::X)
                           (ACL2-COUNT ETHEREUM::X))
                   (ETHEREUM::RLP-ERROR-FIX$INLINE ETHEREUM::X))
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (ETHEREUM::X)
                  (NIL O-P . O<)
                  (((LAMBDA (ETHEREUM::X)
                    ...
                    (ETHEREUM::RLP-ERROR-FIX$INLINE ETHEREUM::X))
                   MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT (ETHEREUM::RLP-ERROR-FIX$INLINE ETHEREUM::X))))
    ((NOT (EQUAL (ETHEREUM::RLP-ERROR-KIND$INLINE ETHEREUM::X)
                 ':SUBTREE))
     (O< (ACL2-COUNT (ETHEREUM::RLP-ERROR-FIX$INLINE (ETHEREUM::RLP-ERROR-SUBTREE->ERROR$INLINE ETHEREUM::X)))
         (ACL2-COUNT (ETHEREUM::RLP-ERROR-FIX$INLINE ETHEREUM::X)))))
   (ETHEREUM::RLP-ERROR-COUNT 1 :SYSTEM
                              .
                              "kestrel/ethereum/rlp/decoding-executable")))
 ((JUSTIFICATION (SHA2::T-VAR)
                 (NIL O-P . O<)
                 ((BINARY-+ '1
                            (NFIX (BINARY-+ '80 (UNARY-- SHA2::T-VAR))))
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (SHA2::T-VAR)
                  (NIL O-P . O<)
                  ((BINARY-+ '1
   ...
   (((O-P (BINARY-+ '1
                    (NFIX (BINARY-+ '80 (UNARY-- SHA2::T-VAR))))))
    ((NOT (< SHA2::T-VAR '64))
     (NOT (INTEGERP SHA2::T-VAR))
     (< SHA2::T-VAR '0)
     (O< (BINARY-+ '1
                   (NFIX (BINARY-+ '80
                                   (UNARY-- (BINARY-+ '1 SHA2::T-VAR)))))
         (BINARY-+ '1
                   (NFIX (BINARY-+ '80
                                   (UNARY-- SHA2::T-VAR)))))))
   (SHA2::SHA-256-INNER-LOOP 10 :SYSTEM
                             . "kestrel/crypto/sha-2/sha-256"))
  ((JUSTIFICATION (SHA2::T-VAR)
                  (NIL O-P . O<)
                  ((BINARY-+ '1
    ...
    ((NOT (< SHA2::T-VAR '80))
     ...
     (O< (BINARY-+ '1
         ...
         (BINARY-+ '1
                   (NFIX (BINARY-+ '80
                                   (UNARY-- SHA2::T-VAR)))))))
   (SHA2::SHA-512-PREPARE-MESSAGE-SCHEDULE-AUX 2 :SYSTEM
                                               . "kestrel/crypto/sha-2/sha-512")))
 ((JUSTIFICATION (KECCAK::X)
                 (NIL O-P . O<)
                 ((NFIX (BINARY-+ '5 (UNARY-- KECCAK::X)))
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (KECCAK::X)
                  (NIL O-P . O<)
                  ((NFIX (BINARY-+ '5 (UNARY-- KECCAK::X)))
                   MV-LIST RETURN-LAST))
   (((O-P (NFIX (BINARY-+ '5 (UNARY-- KECCAK::X)))))
    ((NOT (INTEGERP KECCAK::X))
     (< KECCAK::X '0)
     (NOT (< KECCAK::X '5))
     (O< (NFIX (BINARY-+ '5
                         (UNARY-- (BINARY-+ '1 KECCAK::X))))
         (NFIX (BINARY-+ '5 (UNARY-- KECCAK::X))))))
   (KECCAK::K-THETA-MAKE-C-AUX 3 :SYSTEM
                               . "kestrel/crypto/keccak/keccak")))
 ((JUSTIFICATION (SHA2::T-VAR)
                 (NIL O-P . O<)
                 ((BINARY-+ '1
                            (NFIX (BINARY-+ '64 (UNARY-- SHA2::T-VAR))))
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (SHA2::T-VAR)
                  (NIL O-P . O<)
                  ((BINARY-+ '1
    ...
    ((NOT (< SHA2::T-VAR '64))
     ...
     (O< (BINARY-+ '1
         ...
         (BINARY-+ '1
                   (NFIX (BINARY-+ '64
                                   (UNARY-- SHA2::T-VAR)))))))
   (SHA2::SHA-256-PREPARE-MESSAGE-SCHEDULE-AUX 2 :SYSTEM
                                               . "kestrel/crypto/sha-2/sha-256")))
 ((JUSTIFICATION (APT::J APT::M)
                 (NIL O-P . O<)
                 ((NFIX (BINARY-+ (BINARY-+ '1 (NFIX APT::M))
                                  (UNARY-- (NFIX APT::J))))
                  MV-LIST RETURN-LAST))
  ((JUSTIFICATION (APT::J APT::M)
                  (NIL O-P . O<)
                  ((NFIX (BINARY-+ (BINARY-+ '1 (NFIX APT::M))
                                   (UNARY-- (NFIX APT::J))))
                   MV-LIST RETURN-LAST))
   (((O-P (NFIX (BINARY-+ (BINARY-+ '1 (NFIX APT::M))
                          (UNARY-- (NFIX APT::J))))))
    ((NOT (INTEGERP APT::J))
     (NOT (< '0 APT::J))
     (NOT (INTEGERP APT::M))
     (NOT (< '0 APT::M))
     (< APT::M APT::J)
     (O< (NFIX (BINARY-+ (BINARY-+ '1 (NFIX APT::M))
                         (UNARY-- (NFIX (BINARY-+ '1 APT::J)))))
         (NFIX (BINARY-+ (BINARY-+ '1 (NFIX APT::M))
                         (UNARY-- (NFIX APT::J)))))))
   (APT::ISODATA-GEN-RESULT-VARS-AUX 3 :SYSTEM . "kestrel/apt/isodata")))
