...
(((justification (i maximum)
 ...
 ((justification (deps irule-infos)
                 (nil o-p . o<)
                 ((set::cardinality$inline (set::difference$inline (defind-preds-in-premises-of-irules irule-infos)
                                                                   (symbol-sfix deps)))
                  if mv-list return-last))
  ((justification (deps irule-infos)
                  (nil o-p . o<)
                  ((set::cardinality$inline (set::difference$inline (defind-preds-in-premises-of-irules irule-infos)
                                                                    (symbol-sfix deps)))
                   if mv-list return-last))
   (((o-p (set::cardinality$inline (set::difference$inline (defind-preds-in-premises-of-irules irule-infos)
                                                           (symbol-sfix deps)))))
    ((set::subset$inline (set::union$inline (symbol-sfix deps)
                                            (defind-preds-direct-dependencies (symbol-sfix deps)
                                                                              irule-infos))
                         (symbol-sfix deps))
     (o< (set::cardinality$inline (set::difference$inline (defind-preds-in-premises-of-irules irule-infos)
                                                          (symbol-sfix (set::union$inline (symbol-sfix deps)
                                                                                          (defind-preds-direct-dependencies (symbol-sfix deps)
                                                                                                                            irule-infos)))))
         (set::cardinality$inline (set::difference$inline (defind-preds-in-premises-of-irules irule-infos)
                                                          (symbol-sfix deps))))))
   (defind-pred-dependencies-loop 2 :system . "std/util/definductive")))
 ((justification (unleveled)
                 (nil o-p . o<)
                 ((set::cardinality$inline (symbol-sfix unleveled))
                  if mv-list return-last))
  ((justification (unleveled)
                  (nil o-p . o<)
                  ((set::cardinality$inline (symbol-sfix unleveled))
                   if mv-list return-last))
   (((o-p (set::cardinality$inline (symbol-sfix unleveled))))
    ((set::emptyp$inline (symbol-sfix unleveled))
     (set::emptyp$inline (defind-pred-levels-round unleveled leveled irule-infos))
     (o< (set::cardinality$inline (symbol-sfix (set::difference$inline unleveled
                                                                       (defind-pred-levels-round unleveled leveled irule-infos))))
         (set::cardinality$inline (symbol-sfix unleveled)))))
   (defind-pred-levels-loop 3 :system . "std/util/definductive")))
 ((justification (x)
                 (nil o-p . o<)
 ...
 ((justification (n fgl::bvar-db)
  ...
  ((justification (n fgl::bvar-db)
   ...
   (fgl::bvar-db-to-bfr-env-aux :system
                                . "centaur/fgl/interp-st-bvar-db-ok")))
 ...
 ((justification (primes::m)
  ...
  ((justification (num)
                  (nil o-p . o<)
                  ((nfix num) if mv-list return-last))
   (((o-p (nfix num)))
    ((not (integerp num))
     (not (< '0 num))
     (o< (nfix (binary-+ '-1 (lnfix$inline num)))
         (nfix num))))
   (defind-prem-field-names 2 :system . "std/util/definductive"))
  ((justification (sv::n)
                  (nil o-p . o<)
  ...
  ((justification (x86isa::total-size)
   ...
   (x86isa::simd-mul-low-spec :system
                              .
                              "projects/x86isa/machine/instructions/pmul"))
   ...
   (((o-p (nfix x86isa::result-width)))
    ((not (integerp (nfix x86isa::result-width)))
     ...
     (o< (nfix (binary-+ (nfix x86isa::result-width)
         ...
         (nfix x86isa::result-width))))
   (x86isa::psll-spec 4 :system
                      .
                      "projects/x86isa/machine/instructions/pshift")
 ...
 ((justification (x)
  ...
  ((justification (x)
   ...
   (omap::identity :system . "std/omaps/identity")
  ...
  ((justification (omap::new)
   ...
   (omap::restrict-values :system . "std/omaps/restrict-values")
   (omap::inverse :system . "std/omaps/inverse")
   (omap::compose :system . "std/omaps/compose"))
  ((justification (vl2014::x)
                  (nil o-p . o<)
                  ((acl2-count vl2014::x)
                   if mv-list return-last))
  ...
  ((justification (deps)
                  ...
                  ((acl2-count deps)
                   if mv-list return-last))
   (((o-p (acl2-count deps)))
    ((set::emptyp$inline (symbol-sfix deps))
     (o< (acl2-count (set::tail$inline deps))
         (acl2-count deps))))
   (defind-pred-clique-loop 3 :system . "std/util/definductive"))
  ((justification (cliques-to-do)
                  (nil o-p . o<)
                  ((acl2-count cliques-to-do)
                   if mv-list return-last))
   (((o-p (acl2-count cliques-to-do)))
    ((set::emptyp$inline (symbol-set-set-fix cliques-to-do))
     (o< (acl2-count (set::tail$inline cliques-to-do))
         (acl2-count cliques-to-do))))
   (defind-order-cliques-round 3 :system . "std/util/definductive"))
  ((justification (term)
                  (nil o-p . o<)
                  ((acl2-count term)
                   if mv-list return-last))
   ...
   (((o-p (acl2-count x)))
    ...
    ((not (equal (fn-symb x) 'binary-+))
     (o< (acl2-count (arg2 x))
         (acl2-count x)))
    ((not (equal (fn-symb x) 'binary-+))
     (not (td-stub-2 (arg2 x) newp))
     (o< (acl2-count (arg1 x))
         (acl2-count x)))
    ((not (equal (fn-symb x) 'binary-*))
     (o< (acl2-count (arg2 x))
         (acl2-count x))))
   (factor-gather-exponents-info-list 2 :system
                                      . "arithmetic-5/lib/basic-ops/common"))
  ((justification (x)
                  (nil o-p . o<)
                  ((acl2-count x) if mv-list return-last))
   (((o-p (acl2-count x)))
    ...
    ((not (equal (fn-symb x) 'binary-*))
     (o< (acl2-count (arg2 x))
         (acl2-count x))))
   (factor-scatter-exponents-info-list 1 :system
                                       . "arithmetic-5/lib/basic-ops/common"))
 ...
 ((justification (thm)
  ...
  ((justification (fgl::vars)
   ...
   (((o-p (len fgl::vars)))
    ((not (consp fgl::vars))
     (not (consp (cdr (pseudo-var-list-fix$inline fgl::vars))))
     (o< (len (cdr (pseudo-var-list-fix$inline fgl::vars)))
         (len fgl::vars))))
 ...
 ((justification (cliques-to-do)
                 (nil o-p . o<)
                 ((set::cardinality$inline (symbol-set-set-fix cliques-to-do))
                  if mv-list return-last))
  ((justification (cliques-to-do)
                  (nil o-p . o<)
                  ((set::cardinality$inline (symbol-set-set-fix cliques-to-do))
                   if mv-list return-last))
   (((o-p (set::cardinality$inline (symbol-set-set-fix cliques-to-do))))
    ((set::emptyp$inline (symbol-set-set-fix cliques-to-do))
     (not (consp (mv-nth '0
                         (defind-order-cliques-round cliques-to-do available irule-infos))))
     (o< (set::cardinality$inline (symbol-set-set-fix (mv-nth '1
                                                              (defind-order-cliques-round cliques-to-do available irule-infos))))
         (set::cardinality$inline (symbol-set-set-fix cliques-to-do)))))
   (defind-order-cliques-loop 3 :system . "std/util/definductive")))
 ((justification (svl::lst svl::x svl::flag)
                 (nil o-p . o<)
