   ...
   (((O-P (ACL2-COUNT N)))
    ((NOT (INTEGERP N))
     ...
     (O< (ACL2-COUNT (ASH N '-1))
         (ACL2-COUNT N))))
   (STR::BASIC-NATCHARS2 1 :SYSTEM . "std/strings/binary")
   ...
   (((O-P (ACL2-COUNT N)))
    ((NOT (INTEGERP N))
     ...
     (O< (ACL2-COUNT (FLOOR N '10))
         (ACL2-COUNT N))))
   (STR::BASIC-NATCHARS 1 :SYSTEM . "std/strings/decimal")
   ...
   (((O-P (ACL2-COUNT N)))
    ((NOT (INTEGERP N))
     ...
     (O< (ACL2-COUNT (ASH N '-4))
         (ACL2-COUNT N))))
   (STR::BASIC-NATCHARS16 1 :SYSTEM . "std/strings/hex"))
  ((JUSTIFICATION (N)
                  (NIL O-P . O<)
                  ((ACL2-COUNT N) IF MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT N)))
    ((NOT (INTEGERP N))
     ...
     (O< (ACL2-COUNT (ASH N '-3))
         (ACL2-COUNT N))))
   (STR::BASIC-NATCHARS8 1 :SYSTEM . "std/strings/octal"))
  ((JUSTIFICATION (X)
                  (NIL O-P . O<)
                  ((ACL2-COUNT X) IF MV-LIST RETURN-LAST))
   (((O-P (ACL2-COUNT X)))
