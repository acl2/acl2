...
(STRICT-MERGE-SORT-< (30 15 (:REWRITE DEFAULT-+-2))
                     ...
                     (4 2 (:REWRITE DEFAULT-<-2))
                     (4 2 (:REWRITE DEFAULT-<-1)))
(RATIONAL-LISTP-EVENS (24 21 (:REWRITE DEFAULT-CDR))
...
(RATIONAL-LISTP-STRICT-MERGE-SORT-<
     ...
     (18 2
         (:REWRITE RATIONAL-LISTP-STRICT-MERGE-<))
     (16 16
         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (16 16 (:DEFINITION REVAPPEND))
     (16 8 (:REWRITE DEFAULT-<-2))
     (16 8 (:REWRITE DEFAULT-<-1)))
(STRICT-MERGE-SORT-< (40 1 (:DEFINITION STRICT-MERGE-SORT-<))
