...
(APT::CASESPLIT-GEN-NEW-FN-BODY
 ...
 (405 22 (:DEFINITION SYMBOL-LISTP))
 (352 40 (:REWRITE SUBSETP-IMPLIES-SUBSETP-CDR))
 (348 17 (:REWRITE PSEUDO-TERM-LISTP-WHEN-SYMBOL-LISTP))
...
(APT::PSEUDO-TERMP-OF-CASESPLIT-GEN-NEW-FN-BODY
 ...
 (2841 19 (:REWRITE PSEUDO-TERMP-OF-CAR-WHEN-PSEUDO-TERM-LISTP))
 (2734 136 (:DEFINITION SYMBOL-LISTP))
 (2527 57 (:REWRITE PSEUDO-TERM-LISTP-OF-CDR-WHEN-PSEUDO-TERM-LISTP))
 (1959 114 (:REWRITE PSEUDO-TERM-LISTP-WHEN-SYMBOL-LISTP))
 ...
 (432 19 (:REWRITE SYMBOLP-OF-CAAR-WHEN-SYMBOL-TRUELIST-ALISTP))
 (432 19 (:REWRITE SYMBOLP-OF-CAAR-WHEN-SYMBOL-SYMBOL-ALISTP))
 (320 20 (:DEFINITION NTH))
 (264 12 (:REWRITE SUBSETP-OF-CONS))
 ...
 (186 19 (:REWRITE SYMBOL-TRUELIST-ALISTP-OF-CDR-WHEN-SYMBOL-TRUELIST-ALISTP))
 (186 19 (:REWRITE SYMBOL-SYMBOL-ALISTP-OF-CDR-WHEN-SYMBOL-SYMBOL-ALISTP))
