...
(defsection tailrec-implementation
  ...
  "<p>
   ...
   <ul>
     ...
     generated by @(tsee tailrec-alpha-intro-event).
     </li>
     <li>
...
(define tailrec-domain-of-old-intro-event
  ((old$ symbolp)
   ...
   (wrld plist-worldp))
  :returns (mv (domain-of-old-event "A @(tsee pseudo-event-formp).")
               (domain-of-old-name "A @(tsee symbolp) that names the theorem."))
  :mode :program
...
(define tailrec-new-to-old-intro-event ((old$ symbolp)
                                        ...
                                        (wrld plist-worldp))
  :returns (mv (new-to-old-event "A @(tsee pseudo-event-formp).")
               (new-to-old-name "A @(tsee symbolp) that names the theorem."))
  :mode :program
...
(define tailrec-alpha-intro-event ((old$ symbolp)
                                   (test pseudo-termp)
                                   (updates pseudo-term-listp)
                                   (names-to-avoid symbol-listp)
                                   (wrld plist-worldp))
  :returns (mv (alpha-event "A @(tsee pseudo-event-formp).")
               (alpha-name "A @(tsee symbolp)."))
  :mode :program
...
(define tailrec-alpha-component-terms ((alpha-name symbolp)
                                       (old$ symbolp)
                                       (wrld plist-worldp))
  ...
  (b* ((formals (formals old$ wrld))
       (n (len formals)))
    (tailrec-alpha-component-terms-aux n alpha-name formals nil))
...
(define tailrec-test-of-alpha-intro-event ((old$ symbolp)
                                           ...
                                           (names-to-avoid symbol-listp)
                                           (wrld plist-worldp))
  :returns (mv (test-of-alpha-event "A @(tsee pseudo-event-formp).")
               (test-of-alpha-name "A @(tsee symbolp) that names the theorem."))
  :mode :program
  :short "Event form for the theorem asserting that
  ...
  (b* ((name (fresh-name-in-world-with-$s 'test-of-alpha names-to-avoid wrld))
       (formals (formals old$ wrld))
       (alpha-component-terms (tailrec-alpha-component-terms alpha-name
                                                             old$
                                                             wrld))
...
(define tailrec-old-guard-of-alpha-intro-event ((old$ symbolp)
                                                ...
                                                (names-to-avoid symbol-listp)
                                                (wrld plist-worldp))
  :returns (mv (old-guard-of-alpha-event "A @(tsee pseudo-event-formp).")
               (old-guard-of-alpha-name "A @(tsee symbolp)
...
(define tailrec-domain-of-ground-base-intro-event
  ((old$ symbolp)
   ...
   (names-to-avoid symbol-listp)
   (wrld plist-worldp))
  :returns (mv (domain-of-ground-base-event "A @(tsee pseudo-event-formp).")
               (domain-of-ground-base-name "A @(tsee symbolp)
                                            that names the theorem."))
  :mode :program
  :short "Event form for the theorem asserting that
  ...
  (b* ((name (fresh-name-in-world-with-$s 'domain-of-ground-base
       ...
       (domain-of-base-thm
        (cdr (assoc-eq :domain-of-base app-cond-thm-names)))
       (formals (formals old$ wrld))
       (alpha-comps (tailrec-alpha-component-terms alpha-name
                                                   old$
                                                   wrld))
       (hints `(("Goal"
                 :in-theory nil
...
(define tailrec-combine-left-identity-ground-intro-event
  ((old$ symbolp)
   ...
   (names-to-avoid symbol-listp)
   (wrld plist-worldp))
  :returns (mv (combine-left-identity-ground-event
...
(define tailrec-base-guard-intro-event
  ((old$ symbolp)
   ...
   (names-to-avoid symbol-listp)
   state)
  :returns (mv (base-guard-event "A @(tsee pseudo-event-formp).")
               (base-guard-name "A @(tsee symbolp) that names the theorem."))
  :mode :program
  :short "Event form for the theorem asserting that
...
(define tailrec-old-to-new-intro-event
  ((old$ symbolp)
   ...
   (wrld plist-worldp))
  :returns (mv (old-to-new-event "A @(tsee pseudo-event-formp).")
               (old-to-new-name "A @(tsee symbolp) that names the theorem."))
  :mode :program
...
(define tailrec-event ((old$ symbolp)
  ...
  (b* ((wrld (w state))
       ...
       ((mv domain-of-old-event
            domain-of-old-name) (tailrec-domain-of-old-intro-event
       ...
       ((mv new-fn-local-event
            ...
            new-formals) (tailrec-new-fn-intro-events
                          old$
       ...
       ((mv new-to-old-event
            new-to-old-name) (tailrec-new-to-old-intro-event
       ...
       (names-to-avoid (if (and gen-alpha
                         ...
                         names-to-avoid))
       ((mv old-to-new-event
            old-to-new-name) (tailrec-old-to-new-intro-event
