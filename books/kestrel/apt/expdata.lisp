...
(define expdata-process-old-to-new-name (old-to-new-name
...
(define expdata-process-old-to-new-enable
  (old-to-new-enable
...
(define expdata-process-new-to-old-name (new-to-old-name
...
(define expdata-process-new-to-old-enable
  (new-to-old-enable
...
(define expdata-process-inputs (old
  ...
  (b* ((wrld (w state))
       ...
       ((er (list old-to-new$ names-to-avoid))
        (expdata-process-old-to-new-name old-to-new-name
       ...
       ((er (list new-to-old$ names-to-avoid))
        (expdata-process-new-to-old-name new-to-old-name
       ...
       ((er new-enable$) (ensure-boolean-or-auto-and-return-boolean$
                          ...
                          t nil))
       ((er old-to-new-enable$) (expdata-process-old-to-new-enable
                                 old-to-new-enable
                                 old-to-new-enable-suppliedp
                                 ctx
                                 state))
       ((er new-to-old-enable$) (expdata-process-new-to-old-enable
                                 new-to-old-enable
...
(define expdata-gen-new-to-old-thm
  ...
  (b* ((macro (theorem-intro-macro new-to-old-enable$))
       (formula (expdata-gen-new-to-old-thm-formula old$
                                                    arg-surjmaps
                                                    res-surjmaps
                                                    new$
                                                    wrld))
...
(define expdata-gen-old-to-new-thm
  ...
  (b* ((macro (theorem-intro-macro old-to-new-enable$))
       (formula (expdata-gen-old-to-new-thm-formula
                 old$ arg-surjmaps res-surjmaps new$ wrld))
       (formula (untranslate formula t wrld))
...
(define expdata-gen-newp-of-new-thm
  ...
  (b* ((macro (theorem-intro-macro newp-of-new-enable$))
       (formula (expdata-gen-newp-of-new-thm-formula old$
                                                     arg-surjmaps
                                                     res-surjmaps
                                                     new$
                                                     wrld))
