...
(APT::AUGMENT-TERM
 ...
 (2905 126 (:REWRITE SYMBOLP-OF-CAAR-WHEN-SYMBOL-TRUELIST-ALISTP))
 (2675 2675 (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-SYMBOL-TRUELIST-ALISTP . 2))
 (2675 2675 (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-SYMBOL-TRUELIST-ALISTP . 1))
 (2675 2675 (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-SYMBOL-SYMBOL-ALISTP . 2))
 (2675 2675 (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-SYMBOL-SYMBOL-ALISTP . 1))
 (2669 126 (:REWRITE SYMBOLP-OF-CAAR-WHEN-SYMBOL-SYMBOL-ALISTP))
 (2374 286 (:REWRITE SYMBOL-TRUELIST-ALISTP-OF-CDR-WHEN-SYMBOL-TRUELIST-ALISTP))
 (2024 506 (:DEFINITION INTEGER-ABS))
 (1703 129 (:REWRITE TRUE-LISTP-OF-CDAR-WHEN-SYMBOL-TRUELIST-ALISTP))
 (1409 181 (:REWRITE SYMBOL-SYMBOL-ALISTP-OF-CDR-WHEN-SYMBOL-SYMBOL-ALISTP))
 (1301 541 (:REWRITE SYMBOL-TRUELIST-ALISTP-WHEN-NOT-CONSP))
 (1082 1082 (:REWRITE SYMBOL-TRUELIST-ALISTP-WHEN-SUBSETP-EQUAL))
 ...
 (839 307 (:REWRITE SYMBOL-SYMBOL-ALISTP-WHEN-NOT-CONSP))
 (796 624 (:REWRITE DEFAULT-<-2))
 (708 624 (:REWRITE DEFAULT-<-1))
 (656 328 (:REWRITE STR::COERCE-TO-LIST-REMOVAL))
 (616 616 (:REWRITE TRUE-LISTP-OF-CDR-WHEN-MEMBER-EQUAL-OF-SYMBOL-TRUELIST-ALISTP))
 (614 614 (:REWRITE SYMBOL-SYMBOL-ALISTP-WHEN-SUBSETP-EQUAL))
 (506 506 (:REWRITE DEFAULT-UNARY-MINUS))
 (505 505 (:TYPE-PRESCRIPTION SET::EMPTY-TYPE))
 (505 505 (:REWRITE TRUE-LISTP-WHEN-THEOREM-SYMBOL-LISTP))
 (505 505 (:REWRITE TRUE-LISTP-WHEN-TERMFN-LISTP))
 (505 505 (:REWRITE TRUE-LISTP-WHEN-MACRO-SYMBOL-LISTP))
 (505 505 (:REWRITE TRUE-LISTP-WHEN-LAMBDA-LISTP))
 ...
 (283 283 (:REWRITE TERMP-IMPLIES-PSEUDO-TERMP))
