...
(define isodata-process-inputs (old
  ...
  (b* ((wrld (w state))
       ...
       ((er thm-name$) (if thm-name-suppliedp
                           (isodata-process-thm-name
                            thm-name old$ new-name$ ctx state)
                         (value nil)))
       ((er (list old-to-new$ &)) (isodata-process-old-to-new old-to-new
                                                              old$
                                                              new-name$
                                                              (list new-name$)
                                                              ctx
                                                              state))
       (thm-name$ (or thm-name$ old-to-new$))
       ((er (list new-to-old$ &)) (isodata-process-new-to-old new-to-old
                                                              old$
                                                              new-name$
                                                              (list new-name$
                                                                    thm-name$)
       ...
       (names-to-avoid (list new-name$ thm-name$ new-to-old$))
       ((er (list arg-isomaps res-isomaps names-to-avoid))
...
(define isodata-gen-all-back-guard-instances-to-mv-nth
  ...
  (b* (((when (endp rec-calls)) nil)
       ...
       (forth-updates-back (isodata-gen-forth-of-terms updates-back
                                                       arg-isomaps))
       (new-forth-updates-back (fcons-term new-name$ forth-updates-back))
       (instances (isodata-gen-back-guard-instances-to-mv-nth
                   new-forth-updates-back res-isomaps wrld))
       (more-instances
        (isodata-gen-all-back-guard-instances-to-mv-nth
         old$ (cdr rec-calls) arg-isomaps res-isomaps new-name$ wrld)))
    (append instances more-instances)))
...
(defsection isodata-macro-definition
  ...
  (defmacro isodata (&whole
                     ...
                     (new-name ':auto)
                     (new-enable ':auto)
                     (thm-name ':auto thm-name-suppliedp)
                     (thm-enable 't)
                     (old-to-new 'nil)
                     (new-to-old 'nil)
                     (verify-guards ':auto)
