...
(define add-int20 ((y int20) (x int20))
  :returns (z int20 :hyp :guard
...
(apt::propagate-iso (int10-iso-int20 int10-list-p-iso-int20-list-p)
  ((add-int10 (lambda (x y) (add-int20 y x))
              add-int10-->add-int20 add-int20-->add-int10
              (int10 int10) => int10))
  :first-event add-int10-comm
  :last-event int10-list-p-of-map-double-int10
  :hints-map ((triple-int20-is-iso-triple-int10 (enable add-int20-comm))))
...
(must-be-redundant
 (defthmd add-int20-comm
   (implies (and (int20 x) (int20 y))
            (equal (add-int20 y x) (add-int20 x y)))
 ...
 (defun triple-int20 (x) (declare (xargs :guard (int20 x))) (add-int20 (double-int20 x) x))
