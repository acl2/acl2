...
(APT::SYMBOLP-OF-PARTEVAL-PROCESS-OLD.OLD$
 (21 21
     (:REWRITE RETURN-TYPE-OF-ENSURE-FUNCTION-NAME-OR-NUMBERED-WILDCARD.ERP))
 (20 20
     (:REWRITE RETURN-TYPE-OF-ENSURE-FUNCTION-IS-LOGIC-MODE.ERP))
 (18 18
     (:REWRITE RETURN-TYPE-OF-ENSURE-FUNCTION-IS-DEFINED.ERP))
 (16 16
     (:REWRITE RETURN-TYPE-OF-ENSURE-FUNCTION-NUMBER-OF-RESULTS.ERP))
 (14 14
     (:REWRITE RETURN-TYPE-OF-ENSURE-FUNCTION-NO-STOBJS.ERP))
 (8 8
...
(APT::PARTEVAL-TRANSFORM-REC-ARGS (30 8 (:TYPE-PRESCRIPTION BINARY-APPEND)))
