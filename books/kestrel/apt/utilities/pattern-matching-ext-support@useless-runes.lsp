(DROP-FORMALS (5 5 (:REWRITE DEFAULT-CAR))
              (3 3 (:REWRITE DEFAULT-CDR)))
(SYMBOL-LISTP-REVAPPEND (26 20 (:REWRITE DEFAULT-CAR))
...
(TRUE-LISTP-REVAPPEND (21 15 (:REWRITE DEFAULT-CDR))
                      (3 3 (:REWRITE DEFAULT-CAR)))
(TRUE-LISTP-MV-NTH-1-DROP-FORMALS (27 9 (:DEFINITION REVAPPEND))
...
(STEP-2-LEMMA (275 33 (:DEFINITION LENGTH))
...
(SYMBOL-LISTP-ALL-VARS1 (20 4 (:DEFINITION LEN))
...
(LEN-REVAPPEND (50 24 (:REWRITE DEFAULT-+-2))
               ...
               (3 3 (:REWRITE DEFAULT-CAR)))
(DROP-FORMALS-PRESERVES-EQUAL-LEN (112 16 (:REWRITE DEFAULT-COERCE-3))
...
(DROP-FORMALS-PRESERVES-EQUAL-LEN-0 (45 9 (:DEFINITION ALL-VARS1))
                                    (22 4 (:DEFINITION LEN))
...
(EXT-PREPROCESS-PAT
     ...
     (1 1
        (:TYPE-PRESCRIPTION EXT-PREPROCESS-PAT)))
(EXT-GENEQV-AT-SUBTERM)
(PAT-VAR-P (14 2 (:DEFINITION LEN))
...
(NON-PAT-VARS1)
(PAT-UNIFY-SUBST)
(EQUAL-MOD-PATVARS (248 216 (:REWRITE DEFAULT-CAR))
...
(EXT-ONE-WAY-UNIFY1-SIMPLE
     ...
     (326 326
          (:TYPE-PRESCRIPTION EXT-PREPROCESS-PAT-GUARD-HELPER))
...
(EXTEND-BINDINGS (1890 9 (:DEFINITION SUBLIS-VAR1))
                 (891 9 (:DEFINITION CONS-TERM))
                 (837 9 (:DEFINITION CONS-TERM1-MV2))
                 (828 9 (:DEFINITION CONS-TERM1))
                 (558 558 (:DEFINITION KWOTE))
...
(SYMBOL-ALISTP-APPEND (54 48 (:REWRITE DEFAULT-CAR))
                      (20 10
                          (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
...
(PSEUDO-TERMP-SUBLIS-VAR
     ...
     (10 2
         (:REWRITE PSEUDO-TERM-LISTP-IMPLIES-PSEUDO-TERMP-CAR))
...
(PSEUDO-TERM-LISTP-STRIP-CDRS-EXTEND-BINDINGS
     ...
     (8 8 (:REWRITE DEFAULT-*-2))
     (8 8 (:REWRITE DEFAULT-*-1)))
(SYMBOL-ALISTP-EXTEND-BINDINGS (39 37 (:REWRITE DEFAULT-CAR))
...
(EXT-ADDRESS-SUBTERM-GOVERNORS-LST2
     ...
     (27 3
         (:DEFINITION EXT-ADDRESS-SUBTERM-GOVERNORS-LST2-LST))
     (14 14
         (:TYPE-PRESCRIPTION EXTEND-BINDINGS)))
(EXT-ADDRESS-SUBTERM-GOVERNORS-LST1
     ...
     (96 96
         (:TYPE-PRESCRIPTION EQUAL-MOD-PATVARS))
