(ALIST-FOR-KEYS (204 178 (:REWRITE DEFAULT-CAR))
...
(ELABORATE-MUT-REC-OPTION-MAP
     (772 2
          (:DEFINITION ELABORATE-MUT-REC-OPTION-MAP))
...
(ELABORATE-MUT-REC-MAP-OPTION (6 4 (:REWRITE DEFAULT-CAR))
