...
(PARSE-INT-CHAR)
(PARSE-INT-CHARS
 (306 153 (:REWRITE NOT-MEMBER-EQUAL-WHEN-NOT-MEMBER-EQUAL-OF-CDR-CHEAP))
 (306 153 (:REWRITE MEMBER-EQUAL-WHEN-MEMBER-EQUAL-OF-CDR-CHEAP))
 (164 164 (:REWRITE DEFAULT-CAR))
 (153 153 (:REWRITE MEMBER-EQUAL-WHEN-NOT-CONSP-CHEAP))
...
(ALL-NUMERIC-CHARP-LEADING-NUMERIC-CHARS
 ...
 (20 10 (:REWRITE MEMBER-EQUAL-OF-SINGLETON-CONSTANT-IFF))
...
(NUMERIC-SUFFIX-OF-NAME-AUX
 (560 4 (:DEFINITION LEADING-NUMERIC-CHARS))
...
(NOT-EQUAL-OF-QUOTE-AND-INCREMENT-NAME-SUFFIX-SAFE
 (140 1 (:DEFINITION LEADING-NUMERIC-CHARS))
 (83 3 (:DEFINITION NTH))
...
(SYMBOL-LISTP-OF-INCREMENT-NAME-SUFFIXES-SAFE
 (420 3 (:DEFINITION LEADING-NUMERIC-CHARS))
...
(PICK-NEW-NAME)
(PICK-NEW-NAMES
 (980 7 (:DEFINITION LEADING-NUMERIC-CHARS))
 ...
 (105 7 (:DEFINITION NUMERIC-CHARP))
