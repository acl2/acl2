...
(must-be-redundant
  ...
  (defun double-int20 (x)
    (declare (xargs :guard (int20 x)))
    (add-int20 x x))
  ...
  (defthm int20-of-double-int20
    (implies (int20 x)
             (let ((z (double-int20 x))) (int20 z)))
    :rule-classes ((:rewrite)))
  (encapsulate
      nil
    (defun triple-int20 (x)
      (declare (xargs :guard (int20 x)))
      (add-int20 x (double-int20 x)))
  ...
  (defthm int20-of-triple-int20
    (implies (int20 x)
             (let ((z (triple-int20 x))) (int20 z)))
    :rule-classes ((:rewrite)))
  ...
  (defun int10-list-p-->-int20-list-p (l)
    (declare (xargs :guard (int10-list-p l)
                    :guard-hints (("Goal" :in-theory (enable int10-list-p)))
                    :hints (("Goal" :in-theory (enable int10-list-p)))))
    (if (or (not (mbt (int10-list-p l)))
            (atom l))
        nil
      (cons (int10-to-int20 (car l))
            (int10-list-p-->-int20-list-p (cdr l)))))
  (defun int20-list-p-->-int10-list-p (l)
    (declare (xargs :guard (int20-list-p l)
                    :guard-hints (("Goal" :in-theory (enable int20-list-p)))
                    :hints (("Goal" :in-theory (enable int20-list-p)))))
    (if (or (not (mbt (int20-list-p l)))
            (atom l))
        nil
      (cons (int20-to-int10 (car l))
            (int20-list-p-->-int10-list-p (cdr l)))))
  ...
  (defthm int10-list-p-->-int20-list-p-null
    ...
    :hints (("Goal" :in-theory (enable int10-list-p
                                       int10-list-p-->-int20-list-p))))
  (defthm int10-list-p-->-int20-list-p--consp
    (implies (and (int10-list-p l) (not (atom l)))
             (consp (int10-list-p-->-int20-list-p l)))
    :hints (("Goal" :in-theory (enable int10-list-p
                                       int10-list-p-->-int20-list-p))))
  (defthm int10-list-p-->-int20-list-p-int20-car
    (implies (and (int10-list-p l) (not (atom l)))
             (int20 (car (int10-list-p-->-int20-list-p l))))
    :hints (("Goal" :in-theory (enable int10-list-p
                                       int10-list-p-->-int20-list-p))))
  (defthm int10-list-p-->-int20-list-p-int20-list-p-cdr
    (implies (and (int10-list-p l) (not (atom l)))
             (int20-list-p (cdr (int10-list-p-->-int20-list-p l))))
    :hints (("Goal" :in-theory (enable int10-list-p
                                       int10-list-p-->-int20-list-p))))
  (defthm int20-list-p-->-int10-list-p-null
    ...
    :hints (("Goal" :in-theory (enable int20-list-p
                                       int20-list-p-->-int10-list-p))))
  (defthm int20-list-p-->-int10-list-p--consp
    (implies (and (int20-list-p l) (not (atom l)))
             (consp (int20-list-p-->-int10-list-p l)))
    :hints (("Goal" :in-theory (enable int20-list-p
                                       int20-list-p-->-int10-list-p))))
  (defthm int20-list-p-->-int10-list-p-int10-car
    (implies (and (int20-list-p l) (not (atom l)))
             (int10 (car (int20-list-p-->-int10-list-p l))))
    :hints (("Goal" :in-theory (enable int20-list-p
                                       int20-list-p-->-int10-list-p))))
  (defthm int20-list-p-->-int10-list-p-int10-list-p-cdr
    (implies (and (int20-list-p l) (not (atom l)))
             (int10-list-p (cdr (int20-list-p-->-int10-list-p l))))
    :hints (("Goal" :in-theory (enable int20-list-p
                                       int20-list-p-->-int10-list-p))))
  ...
  (defthm int20-list-p-of-revappend
    ...
    :rule-classes ((:rewrite)))
  (defthm int20-list-p-of-cdr
    (implies (int20-list-p l)
             (equal (int20-list-p (cdr l)) t))
    :rule-classes ((:rewrite)))
  ...
  (defthm int20-list-p-of-take
    ...
    :rule-classes ((:rewrite)))
  (defthmd true-listp-when-int20-list-p
    (implies (int20-list-p l)
             (true-listp l))
    :rule-classes ((:rewrite)))
  ...
  (defthm int20-list-p-of-true-list-fix
    ...
    :rule-classes ((:rewrite)))
  (defthm use-int20-list-p
    (implies (and (int20-list-p free-l)
                  (memberp x free-l))
             (int20 x))
    :rule-classes ((:rewrite)))
  ...
  (defthm map-double-int20-of-nil
    (equal (map-double-int20 nil) nil)
    :rule-classes ((:rewrite)))
  ...
  (defthm cdr-of-map-double-int20
    (equal (cdr (map-double-int20 l))
           (map-double-int20 (cdr l)))
    :rule-classes ((:rewrite)))
  (defthm len-of-map-double-int20
    (equal (len (map-double-int20 l))
  ...
  (defthm consp-of-map-double-int20
    (equal (consp (map-double-int20 l))
           (consp (double-rewrite l)))
    :rule-classes ((:rewrite)))
  (defthm map-double-int20-iff
    (iff (map-double-int20 l)
         (consp (double-rewrite l)))
    :rule-classes ((:rewrite)))
  (defthm true-listp-of-map-double-int20
    (equal (true-listp (map-double-int20 l))
           t)
    :rule-classes ((:rewrite)))
  ...
  (encapsulate
    ...
    (defun int20* (x)
      ...
      (or (null x) (int20 x)))
    (defun int10*-->-int20* (x)
      (declare (xargs :guard (int10* x)
                      :guard-hints (("Goal" :in-theory (enable int10*)))))
      (if (null x) nil (int10-to-int20 x)))
    (defun int20*-->-int10* (x)
      (declare (xargs :guard (int20* x)
                      :guard-hints (("Goal" :in-theory (enable int20*)))))
      (if (null x) nil (int20-to-int10 x)))
    ...
    (defthm int10*-->-int20*-null
      (implies (and (int10* x) (null x))
               (null (int10*-->-int20* x)))
      :hints (("Goal" :in-theory (enable int10* int10*-->-int20*))))
    (defthm int10*-->-int20*-int20
      (implies (and (int10* x) (not (null x)))
               (int20 (int10*-->-int20* x)))
      :hints (("Goal" :in-theory (enable int10* int10*-->-int20*))))
    (defthm int20*-->-int10*-null
      (implies (and (int20* x) (null x))
               (null (int20*-->-int10* x)))
      :hints (("Goal" :in-theory (enable int20* int20*-->-int10*))))
    (defthm int20*-->-int10*-int10
      (implies (and (int20* x) (not (null x)))
               (int10 (int20*-->-int10* x)))
      :hints (("Goal" :in-theory (enable int20* int20*-->-int10*)))))
  (defthm booleanp-of-int20*
    (let ((b (int20* x))) (booleanp b))
    :rule-classes ((:rewrite)))
  (encapsulate
      nil
    (defun pair-int20-bool-p (pr)
      (declare (xargs :guard t))
      (and (consp pr)
           (int20 (car pr))
           (booleanp (cdr pr))))
    ...
    (defthm pair-int10-bool-p-->-pair-int20-bool-p-consp
      ...
      :hints (("Goal" :in-theory (enable pair-int10-bool-p
                                         pair-int10-bool-p-->-pair-int20-bool-p))))
    (defthm pair-int10-bool-p-->-pair-int20-bool-p--consp
      (implies (and (pair-int10-bool-p pr))
               (consp (pair-int10-bool-p-->-pair-int20-bool-p pr)))
    ...
    (defthm pair-int20-bool-p-->-pair-int10-bool-p-consp
      ...
      :hints (("Goal" :in-theory (enable pair-int20-bool-p
                                         pair-int20-bool-p-->-pair-int10-bool-p))))
    (defthm pair-int20-bool-p-->-pair-int10-bool-p--consp
      (implies (and (pair-int20-bool-p pr))
               (consp (pair-int20-bool-p-->-pair-int10-bool-p pr)))
    ...
    (defthm pair-int20-bool-p-->-pair-int10-bool-p-booleanp-cdr
      ...
      :hints (("Goal" :in-theory (enable pair-int20-bool-p
                                         pair-int20-bool-p-->-pair-int10-bool-p)))))
  (defthm booleanp-of-pair-int20-bool-p
    (let ((v (pair-int20-bool-p pr)))
      (booleanp v))
    :rule-classes ((:rewrite)))
  (encapsulate
      nil
    (defun pair-int20-bool->val (pr)
      (declare (xargs :guard (pair-int20-bool-p pr)))
      (car pr))
  ...
  (encapsulate
    ...
    ;; Add these back once we get rid of conds
    (defun pair-int10-bool-listp-->-pair-int20-bool-listp (l)
      (declare (xargs :guard (pair-int10-bool-listp l)
                      :guard-hints (("Goal" :in-theory (enable pair-int10-bool-listp)))
                      :hints (("Goal" :in-theory (enable pair-int10-bool-listp)))))
      (if (or (not (mbt (pair-int10-bool-listp l)))
              (atom l))
          nil
        (cons (pair-int10-bool-p-->-pair-int20-bool-p (car l))
              (pair-int10-bool-listp-->-pair-int20-bool-listp (cdr l)))))
    (defun pair-int20-bool-listp-->-pair-int10-bool-listp (l)
      (declare (xargs :guard (pair-int20-bool-listp l)
                      :guard-hints (("Goal" :in-theory (enable pair-int20-bool-listp)))
                      :hints (("Goal" :in-theory (enable pair-int20-bool-listp)))))
      (if (or (not (mbt (pair-int20-bool-listp l)))
              (atom l))
          nil
        (cons (pair-int20-bool-p-->-pair-int10-bool-p (car l))
              (pair-int20-bool-listp-->-pair-int10-bool-listp (cdr l)))))
    (defiso
    ...
    (defthm pair-int10-bool-listp-->-pair-int20-bool-listp-null
      ...
      :hints (("Goal" :in-theory (enable pair-int10-bool-listp
                                         pair-int10-bool-listp-->-pair-int20-bool-listp))))
    (defthm pair-int10-bool-listp-->-pair-int20-bool-listp--consp
      (implies (and (pair-int10-bool-listp l)
                    (not (atom l)))
               (consp (pair-int10-bool-listp-->-pair-int20-bool-listp l)))
      :hints (("Goal" :in-theory (enable pair-int10-bool-listp
                                         pair-int10-bool-listp-->-pair-int20-bool-listp))))
    (defthm pair-int10-bool-listp-->-pair-int20-bool-listp-pair-int20-bool-p-car
      (implies (and (pair-int10-bool-listp l)
                    (not (atom l)))
               (pair-int20-bool-p (car (pair-int10-bool-listp-->-pair-int20-bool-listp l))))
      :hints (("Goal" :in-theory (enable pair-int10-bool-listp
                                         pair-int10-bool-listp-->-pair-int20-bool-listp))))
    (defthm pair-int10-bool-listp-->-pair-int20-bool-listp-pair-int20-bool-listp-cdr
      (implies (and (pair-int10-bool-listp l)
                    (not (atom l)))
               (pair-int20-bool-listp (cdr (pair-int10-bool-listp-->-pair-int20-bool-listp l))))
      :hints (("Goal" :in-theory (enable pair-int10-bool-listp
                                         pair-int10-bool-listp-->-pair-int20-bool-listp))))
    (defthm pair-int20-bool-listp-->-pair-int10-bool-listp-null
      ...
      :hints (("Goal" :in-theory (enable pair-int20-bool-listp
                                         pair-int20-bool-listp-->-pair-int10-bool-listp))))
    (defthm pair-int20-bool-listp-->-pair-int10-bool-listp--consp
      (implies (and (pair-int20-bool-listp l)
                    (not (atom l)))
               (consp (pair-int20-bool-listp-->-pair-int10-bool-listp l)))
      :hints (("Goal" :in-theory (enable pair-int20-bool-listp
                                         pair-int20-bool-listp-->-pair-int10-bool-listp))))
    (defthm pair-int20-bool-listp-->-pair-int10-bool-listp-pair-int10-bool-p-car
      (implies (and (pair-int20-bool-listp l)
                    (not (atom l)))
               (pair-int10-bool-p (car (pair-int20-bool-listp-->-pair-int10-bool-listp l))))
      :hints (("Goal" :in-theory (enable pair-int20-bool-listp
                                         pair-int20-bool-listp-->-pair-int10-bool-listp))))
    (defthm pair-int20-bool-listp-->-pair-int10-bool-listp-pair-int10-bool-listp-cdr
      (implies (and (pair-int20-bool-listp l)
                    (not (atom l)))
               (pair-int10-bool-listp (cdr (pair-int20-bool-listp-->-pair-int10-bool-listp l))))
      :hints (("Goal" :in-theory (enable pair-int20-bool-listp
                                         pair-int20-bool-listp-->-pair-int10-bool-listp)))))
  ...
  (encapsulate
      ...
      (if (atom l)
        ...
        (let ((rl (filter-double$1 (cdr l)))
          ...
          (if (pair-int20-bool->flag pr)
            ...
            rl))))
    (defthmd filter-double$1-is-iso-filter-double
    ...
    (defthm filter-double-is-iso-filter-double$1
      (implies
        (force (pair-int10-bool-listp l))
  ...
  (encapsulate
    ...
    (defun int10-map-p-->-int20-map-p (m)
      (declare (xargs :guard (int10-map-p m)
                      :guard-hints (("Goal" :in-theory (enable int10-map-p)))
                      :hints (("Goal" :in-theory (enable int10-map-p)))))
      (if (or (not (mbt (int10-map-p m)))
              (atom m))
          nil
        (cons (cons (int10-to-int20 (car (car m)))
                    (int10-to-int20 (cdr (car m))))
              (int10-map-p-->-int20-map-p (cdr m)))))
    (defun int20-map-p-->-int10-map-p (m)
      (declare (xargs :guard (int20-map-p m)
                      :guard-hints (("Goal" :in-theory (enable int20-map-p)))
                      :hints (("Goal" :in-theory (enable int20-map-p)))))
      (if (or (not (mbt (int20-map-p m)))
              (atom m))
          nil
        (cons (cons (int20-to-int10 (car (car m)))
                    (int20-to-int10 (cdr (car m))))
    ...
    (defiso int10-map-p-iso-int20-map-p int10-map-p
      ...
      :hints (:beta-of-alpha (("Goal" :in-theory (enable int10-map-p
              ...
              :beta-image (("Goal" :in-theory (enable int10-map-p int20-map-p
                                                      int20-map-p-->-int10-map-p)))))
    (defthm int10-map-p-->-int20-map-p-null
      (implies (and (int10-map-p m) (atom m))
               (null (int10-map-p-->-int20-map-p m)))
      :hints (("Goal" :in-theory (enable int10-map-p
                                         int10-map-p-->-int20-map-p))))
    (defthm int10-map-p-->-int20-map-p--consp
    ...
    (defthm int10-map-p-->-int20-map-p--consp
      ...
      :hints (("Goal" :in-theory (enable int10-map-p
                                         int10-map-p-->-int20-map-p))))
    (defthm int10-map-p-->-int20-map-p-consp-car ; !! int10-map-p-->-int20-map-p-int20--consp-car
      (implies (and (int10-map-p m) (not (atom m)))
               (consp (car (int10-map-p-->-int20-map-p m))))
      :hints (("Goal" :in-theory (enable int10-map-p
                                         int10-map-p-->-int20-map-p))))
    (defthm int10-map-p-->-int20-map-p-int20-car-car
      (implies (and (int10-map-p m) (not (atom m)))
               (int20 (car (car (int10-map-p-->-int20-map-p m)))))
      :hints (("Goal" :in-theory (enable int10-map-p
                                         int10-map-p-->-int20-map-p))))
    (defthm int10-map-p-->-int20-map-p--consp
      (implies (and (int10-map-p m) (not (atom m)))
      ...
      :hints (("Goal" :in-theory (enable int10-map-p
                                         int10-map-p-->-int20-map-p))))
    (defthm int10-map-p-->-int20-map-p-int20-cdr-car
      (implies (and (int10-map-p m) (not (atom m)))
               (int20 (cdr (car (int10-map-p-->-int20-map-p m)))))
      :hints (("Goal" :in-theory (enable int10-map-p
                                         int10-map-p-->-int20-map-p))))
    (defthm int10-map-p-->-int20-map-p-int20-map-p-cdr
      ...
      :hints (("Goal" :in-theory (enable int10-map-p
                                         int10-map-p-->-int20-map-p))))
    (defthm int20-map-p-->-int10-map-p-null
      (implies (and (int20-map-p m) (atom m))
               (null (int20-map-p-->-int10-map-p m)))
      :hints (("Goal" :in-theory (enable int20-map-p
                                         int20-map-p-->-int10-map-p))))
    (defthm int20-map-p-->-int10-map-p--consp
    ...
    (defthm int20-map-p-->-int10-map-p--consp-car
      ...
      :hints (("Goal" :in-theory (enable int20-map-p
                                         int20-map-p-->-int10-map-p))))
    (defthm int20-map-p-->-int10-map-p-int10-car-car
      (implies (and (int20-map-p m) (not (atom m)))
               (int10 (car (car (int20-map-p-->-int10-map-p m)))))
      :hints (("Goal" :in-theory (enable int20-map-p
                                         int20-map-p-->-int10-map-p))))
    (defthm int20-map-p-->-int10-map-p--consp
      (implies (and (int20-map-p m) (not (atom m)))
      ...
      :hints (("Goal" :in-theory (enable int20-map-p
                                         int20-map-p-->-int10-map-p))))
    (defthm int20-map-p-->-int10-map-p-int10-cdr-car
      (implies (and (int20-map-p m) (not (atom m)))
               (int10 (cdr (car (int20-map-p-->-int10-map-p m)))))
      :hints (("Goal" :in-theory (enable int20-map-p
                                         int20-map-p-->-int10-map-p))))
    (defthm int20-map-p-->-int10-map-p-int10-map-p-cdr
      ...
      :hints (("Goal" :in-theory (enable int20-map-p
                                         int20-map-p-->-int10-map-p)))))
  (defthm booleanp-of-int20-map-p
    (let ((b (int20-map-p m))) (booleanp b))
    :rule-classes ((:rewrite)))
  (defthm int20-map-p-nil (int20-map-p nil)
          :rule-classes ((:rewrite)))
  (defthm int20-map-p-cdr
    (implies (int20-map-p m)
             (int20-map-p (cdr m)))
    :rule-classes ((:rewrite)))
  (defthm int20-map-p-car
    (implies (and (consp m) (int20-map-p m))
             (consp (car m)))
    :rule-classes ((:rewrite)))
  (defthm int20-map-p-caar
    (implies (and (int20-map-p m) (consp m))
             (int20 (car (car m))))
    :rule-classes ((:rewrite)))
  (defthm int20-map-p-cdar
    (implies (and (int20-map-p m) (consp m))
             (int20 (cdr (car m))))
    :rule-classes ((:rewrite)))
  ...
  (encapsulate
    ...
    (defthm int10-map2-p-int10-map-p-->-int20-map-p-null 
      (implies (and (int10-map2-p m) (atom m))
               (null (int10-map-p-->-int20-map-p m)))
      :hints (("Goal" :in-theory (enable int10-map2-p
                                         int10-map-p-->-int20-map-p))))
    (defthm int10-map2-p-int10-map-p-->-int20-map-p--consp
      (implies (and (int10-map2-p m) (not (atom m)))
               (consp (int10-map-p-->-int20-map-p m)))
      :hints (("Goal" :in-theory (enable int10-map2-p
                                         int10-map-p-->-int20-map-p))))
    (defthm int10-map2-p-int10-map-p-->-int20-map-p--consp-car
      (implies (and (int10-map2-p m) (not (atom m)))
               (consp (car (int10-map-p-->-int20-map-p m))))
      :hints (("Goal" :in-theory (enable int10-map2-p
                                         int10-map-p-->-int20-map-p))))
    ...
    (defthm int10-map2-p-int10-map-p-->-int20-map-p--consp-car
      ...
      :hints (("Goal" :in-theory (enable int10-map2-p
                                         int10-map-p-->-int20-map-p))))
    (defthm int10-map2-p-int10-map-p-->-int20-map-p-int20-car-car
      (implies (and (int10-map2-p m) (not (atom m)))
               (int20 (car (car (int10-map-p-->-int20-map-p m)))))
      :hints (("Goal" :in-theory (enable int10-map2-p
                                         int10-map-p-->-int20-map-p))))
    (defthm int10-map2-p-int10-map-p-->-int20-map-p--consp
      ...
      :hints (("Goal" :in-theory (enable int10-map2-p
                                         int10-map-p-->-int20-map-p))))
    (defthm int10-map2-p-int10-map-p-->-int20-map-p-int20-cdr-car
      (implies (and (int10-map2-p m) (not (atom m)))
               (int20 (cdr (car (int10-map-p-->-int20-map-p m)))))
      :hints (("Goal" :in-theory (enable int10-map2-p
                                         int10-map-p-->-int20-map-p))))
    (defthm int10-map2-p-int10-map-p-->-int20-map-p-int20-map2-p-cdr
      (implies (and (int10-map2-p m) (not (atom m)))
               (int20-map2-p (cdr (int10-map-p-->-int20-map-p m))))
      :hints (("Goal" :in-theory (enable int10-map2-p
                                         int10-map-p-->-int20-map-p))))
    (defthm int20-map2-p-int20-map-p-->-int10-map-p-null
      (implies (and (int20-map2-p m) (atom m))
               (null (int20-map-p-->-int10-map-p m)))
      :hints (("Goal" :in-theory (enable int20-map2-p
                                         int20-map-p-->-int10-map-p))))
    (defthm int20-map2-p-int20-map-p-->-int10-map-p--consp
      (implies (and (int20-map2-p m) (not (atom m)))
               (consp (int20-map-p-->-int10-map-p m)))
      :hints (("Goal" :in-theory (enable int20-map2-p
                                         int20-map-p-->-int10-map-p))))
    (defthm int20-map2-p-int20-map-p-->-int10-map-p-consp-car
      (implies (and (int20-map2-p m) (not (atom m)))
               (consp (car (int20-map-p-->-int10-map-p m))))
      :hints (("Goal" :in-theory (enable int20-map2-p
                                         int20-map-p-->-int10-map-p))))
    ...
    (defthm int20-map2-p-int20-map-p-->-int10-map-p--consp-car
      ...
      :hints (("Goal" :in-theory (enable int20-map2-p
                                         int20-map-p-->-int10-map-p))))
    (defthm int20-map2-p-int20-map-p-->-int10-map-p-int10-car-car
      (implies (and (int20-map2-p m) (not (atom m)))
               (int10 (car (car (int20-map-p-->-int10-map-p m)))))
      :hints (("Goal" :in-theory (enable int20-map2-p
                                         int20-map-p-->-int10-map-p))))
    (defthm int20-map2-p-int20-map-p-->-int10-map-p--consp
      ...
      :hints (("Goal" :in-theory (enable int20-map2-p
                                         int20-map-p-->-int10-map-p))))
    (defthm int20-map2-p-int20-map-p-->-int10-map-p-int10-cdr-car
      (implies (and (int20-map2-p m) (not (atom m)))
               (int10 (cdr (car (int20-map-p-->-int10-map-p m)))))
      :hints (("Goal" :in-theory (enable int20-map2-p
                                         int20-map-p-->-int10-map-p))))
    (defthm int20-map2-p-int20-map-p-->-int10-map-p-int10-map2-p-cdr
      (implies (and (int20-map2-p m) (not (atom m)))
               (int10-map2-p (cdr (int20-map-p-->-int10-map-p m))))
      :hints (("Goal" :in-theory (enable int20-map2-p
                                         int20-map-p-->-int10-map-p)))))
  (defthm booleanp-of-int20-map2-p
    (let ((b (int20-map2-p m)))
      (booleanp b))
    :rule-classes ((:rewrite)))
  (defthm int20-map2-p-nil (int20-map2-p nil)
          :rule-classes ((:rewrite)))
  (defthm int20-map2-p-cdr
    (implies (int20-map2-p m)
             (int20-map2-p (cdr m)))
    :rule-classes ((:rewrite)))
  (defthm int20-map2-p-car
    (implies (and (consp m) (int20-map2-p m))
             (consp (car m)))
    :rule-classes ((:rewrite)))
  (defthm int20-map2-p-caar
    (implies (and (int20-map2-p m) (consp m))
             (int20 (car (car m))))
    :rule-classes ((:rewrite)))
  (defthm int20-map2-p-cdar
    (implies (and (int20-map2-p m) (consp m))
             (int20 (cdr (car m))))
    :rule-classes ((:rewrite)))
