...
(APT::TAILREC-PROCESS-NEW/WRAPPER-NAMES)
...
(APT::SYMBOLP-OF-TAILREC-PROCESS-ACCUMULATOR.A
     ...
     (18 18
         (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-KEYWORD-TRUELIST-ALISTP
                   . 1))
     (6 6
        (:REWRITE RETURN-TYPE-OF-ENSURE-NOT-MEMBER-OF-LIST.ERP))
     (1 1 (:REWRITE SYMBOL-FIX-WHEN-SYMBOLP)))
(APT::TAILREC-PROCESS-WRAPPER-ENABLE)
(APT::TAILREC-PROCESS-THM-NAME)
