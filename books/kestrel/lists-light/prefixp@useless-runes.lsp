...
(PREFIXP-OF-TRUE-LIST-FIX-ARG2 (180 9
...
(PREFIXP-OF-TRUE-LIST-FIX-ARG1 (219 11
                                    (:REWRITE TRUE-LIST-FIX-WHEN-TRUE-LISTP))
...
(PREFIXP-WHEN-LENS-EQUAL (724 32
                              (:REWRITE TRUE-LIST-FIX-WHEN-TRUE-LISTP))
...
(EQUAL-OF-EQUAL-AND-PREFIXP (84 84 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
                            ...
                            (1 1 (:DEFINITION FIX)))
(BOOLEANP-OF-PREFIXP)
(PREFIXP-WHEN-NOT-SHORTER (813 34
                               (:REWRITE TRUE-LIST-FIX-WHEN-TRUE-LISTP))
...
(PREFIX-OF-APPEND-WHEN-NOT-CONSP-CHEAP
     ...
     (1 1
        (:REWRITE CONSP-OF-CDR-WHEN-LEN-KNOWN)))
(PREFIXP-OF-APPEND-SAME (219 7 (:REWRITE PREFIXP-WHEN-LEN-0))
                        (206 103
                             (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
