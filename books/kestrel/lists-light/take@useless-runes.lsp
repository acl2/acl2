(CONSP-OF-TAKE (7 7 (:REWRITE DEFAULT-CAR))
               (5 5 (:REWRITE DEFAULT-+-2))
               (5 5 (:REWRITE DEFAULT-+-1))
               (4 4 (:REWRITE DEFAULT-CDR))
               (1 1 (:REWRITE DEFAULT-<-2))
               (1 1 (:REWRITE DEFAULT-<-1)))
(CAR-OF-TAKE-STRONG (17 6 (:REWRITE CONSP-OF-TAKE))
                    (6 6 (:REWRITE DEFAULT-CDR))
                    (6 6 (:REWRITE DEFAULT-+-2))
                    (6 6 (:REWRITE DEFAULT-+-1))
                    (3 3 (:REWRITE DEFAULT-<-2))
                    (3 3 (:REWRITE DEFAULT-<-1)))
(TAKE-OF-CONS (11 5 (:REWRITE ZP-OPEN))
              ...
              (2 2 (:DEFINITION NOT)))
(TAKE-OF-0)
(TAKE-WHEN-ZP (1 1 (:REWRITE ZP-OPEN)))
(TAKE-OF-1 (2 2 (:REWRITE DEFAULT-CAR))
           (1 1 (:REWRITE DEFAULT-CDR)))
(CDR-OF-TAKE (11 5 (:REWRITE ZP-OPEN))
             ...
             (2 2 (:REWRITE DEFAULT-<-2))
             (2 2 (:REWRITE DEFAULT-<-1)))
(LEN-OF-TAKE (57 4 (:REWRITE CDR-OF-TAKE))
             ...
             (1 1
                (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(NTH-OF-TAKE-2 (96 7 (:REWRITE CDR-OF-TAKE))
...
(NTHCDR-OF-TAKE (258 242 (:REWRITE DEFAULT-+-2))
                (242 242 (:REWRITE DEFAULT-+-1))
                (178 86 (:REWRITE DEFAULT-CDR))
                (134 9 (:REWRITE CDR-OF-TAKE))
                ...
                (17 17
                    (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(TAKE-OF-NTHCDR (78 30 (:REWRITE DEFAULT-CDR))
...
(TAKE-DOES-NOTHING (32 4 (:REWRITE ZP-OPEN))
...
(TAKE-IFF (105 9 (:REWRITE TAKE-DOES-NOTHING))
          ...
          (4 4 (:REWRITE DEFAULT-CAR))
          (1 1 (:REWRITE ZP-OPEN)))
(TAKE-OF-TRUE-LIST-FIX (331 32 (:REWRITE TAKE-DOES-NOTHING))
...
(TAKE-OF-TAKE-WHEN-<= (240 20 (:REWRITE TAKE-DOES-NOTHING))
                      (114 114 (:TYPE-PRESCRIPTION LEN))
                      (109 18 (:DEFINITION LEN))
                      ...
                      (1 1 (:REWRITE CDR-CONS))
                      (1 1 (:DEFINITION FIX)))
(TAKE-OF-CDR (45 4 (:REWRITE TAKE-DOES-NOTHING))
             ...
             (1 1 (:REWRITE DEFAULT-<-1))
             (1 1 (:DEFINITION NOT)))
(CDR-TAKE-PLUS-1 (45 4 (:REWRITE TAKE-DOES-NOTHING))
                 (38 2 (:DEFINITION TAKE))
                 (25 25 (:TYPE-PRESCRIPTION LEN))
                 (20 4 (:DEFINITION LEN))
                 (13 8 (:REWRITE DEFAULT-+-2))
...
(SUBSETP-EQUAL-OF-TAKE-AND-TAKE
     ...
     (830 25 (:REWRITE CDR-OF-TAKE))
     (713 141 (:DEFINITION LEN))
     (478 190 (:REWRITE ZP-OPEN))
     (444 298 (:REWRITE DEFAULT-+-2))
     ...
     (15 15
         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(TAKE-OF-APPEND (563 47 (:REWRITE TAKE-DOES-NOTHING))
...
(TAKE-OF-UPDATE-NTH (1580 110 (:REWRITE TAKE-DOES-NOTHING))
                    (794 116 (:DEFINITION LEN))
                    (779 779 (:TYPE-PRESCRIPTION LEN))
                    (389 239 (:REWRITE DEFAULT-+-2))
                    (298 243 (:REWRITE DEFAULT-CDR))
                    (239 239 (:REWRITE DEFAULT-+-1))
                    (132 7 (:REWRITE LEN-UPDATE-NTH))
                    ...
                    (2 2 (:DEFINITION FIX)))
(NTH-OF-TAKE-GEN (12 2 (:DEFINITION NTH))
                 ...
                 (2 2 (:REWRITE ZP-OPEN))
                 (2 2 (:REWRITE DEFAULT-CAR)))
(NTH-OF-TAKE-GEN2 (174 17 (:REWRITE TAKE-DOES-NOTHING))
                  ...
                  (6 6
                     (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(APPEND-OF-TAKE-AND-NTHCDR-2 (433 67 (:REWRITE TAKE-DOES-NOTHING))
                             (294 10 (:REWRITE CDR-OF-TAKE))
                             ...
                             (9 9
                                (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(CADR-OF-TAKE (24 2 (:REWRITE TAKE-DOES-NOTHING))
              ...
              (2 2
                 (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(TAKE-DOES-NOTHING-REWRITE (20 10 (:REWRITE DEFAULT-+-2))
                           ...
                           (4 4 (:REWRITE DEFAULT-CAR)))
(EQUAL-OF-TAKE-AND-TAKE-SAME (310 36 (:REWRITE TAKE-DOES-NOTHING))
                             ...
                             (2 2
                                (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(TAKE-OPENER (81 6 (:REWRITE TAKE-DOES-NOTHING))
