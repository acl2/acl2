...
(TAKE-OF-TAKE-WHEN-<=
 (240 20 (:REWRITE TAKE-DOES-NOTHING))
...
(TAKE-OF-APPEND
 (563 47 (:REWRITE TAKE-DOES-NOTHING))
...
(TAKE-OF-UPDATE-NTH
 (1580 110 (:REWRITE TAKE-DOES-NOTHING))
