...
(NTH-OF-GROUP2
 ...
 (611 495 (:REWRITE DEFAULT-<-1))
 (590 495 (:REWRITE DEFAULT-<-2))
 (516 516 (:TYPE-PRESCRIPTION <=-OF-FLOOR-AND-0-WHEN-NONPOSITIVE-AND-NONNEGATIVE-TYPE))
 (516 516 (:TYPE-PRESCRIPTION <=-OF-0-AND-FLOOR-WHEN-BOTH-NONPOSITIVE-TYPE))
 (516 516 (:TYPE-PRESCRIPTION <-OF-FLOOR-AND-0-WHEN-POSITIVE-AND-NEGATIVE-TYPE))
 (516 516 (:TYPE-PRESCRIPTION <-OF-FLOOR-AND-0-WHEN-NEGATIVE-AND-POSITIVE-TYPE))
 (459 263 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
 (333 73 (:REWRITE FLOOR-WHEN-MOD-0-CHEAP))
 (322 279 (:REWRITE DEFAULT-+-1))
 (316 279 (:REWRITE DEFAULT-+-2))
 (261 72 (:REWRITE FLOOR-WHEN-<))
 (210 12 (:REWRITE FLOOR-OF-+-WHEN-MULT-ARG2))
 (166 140 (:REWRITE DEFAULT-*-2))
 (162 140 (:REWRITE DEFAULT-*-1))
 (144 21 (:LINEAR X*Y>1-POSITIVE))
 (134 85 (:TYPE-PRESCRIPTION RATIONALP-OF-MOD))
 (129 129 (:REWRITE DEFAULT-UNARY-MINUS))
 (126 96 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
 (115 12 (:REWRITE COMMUTATIVITY-2-OF-+))
 (113 72 (:REWRITE FLOOR-WHEN-NOT-RATIONALP-OF-QUOTIENT))
 (113 72 (:REWRITE FLOOR-WHEN-NEGATIVE-AND-SMALL-CHEAP))
 (113 72 (:REWRITE FLOOR-WHEN-I-IS-NOT-AN-ACL2-NUMBERP))
