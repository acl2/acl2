...
(EQUAL-OF-GROUP2-AND-GROUP2
 ...
 (5060 6 (:REWRITE SUBRANGE-WHEN-END-IS-NEGATIVE))
 (5012 1020 (:REWRITE MULTIPLE-WHEN-MOD-0-CHEAP))
 (4652 990 (:REWRITE FLOOR-WHEN-MOD-0-CHEAP))
 (4304 6 (:REWRITE SUBRANGE-OUT-OF-ORDER))
 (4301 6 (:REWRITE SUBRANGE-OUT-OF-ORDER-OR-SINGLETON))
 ...
 (2344 54 (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
...
(GROUP2-IN-TERMS-OF-GROUP
 (2927 3 (:REWRITE TAKE-DOES-NOTHING))
 (2451 103 (:REWRITE FLOOR-MUST-BE-1))
