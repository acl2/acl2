...
(TAKE-OF-GROUP-2
 ...
 (956 695 (:REWRITE DEFAULT-<-1))
 (899 32 (:REWRITE FIRSTN-WHEN-<=-OF-LEN))
 (892 695 (:REWRITE DEFAULT-<-2))
...
(EQUAL-OF-GROUP2-AND-GROUP2
 ...
 (36534 88 (:REWRITE TAKE-DOES-NOTHING))
 (19580 172 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
 (17854 6 (:REWRITE SUBRANGE-TO-END-BECOMES-NTHCDR))
 (10554 253 (:LINEAR MOD-BOUND-LINEAR-ARG1))
 (10424 253 (:LINEAR MOD-BOUND-LINEAR-ARG2-STRONG))
 (8928 253 (:LINEAR MOD-BOUND-LINEAR-ARG2))
 (8912 6 (:REWRITE SUBRANGE-UP-TO-END-BECOMES-NTHCDR))
 (8785 4044 (:REWRITE DEFAULT-*-2))
 (8698 2 (:REWRITE EQUAL-OF-+-AND-+-CANCEL-1+-1+))
 ...
 (5064 6 (:REWRITE SUBRANGE-WHEN-END-IS-NEGATIVE))
 (5012 1020 (:REWRITE MULTIPLE-WHEN-MOD-0-CHEAP))
 (4652 990 (:REWRITE FLOOR-WHEN-MOD-0-CHEAP))
 (4308 6 (:REWRITE SUBRANGE-OUT-OF-ORDER))
 (4305 6 (:REWRITE SUBRANGE-OUT-OF-ORDER-OR-SINGLETON))
 ...
 (2346 54 (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
 (2164 7 (:REWRITE FLOOR-UNIQUE-EQUAL-VERSION))
 ...
 (175 175 (:LINEAR <-OF-*-WHEN-<-OF-CONSTANT-AND-<-OF-CONSTANT-LINEAR))
 ...
 (36 36 (:LINEAR MY-FLOOR-LOWER-BOUND-ALT-NEG-LINEAR))
...
(GROUP2-IN-TERMS-OF-GROUP
 (2935 3 (:REWRITE TAKE-DOES-NOTHING))
 (2457 103 (:REWRITE FLOOR-MUST-BE-1))
 (2286 22 (:REWRITE *-OF-FLOOR-OF-SAME-WHEN-MULTIPLE))
 (1956 32 (:LINEAR <-OF-*-SAME-LINEAR-2))
 (1850 32 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
 (1841 25 (:LINEAR MY-FLOOR-LOWER-BOUND-LINEAR))
 (1789 1 (:REWRITE FIRSTN-WHEN-<=-OF-LEN))
 (1782 7 (:LINEAR FLOOR-UPPER-BOUND-ALT-LINEAR))
 (1766 25 (:LINEAR FLOOR-UPPER-BOUND-LINEAR))
 (1705 32 (:LINEAR <-OF-*-AND-*-SAME-LINEAR-2))
 (1702 2 (:REWRITE GROUP2-WHEN-N-IS-TOO-LARGE))
 (1702 2 (:REWRITE GROUP2-BASE))
 (1627 25 (:LINEAR FLOOR-BOUND-ARG1-LINEAR))
 (1435 103 (:REWRITE FLOOR-WHEN-<=))
 (993 101 (:REWRITE FLOOR-WHEN-<))
 (922 6 (:LINEAR MY-FLOOR-LOWER-BOUND-ALT-LINEAR))
 (802 6 (:LINEAR *-OF-FLOOR-UPPER-BOUND-LINEAR))
 (608 364 (:REWRITE DEFAULT-<-1))
 (606 2 (:REWRITE <-OF-*-SAME-ARG3))
...
(EQUAL-OF-GROUP-AND-GROUP2-HELPER
 ...
 (222 222 (:LINEAR <-OF-*-WHEN-<-OF-CONSTANT-AND-<-OF-CONSTANT-LINEAR))
 ...
 (141 2 (:REWRITE FLOOR-UNIQUE-EQUAL-VERSION))
...
(EQUAL-OF-*-OF-FLOOR
 (617 11 (:LINEAR <-OF-*-SAME-LINEAR-2))
 (592 11 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
...
(EQUAL-OF-GROUP-AND-GROUP
 ...
 (2882 39 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
 ...
 (235 187 (:REWRITE <-OF-+-ARG1-WHEN-NEGATIVE-CONSTANT))
...
(SUBRANGE-OF-GROUP
 ...
 (40 3 (:REWRITE GROUP2-WHEN-N-IS-TOO-LARGE))
 (40 3 (:REWRITE GROUP2-BASE))
 (38 4 (:REWRITE <-OF-+-CANCEL-1+-1))
...
(FIRSTN-OF-UNGROUP
 ...
 (4109 1670 (:REWRITE DEFAULT-<-2))
 (3295 3295 (:REWRITE *-OF-*-COMBINE-CONSTANTS))
 (2038 1670 (:REWRITE DEFAULT-<-1))
 (1760 79 (:REWRITE TAKE-WHEN-NOT-CONSP))
 (1669 10 (:REWRITE EQUAL-OF-+-AND-+-CANCEL-CONSTANTS))
 (1571 40 (:REWRITE EQUAL-OF-+-WHEN-NEGATIVE-CONSTANT))
 (1290 12 (:REWRITE FIRSTN-WHEN-<=-OF-LEN))
 (1140 622 (:REWRITE DEFAULT-+-2))
 (1088 25 (:REWRITE FLOOR-UNIQUE-EQUAL-VERSION))
 (937 229 (:REWRITE FLOOR-WHEN-DIVISIBLE-CHEAP))
 (820 820 (:LINEAR <-OF-*-WHEN-<-OF-CONSTANT-AND-<-OF-CONSTANT-LINEAR))
 ...
 (426 50 (:REWRITE FLOOR-BOUND-HACK-4))
