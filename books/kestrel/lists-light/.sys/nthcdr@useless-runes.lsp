...
(ACL2-COUNT-OF-NTHCDR-STRONG-LINEAR
 (5633 3068 (:REWRITE DEFAULT-+-2))
 (5440 327 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (4199 3068 (:REWRITE DEFAULT-+-1))
 (2907 158 (:REWRITE LEN-OF-NTHCDR))
 (1614 1379 (:REWRITE DEFAULT-<-2))
 (1459 1379 (:REWRITE DEFAULT-<-1))
 (1152 316 (:DEFINITION NFIX))
 (878 878 (:REWRITE DEFAULT-UNARY-MINUS))
 (854 854 (:REWRITE FOLD-CONSTS-IN-+))
 (786 786 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
 (632 316 (:TYPE-PRESCRIPTION TRUE-LISTP-NTHCDR-TYPE-PRESCRIPTION))
 (461 431 (:REWRITE DEFAULT-CAR))
 (455 429 (:REWRITE DEFAULT-CDR))
 (384 40 (:REWRITE COMMUTATIVITY-2-OF-+))
 (360 78 (:REWRITE LEN-OF-CDR))
 (348 348 (:REWRITE DEFAULT-REALPART))
 (348 348 (:REWRITE DEFAULT-NUMERATOR))
 (348 348 (:REWRITE DEFAULT-IMAGPART))
 (348 348 (:REWRITE DEFAULT-DENOMINATOR))
...
(CONSP-OF-NTHCDR
 (944 48 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (227 184 (:REWRITE DEFAULT-+-2))
 ...
 (20 20 (:TYPE-PRESCRIPTION POSP))
 (14 1 (:LINEAR <-OF-LEN-OF-NTHCDR-LINEAR))
