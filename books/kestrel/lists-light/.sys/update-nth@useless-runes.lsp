...
(UPDATE-NTH-OF-APPEND
 (827 502 (:REWRITE DEFAULT-+-2))
 (569 564 (:REWRITE DEFAULT-CDR))
 (551 502 (:REWRITE DEFAULT-+-1))
 (396 242 (:REWRITE DEFAULT-<-1))
 (298 242 (:REWRITE DEFAULT-<-2))
 (120 115 (:REWRITE DEFAULT-CAR))
