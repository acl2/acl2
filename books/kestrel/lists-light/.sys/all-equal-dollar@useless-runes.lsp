...
(ALL-EQUAL$-OF-REVAPPEND
 (132 14 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (69 39 (:REWRITE ALL-EQUAL$-WHEN-NOT-EQUAL-OF-LEN-AND-1-CHEAP))
...
(ALL-EQUAL$-OF-REVERSE
 (281 28 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (80 4 (:REWRITE DEFAULT-COERCE-3))
 (71 55 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
 (63 42 (:REWRITE ALL-EQUAL$-WHEN-NOT-EQUAL-OF-LEN-AND-1-CHEAP))
