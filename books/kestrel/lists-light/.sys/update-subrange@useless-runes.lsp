...
(NTHCDR-OF-UPDATE-SUBRANGE-LESS-BETTER-BETTER
 (424 3 (:DEFINITION UPDATE-SUBRANGE))
...
(TAKE-OF-UPDATE-SUBRANGE-LEMMA
 ...
 (124 120 (:REWRITE DEFAULT-UNARY-MINUS))
