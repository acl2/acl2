(NTHCDR-UPDATE-NTH-BETTER (1562 70 (:REWRITE DEFAULT-CAR))
...
(NTH-OF-UPDATE-SUBRANGE-DIFF-2
     ...
     (4 4
        (:REWRITE CONSP-OF-CDR-WHEN-LEN-KNOWN)))
(NTH-OF-UPDATE-SUBRANGE (183 9 (:DEFINITION NTH))
...
(UPDATE-SUBRANGE-OF-UPDATE-SUBRANGE-SAME
     ...
     (6 6 (:REWRITE ZP-OPEN)))
(UPDATE-SUBRANGE-OF-TAKE (307 32 (:REWRITE CONSP-FROM-LEN-CHEAP))
...
(UPDATE-SUBRANGE-REORDER
     ...
     (2 2 (:REWRITE ZP-OPEN)))
(TAKE-OF-UPDATE-SUBRANGE (182 20 (:REWRITE TAKE-DOES-NOTHING))
...
(LEN-OF-UPDATE-SUBRANGE (360 8
                        ...
                        (3 3 (:TYPE-PRESCRIPTION UPDATE-NTH))
                        (3 3 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(CONSP-OF-UPDATE-SUBRANGE (158 2 (:DEFINITION UPDATE-SUBRANGE))
                          (90 2
                              (:REWRITE UPDATE-NTH-OF-UPDATE-SUBRANGE))
...
(UPDATE-SUBRANGE-OF-TRUE-LIST-FIX
     ...
     (1 1 (:REWRITE EQUAL-OF-0-AND-+-OF--)))
(NTHCDR-WHEN-<=-OF-LEN (37 4 (:DEFINITION TRUE-LISTP))
                       ...
                       (2 2 (:REWRITE DEFAULT-+-1))
                       (1 1 (:REWRITE ZP-OPEN)))
(UPDATE-SUBRANGE-ALL (27 3 (:REWRITE CONSP-FROM-LEN-CHEAP))
