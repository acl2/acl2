(CAR-OF-REVAPPEND (62 21 (:REWRITE DEFAULT-CAR))
                  (15 15 (:REWRITE DEFAULT-CDR)))
(CONSP-OF-REVAPPEND (5 5 (:REWRITE DEFAULT-CDR))
                    (4 4 (:REWRITE DEFAULT-CAR)))
(REVAPPEND-IFF (4 4 (:REWRITE DEFAULT-CDR))
               (3 3 (:REWRITE DEFAULT-CAR)))
(REVAPPEND-OF-APPEND-ARG2 (334 334 (:TYPE-PRESCRIPTION BINARY-APPEND))
...
(REVAPPEND-NORMALIZE-ACC (23 23 (:TYPE-PRESCRIPTION BINARY-APPEND)))
(REVAPPEND-OF-APPEND-ARG1 (36 22 (:REWRITE DEFAULT-CDR))
                          (33 16 (:REWRITE DEFAULT-CAR))
                          (12 4 (:DEFINITION LAST)))
(TRUE-LIST-FIX-OF-REVAPPEND (382 22
                            ...
                            (4 4 (:TYPE-PRESCRIPTION LAST)))
(TRUE-LISTP-OF-REVAPPEND (33 13 (:REWRITE DEFAULT-CDR))
                         (4 4 (:REWRITE CONSP-OF-REVAPPEND))
                         (3 3 (:REWRITE DEFAULT-CAR)))
...
(REVAPPEND-OF-SINGLETON-ARG1 (11 11 (:TYPE-PRESCRIPTION REVAPPEND))
                             (1 1 (:REWRITE DEFAULT-CDR))
                             (1 1 (:REWRITE DEFAULT-CAR)))
(REVAPPEND-OF-CONS (43 22 (:TYPE-PRESCRIPTION BINARY-APPEND)))
(REVAPPEND-OF-REVAPPEND (144 18
                             (:REWRITE TRUE-LIST-FIX-WHEN-TRUE-LISTP))
...
(CDR-OF-REVAPPEND (147 82 (:REWRITE DEFAULT-CDR))
