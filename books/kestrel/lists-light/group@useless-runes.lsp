...
(CDR-OF-GROUP (150 10 (:REWRITE LEN-OF-NTHCDR))
              ...
              (33 2 (:REWRITE TRUE-LISTP-OF-NTHCDR-2))
...
(CAR-OF-GROUP (125 12
              ...
              (21 1 (:REWRITE TRUE-LISTP-OF-NTHCDR-2))
...
(LEN-OF-GROUP (476 342 (:REWRITE DEFAULT-<-2))
              ...
              (100 4 (:REWRITE TRUE-LISTP-OF-NTHCDR-2))
...
(FIRSTN-OF-GROUP
     (3307 81 (:REWRITE FIRSTN-WHEN-<=-OF-LEN))
     ...
     (495 422 (:REWRITE DEFAULT-<-2))
     (444 422 (:REWRITE DEFAULT-<-1))
...
(TAKE-OF-GROUP (2125 10 (:REWRITE TAKE-DOES-NOTHING))
               (1209 13
                     (:REWRITE EQUAL-OF-+-WHEN-NEGATIVE-CONSTANT))
               (1006 30 (:DEFINITION FIRSTN))
               (786 633 (:REWRITE DEFAULT-*-2))
               (713 633 (:REWRITE DEFAULT-*-1))
               (602 446 (:REWRITE DEFAULT-<-2))
               (506 446 (:REWRITE DEFAULT-<-1))
...
(APPEND-OF-NTHCDR-OF-LEN-SAME
     (41 1
         (:REWRITE TRUE-LIST-FIX-WHEN-TRUE-LISTP))
     (33 1 (:REWRITE TRUE-LISTP-OF-NTHCDR-2))
...
(GROUP-OF-APPEND-1
     (43038 100
            (:REWRITE *-OF-FLOOR-OF-SAME-WHEN-MULTIPLE))
     (30313 5 (:DEFINITION FIRSTN))
     (20404 166
            (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
     (14780 13 (:REWRITE GROUP-WHEN-NOT-CONSP))
     (11227 5
            (:REWRITE <-OF-+-CANCEL-FIRST-AND-FIRST))
     (10802 4 (:REWRITE CONSP-OF-APPEND))
     (8757 3 (:REWRITE CONSP-OF-NTHCDR))
     (8287 4905 (:REWRITE DEFAULT-*-2))
     (7048 4905 (:REWRITE DEFAULT-*-1))
     (6653 480
           (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
     (6403 71 (:LINEAR MOD-BOUND-LINEAR-ARG1))
     (6324 142 (:LINEAR MOD-BOUNDED-BY-MODULUS))
     (6018 480 (:REWRITE MOD-WHEN-MULTIPLE))
     (6018 480 (:REWRITE MOD-IS-0-WHEN-MULTIPLE))
     (5908 71
           (:LINEAR MOD-BOUND-LINEAR-ARG2-STRONG))
     (5766 71 (:LINEAR MOD-TYPE . 4))
     (5766 71 (:LINEAR MOD-BOUND-LINEAR-ARG2))
     (5763 4 (:REWRITE CONSP-OF-FIRSTN))
     (5246 3289 (:REWRITE DEFAULT-<-1))
     (5189 3289 (:REWRITE DEFAULT-<-2))
     (4730 565
           (:REWRITE MULTIPLE-WHEN-MOD-0-CHEAP))
     (4664 71 (:LINEAR MOD-TYPE . 2))
     (4144 480
           (:REWRITE MOD-X-Y-=-X-FOR-RATIONALS . 2))
     (4046 2004 (:TYPE-PRESCRIPTION RATIONALP-MOD))
     (3734 480 (:REWRITE MOD-WHEN-<))
     (3624 565 (:REWRITE INTEGERP-OF-SMALL))
     (3285 480
           (:REWRITE MOD-X-Y-=-X-FOR-RATIONALS . 3))
     (2710 231 (:REWRITE FLOOR-=-X/Y . 2))
     (2261 2261 (:REWRITE DEFAULT-UNARY-/))
     (2004 2004 (:TYPE-PRESCRIPTION MOD-TYPE . 4))
     (2004 2004 (:TYPE-PRESCRIPTION MOD-TYPE . 3))
     (2004 2004 (:TYPE-PRESCRIPTION MOD-TYPE . 2))
     (2004 2004 (:TYPE-PRESCRIPTION MOD-TYPE . 1))
     (2004 2004 (:TYPE-PRESCRIPTION INTEGERP-MOD))
     (1979 1979
           (:TYPE-PRESCRIPTION FLOOR-TYPE-1-PART-1-BETTER))
     (1895 71 (:REWRITE CEILING-WHEN-<=))
     (1892 233 (:REWRITE FLOOR-TYPE-3 . 2))
     (1832 231 (:REWRITE FLOOR-WHEN-MOD-0-CHEAP))
     (1832 231
           (:REWRITE FLOOR-WHEN-DIVISIBLE-CHEAP))
     (1682 231 (:REWRITE FLOOR-WHEN-<=))
     (1682 231 (:REWRITE FLOOR-WHEN-<))
     (1554 233 (:REWRITE FLOOR-TYPE-3 . 3))
     (1355 11 (:REWRITE <-OF-CEILING-ARG2))
     (1340 565
           (:REWRITE INTEGERP-OF-SMALL-HELPER-2))
     (1204 233 (:REWRITE FLOOR-TYPE-4 . 2))
     (1124 231 (:REWRITE FLOOR-MUST-BE-1))
     (1046 28 (:REWRITE FLOOR-TYPE-2))
     (890 480
          (:REWRITE MOD-WHEN-RATIONALP-ARG1-AND-NOT-RATIONALP-ARG2))
     (890 480
          (:REWRITE MOD-WHEN-NOT-RATIONALP-ARG1-AND-RATIONALP-ARG2))
     ...
     (480 480
          (:REWRITE DIVISIBLE-WHEN-DIVISIBLE-BY-MULTIPLE))
     (474 28 (:REWRITE FLOOR-BOUND-HACK-4))
     (450 233 (:REWRITE FLOOR-TYPE-4 . 3))
     (446 231
          (:REWRITE FLOOR-WHEN-NOT-RATIONALP-OF-QUOTIENT))
     (446 231
          (:REWRITE FLOOR-WHEN-NOT-RATIONALP-ARG1))
     ...
     (414 51 (:LINEAR FLOOR-TYPE-2 . 2))
     (403 199 (:REWRITE DEFAULT-+-2))
     (332 332 (:LINEAR <-OF-*-AND-*))
     (304 266 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
     (268 199 (:REWRITE DEFAULT-+-1))
     (231 231
          (:REWRITE FLOOR-MINUS-NEGATIVE-CONSTANT))
     (231 231 (:REWRITE FLOOR-MINUS-ERIC-BETTER))
     (231 231
          (:REWRITE FLOOR-DIVIDE-BY-COMMON-CONSTANT-FACTOR))
     ...
     (100 100
          (:REWRITE SAME-REMAINDER-WHEN-CLOSE-LEMMA))
     (71 71 (:LINEAR MOD-TYPE . 3))
     (71 71 (:LINEAR MOD-TYPE . 1))
     (61 50
         (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
     (56 31
...
(GROUP-OF-APPEND
     (61667 487
            (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
     (39380 322 (:LINEAR FLOOR-UPPER-BOUND-LINEAR))
     (38924 322 (:LINEAR FLOOR-BOUND-ARG1-LINEAR))
     (18975 1562 (:REWRITE FLOOR-=-X/Y . 2))
     (17005 322
            (:LINEAR FLOOR-UPPER-BOUND-STRONG-LINEAR))
     (16526 8593 (:REWRITE DEFAULT-*-2))
     (13899 9258 (:REWRITE DEFAULT-<-1))
     (13636 8593 (:REWRITE DEFAULT-*-1))
     (13602 9258 (:REWRITE DEFAULT-<-2))
     (12496 1562 (:REWRITE FLOOR-WHEN-MOD-0-CHEAP))
     (12496 1562
            (:REWRITE FLOOR-WHEN-DIVISIBLE-CHEAP))
     (10378 1570 (:REWRITE FLOOR-TYPE-3 . 2))
     (10288 1286
            (:REWRITE MULTIPLE-WHEN-MOD-0-CHEAP))
     (9303 1562 (:REWRITE FLOOR-WHEN-<=))
     (9275 1562 (:REWRITE FLOOR-WHEN-<))
     (9093 1570 (:REWRITE FLOOR-TYPE-3 . 3))
     (8355 1570 (:REWRITE FLOOR-TYPE-4 . 2))
     (8137 8137
           (:TYPE-PRESCRIPTION FLOOR-TYPE-WHEN-NONPOSITIVE-AND-NONNEGATIVE))
     (8137 8137
           (:TYPE-PRESCRIPTION FLOOR-TYPE-1-PART-1-BETTER))
     (7984 4 (:REWRITE TRUE-LISTP-OF-NTHCDR-2))
     (6456 160 (:REWRITE FLOOR-TYPE-2))
     (5415 1562 (:REWRITE FLOOR-MUST-BE-1))
     (5112 5112 (:TYPE-PRESCRIPTION MOD-TYPE . 3))
     (5112 5112 (:TYPE-PRESCRIPTION MOD-TYPE . 2))
     (5112 5112 (:TYPE-PRESCRIPTION MOD-TYPE . 1))
     (4608 1286 (:REWRITE INTEGERP-OF-SMALL))
     (4075 263 (:REWRITE MOD-WHEN-MULTIPLE))
     (4075 263 (:REWRITE MOD-IS-0-WHEN-MULTIPLE))
     (3644 3644 (:REWRITE DEFAULT-UNARY-/))
     (3511 974 (:LINEAR <=-OF-*-AND-*-SAME-LINEAR))
     (3351 533 (:REWRITE DEFAULT-+-2))
     (3137 1570 (:REWRITE FLOOR-TYPE-4 . 3))
     (3124 1562
           (:REWRITE FLOOR-WHEN-NOT-RATIONALP-OF-QUOTIENT))
     (3124 1562
           (:REWRITE FLOOR-WHEN-NOT-RATIONALP-ARG1))
     ...
     (3124 1562
           (:REWRITE FLOOR-WHEN-I-IS-NOT-AN-ACL2-NUMBERP))
     (2800 162 (:REWRITE FLOOR-BOUND-HACK-4))
     (2751 332 (:LINEAR FLOOR-TYPE-2 . 2))
     (2572 1286
           (:REWRITE INTEGERP-OF-SMALL-HELPER-2))
     (2288 264
           (:REWRITE MOD-X-Y-=-X-FOR-RATIONALS . 2))
     (2035 263 (:REWRITE MOD-WHEN-<))
     (2029 352 (:REWRITE DEFAULT-UNARY-MINUS))
     (2006 264
           (:REWRITE MOD-X-Y-=-X-FOR-RATIONALS . 3))
     (1562 1562
           (:REWRITE FLOOR-MINUS-NEGATIVE-CONSTANT))
     (1562 1562 (:REWRITE FLOOR-MINUS-ERIC-BETTER))
     (1562 1562
           (:REWRITE FLOOR-DIVIDE-BY-COMMON-CONSTANT-FACTOR))
     (1286 1286 (:REWRITE INTEGERP-OF-*))
     (974 974
          (:LINEAR <=-OF-*-AND-*-SAME-ALT-LINEAR))
     (974 974 (:LINEAR <-OF-*-AND-*))
     (885 533 (:REWRITE DEFAULT-+-1))
     (744 744
          (:REWRITE SAME-REMAINDER-WHEN-CLOSE-LEMMA))
     (526 263
          (:REWRITE MOD-WHEN-RATIONALP-ARG1-AND-NOT-RATIONALP-ARG2))
     ...
     (238 55
          (:REWRITE APPEND-WHEN-NOT-CONSP-ARG1-CHEAP))
     (235 235 (:REWRITE EQUAL-OF-*-AND-CONSTANT))
