...
(MAKE-APPEND-WITH-KEY-NEST-AUX
     (232 23 (:REWRITE CONSP-FROM-LEN-CHEAP))
     ...
     (20 3 (:LINEAR LEN-OF-CDR-LINEAR-STRONG))
     ...
     (2 1
        (:TYPE-PRESCRIPTION SYMBOL-LISTP-OF-MV-NTH-0-OF-SPLIT-LIST-FAST)))
(PSEUDO-TERMP-OF-MAKE-APPEND-WITH-KEY-NEST-AUX
     (505 52 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (220 78 (:REWRITE DEFAULT-CAR))
     (147 67 (:REWRITE DEFAULT-CDR))
     (144 144
          (:TYPE-PRESCRIPTION MAKE-APPEND-WITH-KEY-NEST-AUX))
