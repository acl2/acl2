(UPDATE-NTH2)
(LEN-OF-UPDATE-NTH2 (65 2 (:DEFINITION UPDATE-NTH))
...
(CONSP-OF-UPDATE-NTH2 (90 10 (:REWRITE TAKE-DOES-NOTHING))
                      ...
                      (2 2 (:REWRITE DEFAULT-CAR)))
(NTH-OF-UPDATE-NTH2 (132 11 (:REWRITE TAKE-DOES-NOTHING))
                    ...
                    (4 2
                       (:TYPE-PRESCRIPTION TRUE-LISTP-UPDATE-NTH))
                    (2 2 (:TYPE-PRESCRIPTION UPDATE-NTH)))
(NTH-UPDATE-NTH2-SAFE (132 11 (:REWRITE TAKE-DOES-NOTHING))
                      (127 4 (:DEFINITION UPDATE-NTH))
                      (96 6 (:REWRITE CDR-OF-TAKE))
                      (77 77 (:TYPE-PRESCRIPTION LEN))
                      (55 11 (:DEFINITION LEN))
                      ...
                      (4 2
                         (:TYPE-PRESCRIPTION TRUE-LISTP-UPDATE-NTH))
                      (2 2 (:TYPE-PRESCRIPTION UPDATE-NTH)))
(UPDATE-NTH2-OF-0-ARG1 (2 2 (:REWRITE DEFAULT-<-2))
                       (2 2 (:REWRITE DEFAULT-<-1))
                       (1 1 (:REWRITE DEFAULT-CDR)))
(UPDATE-NTH2-TOO-HIGH (66 2 (:DEFINITION UPDATE-NTH))
...
(UPDATE-NTH2-NOT-NIL1 (65 2 (:DEFINITION UPDATE-NTH))
                      (48 4 (:REWRITE TAKE-DOES-NOTHING))
                      (32 2 (:REWRITE CDR-OF-TAKE))
                      ...
                      (2 2 (:REWRITE DEFAULT-CAR))
                      (2 1 (:REWRITE CAR-OF-TAKE-STRONG)))
(UPDATE-NTH2-NOT-NIL2 (65 2 (:DEFINITION UPDATE-NTH))
                      (48 4 (:REWRITE TAKE-DOES-NOTHING))
                      (32 2 (:REWRITE CDR-OF-TAKE))
                      (28 28 (:TYPE-PRESCRIPTION LEN))
                      (22 18 (:REWRITE DEFAULT-<-1))
                      ...
                      (2 2 (:REWRITE DEFAULT-CAR))
                      (2 1 (:REWRITE CAR-OF-TAKE-STRONG)))
(NTH-OF-UPDATE-NTH2-TOO-HIGH (43 1 (:REWRITE TAKE-DOES-NOTHING))
