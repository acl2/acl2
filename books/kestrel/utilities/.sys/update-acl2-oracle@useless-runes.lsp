...
(STATE-P1-OF-UPDATE-ACL2-ORACLE
 (2770 2770 (:REWRITE DEFAULT-CAR))
 (2646 2 (:REWRITE STATE-P-IMPLIES-AND-FORWARD-TO-STATE-P1))
 (2644 1 (:DEFINITION STATE-P))
 (2200 2200 (:REWRITE DEFAULT-CDR))
 (184 15 (:DEFINITION TYPED-IO-LISTP))
