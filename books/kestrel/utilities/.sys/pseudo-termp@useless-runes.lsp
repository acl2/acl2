(PSEUDO-TERMP-OF-NTH-ALT
 (1320 15 (:REWRITE PSEUDO-TERM-LISTP-OF-CONS))
 (961 961 (:REWRITE DEFAULT-CDR))
 (813 813 (:REWRITE DEFAULT-CAR))
 (530 271 (:REWRITE DEFAULT-+-2))
 (306 153 (:REWRITE PSEUDO-TERM-LISTP-WHEN-SYMBOL-LISTP-CHEAP-2))
...
(PSEUDO-TERMP-OF-NTH-2-OF-NTH-0-WHEN-PSEUDO-TERMP-CHEAP
 (1085 23 (:DEFINITION PSEUDO-TERM-LISTP))
 (656 5 (:REWRITE PSEUDO-TERMP-OF-NTH-ALT))
 (572 5 (:REWRITE PSEUDO-TERMP-OF-NTH))
