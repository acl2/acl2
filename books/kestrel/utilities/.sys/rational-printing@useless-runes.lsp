...
(PRINT-TO-HUNDREDTHS
 (1106 64 (:REWRITE DEFAULT-+-2))
 (844 72 (:REWRITE DEFAULT-*-2))
 (610 64 (:REWRITE DEFAULT-+-1))
 (549 549 (:TYPE-PRESCRIPTION <=-OF-FLOOR-AND-0-WHEN-NONPOSITIVE-AND-NONNEGATIVE-TYPE))
 (549 549 (:TYPE-PRESCRIPTION <=-OF-0-AND-FLOOR-WHEN-BOTH-NONPOSITIVE-TYPE))
 (549 549 (:TYPE-PRESCRIPTION <-OF-FLOOR-AND-0-WHEN-POSITIVE-AND-NEGATIVE-TYPE))
 (549 549 (:TYPE-PRESCRIPTION <-OF-FLOOR-AND-0-WHEN-NEGATIVE-AND-POSITIVE-TYPE))
 (482 44 (:REWRITE DEFAULT-UNARY-MINUS))
 (360 72 (:REWRITE DEFAULT-*-1))
 (106 10 (:REWRITE FLOOR-WHEN-NOT-RATIONALP-OF-QUOTIENT))
