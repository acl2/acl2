...
(TRUE-LISTP-OF-MV-NTH-0-OF-MAKE-UNROLL-AND-BASE-CLAIMS-AUX
 (774 9 (:DEFINITION MAKE-LETS-AROUND-TERM))
 (747 9 (:DEFINITION MAKE-LET-AROUND-TERM))
 (330 276 (:REWRITE DEFAULT-CAR))
 (257 221 (:REWRITE DEFAULT-CDR))
 (170 85 (:REWRITE CONSP-OF-CAR-WHEN-SYMBOL-TERM-ALISTP-CHEAP))
 (144 9 (:REWRITE FREE-VARS-IN-TERMS-WHEN-QUOTE-LISTP))
