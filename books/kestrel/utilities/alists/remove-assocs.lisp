; Removal of Multiple Keys from Alists
;
...
(defsection remove-assocs-functions-and-macros
  :parents (remove-assocs)
  :short "Definitions of the @(tsee remove-assocs) functions and macros,
...
(defsection remove-assocs-theorems
  :parents (remove-assocs)
  :short "Theorems about @(tsee remove-assocs)."
