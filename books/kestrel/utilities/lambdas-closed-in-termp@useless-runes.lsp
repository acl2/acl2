(LAMBDAS-CLOSED-IN-TERMP
 ...
 (360 6 (:REWRITE SUBSETP-EQUAL-OF-VARS-IN-TERMS-OF-CAR-CHAIN))
 (322 236 (:REWRITE DEFAULT-+-1))
 (240 12 (:REWRITE SUBSETP-EQUAL-OF-VARS-IN-TERMS-OF-CDR-CHAIN))
 ...
 (6 6 (:REWRITE VARS-IN-TERM-WHEN-NOT-CONSP-CHEAP))
 )
