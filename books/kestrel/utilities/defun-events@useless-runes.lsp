(BUTLAST-OF-NIL (2 2 (:REWRITE DEFAULT-<-2))
...
(FIND-DEFUN-IN-MUT-REC (30 30 (:REWRITE DEFAULT-CAR))
...
(GET-DECLARES-FROM-EVENT (539 280 (:REWRITE DEFAULT-+-2))
...
(GET-XARGS-FROM-EVENT (539 280 (:REWRITE DEFAULT-+-2))
                      (355 280 (:REWRITE DEFAULT-+-1))
                      (333 333 (:REWRITE DEFAULT-CDR))
                      (304 304 (:REWRITE DEFAULT-CAR))
                      (260 52 (:DEFINITION LEN))
                      ...
                      (12 6 (:DEFINITION TRUE-LISTP))
                      (5 5 (:TYPE-PRESCRIPTION DECLAREP)))
(GET-BODY-FROM-EVENT (539 280 (:REWRITE DEFAULT-+-2))
                     (355 280 (:REWRITE DEFAULT-+-1))
                     (333 333 (:REWRITE DEFAULT-CDR))
                     (304 304 (:REWRITE DEFAULT-CAR))
                     (260 52 (:DEFINITION LEN))
...
(ANY-DEFUN-HAS-EXPLICIT-GUARDP (2 2 (:REWRITE DEFAULT-CAR))
                               (1 1 (:REWRITE DEFAULT-CDR)))
(KEYWORD-VALUE-LISTP-OF-GET-XARGS-FROM-DEFUN)
(DEFUN-HAS-VERIFY-GUARDS-NILP (452 452 (:REWRITE DEFAULT-CDR))
...
(ANY-DEFUN-HAS-VERIFY-GUARDS-NILP (2 2 (:REWRITE DEFAULT-CAR))
                                  (1 1 (:REWRITE DEFAULT-CDR)))
...
(GUARDS-WERE-VERIFIED-IN-EVENTP
     ...
     (53 1
         (:DEFINITION ANY-DEFUN-HAS-EXPLICIT-GUARDP))
     (51 40 (:REWRITE DEFAULT-<-2))
     (49 1
         (:DEFINITION DEFUN-HAS-EXPLICIT-GUARDP))
     ...
     (23 1
         (:DEFINITION SOME-DECLARE-HAS-A-GUARD-OR-TYPE))
     (13 1
         (:DEFINITION DECLARE-HAS-A-GUARD-OR-TYPE))
     (11 1
         (:DEFINITION SOME-DECLARE-ARG-HAS-A-GUARD-OR-TYPE))
     (7 1
        (:DEFINITION DECLARE-ARG-HAS-A-GUARD-OR-TYPE))
     (6 6 (:TYPE-PRESCRIPTION DECLAREP))
     (4 1 (:DEFINITION ASSOC-KEYWORD))
     (1 1
        (:TYPE-PRESCRIPTION SOME-DECLARE-HAS-A-GUARD-OR-TYPE))
     (1 1
        (:TYPE-PRESCRIPTION SOME-DECLARE-ARG-HAS-A-GUARD-OR-TYPE))
     (1 1 (:TYPE-PRESCRIPTION ASSOC-KEYWORD)))
(ADD-VERIFY-GUARDS-NIL-TO-DEFUN (288 288 (:REWRITE DEFAULT-CDR))
                                (120 12 (:DEFINITION TAKE))
                                ...
                                (36 12 (:REWRITE FOLD-CONSTS-IN-+))
                                (4 4 (:TYPE-PRESCRIPTION DECLAREP)))
(ADD-VERIFY-GUARDS-T-TO-DEFUN (288 288 (:REWRITE DEFAULT-CDR))
                              (120 12 (:DEFINITION TAKE))
                              (111 111 (:REWRITE DEFAULT-CAR))
                              (63 51 (:REWRITE DEFAULT-<-2))
                              (54 51 (:REWRITE DEFAULT-<-1))
