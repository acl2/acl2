...
(NTH-OF-EXPLODE-OF-NATS=>STRING (24 2 (:REWRITE STR::DEFAULT-CODE-CHAR))
...
(LEN-OF-EXPLODE-OF-NATS=>STRING (10 2 (:DEFINITION LEN))
...
(LEN-OF-STRING=>NATS (22 2 (:DEFINITION LEN))
                     ...
                     (2 2 (:REWRITE DEFAULT-+-1)))
(NTH-OF-STRING=>NATS (30 2 (:DEFINITION NTH))
                     (22 2 (:DEFINITION LEN))
                     (16 16
                         (:TYPE-PRESCRIPTION STR::TRUE-LISTP-OF-EXPLODE))
...
(STRING=>NATS-OF-IMPLODE (3 1 (:DEFINITION CHARACTER-LISTP))
                         (1 1 (:REWRITE DEFAULT-CDR))
                         (1 1 (:REWRITE DEFAULT-CAR)))
(NATS=>STRING-OF-STRING=>NATS (1 1 (:REWRITE STR-FIX-DEFAULT))
                              (1 1
                                 (:REWRITE STR::EXPLODE-WHEN-NOT-STRINGP)))
