...
(EVENP-OF-LENGTH-OF-UBYTE8S=>HEXSTRING
 (7 1 (:DEFINITION LEN))
...
(HEXSTRING=>UBYTE8S-OF-UBYTE8S=>HEXSTRING
 (6 2 (:REWRITE UNSIGNED-BYTE-LIST-FIX-WHEN-UNSIGNED-BYTE-LISTP))
...
(UBYTE8S=>HEXSTRING-OF-HEXSTRING=>UBYTE8S
 ...
 (6 4 (:REWRITE DEFAULT-*-2))
 (6 4 (:REWRITE DEFAULT-*-1))
 (6 2 (:REWRITE STR::UPCASE-CHARLIST-WHEN-ATOM))
 (5 1 (:REWRITE STR::HEX-DIGIT-CHAR-LIST*P-WHEN-NOT-CONSP))
