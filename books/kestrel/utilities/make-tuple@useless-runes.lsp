(MAKE-TUPLE (11 9 (:REWRITE DEFAULT-<-2))
...
(MAKE-TUPLE-DROPPER-HELPER (75 15 (:DEFINITION LEN))
...
(MAKE-TUPLE-DROPPER (5 1 (:DEFINITION LEN))
...
(MAKE-TUPLE-OPENER (46 7 (:DEFINITION NTH))
                   ...
                   (2 2 (:DEFINITION FIX)))
(MAKE-TUPLE-BASE (24 4 (:DEFINITION NTH))
