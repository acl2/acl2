(CBD-FN)
(STRING-LISTP-OF-REV (91 41 (:REWRITE DEFAULT-CAR))
                     (87 37 (:REWRITE DEFAULT-CDR))
                     (36 36 (:REWRITE CONSP-OF-REV))
                     (12 12 (:REWRITE REV-WHEN-NOT-CONSP)))
(GET-NON-EMPTY-LINES (10 10 (:REWRITE DEFAULT-CAR))
                     (9 9 (:REWRITE DEFAULT-CDR)))
(TRUE-LISTP-OF-GET-NON-EMPTY-LINES (23 8 (:DEFINITION TRUE-LISTP))
                                   (11 10 (:REWRITE DEFAULT-CDR))
                                   (6 6 (:REWRITE DEFAULT-CAR)))
(STRING-LISTP-OF-GET-NON-EMPTY-LINES (34 28 (:REWRITE DEFAULT-CAR))
...
(STRING-LISTP-OF-GET-BLOCK-FOR-NAME
     ...
     (154 154
          (:REWRITE CAR-OF-STRING-LIST-FIX-X-NORMALIZE-CONST-UNDER-STREQV))
     (96 48
         (:TYPE-PRESCRIPTION TRUE-LISTP-OF-GET-NON-EMPTY-LINES))
     (48 48 (:TYPE-PRESCRIPTION TRUE-LISTP))
     (48 48
         (:TYPE-PRESCRIPTION GET-NON-EMPTY-LINES)))
(APPEND-STRING-LINES
  (270 3 (:DEFINITION APPEND-STRING-LINES))
  (261 9 (:DEFINITION STRING-APPEND-LST))
...
(GEN-XDOC-FORM-FOR-ITEM
     (190 2 (:DEFINITION APPEND-STRING-LINES))
     (180 6 (:DEFINITION STRING-APPEND-LST))
     ...
     (2 2
        (:REWRITE STR::MAKE-CHARACTER-LIST-IS-IDENTITY-UNDER-CHARLISTEQV)))
(GEN-XDOC-FORMS-FOR-ITEMS (13 13 (:REWRITE DEFAULT-CDR))
