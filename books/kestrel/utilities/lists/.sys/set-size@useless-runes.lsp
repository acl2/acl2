...
(SET-SIZE-OF-ADD-TO-SET
 (919 19 (:DEFINITION REMOVE-DUPLICATES-EQUAL))
 (638 121 (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
 (553 15 (:REWRITE LEN-WHEN-ATOM))
 (252 57 (:REWRITE REMOVE-DUPLICATES-EQUAL-WHEN-ATOM))
 ...
 (30 15 (:TYPE-PRESCRIPTION TRUE-LISTP-OF-ADD-TO-SET-EQUAL-TYPE))
