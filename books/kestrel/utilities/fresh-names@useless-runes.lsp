...
(MAKE-FRESH-NAME)
(FRESH-VAR-NAMES)
(MAKE-FRESH-NAMES (5 5 (:REWRITE DEFAULT-CAR))
                  (4 4 (:REWRITE DEFAULT-CDR))
                  (1 1 (:TYPE-PRESCRIPTION MAKE-FRESH-NAME)))
(SYMBOL-LISTP-OF-MAKE-FRESH-NAMES (12 11 (:REWRITE DEFAULT-CAR))
                                  (11 10 (:REWRITE DEFAULT-CDR)))
(LEN-OF-MAKE-FRESH-NAMES (14 7 (:REWRITE DEFAULT-+-2))
                         (11 10 (:REWRITE DEFAULT-CDR))
