...
(INTEGERP-WHEN-MEMBER-OF-INTEGER-LISTP (10 10 (:REWRITE DEFAULT-CAR))
                                       (4 4 (:REWRITE DEFAULT-CDR)))
(REAL/RATIONALP-WHEN-INTEGERP)
(EQLABLE-LISTP-WHEN-INTEGER-LISTP
     (11 11 (:REWRITE DEFAULT-CAR))
     (4 4
        (:REWRITE INTEGERP-WHEN-MEMBER-OF-INTEGER-LISTP))
     (4 4 (:REWRITE DEFAULT-CDR)))
(POSITIVE-INTERSECTION-P-FN)
(POSITIVE-INTERSECTION-P-NECC)
(BOOLEANP-OF-POSITIVE-INTERSECTION-P)
(POSITIVE-INTERSECTION-P-FN (24 2 (:DEFINITION INTEGER-LISTP))
                            (21 5 (:DEFINITION MEMBER-EQUAL))
                            (7 7 (:REWRITE DEFAULT-CDR))
                            (7 7 (:REWRITE DEFAULT-CAR)))
(POSITIVE-INTERSECTION-P-WHEN-ATOM)
(CROCK (15 15 (:REWRITE DEFAULT-CAR))
       (12 10 (:REWRITE DEFAULT-<-1))
       (10 10 (:REWRITE DEFAULT-CDR))
       (10 10 (:REWRITE DEFAULT-<-2))
       (8 8
          (:REWRITE INTERSECTION-FULLY-NATURALP-NECC))
       (2 2
          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(CROCK2)
(CROCK3)
(EQLABLE-LISTP-WHEN-NAT-LISTP (15 15 (:REWRITE DEFAULT-CAR))
                              (4 4
                                 (:REWRITE INTERSECTION-FULLY-NATURALP-NECC))
                              (4 4 (:REWRITE DEFAULT-CDR))
...
(ALL-GREATER-P-FOR-DEFUN-SK (16 2 (:REWRITE CROCK2))
...
(ALL-GREATER-P (17 2 (:REWRITE CROCK2))
               (12 3 (:DEFINITION MEMBER-EQUAL))
...
(NATP-OF-WEIRD-QUANTIFIER-3-RETURNSPEC.FOO (1 1 (:REWRITE DEFAULT-<-2))
                                           (1 1 (:REWRITE DEFAULT-<-1)))
(NATP-OF-WEIRD-QUANTIFIER-3-RETURNSPEC.BAR (1 1 (:REWRITE DEFAULT-<-2))
                                           (1 1 (:REWRITE DEFAULT-<-1)))
(WEIRD-QUANTIFIER-3-RETURNSPEC)
(FOO-NON-INFINITE-P)
(FOO-NON-INFINITE-P-SUFF)
(BOOLEANP-OF-FOO-NON-INFINITE-P)
(FOO-NON-INFINITE-P (4 2 (:REWRITE DEFAULT-+-2))
                    (3 3
                       (:REWRITE INTERSECTION-FULLY-NATURALP-NECC))
...
(BAR-NON-INFINITE-P (4 2 (:REWRITE DEFAULT-+-2))
                    (3 3
                       (:REWRITE INTERSECTION-FULLY-NATURALP-NECC))
                    (3 3 (:REWRITE DEFAULT-CDR))
                    (3 3 (:REWRITE DEFAULT-CAR))
...
(BOOLEANP-OF-QFMISC2)
(QFMISC2)
(FORALL (1 1 (:TYPE-PRESCRIPTION FORALL)))
(QUANT-OK-TEST)
(QUANT-OK-TEST-NECC)
