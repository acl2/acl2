(KEYWORD-VALUE-LIST-TO-ALIST-AUX (190 89 (:REWRITE DEFAULT-+-2))
...
(KEYWORD-VALUE-LIST-TO-ALIST (190 89 (:REWRITE DEFAULT-+-2))
                             (124 89 (:REWRITE DEFAULT-+-1))
                             (72 18 (:REWRITE COMMUTATIVITY-OF-+))
                             (72 18 (:DEFINITION INTEGER-ABS))
                             (72 9 (:DEFINITION LENGTH))
                             ...
                             (9 9 (:REWRITE DEFAULT-COERCE-2))
                             (9 9 (:REWRITE DEFAULT-COERCE-1)))
(ALISTP-OF-KEYWORD-VALUE-LIST-TO-ALIST (12 11 (:REWRITE DEFAULT-CDR))
                                       (11 10 (:REWRITE DEFAULT-CAR)))
(VERIFY-GUARDS-LEMMA (78 78 (:REWRITE CONSP-OF-REV))
                     (30 30 (:REWRITE REV-WHEN-NOT-CONSP))
                     (18 18
                         (:REWRITE APPEND-ATOM-UNDER-LIST-EQUIV)))
(KEYWORD-VALUE-LIST-TO-ALIST (39 39 (:REWRITE DEFAULT-CDR))
                             (22 22 (:REWRITE DEFAULT-CAR))
                             (5 5
                                (:REWRITE DEFAULT-SYMBOL-PACKAGE-NAME)))
