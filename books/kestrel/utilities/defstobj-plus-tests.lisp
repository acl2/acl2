...
; However, 32-bit CMUCL is unhappy even _compiling_ the defun of
; create-large-array generated by the following event, presumably because the
; array-dimension-limit of 536870911 is exceeded.
#-cmucl
(defstobj+ large-array
  (memory :type (array (unsigned-byte 8) (4294967296)) ; 2^32 bytes
          :initially 0)
