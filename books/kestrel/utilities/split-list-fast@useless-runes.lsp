...
(TRUE-LISTP-OF-MV-NTH-1-OF-SPLIT-LIST-FAST
     ...
     (1 1 (:REWRITE DEFAULT-CAR)))
(LEN-OF-SPLIT-LIST-FAST-BOUND (28 14 (:REWRITE DEFAULT-+-2))
                              ...
                              (2 2 (:REWRITE DEFAULT-CAR)))
(LEN-OF-SPLIT-LIST-FAST-BOUND2 (31 16 (:REWRITE DEFAULT-+-2))
                               (24 24 (:REWRITE DEFAULT-CDR))
                               ...
                               (6 3 (:REWRITE DEFAULT-<-1))
                               (2 2 (:REWRITE DEFAULT-CAR)))
(SPLIT-LIST-FAST-LEN-THEOREM (30 6 (:DEFINITION LEN))
