...
(OMAP::FROM-LISTS-OF-LIST-FIX-KEYS-NORMALIZE-CONST)
...
(OMAP::FROM-LISTS-OF-LIST-FIX-VALS
     ...
     (8 8
        (:REWRITE OMAP::FROM-LISTS-OF-LIST-FIX-KEYS-NORMALIZE-CONST))
     (7 7 (:REWRITE LIST-FIX-WHEN-NOT-CONSP)))
(OMAP::FROM-LISTS-OF-LIST-FIX-VALS-NORMALIZE-CONST)
