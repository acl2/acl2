(SUBLIS-EXPR+-RESTRICT-ALIST-AUX (28 28 (:REWRITE DEFAULT-CAR))
...
(SUBLIS-EXPR+-RESTRICT-ALIST
     ...
     (96 8
         (:DEFINITION SUBLIS-EXPR+-RESTRICT-ALIST-AUX))
...
(MAKE-LAMBDA-TERM)
(SUBLIS-EXPR+ (405 175 (:REWRITE DEFAULT-+-2))
...
(R-SYMBOL-ALISTP-FORWARD-TO-ALISTP (21 21 (:REWRITE DEFAULT-CAR))
...
(SUBLIS-EXPR+-RESTRICT-ALIST-PRESERVES-R-SYMBOL-ALISTP
     ...
     (30 15 (:DEFINITION ADD-TO-SET-EQUAL))
     (15 15 (:DEFINITION MEMBER-EQUAL)))
(FLAG-SUBLIS-EXPR+ (737 335 (:REWRITE DEFAULT-+-2))
...
(LEN-SUBLIS-EXPR+-LST
     ...
     (61 1
         (:DEFINITION SUBLIS-EXPR+-RESTRICT-ALIST))
     ...
     (2 2
        (:TYPE-PRESCRIPTION SUBLIS-EXPR+-RESTRICT-ALIST-AUX))
     (2 2
...
(SYMBOL-LISTP-IMPLIES-PSEUDO-TERM-LISTP
     ...
     (6 6
        (:REWRITE TERMP-IMPLIES-PSEUDO-TERMP)))
(SYMBOL-LISTP-APPEND (21 18 (:REWRITE DEFAULT-CAR))
                     (18 15 (:REWRITE DEFAULT-CDR))
                     (18 9
                         (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
                     (9 9 (:TYPE-PRESCRIPTION TRUE-LISTP))
                     (9 9 (:TYPE-PRESCRIPTION BINARY-APPEND)))
(SYMBOL-LISTP-SET-DIFFERENCE-EQUAL (32 31 (:REWRITE DEFAULT-CAR))
...
(FLAG-LEMMA-FOR-PSEUDO-TERMP-SUBLIS-EXPR+
     ...
     (44 44
         (:TYPE-PRESCRIPTION SUBLIS-EXPR+-RESTRICT-ALIST))
     (34 34
         (:TYPE-PRESCRIPTION MEMBER-SYMBOL-NAME))
     (34 34
         (:REWRITE DEFAULT-SYMBOL-PACKAGE-NAME))
...
(SUBLIS-EXPR+ (653 68
                   (:REWRITE SYMBOL-LISTP-IMPLIES-PSEUDO-TERM-LISTP))
              ...
              (151 151
                   (:TYPE-PRESCRIPTION SUBLIS-EXPR+-LST))
              (124 2
                   (:DEFINITION SUBLIS-EXPR+-RESTRICT-ALIST))
