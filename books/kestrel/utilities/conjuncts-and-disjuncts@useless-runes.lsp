...
(PSEUDO-TERM-LISTP-OF-COMBINE-DISJUNCTS
     ...
     (2 2
        (:TYPE-PRESCRIPTION TRUE-LISTP-OF-UNION-EQUAL-TYPE)))
(TRUE-LISTP-OF-COMBINE-CONJUNCTS (2 1 (:DEFINITION TRUE-LISTP))
                                 (1 1 (:REWRITE DEFAULT-CDR)))
(TRUE-LISTP-OF-COMBINE-DISJUNCTS (2 1 (:DEFINITION TRUE-LISTP))
                                 (1 1 (:REWRITE DEFAULT-CDR)))
(NEGATE-ALL)
(NEGATE-TERMS)
...
(FLAG-LEMMA-FOR-PSEUDO-TERM-LISTP-OF-GET-CONJUNCTS-OF-TERM
    ...
    (28 14
        (:TYPE-PRESCRIPTION COMBINE-DISJUNCTS))
    (28 14
        (:TYPE-PRESCRIPTION COMBINE-CONJUNCTS)))
...
(GET-CONJUNCTS-OF-TERM
     ...
     (1139 8
           (:REWRITE PSEUDO-TERM-LISTP-OF-GET-DISJUNCTS-OF-TERM))
     (1139 8
           (:REWRITE PSEUDO-TERM-LISTP-OF-GET-CONJUNCTS-OF-TERM))
     ...
     (252 126
          (:REWRITE CONSP-OF-CAR-WHEN-SYMBOL-TERM-ALISTP-CHEAP))
     (170 1
          (:REWRITE PSEUDO-TERM-LISTP-OF-NEGATE-DISJUNCTS))
     (170 1
          (:REWRITE PSEUDO-TERM-LISTP-OF-NEGATE-CONJUNCTS))
     (160 80
          (:REWRITE PSEUDO-TERMP-OF-CAR-WHEN-PSEUDO-TERM-LISTP-CHEAP))
     (136 68
          (:REWRITE PSEUDO-TERM-LISTP-WHEN-SYMBOL-LISTP-CHEAP))
     ...
     (16 16
         (:TYPE-PRESCRIPTION GET-DISJUNCTS-OF-TERM))
     (16 16
         (:TYPE-PRESCRIPTION GET-CONJUNCTS-OF-TERM))
     (2 2 (:TYPE-PRESCRIPTION NEGATE-DISJUNCTS))
     (2 2
        (:TYPE-PRESCRIPTION NEGATE-CONJUNCTS)))
