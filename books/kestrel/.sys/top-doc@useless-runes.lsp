(DM::PRIMEP1397769327)
(DM::PRIMEP1368002223
 (4969 36 (:REWRITE MEMBER-OF-CONS))
 (2844 36 (:REWRITE MEMBER-EQUAL-OF-CONS-WHEN-NOT-EQUAL))
 (2304 100 (:REWRITE SET::EMPTY-SET-UNIQUE))
 (1027 13 (:REWRITE MEMBER-EQUAL-WHEN-SINGLETON-IFF))
 (525 50 (:REWRITE TRUE-LIST-LISTP-IMPLIES-TRUE-LISTP-XXX))
 (357 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-FORWARD-TO-TRUE-LISTP))
 (354 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-WHEN-SYMBOL-LISTP))
 (329 5 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (303 1 (:DEFINITION SYMBOL-LISTP))
 (300 50 (:REWRITE BITCOIN::SETP-WHEN-BIP32-PATH-SETP))
 (260 50 (:REWRITE MEMBER-EQUAL-OF-CONSTANT-TRIM))
 (225 2 (:REWRITE SYMBOL-LISTP-WHEN-NOT-CONSP))
 (202 100 (:REWRITE EQUAL-OF-BOOLEANS-CHEAP))
 (200 50 (:REWRITE SET::NONEMPTY-MEANS-SET))
 (198 50 (:REWRITE R1CS::NOT-MEMBER-EQUAL-WHEN-STRICT-SYMBOL<-SORTEDP-OF-REVERSE-LIST-AND-SYMBOL<-CAR))
