(DM::PRIMEP1616772882)
(DM::PRIMEP1653061074
 (12626 121 (:REWRITE MEMBER-OF-CONS))
 (4477 121 (:REWRITE MEMBER-EQUAL-OF-CONS-WHEN-NOT-EQUAL))
 (1118 145 (:REWRITE MEMBER-EQUAL-OF-SINGLETON-CONSTANT-IFF))
 (959 122 (:REWRITE MEMBER-EQUAL-OF-CONSTANT-TRIM))
 (817 145 (:REWRITE TRUE-LIST-LISTP-IMPLIES-TRUE-LISTP-XXX))
 (580 289 (:REWRITE EQUAL-OF-BOOLEANS-CHEAP))
 (482 145 (:REWRITE R1CS::NOT-MEMBER-EQUAL-WHEN-STRICT-SYMBOL<-SORTEDP-OF-REVERSE-LIST-AND-SYMBOL<-CAR))
 (438 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-FORWARD-TO-TRUE-LISTP))
 (435 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-WHEN-SYMBOL-LISTP))
 (363 1 (:DEFINITION SYMBOL-LISTP))
 (306 5 (:REWRITE CONSP-FROM-LEN-CHEAP))
 ...
 (268 2 (:REWRITE SYMBOL-LISTP-WHEN-NOT-CONSP))
 ...
 (63 1 (:REWRITE <-OF-CONSTANT-AND-+-OF-CONSTANT))
