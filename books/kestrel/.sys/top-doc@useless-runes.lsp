...
(DM::PRIMEP461906932
 ...
 (556 50 (:REWRITE TRUE-LIST-LISTP-IMPLIES-TRUE-LISTP-XXX))
 (529 50 (:REWRITE MEMBER-EQUAL-OF-SINGLETON-CONSTANT-IFF))
 (376 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-FORWARD-TO-TRUE-LISTP))
 (373 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-WHEN-SYMBOL-LISTP))
 (327 5 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (310 1 (:DEFINITION SYMBOL-LISTP))
 (239 2 (:REWRITE SYMBOL-LISTP-WHEN-NOT-CONSP))
 ...
 (60 1 (:REWRITE TRUE-LISTP-WHEN-NOT-CONSP))
