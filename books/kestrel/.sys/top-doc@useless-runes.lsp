...
(DM::PRIMEP1876731219
 ...
 (4656 100 (:REWRITE SET::EMPTY-SET-UNIQUE))
 (4536 36 (:REWRITE MEMBER-EQUAL-OF-CONS-WHEN-NOT-EQUAL))
 (2052 50 (:REWRITE OMAP::SETP-WHEN-MAPP))
 (1638 13 (:REWRITE MEMBER-EQUAL-WHEN-SINGLETON-IFF))
 (479 50 (:REWRITE TRUE-LIST-LISTP-IMPLIES-TRUE-LISTP-XXX))
 (324 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-FORWARD-TO-TRUE-LISTP))
 (321 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-WHEN-SYMBOL-LISTP))
 (300 50 (:REWRITE BITCOIN::SETP-WHEN-BIP32-PATH-SETP))
 (287 5 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (281 1 (:DEFINITION SYMBOL-LISTP))
 ...
 (194 2 (:REWRITE SYMBOL-LISTP-WHEN-NOT-CONSP))
