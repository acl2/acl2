(DM::PRIMEP1852080766)
(DM::PRIMEP1824442558
 (5185 36 (:REWRITE MEMBER-OF-CONS))
 (3060 36 (:REWRITE MEMBER-EQUAL-OF-CONS-WHEN-NOT-EQUAL))
 (2604 100 (:REWRITE SET::EMPTY-SET-UNIQUE))
 (1105 13 (:REWRITE MEMBER-EQUAL-WHEN-SINGLETON-IFF))
 (508 50 (:REWRITE TRUE-LIST-LISTP-IMPLIES-TRUE-LISTP-XXX))
 (346 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-FORWARD-TO-TRUE-LISTP))
 (343 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-WHEN-SYMBOL-LISTP))
 (314 5 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (300 50 (:REWRITE BITCOIN::SETP-WHEN-BIP32-PATH-SETP))
 (296 1 (:DEFINITION SYMBOL-LISTP))
 (260 50 (:REWRITE MEMBER-EQUAL-OF-CONSTANT-TRIM))
 (215 2 (:REWRITE SYMBOL-LISTP-WHEN-NOT-CONSP))
 ...
 (63 5 (:LINEAR LEN-POSITIVE-WHEN-CONSP-LINEAR-CHEAP))
