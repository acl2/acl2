(DM::PRIMEP1511308537)
(DM::PRIMEP1489958457
 (6224 36 (:REWRITE MEMBER-OF-CONS))
 (4256 100 (:REWRITE SET::EMPTY-SET-UNIQUE))
 (4248 36 (:REWRITE MEMBER-EQUAL-OF-CONS-DROP))
 (1952 50 (:REWRITE OMAP::SETP-WHEN-MAPP))
 (1534 13 (:REWRITE MEMBER-EQUAL-WHEN-SINGLETON-IFF))
 (503 50 (:REWRITE TRUE-LIST-LISTP-IMPLIES-TRUE-LISTP-XXX))
 (350 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-FORWARD-TO-TRUE-LISTP))
 (347 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-WHEN-SYMBOL-LISTP))
 (314 6 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (306 1 (:DEFINITION SYMBOL-LISTP))
 ...
 (190 2 (:REWRITE SYMBOL-LISTP-WHEN-NOT-CONSP))
