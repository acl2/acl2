(DM::PRIMEP1762371965)
(DM::PRIMEP1808917437
 (6584 36 (:REWRITE MEMBER-OF-CONS))
 (4428 36 (:REWRITE MEMBER-EQUAL-OF-CONS-DROP))
 (4361 106 (:REWRITE SET::EMPTY-SET-UNIQUE))
 (2052 50 (:REWRITE OMAP::SETP-WHEN-MAPP))
 (1599 13 (:REWRITE MEMBER-EQUAL-WHEN-SINGLETON-IFF))
 (545 50 (:REWRITE TRUE-LIST-LISTP-IMPLIES-TRUE-LISTP-XXX))
 (385 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-FORWARD-TO-TRUE-LISTP))
 (382 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-WHEN-SYMBOL-LISTP))
 (334 1 (:DEFINITION SYMBOL-LISTP))
 (300 50 (:REWRITE BITCOIN::SETP-WHEN-BIP32-PATH-SETP))
 (269 5 (:REWRITE CONSP-FROM-LEN-CHEAP))
 ...
 (224 2 (:REWRITE SYMBOL-LISTP-WHEN-NOT-CONSP))
 ...
 (44 1 (:REWRITE TRUE-LISTP-WHEN-NOT-CONSP))
