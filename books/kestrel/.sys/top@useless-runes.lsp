(DM::PRIMEP1038939065)
(DM::PRIMEP1060551033
 (6800 36 (:REWRITE MEMBER-OF-CONS))
 (4661 106 (:REWRITE SET::EMPTY-SET-UNIQUE))
 (4644 36 (:REWRITE MEMBER-EQUAL-OF-CONS-WHEN-NOT-EQUAL))
 (2052 50 (:REWRITE OMAP::SETP-WHEN-MAPP))
 (1677 13 (:REWRITE MEMBER-EQUAL-WHEN-SINGLETON-IFF))
 (554 50 (:REWRITE TRUE-LIST-LISTP-IMPLIES-TRUE-LISTP-XXX))
 (390 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-FORWARD-TO-TRUE-LISTP))
 (387 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-WHEN-SYMBOL-LISTP))
 (338 1 (:DEFINITION SYMBOL-LISTP))
 (300 50 (:REWRITE BITCOIN::SETP-WHEN-BIP32-PATH-SETP))
 (279 5 (:REWRITE CONSP-FROM-LEN-CHEAP))
 ...
 (231 2 (:REWRITE SYMBOL-LISTP-WHEN-NOT-CONSP))
 ...
 (46 1 (:REWRITE TRUE-LISTP-WHEN-NOT-CONSP))
