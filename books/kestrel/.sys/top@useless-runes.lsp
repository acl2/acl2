(DM::PRIMEP69147217)
(DM::PRIMEP113594513
 (3906 36 (:REWRITE MEMBER-OF-CONS))
 (1476 36 (:REWRITE MEMBER-EQUAL-OF-CONS-WHEN-NOT-EQUAL))
 (637 50 (:REWRITE TRUE-LIST-LISTP-IMPLIES-TRUE-LISTP-XXX))
 (620 50 (:REWRITE MEMBER-EQUAL-OF-SINGLETON-CONSTANT-IFF))
 (448 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-FORWARD-TO-TRUE-LISTP))
 (445 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-WHEN-SYMBOL-LISTP))
 (373 1 (:DEFINITION SYMBOL-LISTP))
 (327 5 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (277 2 (:REWRITE SYMBOL-LISTP-WHEN-NOT-CONSP))
 (240 50 (:REWRITE R1CS::NOT-MEMBER-EQUAL-WHEN-STRICT-SYMBOL<-SORTEDP-OF-REVERSE-LIST-AND-SYMBOL<-CAR))
 ...
 (69 1 (:REWRITE TRUE-LISTP-WHEN-NOT-CONSP))
