...
(DM::PRIMEP2004572086
 ...
 (611 50 (:REWRITE TRUE-LIST-LISTP-IMPLIES-TRUE-LISTP-XXX))
 (434 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-FORWARD-TO-TRUE-LISTP))
 (431 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-WHEN-SYMBOL-LISTP))
 (371 1 (:DEFINITION SYMBOL-LISTP))
 (327 5 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (265 2 (:REWRITE SYMBOL-LISTP-WHEN-NOT-CONSP))
