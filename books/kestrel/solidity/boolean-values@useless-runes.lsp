...
(SOLIDITY::BOOLP-OF-BOOL-FIX (12 4 (:REWRITE BOOL-FIX-WHEN-BOOLEANP))
...
(SOLIDITY::BOOL->GET$INLINE-OF-BOOL-FIX-X
     (9 3
        (:REWRITE SOLIDITY::BOOL-FIX-WHEN-BOOLP))
     (6 6 (:TYPE-PRESCRIPTION SOLIDITY::BOOLP)))
(SOLIDITY::BOOL->GET$INLINE-OF-BOOL-FIX-X-NORMALIZE-CONST)
(SOLIDITY::BOOL->GET$INLINE-BOOL-EQUIV-CONGRUENCE-ON-X)
(SOLIDITY::BOOL)
(SOLIDITY::BOOLP-OF-BOOL)
(SOLIDITY::BOOL->GET-OF-BOOL)
(SOLIDITY::BOOL-OF-FIELDS (3 1
                             (:REWRITE SOLIDITY::BOOL-FIX-WHEN-BOOLP))
                          (2 2 (:TYPE-PRESCRIPTION SOLIDITY::BOOLP)))
(SOLIDITY::BOOL-FIX-WHEN-BOOL (3 1
                                 (:REWRITE SOLIDITY::BOOL-FIX-WHEN-BOOLP))
                              (2 2 (:TYPE-PRESCRIPTION SOLIDITY::BOOLP)))
(SOLIDITY::EQUAL-OF-BOOL
     (9 9
        (:REWRITE SOLIDITY::BOOL->GET$INLINE-OF-BOOL-FIX-X-NORMALIZE-CONST)))
(SOLIDITY::BOOL-OF-BOOL-FIX-GET)
(SOLIDITY::BOOL-OF-BOOL-FIX-GET-NORMALIZE-CONST)
