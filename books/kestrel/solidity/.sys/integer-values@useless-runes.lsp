...
(SOLIDITY::UINT->SIZE$INLINE
 (11 11 (:TYPE-PRESCRIPTION SOLIDITY::BIT-SIZE-FIX))
 (1 1 (:REWRITE NATP-RW))
 )
...
(SOLIDITY::UINT->VALUE$INLINE
 ...
 (9 9 (:REWRITE INTEGER-LISTP-WHEN-NOT-CONSP))
 (9 9 (:REWRITE DEFAULT-<-1))
 (8 8 (:TYPE-PRESCRIPTION SOLIDITY::BIT-SIZE-FIX))
 (6 2 (:REWRITE COMMUTATIVITY-OF-+))
 (5 5 (:TYPE-PRESCRIPTION SET::EMPTYP-TYPE))
 (5 5 (:REWRITE SET::IN-SET))
 (4 4 (:REWRITE DEFAULT-+-2))
...
(SOLIDITY::UINT-OF-FIELDS
 (51 6 (:REWRITE FTY::PROVE-EQUAL-OF-CONS-WHEN-FIRST-QUOTEP))
...
(SOLIDITY::EQUAL-OF-UINT
 ...
 (14 10 (:REWRITE FTY::PROVE-EQUAL-OF-CONS-WHEN-FIRST-QUOTEP))
...
(SOLIDITY::INTP-OF-INT-FIX
 ...
 (216 36 (:REWRITE COMMUTATIVITY-OF-+))
...
(SOLIDITY::TAG-OF-INT
 ...
 (33 13 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
