...
(PRIMES::RESIDUE-MEANING (210 105 (:TYPE-PRESCRIPTION RTL::NATP-MOD))
...
(PRIMES::RESIDUE-MEANING-BACKWARDS (54 2 (:DEFINITION EXPT))
                                   ...
                                   (2 2 (:DEFINITION FIX)))
(PRIMES::NO-SQUARE-ROOT-FORALL (100 50 (:TYPE-PRESCRIPTION RTL::NATP-MOD))
