...
(acl2::defmacrodoc defprime-alias (name existing-prime-name &key
  ...
  :inputs (name "Name of the prime to introduce, a symbol."
           ...
           :short "Xdoc :short description for the prime."
           :long "Xdoc :long section for the prime.")
  :long "Defprime-alias generates all of the things generated by @(tsee defprime), except that it omits the call to @(tsee add-io-pairs), since that has already been done for the existing prime, which has the same numeric value as the new prime.")
