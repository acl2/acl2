...
(acl2::defmacrodoc defprime (name number pratt-cert
  ...
  :long (xdoc::topstring
         ...
         (xdoc::ul "A constant, *FOO*, representing the prime."
                   ...
                   "A call of @(tsee add-io-pairs) to cause rtl::primep to be fast when called on the prime."
...
(acl2::defmacrodoc defprime-alias (name existing-prime-name &key
  ...
  :inputs (name "Name of the prime to introduce, a symbol."
           ...
           :short "Xdoc :short description for the prime."
           :long "Xdoc :long section for the prime.")
  :long "Defprime-alias generates all of the things generated by @(tsee defprime), except that it omits the defconst for the Pratt certificate and the call to @(tsee add-io-pairs) (since that has already been done for the existing prime, which has the same numeric value).")
