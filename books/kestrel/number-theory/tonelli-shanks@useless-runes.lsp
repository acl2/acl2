...
(PRIMES::NATP-OF-Q*2^S.S (64 49 (:REWRITE DEFAULT-<-1))
                         ...
                         (4 4 (:LINEAR <-OF-*-AND-*-SAME-LINEAR-2))
                         (4 4 (:LINEAR <-OF-*-AND-*-SAME-LINEAR-1)))
(PRIMES::Q*2^S (31 1 (:DEFINITION PRIMES::Q*2^S))
...
(PRIMES::Q2S-Q-IS-ODD (39 13 (:REWRITE RTL::ODDP-ODD-PRIME))
                      ...
                      (6 6 (:REWRITE DEFAULT-*-1)))
(PRIMES::Q*2^S-TYPE-1)
(PRIMES::Q2S-IS-CORRECT (274 14 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
...
(PRIMES::LEAST-REPEATED-SQUARE-AUX
     ...
     (56 56 (:LINEAR <-OF-*-AND-*))
     (47 7
         (:REWRITE PRIMES::NO-SQUARE-ROOT-FORALL))
     (38 2
     ...
     (3 3
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (2 2
        (:TYPE-PRESCRIPTION PRIMES::HAS-SQUARE-ROOT?))
...
(PRIMES::LEAST-REPEATED-SQUARE-LESS-THAN-M
     ...
     (1 1
        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(PRIMES::REPEATED-SQUARE (9 9 (:REWRITE DEFAULT-<-2))
...
(PRIMES::T-S-AUX
     ...
     (2 2
        (:REWRITE MOD-OF-*-SUBST-CONSTANT-ARG1)))
(PRIMES::TONELLI-SHANKS-SQRT (12 12 (:REWRITE DEFAULT-+-2))
