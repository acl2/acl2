...
(include-book "kestrel/data/treeset/internal/count-defs" :dir :system)
...
(local (include-book "kestrel/data/treeset/internal/count" :dir :system))
...
;; TODO: remove the following rules, if we are going to rewrite to count of
;; keys?
