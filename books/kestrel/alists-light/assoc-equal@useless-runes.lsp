...
(ASSOC-EQUAL-OF-CONS (11 11 (:REWRITE DEFAULT-CAR))
                     (6 6
                        (:REWRITE ASSOC-EQUAL-WHEN-NOT-CONSP-CHEAP))
                     (3 3 (:REWRITE DEFAULT-CDR)))
(ASSOC-EQUAL-OF-CONS-SAFE (11 11 (:REWRITE DEFAULT-CAR))
                          (6 6
                             (:REWRITE ASSOC-EQUAL-WHEN-NOT-CONSP-CHEAP))
                          (3 3 (:REWRITE DEFAULT-CDR)))
(ASSOC-EQUAL-OF-ACONS (12 2 (:DEFINITION ASSOC-EQUAL))
                      (7 7 (:REWRITE DEFAULT-CAR))
                      (4 4
                         (:REWRITE ASSOC-EQUAL-WHEN-NOT-CONSP-CHEAP))
                      (2 2 (:REWRITE DEFAULT-CDR)))
(ASSOC-EQUAL-OF-ACONS-DIFF (2 2
                              (:REWRITE ASSOC-EQUAL-WHEN-NOT-CONSP-CHEAP))
                           (1 1 (:REWRITE DEFAULT-CAR)))
(ASSOC-EQUAL-OF-ACONS-SAME (1 1 (:REWRITE DEFAULT-CAR)))
(ASSOC-EQUAL-OF-APPEND-1 (46 46 (:REWRITE DEFAULT-CAR))
                         (33 21
                             (:REWRITE ASSOC-EQUAL-WHEN-NOT-CONSP-CHEAP))
                         (24 12
...
(ASSOC-EQUAL-OF-APPEND-2 (126 126 (:REWRITE DEFAULT-CAR))
                         (60 30
                             (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
...
(ASSOC-EQUAL-OF-APPEND (152 24 (:DEFINITION ASSOC-EQUAL))
