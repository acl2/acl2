...
(ACL2PL::CONSP-OF-STACK-FIX (12 2
                                (:REWRITE ACL2PL::STACK-FIX-WHEN-STACKP))
                            ...
                            (4 1
                               (:REWRITE ACL2PL::FRAMEP-OF-CAR-WHEN-STACKP))
                            (2 2 (:TYPE-PRESCRIPTION ACL2PL::FRAMEP)))
(ACL2PL::STACK-FIX-UNDER-IFF (12 2
                                 (:REWRITE ACL2PL::STACK-FIX-WHEN-STACKP))
                             (8 8 (:TYPE-PRESCRIPTION ACL2PL::STACKP))
                             (7 1
                                (:REWRITE ACL2PL::FRAME-FIX-WHEN-FRAMEP))
...
(ACL2PL::NTH-OF-STACK-FIX
     ...
     (13 13
         (:REWRITE ACL2PL::CONSP-OF-STACK-FIX))
     (12 4 (:REWRITE FOLD-CONSTS-IN-+))
     (10 4 (:REWRITE DEFAULT-CAR))
     (2 2
        (:REWRITE-QUOTED-CONSTANT ACL2PL::FRAME-FIX-UNDER-FRAME-EQUIV)))
