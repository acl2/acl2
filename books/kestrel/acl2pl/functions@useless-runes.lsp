...
(ACL2PL::BOOLEANP-OFFUNCTION-SETP (6 2 (:DEFINITION ACL2PL::FUNCTION-SETP))
                                  (2 2
                                     (:TYPE-PRESCRIPTION ACL2PL::FUNCTIONP))
...
(ACL2PL::FUNCTION-SETP-OF-INSERT
     (3123 197 (:REWRITE SET::SFIX-WHEN-EMPTY))
     (2296 269 (:REWRITE SET::NONEMPTY-MEANS-SET))
     (1696 1427 (:REWRITE <<-TRANSITIVE))
     (1418 1406 (:REWRITE DEFAULT-CDR))
     (1107 1099 (:REWRITE DEFAULT-CAR))
     (930 102 (:REWRITE SET::HEAD-WHEN-EMPTY))
     (864 36 (:REWRITE SET::INSERT-WHEN-EMPTY))
     (848 32 (:REWRITE SET::TAIL-WHEN-EMPTY))
     (737 269
          (:REWRITE ACL2PL::SETP-WHEN-SYMBOL-VALUE-SETP))
     (468 468
          (:TYPE-PRESCRIPTION ACL2PL::SYMBOL-VALUE-SETP))
...
(ACL2PL::FUNCTION-SETP-OF-UNION
     ...
     (10666 800 (:REWRITE SET::NONEMPTY-MEANS-SET))
     (9984 16 (:REWRITE SET::INSERT-IDENTITY))
     (9952 16 (:REWRITE SET::UNION-IN))
     (9888 64 (:REWRITE SET::IN-TAIL))
     (6883 1176 (:REWRITE <<-ASYMMETRIC))
     (6365 170 (:REWRITE SET::SFIX-WHEN-EMPTY))
     (5024 22 (:REWRITE SET::UNION-EMPTY))
     (4402 806
           (:REWRITE ACL2PL::SETP-WHEN-SYMBOL-VALUE-SETP))
     (4156 16 (:REWRITE SET::INSERT-WHEN-EMPTY))
     ...
     (1832 48 (:REWRITE SET::TAIL-WHEN-EMPTY))
     (1404 1404
           (:TYPE-PRESCRIPTION ACL2PL::SYMBOL-VALUE-SETP))
     (1232 32 (:REWRITE SET::UNION-EMPTY-Y))
     (1176 32 (:REWRITE SET::UNION-EMPTY-X))
     (1058 1058
           (:REWRITE ACL2PL::FUNCTIONP-WHEN-IN-FUNCTION-SETP-BINDS-FREE-X))
     (800 800 (:REWRITE SET::IN-SET))
     (520 16 (:REWRITE SET::HEAD-WHEN-EMPTY))
