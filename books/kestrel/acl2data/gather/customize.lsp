; WARNING: Keep this in sync with customize-advice.lsp.
...
; Raw lisp backtrace shows tau issue
   ((:system . "system/eviscerate-top-support.lisp") :rune)
...
; Mismatch for built-ins with large arity
   ((:system . "demos/loop-primer/lp6.lisp"))

; Killed because they were taking hours
   ((:system . "projects/numbers/support/pratt.lisp"))
...
(include-book "kestrel/acl2data/gather/patch-book"
              :dir :system
              :ttags :all
