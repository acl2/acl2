...
(YUL::MODE-SETP-OF-INSERT
 ...
 (106 10 (:REWRITE SET::INSERT-WHEN-EMPTYP))
...
(YUL::NOT-IN-MODE-SETP-WHEN-NOT-MODEP
 (4 1 (:DEFINITION YUL::MODE-SETP))
 (1 1 (:TYPE-PRESCRIPTION FAST-<<))
 )
(YUL::MODE-SETP-OF-UNION
 (418 418 (:REWRITE YUL::MODEP-WHEN-IN-MODE-SETP-BINDS-FREE-X))
 (36 36 (:TYPE-PRESCRIPTION SET::INSERT))
 )
(YUL::MODE-SETP-OF-INTERSECT
...
(YUL::MODE-SETP-WHEN-RESULT-NOT-ERROR)
(YUL::RESERRP-WHEN-MODE-SET-RESULTP-NOT-OK)
