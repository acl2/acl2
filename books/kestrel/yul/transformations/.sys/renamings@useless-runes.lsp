...
(YUL::RENAMING-RESULT-ERR->GET$INLINE-OF-RENAMING-RESULT-FIX-X
 (124 8 (:REWRITE FTY::RESERR-FIX-WHEN-RESERRP))
 (108 8 (:DEFINITION FTY::RESERRP))
 ...
 (2 2 (:TYPE-PRESCRIPTION FTY::RESERR-FIX$INLINE))
...
(YUL::EQUAL-OF-RENAMING-RESULT-ERR
 (180 6 (:REWRITE FTY::RESERR-FIX-WHEN-RESERRP))
 (162 6 (:DEFINITION FTY::RESERRP))
 (64 4 (:REWRITE OMAP::ALISTP-WHEN-MAPP))
