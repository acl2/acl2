(LOGTAIL-OF-0-ARG1 (72 2 (:LINEAR MY-FLOOR-LOWER-BOUND-LINEAR))
...
(LOGTAIL-WHEN-NOT-POSP-ARG1
     ...
     (1 1 (:LINEAR <-OF-*-AND-*-SAME-LINEAR-2))
     (1 1 (:LINEAR <-OF-*-AND-*-SAME-LINEAR-1)))
(LOGTAIL-SHIFT (81 3 (:REWRITE FLOOR-WHEN-<))
...
(LOGTAIL-SHIFT-ALT (110 2 (:LINEAR LOGTAIL-LEQ))
...
(LOGTAIL-OF-SUM2 (65 3 (:REWRITE LOGTAIL-BECOMES-0))
...
(LOGTAIL-SHIFT-GEN2-ALT
     ...
     (1 1 (:REWRITE EQUAL-OF-*-AND-CONSTANT))
     (1 1 (:REWRITE DEFAULT-UNARY-MINUS)))
(<-OF-LOGTAIL-SAME (70 5 (:DEFINITION EXPT))
