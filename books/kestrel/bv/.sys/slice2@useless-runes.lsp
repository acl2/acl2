(<-TIGHTEN-WHEN-SLICE-IS-0
 (373 19 (:REWRITE UNSIGNED-BYTE-P-PLUS))
 (195 1 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
...
(REWRITE-UNSIGNED-BYTE-P-WHEN-TERM-SIZE-IS-LARGER
 (84 8 (:REWRITE USB-SLICE-HELPER))
 (51 2 (:REWRITE SLICE-TOO-HIGH-IS-0))
