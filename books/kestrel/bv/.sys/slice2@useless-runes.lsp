(<-TIGHTEN-WHEN-SLICE-IS-0
 (378 19 (:REWRITE UNSIGNED-BYTE-P-PLUS))
 (196 1 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
 ...
 (28 1 (:LINEAR LOGTAIL-LEQ))
 (26 1 (:LINEAR LOGTAIL-NON-NEGATIVE-LINEAR))
...
(REWRITE-UNSIGNED-BYTE-P-WHEN-TERM-SIZE-IS-LARGER
 (85 8 (:REWRITE USB-SLICE-HELPER))
 (52 2 (:REWRITE SLICE-TOO-HIGH-IS-0))
 (46 2 (:DEFINITION EXPT))
 (45 4 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
