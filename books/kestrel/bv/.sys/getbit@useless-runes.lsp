...
(GETBIT-OF-+-OF-EXPT-2
 (1539 20 (:REWRITE BVCHOP-IDENTITY))
 (770 35 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (400 50 (:LINEAR <=-OF-LOGTAIL-SAME-LINEAR))
 (351 12 (:REWRITE UNSIGNED-BYTE-P-OF-+-OF-CONSTANT-STRONG))
 (341 12 (:REWRITE USB-PLUS-FROM-BOUNDS))
 (220 190 (:REWRITE DEFAULT-<-1))
 (200 50 (:LINEAR LOGTAIL-NON-NEGATIVE-LINEAR))
 (200 50 (:DEFINITION NATP))
 (200 8 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
 (199 199 (:TYPE-PRESCRIPTION LOGTAIL-NON-POSITIVE))
 (190 190 (:REWRITE DEFAULT-<-2))
 (153 46 (:REWRITE <-OF-LOGTAIL-ARG1))
...
(GETBIT-OF-+-OF-CONSTANT-IRREL
 (386 4 (:REWRITE SLICE-TOO-HIGH-IS-0))
