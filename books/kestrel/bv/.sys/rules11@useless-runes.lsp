...
(BVCAT-OF-+-OF-BVCHOP
 (263 7 (:REWRITE BVCHOP-IDENTITY))
 (213 2 (:REWRITE USB-PLUS-FROM-BOUNDS))
...
(BVPLUS-OF-BVCAT-FITS-IN-LOW-BITS-CORE-NEGATIVE-K1-HELPER
 (1397 30 (:REWRITE BVCHOP-IDENTITY))
