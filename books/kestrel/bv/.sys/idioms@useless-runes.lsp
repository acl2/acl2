(GETBIT-BECOMES-SHIFT-OF-MASK
 (8080 8 (:REWRITE BVAND-WITH-MASK-BETTER))
 (8064 8 (:DEFINITION LOGMASKP))
 (4560 80 (:REWRITE <-OF-EXPT-2-AND-CONSTANT))
 (4336 56 (:REWRITE SLICE-TOO-HIGH-IS-0))
 (4192 24 (:REWRITE EQUAL-OF-+-WHEN-NEGATIVE-CONSTANT))
 (3739 59 (:REWRITE SLICE-TOO-HIGH-LEMMA))
 (3737 57 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
 (1860 16 (:LINEAR <-OF-EXPT-OF-ONE-LESS-OF-INTEGER-LENGTH-LINEAR))
 (1828 8 (:DEFINITION EXPT2$INLINE))
 (1820 8 (:DEFINITION NFIX))
 (1692 8 (:REWRITE <-OF-INTEGER-LENGTH-ARG1))
 (1624 104 (:REWRITE EQUAL-OF-EXPT-AND-CONSTANT))
 (765 295 (:REWRITE DEFAULT-+-2))
...
(SLICE-BECOMES-SHIFT-OF-MASK
 ...
 (914 8 (:REWRITE SLICE-TOO-HIGH-IS-0))
 (807 8 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
 (604 13 (:REWRITE EQUAL-OF-+-WHEN-NEGATIVE-CONSTANT))
 (388 12 (:LINEAR INTEGER-LENGTH-BOUND))
 (308 23 (:REWRITE EQUAL-OF-EXPT-AND-CONSTANT))
