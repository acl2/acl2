...
(BVCOUNT-OF-BVCAT
 (18991 156 (:REWRITE BVCOUNT-WHEN-UNSIGNED-BYTE-P-1))
 (16874 38 (:REWRITE UNSIGNED-BYTE-P-OF-BVCAT-ALL-CASES))
 (10836 782 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (4606 511 (:REWRITE BVCHOP-IDENTITY))
 (3782 236 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR-2))
 (3740 118 (:LINEAR BVCHOP-UPPER-BOUND-LINEAR-STRONG))
 (3130 118 (:LINEAR BVCHOP-UPPER-BOUND))
 (2279 1109 (:REWRITE DEFAULT-<-1))
 (1601 1601 (:TYPE-PRESCRIPTION UNSIGNED-BYTE-P))
 (1386 932 (:REWRITE DEFAULT-+-2))
 (1336 2 (:REWRITE UNSIGNED-BYTE-P-OF-IF))
 ...
 (868 868 (:TYPE-PRESCRIPTION RATIONALP-EXPT-TYPE-PRESCRIPTION))
 (868 868 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-NON-ZERO-BASE))
 (822 822 (:REWRITE UNSIGNED-BYTE-P-TIGHTEN-WHEN-SLICE-IS-0))
 (817 817 (:REWRITE BOUND-WHEN-USB))
 (782 782 (:REWRITE UNSIGNED-BYTE-P-WHEN-UNSIGNED-BYTE-P-SMALLER))
 (782 782 (:REWRITE UNSIGNED-BYTE-P-WHEN-<=-CHEAP))
 (782 782 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
 (704 511 (:REWRITE BVCHOP-WHEN-SIZE-IS-NOT-POSP))
 ...
 (475 475 (:REWRITE BVCHOP-WHEN-SIZE-IS-NOT-NATP))
 (475 475 (:REWRITE BVCHOP-WHEN-NOT-NATP-ARG1-CHEAP))
 (475 475 (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER-CHEAP))
 ...
 (260 122 (:REWRITE GETBIT-WHEN-N-IS-NEGATIVE))
