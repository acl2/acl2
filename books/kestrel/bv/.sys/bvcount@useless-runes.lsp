...
(BVCOUNT-OF-BVCAT-IRREL
 (1330 31 (:REWRITE BVCOUNT-WHEN-UNSIGNED-BYTE-P-1))
 (834 58 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (304 16 (:REWRITE BVCAT-NUMERIC-BOUND))
 (302 214 (:REWRITE DEFAULT-<-1))
 (299 199 (:REWRITE DEFAULT-+-2))
 (299 199 (:REWRITE DEFAULT-+-1))
 (246 214 (:REWRITE DEFAULT-<-2))
 (240 16 (:REWRITE UNSIGNED-BYTE-P-OF-BVCAT))
 (201 201 (:REWRITE BOUND-WHEN-USB))
 (160 16 (:REWRITE UNSIGNED-BYTE-P-OF-BVCAT-ALL-CASES))
 (160 16 (:LINEAR BVCAT-UPPER-BOUND-LINEAR))
...
(BVCOUNT-TIGHTEN-SIZE
 (1087 51 (:REWRITE BVCOUNT-WHEN-UNSIGNED-BYTE-P-1))
 (477 52 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
 (241 53 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (201 174 (:REWRITE DEFAULT-<-2))
 (174 174 (:REWRITE DEFAULT-<-1))
 (158 106 (:REWRITE DEFAULT-+-2))
 (154 106 (:REWRITE DEFAULT-+-1))
 (129 129 (:REWRITE BOUND-WHEN-USB))
 (65 33 (:REWRITE GETBIT-WHEN-NOT-0))
 (53 53 (:REWRITE UNSIGNED-BYTE-P-WHEN-<=-CHEAP))
