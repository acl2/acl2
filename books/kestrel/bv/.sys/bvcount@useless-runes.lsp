...
(BVCOUNT-OF-BVCAT-OF-1-ARG1
 (1468 9 (:REWRITE BVCOUNT-WHEN-UNSIGNED-BYTE-P-1))
 (1404 3 (:REWRITE UNSIGNED-BYTE-P-OF-BVCAT-ALL-CASES))
 (667 67 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (507 45 (:REWRITE BVCHOP-IDENTITY))
 (420 18 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR-2))
 (255 9 (:LINEAR BVCHOP-UPPER-BOUND-LINEAR-STRONG))
 (225 9 (:LINEAR BVCHOP-UPPER-BOUND-LINEAR))
...
(BVCOUNT-OF-BVCHOP-GEN
 (1303 23 (:REWRITE BVCOUNT-WHEN-UNSIGNED-BYTE-P-1))
 (1094 66 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (307 14 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR-2))
 (306 33 (:REWRITE BVCHOP-IDENTITY))
 (223 7 (:LINEAR BVCHOP-UPPER-BOUND-LINEAR-STRONG))
 (183 7 (:LINEAR BVCHOP-UPPER-BOUND-LINEAR))
...
(BVCOUNT-OF-BVCAT
 (19707 156 (:REWRITE BVCOUNT-WHEN-UNSIGNED-BYTE-P-1))
 (17576 38 (:REWRITE UNSIGNED-BYTE-P-OF-BVCAT-ALL-CASES))
 (11750 782 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (4606 511 (:REWRITE BVCHOP-IDENTITY))
 (3698 236 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR-2))
 (3622 118 (:LINEAR BVCHOP-UPPER-BOUND-LINEAR-STRONG))
 (3012 118 (:LINEAR BVCHOP-UPPER-BOUND-LINEAR))
 (2429 1261 (:REWRITE DEFAULT-<-1))
 (1601 1601 (:TYPE-PRESCRIPTION UNSIGNED-BYTE-P))
 (1388 2 (:REWRITE UNSIGNED-BYTE-P-OF-IF))
 (1386 932 (:REWRITE DEFAULT-+-2))
 (1261 1261 (:REWRITE DEFAULT-<-2))
 ...
 (1102 1102 (:TYPE-PRESCRIPTION RATIONALP-EXPT-TYPE-PRESCRIPTION))
 (1102 1102 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-NON-ZERO-BASE))
 ...
 (822 822 (:REWRITE UNSIGNED-BYTE-P-TIGHTEN-WHEN-SLICE-IS-0))
 (780 780 (:REWRITE UNSIGNED-BYTE-P-WHEN-UNSIGNED-BYTE-P-SMALLER))
 (780 780 (:REWRITE UNSIGNED-BYTE-P-WHEN-<=-CHEAP))
 (780 780 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
 (668 475 (:REWRITE BVCHOP-WHEN-SIZE-IS-NOT-POSP))
 (618 78 (:REWRITE <-OF-CONSTANT-AND-EXPT-2))
 (588 588 (:REWRITE INTEGERP-FROM-UNSIGNED-BYTE-P-SIZE-PARAM))
 ...
 (364 364 (:REWRITE ACL2-NUMBERP-WHEN-UNSIGNED-BYTE-P))
 (364 364 (:REWRITE ACL2-NUMBERP-FROM-UNSIGNED-BYTE-P-SIZE-PARAM))
 (304 76 (:REWRITE UNSIGNED-BYTE-P-OF-BVCHOP))
 (258 122 (:REWRITE GETBIT-WHEN-N-IS-NEGATIVE))
 ...
 (97 7 (:REWRITE GETBIT-OF-0-WHEN-BITP))
