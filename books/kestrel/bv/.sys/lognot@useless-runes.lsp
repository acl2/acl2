...
(FLOOR-OF-LOGNOT-AND-EXPT
 ...
 (1039 119 (:REWRITE DEFAULT-+-2))
 (979 145 (:REWRITE DEFAULT-UNARY-/))
 (567 320 (:REWRITE DEFAULT-<-2))
 (542 119 (:REWRITE DEFAULT-+-1))
 (532 76 (:REWRITE DEFAULT-UNARY-MINUS))
 (522 135 (:REWRITE DEFAULT-*-2))
 (498 82 (:REWRITE INTEGERP-OF-*))
 (478 83 (:REWRITE INTEGERP-OF-/-OF-EXPT-2))
 (462 320 (:REWRITE DEFAULT-<-1))
