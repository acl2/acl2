...
(INTEGERP-FROM-UNSIGNED-BYTE-P-SIZE-PARAM-FW
 (30 30 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-INTEGERP))
 (5 1 (:LINEAR EXPT->-1))
...
(NON-NEGATIVE-FROM-UNSIGNED-BYTE-P-SIZE-PARAM-FW
 (29 29 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-INTEGERP))
...
(UNSIGNED-BYTE-P-OF-+-ARG1-A
 ...
 (29 1 (:LINEAR X*Y>1-POSITIVE))
 (19 10 (:REWRITE DEFAULT-<-2))
 (19 4 (:REWRITE DEFAULT-*-2))
 (12 9 (:REWRITE EXPT-WITH-VIOLATED-GUARDS))
 (11 2 (:REWRITE UNSIGNED-BYTE-P-FALSE-WHEN-NOT-LONGER))
 (10 10 (:REWRITE DEFAULT-<-1))
 (9 3 (:REWRITE COMMUTATIVITY-OF-+))
