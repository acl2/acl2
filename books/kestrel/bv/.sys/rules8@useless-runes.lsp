...
(FLOOR-OF-SUM-OF-MINUS-EXPT-AND-BVCHOP
 ...
 (1848 10 (:REWRITE FLOOR-MUST-BE-1))
 (1376 10 (:REWRITE FLOOR-WHEN-<))
 (1356 24 (:REWRITE INTEGERP-OF-*-OF-/-WHEN-<-AND-NEGATIVE))
 (1347 10 (:REWRITE FLOOR-OF-+-WHEN-MULT-ARG2))
 (1288 22 (:REWRITE SMALL-INT-HACK))
 (1226 2 (:REWRITE FLOOR-UNIQUE-EQUAL-VERSION))
 (1009 12 (:REWRITE INTEGERP-OF--))
 (881 10 (:REWRITE FLOOR-OF-+-WHEN-MULT-ARG1))
 (860 52 (:LINEAR BVCHOP-UPPER-BOUND-LINEAR-STRONG))
 (800 10 (:REWRITE FLOOR-WHEN-<=))
 (750 64 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
 (688 43 (:DEFINITION NATP))
 (685 685 (:TYPE-PRESCRIPTION NATP-OF-EXPT))
 (685 685 (:TYPE-PRESCRIPTION INTEGERP-OF-EXPT-TYPE))
 (682 52 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
 (544 2 (:REWRITE <-OF-*-OF-/-ARG2-ALT))
 (524 203 (:REWRITE DEFAULT-<-2))
 (515 64 (:REWRITE BVCHOP-IDENTITY))
 (463 203 (:REWRITE DEFAULT-<-1))
 (445 2 (:LINEAR FLOOR-BOUND-ARG1-LINEAR))
 (249 249 (:TYPE-PRESCRIPTION UNSIGNED-BYTE-P))
 (242 154 (:REWRITE NOT-<-WHEN-SBVLT))
 (228 2 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
 ...
 (161 1 (:REWRITE <-OF-+-OF---AND-0-ARG1))
...
(FLOOR-OF-SUM-OF-MINUS-EXPT-AND-BVCHOP-ARG2
 ...
 (502 3 (:REWRITE FLOOR-MUST-BE-1))
 (448 1 (:REWRITE DEFAULT-UNARY-/))
 (408 3 (:REWRITE FLOOR-WHEN-<))
 (266 16 (:LINEAR BVCHOP-UPPER-BOUND-LINEAR-STRONG))
 (246 22 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
 (246 3 (:REWRITE FLOOR-WHEN-<=))
 ...
 (161 1 (:REWRITE INTEGERP-OF-*-OF-/-WHEN-<-AND-MIXED-1))
 (150 54 (:REWRITE DEFAULT-<-2))
 (138 1 (:REWRITE INTEGERP-OF-*-OF-/-WHEN-<-AND-NEGATIVE-ALT))
 (137 1 (:REWRITE INTEGERP-OF-*-OF-/-WHEN-<-AND-MIXED-2))
...
(INTEGERP-OF-TIMES-OF-/-OF-EXPT-AND-MINUS-OF-BVCHOP
 (897 3 (:REWRITE DEFAULT-UNARY-/))
 (837 15 (:LINEAR BVCHOP-UPPER-BOUND))
 (388 2 (:REWRITE INTEGERP-OF-*-OF-/-WHEN-<-AND-NEGATIVE-ALT))
 (322 2 (:REWRITE INTEGERP-OF-*-OF-/-WHEN-<-AND-MIXED-1))
 (300 15 (:LINEAR BVCHOP-UPPER-BOUND-LINEAR-STRONG))
 (274 2 (:REWRITE INTEGERP-OF-*-OF-/-WHEN-<-AND-MIXED-2))
 (241 17 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
 (240 15 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
 (240 15 (:DEFINITION NATP))
 (219 1 (:REWRITE EQUAL-OF-0-AND-+-OF---ALT))
 (219 1 (:REWRITE EQUAL-OF-0-AND-+-OF--))
 (161 17 (:REWRITE BVCHOP-IDENTITY))
 (126 53 (:REWRITE DEFAULT-<-2))
 (116 2 (:REWRITE SMALL-INT-HACK))
