...
(BVMULT-OF-1-ARG3
 (110 4 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
...
(BVMULT-OF-BVCHOP-ARG3
 ...
 (158 158 (:REWRITE BVCHOP-IDENTITY-FREE))
...
(BVMULT-COMMUTATIVE
 (280 4 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
...
(GETBIT-0-OF-BVMULT
 (353 2 (:REWRITE GETBIT-OF-0-WHEN-BITP))
 (347 2 (:DEFINITION BITP))
...
(BVMULT-WHEN-ARG1-IS-NOT-AN-INTEGER
 (70 1 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
...
(BVMULT-OF-BVCHOP-1-BETTER
 ...
 (263 263 (:REWRITE BVCHOP-IDENTITY-FREE))
