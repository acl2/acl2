...
(BVMULT-OF-BVCHOP-ARG3
 ...
 (436 146 (:REWRITE BVCHOP-IDENTITY))
...
(BVMULT-OF-BVCHOP-1-BETTER
 ...
 (832 64 (:DEFINITION EXPT))
 (641 215 (:REWRITE BVCHOP-IDENTITY))
 (440 440 (:TYPE-PRESCRIPTION IFIX))
 (426 426 (:TYPE-PRESCRIPTION UNSIGNED-BYTE-P))
 (368 124 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
 (326 294 (:REWRITE DEFAULT-<-2))
 (318 294 (:REWRITE DEFAULT-<-1))
 (278 129 (:REWRITE DEFAULT-*-2))
 (224 160 (:REWRITE DEFAULT-+-2))
 (215 215 (:REWRITE BVCHOP-SUBST-CONSTANT))
 (215 215 (:REWRITE BVCHOP-IDENTITY-CHEAP))
 (210 124 (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER))
 (192 64 (:REWRITE COMMUTATIVITY-OF-+))
 (167 167 (:TYPE-PRESCRIPTION POSP))
 (160 160 (:REWRITE DEFAULT-+-1))
 (144 129 (:REWRITE DEFAULT-*-1))
 (138 138 (:REWRITE BVCHOP-WHEN-SIZE-IS-NOT-NATP))
