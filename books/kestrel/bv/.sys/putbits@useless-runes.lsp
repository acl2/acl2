...
(UNSIGNED-BYTE-P-OF-PUTBITS
 (521 77 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
 (312 229 (:REWRITE DEFAULT-<-1))
 (275 229 (:REWRITE DEFAULT-<-2))
 (254 25 (:REWRITE BVCHOP-IDENTITY))
...
(SLICE-OF-PUTBITS
 ...
 (87 7 (:REWRITE SLICE-TOO-HIGH-IS-0))
...
(PUTBIT-OF-BVCHOP-SAME
 (707 35 (:REWRITE SLICE-TOO-HIGH-IS-0))
 (508 72 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (395 40 (:REWRITE BVCHOP-IDENTITY))
