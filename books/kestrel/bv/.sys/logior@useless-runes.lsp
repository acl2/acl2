...
(LOGIOR-OF-LOGAND-SAME-ARG-1
 (223381 230 (:DEFINITION NATP))
 (219871 71 (:LINEAR LOGIOR-BOUND-LINEAR-2))
 (84252 118 (:REWRITE <-OF-*-AND-0))
 (74645 2281 (:LINEAR FLOOR-UPPER-BOUND-LINEAR))
 (54262 572 (:LINEAR <=-OF-LOGAND-SAME-ARG2))
 (53972 172 (:REWRITE MOD-WHEN-<-OF-0))
 (47801 251 (:REWRITE <-OF-LOGAND))
 (32485 32485 (:TYPE-PRESCRIPTION FLOOR-TYPE-NON-NEGATIVE))
 (32485 32485 (:TYPE-PRESCRIPTION FLOOR-TYPE-1-PART-1-BETTER))
 (31770 2285 (:LINEAR FLOOR-BOUND-ARG1-LINEAR))
 (31714 2271 (:REWRITE <-OF-FLOOR-OF-CONSTANT-AND-CONSTANT-GEN))
 (29151 156 (:REWRITE <-OF-LOGAND-AND-0))
 (25136 91 (:REWRITE NATP-OF-FLOOR))
 (20501 251 (:REWRITE LOGAND-OF-NEGATIVE-AND-POSITIVE))
 (19764 81 (:REWRITE <-OF-+-COMBINE-CONSTANTS-2))
 (18570 2285 (:LINEAR FLOOR-BOUND-STRICT-LINEAR))
 ...
 (7329 42 (:LINEAR MOD-BOUND-LINEAR-ARG1))
 ...
 (3774 78 (:REWRITE MOD-WHEN-<))
 (3758 2533 (:REWRITE DEFAULT-+-1))
 (2440 10 (:REWRITE <-OF-+-COMBINE-CONSTANTS-1))
 (2285 2285 (:LINEAR FLOOR-BY-2-BOUND-EVEN-LINEAR))
...
(LOGAND-OF-LOGIOR
 (734954 1432 (:DEFINITION NATP))
 (290796 409 (:REWRITE <-OF-*-AND-0))
 (178627 7763 (:LINEAR FLOOR-UPPER-BOUND-LINEAR))
 (139699 737 (:REWRITE <-OF-LOGAND))
 (120046 637 (:REWRITE <-OF-LOGAND-AND-0))
 (65753 737 (:REWRITE LOGAND-OF-NEGATIVE-AND-POSITIVE))
 (63915 51825 (:REWRITE DEFAULT-*-2))
 (63400 269 (:REWRITE <-OF-+-COMBINE-CONSTANTS-2))
 (62072 708 (:REWRITE MOD-WHEN-<-OF-0))
 (60906 60344 (:META CANCEL_PLUS-LESSP-CORRECT))
 (56566 51825 (:REWRITE DEFAULT-*-1))
 (56370 51922 (:REWRITE DEFAULT-<-1))
 (53746 7765 (:LINEAR FLOOR-BOUND-ARG1-LINEAR))
 (53526 7724 (:REWRITE <-OF-FLOOR-OF-CONSTANT-AND-CONSTANT-GEN))
 (52552 51922 (:REWRITE DEFAULT-<-2))
 (40578 7765 (:LINEAR FLOOR-BOUND-STRICT-LINEAR))
 (31475 31475 (:TYPE-PRESCRIPTION LOGAND-NEGATIVE-TYPE))
 (31043 25634 (:REWRITE FLOOR-WHEN-NEGATIVE-AND-SMALL-CHEAP))
 (31011 25634 (:REWRITE FLOOR-WHEN-NOT-RATIONALP-OF-QUOTIENT))
 (29701 25532 (:REWRITE FLOOR-WHEN-I-IS-NOT-AN-ACL2-NUMBERP))
 (26810 372 (:REWRITE NATP-OF-FLOOR))
 (26097 24861 (:REWRITE FLOOR-WHEN-NOT-RATIONALP-ARG1))
 (25532 25532 (:REWRITE FLOOR-MINUS-NEGATIVE-CONSTANT))
 (23872 9807 (:REWRITE DEFAULT-+-2))
 (22462 9807 (:REWRITE DEFAULT-+-1))
 (15352 59 (:REWRITE FLOOR-OF-LOGIOR-AND-2))
 (7853 7765 (:LINEAR FLOOR-BY-2-BOUND-EVEN-LINEAR))
 (7842 7762 (:LINEAR FLOOR-WEAK-MONOTONE-LINEAR-1))
 (7762 7762 (:LINEAR FLOOR-WEAK-MONOTONE-LINEAR=-2))
 (5912 383 (:REWRITE MOD-WHEN-<))
...
(<-OF-LOGIOR-AND-EXPT-OF-2
 (1080 1080 (:TYPE-PRESCRIPTION NATP-OF-EXPT))
 (362 6 (:REWRITE <-OF-LOGAND))
 (290 96 (:REWRITE DEFAULT-<-2))
 (189 93 (:REWRITE DEFAULT-+-2))
 (148 96 (:REWRITE DEFAULT-<-1))
