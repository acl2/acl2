...
(BVPLUS1C-CORRECT
 (17038 58 (:REWRITE UNSIGNED-BYTE-P-OF-IF))
...
(BVPLUS1C-CORRECT-2
 (738259 1002 (:REWRITE NATP-OF-+-WHEN-NATP-AND-NATP))
 (173718 6484 (:REWRITE DEFAULT-<-1))
 (155849 48 (:REWRITE BVUMINUS-WHEN-BVCHOP-KNOWN-SUBST))
 ...
 (182 182 (:REWRITE <-OF-+-AND-+-COMBINE-CONSTANTS))
