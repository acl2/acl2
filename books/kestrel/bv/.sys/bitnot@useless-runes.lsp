...
(BITNOT-OF-BITNOT
 ...
 (50 2 (:LINEAR BVCHOP-UPPER-BOUND-LINEAR))
...
(GETBIT-OF-1-AND-+-OF-2
 (584 36 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (574 20 (:REWRITE UNSIGNED-BYTE-P-OF-+-OF-CONSTANT-STRONG))
 (549 61 (:LINEAR <=-OF-LOGTAIL-SAME-LINEAR))
 (457 20 (:REWRITE USB-PLUS-FROM-BOUNDS))
 (305 61 (:LINEAR LOGTAIL-NON-NEGATIVE-LINEAR))
 (305 61 (:DEFINITION NATP))
 (293 247 (:REWRITE DEFAULT-<-1))
 (278 10 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
 (262 262 (:TYPE-PRESCRIPTION LOGTAIL-NON-POSITIVE))
 (247 247 (:REWRITE DEFAULT-<-2))
 (190 55 (:REWRITE <-OF-LOGTAIL-ARG1))
...
(BVNOT-1-OF-GETBIT-0
 (1211 24 (:REWRITE <-OF-LOGNOT-ARG1-WHEN-CONSTANT))
 (1204 45 (:REWRITE BVCHOP-IDENTITY))
 (1099 63 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (427 15 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
 (360 6 (:LINEAR GETBIT-BOUND-LINEAR))
