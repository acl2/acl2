...
(GETBIT-OF-1-AND-+-OF-2
 ...
 (240 30 (:LINEAR <=-OF-LOGTAIL-SAME-LINEAR))
 (196 8 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
 (139 139 (:TYPE-PRESCRIPTION LOGTAIL-NON-POSITIVE))
 (135 105 (:REWRITE DEFAULT-<-1))
 (120 30 (:LINEAR LOGTAIL-NON-NEGATIVE-LINEAR))
...
(BVNOT-1-BECOMES-BITNOT-BETTER
 ...
 (22 4 (:REWRITE GETBIT-IDENTITY))
 (12 6 (:REWRITE BVNOT-WHEN-NOT-INTEGERP))
 ...
 (6 6 (:REWRITE UNSIGNED-BYTE-P-WHEN-<=-FREE))
 (6 6 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
 (6 6 (:REWRITE EQUAL-OF-BVNOT-AND-CONSTANT))
