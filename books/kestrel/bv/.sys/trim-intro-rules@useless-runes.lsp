(BVNOT-TRIM-ALL)
(BVXOR-TRIM-ARG1
 (1498 6 (:DEFINITION BINARY-LOGAND))
 (636 16 (:REWRITE EQUAL-OF-LOGNOT-AND-CONSTANT))
 (512 12 (:REWRITE ZIP-OPEN))
 (292 12 (:REWRITE BVCHOP-NOT-0-WHEN-LOW-BIT-NOT-0))
 (268 12 (:REWRITE BVCHOP-NOT-0-WHEN-GETBIT-NOT-0))
 (176 12 (:DEFINITION EVENP))
 ...
 (48 12 (:REWRITE BVCHOP-IMPOSSIBLE-VALUE))
...
(BVMINUS-TRIM-ARG3)
(BVUMINUS-TRIM
 (397 11 (:REWRITE BVCHOP-NOT-0-WHEN-LOW-BIT-NOT-0))
 (364 11 (:REWRITE BVCHOP-NOT-0-WHEN-GETBIT-NOT-0))
 (255 17 (:DEFINITION EXPT))
 (132 132 (:TYPE-PRESCRIPTION GETBIT))
 (116 56 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (101 11 (:REWRITE BVCHOP-IMPOSSIBLE-VALUE))
 ...
 (58 58 (:REWRITE BVCHOP-IDENTITY-FREE))
