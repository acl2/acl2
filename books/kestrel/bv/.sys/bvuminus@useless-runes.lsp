...
(BVUMINUS-EQUAL-CONSTANT
 ...
 (198 2 (:REWRITE UNSIGNED-BYTE-P-OF-IF))
...
(UNSIGNED-BYTE-P-OF-BVUMINUS-BIGGER-SIMPLE
 ...
 (730 1 (:REWRITE USB-PLUS-FROM-BOUNDS))
...
(BVPLUS-OF-BVUMINUS-SAME-2
 (896 18 (:REWRITE BVCHOP-IDENTITY))
...
(BVUMINUS-1
 (712 37 (:REWRITE BVCHOP-IDENTITY))
 (517 40 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (126 43 (:REWRITE DEFAULT-<-1))
 (78 78 (:TYPE-PRESCRIPTION IFIX))
 (57 7 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
 (47 3 (:REWRITE GETBIT-IDENTITY))
