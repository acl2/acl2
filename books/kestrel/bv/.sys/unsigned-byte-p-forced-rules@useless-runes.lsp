...
(UNSIGNED-BYTE-P-FORCED-OF-BVMINUS
 (13 2 (:REWRITE BVMINUS-WHEN-SIZE-IS-NOT-POSITIVE))
 (8 8 (:REWRITE INTEGERP-FROM-UNSIGNED-BYTE-P-SIZE-PARAM))
 (7 4 (:REWRITE DEFAULT-<-2))
 (4 4 (:REWRITE DEFAULT-<-1))
 ...
 (3 2 (:REWRITE BVMINUS-WHEN-SIZE-IS-NOT-INTEGERP))
...
(UNSIGNED-BYTE-P-FORCED-OF-BVCAT
 (24 3 (:REWRITE BVCHOP-IDENTITY))
 (17 2 (:REWRITE BVCHOP-NOT-0-WHEN-GETBIT-NOT-0))
 (15 2 (:REWRITE BVCHOP-NOT-0-WHEN-LOW-BIT-NOT-0))
