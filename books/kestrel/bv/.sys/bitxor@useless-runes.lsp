...
(EQUAL-OF-BITXOR-SAME
 ...
 (8 8 (:DEFINITION BITP))
 (8 4 (:REWRITE BITXOR-WHEN-CONSTANT-IS-NOT-USB-ARG1))
 (6 6 (:REWRITE GETBIT-WHEN-VAL-IS-NOT-AN-INTEGER))
...
(BITXOR-OF-BVCHOP-ARG1
 (665 15 (:REWRITE GETBIT-OF-0-WHEN-BITP))
 (642 8 (:DEFINITION BITP))
...
(BITXOR-OF-BVCHOP-ARG2
 ...
 (76 4 (:REWRITE BVCHOP-1-BECOMES-GETBIT))
 (42 10 (:REWRITE GETBIT-IDENTITY))
