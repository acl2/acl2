(SBVREM
 (330 5 (:REWRITE LOGEXT-WHEN-SIGNED-BYTE-P))
 (320 5 (:DEFINITION SIGNED-BYTE-P))
 (252 11 (:DEFINITION EXPT))
 (155 5 (:REWRITE LOGEXT-WHEN-TOP-BIT-0))
 (150 5 (:DEFINITION INTEGER-RANGE-P))
 (77 7 (:REWRITE ZIP-OPEN))
...
(SBVREM-OF-BVCHOP-ARG2
 (895 3 (:REWRITE BVCHOP-IDENTITY))
 (872 2 (:REWRITE USB-PLUS-FROM-BOUNDS))
 (698 2 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
 (620 2 (:LINEAR <=-OF-TRUNCATE-SAME-LINEAR))
 ...
 (286 2 (:LINEAR <-OF-LOGEXT-LINEAR-LOWER))
 (284 2 (:LINEAR <=-OF-LOGEXT-LINEAR-UPPER))
