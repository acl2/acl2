...
(BVAND-1-OF-GETBIT-ARG1
 (241 4 (:REWRITE BVAND-WITH-MASK-BETTER))
 (234 3 (:DEFINITION LOGMASKP))
 (93 3 (:DEFINITION EXPT2$INLINE))
 (72 3 (:DEFINITION EXPT))
 (68 6 (:LINEAR INTEGER-LENGTH-BOUND))
...
(BITAND-OF-BVCHOP-ARG1
 (389 3 (:REWRITE BVAND-WITH-MASK-BETTER))
 (384 2 (:DEFINITION LOGMASKP))
 (268 4 (:LINEAR INTEGER-LENGTH-BOUND))
 ...
 (38 2 (:LINEAR GETBIT-BOUND-LINEAR))
 (36 2 (:REWRITE BVCHOP-1-BECOMES-GETBIT))
