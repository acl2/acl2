...
(EXPT-GATHER-TIMES
 (1062 4 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
 (330 165 (:TYPE-PRESCRIPTION EXPT-TYPE-ODD-EXPONENT-NEGATIVE-BASE))
 (270 2 (:REWRITE <-UNARY-/-POSITIVE-RIGHT-BETTER))
 (266 2 (:REWRITE <-*-/-RIGHT))
 (178 4 (:LINEAR X*Y>1-POSITIVE))
 (166 2 (:REWRITE X*Y>1-POSITIVE))
...
(INTEGERP-TIMES-EXPTS
 ...
 (80 2 (:REWRITE /R-WHEN-ABS-NUMERATOR=1))
 ...
 (9 2 (:LINEAR EXPT-IS-INCREASING-FOR-BASE>1))
 (9 2 (:LINEAR <-OF-EXPT-AND-EXPT-LINEAR))
