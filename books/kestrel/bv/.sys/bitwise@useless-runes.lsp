...
(BVXOR-OF-BVAND-SAME-ARG2
 (656 4 (:REWRITE BVAND-WITH-MASK-BETTER))
 (648 4 (:DEFINITION LOGMASKP))
 (400 12 (:REWRITE EQUAL-OF-+-WHEN-NEGATIVE-CONSTANT))
 (184 92 (:TYPE-PRESCRIPTION <=-OF-0-AND-EXPT))
