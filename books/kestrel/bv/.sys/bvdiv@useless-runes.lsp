...
(BVDIV-OF-BVDIV-ARG2
 (143015 308 (:REWRITE FLOOR-WHEN-<))
 (113605 1814 (:REWRITE UNSIGNED-BYTE-P-OF-0-ARG1))
 (84187 5149 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (29204 138 (:LINEAR MY-FLOOR-LOWER-BOUND-LINEAR))
 (26728 138 (:REWRITE DEFAULT-UNARY-/))
 (25880 138 (:LINEAR FLOOR-BOUND-STRICT-LINEAR))
 (25174 16391 (:REWRITE DEFAULT-<-1))
 (18350 16391 (:REWRITE DEFAULT-<-2))
 (13948 4787 (:REWRITE DEFAULT-*-2))
 (13767 3483 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
 (11784 11784 (:REWRITE BOUND-WHEN-USB))
 (11000 9948 (:REWRITE DEFAULT-+-2))
 (9948 9948 (:REWRITE DEFAULT-+-1))
 (6658 3483 (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER))
 (5700 5700 (:REWRITE INTEGERP-FROM-UNSIGNED-BYTE-P-SIZE-PARAM))
 (5417 5417 (:REWRITE BVCHOP-IDENTITY-CHEAP))
 (5249 5249 (:REWRITE BVCHOP-SUBST-CONSTANT))
 (5149 5149 (:REWRITE UNSIGNED-BYTE-P-WHEN-<=-CHEAP))
 (5149 5149 (:REWRITE UBP-LONGER-BETTER))
 (4969 4787 (:REWRITE DEFAULT-*-1))
 (4344 4255 (:REWRITE ZIP-OPEN))
 (3818 3818 (:REWRITE SIZE-NON-NEGATIVE-WHEN-UNSIGNED-BYTE-P-FREE))
 (3742 3483 (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER-CHEAP))
 (3602 3483 (:REWRITE BVCHOP-WHEN-SIZE-IS-NOT-NATP))
 (3602 3483 (:REWRITE BVCHOP-WHEN-NOT-NATP-ARG1-CHEAP))
 (3585 3483 (:REWRITE BVCHOP-WITH-N-NOT-AN-INTEGER))
 (3370 3370 (:TYPE-PRESCRIPTION POSP))
 (3226 140 (:REWRITE BVCHOP-IMPOSSIBLE-VALUE))
 (3066 27 (:REWRITE BVCHOP-OF-BVDIV))
 (2694 2694 (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
 (2694 2694 (:REWRITE ACL2-NUMBERP-WHEN-UNSIGNED-BYTE-P))
 (2694 2694 (:REWRITE ACL2-NUMBERP-FROM-UNSIGNED-BYTE-P-SIZE-PARAM))
 (1554 1554 (:TYPE-PRESCRIPTION <=-OF-FLOOR-AND-0-WHEN-NONPOSITIVE-AND-NONNEGATIVE-TYPE))
 (1554 1554 (:TYPE-PRESCRIPTION <=-OF-0-AND-FLOOR-WHEN-BOTH-NONPOSITIVE-TYPE))
 (1554 1554 (:TYPE-PRESCRIPTION <-OF-FLOOR-AND-0-WHEN-POSITIVE-AND-NEGATIVE-TYPE))
 (1554 1554 (:TYPE-PRESCRIPTION <-OF-FLOOR-AND-0-WHEN-NEGATIVE-AND-POSITIVE-TYPE))
 ...
 (458 458 (:REWRITE <-OF-BVCHOP-WHEN-<-OF-BVCHOP-BIGGER))
 ...
 (207 120 (:REWRITE UNSIGNED-BYTE-P-OF-0-ARG2))
 ...
 (136 40 (:REWRITE UNSIGNED-BYTE-P-OF-BVCHOP))
