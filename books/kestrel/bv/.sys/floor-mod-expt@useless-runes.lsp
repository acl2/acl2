...
(FLOOR-OF-SHIFTING-LEMMA2
 (4138 10 (:LINEAR FLOOR-BOUND-ARG1-LINEAR))
 (2980 5 (:REWRITE *-OF-FLOOR-OF-SAME-WHEN-MULTIPLE))
 (1974 14 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
 (1555 334 (:LINEAR EXPT-BOUND-LINEAR-WEAK))
 (1550 10 (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
 (1410 2 (:LINEAR MY-FLOOR-LOWER-BOUND-ALT-LINEAR))
 (1368 2 (:LINEAR *-OF-FLOOR-UPPER-BOUND-LINEAR))
 (1325 5 (:LINEAR MOD-BOUND-LINEAR-ARG2))
 (859 27 (:REWRITE FLOOR-WHEN-<))
 (794 2 (:REWRITE <-OF-*-AND-0))
 (698 2 (:REWRITE <-OF-*-OF-/-ARG2-ALT))
 ...
 (282 10 (:LINEAR FLOOR-BOUND-STRICT-LINEAR))
...
(MOD-OF-FLOOR-AND-EXPT-OF-ONE-LESS
 (511 5 (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
