(FLOOR-OF-SHIFTING-LEMMA2-HELPER
 (10457 252 (:REWRITE FLOOR-WHEN-<))
 (5137 120 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
 (5042 83 (:LINEAR FLOOR-BOUND-ARG1-LINEAR))
 (4739 52 (:REWRITE *-OF-FLOOR-OF-SAME-WHEN-MULTIPLE))
 (3985 15 (:REWRITE <-OF-*-OF-/-ARG2-ALT))
...
(FLOOR-OF-SHIFTING-LEMMA2
 (16480 10 (:LINEAR FLOOR-BOUND-ARG1-LINEAR))
 (12560 5 (:REWRITE *-OF-FLOOR-OF-SAME-WHEN-MULTIPLE))
 (7300 10 (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
 (7082 14 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
 (5973 5973 (:TYPE-PRESCRIPTION EVENP))
 (5830 2 (:LINEAR MY-FLOOR-LOWER-BOUND-ALT-LINEAR))
 (5702 2 (:LINEAR *-OF-FLOOR-UPPER-BOUND-LINEAR))
 (5650 5 (:LINEAR MOD-BOUND-LINEAR-ARG2))
 (5138 334 (:LINEAR EXPT-BOUND-LINEAR-WEAK))
 (4273 27 (:REWRITE FLOOR-WHEN-<))
 (4008 167 (:LINEAR <-OF-EXPT2-SAME-LINEAR))
 (3982 1991 (:TYPE-PRESCRIPTION EXPT-TYPE-ODD-EXPONENT-NEGATIVE-BASE))
 (3982 1991 (:TYPE-PRESCRIPTION EXPT-TYPE-EVEN-EXPONENT-2))
 (3982 1991 (:TYPE-PRESCRIPTION EXPT-TYPE-EVEN-EXPONENT-1))
 (3294 2 (:REWRITE <-OF-*-AND-0))
 (2674 2 (:REWRITE <-OF-*-OF-/-ARG2-ALT))
 (2255 25 (:REWRITE INTEGERP-OF-*-OF-/-WHEN-<-AND-MIXED-1))
 (2135 25 (:REWRITE INTEGERP-OF-*-OF-/-WHEN-<-AND-MIXED-2))
 (2125 25 (:REWRITE INTEGERP-OF-*-OF-/-WHEN-<-AND-NEGATIVE-ALT))
 (2110 10 (:REWRITE MOD-WHEN-<))
 (1991 1991 (:TYPE-PRESCRIPTION EXPT-TYPE-SMALL-BASE-NON-POSITIVE-EXPONENT))
 (1991 1991 (:TYPE-PRESCRIPTION EXPT-TYPE-SMALL-BASE-NEGATIVE-EXPONENT))
 (1486 806 (:REWRITE DEFAULT-<-2))
 (1470 10 (:LINEAR FLOOR-BOUND-STRICT-LINEAR))
 (1470 8 (:REWRITE <-OF-/-AND-CONSTANT))
...
(MOD-OF-FLOOR-AND-EXPT-OF-ONE-LESS
 (1672 5 (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
 ...
 (419 10 (:REWRITE INTEGERP-OF-*-OF-/-WHEN-<-AND-MIXED-1))
 (359 10 (:REWRITE INTEGERP-OF-*-OF-/-WHEN-<-AND-MIXED-2))
 (354 10 (:REWRITE INTEGERP-OF-*-OF-/-WHEN-<-AND-NEGATIVE-ALT))
 (349 5 (:REWRITE MOD-WHEN-<))
