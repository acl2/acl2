...
(SBVDIV-OF-1-ARG3
 (11648 14 (:REWRITE GETBIT-OF-0-WHEN-BITP))
 (11573 13 (:DEFINITION BITP))
 (6048 54 (:LINEAR <-OF-LOGEXT-LINEAR-LOWER))
 (5994 54 (:LINEAR <=-OF-LOGEXT-LINEAR-UPPER))
 (5510 111 (:REWRITE LOGEXT-WHEN-SIGNED-BYTE-P))
 (5288 111 (:DEFINITION SIGNED-BYTE-P))
 (4284 18 (:LINEAR <=-OF-TRUNCATE-SAME-LINEAR))
 (4266 18 (:LINEAR TRUNCATE-UPPER-BOUND-LINEAR))
 (4266 18 (:LINEAR MY-TRUNCATE-LOWER-BOUND-LINEAR))
 (3392 228 (:DEFINITION EXPT))
 (2975 111 (:DEFINITION INTEGER-RANGE-P))
 (1506 6 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
 (1338 228 (:REWRITE COMMUTATIVITY-OF-+))
 (1182 1064 (:REWRITE DEFAULT-+-2))
 (1064 1064 (:REWRITE DEFAULT-+-1))
 (1009 569 (:REWRITE DEFAULT-<-2))
 (684 228 (:REWRITE DEFAULT-*-2))
 (654 218 (:REWRITE FOLD-CONSTS-IN-+))
 (639 569 (:REWRITE DEFAULT-<-1))
 (494 165 (:REWRITE DEFAULT-UNARY-MINUS))
 (470 235 (:REWRITE GETBIT-WHEN-NOT-1))
 (470 235 (:REWRITE GETBIT-WHEN-NOT-0))
 (468 234 (:REWRITE GETBIT-TOO-HIGH-CHEAP-2))
 (298 298 (:TYPE-PRESCRIPTION UNSIGNED-BYTE-P))
 (270 54 (:LINEAR <-OF-LOGEXT-SAME-LINEAR))
 (258 234 (:REWRITE GETBIT-WHEN-VAL-IS-NOT-AN-INTEGER))
 (235 235 (:REWRITE GETBIT-WHEN-SLICE-IS-KNOWN-CONSTANT))
 (234 234 (:REWRITE GETBIT-WHEN-NOT-INTEGERP-ARG1))
 (234 234 (:REWRITE GETBIT-WHEN-N-IS-NEGATIVE))
 (234 234 (:REWRITE GETBIT-WHEN-EQUAL-OF-CONSTANT-AND-BVCHOP-CONSTANT-VERSION))
 ...
 (111 111 (:TYPE-PRESCRIPTION SIGNED-BYTE-P))
