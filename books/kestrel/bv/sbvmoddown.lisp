...
(defthmd sbvmoddown-rewrite-case-5
  ...
  :hints (("Goal" :cases ((integerp x))
           :in-theory (e/d (sbvmoddown-rewrite-case-5-helper
                                   sbvrem
                                   sbvmoddown
                                   LOGEXT-NEGATIVE
                                   LOGEXT-WHEN-NEGATIVE-2
                    ...
                    (if (and (sbvle size 0 x)
                      ...
                      (if (and (sbvlt size x 0)
                        ...
                        (if (equal 0 (sbvrem size x y))
                          ...
                          (bvplus size y (sbvrem size x y))))))))
  :hints (("Goal" :cases ((or (not (integerp x)) (not (integerp y)))
                          (and (integerp x) (integerp y) (sbvlt size y 0)))
