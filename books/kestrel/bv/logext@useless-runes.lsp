...
(LOGEXT-OF-LOGEXT
    (7451 634
          (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
    (3440 125 (:REWRITE LOGTAIL-LESSP))
    (3277 110
          (:REWRITE UNSIGNED-BYTE-P-OF-LOGTAIL-STRONG))
    (3055 376 (:REWRITE UNSIGNED-BYTE-P-PLUS))
    (2666 63 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
    (1874 889 (:REWRITE DEFAULT-<-1))
    (1080 540
          (:REWRITE INTEGERP-WHEN-POWER-OF-2P))
    (995 889 (:REWRITE DEFAULT-<-2))
    (962 634
         (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
    (952 952
         (:REWRITE EXPT-WITH-VIOLATED-GUARDS))
    (831 21 (:REWRITE SLICE-TOO-HIGH-IS-0))
    (803 803 (:TYPE-PRESCRIPTION POWER-OF-2P))
    (634 634
         (:REWRITE UNSIGNED-BYTE-P-WHEN-<=-CHEAP))
    (634 634 (:REWRITE UBP-LONGER-BETTER))
    (540 540
         (:REWRITE INTEGERP-FROM-UNSIGNED-BYTE-P-SIZE-PARAM))
    (526 263 (:REWRITE NATP-WHEN-POWER-OF-2P))
    (448 18
         (:REWRITE UNSIGNED-BYTE-P-OF-BVCHOP-WHEN-ALREADY))
    (440 110 (:DEFINITION NFIX))
    (436 109 (:DEFINITION IFIX))
    ...
    (194 33 (:REWRITE LOGAPP-WHEN-NOT-NATP-ARG1))
    (165 72
         (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER-CHEAP))
    (157 39
         (:REWRITE LOGTAIL-WHEN-NOT-INTEGERP-ARG2))
    (153 153 (:REWRITE FOLD-CONSTS-IN-+))
    (150 70 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
...
(LOGEXT-DOES-NOTHING-REWRITE
     (2187 2187 (:TYPE-PRESCRIPTION NATP-OF-EXPT))
     ...
     (389 263 (:REWRITE DEFAULT-<-2))
     (354 263 (:REWRITE DEFAULT-<-1))
...
(BVCHOP-OF-LOGEXT
     (6450 1388
           (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
     (5611 526 (:REWRITE UNSIGNED-BYTE-P-PLUS))
     (2318 1388
           (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
     (2227 1284 (:REWRITE DEFAULT-<-1))
     (1755 506
           (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER))
     (1678 52 (:REWRITE LOGTAIL-LESSP))
     (1444 722
           (:REWRITE INTEGERP-WHEN-POWER-OF-2P))
     (1388 1388
           (:REWRITE UNSIGNED-BYTE-P-WHEN-<=-CHEAP))
     (1388 1388 (:REWRITE UBP-LONGER-BETTER))
     (1353 506 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
     (1347 1338
           (:REWRITE EXPT-WITH-VIOLATED-GUARDS))
     (1345 1284 (:REWRITE DEFAULT-<-2))
     (1178 151
           (:REWRITE UNSIGNED-BYTE-P-OF-BVCHOP-WHEN-ALREADY))
     (954 954 (:TYPE-PRESCRIPTION POWER-OF-2P))
     (759 33
          (:REWRITE UNSIGNED-BYTE-P-OF-LOGTAIL-STRONG))
     (752 582
          (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER-CHEAP))
     (740 76 (:REWRITE UNSIGNED-BYTE-P-OF-0-ARG1))
     ...
     (373 373 (:TYPE-PRESCRIPTION NATP-OF-EXPT))
...
(LOGEXT-OF-BVCHOP-SMALLER
     (345 11 (:REWRITE BVCHOP-IDENTITY))
     (295 8 (:REWRITE UNSIGNED-BYTE-P-PLUS))
     (235 22
          (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
     (73 4 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR-2))
...
(LOGEXT-OF-BVCHOP-SMALLER-BETTER
     ...
     (41 3
         (:REWRITE UNSIGNED-BYTE-P-OF-BVCHOP-WHEN-ALREADY))
     (32 6 (:LINEAR EXPT-BOUND-LINEAR-WEAK))
...
(SIGNED-BYTE-P-OF-LOGEXT
     ...
     (1 1 (:REWRITE DEFAULT-+-1)))
(LOGEXT-CASES
     (1735 25 (:REWRITE BVCHOP-IDENTITY))
     (1305 56 (:REWRITE UNSIGNED-BYTE-P-PLUS))
     (641 18 (:REWRITE USB-PLUS-FROM-BOUNDS))
     (544 94
          (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
     (342 18
          (:REWRITE DIFFERENCE-UNSIGNED-BYTE-P))
     (214 16 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
     (174 94
          (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
     (134 75 (:REWRITE DEFAULT-<-1))
     (126 12 (:DEFINITION NATP))
     ...
     (79 22 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
     ...
     (62 38 (:LINEAR EXPT-BOUND-LINEAR))
     (60 35 (:REWRITE DEFAULT-+-1))
     (59 1 (:REWRITE LOGTAIL-OF-SUM2))
     (48 24
         (:REWRITE BVCHOP-WHEN-SIZE-IS-NOT-POSP))
     (48 12 (:REWRITE --OF--))
...
(LOGEXT-WHEN-SIZE-NOT-POSP
     (323 23 (:REWRITE BVCHOP-IDENTITY))
     (184 32
          (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
     ...
     (26 6 (:REWRITE IFIX-WHEN-INTEGERP))
...
(EQUAL-OF-0-AND-BVCHOP
     ...
     (258 258 (:TYPE-PRESCRIPTION POWER-OF-2P))
     (258 258
          (:REWRITE INTEGERP-FROM-UNSIGNED-BYTE-P-SIZE-PARAM))
...
(LOGEXT-OF-+-OF-EXPT-SAME
     ...
     (1 1
        (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT)))
(LOGEXT-OF-MININT (73 3 (:REWRITE BVCHOP-IDENTITY))
