(LOGORC1-OF-0-ARG1)
(LOGORC1-OF--1-ARG1)
(LOGORC1-OF-0-ARG2 (9 9 (:REWRITE DEFAULT-+-2))
                   (9 9 (:REWRITE DEFAULT-+-1))
                   (3 3 (:REWRITE DEFAULT-UNARY-MINUS))
                   (1 1 (:REWRITE EQUAL-OF---WHEN-VARIABLE))
                   (1 1 (:REWRITE EQUAL-OF---AND-CONSTANT)))
(LOGORC1-OF--1-ARG2 (14 1 (:LINEAR LOGIOR-BOUND-LINEAR))
...
(LOGORC1-OF-LOGNOT-SAME-ARG1 (30 4 (:LINEAR LOGIOR-BOUND-LINEAR))
                             (29 29
                                 (:TYPE-PRESCRIPTION <-OF-LOGIOR-AND-0-TYPE))
                             (26 4 (:DEFINITION NATP))
                             ...
                             (3 3
                                (:REWRITE LOGIOR-WHEN-NOT-INTEGERP-ARG2))
                             (1 1 (:REWRITE DEFAULT-UNARY-MINUS)))
(LOGORC1-OF-LOGNOT-SAME-ARG2 (4 4 (:REWRITE DEFAULT-+-2))
                             (4 4 (:REWRITE DEFAULT-+-1))
                             (2 2 (:REWRITE DEFAULT-UNARY-MINUS)))
