...
(UNSIGNED-BYTE-P-OF-SBVREM
     ...
     (142 2 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
     ...
     (64 2 (:LINEAR <=-OF-TRUNCATE-SAME-LINEAR))
...
(SBVREM-OF-BVCHOP-ARG2
    (809 3 (:REWRITE BVCHOP-IDENTITY))
    (786 2 (:REWRITE USB-PLUS-FROM-BOUNDS))
    (614 2 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
    (536 2 (:LINEAR <=-OF-TRUNCATE-SAME-LINEAR))
...
(SBVREM-OF-0-ARG1
    (1007 1 (:REWRITE BVCHOP-IDENTITY))
    (812 4 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
    (656 4 (:LINEAR <=-OF-TRUNCATE-SAME-LINEAR))
    (632 12 (:REWRITE LOGEXT-WHEN-TOP-BIT-0))
    (470 1 (:REWRITE UNSIGNED-BYTE-P-OF-0-ARG1))
    (425 23
         (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
    (332 24 (:REWRITE GETBIT-IDENTITY))
    (300 12 (:LINEAR GETBIT-BOUND-LINEAR))
    (288 4 (:LINEAR <-OF-LOGEXT-LINEAR-LOWER))
    (284 4 (:LINEAR <-OF-LOGEXT-LINEAR-UPPER))
    (268 1 (:REWRITE USB-PLUS-FROM-BOUNDS))
    ...
    (70 26 (:REWRITE GETBIT-WHEN-N-IS-NEGATIVE))
...
(SBVREM-OF-0-ARG3
     ...
     (1 1 (:REWRITE GETBIT-OF-0)))
(SBVREM-OF-1-ARG3
    (774 18 (:REWRITE LOGEXT-WHEN-TOP-BIT-0))
    (720 3 (:REWRITE USB-PLUS-FROM-BOUNDS))
    (636 5 (:DEFINITION NATP))
    (286 4 (:LINEAR <-OF-LOGEXT-LINEAR-LOWER))
    (284 4 (:LINEAR <-OF-LOGEXT-LINEAR-UPPER))
    ...
    (80 34 (:REWRITE GETBIT-WHEN-N-IS-NEGATIVE))
