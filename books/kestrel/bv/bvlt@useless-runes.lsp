...
(BVLT-TRIM-CONSTANT-ARG1
     ...
     (1 1
        (:REWRITE NATP-WHEN-UNSIGNED-BYTE-P-SIZE-ARG))
     (1 1 (:REWRITE NATP-WHEN-UNSIGNED-BYTE-P)))
(BVLT-OF-MAX (175 10 (:REWRITE BVCHOP-IDENTITY))
...
(BVLT-OF-BVPLUS-CONSTANT-AND-CONSTANT
     (1597 200 (:REWRITE BVCHOP-IDENTITY))
     (350 350
          (:TYPE-PRESCRIPTION UNSIGNED-BYTE-P))
     (310 187
          (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
...
(BVLT-OF-BVPLUS-CONSTANT-AND-CONSTANT-SAFE
     (687 88 (:REWRITE BVCHOP-IDENTITY))
...
(BVLT-OF-BVPLUS-CONSTANT-AND-CONSTANT-OTHER
     (1852 801
           (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
     (1075 696 (:REWRITE DEFAULT-<-1))
     (801 801
          (:REWRITE UNSIGNED-BYTE-P-WHEN-<=-CHEAP))
     (801 801 (:REWRITE UBP-LONGER-BETTER))
     (793 696 (:REWRITE DEFAULT-<-2))
     (759 285 (:REWRITE DEFAULT-+-2))
     (478 478 (:TYPE-PRESCRIPTION POSP))
     (461 285 (:REWRITE DEFAULT-+-1))
     (353 348
          (:REWRITE BVCHOP-WHEN-SIZE-IS-NOT-NATP))
     (353 211
...
(BVLT-BECOMES-<
     ...
     (514 130 (:REWRITE DEFAULT-*-2))
     (372 201 (:REWRITE DEFAULT-<-2))
     (226 222 (:REWRITE DEFAULT-+-2))
     (226 222 (:REWRITE DEFAULT-+-1))
     (211 201 (:REWRITE DEFAULT-<-1))
     (160 2 (:LINEAR EXPT-HALF-LINEAR))
...
(<-WHEN-BVLT (87 5 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
