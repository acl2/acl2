...
(BVMULT-OF-BVCHOP-ARG3
 ...
 (290 72 (:LINEAR <=-OF-*-AND-*-SAME-ALT-LINEAR))
...
(BVMULT-COMMUTATIVE
 (296 4 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
...
(BVMULT-OF-BVCHOP-1-BETTER
 (1437 84 (:LINEAR <=-OF-*-AND-*-SAME-ALT-LINEAR))
 ...
 (237 151 (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER))
