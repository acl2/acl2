...
(MOD-OF-LOGIOR-AND-2
     ...
     (1156 1012 (:REWRITE DEFAULT-*-2))
     (1124 1012 (:REWRITE DEFAULT-*-1))
...
(LOGIOR-OF-LOGAND-SAME-ARG-1
     (97781 230 (:DEFINITION NATP))
     (96067 71 (:LINEAR LOGIOR-BOUND-LINEAR-2))
     (40289 1347 (:LINEAR FLOOR-UPPER-BOUND-LINEAR))
     ...
     (8790 6256 (:REWRITE DEFAULT-*-2))
     (7838 6256 (:REWRITE DEFAULT-*-1))
     (7451 7451 (:META CANCEL_PLUS-LESSP-CORRECT))
     (7251 5991 (:REWRITE DEFAULT-<-1))
     (6151 5991 (:REWRITE DEFAULT-<-2))
     (4714 4714
           (:TYPE-PRESCRIPTION LOGAND-NEGATIVE-TYPE))
     (4711 2999
           (:REWRITE FLOOR-WHEN-NOT-RATIONALP-OF-QUOTIENT))
     ...
     (1729 248 (:REWRITE DEFAULT-+-2))
     (1670 88 (:REWRITE MOD-WHEN-MULTIPLE))
     (1444 38 (:REWRITE DISTRIBUTIVITY))
     (1277 248 (:REWRITE DEFAULT-+-1))
     (594 54 (:REWRITE FLOOR-OF-FLOOR))
     (451 79 (:REWRITE MOD-WHEN-<))
     ...
     (203 203
          (:REWRITE INTEGERP-OF-HALF-WHEN-MULT-OF-EXPT))
     (203 203 (:REWRITE INTEGERP-OF-*))
     (189 189 (:META CANCEL_PLUS-EQUAL-CORRECT))
     (109 79 (:REWRITE MOD-OF-2-WHEN-EVEN-CHEAP))
     (100 28
          (:REWRITE LOGIOR-WHEN-NOT-INTEGERP-ARG1))
     (88 88
         (:REWRITE MOD-WHEN-NOT-ACL2-NUMBERP-ARG2))
...
(LOGIOR-OF-LOGAND-SAME-ARG-1-EXTRA
     (4256 45 (:LINEAR LOGIOR-BOUND-LINEAR-2))
     (3926 30 (:DEFINITION NATP))
     ...
     (822 822
          (:TYPE-PRESCRIPTION <-OF-LOGIOR-AND-0-TYPE))
     (579 33 (:REWRITE <-OF-LOGAND))
     (578 33 (:REWRITE <-OF-LOGAND-AND-0))
     (338 45 (:LINEAR LOGIOR-BOUND-LINEAR))
     (320 33 (:LINEAR <=-OF-LOGAND-SAME-ARG2))
     (312 33 (:LINEAR <=-OF-LOGAND-SAME-ARG1))
...
(LOGAND-OF-LOGIOR
     (402486 1472 (:DEFINITION NATP))
     (138875 6543 (:LINEAR FLOOR-UPPER-BOUND-LINEAR))
     (138250 350 (:REWRITE <-OF-*-AND-0))
     (76854 650 (:REWRITE <-OF-LOGAND))
     (68596 580 (:REWRITE <-OF-LOGAND-AND-0))
     (46288 292
            (:REWRITE <-OF-+-COMBINE-CONSTANTS-2))
     (42976 32216 (:REWRITE DEFAULT-*-2))
     (39766 6549 (:LINEAR FLOOR-BOUND-ARG1-LINEAR))
     (39182 6498
            (:REWRITE <-OF-FLOOR-OF-CONSTANT-AND-CONSTANT-GEN))
     (38753 38221 (:META CANCEL_PLUS-LESSP-CORRECT))
     (36252 32216 (:REWRITE DEFAULT-*-1))
     (34675 31071 (:REWRITE DEFAULT-<-1))
     (31301 31071 (:REWRITE DEFAULT-<-2))
     (31228 31228
            (:TYPE-PRESCRIPTION LOGAND-NEGATIVE-TYPE))
     (19024 15404
            (:REWRITE FLOOR-WHEN-NEGATIVE-AND-SMALL-CHEAP))
     ...
     (14391 2154 (:REWRITE DEFAULT-+-2))
     (12937 2154 (:REWRITE DEFAULT-+-1))
     (10778 59 (:REWRITE FLOOR-OF-LOGIOR-AND-2))
     (9117 236 (:LINEAR MOD-BOUND-LINEAR-ARG1))
     (7193 532 (:REWRITE MOD-WHEN-MULTIPLE))
     (5884 526
           (:REWRITE FLOOR-UNIQUE-EQUAL-VERSION))
     (3381 708
           (:REWRITE LOGAND-WHEN-NOT-INTEGERP-ARG2-CHEAP))
     ...
     (972 532
          (:REWRITE MOD-WHEN-NOT-ACL2-NUMBERP-ARG1))
     (972 532 (:REWRITE MOD-OF-2-WHEN-EVEN-CHEAP))
