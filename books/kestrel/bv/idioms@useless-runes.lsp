...
(BVAND-WITH-MASK-OF-ONES
     (206 1 (:REWRITE BVAND-OF-EXPT))
     (144 3
          (:REWRITE EQUAL-OF-+-WHEN-NEGATIVE-CONSTANT))
     (95 10 (:REWRITE BVCHOP-IDENTITY))
     (89 9 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
...
(BVAND-WITH-MASK-OF-ONES-ALT
     (293 22 (:REWRITE BVCHOP-IDENTITY))
     (209 19 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
     (158 1 (:REWRITE BVAND-WITH-MASK-BETTER))
     (156 1 (:DEFINITION LOGMASKP))
     (88 3
         (:REWRITE EQUAL-OF-+-WHEN-NEGATIVE-CONSTANT))
     (84 19
         (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER))
...
(SLICE-AS-MASK-AND-SHIFT
     ...
     (497 9
          (:REWRITE EQUAL-OF-+-WHEN-NEGATIVE-CONSTANT))
     (336 18 (:LINEAR INTEGER-LENGTH-BOUND))
     (226 6 (:REWRITE SLICE-TOO-HIGH-LEMMA))
     (181 5 (:REWRITE SLICE-TOO-HIGH-IS-0))
     (176 80 (:LINEAR EXPT-BOUND-LINEAR-WEAK))
     (171 3 (:REWRITE BVAND-OF-EXPT))
     (137 5 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
     (112 80 (:LINEAR EXPT-BOUND-LINEAR))
     (102 1 (:REWRITE BVCHOP-IDENTITY))
     (99 1
         (:REWRITE UNSIGNED-BYTE-P-OF-+-OF-MINUS-ALT))
...
(BVCAT-BECOMES-BVOR-OF-BVSHL
     ...
     (59 38 (:REWRITE NOT-<-WHEN-SBVLT-ALT))
     ...
     (38 38
         (:REWRITE <-OF-CONSTANT-WHEN-UNSIGNED-BYTE-P-SIZE-PARAM))
     (30 3 (:REWRITE UNSIGNED-BYTE-P-OF-BVCHOP))
...
(BVAND-EXTEND-TO-32BITS
     (1175 2 (:REWRITE BVAND-WITH-MASK-BETTER))
     (1171 2 (:DEFINITION LOGMASKP))
     (759 6
          (:REWRITE EQUAL-OF-+-WHEN-NEGATIVE-CONSTANT))
     (519 12 (:LINEAR INTEGER-LENGTH-BOUND))
     (240 2 (:REWRITE BVAND-OF-EXPT))
     (222 22 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
     ...
     (48 40 (:LINEAR EXPT-BOUND-LINEAR-WEAK))
...
(BVOR-EXTEND-TO-32BITS
     (175 1 (:REWRITE BVOR-DISJOINT-ONES-ARG2))
     (175 1 (:REWRITE BVOR-DISJOINT-ONES-ARG1))
     (112 12 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
...
(BVSHL-EXTEND-TO-32BITS
     (1048 34 (:REWRITE USB-WHEN-USB8))
     (894 31
          (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
     (853 7
          (:REWRITE UNSIGNED-BYTE-P-OF-+-WHEN-<-OF-LOGTAIL-AND-EXPT))
     (546 96 (:REWRITE BOUND-WHEN-USB2))
     (504 9 (:REWRITE LOGTAIL-BECOMES-0))
     (325 1 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
     (306 4 (:LINEAR <=-OF-LOGTAIL-SAME-LINEAR))
     (285 1
          (:REWRITE UNSIGNED-BYTE-P-OF-BVCAT-ALL-CASES))
     (172 96 (:REWRITE DEFAULT-<-2))
     (120 96 (:REWRITE DEFAULT-<-1))
     (105 66 (:REWRITE NOT-<-WHEN-SBVLT-ALT))
     (96 96 (:REWRITE <-WHEN-BVLT))
     (96 96 (:REWRITE <-TIGHTEN-WHEN-SLICE-IS-0))
     (93 93 (:TYPE-PRESCRIPTION NATP-OF-EXPT))
     (85 1 (:LINEAR BVCHOP-UPPER-BOUND))
     (83 34
         (:REWRITE <-OF-+-COMBINE-CONSTANTS-1))
     (78 66 (:REWRITE NOT-<-WHEN-SBVLT))
     (68 4 (:LINEAR LOGTAIL-NON-NEGATIVE-LINEAR))
     (66 66
         (:REWRITE USE-<=-BOUND-TO-DROP-<=-HYP))
     (66 66
         (:REWRITE <-OF-CONSTANT-WHEN-UNSIGNED-BYTE-P-SIZE-PARAM))
...
(UNSIGNED-BYTE-P-OF-BVSHL-GEN
     (4040 73 (:REWRITE USB-WHEN-USB8))
     (2932 30
           (:REWRITE UNSIGNED-BYTE-P-OF-+-WHEN-<-OF-LOGTAIL-AND-EXPT))
     (2135 70
           (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
     (1806 10 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
     (1793 210 (:REWRITE BOUND-WHEN-USB2))
     (923 5 (:REWRITE LOGTAIL-BECOMES-0))
     (508 2 (:LINEAR <=-OF-LOGTAIL-SAME-LINEAR))
     (446 2 (:LINEAR LOGTAIL-NON-NEGATIVE-LINEAR))
     (444 204 (:REWRITE DEFAULT-<-2))
     (288 204 (:REWRITE DEFAULT-<-1))
     (254 254 (:TYPE-PRESCRIPTION NATP-OF-EXPT))
     (216 142 (:REWRITE NOT-<-WHEN-SBVLT-ALT))
     (212 20 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
     (210 210 (:REWRITE <-WHEN-BVLT))
     (210 210
          (:REWRITE <-TIGHTEN-WHEN-SLICE-IS-0))
     (172 5 (:REWRITE BVCHOP-BOUND-2))
     (161 142 (:REWRITE NOT-<-WHEN-SBVLT))
     (160 16 (:REWRITE <-OF-+-AND-+-CANCEL-1))
     (142 142
          (:REWRITE USE-<=-BOUND-TO-DROP-<=-HYP))
     (142 142
          (:REWRITE <-OF-CONSTANT-WHEN-UNSIGNED-BYTE-P-SIZE-PARAM))
     ...
     (70 70
         (:REWRITE UNSIGNED-BYTE-P-WHEN-<=-CHEAP))
     (68 6 (:REWRITE UNSIGNED-BYTE-P-OF-BVCHOP))
     (63 63
         (:REWRITE <-OF-+-COMBINE-CONSTANTS-1))
     (63 63
         (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
     (60 22 (:REWRITE IFIX-WHEN-INTEGERP))
     (52 20
         (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER))
     (50 40
         (:TYPE-PRESCRIPTION LOGTAIL-NON-POSITIVE))
     (44 14 (:REWRITE SMALL-INT-HACK))
     (41 41
         (:REWRITE INTEGERP-WHEN-UNSIGNED-BYTE-P-SIZE-ARG))
     ...
     (30 30
         (:REWRITE <-OF-+-ARG1-WHEN-NEGATIVE-CONSTANT))
     (28 26 (:REWRITE BVCHOP-OF-EXPT-ALT))
     (26 26
         (:REWRITE BVCHOP-WHEN-TOP-BIT-NOT-1-FAKE-FREE))
     (26 26
         (:REWRITE BVCHOP-WHEN-GETBIT-AND-BVCHOP-KNOWN))
