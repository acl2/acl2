...
(BVSHL-EXTEND-TO-32BITS
     (699 25 (:REWRITE USB-WHEN-USB8))
     (448 22
          (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
     (249 63 (:REWRITE BOUND-WHEN-USB2))
     (145 1
...
(UNSIGNED-BYTE-P-OF-BVSHL-GEN
     (1909 50 (:REWRITE USB-WHEN-USB8))
     (1028 47
           (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
     (660 6 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
     (585 113 (:REWRITE BOUND-WHEN-USB2))
     (171 107 (:REWRITE DEFAULT-<-2))
     (132 12 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
     (129 107 (:REWRITE DEFAULT-<-1))
     (126 82 (:REWRITE NOT-<-WHEN-SBVLT-ALT))
     (113 113 (:REWRITE <-WHEN-BVLT))
     (113 113
          (:REWRITE <-TIGHTEN-WHEN-SLICE-IS-0))
     (100 10 (:REWRITE <-OF-+-AND-+-CANCEL-1))
     (98 82 (:REWRITE NOT-<-WHEN-SBVLT))
     ...
     (20 18 (:REWRITE BVCHOP-OF-EXPT-ALT))
     (18 18
         (:REWRITE BVCHOP-WHEN-TOP-BIT-NOT-1-FAKE-FREE))
     (18 18
         (:REWRITE BVCHOP-WHEN-GETBIT-AND-BVCHOP-KNOWN))
