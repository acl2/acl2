(BVPLUS)
(BVPLUS-ASSOCIATIVE
     (541 12 (:REWRITE BVCHOP-IDENTITY))
     (468 11 (:REWRITE USB-PLUS-FROM-BOUNDS))
     ...
     (5 2 (:REWRITE BVCHOP-SUM-DROP-BVCHOP-ALT))
...
(BVPLUS-OF-0 (64 4 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
...
(BVPLUS-OF-BVCHOP-ARG1
     (1446 53 (:REWRITE BVCHOP-IDENTITY))
     (1104 22 (:REWRITE USB-PLUS-FROM-BOUNDS))
     (419 36 (:DEFINITION NATP))
     (282 90 (:REWRITE DEFAULT-<-2))
     (207 42 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
     (168 168 (:TYPE-PRESCRIPTION NATP-OF-EXPT))
     (168 168
          (:TYPE-PRESCRIPTION INTEGERP-OF-EXPT-TYPE))
     (143 11 (:REWRITE BVCHOP-SUM-DROP-BVCHOP))
     (141 42
          (:REWRITE BVCHOP-WITH-N-NOT-AN-INTEGER))
...
(BVPLUS-OF-BVCHOP-ARG2
     (1462 53 (:REWRITE BVCHOP-IDENTITY))
     (1120 22 (:REWRITE USB-PLUS-FROM-BOUNDS))
     (419 36 (:DEFINITION NATP))
     (282 90 (:REWRITE DEFAULT-<-2))
     (207 42 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
...
(BVPLUS-OF-1-SUBST-ALT
     ...
     (1 1
        (:REWRITE EQUAL-CONSTANT-WHEN-BVCHOP-EQUAL-CONSTANT-FALSE)))
(BVCHOP-OF-BVPLUS
     (2709 65 (:REWRITE USB-PLUS-FROM-BOUNDS))
     (849 849 (:TYPE-PRESCRIPTION IFIX))
     (634 13
          (:REWRITE UNSIGNED-BYTE-P-OF-BVCHOP-WHEN-ALREADY))
     (426 86
          (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
     (314 157 (:REWRITE DEFAULT-<-2))
     (301 12 (:REWRITE UNSIGNED-BYTE-P-OF-0-ARG1))
     (298 52 (:REWRITE COMMUTATIVITY-OF-+))
     (269 119 (:REWRITE DEFAULT-+-1))
     (268 119 (:REWRITE DEFAULT-+-2))
     (229 157 (:REWRITE DEFAULT-<-1))
     (190 150 (:LINEAR EXPT-BOUND-LINEAR))
     (157 53 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
     (134 62
          (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER-CHEAP))
     (133 53
          (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER))
     (110 65 (:REWRITE DEFAULT-UNARY-MINUS))
     (86 86
         (:REWRITE UNSIGNED-BYTE-P-WHEN-<=-CHEAP))
     (86 86
         (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
...
(BVPLUS-CANCEL (248 104
                    (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
               (168 18 (:LINEAR <=-OF-BVCHOP-SAME-LINEAR))
...
(BVPLUS-WHEN-EQUAL-OF-CONSTANT-AND-BVCHOP-ARG3
     (348 72
          (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
     (245 8 (:REWRITE UNSIGNED-BYTE-P-OF-0-ARG1))
     (152 44
          (:REWRITE BVCHOP-WHEN-I-IS-NOT-AN-INTEGER))
