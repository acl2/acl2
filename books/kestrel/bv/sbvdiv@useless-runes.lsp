...
(TRUNCATE-OF-0)
(SBVDIV-OF-0-ARG1
    (230 8 (:REWRITE LOGEXT-WHEN-TOP-BIT-0))
    (209 1 (:REWRITE DEFAULT-UNARY-/))
    (108 9 (:LINEAR GETBIT-BOUND-LINEAR))
    (83 2 (:LINEAR <-OF-LOGEXT-LINEAR-LOWER))
    (82 2 (:LINEAR <-OF-LOGEXT-LINEAR-UPPER))
    (76 2
        (:DEFINITION NONNEGATIVE-INTEGER-QUOTIENT))
