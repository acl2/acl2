(SALSA::BYTE-LISTP-FORWARD-TO-ALL-INTEGERP
 (216 17 (:REWRITE BYTE-LISTP-OF-CDR))
 (116 17 (:REWRITE UNSIGNED-BYTE-P-OF-CAR-WHEN-ALL-UNSIGNED-BYTE-P))
 (105 11 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (96 17 (:REWRITE USE-ALL-UNSIGNED-BYTE-P-FOR-CAR))
 (91 13 (:REWRITE BYTEP-OF-CAR-WHEN-BYTE-LISTP-2))
