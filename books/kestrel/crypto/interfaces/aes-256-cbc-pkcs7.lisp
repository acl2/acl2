...
(definterface-encrypt-init aes-256-cbc-pkcs7
  :key-size 256
  :init-size 128
  :parents (interfaces)
  :short (xdoc::topstring
          "AES-256 CBC PKCS7 " (xdoc::seetopic "interfaces" "interface") ".")
  :long
  (xdoc::topstring
   (xdoc::p
    ...
    ".")
   (xdoc::p
    "According to FIPS PUB 197, AES-256 has a key size of 256 bits.
