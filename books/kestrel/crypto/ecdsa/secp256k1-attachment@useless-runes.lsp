...
(ECDSA::SECP256K1-FIELDP-OF-SECP256K1-SIGN-DET-REC-WRAPPER.R
 ...
 (8 8 (:TYPE-PRESCRIPTION ECURVE::SECP256K1-PRIV-KEY-FIX))
...
(ECDSA::SECP256K1-FIELDP-OF-SECP256K1-SIGN-DET-REC-WRAPPER.S
 (252 252 (:TYPE-PRESCRIPTION ECURVE::SECP256K1-PRIV-KEY-FIX))
 (176 60 (:REWRITE BOOL-FIX-WHEN-BOOLEANP))
 (127 27 (:REWRITE DEFAULT-<-1))
 (116 116 (:TYPE-PRESCRIPTION BOOLEANP))
 (115 39 (:REWRITE ECURVE::SECP256K1-PRIV-KEY-FIX-WHEN-SECP256K1-PRIV-KEY-P))
 (76 76 (:TYPE-PRESCRIPTION ECURVE::SECP256K1-PRIV-KEY-P))
 (68 8 (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
 (55 27 (:REWRITE DEFAULT-<-2))
 (26 6 (:LINEAR ECDSA::<-*Q*-OF-MV-NTH-4-OF-ECDSA-SIGN-DETERMINISTIC-PREHASHED))
