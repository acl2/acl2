...
(SHA2::SHA-256-MESSAGE-BLOCKS
 (248 4 (:DEFINITION ACL2-COUNT))
 (194 7 (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
 (121 9 (:REWRITE SHA2::INTEGERP-WHEN-UNSIGNED-BYTE-P-32))
 (85 9 (:REWRITE USE-ALL-UNSIGNED-BYTE-P))
...
(SHA2::ALL-SHA-256-BLOCKP-OF-SHA-256-MESSAGE-BLOCKS
 (290 10 (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
 (167 9 (:REWRITE SHA2::INTEGERP-WHEN-UNSIGNED-BYTE-P-32))
 (144 11 (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-CONSP))
 (131 9 (:REWRITE USE-ALL-UNSIGNED-BYTE-P))
 (104 9 (:DEFINITION MEMBER-EQUAL))
 (79 70 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
 (78 48 (:REWRITE DEFAULT-<-2))
 (57 42 (:REWRITE MOD-WHEN-<-OF-0))
...
(SHA2::ALL-UNSIGNED-BYTE-P-OF-SHA-256-PREPARE-MESSAGE-SCHEDULE-AUX
 (748 21 (:REWRITE SHA2::INTEGERP-WHEN-UNSIGNED-BYTE-P-32))
 ...
 (506 48 (:REWRITE BVPLUS-WHEN-ARG2-IS-NOT-AN-INTEGER))
 (425 48 (:REWRITE BVPLUS-WHEN-ARG1-IS-NOT-AN-INTEGER))
 (270 270 (:TYPE-PRESCRIPTION LEN))
 (171 117 (:REWRITE DEFAULT-<-2))
 (163 12 (:REWRITE UNSIGNED-BYTE-P-OF-NTH))
...
(SHA2::SHA-256-PROCESS-BLOCK
 ...
 (198 1 (:DEFINITION SHA2::SHA-256-PREPARE-MESSAGE-SCHEDULE-AUX))
 (164 17 (:DEFINITION MEMBER-EQUAL))
 (95 3 (:REWRITE BVPLUS-COMMUTATIVE-2))
