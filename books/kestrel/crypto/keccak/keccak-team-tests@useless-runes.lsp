...
(KECCAK::KAT-MSG-TO-BITS
 (1633 4 (:DEFINITION TAKE))
 (1016 45 (:LINEAR MY-FLOOR-LOWER-BOUND-LINEAR))
 (1014 1014 (:TYPE-PRESCRIPTION FLOOR-TYPE-WHEN-NONPOSITIVE-AND-NONNEGATIVE))
 (1014 1014 (:TYPE-PRESCRIPTION FLOOR-TYPE-1-PART-1-BETTER))
 (926 45 (:LINEAR FLOOR-UPPER-BOUND-LINEAR))
 (771 31 (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
 (701 45 (:LINEAR FLOOR-BOUND-ARG1-LINEAR))
 (676 8 (:REWRITE TAKE-OF-LEN-FREE))
 (554 63 (:DEFINITION LEN))
 (538 373 (:REWRITE DEFAULT-<-1))
 (479 373 (:REWRITE DEFAULT-<-2))
 (366 154 (:REWRITE FLOOR-WHEN-<))
 (334 324 (:REWRITE DEFAULT-*-2))
 (326 324 (:REWRITE DEFAULT-*-1))
 (312 4 (:REWRITE UNSIGNED-BYTE-P-OF-+-OF-CONSTANT-STRONG))
 (311 144 (:REWRITE DEFAULT-+-2))
 (306 31 (:REWRITE MOD-WHEN-MULTIPLE))
 (303 5 (:REWRITE USB-PLUS-FROM-BOUNDS))
 (294 2 (:REWRITE FIRSTN-WHEN-<=-OF-LEN))
 (293 105 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
 (244 9 (:DEFINITION NTH))
 (190 144 (:REWRITE DEFAULT-+-1))
 (161 71 (:REWRITE MULTIPLE-WHEN-MOD-0-CHEAP))
 (154 154 (:REWRITE FLOOR-WHEN-NOT-RATIONALP-OF-QUOTIENT))
 (154 154 (:REWRITE FLOOR-WHEN-NOT-RATIONALP-ARG1))
 (154 154 (:REWRITE FLOOR-WHEN-NEGATIVE-AND-SMALL-CHEAP))
 (154 154 (:REWRITE FLOOR-WHEN-I-IS-NOT-AN-ACL2-NUMBERP))
 (154 154 (:REWRITE FLOOR-MINUS-NEGATIVE-CONSTANT))
...
(KECCAK::BIT-LISTP-OF-KAT-MSG-TO-BITS
 (303 3 (:DEFINITION TAKE))
 (230 7 (:REWRITE TAKE-OF-LEN-FREE))
 (216 27 (:DEFINITION LEN))
 (147 78 (:REWRITE DEFAULT-<-1))
