...
(KECCAK::KAT-MSG-TO-BITS
 (2697 4 (:DEFINITION TAKE))
 (1262 45 (:LINEAR MY-FLOOR-LOWER-BOUND-LINEAR))
 (1172 45 (:LINEAR FLOOR-UPPER-BOUND-LINEAR))
 (1082 1082 (:TYPE-PRESCRIPTION <=-OF-FLOOR-AND-0-WHEN-NONPOSITIVE-AND-NONNEGATIVE-TYPE))
 (1082 1082 (:TYPE-PRESCRIPTION <=-OF-FLOOR-AND-0-WHEN-NONNEGATIVE-AND-NONPOSITIVE-TYPE))
 (1082 1082 (:TYPE-PRESCRIPTION <=-OF-0-AND-FLOOR-WHEN-BOTH-NONPOSITIVE-TYPE))
 (1082 1082 (:TYPE-PRESCRIPTION <-OF-FLOOR-AND-0-WHEN-POSITIVE-AND-NEGATIVE-TYPE))
 (1082 1082 (:TYPE-PRESCRIPTION <-OF-FLOOR-AND-0-WHEN-NEGATIVE-AND-POSITIVE-TYPE))
 (1058 8 (:REWRITE TAKE-OF-LEN-FREE))
 (835 45 (:LINEAR FLOOR-BOUND-ARG1-LINEAR))
 (802 31 (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
 (660 45 (:LINEAR FLOOR-WEAK-MONOTONE-LINEAR-1))
 (656 431 (:REWRITE DEFAULT-<-1))
 (623 45 (:LINEAR FLOOR-BOUND-STRICT-LINEAR))
 (594 431 (:REWRITE DEFAULT-<-2))
 ...
 (378 122 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
 (374 144 (:REWRITE DEFAULT-+-2))
 (352 9 (:DEFINITION NTH))
 (334 324 (:REWRITE DEFAULT-*-2))
 (326 324 (:REWRITE DEFAULT-*-1))
 (306 31 (:REWRITE MOD-WHEN-MULTIPLE))
 (272 17 (:REWRITE UNSIGNED-BYTE-P-OF-FLOOR))
