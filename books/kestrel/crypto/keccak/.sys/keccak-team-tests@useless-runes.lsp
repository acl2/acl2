...
(KECCAK::KAT-MSG-TO-BITS
 (3433 4 (:DEFINITION TAKE))
 (1344 45 (:LINEAR MY-FLOOR-LOWER-BOUND-LINEAR))
 (1254 45 (:LINEAR FLOOR-UPPER-BOUND-LINEAR))
 (1142 8 (:REWRITE TAKE-OF-LEN-FREE))
 (1134 1134 (:TYPE-PRESCRIPTION <=-OF-FLOOR-WHEN-<-TYPE))
 (1134 1134 (:TYPE-PRESCRIPTION <=-OF-FLOOR-AND-0-WHEN-NONPOSITIVE-AND-NONNEGATIVE-TYPE))
 (1134 1134 (:TYPE-PRESCRIPTION <=-OF-FLOOR-AND-0-WHEN-NONNEGATIVE-AND-NONPOSITIVE-TYPE))
 (1134 1134 (:TYPE-PRESCRIPTION <=-OF-0-AND-FLOOR-WHEN-BOTH-NONPOSITIVE-TYPE))
 (1134 1134 (:TYPE-PRESCRIPTION <-OF-FLOOR-AND-0-WHEN-POSITIVE-AND-NEGATIVE-TYPE))
 (1134 1134 (:TYPE-PRESCRIPTION <-OF-FLOOR-AND-0-WHEN-NEGATIVE-AND-POSITIVE-TYPE))
 (901 45 (:LINEAR FLOOR-BOUND-ARG1-LINEAR))
 (802 31 (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
 (768 427 (:REWRITE DEFAULT-<-1))
 (701 45 (:LINEAR FLOOR-WEAK-MONOTONE-LINEAR-1))
 (676 4 (:REWRITE UNSIGNED-BYTE-P-OF-+-OF--1))
 (675 45 (:LINEAR FLOOR-BOUND-STRICT-LINEAR))
 (609 427 (:REWRITE DEFAULT-<-2))
 (571 5 (:REWRITE USB-PLUS-FROM-BOUNDS))
 (554 63 (:DEFINITION LEN))
 (515 225 (:REWRITE FLOOR-WHEN-<))
 (466 2 (:REWRITE FIRSTN-WHEN-<=-OF-LEN))
 (395 144 (:REWRITE DEFAULT-+-2))
 (395 135 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUND))
 (379 9 (:DEFINITION NTH))
 (336 21 (:REWRITE UNSIGNED-BYTE-P-OF-FLOOR))
 (272 262 (:REWRITE DEFAULT-*-2))
 ...
 (135 135 (:REWRITE UNSIGNED-BYTE-P-WHEN-<=-FREE))
...
(KECCAK::RUN-KAT-TEST
 ...
 (31 3 (:REWRITE INTEGERP-OF-CAR-WHEN-INTEGER-LISTP))
...
(KECCAK::RUN-KAT-TESTS
 ...
 (171 14 (:REWRITE INTEGERP-OF-CAR-WHEN-INTEGER-LISTP))
 (153 7 (:DEFINITION INTEGER-LISTP))
