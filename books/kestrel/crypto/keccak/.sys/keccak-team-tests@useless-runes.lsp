...
(KECCAK::KAT-MSG-TO-BITS
 ...
 (1091 1091 (:TYPE-PRESCRIPTION FLOOR-TYPE-WHEN-NONPOSITIVE-AND-NONNEGATIVE))
 (1091 1091 (:TYPE-PRESCRIPTION FLOOR-TYPE-1-PART-1-BETTER))
...
(KECCAK::RUN-KAT-TESTS-AND-REPORT
 (1 1 (:REWRITE KECCAK::TEST-CASE-LISTP-WHEN-NOT-CONSP))
 (1 1 (:REWRITE SUBSETP-TRANS2))
 (1 1 (:REWRITE SUBSETP-TRANS))
 (1 1 (:REWRITE SIZE-NON-NEGATIVE-WHEN-UNSIGNED-BYTE-P-FREE))
 (1 1 (:REWRITE INTEGERP-FROM-UNSIGNED-BYTE-P-SIZE-PARAM))
