...
(BLAKE::CONSP-OF-D-BLOCKS
     (357 5 (:REWRITE TAKE-DOES-NOTHING))
     (194 21 (:REWRITE CEILING-WHEN-MULTIPLE))
     (124 21 (:REWRITE CEILING-WHEN-<=))
...
(BLAKE::LEN-OF-D-BLOCKS
     (1762 8 (:DEFINITION BLAKE::BYTES-TO-BLOCKS))
     (1172 8 (:REWRITE TAKE-DOES-NOTHING))
     (668 23 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (350 177 (:REWRITE DEFAULT-*-2))
     (326 326
          (:TYPE-PRESCRIPTION FLOOR-TYPE-1-PART-1-BETTER))
     (215 177 (:REWRITE DEFAULT-*-1))
     (192 36 (:REWRITE DEFAULT-+-2))
     (181 38 (:REWRITE DEFAULT-UNARY-MINUS))
     (178 18 (:REWRITE MOD-WHEN-MULTIPLE))
     (140 4
          (:REWRITE EQUAL-OF-+-COMBINE-CONSTANTS))
     (112 4
     ...
     (99 17 (:REWRITE MULTIPLE-WHEN-MOD-0-CHEAP))
     (96 4 (:LINEAR FLOOR-UPPER-BOUND-LINEAR))
     (76 4 (:LINEAR FLOOR-BOUND-ARG1-LINEAR))
     ...
     (16 16
         (:TYPE-PRESCRIPTION BLAKE::PAD-DATA-BYTES))
     (12 8
         (:REWRITE NTHCDR-WHEN-NOT-CONSP-CHEAP))
     (8 8 (:REWRITE NTHCDR-WHEN-NOT-POSP))
     (8 8 (:REWRITE NTHCDR-WHEN-EQUAL-OF-LEN))
     (8 8 (:DEFINITION BLAKE::BYTES-TO-BLOCK))
     (4 4
        (:REWRITE EQUAL-OF-+-WHEN-NEGATIVE-CONSTANT))
     (2 2
        (:REWRITE MOD-OF-*-SUBST-CONSTANT-ARG2))
...
(BLAKE::ALL-BLOCKP-OF-D-BLOCKS
     (496 4 (:DEFINITION BLAKE::BYTES-TO-BLOCKS))
     (361 4 (:REWRITE TAKE-DOES-NOTHING))
     (284 9 (:LINEAR CEILING-LOWER-BOUND-LINEAR))
     (156 15 (:REWRITE CEILING-WHEN-MULTIPLE))
     (142 8 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (125 8 (:REWRITE BLAKE::LEN-OF-DATA-BYTES))
...
(BLAKE::BLOCKP-OF-G
     ...
     (1 1
        (:LINEAR LEN-POSITIVE-WHEN-CONSP-LINEAR-CHEAP)))
(BLAKE::LOOP2 (624 416 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
...
(BLAKE::BLOCKP-OF-LOOP2
     ...
     (2 2
        (:REWRITE <-OF-+-ARG1-WHEN-NEGATIVE-CONSTANT)))
(BLAKE::LOOP3 (23 19 (:REWRITE DEFAULT-<-2))
...
(BLAKE::BLAKE2S-MAIN
     ...
     (2 1 (:REWRITE NATP-WHEN-POWER-OF-2P)))
(BLAKE::CEILING-HELPER2 (61 61
                            (:TYPE-PRESCRIPTION FLOOR-TYPE-1-PART-1-BETTER))
                        (38 12 (:REWRITE FLOOR-WHEN-<))
