...
(BLAKE::ALL-WORDP-OF-TAKE
     (1128 41 (:REWRITE TAKE-DOES-NOTHING))
     (898 119 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (223 38 (:REWRITE DEFAULT-CDR))
...
(BLAKE::BLAKE-256-WITH-SALT
     ...
     (39 1 (:LINEAR FLOOR-UPPER-BOUND-LINEAR))
     (35 1 (:LINEAR FLOOR-BOUND-ARG1-LINEAR))
     (29 4 (:REWRITE FLOOR-WHEN-<))
