(BLAKE::XOR-LEMMA
 (102 12 (:REWRITE REWRITE-UNSIGNED-BYTE-P-WHEN-TERM-SIZE-IS-LARGER))
...
(BLAKE::XOR-LEMMA2
 (83 68 (:REWRITE UNSIGNED-BYTE-P-WHEN-ZP-CHEAP))
