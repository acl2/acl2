...
(BLAKE::APPLY-G
 ...
 (70 6 (:REWRITE BLAKE::TRUE-LISTP-WHEN-STATEP))
...
(BLAKE::ALL-WORDP-OF-TAKE
 (1185 41 (:REWRITE TAKE-DOES-NOTHING))
 (915 119 (:REWRITE CONSP-FROM-LEN-CHEAP))
