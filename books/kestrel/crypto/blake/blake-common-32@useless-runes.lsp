...
(BLAKE::WORDP-OF-ROT-WORD
 (237 2 (:DEFINITION POSP))
 (160 16 (:REWRITE MOD-WHEN-MULTIPLE))
 (160 16 (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
 (140 4 (:LINEAR MOD-BOUND-LINEAR-ARG1))
 (128 32 (:REWRITE MULTIPLE-WHEN-MOD-0-CHEAP))
 (128 4 (:LINEAR MOD-BOUND-LINEAR-ARG2))
 (126 2 (:REWRITE BVCAT-WHEN-LOWSIZE-IS-NOT-POSP))
 (122 3 (:REWRITE BVCHOP-WITH-N-NEGATIVE))
 (119 3 (:REWRITE SLICE-OUT-OF-ORDER))
