...
(KDF::ALL-UNSIGNED-BYTE-P-8-OF-F-AUX
     ...
     (10 10
         (:TYPE-PRESCRIPTION HMAC::TRUE-LISTP-OF-HMAC-SHA-512))
...
(KDF::LEN-OF-F-AUX
     (114 3 (:DEFINITION BVXOR-LIST))
     (36 3
         (:REWRITE BVXOR-WHEN-Y-IS-NOT-AN-INTEGER))
     (33 33
         (:TYPE-PRESCRIPTION KDF::TRUE-LISTP-OF-F-AUX))
     (27 3
         (:REWRITE BVXOR-WHEN-X-IS-NOT-AN-INTEGER))
     (27 3 (:DEFINITION LEN))
...
(KDF::F
 ...
 (48 3 (:REWRITE CAR-OF-BYTES-TO-BITS))
...
(KDF::ALL-UNSIGNED-BYTE-P-8-OF-F
     (185 1
          (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-CONSP))
     (166 7 (:DEFINITION BINARY-APPEND))
     (114 3 (:DEFINITION BVXOR-LIST))
     (96 6 (:REWRITE CAR-OF-BYTES-TO-BITS))
     (54 6
         (:REWRITE GETBIT-WHEN-VAL-IS-NOT-AN-INTEGER))
...
(KDF::ALL-INTEGERP-OF-F
     (38 1 (:DEFINITION BVXOR-LIST))
     (31 2 (:DEFINITION BINARY-APPEND))
     (24 2 (:REWRITE ACL2-NUMBERP-X))
     (16 1 (:REWRITE CAR-OF-BYTES-TO-BITS))
...
(KDF::ALL-UNSIGNED-BYTE-P-8-OF-APPENDED-TS
     ...
     (35 35
         (:TYPE-PRESCRIPTION KDF::TRUE-LISTP-OF-F))
     (32 16 (:REWRITE INTEGERP-WHEN-POWER-OF-2P))
...
(KDF::LEN-OF-APPENDED-TS
     ...
     (58 58
         (:TYPE-PRESCRIPTION KDF::TRUE-LISTP-OF-APPENDED-TS))
...
(KDF::ALL-UNSIGNED-BYTE-P-8-OF-PBKDF2-HMAC-SHA-512
     ...
     (903 1
          (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-CONSP))
     (778 89 (:REWRITE INTEGERP-MINUS-X))
     (674 105 (:REWRITE |(* (- x) y)|))
     (649 241
          (:REWRITE PREFER-POSITIVE-ADDENDS-<))
     (597 286 (:REWRITE DEFAULT-LESS-THAN-1))
     (589 51 (:REWRITE FLOOR-=-X/Y . 3))
     (462 462
          (:REWRITE NORMALIZE-FACTORS-GATHER-EXPONENTS))
     (459 102 (:REWRITE |(- (* c x))|))
     (393 51 (:REWRITE FLOOR-=-X/Y . 2))
...
(KDF::LEN-OF-PBKDF2-HMAC-SHA-512
     ...
     (119 119
          (:TYPE-PRESCRIPTION NOT-INTEGERP-1B))
     (116 13 (:REWRITE ACL2-NUMBERP-X))
     (69 1 (:REWRITE FLOOR-ZERO . 3))
     (60 30 (:REWRITE INTEGERP-WHEN-POWER-OF-2P))
     (57 31 (:REWRITE INTEGERP-MINUS-X))
     (57 1 (:REWRITE CANCEL-FLOOR-+))
