...
(TRY-TO-APPLY-RULES-FOR-R1CS-PROVER-RETURN-TYPE-COROLLARY
 ...
 (2349 41 (:DEFINITION PSEUDO-TERM-LISTP))
 (2333 30
       (:REWRITE AXE-TREEP-WHEN-PSEUDO-TERMP))
 (1762 38 (:REWRITE PSEUDO-TERMP-OF-CADDR))
 (1176 30 (:REWRITE AXE-TREEP-WHEN-DARGP))
 (1054 27
       (:REWRITE ALL-AXE-TREEP-WHEN-PSEUDO-TERM-LISTP))
 (1008 72
       (:REWRITE MEMBER-EQUAL-BECOMES-MEMBERP))
 (988 422 (:REWRITE DEFAULT-CDR))
 (916 11 (:DEFINITION DARGP))
 (850 99
      (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
 (746 34
      (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
 ...
 (296 296 (:TYPE-PRESCRIPTION MEMBERP))
...
(TRY-TO-APPLY-RULES-FOR-R1CS-PROVER-RETURN-TYPE-COROLLARY-LINEAR
     (1498 5 (:DEFINITION PSEUDO-TERMP))
     (1206 1 (:DEFINITION AXE-TREEP))
     ...
     (298 1 (:REWRITE ALL-AXE-TREEP-OF-CDR))
     (224 17 (:REWRITE LEN-OF-CDR))
     (187 2 (:REWRITE AXE-TREEP-WHEN-DARGP))
     (185 37
          (:LINEAR LEN-POSITIVE-WHEN-CONSP-LINEAR-CHEAP))
     ...
     (77 35 (:REWRITE USE-ALL-<))
     (72 34
         (:TYPE-PRESCRIPTION NATP-OF-NTH-WHEN-NAT-LISTP-TYPE))
     (55 2 (:DEFINITION QUOTEP))
...
(SIMPLIFY-TREE-AND-ADD-TO-DAG-FOR-R1CS-PROVER-RETURN-TYPE-COROLLARY
     ...
     (3975 26
           (:REWRITE AXE-TREEP-WHEN-PSEUDO-TERMP))
     (1158 26 (:REWRITE AXE-TREEP-WHEN-DARGP))
     (1100 550
           (:TYPE-PRESCRIPTION TRUE-LISTP-OF-AREF1-WHEN-DAG-PARENT-ARRAYP))
     (1091 25
           (:REWRITE ALL-AXE-TREEP-WHEN-PSEUDO-TERM-LISTP))
     (941 25 (:DEFINITION PSEUDO-TERM-LISTP))
     (919 8 (:DEFINITION DARGP))
     (889 36
          (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
     (662 80
          (:REWRITE SET::SETS-ARE-TRUE-LISTS-CHEAP))
     ...
     (517 517
          (:REWRITE LEN-WHEN-BOUNDED-DAG-EXPRP-AND-QUOTEP))
     (450 151 (:REWRITE <-WHEN-BOUNDED-AXE-TREEP))
     (378 13 (:REWRITE ALL-AXE-TREEP-OF-CDR-2))
     (375 151 (:REWRITE USE-ALL-<))
     (310 139
          (:TYPE-PRESCRIPTION NATP-OF-NTH-WHEN-NAT-LISTP-TYPE))
     (282 78
          (:REWRITE R1CS::PSEUDO-VAR-LISTP-WHEN-SYMBOL-LISTP))
...
(SIMPLIFY-TREE-AND-ADD-TO-DAG-FOR-R1CS-PROVER-RETURN-TYPE-COROLLARY-LINEAR
     ...
     (909 21
          (:REWRITE ALL-AXE-TREEP-WHEN-PSEUDO-TERM-LISTP))
     (804 22 (:REWRITE AXE-TREEP-WHEN-DARGP))
     (783 21 (:DEFINITION PSEUDO-TERM-LISTP))
     (700 125
          (:LINEAR LEN-POSITIVE-WHEN-CONSP-LINEAR-CHEAP))
     (622 25
          (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
     (615 6 (:DEFINITION DARGP))
     ...
     (306 99 (:REWRITE <-WHEN-BOUNDED-AXE-TREEP))
     (267 99 (:REWRITE USE-ALL-<))
     (217 21
          (:REWRITE ALL-AXE-TREEP-WHEN-ALL-DARGP))
     (214 95
          (:TYPE-PRESCRIPTION NATP-OF-NTH-WHEN-NAT-LISTP-TYPE))
...
(SIMPLIFY-TREES-AND-ADD-TO-DAG-FOR-R1CS-PROVER-RETURN-TYPE-COROLLARY
  (2339 6
        (:REWRITE AXE-TREEP-WHEN-PSEUDO-TERMP))
  (2315 6 (:DEFINITION PSEUDO-TERMP))
  (1386 46 (:REWRITE CONSP-FROM-LEN-CHEAP))
  (1174 3 (:REWRITE ALL-AXE-TREEP-OF-CDR))
  (1076 6 (:REWRITE AXE-TREEP-WHEN-DARGP))
  (1006 1006 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
  (763 3 (:DEFINITION DARGP))
  (642 6 (:DEFINITION MYQUOTEP))
  ...
  (214 6 (:REWRITE DARGP-WHEN-CONSP-CHEAP))
  (184 4
...
(REWRITE-LITERALS-FOR-R1CS-PROVER
     ...
     (79 7
         (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
     (73 1 (:REWRITE TYPE-OF-GET-DISJUNCTS-TWO))
...
(REWRITE-LITERALS-FOR-R1CS-PROVER-RETURN-TYPE-COROLLARY
     ...
     (78 39
         (:TYPE-PRESCRIPTION NATP-OF-MV-NTH-4-OF-GET-DISJUNCTS))
     (74 2 (:REWRITE TYPE-OF-GET-DISJUNCTS-TWO))
     (65 46
         (:REWRITE MEMBERP-WHEN-SINGLETON-CHEAP))
...
(REWRITE-LITERALS-FOR-R1CS-PROVER-RETURN-TYPE-COROLLARY-LINEAR
     ...
     (65 3 (:REWRITE ALL-<-TRANSITIVE-FREE))
     (63 7 (:REWRITE USE-ALL-<))
...
(REWRITE-CLAUSE-FOR-R1CS-PROVER-RETURN-TYPE-2
     ...
     (2 2
        (:REWRITE EQUAL-CONSTANT-WHEN-BVCHOP-EQUAL-CONSTANT-FALSE)))
(REWRITE-SUBST-AND-ELIM-WITH-RULE-ALIST-FOR-R1CS-PROVER
     (1547 68 (:REWRITE CONSP-FROM-LEN-CHEAP))
     (1343 14 (:REWRITE MAXELEM-SINGLETON-ALT))
     (1097 5 (:REWRITE <-OF-+-OF-1-STRENGTHEN-2))
     ...
     (1 1
        (:REWRITE ALL-UNSIGNED-BYTE-P-IMPLIES-ALL-INTEGERP)))
(REWRITE-SUBST-AND-ELIM-WITH-RULE-ALIST-FOR-R1CS-PROVER-RETURN-TYPE
     ...
     (377 17
          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (373 26 (:REWRITE ALL-<-TRANSITIVE-FREE-2))
     (372 372
          (:TYPE-PRESCRIPTION TYPE-OF-AREF1-WHEN-PSEUDO-DAG-ARRAYP-AUX))
     (365 52 (:REWRITE DEFAULT-<-1))
     (304 26 (:REWRITE ALL-<-TRANSITIVE-FREE))
     (275 20
          (:REWRITE RATIONALP-WHEN-NATP-FOR-AXE))
     (256 40
          (:TYPE-PRESCRIPTION NATP-OF-NTH-WHEN-NAT-LISTP-TYPE))
     (236 52 (:REWRITE DEFAULT-<-2))
     (164 52 (:REWRITE USE-ALL-<))
     ...
     (3 3
        (:REWRITE TRUE-LISTP-WHEN-PSEUDO-DAGP-AUX))
     (3 3 (:REWRITE SET::IN-SET)))
(REWRITE-SUBST-AND-ELIM-WITH-RULE-ALIST-FOR-R1CS-PROVER-RETURN-TYPE-COROLLARY-LINEAR
     (224 224 (:TYPE-PRESCRIPTION POSP-OF-ALEN1))
     (34 6 (:REWRITE USE-ALL-<))
     (16 6 (:REWRITE DEFAULT-<-1))
     (8 8 (:TYPE-PRESCRIPTION MEMBERP))
     ...
     (2 2
        (:REWRITE ACL2-NUMBERP-FROM-UNSIGNED-BYTE-P-SIZE-PARAM))
     (2 2 (:LINEAR ARRAY2P-LINEAR)))
(REWRITE-SUBST-AND-ELIM-WITH-RULE-ALIST-FOR-R1CS-PROVER-RETURN-TYPE-2
     ...
     (5 5
        (:REWRITE <-WHEN-ALL-DARGP-LESS-THAN-GEN)))
(REWRITE-SUBST-AND-ELIM-WITH-RULE-ALISTS-FOR-R1CS-PROVER
     ...
     (1 1
        (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT)))
(REWRITE-SUBST-AND-ELIM-WITH-RULE-ALISTS-FOR-R1CS-PROVER-RETURN-TYPE
     ...
     (60 4
         (:REWRITE <-OF-+-ARG2-WHEN-NEGATIVE-CONSTANT))
     (59 17 (:REWRITE USE-ALL-<))
     (59 10 (:REWRITE ALL-<-TRANSITIVE-FREE-2))
     ...
     (1 1
        (:REWRITE TRUE-LISTP-WHEN-PSEUDO-DAGP-AUX))
     (1 1 (:REWRITE SET::IN-SET)))
(REWRITE-SUBST-AND-ELIM-WITH-RULE-ALISTS-FOR-R1CS-PROVER-RETURN-TYPE-2
