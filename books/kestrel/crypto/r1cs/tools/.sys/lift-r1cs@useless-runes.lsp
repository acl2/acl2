(R1CS::FEP-ASSUMPTIONS-FOR-VARS-AUX
 (58 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-FORWARD-TO-TRUE-LISTP))
 (55 1 (:REWRITE R1CS::PSEUDO-VAR-LISTP-WHEN-SYMBOL-LISTP))
...
(R1CS::R1CS-VAR-TO-LIFTED-VAR-ALIST
 (248 6 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (96 4 (:REWRITE <-0-+-NEGATIVE-1))
