...
(ECURVE::MODP-OF-MODP
     ...
     (701 22 (:REWRITE MOD-WHEN-MULTIPLE))
     (684 2
...
(ECURVE::MODP-OF-1
     ...
     (130 10
          (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
     (120 3 (:LINEAR MOD-BOUND-LINEAR-ARG2))
...
(ECURVE::|2 p/= 0|
     ...
     (39 1 (:LINEAR MOD-BOUND-LINEAR-ARG2))
...
(ECURVE::=P-IMPLIES-=P-I+-1
     (22533 8 (:REWRITE MOD-X-Y-=-X-Y . 1))
     (11661 120
            (:REWRITE PREFER-POSITIVE-ADDENDS-EQUAL))
     (11357 8 (:REWRITE MOD-X-Y-=-X+Y . 1))
     (6632 98
           (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
...
(ECURVE::=P-IMPLIES-=P-I*-2
     ...
     (1 1
        (:REWRITE INTEGERP-+-REDUCE-CONSTANT)))
(ECURVE::=P-IMPLIES-=P-I--1
     (22901 12 (:REWRITE MOD-X-Y-=-X-Y . 1))
     (11637 12 (:REWRITE MOD-X-Y-=-X+Y . 1))
...
(ECURVE::=P-OF-I+-AND-I+-CANCEL
     (344728 46 (:REWRITE MOD-X-Y-=-X-Y . 1))
     (225936 46 (:REWRITE MOD-X-Y-=-X+Y . 1))
     (104650 3498
             (:REWRITE MULTIPLE-WHEN-MOD-0-CHEAP))
     ...
     (15628 213 (:LINEAR MOD-BOUND-LINEAR-ARG1))
