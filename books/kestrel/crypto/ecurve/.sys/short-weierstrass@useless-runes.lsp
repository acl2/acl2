...
(ECURVE::POINT-ON-WEIERSTRASS-ELLIPTIC-CURVE-P-EQUIVALENCE
 (6748 12 (:REWRITE ECURVE::|x =p -y --> x + y =p 0|))
 (1838 8 (:REWRITE MOD-OF-MINUS-ARG1))
 (1786 4 (:REWRITE ECURVE::|x + x =p 0 --> x =p 0|))
 ...
 (1066 2 (:REWRITE PFIELD::EQUAL-OF-ADD-OF-NEG-SIMPLE))
