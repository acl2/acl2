(ECURVE::POINT-FIX (1 1
                      (:TYPE-PRESCRIPTION ECURVE::POINT-FIX)))
(ECURVE::POINTP-OF-POINT-FIX (3 3
                                (:TYPE-PRESCRIPTION ECURVE::POINT-FIX)))
(ECURVE::POINT-FIX-WHEN-POINTP (19 19
                                   (:TYPE-PRESCRIPTION ECURVE::POINT-FIX)))
(FTY::TMP-DEFFIXTYPE-IDEMPOTENT (33 33
                                    (:TYPE-PRESCRIPTION ECURVE::POINT-FIX)))
(ECURVE::POINT-EQUIV$INLINE (4 4
                               (:TYPE-PRESCRIPTION ECURVE::POINT-FIX)))
...
(ECURVE::POINT-FINITE->X-OF-POINT-FIX-P
     (18 18
         (:TYPE-PRESCRIPTION ECURVE::POINT-FIX)))
(ECURVE::POINT-FINITE->X-OF-POINT-FIX-P-NORMALIZE-CONST)
...
(ECURVE::POINT-FINITE->Y-OF-POINT-FIX-P
     (39 39
         (:TYPE-PRESCRIPTION ECURVE::POINT-FIX)))
(ECURVE::POINT-FINITE->Y-OF-POINT-FIX-P-NORMALIZE-CONST)
(ECURVE::POINT-FINITE->Y-POINT-EQUIV-CONGRUENCE-ON-P)
(ECURVE::POINT-FINITE (4 4 (:REWRITE DEFAULT-<-2))
                      (4 4 (:REWRITE DEFAULT-<-1)))
(ECURVE::POINTP-OF-POINT-FINITE (2 2 (:REWRITE DEFAULT-<-2))
...
(ECURVE::POINT-KIND-OF-POINT-FINITE
     ...
     (1 1 (:REWRITE DEFAULT-CDR))
     (1 1 (:REWRITE DEFAULT-CAR)))
(ECURVE::POINT-FINITE->X-OF-POINT-FINITE (3 3 (:REWRITE DEFAULT-<-2))
                                         (3 3 (:REWRITE DEFAULT-<-1))
                                         (2 2 (:REWRITE DEFAULT-CAR))
                                         (1 1 (:REWRITE DEFAULT-CDR)))
(ECURVE::POINT-FINITE->Y-OF-POINT-FINITE (3 3 (:REWRITE DEFAULT-<-2))
                                         (3 3 (:REWRITE DEFAULT-<-1))
...
(ECURVE::POINT-FINITE-OF-NFIX-X-NORMALIZE-CONST)
(ECURVE::POINT-FINITE-NAT-EQUIV-CONGRUENCE-ON-X)
(ECURVE::POINT-FINITE-OF-NFIX-Y)
(ECURVE::POINT-FINITE-OF-NFIX-Y-NORMALIZE-CONST)
