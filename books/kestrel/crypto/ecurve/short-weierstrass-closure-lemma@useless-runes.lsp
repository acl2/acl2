(ECURVE::*-OF-/P-2-INSTANCE (28 18 (:REWRITE DEFAULT-*-2))
...
(ECURVE::*-3-X (5 4 (:REWRITE DEFAULT-+-2))
...
(ECURVE::STEP0-1)
(ECURVE::STEP0-2 (4558 1200
                       (:REWRITE ECURVE::|x =p -y --> x + y =p 0|))
                 (6 6
                    (:TYPE-PRESCRIPTION NONNEGATIVE-IPRODUCT)))
(ECURVE::STEP1 (2558 982 (:REWRITE DEFAULT-+-2))
...
(ECURVE::STEP3 (10 10 (:REWRITE DEFAULT-*-2))
               (10 10 (:REWRITE DEFAULT-*-1)))
(ECURVE::STEP4.1 (11802 3716
                        (:REWRITE ECURVE::|x =p -y --> x + y =p 0|))
...
(ECURVE::STEP5.1 (1949 565
                 ...
                 (4 4 (:REWRITE *-OF-*-COMBINE-CONSTANTS))
                 (2 1
                    (:REWRITE ECURVE::=P-OF-I+-AND-I+-CANCEL)))
(ECURVE::STEP6.1 (3 1
                    (:REWRITE FUNCTIONAL-SELF-INVERSION-OF-IMINUS))
                 (1 1 (:TYPE-PRESCRIPTION INTEGERP-OF-I*)))
(ECURVE::STEP7.1 (27 7
                     (:REWRITE ECURVE::|x =p -y --> x + y =p 0|)))
(ECURVE::STEP8.1 (83 21
                     (:REWRITE ECURVE::|x =p -y --> x + y =p 0|))
                 (20 7
                     (:REWRITE FUNCTIONAL-SELF-INVERSION-OF-IMINUS))
                 (14 1
                 ...
                 (6 6 (:TYPE-PRESCRIPTION INTEGERP-OF-I*))
                 (3 3 (:META CANCEL_IPLUS-EQUAL-CORRECT)))
(ECURVE::STEP9.1 (855 171
                      (:REWRITE ECURVE::|x =p -y --> x + y =p 0|))
                 (2 2
                    (:TYPE-PRESCRIPTION NONNEGATIVE-IPRODUCT)))
(ECURVE::STEP10.1 (124 28
                       (:REWRITE ECURVE::|x =p -y --> x + y =p 0|))
                  (8 4
                     (:TYPE-PRESCRIPTION NONNEGATIVE-IPRODUCT))
                  (4 4 (:TYPE-PRESCRIPTION ECURVE::X3)))
(ECURVE::STEP4.2 (750 750
                      (:TYPE-PRESCRIPTION INTEGERP-OF-I*)))
(ECURVE::STEP5.2 (62 14
                     (:REWRITE ECURVE::|x =p -y --> x + y =p 0|))
                 (20 7
                     (:REWRITE FUNCTIONAL-SELF-INVERSION-OF-IMINUS))
                 (14 1
                 ...
                 (6 6 (:TYPE-PRESCRIPTION INTEGERP-OF-I*))
                 (3 3 (:META CANCEL_IPLUS-EQUAL-CORRECT)))
(ECURVE::STEP6.2 (409 93
                      (:REWRITE ECURVE::|x =p -y --> x + y =p 0|)))
(ECURVE::STEP7.2 (107 27
                      (:REWRITE ECURVE::|x =p -y --> x + y =p 0|))
...
(ECURVE::P[X1.Y1]=0-AND-P[X2.Y2]=0-IMPLIES-P[X3.Y3]=0
     ...
     (36 36
         (:TYPE-PRESCRIPTION ECURVE::QUOTIENT))
