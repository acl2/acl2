...
(PFIELD::ADD-OF-MOD-ARG1
     (384 19 (:REWRITE DISTRIBUTIVITY-ALT))
     (349 12
          (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
     (316 11 (:REWRITE MOD-WHEN-MULTIPLE))
     (139 11 (:REWRITE MOD-WHEN-<))
...
(PFIELD::ADD-OF-MOD-ARG2
     (328 19 (:REWRITE DISTRIBUTIVITY-ALT))
     (321 12
          (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
     (288 11 (:REWRITE MOD-WHEN-MULTIPLE))
     (139 11 (:REWRITE MOD-WHEN-<))
     (99 56 (:REWRITE DEFAULT-*-2))
     (99 56 (:REWRITE DEFAULT-*-1))
...
(PFIELD::EQUAL-OF-SUB-COMBINE-CONSTANTS
     (11222 1610 (:REWRITE MOD-WHEN-MULTIPLE))
...
(PFIELD::MOD-OF-SUB
     (6450 56
           (:REWRITE INTEGERP-OF-*-OF-/-AND-MOD-SAME))
     (5171 199 (:REWRITE MOD-WHEN-MULTIPLE))
     (3542 260 (:REWRITE DISTRIBUTIVITY-ALT))
     (1970 64 (:LINEAR MOD-BOUND-LINEAR-ARG1))
