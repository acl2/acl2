(PFIELD::MUL-WHEN-NOT-INTEGERP-ARG1-CHEAP
     (154 2 (:REWRITE PFIELD::MOD-WHEN-FEP))
     (148 2 (:REWRITE PFIELD::FEP-HOLDS))
...
(PFIELD::EQUAL-OF-NEG-ARG2
     ...
     (57 8 (:REWRITE PFIELD::MOD-WHEN-FEP))
...
(PFIELD::EQUAL-OF-ADD-OF-NEG-ARG2
     (255 23 (:REWRITE MOD-WHEN-MULTIPLE))
     (164 40 (:REWRITE MULTIPLE-WHEN-MOD-0-CHEAP))
     (124 40 (:REWRITE COMMUTATIVITY-OF-*))
...
(PFIELD::NEG-OF-MUL-OF-NEG-ARG1
     ...
     (2502 84 (:REWRITE MOD-WHEN-MULTIPLE))
     (2284 64 (:REWRITE PFIELD::MOD-WHEN-FEP))
     (2104 58 (:REWRITE PFIELD::FEP-HOLDS))
     (1892 58 (:DEFINITION NATP))
     (1236 46 (:REWRITE <-OF-*-AND-0))
     (827 21 (:LINEAR MOD-BOUND-LINEAR-ARG1))
     (775 79 (:LINEAR <-OF-*-SAME-LINEAR-SPECIAL))
...
(PFIELD::NEG-OF-MUL-ARG1
     (1395 68 (:REWRITE MOD-WHEN-MULTIPLE))
     (1300 53 (:REWRITE PFIELD::MOD-WHEN-FEP))
...
(PFIELD::NEG-OF-MUL-ARG2
     (1393 68 (:REWRITE MOD-WHEN-MULTIPLE))
     (1300 53 (:REWRITE PFIELD::MOD-WHEN-FEP))
     (1151 48 (:REWRITE PFIELD::FEP-HOLDS))
     (1025 48 (:DEFINITION NATP))
     (1007 4
...
(PFIELD::MUL-OF-IFIX-ARG1
     (645 10 (:REWRITE PFIELD::MOD-WHEN-FEP))
...
(PFIELD::ADD-OF-IFIX-ARG1
     ...
     (437 10
          (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
     (209 10 (:REWRITE PFIELD::MOD-WHEN-FEP))
