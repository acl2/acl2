...
(PFIELD::PSEUDO-TERM-LISTP-OF-GET-NEGATED-ADDENDS
 (488 244 (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP))
...
(PFIELD::BIND-SUM-OF-NEGATED-TERMS
 (2676 20 (:DEFINITION PFIELD::GET-NEGATED-ADDENDS))
 (1836 100 (:DEFINITION MEMBER-EQUAL))
 (1403 1303 (:REWRITE DEFAULT-CDR))
 (1230 1050 (:REWRITE DEFAULT-CAR))
 (1120 540 (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP))
...
(PFIELD::SYMBOL-TERM-ALISTP-OF-BIND-SUM-OF-NEGATED-TERMS
 (7722 58 (:DEFINITION PFIELD::GET-NEGATED-ADDENDS))
 (5286 290 (:DEFINITION MEMBER-EQUAL))
 (2844 1364 (:TYPE-PRESCRIPTION SYMBOLP-OF-CAR-OF-CAR-WHEN-SYMBOL-TERM-ALISTP))
 (2617 2095 (:REWRITE DEFAULT-CAR))
 (2331 2041 (:REWRITE DEFAULT-CDR))
 (1160 1160 (:TYPE-PRESCRIPTION PFIELD::GET-ADDENDS))
