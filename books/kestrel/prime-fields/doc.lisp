...
(xdoc::defxdoc prime-fields
  ...
  (xdoc::topstring
   ...
   (xdoc::ul
    ...
    (xdoc::li (xdoc::tt "(add x y p)") ": Addition in the field: Computes the sum of " (xdoc::tt "x") " and " (xdoc::tt "y") " modulo the prime " (xdoc::tt "p") ".")
    (xdoc::li (xdoc::tt "(sub x y p)") ": Subtraction in the field: Computes the difference of " (xdoc::tt "x") " and " (xdoc::tt "y") " modulo the prime " (xdoc::tt "p") ".")
    (xdoc::li (xdoc::tt "(neg x p)") ": Negation (additive inverse) in the field: Computes the (unary) negation of " (xdoc::tt "x") " modulo the prime " (xdoc::tt "p") ".")
    (xdoc::li (xdoc::tt "(mul x y p)") ": Multiplication in the field: Computes the product of " (xdoc::tt "x") " and " (xdoc::tt "y") " modulo the prime " (xdoc::tt "p") ".")
    (xdoc::li (xdoc::tt "(pow x n p)") ": Exponentiation in the field: Computes " (xdoc::tt "x") " to the nth power " (xdoc::tt "(x^n)") " modulo the prime " (xdoc::tt "p") ".  Note that " (xdoc::tt "n") " can be any natural.")
    ...
    (xdoc::li (xdoc::tt "(minus1 p)") ": Returns " (xdoc::tt "p-1") ".  This is often very large (if " (xdoc::tt "p") "is very large), but it can help to think of this value as " (xdoc::tt "-1") "."))))
