...
(xdoc::defxdoc prime-fields
  ...
  (xdoc::topstring
   ...
   (xdoc::ul
    ...
    (xdoc::li (xdoc::tt "(add x y p)") ": Addition in the field: Compute the sum of " (xdoc::tt "x") " and " (xdoc::tt "y") " modulo the prime.")
    (xdoc::li (xdoc::tt "(sub x y p)") ": Subtraction in the field: Compute the difference of " (xdoc::tt "x") " and " (xdoc::tt "y") " modulo the prime.")
    (xdoc::li (xdoc::tt "(neg x p)") ": Negation (additive inverse) in the field: Compute the (unary) negation of " (xdoc::tt "x") " modulo the prime.")
    (xdoc::li (xdoc::tt "(mul x y p)") ": Multiplication in the field: Compute the product of " (xdoc::tt "x") " and " (xdoc::tt "y") " modulo the prime.")
    (xdoc::li (xdoc::tt "(pow x n p)") ": Exponentiation in the field: Compute " (xdoc::tt "x") " to the nth power " (xdoc::tt "(x^n)") " modulo the prime. Note that " (xdoc::tt "n") " can be any natural.")
