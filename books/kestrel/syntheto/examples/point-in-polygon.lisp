...
(defmacro must-eval-to--then-eval (fm expected-result)
  `(progn (acl2::must-eval-to ,fm ',expected-result)
          ,fm))
   ...
   (make-toplevel-function
    ...
    (make-function-definition
     ...
     (make-function-header
      :name (make-identifier :name "crossings_count_aux_1")
      :inputs (list (make-typed-variable :name (make-identifier :name "edge0")
                                         :type (make-type-defined :name (make-identifier :name "edge")))
                    (make-typed-variable
                     :name (make-identifier :name "edges")
                     :type (make-type-sequence :element (make-type-defined :name (make-identifier :name "edge"))))
                    (make-typed-variable :name (make-identifier :name "count")
                                         :type (make-type-integer)))
      :outputs (list (make-typed-variable :name (make-identifier :name "n")
                                          :type (make-type-integer))))
     :precondition
     (make-expression-call :function (make-identifier :name "path_p")
                           :types (list)
                           :arguments (list (make-expression-variable :name (make-identifier :name "edges"))))
     :postcondition nil
     :definer
     (make-function-definer-regular
      :body
      (make-expression-if
       :test (make-expression-call
              :function (make-identifier :name "is_empty")
              :types (list (make-type-sequence :element (make-type-defined :name (make-identifier :name "edge"))))
              :arguments (list (make-expression-variable :name (make-identifier :name "edges"))))
       :then (make-expression-variable :name (make-identifier :name "count"))
       :else
       (make-expression-call
        :function (make-identifier :name "crossings_count_aux_1")
        :types (list)
        :arguments
        (list
         (make-expression-variable :name (make-identifier :name "edge0"))
         (make-expression-call
          :function (make-identifier :name "rest")
          :types (list (make-type-sequence :element (make-type-defined :name (make-identifier :name "edge"))))
          :arguments (list (make-expression-variable :name (make-identifier :name "edges"))))
         (make-expression-binary
          ...
          (make-expression-if
           ...
           (make-expression-call
            ...
            :arguments
            (list
             (make-expression-product-field :type (make-identifier :name "edge")
                                            :target (make-expression-variable :name (make-identifier :name "edge0"))
                                            :field (make-identifier :name "p1"))
             (make-expression-product-field :type (make-identifier :name "edge")
                                            :target (make-expression-variable :name (make-identifier :name "edge0"))
                                            :field (make-identifier :name "p2"))
           ...
           :else (make-expression-literal :get (make-literal-integer :value 0)))
          :right-operand (make-expression-variable :name (make-identifier :name "count"))))))
      :measure nil))))))
#|
  ...
  (list
   (make-toplevel-function
    ...
    (make-function-definition
     :header
     (make-function-header
      :name (make-identifier :name "crossings_count_aux_2")
      :inputs (list (make-typed-variable :name (make-identifier :name "edge0")
                                         :type (make-type-defined :name (make-identifier :name "edge")))
                    (make-typed-variable
                     :name (make-identifier :name "edges")
     ...
     (make-expression-binary
      ...
      (make-expression-call :function (make-identifier :name "path_p")
                            ...
                            :arguments (list (make-expression-variable :name (make-identifier :name "edges"))))
      :right-operand
      (make-expression-call :function (make-identifier :name "natp")
                            :types (list)
                            :arguments (list (make-expression-variable :name (make-identifier :name "count")))))
     :postcondition nil
     :definer
     (make-function-definer-regular
      ...
      (make-expression-if
       ...
       :else
       (make-expression-call
        :function (make-identifier :name "crossings_count_aux_2")
        :types (list)
        :arguments
        (list
         (make-expression-variable :name (make-identifier :name "edge0"))
  ...
  (list
   (make-toplevel-function
    ...
    (make-function-definition
     :header
     (make-function-header
      :name (make-identifier :name "crossings_count_aux_3")
      :inputs (list (make-typed-variable :name (make-identifier :name "edge0")
                                         :type (make-type-defined :name (make-identifier :name "edge")))
                    (make-typed-variable
                     :name (make-identifier :name "vertices")
                     :type (make-type-sequence :element (make-type-defined :name (make-identifier :name "point"))))
                    (make-typed-variable :name (make-identifier :name "count")
                                         :type (make-type-integer)))
      :outputs (list (make-typed-variable :name (make-identifier :name "n")
                                          :type (make-type-integer))))
     ...
     (make-expression-binary
      :operator (make-binary-op-and)
      :left-operand
      (make-expression-call :function (make-identifier :name "points2_p")
                            :types (list)
                            :arguments (list (make-expression-variable :name (make-identifier :name "vertices"))))
      :right-operand
      (make-expression-binary
       :operator (make-binary-op-and)
       :left-operand
       (make-expression-call
        ...
        :arguments
        (list
         (make-expression-call :function (make-identifier :name "path")
                               :types (list)
                               :arguments (list (make-expression-variable :name (make-identifier :name "vertices"))))))
       :right-operand
       (make-expression-call :function (make-identifier :name "natp")
     ...
     (make-function-definer-regular
      ...
      (make-expression-if
       ...
       (make-expression-binary
        ...
        (make-expression-call
         :function (make-identifier :name "is_empty")
         :types (list (make-type-sequence :element (make-type-defined :name (make-identifier :name "point"))))
         :arguments (list (make-expression-variable :name (make-identifier :name "vertices"))))
        :right-operand
        (make-expression-call
         :function (make-identifier :name "is_empty")
       ...
       :else
       (make-expression-call
        :function (make-identifier :name "crossings_count_aux_3")
        :types (list)
        :arguments
        (list
         (make-expression-variable :name (make-identifier :name "edge0"))
         (make-expression-call :function (make-identifier :name "rest1")
                               :types (list)
                               :arguments (list (make-expression-variable :name (make-identifier :name "vertices"))))
         (make-expression-binary
          :operator (make-binary-op-add)
          :left-operand (make-expression-variable :name (make-identifier :name "count"))
          :right-operand
          (make-expression-if
           :test
           (make-expression-call
  ...
  (list
   (make-toplevel-function
    ...
    (make-function-definition
     :header
     (make-function-header
      :name (make-identifier :name "crossings_count_aux_4")
      :inputs (list (make-typed-variable :name (make-identifier :name "edge0")
                                         :type (make-type-defined :name (make-identifier :name "edge")))
                    (make-typed-variable
                     :name (make-identifier :name "vertices")
        ...
        (make-expression-call
         ...
         (list
          (make-expression-call
           ...
           :types (list (make-type-sequence :element (make-type-defined :name (make-identifier :name "point"))))
           :arguments (list (make-expression-variable :name (make-identifier :name "vertices")))))))
       :then (make-expression-call :function (make-identifier :name "odd")
                                   :types (list)
                                   :arguments (list (make-expression-variable :name (make-identifier :name "count"))))
       :else
       (make-expression-call
        :function (make-identifier :name "crossings_count_aux_4")
        :types (list)
        :arguments
        (list
         (make-expression-variable :name (make-identifier :name "edge0"))
  ...
  (list
   (make-toplevel-function
    ...
    (make-function-definition
     :header
     (make-function-header
      :name (make-identifier :name "crossings_count_aux_5")
      :inputs (list (make-typed-variable :name (make-identifier :name "edge0")
                                         :type (make-type-defined :name (make-identifier :name "edge")))
                    (make-typed-variable
                     :name (make-identifier :name "vertices")
                    ...
                    (make-typed-variable :name (make-identifier :name "count")
                                         :type (make-type-integer))
                    (make-typed-variable :name (make-identifier :name "count_odd")
                                         :type (make-type-boolean)))
      :outputs (list (make-typed-variable :name (make-identifier :name "n")
                                          :type (make-type-boolean))))
     :precondition
     (make-expression-binary
      ...
      (make-expression-binary
       :operator (make-binary-op-eq)
       :left-operand (make-expression-variable :name (make-identifier :name "count_odd"))
       :right-operand
       (make-expression-call :function (make-identifier :name "odd")
                             :types (list)
                             :arguments (list (make-expression-variable :name (make-identifier :name "count"))))))
     :postcondition nil
     :definer
        ...
        (make-expression-call
         ...
         (list
          (make-expression-call
           ...
           :types (list (make-type-sequence :element (make-type-defined :name (make-identifier :name "point"))))
           :arguments (list (make-expression-variable :name (make-identifier :name "vertices")))))))
       :then (make-expression-variable :name (make-identifier :name "count_odd"))
       :else
       (make-expression-call
        :function (make-identifier :name "crossings_count_aux_5")
        :types (list)
        :arguments
        (list
         (make-expression-variable :name (make-identifier :name "edge0"))
            ...
            (make-expression-call
             ...
             (list
              (make-expression-call
               ...
               :types (list (make-type-sequence :element (make-type-defined :name (make-identifier :name "point"))))
               :arguments (list (make-expression-variable :name (make-identifier :name "vertices"))))))))
          :then (make-expression-unary :operator (make-unary-op-not)
                                       :operand (make-expression-variable :name (make-identifier :name "count_odd")))
          :else (make-expression-variable :name (make-identifier :name "count_odd"))))))
      :measure nil))))))
#|
  ...
  (list
   (make-toplevel-function
    ...
    (make-function-definition
     :header
     (make-function-header
      :name (make-identifier :name "crossings_count_aux_6")
      :inputs (list (make-typed-variable :name (make-identifier :name "edge0")
                                         :type (make-type-defined :name (make-identifier :name "edge")))
                    (make-typed-variable
                     :name (make-identifier :name "vertices")
     ...
     (make-function-definer-regular
      ...
      (make-expression-if
       ...
       :else
       (make-expression-call
        :function (make-identifier :name "crossings_count_aux_6")
        :types (list)
        :arguments
        (list
         (make-expression-variable :name (make-identifier :name "edge0"))
  ...
  (list
   (make-toplevel-function
    ...
    (make-function-definition
     :header
     (make-function-header
      :name (make-identifier :name "crossings_count_1")
      :inputs (list (make-typed-variable :name (make-identifier :name "p")
                                         :type (make-type-defined :name (make-identifier :name "point")))
                    (make-typed-variable
                     :name (make-identifier :name "polygon")
                     :type (make-type-sequence :element (make-type-defined :name (make-identifier :name "point")))))
      :outputs (list (make-typed-variable :name (make-identifier :name "n")
                                          :type (make-type-boolean))))
     :precondition
     (make-expression-call :function (make-identifier :name "simple_polygon")
                           :types (list)
                           :arguments (list (make-expression-variable :name (make-identifier :name "polygon"))))
     :postcondition nil
     :definer
     (make-function-definer-regular
      :body
      (make-expression-bind
       :variables (list (make-typed-variable :name (make-identifier :name "pm")
                                             :type (make-type-defined :name (make-identifier :name "point"))))
       :value
        ...
        (list
         (make-initializer
          ...
          (make-expression-binary
           ...
           :right-operand
           (make-expression-call :function (make-identifier :name "max_x")
                                 :types (list)
                                 :arguments (list (make-expression-variable :name (make-identifier :name "polygon"))))))
         (make-initializer
          :field (make-identifier :name "y")
          :value (make-expression-product-field :type (make-identifier :name "point")
                                                :target (make-expression-variable :name (make-identifier :name "p"))
                                                :field (make-identifier :name "y")))))
       :body
       (make-expression-bind
        :variables (list (make-typed-variable :name (make-identifier :name "e")
                                              :type (make-type-defined :name (make-identifier :name "edge"))))
        :value
        (make-expression-product-construct
         :type (make-identifier :name "edge")
         :fields (list (make-initializer :field (make-identifier :name "p1")
                                         :value (make-expression-variable :name (make-identifier :name "p")))
                       (make-initializer :field (make-identifier :name "p2")
                                         :value (make-expression-variable :name (make-identifier :name "pm")))))
        :body
        (make-expression-call
         :function (make-identifier :name "crossings_count_aux_6")
         :types (list)
         :arguments
         (list
          (make-expression-variable :name (make-identifier :name "e"))
          (make-expression-call :function (make-identifier :name "append_first")
                                :types (list)
                                :arguments (list (make-expression-variable :name (make-identifier :name "polygon"))))
          (make-expression-literal :get (make-literal-boolean :value nil))))))
      :measure nil))))))
 ...
 (process-syntheto-toplevel
  (make-toplevel-transform
   :get (make-transform
         ...
         :arguments ())))
 (make-outcome-transformation-success
  :message "point_in_polygon_final"
  :toplevels
  (list
   (make-toplevel-function
    :get
    (make-function-definition
     :header
     (make-function-header
      :name (make-identifier :name "point_in_polygon_final")
      :inputs (list (make-typed-variable :name (make-identifier :name "p")
                                         :type (make-type-defined :name (make-identifier :name "point")))
                    (make-typed-variable
                     :name (make-identifier :name "polygon")
     ...
     (make-function-definer-regular
      ...
      (make-expression-binary
       ...
       (make-expression-call :function (make-identifier :name "simple_polygon")
                             ...
                             :arguments (list (make-expression-variable :name (make-identifier :name "polygon"))))
       :right-operand
       (make-expression-call :function (make-identifier :name "crossings_count_1")
                             :types (list)
                             :arguments (list (make-expression-variable :name (make-identifier :name "p"))
                                              (make-expression-variable :name (make-identifier :name "polygon")))))
      :measure nil)))
   (make-toplevel-theorem
    :get
    (make-theorem
     :name (make-identifier :name "point_in_polygon_to_point_in_polygon_final")
     :variables
     (list (make-typed-variable :name (make-identifier :name "p")
                                :type (make-type-defined :name (make-identifier :name "point")))
           (make-typed-variable
            :name (make-identifier :name "polygon")
            :type (make-type-sequence :element (make-type-defined :name (make-identifier :name "point")))))
     ...
     (make-expression-binary
      :operator (make-binary-op-eq)
      :left-operand
      (make-expression-call :function (make-identifier :name "point_in_polygon")
                            :types (list)
                            :arguments (list (make-expression-variable :name (make-identifier :name "p"))
                                             (make-expression-variable :name (make-identifier :name "polygon"))))
      :right-operand
      (make-expression-call :function (make-identifier :name "point_in_polygon_final")
                            :types (list)
                            :arguments (list (make-expression-variable :name (make-identifier :name "p"))
                                             (make-expression-variable :name (make-identifier :name "polygon"))))))))))
