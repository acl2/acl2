...
(BV-ARRAYP-LIST-OF-TAKE
 (2016 180 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (1563 61 (:REWRITE TAKE-DOES-NOTHING))
...
(BV-ARRAYP-LIST-OF-NTHCDR
 (1024 82 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (299 10 (:REWRITE ALL-UNSIGNED-BYTE-P-WHEN-NOT-CONSP))
 (267 7 (:DEFINITION NTH))
 (232 25 (:REWRITE DEFAULT-CDR))
 (218 8 (:REWRITE LEN-OF-NTHCDR))
...
(2D-ARRAYP-WHEN-2D-BV-ARRAYP
 ...
 (159 6 (:REWRITE BV-ARRAYP-LIST-WHEN-LST-IS-NOT-A-CONS))
