...
(APPLY$-BVAND
 (9736 54 (:DEFINITION APPLY$-BADGEP))
 (8598 144 (:REWRITE INTEGERP-OF-CAR-WHEN-INTEGER-LISTP))
 (8426 82 (:DEFINITION INTEGER-LISTP))
 (6504 118 (:REWRITE APPLY$-BADGEP-PROPERTIES . 1))
 (5468 2 (:REWRITE BVAND-WHEN-Y-IS-NOT-AN-INTEGER))
 (5252 28 (:DEFINITION SUBSETP-EQUAL))
 (4888 392 (:DEFINITION MEMBER-EQUAL))
 (3428 64 (:REWRITE APPLY$-BADGEP-PROPERTIES . 2))
 (3130 2 (:REWRITE BVAND-WITH-MASK-BETTER))
 (3126 2 (:DEFINITION LOGMASKP))
 (3072 196 (:REWRITE MEMBER-EQUAL-NEWVAR-COMPONENTS-1))
 (2990 2990 (:REWRITE DEFAULT-CDR))
 (2874 140 (:REWRITE INTEGER-LISTP-OF-CDR-WHEN-INTEGER-LISTP))
