...
(ABNF::RULENAMES-FROM-SINGULAR-CONC-AND-REP
 (366 3 (:DEFINITION ABNF::RULENAMES-FROM-SINGULAR-CONC-AND-REP))
 (266 5 (:REWRITE STRING-LISTP-WHEN-NOT-CONSP))
 (69 5 (:REWRITE ABNF::0-WHEN-MATCH-REPEAT-RANGE-0))
 ...
 (50 6 (:REWRITE ABNF::CONCATENATIONP-WHEN-NOT-CONSP))
 (45 9 (:REWRITE FTY::RESULTERRP-WHEN-RESULTERR-OPTIONP))
...
(ABNF::STRING-LIST-RESULTP-OF-RULENAMES-FROM-SINGULAR-CONC-AND-REP
 (647 133 (:REWRITE DEFAULT-CAR))
 (500 20 (:REWRITE ABNF::REPETITIONP-OF-CAR-WHEN-CONCATENATIONP))
 (368 27 (:REWRITE LEN-WHEN-ATOM))
 (323 19 (:REWRITE ABNF::0-WHEN-MATCH-REPEAT-RANGE-0))
 (309 144 (:REWRITE CONSP-UNDER-IFF-WHEN-TRUE-LISTP))
 (288 288 (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-CONS-LISTP))
 (288 288 (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
 (240 20 (:REWRITE ABNF::CONCATENATIONP-WHEN-NOT-CONSP))
 (214 23 (:REWRITE STRING-LISTP-WHEN-NOT-CONSP))
...
(ABNF::RULE-SIMPLE-SUBS
 (64 6 (:REWRITE ABNF::RULEP-WHEN-MEMBER-EQUAL-OF-RULELISTP))
