...
(ABNF::RULELIST-CALLED-RULES
     ...
     (35 7 (:REWRITE SET::SETP-WHEN-NAT-SETP))
     (35 7
     ...
     (32 32
         (:REWRITE CONSP-WHEN-MEMBER-EQUAL-OF-ATOM-LISTP))
     (30 8 (:REWRITE SET::SFIX-SET-IDENTITY))
     (30 6
         (:REWRITE ABNF::RULEP-WHEN-MAYBE-RULEP))
     (21 3
         (:REWRITE ABNF::MAYBE-RULEP-WHEN-RULEP))
     (19 1 (:REWRITE ABNF::TREE-SETP-OF-UNION))
     ...
     (15 1 (:REWRITE SET::NAT-SETP-OF-UNION))
     (15 1 (:REWRITE SET::INTEGER-SETP-OF-UNION))
     (12 1
