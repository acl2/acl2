...
(FLAG-LEMMA-FOR-PSEUDO-TERMP-OF-EXPAND-LAMBDAS-IN-TERM
 ...
 (600 24 (:REWRITE CAR-OF-SUBLIS-VAR-SIMPLE))
 (405 15 (:REWRITE CDR-OF-SUBLIS-VAR-SIMPLE))
 (390 39 (:REWRITE ASSOC-EQUAL-OF-PAIRLIS$-IFF))
 (351 39 (:DEFINITION ASSOC-EQUAL))
 (294 147 (:REWRITE CONSP-OF-CAR-WHEN-SYMBOL-TERM-ALISTP-CHEAP))
 (273 39 (:DEFINITION MEMBER-EQUAL))
