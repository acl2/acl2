(COUNT-FREE-OCCURENCES-IN-TERM
 (499 212 (:REWRITE DEFAULT-+-2))
 (295 212 (:REWRITE DEFAULT-+-1))
...
(FLAG-LEMMA-FOR-PSEUDO-TERMP-OF-SUBSTITUTE-UNNECESSARY-LAMBDA-VARS-IN-TERM
 (12516 7908 (:REWRITE DEFAULT-CDR))
...
(SUBSTITUTE-UNNECESSARY-LAMBDA-VARS-IN-TERM
 (29868 131 (:DEFINITION SUBSTITUTE-UNNECESSARY-LAMBDA-VARS-IN-TERM))
 (16327 10637 (:REWRITE DEFAULT-CDR))
 (13634 1050 (:DEFINITION SET-DIFFERENCE-EQUAL))
 (11941 9068 (:REWRITE DEFAULT-CAR))
 (7061 1409 (:DEFINITION MEMBER-EQUAL))
 (5704 344 (:DEFINITION VARS-BOUND-TO-THEMSELVES))
 (5698 238 (:DEFINITION VARS-BOUND-TO-MV-NTHS))
 (4104 2052 (:REWRITE CONSP-OF-CAR-WHEN-SYMBOL-TERM-ALISTP-CHEAP))
 (3629 149 (:DEFINITION PAIR-GIVEN-FORMALS-WITH-ARGS))
 (3600 154 (:DEFINITION GET-ARGS-FOR-FORMALS))
 (2758 238 (:DEFINITION PAIRLIS$))
 (1628 328 (:DEFINITION TRUE-LIST-FIX))
 (1585 275 (:REWRITE FREE-VARS-IN-TERM-WHEN-NOT-CONSP-CHEAP))
 (548 276 (:REWRITE APPEND-WHEN-NOT-CONSP-ARG1-CHEAP))
 (464 32 (:DEFINITION PSEUDO-TERM-LISTP))
 (294 147 (:REWRITE DEFAULT-+-2))
 (226 91 (:REWRITE PSEUDO-TERM-LISTP-WHEN-SYMBOL-LISTP-CHEAP-2))
 (220 16 (:REWRITE PSEUDO-TERM-LISTP-OF-SET-DIFFERENCE-EQUAL))
 (155 147 (:REWRITE DEFAULT-+-1))
 (149 149 (:DEFINITION ACONS))
 ...
 (64 12 (:REWRITE CONSP-OF-UNION-EQUAL))
