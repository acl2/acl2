(STATE-P1-OF-CLOSE-INPUT-CHANNEL
 ...
 (3540 3539 (:REWRITE DEFAULT-CDR))
 (2178 198 (:DEFINITION FGETPROP))
 (1833 109 (:REWRITE WRITEABLE-FILES-P-OF-WRITEABLE-FILES))
 (1833 109 (:REWRITE OPEN-CHANNELS-P-OF-OPEN-OUTPUT-CHANNELS))
 (1831 109 (:REWRITE WRITTEN-FILES-P-OF-WRITTEN-FILES))
 (1831 109 (:REWRITE READABLE-FILES-P-OF-READABLE-FILES))
 (1826 108 (:REWRITE OPEN-CHANNELS-P-OF-OPEN-INPUT-CHANNELS))
 (1826 108 (:REWRITE FILE-CLOCK-P-OF-FILE-CLOCK))
 (928 464 (:TYPE-PRESCRIPTION NATP-OF-FILE-CLOCK))
 (561 99 (:DEFINITION SYMBOL-LISTP))
 (561 99 (:DEFINITION RATIONAL-LISTP))
 (531 1 (:REWRITE STATE-P1-OF-UPDATE-OPEN-INPUT-CHANNELS))
