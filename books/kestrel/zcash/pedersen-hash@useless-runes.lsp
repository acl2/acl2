...
(ZCASH::LEMMA2 (266 58 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
               (266 58
                    (:TYPE-PRESCRIPTION MOD-POSITIVE . 2))
               (207 9 (:REWRITE MOD-ZERO . 2))
               (195 11 (:REWRITE CANCEL-FLOOR-+))
               (175 175
...
(ZCASH::VERIFY-GUARDS-LEMMA (16 16 (:TYPE-PRESCRIPTION NOT-INTEGERP-3B))
                            (16 16
                                (:TYPE-PRESCRIPTION NOT-INTEGERP-2B)))
(ZCASH::PEDERSEN-SEGMENT-SCALAR-LOOP
     (688 8 (:REWRITE TAKE-OF-LEN-FREE))
     (656 4 (:DEFINITION TAKE))
...
(ZCASH::PEDERSEN-SEGMENT-POINT
     ...
     (1 1
        (:REWRITE EQUAL-CONSTANT-WHEN-BVCHOP-EQUAL-CONSTANT-FALSE))
     (1 1
        (:REWRITE BITS=>BEBYTES-OF-BIT-LIST-FIX-DIGITS-NORMALIZE-CONST))
     (1 1 (:REWRITE |(< 0 (- x))|)))
...
(ZCASH::PEDERSEN-POINT
     ...
     (6 1 (:REWRITE INTEGERP==>DENOMINATOR=1))
