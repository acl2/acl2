(PFIELD::EQUAL-OF-ADD-OF-NEG-ALT
 (79389 739 (:REWRITE PFIELD::MOD-WHEN-FEP))
 (18966 2360 (:REWRITE INEQ-HACK))
 (17705 491 (:REWRITE R1CS::BITP-IN-FIELD))
 (16693 487 (:REWRITE BITP-BECOMES-UNSIGNED-BYTE-P))
 (13197 718 (:REWRITE R1CS::INTEGERP-OF-*-OF-/-WHEN-POWER-OF-2P-AND-POWER-OF-2P))
 (12543 121 (:LINEAR MOD-BOUND-LINEAR-ARG1))
 (11088 56 (:REWRITE INTEGERP-OF-*-OF-/-AND-MOD-SAME))
 (10157 105 (:REWRITE SMALL-INT-HACK))
 (9251 482 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (8673 43 (:REWRITE <-OF-IF-ARG2))
 (6466 77 (:REWRITE INTEGERP-OF-+-WHEN-INTEGERP-2))
 (5331 4657 (:REWRITE DEFAULT-<-1))
 (4697 25 (:REWRITE <-+-NEGATIVE-0-1))
 ...
 (3792 62 (:REWRITE INTEGERP-OF-+-WHEN-INTEGERP-1))
 (3711 3 (:REWRITE <-OF-+-CANCEL-1-1+))
 (3436 2360 (:REWRITE NOT-<-WHEN-SBVLT))
 (3072 85 (:REWRITE INTEGERP-OF-+-WHEN-INTEGERP-1-CHEAP))
 ...
 (1938 11 (:REWRITE <-0-+-NEGATIVE-2))
 (1881 3 (:REWRITE <-0-MINUS))
 (1688 96 (:REWRITE DISTRIBUTIVITY))
 ...
 (1205 30 (:REWRITE UNSIGNED-BYTE-P-OF-IF))
 ...
 (335 5 (:REWRITE UNSIGNED-BYTE-P-OF-+-OF-MINUS))
...
(PFIELD::EQUAL-OF-ADD-OF-ADD-OF-NEG-ARG2-ARG2-ALT
 ...
 (1303 1 (:REWRITE INTEGERP-OF-*-OF-/-AND-MOD-SAME))
