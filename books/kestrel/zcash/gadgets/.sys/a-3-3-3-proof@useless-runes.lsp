...
(ZCASH::MUL-OF-+-ARG2
 (374 2 (:REWRITE PFIELD::MOD-WHEN-FEP))
 (289 3 (:REWRITE PFIELD::FEP-HOLDS))
 (232 5 (:REWRITE NATP-WHEN-INTEGERP-CHEAP))
 (227 1 (:REWRITE MOD-OF-+-SUBST-CONSTANT))
 (169 3 (:REWRITE R1CS::BITP-IN-FIELD))
 (163 3 (:REWRITE BITP-BECOMES-UNSIGNED-BYTE-P))
 (147 2 (:REWRITE MOD-WHEN-<))
 (145 2 (:REWRITE <-OF-IF-ARG2))
 (105 1 (:REWRITE PFIELD::EQUAL-OF-MUL-AND-MUL-SAME))
...
(ZCASH::ADD-OF-NEG-OF-MUL-SAME-UNDISTRIBUTE
 (195 3 (:REWRITE PFIELD::MOD-WHEN-FEP))
 (138 1 (:REWRITE NATP-WHEN-INTEGERP-CHEAP))
