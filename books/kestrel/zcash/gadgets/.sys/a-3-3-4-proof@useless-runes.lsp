(ZCASH::SOLVE-FOR-XPRIME
 (2922 153 (:REWRITE R1CS::BITP-IN-FIELD))
 (2688 57 (:REWRITE BITP-BECOMES-UNSIGNED-BYTE-P))
 (1866 57 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (1845 45 (:DEFINITION NATP))
 (1651 147 (:REWRITE PFIELD::FEP-WHEN-CONSTANT))
 ...
 (449 449 (:REWRITE DROP-LINEAR-HYPS2))
 ...
 (446 446 (:REWRITE <-TRANS))
 (446 446 (:REWRITE <-TIGHTEN-WHEN-SLICE-IS-0))
 (446 446 (:REWRITE <-LEMMA-FOR-KNOWN-OPERATORS-NON-DAG))
 (446 446 (:REWRITE <-FROM-<=-FREE))
 (430 430 (:REWRITE USE-ALL-<-2))
 (430 430 (:REWRITE USE-ALL-<))
 (430 430 (:REWRITE <-WHEN-BOUNDED-DARG-LISTP-GEN))
 (328 4 (:REWRITE PFIELD::FEP-OF-IFIX))
 (315 26 (:REWRITE R1CS::INTEGERP-OF-*-OF-/-WHEN-POWER-OF-2P-AND-POWER-OF-2P))
...
(ZCASH::SOLVE-FOR-LAMBDA
 (250 5 (:REWRITE R1CS::BITP-IN-FIELD))
 (240 5 (:REWRITE BITP-BECOMES-UNSIGNED-BYTE-P))
 (205 5 (:DEFINITION NATP))
 (204 4 (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
 (170 5 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (102 4 (:REWRITE MOD-WHEN-MULTIPLE))
 (87 8 (:REWRITE R1CS::INTEGERP-OF-*-OF-/-WHEN-POWER-OF-2P-AND-POWER-OF-2P))
