(ZCASH::SOLVE-FOR-XPRIME
 ...
 (276 13 (:REWRITE R1CS::INTEGERP-OF-*-OF-/-WHEN-POWER-OF-2P-AND-POWER-OF-2P))
 (270 45 (:REWRITE INTEGERP-IMPLIES-ACL2-NUMBERP))
 (200 200 (:REWRITE INTEGERP-WHEN-UNSIGNED-BYTE-P-SIZE-ARG))
 (200 200 (:REWRITE INTEGERP-WHEN-UNSIGNED-BYTE-P-FREE))
 (200 200 (:REWRITE INTEGERP-WHEN-SIGNED-BYTE-P))
 (200 200 (:REWRITE INTEGERP-WHEN-DARGP-LESS-THAN))
 (200 200 (:REWRITE INTEGERP-FROM-UNSIGNED-BYTE-P-SIZE-PARAM))
...
(ZCASH::SOLVE-FOR-LAMBDA
 ...
 (75 4 (:REWRITE R1CS::INTEGERP-OF-*-OF-/-WHEN-POWER-OF-2P-AND-POWER-OF-2P))
