(ZCASH::SOLVE-FOR-XPRIME
 (2649 153 (:REWRITE R1CS::BITP-IN-FIELD))
 (2415 57 (:REWRITE BITP-BECOMES-UNSIGNED-BYTE-P))
 (1593 57 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
 (1575 45 (:DEFINITION NATP))
 (1463 147 (:REWRITE PFIELD::FEP-WHEN-CONSTANT))
 (926 430 (:REWRITE DEFAULT-<-1))
...
(ZCASH::SOLVE-FOR-LAMBDA
 (225 5 (:REWRITE R1CS::BITP-IN-FIELD))
 (215 5 (:REWRITE BITP-BECOMES-UNSIGNED-BYTE-P))
 (175 5 (:DEFINITION NATP))
 (168 4 (:REWRITE MOD-WHEN-INTEGERP-OF-QUOTIENT))
 (145 5 (:REWRITE UNSIGNED-BYTE-P-FROM-BOUNDS))
