...
(ITEMS-HAVE-LEN-OF-CDR (5 1 (:DEFINITION LEN))
                       (2 1 (:REWRITE DEFAULT-+-2))
                       (1 1 (:REWRITE DEFAULT-CAR))
                       (1 1 (:REWRITE DEFAULT-+-1)))
(ITEMS-HAVE-LEN-OF-CONS (25 5 (:DEFINITION LEN))
                        (10 5 (:REWRITE DEFAULT-+-2))
                        (8 8 (:REWRITE DEFAULT-CDR))
                        (8 2 (:REWRITE ITEMS-HAVE-LEN-OF-CDR))
                        (5 5 (:REWRITE DEFAULT-+-1))
                        (3 3 (:REWRITE DEFAULT-CAR)))
(ITEMS-HAVE-LEN-OF-UPDATE-NTH (94 50 (:REWRITE DEFAULT-+-2))
...
(ITEMS-HAVE-LEN-OF-APPEND (205 41 (:DEFINITION LEN))
...
(ITEMS-HAVE-LEN-OF-TRUE-LIST-FIX (336 44 (:REWRITE ITEMS-HAVE-LEN-OF-CDR))
...
(LEN-OF-CAR-WHEN-ITEMS-HAVE-LEN (10 2 (:DEFINITION LEN))
