...
(INTEGERP-OF-CAR-WHEN-ALL-INTEGERP
...
(INTEGERP-OF-CAR-WHEN-ALL-INTEGERP-CHEAP
 (8 2 (:REWRITE ALL-INTEGERP-OF-CDR))
 (5 5 (:REWRITE DEFAULT-CAR))
 (2 2 (:REWRITE DEFAULT-CDR))
 )
(ALL-INTEGERP-OF-CONS
 (8 2 (:REWRITE ALL-INTEGERP-OF-CDR))
...
(ALL-INTEGERP-OF-APPEND
 ...
 (47 24 (:REWRITE INTEGERP-OF-CAR-WHEN-ALL-INTEGERP-CHEAP))
...
(ALL-INTEGERP-OF-SET-DIFFERENCE-EQUAL
...
(ALL-INTEGERP-OF-TAKE
 (80 64 (:REWRITE ALL-INTEGERP-WHEN-NOT-CONSP-CHEAP))
