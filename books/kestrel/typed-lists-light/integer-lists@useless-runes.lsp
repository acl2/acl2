(ALL-INTEGERP-WHEN-ALL-NATP
 (509 22 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (479 12 (:DEFINITION NAT-LISTP))
 (302 20 (:REWRITE USE-ALL-NATP-FOR-CAR))
 (226 18 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (146 22 (:REWRITE ALL-NATP-WHEN-NOT-CONSP))
...
(INTEGER-LISTP-WHEN-ALL-NATP
 (703 30 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
 (661 16 (:DEFINITION NAT-LISTP))
 (419 25 (:REWRITE USE-ALL-NATP-FOR-CAR))
 (370 30 (:REWRITE CONSP-FROM-LEN-CHEAP))
 (216 30 (:REWRITE ALL-NATP-WHEN-NOT-CONSP))
 ...
 (56 30 (:REWRITE INTEGERP-OF-CAR-WHEN-ALL-NATP-CHEAP))
