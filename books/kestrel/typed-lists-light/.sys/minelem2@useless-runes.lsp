...
(MINELEM-OF-SUBRANGE-AND-SUBRANGE-HACK
 (135 9 (:REWRITE MEMBERP-OF-CONS))
 (120 3 (:REWRITE MEMBER-EQUAL-BECOMES-MEMBERP))
 (98 2 (:REWRITE <=-OF-MINELEM-WHEN-MEMBER-EQUAL))
 (92 2 (:REWRITE <=-OF-MINELEM-WHEN-MEMBERP))
 (45 12 (:REWRITE NOT-GREATER-WHEN-<=-OF-MINELEM))
