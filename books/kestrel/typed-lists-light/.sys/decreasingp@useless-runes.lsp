...
(NOT-<-OF-NTH-0-AND-NTH-1-WHEN-DECREASINGP
 (177 9 (:REWRITE ALL-NATP-WHEN-NAT-LISTP))
...
(ALL-<=OF-CDR-AND-NTH-0-WHEN-DECREASINGP
 (1031 59 (:REWRITE USE-ALL-<-FOR-CAR))
 (691 61 (:REWRITE DECREASINGP-OF-CDR))
 (552 69 (:REWRITE ALL-<-OF-CDR))
 (315 315 (:TYPE-PRESCRIPTION ALL-<))
 (229 117 (:REWRITE DEFAULT-<-2))
 (219 219 (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
 (135 128 (:REWRITE ALL-<-WHEN-NOT-CONSP))
...
(ALL-<=-WHEN-<=-AND-DECREASINGP
 (136 10 (:REWRITE USE-ALL-<-FOR-CAR))
