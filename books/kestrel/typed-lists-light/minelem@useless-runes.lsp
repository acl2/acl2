...
(INFINITY)
(MINELEM (133 133 (:REWRITE LEN-WHEN-NOT-CONSP-CHEAP))
...
(MINELEM-WHEN-NON-CONSP (10 1 (:REWRITE CONSP-FROM-LEN-CHEAP))
...
(MINELEM-OF-APPEND (614 307
                   ...
                   (15 15
                       (:REWRITE LEN-OF-CDDR-WHEN-EQUAL-OF-LEN)))
(MINELEM-SINGLETON (1 1 (:REWRITE MINELEM-WHEN-NON-CONSP))
...
(<=-OF-MINELEM-WHEN-MEMBER-EQUAL
     ...
     (24 7 (:REWRITE MINELEM-WHEN-NON-CONSP))
     (20 20
         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(MINELEM-WHEN-SUBSETP-EQUAL-HELPER
     ...
     (93 28 (:REWRITE MINELEM-WHEN-NON-CONSP))
     (78 39
         (:REWRITE NOT-MEMBER-EQUAL-WHEN-NOT-MEMBER-EQUAL-OF-CDR-CHEAP))
     (78 39
         (:REWRITE MEMBER-EQUAL-WHEN-MEMBER-EQUAL-OF-CDR-CHEAP))
     ...
     (69 40
         (:REWRITE MEMBER-EQUAL-WHEN-EQUAL-OF-LEN-AND-1-CHEAP))
...
(MINELEM-WHEN-SUBSETP-EQUAL
     (69 4
         (:REWRITE <=-OF-MINELEM-WHEN-MEMBER-EQUAL))
...
(MINELEM-OF-NTHCDR-PEEL-OFF-ONE
     (358 137
          (:REWRITE NOT-GREATER-WHEN-<=-OF-MINELEM))
     (322 23
          (:REWRITE <=-OF-MINELEM-WHEN-MEMBER-EQUAL))
     (314 14 (:REWRITE CAR-OF-NTHCDR))
     (306 104 (:REWRITE DEFAULT-CDR))
     ...
     (194 40 (:REWRITE MINELEM-WHEN-NON-CONSP))
