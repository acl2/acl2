(STR-TRIM-LEFT2 (14 14 (:REWRITE DEFAULT-CAR))
                (7 7 (:REWRITE DEFAULT-CDR)))
(BOOLEANP-OF-STR-TRIM-LEFT2.DONE (46 46 (:REWRITE DEFAULT-CAR))
                                 (31 31 (:REWRITE DEFAULT-CDR)))
(CHARACTER-LISTP-OF-STR-TRIM-LEFT2.THECHARS (66 66 (:REWRITE DEFAULT-CAR))
                                            (49 49 (:REWRITE DEFAULT-CDR)))
(STR-TRIM-LEFT2-MAKES-PROGRESS (135 64 (:REWRITE DEFAULT-+-2))
...
(STR-TRIM-LEFT1 (102 2 (:DEFINITION ACL2-COUNT))
...
(CHARACTER-LISTP-OF-STR-TRIM-LEFT1 (36 36 (:REWRITE DEFAULT-CDR))
                                   (36 36 (:REWRITE DEFAULT-CAR)))
(STR-TRIM-LEFT (2 2 (:REWRITE DEFAULT-CDR))
               (2 2 (:REWRITE DEFAULT-CAR))
               (1 1 (:REWRITE DEFAULT-COERCE-2))
               (1 1 (:REWRITE DEFAULT-COERCE-1)))
(STRINGP-OF-STR-TRIM-LEFT)
(REV-RETURNS-CHARACTER-LISTP (3 3 (:REWRITE DEFAULT-CDR))
                             (3 3 (:REWRITE DEFAULT-CAR))
                             (3 1 (:DEFINITION REVAPPEND)))
(STR-TRIM-RIGHT1)
(CHARACTER-LISTP-OF-STR-TRIM-RIGHT1)
(STR-TRIM-RIGHT (2 2 (:REWRITE DEFAULT-CDR))
                (2 2 (:REWRITE DEFAULT-CAR))
                (1 1 (:REWRITE DEFAULT-COERCE-2))
                (1 1 (:REWRITE DEFAULT-COERCE-1)))
