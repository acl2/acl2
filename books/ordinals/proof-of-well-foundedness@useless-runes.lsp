...
(ORD::WELL-FOUNDEDNESS-OF-NATURAL-NUMBERS (5 5 (:REWRITE DEFAULT-<-2))
                                          (5 5 (:REWRITE DEFAULT-<-1)))
(ORD::O< (447 210 (:REWRITE DEFAULT-+-2))
...
(ORD::O-P (202 94 (:REWRITE DEFAULT-+-2))
...
(ORD::|~(a < a)| (30 30 (:REWRITE DEFAULT-CAR))
...
(ORD::TRANSITIVITY-OF-O< (1056 1056 (:REWRITE DEFAULT-CAR))
...
(ORD::TRANSITIVITY-OF-O<= (6544 6544 (:REWRITE DEFAULT-CAR))
                          ...
                          (747 747
                               (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(ORD::TRICHOTOMY-OF-O<=)
(ORD::OD (192 90 (:REWRITE DEFAULT-+-2))
         ...
         (9 9 (:REWRITE DEFAULT-COERCE-2))
         (9 9 (:REWRITE DEFAULT-COERCE-1)))
(ORD::OD-1 (192 90 (:REWRITE DEFAULT-+-2))
           (126 90 (:REWRITE DEFAULT-+-1))
           (72 18 (:DEFINITION INTEGER-ABS))
           (72 9 (:DEFINITION LENGTH))
           (45 9 (:DEFINITION LEN))
           ...
           (9 9 (:REWRITE DEFAULT-COERCE-2))
           (9 9 (:REWRITE DEFAULT-COERCE-1)))
(ORD::OD-IMPLIES-ORDLESSP (797 797 (:REWRITE DEFAULT-CAR))
