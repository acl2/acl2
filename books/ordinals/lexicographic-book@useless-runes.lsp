...
(L< (21 11 (:REWRITE DEFAULT-+-2))
    ...
    (2 2 (:META CANCEL_PLUS-LESSP-CORRECT)))
(LSTTOO (545 5 (:REWRITE O+-O-FIRST-EXPT-SMASH))
...
(LTOO (2 2 (:REWRITE NATP-RW))
      (1 1 (:REWRITE DEFAULT-<-2))
      (1 1 (:REWRITE DEFAULT-<-1))
      (1 1 (:META CANCEL_PLUS-LESSP-CORRECT)))
(O-P-LSTTOO (363 3 (:REWRITE O+-O-FIRST-EXPT-SMASH))
...
(O-FIRST-EXPT-LTOO (548 5 (:REWRITE O+-O-FIRST-EXPT-SMASH))
                   ...
                   (1 1 (:META CANCEL_PLUS-LESSP-CORRECT)))
(O-FIRST-COEFF-LTOO-HELPER (606 3 (:DEFINITION LSTTOO))
                           ...
                           (1 1 (:META CANCEL_PLUS-LESSP-CORRECT)))
(O-FIRST-COEFF-LTOO (1171 10 (:REWRITE O+-O-FIRST-EXPT-SMASH))
...
(WELL-FOUNDED-L<-CASE-2 (22238 135 (:DEFINITION O<))
