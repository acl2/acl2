(FIRSTN)
(DROPN (3 3 (:REWRITE DEFAULT-<-2))
       (3 3 (:REWRITE DEFAULT-<-1))
       (1 1 (:REWRITE ZP-OPEN))
       (1 1 (:REWRITE DEFAULT-+-2))
       (1 1 (:REWRITE DEFAULT-+-1)))
(WCMP)
(OCMP-AUX (218 218 (:REWRITE DEFAULT-CDR))
...
(LIMITPART)
(NATPART (6 6 (:REWRITE DEFAULT-CAR))
         (2 2 (:REWRITE DEFAULT-CDR))
         (1 1 (:REWRITE DEFAULT-<-2))
         (1 1 (:REWRITE DEFAULT-<-1)))
(LIMITP)
(OLEN (6 6 (:REWRITE DEFAULT-CAR))
      (2 2 (:REWRITE DEFAULT-CDR))
      (1 1 (:REWRITE DEFAULT-<-2))
      (1 1 (:REWRITE DEFAULT-<-1)))
(O-LAST-EXPT)
(O-LAST-EXPT-GUARD-IMPLIES-TEST)
(O-LAST-EXPT (7 7 (:REWRITE DEFAULT-CAR))
             (2 2 (:REWRITE DEFAULT-CDR))
             (1 1 (:REWRITE DEFAULT-<-2))
             (1 1 (:REWRITE DEFAULT-<-1)))
(OB+ (295 142 (:REWRITE DEFAULT-+-2))
...
(PADD (121 58 (:REWRITE DEFAULT-+-2))
      ...
      (4 4 (:REWRITE ZP-OPEN)))
(PMULT (6 6 (:TYPE-PRESCRIPTION PADD)))
(OB* (6 6 (:TYPE-PRESCRIPTION OB+)))
(O^1 (8 8
        (:TYPE-PRESCRIPTION RATIONALP-EXPT-TYPE-PRESCRIPTION))
     (8 8
        (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-NON-ZERO-BASE)))
(O^2)
(O^3H (1 1 (:TYPE-PRESCRIPTION O^2)))
(O^3 (7 5 (:TYPE-PRESCRIPTION PADD)))
(O^4)
(OB^ (5 5 (:REWRITE DEFAULT-<-2))
