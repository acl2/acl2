(OLEN-POSP (40 4 (:REWRITE POSP-RW))
...
(MAKE-ORD-O-FIRST-EXPT (2 2 (:REWRITE DEFAULT-CAR)))
(MAKE-ORD-O-FIRST-COEFF (1 1 (:REWRITE DEFAULT-CDR))
                        (1 1 (:REWRITE DEFAULT-CAR)))
(MAKE-ORD-O-RST)
(MAKE-ORD-O-INFP)
(MAKE-ORD-O-P (1407 14 (:DEFINITION O<))
...
(O-FIRST-EXPT-O-FIRST-COEFF-O-RST-ELIM
     ...
     (2 2 (:REWRITE POSP-RW))
     (2 2 (:REWRITE NATP-RW)))
(MAKE-ORD-EQUAL-2 (9 9 (:META CANCEL_TIMES-EQUAL-CORRECT))
                  (9 9 (:META CANCEL_PLUS-EQUAL-CORRECT))
                  (6 6 (:REWRITE DEFAULT-CDR))
                  (6 6 (:REWRITE DEFAULT-CAR)))
(MAKE-ORD-CAR (5 5 (:REWRITE DEFAULT-CAR))
...
(O-FINP-O-RST)
(ACL2-COUNT-O-RST)
(ACL2-COUNT-O-RST-2 (118 57 (:REWRITE DEFAULT-+-2))
...
(O-FIRST-EXPT-1-O-FINP-O-RST (216 14 (:REWRITE O-FIRST-EXPT-<))
...
(CDR-O-RST)
(O-FIRST-EXPT-O-P (442 4 (:DEFINITION O<))
                  ...
                  (4 4 (:REWRITE NATP-RW))
                  (2 2 (:REWRITE POSP-RW)))
(|(o-first-expt a) < a| (4308 38 (:DEFINITION O<))
...
(O-FIRST-EXPT-<= (245 6 (:DEFINITION O<))
                 ...
                 (4 4 (:REWRITE POSP-RW)))
(O-FIRST-EXPT-0-NATP (221 2 (:DEFINITION O<))
                     ...
                     (1 1 (:REWRITE POSP-RW)))
(<=-O-FIRST-EXPT-<=)
(O-FIRST-EXPT-NATP (9 9 (:REWRITE DEFAULT-CAR))
                   (1 1 (:META CANCEL_TIMES-EQUAL-CORRECT))
                   (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(O-FIRST-EXPT-O-INFP)
(O-FIRST-EXPT-O-INFP-2 (678 29 (:REWRITE O-FIRST-EXPT-<))
                       (420 1 (:REWRITE |~(a<0)|))
                       (296 4 (:REWRITE O-INFP-O-FINP-O<=))
                       (278 19 (:REWRITE O-FIRST-EXPT-0-NATP))
...
(ACL2-COUNT-O-FIRST-EXPT (229 108 (:REWRITE DEFAULT-+-2))
                         (151 108 (:REWRITE DEFAULT-+-1))
...
(NATP-O-FIRST-COEFF (316 2 (:DEFINITION O<))
                    ...
                    (3 3 (:REWRITE NATP-RW))
                    (1 1 (:REWRITE POSP-RW)))
(POSP-O-FIRST-COEFF (316 2 (:DEFINITION O<))
                    (211 8 (:REWRITE O-FIRST-EXPT-<))
                    (143 25 (:REWRITE O-FIRST-EXPT-O-INFP))
                    (101 46 (:REWRITE O-FIRST-EXPT-DEF-O-FINP))
                    (72 72 (:TYPE-PRESCRIPTION O-FINP))
                    ...
                    (4 4 (:META CANCEL_PLUS-LESSP-CORRECT))
                    (3 3 (:REWRITE POSP-RW)))
(O-FIRST-COEFF-0 (316 2 (:DEFINITION O<))
                 (211 8 (:REWRITE O-FIRST-EXPT-<))
                 (143 25 (:REWRITE O-FIRST-EXPT-O-INFP))
                 (101 46 (:REWRITE O-FIRST-EXPT-DEF-O-FINP))
                 (72 72 (:TYPE-PRESCRIPTION O-FINP))
...
(O-P-O-INFP-CAR (828 6 (:DEFINITION O<))
                ...
                (6 6 (:REWRITE NATP-RW))
                (3 3 (:REWRITE POSP-RW)))
(O-P-O-INFP-CAR-2 (1 1 (:REWRITE DEFAULT-CAR)))
(O-P-O-FIRST-EXPT-NEQ-0)
(O-P-O-P-O-RST (4 1 (:REWRITE POSP-O-FIRST-COEFF))
...
(O-P-<-O-FIRST-EXPT-O-FIRST-EXPT-O-RST
     ...
     (1 1 (:REWRITE NATP-RW))
     (1 1 (:REWRITE DEFAULT-CAR)))
(O-P-DEF-O-FINP-1 (2 2 (:REWRITE NATP-RW)))
(O-P-DEF-O-FINP-2)
(O-INFP->NEQ-0)
(LIMITP-O-P)
(LIMITP-O-INFP)
(LIMITP-NATPART)
(NOT-LIMITP-NATP (19 4 (:REWRITE O-FIRST-EXPT-O-INFP))
                 ...
                 (1 1 (:REWRITE O-FINP-O-RST)))
(LIMITP-O-RST (85 19 (:REWRITE O-FIRST-EXPT-O-INFP))
...
(LIMITP-O-INFP-O-RST (82 18 (:REWRITE O-FIRST-EXPT-O-INFP))
                     ...
                     (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(LIMITP-DEF)
(LIMITP-DEF-2 (678 4 (:DEFINITION O<))
              ...
              (2 2 (:REWRITE POSP-RW))
              (2 2 (:REWRITE NATP-RW)))
(NATPART-O-FINP (182 21 (:REWRITE O-FIRST-EXPT-O-INFP))
...
(NATPART-NATP (76 16 (:REWRITE O-FIRST-EXPT-O-INFP))
              ...
              (4 4 (:REWRITE NATP-RW))
              (2 2 (:REWRITE O-FINP-O-RST)))
(NATPART-DEF-O-FINP (50 25 (:TYPE-PRESCRIPTION NATPART-NATP))
                    ...
                    (1 1 (:META CANCEL_TIMES-EQUAL-CORRECT))
                    (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(NATPART-O-RST (88 44 (:TYPE-PRESCRIPTION NATPART-NATP))
...
(NATPART-MAKE-ORD (52 6 (:REWRITE O-FIRST-EXPT-O-INFP))
                  ...
                  (2 2 (:META CANCEL_TIMES-EQUAL-CORRECT))
                  (2 2 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(LIMITPART-O-FIRST-EXPT (78 9 (:REWRITE O-FIRST-EXPT-O-INFP))
...
(LIMITPART-O-FIRST-COEFF (52 6 (:REWRITE O-FIRST-EXPT-O-INFP))
                         (12 4 (:REWRITE O-P-DEF-O-FINP-1))
                         (12 2 (:REWRITE O-FIRST-EXPT-0-NATP))
                         (12 2 (:LINEAR O-FIRST-EXPT-<=))
...
(LIMITPART-O-RST (78 9 (:REWRITE O-FIRST-EXPT-O-INFP))
                 (18 6 (:REWRITE O-P-DEF-O-FINP-1))
                 (18 3 (:REWRITE O-FIRST-EXPT-0-NATP))
                 (18 3 (:LINEAR O-FIRST-EXPT-<=))
                 ...
                 (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT))
                 (1 1 (:TYPE-PRESCRIPTION MAKE-ORD)))
(LIMITPART-DEF-O-FINP (26 3 (:REWRITE O-FIRST-EXPT-O-INFP))
                      (6 2 (:REWRITE O-P-DEF-O-FINP-1))
                      (6 1 (:REWRITE O-FIRST-EXPT-0-NATP))
                      (6 1 (:LINEAR O-FIRST-EXPT-<=))
                      (4 1 (:REWRITE O-P-O-FIRST-EXPT-NEQ-0))
                      ...
                      (1 1 (:META CANCEL_TIMES-EQUAL-CORRECT))
                      (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(LIMITPART-OLEN (300 30 (:REWRITE O-FIRST-EXPT-O-INFP))
                ...
                (6 6 (:REWRITE NATP-RW))
                (3 3 (:REWRITE O-FIRST-COEFF-DEF-O-FINP)))
(LIMITPART-O-FINP (278 24 (:REWRITE O-FIRST-EXPT-O-INFP))
                  ...
                  (3 3 (:REWRITE O-FIRST-COEFF-DEF-O-FINP))
                  (3 3 (:REWRITE O-FINP-O-RST)))
(LIMITPART-O-P (228 47 (:REWRITE O-FIRST-EXPT-O-INFP))
               ...
               (1 1 (:TYPE-PRESCRIPTION MAKE-ORD))
               (1 1 (:REWRITE |~(a < a)|)))
(LIMITPART (72 11 (:REWRITE O-FIRST-EXPT-O-INFP))
           ...
           (2 2 (:META CANCEL_TIMES-EQUAL-CORRECT))
           (2 2 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(NATPART-LIMITPART (390 45 (:REWRITE O-FIRST-EXPT-O-INFP))
...
(LIMITPART-LIMITP (58 13 (:REWRITE O-FIRST-EXPT-O-INFP))
                  ...
                  (1 1 (:META CANCEL_TIMES-EQUAL-CORRECT))
                  (1 1 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(LIMITPART-LIMITP-TP (19 4 (:REWRITE O-FIRST-EXPT-O-INFP))
                     ...
                     (1 1 (:REWRITE O-FIRST-COEFF-DEF-O-FINP))
                     (1 1 (:REWRITE O-FINP-O-RST)))
(O-P-O-LAST-EXPT (185 34 (:REWRITE O-FIRST-EXPT-O-INFP))
                 ...
                 (2 2 (:META CANCEL_PLUS-EQUAL-CORRECT))
                 (1 1 (:REWRITE NATP-RW)))
(O-LAST-EXPT-O-FIRST-EXPT-2 (2924 18 (:DEFINITION O<))
                            ...
                            (4 4 (:REWRITE NATP-RW))
                            (2 2 (:REWRITE POSP-RW)))
(O-LAST-EXPT-0 (291 54 (:REWRITE O-FIRST-EXPT-O-INFP))
               ...
               (9 9 (:META CANCEL_PLUS-EQUAL-CORRECT))
               (1 1 (:REWRITE NATP-RW)))
(O-LAST-EXPT-DEF-O-INFP-1 (130 15 (:REWRITE O-FIRST-EXPT-O-INFP))
                          ...
                          (6 6 (:META CANCEL_TIMES-EQUAL-CORRECT))
                          (6 6 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(O-LAST-EXPT-DEF-O-INFP-2 (52 6 (:REWRITE O-FIRST-EXPT-O-INFP))
                          (12 4 (:REWRITE O-P-DEF-O-FINP-1))
                          (12 2 (:REWRITE O-FIRST-EXPT-0-NATP))
                          (12 2 (:LINEAR O-FIRST-EXPT-<=))
...
(O-P-DROPN (12 5 (:REWRITE ZP-OPEN))
           (4 4 (:REWRITE O-FINP-O-RST))
...
(DROPN-NEW-DEF (26 3 (:REWRITE O-FIRST-EXPT-O-INFP))
