...
(TEENY$EXEC-STEP
 (4731 1245 (:REWRITE <<-TRICHOTOMY))
 (4233 747 (:REWRITE <<-ASYMMETRIC))
 (3993 3981 (:REWRITE DEFAULT-CDR))
 (3529 3517 (:REWRITE DEFAULT-CAR))
 (2739 2739 (:TYPE-PRESCRIPTION <<))
 (1245 1245 (:REWRITE <<-TRANSITIVE))
 (360 72 (:DEFINITION LEN))
 (328 285 (:REWRITE DEFAULT-<-1))
...
(TEENY$EXEC-RUN1
 (204453 4 (:DEFINITION TEENY$EXEC-RUN1))
 (203870 1044 (:DEFINITION UPDATE-NTH))
 (78030 77983 (:REWRITE DEFAULT-CDR))
 (49372 49343 (:REWRITE DEFAULT-CAR))
 (5576 5533 (:REWRITE DEFAULT-<-1))
 (5533 5533 (:REWRITE DEFAULT-<-2))
 (5073 1335 (:REWRITE <<-TRICHOTOMY))
 (4539 801 (:REWRITE <<-ASYMMETRIC))
 (2937 2937 (:TYPE-PRESCRIPTION <<))
 (2362 2285 (:REWRITE DEFAULT-+-2))
 (2285 2285 (:REWRITE DEFAULT-+-1))
 (1335 1335 (:REWRITE <<-TRANSITIVE))
 (528 528 (:REWRITE CDR-CONS))
 (524 524 (:REWRITE CAR-CONS))
 (386 218 (:REWRITE NTH-ADD1))
 (385 77 (:DEFINITION LEN))
 (168 168 (:REWRITE NTH-0-CONS))
 (91 79 (:REWRITE ZP-OPEN))
 (43 43 (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
