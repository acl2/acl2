...
(TEENY$EXEC-STEP
 (4085 1075 (:REWRITE <<-TRICHOTOMY))
 (3711 3699 (:REWRITE DEFAULT-CDR))
 (3655 645 (:REWRITE <<-ASYMMETRIC))
 (3184 3172 (:REWRITE DEFAULT-CAR))
 (2365 2365 (:TYPE-PRESCRIPTION <<))
 (1075 1075 (:REWRITE <<-TRANSITIVE))
 (320 64 (:DEFINITION LEN))
 (309 269 (:REWRITE DEFAULT-<-1))
 (269 269 (:REWRITE DEFAULT-<-2))
 (208 144 (:REWRITE DEFAULT-+-2))
