...
(RUN-STATE)
(INV)
(OPEN-INIT-RPC (1 1 (:REWRITE ZP-OPEN)))
(OPEN-INIT-RRA (1 1 (:REWRITE ZP-OPEN)))
(OPEN-INIT-RRB (1 1 (:REWRITE ZP-OPEN)))
(OPEN-STEP-RPC (243 44 (:REWRITE ZP-OPEN))
...
(OPEN-STEP-RRA (227 41 (:REWRITE ZP-OPEN))
               ...
               (2 2 (:TYPE-PRESCRIPTION >N)))
(OPEN-STEP-RRB (307 55 (:REWRITE ZP-OPEN))
...
(INV-OVER-STEP-SV (121 16 (:REWRITE OPEN-INIT-RRB))
...
(INV-OF-INIT-SV (33 33 (:REWRITE DEFAULT-CDR))
                (9 9 (:REWRITE DEFAULT-CAR)))
(RUN-SV-COMMUTE (15 6 (:REWRITE DEFAULT-CDR))
                (15 6 (:REWRITE DEFAULT-CAR))
                (6 6 (:REWRITE ZP-OPEN))
                (4 4 (:REWRITE DEFAULT-+-2))
                (4 4 (:REWRITE DEFAULT-+-1)))
(INDUCT-SCHEME)
(INV-OVER-RUN-SV (62 62 (:REWRITE DEFAULT-+-2))
                 (62 62 (:REWRITE DEFAULT-+-1))
                 (54 54 (:REWRITE DEFAULT-<-2))
                 (54 54 (:REWRITE DEFAULT-<-1)))
(INV-OVER-RUN-STATE (414 2 (:DEFINITION RUN-SV))
...
(MACHINE-STATE (126 36 (:REWRITE ZP-OPEN))
               (74 2 (:DEFINITION RRB))
               (72 2 (:DEFINITION RPC))
               (68 2 (:DEFINITION RRA))
