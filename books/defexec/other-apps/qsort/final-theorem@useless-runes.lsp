...
(LEN-0-IMPLIES-NOT-CONSP (7 4 (:REWRITE DEFAULT-+-2))
                         (4 4 (:REWRITE DEFAULT-+-1))
                         (3 3 (:REWRITE DEFAULT-CDR))
                         (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
                         (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(QSORT-IS-CORRECT (208 2 (:DEFINITION QSORT-FN))
...
(SORT-LIST (208 2 (:DEFINITION QSORT-FN))
           (108 2 (:DEFINITION UPPER-PART))
           (73 73 (:REWRITE DEFAULT-CDR))
           (72 2 (:DEFINITION LOWER-PART))
           (48 12 (:DEFINITION DEL-LAST))
...
(<<=-IMPLIES-EQUAL)
(ORDP-ISORT)
(TRUE-LISTP-ISORT (34 3 (:DEFINITION INSERT))
...
(INSERT-EQUALS-CONS (137 118 (:REWRITE DEFAULT-CAR))
...
(ISORT-IDEMPOTENT (112 2 (:DEFINITION ISORT))
