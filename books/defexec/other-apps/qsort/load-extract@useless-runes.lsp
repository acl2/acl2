...
(EXTRACT-N-UPDATE-REDUCTION (39 3 (:REWRITE NTH-UPDATE-NTH-SAME-OBJSI))
...
(OBJSI-LOAD-REDUCTION (13 1 (:REWRITE NTH-UPDATE-NTH-SAME-OBJSI))
                      (8 8 (:REWRITE NATP-RW))
                      (8 8 (:REWRITE DEFAULT-<-2))
                      (8 8 (:REWRITE DEFAULT-<-1))
...
(LOAD-EXTRACT-N-REDUCTION (53 6 (:REWRITE FIRST-N-LENGTH-IS-X))
                          ...
                          (1 1
                             (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(FIRST-N-EXTRACT-N-REDUCTION (85 7 (:REWRITE FIRST-N-LENGTH-IS-X))
...
(EXTRACT-QS-N-REDUCTION (49 37 (:REWRITE DEFAULT-+-2))
...
(LOAD-ALLOC-EXTRACT-QS-SAME (55 55
                                (:TYPE-PRESCRIPTION |x < y  =>  0 < y-x|))
...
(ARITH-002)
(FIRST-N-EXTRACT-QS-REDUCTION (27 18 (:REWRITE DEFAULT-+-2))
...
(LAST-N-EXTRACT-QS-REDUCTION (8 6 (:REWRITE DEFAULT-+-2))
                             (6 6 (:REWRITE DEFAULT-+-1))
