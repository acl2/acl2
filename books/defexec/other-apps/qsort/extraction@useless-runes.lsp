...
(EXTRACT-QS-EXPAND-TO-NIL (1 1 (:REWRITE NATP-RW))
                          (1 1 (:REWRITE DEFAULT-+-2))
                          (1 1 (:REWRITE DEFAULT-+-1)))
(EXTRACT-QS-EXPAND-TO-LIST (2 2 (:REWRITE DEFAULT-CDR))
...
(EXTRACT-QS-DECREMENT-HI (160 160
                              (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(LAST-VAL-SNOC-REDUCTION (19 11 (:REWRITE DEFAULT-CDR))
...
(EXTRACT-QS-UPDATE-BELOW-REDUCTION
     ...
     (62 12
         (:REWRITE EXTRACT-QS-UPDATE-ABOVE-REDUCTION))
...
(EXTRACT-QS-LEN-REDUCTION (22 16 (:REWRITE DEFAULT-+-2))
                          (19 19
                              (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
                          ...
                          (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
                          (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(EXTRACT-IS-APPEND-OF-MID (24 24 (:REWRITE DEFAULT-<-2))
...
(CONSP-EXTRACT-REDUCTION (6 2 (:REWRITE FOLD-CONSTS-IN-+))
                         ...
                         (2 2 (:REWRITE NATP-RW)))
(EXTRACT-FOR-1-ELEMENT (17 17 (:REWRITE DEFAULT-<-2))
                       (17 17 (:REWRITE DEFAULT-<-1))
                       (12 12 (:REWRITE DEFAULT-+-2))
                       (12 12 (:REWRITE DEFAULT-+-1))
                       (11 11 (:REWRITE NATP-RW))
