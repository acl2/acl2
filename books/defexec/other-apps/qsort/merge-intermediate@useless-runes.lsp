(MERGE-FUNC (254 128 (:REWRITE DEFAULT-+-2))
...
(WALK (2953 1281 (:REWRITE DEFAULT-+-2))
      (1805 1281 (:REWRITE DEFAULT-+-1))
...
(WALK-IS-A-NATP)
(WALK-LOWER-PART-REDUCTION (325 313 (:REWRITE DEFAULT-CDR))
...
(MERGE-FUNC-LOWER-UPPER-REDUCTION (6133 5539 (:REWRITE DEFAULT-CDR))
...
(REDUCE-MERGE-LOWER-PART (126 4 (:REWRITE FIRST-N-LENGTH-IS-X))
                         (52 4 (:DEFINITION LEN))
...
(REDUCE-MERGE-UPPER-PART (30 6 (:REWRITE DEFAULT-CDR))
                         (20 4 (:DEFINITION BINARY-APPEND))
...
(INTERMEDIATE-IN-SITU-QSORT-FN (80 1 (:DEFINITION UPPER-PART))
...
(MERGE-FUNC-IS-A-PERMUTATION (107 1 (:DEFINITION UPPER-PART))
...
(IN-SITU-QSORT-FN (800 10 (:DEFINITION UPPER-PART))
                  ...
                  (2 2 (:REWRITE EQUAL-CONSTANT-+))
                  (1 1 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(APPEND-NULL-REDUCTION (54 27
                           (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
                       (27 27 (:TYPE-PRESCRIPTION TRUE-LISTP))
                       (27 27 (:TYPE-PRESCRIPTION BINARY-APPEND)))
(MERGE-FUNC-EQUAL-X-IF-WALK-0 (66 66 (:REWRITE DEFAULT-CDR))
                              (56 14 (:DEFINITION LAST-VAL))
...
(IN-SITU-EQUAL-INTERMEDIATE (364 13 (:DEFINITION FIRST-N))
