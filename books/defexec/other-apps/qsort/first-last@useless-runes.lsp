...
(LAST-N (4 4
           (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(FIRST-LAST-CONS-REDUCTION (3 3 (:REWRITE DEFAULT-CDR))
...
(APPEND-FIRST-REDUCTION-LEN (100 50
                            ...
                            (4 4 (:META CANCEL_TIMES-EQUAL-CORRECT))
                            (4 4 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(APPEND-LAST-REDUCTION-LEN (66 33
                               (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
                           ...
                           (4 4 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(APPEND-FIRST-REDUCTION (43 14 (:REWRITE DEFAULT-CAR))
                        (42 14
                            (:TYPE-PRESCRIPTION TRUE-LISTP-APPEND))
                        ...
                        (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
                        (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(FIRST-N-LENGTH-IS-X (36 4 (:REWRITE ZP-OPEN))
                     ...
                     (4 4 (:META CANCEL_PLUS-LESSP-CORRECT))
                     (4 4 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(LAST-N-TRUE-LISTP-REDUCTION (12 5 (:REWRITE ZP-OPEN))
