(SEL-MATCH (608 271 (:REWRITE DEFAULT-+-2))
...
(SEL-MATCH-SELECT-A-PAIR (68 68 (:REWRITE DEFAULT-CAR))
                         (30 30 (:REWRITE DEFAULT-CDR))
                         (9 9 (:META CANCEL_TIMES-EQUAL-CORRECT))
                         (9 9 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(SEL-MATCH-CONSP (63 63 (:REWRITE DEFAULT-CAR))
...
(TRANSFORM-SUBS (224 4 (:DEFINITION SEL-MATCH))
...
(TRANSFORM-SUBS-DECREASES-LENGTH-OF-FIRST-SYSTEM
     ...
     (610 391
          (:TYPE-PRESCRIPTION SEL-MATCH-CONSP))
...
(SUBS-SYSTEM (228 197 (:REWRITE DEFAULT-CAR))
...
(MATCH-MV)
(SUBS-SYSTEM-BRIDGE (1 1
                       (:TYPE-PRESCRIPTION SUBS-SYSTEM-BRIDGE)))
(MATCH-MV-BRIDGE)
(BOOLEANP-THIRD-SUBS-SYSTEM (2012 1009
                                  (:TYPE-PRESCRIPTION SEL-MATCH-CONSP))
...
(MATCH-MV-COMPLETENESS
     ...
     (206 2
          (:REWRITE NIL-THIRD-IMPLIES-NIL-SECOND-SUBS-SYSTEM))
...
(MATCH-MV-SUBSTITUTION-S-P (1330 7 (:DEFINITION SUBS-SYSTEM))
...
(SUBS-MV (8 8 (:REWRITE DEFAULT-CAR))
         (6 6 (:REWRITE DEFAULT-CDR)))
(SUBS)
(MATCHING)
(SUBS-SOUNDNESS (1070 10 (:DEFINITION SUBS-SYSTEM))
...
(SUBS-COMPLETENESS (357 3 (:DEFINITION SUBS-SYSTEM))
...
(MATCHING-SUBSTITUTION-S-P
     ...
     (4 4
        (:TYPE-PRESCRIPTION BOOLEANP-THIRD-SUBS-SYSTEM))
     (4 4 (:REWRITE PAIR-ARGS-TRUE-LISTP))
     (4 4 (:DEFINITION ASSOC-EQUAL))
     (2 2
        (:REWRITE SYSTEM-S-P-TERM-P-AUX-ARGUMENTS)))
(MATCHING-SUBSTITUTION-P (37 37 (:REWRITE DEFAULT-CAR))
                         (27 27 (:REWRITE DEFAULT-CDR))
                         (11 11
                             (:REWRITE SYSTEM-P-TERM-P-AUX-ARGUMENTS)))
(SUBS-MV-SUBS)
(SUBS-MV-MATCHING)
(SUBS-LIST-MV (41 33 (:REWRITE DEFAULT-CAR))
...
(SUBS-LIST)
(MATCHING-LIST)
(MATCHER-APPLY-SUBST-NIL (510 308 (:REWRITE DEFAULT-CAR))
...
(APPLY-SUBST-NIL-PAIR-ARGS (47 24 (:REWRITE DEFAULT-CAR))
...
(SUBS-LIST-SOUNDNESS (1728 9 (:DEFINITION SUBS-SYSTEM))
...
(SUBSUMPTION-TRANSITIVE (17 1 (:DEFINITION COMPOSITION))
...
(VARIABLE-MINIMUM-SUBSUMPTION (3 3 (:REWRITE DEFAULT-CAR))
