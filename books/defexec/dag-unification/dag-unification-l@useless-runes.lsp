...
(UNIFICATION-MEASURE-DECREASES-L (4 4 (:REWRITE DEFAULT-CAR)))
(WELL-FORMED-UPL-PRESERVED-BY-DAG-TRANSFORM-MM-L
     (3 3 (:REWRITE DEFAULT-CAR)))
(SOLVE-UPL-L (4 4 (:REWRITE DEFAULT-CAR))
             (1 1 (:TYPE-PRESCRIPTION SOLVE-UPL-L)))
(SOLVE-UPL-L-OP (4 4 (:REWRITE DEFAULT-CAR)))
(SOLVE-UPL-L-UNIF-SEQ-L-P-NORMAL-FORM
     ...
     (204 6
          (:DEFINITION UNIF-LEGAL-L-OCCUR-CHECK))
     ...
     (6 6 (:REWRITE NATP-RW)))
(WELL-FORMED-UPL-PRESERVED-BY-SOLVE-UPL-L (21 20 (:REWRITE DEFAULT-CAR))
...
(DAG-MGS-L-OP-UNIF-SEQ-L-P-NORMAL-FORM
     ...
     (15 3
         (:REWRITE TRANSFORM-MM-L-APPLIES-AN-OPERATOR))
...
(DAG-MGS-L-COMPLETENESS (40 1 (:DEFINITION TBS-AS-SYSTEM))
...
(DAG-MGS-L-SOUNDNESS (105 6 (:DEFINITION DAG-AS-TERM-L))
...
(DAG-MGS-L-IDEMPOTENT (55 2 (:DEFINITION SOLVED-AS-SYSTEM))
...
(DAG-MGS-L-MOST-GENERAL-SOLUTION (107 6 (:DEFINITION DAG-AS-TERM-L))
                                 (80 2 (:DEFINITION TBS-AS-SYSTEM))
                                 (64 6 (:DEFINITION NTH))
                                 ...
                                 (3 1 (:REWRITE MGS-SEQ-L-DAG-P)))
(DAG-MGU-L)
(DAG-MGU-L-COMPLETENESS-ALMOST (30 1 (:DEFINITION SOLUTION))
                               (22 2 (:DEFINITION APPLY-SUBST))
                               (16 2 (:DEFINITION VAL))
...
(DAG-MGU-L-SOUNDNESS-ALMOST
     ...
     (5 1 (:REWRITE ZP-OPEN))
     (3 1
        (:REWRITE UNIF-TWO-TERMS-PROBLEM-L-STORES-THE-PROBLEM))
     (1 1 (:TYPE-PRESCRIPTION DAG-P))
...
(DAG-MGU-L-COMPLETENESS
     ...
     (2 2
        (:REWRITE UNIF-TWO-TERMS-PROBLEM-L-WELL-FORMED-DAG-SYSTEM)))
(DAG-MGU-L-SOUNDNESS
     ...
     (3 1
        (:REWRITE UNIF-TWO-TERMS-PROBLEM-L-WELL-FORMED-DAG-SYSTEM))
     (2 2 (:TYPE-PRESCRIPTION WELL-FORMED-UPL)))
(DAG-MGU-L-MOST-GENERAL-SOLUTION (162 6 (:DEFINITION SOLVED-AS-SYSTEM))
                                 ...
                                 (6 6 (:REWRITE DAG-P-COMPLETENESS))
                                 (6 6 (:META CANCEL_PLUS-LESSP-CORRECT)))
(DAG-MGU-L-IDEMPOTENT (27 1 (:DEFINITION SOLVED-AS-SYSTEM))
                      (19 1 (:DEFINITION DAG-AS-TERM-L))
                      (15 9 (:REWRITE DEFAULT-CDR))
                      (15 9 (:REWRITE DEFAULT-CAR))
                      (12 1 (:DEFINITION NTH))
