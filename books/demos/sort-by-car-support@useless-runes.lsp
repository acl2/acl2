...
(SORT-BY-CAR::SORT-BY-CAR<-ORDERED-P
     ...
     (4 4
        (:REWRITE SORT-BY-CAR::SORT-BY-CAR<-COMPARE<-TRANSITIVE)))
...
(SORT-BY-CAR::SORT-BY-CAR<-NO-DUPLICATESP-EQUAL)
(SORT-BY-CAR::SORT-BY-CAR<-TRUE-LISTP)
(SORT-BY-CAR::SORT-BY-CAR<-LEN)
(SORT-BY-CAR::SORT-BY-CAR<-CONSP)
...
(SORT-BY-CAR::MEMBER-STRIP-CARS (15 14 (:REWRITE DEFAULT-CDR)))
(SORT-BY-CAR::MEMBER-IMPLIES-ASSOC (78 65 (:REWRITE DEFAULT-CDR)))
(SORT-BY-CAR::ASSOC-IMPLIES-MEMBER (52 52 (:REWRITE DEFAULT-CAR))
                                   (6 6 (:REWRITE DEFAULT-CDR)))
(SORT-BY-CAR::OTHER-ASSOC-PAIR)
(SORT-BY-CAR::MEMBER-STRIP-CARS-REWRITE (71 68 (:REWRITE DEFAULT-CAR))
...
(SORT-BY-CAR::ALISTP-REVAPPEND (26 20 (:REWRITE DEFAULT-CAR))
                               (21 15 (:REWRITE DEFAULT-CDR)))
(SORT-BY-CAR::ALISTP-OF-TAKE (15 14 (:REWRITE DEFAULT-CAR))
...
(SORT-BY-CAR::ALISTP-SORT-BY-CAR<
     ...
     (130 26 (:REWRITE |(+ y x)|))
     (128 24
          (:REWRITE SORT-BY-CAR::SORT-BY-CAR<-CONSP))
     (106 106
     ...
     (6 2
        (:TYPE-PRESCRIPTION SORT-BY-CAR::SORT-BY-CAR<-MERGE)))
(SORT-BY-CAR::OTHER-ASSOC-PAIR-MEMBER (229 229 (:REWRITE DEFAULT-CAR))
                                      (115 115 (:REWRITE DEFAULT-CDR)))
(SORT-BY-CAR::LISTP-OTHER-ASSOC-PAIR (113 113 (:REWRITE DEFAULT-CAR))
                                     (54 54 (:REWRITE DEFAULT-CDR)))
(SORT-BY-CAR::TWO-MEMBERS-IMPLIES-OTHER-ASSOC-PAIR
     (382 382 (:REWRITE DEFAULT-CDR)))
(SORT-BY-CAR::MEMBER-IMPLIES-MEMBER-ASSOC (12 12 (:REWRITE DEFAULT-CDR)))
(SORT-BY-CAR::CAR-ASSOC (39 39 (:REWRITE DEFAULT-CAR))
                        (4 4 (:REWRITE DEFAULT-CDR)))
(SORT-BY-CAR::CAR-MEMBER (22 19 (:REWRITE DEFAULT-CAR))
                         (4 4 (:REWRITE DEFAULT-CDR)))
(SORT-BY-CAR::MEMBER-IMPLIES-ASSOC-CAR (12 12 (:REWRITE DEFAULT-CDR)))
(SORT-BY-CAR::OTHER-ASSOC-PAIR-IMPLIES-ASSOC
     (399 381 (:REWRITE DEFAULT-CAR))
     (210 210 (:REWRITE DEFAULT-CDR))
     (80 16
         (:REWRITE SORT-BY-CAR::TWO-MEMBERS-IMPLIES-OTHER-ASSOC-PAIR)))
(SORT-BY-CAR::ASSOC-IMPLIES-MEMBER-ALT
     (44 7 (:DEFINITION ASSOC-EQUAL))
     (18 2
         (:REWRITE SORT-BY-CAR::OTHER-ASSOC-PAIR-IMPLIES-ASSOC))
...
(SORT-BY-CAR::OTHER-ASSOC-PAIR-IS-NOT-ASSOC
     ...
     (558 58
          (:REWRITE SORT-BY-CAR::MEMBER-IMPLIES-ASSOC-CAR))
...
(SORT-BY-CAR::NO-DUPLICATESP-STRIP-CARS-IMPLIES-NO-DUPLICATESP
 (54
  6
  (:REWRITE SORT-BY-CAR::NOT-NO-DUPLICATESP-STRIP-CARS-IFF-OTHER-ASSOC-PAIR))
...
(SORT-BY-CAR::NO-DUPLICATESP-STRIP-CARS-SORT-BY-CAR<
     ...
     (8 8
        (:TYPE-PRESCRIPTION SORT-BY-CAR::SORT-BY-CAR<-TRUE-LISTP))
     (3 3
        (:REWRITE SORT-BY-CAR::SORT-BY-CAR<-CONSP))
...
(SORT-BY-CAR::SORT-BY-CAR<-PRESERVES-ASSOC-1
 (86
    6
    (:REWRITE SORT-BY-CAR::NO-DUPLICATESP-STRIP-CARS-IMPLIES-NO-DUPLICATESP))
