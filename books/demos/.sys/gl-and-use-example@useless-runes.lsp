...
(MAIN-3
 ...
 (100991 13896 (:REWRITE DEFAULT-TIMES-1))
 (94530 12 (:REWRITE MOD-X-Y-=-X-Y . 1))
 (71571 13896 (:REWRITE DEFAULT-TIMES-2))
 (69380 12659 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
 (68862 12685 (:TYPE-PRESCRIPTION MOD-POSITIVE . 2))
 (68862 12685 (:TYPE-PRESCRIPTION MOD-NEGATIVE . 2))
 (61387 237 (:REWRITE MOD-ZERO . 4))
 (55672 237 (:REWRITE MOD-X-Y-=-X . 3))
 (53120 384 (:REWRITE FLOOR-X-Y-=-1 . 2))
 (52384 237 (:REWRITE MOD-X-Y-=-X . 4))
 (49638 384 (:REWRITE FLOOR-ZERO . 3))
 (48482 237 (:REWRITE MOD-X-Y-=-X-Y . 2))
 (48389 35 (:REWRITE |(equal (+ (- c) x) y)|))
 (48303 48303 (:TYPE-PRESCRIPTION NOT-INTEGERP-3B))
 (48303 48303 (:TYPE-PRESCRIPTION NOT-INTEGERP-2B))
 (48303 48303 (:TYPE-PRESCRIPTION NOT-INTEGERP-1B))
 (47928 12 (:REWRITE MOD-X-Y-=-X+Y . 1))
 (47723 47723 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-NONPOSITIVE-BASE-EVEN-EXPONENT))
 (47723 47723 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-NEGATIVE-BASE-ODD-EXPONENT))
 (47723 47723 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-NEGATIVE-BASE-EVEN-EXPONENT))
 (47723 47723 (:TYPE-PRESCRIPTION EXPT-TYPE-PRESCRIPTION-INTEGERP-BASE-B))
 (30581 387 (:REWRITE DEFAULT-FLOOR-RATIO))
 (30332 384 (:REWRITE FLOOR-ZERO . 4))
 (28799 237 (:REWRITE MOD-X-Y-=-X+Y . 2))
 (28660 237 (:REWRITE MOD-ZERO . 3))
 (26457 384 (:REWRITE FLOOR-ZERO . 5))
 (24664 12659 (:TYPE-PRESCRIPTION INTEGERP-MOD-2))
 (22788 423 (:REWRITE |(integerp (- x))|))
 (22746 1904 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-<))
 (22739 1904 (:REWRITE PREFER-POSITIVE-ADDENDS-<))
 (20088 386 (:REWRITE FLOOR-=-X/Y . 3))
 (16940 1907 (:REWRITE DEFAULT-LESS-THAN-1))
 (15685 384 (:REWRITE FLOOR-X-Y-=--1 . 2))
 (12685 12685 (:TYPE-PRESCRIPTION MOD-ZERO . 3))
 (12685 12685 (:TYPE-PRESCRIPTION MOD-POSITIVE . 1))
 (12685 12685 (:TYPE-PRESCRIPTION MOD-NEGATIVE . 1))
 (12659 12659 (:TYPE-PRESCRIPTION MOD-NONPOSITIVE))
 (12536 1817 (:REWRITE DEFAULT-PLUS-2))
 (11903 1931 (:REWRITE THE-FLOOR-ABOVE))
 (11403 71 (:LINEAR MOD-BOUNDS-3))
 (10862 241 (:REWRITE SIMPLIFY-PRODUCTS-GATHER-EXPONENTS-EQUAL))
 (10426 794 (:REWRITE DEFAULT-MINUS))
 (10070 1668 (:REWRITE INTEGERP-MINUS-X))
 (9720 1817 (:REWRITE DEFAULT-PLUS-1))
 (8231 378 (:REWRITE |(floor x 1)|))
 (8189 237 (:REWRITE MOD-X-Y-=-X . 2))
 (8189 237 (:REWRITE |(mod (+ x (mod a b)) y)|))
 (8189 237 (:REWRITE |(mod (+ x (- (mod a b))) y)|))
 (7858 142 (:LINEAR LINEAR-FLOOR-BOUNDS-2))
 (7709 1907 (:REWRITE DEFAULT-LESS-THAN-2))
 (6390 236 (:REWRITE SIMPLIFY-SUMS-EQUAL))
 (5437 236 (:REWRITE EQUAL-OF-BOOLEANS-REWRITE))
 (4357 237 (:REWRITE MOD-X-Y-=-X-Y . 3))
 (4357 237 (:REWRITE MOD-X-Y-=-X+Y . 3))
 (4293 236 (:REWRITE MOD-CANCEL-*-CONST))
 ...
 (2440 1931 (:REWRITE THE-FLOOR-BELOW))
 (2206 228 (:REWRITE MOD-CANCEL-*-NOT-REWRITING-GOAL-LITERAL))
 (2198 220 (:REWRITE |(mod (* x (/ y)) z) not rewriting-goal-literal|))
 (2058 374 (:REWRITE FLOOR-CANCEL-*-NOT-REWRITING-GOAL-LITERAL))
 (2058 374 (:REWRITE |(floor (* x (/ y)) z) not rewriting-goal-literal|))
 (1913 1907 (:REWRITE REDUCE-RATIONAL-MULTIPLICATIVE-CONSTANT-<))
 (1913 1907 (:REWRITE REDUCE-MULTIPLICATIVE-CONSTANT-<))
 (1907 1907 (:REWRITE REMOVE-STRICT-INEQUALITIES))
 (1907 1907 (:REWRITE REDUCE-ADDITIVE-CONSTANT-<))
 (1907 1907 (:REWRITE INTEGERP-<-CONSTANT))
 (1907 1907 (:REWRITE CONSTANT-<-INTEGERP))
 (1907 1907 (:REWRITE |(< c (/ x)) positive c --- present in goal|))
 (1907 1907 (:REWRITE |(< c (/ x)) positive c --- obj t or nil|))
 (1907 1907 (:REWRITE |(< c (/ x)) negative c --- present in goal|))
 (1907 1907 (:REWRITE |(< c (/ x)) negative c --- obj t or nil|))
 (1907 1907 (:REWRITE |(< c (- x))|))
 (1907 1907 (:REWRITE |(< (/ x) c) positive c --- present in goal|))
 (1907 1907 (:REWRITE |(< (/ x) c) positive c --- obj t or nil|))
 (1907 1907 (:REWRITE |(< (/ x) c) negative c --- present in goal|))
 (1907 1907 (:REWRITE |(< (/ x) c) negative c --- obj t or nil|))
 (1907 1907 (:REWRITE |(< (/ x) (/ y))|))
 (1907 1907 (:REWRITE |(< (- x) c)|))
 (1907 1907 (:REWRITE |(< (- x) (- y))|))
 (1890 38 (:REWRITE |(- (+ x y))|))
 (1873 220 (:REWRITE |(mod (* x (/ y)) z) rewriting-goal-literal|))
 ...
 (722 248 (:REWRITE REDUCE-ADDITIVE-CONSTANT-EQUAL))
 ...
 (374 374 (:REWRITE |(floor (- x) y)| . 2))
 (374 374 (:REWRITE |(floor (- x) y)| . 1))
 (344 344 (:REWRITE |(< 0 (* x y)) rationalp (* x y)|))
 ...
 (257 242 (:REWRITE |(equal (/ x) c)|))
 (242 242 (:REWRITE DEFAULT-MOD-2))
 ...
 (220 220 (:REWRITE THIS-NEEDS-TO-BE-ADDED-TO-QUOTIENT-REMAINDER-LEMMAS))
 (220 220 (:REWRITE |(mod x (- y))| . 3))
 (220 220 (:REWRITE |(mod x (- y))| . 2))
 (220 220 (:REWRITE |(mod x (- y))| . 1))
 (220 220 (:REWRITE |(mod x (* y (/ z))) rewriting-goal-literal|))
 (220 220 (:REWRITE |(mod x (* y (/ z))) not rewriting-goal-literal|))
 (220 220 (:REWRITE |(mod (- x) y)| . 3))
 (220 220 (:REWRITE |(mod (- x) y)| . 2))
 (220 220 (:REWRITE |(mod (- x) y)| . 1))
