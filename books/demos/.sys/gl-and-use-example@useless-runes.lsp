...
(MAIN-3
 ...
 (69415 12666 (:TYPE-PRESCRIPTION MOD-ZERO . 1))
 (68913 12692 (:TYPE-PRESCRIPTION MOD-POSITIVE . 2))
 (68913 12692 (:TYPE-PRESCRIPTION MOD-NEGATIVE . 2))
 ...
 (24671 12666 (:TYPE-PRESCRIPTION INTEGERP-MOD-2))
 ...
 (12692 12692 (:TYPE-PRESCRIPTION MOD-ZERO . 3))
 (12692 12692 (:TYPE-PRESCRIPTION MOD-POSITIVE . 1))
 (12692 12692 (:TYPE-PRESCRIPTION MOD-NEGATIVE . 1))
 (12666 12666 (:TYPE-PRESCRIPTION MOD-NONPOSITIVE))
 ...
 (2605 2461 (:TYPE-PRESCRIPTION FLOOR-NONNEGATIVE . 1))
 ...
 (158 158 (:TYPE-PRESCRIPTION RATIONALP-MOD))
...
(MAIN-4
 (78114 84 (:LINEAR LINEAR-FLOOR-BOUNDS-1))
 (36813 26 (:REWRITE MOD-ZERO . 4))
 (26171 26 (:REWRITE MOD-X-Y-=-X . 3))
 (25703 26 (:REWRITE MOD-X-Y-=-X-Y . 2))
 (25533 26 (:REWRITE MOD-X-Y-=-X+Y . 2))
 (24855 26 (:REWRITE MOD-X-Y-=-X . 4))
 (21086 2881 (:REWRITE DEFAULT-TIMES-2))
 (19639 135 (:REWRITE CANCEL-FLOOR-+))
 (19210 2881 (:REWRITE DEFAULT-TIMES-1))
 (18696 128 (:REWRITE |(floor (* x (/ y)) z) not rewriting-goal-literal|))
