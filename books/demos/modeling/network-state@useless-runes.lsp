...
(CLIENT-STATE)
(HONSED-CLIENT-STATE)
(CLIENT-STATE->NUMBER-TO-SQUARE$INLINE (2 2 (:DEFINITION ASSOC-EQUAL)))
(CLIENT-STATE->ANSWER$INLINE (2 2 (:DEFINITION ASSOC-EQUAL)))
...
(SERVER-STATE)
(HONSED-SERVER-STATE)
(SERVER-STATE->REQUESTS-SERVED$INLINE (1 1 (:DEFINITION ASSOC-EQUAL)))
...
(MESSAGE)
(HONSED-MESSAGE)
(MESSAGE->TAG$INLINE (2 2 (:DEFINITION ASSOC-EQUAL)))
(MESSAGE->PAYLOAD$INLINE (2 2 (:DEFINITION ASSOC-EQUAL)))
(CONSP-OF-MESSAGE)
...
(ID-P)
(ID-P-IMPLIES-KEYWORDP (2 2
                          (:REWRITE DEFAULT-SYMBOL-PACKAGE-NAME)))
(NETWORK-PACKET-P (3 3
                     (:TYPE-PRESCRIPTION CONSP-ASSOC-EQUAL)))
(NETWORK-PACKET)
(HONSED-NETWORK-PACKET)
(NETWORK-PACKET->SENDER$INLINE (3 3 (:DEFINITION ASSOC-EQUAL)))
(NETWORK-PACKET->DEST$INLINE (3 3 (:DEFINITION ASSOC-EQUAL)))
(NETWORK-PACKET->MESSAGE$INLINE (3 3 (:DEFINITION ASSOC-EQUAL)))
...
(SQUARE-OUTPUT-LEMMA)
(RETRIEVE-NETWORK-MESSAGE (1 1 (:REWRITE SUBSETP-TRANS2))
                          (1 1 (:REWRITE SUBSETP-TRANS))
                          (1 1
                             (:REWRITE NETWORK-STATE-P-WHEN-NOT-CONSP))
                          (1 1 (:REWRITE DEFAULT-CDR))
                          (1 1 (:REWRITE DEFAULT-CAR)))
(RETRIEVE-NETWORK-MESSAGE-RETURNS-NETWORK-PACKET-P
     (184 18 (:DEFINITION MEMBER-EQUAL))
     (118 14
          (:REWRITE NETWORK-PACKET-P-WHEN-WRONG-TAG))
     ...
     (13 13
         (:TYPE-PRESCRIPTION BOOLEANP-OF-SERVER-STATE-P))
     (13 13
         (:TYPE-PRESCRIPTION BOOLEANP-OF-MESSAGE-P))
     (13 13
         (:TYPE-PRESCRIPTION BOOLEANP-OF-CLIENT-STATE-P))
     (12 2
...
(MAKE-SQUARE-REQUEST (10 1 (:REWRITE MESSAGE-P-WHEN-WRONG-TAG))
                     (4 1 (:REWRITE TAG-WHEN-NETWORK-PACKET-P))
                     (4 1 (:REWRITE TAG-WHEN-MESSAGE-P))
                     (1 1
                        (:TYPE-PRESCRIPTION BOOLEANP-OF-NETWORK-PACKET-P))
...
(MAKE-SQUARE-REQUEST-OUTPUT-LEMMA
     ...
     (4 1 (:REWRITE TAG-WHEN-NETWORK-PACKET-P))
     (2 2
        (:REWRITE NETWORK-PACKET-P-WHEN-MEMBER-EQUAL-OF-NETWORK-STATE-P))
     (1 1 (:REWRITE TAG-OF-NETWORK-PACKET)))
(PRINT-STATES)
(CLIENT-STEP1)
(CLIENT-STEP1-OUTPUT-LEMMA-1
     (10 2
         (:REWRITE CLIENT-STATE-P-WHEN-WRONG-TAG))
     (2 2
        (:REWRITE NETWORK-STATE-P-WHEN-SUBSETP-EQUAL))
...
(CLIENT-STEP1-OUTPUT-LEMMA-2
     ...
     (1 1
        (:TYPE-PRESCRIPTION BOOLEANP-OF-SERVER-STATE-P))
     (1 1 (:REWRITE TAG-OF-NETWORK-PACKET)))
(MAKE-SQUARE-RESPONSE (10 1 (:REWRITE MESSAGE-P-WHEN-WRONG-TAG))
                      (4 1 (:REWRITE TAG-WHEN-NETWORK-PACKET-P))
                      (4 1 (:REWRITE TAG-WHEN-MESSAGE-P))
                      (1 1
                         (:TYPE-PRESCRIPTION BOOLEANP-OF-NETWORK-PACKET-P))
...
(LEMMA-ADDED-IN-TYPE-ALIST-REORDERING
     ...
     (51 3
         (:REWRITE NETWORK-PACKET-P-OF-CAR-WHEN-NETWORK-STATE-P))
...
(SERVER-STEP1
     ...
     (147 16
          (:REWRITE RETRIEVE-NETWORK-MESSAGE-RETURNS-NETWORK-PACKET-P))
     (146 18
          (:REWRITE NETWORK-PACKET-P-WHEN-WRONG-TAG))
     (137 17
          (:REWRITE SERVER-STATE-P-WHEN-WRONG-TAG))
     ...
     (3 3 (:REWRITE SUBSETP-TRANS))
     (2 1
        (:TYPE-PRESCRIPTION INTEGERP-OF-MESSAGE->PAYLOAD))
...
(SERVER-STEP1-OUTPUT-LEMMA-1
     (65 7
         (:REWRITE SERVER-STATE-P-WHEN-WRONG-TAG))
     (45 9
         (:DEFINITION RETRIEVE-NETWORK-MESSAGE))
     (28 4
         (:REWRITE NETWORK-PACKET-P-WHEN-MEMBER-EQUAL-OF-NETWORK-STATE-P))
...
(SERVER-STEP1-OUTPUT-LEMMA-2
     ...
     (2 1 (:REWRITE DEFAULT-+-2))
     (1 1
        (:TYPE-PRESCRIPTION INTEGERP-OF-SERVER-STATE->REQUESTS-SERVED))
     (1 1 (:REWRITE TAG-OF-NETWORK-PACKET))
     (1 1 (:REWRITE DEFAULT-+-1)))
(CLIENT-STEP2
