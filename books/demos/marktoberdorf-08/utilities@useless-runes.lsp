(COERCE-LEMMA (1 1 (:REWRITE DEFAULT-COERCE-2))
              (1 1 (:REWRITE DEFAULT-COERCE-1)))
(COERCE-LEMMA-CORROLLARY)
(NTHCDR-LEN (36 4 (:REWRITE ZP-OPEN))
...
(LEN-FIRSTN (117 68 (:REWRITE DEFAULT-+-2))
...
(NTHCDR-NIL-2 (13 13
              ...
              (4 4 (:REWRITE DEFAULT-+-1)))
(NTH-NTHCDR (275 64 (:REWRITE ZP-OPEN))
            (181 181
                 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
            ...
            (5 5
               (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(LEN-NTHCDR (143 85 (:REWRITE DEFAULT-+-2))
...
(LEN-CDR (105 68 (:REWRITE DEFAULT-+-2))
...
(NTH-IS-CAR-NTHCDR-2 (98 4 (:REWRITE CONSP-NTHCDR-2))
                     (67 67
                         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
                     (38 6 (:DEFINITION LEN))
                     ...
                     (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
                     (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(DUMB-LEMMA (5 5 (:META CANCEL_TIMES-EQUAL-CORRECT))
            (5 5 (:META CANCEL_PLUS-EQUAL-CORRECT))
...
(NTHCDR-NIL)
(CONSP-NTHCDR (15 3 (:DEFINITION LEN))
              ...
              (1 1 (:REWRITE NATP-RW)))
(NTHCDR-FIRSTN-NTHCDR (549 101 (:DEFINITION LEN))
...
(UP-DOWN-HINT (3 3
                 (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|)))
(FIRSTN-NTHCDR-FIRSTN (186 147 (:REWRITE DEFAULT-+-2))
                      ...
                      (1 1
                         (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP)))
(NTHCDR-NON-NIL (175 126 (:REWRITE DEFAULT-+-2))
                ...
                (3 3 (:REWRITE POSP-RW))
                (2 2 (:REWRITE O-INFP->NEQ-0)))
(FIRSTN-NTHCDR-ELIM (671 208 (:TYPE-PRESCRIPTION BINARY-APPEND))
                    (215 215
                         (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
...
(LEN-NTHCDR-GEN)
(FIRSTN-FIRSTN (34 33 (:REWRITE DEFAULT-<-2))
...
(FIRSTN-LEN (27 3 (:REWRITE ZP-OPEN))
...
(FIRSTN-TOO-BIG (51 51
                ...
                (3 3 (:META CANCEL_TIMES-EQUAL-CORRECT))
                (3 3 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(FIRSTN-APPEND (1326 59 (:REWRITE FIRSTN-TOO-BIG))
               ...
               (2 2 (:TYPE-PRESCRIPTION POSP)))
(HINT2)
(EQUAL-APPEND (685 685 (:TYPE-PRESCRIPTION BINARY-APPEND))
...
(NTHCDR-APPEND (1323 1315 (:TYPE-PRESCRIPTION BINARY-APPEND))
               ...
               (3 3 (:REWRITE NATP-RW))
               (1 1 (:REWRITE POSP-RW)))
(CHARACTERP-CAR-NTHCDR-COERCE (201 108 (:REWRITE DEFAULT-+-2))
                              ...
                              (1 1 (:REWRITE EQUAL-CONSTANT-+)))
(LENS-DIFFER)
(EQUAL-CHAR-CODES (40 4 (:REWRITE DEFAULT-CODE-CHAR))
                  ...
                  (5 5 (:META CANCEL_TIMES-EQUAL-CORRECT))
                  (5 5 (:META CANCEL_PLUS-EQUAL-CORRECT)))
(LEN-0 (20 4 (:REWRITE LENS-DIFFER))
...
(EQUAL-LENGTH-0 (20 4 (:DEFINITION LEN))
