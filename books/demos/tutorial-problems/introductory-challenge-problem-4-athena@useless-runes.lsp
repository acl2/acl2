(DUPSP)
(COLLECT-ONCE)
(MAIN-THEOREM-1-ABOUT-COLLECT-ONCE (242 241 (:REWRITE DEFAULT-CAR))
                                   (238 237 (:REWRITE DEFAULT-CDR)))
(MEMBER-COLLECT-ONCE (167 160 (:REWRITE DEFAULT-CAR))
                     (152 149 (:REWRITE DEFAULT-CDR)))
(MAIN-THEOREM-2-ABOUT-COLLECT-ONCE (36 34 (:REWRITE DEFAULT-CDR))
                                   (28 27 (:REWRITE DEFAULT-CAR)))
(WHILE-LOOP-VERSION)
(REV)
(LIST-MINUS)
(LIST-MINUS-APPEND (83 73 (:REWRITE DEFAULT-CAR))
...
(COLLECT-ONCE-APPEND (183 165 (:REWRITE DEFAULT-CDR))
...
(MEMBER-LIST-MINUS (165 160 (:REWRITE DEFAULT-CAR))
                   (129 125 (:REWRITE DEFAULT-CDR)))
(LIST-MINUS-COLLECT-ONCE (164 159 (:REWRITE DEFAULT-CDR))
                         (149 144 (:REWRITE DEFAULT-CAR)))
(LIST-MINUS-LIST-MINUS (103 100 (:REWRITE DEFAULT-CAR))
                       (92 90 (:REWRITE DEFAULT-CDR))
                       (33 11 (:DEFINITION BINARY-APPEND)))
(GENERAL-EQUIVALENCE (97 97 (:REWRITE DEFAULT-CAR))
                     (87 87 (:REWRITE DEFAULT-CDR))
                     (20 20 (:TYPE-PRESCRIPTION REV)))
(MAIN-THEOREM-1-ABOUT-WHILE-LOOP (771 638 (:REWRITE DEFAULT-CAR))
                                 (681 611 (:REWRITE DEFAULT-CDR)))
(MAIN-THEOREM-2-ABOUT-WHILE-LOOP (12 1 (:DEFINITION COLLECT-ONCE))
                                 (8 1 (:DEFINITION REV))
...
(TRANS-SUBSETP (116 116 (:REWRITE DEFAULT-CAR))
               (89 89 (:REWRITE DEFAULT-CDR)))
(APPEND-CONS-V-CONS-APPEND-1 (340 16 (:REWRITE MEMBER-APPEND))
                             (207 96 (:REWRITE DEFAULT-CAR))
                             (181 181 (:TYPE-PRESCRIPTION MEMBER-EQUAL))
                             (151 73 (:REWRITE DEFAULT-CDR)))
(APPEND-CONS-V-CONS-APPEND-2 (63 51 (:REWRITE DEFAULT-CAR))
                             (46 37 (:REWRITE DEFAULT-CDR)))
(SUBSETP-APPEND-CONS-CONS-APPEND (90 3 (:DEFINITION SUBSETP-EQUAL))
...
(MAIN-LEMMA-1-ABOUT-WHILE-LOOP-VERSION
     ...
     (7 5
        (:TYPE-PRESCRIPTION WHILE-LOOP-VERSION))
     (1 1 (:REWRITE CDR-CONS))
     (1 1 (:REWRITE CAR-CONS)))
(SUBSETP-APPEND-NIL (144 18 (:REWRITE APPEND-TO-NIL))
...
(MAIN-LEMMA-2-ABOUT-WHILE-LOOP-VERSION (82 78 (:REWRITE DEFAULT-CDR))
