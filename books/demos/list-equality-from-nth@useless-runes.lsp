(F1)
(F2)
(NTH-I-OUT-OF-RANGE (18 13 (:REWRITE DEFAULT-<-2))
...
(NTH-I-F2-F1-BETTER (42 2 (:DEFINITION NTH))
                    (38 6 (:DEFINITION LEN))
...
(BADGUY (58 28 (:REWRITE DEFAULT-+-2))
...
(BADGUY-IS-CORRECT (796 48 (:REWRITE NTH-I-OUT-OF-RANGE))
                   (230 125 (:REWRITE DEFAULT-+-2))
...
(F1-EQUALS-F2 (64 2 (:DEFINITION NTH))
