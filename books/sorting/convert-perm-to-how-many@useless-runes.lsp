...
(HOW-MANY-RM (48 48 (:REWRITE DEFAULT-CDR))
             (41 41 (:REWRITE DEFAULT-CAR))
             (36 18 (:REWRITE DEFAULT-+-2))
             (18 18 (:REWRITE DEFAULT-+-1)))
(NOT-MEMB-IMPLIES-RM-IS-NO-OP (14 14 (:REWRITE DEFAULT-CAR))
                              (9 9 (:REWRITE DEFAULT-CDR)))
(TRUE-LISTP-RM (17 17 (:REWRITE DEFAULT-CDR))
               (16 16 (:REWRITE DEFAULT-CAR)))
(NOT-MEMB-IMPLIES-HOW-MANY-IS-0 (17 17 (:REWRITE DEFAULT-CAR))
                                (11 11 (:REWRITE DEFAULT-CDR))
                                (6 3 (:REWRITE DEFAULT-+-2))
                                (3 3 (:REWRITE DEFAULT-+-1)))
(HOW-MANY-RM-GENERAL (400 200 (:TYPE-PRESCRIPTION TRUE-LISTP-RM))
                     (381 52
...
(PERM-COUNTER-EXAMPLE-TLFIX-1 (107 7 (:DEFINITION RM))
