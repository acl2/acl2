...
(HOW-MANY-SMALLER)
(BNEXT-SIZE)
(HOW-MANY-SMALLER-BNEXT (285 258 (:REWRITE DEFAULT-CDR))
                        (217 199 (:REWRITE DEFAULT-CAR))
                        (94 47 (:REWRITE DEFAULT-+-2))
                        (47 47 (:REWRITE DEFAULT-+-1)))
(HOW-MANY-BAD-PAIRS-BNEXT (377 354 (:REWRITE DEFAULT-CDR))
...
(BSORT (124 5 (:DEFINITION BNEXT-SIZE))
       ...
       (15 15
           (:TYPE-PRESCRIPTION HOW-MANY-SMALLER))
       (8 8 (:TYPE-PRESCRIPTION LEXORDER))
       (8 8 (:REWRITE LEXORDER-TRANSITIVE))
       (2 1 (:REWRITE DEFAULT-<-2))
       (2 1 (:REWRITE DEFAULT-<-1)))
(ORDEREDP-WHEN-BNEXT-CONSTANT (329 306 (:REWRITE DEFAULT-CDR)))
(ORDEREDP-BSORT (120 116 (:REWRITE DEFAULT-CDR))
                (100 96 (:REWRITE DEFAULT-CAR))
                (90 90 (:TYPE-PRESCRIPTION BNEXT))
                (20 20 (:REWRITE LEXORDER-TRANSITIVE)))
(TRUE-LISTP-BNEXT (31 29 (:REWRITE DEFAULT-CDR))
                  (20 20 (:REWRITE DEFAULT-CAR)))
(TRUE-LISTP-BSORT (55 55 (:REWRITE DEFAULT-CDR))
                  (40 40 (:REWRITE DEFAULT-CAR))
                  (14 7 (:DEFINITION TRUE-LISTP))
                  (8 8 (:REWRITE LEXORDER-TRANSITIVE)))
(HOW-MANY-BNEXT (284 257 (:REWRITE DEFAULT-CDR))
                (226 206 (:REWRITE DEFAULT-CAR))
                (64 32 (:REWRITE DEFAULT-+-2))
                (32 32 (:REWRITE DEFAULT-+-1)))
(HOW-MANY-BSORT (262 30
